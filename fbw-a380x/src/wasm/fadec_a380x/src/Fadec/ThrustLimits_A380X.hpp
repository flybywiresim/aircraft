...
class ThrustLimits_A380X {
  ...
  // GA
      {-1000,   45.771,  54.681,  85.255, 82.461, 63.920}, // row 21
      ...
      {16600,   5.182,   21.022,  97.366, 91.384, 58.642}, // row 40
  // CLB
      {-2000,   30.800,  56.870,  80.280, 72.000, 0.000 }, // row 41
      ...
      {35000,   -45.679, -17.150, 97.06504, 85.248, 0.000 }, //
      {39000,   -45.679, -17.150, 99.09115, 84.346, 0.000 }, //
      {41500,   -45.679, -17.150, 100.4598, 83.745, 0.000 }, // row 58
  // MCT
      ...
      {35000,   -43.628, -14.384, 99.370, 85.747, 0.000 }, //
      {39000,   -47.286, -18.508, 100.196, 85.545, 0.000 }  // row 71
  };
