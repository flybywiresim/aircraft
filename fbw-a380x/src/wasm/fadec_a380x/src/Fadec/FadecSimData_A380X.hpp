...
class FadecSimData_A380X {
 public:
  ...
  NamedVariablePtr fuelLeftOuterPre;
  NamedVariablePtr fuelFeedOnePre;
  NamedVariablePtr fuelLeftMidPre;
  NamedVariablePtr fuelLeftInnerPre;
  NamedVariablePtr fuelFeedTwoPre;
  NamedVariablePtr fuelFeedThreePre;
  NamedVariablePtr fuelRightInnerPre;
  NamedVariablePtr fuelRightMidPre;
  NamedVariablePtr fuelFeedFourPre;
  NamedVariablePtr fuelRightOuterPre;
  NamedVariablePtr fuelTrimPre;
  ...
  void initLvars(DataManager* dm) {
    ...
    engineFF[E3]->set(0);
    engineFF[E4]->set(0);
    engineFuelUsed[E1]->set(0);
    engineFuelUsed[E2]->set(0);
    engineFuelUsed[E3]->set(0);
    engineFuelUsed[E4]->set(0);
    engineIdleEGT->set(0);
    engineIdleFF->set(0);
    engineIdleN1->set(0);
    engineIdleN3->set(0);
    ...
    engineN2[E3]->set(0);
    engineN2[E4]->set(0);
    engineOilTotal[E1]->set(0);
    engineOilTotal[E2]->set(0);
    engineOilTotal[E3]->set(0);
    engineOilTotal[E4]->set(0);
    engineOil[E1]->set(0);
    engineOil[E2]->set(0);
    engineOil[E3]->set(0);
    engineOil[E4]->set(0);
    enginePreFF[E1]->set(0);
    enginePreFF[E2]->set(0);
    enginePreFF[E3]->set(0);
    enginePreFF[E4]->set(0);
    engineTimer[E1]->set(0);
    engineTimer[E2]->set(0);
    engineTimer[E3]->set(0);
    engineTimer[E4]->set(0);
    fuelPumpState[E1]->set(0);
    fuelPumpState[E2]->set(0);
    fuelPumpState[E3]->set(0);
    fuelPumpState[E4]->set(0);
