...
class ThrustLimits_A380X {
   ...
   *
   * This function calculates the total bleed air situation based on the given parameters. It takes into account the type of limit,
   * altitude, outside air temperature, low and high temperature limits, flex temperature, and the status of the air conditioning,
   * nacelle anti-ice, and wing anti-ice. It returns the total bleed air as a double.
   *
   ...
   *
   * This function calculates the N1 limit based on the type of limit, altitude, ambient temperature, ambient pressure, flex temperature,
   * and the status of the air conditioning, nacelle anti-ice, and wing anti-ice. It uses a series of calculations and interpolations
   ...
   *
   * TODO: might be improved - CoPilot had a much cleaner version but it was not used in the code
   */
  static double
