 ...
 public:
  ...
  // clang-format off
      ...
      .POWERED_CONFIG_ON {
        ...
        ProcedureStep{"ENG Fire Test On",         PROC, 2000, "(L:A32NX_AIRCRAFT_PRESET_FIRE_TEST_ENG1_DONE)",          "1 (>L:A32NX_FIRE_TEST_ENG1)"},
        ProcedureStep{"ENG Fire Test Off",        PROC, 2000, "(L:A32NX_AIRCRAFT_PRESET_FIRE_TEST_ENG1_DONE)",          "0 (>L:A32NX_FIRE_TEST_ENG1) 1 (>L:A32NX_AIRCRAFT_PRESET_FIRE_TEST_ENG1_DONE)"},
