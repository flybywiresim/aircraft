...
const prim_outputs A380PrimComputerFe_rtZprim_outputs{ { { 0.0,
      0.0,
      0.0
    },
...
{
  A380PrimComputerFe_U.in = A380PrimComputerFe_rtZprim_outputs;
  A380PrimComputerFe_Y.out = A380PrimComputerFe_rtZprim_outputs;
  A380PrimComputerFe_DWork.Delay_DSTATE = A380PrimComputerFe_P.DiscreteDerivativeVariableTs_InitialCondition;
