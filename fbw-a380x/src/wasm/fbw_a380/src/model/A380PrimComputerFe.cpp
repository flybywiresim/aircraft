...
void A380PrimComputerFe::step()
{
  ...
  if (A380PrimComputerFe_U.in.data.sim_data.computer_running) {
    ...
    if (A380PrimComputerFe_P.reset_Value_o) {
      ...
      A380PrimComputerFe_DWork.pY += std::fmax(std::fmin(rtb_conf - A380PrimComputerFe_DWork.pY, std::abs
    ...
    rtb_uDLookupTable = A380PrimComputerFe_P.Gain2_Gain * A380PrimComputerFe_U.in.data.adcn_inputs.fms.fms_weight_lbs;
    bpIndices[0U] = plook_binx(rtb_uDLookupTable, A380PrimComputerFe_P.nDLookupTable_bp01Data, 7U, &rtb_vs1g_o);
    fractions[0U] = rtb_vs1g_o;
    bpIndices[1U] = plook_binx(A380PrimComputerFe_P.Gain3_Gain *
      ...
      &rtb_vs1g_o);
    fractions[1U] = rtb_vs1g_o;
    bpIndices[2U] = plook_binx(static_cast<real_T>(A380PrimComputerFe_U.in.general_logic.flap_handle_index),
      A380PrimComputerFe_P.nDLookupTable_bp03Data, 5U, &rtb_vs1g_o);
    fractions[2U] = rtb_vs1g_o;
    A380PrimComputerFe_VS1GfromVLS(look2_binlxpw(rtb_uDLookupTable,
      ...
      static_cast<real_T>(A380PrimComputerFe_U.in.general_logic.flap_handle_index), &rtb_vs1g_o);
    A380PrimComputerFe_RateLimiter(rtb_vs1g_o, A380PrimComputerFe_P.RateLimiterGenericVariableTs1_up_j,
      ...
      A380PrimComputerFe_P.reset_Value_h, &rtb_Switch, &A380PrimComputerFe_DWork.sf_RateLimiter_b);
    A380PrimComputerFe_Y.out.flight_envelope.v_ls_kn = std::fmax(A380PrimComputerFe_P.Vmcl_Value,
      A380PrimComputerFe_DWork.pY * rtb_Switch) + rtb_vs1g;
    rtb_uDLookupTable = A380PrimComputerFe_P.Gain2_Gain_m * A380PrimComputerFe_U.in.data.adcn_inputs.fms.fms_weight_lbs;
    bpIndices_0[0U] = plook_binx(rtb_uDLookupTable, A380PrimComputerFe_P.nDLookupTable_bp01Data_n, 7U, &rtb_vs1g_o);
    fractions_0[0U] = rtb_vs1g_o;
    ...
    rtb_uDLookupTable = A380PrimComputerFe_P.Gain2_Gain_d * A380PrimComputerFe_U.in.data.adcn_inputs.fms.fms_weight_lbs;
    if (A380PrimComputerFe_U.in.general_logic.on_ground) {
    ...
    bpIndices_1[0U] = plook_binx(rtb_uDLookupTable, A380PrimComputerFe_P.nDLookupTable_bp01Data_c, 7U, &rtb_vs1g_o);
    fractions_1[0U] = rtb_vs1g_o;
    bpIndices_1[1U] = plook_binx(A380PrimComputerFe_P.Gain3_Gain_k *
      A380PrimComputerFe_U.in.data.adcn_inputs.fms.fms_cg_percent, A380PrimComputerFe_P.nDLookupTable_bp02Data_e, 1U,
      &rtb_vs1g_o);
    fractions_1[1U] = rtb_vs1g_o;
    bpIndices_1[2U] = plook_binx(rtb_conf, A380PrimComputerFe_P.nDLookupTable_bp03Data_l, 5U, &rtb_vs1g_o);
    fractions_1[2U] = rtb_vs1g_o;
    A380PrimComputerFe_VS1GfromVLS(look2_binlxpw(rtb_uDLookupTable,
      A380PrimComputerFe_U.in.general_logic.adr_computation_data.altitude_standard_ft,
      ...
      (bpIndices_1, fractions_1, A380PrimComputerFe_P.nDLookupTable_tableData_p,
       A380PrimComputerFe_P.nDLookupTable_dimSizes_l), rtb_conf, &rtb_vs1g_o);
    ...
    rtb_uDLookupTable = A380PrimComputerFe_P.Gain2_Gain_n * A380PrimComputerFe_U.in.data.adcn_inputs.fms.fms_weight_lbs;
    bpIndices_2[0U] = plook_binx(rtb_uDLookupTable, A380PrimComputerFe_P.nDLookupTable_bp01Data_cz, 7U, &rtb_vs1g_o);
    fractions_2[0U] = rtb_vs1g_o;
    bpIndices_2[1U] = plook_binx(A380PrimComputerFe_P.Gain3_Gain_kw *
      A380PrimComputerFe_U.in.data.adcn_inputs.fms.fms_cg_percent, A380PrimComputerFe_P.nDLookupTable_bp02Data_i, 1U,
      &rtb_vs1g_o);
    fractions_2[1U] = rtb_vs1g_o;
    bpIndices_2[2U] = plook_binx(A380PrimComputerFe_P.Constant_Value_a, A380PrimComputerFe_P.nDLookupTable_bp03Data_h,
      5U, &rtb_vs1g_o);
    fractions_2[2U] = rtb_vs1g_o;
    A380PrimComputerFe_VS1GfromVLS(look2_binlxpw(rtb_uDLookupTable,
      A380PrimComputerFe_U.in.general_logic.adr_computation_data.altitude_standard_ft,
    ...
    rtb_vs1g_o = std::fmax(A380PrimComputerFe_P.Gain2_Gain_j * rtb_vs1g, A380PrimComputerFe_P.Vmcl20_Value);
    A380PrimComputerFe_Y.out.flight_envelope.v_stall_kn = rtb_Switch;
    ...
    {
      rtb_conf = A380PrimComputerFe_P.Saturation_UpperSat;
    } else if (A380PrimComputerFe_U.in.general_logic.adr_computation_data.V_ias_kn <
               A380PrimComputerFe_P.Saturation_LowerSat) {
      rtb_conf = A380PrimComputerFe_P.Saturation_LowerSat;
    } else {
      rtb_conf = A380PrimComputerFe_U.in.general_logic.adr_computation_data.V_ias_kn;
    }

    A380PrimComputerFe_LagFilter(rtb_conf, A380PrimComputerFe_P.LagFilter_C1_d, A380PrimComputerFe_U.in.data.time.dt,
      &rtb_Switch, &A380PrimComputerFe_DWork.sf_LagFilter_d);
    if ((!A380PrimComputerFe_DWork.pY_not_empty_d) || (!A380PrimComputerFe_DWork.pU_not_empty)) {
      A380PrimComputerFe_DWork.pU = rtb_Switch;
      A380PrimComputerFe_DWork.pU_not_empty = true;
      A380PrimComputerFe_DWork.pY_b = rtb_Switch;
    ...
    rtb_conf = 2.0 / rtb_vs1g;
    A380PrimComputerFe_DWork.pY_b = (2.0 - A380PrimComputerFe_U.in.data.time.dt * A380PrimComputerFe_P.WashoutFilter_C1)
      / rtb_vs1g * A380PrimComputerFe_DWork.pY_b + (rtb_Switch * rtb_conf - A380PrimComputerFe_DWork.pU * rtb_conf);
    A380PrimComputerFe_DWork.pU = rtb_Switch;
    A380PrimComputerFe_LagFilter(A380PrimComputerFe_U.in.general_logic.ir_computation_data.n_z_g +
      ...
      &rtb_Switch, &A380PrimComputerFe_DWork.sf_LagFilter_pa);
    if (A380PrimComputerFe_U.in.general_logic.on_ground) {
    ...
    if (rtb_Switch > A380PrimComputerFe_P.Saturation1_UpperSat) {
      rtb_conf = A380PrimComputerFe_P.Saturation1_UpperSat;
    } else if (rtb_Switch < A380PrimComputerFe_P.Saturation1_LowerSat) {
      rtb_conf = A380PrimComputerFe_P.Saturation1_LowerSat;
    } else {
      rtb_conf = rtb_Switch;
    }

    A380PrimComputerFe_LagFilter(A380PrimComputerFe_P.Gain_Gain_e *
      A380PrimComputerFe_U.in.general_logic.ir_computation_data.n_x_g - rtb_vs1g * (rtb_conf +
      A380PrimComputerFe_P.Bias1_Bias), A380PrimComputerFe_P.LagFilter1_C1, A380PrimComputerFe_U.in.data.time.dt,
      &rtb_Switch, &A380PrimComputerFe_DWork.sf_LagFilter_p);
    ...
    A380PrimComputerFe_Y.out.flight_envelope.computed_weight_lbs =
      A380PrimComputerFe_U.in.data.adcn_inputs.fms.fms_weight_lbs;
    A380PrimComputerFe_Y.out.flight_envelope.computed_cg_percent =
      A380PrimComputerFe_U.in.data.adcn_inputs.fms.fms_cg_percent;
    ...
    A380PrimComputerFe_Y.out.flight_envelope.v_4_kn = std::fmin(rtb_vs1g_o, A380PrimComputerFe_P.Vfe_25_Value);
    ...
    if (A380PrimComputerFe_U.in.general_logic.landing_gear_down) {
      rtb_conf = A380PrimComputerFe_P.Constant2_Value;
    } else {
      rtb_conf = A380PrimComputerFe_P.Constant3_Value;
    }

    A380PrimComputerFe_Y.out.flight_envelope.v_max_kn = std::fmin(std::fmin(std::fmin(rtb_conf, std::sqrt(std::pow((std::
      pow(rtb_uDLookupTable * rtb_uDLookupTable * 0.2 + 1.0, 3.5) - 1.0) * (std::fmax
    ...
    A380PrimComputerFe_Y.out.flight_envelope.gamma_t_deg = rtb_Switch;
