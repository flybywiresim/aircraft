...
class A380PitchAlternateLaw final
{
 public:
  struct rtDW_RateLimiter_A380PitchAlternateLaw_T {
    real_T pY;
    boolean_T pY_not_empty;
  };

  struct rtDW_LagFilter_A380PitchAlternateLaw_T {
    real_T pY;
    real_T pU;
    boolean_T pY_not_empty;
  ...
  struct rtDW_WashoutFilter_A380PitchAlternateLaw_T {
    real_T pY;
    real_T pU;
    boolean_T pY_not_empty;
    boolean_T pU_not_empty;
  ...
  struct D_Work_A380PitchAlternateLaw_T {
    ...
    rtDW_WashoutFilter_A380PitchAlternateLaw_T sf_WashoutFilter_c;
    rtDW_LagFilter_A380PitchAlternateLaw_T sf_LagFilter_g3;
    rtDW_WashoutFilter_A380PitchAlternateLaw_T sf_WashoutFilter_d;
    rtDW_LagFilter_A380PitchAlternateLaw_T sf_LagFilter_g;
  ...
  struct Parameters_A380PitchAlternateLaw_T {
  ...
  void init();
  A380PitchAlternateLaw(A380PitchAlternateLaw const&) = delete;
 ...
 private:
  ...
  static void A380PitchAlternateLaw_RateLimiter(real_T rtu_u, real_T rtu_up, real_T rtu_lo, const real_T *rtu_Ts, real_T
    rtu_init, real_T *rty_Y, rtDW_RateLimiter_A380PitchAlternateLaw_T *localDW);
  static void A380PitchAlternateLaw_LagFilter_Reset(rtDW_LagFilter_A380PitchAlternateLaw_T *localDW);
  static void A380PitchAlternateLaw_LagFilter(real_T rtu_U, real_T rtu_C1, const real_T *rtu_dt, real_T *rty_Y,
    rtDW_LagFilter_A380PitchAlternateLaw_T *localDW);
  static void A380PitchAlternateLaw_WashoutFilter_Reset(rtDW_WashoutFilter_A380PitchAlternateLaw_T *localDW);
  static void A380PitchAlternateLaw_WashoutFilter(real_T rtu_U, real_T rtu_C1, const real_T *rtu_dt, real_T *rty_Y,
    rtDW_WashoutFilter_A380PitchAlternateLaw_T *localDW);
};

extern A380PitchAlternateLaw::Parameters_A380PitchAlternateLaw_T A380PitchAlternateLaw_rtP;
