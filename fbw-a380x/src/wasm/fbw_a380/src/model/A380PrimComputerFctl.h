...
class A380PrimComputerFctl final
{
 public:
  ...
  struct rtDW_RateLimiter_A380PrimComputerFctl_j_T {
    real_T pY;
    boolean_T pY_not_empty;
  };
  ...
  struct D_Work_A380PrimComputerFctl_T {
    ...
    rtDW_RateLimiter_A380PrimComputerFctl_p_T sf_RateLimiter_bx;
    ...
    rtDW_RateLimiter_A380PrimComputerFctl_j_T sf_RateLimiter_d;
    rtDW_RateLimiter_A380PrimComputerFctl_j_T sf_RateLimiter_b;
 ...
 private:
  ...
  static void A380PrimComputerFctl_RateLimiter_l_Reset(rtDW_RateLimiter_A380PrimComputerFctl_j_T *localDW);
  static void A380PrimComputerFctl_RateLimiter_b(real_T rtu_u, real_T rtu_up, real_T rtu_lo, real_T rtu_Ts, real_T
    rtu_init, boolean_T rtu_reset, real_T *rty_Y, rtDW_RateLimiter_A380PrimComputerFctl_j_T *localDW);
  ...
  static void A380PrimComputerFctl_MATLABFunction_i(const boolean_T rtu_u[19], real32_T *rty_y);
  static void A380PrimComputerFctl_MATLABFunction_b(a380_pitch_efcs_law rtu_law, boolean_T *rty_bit1, boolean_T
