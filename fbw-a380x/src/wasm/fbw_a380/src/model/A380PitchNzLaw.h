#ifndef A380PitchNzLaw_h_
#define A380PitchNzLaw_h_
#include "rtwtypes.h"
#include "A380PitchNzLaw_types.h"
#include <cstring>

class A380PitchNzLaw final
{
 public:
  struct rtDW_RateLimiter_A380PitchNzLaw_T {
    real_T pY;
    boolean_T pY_not_empty;
  };

  struct rtDW_eta_trim_limit_lofreeze_A380PitchNzLaw_T {
    real_T frozen_eta_trim;
    boolean_T frozen_eta_trim_not_empty;
  };

  struct rtDW_RateLimiter_A380PitchNzLaw_k_T {
    real_T pY;
    boolean_T pY_not_empty;
  };

  struct rtDW_LagFilter_A380PitchNzLaw_T {
    real_T pY;
    real_T pU;
    boolean_T pY_not_empty;
  ...
  struct rtDW_WashoutFilter_A380PitchNzLaw_T {
    real_T pY;
    real_T pU;
    boolean_T pY_not_empty;
    boolean_T pU_not_empty;
  ...
  struct BlockIO_A380PitchNzLaw_T {
    real_T in_flight;
  };

  struct D_Work_A380PitchNzLaw_T {
    real_T Delay_DSTATE;
    ...
    uint8_T is_active_c7_A380PitchNzLaw;
    uint8_T is_c7_A380PitchNzLaw;
    uint8_T is_active_c3_A380PitchNzLaw;
    uint8_T is_c3_A380PitchNzLaw;
    uint8_T is_active_c9_A380PitchNzLaw;
    uint8_T is_c9_A380PitchNzLaw;
    boolean_T icLoad;
    boolean_T pY_not_empty;
    boolean_T pU_not_empty;
    rtDW_RateLimiter_A380PitchNzLaw_T sf_RateLimiter_b;
    rtDW_WashoutFilter_A380PitchNzLaw_T sf_WashoutFilter_h;
    rtDW_RateLimiter_A380PitchNzLaw_k_T sf_RateLimiter_nx;
    rtDW_RateLimiter_A380PitchNzLaw_k_T sf_RateLimiter_d;
    rtDW_RateLimiter_A380PitchNzLaw_k_T sf_RateLimiter_c2;
    rtDW_RateLimiter_A380PitchNzLaw_T sf_RateLimiter_o;
    rtDW_WashoutFilter_A380PitchNzLaw_T sf_WashoutFilter_c;
    rtDW_LagFilter_A380PitchNzLaw_T sf_LagFilter_g3;
    rtDW_WashoutFilter_A380PitchNzLaw_T sf_WashoutFilter_d;
    rtDW_LagFilter_A380PitchNzLaw_T sf_LagFilter_g;
    rtDW_WashoutFilter_A380PitchNzLaw_T sf_WashoutFilter_l;
    rtDW_LagFilter_A380PitchNzLaw_T sf_LagFilter_i;
    rtDW_WashoutFilter_A380PitchNzLaw_T sf_WashoutFilter_k;
    rtDW_LagFilter_A380PitchNzLaw_T sf_LagFilter_k;
    rtDW_WashoutFilter_A380PitchNzLaw_T sf_WashoutFilter;
    rtDW_LagFilter_A380PitchNzLaw_T sf_LagFilter;
    rtDW_RateLimiter_A380PitchNzLaw_k_T sf_RateLimiter_h;
    rtDW_eta_trim_limit_lofreeze_A380PitchNzLaw_T sf_eta_trim_limit_upfreeze;
    rtDW_eta_trim_limit_lofreeze_A380PitchNzLaw_T sf_eta_trim_limit_lofreeze;
    rtDW_RateLimiter_A380PitchNzLaw_T sf_RateLimiter_l;
    rtDW_RateLimiter_A380PitchNzLaw_T sf_RateLimiter_n;
    rtDW_RateLimiter_A380PitchNzLaw_T sf_RateLimiter_c;
    rtDW_RateLimiter_A380PitchNzLaw_T sf_RateLimiter;
  };

  struct Parameters_A380PitchNzLaw_T {
    ...
    real_T ScheduledGain_BreakpointsForDimension1_fn[4];
    ...
    real_T DiscreteDerivativeVariableTs1_Gain_g;
    real_T DiscreteDerivativeVariableTs_Gain_g;
    real_T DiscreteDerivativeVariableTs2_Gain_h;
    ...
    real_T RateLimiterVariableTs4_InitialCondition_i;
    real_T RateLimiterVariableTs6_InitialCondition;
    real_T DiscreteDerivativeVariableTs_InitialCondition_ax;
    ...
    real_T RateLimiterVariableTs4_lo_j;
    ...
    real_T RateLimiterVariableTs4_up_p;
    ...
    real_T PLUT_tableData_c[2];
    real_T PLUT_bp01Data_fy[2];
    real_T DLUT_tableData_l[2];
    real_T DLUT_bp01Data_c[2];
    real_T SaturationV_dot_UpperSat_c;
    real_T SaturationV_dot_LowerSat_b;
    real_T Gain_Gain_l;
    real_T SaturationSpoilers_UpperSat_f;
    real_T SaturationSpoilers_LowerSat_m;
    real_T Saturation_UpperSat_hx;
  ...
  void init();
  A380PitchNzLaw(A380PitchNzLaw const&) = delete;
  A380PitchNzLaw& operator= (A380PitchNzLaw const&) & = delete;
  A380PitchNzLaw(A380PitchNzLaw &&) = delete;
  A380PitchNzLaw& operator= (A380PitchNzLaw &&) = delete;
  void step(const real_T *rtu_In_time_dt, const real_T *rtu_In_time_simulation_time, const real_T *rtu_In_nz_g, const
            ...
            *rtu_In_H_radio_ft, const real_T *rtu_In_flaps_handle_index, const real_T *rtu_In_spoilers_left_pos, const
            real_T *rtu_In_spoilers_right_pos, const real_T *rtu_In_gnd_splr_cmd_deg, const real_T *rtu_In_VLS_kn, const
            real_T *rtu_In_delta_eta_pos, const boolean_T *rtu_In_on_ground, const boolean_T *rtu_In_tracking_mode_on,
            const boolean_T *rtu_In_high_aoa_prot_active, const boolean_T *rtu_In_high_speed_prot_active, const real_T
            ...
            *rtu_In_any_ap_engaged, const boolean_T *rtu_In_protections_available, const boolean_T
            *rtu_In_flare_override, real_T *rty_Out_eta_deg, real_T *rty_Out_eta_trim_dot_deg_s, real_T
            *rty_Out_eta_trim_limit_lo, real_T *rty_Out_eta_trim_limit_up);
  void reset();
  A380PitchNzLaw();
  ~A380PitchNzLaw();
 private:
  BlockIO_A380PitchNzLaw_T A380PitchNzLaw_B;
  D_Work_A380PitchNzLaw_T A380PitchNzLaw_DWork;
  static Parameters_A380PitchNzLaw_T A380PitchNzLaw_rtP;
  static void A380PitchNzLaw_RateLimiter_Reset(rtDW_RateLimiter_A380PitchNzLaw_T *localDW);
  static void A380PitchNzLaw_RateLimiter(real_T rtu_u, real_T rtu_up, real_T rtu_lo, const real_T *rtu_Ts, real_T
    rtu_init, real_T *rty_Y, rtDW_RateLimiter_A380PitchNzLaw_T *localDW);
  static void A380PitchNzLaw_eta_trim_limit_lofreeze_Reset(rtDW_eta_trim_limit_lofreeze_A380PitchNzLaw_T *localDW);
  static void A380PitchNzLaw_eta_trim_limit_lofreeze(const real_T *rtu_eta_trim, const boolean_T *rtu_trigger, real_T
    *rty_y, rtDW_eta_trim_limit_lofreeze_A380PitchNzLaw_T *localDW);
  static void A380PitchNzLaw_RateLimiter_l_Reset(rtDW_RateLimiter_A380PitchNzLaw_k_T *localDW);
  static void A380PitchNzLaw_RateLimiter_h(const real_T *rtu_u, real_T rtu_up, real_T rtu_lo, const real_T *rtu_Ts,
    real_T rtu_init, real_T *rty_Y, rtDW_RateLimiter_A380PitchNzLaw_k_T *localDW);
  static void A380PitchNzLaw_LagFilter_Reset(rtDW_LagFilter_A380PitchNzLaw_T *localDW);
  static void A380PitchNzLaw_LagFilter(real_T rtu_U, real_T rtu_C1, const real_T *rtu_dt, real_T *rty_Y,
    rtDW_LagFilter_A380PitchNzLaw_T *localDW);
  static void A380PitchNzLaw_WashoutFilter_Reset(rtDW_WashoutFilter_A380PitchNzLaw_T *localDW);
  static void A380PitchNzLaw_WashoutFilter(real_T rtu_U, real_T rtu_C1, const real_T *rtu_dt, real_T *rty_Y,
    rtDW_WashoutFilter_A380PitchNzLaw_T *localDW);
  static void A380PitchNzLaw_VoterAttitudeProtection(real_T rtu_input, real_T rtu_input_l, real_T rtu_input_o, real_T
    *rty_vote);
};

extern A380PitchNzLaw::Parameters_A380PitchNzLaw_T A380PitchNzLaw_rtP;
