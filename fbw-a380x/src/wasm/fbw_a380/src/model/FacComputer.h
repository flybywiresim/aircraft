...
class FacComputer final
{
 public:
  ...
  struct Parameters_FacComputer_T {
    ...
    real_T Gain2_Gain_d;
    real_T uDLookupTable1_tableData[80];
    real_T uDLookupTable1_bp01Data[8];
    real_T uDLookupTable1_bp02Data[10];
    real_T Gain3_Gain_h;
    ...
    real_T _Value;
    real_T Gain2_Gain_j;
    real_T uDLookupTable1_tableData_j[80];
    real_T uDLookupTable1_bp01Data_p[8];
    real_T uDLookupTable1_bp02Data_n[10];
    real_T Gain3_Gain_d;
    ...
    real_T Gain2_Gain_o;
    real_T uDLookupTable1_tableData_o[80];
    real_T uDLookupTable1_bp01Data_a[8];
    real_T uDLookupTable1_bp02Data_l[10];
    real_T Gain3_Gain_n;
    ...
    real_T Gain2_Gain_c;
    real_T uDLookupTable1_tableData_i[80];
    real_T uDLookupTable1_bp01Data_l[8];
    real_T uDLookupTable1_bp02Data_p[10];
