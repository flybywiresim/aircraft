...
void A380FcuComputer::step()
{
  ...
  int32_T tmp;
  real32_T rtb_MultiportSwitch_j0_fg_selected_fpa_deg_Data;
  real32_T rtb_MultiportSwitch_j0_fg_selected_spd_kts_Data;
  real32_T rtb_y;
  real32_T rtb_y_b;
  real32_T rtb_y_e3;
  real32_T rtb_y_h;
  uint32_T rtb_DataTypeConversion1_j;
  uint32_T rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM;
  ...
  boolean_T rtb_BusAssignment_ao_logic_afs_vs_fpa_dashes;
  ...
  boolean_T rtb_BusAssignment_p_logic_afs_trk_fpa_active;
  ...
  boolean_T rtb_DataTypeConversion_d3;
  boolean_T rtb_DataTypeConversion_h;
  boolean_T rtb_DataTypeConversion_o;
  boolean_T rtb_DataTypeConversion_p;
  ...
  if (A380FcuComputer_U.in.sim_data.computer_running) {
    if (!A380FcuComputer_DWork.Runtime_MODE) {
      ...
      A380FcuComputer_MATLABFunction_e_Reset(&A380FcuComputer_DWork.sf_MATLABFunction_l);
      ...
      A380FcuComputer_MATLABFunction_e_Reset(&A380FcuComputer_DWork.sf_MATLABFunction_fb);
      A380FcuComputer_MATLABFunction_e_Reset(&A380FcuComputer_DWork.sf_MATLABFunction_cq);
      ...
      A380FcuComputer_MATLABFunction_e_Reset(&A380FcuComputer_DWork.sf_MATLABFunction_dh);
    ...
    A380FcuComputer_MATLABFunction_e(A380FcuComputer_U.in.discrete_inputs.afs_inputs.alt_knob.pulled,
      ...
      A380FcuComputer_P.KnobMtrigProcessing2_triggerDuration, &A380FcuComputer_DWork.sf_MATLABFunction_fb);
    A380FcuComputer_MATLABFunction_e((A380FcuComputer_U.in.discrete_inputs.afs_inputs.alt_knob.turns !=
      A380FcuComputer_P.CompareToConstant_const_pg), A380FcuComputer_U.in.time.dt, &rtb_y_gd,
      A380FcuComputer_P.MTrigNode2_isRisingEdge_h, A380FcuComputer_P.MTrigNode2_retriggerable_h,
      A380FcuComputer_P.KnobMtrigProcessing2_triggerDuration, &A380FcuComputer_DWork.sf_MATLABFunction_cq);
    rtb_BusConversion_InsertedFor_BusAssignment_at_inport_3_BusCreator1_turns = static_cast<int8_T>(rtb_y_gd);
    ...
    A380FcuComputer_MATLABFunction_e((A380FcuComputer_U.in.discrete_inputs.afs_inputs.vs_fpa_knob.turns !=
      A380FcuComputer_P.CompareToConstant_const_e), A380FcuComputer_U.in.time.dt, &rtb_y_gd,
    ...
    rtb_DataTypeConversion_j = static_cast<int8_T>(rtb_y_gd);
    ...
    A380FcuComputer_MATLABFunction_e(A380FcuComputer_U.in.discrete_inputs.afs_inputs.loc_button_pressed,
      A380FcuComputer_U.in.time.dt, &rtb_y_gd, A380FcuComputer_P.MTrigNode_isRisingEdge_c,
      A380FcuComputer_P.MTrigNode_retriggerable_i, A380FcuComputer_P.MTrigNode_triggerDuration_o,
      &A380FcuComputer_DWork.sf_MATLABFunction_dh);
    A380FcuComputer_MATLABFunction_e(A380FcuComputer_U.in.discrete_inputs.afs_inputs.alt_button_pressed,
      A380FcuComputer_U.in.time.dt, &rtb_y_pp, A380FcuComputer_P.MTrigNode1_isRisingEdge_a,
    ...
    A380FcuComputer_MATLABFunction_e(A380FcuComputer_U.in.discrete_inputs.afs_inputs.appr_button_pressed,
      A380FcuComputer_U.in.time.dt, &rtb_y_f, A380FcuComputer_P.MTrigNode2_isRisingEdge_p,
      A380FcuComputer_P.MTrigNode2_retriggerable_c, A380FcuComputer_P.MTrigNode2_triggerDuration,
      &A380FcuComputer_DWork.sf_MATLABFunction_k0);
    ...
    switch (rtb_masterPrim) {
     case 1:
      rtb_MultiportSwitch_fg_discrete_word_5 = &A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.discrete_word_5;
      break;

     case 2:
      rtb_MultiportSwitch_fg_discrete_word_5 = &A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.discrete_word_5;
      break;

     default:
      rtb_MultiportSwitch_fg_discrete_word_5 = &A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.discrete_word_5;
      break;
    }

    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_fg_discrete_word_5, A380FcuComputer_P.BitfromLabel_bit_n,
      &rtb_DataTypeConversion1_j);
    rtb_BusAssignment_p_logic_afs_trk_fpa_active = (rtb_DataTypeConversion1_j != 0U);
    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_fg_discrete_word_5, A380FcuComputer_P.BitfromLabel1_bit_m,
      &rtb_DataTypeConversion1_j);
    rtb_BusAssignment_p_logic_afs_metric_alt_active = (rtb_DataTypeConversion1_j != 0U);
    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_fg_discrete_word_5, A380FcuComputer_P.BitfromLabel2_bit,
      &rtb_DataTypeConversion1_j);
    rtb_BusAssignment_p_logic_afs_mach_active = (rtb_DataTypeConversion1_j != 0U);
    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_fg_discrete_word_5, A380FcuComputer_P.BitfromLabel3_bit,
      &rtb_DataTypeConversion1_j);
    rtb_BusAssignment_p_logic_afs_true_active = (rtb_DataTypeConversion1_j != 0U);
    switch (rtb_masterPrim) {
     case 1:
    ...
    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_fg_discrete_word_5, A380FcuComputer_P.BitfromLabel7_bit,
      &rtb_DataTypeConversion1_j);
    rtb_Equal1 = (rtb_DataTypeConversion1_j != 0U);
    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_fg_discrete_word_5, A380FcuComputer_P.BitfromLabel8_bit,
      &rtb_DataTypeConversion1_j);
    rtb_Equal8 = (rtb_DataTypeConversion1_j != 0U);
    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_f_fg_discrete_word_2, A380FcuComputer_P.BitfromLabel9_bit,
      &rtb_DataTypeConversion1_j);
    rtb_OR3 = (rtb_Equal1 || rtb_Equal8 || (rtb_DataTypeConversion1_j != 0U));
    ...
    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_f_fg_discrete_word_1, A380FcuComputer_P.BitfromLabel11_bit,
      &rtb_DataTypeConversion1_j);
    rtb_Equal7 = (rtb_Equal7 || (rtb_DataTypeConversion1_j != 0U));
    rtb_Equal8 = (rtb_OR3 && (!rtb_Equal7));
    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_f_fg_discrete_word_2, A380FcuComputer_P.BitfromLabel6_bit,
      &rtb_DataTypeConversion1_j);
    rtb_Equal1 = (rtb_DataTypeConversion1_j != 0U);
    A380FcuComputer_MATLABFunction_o(rtb_MultiportSwitch_f_fg_discrete_word_3, A380FcuComputer_P.BitfromLabel10_bit,
      &rtb_DataTypeConversion1_j);
    rtb_OR3 = (rtb_Equal7 || rtb_Equal1 || (rtb_DataTypeConversion1_j != 0U));
    switch (rtb_masterPrim) {
     case 1:
      rtb_DataTypeConversion1_j = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_spd_kts.SSM;
      rtb_MultiportSwitch_j0_fg_selected_spd_kts_Data =
        A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_spd_kts.Data;
      rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM =
        A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_mach_kts.SSM;
      rtb_y_h = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_mach_kts.Data;
      break;

     case 2:
      rtb_DataTypeConversion1_j = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_spd_kts.SSM;
      rtb_MultiportSwitch_j0_fg_selected_spd_kts_Data =
        A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_spd_kts.Data;
      rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM =
        A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_mach_kts.SSM;
      rtb_y_h = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_mach_kts.Data;
      break;

     default:
      rtb_DataTypeConversion1_j = A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.selected_spd_kts.SSM;
      rtb_MultiportSwitch_j0_fg_selected_spd_kts_Data =
        A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.selected_spd_kts.Data;
      rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM =
        A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.selected_mach_kts.SSM;
      rtb_y_h = A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.selected_mach_kts.Data;
      break;
    }

    if (rtb_BusAssignment_p_logic_afs_mach_active) {
      rtb_Switch.SSM = rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM;
      rtb_Switch.Data = rtb_y_h;
    } else {
      rtb_Switch.SSM = rtb_DataTypeConversion1_j;
      rtb_Switch.Data = rtb_MultiportSwitch_j0_fg_selected_spd_kts_Data;
    }

    A380FcuComputer_MATLABFunction(&rtb_Switch, A380FcuComputer_P.A429ValueOrDefault_defaultValue,
      &rtb_MultiportSwitch_j0_fg_selected_spd_kts_Data);
    A380FcuComputer_MATLABFunction_m(&rtb_Switch, &rtb_Compare_j);
    rtb_BusAssignment_ak_logic_afs_spd_mach_dashes = !rtb_Compare_j;
    switch (rtb_masterPrim) {
     case 1:
      rtb_DataTypeConversion1_j = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_hdg_deg.SSM;
      rtb_y_h = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_hdg_deg.Data;
      rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM =
        A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_trk_deg.SSM;
      rtb_y_b = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_trk_deg.Data;
      break;

     case 2:
      rtb_DataTypeConversion1_j = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_hdg_deg.SSM;
      rtb_y_h = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_hdg_deg.Data;
      rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM =
        A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_trk_deg.SSM;
      rtb_y_b = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_trk_deg.Data;
      break;

     default:
      rtb_DataTypeConversion1_j = A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.selected_hdg_deg.SSM;
      rtb_y_h = A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.selected_hdg_deg.Data;
      rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM =
        A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.selected_trk_deg.SSM;
      rtb_y_b = A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.selected_trk_deg.Data;
      break;
    }

    if (rtb_BusAssignment_p_logic_afs_trk_fpa_active) {
      rtb_Switch_j.SSM = rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM;
      rtb_Switch_j.Data = rtb_y_b;
    } else {
      rtb_Switch_j.SSM = rtb_DataTypeConversion1_j;
      rtb_Switch_j.Data = rtb_y_h;
    }

    A380FcuComputer_MATLABFunction(&rtb_Switch_j, A380FcuComputer_P.A429ValueOrDefault_defaultValue_j, &rtb_y_h);
    A380FcuComputer_MATLABFunction_m(&rtb_Switch_j, &rtb_Compare_j);
    rtb_BusAssignment_af_logic_afs_hdg_trk_dashes = !rtb_Compare_j;
    switch (rtb_masterPrim) {
     case 1:
      rtb_Switch = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_alt_ft;
      break;

     case 2:
      rtb_Switch = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_alt_ft;
      break;

     default:
      rtb_Switch = A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.selected_alt_ft;
      break;
    }

    A380FcuComputer_MATLABFunction(&rtb_Switch, A380FcuComputer_P.A429ValueOrDefault_defaultValue_b, &rtb_y_b);
    switch (rtb_masterPrim) {
     case 1:
      rtb_DataTypeConversion1_j = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_vs_ft_min.SSM;
      rtb_y_e3 = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_vs_ft_min.Data;
      rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM =
        A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_fpa_deg.SSM;
      rtb_MultiportSwitch_j0_fg_selected_fpa_deg_Data =
        A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.selected_fpa_deg.Data;
      break;

     case 2:
      rtb_DataTypeConversion1_j = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_vs_ft_min.SSM;
      rtb_y_e3 = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_vs_ft_min.Data;
      rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM =
        A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_fpa_deg.SSM;
      rtb_MultiportSwitch_j0_fg_selected_fpa_deg_Data =
        A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.selected_fpa_deg.Data;
      break;
    ...
    if (rtb_BusAssignment_p_logic_afs_trk_fpa_active) {
      rtb_Switch_m.SSM = rtb_MultiportSwitch_j0_fg_selected_mach_kts_SSM;
      rtb_Switch_m.Data = rtb_MultiportSwitch_j0_fg_selected_fpa_deg_Data;
    } else {
      rtb_Switch_m.SSM = rtb_DataTypeConversion1_j;
      rtb_Switch_m.Data = rtb_y_e3;
    }

    A380FcuComputer_MATLABFunction_m(&rtb_Switch_m, &rtb_Compare_j);
    rtb_BusAssignment_ao_logic_afs_vs_fpa_dashes = !rtb_Compare_j;
    A380FcuComputer_MATLABFunction(&rtb_Switch_m, A380FcuComputer_P.A429ValueOrDefault_defaultValue_e, &rtb_y_e3);
    if (!A380FcuComputer_U.in.discrete_inputs.efis_backup_activated) {
      ...
      switch (rtb_masterPrim) {
       case 1:
        rtb_Switch_m = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.discrete_word_5;
        rtb_Switch = A380FcuComputer_U.in.bus_inputs.prim_1_bus.fg.discrete_word_2;
        break;

       case 2:
        rtb_Switch_m = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.discrete_word_5;
        rtb_Switch = A380FcuComputer_U.in.bus_inputs.prim_2_bus.fg.discrete_word_2;
        break;

       default:
        rtb_Switch_m = A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.discrete_word_5;
        rtb_Switch = A380FcuComputer_U.in.bus_inputs.prim_3_bus.fg.discrete_word_2;
        break;
      }

      A380FcuComputer_MATLABFunction_o(&rtb_Switch_m, A380FcuComputer_P.BitfromLabel_bit, &rtb_DataTypeConversion1_j);
      rtb_DataTypeConversion_h = (rtb_DataTypeConversion1_j != 0U);
      A380FcuComputer_MATLABFunction_n((rtb_DataTypeConversion1_j != 0U), A380FcuComputer_P.PulseNode1_isRisingEdge,
        &rtb_Equal7, &A380FcuComputer_DWork.sf_MATLABFunction_kq);
      A380FcuComputer_MATLABFunction_o(&rtb_Switch, A380FcuComputer_P.BitfromLabel1_bit, &rtb_DataTypeConversion1_j);
      A380FcuComputer_MATLABFunction_n((rtb_DataTypeConversion1_j != 0U), A380FcuComputer_P.PulseNode2_isRisingEdge,
        &rtb_Compare_j, &A380FcuComputer_DWork.sf_MATLABFunction_mt1);
      ...
      A380FcuComputer_Y.out.logic.efis.baro_preset_active = (rtb_Compare_j && A380FcuComputer_DWork.std_active);
      ...
      rtb_Equal7 = (rtb_BusAssignment_pg_efis_mode == A380FcuComputer_P.EnumeratedConstant_Value);
      ...
      if (rtb_Equal7 && (!A380FcuComputer_DWork.pArcActive) && (A380FcuComputer_DWork.pRange > 4)) {
        A380FcuComputer_DWork.pRange = static_cast<int8_T>(A380FcuComputer_DWork.pRange - 1);
      } else if ((!rtb_Equal7) && A380FcuComputer_DWork.pArcActive && (A380FcuComputer_DWork.pRange < 10)) {
        A380FcuComputer_DWork.pRange = static_cast<int8_T>(A380FcuComputer_DWork.pRange + 1);
      }
      ...
      A380FcuComputer_Y.out.logic.afs.master_prim = rtb_masterPrim;
      A380FcuComputer_Y.out.logic.afs.ap_1_engaged = rtb_DataTypeConversion_p;
      A380FcuComputer_Y.out.logic.afs.ap_2_engaged = rtb_DataTypeConversion_o;
      A380FcuComputer_Y.out.logic.afs.athr_engaged = rtb_DataTypeConversion_d3;
      A380FcuComputer_Y.out.logic.afs.fd_engaged = rtb_OR;
      A380FcuComputer_Y.out.logic.afs.mach_active = rtb_BusAssignment_p_logic_afs_mach_active;
      A380FcuComputer_Y.out.logic.afs.trk_fpa_active = rtb_BusAssignment_p_logic_afs_trk_fpa_active;
      A380FcuComputer_Y.out.logic.afs.true_active = rtb_BusAssignment_p_logic_afs_true_active;
      A380FcuComputer_Y.out.logic.afs.metric_alt_active = rtb_BusAssignment_p_logic_afs_metric_alt_active;
      A380FcuComputer_Y.out.logic.afs.spd_mach_display_value = rtb_MultiportSwitch_j0_fg_selected_spd_kts_Data;
      A380FcuComputer_Y.out.logic.afs.spd_mach_dashes = rtb_BusAssignment_ak_logic_afs_spd_mach_dashes;
      A380FcuComputer_Y.out.logic.afs.hdg_trk_display_value = rtb_y_h;
      A380FcuComputer_Y.out.logic.afs.hdg_trk_dashes = rtb_BusAssignment_af_logic_afs_hdg_trk_dashes;
      A380FcuComputer_Y.out.logic.afs.alt_display_value = rtb_y_b;
      A380FcuComputer_Y.out.logic.afs.vs_fpa_display_value = rtb_y_e3;
      A380FcuComputer_Y.out.logic.afs.vs_fpa_dashes = rtb_BusAssignment_ao_logic_afs_vs_fpa_dashes;
      ...
      A380FcuComputer_Y.out.logic.afs.alt_buttons.turns =
      ...
      A380FcuComputer_Y.out.logic.afs.vs_fpa_buttons.turns = rtb_DataTypeConversion_j;
      A380FcuComputer_Y.out.logic.afs.fd_pushed = rtb_BusAssignment_p_logic_afs_fd_pushed;
      A380FcuComputer_Y.out.logic.afs.loc_pushed = rtb_y_gd;
      A380FcuComputer_Y.out.logic.afs.alt_pushed = rtb_y_pp;
      A380FcuComputer_Y.out.logic.afs.appr_pushed = rtb_y_f;
      A380FcuComputer_Y.out.logic.afs.spd_mach_switching_pushed =
        rtb_BusAssignment_p_logic_afs_spd_mach_switching_pushed;
      A380FcuComputer_Y.out.logic.afs.trk_fpa_switching_pushed = rtb_BusAssignment_p_logic_afs_trk_fpa_switching_pushed;
      A380FcuComputer_Y.out.logic.afs.true_mag_switching_pushed =
        rtb_BusAssignment_p_logic_afs_true_mag_switching_pushed;
      A380FcuComputer_Y.out.logic.afs.metric_alt_switching_pushed =
      ...
      A380FcuComputer_Y.out.logic.efis.vv_auto_activate = rtb_DataTypeConversion_h;
      ...
      A380FcuComputer_Y.out.logic.efis.baro_qnh = (A380FcuComputer_DWork.qnh_active &&
        (!A380FcuComputer_DWork.std_active));
      A380FcuComputer_Y.out.logic.efis.baro_qfe = (A380FcuComputer_DWork.qfe_active &&
        (!A380FcuComputer_DWork.std_active));
    ...
    if (A380FcuComputer_B.BusAssignment.logic.efis.efis_cp_panel_activate) {
      rtb_DataTypeConversion1_j = static_cast<uint32_T>(A380FcuComputer_B.BusAssignment.logic.efis.efis_range) - 2U;
    ...
    rtb_VectorConcatenate[0] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_mode ==
      A380FcuComputer_P.EnumeratedConstant20_Value);
    rtb_VectorConcatenate[1] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_mode ==
      A380FcuComputer_P.EnumeratedConstant19_Value);
    rtb_VectorConcatenate[2] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_mode ==
      A380FcuComputer_P.EnumeratedConstant18_Value);
    rtb_VectorConcatenate[3] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_mode ==
      A380FcuComputer_P.EnumeratedConstant17_Value);
    rtb_VectorConcatenate[4] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_mode ==
    ...
    rtb_VectorConcatenate[15] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_range ==
      A380FcuComputer_P.EnumeratedConstant4_Value);
    rtb_VectorConcatenate[16] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_range ==
      A380FcuComputer_P.EnumeratedConstant3_Value);
    rtb_VectorConcatenate[17] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_range ==
      A380FcuComputer_P.EnumeratedConstant2_Value_k);
    rtb_VectorConcatenate[18] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_range ==
      A380FcuComputer_P.EnumeratedConstant1_Value_a);
    A380FcuComputer_MATLABFunction_a(rtb_VectorConcatenate, &rtb_y_h);
    rtb_VectorConcatenate[0] = A380FcuComputer_B.BusAssignment.logic.efis.baro_std;
    rtb_VectorConcatenate[1] = A380FcuComputer_B.BusAssignment.logic.efis.baro_qnh;
    rtb_VectorConcatenate[2] = A380FcuComputer_B.BusAssignment.data.discrete_inputs.efis_inputs.baro_is_inhg;
    rtb_VectorConcatenate[3] = A380FcuComputer_B.BusAssignment.logic.efis.ls_on;
    rtb_VectorConcatenate[4] = A380FcuComputer_B.BusAssignment.logic.efis.vv_on;
    rtb_VectorConcatenate[5] = A380FcuComputer_B.BusAssignment.logic.efis.taxi_on;
    rtb_VectorConcatenate[6] = A380FcuComputer_B.BusAssignment.logic.efis.cstr_on;
    rtb_VectorConcatenate[7] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_filter ==
      A380FcuComputer_P.EnumeratedConstant6_Value_k);
    rtb_VectorConcatenate[8] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_filter ==
      A380FcuComputer_P.EnumeratedConstant8_Value);
    rtb_VectorConcatenate[9] = (A380FcuComputer_B.BusAssignment.logic.efis.efis_filter ==
      A380FcuComputer_P.EnumeratedConstant9_Value);
    rtb_VectorConcatenate[10] = A380FcuComputer_B.BusAssignment.logic.efis.arpt_on;
    rtb_VectorConcatenate[11] = A380FcuComputer_P.Constant_Value_i;
    rtb_VectorConcatenate[12] = (A380FcuComputer_B.BusAssignment.logic.efis.surv_filter ==
      A380FcuComputer_P.EnumeratedConstant2_Value_i);
    rtb_VectorConcatenate[13] = (A380FcuComputer_B.BusAssignment.logic.efis.surv_filter ==
      A380FcuComputer_P.EnumeratedConstant1_Value_j);
    rtb_VectorConcatenate[14] = A380FcuComputer_B.BusAssignment.logic.efis.traf_on;
    rtb_VectorConcatenate[15] = (A380FcuComputer_B.BusAssignment.logic.efis.navaid_1 ==
      A380FcuComputer_P.EnumeratedConstant12_Value);
    rtb_VectorConcatenate[16] = (A380FcuComputer_P.EnumeratedConstant12_Value ==
      A380FcuComputer_B.BusAssignment.logic.efis.navaid_2);
    rtb_VectorConcatenate[17] = (A380FcuComputer_B.BusAssignment.logic.efis.navaid_1 ==
      A380FcuComputer_P.EnumeratedConstant11_Value);
    rtb_VectorConcatenate[18] = (A380FcuComputer_P.EnumeratedConstant11_Value ==
      A380FcuComputer_B.BusAssignment.logic.efis.navaid_2);
    A380FcuComputer_MATLABFunction_a(rtb_VectorConcatenate, &rtb_y_b);
    rtb_VectorConcatenate[0] = A380FcuComputer_B.BusAssignment.logic.afs.spd_mach_buttons.pushed;
    rtb_VectorConcatenate[1] = A380FcuComputer_B.BusAssignment.logic.afs.spd_mach_buttons.pulled;
    rtb_VectorConcatenate[2] = A380FcuComputer_B.BusAssignment.logic.afs.hdg_trk_buttons.pushed;
    rtb_VectorConcatenate[3] = A380FcuComputer_B.BusAssignment.logic.afs.hdg_trk_buttons.pulled;
    rtb_VectorConcatenate[4] = A380FcuComputer_B.BusAssignment.logic.afs.alt_buttons.pushed;
    rtb_VectorConcatenate[5] = A380FcuComputer_B.BusAssignment.logic.afs.alt_buttons.pulled;
    rtb_VectorConcatenate[6] = A380FcuComputer_B.BusAssignment.logic.afs.vs_fpa_buttons.pushed;
    rtb_VectorConcatenate[7] = A380FcuComputer_B.BusAssignment.logic.afs.vs_fpa_buttons.pulled;
    rtb_VectorConcatenate[8] = A380FcuComputer_B.BusAssignment.logic.afs.spd_mach_switching_pushed;
    rtb_VectorConcatenate[9] = A380FcuComputer_B.BusAssignment.logic.afs.true_mag_switching_pushed;
    rtb_VectorConcatenate[10] = A380FcuComputer_B.BusAssignment.logic.afs.trk_fpa_switching_pushed;
    rtb_VectorConcatenate[11] = A380FcuComputer_B.BusAssignment.logic.afs.metric_alt_switching_pushed;
    rtb_VectorConcatenate[12] = A380FcuComputer_B.BusAssignment.logic.afs.fd_pushed;
    rtb_VectorConcatenate[13] = A380FcuComputer_B.BusAssignment.logic.afs.loc_pushed;
    rtb_VectorConcatenate[14] = A380FcuComputer_B.BusAssignment.logic.afs.alt_pushed;
    rtb_VectorConcatenate[15] = A380FcuComputer_B.BusAssignment.logic.afs.appr_pushed;
    rtb_VectorConcatenate[16] = A380FcuComputer_B.BusAssignment.data.discrete_inputs.afs_inputs.alt_increment_1000;
    rtb_VectorConcatenate[17] = A380FcuComputer_P.Constant20_Value;
    rtb_VectorConcatenate[18] = A380FcuComputer_P.Constant20_Value;
    A380FcuComputer_MATLABFunction_a(rtb_VectorConcatenate, &rtb_y_e3);
    ...
    if (A380FcuComputer_B.BusAssignment.data.discrete_inputs.afs_inputs.alt_knob.turns < -8) {
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_3_BusCreator1_turns = -8;
    } else {
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_3_BusCreator1_turns =
        A380FcuComputer_B.BusAssignment.data.discrete_inputs.afs_inputs.alt_knob.turns;
    }

    if (A380FcuComputer_B.BusAssignment.data.discrete_inputs.afs_inputs.vs_fpa_knob.turns < -8) {
      rtb_DataTypeConversion_j = -8;
    } else {
    ...
    if (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_3_BusCreator1_turns > 7) {
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_3_BusCreator1_turns = 7;
    }

    if (rtb_DataTypeConversion_j > 7) {
      rtb_DataTypeConversion_j = 7;
    }

    rtb_DataTypeConversion1_j = (static_cast<uint32_T>
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_g_turns) & 15U) << 10 | (static_cast<uint32_T>
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_2_BusCreator1_k_turns) & 15U) << 14 | (static_cast<uint32_T>
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_3_BusCreator1_turns) & 15U) << 18 | (static_cast<uint32_T>
      (rtb_DataTypeConversion_j) & 15U) << 22;
    std::memcpy((void *)&rtb_y, (void *)&rtb_DataTypeConversion1_j, (uint32_T)((size_t)1 * sizeof(real32_T)));
    A380FcuComputer_Y.out = A380FcuComputer_B.BusAssignment;
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.vv_light_on = A380FcuComputer_B.BusAssignment.logic.efis.vv_on;
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.ls_light_on = A380FcuComputer_B.BusAssignment.logic.efis.ls_on;
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.taxi_light_on =
      A380FcuComputer_B.BusAssignment.logic.efis.taxi_on;
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.cstr_light_on =
      A380FcuComputer_B.BusAssignment.logic.efis.cstr_on;
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.wpt_light_on =
      (A380FcuComputer_B.BusAssignment.logic.efis.efis_filter == A380FcuComputer_P.EnumeratedConstant6_Value);
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.vord_light_on =
      (A380FcuComputer_B.BusAssignment.logic.efis.efis_filter == A380FcuComputer_P.EnumeratedConstant1_Value_o);
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.ndb_light_on =
      (A380FcuComputer_B.BusAssignment.logic.efis.efis_filter == A380FcuComputer_P.EnumeratedConstant2_Value);
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.arpt_light_on =
      A380FcuComputer_B.BusAssignment.logic.efis.arpt_on;
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.traf_light_on =
      A380FcuComputer_B.BusAssignment.logic.efis.traf_on;
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.wxr_light_on =
      (A380FcuComputer_B.BusAssignment.logic.efis.surv_filter == A380FcuComputer_P.EnumeratedConstant3_Value_b);
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.terr_light_on =
      (A380FcuComputer_B.BusAssignment.logic.efis.surv_filter == A380FcuComputer_P.EnumeratedConstant4_Value_f);
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.navaid_1_mode =
      A380FcuComputer_B.BusAssignment.logic.efis.navaid_1;
    ...
    if (A380FcuComputer_B.BusAssignment.logic.efis.efis_cp_panel_activate) {
      A380FcuComputer_Y.out.discrete_outputs.efis_outputs.efis_mode = static_cast<a380_efis_panel_mode_selection>(
        static_cast<uint8_T>(static_cast<int32_T>(A380FcuComputer_B.BusAssignment.logic.efis.efis_mode) + 1));
    } else {
    ...
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.baro_is_inhg =
      A380FcuComputer_B.BusAssignment.data.discrete_inputs.efis_inputs.baro_is_inhg;
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.baro_is_std =
      A380FcuComputer_B.BusAssignment.logic.efis.baro_std;
    if (!A380FcuComputer_B.BusAssignment.data.discrete_inputs.efis_inputs.baro_is_inhg) {
      A380FcuComputer_Y.out.discrete_outputs.efis_outputs.baro_value =
        A380FcuComputer_B.BusAssignment.logic.efis.baro_value_hpa;
    } else {
      A380FcuComputer_Y.out.discrete_outputs.efis_outputs.baro_value =
        A380FcuComputer_B.BusAssignment.logic.efis.baro_value_inhg;
    }

    if (A380FcuComputer_B.BusAssignment.logic.efis.baro_std) {
      A380FcuComputer_Y.out.discrete_outputs.efis_outputs.baro_mode = 0;
    } else if (A380FcuComputer_B.BusAssignment.logic.efis.baro_qnh) {
    ...
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.baro_preset_visible =
      A380FcuComputer_B.BusAssignment.logic.efis.baro_preset_active;
    A380FcuComputer_Y.out.discrete_outputs.efis_outputs.efis_cp_active =
      A380FcuComputer_B.BusAssignment.logic.efis.efis_cp_panel_activate;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.loc_light_on =
      A380FcuComputer_B.BusAssignment.logic.afs.loc_only_active;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.alt_light_on =
      A380FcuComputer_B.BusAssignment.logic.afs.alt_active;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.appr_light_on =
      A380FcuComputer_B.BusAssignment.logic.afs.appr_active;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.ap_1_light_on =
      A380FcuComputer_B.BusAssignment.logic.afs.ap_1_engaged;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.ap_2_light_on =
      A380FcuComputer_B.BusAssignment.logic.afs.ap_2_engaged;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.athr_light_on =
      A380FcuComputer_B.BusAssignment.logic.afs.athr_engaged;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.fd_light_on =
      A380FcuComputer_B.BusAssignment.logic.afs.fd_engaged;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.trk_fpa_mode =
      A380FcuComputer_B.BusAssignment.logic.afs.trk_fpa_active;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.true_mode = A380FcuComputer_B.BusAssignment.logic.afs.true_active;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.mach_mode = A380FcuComputer_B.BusAssignment.logic.afs.mach_active;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.spd_mach_value =
      A380FcuComputer_B.BusAssignment.logic.afs.spd_mach_display_value;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.spd_mach_dashes =
      A380FcuComputer_B.BusAssignment.logic.afs.spd_mach_dashes;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.hdg_trk_value =
      A380FcuComputer_B.BusAssignment.logic.afs.hdg_trk_display_value;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.hdg_trk_dashes =
      A380FcuComputer_B.BusAssignment.logic.afs.hdg_trk_dashes;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.alt_value =
      A380FcuComputer_B.BusAssignment.logic.afs.alt_display_value;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.vs_fpa_value =
      A380FcuComputer_B.BusAssignment.logic.afs.vs_fpa_display_value;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.vs_fpa_dashes =
      A380FcuComputer_B.BusAssignment.logic.afs.vs_fpa_dashes;
    A380FcuComputer_Y.out.discrete_outputs.afs_outputs.afs_cp_active =
      (A380FcuComputer_B.BusAssignment.logic.afs.master_prim != A380FcuComputer_P.CompareToConstant_const_g);
    A380FcuComputer_Y.out.discrete_outputs.true_selected = A380FcuComputer_B.BusAssignment.logic.afs.true_active;
    ...
    A380FcuComputer_Y.out.bus_outputs.efis_discrete_word_1.Data = rtb_y_h;
    A380FcuComputer_Y.out.bus_outputs.efis_discrete_word_2.SSM = static_cast<uint32_T>
      (A380FcuComputer_P.EnumeratedConstant1_Value);
    A380FcuComputer_Y.out.bus_outputs.efis_discrete_word_2.Data = rtb_y_b;
    A380FcuComputer_Y.out.bus_outputs.baro_setting_hpa.SSM = static_cast<uint32_T>
      (A380FcuComputer_P.EnumeratedConstant1_Value);
    A380FcuComputer_Y.out.bus_outputs.baro_setting_hpa.Data = A380FcuComputer_B.BusAssignment.logic.efis.baro_value_hpa;
    ...
    A380FcuComputer_Y.out.bus_outputs.afs_discrete_word_1.SSM = static_cast<uint32_T>
      (A380FcuComputer_P.EnumeratedConstant1_Value);
    A380FcuComputer_Y.out.bus_outputs.afs_discrete_word_1.Data = rtb_y_e3;
    A380FcuComputer_Y.out.bus_outputs.afs_discrete_word_2.SSM = static_cast<uint32_T>
      (A380FcuComputer_P.EnumeratedConstant1_Value);
    A380FcuComputer_Y.out.bus_outputs.afs_discrete_word_2.Data = rtb_y;
...
{
  {
    A380FcuComputer_B.BusAssignment = A380FcuComputer_rtZfcu_outputs;
  }
