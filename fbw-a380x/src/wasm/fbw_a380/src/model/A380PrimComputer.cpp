...
#include "combineVectorElements_iJqADVYL.h"
...
void A380PrimComputer::A380PrimComputer_OtherRAselection(const prim_outputs *rtu_in, base_arinc_429 *rty_ra3Word)
{
  base_arinc_429 ra3Word1;
  if (rtu_in->data.discrete_inputs.is_unit_1) {
    ra3Word1 = rtu_in->data.bus_inputs.prim_x_bus.radio_height_1_ft;
    *rty_ra3Word = rtu_in->data.bus_inputs.prim_y_bus.radio_height_2_ft;
  } else if (rtu_in->data.discrete_inputs.is_unit_2) {
    ra3Word1 = rtu_in->data.bus_inputs.prim_x_bus.radio_height_1_ft;
    *rty_ra3Word = rtu_in->data.bus_inputs.prim_y_bus.radio_height_1_ft;
  } else {
    ra3Word1 = rtu_in->data.bus_inputs.prim_x_bus.radio_height_2_ft;
    *rty_ra3Word = rtu_in->data.bus_inputs.prim_y_bus.radio_height_2_ft;
  }

  if (ra3Word1.SSM != static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) {
    *rty_ra3Word = ra3Word1;
  }
}
...
boolean_T A380PrimComputer::A380PrimComputer_a429_bitValueOr(uint32_T word_SSM, real32_T word_Data)
{
  uint64m_T tmp;
  uint64m_T tmp_0;
  static const uint64m_T tmp_1{ { 134217728U, 0U }
  };
...
boolean_T A380PrimComputer::A380PrimComputer_a429_bitValueOr_h(uint32_T word_SSM, real32_T word_Data)
{
  uint64m_T tmp;
  uint64m_T tmp_0;
...
void A380PrimComputer::step()
{
  ...
  uint64m_T tmp_3;
  uint64m_T tmp_4;
  real_T rtb_BusAssignment_d_logic_alpha_prot_deg;
  real_T rtb_Gain_bk;
  real_T rtb_Gain_g;
  real_T rtb_Gain_p;
  ...
  boolean_T rtb_BusAssignment_logic_flaps_locked;
  boolean_T rtb_BusAssignment_logic_slats_locked;
  ...
  boolean_T rtb_OR_n;
  boolean_T rtb_OR_ou;
  boolean_T rtb_TmpSignalConversionAtSFunctionInport6_idx_2;
  ...
  static const uint64m_T tmp_5{ { 0U, 0U }
  };

  static const uint64m_T tmp_6{ { 4U, 0U }
  };
  ...
  if (A380PrimComputer_U.in.sim_data.computer_running) {
    ...
    rtb_OR_lu = rtb_y_i;
    rtb_BusAssignment_logic_slats_locked = (rtb_y_m != 0U);
    rtb_BusAssignment_logic_flaps_locked = (rtb_y_e != 0U);
    rtb_OR_ll = ((A380PrimComputer_U.in.bus_inputs.adr_1_bus.mach.SSM == static_cast<uint32_T>(SignStatusMatrix::
    ...
    rtb_Equal = ((A380PrimComputer_U.in.bus_inputs.adr_2_bus.mach.SSM == static_cast<uint32_T>(SignStatusMatrix::
      ...
      static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
                 (A380PrimComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM == static_cast<uint32_T>
                  (SignStatusMatrix::FailureWarning)) || A380PrimComputer_P.Constant1_Value_b ||
                 A380PrimComputer_P.Constant1_Value_b);
    rtb_OR_n = ((A380PrimComputer_U.in.bus_inputs.adr_3_bus.mach.SSM == static_cast<uint32_T>(SignStatusMatrix::
      ...
      static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
                (A380PrimComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.SSM == static_cast<uint32_T>
                 (SignStatusMatrix::FailureWarning)) || A380PrimComputer_P.Constant1_Value_b ||
                A380PrimComputer_P.Constant1_Value_b);
    rtb_OR3_m = (rtb_OR_ll && rtb_Equal);
    rtb_OR_ou = (rtb_OR3_m || (rtb_OR_ll && rtb_OR_n) || (rtb_Equal && rtb_OR_n));
    rtb_OR_a = (rtb_OR3_m && rtb_OR_n);
    ...
    rtb_OR7 = ((A380PrimComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.SSM != static_cast<uint32_T>(SignStatusMatrix::
      ...
      NormalOperation)) || (A380PrimComputer_U.in.bus_inputs.ir_3_bus.body_normal_accel_g.SSM != static_cast<uint32_T>
               ...
               (A380PrimComputer_U.in.bus_inputs.ir_3_bus.roll_att_rate_deg_s.SSM != static_cast<uint32_T>
                (SignStatusMatrix::NormalOperation)) || A380PrimComputer_P.Constant_Value_ad);
    rtb_AND1_b = !rtb_OR_n;
    leftAileron2Avail = !rtb_Equal;
    rightAileron2Avail = (rtb_OR_ll && leftAileron2Avail);
    if (rightAileron2Avail && rtb_AND1_b) {
    ...
    } else if ((!rtb_OR_ll) && rtb_Equal && rtb_AND1_b) {
      ...
      rtb_alpha = (A380PrimComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data +
                   A380PrimComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.Data) / 2.0F;
    } else if (((!rtb_OR_ll) && leftAileron2Avail && rtb_AND1_b) || ((!rtb_OR_ll) && (!rtb_Equal) && rtb_OR_n)) {
      rtb_V_ias = (A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data +
    ...
    } else if ((!rtb_OR_ll) && rtb_Equal && rtb_OR_n) {
      rtb_V_ias = A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data;
      rtb_V_tas = A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_true_kn.Data;
      rtb_mach = A380PrimComputer_U.in.bus_inputs.adr_1_bus.mach.Data;
      rtb_alpha = A380PrimComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data;
    } else if (rightAileron2Avail && rtb_OR_n) {
      rtb_V_ias = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.Data;
      rtb_V_tas = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
      rtb_mach = A380PrimComputer_U.in.bus_inputs.adr_2_bus.mach.Data;
      rtb_alpha = A380PrimComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
    } else if (rtb_OR3_m && rtb_AND1_b) {
    ...
    rtb_AND1_b = !rtb_OR6;
    leftAileron2Avail = !rtb_OR7;
    rightAileron2Avail = (rtb_OR && leftAileron2Avail);
    if (rightAileron2Avail && rtb_AND1_b) {
    ...
    } else if ((!rtb_OR) && rtb_OR7 && rtb_AND1_b) {
    ...
    } else if (((!rtb_OR) && leftAileron2Avail && rtb_AND1_b) || ((!rtb_OR) && (!rtb_OR7) && rtb_OR6)) {
      rtb_alpha = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.Data +
                   A380PrimComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.Data) / 2.0F;
      rtb_phi = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.roll_angle_deg.Data +
                 A380PrimComputer_U.in.bus_inputs.ir_3_bus.roll_angle_deg.Data) / 2.0F;
      ...
      rtb_theta_dot = A380PrimComputer_U.in.bus_inputs.ir_1_bus.pitch_att_rate_deg_s.Data;
      rtb_phi_dot = A380PrimComputer_U.in.bus_inputs.ir_1_bus.roll_att_rate_deg_s.Data;
    } else if (rightAileron2Avail && rtb_OR6) {
    ...
    A380PrimComputer_B.BusAssignment_n.data = A380PrimComputer_U.in;
    A380PrimComputer_B.BusAssignment_n.laws = rtP_prim_laws_output_MATLABStruct;
    A380PrimComputer_B.BusAssignment_n.logic.on_ground = rtP_prim_logic_output_MATLABStruct.on_ground;
    A380PrimComputer_B.BusAssignment_n.logic.tracking_mode_on = rtP_prim_logic_output_MATLABStruct.tracking_mode_on;
    A380PrimComputer_B.BusAssignment_n.logic.surface_statuses = rtP_prim_logic_output_MATLABStruct.surface_statuses;
    A380PrimComputer_B.BusAssignment_n.logic.lateral_surface_positions =
      rtP_prim_logic_output_MATLABStruct.lateral_surface_positions;
    A380PrimComputer_B.BusAssignment_n.logic.pitch_surface_positions =
      rtP_prim_logic_output_MATLABStruct.pitch_surface_positions;
    A380PrimComputer_B.BusAssignment_n.logic.lateral_law_capability =
      rtP_prim_logic_output_MATLABStruct.lateral_law_capability;
    A380PrimComputer_B.BusAssignment_n.logic.active_lateral_law = rtP_prim_logic_output_MATLABStruct.active_lateral_law;
    A380PrimComputer_B.BusAssignment_n.logic.pitch_law_capability =
      rtP_prim_logic_output_MATLABStruct.pitch_law_capability;
    A380PrimComputer_B.BusAssignment_n.logic.active_pitch_law = rtP_prim_logic_output_MATLABStruct.active_pitch_law;
    A380PrimComputer_B.BusAssignment_n.logic.abnormal_condition_law_active =
      rtP_prim_logic_output_MATLABStruct.abnormal_condition_law_active;
    A380PrimComputer_B.BusAssignment_n.logic.is_master_prim = rtP_prim_logic_output_MATLABStruct.is_master_prim;
    A380PrimComputer_B.BusAssignment_n.logic.elevator_1_avail = rtP_prim_logic_output_MATLABStruct.elevator_1_avail;
    A380PrimComputer_B.BusAssignment_n.logic.elevator_1_engaged = rtP_prim_logic_output_MATLABStruct.elevator_1_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.elevator_2_avail = rtP_prim_logic_output_MATLABStruct.elevator_2_avail;
    A380PrimComputer_B.BusAssignment_n.logic.elevator_2_engaged = rtP_prim_logic_output_MATLABStruct.elevator_2_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.elevator_3_avail = rtP_prim_logic_output_MATLABStruct.elevator_3_avail;
    A380PrimComputer_B.BusAssignment_n.logic.elevator_3_engaged = rtP_prim_logic_output_MATLABStruct.elevator_3_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.ths_avail = rtP_prim_logic_output_MATLABStruct.ths_avail;
    A380PrimComputer_B.BusAssignment_n.logic.ths_engaged = rtP_prim_logic_output_MATLABStruct.ths_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.left_aileron_1_avail =
      rtP_prim_logic_output_MATLABStruct.left_aileron_1_avail;
    A380PrimComputer_B.BusAssignment_n.logic.left_aileron_1_engaged =
      rtP_prim_logic_output_MATLABStruct.left_aileron_1_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.left_aileron_2_avail =
      rtP_prim_logic_output_MATLABStruct.left_aileron_2_avail;
    A380PrimComputer_B.BusAssignment_n.logic.left_aileron_2_engaged =
      rtP_prim_logic_output_MATLABStruct.left_aileron_2_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.right_aileron_1_avail =
      rtP_prim_logic_output_MATLABStruct.right_aileron_1_avail;
    A380PrimComputer_B.BusAssignment_n.logic.right_aileron_1_engaged =
      rtP_prim_logic_output_MATLABStruct.right_aileron_1_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.right_aileron_2_avail =
      rtP_prim_logic_output_MATLABStruct.right_aileron_2_avail;
    A380PrimComputer_B.BusAssignment_n.logic.right_aileron_2_engaged =
      rtP_prim_logic_output_MATLABStruct.right_aileron_2_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_hydraulic_mode_avail =
      rtP_prim_logic_output_MATLABStruct.left_spoiler_hydraulic_mode_avail;
    A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_electric_mode_avail =
      rtP_prim_logic_output_MATLABStruct.left_spoiler_electric_mode_avail;
    A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_hydraulic_mode_engaged =
      rtP_prim_logic_output_MATLABStruct.left_spoiler_hydraulic_mode_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_electric_mode_engaged =
      rtP_prim_logic_output_MATLABStruct.left_spoiler_electric_mode_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_hydraulic_mode_avail =
      rtP_prim_logic_output_MATLABStruct.right_spoiler_hydraulic_mode_avail;
    A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_electric_mode_avail =
      rtP_prim_logic_output_MATLABStruct.right_spoiler_electric_mode_avail;
    A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_hydraulic_mode_engaged =
      rtP_prim_logic_output_MATLABStruct.right_spoiler_hydraulic_mode_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_electric_mode_engaged =
      rtP_prim_logic_output_MATLABStruct.right_spoiler_electric_mode_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.rudder_1_hydraulic_mode_avail =
      rtP_prim_logic_output_MATLABStruct.rudder_1_hydraulic_mode_avail;
    A380PrimComputer_B.BusAssignment_n.logic.rudder_1_electric_mode_avail =
      rtP_prim_logic_output_MATLABStruct.rudder_1_electric_mode_avail;
    A380PrimComputer_B.BusAssignment_n.logic.rudder_1_hydraulic_mode_engaged =
      rtP_prim_logic_output_MATLABStruct.rudder_1_hydraulic_mode_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.rudder_1_electric_mode_engaged =
      rtP_prim_logic_output_MATLABStruct.rudder_1_electric_mode_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.rudder_2_hydraulic_mode_avail =
      rtP_prim_logic_output_MATLABStruct.rudder_2_hydraulic_mode_avail;
    A380PrimComputer_B.BusAssignment_n.logic.rudder_2_electric_mode_avail =
      rtP_prim_logic_output_MATLABStruct.rudder_2_electric_mode_avail;
    A380PrimComputer_B.BusAssignment_n.logic.rudder_2_hydraulic_mode_engaged =
      rtP_prim_logic_output_MATLABStruct.rudder_2_hydraulic_mode_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.rudder_2_electric_mode_engaged =
      rtP_prim_logic_output_MATLABStruct.rudder_2_electric_mode_engaged;
    A380PrimComputer_B.BusAssignment_n.logic.aileron_droop_active =
      rtP_prim_logic_output_MATLABStruct.aileron_droop_active;
    A380PrimComputer_B.BusAssignment_n.logic.aileron_antidroop_active =
      rtP_prim_logic_output_MATLABStruct.aileron_antidroop_active;
    A380PrimComputer_B.BusAssignment_n.logic.ths_automatic_mode_active =
      rtP_prim_logic_output_MATLABStruct.ths_automatic_mode_active;
    A380PrimComputer_B.BusAssignment_n.logic.ths_manual_mode_c_deg_s =
      rtP_prim_logic_output_MATLABStruct.ths_manual_mode_c_deg_s;
    A380PrimComputer_B.BusAssignment_n.logic.is_yellow_hydraulic_power_avail =
      rtP_prim_logic_output_MATLABStruct.is_yellow_hydraulic_power_avail;
    A380PrimComputer_B.BusAssignment_n.logic.is_green_hydraulic_power_avail =
      rtP_prim_logic_output_MATLABStruct.is_green_hydraulic_power_avail;
    A380PrimComputer_B.BusAssignment_n.logic.eha_ebha_elec_mode_inhibited =
      rtP_prim_logic_output_MATLABStruct.eha_ebha_elec_mode_inhibited;
    A380PrimComputer_B.BusAssignment_n.logic.left_sidestick_disabled =
      rtP_prim_logic_output_MATLABStruct.left_sidestick_disabled;
    A380PrimComputer_B.BusAssignment_n.logic.right_sidestick_disabled =
      rtP_prim_logic_output_MATLABStruct.right_sidestick_disabled;
    A380PrimComputer_B.BusAssignment_n.logic.left_sidestick_priority_locked =
      rtP_prim_logic_output_MATLABStruct.left_sidestick_priority_locked;
    A380PrimComputer_B.BusAssignment_n.logic.right_sidestick_priority_locked =
      rtP_prim_logic_output_MATLABStruct.right_sidestick_priority_locked;
    A380PrimComputer_B.BusAssignment_n.logic.total_sidestick_pitch_command =
      rtP_prim_logic_output_MATLABStruct.total_sidestick_pitch_command;
    A380PrimComputer_B.BusAssignment_n.logic.total_sidestick_roll_command =
      rtP_prim_logic_output_MATLABStruct.total_sidestick_roll_command;
    A380PrimComputer_B.BusAssignment_n.logic.speed_brake_inhibited =
      rtP_prim_logic_output_MATLABStruct.speed_brake_inhibited;
    A380PrimComputer_B.BusAssignment_n.logic.ground_spoilers_armed =
      rtP_prim_logic_output_MATLABStruct.ground_spoilers_armed;
    A380PrimComputer_B.BusAssignment_n.logic.ground_spoilers_out =
      rtP_prim_logic_output_MATLABStruct.ground_spoilers_out;
    A380PrimComputer_B.BusAssignment_n.logic.phased_lift_dumping_active =
      rtP_prim_logic_output_MATLABStruct.phased_lift_dumping_active;
    A380PrimComputer_B.BusAssignment_n.logic.spoiler_lift_active =
      rtP_prim_logic_output_MATLABStruct.spoiler_lift_active;
    A380PrimComputer_B.BusAssignment_n.logic.ap_authorised = rtP_prim_logic_output_MATLABStruct.ap_authorised;
    A380PrimComputer_B.BusAssignment_n.logic.protection_ap_disconnect =
      rtP_prim_logic_output_MATLABStruct.protection_ap_disconnect;
    A380PrimComputer_B.BusAssignment_n.logic.high_alpha_prot_active =
      rtP_prim_logic_output_MATLABStruct.high_alpha_prot_active;
    A380PrimComputer_B.BusAssignment_n.logic.alpha_prot_deg = rtP_prim_logic_output_MATLABStruct.alpha_prot_deg;
    A380PrimComputer_B.BusAssignment_n.logic.alpha_max_deg = rtP_prim_logic_output_MATLABStruct.alpha_max_deg;
    A380PrimComputer_B.BusAssignment_n.logic.high_speed_prot_active =
      rtP_prim_logic_output_MATLABStruct.high_speed_prot_active;
    A380PrimComputer_B.BusAssignment_n.logic.high_speed_prot_lo_thresh_kn =
      rtP_prim_logic_output_MATLABStruct.high_speed_prot_lo_thresh_kn;
    A380PrimComputer_B.BusAssignment_n.logic.high_speed_prot_hi_thresh_kn =
      rtP_prim_logic_output_MATLABStruct.high_speed_prot_hi_thresh_kn;
    A380PrimComputer_B.BusAssignment_n.logic.ra_computation_data_ft =
      rtP_prim_logic_output_MATLABStruct.ra_computation_data_ft;
    A380PrimComputer_B.BusAssignment_n.logic.all_ra_failure = rtP_prim_logic_output_MATLABStruct.all_ra_failure;
    A380PrimComputer_B.BusAssignment_n.logic.all_sfcc_lost = rtb_y_i;
    A380PrimComputer_B.BusAssignment_n.logic.flap_handle_index = rtb_Switch_g_idx_0;
    A380PrimComputer_B.BusAssignment_n.logic.flap_angle_deg = rtb_Switch_g_idx_1;
    A380PrimComputer_B.BusAssignment_n.logic.slat_angle_deg = rtb_Switch_g_idx_2;
    A380PrimComputer_B.BusAssignment_n.logic.slat_flap_actual_pos = rtb_Switch_g_idx_3;
    A380PrimComputer_B.BusAssignment_n.logic.double_lgciu_failure =
      rtP_prim_logic_output_MATLABStruct.double_lgciu_failure;
    A380PrimComputer_B.BusAssignment_n.logic.slats_locked = (rtb_y_m != 0U);
    A380PrimComputer_B.BusAssignment_n.logic.flaps_locked = (rtb_y_e != 0U);
    A380PrimComputer_B.BusAssignment_n.logic.landing_gear_down = rtP_prim_logic_output_MATLABStruct.landing_gear_down;
    A380PrimComputer_B.BusAssignment_n.fg_logic = rtP_prim_fg_logic_output_MATLABStruct;
    A380PrimComputer_B.BusAssignment_n.discrete_outputs = rtP_prim_discrete_output_MATLABStruct;
    A380PrimComputer_B.BusAssignment_n.analog_outputs = rtP_prim_analog_output_MATLABStruct;
    A380PrimComputer_B.BusAssignment_n.bus_outputs = A380PrimComputer_P.Constant4_Value;
    A380PrimComputer_B.BusAssignment_n.logic.double_adr_failure = rtb_OR_ou;
    A380PrimComputer_B.BusAssignment_n.logic.triple_adr_failure = rtb_OR_a;
    A380PrimComputer_B.BusAssignment_n.logic.cas_or_mach_disagree = A380PrimComputer_P.Constant1_Value_b;
    A380PrimComputer_B.BusAssignment_n.logic.alpha_disagree = A380PrimComputer_P.Constant1_Value_b;
    rtb_AND1_b = (rtb_OR && rtb_OR6);
    A380PrimComputer_B.BusAssignment_n.logic.double_ir_failure = (rtb_AND1_b || (rtb_OR && rtb_OR7) || (rtb_OR6 &&
      rtb_OR7));
    A380PrimComputer_B.BusAssignment_n.logic.triple_ir_failure = (rtb_AND1_b && rtb_OR7);
    A380PrimComputer_B.BusAssignment_n.logic.ir_failure_not_self_detected = A380PrimComputer_P.Constant_Value_ad;
    A380PrimComputer_B.BusAssignment_n.logic.adr_computation_data.V_ias_kn = rtb_V_ias;
    A380PrimComputer_B.BusAssignment_n.logic.adr_computation_data.V_tas_kn = rtb_V_tas;
    A380PrimComputer_B.BusAssignment_n.logic.adr_computation_data.mach = rtb_mach;
    A380PrimComputer_B.BusAssignment_n.logic.adr_computation_data.alpha_deg = rtb_Y;
    A380PrimComputer_B.BusAssignment_n.logic.ir_computation_data.theta_deg = rtb_alpha;
    A380PrimComputer_B.BusAssignment_n.logic.ir_computation_data.phi_deg = rtb_phi;
    A380PrimComputer_B.BusAssignment_n.logic.ir_computation_data.q_deg_s = rtb_q;
    A380PrimComputer_B.BusAssignment_n.logic.ir_computation_data.r_deg_s = rtb_r;
    A380PrimComputer_B.BusAssignment_n.logic.ir_computation_data.n_x_g = rtb_n_x;
    A380PrimComputer_B.BusAssignment_n.logic.ir_computation_data.n_y_g = rtb_n_y;
    A380PrimComputer_B.BusAssignment_n.logic.ir_computation_data.n_z_g = rtb_n_z;
    A380PrimComputer_B.BusAssignment_n.logic.ir_computation_data.theta_dot_deg_s = rtb_theta_dot;
    A380PrimComputer_B.BusAssignment_n.logic.ir_computation_data.phi_dot_deg_s = rtb_phi_dot;
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_y_i);
    A380PrimComputer_OtherRAselection(&A380PrimComputer_B.BusAssignment_n, &rtb_left_inboard_aileron_command_deg);
    rtb_OR_ll = (rtb_OR_a || (rtb_OR_ou && A380PrimComputer_P.Constant1_Value_b));
    A380PrimComputer_MATLABFunction_c(((A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data > 50.0F) &&
      ...
      NormalOperation)) && (rtb_V_ias > 200.0F) && rtb_OR_ll), A380PrimComputer_U.in.time.dt,
    ...
    A380PrimComputer_MATLABFunction_c(((A380PrimComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data > 50.0F) &&
      ...
      NormalOperation)) && (rtb_V_ias > 200.0F) && rtb_OR_ll), A380PrimComputer_U.in.time.dt,
      A380PrimComputer_P.ConfirmNode1_isRisingEdge, A380PrimComputer_P.ConfirmNode1_timeDelay, &rtb_y_jb,
      &A380PrimComputer_DWork.sf_MATLABFunction_jl);
    A380PrimComputer_MATLABFunction_c(((rtb_left_inboard_aileron_command_deg.Data > 50.0F) &&
      (rtb_left_inboard_aileron_command_deg.SSM == static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) &&
      (rtb_V_ias > 200.0F) && rtb_OR_ll), A380PrimComputer_U.in.time.dt, A380PrimComputer_P.ConfirmNode3_isRisingEdge,
    ...
    A380PrimComputer_DWork.ra2CoherenceRejected = (rtb_y_jb || A380PrimComputer_DWork.ra2CoherenceRejected);
    A380PrimComputer_DWork.ra3CoherenceRejected = (rtb_y_i || A380PrimComputer_DWork.ra3CoherenceRejected);
    rtb_OR_ll = ((A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.SSM == static_cast<uint32_T>
                  (SignStatusMatrix::FailureWarning)) || A380PrimComputer_DWork.ra1CoherenceRejected);
    rtb_Equal = ((A380PrimComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.SSM == static_cast<uint32_T>
                  (SignStatusMatrix::FailureWarning)) || A380PrimComputer_DWork.ra2CoherenceRejected);
    rtb_OR_n = ((rtb_left_inboard_aileron_command_deg.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
                A380PrimComputer_DWork.ra3CoherenceRejected);
    rtb_raComputationValue = 250.0F;
    switch ((!rtb_OR_ll + !rtb_Equal) + !rtb_OR_n) {
     case 3:
      ...
      v[2] = rtb_left_inboard_aileron_command_deg.Data;
      if (A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data <
        ...
        if (A380PrimComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data < rtb_left_inboard_aileron_command_deg.Data)
        {
          nz = 1;
        } else if (A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data <
                   rtb_left_inboard_aileron_command_deg.Data) {
          nz = 2;
        } else {
          nz = 0;
        }
                 ...
                 rtb_left_inboard_aileron_command_deg.Data) {
        nz = 0;
      } else if (A380PrimComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data <
                 rtb_left_inboard_aileron_command_deg.Data) {
        nz = 2;
      } else {
        nz = 1;
     ...
     case 2:
      if (rtb_OR_ll) {
        rtb_raComputationValue = (A380PrimComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data +
          rtb_left_inboard_aileron_command_deg.Data) / 2.0F;
      } else if (rtb_Equal) {
     ...
     case 1:
      if ((rtb_V_ias <= 180.0F) || ((!rtb_OR_a) && ((!rtb_OR_ou) || (!A380PrimComputer_P.Constant1_Value_b)))) {
        if (!rtb_OR_ll) {
          rtb_raComputationValue = A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data;
        } else if (!rtb_Equal) {
          rtb_raComputationValue = A380PrimComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data;
        } else if (!rtb_OR_n) {
          rtb_raComputationValue = rtb_left_inboard_aileron_command_deg.Data;
        }
      }
      break;
    }

    rtb_OR_ll = (rtb_OR_ll && rtb_Equal && rtb_OR_n);
    ...
    rtb_y_a = (rtb_Switch31 != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.lgciu_1_bus.discrete_word_2,
      A380PrimComputer_P.BitfromLabel1_bit_jr, &rtb_Switch31);
    rtb_Equal = (rtb_y_a || (rtb_Switch31 != 0U));
    ...
    rtb_y_a = ((rtb_Equal && rtb_NOT_k) || ((rtb_y_a || (rtb_Switch31 != 0U)) && rtb_y_i));
    rtb_Equal = ((!rtb_NOT_k) && (!rtb_y_i));
    rtb_OR_n = (A380PrimComputer_U.in.sim_data.slew_on || A380PrimComputer_U.in.sim_data.pause_on ||
    ...
    rtb_OR3_m = ((rtb_DataTypeConversion_m2 || rtb_y_jb || (rtb_Switch31 != 0U)) && rtb_y_i);
    ...
    rtb_OR = (rtb_y_a && ((rtb_y_i || rtb_DataTypeConversion_m2 ||
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_left_inboard_aileron_command_deg = A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word;
    } else {
      rtb_left_inboard_aileron_command_deg = A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word;
    }

    A380PrimComputer_MATLABFunction_e(&rtb_left_inboard_aileron_command_deg, A380PrimComputer_P.BitfromLabel2_bit_k,
      &rtb_Switch31);
    A380PrimComputer_MATLABFunction(&rtb_left_inboard_aileron_command_deg, &rtb_y_la);
    rtb_AND1_e = ((rtb_Switch31 != 0U) && rtb_y_la);
    A380PrimComputer_MATLABFunction_e(&rtb_left_inboard_aileron_command_deg, A380PrimComputer_P.BitfromLabel1_bit_b,
      &rtb_Switch31);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      leftAileron2Avail = rtb_DataTypeConversion_m2;
    ...
    rtb_rightAileron2Engaged = (rightAileron2Avail && (((!rtb_y_la) || (rtb_Switch31 == 0U)) && rtb_rightAileron2Engaged));
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_left_inboard_aileron_command_deg = A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word;
    } else {
      rtb_left_inboard_aileron_command_deg = A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word;
    }

    A380PrimComputer_MATLABFunction(&rtb_left_inboard_aileron_command_deg, &rtb_y_la);
    A380PrimComputer_MATLABFunction_e(&rtb_left_inboard_aileron_command_deg, A380PrimComputer_P.BitfromLabel1_bit_n,
      &rtb_Switch31);
    rtb_AND_e = (rtb_y_la && (rtb_Switch31 != 0U));
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND1_b = ((!rtb_AND_e) && rtb_rudder2HydraulicModeEngaged);
    } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_AND1_b = ((!rtb_AND_e) && rtb_rudder2HydraulicModeEngaged);
    } else {
      rtb_AND1_b = A380PrimComputer_U.in.discrete_inputs.is_unit_3;
    }

    rtb_AND_e = (elevator2Avail && rtb_AND1_b);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_jk);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word, &rtb_y_la);
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_y_jk = (rtb_y_jk && (rtb_Switch29 != 0U));
    } else {
      rtb_y_jk = (rtb_y_la && (rtb_Switch31 != 0U));
    }

    rtb_y_la = (A380PrimComputer_U.in.discrete_inputs.is_unit_1 || A380PrimComputer_U.in.discrete_inputs.is_unit_2);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND1_b = ((!rtb_y_jk) && rtb_rudder2HydraulicModeEngaged);
    } else {
      rtb_AND1_b = (A380PrimComputer_U.in.discrete_inputs.is_unit_2 && ((!rtb_y_jk) && rtb_rudder2HydraulicModeEngaged));
    }

    rtb_y_jk = (rtb_y_la && rtb_AND1_b);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_jb);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_bv, &rtb_y_e);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      thsAvail = rtb_DataTypeConversion_m2;
      rtb_AND1_b = ((!rtb_y_jb) || (rtb_y_e == 0U));
    } else {
      thsAvail = ((!A380PrimComputer_U.in.discrete_inputs.is_unit_2) && (A380PrimComputer_U.in.discrete_inputs.is_unit_3
        && rtb_y_i));
      rtb_AND1_b = ((!A380PrimComputer_U.in.discrete_inputs.is_unit_2) &&
                    A380PrimComputer_U.in.discrete_inputs.is_unit_3);
    }

    rtb_thsEngaged = (thsAvail && rtb_AND1_b);
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      rtb_AND1_b = (rtb_Switch31 != 0U);
    } else {
      rtb_AND1_b = (rtb_Switch29 != 0U);
    }

    rtb_AND_n = (rtb_AND1_b && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_c, &rtb_Switch31);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_p, &rtb_Switch29);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_left_inboard_aileron_command_deg = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word;
    } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_left_inboard_aileron_command_deg = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word;
    } else {
      rtb_left_inboard_aileron_command_deg = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word;
    }

    A380PrimComputer_MATLABFunction_e(&rtb_left_inboard_aileron_command_deg, A380PrimComputer_P.BitfromLabel6_bit_k,
      &rtb_y_m);
    A380PrimComputer_MATLABFunction(&rtb_left_inboard_aileron_command_deg, &rtb_y_i);
    ...
    A380PrimComputer_MATLABFunction_e(&rtb_left_inboard_aileron_command_deg, A380PrimComputer_P.BitfromLabel9_bit_l,
      &rtb_y_m);
    A380PrimComputer_MATLABFunction_e(&rtb_left_inboard_aileron_command_deg, A380PrimComputer_P.BitfromLabel10_bit_b,
      &rtb_y_k1);
    A380PrimComputer_MATLABFunction(&rtb_left_inboard_aileron_command_deg, &rtb_y_jb);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      rtb_AND1_b = (rtb_y_m != 0U);
    } else {
      rtb_AND1_b = (rtb_y_k1 != 0U);
    }

    rtb_AND3 = (rtb_AND1_b && rtb_y_jb);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2 || A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
        ...
        rtb_AND6_o = (rudder1HydraulicModeHasPriority && ((!rtb_DataTypeConversion_m2) || (!rtb_AND1_b)) &&
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word, &rtb_y_jb);
    rtb_AND4_f = ((rtb_y_k1 != 0U) && rtb_y_jb);
    ...
    rudder2HydraulicModeHasPriority = rtb_y_a;
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word, &rtb_y_a);
    rtb_AND4_f = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_c, &rtb_y_k1);
    rtb_AND3_d = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_p, &rtb_y_k1);
    rtb_AND2_b = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_n, &rtb_y_k1);
    rtb_AND1_at = ((rtb_y_k1 != 0U) && rtb_y_a);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word, &rtb_y_jb);
    rtb_AND13 = ((rtb_y_k1 != 0U) && rtb_y_jb);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_b, &rtb_y_k1);
    rtb_AND11 = ((rtb_y_k1 != 0U) && rtb_y_jb);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel10_bit_h, &rtb_y_k1);
    rtb_AND10 = ((rtb_y_k1 != 0U) && rtb_y_jb);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel11_bit, &rtb_y_k1);
    rtb_AND9 = ((rtb_y_k1 != 0U) && rtb_y_jb);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word, &rtb_y_a);
    rtb_AND17 = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel17_bit, &rtb_y_k1);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_y_jb = (rtb_OR6 || rtb_AND2_b);
      rtb_AND9_o = (rtb_OR7 || rtb_AND1_at);
      rtb_AND2_b = (rtb_AND1_e || rtb_AND4_d);
      rtb_AND1_at = (rtb_rightAileron2Engaged || rtb_AND6_pt);
      ...
      rtb_y_jb = (rtb_AND1_e || rtb_AND4_f);
      rtb_AND9_o = (rtb_rightAileron2Engaged || rtb_AND3_d);
      rtb_AND2_b = (rtb_AND2_b || rtb_AND4_d);
      rtb_AND1_at = (rtb_AND1_at || rtb_AND6_pt);
      ...
      rtb_y_jb = (rtb_AND4_f || rtb_AND7);
      rtb_AND9_o = (rtb_AND3_d || rtb_AND8);
      rtb_AND2_b = (rtb_OR6 || rtb_AND2_b);
      rtb_AND1_at = (rtb_OR7 || rtb_AND1_at);
    ...
    rtb_AND6_pt = (rtb_y_jb || (rtb_AND13 || rtb_AND15));
    rtb_AND11 = (rtb_AND9_o || (rtb_AND11 || rtb_AND16));
    rtb_AND10 = (rtb_AND2_b || (rtb_AND10 || rtb_AND17));
    rtb_AND9 = (rtb_AND1_at || (rtb_AND9 || ((rtb_y_k1 != 0U) && rtb_y_a)));
    ...
    rtb_AND13 = (rtb_y_i && (rtb_NOT_k || (rtb_y_e != 0U)));
    ...
    rtb_AND17 = (rtb_y_i && (rtb_y_jb || (rtb_y_e != 0U)));
    ...
    rtb_AND4_d = (rtb_y_i && (rtb_DataTypeConversion_m2 || (rtb_y_e != 0U)));
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word, &rtb_y_i);
    rtb_AND15 = ((rtb_y_a || (rtb_y_e != 0U)) && rtb_y_i);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel10_bit_j, &rtb_y_e);
    rtb_y_a = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel11_bit_j, &rtb_y_e);
    rtb_AND16 = ((rtb_y_a || (rtb_y_e != 0U)) && rtb_y_i);
    ...
    rtb_AND16 = (rtb_y_i && (rtb_y_a || (rtb_y_e != 0U)));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word, &rtb_y_i);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
    ...
    rtb_AND9_o = (rtb_y_i && (rtb_DataTypeConversion_m2 || (rtb_y_e != 0U)));
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word, &rtb_y_a);
    rtb_AND2_b = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel17_bit_i, &rtb_y_k1);
    rtb_AND15_l = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel18_bit, &rtb_y_k1);
    rtb_AND1_at = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel19_bit, &rtb_y_k1);
    rtb_AND12 = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      &rtb_DataTypeConversion_m2);
    rtb_AND5_e = ((rtb_y_k1 != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_g, &rtb_y_k1);
    rtb_AND3_h = ((rtb_y_k1 != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
    ...
    rtb_AND1_b = ((rtb_y_k1 != 0U) && rtb_DataTypeConversion_m2);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word, &rtb_y_a);
    rtb_AND4_fg3 = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_b, &rtb_y_k1);
    rtb_DataTypeConversion_m2 = ((rtb_y_k1 != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_p, &rtb_y_k1);
    rtb_y_a = ((rtb_y_k1 != 0U) && rtb_y_a);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word, &rtb_y_jb);
    rtb_AND11_m = ((rtb_y_k1 != 0U) && rtb_y_jb);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_e, &rtb_y_k1);
    rtb_NOT_k = ((rtb_y_k1 != 0U) && rtb_y_jb);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel11_bit_n, &rtb_y_k1);
    rtb_TmpSignalConversionAtSFunctionInport6_idx_2 = ((rtb_y_k1 != 0U) && rtb_y_jb);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_y_jb = (rtb_AND_e || rtb_AND16_n);
      rtb_AND19 = (rtb_AND18_c || rtb_AND1_at);
      rtb_AND15_l = (elevator1Avail || rtb_AND15_l);
      rtb_AND16_n = (rtb_AND2_b || rtb_y_jk);
      ...
      rtb_y_jb = (rtb_AND16_n || rtb_AND15_l);
      rtb_AND19 = (rtb_y_jk || rtb_AND18_c);
      rtb_AND15_l = (rtb_AND_e || rtb_AND2_b);
      ...
      rtb_y_jb = (elevator1Avail || rtb_AND15_l);
      rtb_AND19 = (rtb_AND_e || rtb_AND19);
      rtb_AND15_l = (rtb_AND2_b || rtb_AND18_c);
    ...
    rtb_AND2_b = (rtb_y_jb || (rtb_AND11_m || rtb_AND3_h));
    rtb_AND1_at = (rtb_AND19 || (rtb_NOT_k || rtb_y_a));
    rtb_AND5_e = (rtb_AND15_l || (rtb_AND5_e || rtb_DataTypeConversion_m2));
    rtb_AND4_fg3 = (rtb_AND16_n || (rtb_AND4_fg3 || rtb_y_i));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      &rtb_DataTypeConversion_m2);
    rtb_AND3_h = ((rtb_NOT_k || (rtb_y_k1 != 0U)) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel32_bit, &rtb_y_k1);
    rtb_NOT_k = (rtb_y_k1 != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel33_bit, &rtb_y_k1);
    rtb_AND15_l = ((rtb_NOT_k || (rtb_y_k1 != 0U)) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
    ...
    rtb_AND16_n = (rtb_NOT_k || (rtb_y_k1 != 0U));
    ...
    rtb_y_jb = (rtb_NOT_k || (rtb_y_k1 != 0U));
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word, &rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word,
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND3_h = (rtb_AND_n || rtb_AND6_o || rtb_AND3_h);
      rtb_AND15_l = (rtb_rudder2HydraulicModeEngaged || rtb_AND2_jo || rtb_AND18_c);
      rtb_handleIndex_f = A380PrimComputer_U.in.analog_inputs.rudder_1_pos_deg;
      ...
      rtb_AND3_h = (rtb_AND3_h || rtb_AND18_c);
      rtb_AND15_l = (rtb_AND_n || rtb_AND6_o || rtb_AND15_l);
      if (A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_1_position_deg.SSM == static_cast<uint32_T>
          (SignStatusMatrix::NormalOperation)) {
        rtb_handleIndex_f = A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_1_position_deg.Data;
      } else {
        rtb_handleIndex_f = A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_1_position_deg.Data;
      }
      ...
      rtb_AND3_h = false;
      rtb_AND15_l = false;
      rtb_handleIndex_f = 0.0;
      rtb_lowerRudderPos = 0.0;
    }

    rtb_AND3_h = (rtb_AND3_h || (rtb_AND16_n && rtb_DataTypeConversion_m2) || (rtb_AND20 && rtb_y_a));
    rtb_AND15_l = (rtb_AND15_l || (rtb_y_jb && rtb_DataTypeConversion_m2) || (rtb_y_i && rtb_NOT_k));
    ...
    rtb_Gain_g = std::abs(static_cast<real_T>(rtb_phi));
    rtb_AND20 = !rudder2HydraulicModeHasPriority;
    rtb_AND16_n = ((!rtb_y_i) && rtb_AND20 && (((!rtb_OR_a) && ((rtb_mach > 0.96) || (rtb_mach < 0.1) || (rtb_Y < -10.0)
      || (rtb_Y > 37.5) || (rtb_V_ias > 420.0F) || (rtb_V_ias < 70.0F))) ||
      ((!A380PrimComputer_B.BusAssignment_n.logic.triple_ir_failure) &&
       ((!A380PrimComputer_B.BusAssignment_n.logic.double_ir_failure) || (!A380PrimComputer_P.Constant_Value_ad)) &&
       ((rtb_Gain_g > 120.0) || ((rtb_alpha > 50.0F) || (rtb_alpha < -30.0F))))));
    A380PrimComputer_DWork.abnormalConditionWasActive = (rtb_AND16_n || (rtb_AND20 &&
      A380PrimComputer_DWork.abnormalConditionWasActive));
    nz = ((rtb_AND2_b + rtb_AND1_at) + rtb_AND5_e) + rtb_AND4_fg3;
    b_x[0] = rtb_AND6_pt;
    b_x[1] = rtb_AND11;
    b_x[2] = rtb_AND10;
    b_x[3] = rtb_AND9;
    ...
    if (rtb_OR_a || rtb_AND16_n) {
      ...
      if ((nz == 2) || rtb_OR_ou || A380PrimComputer_B.BusAssignment_n.logic.double_ir_failure) {
        ...
        rtb_AND15_l)) || (nz == 3) || (b_nz == 4) || rtb_BusAssignment_logic_slats_locked ||
                 rtb_BusAssignment_logic_flaps_locked || rtb_OR_lu || (rtb_OR_ll && rtb_OR3_m &&
    ...
    A380PrimComputer_MATLABFunction_ek(rtb_DataTypeConversion_dj, rtb_DataTypeConversion_gf, rtb_y_a, rtb_y_i,
      &rtb_law_j);
    ...
    A380PrimComputer_MATLABFunction_ek(rtb_DataTypeConversion_dj, rtb_DataTypeConversion_gf, rtb_y_a, rtb_y_i, &rtb_law);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    if (!A380PrimComputer_DWork.pRightStickDisabled) {
      u0 = A380PrimComputer_U.in.analog_inputs.fo_pitch_stick_pos;
    } else {
      u0 = A380PrimComputer_P.Constant_Value_p;
    }
    ...
    rtb_right_spoiler_2_deg = u0 + rtb_handleIndex;
    ...
    if (!A380PrimComputer_DWork.pRightStickDisabled) {
      u0 = A380PrimComputer_U.in.analog_inputs.fo_roll_stick_pos;
    } else {
      u0 = A380PrimComputer_P.Constant1_Value_p;
    }
    ...
    u0 += rtb_handleIndex;
    if (u0 > A380PrimComputer_P.Saturation1_UpperSat) {
      u0 = A380PrimComputer_P.Saturation1_UpperSat;
    } else if (u0 < A380PrimComputer_P.Saturation1_LowerSat) {
      u0 = A380PrimComputer_P.Saturation1_LowerSat;
    }
    ...
    A380PrimComputer_MATLABFunction_o(rtb_y_a, rtb_y_jb, rtb_y_i, rtb_DataTypeConversion_m2, rtb_NOT_k, (rtb_y_k1 != 0U),
      &rtb_handleIndex);
    ...
    if (A380PrimComputer_U.in.time.simulation_time - A380PrimComputer_DWork.eventTime_f <=
      ...
      rtb_BusAssignment_d_logic_alpha_prot_deg = rtb_Gain_p;
    } else {
      rtb_BusAssignment_d_logic_alpha_prot_deg = rtb_Y_i;
    }
    ...
    rtb_y_a = ((rtb_law_j == a380_pitch_efcs_law::NormalLaw) || (rtb_activeLateralLaw == a380_lateral_efcs_law::
                NormalLaw));
    if ((!A380PrimComputer_U.in.temporary_ap_input.ap_engaged) && (rtb_V_ias > std::fmin(look1_binlxpw
      ...
      A380PrimComputer_DWork.sProtActive = (rtb_y_a || A380PrimComputer_DWork.sProtActive);
    }

    A380PrimComputer_DWork.sProtActive = ((rtb_V_ias >= rtb_handleIndex) &&
      (!A380PrimComputer_U.in.temporary_ap_input.ap_engaged) && rtb_y_a && A380PrimComputer_DWork.sProtActive);
    ...
    A380PrimComputer_DWork.sProtActive_g = ((rtb_AND20 && rtb_y_a &&
      (!A380PrimComputer_U.in.temporary_ap_input.ap_engaged) && (rtb_Y > rtb_BusAssignment_d_logic_alpha_prot_deg) &&
    ...
    A380PrimComputer_DWork.sProtActive_g = ((A380PrimComputer_U.in.time.simulation_time -
      ...
      200.0F) || (rtb_right_spoiler_2_deg >= 0.5) || (rtb_Y >= rtb_BusAssignment_d_logic_alpha_prot_deg - 2.0)) &&
      rtb_AND20 && rtb_y_a && A380PrimComputer_DWork.sProtActive_g);
    ...
    rtb_NOT_k = ((rtb_AND20 && (((nz != 0) && (rtb_Y > rtb_Gain_p)) || (rtb_Y > rtb_BusAssignment_d_logic_alpha_prot_deg
      + 0.25)) && rtb_y_a) || (A380PrimComputer_U.in.time.simulation_time - A380PrimComputer_DWork.eventTime > 3.0) ||
                 A380PrimComputer_DWork.sProtActive || A380PrimComputer_DWork.sProtActive_g);
    rtb_AND11_m = ((std::abs(rtb_right_spoiler_2_deg) <= 0.5) && (std::abs(u0) <= 0.5) && ((std::abs
      (A380PrimComputer_U.in.analog_inputs.rudder_pedal_pos) <= 0.4) && ((rtb_alpha <= 25.0F) && (rtb_alpha >= -13.0F) &&
      (rtb_Gain_g <= 45.0) && (!rtb_NOT_k))));
    rtb_AND19 = rtb_NOT_k;
    ...
    rtb_NOT_k3 = (rtb_NOT_k || A380PrimComputer_DWork.Memory_PreviousInput);
    ...
    rtb_y_jb = ((((A380PrimComputer_U.in.analog_inputs.speed_brake_lever_pos >
      ...
      A380PrimComputer_P.CompareToConstant17_const)) + rtb_DataTypeConversion_m2) >=
                  A380PrimComputer_P.CompareToConstant19_const)));
    A380PrimComputer_MATLABFunction_f(false, A380PrimComputer_P.PulseNode5_isRisingEdge, &rtb_y_i,
    ...
    A380PrimComputer_MATLABFunction_f(rudder2HydraulicModeHasPriority, A380PrimComputer_P.PulseNode6_isRisingEdge,
      &rtb_y_a, &A380PrimComputer_DWork.sf_MATLABFunction_gc);
    A380PrimComputer_DWork.Memory_PreviousInput_a = A380PrimComputer_P.Logic_table_h[(((static_cast<uint32_T>
      ...
      A380PrimComputer_P.CompareToConstant14_const)))) << 1) + rtb_y_a) << 1) +
    ...
    rtb_DataTypeConversion_m2 = (((A380PrimComputer_U.in.analog_inputs.left_body_wheel_speed >=
      ...
      A380PrimComputer_P.CompareToConstant3_const_n) || rtb_y_a) && A380PrimComputer_DWork.Memory_PreviousInput_a);
    A380PrimComputer_DWork.Delay1_DSTATE_b = (rtb_y_jb && (rtb_y_i || rtb_DataTypeConversion_m2 ||
    ...
    A380PrimComputer_DWork.Delay2_DSTATE = (rtb_y_jb && (rtb_DataTypeConversion_m2 ||
    ...
    A380PrimComputer_DWork.Delay3_DSTATE = (rtb_NOT_k && ((A380PrimComputer_U.in.analog_inputs.thr_lever_1_pos <=
      ...
      A380PrimComputer_P.CompareToConstant2_const_k)) && (rtb_y_i || A380PrimComputer_DWork.Delay3_DSTATE));
    A380PrimComputer_B.BusAssignment_jy.logic.phased_lift_dumping_active = ((!A380PrimComputer_DWork.Delay1_DSTATE_b) &&
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_DataTypeConversion_m2);
    A380PrimComputer_B.BusAssignment_jy.logic.spoiler_lift_active = (rudder2HydraulicModeHasPriority && (rtb_y_a ||
      ((rtb_y_k1 == 0U) && rtb_DataTypeConversion_m2)));
    A380PrimComputer_B.BusAssignment_jy.data = A380PrimComputer_U.in;
    A380PrimComputer_B.BusAssignment_jy.laws = rtP_prim_laws_output_MATLABStruct;
    A380PrimComputer_B.BusAssignment_jy.logic.on_ground = rudder2HydraulicModeHasPriority;
    A380PrimComputer_B.BusAssignment_jy.logic.tracking_mode_on = rtb_OR_n;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.left_inboard_aileron_engaged = rtb_AND6_pt;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.right_inboard_aileron_engaged = rtb_AND11;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.left_midboard_aileron_engaged = rtb_AND10;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.right_midboard_aileron_engaged = rtb_AND9;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.left_outboard_aileron_engaged = rtb_AND4_f;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.right_outboard_aileron_engaged = rtb_AND3_d;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.spoiler_pair_1_engaged = rtb_AND13;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.spoiler_pair_2_engaged = rtb_AND17;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.spoiler_pair_3_engaged = rtb_AND4_d;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.spoiler_pair_4_engaged = rtb_AND7;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.spoiler_pair_5_engaged = rtb_AND8;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.spoiler_pair_6_engaged = rtb_AND15;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.spoiler_pair_7_engaged = rtb_AND16;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.spoiler_pair_8_engaged = rtb_AND9_o;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.left_inboard_elevator_engaged = rtb_AND2_b;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.right_inboard_elevator_engaged = rtb_AND1_at;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.left_outboard_elevator_engaged = rtb_AND5_e;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.right_outboard_elevator_engaged = rtb_AND4_fg3;
    rtb_AND1_b = (rtb_AND12 || (rtb_TmpSignalConversionAtSFunctionInport6_idx_2 || rtb_AND1_b));
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.ths_engaged = rtb_AND1_b;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.upper_rudder_engaged = rtb_AND3_h;
    A380PrimComputer_B.BusAssignment_jy.logic.surface_statuses.lower_rudder_engaged = rtb_AND15_l;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_inboard_aileron_deg = rtb_leftInboardAilPos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_inboard_aileron_deg =
      rtb_rightInboardAilPos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_midboard_aileron_deg =
      rtb_leftMidboardAilPos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_midboard_aileron_deg =
      rtb_rightMidboardAilPos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_outboard_aileron_deg =
      rtb_leftOutboardAilPos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_outboard_aileron_deg =
      rtb_rightOutboardAilPos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_spoiler_1_deg =
      A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_1_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_spoiler_1_deg =
      A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_1_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_spoiler_2_deg =
      A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_spoiler_2_deg =
      A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_spoiler_3_deg =
      A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_spoiler_3_deg =
      A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_spoiler_4_deg = rtb_leftSplr4Pos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_spoiler_4_deg = rtb_rightSplr4Pos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_spoiler_5_deg = rtb_leftSplr5Pos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_spoiler_5_deg = rtb_rightSplr5Pos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_spoiler_6_deg = rtb_leftSplr6Pos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_spoiler_6_deg = rtb_rightSplr6Pos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_spoiler_7_deg =
      A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_spoiler_7_deg =
      A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.left_spoiler_8_deg =
      A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_2_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.right_spoiler_8_deg =
      A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.Data;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.upper_rudder_deg = rtb_handleIndex_f;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_surface_positions.lower_rudder_deg = rtb_lowerRudderPos;
    A380PrimComputer_B.BusAssignment_jy.logic.pitch_surface_positions.left_inboard_elevator_deg = rtb_leftInboardElevPos;
    A380PrimComputer_B.BusAssignment_jy.logic.pitch_surface_positions.right_inboard_elevator_deg =
      rtb_rightInboardElevPos;
    A380PrimComputer_B.BusAssignment_jy.logic.pitch_surface_positions.left_outboard_elevator_deg =
      rtb_leftOutboardElevPos;
    A380PrimComputer_B.BusAssignment_jy.logic.pitch_surface_positions.right_outboard_elevator_deg =
      rtb_rightOutboardElevPos;
    A380PrimComputer_B.BusAssignment_jy.logic.pitch_surface_positions.ths_deg = rtb_thsPos;
    A380PrimComputer_B.BusAssignment_jy.logic.lateral_law_capability = rtb_lateralLawCapability;
    A380PrimComputer_B.BusAssignment_jy.logic.active_lateral_law = rtb_activeLateralLaw;
    A380PrimComputer_B.BusAssignment_jy.logic.pitch_law_capability = rtb_pitchLawCapability;
    A380PrimComputer_B.BusAssignment_jy.logic.active_pitch_law = rtb_law_j;
    A380PrimComputer_B.BusAssignment_jy.logic.abnormal_condition_law_active = rtb_AND16_n;
    A380PrimComputer_B.BusAssignment_jy.logic.is_master_prim = rtb_AND18_c;
    A380PrimComputer_B.BusAssignment_jy.logic.elevator_1_avail = elevator1Avail;
    A380PrimComputer_B.BusAssignment_jy.logic.elevator_1_engaged = elevator1Avail;
    A380PrimComputer_B.BusAssignment_jy.logic.elevator_2_avail = elevator2Avail;
    A380PrimComputer_B.BusAssignment_jy.logic.elevator_2_engaged = rtb_AND_e;
    A380PrimComputer_B.BusAssignment_jy.logic.elevator_3_avail = rtb_y_la;
    A380PrimComputer_B.BusAssignment_jy.logic.elevator_3_engaged = rtb_y_jk;
    A380PrimComputer_B.BusAssignment_jy.logic.ths_avail = thsAvail;
    A380PrimComputer_B.BusAssignment_jy.logic.ths_engaged = rtb_thsEngaged;
    A380PrimComputer_B.BusAssignment_jy.logic.left_aileron_1_avail = rtb_OR6;
    A380PrimComputer_B.BusAssignment_jy.logic.left_aileron_1_engaged = rtb_OR6;
    A380PrimComputer_B.BusAssignment_jy.logic.left_aileron_2_avail = leftAileron2Avail;
    A380PrimComputer_B.BusAssignment_jy.logic.left_aileron_2_engaged = rtb_AND1_e;
    A380PrimComputer_B.BusAssignment_jy.logic.right_aileron_1_avail = rtb_OR7;
    A380PrimComputer_B.BusAssignment_jy.logic.right_aileron_1_engaged = rtb_OR7;
    A380PrimComputer_B.BusAssignment_jy.logic.right_aileron_2_avail = rightAileron2Avail;
    A380PrimComputer_B.BusAssignment_jy.logic.right_aileron_2_engaged = rtb_rightAileron2Engaged;
    A380PrimComputer_B.BusAssignment_jy.logic.left_spoiler_hydraulic_mode_avail = leftSpoilerHydraulicModeAvail;
    A380PrimComputer_B.BusAssignment_jy.logic.left_spoiler_electric_mode_avail = leftSpoilerElectricModeAvail;
    A380PrimComputer_B.BusAssignment_jy.logic.left_spoiler_hydraulic_mode_engaged = rtb_leftSpoilerHydraulicModeEngaged;
    A380PrimComputer_B.BusAssignment_jy.logic.left_spoiler_electric_mode_engaged = rtb_leftSpoilerElectricModeEngaged;
    A380PrimComputer_B.BusAssignment_jy.logic.right_spoiler_hydraulic_mode_avail = rightSpoilerHydraulicModeAvail;
    A380PrimComputer_B.BusAssignment_jy.logic.right_spoiler_electric_mode_avail = rightSpoilerElectricModeAvail;
    A380PrimComputer_B.BusAssignment_jy.logic.right_spoiler_hydraulic_mode_engaged =
      rtb_rightSpoilerHydraulicModeEngaged;
    A380PrimComputer_B.BusAssignment_jy.logic.right_spoiler_electric_mode_engaged = rtb_rightSpoilerElectricModeEngaged;
    A380PrimComputer_B.BusAssignment_jy.logic.rudder_1_hydraulic_mode_avail = rudder1HydraulicModeAvail;
    A380PrimComputer_B.BusAssignment_jy.logic.rudder_1_electric_mode_avail = rudder1ElectricModeAvail;
    A380PrimComputer_B.BusAssignment_jy.logic.rudder_1_hydraulic_mode_engaged = rtb_AND_n;
    A380PrimComputer_B.BusAssignment_jy.logic.rudder_1_electric_mode_engaged = rtb_AND6_o;
    A380PrimComputer_B.BusAssignment_jy.logic.rudder_2_hydraulic_mode_avail = rudder1HydraulicModeHasPriority;
    A380PrimComputer_B.BusAssignment_jy.logic.rudder_2_electric_mode_avail = rtb_AND3;
    A380PrimComputer_B.BusAssignment_jy.logic.rudder_2_hydraulic_mode_engaged = rtb_rudder2HydraulicModeEngaged;
    A380PrimComputer_B.BusAssignment_jy.logic.rudder_2_electric_mode_engaged = rtb_AND2_jo;
    A380PrimComputer_B.BusAssignment_jy.logic.aileron_droop_active =
      rtP_prim_logic_output_MATLABStruct.aileron_droop_active;
    A380PrimComputer_B.BusAssignment_jy.logic.aileron_antidroop_active =
      rtP_prim_logic_output_MATLABStruct.aileron_antidroop_active;
    A380PrimComputer_B.BusAssignment_jy.logic.ths_automatic_mode_active =
      rtP_prim_logic_output_MATLABStruct.ths_automatic_mode_active;
    A380PrimComputer_B.BusAssignment_jy.logic.ths_manual_mode_c_deg_s =
      rtP_prim_logic_output_MATLABStruct.ths_manual_mode_c_deg_s;
    A380PrimComputer_B.BusAssignment_jy.logic.is_yellow_hydraulic_power_avail =
      rtb_BusAssignment_hi_logic_is_yellow_hydraulic_power_avail;
    A380PrimComputer_B.BusAssignment_jy.logic.is_green_hydraulic_power_avail =
      rtb_BusAssignment_hi_logic_is_green_hydraulic_power_avail;
    A380PrimComputer_B.BusAssignment_jy.logic.eha_ebha_elec_mode_inhibited = rtb_OR;
    A380PrimComputer_B.BusAssignment_jy.logic.left_sidestick_disabled = A380PrimComputer_DWork.pLeftStickDisabled;
    A380PrimComputer_B.BusAssignment_jy.logic.right_sidestick_disabled = A380PrimComputer_DWork.pRightStickDisabled;
    A380PrimComputer_B.BusAssignment_jy.logic.left_sidestick_priority_locked = rtb_DataTypeConversion_dj;
    A380PrimComputer_B.BusAssignment_jy.logic.right_sidestick_priority_locked = rtb_DataTypeConversion_gf;
    A380PrimComputer_B.BusAssignment_jy.logic.total_sidestick_pitch_command = rtb_right_spoiler_2_deg;
    A380PrimComputer_B.BusAssignment_jy.logic.total_sidestick_roll_command = u0;
    A380PrimComputer_B.BusAssignment_jy.logic.speed_brake_inhibited = rtb_NOT_k3;
    A380PrimComputer_B.BusAssignment_jy.logic.ap_authorised = rtb_AND11_m;
    A380PrimComputer_B.BusAssignment_jy.logic.protection_ap_disconnect = rtb_AND19;
    A380PrimComputer_B.BusAssignment_jy.logic.high_alpha_prot_active = A380PrimComputer_DWork.sProtActive_g;
    A380PrimComputer_B.BusAssignment_jy.logic.alpha_prot_deg = rtb_BusAssignment_d_logic_alpha_prot_deg;
    A380PrimComputer_B.BusAssignment_jy.logic.alpha_max_deg = rtb_Gain_p;
    A380PrimComputer_B.BusAssignment_jy.logic.high_speed_prot_active = A380PrimComputer_DWork.sProtActive;
    A380PrimComputer_B.BusAssignment_jy.logic.high_speed_prot_lo_thresh_kn = rtb_handleIndex;
    A380PrimComputer_B.BusAssignment_jy.logic.high_speed_prot_hi_thresh_kn = std::fmin
      (A380PrimComputer_P.Constant7_Value_g, rtb_Y_i);
    A380PrimComputer_B.BusAssignment_jy.logic.double_adr_failure = rtb_OR_ou;
    A380PrimComputer_B.BusAssignment_jy.logic.triple_adr_failure = rtb_OR_a;
    A380PrimComputer_B.BusAssignment_jy.logic.cas_or_mach_disagree = A380PrimComputer_P.Constant1_Value_b;
    A380PrimComputer_B.BusAssignment_jy.logic.alpha_disagree = A380PrimComputer_P.Constant1_Value_b;
    A380PrimComputer_B.BusAssignment_jy.logic.double_ir_failure =
      A380PrimComputer_B.BusAssignment_n.logic.double_ir_failure;
    A380PrimComputer_B.BusAssignment_jy.logic.triple_ir_failure =
      A380PrimComputer_B.BusAssignment_n.logic.triple_ir_failure;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_failure_not_self_detected = A380PrimComputer_P.Constant_Value_ad;
    A380PrimComputer_B.BusAssignment_jy.logic.adr_computation_data.V_ias_kn = rtb_V_ias;
    A380PrimComputer_B.BusAssignment_jy.logic.adr_computation_data.V_tas_kn = rtb_V_tas;
    A380PrimComputer_B.BusAssignment_jy.logic.adr_computation_data.mach = rtb_mach;
    A380PrimComputer_B.BusAssignment_jy.logic.adr_computation_data.alpha_deg = rtb_Y;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_computation_data.theta_deg = rtb_alpha;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_computation_data.phi_deg = rtb_phi;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_computation_data.q_deg_s = rtb_q;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_computation_data.r_deg_s = rtb_r;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_computation_data.n_x_g = rtb_n_x;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_computation_data.n_y_g = rtb_n_y;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_computation_data.n_z_g = rtb_n_z;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_computation_data.theta_dot_deg_s = rtb_theta_dot;
    A380PrimComputer_B.BusAssignment_jy.logic.ir_computation_data.phi_dot_deg_s = rtb_phi_dot;
    A380PrimComputer_B.BusAssignment_jy.logic.ra_computation_data_ft = rtb_raComputationValue;
    A380PrimComputer_B.BusAssignment_jy.logic.all_ra_failure = rtb_OR_ll;
    A380PrimComputer_B.BusAssignment_jy.logic.all_sfcc_lost = rtb_OR_lu;
    A380PrimComputer_B.BusAssignment_jy.logic.flap_handle_index = rtb_Switch_g_idx_0;
    A380PrimComputer_B.BusAssignment_jy.logic.flap_angle_deg = rtb_Switch_g_idx_1;
    A380PrimComputer_B.BusAssignment_jy.logic.slat_angle_deg = rtb_Switch_g_idx_2;
    A380PrimComputer_B.BusAssignment_jy.logic.slat_flap_actual_pos = rtb_Switch_g_idx_3;
    A380PrimComputer_B.BusAssignment_jy.logic.double_lgciu_failure = rtb_Equal;
    A380PrimComputer_B.BusAssignment_jy.logic.slats_locked = rtb_BusAssignment_logic_slats_locked;
    A380PrimComputer_B.BusAssignment_jy.logic.flaps_locked = rtb_BusAssignment_logic_flaps_locked;
    A380PrimComputer_B.BusAssignment_jy.logic.landing_gear_down = rtb_OR3_m;
    A380PrimComputer_B.BusAssignment_jy.fg_logic = rtP_prim_fg_logic_output_MATLABStruct;
    A380PrimComputer_B.BusAssignment_jy.discrete_outputs = rtP_prim_discrete_output_MATLABStruct;
    A380PrimComputer_B.BusAssignment_jy.analog_outputs = rtP_prim_analog_output_MATLABStruct;
    A380PrimComputer_B.BusAssignment_jy.bus_outputs = A380PrimComputer_P.Constant4_Value;
    A380PrimComputer_B.BusAssignment_jy.logic.ground_spoilers_armed = rtb_NOT_k;
    A380PrimComputer_B.BusAssignment_jy.logic.ground_spoilers_out = A380PrimComputer_DWork.Delay1_DSTATE_b;
    A380PrimComputer_OtherRAselection(&A380PrimComputer_B.BusAssignment_jy, &rtb_left_inboard_aileron_command_deg);
    Double2MultiWord(A380PrimComputer_U.in.temporary_ap_input.lateral_mode_armed, &tmp_2.chunks[0U], 2);
    tmp_3 = tmp_6;
    MultiWordAnd(&tmp_2.chunks[0U], &tmp_6.chunks[0U], &tmp_1.chunks[0U], 2);
    rtb_OR_lu = (A380PrimComputer_U.in.temporary_ap_input.ap_1_engaged && (uMultiWordNe(&tmp_1.chunks[0U],
      &tmp_5.chunks[0U], 2) || (A380PrimComputer_U.in.temporary_ap_input.lateral_mode == 32.0)));
    Double2MultiWord(A380PrimComputer_U.in.temporary_ap_input.lateral_mode_armed, &tmp_4.chunks[0U], 2);
    MultiWordAnd(&tmp_4.chunks[0U], &tmp_6.chunks[0U], &tmp_3.chunks[0U], 2);
    rtb_y_a = (A380PrimComputer_U.in.temporary_ap_input.ap_2_engaged && (uMultiWordNe(&tmp_3.chunks[0U], &tmp_5.chunks
      [0U], 2) || (A380PrimComputer_U.in.temporary_ap_input.lateral_mode == 32.0)));
    ...
    if (A380PrimComputer_a429_bitValueOr(A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word.SSM,
      ...
      rtb_y_jb = A380PrimComputer_a429_bitValueOr(A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word.SSM,
        A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word.Data);
    }

    rtb_y_i = (rtb_lateralLawCapability == a380_lateral_efcs_law::NormalLaw);
    b_nz = rtb_BusAssignment_hi_logic_is_yellow_hydraulic_power_avail +
      rtb_BusAssignment_hi_logic_is_green_hydraulic_power_avail;
    prim3LawCap = A380PrimComputer_U.in.discrete_inputs.fws_1_audio_function +
    ...
    rtb_TmpSignalConversionAtSFunctionInport6_idx_2 = ((A380PrimComputer_U.in.bus_inputs.lgciu_1_bus.discrete_word_1.SSM
      ...
      NormalOperation)) >= 1);
    rtb_BusAssignment_logic_slats_locked = (leftSpoilerHydraulicModeAvail || leftSpoilerElectricModeAvail);
    rtb_DataTypeConversion_m2 = rtb_BusAssignment_logic_slats_locked;
    ...
    tmp[1] = A380PrimComputer_a429_bitValueOr_h(A380PrimComputer_U.in.bus_inputs.ir_2_bus.discrete_word_1.SSM,
      A380PrimComputer_U.in.bus_inputs.ir_2_bus.discrete_word_1.Data);
    tmp[2] = A380PrimComputer_a429_bitValueOr_h(A380PrimComputer_U.in.bus_inputs.ir_3_bus.discrete_word_1.SSM,
      A380PrimComputer_U.in.bus_inputs.ir_3_bus.discrete_word_1.Data);
    f_nz = combineVectorElements_N0KSVqzt(tmp);
    rtb_BusAssignment_logic_flaps_locked = ((nz >= 1) && rtb_y_jb && rtb_y_i && (b_nz >= 1) &&
      A380PrimComputer_U.in.discrete_inputs.fcu_healthy && (prim3LawCap >= 1) && (d_nz >= 1) &&
      rtb_TmpSignalConversionAtSFunctionInport6_idx_2 && rtb_BusAssignment_logic_slats_locked && (e_nz >= 2) && (f_nz >=
      2));
    tmp[0] = (A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.SSM == static_cast<uint32_T>(SignStatusMatrix::
               NormalOperation));
    tmp[1] = (A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.SSM == static_cast<uint32_T>(SignStatusMatrix::
               NormalOperation));
    ...
    tmp_0[2] = A380PrimComputer_U.in.discrete_inputs.is_engine_operative_3;
    tmp_0[3] = A380PrimComputer_U.in.discrete_inputs.is_engine_operative_4;
    h_nz = combineVectorElements_iJqADVYL(tmp_0);
    rtb_BusAssignment_logic_slats_locked = (rtb_BusAssignment_logic_flaps_locked && (g_nz >= 1) &&
      (A380PrimComputer_U.in.discrete_inputs.is_engine_operative_1 ||
       A380PrimComputer_U.in.discrete_inputs.is_engine_operative_2) &&
      (A380PrimComputer_U.in.discrete_inputs.is_engine_operative_3 ||
       A380PrimComputer_U.in.discrete_inputs.is_engine_operative_4));
    rtb_BusAssignment_logic_flaps_locked = (rtb_BusAssignment_logic_flaps_locked && (g_nz == 2) && (h_nz >= 3));
    rtb_TmpSignalConversionAtSFunctionInport6_idx_2 = ((nz >= 2) && rtb_y_jb && rtb_y_i && (b_nz == 2) &&
      ...
      (A380PrimComputer_U.in.discrete_inputs.every_dc_supplied_by_tr != 0.0));
    rtb_AND12 = (A380PrimComputer_DWork.pLand3FailOp || (rtb_TmpSignalConversionAtSFunctionInport6_idx_2 && rtb_OR_lu &&
      rtb_y_a && A380PrimComputer_U.in.temporary_ap_input.athr_engaged));
    b_tmp = !rtb_AND12;
    b = (A380PrimComputer_DWork.pLand3FailPass || (rtb_BusAssignment_logic_flaps_locked && rtb_OR_lu &&
          A380PrimComputer_U.in.temporary_ap_input.athr_engaged && b_tmp));
    if ((rtb_raComputationValue < 200.0F) && (rtb_OR_lu || rtb_y_a)) {
      A380PrimComputer_DWork.pLand3FailOp = rtb_AND12;
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_NOT_k);
    A380PrimComputer_B.BusAssignment_nw.logic.aileron_droop_active = ((rtb_y_a && rtb_y_jb) || ((rtb_y_k1 == 0U) &&
      rtb_NOT_k));
    ...
    A380PrimComputer_MATLABFunction_f(rudder2HydraulicModeHasPriority, A380PrimComputer_P.PulseNode2_isRisingEdge,
      &rtb_y_jb, &A380PrimComputer_DWork.sf_MATLABFunction_dmh);
    A380PrimComputer_DWork.Memory_PreviousInput_d = A380PrimComputer_P.Logic_table_j[(((static_cast<uint32_T>
      (rtb_DataTypeConversion_m2) << 1) + (rtb_y_jb || A380PrimComputer_DWork.Delay_DSTATE_e)) << 1) +
    ...
    if ((rtb_y_e != 0U) && rtb_DataTypeConversion_m2) {
      rtb_Switch_j_0 = &A380PrimComputer_U.in.bus_inputs.prim_x_bus.discrete_status_word_1;
    } else {
      rtb_Switch_j_0 = &A380PrimComputer_U.in.bus_inputs.prim_y_bus.discrete_status_word_1;
    }

    A380PrimComputer_MATLABFunction_e(rtb_Switch_j_0, A380PrimComputer_P.BitfromLabel3_bit_gv, &rtb_y_e);
    if (rtb_AND18_c) {
      rtb_y_jb = (rtb_AND20 && (rtb_law_j != A380PrimComputer_P.EnumeratedConstant_Value_l));
    } else {
      rtb_y_jb = ((rtb_y_e != 0U) && (rtb_Switch_j_0->SSM == static_cast<uint32_T>(SignStatusMatrix::NormalOperation)));
    }

    A380PrimComputer_DWork.Delay_DSTATE_e = A380PrimComputer_P.Logic_table_n[(((rtb_y_jb || (std::abs(rtb_thsPos) <=
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_i);
    rtb_y_i = (((!rtb_NOT_k) || (rtb_Switch29 == 0U)) && rtb_y_i);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
    ...
    if (rtb_y_i || (rtb_y_a && ((!rtb_NOT_k) || (rtb_Switch29 == 0U)))) {
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.tracking_mode_on = rtb_OR_n;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_1_engaged = rtb_AND13;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_2_engaged = rtb_AND17;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_3_engaged = rtb_AND4_d;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_4_engaged = rtb_AND7;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_5_engaged = rtb_AND8;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_6_engaged = rtb_AND15;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_7_engaged = rtb_AND16;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_8_engaged = rtb_AND9_o;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.left_inboard_elevator_engaged = rtb_AND2_b;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.right_inboard_elevator_engaged = rtb_AND1_at;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.left_outboard_elevator_engaged = rtb_AND5_e;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.right_outboard_elevator_engaged = rtb_AND4_fg3;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.ths_engaged = rtb_AND1_b;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.upper_rudder_engaged = rtb_AND3_h;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.lower_rudder_engaged = rtb_AND15_l;
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_inboard_aileron_deg = rtb_leftInboardAilPos;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.right_spoiler_3_deg =
      A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data;
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_spoiler_4_deg = rtb_leftSplr4Pos;
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.right_spoiler_4_deg = rtb_rightSplr4Pos;
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_spoiler_5_deg = rtb_leftSplr5Pos;
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.right_spoiler_5_deg = rtb_rightSplr5Pos;
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_spoiler_6_deg = rtb_leftSplr6Pos;
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.right_spoiler_6_deg = rtb_rightSplr6Pos;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.right_spoiler_8_deg =
      A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.Data;
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.upper_rudder_deg = rtb_handleIndex_f;
    A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.lower_rudder_deg = rtb_lowerRudderPos;
    A380PrimComputer_B.BusAssignment_nw.logic.pitch_surface_positions.left_inboard_elevator_deg = rtb_leftInboardElevPos;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.abnormal_condition_law_active = rtb_AND16_n;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.elevator_3_avail = rtb_y_la;
    A380PrimComputer_B.BusAssignment_nw.logic.elevator_3_engaged = rtb_y_jk;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.left_aileron_2_avail = leftAileron2Avail;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.total_sidestick_roll_command = u0;
    A380PrimComputer_B.BusAssignment_nw.logic.speed_brake_inhibited = rtb_NOT_k3;
    A380PrimComputer_B.BusAssignment_nw.logic.ground_spoilers_armed =
      A380PrimComputer_B.BusAssignment_jy.logic.ground_spoilers_armed;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.phased_lift_dumping_active =
      A380PrimComputer_B.BusAssignment_jy.logic.phased_lift_dumping_active;
    A380PrimComputer_B.BusAssignment_nw.logic.spoiler_lift_active =
      A380PrimComputer_B.BusAssignment_jy.logic.spoiler_lift_active;
    A380PrimComputer_B.BusAssignment_nw.logic.ap_authorised = rtb_AND11_m;
    A380PrimComputer_B.BusAssignment_nw.logic.protection_ap_disconnect = rtb_AND19;
    A380PrimComputer_B.BusAssignment_nw.logic.high_alpha_prot_active = A380PrimComputer_DWork.sProtActive_g;
    A380PrimComputer_B.BusAssignment_nw.logic.alpha_prot_deg = rtb_BusAssignment_d_logic_alpha_prot_deg;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.high_speed_prot_hi_thresh_kn = std::fmin
      (A380PrimComputer_P.Constant7_Value_g, rtb_Y_i);
    A380PrimComputer_B.BusAssignment_nw.logic.double_adr_failure = rtb_OR_ou;
    A380PrimComputer_B.BusAssignment_nw.logic.triple_adr_failure = rtb_OR_a;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.double_ir_failure =
      A380PrimComputer_B.BusAssignment_n.logic.double_ir_failure;
    A380PrimComputer_B.BusAssignment_nw.logic.triple_ir_failure =
      A380PrimComputer_B.BusAssignment_n.logic.triple_ir_failure;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.all_ra_failure = rtb_OR_ll;
    A380PrimComputer_B.BusAssignment_nw.logic.all_sfcc_lost = A380PrimComputer_B.BusAssignment_n.logic.all_sfcc_lost;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.double_lgciu_failure = rtb_Equal;
    A380PrimComputer_B.BusAssignment_nw.logic.slats_locked = A380PrimComputer_B.BusAssignment_n.logic.slats_locked;
    A380PrimComputer_B.BusAssignment_nw.logic.flaps_locked = A380PrimComputer_B.BusAssignment_n.logic.flaps_locked;
    A380PrimComputer_B.BusAssignment_nw.logic.landing_gear_down = rtb_OR3_m;
    A380PrimComputer_B.BusAssignment_nw.fg_logic.land_2_capability = (rtb_BusAssignment_logic_slats_locked && rtb_OR_lu &&
      (!b) && b_tmp);
    A380PrimComputer_B.BusAssignment_nw.fg_logic.land_3_fail_passive_capability = b;
    A380PrimComputer_B.BusAssignment_nw.fg_logic.land_3_fail_op_capability = rtb_AND12;
    A380PrimComputer_B.BusAssignment_nw.fg_logic.land_2_inop = !rtb_BusAssignment_logic_slats_locked;
    A380PrimComputer_B.BusAssignment_nw.fg_logic.land_3_fail_passive_inop = !rtb_BusAssignment_logic_flaps_locked;
    A380PrimComputer_B.BusAssignment_nw.fg_logic.land_3_fail_op_inop = !rtb_TmpSignalConversionAtSFunctionInport6_idx_2;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.ths_automatic_mode_active = rtb_y_jb;
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.aileron_droop_active) {
      u0 = A380PrimComputer_P.Constant2_Value;
    } else {
      u0 = A380PrimComputer_P.Constant1_Value;
    }

    A380PrimComputer_RateLimiter(u0, A380PrimComputer_P.RateLimiterVariableTs2_up,
      A380PrimComputer_P.RateLimiterVariableTs2_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_P.RateLimiterVariableTs2_InitialCondition, &rtb_Y_i, &A380PrimComputer_DWork.sf_RateLimiter);
    if (A380PrimComputer_B.BusAssignment_nw.logic.aileron_antidroop_active) {
      u0 = A380PrimComputer_P.Constant4_Value_a;
    } else {
      u0 = A380PrimComputer_P.Constant3_Value;
    }

    A380PrimComputer_RateLimiter(u0, A380PrimComputer_P.RateLimiterVariableTs3_up,
      A380PrimComputer_P.RateLimiterVariableTs3_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_P.RateLimiterVariableTs3_InitialCondition, &rtb_thsPos, &A380PrimComputer_DWork.sf_RateLimiter_b);
    rtb_handleIndex = rtb_Y_i + rtb_thsPos;
    ...
    if ((rtb_y_k1 != 0U) && rtb_y_jb) {
      ...
      rtb_right_spoiler_3_command_deg_Data =
    ...
    switch (static_cast<int32_T>(A380PrimComputer_B.BusAssignment_nw.logic.active_lateral_law)) {
     case 0:
      rtb_leftInboardAilPos = rtb_xi_midboard_deg;
      break;

     case 1:
      rtb_leftInboardAilPos = rtb_xi_midboard_deg_a;
      break;

     default:
      rtb_leftInboardAilPos = A380PrimComputer_P.Constant_Value_c;
      break;
    }

    rtb_right_spoiler_2_deg = A380PrimComputer_P.Gain3_Gain * rtb_leftInboardAilPos + rtb_handleIndex;
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_rightInboardAilPos = rtb_Y_i;
    } else {
      rtb_rightInboardAilPos = rtb_Switch_g_idx_2;
    }

    rtb_right_spoiler_2_deg = rtb_handleIndex + rtb_leftInboardAilPos;
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_leftInboardAilPos = rtb_Y_i;
    } else {
      rtb_leftInboardAilPos = rtb_Switch_g_idx_3;
    }

    rtb_Gain_p = std::fmax(std::fmin(-(A380PrimComputer_B.BusAssignment_nw.logic.adr_computation_data.V_ias_kn - 240.0) /
      20.0, 1.0), 0.0) * 20.0;
    rtb_rightMidboardAilPos = std::fmax(std::fmin
      (-(A380PrimComputer_B.BusAssignment_nw.logic.adr_computation_data.V_ias_kn - 300.0) / 20.0, 1.0), 0.0) * -30.0;
    switch (static_cast<int32_T>(A380PrimComputer_B.BusAssignment_nw.logic.active_lateral_law)) {
     case 0:
    ...
    rtb_leftMidboardAilPos = A380PrimComputer_P.Gain4_Gain * rtb_right_spoiler_2_deg + rtb_handleIndex;
    if (rtb_leftMidboardAilPos > rtb_Gain_p) {
      rtb_leftMidboardAilPos = rtb_Gain_p;
    } else if (rtb_leftMidboardAilPos < rtb_rightMidboardAilPos) {
      rtb_leftMidboardAilPos = rtb_rightMidboardAilPos;
    }

    A380PrimComputer_RateLimiter_a(rtb_leftMidboardAilPos, A380PrimComputer_P.RateLimiterGenericVariableTs4_up,
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_leftMidboardAilPos = rtb_Y_i;
    } else {
      rtb_leftMidboardAilPos = rtb_V_ias;
    }

    rtb_handleIndex += rtb_right_spoiler_2_deg;
    if (rtb_handleIndex > rtb_Gain_p) {
      rtb_handleIndex = rtb_Gain_p;
    } else if (rtb_handleIndex < rtb_rightMidboardAilPos) {
      rtb_handleIndex = rtb_rightMidboardAilPos;
    }
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.phased_lift_dumping_active) {
      u0 = A380PrimComputer_P.Constant5_Value;
    } else {
      u0 = A380PrimComputer_P.Constant6_Value;
    }

    A380PrimComputer_RateLimiter(u0, A380PrimComputer_P.RateLimiterVariableTs4_up,
      A380PrimComputer_P.RateLimiterVariableTs4_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_P.RateLimiterVariableTs4_InitialCondition, &rtb_thsPos, &A380PrimComputer_DWork.sf_RateLimiter_c);
    if (A380PrimComputer_B.BusAssignment_nw.logic.ground_spoilers_out) {
      u0 = A380PrimComputer_P.Constant_Value;
    } else {
      u0 = rtb_thsPos;
    }

    A380PrimComputer_RateLimiter(u0, A380PrimComputer_P.RateLimiterVariableTs6_up,
      A380PrimComputer_P.RateLimiterVariableTs6_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_P.RateLimiterVariableTs6_InitialCondition, &rtb_thsPos, &A380PrimComputer_DWork.sf_RateLimiter_g);
    rtb_right_spoiler_2_deg = A380PrimComputer_P.Gain5_Gain * rtb_thsPos;
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.spoiler_lift_active) {
      u0 = A380PrimComputer_P.Constant9_Value;
    } else {
      u0 = A380PrimComputer_P.Constant8_Value_d;
    }

    A380PrimComputer_RateLimiter_m(u0, A380PrimComputer_P.RateLimiterGenericVariableTs25_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs25_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
    ...
    rtb_leftSplr4Pos = std::fmin(rtb_Y_i * rtb_handleIndex_f, rtb_Gain_g);
    if (rtb_NOT_k) {
      u0 = rtb_right_spoiler_2_deg;
    } else {
      u0 = rtb_leftSplr4Pos;
    }

    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs8_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs8_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_spoiler_1_deg,
      ((!A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_1_engaged) ||
       (!A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim)), &rtb_Y_i, &A380PrimComputer_DWork.sf_RateLimiter_j4);
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_rightMidboardAilPos = rtb_Y_i;
    } else {
      rtb_rightMidboardAilPos = rtb_mach;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs9_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs9_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.right_spoiler_1_deg,
      ((!A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_1_engaged) ||
       (!A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim)), &rtb_Y_i, &A380PrimComputer_DWork.sf_RateLimiter_cd);
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_leftOutboardAilPos = rtb_Y_i;
    } else {
      rtb_leftOutboardAilPos = rtb_alpha;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs10_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs10_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_spoiler_2_deg,
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_rightOutboardAilPos = rtb_Y_i;
    } else {
      rtb_rightOutboardAilPos = rtb_phi;
    }

    if (rtb_NOT_k) {
      rtb_leftSplr4Pos = rtb_right_spoiler_2_deg;
    }

    A380PrimComputer_RateLimiter_a(rtb_leftSplr4Pos, A380PrimComputer_P.RateLimiterGenericVariableTs11_up,
    ...
    switch (static_cast<int32_T>(A380PrimComputer_B.BusAssignment_nw.logic.active_lateral_law)) {
     case 0:
      rtb_leftInboardElevPos = rtb_xi_spoiler_deg;
      break;

     case 1:
      rtb_leftInboardElevPos = rtb_xi_spoiler_deg_i;
      break;

     default:
      rtb_leftInboardElevPos = A380PrimComputer_P.Constant_Value_c;
      break;
    }
    ...
    A380PrimComputer_Spoiler345Computation(rtb_leftInboardElevPos, std::fmin(rtb_Y_i * rtb_handleIndex_f, rtb_Gain_g),
      &rtb_Y_i, &rtb_Gain_p);
    if (rtb_NOT_k) {
      u0 = rtb_thsPos;
    } else {
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs14_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs14_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_spoiler_3_deg,
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_leftSplr4Pos = rtb_handleIndex_d;
    } else {
      rtb_leftSplr4Pos = rtb_r;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs15_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs15_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.right_spoiler_3_deg,
      ((!A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_3_engaged) ||
       (!A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim)), &rtb_handleIndex_d,
      &A380PrimComputer_DWork.sf_RateLimiter_nh);
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_rightSplr4Pos = rtb_handleIndex_d;
    } else {
      rtb_rightSplr4Pos = rtb_n_x;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs12_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs12_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_leftSplr5Pos = rtb_handleIndex_d;
    } else {
      rtb_leftSplr5Pos = rtb_n_y;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs13_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs13_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_rightSplr5Pos = rtb_handleIndex_d;
    } else {
      rtb_rightSplr5Pos = rtb_n_z;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs18_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs18_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      ...
      ((!A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_5_engaged) ||
       (!A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim)), &rtb_Y_i, &A380PrimComputer_DWork.sf_RateLimiter_n2);
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_leftSplr6Pos = rtb_Y_i;
    } else {
      rtb_leftSplr6Pos = rtb_theta_dot;
    }

    if (rtb_NOT_k) {
      rtb_Gain_p = rtb_thsPos;
    }
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_rightSplr6Pos = rtb_Y_i;
    } else {
      rtb_rightSplr6Pos = rtb_phi_dot;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs16_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs16_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_leftInboardElevPos = rtb_Gain_g;
    } else {
      rtb_leftInboardElevPos = rtb_raComputationValue;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs17_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs17_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_rightInboardElevPos = rtb_Gain_g;
    } else {
      rtb_rightInboardElevPos = rtb_right_spoiler_3_command_deg_Data;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs22_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs22_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_spoiler_7_deg,
      ((!A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_7_engaged) ||
       (!A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim)), &rtb_Gain_g,
      &A380PrimComputer_DWork.sf_RateLimiter_i);
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_leftOutboardElevPos = rtb_Gain_g;
    } else {
      rtb_leftOutboardElevPos = rtb_left_spoiler_4_command_deg_Data;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs23_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs23_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.right_spoiler_7_deg,
      ((!A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_7_engaged) ||
       (!A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim)), &rtb_Gain_g,
      &A380PrimComputer_DWork.sf_RateLimiter_f1);
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_rightOutboardElevPos = rtb_Gain_g;
    } else {
      rtb_rightOutboardElevPos = rtb_right_spoiler_4_command_deg_Data;
    }
    ...
    A380PrimComputer_RateLimiter_a(u0, A380PrimComputer_P.RateLimiterGenericVariableTs20_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs20_lo, A380PrimComputer_B.BusAssignment_nw.data.time.dt,
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_spoiler_8_deg,
      ((!A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_8_engaged) ||
       (!A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim)), &rtb_Y_i, &A380PrimComputer_DWork.sf_RateLimiter_gm);
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      u0 = rtb_Y_i;
    } else {
      u0 = rtb_left_spoiler_5_command_deg_Data;
    }
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      ...
      rtb_thsPos = rtb_right_spoiler_5_command_deg_Data;
    }
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim) {
      rtb_lowerRudderPos = rtb_Y_i;
    } else {
      rtb_lowerRudderPos = rtb_left_spoiler_6_command_deg_Data;
    }
    ...
    if (A380PrimComputer_B.BusAssignment_nw.logic.ths_automatic_mode_active) {
      rtb_AND1_b = ((!A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.ths_engaged) ||
                    (!A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim));
    } else {
      rtb_AND1_b = !A380PrimComputer_B.BusAssignment_nw.logic.ths_engaged;
    }

    A380PrimComputer_DWork.icLoad = (rtb_AND1_b || A380PrimComputer_DWork.icLoad);
    ...
    A380PrimComputer_B.BusAssignment_n = A380PrimComputer_B.BusAssignment_nw;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_inboard_aileron_deg = rtb_Y;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_inboard_aileron_deg =
      rtb_right_inboard_aileron_deg;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_midboard_aileron_deg = rtb_rightInboardAilPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_midboard_aileron_deg = rtb_leftInboardAilPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_outboard_aileron_deg = rtb_leftMidboardAilPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_outboard_aileron_deg = rtb_handleIndex;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_spoiler_1_deg = rtb_rightMidboardAilPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_spoiler_1_deg = rtb_leftOutboardAilPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_spoiler_2_deg = rtb_rightOutboardAilPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_spoiler_2_deg = rtb_right_spoiler_2_deg;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_spoiler_3_deg = rtb_leftSplr4Pos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_spoiler_3_deg = rtb_rightSplr4Pos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_spoiler_4_deg = rtb_leftSplr5Pos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_spoiler_4_deg = rtb_rightSplr5Pos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_spoiler_5_deg = rtb_leftSplr6Pos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_spoiler_5_deg = rtb_rightSplr6Pos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_spoiler_6_deg = rtb_leftInboardElevPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_spoiler_6_deg = rtb_rightInboardElevPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_spoiler_7_deg = rtb_leftOutboardElevPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_spoiler_7_deg = rtb_rightOutboardElevPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.left_spoiler_8_deg = u0;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.right_spoiler_8_deg = rtb_thsPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.upper_rudder_deg = rtb_lowerRudderPos;
    A380PrimComputer_B.BusAssignment_n.laws.lateral_law_outputs.lower_rudder_deg =
      rtb_BusAssignment_d_logic_alpha_prot_deg;
    A380PrimComputer_B.BusAssignment_n.laws.pitch_law_outputs.left_inboard_elevator_deg = rtb_Y_i;
    A380PrimComputer_B.BusAssignment_n.laws.pitch_law_outputs.right_inboard_elevator_deg = rtb_Gain_p;
    A380PrimComputer_B.BusAssignment_n.laws.pitch_law_outputs.left_outboard_elevator_deg = rtb_Gain_g;
    A380PrimComputer_B.BusAssignment_n.laws.pitch_law_outputs.right_outboard_elevator_deg = rtb_handleIndex_f;
    A380PrimComputer_B.BusAssignment_n.laws.pitch_law_outputs.ths_deg = rtb_handleIndex_d;
    if (A380PrimComputer_B.BusAssignment_n.data.discrete_inputs.is_unit_1) {
      rtb_Switch2_a = rtb_Y;
      rtb_rightAileron1Command = rtb_right_inboard_aileron_deg;
      rtb_leftAileron2Command = rtb_rightInboardAilPos;
      rtb_rightAileron2Command = rtb_leftInboardAilPos;
      rtb_elevator1Command = rtb_Gain_g;
      rtb_elevator2Command = rtb_Y_i;
      rtb_elevator3Command = rtb_handleIndex_f;
      rtb_rudder1Command = rtb_lowerRudderPos;
      rtb_rudder2Command = rtb_BusAssignment_d_logic_alpha_prot_deg;
      rtb_leftSpoilerCommand = rtb_leftInboardElevPos;
      rtb_rightSpoilerCommand = rtb_rightInboardElevPos;
    } else if (A380PrimComputer_B.BusAssignment_n.data.discrete_inputs.is_unit_2) {
      rtb_Switch2_a = rtb_leftMidboardAilPos;
      ...
      rtb_leftSpoilerCommand = rtb_leftSplr6Pos;
      rtb_rightSpoilerCommand = rtb_rightSplr6Pos;
    } else {
      rtb_Switch2_a = rtb_rightInboardAilPos;
      rtb_rightAileron1Command = rtb_leftInboardAilPos;
      rtb_leftAileron2Command = rtb_leftMidboardAilPos;
      ...
      rtb_rudder1Command = rtb_BusAssignment_d_logic_alpha_prot_deg;
      rtb_rudder2Command = 0.0;
      rtb_leftSpoilerCommand = rtb_leftSplr5Pos;
      rtb_rightSpoilerCommand = rtb_rightSplr5Pos;
    }

    rtb_Switch31 = static_cast<uint32_T>(A380PrimComputer_P.EnumeratedConstant_Value);
    if (A380PrimComputer_B.BusAssignment_n.logic.is_master_prim) {
      rtb_left_inboard_aileron_command_deg.Data = static_cast<real32_T>(rtb_Y);
      rtb_left_inboard_aileron_command_deg.SSM = static_cast<uint32_T>(A380PrimComputer_P.EnumeratedConstant1_Value);
      ...
      rtb_Switch_g_idx_1 = static_cast<real32_T>(rtb_lowerRudderPos);
      rtb_Switch31 = static_cast<uint32_T>(A380PrimComputer_P.EnumeratedConstant1_Value);
      rtb_Switch_g_idx_2 = static_cast<real32_T>(rtb_BusAssignment_d_logic_alpha_prot_deg);
    } else {
      rtb_left_inboard_aileron_command_deg.Data = A380PrimComputer_P.Constant20_Value;
      rtb_left_inboard_aileron_command_deg.SSM = static_cast<uint32_T>(A380PrimComputer_P.EnumeratedConstant_Value);
      ...
      rtb_raComputationValue = A380PrimComputer_P.Constant7_Value_a;
      rtb_left_spoiler_3_command_deg_SSM = static_cast<uint32_T>(A380PrimComputer_P.EnumeratedConstant_Value);
      rtb_right_spoiler_3_command_deg_Data = A380PrimComputer_P.Constant6_Value_a0;
    ...
    rtb_VectorConcatenate[0] = A380PrimComputer_B.BusAssignment_n.logic.left_aileron_1_avail;
    rtb_VectorConcatenate[1] = A380PrimComputer_B.BusAssignment_n.logic.left_aileron_1_engaged;
    rtb_VectorConcatenate[2] = A380PrimComputer_P.Constant16_Value;
    rtb_VectorConcatenate[3] = A380PrimComputer_B.BusAssignment_n.logic.right_aileron_1_avail;
    rtb_VectorConcatenate[4] = A380PrimComputer_B.BusAssignment_n.logic.right_aileron_1_engaged;
    rtb_VectorConcatenate[5] = A380PrimComputer_P.Constant16_Value;
    rtb_VectorConcatenate[6] = A380PrimComputer_B.BusAssignment_n.logic.left_aileron_2_avail;
    rtb_VectorConcatenate[7] = A380PrimComputer_B.BusAssignment_n.logic.left_aileron_2_engaged;
    rtb_VectorConcatenate[8] = A380PrimComputer_P.Constant16_Value;
    rtb_VectorConcatenate[9] = A380PrimComputer_B.BusAssignment_n.logic.right_aileron_2_avail;
    rtb_VectorConcatenate[10] = A380PrimComputer_B.BusAssignment_n.logic.right_aileron_2_engaged;
    ...
    rtb_VectorConcatenate[0] = A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_hydraulic_mode_avail;
    rtb_VectorConcatenate[1] = A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_electric_mode_avail;
    rtb_VectorConcatenate[2] = A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_hydraulic_mode_engaged;
    rtb_VectorConcatenate[3] = A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_electric_mode_engaged;
    rtb_VectorConcatenate[4] = A380PrimComputer_P.Constant17_Value;
    rtb_VectorConcatenate[5] = A380PrimComputer_P.Constant17_Value;
    rtb_VectorConcatenate[6] = A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_hydraulic_mode_avail;
    rtb_VectorConcatenate[7] = A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_electric_mode_avail;
    rtb_VectorConcatenate[8] = A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_hydraulic_mode_engaged;
    rtb_VectorConcatenate[9] = A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_electric_mode_engaged;
    ...
    rtb_VectorConcatenate[0] = A380PrimComputer_B.BusAssignment_n.logic.elevator_1_avail;
    rtb_VectorConcatenate[1] = A380PrimComputer_B.BusAssignment_n.logic.elevator_1_engaged;
    rtb_VectorConcatenate[2] = A380PrimComputer_P.Constant18_Value;
    rtb_VectorConcatenate[3] = A380PrimComputer_B.BusAssignment_n.logic.elevator_2_avail;
    rtb_VectorConcatenate[4] = A380PrimComputer_B.BusAssignment_n.logic.elevator_2_engaged;
    rtb_VectorConcatenate[5] = A380PrimComputer_P.Constant18_Value;
    rtb_VectorConcatenate[6] = A380PrimComputer_B.BusAssignment_n.logic.elevator_3_avail;
    rtb_VectorConcatenate[7] = A380PrimComputer_B.BusAssignment_n.logic.elevator_3_engaged;
    rtb_VectorConcatenate[8] = A380PrimComputer_P.Constant18_Value;
    rtb_VectorConcatenate[9] = A380PrimComputer_B.BusAssignment_n.logic.ths_avail;
    rtb_VectorConcatenate[10] = A380PrimComputer_B.BusAssignment_n.logic.ths_engaged;
    ...
    rtb_VectorConcatenate[0] = A380PrimComputer_B.BusAssignment_n.logic.rudder_1_hydraulic_mode_avail;
    rtb_VectorConcatenate[1] = A380PrimComputer_B.BusAssignment_n.logic.rudder_1_electric_mode_avail;
    rtb_VectorConcatenate[2] = A380PrimComputer_B.BusAssignment_n.logic.rudder_1_hydraulic_mode_engaged;
    rtb_VectorConcatenate[3] = A380PrimComputer_B.BusAssignment_n.logic.rudder_1_electric_mode_engaged;
    rtb_VectorConcatenate[4] = A380PrimComputer_P.Constant19_Value;
    rtb_VectorConcatenate[5] = A380PrimComputer_P.Constant19_Value;
    rtb_VectorConcatenate[6] = A380PrimComputer_B.BusAssignment_n.logic.rudder_2_hydraulic_mode_avail;
    rtb_VectorConcatenate[7] = A380PrimComputer_B.BusAssignment_n.logic.rudder_2_electric_mode_avail;
    rtb_VectorConcatenate[8] = A380PrimComputer_B.BusAssignment_n.logic.rudder_2_hydraulic_mode_engaged;
    rtb_VectorConcatenate[9] = A380PrimComputer_B.BusAssignment_n.logic.rudder_2_electric_mode_engaged;
    ...
    A380PrimComputer_MATLABFunction_b(A380PrimComputer_B.BusAssignment_n.logic.pitch_law_capability,
      &rtb_VectorConcatenate_ep[0], &rtb_VectorConcatenate_ep[1], &rtb_VectorConcatenate_ep[2]);
    A380PrimComputer_MATLABFunction2(A380PrimComputer_B.BusAssignment_n.logic.lateral_law_capability,
      &rtb_VectorConcatenate_ep[3], &rtb_VectorConcatenate_ep[4]);
    A380PrimComputer_MATLABFunction_b(A380PrimComputer_B.BusAssignment_n.logic.active_pitch_law,
      &rtb_VectorConcatenate_ep[5], &rtb_VectorConcatenate_ep[6], &rtb_VectorConcatenate_ep[7]);
    A380PrimComputer_MATLABFunction2(A380PrimComputer_B.BusAssignment_n.logic.active_lateral_law,
      &rtb_VectorConcatenate_ep[8], &rtb_VectorConcatenate_ep[9]);
    rtb_VectorConcatenate_ep[10] = A380PrimComputer_B.BusAssignment_n.logic.is_master_prim;
    ...
    rtb_VectorConcatenate_ep[0] = A380PrimComputer_B.BusAssignment_n.logic.ths_automatic_mode_active;
    ...
    rtb_VectorConcatenate_ep[0] = A380PrimComputer_B.BusAssignment_n.logic.ap_authorised;
    rtb_VectorConcatenate_ep[1] = A380PrimComputer_B.BusAssignment_n.logic.protection_ap_disconnect;
    ...
    rtb_VectorConcatenate_ep[0] = A380PrimComputer_B.BusAssignment_n.data.temporary_ap_input.ap_engaged;
    rtb_VectorConcatenate_ep[1] = A380PrimComputer_B.BusAssignment_n.data.temporary_ap_input.ap_engaged;
    rtb_VectorConcatenate_ep[2] = A380PrimComputer_P.Constant38_Value;
    ...
    rtb_VectorConcatenate_ep[5] = A380PrimComputer_B.BusAssignment_n.fg_logic.land_2_capability;
    rtb_VectorConcatenate_ep[6] = A380PrimComputer_B.BusAssignment_n.fg_logic.land_3_fail_passive_capability;
    rtb_VectorConcatenate_ep[7] = A380PrimComputer_B.BusAssignment_n.fg_logic.land_3_fail_op_capability;
    rtb_VectorConcatenate_ep[8] = A380PrimComputer_P.Constant37_Value;
    rtb_VectorConcatenate_ep[9] = A380PrimComputer_B.BusAssignment_n.fg_logic.land_2_inop;
    rtb_VectorConcatenate_ep[10] = A380PrimComputer_B.BusAssignment_n.fg_logic.land_3_fail_passive_inop;
    rtb_VectorConcatenate_ep[11] = A380PrimComputer_B.BusAssignment_n.fg_logic.land_3_fail_op_inop;
    ...
    A380PrimComputer_Y.out = A380PrimComputer_B.BusAssignment_n;
    A380PrimComputer_Y.out.discrete_outputs.elevator_1_active_mode =
      A380PrimComputer_B.BusAssignment_n.logic.elevator_1_engaged;
    A380PrimComputer_Y.out.discrete_outputs.elevator_2_active_mode =
      A380PrimComputer_B.BusAssignment_n.logic.elevator_2_engaged;
    A380PrimComputer_Y.out.discrete_outputs.elevator_3_active_mode =
      A380PrimComputer_B.BusAssignment_n.logic.elevator_3_engaged;
    A380PrimComputer_Y.out.discrete_outputs.ths_active_mode = A380PrimComputer_B.BusAssignment_n.logic.ths_engaged;
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.elevator_1_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.elevator_2_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.elevator_3_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.ths_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.left_aileron_1_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.left_aileron_2_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.right_aileron_1_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.right_aileron_2_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_electric_mode_engaged ||
        A380PrimComputer_B.BusAssignment_n.logic.left_spoiler_hydraulic_mode_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_electric_mode_engaged ||
        A380PrimComputer_B.BusAssignment_n.logic.right_spoiler_hydraulic_mode_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.rudder_1_electric_mode_engaged ||
        A380PrimComputer_B.BusAssignment_n.logic.rudder_1_hydraulic_mode_engaged) {
    ...
    if (A380PrimComputer_B.BusAssignment_n.logic.rudder_2_electric_mode_engaged ||
        A380PrimComputer_B.BusAssignment_n.logic.rudder_2_hydraulic_mode_engaged) {
    ...
    A380PrimComputer_Y.out.bus_outputs.left_inboard_aileron_command_deg = rtb_left_inboard_aileron_command_deg;
    A380PrimComputer_Y.out.bus_outputs.right_inboard_aileron_command_deg.SSM = rtb_y_k1;
    A380PrimComputer_Y.out.bus_outputs.right_inboard_aileron_command_deg.Data = rtb_alpha;
    A380PrimComputer_Y.out.bus_outputs.left_midboard_aileron_command_deg.SSM = rtb_DataTypeConversion1_j;
    A380PrimComputer_Y.out.bus_outputs.left_midboard_aileron_command_deg.Data = rtb_phi;
    A380PrimComputer_Y.out.bus_outputs.right_midboard_aileron_command_deg.SSM = rtb_y_e;
    ...
    A380PrimComputer_Y.out.bus_outputs.left_spoiler_3_command_deg.Data = rtb_raComputationValue;
    A380PrimComputer_Y.out.bus_outputs.right_spoiler_3_command_deg.SSM = rtb_right_spoiler_3_command_deg_SSM;
    A380PrimComputer_Y.out.bus_outputs.right_spoiler_3_command_deg.Data = rtb_right_spoiler_3_command_deg_Data;
    ...
    A380PrimComputer_Y.out.bus_outputs.left_sidestick_pitch_command_deg.Data = A380PrimComputer_P.Gain_Gain_k *
      static_cast<real32_T>(A380PrimComputer_B.BusAssignment_n.data.analog_inputs.capt_pitch_stick_pos);
    ...
    A380PrimComputer_Y.out.bus_outputs.right_sidestick_pitch_command_deg.Data = A380PrimComputer_P.Gain1_Gain_g *
      static_cast<real32_T>(A380PrimComputer_B.BusAssignment_n.data.analog_inputs.fo_pitch_stick_pos);
    ...
    A380PrimComputer_Y.out.bus_outputs.left_sidestick_roll_command_deg.Data = A380PrimComputer_P.Gain2_Gain *
      static_cast<real32_T>(A380PrimComputer_B.BusAssignment_n.data.analog_inputs.capt_roll_stick_pos);
    ...
    A380PrimComputer_Y.out.bus_outputs.right_sidestick_roll_command_deg.Data = A380PrimComputer_P.Gain3_Gain_e *
      static_cast<real32_T>(A380PrimComputer_B.BusAssignment_n.data.analog_inputs.fo_roll_stick_pos);
    ...
    A380PrimComputer_Y.out.bus_outputs.rudder_pedal_position_deg.Data = A380PrimComputer_P.Gain4_Gain_l *
      static_cast<real32_T>(A380PrimComputer_B.BusAssignment_n.data.analog_inputs.rudder_pedal_pos);
    ...
    A380PrimComputer_Y.out.bus_outputs.left_aileron_1_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.left_aileron_1_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.left_aileron_2_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.left_aileron_2_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.right_aileron_1_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.right_aileron_1_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.right_aileron_2_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.right_aileron_2_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.left_spoiler_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.left_spoiler_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.right_spoiler_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.right_spoiler_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.elevator_1_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.elevator_1_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.elevator_2_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.elevator_2_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.elevator_3_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.elevator_3_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.ths_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.ths_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.rudder_1_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.rudder_1_pos_deg);
    ...
    A380PrimComputer_Y.out.bus_outputs.rudder_2_position_deg.Data = static_cast<real32_T>
      (A380PrimComputer_B.BusAssignment_n.data.analog_inputs.rudder_2_pos_deg);
    A380PrimComputer_Y.out.bus_outputs.radio_height_1_ft =
      A380PrimComputer_B.BusAssignment_n.data.bus_inputs.ra_1_bus.radio_height_ft;
    A380PrimComputer_Y.out.bus_outputs.radio_height_2_ft =
      A380PrimComputer_B.BusAssignment_n.data.bus_inputs.ra_2_bus.radio_height_ft;
