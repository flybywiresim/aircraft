...
void A380PrimComputer::step()
{
  ...
  if (A380PrimComputer_U.in.sim_data.computer_running) {
    ...
    rtb_OR4 = ((A380PrimComputer_U.in.bus_inputs.adr_3_bus.mach.SSM == static_cast<uint32_T>(SignStatusMatrix::
      FailureWarning)) || (A380PrimComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM == static_cast<uint32_T>
               ...
               (A380PrimComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.SSM == static_cast<uint32_T>
                (SignStatusMatrix::FailureWarning)) || A380PrimComputer_P.Constant1_Value_b ||
               A380PrimComputer_P.Constant1_Value_b);
    rtb_LogicalOperator3 = (rtb_OR1 && rtb_OR3);
    rtb_Equal = (rtb_LogicalOperator3 || (rtb_OR1 && rtb_OR4) || (rtb_OR3 && rtb_OR4));
    rtb_OR_n = (rtb_LogicalOperator3 && rtb_OR4);
    ...
    rtb_rudder1HydraulicModeEngaged = !rtb_OR4;
    rtb_AND1_e = !rtb_OR3;
    rtb_rightAileron2Engaged = (rtb_OR1 && rtb_AND1_e);
    if (rtb_rightAileron2Engaged && rtb_rudder1HydraulicModeEngaged) {
    ...
    } else if ((!rtb_OR1) && rtb_OR3 && rtb_rudder1HydraulicModeEngaged) {
      ...
      rtb_alpha = (A380PrimComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data +
                   A380PrimComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.Data) / 2.0F;
    } else if (((!rtb_OR1) && rtb_AND1_e && rtb_rudder1HydraulicModeEngaged) || ((!rtb_OR1) && (!rtb_OR3) && rtb_OR4)) {
      rtb_V_ias = (A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data +
      ...
      rtb_mach = A380PrimComputer_U.in.bus_inputs.adr_1_bus.mach.Data;
      rtb_alpha = A380PrimComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data;
    } else if (rtb_rightAileron2Engaged && rtb_OR4) {
      rtb_V_ias = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.Data;
      rtb_V_tas = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
      rtb_mach = A380PrimComputer_U.in.bus_inputs.adr_2_bus.mach.Data;
      rtb_alpha = A380PrimComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
    } else if (rtb_LogicalOperator3 && rtb_rudder1HydraulicModeEngaged) {
    ...
    rtb_AND1_e = !rtb_OR7;
    rtb_rightAileron2Engaged = (rtb_OR && rtb_AND1_e);
    if (rtb_rightAileron2Engaged && rtb_rudder1HydraulicModeEngaged) {
    ...
    } else if ((!rtb_OR) && rtb_OR7 && rtb_rudder1HydraulicModeEngaged) {
    ...
    } else if (((!rtb_OR) && rtb_AND1_e && rtb_rudder1HydraulicModeEngaged) || ((!rtb_OR) && (!rtb_OR7) && rtb_OR6)) {
      rtb_alpha = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.Data +
                   A380PrimComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.Data) / 2.0F;
      rtb_phi = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.roll_angle_deg.Data +
                 A380PrimComputer_U.in.bus_inputs.ir_3_bus.roll_angle_deg.Data) / 2.0F;
      ...
      rtb_theta_dot = A380PrimComputer_U.in.bus_inputs.ir_1_bus.pitch_att_rate_deg_s.Data;
      rtb_phi_dot = A380PrimComputer_U.in.bus_inputs.ir_1_bus.roll_att_rate_deg_s.Data;
    } else if (rtb_rightAileron2Engaged && rtb_OR6) {
    ...
    } else if (rtb_doubleIrFault_tmp && rtb_rudder1HydraulicModeEngaged) {
      rtb_alpha = A380PrimComputer_U.in.bus_inputs.ir_2_bus.pitch_angle_deg.Data;
      rtb_phi = A380PrimComputer_U.in.bus_inputs.ir_2_bus.roll_angle_deg.Data;
      rtb_q = A380PrimComputer_U.in.bus_inputs.ir_2_bus.body_pitch_rate_deg_s.Data;
      rtb_r = A380PrimComputer_U.in.bus_inputs.ir_2_bus.body_yaw_rate_deg_s.Data;
    ...
    A380PrimComputer_MATLABFunction_c(((A380PrimComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data > 50.0F) &&
      ...
      NormalOperation)) && (rtb_V_ias > 200.0F) && rtb_OR1), A380PrimComputer_U.in.time.dt,
      A380PrimComputer_P.ConfirmNode1_isRisingEdge, A380PrimComputer_P.ConfirmNode1_timeDelay, &rtb_y_ls,
    ...
    A380PrimComputer_DWork.ra2CoherenceRejected = (rtb_y_ls || A380PrimComputer_DWork.ra2CoherenceRejected);
    ...
    rtb_OR4 = ((rtb_Switch29 == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
               A380PrimComputer_DWork.ra3CoherenceRejected);
    rtb_raComputationValue = 250.0F;
    switch ((!rtb_OR1 + !rtb_OR3) + !rtb_OR4) {
     case 3:
    ...
    rtb_OR1 = (rtb_OR1 && rtb_OR3 && rtb_OR4);
    ...
    rtb_y_h = (rtb_Switch31 != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.lgciu_1_bus.discrete_word_2,
      A380PrimComputer_P.BitfromLabel1_bit_jr, &rtb_Switch31);
    rtb_OR3 = (rtb_y_h || (rtb_Switch31 != 0U));
    ...
    rtb_y_h = ((rtb_OR3 && rtb_NOT_k) || ((rtb_y_h || (rtb_Switch31 != 0U)) && rtb_y_i));
    rtb_OR3 = ((!rtb_NOT_k) && (!rtb_y_i));
    ...
    rtb_OR4 = ((rtb_DataTypeConversion_m2 || rtb_y_ls || (rtb_Switch31 != 0U)) && rtb_y_i);
    ...
    rtb_LogicalOperator3 = (rtb_y_h && ((rtb_y_i || rtb_DataTypeConversion_m2 ||
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_OR = rtb_DataTypeConversion_m2;
    ...
    A380PrimComputer_MATLABFunction(rtb_Switch_ir_0, &rtb_y_mb);
    rtb_AND1_e = ((rtb_Switch31 != 0U) && rtb_y_mb);
    ...
    rtb_rudder2HydraulicModeEngaged = !rtb_LogicalOperator3;
    rtb_rightAileron2Engaged = (A380PrimComputer_U.in.discrete_inputs.is_unit_3 || rtb_rudder2HydraulicModeEngaged);
    rtb_AND1_e = (rtb_OR7 && ((!rtb_AND1_e) && rtb_rightAileron2Engaged));
    rtb_rightAileron2Engaged = (rtb_doubleIrFault_tmp && (((!rtb_y_mb) || (rtb_Switch31 == 0U)) &&
      rtb_rightAileron2Engaged));
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      leftSpoilerHydraulicModeAvail = rtb_y_i;
      A380PrimComputer_B.BusAssignment_nw.logic.left_spoiler_electric_mode_avail = true;
      rightSpoilerHydraulicModeAvail = rtb_y_i;
      A380PrimComputer_B.BusAssignment_nw.logic.right_spoiler_electric_mode_avail = true;
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
        ...
        A380PrimComputer_B.BusAssignment_nw.logic.left_spoiler_electric_mode_avail = false;
        rightSpoilerHydraulicModeAvail = false;
        A380PrimComputer_B.BusAssignment_nw.logic.right_spoiler_electric_mode_avail = false;
      }
    ...
    rtb_AND_e = (rtb_y_mb && (rtb_Switch31 != 0U));
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_rudder1HydraulicModeEngaged = ((!rtb_AND_e) && rtb_rudder2HydraulicModeEngaged);
    } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_rudder1HydraulicModeEngaged = ((!rtb_AND_e) && rtb_rudder2HydraulicModeEngaged);
    } else {
      rtb_rudder1HydraulicModeEngaged = A380PrimComputer_U.in.discrete_inputs.is_unit_3;
    }

    rtb_AND_e = (elevator2Avail && rtb_rudder1HydraulicModeEngaged);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_dl);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word, &rtb_y_mb);
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_y_dl = (rtb_y_dl && (rtb_Switch29 != 0U));
    } else {
      rtb_y_dl = (rtb_y_mb && (rtb_Switch31 != 0U));
    }

    rtb_y_mb = (A380PrimComputer_U.in.discrete_inputs.is_unit_1 || A380PrimComputer_U.in.discrete_inputs.is_unit_2);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_rudder1HydraulicModeEngaged = ((!rtb_y_dl) && rtb_rudder2HydraulicModeEngaged);
    } else {
      rtb_rudder1HydraulicModeEngaged = (A380PrimComputer_U.in.discrete_inputs.is_unit_2 && ((!rtb_y_dl) &&
        rtb_rudder2HydraulicModeEngaged));
    }

    rtb_y_dl = (rtb_y_mb && rtb_rudder1HydraulicModeEngaged);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_ls);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_bv, &rtb_y_e);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      thsAvail = rtb_DataTypeConversion_m2;
      rtb_rudder1HydraulicModeEngaged = ((!rtb_y_ls) || (rtb_y_e == 0U));
    } else {
      thsAvail = ((!A380PrimComputer_U.in.discrete_inputs.is_unit_2) && (A380PrimComputer_U.in.discrete_inputs.is_unit_3
        && rtb_y_i));
      rtb_rudder1HydraulicModeEngaged = ((!A380PrimComputer_U.in.discrete_inputs.is_unit_2) &&
        A380PrimComputer_U.in.discrete_inputs.is_unit_3);
    }

    rtb_thsEngaged = (thsAvail && rtb_rudder1HydraulicModeEngaged);
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      rtb_rudder1HydraulicModeEngaged = (rtb_Switch31 != 0U);
    } else {
      rtb_rudder1HydraulicModeEngaged = (rtb_Switch29 != 0U);
    }

    rtb_AND_n = (rtb_rudder1HydraulicModeEngaged && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
    ...
    A380PrimComputer_MATLABFunction(rtb_Switch_ir_0, &rtb_y_ls);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      rtb_rudder1HydraulicModeEngaged = (rtb_y_m != 0U);
    } else {
      rtb_rudder1HydraulicModeEngaged = (rtb_y_k1 != 0U);
    }

    rtb_AND3 = (rtb_rudder1HydraulicModeEngaged && rtb_y_ls);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_AND_n = ((!rtb_AND_n) && rtb_DataTypeConversion_gf && (!rtb_AND6_o) && (!rtb_AND3) &&
                   rtb_rudder2HydraulicModeEngaged);
    } else {
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2 || A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
        ...
        rtb_AND_n = (rudder1HydraulicModeHasPriority && ((!rtb_DataTypeConversion_m2) ||
          (!rtb_rudder1HydraulicModeEngaged)) && (!rudder1HydraulicModeAvail) && (!rtb_AND6_o) && (!rtb_AND3) &&
                     rtb_rudder2HydraulicModeEngaged);
      } else {
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
      &rtb_DataTypeConversion_m2);
    rtb_AND3 = ((rtb_y_k1 != 0U) && rtb_DataTypeConversion_m2);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word, &rtb_y_ls);
    rtb_AND4_f = ((rtb_y_k1 != 0U) && rtb_y_ls);
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_AND3 = ((!rtb_AND3) && rtb_DataTypeConversion_dj && (!rtb_AND4_f) && ((rtb_y_k1 == 0U) || (!rtb_y_i)) &&
                  rtb_rudder2HydraulicModeEngaged);
    } else {
      rtb_AND6_o = false;
      rudder1HydraulicModeHasPriority = false;
    ...
    rtb_AND3 = (rudder1HydraulicModeHasPriority && rtb_AND3);
    rudder2HydraulicModeHasPriority = rtb_y_h;
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word, &rtb_y_h);
    rtb_AND4_f = ((rtb_y_k1 != 0U) && rtb_y_h);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_c, &rtb_y_k1);
    rtb_AND3_d = ((rtb_y_k1 != 0U) && rtb_y_h);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_p, &rtb_y_k1);
    rtb_AND2_ac = ((rtb_y_k1 != 0U) && rtb_y_h);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_n, &rtb_y_k1);
    rtb_AND1_at = ((rtb_y_k1 != 0U) && rtb_y_h);
    ...
    rtb_DataTypeConversion_m2 = ((rtb_y_k1 != 0U) && rtb_DataTypeConversion_m2);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word, &rtb_y_ls);
    rtb_AND13 = ((rtb_y_k1 != 0U) && rtb_y_ls);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_b, &rtb_y_k1);
    rtb_AND11 = ((rtb_y_k1 != 0U) && rtb_y_ls);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel10_bit_h, &rtb_y_k1);
    rtb_AND10 = ((rtb_y_k1 != 0U) && rtb_y_ls);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel11_bit, &rtb_y_k1);
    rtb_AND9 = ((rtb_y_k1 != 0U) && rtb_y_ls);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word, &rtb_y_h);
    rtb_AND17 = ((rtb_y_k1 != 0U) && rtb_y_h);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel17_bit, &rtb_y_k1);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND3_h = (rtb_OR || rtb_AND2_ac);
      rtb_AND12 = (rtb_OR6 || rtb_AND1_at);
      rtb_AND2_ac = (rtb_AND1_e || rtb_AND4_d);
      rtb_AND1_at = (rtb_rightAileron2Engaged || rtb_AND6_pt);
      rtb_AND4_f = (rtb_AND4_f || rtb_AND7);
      rtb_AND3_d = (rtb_AND3_d || rtb_DataTypeConversion_m2);
      ...
      rtb_AND3_h = (rtb_AND1_e || rtb_AND4_f);
      rtb_AND12 = (rtb_rightAileron2Engaged || rtb_AND3_d);
      rtb_AND2_ac = (rtb_AND2_ac || rtb_AND4_d);
      rtb_AND1_at = (rtb_AND1_at || rtb_AND6_pt);
      rtb_AND4_f = (rtb_OR || rtb_AND7);
      rtb_AND3_d = (rtb_OR6 || rtb_DataTypeConversion_m2);
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.left_inboard_aileron_deg =
        A380PrimComputer_U.in.analog_inputs.left_aileron_2_pos_deg;
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.right_inboard_aileron_deg =
        A380PrimComputer_U.in.analog_inputs.right_aileron_2_pos_deg;
      ...
      rtb_AND3_h = (rtb_AND4_f || rtb_AND7);
      rtb_AND12 = (rtb_AND3_d || rtb_DataTypeConversion_m2);
      rtb_AND2_ac = (rtb_OR || rtb_AND2_ac);
      rtb_AND1_at = (rtb_OR6 || rtb_AND1_at);
    ...
    rtb_AND6_pt = (rtb_AND3_h || (rtb_AND13 || rtb_y_ls));
    rtb_AND11 = (rtb_AND12 || (rtb_AND11 || rtb_y_i));
    rtb_AND10 = (rtb_AND2_ac || (rtb_AND10 || rtb_AND17));
    rtb_AND9 = (rtb_AND1_at || (rtb_AND9 || ((rtb_y_k1 != 0U) && rtb_y_h)));
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_2_engaged = (rtb_y_i && (rtb_y_ls ||
      (rtb_y_e != 0U)));
    ...
    rtb_AND4_d = ((rtb_y_h || (rtb_y_e != 0U)) && rtb_y_i);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel12_bit, &rtb_y_e);
    rtb_y_h = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel13_bit, &rtb_y_e);
    rtb_y_h = ((rtb_y_h || (rtb_y_e != 0U)) && rtb_y_i);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_4_engaged = (rtb_AND4_d || rtb_y_h);
      ...
      A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_4_engaged =
        (rtb_leftSpoilerHydraulicModeEngaged || rtb_leftSpoilerElectricModeEngaged ||
         rtb_rightSpoilerHydraulicModeEngaged || rtb_rightSpoilerElectricModeEngaged);
      A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_5_engaged = (rtb_AND4_d || rtb_y_h);
      A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_6_engaged = (rtb_AND13 || rtb_AND17);
    } else {
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_7_engaged = (rtb_y_i && (rtb_y_h || (rtb_y_e
      != 0U)));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word, &rtb_y_i);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.spoiler_pair_8_engaged = (rtb_y_i && (rtb_y_d || (rtb_y_e
      != 0U)));
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      &rtb_DataTypeConversion_m2);
    rtb_AND2_ac = ((rtb_y_k1 != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word, &rtb_y_h);
    rtb_DataTypeConversion_m2 = ((rtb_y_k1 != 0U) && rtb_y_h);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_b, &rtb_y_k1);
    rtb_AND1_at = ((rtb_y_k1 != 0U) && rtb_y_h);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_p, &rtb_y_k1);
    rtb_y_h = ((rtb_y_k1 != 0U) && rtb_y_h);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word, &rtb_y_ls);
    rtb_AND11_m = ((rtb_y_k1 != 0U) && rtb_y_ls);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_e, &rtb_y_k1);
    rtb_AND10_b = ((rtb_y_k1 != 0U) && rtb_y_ls);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel11_bit_n, &rtb_y_k1);
    rtb_AND17 = ((rtb_y_k1 != 0U) && rtb_y_ls);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_y_ls = (rtb_AND_e || rtb_AND16_n);
      rtb_AND19 = (rtb_y_d || rtb_AND7);
      rtb_NOT_k = (elevator1Avail || rtb_NOT_k);
      rtb_AND16_n = (rtb_AND4_d || rtb_y_dl);
      ...
      rtb_y_ls = (rtb_AND16_n || rtb_NOT_k);
      rtb_AND19 = (rtb_y_dl || rtb_y_d);
      rtb_NOT_k = (rtb_AND_e || rtb_AND4_d);
      rtb_AND16_n = (elevator1Avail || rtb_AND7);
      rtb_AND4_d = (rtb_AND12 || rtb_AND20);
      ...
      rtb_y_ls = (elevator1Avail || rtb_NOT_k);
      rtb_AND19 = (rtb_AND_e || rtb_AND19);
      rtb_NOT_k = (rtb_AND4_d || rtb_y_d);
      rtb_AND16_n = (rtb_AND16_n || rtb_AND7);
      rtb_AND4_d = (rtb_thsEngaged || rtb_AND12);
      A380PrimComputer_B.BusAssignment_nw.logic.pitch_surface_positions.left_inboard_elevator_deg =
        A380PrimComputer_U.in.analog_inputs.elevator_1_pos_deg;
      A380PrimComputer_B.BusAssignment_nw.logic.pitch_surface_positions.right_inboard_elevator_deg =
        A380PrimComputer_U.in.analog_inputs.elevator_2_pos_deg;
    ...
    rtb_AND7 = (rtb_y_ls || (rtb_AND11_m || rtb_AND3_h));
    rtb_AND12 = (rtb_AND19 || (rtb_AND10_b || rtb_y_h));
    rtb_AND2_ac = (rtb_NOT_k || (rtb_AND2_ac || rtb_AND1_at));
    rtb_AND1_at = (rtb_AND16_n || (rtb_DataTypeConversion_m2 || rtb_y_i));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
    ...
    rtb_DataTypeConversion_m2 = ((rtb_NOT_k || (rtb_y_k1 != 0U)) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word, &rtb_y_d);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word, &rtb_y_h);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_gt, &rtb_y_k1);
    rtb_NOT_k = (rtb_y_k1 != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel8_bit_i5, &rtb_y_k1);
    rtb_y_ls = (rtb_NOT_k || (rtb_y_k1 != 0U));
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_DataTypeConversion_m2 = (rtb_rudder2HydraulicModeEngaged || rtb_AND3 || rtb_AND10_b);
      ...
      rtb_AND3_h = (rtb_rudder1HydraulicModeEngaged || rtb_AND_n || rtb_AND3_h);
      rtb_DataTypeConversion_m2 = (rtb_DataTypeConversion_m2 || rtb_AND10_b);
      A380PrimComputer_B.BusAssignment_nw.logic.lateral_surface_positions.upper_rudder_deg =
        A380PrimComputer_U.in.analog_inputs.rudder_1_pos_deg;
      ...
      rtb_DataTypeConversion_m2 = (rtb_rudder1HydraulicModeEngaged || rtb_AND_n || rtb_DataTypeConversion_m2);
    ...
    rtb_AND3_h = (rtb_AND3_h || (rtb_AND16_n && rtb_y_d) || (rtb_AND20 && rtb_y_h));
    rtb_AND16_n = (rtb_DataTypeConversion_m2 || (rtb_y_i && rtb_y_d) || (rtb_y_ls && rtb_NOT_k));
    ...
    rtb_left_midboard_aileron_deg = std::abs(static_cast<real_T>(rtb_phi));
    ...
    rtb_AND20 = ((!rtb_y_i) && rtb_AND10_b && (((!rtb_OR_n) && ((rtb_mach > 0.96) || (rtb_mach < 0.1) || (rtb_Y < -10.0)
      ...
      (!A380PrimComputer_P.Constant_Value_ad)) && ((rtb_left_midboard_aileron_deg > 120.0) || ((rtb_alpha > 50.0F) ||
      (rtb_alpha < -30.0F))))));
    A380PrimComputer_DWork.abnormalConditionWasActive = (rtb_AND20 || (rtb_AND10_b &&
      A380PrimComputer_DWork.abnormalConditionWasActive));
    nz = ((rtb_AND7 + rtb_AND12) + rtb_AND2_ac) + rtb_AND1_at;
    b_x[0] = rtb_AND6_pt;
    b_x[1] = rtb_AND11;
    b_x[2] = rtb_AND10;
    b_x[3] = rtb_AND9;
    ...
    if (rtb_OR_n || rtb_AND20) {
      ...
      } else if (A380PrimComputer_DWork.abnormalConditionWasActive || ((rtb_AND3_h && (!rtb_AND16_n)) || ((!rtb_AND3_h) &&
        rtb_AND16_n)) || (nz == 3) || (b_nz == 4) || rtb_OR_a || rtb_OR_ll || rtb_OR_ou || (rtb_OR1 && rtb_OR4 &&
    ...
    A380PrimComputer_MATLABFunction_ek(rtb_DataTypeConversion_dj, rtb_DataTypeConversion_gf, rtb_y_h, rtb_y_i,
      &rtb_law_j);
    ...
    A380PrimComputer_MATLABFunction_ek(rtb_DataTypeConversion_dj, rtb_DataTypeConversion_gf, rtb_y_h, rtb_y_i, &rtb_law);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    rtb_Sum6 = rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg + rtb_handleIndex;
    ...
    A380PrimComputer_MATLABFunction_o(rtb_y_h, rtb_y_i, rtb_y_ls, rtb_DataTypeConversion_m2, rtb_NOT_k, (rtb_y_k1 != 0U),
      &rtb_handleIndex);
    ...
    rtb_y_h = ((rtb_law_j == a380_pitch_efcs_law::NormalLaw) || (rtb_activeLateralLaw == a380_lateral_efcs_law::
                NormalLaw));
    if ((!A380PrimComputer_U.in.temporary_ap_input.ap_engaged) && (rtb_V_ias > std::fmin(look1_binlxpw
      ...
      A380PrimComputer_DWork.sProtActive = (rtb_y_h || A380PrimComputer_DWork.sProtActive);
    }

    A380PrimComputer_DWork.sProtActive = ((rtb_V_ias >= rtb_handleIndex) &&
      (!A380PrimComputer_U.in.temporary_ap_input.ap_engaged) && rtb_y_h && A380PrimComputer_DWork.sProtActive);
    ...
    A380PrimComputer_DWork.sProtActive_g = ((rtb_AND10_b && rtb_y_h &&
    ...
    A380PrimComputer_DWork.sProtActive_g = ((A380PrimComputer_U.in.time.simulation_time -
      ...
      200.0F) || (rtb_right_spoiler_2_deg >= 0.5) || (rtb_Y >= rtb_outerAilLowerLim - 2.0)) && rtb_AND10_b && rtb_y_h &&
    ...
    rtb_NOT_k = ((rtb_AND10_b && (((nz != 0) && (rtb_Y > rtb_Gain_p)) || (rtb_Y > rtb_outerAilLowerLim + 0.25)) &&
                  rtb_y_h) || (A380PrimComputer_U.in.time.simulation_time - A380PrimComputer_DWork.eventTime > 3.0) ||
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.ap_authorised = ((std::abs(rtb_right_spoiler_2_deg) <= 0.5) && (std::abs
      ...
      25.0F) && (rtb_alpha >= -13.0F) && (rtb_left_midboard_aileron_deg <= 45.0) && (!rtb_NOT_k))));
    ...
    A380PrimComputer_MATLABFunction_f(rudder2HydraulicModeHasPriority, A380PrimComputer_P.PulseNode6_isRisingEdge,
      &rtb_y_h, &A380PrimComputer_DWork.sf_MATLABFunction_gc);
    A380PrimComputer_DWork.Memory_PreviousInput_a = A380PrimComputer_P.Logic_table_h[(((static_cast<uint32_T>
      ...
      A380PrimComputer_P.CompareToConstant14_const)))) << 1) + rtb_y_h) << 1) +
    ...
    rtb_y_d = (A380PrimComputer_U.in.analog_inputs.thr_lever_4_pos <= A380PrimComputer_P.CompareToConstant18_const);
    rtb_y_ls = ((((A380PrimComputer_U.in.analog_inputs.speed_brake_lever_pos >
      ...
      A380PrimComputer_P.CompareToConstant17_const)) + rtb_y_d) >= A380PrimComputer_P.CompareToConstant19_const)));
    A380PrimComputer_MATLABFunction_f(false, A380PrimComputer_P.PulseNode5_isRisingEdge, &rtb_y_d,
    ...
    rtb_DataTypeConversion_m2 = (((A380PrimComputer_U.in.analog_inputs.left_body_wheel_speed >=
      ...
      A380PrimComputer_P.CompareToConstant3_const_n) || rtb_y_h) && A380PrimComputer_DWork.Memory_PreviousInput_a);
    A380PrimComputer_DWork.Delay1_DSTATE_b = (rtb_y_ls && (rtb_y_d || rtb_DataTypeConversion_m2 ||
    ...
    A380PrimComputer_DWork.Delay2_DSTATE = (rtb_y_ls && (rtb_DataTypeConversion_m2 ||
    ...
    A380PrimComputer_DWork.Delay3_DSTATE = (rtb_NOT_k && ((A380PrimComputer_U.in.analog_inputs.thr_lever_1_pos <=
      ...
      A380PrimComputer_P.CompareToConstant2_const_k)) && (rtb_y_d || A380PrimComputer_DWork.Delay3_DSTATE));
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_DataTypeConversion_m2);
    A380PrimComputer_B.BusAssignment_nw.logic.spoiler_lift_active = (rudder2HydraulicModeHasPriority && (rtb_y_h ||
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_NOT_k);
    A380PrimComputer_B.BusAssignment_nw.logic.aileron_droop_active = ((rtb_y_h && rtb_y_ls) || ((rtb_y_k1 == 0U) &&
      rtb_NOT_k));
    A380PrimComputer_MATLABFunction_f(rudder2HydraulicModeHasPriority, A380PrimComputer_P.PulseNode1_isRisingEdge_n,
      &rtb_y_d, &A380PrimComputer_DWork.sf_MATLABFunction_ky);
    A380PrimComputer_MATLABFunction_f(rudder2HydraulicModeHasPriority, A380PrimComputer_P.PulseNode2_isRisingEdge,
      &rtb_y_ls, &A380PrimComputer_DWork.sf_MATLABFunction_dmh);
    A380PrimComputer_DWork.Memory_PreviousInput_d = A380PrimComputer_P.Logic_table_j[(((static_cast<uint32_T>(rtb_y_d) <<
      1) + (rtb_y_ls || A380PrimComputer_DWork.Delay_DSTATE_e)) << 1) + A380PrimComputer_DWork.Memory_PreviousInput_d];
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
    ...
    if (rtb_AND11_m) {
      rtb_y_ls = (rtb_AND10_b && (rtb_law_j != A380PrimComputer_P.EnumeratedConstant_Value_l));
    } else {
      rtb_y_ls = ((rtb_y_e != 0U) && (rtb_Switch_ir_0->SSM == static_cast<uint32_T>(SignStatusMatrix::NormalOperation)));
    }

    A380PrimComputer_DWork.Delay_DSTATE_e = A380PrimComputer_P.Logic_table_n[(((rtb_y_ls || (std::abs(rtb_thsPos) <=
    ...
    if (rtb_y_i || (rtb_y_h && ((!rtb_NOT_k) || (rtb_Switch29 == 0U)))) {
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.right_inboard_elevator_engaged = rtb_AND12;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.left_outboard_elevator_engaged = rtb_AND2_ac;
    A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.right_outboard_elevator_engaged = rtb_AND1_at;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim = rtb_AND11_m;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.elevator_3_avail = rtb_y_mb;
    A380PrimComputer_B.BusAssignment_nw.logic.elevator_3_engaged = rtb_y_dl;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.left_aileron_1_avail = rtb_OR;
    A380PrimComputer_B.BusAssignment_nw.logic.left_aileron_1_engaged = rtb_OR;
    A380PrimComputer_B.BusAssignment_nw.logic.left_aileron_2_avail = rtb_OR7;
    A380PrimComputer_B.BusAssignment_nw.logic.left_aileron_2_engaged = rtb_AND1_e;
    A380PrimComputer_B.BusAssignment_nw.logic.right_aileron_1_avail = rtb_OR6;
    A380PrimComputer_B.BusAssignment_nw.logic.right_aileron_1_engaged = rtb_OR6;
    A380PrimComputer_B.BusAssignment_nw.logic.right_aileron_2_avail = rtb_doubleIrFault_tmp;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.rudder_1_hydraulic_mode_engaged = rtb_rudder1HydraulicModeEngaged;
    A380PrimComputer_B.BusAssignment_nw.logic.rudder_1_electric_mode_engaged = rtb_AND_n;
    A380PrimComputer_B.BusAssignment_nw.logic.rudder_2_hydraulic_mode_avail = rtb_AND6_o;
    A380PrimComputer_B.BusAssignment_nw.logic.rudder_2_electric_mode_avail = rudder1HydraulicModeHasPriority;
    A380PrimComputer_B.BusAssignment_nw.logic.rudder_2_hydraulic_mode_engaged = rtb_rudder2HydraulicModeEngaged;
    A380PrimComputer_B.BusAssignment_nw.logic.rudder_2_electric_mode_engaged = rtb_AND3;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.eha_ebha_elec_mode_inhibited = rtb_LogicalOperator3;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.all_ra_failure = rtb_OR1;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.double_lgciu_failure = rtb_OR3;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.landing_gear_down = rtb_OR4;
    ...
    A380PrimComputer_B.BusAssignment_nw.logic.ths_automatic_mode_active = rtb_y_ls;
    ...
    rtb_Switch2_a = A380PrimComputer_P.DiscreteTimeIntegratorVariableTsLimit_Gain * rtb_Switch2_a *
      A380PrimComputer_B.BusAssignment_nw.data.time.dt;
    if (A380PrimComputer_B.BusAssignment_nw.logic.ths_automatic_mode_active) {
      rtb_rudder1HydraulicModeEngaged = ((!A380PrimComputer_B.BusAssignment_nw.logic.surface_statuses.ths_engaged) ||
        (!A380PrimComputer_B.BusAssignment_nw.logic.is_master_prim));
    } else {
      rtb_rudder1HydraulicModeEngaged = !A380PrimComputer_B.BusAssignment_nw.logic.ths_engaged;
    }

    A380PrimComputer_DWork.icLoad = (rtb_rudder1HydraulicModeEngaged || A380PrimComputer_DWork.icLoad);
    ...
    rtb_VectorConcatenate_ep[0] = A380PrimComputer_B.BusAssignment_om.data.temporary_ap_input.ap_engaged;
