...
void A380PrimComputer::step()
{
  ...
  if (A380PrimComputer_U.in.sim_data.computer_running) {
    ...
    rtb_AND2_i = !rtb_OR4;
    rtb_y_cp = !rtb_OR3;
    leftAileron2Avail = (rtb_OR1 && rtb_y_cp);
    if (leftAileron2Avail && rtb_AND2_i) {
      ...
      if (rtb_OR3 && rtb_AND2_i) {
        ...
        rtb_y_cp = (rtb_OR1 && rtb_y_cp);
        if ((rtb_y_cp && rtb_AND2_i) || (rtb_y_cp && rtb_OR4)) {
          rtb_V_ias = (A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data +
    ...
    rtb_AND2_i = !rtb_OR6;
    rtb_y_cp = !rtb_OR7;
    leftAileron2Avail = (rtb_OR && rtb_y_cp);
    if (leftAileron2Avail && rtb_AND2_i) {
      ...
      if (rtb_OR3 && rtb_AND2_i) {
        ...
        rtb_y_cp = (rtb_OR1 && rtb_y_cp);
        if ((rtb_y_cp && rtb_AND2_i) || (rtb_y_cp && rtb_OR6)) {
          rtb_alpha = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.Data +
                       A380PrimComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.Data) / 2.0F;
          rtb_phi = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.roll_angle_deg.Data +
                     A380PrimComputer_U.in.bus_inputs.ir_3_bus.roll_angle_deg.Data) / 2.0F;
    ...
    A380PrimComputer_MATLABFunction_c((std::abs(A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data -
      ...
      A380PrimComputer_P.ConfirmNode_timeDelay, &rtb_y_az, &A380PrimComputer_DWork.sf_MATLABFunction_jz);
    ...
    A380PrimComputer_MATLABFunction_c(((A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data > 50.0F) &&
      ...
      A380PrimComputer_P.ConfirmNode2_isRisingEdge, A380PrimComputer_P.ConfirmNode2_timeDelay, &rtb_y_kf,
    ...
    A380PrimComputer_DWork.ra1CoherenceRejected = (rtb_y_kf || A380PrimComputer_DWork.ra1CoherenceRejected);
    ...
    } else if ((rtb_OR4 && rtb_AND2_i) || (rtb_y_cp && rtb_ra2Invalid)) {
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.lgciu_1_bus.discrete_word_2,
      A380PrimComputer_P.BitfromLabel6_bit, &rtb_y_e);
    rtb_y_cp = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.lgciu_1_bus.discrete_word_2,
      A380PrimComputer_P.BitfromLabel1_bit_j, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.lgciu_1_bus.discrete_word_2, &rtb_NOT_k);
    rtb_OR6 = ((rtb_y_cp || (rtb_y_e != 0U)) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.lgciu_2_bus.discrete_word_2,
      A380PrimComputer_P.BitfromLabel3_bit, &rtb_y_e);
    rtb_y_cp = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.lgciu_2_bus.discrete_word_2,
      A380PrimComputer_P.BitfromLabel2_bit, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.lgciu_2_bus.discrete_word_2, &rtb_y_kf);
    ...
    rtb_OR6 = (rtb_OR6 || ((rtb_y_cp || (rtb_y_e != 0U)) && rtb_y_kf));
    A380PrimComputer_MATLABFunction_n(A380PrimComputer_U.in.analog_inputs.yellow_hyd_pressure_psi,
      A380PrimComputer_P.HysteresisNode2_highTrigger, A380PrimComputer_P.HysteresisNode2_lowTrigger, &rtb_y_kf,
      &A380PrimComputer_DWork.sf_MATLABFunction_nj);
    A380PrimComputer_MATLABFunction_c(((!A380PrimComputer_U.in.discrete_inputs.yellow_low_pressure) && rtb_y_kf),
    ...
    A380PrimComputer_MATLABFunction_n(A380PrimComputer_U.in.analog_inputs.green_hyd_pressure_psi,
      A380PrimComputer_P.HysteresisNode3_highTrigger, A380PrimComputer_P.HysteresisNode3_lowTrigger, &rtb_y_kf,
      &A380PrimComputer_DWork.sf_MATLABFunction_e1);
    A380PrimComputer_MATLABFunction_c(((!A380PrimComputer_U.in.discrete_inputs.green_low_pressure) && rtb_y_kf),
      A380PrimComputer_U.in.time.dt, A380PrimComputer_P.ConfirmNode2_isRisingEdge_i,
      A380PrimComputer_P.ConfirmNode2_timeDelay_h, &rtb_y_kf, &A380PrimComputer_DWork.sf_MATLABFunction_kq);
    rtb_rudder2HydraulicModeEngaged = !rtb_y_kf;
    rtb_rudder1HydraulicModeEngaged = !rtb_NOT_k;
    rtb_OR1 = !A380PrimComputer_P.Constant_Value_aq;
    rtb_OR7 = (rtb_OR6 && ((rtb_y_kf || rtb_NOT_k || (!A380PrimComputer_U.in.discrete_inputs.rat_contactor_closed) ||
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_doubleIrFault_tmp = rtb_y_kf;
      rtb_OR3 = rtb_y_kf;
    ...
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel2_bit_k, &rtb_y_e);
    A380PrimComputer_MATLABFunction(rtb_Switch_ir_0, &rtb_y_a);
    rtb_AND1_e = ((rtb_y_e != 0U) && rtb_y_a);
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel1_bit_b, &rtb_y_e);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    rtb_rightAileron2Engaged = (rtb_OR1 && (((!rtb_y_a) || (rtb_y_e == 0U)) && rtb_rightAileron2Engaged));
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      leftSpoilerHydraulicModeAvail = rtb_y_kf;
      leftSpoilerElectricModeAvail = true;
      rightSpoilerHydraulicModeAvail = rtb_y_kf;
      rightSpoilerElectricModeAvail = true;
      rtb_leftSpoilerHydraulicModeEngaged = rtb_y_kf;
      rtb_leftSpoilerElectricModeEngaged = (rtb_rudder2HydraulicModeEngaged && rudder2ElectricModeHasPriority);
      rtb_rightSpoilerHydraulicModeEngaged = rtb_y_kf;
      rtb_rightSpoilerElectricModeEngaged = rtb_leftSpoilerElectricModeEngaged;
      elevator1Avail = rtb_y_kf;
    } else {
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
        ...
        elevator1Avail = (A380PrimComputer_U.in.discrete_inputs.is_unit_3 && rtb_y_kf);
      }
    }
    ...
    A380PrimComputer_MATLABFunction(rtb_Switch_ir_0, &rtb_y_a);
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel1_bit_n, &rtb_y_e);
    rtb_AND_e = (rtb_y_a && (rtb_y_e != 0U));
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_pd);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_l, &rtb_y_k);
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_l, &rtb_y_e);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_y_pd = (rtb_y_pd && (rtb_y_k != 0U));
    } else {
      rtb_y_pd = (rtb_y_a && (rtb_y_e != 0U));
    }

    rtb_y_a = (A380PrimComputer_U.in.discrete_inputs.is_unit_1 || A380PrimComputer_U.in.discrete_inputs.is_unit_2);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND2_i = ((!rtb_y_pd) && rudder2ElectricModeHasPriority);
    } else {
      rtb_AND2_i = (A380PrimComputer_U.in.discrete_inputs.is_unit_2 && ((!rtb_y_pd) && rudder2ElectricModeHasPriority));
    }

    rtb_y_pd = (rtb_y_a && rtb_AND2_i);
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_AND2_i = ((!rtb_NOT_k) || (rtb_y_e == 0U));
    } else {
      rtb_NOT_k = !A380PrimComputer_U.in.discrete_inputs.is_unit_2;
      thsAvail = (rtb_NOT_k && (A380PrimComputer_U.in.discrete_inputs.is_unit_3 && rtb_y_kf));
      rtb_AND2_i = (rtb_NOT_k && A380PrimComputer_U.in.discrete_inputs.is_unit_3);
    }

    rtb_thsEngaged = (thsAvail && rtb_AND2_i);
    rtb_BusAssignment_hi_logic_is_green_hydraulic_power_avail = rtb_y_kf;
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_k, &rtb_y_e);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_e, &rtb_y_k);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word, &rtb_y_az);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      rtb_AND2_i = (rtb_y_e != 0U);
    } else {
      rtb_AND2_i = (rtb_y_k != 0U);
    }

    rtb_AND_n = (rtb_AND2_i && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_c, &rtb_y_e);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel4_bit, &rtb_y_k);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel6_bit_k, &rtb_y_j);
    A380PrimComputer_MATLABFunction(rtb_Switch_ir_0, &rtb_y_kf);
    rtb_AND6_o = ((rtb_y_j != 0U) && rtb_y_kf);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_Switch_ir_0 = &A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word;
    } else {
      rtb_Switch_ir_0 = &A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word;
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2 || A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
        ...
        rtb_AND_n = (rudder1HydraulicModeHasPriority && ((!rtb_y_az) || (!rtb_AND2_i)) && (!rudder1HydraulicModeAvail) &&
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel5_bit, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word, &rtb_y_az);
    rtb_AND3 = ((rtb_y_e != 0U) && rtb_y_az);
    ...
    rtb_AND4_f = ((rtb_y_e != 0U) && rtb_NOT_k);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word, &rtb_y_kf);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND6_o = rtb_BusAssignment_hi_logic_is_green_hydraulic_power_avail;
      rudder1HydraulicModeHasPriority = true;
      rudder2HydraulicModeHasPriority = true;
      rudder2ElectricModeHasPriority = ((!rtb_AND3) && rtb_rudder2HydraulicModeEngaged && (!rtb_AND4_f) && ((rtb_y_e ==
        0U) || (!rtb_y_kf)) && rudder2ElectricModeHasPriority);
    } else {
      rtb_AND6_o = false;
      rudder1HydraulicModeHasPriority = false;
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel_bit_i, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word, &rtb_y_cp);
    rtb_AND3 = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_c, &rtb_y_e);
    rudder2HydraulicModeHasPriority = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_p, &rtb_y_e);
    rtb_AND2_ac = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_n, &rtb_y_e);
    rtb_AND1_at = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_j, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word, &rtb_y_az);
    rtb_AND4_d = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_i, &rtb_y_e);
    rtb_AND4_f = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_j, &rtb_y_e);
    rtb_AND7 = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_n, &rtb_y_e);
    rtb_AND8 = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel8_bit_n, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word, &rtb_NOT_k);
    rtb_AND13 = ((rtb_y_e != 0U) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_b, &rtb_y_e);
    rtb_AND11 = ((rtb_y_e != 0U) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel10_bit_h, &rtb_y_e);
    rtb_AND10 = ((rtb_y_e != 0U) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel11_bit, &rtb_y_e);
    rtb_AND9 = ((rtb_y_e != 0U) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel14_bit, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word, &rtb_y_kf);
    rtb_AND15 = ((rtb_y_e != 0U) && rtb_y_kf);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel15_bit, &rtb_y_e);
    rtb_AND16 = ((rtb_y_e != 0U) && rtb_y_kf);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel16_bit, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word, &rtb_y_az);
    rtb_AND17 = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel17_bit, &rtb_y_e);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    rtb_AND9 = (rtb_AND1_at || (rtb_AND9 || ((rtb_y_e != 0U) && rtb_y_az)));
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word, &rtb_y_kf);
    ...
    rtb_AND13 = (rtb_y_kf && (rtb_y_cp || (rtb_y_e != 0U)));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word, &rtb_y_kf);
    ...
    rtb_AND17 = (rtb_y_kf && (rtb_y_m || (rtb_y_e != 0U)));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.spoiler_status_word, &rtb_y_kf);
    ...
    rtb_AND4_d = (rtb_y_kf && (rtb_y_cp || (rtb_y_e != 0U)));
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word, &rtb_y_kf);
    rtb_AND8 = ((rtb_y_az || (rtb_y_e != 0U)) && rtb_y_kf);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel12_bit, &rtb_y_e);
    rtb_y_az = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel13_bit, &rtb_y_e);
    rtb_AND9_o = ((rtb_y_az || (rtb_y_e != 0U)) && rtb_y_kf);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    rtb_AND16 = (rtb_y_kf && (rtb_y_az || (rtb_y_e != 0U)));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word, &rtb_y_kf);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
    ...
    rtb_AND9_o = (rtb_y_kf && (rtb_y_cp || (rtb_y_e != 0U)));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel16_bit_b, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word, &rtb_y_az);
    rtb_AND2_ac = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel17_bit_i, &rtb_y_e);
    rtb_AND15_l = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel18_bit, &rtb_y_e);
    rtb_AND1_at = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel19_bit, &rtb_y_e);
    rtb_AND12 = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel20_bit, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_kf);
    rtb_AND16_n = ((rtb_y_e != 0U) && rtb_y_kf);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel21_bit, &rtb_y_e);
    rtb_AND18_c = ((rtb_y_e != 0U) && rtb_y_kf);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel22_bit, &rtb_y_e);
    rtb_AND19 = ((rtb_y_e != 0U) && rtb_y_kf);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel23_bit, &rtb_y_e);
    rtb_AND20 = ((rtb_y_e != 0U) && rtb_y_kf);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_lr, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word, &rtb_y_cp);
    rtb_AND5_e = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_g, &rtb_y_e);
    rtb_AND3_h = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_k, &rtb_y_e);
    rtb_AND2_i = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_n, &rtb_y_e);
    rtb_y_kf = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_e, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word, &rtb_y_cp);
    rtb_AND4_fg3 = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_b, &rtb_y_e);
    rtb_NOT_k = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_p, &rtb_y_e);
    rtb_AND7_d = ((rtb_y_e != 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel8_bit_d, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word, &rtb_y_az);
    rtb_y_cp = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_e, &rtb_y_e);
    rtb_AND10_b = ((rtb_y_e != 0U) && rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel11_bit_n, &rtb_y_e);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      leftInboardElevEngaged = (rtb_AND_e || rtb_AND16_n);
      rtb_AND19 = (rtb_AND18_c || rtb_AND1_at);
      rtb_AND15_l = (elevator1Avail || rtb_AND15_l);
      rtb_AND16_n = (rtb_AND2_ac || rtb_y_pd);
      ...
      rtb_AND19 = (rtb_y_pd || rtb_AND18_c);
    ...
    rtb_AND2_ac = (leftInboardElevEngaged || (rtb_y_cp || rtb_AND3_h));
    ...
    rtb_AND12 = (rtb_AND12 || (((rtb_y_e != 0U) && rtb_y_az) || rtb_y_kf));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel38_bit, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel39_bit, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word, &rtb_y_cp);
    rtb_AND3_h = ((rtb_NOT_k || (rtb_y_e != 0U)) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel32_bit, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel33_bit, &rtb_y_e);
    rtb_AND15_l = ((rtb_NOT_k || (rtb_y_e != 0U)) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel36_bit, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel37_bit, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word, &rtb_y_kf);
    rtb_AND20 = ((rtb_NOT_k || (rtb_y_e != 0U)) && rtb_y_kf);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_m, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_b, &rtb_y_e);
    rtb_y_kf = (rtb_NOT_k || (rtb_y_e != 0U));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word, &rtb_y_m);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_pt, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_h, &rtb_y_e);
    rtb_y_az = (rtb_NOT_k || (rtb_y_e != 0U));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_d, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_p, &rtb_y_e);
    rtb_AND16_n = (rtb_NOT_k || (rtb_y_e != 0U));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word, &rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_g, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel8_bit_i, &rtb_y_e);
    rtb_AND2_i = (rtb_NOT_k || (rtb_y_e != 0U));
    ...
    rtb_AND3_h = (rtb_AND3_h || (rtb_y_kf && rtb_y_m) || (rtb_AND16_n && rtb_y_cp));
    rtb_AND15_l = (rtb_AND15_l || (rtb_y_az && rtb_y_m) || (rtb_AND2_i && rtb_NOT_k));
    A380PrimComputer_MATLABFunction_c(A380PrimComputer_U.in.sim_data.slew_on, A380PrimComputer_U.in.time.dt,
      A380PrimComputer_P.ConfirmNode_isRisingEdge_o, A380PrimComputer_P.ConfirmNode_timeDelay_d, &rtb_y_kf,
      &A380PrimComputer_DWork.sf_MATLABFunction_nb);
    abs_rate_c = std::abs(static_cast<real_T>(rtb_phi));
    rtb_AND1_ci = !rtb_OR6;
    rtb_AND16_n = ((!rtb_y_kf) && rtb_AND1_ci && (((!rtb_tripleAdrFault) && ((rtb_mach > 0.96) || (rtb_Y < -10.0) ||
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel_bit_o, &rtb_y_e);
    rtb_y_az = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_e, &rtb_y_e);
    rtb_AND2_i = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_hr, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_kq, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word, &rtb_y_kf);
    A380PrimComputer_MATLABFunction_ek(rtb_y_az, rtb_AND2_i, rtb_NOT_k, rtb_y_kf, &rtb_law_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_le, &rtb_y_e);
    rtb_y_az = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_bl, &rtb_y_e);
    rtb_AND2_i = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_p, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_h, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word, &rtb_y_kf);
    A380PrimComputer_MATLABFunction_ek(rtb_y_az, rtb_AND2_i, rtb_NOT_k, rtb_y_kf, &rtb_law);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputer_MATLABFunction_f(A380PrimComputer_U.in.discrete_inputs.fo_priority_takeover_pressed,
      A380PrimComputer_P.PulseNode1_isRisingEdge, &rtb_y_kf, &A380PrimComputer_DWork.sf_MATLABFunction_nu);
    if (rtb_NOT_k) {
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel_bit_h, &rtb_y_e);
    rtb_y_az = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_gs, &rtb_y_e);
    rtb_y_kf = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_nu, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_g, &rtb_y_e);
    rtb_y_cp = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_e, &rtb_y_e);
    rtb_AND18_c = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_a, &rtb_y_e);
    A380PrimComputer_MATLABFunction_o(rtb_y_az, rtb_y_kf, rtb_NOT_k, rtb_y_cp, rtb_AND18_c, (rtb_y_e != 0U),
      &rtb_handleIndex);
    ...
    rtb_y_az = ((rtb_law_k == a380_pitch_efcs_law::NormalLaw) || (rtb_activeLateralLaw == a380_lateral_efcs_law::
      NormalLaw));
    if ((!A380PrimComputer_U.in.temporary_ap_input.ap_engaged) && (rtb_V_ias > std::fmin(look1_binlxpw
      ...
      A380PrimComputer_DWork.sProtActive = (rtb_y_az || A380PrimComputer_DWork.sProtActive);
    }
    ...
    A380PrimComputer_DWork.sProtActive = ((rtb_V_ias >= rtb_right_outboard_aileron_deg) && rtb_aileronAntidroopActive &&
      rtb_y_az && A380PrimComputer_DWork.sProtActive);
    ...
    A380PrimComputer_DWork.sProtActive_l = ((rtb_AND1_ci && rtb_y_az && rtb_aileronAntidroopActive && (rtb_Y >
    ...
    A380PrimComputer_DWork.sProtActive_l = ((A380PrimComputer_U.in.time.simulation_time -
      ...
      || (rtb_Y >= rtb_handleIndex - 2.0)) && rtb_AND1_ci && rtb_y_az && A380PrimComputer_DWork.sProtActive_l);
    ...
    rtb_NOT_k = ((rtb_AND1_ci && (((nz != 0) && (rtb_Y > rtb_Switch_h)) || (rtb_Y > rtb_handleIndex + 0.25)) && rtb_y_az)
    ...
    rtb_y_cp = (A380PrimComputer_U.in.analog_inputs.thr_lever_3_pos >= A380PrimComputer_P.CompareToConstant1_const);
    rtb_NOT_k = (A380PrimComputer_P.Constant_Value_h || A380PrimComputer_DWork.sProtActive_l ||
                 ((A380PrimComputer_U.in.analog_inputs.thr_lever_1_pos >= A380PrimComputer_P.CompareToConstant3_const) ||
                  ...
                  rtb_y_cp || (A380PrimComputer_U.in.analog_inputs.thr_lever_4_pos >=
    ...
    A380PrimComputer_MATLABFunction_c((A380PrimComputer_U.in.analog_inputs.speed_brake_lever_pos <
      ...
      A380PrimComputer_P.ConfirmNode_isRisingEdge_c, A380PrimComputer_P.ConfirmNode_timeDelay_g, &rtb_y_kf,
    ...
    A380PrimComputer_DWork.Memory_PreviousInput = A380PrimComputer_P.Logic_table[(((static_cast<uint32_T>(rtb_NOT_k) <<
      1) + rtb_y_kf) << 1) + A380PrimComputer_DWork.Memory_PreviousInput];
    rtb_y_kf = (rtb_NOT_k || A380PrimComputer_DWork.Memory_PreviousInput);
    A380PrimComputer_MATLABFunction_f(rtb_OR6, A380PrimComputer_P.PulseNode7_isRisingEdge, &rtb_y_cp,
      &A380PrimComputer_DWork.sf_MATLABFunction_ny);
    A380PrimComputer_MATLABFunction_f(rtb_OR6, A380PrimComputer_P.PulseNode6_isRisingEdge, &rtb_y_az,
      &A380PrimComputer_DWork.sf_MATLABFunction_gc);
    A380PrimComputer_DWork.Memory_PreviousInput_a = A380PrimComputer_P.Logic_table_h[(((static_cast<uint32_T>(rtb_y_cp ||
      ...
      1) + rtb_y_az) << 1) + A380PrimComputer_DWork.Memory_PreviousInput_a];
    ...
    rtb_y_az = ((((A380PrimComputer_U.in.analog_inputs.speed_brake_lever_pos >
    ...
    rtb_y_cp = (((A380PrimComputer_U.in.analog_inputs.left_body_wheel_speed >=
    ...
    A380PrimComputer_DWork.Delay1_DSTATE_b = (rtb_y_az && (rtb_y_m || rtb_y_cp || A380PrimComputer_DWork.Delay1_DSTATE_b));
    A380PrimComputer_MATLABFunction_f(false, A380PrimComputer_P.PulseNode4_isRisingEdge, &rtb_y_cp,
      &A380PrimComputer_DWork.sf_MATLABFunction_ff);
    A380PrimComputer_DWork.Delay2_DSTATE = (rtb_y_az && (rtb_y_cp || A380PrimComputer_DWork.Delay2_DSTATE));
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel_bit_l, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_cp);
    rtb_y_az = ((rtb_y_e == 0U) && rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel1_bit_cm, &rtb_y_e);
    rtb_y_cp = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_y_cp);
    rtb_BusAssignment_p_logic_spoiler_lift_active = (rtb_OR6 && (rtb_y_az || ((rtb_y_e == 0U) && rtb_y_cp)));
    A380PrimComputer_Y.out.logic.ground_spoilers_armed = rtb_NOT_k;
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel_bit_e, &rtb_y_e);
    rtb_y_cp = (rtb_y_e == 0U);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_az);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel1_bit_d, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_NOT_k);
    rtb_OR_b = ((rtb_y_cp && rtb_y_az) || ((rtb_y_e == 0U) && rtb_NOT_k));
    rtb_aileronAntidroopActive = (rtb_aileronAntidroopActive && A380PrimComputer_DWork.Delay1_DSTATE_b);
    A380PrimComputer_MATLABFunction_f(rtb_OR6, A380PrimComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_m,
      &A380PrimComputer_DWork.sf_MATLABFunction_ky);
    A380PrimComputer_MATLABFunction_f(rtb_OR6, A380PrimComputer_P.PulseNode2_isRisingEdge, &rtb_y_az,
    ...
    A380PrimComputer_DWork.Memory_PreviousInput_d = A380PrimComputer_P.Logic_table_j[(((static_cast<uint32_T>(rtb_y_m) <<
      1) + (rtb_y_az || A380PrimComputer_DWork.Delay_DSTATE_e)) << 1) + A380PrimComputer_DWork.Memory_PreviousInput_d];
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_pt, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word, &rtb_y_cp);
    if ((rtb_y_e != 0U) && rtb_y_cp) {
    ...
    if (rtb_AND20) {
      rtb_y_az = (rtb_AND1_ci && (rtb_law_k != A380PrimComputer_P.EnumeratedConstant_Value_l));
    } else {
      rtb_y_az = ((rtb_y_e != 0U) && (rtb_Switch_ir_0->SSM == static_cast<uint32_T>(SignStatusMatrix::NormalOperation)));
    }

    rtb_y_cp = A380PrimComputer_DWork.Memory_PreviousInput_j;
    A380PrimComputer_DWork.Delay_DSTATE_e = A380PrimComputer_P.Logic_table_n[(((rtb_y_az || (std::abs(rtb_thsPos) <=
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel4_bit_p, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel_bit_g, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_cp);
    rtb_AND1_ci = (((!rtb_NOT_k) || (rtb_y_e == 0U)) && rtb_y_cp);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_cp);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel6_bit_l, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel5_bit_as, &rtb_y_e);
    if (rtb_AND1_ci || (rtb_y_cp && ((!rtb_NOT_k) || (rtb_y_e == 0U)))) {
      abs_rate_c = 0.25;
    } else {
      abs_rate_c = 0.15;
    }
    ...
    rtb_BusAssignment_nw_logic_high_speed_prot_hi_thresh_kn = std::fmin(A380PrimComputer_P.Constant7_Value_g,
      rtb_Switch4_d);
    rtb_AND1_ci = rtb_y_az;
    rtb_y_az = (rtb_OR || (static_cast<real_T>(rtb_activeLateralLaw) != A380PrimComputer_P.CompareToConstant_const_m4));
    LawMDLOBJ2.step(&A380PrimComputer_U.in.time.dt, &rtb_rightAileron2Command, &rtb_elevator1Command,
                    ...
                    &A380PrimComputer_U.in.analog_inputs.rudder_pedal_pos, &rtb_OR6, &rtb_y_az,
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel_bit_la, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word, &rtb_y_az);
    if ((rtb_y_e != 0U) && rtb_y_az) {
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       (A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_1_position_deg.Data), rtb_y_cp, &rtb_Switch4_d,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_1_position_deg.Data), rtb_y_cp, &rtb_Switch4_d,
    ...
    rtb_y_cp = ((!rtb_AND17) || rtb_AND2_i);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs10_up, A380PrimComputer_P.RateLimiterGenericVariableTs10_lo,
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.Data), rtb_y_cp, &rtb_Switch4_d,
    ...
    A380PrimComputer_RateLimiter_a(rtb_outerAilUpperLim, A380PrimComputer_P.RateLimiterGenericVariableTs11_up,
      ...
      (A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.Data), rtb_y_cp, &rtb_Switch4_d,
    ...
    rtb_y_cp = ((!rtb_AND4_d) || rtb_AND2_i);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs14_up, A380PrimComputer_P.RateLimiterGenericVariableTs14_lo,
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.Data), rtb_y_cp, &rtb_eta_trim_limit_up_m,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data), rtb_y_cp,
    ...
    rtb_y_cp = ((!rtb_AND7) || rtb_AND2_i);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs12_up, A380PrimComputer_P.RateLimiterGenericVariableTs12_lo,
       A380PrimComputer_U.in.time.dt, rtb_leftSplr4Pos, rtb_y_cp, &rtb_eta_trim_limit_up_m,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, rtb_rightSplr4Pos, rtb_y_cp, &rtb_eta_trim_limit_up_m,
    ...
    A380PrimComputer_RateLimiter_a(rtb_Switch_h, A380PrimComputer_P.RateLimiterGenericVariableTs19_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs19_lo, A380PrimComputer_U.in.time.dt, rtb_rightSplr5Pos, rtb_y_cp,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, rtb_rightSplr6Pos, rtb_y_cp, &rtb_Switch1_k,
    ...
    rtb_y_cp = ((!rtb_AND16) || rtb_AND2_i);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs22_up, A380PrimComputer_P.RateLimiterGenericVariableTs22_lo,
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.Data), rtb_y_cp, &rtb_Switch1_k,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.Data), rtb_y_cp, &rtb_Switch1_k,
    ...
    rtb_y_cp = ((!rtb_AND9_o) || rtb_AND2_i);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs20_up, A380PrimComputer_P.RateLimiterGenericVariableTs20_lo,
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_2_position_deg.Data), rtb_y_cp, &rtb_Switch4_d,
    ...
    A380PrimComputer_RateLimiter_a(rtb_Switch_h, A380PrimComputer_P.RateLimiterGenericVariableTs21_up,
      ...
      (A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.Data), rtb_y_cp, &rtb_Switch4_d,
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel_bit_p, &rtb_y_e);
    rtb_y_az = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_h, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_fv, &rtb_y_e);
    rtb_y_cp = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_cv, &rtb_y_e);
    rtb_y_m = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_n4, &rtb_y_e);
    rtb_DataTypeConversion_m5 = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_py, &rtb_y_e);
    A380PrimComputer_MATLABFunction_o(rtb_y_az, rtb_NOT_k, rtb_y_cp, rtb_y_m, rtb_DataTypeConversion_m5, (rtb_y_e != 0U),
      &rtb_Switch1_k);
    rtb_y_az = (rtb_OR || ((static_cast<real_T>(rtb_law_k) != A380PrimComputer_P.CompareToConstant_const_f) && (
    ...
    LawMDLOBJ5.step(&A380PrimComputer_U.in.time.dt, &A380PrimComputer_U.in.time.simulation_time, &rtb_elevator2Command,
      ...
      const_cast<real_T*>(&A380PrimComputer_RGND)), &u0, &rtb_OR6, &rtb_y_az, &A380PrimComputer_DWork.sProtActive_l,
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel_bit_n, &rtb_y_e);
    rtb_y_az = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_h1, &rtb_y_e);
    rtb_NOT_k = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_gn, &rtb_y_e);
    rtb_y_cp = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_b, &rtb_y_e);
    rtb_y_m = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_i, &rtb_y_e);
    rtb_DataTypeConversion_m5 = (rtb_y_e != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_l, &rtb_y_e);
    A380PrimComputer_MATLABFunction_o(rtb_y_az, rtb_NOT_k, rtb_y_cp, rtb_y_m, rtb_DataTypeConversion_m5, (rtb_y_e != 0U),
      &rtb_Switch_h);
    rtb_y_az = (rtb_OR || ((static_cast<real_T>(rtb_law_k) != A380PrimComputer_P.CompareToConstant3_const_o) && (
    ...
    LawMDLOBJ3.step(&A380PrimComputer_U.in.time.dt, &rtb_elevator2Command, &rtb_rightAileron2Command,
      ...
      const_cast<real_T*>(&A380PrimComputer_RGND)), &u0, &rtb_y_az, &rtb_NOT_k, &rtb_eta_deg_o,
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel_bit_of, &rtb_y_e);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word, &rtb_y_az);
    if ((rtb_y_e != 0U) && rtb_y_az) {
      rtb_Switch_left_inboard_aileron_command_deg_Data =
    ...
    rtb_VectorConcatenate[6] = rtb_y_a;
    rtb_VectorConcatenate[7] = rtb_y_pd;
    ...
    A380PrimComputer_Y.out.logic.elevator_3_avail = rtb_y_a;
    A380PrimComputer_Y.out.logic.elevator_3_engaged = rtb_y_pd;
    ...
    A380PrimComputer_Y.out.logic.speed_brake_inhibited = rtb_y_kf;
    ...
    A380PrimComputer_Y.out.discrete_outputs.elevator_3_active_mode = rtb_y_pd;
