...
void A380PrimComputer::step()
{
  ...
  if (A380PrimComputer_U.in.sim_data.computer_running) {
    ...
    speedBrakeGain = rtb_Switch10_n * speedBrakeGain + rtb_Switch1_k;
    if (rtb_NOT_k) {
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg = rtb_right_spoiler_2_deg;
    } else {
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg = speedBrakeGain;
    }
    ...
    if (rtb_NOT_k) {
      speedBrakeGain = rtb_right_spoiler_2_deg;
    }

    A380PrimComputer_RateLimiter_a(speedBrakeGain, A380PrimComputer_P.RateLimiterGenericVariableTs11_up,
    ...
    if (rtb_AND20) {
      speedBrakeGain = rtb_eta_trim_limit_up_m;
    } else {
      speedBrakeGain = rtb_Switch_left_spoiler_3_command_deg_Data;
    }
    ...
    A380PrimComputer_Spoiler345Computation(rtb_xi_spoiler_deg_b, rtb_Switch4_d * rtb_Switch10_n + rtb_Switch1_k,
      &rtb_Switch4_d, &rtb_Switch_h);
    if (rtb_NOT_k) {
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg = rtb_Y_dc;
    } else {
    ...
    if (rtb_AND20) {
      ...
      A380PrimComputer_Y.out.bus_outputs.left_spoiler_3_command_deg.Data = static_cast<real32_T>(speedBrakeGain);
    ...
    A380PrimComputer_Y.out.laws.lateral_law_outputs.left_spoiler_3_deg = speedBrakeGain;
