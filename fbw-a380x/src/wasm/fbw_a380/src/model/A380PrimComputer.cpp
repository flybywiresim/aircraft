...
void A380PrimComputer::step()
{
  ...
  if (A380PrimComputer_U.in.sim_data.computer_running) {
    ...
    boolean_T
      rtb_BusConversion_InsertedFor_Rudder1ServoingLogic_at_inport_0_BusCreator1_logic_is_green_hydraulic_power_avail;
    boolean_T
      rtb_BusConversion_InsertedFor_THSServoingLogic_at_inport_0_BusCreator1_logic_is_yellow_hydraulic_power_avail;
    ...
    boolean_T rtb_OR6;
    boolean_T rtb_OR7;
    boolean_T rtb_TmpSignalConversionAtSFunctionInport9_idx_1;
    ...
    if (!A380PrimComputer_DWork.Runtime_MODE) {
      ...
      A380PrimComputer_MATLABFunction_p_Reset(&A380PrimComputer_DWork.sf_MATLABFunction_al4);
    ...
    rtb_AND1 = (rtb_OR && rtb_OR7);
    rtb_doubleIrFault = (rtb_tripleIrFault || rtb_AND1 || (rtb_OR6 && rtb_OR7));
    rtb_tripleIrFault = (rtb_tripleIrFault && rtb_OR7);
    rtb_AND13 = !rtb_OR4;
    rtb_AND11 = !rtb_OR3;
    if (rtb_OR1 && rtb_AND11 && rtb_AND13) {
    ...
    } else if ((!rtb_OR1) && rtb_OR3 && rtb_AND13) {
      ...
      rtb_alpha = (A380PrimComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data +
                   A380PrimComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.Data) / 2.0F;
    } else if (((!rtb_OR1) && rtb_AND11 && rtb_AND13) || ((!rtb_OR1) && rtb_AND11 && rtb_OR4)) {
      rtb_V_ias = (A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data +
      ...
      rtb_mach_h = A380PrimComputer_U.in.bus_inputs.adr_1_bus.mach.Data;
      rtb_alpha = A380PrimComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data;
    } else if (rtb_OR1 && rtb_AND11 && rtb_OR4) {
      rtb_V_ias = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.Data;
      rtb_V_tas = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
      rtb_mach_h = A380PrimComputer_U.in.bus_inputs.adr_2_bus.mach.Data;
      rtb_alpha = A380PrimComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
    ...
    rtb_AND13 = !rtb_OR6;
    rtb_AND11 = !rtb_OR7;
    rtb_AND10 = (rtb_OR && rtb_AND11);
    if (rtb_AND10 && rtb_AND13) {
      ...
      rtb_AND17 = !rtb_OR;
      rtb_OR7 = (rtb_AND17 && rtb_OR7);
      if (rtb_OR7 && rtb_AND13) {
        ...
        rtb_AND11 = (rtb_AND17 && rtb_AND11);
        if ((rtb_AND11 && rtb_AND13) || (rtb_AND11 && rtb_OR6)) {
          rtb_alpha = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.Data +
                       A380PrimComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.Data) / 2.0F;
          rtb_phi = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.roll_angle_deg.Data +
                     A380PrimComputer_U.in.bus_inputs.ir_3_bus.roll_angle_deg.Data) / 2.0F;
    ...
    A380PrimComputer_MATLABFunction_c(std::abs(A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data -
      ...
      A380PrimComputer_P.ConfirmNode_timeDelay, &rtb_y_b, &A380PrimComputer_DWork.sf_MATLABFunction_jz);
    rtb_OR6 = (rtb_tripleAdrFault || (rtb_doubleAdrFault && A380PrimComputer_P.Constant1_Value_b));
    A380PrimComputer_MATLABFunction_c((A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data > 50.0F) &&
      ...
      NormalOperation)) && (rtb_V_ias > 200.0F) && rtb_OR6, A380PrimComputer_U.in.time.dt,
      A380PrimComputer_P.ConfirmNode2_isRisingEdge, A380PrimComputer_P.ConfirmNode2_timeDelay, &rtb_y_c,
    ...
    A380PrimComputer_DWork.ra1CoherenceRejected = (rtb_y_c || A380PrimComputer_DWork.ra1CoherenceRejected);
    A380PrimComputer_DWork.ra2CoherenceRejected = (rtb_NOT_k || A380PrimComputer_DWork.ra2CoherenceRejected);
    rtb_OR = ((A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.SSM == static_cast<uint32_T>(SignStatusMatrix::
    ...
    } else if ((rtb_OR && rtb_AND13) || (rtb_AND11 && rtb_OR1)) {
    ...
    rtb_OR6 = (rtb_OR && rtb_OR1);
    rtb_AND1 = ((rtb_raComputationValue < A380PrimComputer_P.CompareToConstant_const) && (!rtb_OR6));
    rtb_y_kx = (A380PrimComputer_U.in.sim_data.slew_on || A380PrimComputer_U.in.sim_data.pause_on ||
                A380PrimComputer_U.in.sim_data.tracking_mode_on_override);
    A380PrimComputer_B.logic.tracking_mode_on = rtb_y_kx;
    A380PrimComputer_MATLABFunction_j(A380PrimComputer_U.in.analog_inputs.yellow_hyd_pressure_psi,
      A380PrimComputer_P.HysteresisNode2_highTrigger, A380PrimComputer_P.HysteresisNode2_lowTrigger, &rtb_y_c,
      &A380PrimComputer_DWork.sf_MATLABFunction_jg);
    A380PrimComputer_MATLABFunction_c((!A380PrimComputer_U.in.discrete_inputs.yellow_low_pressure) && rtb_y_c,
      A380PrimComputer_U.in.time.dt, A380PrimComputer_P.ConfirmNode_isRisingEdge_k,
      A380PrimComputer_P.ConfirmNode_timeDelay_n, &rtb_NOT_k, &A380PrimComputer_DWork.sf_MATLABFunction_cj);
    A380PrimComputer_MATLABFunction_j(A380PrimComputer_U.in.analog_inputs.green_hyd_pressure_psi,
      A380PrimComputer_P.HysteresisNode3_highTrigger, A380PrimComputer_P.HysteresisNode3_lowTrigger, &rtb_y_c,
      &A380PrimComputer_DWork.sf_MATLABFunction_br);
    A380PrimComputer_MATLABFunction_c((!A380PrimComputer_U.in.discrete_inputs.green_low_pressure) && rtb_y_c,
      A380PrimComputer_U.in.time.dt, A380PrimComputer_P.ConfirmNode2_isRisingEdge_j,
      A380PrimComputer_P.ConfirmNode2_timeDelay_k, &rtb_y_c, &A380PrimComputer_DWork.sf_MATLABFunction_gfx);
    rtb_OR7 = rtb_NOT_k;
    rtb_OR = rtb_y_c;
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_y_ik = A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word.SSM;
      rtb_y_oq = A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word.Data;
    } else {
      rtb_y_ik = A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word.SSM;
      rtb_y_oq = A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word.Data;
    }

    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.SSM = rtb_y_ik;
    ...
    A380PrimComputer_MATLABFunction_e(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1,
      A380PrimComputer_P.BitfromLabel2_bit, &rtb_y_j);
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.SSM = rtb_y_ik;
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.Data = rtb_y_oq;
    A380PrimComputer_MATLABFunction(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1, &rtb_y_mj);
    rtb_AND1_e = ((rtb_y_j != 0U) && rtb_y_mj);
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.SSM = rtb_y_ik;
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.Data = rtb_y_oq;
    A380PrimComputer_MATLABFunction_e(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1,
      A380PrimComputer_P.BitfromLabel1_bit_b, &rtb_y_j);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_OR4 = true;
      rightAileron2Avail = true;
      leftSpoilerHydraulicModeAvail = rtb_y_c;
      A380PrimComputer_B.logic.left_spoiler_electric_mode_avail = true;
      rightSpoilerHydraulicModeAvail = rtb_y_c;
      A380PrimComputer_B.logic.right_spoiler_electric_mode_avail = true;
      rtb_leftSpoilerHydraulicModeEngaged = rtb_y_c;
      rtb_leftSpoilerElectricModeEngaged = !rtb_y_c;
      rtb_rightSpoilerHydraulicModeEngaged = rtb_y_c;
      rtb_rightSpoilerElectricModeEngaged = rtb_leftSpoilerElectricModeEngaged;
      elevator1Avail = rtb_y_c;
    } else {
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
        rtb_OR4 = true;
        rightAileron2Avail = true;
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
        ...
        elevator1Avail = (A380PrimComputer_U.in.discrete_inputs.is_unit_3 && rtb_y_c);
      }
    }

    rtb_AND1_e = (rtb_OR4 && (!rtb_AND1_e));
    rtb_rightAileron2Engaged = (rightAileron2Avail && ((!rtb_y_mj) || (rtb_y_j == 0U)));
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_y_ik = A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word.SSM;
      rtb_y_oq = A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word.Data;
    } else {
      rtb_y_ik = A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word.SSM;
    ...
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.Data = rtb_y_oq;
    A380PrimComputer_MATLABFunction_e(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1,
      A380PrimComputer_P.BitfromLabel1_bit_n, &rtb_y_j);
    rtb_AND_cs = (rtb_y_mj && (rtb_y_j != 0U));
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND13 = !rtb_AND_cs;
    } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_AND13 = !rtb_AND_cs;
    } else {
      rtb_AND13 = A380PrimComputer_U.in.discrete_inputs.is_unit_3;
    }

    rtb_AND_cs = (elevator2Avail && rtb_AND13);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_ow);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel3_bit, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word, &rtb_y_mj);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_l, &rtb_y_j);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_y_ow = (rtb_y_ow && (rtb_y_ik != 0U));
    } else {
      rtb_y_ow = (rtb_y_mj && (rtb_y_j != 0U));
    }

    rtb_y_mj = (A380PrimComputer_U.in.discrete_inputs.is_unit_1 || A380PrimComputer_U.in.discrete_inputs.is_unit_2);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND13 = !rtb_y_ow;
    } else {
      rtb_AND13 = (A380PrimComputer_U.in.discrete_inputs.is_unit_2 && (!rtb_y_ow));
    }

    rtb_y_ow = (rtb_y_mj && rtb_AND13);
    rtb_BusConversion_InsertedFor_THSServoingLogic_at_inport_0_BusCreator1_logic_is_yellow_hydraulic_power_avail =
      rtb_NOT_k;
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_bv, &rtb_y_ik);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND13 = ((!rtb_NOT_k) || (rtb_y_ik == 0U));
    } else {
      rtb_thsEngaged = !A380PrimComputer_U.in.discrete_inputs.is_unit_2;
      rtb_BusConversion_InsertedFor_THSServoingLogic_at_inport_0_BusCreator1_logic_is_yellow_hydraulic_power_avail =
        (rtb_thsEngaged && (A380PrimComputer_U.in.discrete_inputs.is_unit_3 && rtb_y_c));
      rtb_AND13 = (rtb_thsEngaged && A380PrimComputer_U.in.discrete_inputs.is_unit_3);
    }
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_k, &rtb_y_ik);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_e, &rtb_y_j);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word, &rtb_y_b);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      rtb_AND13 = (rtb_y_ik != 0U);
    } else {
      rtb_AND13 = (rtb_y_j != 0U);
    }

    rtb_AND_h0 = (rtb_AND13 && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_c, &rtb_y_j);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel4_bit, &rtb_y_bg);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_y_ik = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word.SSM;
      rtb_y_oq = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word.Data;
    } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_y_ik = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word.SSM;
      rtb_y_oq = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word.Data;
    } else {
      rtb_y_ik = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word.SSM;
      rtb_y_oq = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word.Data;
    }

    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.SSM = rtb_y_ik;
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.Data = rtb_y_oq;
    A380PrimComputer_MATLABFunction_e(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1,
      A380PrimComputer_P.BitfromLabel6_bit, &rtb_y_n);
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.SSM = rtb_y_ik;
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.Data = rtb_y_oq;
    A380PrimComputer_MATLABFunction(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1, &rtb_y_c);
    rtb_AND6 = ((rtb_y_n != 0U) && rtb_y_c);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_y_ik = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word.SSM;
      rtb_y_oq = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word.Data;
    } else {
    ...
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.Data = rtb_y_oq;
    A380PrimComputer_MATLABFunction_e(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1,
      A380PrimComputer_P.BitfromLabel9_bit, &rtb_y_n);
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.SSM = rtb_y_ik;
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.Data = rtb_y_oq;
    A380PrimComputer_MATLABFunction_e(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1,
      A380PrimComputer_P.BitfromLabel10_bit, &rtb_y_hi);
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.SSM = rtb_y_ik;
    rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1.Data = rtb_y_oq;
    A380PrimComputer_MATLABFunction(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_c1, &rtb_NOT_k);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      rtb_AND13 = (rtb_y_n != 0U);
    } else {
      rtb_AND13 = (rtb_y_hi != 0U);
    }

    rtb_AND3 = (rtb_AND13 && rtb_NOT_k);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_BusConversion_InsertedFor_Rudder1ServoingLogic_at_inport_0_BusCreator1_logic_is_green_hydraulic_power_avail =
        rtb_OR7;
      rudder1ElectricModeAvail = true;
      rudder1HydraulicModeHasPriority = true;
      rtb_AND6 = ((!rtb_AND_h0) && (!rtb_OR7) && (!rtb_AND6) && (!rtb_AND3));
    } else {
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
        rudder1ElectricModeAvail = true;
      } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2 || A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
        ...
        if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
          ...
          rtb_AND13 = (rtb_y_bg != 0U);
        }

        rtb_AND6 = (rudder1HydraulicModeHasPriority && ((!rtb_y_b) || (!rtb_AND13)) &&
                    (!rtb_BusConversion_InsertedFor_Rudder1ServoingLogic_at_inport_0_BusCreator1_logic_is_green_hydraulic_power_avail)
                    && (!rtb_AND6) && (!rtb_AND3));
      } else {
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel5_bit, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word, &rtb_y_b);
    rtb_AND2_jo = ((rtb_y_ik != 0U) && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel7_bit, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word, &rtb_NOT_k);
    rtb_y_b = ((rtb_y_ik != 0U) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel8_bit, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word, &rtb_y_c);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rudder1HydraulicModeHasPriority = rtb_OR;
      rtb_AND3 = true;
      rudder2HydraulicModeHasPriority = true;
      rtb_y_b = ((!rtb_AND2_jo) && (!rtb_OR) && (!rtb_y_b) && ((rtb_y_ik == 0U) || (!rtb_y_c)));
    } else {
      rudder1HydraulicModeHasPriority = false;
      rtb_AND3 = false;
    ...
    rtb_AND2_jo = (rudder1HydraulicModeHasPriority && rudder2HydraulicModeHasPriority);
    rudder2HydraulicModeHasPriority = (rtb_AND3 && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel_bit_i, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word, &rtb_y_kx);
    rtb_AND5_e = ((rtb_y_ik != 0U) && rtb_y_kx);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_c, &rtb_y_ik);
    rtb_AND3_d = ((rtb_y_ik != 0U) && rtb_y_kx);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_p, &rtb_y_ik);
    rtb_AND2_b = ((rtb_y_ik != 0U) && rtb_y_kx);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_n, &rtb_y_ik);
    rtb_AND1_at = ((rtb_y_ik != 0U) && rtb_y_kx);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_j, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word, &rtb_y_k);
    rtb_AND4_n = ((rtb_y_ik != 0U) && rtb_y_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_i, &rtb_y_ik);
    rtb_AND6_m = ((rtb_y_ik != 0U) && rtb_y_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_j, &rtb_y_ik);
    rtb_AND7 = ((rtb_y_ik != 0U) && rtb_y_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_n, &rtb_y_ik);
    rtb_AND8 = ((rtb_y_ik != 0U) && rtb_y_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel8_bit_n, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word, &rtb_y_b);
    rtb_AND13 = ((rtb_y_ik != 0U) && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_b, &rtb_y_ik);
    rtb_AND11 = ((rtb_y_ik != 0U) && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel10_bit_h, &rtb_y_ik);
    rtb_AND10 = ((rtb_y_ik != 0U) && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel11_bit, &rtb_y_ik);
    rtb_AND9 = ((rtb_y_ik != 0U) && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel14_bit, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word, &rtb_NOT_k);
    rtb_AND15 = ((rtb_y_ik != 0U) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel15_bit, &rtb_y_ik);
    rtb_AND16 = ((rtb_y_ik != 0U) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel16_bit, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word, &rtb_y_c);
    rtb_AND17 = ((rtb_y_ik != 0U) && rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel17_bit, &rtb_y_ik);
    rtb_TmpSignalConversionAtSFunctionInport9_idx_1 = ((rtb_y_ik != 0U) && rtb_y_c);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      leftInboardAilEngaged = (rtb_OR1 || rtb_AND2_b);
      rtb_DataTypeConversion_hm = (rtb_OR3 || rtb_AND1_at);
      rtb_AND2_b = (rtb_AND1_e || rtb_AND4_n);
      rtb_AND1_at = (rtb_rightAileron2Engaged || rtb_AND6_m);
      rtb_AND5_e = (rtb_AND5_e || rtb_AND7);
      rtb_AND6_m = (rtb_AND3_d || rtb_AND8);
      ...
      leftInboardAilEngaged = (rtb_AND1_e || rtb_AND5_e);
      rtb_DataTypeConversion_hm = (rtb_rightAileron2Engaged || rtb_AND3_d);
      rtb_AND2_b = (rtb_AND2_b || rtb_AND4_n);
      rtb_AND1_at = (rtb_AND1_at || rtb_AND6_m);
      rtb_AND5_e = (rtb_OR1 || rtb_AND7);
      rtb_AND6_m = (rtb_OR3 || rtb_AND8);
      A380PrimComputer_B.logic.lateral_surface_positions.left_inboard_aileron_deg =
        A380PrimComputer_U.in.analog_inputs.left_aileron_2_pos_deg;
      A380PrimComputer_B.logic.lateral_surface_positions.right_inboard_aileron_deg =
        A380PrimComputer_U.in.analog_inputs.right_aileron_2_pos_deg;
      ...
      leftInboardAilEngaged = (rtb_AND5_e || rtb_AND7);
      rtb_DataTypeConversion_hm = (rtb_AND3_d || rtb_AND8);
      rtb_AND2_b = (rtb_OR1 || rtb_AND2_b);
      rtb_AND1_at = (rtb_OR3 || rtb_AND1_at);
      rtb_AND5_e = (rtb_AND4_n || rtb_AND1_e);
      rtb_AND6_m = (rtb_AND6_m || rtb_rightAileron2Engaged);
      if (A380PrimComputer_U.in.bus_inputs.prim_x_bus.left_aileron_1_position_deg.SSM == static_cast<uint32_T>
          (SignStatusMatrix::NormalOperation)) {
        A380PrimComputer_B.logic.lateral_surface_positions.left_inboard_aileron_deg =
          A380PrimComputer_U.in.bus_inputs.prim_x_bus.left_aileron_1_position_deg.Data;
      ...
      rtb_DataTypeConversion_hm = false;
      rtb_AND2_b = false;
      rtb_AND1_at = false;
      rtb_AND5_e = false;
      rtb_AND6_m = false;
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word, &rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_g, &rtb_y_ik);
    rtb_y_o = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_pc, &rtb_y_ik);
    rtb_y_o = (rtb_y_c && (rtb_y_o || (rtb_y_ik != 0U)));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word, &rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_i, &rtb_y_ik);
    rtb_y_kx = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_n, &rtb_y_ik);
    rtb_y_kx = (rtb_y_c && (rtb_y_kx || (rtb_y_ik != 0U)));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.spoiler_status_word, &rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_nd, &rtb_y_ik);
    rtb_AND3_d = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_d, &rtb_y_ik);
    rtb_y_k = (rtb_y_c && (rtb_AND3_d || (rtb_y_ik != 0U)));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel8_bit_l, &rtb_y_ik);
    rtb_AND3_d = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_g, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word, &rtb_NOT_k);
    rtb_AND3_d = ((rtb_AND3_d || (rtb_y_ik != 0U)) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel10_bit_j, &rtb_y_ik);
    rtb_y_b = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel11_bit_j, &rtb_y_ik);
    rtb_AND4_n = ((rtb_y_b || (rtb_y_ik != 0U)) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel14_bit_p, &rtb_y_ik);
    rtb_y_b = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel15_bit_i, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word, &rtb_y_c);
    rtb_NOT_k = ((rtb_y_b || (rtb_y_ik != 0U)) && rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel12_bit, &rtb_y_ik);
    rtb_y_b = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel13_bit, &rtb_y_ik);
    rtb_y_b = ((rtb_y_b || (rtb_y_ik != 0U)) && rtb_y_c);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      A380PrimComputer_B.logic.surface_statuses.spoiler_pair_4_engaged = (rtb_NOT_k || rtb_y_b);
      A380PrimComputer_B.logic.surface_statuses.spoiler_pair_5_engaged = (rtb_AND3_d || rtb_AND4_n);
      ...
      A380PrimComputer_B.logic.surface_statuses.spoiler_pair_5_engaged = (rtb_leftSpoilerHydraulicModeEngaged ||
        rtb_leftSpoilerElectricModeEngaged || rtb_rightSpoilerHydraulicModeEngaged ||
        rtb_rightSpoilerElectricModeEngaged);
      A380PrimComputer_B.logic.surface_statuses.spoiler_pair_6_engaged = (rtb_AND3_d || rtb_AND4_n);
    } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      A380PrimComputer_B.logic.surface_statuses.spoiler_pair_4_engaged = (rtb_leftSpoilerHydraulicModeEngaged ||
        rtb_leftSpoilerElectricModeEngaged || rtb_rightSpoilerHydraulicModeEngaged ||
        rtb_rightSpoilerElectricModeEngaged);
      A380PrimComputer_B.logic.surface_statuses.spoiler_pair_5_engaged = (rtb_NOT_k || rtb_y_b);
      A380PrimComputer_B.logic.surface_statuses.spoiler_pair_6_engaged = (rtb_AND3_d || rtb_AND4_n);
    } else {
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word, &rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_l, &rtb_y_ik);
    rtb_y_b = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_f, &rtb_y_ik);
    rtb_y_b = (rtb_y_c && (rtb_y_b || (rtb_y_ik != 0U)));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word, &rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_p, &rtb_y_ik);
    rtb_AND3_d = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_b, &rtb_y_ik);
    A380PrimComputer_B.logic.surface_statuses.spoiler_pair_8_engaged = (rtb_y_c && (rtb_AND3_d || (rtb_y_ik != 0U)));
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputer_B.logic.surface_statuses.spoiler_pair_1_engaged = rtb_y_o;
    A380PrimComputer_B.logic.surface_statuses.spoiler_pair_2_engaged = rtb_y_kx;
    A380PrimComputer_B.logic.surface_statuses.spoiler_pair_3_engaged = rtb_y_k;
    A380PrimComputer_B.logic.surface_statuses.spoiler_pair_7_engaged = rtb_y_b;
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel16_bit_b, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word, &rtb_y_c);
    rtb_AND4_n = ((rtb_y_ik != 0U) && rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel17_bit_i, &rtb_y_ik);
    rtb_AND15_l = ((rtb_y_ik != 0U) && rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel18_bit, &rtb_y_ik);
    rtb_AND7 = ((rtb_y_ik != 0U) && rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel19_bit, &rtb_y_ik);
    rtb_AND8 = ((rtb_y_ik != 0U) && rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel20_bit, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_b);
    rtb_AND16_n = ((rtb_y_ik != 0U) && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel21_bit, &rtb_y_ik);
    rtb_AND18_c = ((rtb_y_ik != 0U) && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel22_bit, &rtb_y_ik);
    rtb_AND19 = ((rtb_y_ik != 0U) && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel23_bit, &rtb_y_ik);
    rtb_AND20 = ((rtb_y_ik != 0U) && rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_lr, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word, &rtb_y_o);
    rtb_NOT_k = ((rtb_y_ik != 0U) && rtb_y_o);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_g, &rtb_y_ik);
    rtb_AND3_h = ((rtb_y_ik != 0U) && rtb_y_o);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_k, &rtb_y_ik);
    rtb_y_c = ((rtb_y_ik != 0U) && rtb_y_o);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_n, &rtb_y_ik);
    rtb_y_b = ((rtb_y_ik != 0U) && rtb_y_o);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_e, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word, &rtb_y_kx);
    rtb_AND4_d = ((rtb_y_ik != 0U) && rtb_y_kx);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_b, &rtb_y_ik);
    rtb_AND6_b = ((rtb_y_ik != 0U) && rtb_y_kx);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_p, &rtb_y_ik);
    rtb_y_kx = ((rtb_y_ik != 0U) && rtb_y_kx);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel8_bit_d, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word, &rtb_y_k);
    rtb_AND11_m = ((rtb_y_ik != 0U) && rtb_y_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_e, &rtb_y_ik);
    rtb_y_o = ((rtb_y_ik != 0U) && rtb_y_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel11_bit_n, &rtb_y_ik);
    rtb_AND3_d = ((rtb_y_ik != 0U) && rtb_y_k);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_y_k = (rtb_AND_cs || rtb_AND16_n);
      rtb_AND19 = (rtb_AND18_c || rtb_AND7);
      rtb_AND15_l = (elevator1Avail || rtb_AND15_l);
      rtb_AND16_n = (rtb_AND4_n || rtb_y_ow);
      rtb_AND4_n = (rtb_thsEngaged || rtb_AND20);
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
        rtb_y_k = (rtb_AND16_n || rtb_AND15_l);
        rtb_AND19 = (rtb_y_ow || rtb_AND18_c);
        rtb_AND15_l = (rtb_AND_cs || rtb_AND4_n);
        rtb_AND16_n = (elevator1Avail || rtb_AND7);
        rtb_AND4_n = (rtb_AND8 || rtb_AND20);
      } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
        rtb_y_k = (elevator1Avail || rtb_AND15_l);
        rtb_AND19 = (rtb_AND_cs || rtb_AND19);
        rtb_AND15_l = (rtb_AND4_n || rtb_AND18_c);
        rtb_AND16_n = (rtb_AND16_n || rtb_AND7);
        rtb_AND4_n = (rtb_thsEngaged || rtb_AND8);
      } else {
        rtb_y_k = false;
        rtb_AND19 = false;
        rtb_AND15_l = false;
    ...
    rtb_AND7 = (rtb_y_k || (rtb_AND11_m || rtb_AND3_h));
    rtb_AND8 = (rtb_AND19 || (rtb_y_o || rtb_y_kx));
    rtb_AND6_b = (rtb_AND15_l || (rtb_NOT_k || rtb_AND6_b));
    rtb_AND4_d = (rtb_AND16_n || (rtb_AND4_d || rtb_y_c));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel38_bit, &rtb_y_ik);
    rtb_NOT_k = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel39_bit, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word, &rtb_y_k);
    rtb_AND15_l = ((rtb_NOT_k || (rtb_y_ik != 0U)) && rtb_y_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel32_bit, &rtb_y_ik);
    rtb_NOT_k = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel33_bit, &rtb_y_ik);
    rtb_y_k = ((rtb_NOT_k || (rtb_y_ik != 0U)) && rtb_y_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel36_bit, &rtb_y_ik);
    rtb_NOT_k = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel37_bit, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word, &rtb_y_c);
    rtb_AND18_c = ((rtb_NOT_k || (rtb_y_ik != 0U)) && rtb_y_c);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_m, &rtb_y_ik);
    rtb_NOT_k = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_b, &rtb_y_ik);
    rtb_AND16_n = (rtb_NOT_k || (rtb_y_ik != 0U));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word, &rtb_y_kx);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_pt, &rtb_y_ik);
    rtb_NOT_k = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_h, &rtb_y_ik);
    rtb_y_c = (rtb_NOT_k || (rtb_y_ik != 0U));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_d, &rtb_y_ik);
    rtb_NOT_k = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_p, &rtb_y_ik);
    rtb_AND20 = (rtb_NOT_k || (rtb_y_ik != 0U));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word, &rtb_y_o);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_g, &rtb_y_ik);
    rtb_NOT_k = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel8_bit_i, &rtb_y_ik);
    rtb_AND3_h = (rtb_NOT_k || (rtb_y_ik != 0U));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word, &rtb_NOT_k);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND15_l = (rtb_AND_h0 || rtb_AND6 || rtb_AND15_l);
      rtb_AND18_c = (rtb_AND2_jo || rudder2HydraulicModeHasPriority || rtb_AND18_c);
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
        rtb_AND15_l = (rtb_AND_h0 || rtb_AND6 || rtb_AND15_l);
        rtb_AND18_c = (rtb_y_k || rtb_AND18_c);
      } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
        rtb_AND15_l = (rtb_AND15_l || rtb_AND18_c);
        rtb_AND18_c = (rtb_AND_h0 || rtb_AND6 || rtb_y_k);
      } else {
        rtb_AND15_l = false;
        rtb_AND18_c = false;
      }
    ...
    rtb_y_k = (rtb_AND15_l || (rtb_AND16_n && rtb_y_kx) || (rtb_AND20 && rtb_y_o));
    rtb_y_kx = (rtb_AND18_c || (rtb_y_c && rtb_y_kx) || (rtb_AND3_h && rtb_NOT_k));
    rtb_AND13 = (leftInboardAilEngaged || (rtb_AND13 || rtb_AND15));
    A380PrimComputer_B.logic.surface_statuses.left_inboard_aileron_engaged = rtb_AND13;
    rtb_AND11 = (rtb_DataTypeConversion_hm || (rtb_AND11 || rtb_AND16));
    A380PrimComputer_B.logic.surface_statuses.right_inboard_aileron_engaged = rtb_AND11;
    rtb_AND10 = (rtb_AND2_b || (rtb_AND10 || rtb_AND17));
    A380PrimComputer_B.logic.surface_statuses.left_midboard_aileron_engaged = rtb_AND10;
    rtb_AND17 = (rtb_AND1_at || (rtb_AND9 || rtb_TmpSignalConversionAtSFunctionInport9_idx_1));
    A380PrimComputer_B.logic.surface_statuses.right_midboard_aileron_engaged = rtb_AND17;
    A380PrimComputer_B.logic.surface_statuses.left_outboard_aileron_engaged = rtb_AND5_e;
    A380PrimComputer_B.logic.surface_statuses.right_outboard_aileron_engaged = rtb_AND6_m;
    A380PrimComputer_MATLABFunction_c(A380PrimComputer_U.in.sim_data.slew_on, A380PrimComputer_U.in.time.dt,
      A380PrimComputer_P.ConfirmNode_isRisingEdge_o, A380PrimComputer_P.ConfirmNode_timeDelay_d, &rtb_y_c,
      &A380PrimComputer_DWork.sf_MATLABFunction_nb);
    rtb_AND9 = !rtb_AND1;
    rtb_TmpSignalConversionAtSFunctionInport9_idx_1 = ((!rtb_y_c) && rtb_AND9 && (((!rtb_tripleAdrFault) && ((rtb_mach_h
      > 0.96) || (rtb_Y < -10.0) || (rtb_Y > 37.5) || (rtb_V_ias > 420.0F) || (rtb_V_ias < 70.0F))) ||
      ((!rtb_tripleIrFault) && ((!rtb_doubleIrFault) || (!A380PrimComputer_P.Constant_Value_ad)) && ((std::abs(
      static_cast<real_T>(rtb_phi)) > 120.0) || ((rtb_alpha > 50.0F) || (rtb_alpha < -30.0F))))));
    A380PrimComputer_DWork.abnormalConditionWasActive = (rtb_TmpSignalConversionAtSFunctionInport9_idx_1 || (rtb_AND9 &&
      A380PrimComputer_DWork.abnormalConditionWasActive));
    nz = ((rtb_AND7 + rtb_AND8) + rtb_AND6_b) + rtb_AND4_d;
    b_x[0] = rtb_AND13;
    b_x[1] = rtb_AND11;
    b_x[2] = rtb_AND10;
    b_x[3] = rtb_AND17;
    ...
    if (rtb_TmpSignalConversionAtSFunctionInport9_idx_1) {
      rtb_pitchLawCapability = a380_pitch_efcs_law::DirectLaw;
    } else if (nz == 2) {
      rtb_pitchLawCapability = a380_pitch_efcs_law::AlternateLaw1B;
    } else if (A380PrimComputer_DWork.abnormalConditionWasActive || ((rtb_y_k && (!rtb_y_kx)) || ((!rtb_y_k) && rtb_y_kx))
               || (nz == 3) || (b_nz == 4)) {
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel_bit_o, &rtb_y_ik);
    rtb_AND10 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_e, &rtb_y_ik);
    rtb_AND17 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_hr, &rtb_y_ik);
    rtb_AND11 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_k, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word, &rtb_y_c);
    A380PrimComputer_MATLABFunction_ek(rtb_AND10, rtb_AND17, rtb_AND11, rtb_y_c, &rtb_law_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_l, &rtb_y_ik);
    rtb_AND10 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_bl, &rtb_y_ik);
    rtb_AND17 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_p, &rtb_y_ik);
    rtb_AND11 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_h, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.fctl_law_status_word, &rtb_y_c);
    A380PrimComputer_MATLABFunction_ek(rtb_AND10, rtb_AND17, rtb_AND11, rtb_y_c, &rtb_law);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputer_MATLABFunction_m(A380PrimComputer_U.in.discrete_inputs.fo_priority_takeover_pressed,
      A380PrimComputer_P.PulseNode1_isRisingEdge, &rtb_y_c, &A380PrimComputer_DWork.sf_MATLABFunction_nu);
    if (rtb_NOT_k) {
    ...
    if (!A380PrimComputer_DWork.pRightStickDisabled) {
      rtb_Sum6 = A380PrimComputer_U.in.analog_inputs.fo_pitch_stick_pos;
    } else {
      rtb_Sum6 = A380PrimComputer_P.Constant_Value_p;
    }

    if (A380PrimComputer_DWork.pLeftStickDisabled) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Constant_Value_p;
    } else {
      rtb_outerAilLowerLim = A380PrimComputer_U.in.analog_inputs.capt_pitch_stick_pos;
    }

    rtb_outerAilLowerLim += rtb_Sum6;
    if (rtb_outerAilLowerLim > A380PrimComputer_P.Saturation_UpperSat) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation_UpperSat;
    } else if (rtb_outerAilLowerLim < A380PrimComputer_P.Saturation_LowerSat) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation_LowerSat;
    }

    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel_bit_h, &rtb_y_ik);
    rtb_AND17 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_gs, &rtb_y_ik);
    rtb_y_c = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_nu, &rtb_y_ik);
    rtb_AND11 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_g, &rtb_y_ik);
    rtb_AND16 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_e, &rtb_y_ik);
    rtb_DataTypeConversion_hm = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_a, &rtb_y_ik);
    A380PrimComputer_MATLABFunction_o(rtb_AND17, rtb_y_c, rtb_AND11, rtb_AND16, rtb_DataTypeConversion_hm, rtb_y_ik !=
      0U, &rtb_handleIndex);
    ...
    if (rtb_AND1 || (A380PrimComputer_DWork.eventTime_g == 0.0)) {
      A380PrimComputer_DWork.eventTime_g = A380PrimComputer_U.in.time.simulation_time;
    }
    ...
    A380PrimComputer_GetIASforMach4(static_cast<real_T>(rtb_mach_h), A380PrimComputer_P.Constant8_Value_h,
      static_cast<real_T>(rtb_V_ias), &rtb_Switch8_o);
    rtb_AND17 = ((rtb_law_k == a380_pitch_efcs_law::NormalLaw) || (rtb_activeLateralLaw == a380_lateral_efcs_law::
      NormalLaw));
    ...
    if ((rtb_outerAilLowerLim >= -0.03125) || (rtb_Y >= rtb_Switch_h) || (A380PrimComputer_DWork.resetEventTime == 0.0))
    {
      A380PrimComputer_DWork.resetEventTime = A380PrimComputer_U.in.time.simulation_time;
    }

    A380PrimComputer_DWork.sProtActive = ((rtb_AND9 && rtb_AND17 && (rtb_Y > rtb_handleIndex) &&
    ...
    A380PrimComputer_DWork.sProtActive = ((A380PrimComputer_U.in.time.simulation_time -
      A380PrimComputer_DWork.resetEventTime <= 0.5) && (rtb_outerAilLowerLim >= -0.5) && ((rtb_raComputationValue >=
      200.0F) || (rtb_outerAilLowerLim >= 0.5) || (rtb_Y >= rtb_handleIndex - 2.0)) && rtb_AND9 && rtb_AND17 &&
    ...
    A380PrimComputer_B.logic.surface_statuses.left_inboard_elevator_engaged = rtb_AND7;
    A380PrimComputer_B.logic.surface_statuses.right_inboard_elevator_engaged = rtb_AND8;
    A380PrimComputer_B.logic.surface_statuses.left_outboard_elevator_engaged = rtb_AND6_b;
    A380PrimComputer_B.logic.surface_statuses.right_outboard_elevator_engaged = rtb_AND4_d;
    A380PrimComputer_B.logic.surface_statuses.ths_engaged = (rtb_AND4_n || (rtb_AND3_d || rtb_y_b));
    A380PrimComputer_B.logic.surface_statuses.upper_rudder_engaged = rtb_y_k;
    A380PrimComputer_B.logic.surface_statuses.lower_rudder_engaged = rtb_y_kx;
    ...
    rtb_y_k = (A380PrimComputer_U.in.analog_inputs.thr_lever_3_pos >= A380PrimComputer_P.CompareToConstant1_const);
    rtb_y_o = (A380PrimComputer_U.in.analog_inputs.thr_lever_4_pos >= A380PrimComputer_P.CompareToConstant2_const);
    rtb_NOT_k = (A380PrimComputer_P.Constant_Value_h || A380PrimComputer_DWork.sProtActive ||
    ...
    A380PrimComputer_MATLABFunction_c(A380PrimComputer_U.in.analog_inputs.speed_brake_lever_pos <
      ...
      A380PrimComputer_P.ConfirmNode_isRisingEdge_c, A380PrimComputer_P.ConfirmNode_timeDelay_g, &rtb_y_c,
    ...
    A380PrimComputer_DWork.Memory_PreviousInput = A380PrimComputer_P.Logic_table[(((static_cast<uint32_T>(rtb_NOT_k) <<
      1) + rtb_y_c) << 1) + A380PrimComputer_DWork.Memory_PreviousInput];
    A380PrimComputer_B.logic.speed_brake_inhibited = (rtb_NOT_k || A380PrimComputer_DWork.Memory_PreviousInput);
    A380PrimComputer_MATLABFunction_m(rtb_AND1, A380PrimComputer_P.PulseNode3_isRisingEdge, &rtb_y_k,
      &A380PrimComputer_DWork.sf_MATLABFunction_jj);
    A380PrimComputer_MATLABFunction_m(rtb_AND1, A380PrimComputer_P.PulseNode2_isRisingEdge, &rtb_y_o,
      &A380PrimComputer_DWork.sf_MATLABFunction_ej);
    A380PrimComputer_DWork.Memory_PreviousInput_j = A380PrimComputer_P.Logic_table_h[(((static_cast<uint32_T>(rtb_y_k ||
      ...
      1) + rtb_y_o) << 1) + A380PrimComputer_DWork.Memory_PreviousInput_j];
    rtb_y_b = (A380PrimComputer_U.in.analog_inputs.right_wing_wheel_speed >=
    ...
    rtb_NOT_k = (((A380PrimComputer_U.in.analog_inputs.left_body_wheel_speed >=
                 ...
                 ((A380PrimComputer_U.in.analog_inputs.right_body_wheel_speed >=
                   A380PrimComputer_P.CompareToConstant19_const) || rtb_y_b));
    A380PrimComputer_MATLABFunction_m(false, A380PrimComputer_P.PulseNode1_isRisingEdge_c, &rtb_y_b,
      &A380PrimComputer_DWork.sf_MATLABFunction_ja);
    rtb_y_b = (rtb_y_b || (rtb_NOT_k && A380PrimComputer_DWork.Memory_PreviousInput_j));
    ...
    A380PrimComputer_DWork.Delay1_DSTATE_b = (((((A380PrimComputer_U.in.analog_inputs.speed_brake_lever_pos >
      ...
      (rtb_y_b || A380PrimComputer_DWork.Delay1_DSTATE_b));
    rtb_y_b = (A380PrimComputer_U.in.analog_inputs.thr_lever_1_pos <= A380PrimComputer_P.CompareToConstant8_const);
    rtb_y_k = (A380PrimComputer_U.in.analog_inputs.thr_lever_2_pos < A380PrimComputer_P.CompareToConstant9_const);
    rtb_AND3_d = (((A380PrimComputer_U.in.analog_inputs.thr_lever_1_pos < A380PrimComputer_P.CompareToConstant17_const) &&
                   (A380PrimComputer_U.in.analog_inputs.thr_lever_2_pos <= A380PrimComputer_P.CompareToConstant18_const))
                  || (rtb_y_b && rtb_y_k));
    A380PrimComputer_MATLABFunction_m(false, A380PrimComputer_P.PulseNode_isRisingEdge_n, &rtb_y_b,
    ...
    A380PrimComputer_DWork.Delay_DSTATE_f = (((((A380PrimComputer_U.in.analog_inputs.speed_brake_lever_pos >
      ...
      rtb_AND3_d) && (rtb_y_b || A380PrimComputer_DWork.Delay_DSTATE_f));
    rtb_y_b = ((!A380PrimComputer_DWork.Delay1_DSTATE_b) && A380PrimComputer_DWork.Delay_DSTATE_f);
    A380PrimComputer_B.logic.ground_spoilers_armed = rtb_NOT_k;
    A380PrimComputer_B.logic.phased_lift_dumping_active = rtb_y_b;
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel_bit_e, &rtb_y_ik);
    rtb_AND3_d = (rtb_y_ik == 0U);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_b);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel1_bit_d, &rtb_y_ik);
    rtb_NOT_k = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_NOT_k);
    A380PrimComputer_B.logic.on_ground = rtb_AND1;
    ...
    A380PrimComputer_B.logic.abnormal_condition_law_active = rtb_TmpSignalConversionAtSFunctionInport9_idx_1;
    A380PrimComputer_B.logic.is_master_prim = rtb_AND10;
    ...
    A380PrimComputer_B.logic.elevator_3_avail = rtb_y_mj;
    A380PrimComputer_B.logic.elevator_3_engaged = rtb_y_ow;
    A380PrimComputer_B.logic.ths_avail =
      rtb_BusConversion_InsertedFor_THSServoingLogic_at_inport_0_BusCreator1_logic_is_yellow_hydraulic_power_avail;
    ...
    A380PrimComputer_B.logic.right_aileron_2_avail = rightAileron2Avail;
    ...
    A380PrimComputer_B.logic.rudder_1_hydraulic_mode_avail =
      rtb_BusConversion_InsertedFor_Rudder1ServoingLogic_at_inport_0_BusCreator1_logic_is_green_hydraulic_power_avail;
    ...
    A380PrimComputer_B.logic.rudder_1_electric_mode_engaged = rtb_AND6;
    A380PrimComputer_B.logic.rudder_2_hydraulic_mode_avail = rudder1HydraulicModeHasPriority;
    A380PrimComputer_B.logic.rudder_2_electric_mode_avail = rtb_AND3;
    A380PrimComputer_B.logic.rudder_2_hydraulic_mode_engaged = rtb_AND2_jo;
    A380PrimComputer_B.logic.rudder_2_electric_mode_engaged = rudder2HydraulicModeHasPriority;
    A380PrimComputer_B.logic.aileron_droop_active = ((rtb_AND3_d && rtb_y_b) || ((rtb_y_ik == 0U) && rtb_NOT_k));
    A380PrimComputer_B.logic.aileron_antidroop_active = A380PrimComputer_DWork.Delay1_DSTATE_b;
    A380PrimComputer_B.logic.is_yellow_hydraulic_power_avail = rtb_OR7;
    ...
    A380PrimComputer_B.logic.total_sidestick_pitch_command = rtb_outerAilLowerLim;
    if (!A380PrimComputer_DWork.pRightStickDisabled) {
      rtb_Sum6 = A380PrimComputer_U.in.analog_inputs.fo_roll_stick_pos;
    } else {
      rtb_Sum6 = A380PrimComputer_P.Constant1_Value_p;
    }

    if (A380PrimComputer_DWork.pLeftStickDisabled) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Constant1_Value_p;
    } else {
      rtb_outerAilLowerLim = A380PrimComputer_U.in.analog_inputs.capt_roll_stick_pos;
    }

    rtb_outerAilLowerLim += rtb_Sum6;
    if (rtb_outerAilLowerLim > A380PrimComputer_P.Saturation1_UpperSat) {
      A380PrimComputer_B.logic.total_sidestick_roll_command = A380PrimComputer_P.Saturation1_UpperSat;
    } else if (rtb_outerAilLowerLim < A380PrimComputer_P.Saturation1_LowerSat) {
      A380PrimComputer_B.logic.total_sidestick_roll_command = A380PrimComputer_P.Saturation1_LowerSat;
    } else {
      A380PrimComputer_B.logic.total_sidestick_roll_command = rtb_outerAilLowerLim;
    }
    ...
    A380PrimComputer_B.logic.protection_ap_disconnect = ((rtb_AND9 && (((nz != 0) && (rtb_Y > rtb_Switch_h)) || (rtb_Y >
    ...
    A380PrimComputer_B.logic.dual_ra_failure = rtb_OR6;
    ...
    if (A380PrimComputer_B.logic.aileron_droop_active) {
      rtb_Sum6 = A380PrimComputer_P.Constant2_Value;
    } else {
      rtb_Sum6 = A380PrimComputer_P.Constant1_Value;
    }

    A380PrimComputer_RateLimiter(rtb_Sum6, A380PrimComputer_P.RateLimiterVariableTs2_up,
    ...
    if (A380PrimComputer_B.logic.aileron_antidroop_active) {
      rtb_Sum6 = A380PrimComputer_P.Constant4_Value_a;
    } else {
      rtb_Sum6 = A380PrimComputer_P.Constant3_Value;
    }

    A380PrimComputer_RateLimiter(rtb_Sum6, A380PrimComputer_P.RateLimiterVariableTs3_up,
    ...
    rtb_Y += rtb_Switch8_o;
    rtb_outerAilLowerLim = A380PrimComputer_P.Gain_Gain * rtb_handleIndex + rtb_Y;
    if (rtb_outerAilLowerLim > A380PrimComputer_P.Saturation2_UpperSat) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation2_UpperSat;
    } else if (rtb_outerAilLowerLim < A380PrimComputer_P.Saturation2_LowerSat) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation2_LowerSat;
    }

    A380PrimComputer_RateLimiter_a(rtb_outerAilLowerLim, A380PrimComputer_P.RateLimiterGenericVariableTs_up_b,
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel_bit_l, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word, &rtb_y_k);
    rtb_doubleAdrFault = ((rtb_y_ik != 0U) && rtb_y_k);
    ...
    rtb_outerAilLowerLim = rtb_Y + rtb_handleIndex;
    if (rtb_outerAilLowerLim > A380PrimComputer_P.Saturation1_UpperSat_a) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation1_UpperSat_a;
    } else if (rtb_outerAilLowerLim < A380PrimComputer_P.Saturation1_LowerSat_p) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation1_LowerSat_p;
    }

    A380PrimComputer_RateLimiter_a(rtb_outerAilLowerLim, A380PrimComputer_P.RateLimiterGenericVariableTs1_up_k,
    ...
    rtb_outerAilLowerLim = A380PrimComputer_P.Gain3_Gain * rtb_Switch_h + rtb_Y;
    if (rtb_outerAilLowerLim > A380PrimComputer_P.Saturation3_UpperSat) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation3_UpperSat;
    } else if (rtb_outerAilLowerLim < A380PrimComputer_P.Saturation3_LowerSat) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation3_LowerSat;
    }

    A380PrimComputer_RateLimiter_a(rtb_outerAilLowerLim, A380PrimComputer_P.RateLimiterGenericVariableTs2_up,
    ...
    rtb_outerAilLowerLim = rtb_Y + rtb_Switch_h;
    if (rtb_outerAilLowerLim > A380PrimComputer_P.Saturation4_UpperSat) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation4_UpperSat;
    } else if (rtb_outerAilLowerLim < A380PrimComputer_P.Saturation4_LowerSat) {
      rtb_outerAilLowerLim = A380PrimComputer_P.Saturation4_LowerSat;
    }

    A380PrimComputer_RateLimiter_a(rtb_outerAilLowerLim, A380PrimComputer_P.RateLimiterGenericVariableTs3_up,
    ...
    rtb_handleIndex = std::fmax(std::fmin(-(A380PrimComputer_B.logic.adr_computation_data.V_ias_kn - 240.0) / 20.0, 1.0),
      0.0) * 20.0;
    rtb_outerAilLowerLim = std::fmax(std::fmin(-(A380PrimComputer_B.logic.adr_computation_data.V_ias_kn - 300.0) / 20.0,
      1.0), 0.0) * -30.0;
    switch (static_cast<int32_T>(A380PrimComputer_B.logic.active_lateral_law)) {
     case 0:
    ...
    rtb_Sum6 = A380PrimComputer_P.Gain4_Gain * rtb_Switch_h + rtb_Y;
    if (rtb_Sum6 > rtb_handleIndex) {
    ...
    rtb_Y += rtb_Switch_h;
    if (rtb_Y > rtb_handleIndex) {
      rtb_Y = rtb_handleIndex;
    } else if (rtb_Y < rtb_outerAilLowerLim) {
      rtb_Y = rtb_outerAilLowerLim;
    }

    A380PrimComputer_RateLimiter_a(rtb_Y, A380PrimComputer_P.RateLimiterGenericVariableTs5_up,
    ...
    if (A380PrimComputer_B.logic.phased_lift_dumping_active) {
      rtb_Sum6 = A380PrimComputer_P.Constant5_Value;
    } else {
      rtb_Sum6 = A380PrimComputer_P.Constant6_Value;
    }

    A380PrimComputer_RateLimiter(rtb_Sum6, A380PrimComputer_P.RateLimiterVariableTs4_up,
    ...
    if (A380PrimComputer_B.logic.ground_spoilers_out) {
      rtb_Sum6 = A380PrimComputer_P.Constant_Value;
    } else {
      rtb_Sum6 = rtb_Y;
    }

    A380PrimComputer_RateLimiter(rtb_Sum6, A380PrimComputer_P.RateLimiterVariableTs6_up,
    ...
    rtb_Switch_h = A380PrimComputer_P.Gain5_Gain * rtb_Y;
    ...
    if (A380PrimComputer_P.Constant7_Value_n) {
      rtb_Sum6 = A380PrimComputer_P.Constant9_Value;
    } else {
      rtb_Sum6 = A380PrimComputer_P.Constant8_Value_d;
    }

    A380PrimComputer_RateLimiter_m(rtb_Sum6, A380PrimComputer_P.RateLimiterGenericVariableTs25_up,
      ...
      &rtb_outerAilLowerLim, &A380PrimComputer_DWork.sf_RateLimiter_md);
    rtb_Sum6 = rtb_Switch8_o + rtb_outerAilLowerLim;
    if (rtb_NOT_k) {
    ...
    if (rtb_NOT_k) {
      rtb_Sum6 = rtb_Switch_h;
    }

    A380PrimComputer_RateLimiter_a(rtb_Sum6, A380PrimComputer_P.RateLimiterGenericVariableTs11_up,
    ...
    A380PrimComputer_Spoiler12SpeedbrakeGain(rtb_handleIndex, &rtb_Switch8_o);
    A380PrimComputer_Spoiler345Computation(rtb_xi_spoiler_deg_b, rtb_Switch8_o + rtb_outerAilLowerLim, &rtb_Switch8_o,
      &rtb_Switch_h);
    if (rtb_NOT_k) {
      rtb_eta_deg_dv = rtb_Y;
    } else {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs14_up,
      ...
      &rtb_Sum6, &A380PrimComputer_DWork.sf_RateLimiter_gr);
    if (A380PrimComputer_B.logic.is_master_prim) {
      A380PrimComputer_B.laws.lateral_law_outputs.left_spoiler_3_deg = rtb_Sum6;
    } else if (rtb_doubleAdrFault) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs15_up,
      ...
      A380PrimComputer_B.logic.lateral_surface_positions.right_spoiler_3_deg,
      (!A380PrimComputer_B.logic.surface_statuses.spoiler_pair_3_engaged) || (!A380PrimComputer_B.logic.is_master_prim),
      &rtb_Sum6, &A380PrimComputer_DWork.sf_RateLimiter_nh);
    if (A380PrimComputer_B.logic.is_master_prim) {
      A380PrimComputer_B.laws.lateral_law_outputs.right_spoiler_3_deg = rtb_Sum6;
    } else if (rtb_doubleAdrFault) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs12_up,
      ...
      &rtb_Sum6, &A380PrimComputer_DWork.sf_RateLimiter_c5);
    if (A380PrimComputer_B.logic.is_master_prim) {
      A380PrimComputer_B.laws.lateral_law_outputs.left_spoiler_4_deg = rtb_Sum6;
    } else if (rtb_doubleAdrFault) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs13_up,
      ...
      A380PrimComputer_B.logic.lateral_surface_positions.right_spoiler_4_deg,
      (!A380PrimComputer_B.logic.surface_statuses.spoiler_pair_4_engaged) || (!A380PrimComputer_B.logic.is_master_prim),
      &rtb_Sum6, &A380PrimComputer_DWork.sf_RateLimiter_m);
    if (A380PrimComputer_B.logic.is_master_prim) {
      A380PrimComputer_B.laws.lateral_law_outputs.right_spoiler_4_deg = rtb_Sum6;
    } else if (rtb_doubleAdrFault) {
    ...
    A380PrimComputer_Spoiler345Computation(rtb_xi_spoiler_deg_b, rtb_handleIndex + rtb_outerAilLowerLim, &rtb_Switch8_o,
      &rtb_Switch_h);
    if (rtb_NOT_k) {
      rtb_eta_deg_dv = rtb_Y;
    } else {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs16_up,
      ...
      &rtb_outerAilLowerLim, &A380PrimComputer_DWork.sf_RateLimiter_k);
    if (A380PrimComputer_B.logic.is_master_prim) {
      A380PrimComputer_B.laws.lateral_law_outputs.left_spoiler_6_deg = rtb_outerAilLowerLim;
    } else if (rtb_doubleAdrFault) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs17_up,
      ...
      A380PrimComputer_B.logic.lateral_surface_positions.right_spoiler_6_deg,
      (!A380PrimComputer_B.logic.surface_statuses.spoiler_pair_6_engaged) || (!A380PrimComputer_B.logic.is_master_prim),
      &rtb_outerAilLowerLim, &A380PrimComputer_DWork.sf_RateLimiter_bo);
    if (A380PrimComputer_B.logic.is_master_prim) {
      A380PrimComputer_B.laws.lateral_law_outputs.right_spoiler_6_deg = rtb_outerAilLowerLim;
    } else if (rtb_doubleAdrFault) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs22_up,
      ...
      &rtb_outerAilLowerLim, &A380PrimComputer_DWork.sf_RateLimiter_i);
    if (A380PrimComputer_B.logic.is_master_prim) {
      A380PrimComputer_B.laws.lateral_law_outputs.left_spoiler_7_deg = rtb_outerAilLowerLim;
    } else if (rtb_doubleAdrFault) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs23_up,
      ...
      A380PrimComputer_B.logic.lateral_surface_positions.right_spoiler_7_deg,
      (!A380PrimComputer_B.logic.surface_statuses.spoiler_pair_7_engaged) || (!A380PrimComputer_B.logic.is_master_prim),
      &rtb_outerAilLowerLim, &A380PrimComputer_DWork.sf_RateLimiter_f1);
    if (A380PrimComputer_B.logic.is_master_prim) {
      A380PrimComputer_B.laws.lateral_law_outputs.right_spoiler_7_deg = rtb_outerAilLowerLim;
    } else if (rtb_doubleAdrFault) {
    ...
    if (A380PrimComputer_B.logic.is_master_prim) {
      rtb_outerAilLowerLim = rtb_Switch8_o;
    } else if (rtb_doubleAdrFault) {
      rtb_outerAilLowerLim = A380PrimComputer_U.in.bus_inputs.prim_x_bus.right_spoiler_8_command_deg.Data;
    } else {
      rtb_outerAilLowerLim = A380PrimComputer_U.in.bus_inputs.prim_y_bus.right_spoiler_8_command_deg.Data;
    }

    switch (static_cast<int32_T>(A380PrimComputer_B.logic.active_lateral_law)) {
     case 0:
      rtb_Y = rtb_zeta_upper_deg;
      break;

     case 1:
      rtb_Y = rtb_zeta_upper_deg_p;
      break;
    ...
    A380PrimComputer_RateLimiter_a(rtb_Y, A380PrimComputer_P.RateLimiterGenericVariableTs6_up,
    ...
    switch (static_cast<int32_T>(A380PrimComputer_B.logic.active_lateral_law)) {
     case 0:
      rtb_Y = rtb_zeta_lower_deg;
      break;

     case 1:
      rtb_Y = rtb_zeta_lower_deg_n;
      break;
    ...
    A380PrimComputer_RateLimiter_a(rtb_Y, A380PrimComputer_P.RateLimiterGenericVariableTs7_up,
    ...
    A380PrimComputer_B.laws.lateral_law_outputs.right_spoiler_8_deg = rtb_outerAilLowerLim;
    ...
    rtb_Switch8_o = rtb_Y - A380PrimComputer_DWork.Delay_DSTATE;
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel_bit_p, &rtb_y_ik);
    rtb_doubleAdrFault = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_h, &rtb_y_ik);
    rtb_tripleAdrFault = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_fv, &rtb_y_ik);
    rtb_doubleIrFault = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_cv, &rtb_y_ik);
    rtb_tripleIrFault = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_n4, &rtb_y_ik);
    rtb_OR6 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_py, &rtb_y_ik);
    A380PrimComputer_MATLABFunction_o(rtb_doubleAdrFault, rtb_tripleAdrFault, rtb_doubleIrFault, rtb_tripleIrFault,
      rtb_OR6, rtb_y_ik != 0U, &rtb_Switch8_o);
    rtb_doubleAdrFault = (A380PrimComputer_B.logic.tracking_mode_on || ((static_cast<real_T>
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel_bit_n, &rtb_y_ik);
    rtb_doubleAdrFault = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_h1, &rtb_y_ik);
    rtb_tripleAdrFault = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_gn, &rtb_y_ik);
    rtb_doubleIrFault = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_b, &rtb_y_ik);
    rtb_tripleIrFault = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_i, &rtb_y_ik);
    rtb_OR6 = (rtb_y_ik != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_l, &rtb_y_ik);
    A380PrimComputer_MATLABFunction_o(rtb_doubleAdrFault, rtb_tripleAdrFault, rtb_doubleIrFault, rtb_tripleIrFault,
      rtb_OR6, rtb_y_ik != 0U, &rtb_Switch8_o);
    rtb_doubleAdrFault = (A380PrimComputer_B.logic.tracking_mode_on || ((static_cast<real_T>
    ...
    LawMDLOBJ4.step(&A380PrimComputer_U.in.time.dt, &A380PrimComputer_B.logic.total_sidestick_pitch_command,
                    &rtb_eta_deg_dv, &rtb_xi_spoiler_deg_b, &rtb_eta_trim_limit_lo_d, &rtb_Sum6);
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel_bit_of, &rtb_y_ik);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word, &rtb_y_b);
    rtb_doubleAdrFault = ((rtb_y_ik != 0U) && rtb_y_b);
    if (!A380PrimComputer_B.logic.is_master_prim) {
      if (rtb_doubleAdrFault) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs2_up_l,
      ...
      (!A380PrimComputer_B.logic.is_master_prim), &rtb_outerAilLowerLim, &A380PrimComputer_DWork.sf_RateLimiter_cda);
    if (!A380PrimComputer_B.logic.is_master_prim) {
      if (rtb_doubleAdrFault) {
        rtb_outerAilLowerLim = A380PrimComputer_U.in.bus_inputs.prim_x_bus.left_outboard_elevator_command_deg.Data;
      } else {
        rtb_outerAilLowerLim = A380PrimComputer_U.in.bus_inputs.prim_y_bus.left_outboard_elevator_command_deg.Data;
      }
    }
    ...
    switch (static_cast<int32_T>(A380PrimComputer_B.logic.active_pitch_law)) {
     case 0:
     case 1:
      rtb_Sum6 = rtb_eta_trim_limit_up;
      break;

     case 2:
     case 3:
     case 4:
      rtb_Sum6 = rtb_eta_trim_limit_up_d;
      break;
     ...
     default:
      rtb_Sum6 = A380PrimComputer_P.Constant2_Value_l;
      break;
    }
    ...
    if (A380PrimComputer_DWork.Delay_DSTATE_c > rtb_Sum6) {
      A380PrimComputer_DWork.Delay_DSTATE_c = rtb_Sum6;
    } else {
      switch (static_cast<int32_T>(A380PrimComputer_B.logic.active_pitch_law)) {
       case 0:
       case 1:
    ...
    A380PrimComputer_B.laws.pitch_law_outputs.left_outboard_elevator_deg = rtb_outerAilLowerLim;
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_outerAilLowerLim = A380PrimComputer_B.laws.pitch_law_outputs.left_inboard_elevator_deg;
      rtb_Sum6 = A380PrimComputer_B.laws.pitch_law_outputs.right_outboard_elevator_deg;
      ...
      rtb_outerAilLowerLim = A380PrimComputer_B.laws.pitch_law_outputs.left_outboard_elevator_deg;
      rtb_Sum6 = A380PrimComputer_B.laws.pitch_law_outputs.right_inboard_elevator_deg;
      rtb_eta_deg_dv = A380PrimComputer_B.laws.lateral_law_outputs.upper_rudder_deg;
      ...
      rtb_outerAilLowerLim = A380PrimComputer_B.laws.pitch_law_outputs.right_inboard_elevator_deg;
      rtb_Sum6 = 0.0;
    ...
    if (A380PrimComputer_B.logic.elevator_2_engaged) {
      A380PrimComputer_Y.out.analog_outputs.elevator_2_pos_order_deg = rtb_outerAilLowerLim;
    } else {
    ...
    if (A380PrimComputer_B.logic.elevator_3_engaged) {
      A380PrimComputer_Y.out.analog_outputs.elevator_3_pos_order_deg = rtb_Sum6;
    } else {
    ...
    if (A380PrimComputer_B.logic.is_master_prim) {
      ...
      rtb_raComputationValue = static_cast<real32_T>(A380PrimComputer_B.laws.lateral_law_outputs.left_spoiler_4_deg);
      rtb_y_oq = static_cast<real32_T>(A380PrimComputer_B.laws.lateral_law_outputs.right_spoiler_4_deg);
      ...
      rtb_left_spoiler_8_command_deg_kt_Data = static_cast<real32_T>
        (A380PrimComputer_B.laws.lateral_law_outputs.left_spoiler_8_deg);
      rtb_right_spoiler_8_command_deg_g0_Data = static_cast<real32_T>
        (A380PrimComputer_B.laws.lateral_law_outputs.right_spoiler_8_deg);
    ...
    A380PrimComputer_B.ap_1_pushbutton_pressed = A380PrimComputer_U.in.discrete_inputs.ap_1_pushbutton_pressed;
    ...
    A380PrimComputer_B.ap_2_pushbutton_pressed = A380PrimComputer_U.in.discrete_inputs.ap_2_pushbutton_pressed;
    ...
    A380PrimComputer_B.SSM_npr = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.SSM;
    A380PrimComputer_B.Data_j0 = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.Data;
    A380PrimComputer_B.SSM_ew = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.SSM;
    A380PrimComputer_B.Data_bs = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.Data;
    A380PrimComputer_B.SSM_lt = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.SSM;
    A380PrimComputer_B.Data_hp = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.Data;
    A380PrimComputer_B.SSM_ger = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.SSM;
    A380PrimComputer_B.Data_ct = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.Data;
    A380PrimComputer_B.lat_acc_2_g = A380PrimComputer_U.in.analog_inputs.lat_acc_2_g;
    A380PrimComputer_B.SSM_pxo = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_pedal_position_deg.SSM;
    A380PrimComputer_B.Data_pc = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_pedal_position_deg.Data;
    A380PrimComputer_B.SSM_co2 = A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word.SSM;
    A380PrimComputer_B.Data_nzt = A380PrimComputer_U.in.bus_inputs.sec_1_bus.aileron_status_word.Data;
    A380PrimComputer_B.SSM_ny = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_aileron_1_position_deg.SSM;
    A380PrimComputer_B.Data_c0 = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_aileron_1_position_deg.Data;
    A380PrimComputer_B.SSM_l4 = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_aileron_2_position_deg.SSM;
    A380PrimComputer_B.Data_ojg = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_aileron_2_position_deg.Data;
    A380PrimComputer_B.SSM_nm = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_aileron_1_position_deg.SSM;
    A380PrimComputer_B.Data_lm = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_aileron_1_position_deg.Data;
    A380PrimComputer_B.lat_acc_3_g = A380PrimComputer_U.in.analog_inputs.lat_acc_3_g;
    A380PrimComputer_B.SSM_nh = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_aileron_2_position_deg.SSM;
    A380PrimComputer_B.Data_fz = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_aileron_2_position_deg.Data;
    A380PrimComputer_B.SSM_dl = A380PrimComputer_U.in.bus_inputs.sec_1_bus.spoiler_status_word.SSM;
    A380PrimComputer_B.Data_oz = A380PrimComputer_U.in.bus_inputs.sec_1_bus.spoiler_status_word.Data;
    A380PrimComputer_B.SSM_dx = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.SSM;
    A380PrimComputer_B.Data_gf = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.Data;
    A380PrimComputer_B.SSM_a5h = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.SSM;
    A380PrimComputer_B.Data_nn = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data;
    A380PrimComputer_B.SSM_fl = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.SSM;
    A380PrimComputer_B.Data_a0z = A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.Data;
    A380PrimComputer_B.left_body_wheel_speed = A380PrimComputer_U.in.analog_inputs.left_body_wheel_speed;
    A380PrimComputer_B.SSM_p3 = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.SSM;
    A380PrimComputer_B.Data_fk = A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.Data;
    A380PrimComputer_B.SSM_ns = A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word.SSM;
    A380PrimComputer_B.Data_bu = A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word.Data;
    A380PrimComputer_B.SSM_bm = A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_1_position_deg.SSM;
    A380PrimComputer_B.Data_o23 = A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_1_position_deg.Data;
    A380PrimComputer_B.SSM_nl = A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_2_position_deg.SSM;
    A380PrimComputer_B.Data_g3 = A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_2_position_deg.Data;
    A380PrimComputer_B.SSM_grm = A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_3_position_deg.SSM;
    A380PrimComputer_B.Data_icc = A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_3_position_deg.Data;
    A380PrimComputer_B.left_wing_wheel_speed = A380PrimComputer_U.in.analog_inputs.left_wing_wheel_speed;
    A380PrimComputer_B.SSM_gzm = A380PrimComputer_U.in.bus_inputs.sec_1_bus.ths_position_deg.SSM;
    A380PrimComputer_B.Data_pwf = A380PrimComputer_U.in.bus_inputs.sec_1_bus.ths_position_deg.Data;
    A380PrimComputer_B.SSM_oi = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word.SSM;
    A380PrimComputer_B.Data_gvk = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word.Data;
    A380PrimComputer_B.SSM_aa = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_1_position_deg.SSM;
    A380PrimComputer_B.Data_ln = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_1_position_deg.Data;
    A380PrimComputer_B.SSM_fvk = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_2_position_deg.SSM;
    A380PrimComputer_B.Data_ka = A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_2_position_deg.Data;
    A380PrimComputer_B.SSM_lw = A380PrimComputer_U.in.bus_inputs.sec_1_bus.fctl_law_status_word.SSM;
    A380PrimComputer_B.Data_mp = A380PrimComputer_U.in.bus_inputs.sec_1_bus.fctl_law_status_word.Data;
    A380PrimComputer_B.right_body_wheel_speed = A380PrimComputer_U.in.analog_inputs.right_body_wheel_speed;
    A380PrimComputer_B.SSM_fa = A380PrimComputer_U.in.bus_inputs.sec_1_bus.misc_data_status_word.SSM;
    A380PrimComputer_B.Data_m4 = A380PrimComputer_U.in.bus_inputs.sec_1_bus.misc_data_status_word.Data;
    A380PrimComputer_B.SSM_lbx = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.SSM;
    A380PrimComputer_B.Data_fki = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.Data;
    A380PrimComputer_B.SSM_n3 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.SSM;
    A380PrimComputer_B.Data_bv = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.Data;
    A380PrimComputer_B.SSM_a1 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.SSM;
    A380PrimComputer_B.Data_m21 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.Data;
    A380PrimComputer_B.SSM_p1 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.SSM;
    A380PrimComputer_B.Data_nbg = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.Data;
    ...
    A380PrimComputer_B.SSM_cn2 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_pedal_position_deg.SSM;
    A380PrimComputer_B.Data_l25 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_pedal_position_deg.Data;
    A380PrimComputer_B.SSM_an3 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word.SSM;
    A380PrimComputer_B.Data_ki = A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word.Data;
    A380PrimComputer_B.SSM_c3 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_aileron_1_position_deg.SSM;
    A380PrimComputer_B.Data_p5p = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_aileron_1_position_deg.Data;
    A380PrimComputer_B.SSM_dp = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_aileron_2_position_deg.SSM;
    A380PrimComputer_B.Data_nry = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_aileron_2_position_deg.Data;
    A380PrimComputer_B.SSM_boy = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_aileron_1_position_deg.SSM;
    A380PrimComputer_B.Data_mh = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_aileron_1_position_deg.Data;
    A380PrimComputer_B.SSM_lg = A380PrimComputer_U.in.bus_inputs.adr_1_bus.altitude_standard_ft.SSM;
    A380PrimComputer_B.SSM_cm = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_aileron_2_position_deg.SSM;
    A380PrimComputer_B.Data_ll = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_aileron_2_position_deg.Data;
    A380PrimComputer_B.SSM_hl = A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word.SSM;
    A380PrimComputer_B.Data_hy = A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word.Data;
    A380PrimComputer_B.SSM_irh = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.SSM;
    A380PrimComputer_B.Data_j04 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.Data;
    A380PrimComputer_B.SSM_b42 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.SSM;
    A380PrimComputer_B.Data_pf = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.Data;
    A380PrimComputer_B.SSM_anz = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.SSM;
    A380PrimComputer_B.Data_pl = A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.Data;
    A380PrimComputer_B.Data_gb = A380PrimComputer_U.in.bus_inputs.adr_1_bus.altitude_standard_ft.Data;
    A380PrimComputer_B.SSM_d2 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.SSM;
    A380PrimComputer_B.Data_hq = A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.Data;
    A380PrimComputer_B.SSM_gov = A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word.SSM;
    A380PrimComputer_B.Data_ai = A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word.Data;
    A380PrimComputer_B.SSM_nb = A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_1_position_deg.SSM;
    A380PrimComputer_B.Data_gfr = A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_1_position_deg.Data;
    A380PrimComputer_B.SSM_pe3 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_2_position_deg.SSM;
    A380PrimComputer_B.Data_czp = A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_2_position_deg.Data;
    A380PrimComputer_B.SSM_jj = A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_3_position_deg.SSM;
    A380PrimComputer_B.Data_fm = A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_3_position_deg.Data;
    A380PrimComputer_B.SSM_jx = A380PrimComputer_U.in.bus_inputs.adr_1_bus.altitude_corrected_ft.SSM;
    A380PrimComputer_B.SSM_npl = A380PrimComputer_U.in.bus_inputs.sec_2_bus.ths_position_deg.SSM;
    A380PrimComputer_B.Data_jsg = A380PrimComputer_U.in.bus_inputs.sec_2_bus.ths_position_deg.Data;
    A380PrimComputer_B.SSM_gf = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word.SSM;
    A380PrimComputer_B.Data_g1 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word.Data;
    A380PrimComputer_B.SSM_gbi = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_1_position_deg.SSM;
    A380PrimComputer_B.Data_j4 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_1_position_deg.Data;
    A380PrimComputer_B.SSM_fhm = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_2_position_deg.SSM;
    A380PrimComputer_B.Data_jyh = A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_2_position_deg.Data;
    A380PrimComputer_B.SSM_ltj = A380PrimComputer_U.in.bus_inputs.sec_2_bus.fctl_law_status_word.SSM;
    A380PrimComputer_B.Data_e4 = A380PrimComputer_U.in.bus_inputs.sec_2_bus.fctl_law_status_word.Data;
    A380PrimComputer_B.Data_ghs = A380PrimComputer_U.in.bus_inputs.adr_1_bus.altitude_corrected_ft.Data;
    A380PrimComputer_B.SSM_hn = A380PrimComputer_U.in.bus_inputs.sec_2_bus.misc_data_status_word.SSM;
    A380PrimComputer_B.Data_bmk = A380PrimComputer_U.in.bus_inputs.sec_2_bus.misc_data_status_word.Data;
    A380PrimComputer_B.SSM_h3 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_sidestick_pitch_command_deg.SSM;
    A380PrimComputer_B.Data_lzt = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_sidestick_pitch_command_deg.Data;
    A380PrimComputer_B.SSM_bfs = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_sidestick_pitch_command_deg.SSM;
    A380PrimComputer_B.Data_kn = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_sidestick_pitch_command_deg.Data;
    A380PrimComputer_B.SSM_p0 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_sidestick_roll_command_deg.SSM;
    A380PrimComputer_B.Data_nab = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_sidestick_roll_command_deg.Data;
    A380PrimComputer_B.SSM_fu = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_sidestick_roll_command_deg.SSM;
    A380PrimComputer_B.Data_lgf = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_sidestick_roll_command_deg.Data;
    A380PrimComputer_B.SSM_hr = A380PrimComputer_U.in.bus_inputs.adr_1_bus.mach.SSM;
    A380PrimComputer_B.SSM_bi = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_pedal_position_deg.SSM;
    A380PrimComputer_B.Data_fpq = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_pedal_position_deg.Data;
    A380PrimComputer_B.SSM_bd = A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word.SSM;
    A380PrimComputer_B.Data_dt = A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word.Data;
    A380PrimComputer_B.SSM_omt = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_aileron_1_position_deg.SSM;
    A380PrimComputer_B.Data_b1 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_aileron_1_position_deg.Data;
    A380PrimComputer_B.SSM_la = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_aileron_2_position_deg.SSM;
    A380PrimComputer_B.Data_nmr = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_aileron_2_position_deg.Data;
    A380PrimComputer_B.SSM_l1 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_aileron_1_position_deg.SSM;
    A380PrimComputer_B.Data_ea = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_aileron_1_position_deg.Data;
    A380PrimComputer_B.Data_nib = A380PrimComputer_U.in.bus_inputs.adr_1_bus.mach.Data;
    A380PrimComputer_B.SSM_dy = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_aileron_2_position_deg.SSM;
    A380PrimComputer_B.Data_i2t = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_aileron_2_position_deg.Data;
    A380PrimComputer_B.SSM_ie = A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word.SSM;
    A380PrimComputer_B.Data_ng = A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word.Data;
    A380PrimComputer_B.SSM_kf = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_1_position_deg.SSM;
    A380PrimComputer_B.Data_h31 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_1_position_deg.Data;
    A380PrimComputer_B.SSM_p5l = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_1_position_deg.SSM;
    A380PrimComputer_B.Data_ew = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_1_position_deg.Data;
    A380PrimComputer_B.SSM_g3 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_2_position_deg.SSM;
    A380PrimComputer_B.Data_j1s = A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_2_position_deg.Data;
    A380PrimComputer_B.SSM_b3 = A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.SSM;
    A380PrimComputer_B.SSM_dxv = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.SSM;
    A380PrimComputer_B.Data_j5 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.Data;
    A380PrimComputer_B.SSM_mxz = A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word.SSM;
    A380PrimComputer_B.Data_cw = A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word.Data;
    A380PrimComputer_B.SSM_kk4 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_1_position_deg.SSM;
    A380PrimComputer_B.Data_gqa = A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_1_position_deg.Data;
    A380PrimComputer_B.SSM_cy = A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_2_position_deg.SSM;
    A380PrimComputer_B.Data_hz = A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_2_position_deg.Data;
    A380PrimComputer_B.SSM_ju = A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_3_position_deg.SSM;
    A380PrimComputer_B.Data_fri = A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_3_position_deg.Data;
    A380PrimComputer_B.Data_cm = A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data;
    A380PrimComputer_B.SSM_ey = A380PrimComputer_U.in.bus_inputs.sec_3_bus.ths_position_deg.SSM;
    A380PrimComputer_B.Data_czj = A380PrimComputer_U.in.bus_inputs.sec_3_bus.ths_position_deg.Data;
    A380PrimComputer_B.SSM_jr = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word.SSM;
    A380PrimComputer_B.Data_mb = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word.Data;
    A380PrimComputer_B.SSM_hs = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_1_position_deg.SSM;
    A380PrimComputer_B.Data_gk4 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_1_position_deg.Data;
    A380PrimComputer_B.SSM_mx3 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_2_position_deg.SSM;
    A380PrimComputer_B.Data_gbt = A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_2_position_deg.Data;
    A380PrimComputer_B.SSM_er = A380PrimComputer_U.in.bus_inputs.sec_3_bus.fctl_law_status_word.SSM;
    A380PrimComputer_B.Data_p0 = A380PrimComputer_U.in.bus_inputs.sec_3_bus.fctl_law_status_word.Data;
    A380PrimComputer_B.SSM_hm = A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_true_kn.SSM;
    A380PrimComputer_B.SSM_dm = A380PrimComputer_U.in.bus_inputs.sec_3_bus.misc_data_status_word.SSM;
    A380PrimComputer_B.Data_dn = A380PrimComputer_U.in.bus_inputs.sec_3_bus.misc_data_status_word.Data;
    A380PrimComputer_B.tailstrike_protection_on = A380PrimComputer_U.in.sim_data.tailstrike_protection_on;
    A380PrimComputer_B.Data_iyw = A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_true_kn.Data;
    A380PrimComputer_B.SSM_fk = A380PrimComputer_U.in.bus_inputs.adr_1_bus.vertical_speed_ft_min.SSM;
    A380PrimComputer_B.Data_p5d = A380PrimComputer_U.in.bus_inputs.adr_1_bus.vertical_speed_ft_min.Data;
    A380PrimComputer_B.SSM_lm1 = A380PrimComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.SSM;
    A380PrimComputer_B.Data_oo = A380PrimComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data;
    A380PrimComputer_B.SSM_nc = A380PrimComputer_U.in.bus_inputs.adr_1_bus.corrected_average_static_pressure.SSM;
    A380PrimComputer_B.Data_ho = A380PrimComputer_U.in.bus_inputs.adr_1_bus.corrected_average_static_pressure.Data;
    A380PrimComputer_B.SSM_e4 = A380PrimComputer_U.in.bus_inputs.adr_2_bus.altitude_standard_ft.SSM;
    A380PrimComputer_B.Data_kqr = A380PrimComputer_U.in.bus_inputs.adr_2_bus.altitude_standard_ft.Data;
    A380PrimComputer_B.SSM_bw = A380PrimComputer_U.in.bus_inputs.adr_2_bus.altitude_corrected_ft.SSM;
    A380PrimComputer_B.computer_running = A380PrimComputer_U.in.sim_data.computer_running;
    A380PrimComputer_B.Data_omv = A380PrimComputer_U.in.bus_inputs.adr_2_bus.altitude_corrected_ft.Data;
    A380PrimComputer_B.SSM_na = A380PrimComputer_U.in.bus_inputs.adr_2_bus.mach.SSM;
    A380PrimComputer_B.Data_mby = A380PrimComputer_U.in.bus_inputs.adr_2_bus.mach.Data;
    A380PrimComputer_B.SSM_lf = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.SSM;
    A380PrimComputer_B.Data_hk = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.Data;
    A380PrimComputer_B.SSM_oz = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.SSM;
    A380PrimComputer_B.Data_hg = A380PrimComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
    A380PrimComputer_B.SSM_mub = A380PrimComputer_U.in.bus_inputs.adr_2_bus.vertical_speed_ft_min.SSM;
    A380PrimComputer_B.Data_bi = A380PrimComputer_U.in.bus_inputs.adr_2_bus.vertical_speed_ft_min.Data;
    A380PrimComputer_B.SSM_li = A380PrimComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM;
    A380PrimComputer_B.prim_overhead_button_pressed = A380PrimComputer_U.in.discrete_inputs.prim_overhead_button_pressed;
    A380PrimComputer_B.Data_i4u = A380PrimComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
    A380PrimComputer_B.SSM_hcd = A380PrimComputer_U.in.bus_inputs.adr_2_bus.corrected_average_static_pressure.SSM;
    A380PrimComputer_B.Data_ik = A380PrimComputer_U.in.bus_inputs.adr_2_bus.corrected_average_static_pressure.Data;
    A380PrimComputer_B.SSM_php = A380PrimComputer_U.in.bus_inputs.adr_3_bus.altitude_standard_ft.SSM;
    A380PrimComputer_B.Data_dq = A380PrimComputer_U.in.bus_inputs.adr_3_bus.altitude_standard_ft.Data;
    A380PrimComputer_B.SSM_ma = A380PrimComputer_U.in.bus_inputs.adr_3_bus.altitude_corrected_ft.SSM;
    A380PrimComputer_B.Data_pv = A380PrimComputer_U.in.bus_inputs.adr_3_bus.altitude_corrected_ft.Data;
    A380PrimComputer_B.SSM_jut = A380PrimComputer_U.in.bus_inputs.adr_3_bus.mach.SSM;
    A380PrimComputer_B.Data_p1d = A380PrimComputer_U.in.bus_inputs.adr_3_bus.mach.Data;
    A380PrimComputer_B.SSM_kh = A380PrimComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM;
  ...
  A380PrimComputer_Y.out.data.discrete_inputs.ap_1_pushbutton_pressed = A380PrimComputer_B.ap_1_pushbutton_pressed;
  A380PrimComputer_Y.out.data.discrete_inputs.ap_2_pushbutton_pressed = A380PrimComputer_B.ap_2_pushbutton_pressed;
  ...
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.altitude_standard_ft.SSM = A380PrimComputer_B.SSM_lg;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.altitude_standard_ft.Data = A380PrimComputer_B.Data_gb;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.altitude_corrected_ft.SSM = A380PrimComputer_B.SSM_jx;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.altitude_corrected_ft.Data = A380PrimComputer_B.Data_ghs;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.mach.SSM = A380PrimComputer_B.SSM_hr;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.mach.Data = A380PrimComputer_B.Data_nib;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.airspeed_computed_kn.SSM = A380PrimComputer_B.SSM_b3;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.airspeed_computed_kn.Data = A380PrimComputer_B.Data_cm;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.airspeed_true_kn.SSM = A380PrimComputer_B.SSM_hm;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.airspeed_true_kn.Data = A380PrimComputer_B.Data_iyw;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.vertical_speed_ft_min.SSM = A380PrimComputer_B.SSM_fk;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.vertical_speed_ft_min.Data = A380PrimComputer_B.Data_p5d;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.aoa_corrected_deg.SSM = A380PrimComputer_B.SSM_lm1;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.aoa_corrected_deg.Data = A380PrimComputer_B.Data_oo;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.corrected_average_static_pressure.SSM = A380PrimComputer_B.SSM_nc;
  A380PrimComputer_Y.out.data.bus_inputs.adr_1_bus.corrected_average_static_pressure.Data = A380PrimComputer_B.Data_ho;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.altitude_standard_ft.SSM = A380PrimComputer_B.SSM_e4;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.altitude_standard_ft.Data = A380PrimComputer_B.Data_kqr;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.altitude_corrected_ft.SSM = A380PrimComputer_B.SSM_bw;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.altitude_corrected_ft.Data = A380PrimComputer_B.Data_omv;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.mach.SSM = A380PrimComputer_B.SSM_na;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.mach.Data = A380PrimComputer_B.Data_mby;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_computed_kn.SSM = A380PrimComputer_B.SSM_lf;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_computed_kn.Data = A380PrimComputer_B.Data_hk;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_true_kn.SSM = A380PrimComputer_B.SSM_oz;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_true_kn.Data = A380PrimComputer_B.Data_hg;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.SSM = A380PrimComputer_B.SSM_mub;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.Data = A380PrimComputer_B.Data_bi;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM = A380PrimComputer_B.SSM_li;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.aoa_corrected_deg.Data = A380PrimComputer_B.Data_i4u;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.corrected_average_static_pressure.SSM = A380PrimComputer_B.SSM_hcd;
  A380PrimComputer_Y.out.data.bus_inputs.adr_2_bus.corrected_average_static_pressure.Data = A380PrimComputer_B.Data_ik;
  A380PrimComputer_Y.out.data.bus_inputs.adr_3_bus.altitude_standard_ft.SSM = A380PrimComputer_B.SSM_php;
  A380PrimComputer_Y.out.data.bus_inputs.adr_3_bus.altitude_standard_ft.Data = A380PrimComputer_B.Data_dq;
  A380PrimComputer_Y.out.data.bus_inputs.adr_3_bus.altitude_corrected_ft.SSM = A380PrimComputer_B.SSM_ma;
  A380PrimComputer_Y.out.data.bus_inputs.adr_3_bus.altitude_corrected_ft.Data = A380PrimComputer_B.Data_pv;
  A380PrimComputer_Y.out.data.bus_inputs.adr_3_bus.mach.SSM = A380PrimComputer_B.SSM_jut;
  A380PrimComputer_Y.out.data.bus_inputs.adr_3_bus.mach.Data = A380PrimComputer_B.Data_p1d;
  A380PrimComputer_Y.out.data.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM = A380PrimComputer_B.SSM_kh;
  ...
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.SSM = A380PrimComputer_B.SSM_npr;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.Data = A380PrimComputer_B.Data_j0;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.SSM = A380PrimComputer_B.SSM_ew;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.Data = A380PrimComputer_B.Data_bs;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.SSM = A380PrimComputer_B.SSM_lt;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.Data = A380PrimComputer_B.Data_hp;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.SSM = A380PrimComputer_B.SSM_ger;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.Data = A380PrimComputer_B.Data_ct;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.rudder_pedal_position_deg.SSM = A380PrimComputer_B.SSM_pxo;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.rudder_pedal_position_deg.Data = A380PrimComputer_B.Data_pc;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.aileron_status_word.SSM = A380PrimComputer_B.SSM_co2;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.aileron_status_word.Data = A380PrimComputer_B.Data_nzt;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_aileron_1_position_deg.SSM = A380PrimComputer_B.SSM_ny;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_aileron_1_position_deg.Data = A380PrimComputer_B.Data_c0;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_aileron_2_position_deg.SSM = A380PrimComputer_B.SSM_l4;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_aileron_2_position_deg.Data = A380PrimComputer_B.Data_ojg;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_aileron_1_position_deg.SSM = A380PrimComputer_B.SSM_nm;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_aileron_1_position_deg.Data = A380PrimComputer_B.Data_lm;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_aileron_2_position_deg.SSM = A380PrimComputer_B.SSM_nh;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_aileron_2_position_deg.Data = A380PrimComputer_B.Data_fz;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.spoiler_status_word.SSM = A380PrimComputer_B.SSM_dl;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.spoiler_status_word.Data = A380PrimComputer_B.Data_oz;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.SSM = A380PrimComputer_B.SSM_dx;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.Data = A380PrimComputer_B.Data_gf;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.SSM = A380PrimComputer_B.SSM_a5h;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data = A380PrimComputer_B.Data_nn;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.SSM = A380PrimComputer_B.SSM_fl;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.Data = A380PrimComputer_B.Data_a0z;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.SSM = A380PrimComputer_B.SSM_p3;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.Data = A380PrimComputer_B.Data_fk;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.elevator_status_word.SSM = A380PrimComputer_B.SSM_ns;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.elevator_status_word.Data = A380PrimComputer_B.Data_bu;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.elevator_1_position_deg.SSM = A380PrimComputer_B.SSM_bm;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.elevator_1_position_deg.Data = A380PrimComputer_B.Data_o23;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.elevator_2_position_deg.SSM = A380PrimComputer_B.SSM_nl;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.elevator_2_position_deg.Data = A380PrimComputer_B.Data_g3;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.elevator_3_position_deg.SSM = A380PrimComputer_B.SSM_grm;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.elevator_3_position_deg.Data = A380PrimComputer_B.Data_icc;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.ths_position_deg.SSM = A380PrimComputer_B.SSM_gzm;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.ths_position_deg.Data = A380PrimComputer_B.Data_pwf;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.rudder_status_word.SSM = A380PrimComputer_B.SSM_oi;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.rudder_status_word.Data = A380PrimComputer_B.Data_gvk;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.rudder_1_position_deg.SSM = A380PrimComputer_B.SSM_aa;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.rudder_1_position_deg.Data = A380PrimComputer_B.Data_ln;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.rudder_2_position_deg.SSM = A380PrimComputer_B.SSM_fvk;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.rudder_2_position_deg.Data = A380PrimComputer_B.Data_ka;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.fctl_law_status_word.SSM = A380PrimComputer_B.SSM_lw;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.fctl_law_status_word.Data = A380PrimComputer_B.Data_mp;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.misc_data_status_word.SSM = A380PrimComputer_B.SSM_fa;
  A380PrimComputer_Y.out.data.bus_inputs.sec_1_bus.misc_data_status_word.Data = A380PrimComputer_B.Data_m4;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.SSM = A380PrimComputer_B.SSM_lbx;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.Data = A380PrimComputer_B.Data_fki;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.SSM = A380PrimComputer_B.SSM_n3;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.Data = A380PrimComputer_B.Data_bv;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.SSM = A380PrimComputer_B.SSM_a1;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.Data = A380PrimComputer_B.Data_m21;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.SSM = A380PrimComputer_B.SSM_p1;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.Data = A380PrimComputer_B.Data_nbg;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.rudder_pedal_position_deg.SSM = A380PrimComputer_B.SSM_cn2;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.rudder_pedal_position_deg.Data = A380PrimComputer_B.Data_l25;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.aileron_status_word.SSM = A380PrimComputer_B.SSM_an3;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.aileron_status_word.Data = A380PrimComputer_B.Data_ki;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_aileron_1_position_deg.SSM = A380PrimComputer_B.SSM_c3;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_aileron_1_position_deg.Data = A380PrimComputer_B.Data_p5p;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_aileron_2_position_deg.SSM = A380PrimComputer_B.SSM_dp;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_aileron_2_position_deg.Data = A380PrimComputer_B.Data_nry;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_aileron_1_position_deg.SSM = A380PrimComputer_B.SSM_boy;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_aileron_1_position_deg.Data = A380PrimComputer_B.Data_mh;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_aileron_2_position_deg.SSM = A380PrimComputer_B.SSM_cm;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_aileron_2_position_deg.Data = A380PrimComputer_B.Data_ll;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.spoiler_status_word.SSM = A380PrimComputer_B.SSM_hl;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.spoiler_status_word.Data = A380PrimComputer_B.Data_hy;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.SSM = A380PrimComputer_B.SSM_irh;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.Data = A380PrimComputer_B.Data_j04;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.SSM = A380PrimComputer_B.SSM_b42;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.Data = A380PrimComputer_B.Data_pf;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.SSM = A380PrimComputer_B.SSM_anz;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.Data = A380PrimComputer_B.Data_pl;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.SSM = A380PrimComputer_B.SSM_d2;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.Data = A380PrimComputer_B.Data_hq;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.elevator_status_word.SSM = A380PrimComputer_B.SSM_gov;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.elevator_status_word.Data = A380PrimComputer_B.Data_ai;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.elevator_1_position_deg.SSM = A380PrimComputer_B.SSM_nb;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.elevator_1_position_deg.Data = A380PrimComputer_B.Data_gfr;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.elevator_2_position_deg.SSM = A380PrimComputer_B.SSM_pe3;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.elevator_2_position_deg.Data = A380PrimComputer_B.Data_czp;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.elevator_3_position_deg.SSM = A380PrimComputer_B.SSM_jj;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.elevator_3_position_deg.Data = A380PrimComputer_B.Data_fm;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.ths_position_deg.SSM = A380PrimComputer_B.SSM_npl;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.ths_position_deg.Data = A380PrimComputer_B.Data_jsg;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.rudder_status_word.SSM = A380PrimComputer_B.SSM_gf;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.rudder_status_word.Data = A380PrimComputer_B.Data_g1;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.rudder_1_position_deg.SSM = A380PrimComputer_B.SSM_gbi;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.rudder_1_position_deg.Data = A380PrimComputer_B.Data_j4;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.rudder_2_position_deg.SSM = A380PrimComputer_B.SSM_fhm;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.rudder_2_position_deg.Data = A380PrimComputer_B.Data_jyh;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.fctl_law_status_word.SSM = A380PrimComputer_B.SSM_ltj;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.fctl_law_status_word.Data = A380PrimComputer_B.Data_e4;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.misc_data_status_word.SSM = A380PrimComputer_B.SSM_hn;
  A380PrimComputer_Y.out.data.bus_inputs.sec_2_bus.misc_data_status_word.Data = A380PrimComputer_B.Data_bmk;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_sidestick_pitch_command_deg.SSM = A380PrimComputer_B.SSM_h3;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_sidestick_pitch_command_deg.Data = A380PrimComputer_B.Data_lzt;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_sidestick_pitch_command_deg.SSM = A380PrimComputer_B.SSM_bfs;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_sidestick_pitch_command_deg.Data = A380PrimComputer_B.Data_kn;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_sidestick_roll_command_deg.SSM = A380PrimComputer_B.SSM_p0;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_sidestick_roll_command_deg.Data = A380PrimComputer_B.Data_nab;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_sidestick_roll_command_deg.SSM = A380PrimComputer_B.SSM_fu;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_sidestick_roll_command_deg.Data = A380PrimComputer_B.Data_lgf;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.rudder_pedal_position_deg.SSM = A380PrimComputer_B.SSM_bi;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.rudder_pedal_position_deg.Data = A380PrimComputer_B.Data_fpq;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.aileron_status_word.SSM = A380PrimComputer_B.SSM_bd;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.aileron_status_word.Data = A380PrimComputer_B.Data_dt;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_aileron_1_position_deg.SSM = A380PrimComputer_B.SSM_omt;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_aileron_1_position_deg.Data = A380PrimComputer_B.Data_b1;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_aileron_2_position_deg.SSM = A380PrimComputer_B.SSM_la;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_aileron_2_position_deg.Data = A380PrimComputer_B.Data_nmr;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_aileron_1_position_deg.SSM = A380PrimComputer_B.SSM_l1;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_aileron_1_position_deg.Data = A380PrimComputer_B.Data_ea;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_aileron_2_position_deg.SSM = A380PrimComputer_B.SSM_dy;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_aileron_2_position_deg.Data = A380PrimComputer_B.Data_i2t;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.spoiler_status_word.SSM = A380PrimComputer_B.SSM_ie;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.spoiler_status_word.Data = A380PrimComputer_B.Data_ng;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_spoiler_1_position_deg.SSM = A380PrimComputer_B.SSM_kf;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_spoiler_1_position_deg.Data = A380PrimComputer_B.Data_h31;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_spoiler_1_position_deg.SSM = A380PrimComputer_B.SSM_p5l;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_spoiler_1_position_deg.Data = A380PrimComputer_B.Data_ew;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_spoiler_2_position_deg.SSM = A380PrimComputer_B.SSM_g3;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.left_spoiler_2_position_deg.Data = A380PrimComputer_B.Data_j1s;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.SSM = A380PrimComputer_B.SSM_dxv;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.Data = A380PrimComputer_B.Data_j5;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.elevator_status_word.SSM = A380PrimComputer_B.SSM_mxz;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.elevator_status_word.Data = A380PrimComputer_B.Data_cw;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.elevator_1_position_deg.SSM = A380PrimComputer_B.SSM_kk4;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.elevator_1_position_deg.Data = A380PrimComputer_B.Data_gqa;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.elevator_2_position_deg.SSM = A380PrimComputer_B.SSM_cy;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.elevator_2_position_deg.Data = A380PrimComputer_B.Data_hz;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.elevator_3_position_deg.SSM = A380PrimComputer_B.SSM_ju;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.elevator_3_position_deg.Data = A380PrimComputer_B.Data_fri;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.ths_position_deg.SSM = A380PrimComputer_B.SSM_ey;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.ths_position_deg.Data = A380PrimComputer_B.Data_czj;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.rudder_status_word.SSM = A380PrimComputer_B.SSM_jr;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.rudder_status_word.Data = A380PrimComputer_B.Data_mb;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.rudder_1_position_deg.SSM = A380PrimComputer_B.SSM_hs;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.rudder_1_position_deg.Data = A380PrimComputer_B.Data_gk4;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.rudder_2_position_deg.SSM = A380PrimComputer_B.SSM_mx3;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.rudder_2_position_deg.Data = A380PrimComputer_B.Data_gbt;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.fctl_law_status_word.SSM = A380PrimComputer_B.SSM_er;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.fctl_law_status_word.Data = A380PrimComputer_B.Data_p0;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.misc_data_status_word.SSM = A380PrimComputer_B.SSM_dm;
  A380PrimComputer_Y.out.data.bus_inputs.sec_3_bus.misc_data_status_word.Data = A380PrimComputer_B.Data_dn;
...
void A380PrimComputer::initialize()
{
  ...
  A380PrimComputer_B.ap_1_pushbutton_pressed = A380PrimComputer_P.out_Y0.data.discrete_inputs.ap_1_pushbutton_pressed;
  A380PrimComputer_B.ap_2_pushbutton_pressed = A380PrimComputer_P.out_Y0.data.discrete_inputs.ap_2_pushbutton_pressed;
  ...
  A380PrimComputer_B.SSM_lg = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.altitude_standard_ft.SSM;
  A380PrimComputer_B.Data_gb = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.altitude_standard_ft.Data;
  A380PrimComputer_B.SSM_jx = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.altitude_corrected_ft.SSM;
  A380PrimComputer_B.Data_ghs = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.altitude_corrected_ft.Data;
  A380PrimComputer_B.SSM_hr = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.mach.SSM;
  A380PrimComputer_B.Data_nib = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.mach.Data;
  A380PrimComputer_B.SSM_b3 = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.airspeed_computed_kn.SSM;
  A380PrimComputer_B.Data_cm = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.airspeed_computed_kn.Data;
  A380PrimComputer_B.SSM_hm = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.airspeed_true_kn.SSM;
  A380PrimComputer_B.Data_iyw = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.airspeed_true_kn.Data;
  A380PrimComputer_B.SSM_fk = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.vertical_speed_ft_min.SSM;
  A380PrimComputer_B.Data_p5d = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.vertical_speed_ft_min.Data;
  A380PrimComputer_B.SSM_lm1 = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.aoa_corrected_deg.SSM;
  A380PrimComputer_B.Data_oo = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.aoa_corrected_deg.Data;
  A380PrimComputer_B.SSM_nc = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.corrected_average_static_pressure.SSM;
  A380PrimComputer_B.Data_ho =
    A380PrimComputer_P.out_Y0.data.bus_inputs.adr_1_bus.corrected_average_static_pressure.Data;
  A380PrimComputer_B.SSM_e4 = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.altitude_standard_ft.SSM;
  A380PrimComputer_B.Data_kqr = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.altitude_standard_ft.Data;
  A380PrimComputer_B.SSM_bw = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.altitude_corrected_ft.SSM;
  A380PrimComputer_B.Data_omv = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.altitude_corrected_ft.Data;
  A380PrimComputer_B.SSM_na = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.mach.SSM;
  A380PrimComputer_B.Data_mby = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.mach.Data;
  A380PrimComputer_B.SSM_lf = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_computed_kn.SSM;
  A380PrimComputer_B.Data_hk = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_computed_kn.Data;
  A380PrimComputer_B.SSM_oz = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_true_kn.SSM;
  A380PrimComputer_B.Data_hg = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
  A380PrimComputer_B.SSM_mub = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.SSM;
  A380PrimComputer_B.Data_bi = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.Data;
  A380PrimComputer_B.SSM_li = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM;
  A380PrimComputer_B.Data_i4u = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
  A380PrimComputer_B.SSM_hcd = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.corrected_average_static_pressure.SSM;
  A380PrimComputer_B.Data_ik =
    A380PrimComputer_P.out_Y0.data.bus_inputs.adr_2_bus.corrected_average_static_pressure.Data;
  A380PrimComputer_B.SSM_php = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_3_bus.altitude_standard_ft.SSM;
  A380PrimComputer_B.Data_dq = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_3_bus.altitude_standard_ft.Data;
  A380PrimComputer_B.SSM_ma = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_3_bus.altitude_corrected_ft.SSM;
  A380PrimComputer_B.Data_pv = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_3_bus.altitude_corrected_ft.Data;
  A380PrimComputer_B.SSM_jut = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_3_bus.mach.SSM;
  A380PrimComputer_B.Data_p1d = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_3_bus.mach.Data;
  A380PrimComputer_B.SSM_kh = A380PrimComputer_P.out_Y0.data.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM;
  ...
  A380PrimComputer_B.SSM_npr = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.SSM;
  A380PrimComputer_B.Data_j0 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.Data;
  A380PrimComputer_B.SSM_ew = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.SSM;
  A380PrimComputer_B.Data_bs =
    A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.Data;
  A380PrimComputer_B.SSM_lt = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.SSM;
  A380PrimComputer_B.Data_hp = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.Data;
  A380PrimComputer_B.SSM_ger = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.SSM;
  A380PrimComputer_B.Data_ct = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.Data;
  A380PrimComputer_B.SSM_pxo = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.rudder_pedal_position_deg.SSM;
  A380PrimComputer_B.Data_pc = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.rudder_pedal_position_deg.Data;
  A380PrimComputer_B.SSM_co2 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.aileron_status_word.SSM;
  A380PrimComputer_B.Data_nzt = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.aileron_status_word.Data;
  A380PrimComputer_B.SSM_ny = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_aileron_1_position_deg.SSM;
  A380PrimComputer_B.Data_c0 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_aileron_1_position_deg.Data;
  A380PrimComputer_B.SSM_l4 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_aileron_2_position_deg.SSM;
  A380PrimComputer_B.Data_ojg = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_aileron_2_position_deg.Data;
  A380PrimComputer_B.SSM_nm = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_aileron_1_position_deg.SSM;
  A380PrimComputer_B.Data_lm = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_aileron_1_position_deg.Data;
  A380PrimComputer_B.SSM_nh = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_aileron_2_position_deg.SSM;
  A380PrimComputer_B.Data_fz = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_aileron_2_position_deg.Data;
  A380PrimComputer_B.SSM_dl = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.spoiler_status_word.SSM;
  A380PrimComputer_B.Data_oz = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.spoiler_status_word.Data;
  A380PrimComputer_B.SSM_dx = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.SSM;
  A380PrimComputer_B.Data_gf = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.Data;
  A380PrimComputer_B.SSM_a5h = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.SSM;
  A380PrimComputer_B.Data_nn = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data;
  A380PrimComputer_B.SSM_fl = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.SSM;
  A380PrimComputer_B.Data_a0z = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.Data;
  A380PrimComputer_B.SSM_p3 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.SSM;
  A380PrimComputer_B.Data_fk = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.Data;
  A380PrimComputer_B.SSM_ns = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.elevator_status_word.SSM;
  A380PrimComputer_B.Data_bu = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.elevator_status_word.Data;
  A380PrimComputer_B.SSM_bm = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.elevator_1_position_deg.SSM;
  A380PrimComputer_B.Data_o23 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.elevator_1_position_deg.Data;
  A380PrimComputer_B.SSM_nl = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.elevator_2_position_deg.SSM;
  A380PrimComputer_B.Data_g3 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.elevator_2_position_deg.Data;
  A380PrimComputer_B.SSM_grm = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.elevator_3_position_deg.SSM;
  A380PrimComputer_B.Data_icc = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.elevator_3_position_deg.Data;
  A380PrimComputer_B.SSM_gzm = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.ths_position_deg.SSM;
  A380PrimComputer_B.Data_pwf = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.ths_position_deg.Data;
  A380PrimComputer_B.SSM_oi = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.rudder_status_word.SSM;
  A380PrimComputer_B.Data_gvk = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.rudder_status_word.Data;
  A380PrimComputer_B.SSM_aa = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.rudder_1_position_deg.SSM;
  A380PrimComputer_B.Data_ln = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.rudder_1_position_deg.Data;
  A380PrimComputer_B.SSM_fvk = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.rudder_2_position_deg.SSM;
  A380PrimComputer_B.Data_ka = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.rudder_2_position_deg.Data;
  A380PrimComputer_B.SSM_lw = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.fctl_law_status_word.SSM;
  A380PrimComputer_B.Data_mp = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.fctl_law_status_word.Data;
  A380PrimComputer_B.SSM_fa = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.misc_data_status_word.SSM;
  A380PrimComputer_B.Data_m4 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_1_bus.misc_data_status_word.Data;
  A380PrimComputer_B.SSM_lbx = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.SSM;
  A380PrimComputer_B.Data_fki =
    A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.Data;
  A380PrimComputer_B.SSM_n3 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.SSM;
  A380PrimComputer_B.Data_bv =
    A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.Data;
  A380PrimComputer_B.SSM_a1 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.SSM;
  A380PrimComputer_B.Data_m21 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.Data;
  A380PrimComputer_B.SSM_p1 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.SSM;
  A380PrimComputer_B.Data_nbg =
    A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.Data;
  A380PrimComputer_B.SSM_cn2 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.rudder_pedal_position_deg.SSM;
  A380PrimComputer_B.Data_l25 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.rudder_pedal_position_deg.Data;
  A380PrimComputer_B.SSM_an3 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.aileron_status_word.SSM;
  A380PrimComputer_B.Data_ki = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.aileron_status_word.Data;
  A380PrimComputer_B.SSM_c3 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_aileron_1_position_deg.SSM;
  A380PrimComputer_B.Data_p5p = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_aileron_1_position_deg.Data;
  A380PrimComputer_B.SSM_dp = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_aileron_2_position_deg.SSM;
  A380PrimComputer_B.Data_nry = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_aileron_2_position_deg.Data;
  A380PrimComputer_B.SSM_boy = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_aileron_1_position_deg.SSM;
  A380PrimComputer_B.Data_mh = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_aileron_1_position_deg.Data;
  A380PrimComputer_B.SSM_cm = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_aileron_2_position_deg.SSM;
  A380PrimComputer_B.Data_ll = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_aileron_2_position_deg.Data;
  A380PrimComputer_B.SSM_hl = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.spoiler_status_word.SSM;
  A380PrimComputer_B.Data_hy = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.spoiler_status_word.Data;
  A380PrimComputer_B.SSM_irh = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.SSM;
  A380PrimComputer_B.Data_j04 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.Data;
  A380PrimComputer_B.SSM_b42 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.SSM;
  A380PrimComputer_B.Data_pf = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.Data;
  A380PrimComputer_B.SSM_anz = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.SSM;
  A380PrimComputer_B.Data_pl = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.Data;
  A380PrimComputer_B.SSM_d2 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.SSM;
  A380PrimComputer_B.Data_hq = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.Data;
  A380PrimComputer_B.SSM_gov = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.elevator_status_word.SSM;
  A380PrimComputer_B.Data_ai = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.elevator_status_word.Data;
  A380PrimComputer_B.SSM_nb = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.elevator_1_position_deg.SSM;
  A380PrimComputer_B.Data_gfr = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.elevator_1_position_deg.Data;
  A380PrimComputer_B.SSM_pe3 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.elevator_2_position_deg.SSM;
  A380PrimComputer_B.Data_czp = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.elevator_2_position_deg.Data;
  A380PrimComputer_B.SSM_jj = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.elevator_3_position_deg.SSM;
  A380PrimComputer_B.Data_fm = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.elevator_3_position_deg.Data;
  A380PrimComputer_B.SSM_npl = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.ths_position_deg.SSM;
  A380PrimComputer_B.Data_jsg = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.ths_position_deg.Data;
  A380PrimComputer_B.SSM_gf = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.rudder_status_word.SSM;
  A380PrimComputer_B.Data_g1 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.rudder_status_word.Data;
  A380PrimComputer_B.SSM_gbi = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.rudder_1_position_deg.SSM;
  A380PrimComputer_B.Data_j4 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.rudder_1_position_deg.Data;
  A380PrimComputer_B.SSM_fhm = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.rudder_2_position_deg.SSM;
  A380PrimComputer_B.Data_jyh = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.rudder_2_position_deg.Data;
  A380PrimComputer_B.SSM_ltj = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.fctl_law_status_word.SSM;
  A380PrimComputer_B.Data_e4 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.fctl_law_status_word.Data;
  A380PrimComputer_B.SSM_hn = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.misc_data_status_word.SSM;
  A380PrimComputer_B.Data_bmk = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_2_bus.misc_data_status_word.Data;
  A380PrimComputer_B.SSM_h3 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_sidestick_pitch_command_deg.SSM;
  A380PrimComputer_B.Data_lzt =
    A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_sidestick_pitch_command_deg.Data;
  A380PrimComputer_B.SSM_bfs = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_sidestick_pitch_command_deg.SSM;
  A380PrimComputer_B.Data_kn =
    A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_sidestick_pitch_command_deg.Data;
  A380PrimComputer_B.SSM_p0 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_sidestick_roll_command_deg.SSM;
  A380PrimComputer_B.Data_nab = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_sidestick_roll_command_deg.Data;
  A380PrimComputer_B.SSM_fu = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_sidestick_roll_command_deg.SSM;
  A380PrimComputer_B.Data_lgf =
    A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_sidestick_roll_command_deg.Data;
  A380PrimComputer_B.SSM_bi = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.rudder_pedal_position_deg.SSM;
  A380PrimComputer_B.Data_fpq = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.rudder_pedal_position_deg.Data;
  A380PrimComputer_B.SSM_bd = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.aileron_status_word.SSM;
  A380PrimComputer_B.Data_dt = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.aileron_status_word.Data;
  A380PrimComputer_B.SSM_omt = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_aileron_1_position_deg.SSM;
  A380PrimComputer_B.Data_b1 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_aileron_1_position_deg.Data;
  A380PrimComputer_B.SSM_la = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_aileron_2_position_deg.SSM;
  A380PrimComputer_B.Data_nmr = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_aileron_2_position_deg.Data;
  A380PrimComputer_B.SSM_l1 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_aileron_1_position_deg.SSM;
  A380PrimComputer_B.Data_ea = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_aileron_1_position_deg.Data;
  A380PrimComputer_B.SSM_dy = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_aileron_2_position_deg.SSM;
  A380PrimComputer_B.Data_i2t = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_aileron_2_position_deg.Data;
  A380PrimComputer_B.SSM_ie = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.spoiler_status_word.SSM;
  A380PrimComputer_B.Data_ng = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.spoiler_status_word.Data;
  A380PrimComputer_B.SSM_kf = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_spoiler_1_position_deg.SSM;
  A380PrimComputer_B.Data_h31 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_spoiler_1_position_deg.Data;
  A380PrimComputer_B.SSM_p5l = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_spoiler_1_position_deg.SSM;
  A380PrimComputer_B.Data_ew = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_spoiler_1_position_deg.Data;
  A380PrimComputer_B.SSM_g3 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_spoiler_2_position_deg.SSM;
  A380PrimComputer_B.Data_j1s = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.left_spoiler_2_position_deg.Data;
  A380PrimComputer_B.SSM_dxv = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.SSM;
  A380PrimComputer_B.Data_j5 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.Data;
  A380PrimComputer_B.SSM_mxz = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.elevator_status_word.SSM;
  A380PrimComputer_B.Data_cw = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.elevator_status_word.Data;
  A380PrimComputer_B.SSM_kk4 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.elevator_1_position_deg.SSM;
  A380PrimComputer_B.Data_gqa = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.elevator_1_position_deg.Data;
  A380PrimComputer_B.SSM_cy = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.elevator_2_position_deg.SSM;
  A380PrimComputer_B.Data_hz = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.elevator_2_position_deg.Data;
  A380PrimComputer_B.SSM_ju = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.elevator_3_position_deg.SSM;
  A380PrimComputer_B.Data_fri = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.elevator_3_position_deg.Data;
  A380PrimComputer_B.SSM_ey = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.ths_position_deg.SSM;
  A380PrimComputer_B.Data_czj = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.ths_position_deg.Data;
  A380PrimComputer_B.SSM_jr = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.rudder_status_word.SSM;
  A380PrimComputer_B.Data_mb = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.rudder_status_word.Data;
  A380PrimComputer_B.SSM_hs = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.rudder_1_position_deg.SSM;
  A380PrimComputer_B.Data_gk4 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.rudder_1_position_deg.Data;
  A380PrimComputer_B.SSM_mx3 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.rudder_2_position_deg.SSM;
  A380PrimComputer_B.Data_gbt = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.rudder_2_position_deg.Data;
  A380PrimComputer_B.SSM_er = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.fctl_law_status_word.SSM;
  A380PrimComputer_B.Data_p0 = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.fctl_law_status_word.Data;
  A380PrimComputer_B.SSM_dm = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.misc_data_status_word.SSM;
  A380PrimComputer_B.Data_dn = A380PrimComputer_P.out_Y0.data.bus_inputs.sec_3_bus.misc_data_status_word.Data;
