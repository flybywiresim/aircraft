...
void A380PrimComputer::step()
{
  ...
  if (A380PrimComputer_U.in.sim_data.computer_running) {
    ...
    rtb_AND2_i = !rtb_OR4;
    rtb_y_or = !rtb_OR3;
    rightAileron2Avail = (rtb_OR1 && rtb_y_or);
    if (rightAileron2Avail && rtb_AND2_i) {
      ...
      if (rtb_OR3 && rtb_AND2_i) {
        ...
        if ((rtb_y_or && rtb_AND2_i) || (rtb_y_or && rtb_OR4)) {
          rtb_V_ias = (A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data +
    ...
    rtb_AND2_i = !rtb_OR6;
    rtb_y_or = !rtb_OR7;
    rightAileron2Avail = (rtb_OR && rtb_y_or);
    if (rightAileron2Avail && rtb_AND2_i) {
      ...
      if (rtb_OR3 && rtb_AND2_i) {
        ...
        rtb_y_or = (rtb_OR1 && rtb_y_or);
        if ((rtb_y_or && rtb_AND2_i) || (rtb_y_or && rtb_OR6)) {
          rtb_alpha = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.Data +
                       A380PrimComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.Data) / 2.0F;
          rtb_phi = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.roll_angle_deg.Data +
                     A380PrimComputer_U.in.bus_inputs.ir_3_bus.roll_angle_deg.Data) / 2.0F;
    ...
    } else if ((rtb_OR6 && rtb_AND2_i) || (rtb_y_or && rtb_OR7)) {
    ...
    A380PrimComputer_MATLABFunction_c(((!A380PrimComputer_U.in.discrete_inputs.green_low_pressure) && rtb_y_og),
      ...
      A380PrimComputer_P.ConfirmNode2_timeDelay_h, &rtb_y_og, &A380PrimComputer_DWork.sf_MATLABFunction_kq);
    rtb_rudder2HydraulicModeEngaged = !rtb_y_og;
    rtb_rudder1HydraulicModeEngaged = !rtb_NOT_k;
    rtb_OR6 = !A380PrimComputer_P.Constant_Value_aq;
    rtb_OR6 = (rtb_AND1 && ((rtb_y_og || rtb_NOT_k || (!A380PrimComputer_U.in.discrete_inputs.rat_contactor_closed) || (
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_OR7 = rtb_y_og;
      rtb_doubleIrFault_tmp = rtb_y_og;
    ...
    rtb_rightAileron2Engaged = (rightAileron2Avail && (((!rtb_y_j) || (rtb_y_m == 0U)) && rtb_rightAileron2Engaged));
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND2_i = ((!rtb_y_ex) && rudder2ElectricModeHasPriority);
    } else {
      rtb_AND2_i = (A380PrimComputer_U.in.discrete_inputs.is_unit_2 && ((!rtb_y_ex) && rudder2ElectricModeHasPriority));
    }

    rtb_y_ex = (rtb_y_j && rtb_AND2_i);
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      ...
      rtb_AND2_i = (rtb_y_kkm != 0U);
    }

    rtb_AND_n = (rtb_AND2_i && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
    ...
    rtb_AND6_o = ((rtb_y_mc != 0U) && rtb_y_og);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_Switch_ir_0 = &A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word;
    } else {
      rtb_Switch_ir_0 = &A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word;
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2 || A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
        ...
        rtb_AND_n = (rudder1HydraulicModeHasPriority && ((!rtb_y_g) || (!rtb_AND2_i)) && (!rudder1HydraulicModeAvail) &&
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rudder2ElectricModeHasPriority = ((!rtb_AND3) && rtb_rudder2HydraulicModeEngaged && (!rtb_AND4_f) && ((rtb_y_m ==
        0U) || (!rtb_y_og)) && rudder2ElectricModeHasPriority);
    } else {
      rtb_AND6_o = false;
      rudder1HydraulicModeHasPriority = false;
    ...
    rtb_AND3 = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_c, &rtb_y_m);
    rudder2HydraulicModeHasPriority = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_p, &rtb_y_m);
    rtb_AND2_ac = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_n, &rtb_y_m);
    rtb_AND1_l = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    ...
    rtb_AND4_d = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_i, &rtb_y_m);
    rtb_AND4_f = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
    ...
    rtb_AND9 = (rtb_AND1_l || (rtb_AND9 || ((rtb_y_m != 0U) && rtb_y_g)));
    ...
    rtb_AND4_d = (rtb_y_og && (rtb_y_or || (rtb_y_m != 0U)));
    ...
    rtb_AND1_l = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel19_bit, &rtb_y_m);
    rtb_AND12 = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
    ...
    rtb_AND2_i = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_n, &rtb_y_m);
    rtb_y_og = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    ...
    rtb_AND4_i = ((rtb_y_m != 0U) && rtb_y_or);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_b, &rtb_y_m);
    rtb_NOT_k = ((rtb_y_m != 0U) && rtb_y_or);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
        rtb_AND1_p = (rtb_AND16_n || rtb_AND15_l);
        ...
        rtb_AND1_p = (elevator1Avail || rtb_AND15_l);
    ...
    rtb_AND2_ac = (rtb_AND1_p || (rtb_y_or || rtb_AND3_h));
    rtb_AND1_l = (rtb_AND19 || (rtb_AND10_b || rtb_AND7_d));
    rtb_AND5_e = (rtb_AND15_l || (rtb_AND5_e || rtb_NOT_k));
    rtb_AND4_i = (rtb_AND16_n || (rtb_AND4_i || rtb_AND2_i));
    rtb_AND12 = (rtb_AND12 || (((rtb_y_m != 0U) && rtb_y_g) || rtb_y_og));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
    ...
    rtb_AND15_l = (rtb_AND15_l || (rtb_y_g && rtb_DataTypeConversion_m2) || (rtb_AND2_i && rtb_NOT_k));
    ...
    rtb_AND1_p = !rtb_AND1;
    rtb_AND16_n = ((!rtb_y_og) && rtb_AND1_p && (((!rtb_tripleAdrFault) && ((rtb_mach > 0.96) || (rtb_Y < -10.0) ||
    ...
    nz = ((rtb_AND2_ac + rtb_AND1_l) + rtb_AND5_e) + rtb_AND4_i;
    b_x[0] = rtb_AND4_f;
    b_x[1] = rtb_AND11;
    b_x[2] = rtb_AND10;
    b_x[3] = rtb_AND9;
    ...
    A380PrimComputer_MATLABFunction_ek(rtb_y_g, rtb_AND2_i, rtb_NOT_k, rtb_y_og, &rtb_law_c);
    ...
    A380PrimComputer_MATLABFunction_ek(rtb_y_g, rtb_AND2_i, rtb_NOT_k, rtb_y_og, &rtb_law);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputer_DWork.sProtActive = ((rtb_AND1_p && rtb_y_g && (rtb_Y > rtb_handleIndex) &&
    ...
    A380PrimComputer_DWork.sProtActive = ((A380PrimComputer_U.in.time.simulation_time -
      ...
      || (rtb_Y >= rtb_handleIndex - 2.0)) && rtb_AND1_p && rtb_y_g && A380PrimComputer_DWork.sProtActive);
    ...
    A380PrimComputer_Y.out.logic.protection_ap_disconnect = ((rtb_AND1_p && (((nz != 0) && (rtb_Y > rtb_Switch_h)) ||
    ...
    if (rtb_AND20) {
      rtb_y_g = (rtb_AND1_p && (rtb_law_c != A380PrimComputer_P.EnumeratedConstant_Value_l));
    } else {
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_or);
    rtb_AND1_p = (((!rtb_NOT_k) || (rtb_y_m == 0U)) && rtb_y_or);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_or);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
    ...
    if (rtb_AND1_p || (rtb_y_or && ((!rtb_NOT_k) || (rtb_y_m == 0U)))) {
      abs_rate_c = 0.25;
    } else {
      abs_rate_c = 0.15;
    }
    ...
    rtb_y_or = ((!rtb_AND4_d) || rtb_AND2_i);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
    ...
    rtb_y_or = ((!rtb_AND9_o) || rtb_AND2_i);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs3_up_j,
      ...
      !rtb_AND4_i) || rtb_AND2_i), &rtb_Switch10_n, &A380PrimComputer_DWork.sf_RateLimiter_ph);
    if (!rtb_AND20) {
    ...
    rtb_VectorConcatenate_c[0] = rtb_AND1_p;
    ...
    A380PrimComputer_Y.out.logic.surface_statuses.right_outboard_elevator_engaged = rtb_AND4_i;
