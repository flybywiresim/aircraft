...
void A380PrimComputer::step()
{
  ...
  if (A380PrimComputer_U.in.sim_data.computer_running) {
    if (!A380PrimComputer_DWork.Runtime_MODE) {
      ...
      A380PrimComputer_DWork.Memory_PreviousInput_d = A380PrimComputer_P.SRFlipFlop1_initial_condition;
      A380PrimComputer_DWork.Memory_PreviousInput_jw = A380PrimComputer_P.SRFlipFlop_initial_condition_i;
      ...
      A380PrimComputer_MATLABFunction_m_Reset(&A380PrimComputer_DWork.sf_MATLABFunction_ky);
      A380PrimComputer_MATLABFunction_m_Reset(&A380PrimComputer_DWork.sf_MATLABFunction_dmh);
      LawMDLOBJ2.reset();
      LawMDLOBJ1.reset();
    ...
    rtb_AND2_j = !rtb_OR4;
    rtb_y_or = !rtb_OR3;
    rtb_AND1_e = (rtb_OR1 && rtb_y_or);
    if (rtb_AND1_e && rtb_AND2_j) {
      ...
      if (rtb_OR3 && rtb_AND2_j) {
        ...
        rtb_y_or = (rtb_OR1 && rtb_y_or);
        if ((rtb_y_or && rtb_AND2_j) || (rtb_y_or && rtb_OR4)) {
          rtb_V_ias = (A380PrimComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data +
    ...
    if (rtb_AND1_e && rtb_AND2_j) {
      ...
      if (rtb_OR3 && rtb_AND2_j) {
        ...
        rtb_y_or = (rtb_OR1 && rtb_y_or);
        if ((rtb_y_or && rtb_AND2_j) || (rtb_y_or && rtb_OR6)) {
          rtb_alpha = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.Data +
                       A380PrimComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.Data) / 2.0F;
          rtb_phi = (A380PrimComputer_U.in.bus_inputs.ir_1_bus.roll_angle_deg.Data +
                     A380PrimComputer_U.in.bus_inputs.ir_3_bus.roll_angle_deg.Data) / 2.0F;
        ...
        } else if (rtb_doubleIrFault_tmp && rtb_AND2_j) {
          rtb_alpha = A380PrimComputer_U.in.bus_inputs.ir_2_bus.pitch_angle_deg.Data;
          rtb_phi = A380PrimComputer_U.in.bus_inputs.ir_2_bus.roll_angle_deg.Data;
          rtb_q = A380PrimComputer_U.in.bus_inputs.ir_2_bus.body_pitch_rate_deg_s.Data;
          rtb_r = A380PrimComputer_U.in.bus_inputs.ir_2_bus.body_yaw_rate_deg_s.Data;
    ...
    A380PrimComputer_MATLABFunction_c((std::abs(A380PrimComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data -
      ...
      A380PrimComputer_P.ConfirmNode_timeDelay, &rtb_y_g, &A380PrimComputer_DWork.sf_MATLABFunction_jz);
    ...
    } else if ((rtb_OR6 && rtb_AND2_j) || (rtb_y_or && rtb_OR7)) {
    ...
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel2_bit, &rtb_y_m);
    A380PrimComputer_MATLABFunction(rtb_Switch_ir_0, &rtb_y_j);
    rtb_AND1_e = ((rtb_y_m != 0U) && rtb_y_j);
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel1_bit_b, &rtb_y_m);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    rtb_OR1 = (rtb_OR3 && ((!rtb_y_j) || (rtb_y_m == 0U)));
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
    ...
    A380PrimComputer_MATLABFunction(rtb_Switch_ir_0, &rtb_y_j);
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel1_bit_n, &rtb_y_m);
    rtb_AND_e = (rtb_y_j && (rtb_y_m != 0U));
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND2_j = !rtb_AND_e;
    } else if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_AND2_j = !rtb_AND_e;
    } else {
      rtb_AND2_j = A380PrimComputer_U.in.discrete_inputs.is_unit_3;
    }

    rtb_AND_e = (elevator2Avail && rtb_AND2_j);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_ex);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel3_bit, &rtb_y_kkm);
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_l, &rtb_y_m);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
      rtb_y_ex = (rtb_y_ex && (rtb_y_kkm != 0U));
    } else {
      rtb_y_ex = (rtb_y_j && (rtb_y_m != 0U));
    }
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_AND2_j = (A380PrimComputer_U.in.discrete_inputs.is_unit_2 && (!rtb_y_ex));
    }

    rtb_y_ex = (rtb_y_j && rtb_AND2_j);
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_bv, &rtb_y_m);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      thsAvail = rtb_BusAssignment_j_logic_is_yellow_hydraulic_power_avail;
      rtb_AND2_j = ((!rtb_NOT_k) || (rtb_y_m == 0U));
    } else {
      ...
      rtb_AND2_j = (rtb_thsEngaged && A380PrimComputer_U.in.discrete_inputs.is_unit_3);
    }

    rtb_thsEngaged = (thsAvail && rtb_AND2_j);
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_k, &rtb_y_m);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_e, &rtb_y_kkm);
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      rtb_AND2_j = (rtb_y_m != 0U);
    } else {
      rtb_AND2_j = (rtb_y_kkm != 0U);
    }

    rtb_AND_n = (rtb_AND2_j && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_c, &rtb_y_m);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel4_bit, &rtb_y_kkm);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel6_bit, &rtb_y_mc);
    A380PrimComputer_MATLABFunction(rtb_Switch_ir_0, &rtb_y_og);
    rtb_AND6 = ((rtb_y_mc != 0U) && rtb_y_og);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_Switch_ir_0 = &A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word;
    } else {
      rtb_Switch_ir_0 = &A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word;
    ...
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel9_bit, &rtb_y_mc);
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel10_bit, &rtb_y_ad);
    A380PrimComputer_MATLABFunction(rtb_Switch_ir_0, &rtb_NOT_k);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
      rtb_AND2_j = (rtb_y_mc != 0U);
    } else {
      rtb_AND2_j = (rtb_y_ad != 0U);
    }

    rtb_AND3 = (rtb_AND2_j && rtb_NOT_k);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2 || A380PrimComputer_U.in.discrete_inputs.is_unit_3) {
        ...
        rtb_AND6 = (rudder1HydraulicModeHasPriority && ((!rtb_y_g) || (!rtb_AND2_j)) && (!rudder1HydraulicModeAvail) &&
                    (!rtb_AND6) && (!rtb_AND3));
      } else {
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel5_bit, &rtb_y_m);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word, &rtb_y_g);
    rtb_AND2_jo = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel7_bit, &rtb_y_m);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.rudder_status_word, &rtb_NOT_k);
    rtb_AND4 = ((rtb_y_m != 0U) && rtb_NOT_k);
    ...
    rtb_AND4 = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_c, &rtb_y_m);
    rtb_AND3_d = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_p, &rtb_y_m);
    rtb_AND2_b = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_n, &rtb_y_m);
    rtb_AND1_at = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word, &rtb_y_g);
    rtb_AND4_n = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_i, &rtb_y_m);
    rtb_AND6_m = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_j, &rtb_y_m);
    rtb_AND7 = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_n, &rtb_y_m);
    rtb_AND8 = ((rtb_y_m != 0U) && rtb_y_g);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word, &rtb_y_og);
    rtb_AND15 = ((rtb_y_m != 0U) && rtb_y_og);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.aileron_status_word,
      A380PrimComputer_P.BitfromLabel15_bit, &rtb_y_m);
    rtb_AND16 = ((rtb_y_m != 0U) && rtb_y_og);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word, &rtb_y_g);
    rtb_AND17 = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.aileron_status_word,
    ...
    rtb_AND9 = (rtb_AND1_at || (rtb_AND9 || ((rtb_y_m != 0U) && rtb_y_g)));
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_g, &rtb_y_m);
    rtb_y_or = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_pc, &rtb_y_m);
    rtb_AND13 = (rtb_y_og && (rtb_y_or || (rtb_y_m != 0U)));
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_i, &rtb_y_m);
    rtb_DataTypeConversion_m2 = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_n, &rtb_y_m);
    rtb_AND17 = (rtb_y_og && (rtb_DataTypeConversion_m2 || (rtb_y_m != 0U)));
    ...
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_nd, &rtb_y_m);
    rtb_y_or = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_d, &rtb_y_m);
    rtb_AND4_n = (rtb_y_og && (rtb_y_or || (rtb_y_m != 0U)));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel8_bit_l, &rtb_y_m);
    rtb_y_or = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_g, &rtb_y_m);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word, &rtb_NOT_k);
    rtb_AND15 = ((rtb_y_or || (rtb_y_m != 0U)) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel10_bit_j, &rtb_y_m);
    rtb_y_g = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel11_bit_j, &rtb_y_m);
    rtb_AND16 = ((rtb_y_g || (rtb_y_m != 0U)) && rtb_NOT_k);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel14_bit_p, &rtb_y_m);
    rtb_y_g = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel15_bit_i, &rtb_y_m);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word, &rtb_y_og);
    rtb_AND8 = ((rtb_y_g || (rtb_y_m != 0U)) && rtb_y_og);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel12_bit, &rtb_y_m);
    rtb_y_g = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel13_bit, &rtb_y_m);
    rtb_AND9_o = ((rtb_y_g || (rtb_y_m != 0U)) && rtb_y_og);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word, &rtb_y_og);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_l, &rtb_y_m);
    rtb_y_g = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_f, &rtb_y_m);
    rtb_AND16 = (rtb_y_og && (rtb_y_g || (rtb_y_m != 0U)));
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word, &rtb_y_og);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel1_bit_p, &rtb_y_m);
    rtb_y_or = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_b, &rtb_y_m);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    rtb_AND9_o = (rtb_y_og && (rtb_y_or || (rtb_y_m != 0U)));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel16_bit_b, &rtb_y_m);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word, &rtb_y_g);
    rtb_AND2_b = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel17_bit_i, &rtb_y_m);
    rtb_AND15_l = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.elevator_status_word,
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word, &rtb_y_og);
    rtb_AND16_n = ((rtb_y_m != 0U) && rtb_y_og);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel21_bit, &rtb_y_m);
    rtb_AND18_c = ((rtb_y_m != 0U) && rtb_y_og);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel22_bit, &rtb_y_m);
    rtb_AND19 = ((rtb_y_m != 0U) && rtb_y_og);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel23_bit, &rtb_y_m);
    rtb_AND20 = ((rtb_y_m != 0U) && rtb_y_og);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      &rtb_DataTypeConversion_m2);
    rtb_AND5_e = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_g, &rtb_y_m);
    rtb_AND3_h = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_k, &rtb_y_m);
    rtb_AND2_j = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel4_bit_n, &rtb_y_m);
    rtb_AND1_b = ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word, &rtb_y_or);
    rtb_AND4_d = ((rtb_y_m != 0U) && rtb_y_or);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_b, &rtb_y_m);
    rtb_y_og = ((rtb_y_m != 0U) && rtb_y_or);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel7_bit_p, &rtb_y_m);
    rtb_AND7_d = ((rtb_y_m != 0U) && rtb_y_or);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word, &rtb_y_g);
    rtb_y_or = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel9_bit_e, &rtb_y_m);
    rtb_AND10_b = ((rtb_y_m != 0U) && rtb_y_g);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputer_P.BitfromLabel11_bit_n, &rtb_y_m);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND1_d = (rtb_AND_e || rtb_AND16_n);
      rtb_AND19 = (rtb_AND18_c || rtb_AND1_at);
      rtb_AND15_l = (elevator1Avail || rtb_AND15_l);
      rtb_AND16_n = (rtb_AND2_b || rtb_y_ex);
      rtb_NOT_k = (rtb_thsEngaged || rtb_AND20);
    ...
    rtb_AND2_b = (rtb_AND1_d || (rtb_y_or || rtb_AND3_h));
    rtb_AND1_at = (rtb_AND19 || (rtb_AND10_b || rtb_AND7_d));
    rtb_AND5_e = (rtb_AND15_l || (rtb_AND5_e || rtb_y_og));
    rtb_AND4_d = (rtb_AND16_n || (rtb_AND4_d || rtb_AND2_j));
    rtb_AND1_b = (rtb_NOT_k || (((rtb_y_m != 0U) && rtb_y_g) || rtb_AND1_b));
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      &rtb_DataTypeConversion_m2);
    rtb_AND3_h = ((rtb_NOT_k || (rtb_y_m != 0U)) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel32_bit, &rtb_y_m);
    rtb_NOT_k = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.rudder_status_word,
      A380PrimComputer_P.BitfromLabel33_bit, &rtb_y_m);
    rtb_AND15_l = ((rtb_NOT_k || (rtb_y_m != 0U)) && rtb_DataTypeConversion_m2);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_y_bus.rudder_status_word,
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sec_2_bus.rudder_status_word, &rtb_y_or);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sec_3_bus.rudder_status_word,
    ...
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_AND15_l = (rtb_AND2_jo || rudder2HydraulicModeHasPriority || rtb_AND20);
      ...
      if (A380PrimComputer_U.in.discrete_inputs.is_unit_2) {
        ...
        rtb_AND15_l = (rtb_AND_n || rtb_AND6 || rtb_AND15_l);
      } else {
        rtb_AND3_h = false;
        rtb_AND15_l = false;
      }
    ...
    rtb_AND3_h = (rtb_AND3_h || (rtb_y_og && rtb_DataTypeConversion_m2) || (rtb_AND16_n && rtb_y_or));
    rtb_AND15_l = (rtb_AND15_l || (rtb_y_g && rtb_DataTypeConversion_m2) || (rtb_AND2_j && rtb_NOT_k));
    ...
    rtb_AND1_d = !rtb_AND1;
    rtb_AND16_n = ((!rtb_y_og) && rtb_AND1_d && (((!rtb_tripleAdrFault) && ((rtb_mach > 0.96) || (rtb_Y < -10.0) ||
    ...
    A380PrimComputer_DWork.abnormalConditionWasActive = (rtb_AND16_n || (rtb_AND1_d &&
      A380PrimComputer_DWork.abnormalConditionWasActive));
    nz = ((rtb_AND2_b + rtb_AND1_at) + rtb_AND5_e) + rtb_AND4_d;
    b_x[0] = rtb_AND6_m;
    b_x[1] = rtb_AND11;
    b_x[2] = rtb_AND10;
    b_x[3] = rtb_AND9;
    ...
    rtb_NOT_k = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel6_bit_k, &rtb_y_m);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word, &rtb_y_og);
    A380PrimComputer_MATLABFunction_ek(rtb_y_g, rtb_AND2_j, rtb_NOT_k, rtb_y_og, &rtb_law_c);
    ...
    A380PrimComputer_MATLABFunction_ek(rtb_y_g, rtb_AND2_j, rtb_NOT_k, rtb_y_og, &rtb_law);
    if (A380PrimComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    rtb_NOT_k = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel3_bit_g, &rtb_y_m);
    rtb_y_or = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
    ...
    A380PrimComputer_MATLABFunction_o(rtb_y_g, rtb_y_og, rtb_NOT_k, rtb_y_or, rtb_AND18_c, (rtb_y_m != 0U),
      &rtb_handleIndex);
    ...
    rtb_y_a = false;
    rtb_y_g = ((rtb_law_c == a380_pitch_efcs_law::NormalLaw) || (rtb_activeLateralLaw == a380_lateral_efcs_law::
                NormalLaw));
    ...
    A380PrimComputer_DWork.sProtActive = ((rtb_AND1_d && rtb_y_g && (rtb_Y > rtb_handleIndex) &&
    ...
    A380PrimComputer_DWork.sProtActive = ((A380PrimComputer_U.in.time.simulation_time -
      ...
      || (rtb_Y >= rtb_handleIndex - 2.0)) && rtb_AND1_d && rtb_y_g && A380PrimComputer_DWork.sProtActive);
    ...
    A380PrimComputer_Y.out.logic.protection_ap_disconnect = ((rtb_AND1_d && (((nz != 0) && (rtb_Y > rtb_Switch_h)) ||
    ...
    rtb_y_or = (A380PrimComputer_U.in.analog_inputs.thr_lever_4_pos >= A380PrimComputer_P.CompareToConstant2_const);
    rtb_NOT_k = (A380PrimComputer_P.Constant_Value_h || A380PrimComputer_DWork.sProtActive ||
                 ((A380PrimComputer_U.in.analog_inputs.thr_lever_1_pos >= A380PrimComputer_P.CompareToConstant3_const) ||
                  ...
                  rtb_DataTypeConversion_m2 || rtb_y_or));
    ...
    rtb_y_og = (rtb_NOT_k || A380PrimComputer_DWork.Memory_PreviousInput);
    A380PrimComputer_MATLABFunction_m(rtb_AND1, A380PrimComputer_P.PulseNode3_isRisingEdge, &rtb_DataTypeConversion_m2,
      &A380PrimComputer_DWork.sf_MATLABFunction_jj);
    A380PrimComputer_MATLABFunction_m(rtb_AND1, A380PrimComputer_P.PulseNode2_isRisingEdge, &rtb_y_g,
      &A380PrimComputer_DWork.sf_MATLABFunction_ej);
    A380PrimComputer_DWork.Memory_PreviousInput_j = A380PrimComputer_P.Logic_table_h[(((static_cast<uint32_T>
      (rtb_DataTypeConversion_m2 || (((A380PrimComputer_U.in.analog_inputs.left_body_wheel_speed <
      A380PrimComputer_P.CompareToConstant23_const) || (A380PrimComputer_U.in.analog_inputs.left_wing_wheel_speed <
      A380PrimComputer_P.CompareToConstant21_const)) && ((A380PrimComputer_U.in.analog_inputs.right_body_wheel_speed <
      A380PrimComputer_P.CompareToConstant22_const) || (A380PrimComputer_U.in.analog_inputs.right_wing_wheel_speed <
      A380PrimComputer_P.CompareToConstant24_const)))) << 1) + rtb_y_g) << 1) +
    ...
    A380PrimComputer_MATLABFunction_m(false, A380PrimComputer_P.PulseNode1_isRisingEdge_c, &rtb_y_or,
    ...
    A380PrimComputer_DWork.Delay1_DSTATE_b = (((((A380PrimComputer_U.in.analog_inputs.speed_brake_lever_pos >
      ...
      (rtb_y_or || (((A380PrimComputer_U.in.analog_inputs.left_body_wheel_speed >=
                    ...
                    ((A380PrimComputer_U.in.analog_inputs.right_body_wheel_speed >=
                     ...
                     (A380PrimComputer_U.in.analog_inputs.right_wing_wheel_speed >=
                      A380PrimComputer_P.CompareToConstant20_const)) && A380PrimComputer_DWork.Memory_PreviousInput_j) ||
       A380PrimComputer_DWork.Delay1_DSTATE_b));
    rtb_y_g = (A380PrimComputer_U.in.analog_inputs.thr_lever_1_pos <= A380PrimComputer_P.CompareToConstant8_const);
    rtb_DataTypeConversion_m2 = (A380PrimComputer_U.in.analog_inputs.thr_lever_2_pos <
      A380PrimComputer_P.CompareToConstant9_const);
    rtb_y_or = (((A380PrimComputer_U.in.analog_inputs.thr_lever_1_pos < A380PrimComputer_P.CompareToConstant17_const) &&
                 (A380PrimComputer_U.in.analog_inputs.thr_lever_2_pos <= A380PrimComputer_P.CompareToConstant18_const)) ||
                (rtb_y_g && rtb_DataTypeConversion_m2));
    A380PrimComputer_MATLABFunction_m(false, A380PrimComputer_P.PulseNode_isRisingEdge_n, &rtb_y_g,
    ...
    A380PrimComputer_DWork.Delay_DSTATE_f = (((((A380PrimComputer_U.in.analog_inputs.speed_brake_lever_pos >
      ...
      rtb_y_or) && (rtb_y_g || A380PrimComputer_DWork.Delay_DSTATE_f));
    rtb_AND18_c = ((!A380PrimComputer_DWork.Delay1_DSTATE_b) && A380PrimComputer_DWork.Delay_DSTATE_f);
    ...
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_NOT_k);
    rtb_AND19 = ((rtb_y_or && rtb_y_g) || ((rtb_y_m == 0U) && rtb_NOT_k));
    A380PrimComputer_MATLABFunction_m(rtb_AND1, A380PrimComputer_P.PulseNode1_isRisingEdge_n, &rtb_DataTypeConversion_m2,
      &A380PrimComputer_DWork.sf_MATLABFunction_ky);
    A380PrimComputer_MATLABFunction_m(rtb_AND1, A380PrimComputer_P.PulseNode2_isRisingEdge_g, &rtb_y_g,
    ...
    A380PrimComputer_DWork.Memory_PreviousInput_d = A380PrimComputer_P.Logic_table_j[(((static_cast<uint32_T>
      (rtb_DataTypeConversion_m2) << 1) + (rtb_y_g || A380PrimComputer_DWork.Delay_DSTATE_e)) << 1) +
      A380PrimComputer_DWork.Memory_PreviousInput_d];
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      A380PrimComputer_P.BitfromLabel2_bit_pt, &rtb_y_m);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
      &rtb_DataTypeConversion_m2);
    if ((rtb_y_m != 0U) && rtb_DataTypeConversion_m2) {
    ...
    A380PrimComputer_MATLABFunction_e(rtb_Switch_ir_0, A380PrimComputer_P.BitfromLabel3_bit_gv, &rtb_y_m);
    if (rtb_AND20) {
      rtb_y_g = (rtb_AND1_d && (rtb_law_c != A380PrimComputer_P.EnumeratedConstant_Value_l));
    } else {
      rtb_y_g = ((rtb_y_m != 0U) && (rtb_Switch_ir_0->SSM == static_cast<uint32_T>(SignStatusMatrix::NormalOperation)));
    }

    rtb_y_or = A380PrimComputer_DWork.Memory_PreviousInput_jw;
    A380PrimComputer_DWork.Delay_DSTATE_e = A380PrimComputer_P.Logic_table_n[(((rtb_y_g || (std::abs(rtb_thsPos) <=
      A380PrimComputer_P.CompareToConstant1_const_pc) || A380PrimComputer_U.in.discrete_inputs.pitch_trim_up_pressed ||
      ...
      A380PrimComputer_DWork.Memory_PreviousInput_jw];
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel4_bit_p, &rtb_y_m);
    rtb_NOT_k = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel_bit_g, &rtb_y_m);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_or);
    rtb_AND1_d = (((!rtb_NOT_k) || (rtb_y_m == 0U)) && rtb_y_or);
    A380PrimComputer_MATLABFunction(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_y_or);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel6_bit_l, &rtb_y_m);
    rtb_NOT_k = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      A380PrimComputer_P.BitfromLabel5_bit_as, &rtb_y_m);
    if (rtb_AND1_d || (rtb_y_or && ((!rtb_NOT_k) || (rtb_y_m == 0U)))) {
      abs_rate_c = 0.25;
    } else {
      abs_rate_c = 0.15;
    }
    ...
    rtb_BusAssignment_nw_logic_high_speed_prot_hi_thresh_kn = std::fmin(A380PrimComputer_P.Constant7_Value_g,
      rtb_Switch4_d);
    rtb_AND1_d = rtb_y_g;
    rtb_y_g = (rtb_OR || (static_cast<real_T>(rtb_activeLateralLaw) != A380PrimComputer_P.CompareToConstant_const_m4));
    LawMDLOBJ2.step(&A380PrimComputer_U.in.time.dt, &rtb_rightAileron2Command, &rtb_elevator1Command,
                    ...
                    &A380PrimComputer_U.in.analog_inputs.rudder_pedal_pos, &rtb_AND1, &rtb_y_g,
                    &A380PrimComputer_DWork.sProtActive, &rtb_y_a,
    ...
    A380PrimComputer_RateLimiter_a(rtb_right_spoiler_2_deg, A380PrimComputer_P.RateLimiterGenericVariableTs_up_b,
      ...
      ((!rtb_AND6_m) || rtb_AND2_j), &rtb_Switch4_d, &A380PrimComputer_DWork.sf_RateLimiter_a);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
    ...
    A380PrimComputer_RateLimiter_a(rtb_right_spoiler_2_deg, A380PrimComputer_P.RateLimiterGenericVariableTs1_up_k,
      ...
      ((!rtb_AND11) || rtb_AND2_j), &rtb_Switch4_d, &A380PrimComputer_DWork.sf_RateLimiter_n);
    if (rtb_AND20) {
      rtb_handleIndex = rtb_Switch4_d;
    } else {
    ...
    A380PrimComputer_RateLimiter_a(rtb_right_spoiler_2_deg, A380PrimComputer_P.RateLimiterGenericVariableTs2_up,
      ...
      ((!rtb_AND10) || rtb_AND2_j), &rtb_Switch4_d, &A380PrimComputer_DWork.sf_RateLimiter_f);
    if (rtb_AND20) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_right_spoiler_2_deg, A380PrimComputer_P.RateLimiterGenericVariableTs3_up,
      ...
      ((!rtb_AND9) || rtb_AND2_j), &rtb_Switch4_d, &A380PrimComputer_DWork.sf_RateLimiter_au);
    if (rtb_AND20) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_Sum6, A380PrimComputer_P.RateLimiterGenericVariableTs4_up,
      ...
      ((!rtb_AND4) || rtb_AND2_j), &rtb_Switch4_d, &A380PrimComputer_DWork.sf_RateLimiter_mn);
    if (rtb_AND20) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_right_outboard_aileron_deg, A380PrimComputer_P.RateLimiterGenericVariableTs5_up,
      ...
      ((!rtb_AND3_d) || rtb_AND2_j), &rtb_Switch4_d, &A380PrimComputer_DWork.sf_RateLimiter_lm);
    if (rtb_AND20) {
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       (A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_1_position_deg.Data), rtb_y_or, &rtb_Switch4_d,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_1_position_deg.Data), rtb_y_or, &rtb_Switch4_d,
    ...
    rtb_y_or = ((!rtb_AND17) || rtb_AND2_j);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs10_up, A380PrimComputer_P.RateLimiterGenericVariableTs10_lo,
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.Data), rtb_y_or, &rtb_Switch4_d,
    ...
    A380PrimComputer_RateLimiter_a(rtb_outerAilUpperLim, A380PrimComputer_P.RateLimiterGenericVariableTs11_up,
      ...
      (A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.Data), rtb_y_or, &rtb_Switch4_d,
    ...
    rtb_y_or = ((!rtb_AND4_n) || rtb_AND2_j);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs14_up, A380PrimComputer_P.RateLimiterGenericVariableTs14_lo,
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.Data), rtb_y_or, &rtb_eta_trim_limit_up_m,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data), rtb_y_or,
    ...
    rtb_y_or = ((!rtb_AND7) || rtb_AND2_j);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs12_up, A380PrimComputer_P.RateLimiterGenericVariableTs12_lo,
       A380PrimComputer_U.in.time.dt, rtb_leftSplr4Pos, rtb_y_or, &rtb_eta_trim_limit_up_m,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, rtb_rightSplr4Pos, rtb_y_or, &rtb_eta_trim_limit_up_m,
    ...
    A380PrimComputer_RateLimiter_a(rtb_Switch_h, A380PrimComputer_P.RateLimiterGenericVariableTs19_up,
      A380PrimComputer_P.RateLimiterGenericVariableTs19_lo, A380PrimComputer_U.in.time.dt, rtb_rightSplr5Pos, rtb_y_or,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, rtb_rightSplr6Pos, rtb_y_or, &rtb_Switch1_k,
    ...
    rtb_y_or = ((!rtb_AND16) || rtb_AND2_j);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs22_up, A380PrimComputer_P.RateLimiterGenericVariableTs22_lo,
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.Data), rtb_y_or, &rtb_Switch1_k,
    ...
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       ...
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.Data), rtb_y_or, &rtb_Switch1_k,
    ...
    rtb_y_or = ((!rtb_AND9_o) || rtb_AND2_j);
    A380PrimComputer_RateLimiter_a
      (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg,
       A380PrimComputer_P.RateLimiterGenericVariableTs20_up, A380PrimComputer_P.RateLimiterGenericVariableTs20_lo,
       A380PrimComputer_U.in.time.dt, static_cast<real_T>
       (A380PrimComputer_U.in.bus_inputs.sec_3_bus.left_spoiler_2_position_deg.Data), rtb_y_or, &rtb_Switch4_d,
    ...
    A380PrimComputer_RateLimiter_a(rtb_Switch_h, A380PrimComputer_P.RateLimiterGenericVariableTs21_up,
      ...
      (A380PrimComputer_U.in.bus_inputs.sec_3_bus.right_spoiler_2_position_deg.Data), rtb_y_or, &rtb_Switch4_d,
    ...
    A380PrimComputer_RateLimiter_a(rtb_Switch_h, A380PrimComputer_P.RateLimiterGenericVariableTs6_up,
      ...
      ((!rtb_AND3_h) || rtb_AND2_j), &rtb_Switch4_d, &A380PrimComputer_DWork.sf_RateLimiter_np);
    if (rtb_AND20) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_Switch_h, A380PrimComputer_P.RateLimiterGenericVariableTs7_up,
      ...
      ((!rtb_AND15_l) || rtb_AND2_j), &rtb_Switch4_d, &A380PrimComputer_DWork.sf_RateLimiter_iy);
    if (!rtb_AND20) {
    ...
    rtb_DataTypeConversion_h = (rtb_y_m != 0U);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      A380PrimComputer_P.BitfromLabel5_bit_py, &rtb_y_m);
    A380PrimComputer_MATLABFunction_o(rtb_y_g, rtb_NOT_k, rtb_y_or, rtb_DataTypeConversion_m2, rtb_DataTypeConversion_h,
      (rtb_y_m != 0U), &rtb_Switch1_k);
    rtb_y_g = (rtb_OR || ((static_cast<real_T>(rtb_law_c) != A380PrimComputer_P.CompareToConstant_const_f) && (
    ...
    LawMDLOBJ5.step(&A380PrimComputer_U.in.time.dt, &A380PrimComputer_U.in.time.simulation_time, &rtb_elevator2Command,
      ...
      const_cast<real_T*>(&A380PrimComputer_RGND)), &u0, &rtb_AND1, &rtb_y_g, &A380PrimComputer_DWork.sProtActive,
                    &rtb_y_a, &rtb_BusAssignment_d_logic_alpha_prot_deg, &rtb_BusAssignment_nw_logic_alpha_max_deg,
    ...
    A380PrimComputer_MATLABFunction_o(rtb_y_g, rtb_NOT_k, rtb_y_or, rtb_DataTypeConversion_m2, rtb_y_a, (rtb_y_m != 0U),
      &rtb_Switch_h);
    rtb_y_g = (rtb_OR || ((static_cast<real_T>(rtb_law_c) != A380PrimComputer_P.CompareToConstant3_const_o) && (
    ...
    LawMDLOBJ3.step(&A380PrimComputer_U.in.time.dt, &rtb_elevator2Command, &rtb_rightAileron2Command,
      ...
      const_cast<real_T*>(&A380PrimComputer_RGND)), &u0, &rtb_y_g, &rtb_NOT_k, &rtb_eta_deg_o, &rtb_eta_trim_dot_deg_s_a,
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs_up_a,
      ...
      ((!rtb_AND2_b) || rtb_AND2_j), &rtb_Switch4_d, &A380PrimComputer_DWork.sf_RateLimiter_cr);
    A380PrimComputer_MATLABFunction_e(&A380PrimComputer_U.in.bus_inputs.prim_x_bus.fctl_law_status_word,
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs1_up_a,
      ...
      ((!rtb_AND1_at) || rtb_AND2_j), &rtb_Switch_h, &A380PrimComputer_DWork.sf_RateLimiter_p);
    if (!rtb_AND20) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs2_up_l,
      ...
      ((!rtb_AND5_e) || rtb_AND2_j), &rtb_Switch1_k, &A380PrimComputer_DWork.sf_RateLimiter_cda);
    if (!rtb_AND20) {
    ...
    A380PrimComputer_RateLimiter_a(rtb_eta_deg_dv, A380PrimComputer_P.RateLimiterGenericVariableTs3_up_j,
      ...
      !rtb_AND4_d) || rtb_AND2_j), &rtb_Switch10_n, &A380PrimComputer_DWork.sf_RateLimiter_ph);
    if (!rtb_AND20) {
    ...
    if (rtb_AND1_d) {
      ...
      rtb_AND2_j = ((!rtb_AND1_b) || rtb_AND2_j);
    } else {
      rtb_eta_trim_dot_deg_s_n = abs_rate_c;
      rtb_AND2_j = !rtb_thsEngaged;
    }
    ...
    A380PrimComputer_DWork.icLoad = (rtb_AND2_j || A380PrimComputer_DWork.icLoad);
    ...
    rtb_VectorConcatenate[7] = rtb_y_ex;
    ...
    rtb_VectorConcatenate_c[0] = rtb_AND1_d;
    ...
    A380PrimComputer_Y.out.logic.surface_statuses.right_outboard_elevator_engaged = rtb_AND4_d;
    A380PrimComputer_Y.out.logic.surface_statuses.ths_engaged = rtb_AND1_b;
    ...
    A380PrimComputer_Y.out.logic.elevator_3_engaged = rtb_y_ex;
    ...
    A380PrimComputer_Y.out.logic.ths_automatic_mode_active = rtb_AND1_d;
    ...
    A380PrimComputer_Y.out.logic.speed_brake_inhibited = rtb_y_og;
    ...
    A380PrimComputer_Y.out.discrete_outputs.elevator_3_active_mode = rtb_y_ex;
    ...
    A380PrimComputer_DWork.Memory_PreviousInput_jw = A380PrimComputer_DWork.Delay_DSTATE_e;
