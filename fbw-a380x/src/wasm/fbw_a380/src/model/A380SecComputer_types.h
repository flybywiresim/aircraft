...
#ifndef DEFINED_TYPEDEF_FOR_base_sec_adcn_inputs_
#define DEFINED_TYPEDEF_FOR_base_sec_adcn_inputs_

struct base_sec_adcn_inputs
{
  base_eec eec_1;
  base_eec eec_2;
  base_eec eec_3;
...
struct sec_inputs
{
  ...
  base_sec_adcn_inputs adcn_inputs;
};
