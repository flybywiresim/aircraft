...
const prim_outputs A380PrimComputerFctl_rtZprim_outputs{ { { 0.0,
      0.0,
      0.0
    },
...
void A380PrimComputerFctl::A380PrimComputerFctl_MoreThan(boolean_T rtu_In1, boolean_T rtu_In2, boolean_T rtu_In3,
  boolean_T rtu_In4, boolean_T *rty_Out1, uint8_T rtp_moreThan)
{
  *rty_Out1 = (static_cast<int32_T>(((static_cast<uint32_T>(rtu_In1) + rtu_In2) + rtu_In3) + rtu_In4) > rtp_moreThan);
}
...
void A380PrimComputerFctl::A380PrimComputerFctl_PulseRejectNode_Init(rtDW_PulseRejectNode_A380PrimComputerFctl_T
  *localDW, rtP_PulseRejectNode_A380PrimComputerFctl_T *localP)
{
  localDW->Memory_PreviousInput = localP->SRFlipFlop_initial_condition;
}

void A380PrimComputerFctl::A380PrimComputerFctl_PulseRejectNode_Reset(rtDW_PulseRejectNode_A380PrimComputerFctl_T
  *localDW, rtP_PulseRejectNode_A380PrimComputerFctl_T *localP)
{
  localDW->Memory_PreviousInput = localP->SRFlipFlop_initial_condition;
  A380PrimComputerFctl_MATLABFunction_k_Reset(&localDW->sf_MATLABFunction);
  A380PrimComputerFctl_MATLABFunction_k_Reset(&localDW->sf_MATLABFunction_n);
}

void A380PrimComputerFctl::A380PrimComputerFctl_PulseRejectNode(boolean_T rtu_u, real_T rtu_Ts, boolean_T rty_y[2],
  real_T rtp_risingDelay, real_T rtp_fallingDelay, rtDW_PulseRejectNode_A380PrimComputerFctl_T *localDW,
  rtP_PulseRejectNode_A380PrimComputerFctl_T *localP)
{
  uint32_T rowIdx;
  boolean_T rtb_y_bv;
  boolean_T rtb_y_nt;
  A380PrimComputerFctl_MATLABFunction_n(rtu_u, rtu_Ts, localP->ConfirmNode_isRisingEdge, rtp_risingDelay, &rtb_y_nt,
    &localDW->sf_MATLABFunction);
  A380PrimComputerFctl_MATLABFunction_n(!rtu_u, rtu_Ts, localP->ConfirmNode1_isRisingEdge, rtp_fallingDelay, &rtb_y_bv,
    &localDW->sf_MATLABFunction_n);
  rowIdx = (((static_cast<uint32_T>(rtb_y_nt) << 1) + rtb_y_bv) << 1) + localDW->Memory_PreviousInput;
  rty_y[0U] = localP->Logic_table[rowIdx];
  rty_y[1U] = localP->Logic_table[rowIdx + 8U];
  localDW->Memory_PreviousInput = rty_y[0];
}

void A380PrimComputerFctl::A380PrimComputerFctl_CalculateV_alpha_protection(real_T rtu_v_ias, real_T rtu_alpha, real_T
  rtu_alpha_0, real_T rtu_alpha_target, real_T *rty_V_alpha_target)
{
  *rty_V_alpha_target = std::sqrt(std::fmax(std::abs(rtu_alpha - rtu_alpha_0) / (rtu_alpha_target - rtu_alpha_0), 0.0)) *
    rtu_v_ias;
}
...
void A380PrimComputerFctl::A380PrimComputerFctl_MATLABFunction_g(const boolean_T rtu_u[19], real32_T *rty_y)
{
  uint32_T out;
  out = 0U;
...
void A380PrimComputerFctl::A380PrimComputerFctl_MATLABFunction1(a380_efcs_law rtu_law, boolean_T *rty_bit1, boolean_T
  *rty_bit2, boolean_T *rty_bit3)
{
  switch (rtu_law) {
   case a380_efcs_law::None:
    *rty_bit1 = false;
    *rty_bit2 = false;
    *rty_bit3 = false;
    break;

   case a380_efcs_law::NormalLaw:
    *rty_bit1 = false;
    *rty_bit2 = false;
    *rty_bit3 = true;
    break;

   case a380_efcs_law::AlternateLaw1A:
    *rty_bit1 = false;
    *rty_bit2 = true;
    *rty_bit3 = false;
    break;

   case a380_efcs_law::AlternateLaw1B:
    *rty_bit1 = false;
    *rty_bit2 = true;
    *rty_bit3 = true;
    break;

   case a380_efcs_law::AlternateLaw1C:
    *rty_bit1 = true;
    *rty_bit2 = false;
    *rty_bit3 = false;
    break;

   case a380_efcs_law::AlternateLaw2A:
    *rty_bit1 = true;
    *rty_bit2 = false;
    *rty_bit3 = true;
    break;

   case a380_efcs_law::AlternateLaw2B:
    *rty_bit1 = true;
    *rty_bit2 = true;
    *rty_bit3 = false;
    break;
...
void A380PrimComputerFctl::step()
{
  ...
  real_T rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_right_spoiler_8_deg;
  real_T rtb_Gain2;
  real_T rtb_Gain_c;
  real_T rtb_Gain_jw;
  real_T rtb_Sum6;
  ...
  real32_T rtb_Gain4_o;
  real32_T rtb_Gain_go;
  ...
  boolean_T rtb_AND10;
  boolean_T rtb_AND11;
  boolean_T rtb_AND11_b;
  boolean_T rtb_AND11_p;
  boolean_T rtb_AND12;
  boolean_T rtb_AND13;
  boolean_T rtb_AND14;
  ...
  boolean_T rtb_AND_e;
  boolean_T rtb_AND_n;
  boolean_T rtb_DataTypeConversion_ah;
  boolean_T rtb_NOT_k;
  boolean_T rtb_OR1_h;
  boolean_T rtb_OR1_l;
  boolean_T rtb_OR2_o;
  ...
  boolean_T thsAvail;
  a380_efcs_law activeLaw;
  a380_efcs_law rtb_pitchLawCapability;
  if (A380PrimComputerFctl_U.in.data.sim_data.computer_running) {
    if (!A380PrimComputerFctl_DWork.Runtime_MODE) {
      ...
      A380PrimComputerFctl_DWork.Delay_DSTATE_e = A380PrimComputerFctl_P.Delay_InitialCondition_h;
      A380PrimComputerFctl_DWork.Memory_PreviousInput_m = A380PrimComputerFctl_P.SRFlipFlop1_initial_condition_p;
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.DetectChange_vinit;
      A380PrimComputerFctl_DWork.DelayOneStep_DSTATE = A380PrimComputerFctl_P.DelayOneStep_InitialCondition;
      A380PrimComputerFctl_DWork.Memory_PreviousInput_o = A380PrimComputerFctl_P.SRFlipFlop2_initial_condition;
      A380PrimComputerFctl_DWork.Memory_PreviousInput_k = A380PrimComputerFctl_P.SRFlipFlop_initial_condition_f;
      ...
      A380PrimComputerFctl_PulseRejectNode_Reset(&A380PrimComputerFctl_DWork.PulseRejectNode,
        &A380PrimComputerFctl_P.PulseRejectNode);
      A380PrimComputerFctl_PulseRejectNode_Reset(&A380PrimComputerFctl_DWork.PulseRejectNode1,
      ...
      A380PrimComputerFctl_RateLimiter_Reset(&A380PrimComputerFctl_DWork.sf_RateLimiter_gu);
      A380PrimComputerFctl_RateLimiter_Reset(&A380PrimComputerFctl_DWork.sf_RateLimiter_ip);
      A380PrimComputerFctl_MATLABFunction_b_Reset(&A380PrimComputerFctl_DWork.sf_MATLABFunction_c4);
      A380PrimComputerFctl_MATLABFunction_b_Reset(&A380PrimComputerFctl_DWork.sf_MATLABFunction_bw);
      A380PrimComputerFctl_MATLABFunction_b_Reset(&A380PrimComputerFctl_DWork.sf_MATLABFunction_bmt);
      A380PrimComputerFctl_MATLABFunction_b_Reset(&A380PrimComputerFctl_DWork.sf_MATLABFunction_ixk);
      A380PrimComputerFctl_MATLABFunction_b_Reset(&A380PrimComputerFctl_DWork.sf_MATLABFunction_m3);
      A380PrimComputerFctl_MATLABFunction_k_Reset(&A380PrimComputerFctl_DWork.sf_MATLABFunction_im);
      ...
      A380PrimComputerFctl_RateLimiter_a_Reset(&A380PrimComputerFctl_DWork.sf_RateLimiter_i);
      ...
      A380PrimComputerFctl_RateLimiter_a_Reset(&A380PrimComputerFctl_DWork.sf_RateLimiter_g);
    ...
    rtb_OR_jr = (A380PrimComputerFctl_U.in.general_logic.on_ground &&
    ...
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      rtb_OR1_h = A380PrimComputerFctl_U.in.general_logic.is_green_hydraulic_power_avail;
      rtb_OR_i = A380PrimComputerFctl_U.in.general_logic.is_green_hydraulic_power_avail;
      ...
      rtb_OR_i = A380PrimComputerFctl_U.in.general_logic.is_yellow_hydraulic_power_avail;
    } else {
      rtb_OR1_h = false;
      rtb_OR_i = false;
    }
    ...
    A380PrimComputerFctl_MATLABFunction_p(rtb_Switch_i_0, A380PrimComputerFctl_P.BitfromLabel2_bit, &rtb_y_ph);
    A380PrimComputerFctl_MATLABFunction(rtb_Switch_i_0, &rtb_y_la);
    rtb_OR_o = ((rtb_y_ph != 0U) && rtb_y_la);
    A380PrimComputerFctl_MATLABFunction_p(rtb_Switch_i_0, A380PrimComputerFctl_P.BitfromLabel1_bit, &rtb_y_ph);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      rtb_OR1_l = true;
      rtb_OR2_o = true;
    } else if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2) {
      ...
      rtb_OR2_o = A380PrimComputerFctl_U.in.general_logic.is_yellow_hydraulic_power_avail;
    } else {
      rtb_OR1_l = false;
      rtb_OR2_o = false;
    }
    ...
    rtb_OR_b = !rtb_OR_jr;
    rtb_OR_cc = (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_3 || rtb_OR_b);
    rtb_OR_o = (rtb_OR1_l && ((!rtb_OR_o) && rtb_OR_cc));
    rtb_OR_cc = (rtb_OR2_o && (((!rtb_y_la) || (rtb_y_ph == 0U)) && rtb_OR_cc));
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputerFctl_MATLABFunction(rtb_Switch_i_0, &rtb_y_la);
    A380PrimComputerFctl_MATLABFunction_p(rtb_Switch_i_0, A380PrimComputerFctl_P.BitfromLabel1_bit_n, &rtb_y_ph);
    rtb_AND_e = (rtb_y_la && (rtb_y_ph != 0U));
    elevator2Avail = (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1 ||
                      (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2 ||
                       (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_3 &&
                        A380PrimComputerFctl_U.in.general_logic.is_yellow_hydraulic_power_avail)));
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      rtb_DataTypeConversion_ah = ((!rtb_AND_e) && rtb_OR_b);
    } else if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2) {
      rtb_DataTypeConversion_ah = ((!rtb_AND_e) && rtb_OR_b);
    } else {
      rtb_DataTypeConversion_ah = A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_3;
    }

    rtb_AND_e = (elevator2Avail && rtb_DataTypeConversion_ah);
    ...
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel3_bit, &rtb_y_ei);
    ...
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel2_bit_l, &rtb_y_ph);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2) {
      rtb_y_m = (rtb_y_m && (rtb_y_ei != 0U));
    } else {
      rtb_y_m = (rtb_y_la && (rtb_y_ph != 0U));
    }

    rtb_y_la = (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1 ||
                A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      rtb_DataTypeConversion_ah = ((!rtb_y_m) && rtb_OR_b);
    } else {
      rtb_DataTypeConversion_ah = (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2 && ((!rtb_y_m) && rtb_OR_b));
    }

    rtb_y_m = (rtb_y_la && rtb_DataTypeConversion_ah);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.elevator_status_word,
      &rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel1_bit_b, &rtb_y_bl);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      thsAvail = A380PrimComputerFctl_U.in.general_logic.is_yellow_hydraulic_power_avail;
      rtb_DataTypeConversion_ah = ((!rtb_y_d) || (rtb_y_bl == 0U));
    } else {
      thsAvail = ((!A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2) &&
                  (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_3 &&
                   A380PrimComputerFctl_U.in.general_logic.is_green_hydraulic_power_avail));
      rtb_DataTypeConversion_ah = ((!A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2) &&
        A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_3);
    }

    rtb_thsEngaged = (thsAvail && rtb_DataTypeConversion_ah);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel1_bit_k, &rtb_y_ph);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel2_bit_e, &rtb_y_ei);
    ...
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_3) {
      rtb_DataTypeConversion_ah = (rtb_y_ph != 0U);
    } else {
      rtb_DataTypeConversion_ah = (rtb_y_ei != 0U);
    }

    rtb_AND_n = (rtb_DataTypeConversion_ah && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel3_bit_c, &rtb_y_ph);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel4_bit, &rtb_y_ei);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
    ...
    A380PrimComputerFctl_MATLABFunction_p(rtb_Switch_i_0, A380PrimComputerFctl_P.BitfromLabel6_bit, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(rtb_Switch_i_0, &rtb_y_kc);
    rtb_AND6 = ((rtb_y_bl != 0U) && rtb_y_kc);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      rtb_Switch_i_0 = &A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.rudder_status_word;
    } else {
      rtb_Switch_i_0 = &A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.rudder_status_word;
    ...
    A380PrimComputerFctl_MATLABFunction_p(rtb_Switch_i_0, A380PrimComputerFctl_P.BitfromLabel9_bit, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction_p(rtb_Switch_i_0, A380PrimComputerFctl_P.BitfromLabel10_bit, &rtb_y_cf);
    A380PrimComputerFctl_MATLABFunction(rtb_Switch_i_0, &rtb_y_d);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_3) {
      rtb_DataTypeConversion_ah = (rtb_y_bl != 0U);
    } else {
      rtb_DataTypeConversion_ah = (rtb_y_cf != 0U);
    }

    rtb_AND3 = (rtb_DataTypeConversion_ah && rtb_y_d);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      ...
      if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2 ||
        ...
        rtb_AND6 = (rudder1HydraulicModeHasPriority && ((!rtb_NOT_k) || (!rtb_DataTypeConversion_ah)) &&
                    (!rudder1HydraulicModeAvail) && (!rtb_AND6) && (!rtb_AND3) && rtb_OR_b);
      } else {
    ...
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      ...
      rtb_AND4 = ((!rtb_AND2) && (!A380PrimComputerFctl_U.in.general_logic.is_green_hydraulic_power_avail) && (!rtb_AND4)
                  && ((rtb_y_bl == 0U) || (!rtb_y_kc)) && rtb_OR_b);
    } else {
      rudder1HydraulicModeHasPriority = false;
      rtb_AND3 = false;
    ...
    rtb_AND2 = (rudder1HydraulicModeHasPriority && rudder2HydraulicModeHasPriority);
    rudder2HydraulicModeHasPriority = (rtb_AND3 && rtb_AND4);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel_bit, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.aileron_status_word,
      &rtb_y_kc);
    rtb_AND4 = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel1_bit_c, &rtb_y_bl);
    rtb_AND3_bu = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel2_bit_p, &rtb_y_bl);
    rtb_AND2_ac = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel3_bit_n, &rtb_y_bl);
    rtb_AND1_l = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel4_bit_j, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.aileron_status_word,
      &rtb_NOT_k);
    rtb_AND4_n = ((rtb_y_bl != 0U) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel5_bit_i, &rtb_y_bl);
    rtb_AND6_m = ((rtb_y_bl != 0U) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel6_bit_j, &rtb_y_bl);
    rtb_AND7 = ((rtb_y_bl != 0U) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel7_bit_n, &rtb_y_bl);
    rtb_AND8 = ((rtb_y_bl != 0U) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel8_bit_n, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.aileron_status_word,
      &rtb_y_d);
    rtb_AND13 = ((rtb_y_bl != 0U) && rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel9_bit_b, &rtb_y_bl);
    rtb_AND11 = ((rtb_y_bl != 0U) && rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel10_bit_h, &rtb_y_bl);
    rtb_AND10 = ((rtb_y_bl != 0U) && rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel11_bit, &rtb_y_bl);
    rtb_AND9 = ((rtb_y_bl != 0U) && rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel14_bit, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.aileron_status_word,
      &rtb_y_kc);
    rtb_y_d = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel15_bit, &rtb_y_bl);
    rtb_AND16 = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel16_bit, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.aileron_status_word,
      &rtb_NOT_k);
    rtb_AND17 = ((rtb_y_bl != 0U) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.aileron_status_word,
      A380PrimComputerFctl_P.BitfromLabel17_bit, &rtb_y_bl);
    rtb_Logic_k[0] = rtb_AND7;
    rtb_Logic_k[1] = rtb_AND8;
    rtb_Logic_o[0] = rtb_AND13;
    rtb_Logic_o[1] = rtb_AND11;
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      rtb_AND14 = (rtb_OR1_h || rtb_AND2_ac);
      rtb_AND11_b = (rtb_OR_i || rtb_AND1_l);
      rtb_AND2_ac = (rtb_OR_o || rtb_AND4_n);
      rtb_AND1_l = (rtb_OR_cc || rtb_AND6_m);
      rtb_AND4 = (rtb_AND4 || rtb_AND7);
      rtb_AND3_bu = (rtb_AND3_bu || rtb_AND8);
      ...
      rtb_AND14 = (rtb_OR_o || rtb_AND4);
      rtb_AND11_b = (rtb_OR_cc || rtb_AND3_bu);
      rtb_AND2_ac = (rtb_AND2_ac || rtb_AND4_n);
      rtb_AND1_l = (rtb_AND1_l || rtb_AND6_m);
      rtb_AND4 = (rtb_OR1_h || rtb_AND7);
      rtb_AND3_bu = (rtb_OR_i || rtb_AND8);
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.lateral_surface_positions.left_inboard_aileron_deg =
        A380PrimComputerFctl_U.in.data.analog_inputs.left_aileron_2_pos_deg;
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.lateral_surface_positions.right_inboard_aileron_deg =
        A380PrimComputerFctl_U.in.data.analog_inputs.right_aileron_2_pos_deg;
      ...
      rtb_AND14 = (rtb_AND4 || rtb_AND7);
      rtb_AND11_b = (rtb_AND3_bu || rtb_AND8);
      rtb_AND2_ac = (rtb_OR1_h || rtb_AND2_ac);
      rtb_AND1_l = (rtb_OR_i || rtb_AND1_l);
      rtb_AND4 = (rtb_AND4_n || rtb_OR_o);
      rtb_AND3_bu = (rtb_AND6_m || rtb_OR_cc);
      if (A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.left_aileron_1_position_deg.SSM ==
          static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) {
        A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.lateral_surface_positions.left_inboard_aileron_deg =
          A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.left_aileron_1_position_deg.Data;
    ...
    rtb_AND6_m = (rtb_AND14 || (rtb_AND13 || rtb_y_d));
    rtb_AND11 = (rtb_AND11_b || (rtb_AND11 || rtb_AND16));
    rtb_AND10 = (rtb_AND2_ac || (rtb_AND10 || rtb_AND17));
    rtb_AND9 = (rtb_AND1_l || (rtb_AND9 || ((rtb_y_bl != 0U) && rtb_NOT_k)));
    ...
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel1_bit_g, &rtb_y_bl);
    rtb_y_nz = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel2_bit_pc, &rtb_y_bl);
    rtb_AND13 = (rtb_y_d && (rtb_y_nz || (rtb_y_bl != 0U)));
    ...
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel1_bit_i, &rtb_y_bl);
    rtb_y_kc = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel2_bit_n, &rtb_y_bl);
    rtb_AND17 = (rtb_y_d && (rtb_y_kc || (rtb_y_bl != 0U)));
    ...
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel1_bit_nd, &rtb_y_bl);
    rtb_y_nz = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel2_bit_d, &rtb_y_bl);
    rtb_AND4_n = (rtb_y_d && (rtb_y_nz || (rtb_y_bl != 0U)));
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel8_bit_l, &rtb_y_bl);
    rtb_y_nz = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel9_bit_g, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.spoiler_status_word,
      &rtb_NOT_k);
    rtb_AND16 = ((rtb_y_nz || (rtb_y_bl != 0U)) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel10_bit_j, &rtb_y_bl);
    rtb_y_kc = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel11_bit_j, &rtb_y_bl);
    rtb_AND11_b = ((rtb_y_kc || (rtb_y_bl != 0U)) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel14_bit_p, &rtb_y_bl);
    rtb_y_kc = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel15_bit_i, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.spoiler_status_word,
      &rtb_y_d);
    rtb_AND8 = ((rtb_y_kc || (rtb_y_bl != 0U)) && rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel12_bit, &rtb_y_bl);
    rtb_y_kc = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel13_bit, &rtb_y_bl);
    rtb_y_d = ((rtb_y_kc || (rtb_y_bl != 0U)) && rtb_y_d);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      rtb_AND7 = (rtb_AND8 || rtb_y_d);
      rtb_AND8 = (rtb_AND16 || rtb_AND11_b);
      rtb_AND16 = (rtb_leftSpoilerHydraulicModeEngaged || rtb_leftSpoilerElectricModeEngaged ||
    ...
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.spoiler_status_word,
      &rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel1_bit_l, &rtb_y_bl);
    rtb_y_kc = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel2_bit_f, &rtb_y_bl);
    rtb_AND11_b = (rtb_y_d && (rtb_y_kc || (rtb_y_bl != 0U)));
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.spoiler_status_word,
      &rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel1_bit_p, &rtb_y_bl);
    rtb_y_nz = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.spoiler_status_word,
      A380PrimComputerFctl_P.BitfromLabel2_bit_b, &rtb_y_bl);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
    ...
    rtb_AND2_ac = (rtb_y_d && (rtb_y_nz || (rtb_y_bl != 0U)));
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel16_bit_b, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.elevator_status_word,
      &rtb_NOT_k);
    rtb_AND1_l = ((rtb_y_bl != 0U) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel17_bit_i, &rtb_y_bl);
    rtb_AND15_l = ((rtb_y_bl != 0U) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel18_bit, &rtb_y_bl);
    rtb_AND14 = ((rtb_y_bl != 0U) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel19_bit, &rtb_y_bl);
    rtb_AND12 = ((rtb_y_bl != 0U) && rtb_NOT_k);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel20_bit, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.elevator_status_word,
      &rtb_y_kc);
    rtb_AND16_n = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel21_bit, &rtb_y_bl);
    rtb_AND18_c = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel22_bit, &rtb_y_bl);
    rtb_AND19 = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.elevator_status_word,
       A380PrimComputerFctl_P.BitfromLabel23_bit, &rtb_y_bl);
    rtb_AND20 = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel1_bit_lr, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.elevator_status_word,
      &rtb_y_kc);
    rtb_AND5_e = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel2_bit_g, &rtb_y_bl);
    rtb_AND3_k = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel3_bit_k, &rtb_y_bl);
    rtb_NOT_k = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel4_bit_n, &rtb_y_bl);
    rtb_y_kc = ((rtb_y_bl != 0U) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel5_bit_e, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.elevator_status_word,
      &rtb_DataTypeConversion_ah);
    rtb_AND4_d = ((rtb_y_bl != 0U) && rtb_DataTypeConversion_ah);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel6_bit_b, &rtb_y_bl);
    rtb_AND6_b = ((rtb_y_bl != 0U) && rtb_DataTypeConversion_ah);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel7_bit_p, &rtb_y_bl);
    rtb_DataTypeConversion_ah = ((rtb_y_bl != 0U) && rtb_DataTypeConversion_ah);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel8_bit_d, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.elevator_status_word,
      &rtb_y_d);
    rtb_AND11_p = ((rtb_y_bl != 0U) && rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel9_bit_e, &rtb_y_bl);
    rtb_y_nz = ((rtb_y_bl != 0U) && rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.elevator_status_word,
      A380PrimComputerFctl_P.BitfromLabel11_bit_n, &rtb_y_bl);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      leftInboardElevEngaged = (rtb_AND_e || rtb_AND16_n);
      rtb_AND19 = (rtb_AND18_c || rtb_AND14);
      rtb_AND15_l = (elevator1Avail || rtb_AND15_l);
      rtb_AND16_n = (rtb_AND1_l || rtb_y_m);
      ...
      rtb_Switch1_d = A380PrimComputerFctl_U.in.data.analog_inputs.ths_pos_deg;
    } else if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2) {
      leftInboardElevEngaged = (rtb_AND16_n || rtb_AND15_l);
      rtb_AND19 = (rtb_y_m || rtb_AND18_c);
      rtb_AND15_l = (rtb_AND_e || rtb_AND1_l);
      rtb_AND16_n = (elevator1Avail || rtb_AND14);
      ...
      if (A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.ths_position_deg.SSM == static_cast<uint32_T>
          (SignStatusMatrix::NormalOperation)) {
        rtb_Switch1_d = A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.ths_position_deg.Data;
      } else {
        rtb_Switch1_d = A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.ths_position_deg.Data;
      }
    } else if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_3) {
      leftInboardElevEngaged = (elevator1Avail || rtb_AND15_l);
      rtb_AND19 = (rtb_AND_e || rtb_AND19);
      rtb_AND15_l = (rtb_AND1_l || rtb_AND18_c);
      rtb_AND16_n = (rtb_AND16_n || rtb_AND14);
    ...
    rtb_AND1_l = (leftInboardElevEngaged || (rtb_AND11_p || rtb_AND3_k));
    rtb_AND14 = (rtb_AND19 || (rtb_y_nz || rtb_DataTypeConversion_ah));
    rtb_AND5_e = (rtb_AND15_l || (rtb_AND5_e || rtb_AND6_b));
    rtb_AND4_d = (rtb_AND16_n || (rtb_AND4_d || rtb_NOT_k));
    rtb_AND6_b = (rtb_AND12 || (((rtb_y_bl != 0U) && rtb_y_d) || rtb_y_kc));
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel38_bit, &rtb_y_bl);
    rtb_NOT_k = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel39_bit, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.rudder_status_word,
      &rtb_y_d);
    rtb_AND12 = ((rtb_NOT_k || (rtb_y_bl != 0U)) && rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel32_bit, &rtb_y_bl);
    rtb_NOT_k = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel33_bit, &rtb_y_bl);
    rtb_AND3_k = ((rtb_NOT_k || (rtb_y_bl != 0U)) && rtb_y_d);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel36_bit, &rtb_y_bl);
    rtb_NOT_k = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel37_bit, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_y_bus.fctl.rudder_status_word,
      &rtb_y_kc);
    rtb_AND20 = ((rtb_NOT_k || (rtb_y_bl != 0U)) && rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel3_bit_m, &rtb_y_bl);
    rtb_NOT_k = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel4_bit_b, &rtb_y_bl);
    rtb_AND15_l = (rtb_NOT_k || (rtb_y_bl != 0U));
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.rudder_status_word,
      &rtb_y_nz);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel1_bit_pt, &rtb_y_bl);
    rtb_NOT_k = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_1_bus.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel2_bit_h, &rtb_y_bl);
    rtb_y_d = (rtb_NOT_k || (rtb_y_bl != 0U));
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel5_bit_d, &rtb_y_bl);
    rtb_NOT_k = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel6_bit_p, &rtb_y_bl);
    rtb_AND16_n = (rtb_NOT_k || (rtb_y_bl != 0U));
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_2_bus.rudder_status_word,
      &rtb_DataTypeConversion_ah);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel7_bit_g, &rtb_y_bl);
    rtb_NOT_k = (rtb_y_bl != 0U);
    A380PrimComputerFctl_MATLABFunction_p(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.rudder_status_word,
      A380PrimComputerFctl_P.BitfromLabel8_bit_i, &rtb_y_bl);
    rtb_y_kc = (rtb_NOT_k || (rtb_y_bl != 0U));
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.sec_3_bus.rudder_status_word,
      &rtb_NOT_k);
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      rtb_AND12 = (rtb_AND_n || rtb_AND6 || rtb_AND12);
      rtb_AND20 = (rtb_AND2 || rudder2HydraulicModeHasPriority || rtb_AND20);
      ...
      rtb_AND12 = (rtb_AND_n || rtb_AND6 || rtb_AND12);
      rtb_AND20 = (rtb_AND3_k || rtb_AND20);
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.lateral_surface_positions.upper_rudder_deg =
        A380PrimComputerFctl_U.in.data.analog_inputs.rudder_1_pos_deg;
      ...
      rtb_AND12 = (rtb_AND12 || rtb_AND20);
      rtb_AND20 = (rtb_AND_n || rtb_AND6 || rtb_AND3_k);
    ...
    rtb_AND3_k = (rtb_AND12 || (rtb_AND15_l && rtb_y_nz) || (rtb_AND16_n && rtb_DataTypeConversion_ah));
    rtb_AND15_l = (rtb_AND20 || (rtb_y_d && rtb_y_nz) || (rtb_y_kc && rtb_NOT_k));
    ...
    rtb_AND20 = (A380PrimComputerFctl_U.in.general_logic.all_ra_failure &&
    ...
    if (A380PrimComputerFctl_U.in.fg_mode_logic.land_3_fail_op_capability) {
      c_nz = 3;
    } else if (A380PrimComputerFctl_U.in.fg_mode_logic.land_3_fail_passive_capability) {
      c_nz = 2;
    } else {
    ...
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.fctl_law_status_word,
       A380PrimComputerFctl_P.BitfromLabel6_bit_h, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction_p
    ...
    if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_1) {
      rtb_AND18_c = (rtb_OR_b && rtb_y_d);
    } else if (A380PrimComputerFctl_U.in.data.discrete_inputs.is_unit_2) {
      rtb_AND18_c = ((rtb_y_bl == 0U) && rtb_y_d);
    } else {
      rtb_AND18_c = ((rtb_y_bl == 0U) && (rtb_y_ph == 0U));
    }

    if (!rtb_AND18_c) {
      activeLaw = a380_efcs_law::None;
    } else {
      activeLaw = rtb_pitchLawCapability;
    }

    A380PrimComputerFctl_MATLABFunction_f(A380PrimComputerFctl_U.in.data.discrete_inputs.capt_priority_takeover_pressed,
      A380PrimComputerFctl_P.PulseNode_isRisingEdge, &rtb_y_d, &A380PrimComputerFctl_DWork.sf_MATLABFunction_g4);
    A380PrimComputerFctl_MATLABFunction_f(A380PrimComputerFctl_U.in.data.discrete_inputs.fo_priority_takeover_pressed,
      A380PrimComputerFctl_P.PulseNode1_isRisingEdge, &rtb_y_kc, &A380PrimComputerFctl_DWork.sf_MATLABFunction_nu);
    if (rtb_y_d) {
    ...
    A380PrimComputerFctl_MATLABFunction_n((A380PrimComputerFctl_DWork.pLeftStickDisabled &&
      ...
      A380PrimComputerFctl_P.ConfirmNode1_isRisingEdge, A380PrimComputerFctl_P.ConfirmNode1_timeDelay, &rtb_OR_b,
    ...
    A380PrimComputerFctl_MATLABFunction_n((A380PrimComputerFctl_DWork.pRightStickDisabled &&
      ...
      A380PrimComputerFctl_P.ConfirmNode_isRisingEdge_j, A380PrimComputerFctl_P.ConfirmNode_timeDelay_a, &rtb_AND12,
      &A380PrimComputerFctl_DWork.sf_MATLABFunction_g2);
    if (!A380PrimComputerFctl_DWork.pRightStickDisabled) {
      rtb_Switch11_a = A380PrimComputerFctl_U.in.data.analog_inputs.fo_pitch_stick_pos;
    } else {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant_Value_p;
    }
    ...
    rtb_left_spoiler_3_deg = rtb_Switch11_a + rtb_Y_k;
    ...
    if (!A380PrimComputerFctl_DWork.pRightStickDisabled) {
      rtb_Switch11_a = A380PrimComputerFctl_U.in.data.analog_inputs.fo_roll_stick_pos;
    } else {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant1_Value_p;
    }
    ...
    rtb_right_spoiler_2_deg = rtb_Switch11_a + rtb_Y_k;
    ...
    rtb_Switch_nb = look2_binlxpw(A380PrimComputerFctl_U.in.general_logic.adr_computation_data.mach, static_cast<real_T>
      (A380PrimComputerFctl_U.in.general_logic.flap_handle_index), A380PrimComputerFctl_P.alphamax_bp01Data,
      A380PrimComputerFctl_P.alphamax_bp02Data, A380PrimComputerFctl_P.alphamax_tableData,
      A380PrimComputerFctl_P.alphamax_maxIndex, 4U);
    if (rtb_Switch_nb > A380PrimComputerFctl_P.Saturation2_UpperSat) {
      rtb_Switch_nb = A380PrimComputerFctl_P.Saturation2_UpperSat;
    } else if (rtb_Switch_nb < A380PrimComputerFctl_P.Saturation2_LowerSat) {
      rtb_Switch_nb = A380PrimComputerFctl_P.Saturation2_LowerSat;
    }

    A380PrimComputerFctl_RateLimiter_l(rtb_Switch_nb, A380PrimComputerFctl_P.RateLimiterGenericVariableTs_up,
      A380PrimComputerFctl_P.RateLimiterGenericVariableTs_lo, A380PrimComputerFctl_U.in.data.time.dt,
      A380PrimComputerFctl_P.reset_Value, &rtb_handleIndex, &A380PrimComputerFctl_DWork.sf_RateLimiter_ne);
    ...
    rtb_Switch_nb = look2_binlxpw(A380PrimComputerFctl_U.in.general_logic.adr_computation_data.mach, static_cast<real_T>
      (A380PrimComputerFctl_U.in.general_logic.flap_handle_index), A380PrimComputerFctl_P.alphaprotection_bp01Data,
      A380PrimComputerFctl_P.alphaprotection_bp02Data, A380PrimComputerFctl_P.alphaprotection_tableData,
      A380PrimComputerFctl_P.alphaprotection_maxIndex, 4U);
    if (rtb_Switch_nb > A380PrimComputerFctl_P.Saturation1_UpperSat_i) {
      rtb_Switch_nb = A380PrimComputerFctl_P.Saturation1_UpperSat_i;
    } else if (rtb_Switch_nb < A380PrimComputerFctl_P.Saturation1_LowerSat_k) {
      rtb_Switch_nb = A380PrimComputerFctl_P.Saturation1_LowerSat_k;
    }

    A380PrimComputerFctl_RateLimiter_l(rtb_Switch_nb, A380PrimComputerFctl_P.RateLimiterGenericVariableTs1_up,
      A380PrimComputerFctl_P.RateLimiterGenericVariableTs1_lo, A380PrimComputerFctl_U.in.data.time.dt,
      A380PrimComputerFctl_P.reset_Value_j, &rtb_Gain_c, &A380PrimComputerFctl_DWork.sf_RateLimiter_mr);
    ...
    A380PrimComputerFctl_CalculateV_alpha_protection
      (A380PrimComputerFctl_U.in.general_logic.adr_computation_data.V_ias_kn,
       A380PrimComputerFctl_U.in.general_logic.adr_computation_data.alpha_deg, rtb_Y, rtb_Gain_c,
    ...
    A380PrimComputerFctl_RateLimiter_l(look2_binlxpw(A380PrimComputerFctl_U.in.general_logic.adr_computation_data.mach,
      ...
      A380PrimComputerFctl_U.in.data.time.dt, A380PrimComputerFctl_P.reset_Value_g, &rtb_Gain_c,
    ...
    A380PrimComputerFctl_GetIASforMach4(A380PrimComputerFctl_U.in.general_logic.adr_computation_data.mach,
      ...
      &rtb_Gain_c);
    rtb_Y_k = std::fmin(A380PrimComputerFctl_P.Constant5_Value_k, rtb_Gain_c);
    A380PrimComputerFctl_GetIASforMach4(A380PrimComputerFctl_U.in.general_logic.adr_computation_data.mach,
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.high_speed_prot_hi_thresh_kn = std::fmin
      (A380PrimComputerFctl_P.Constant7_Value_g, rtb_Gain_c);
    ...
    rtb_AND11_p = ((activeLaw == a380_efcs_law::NormalLaw) || (activeLaw == a380_efcs_law::AlternateLaw1A));
    rtb_DataTypeConversion_ah = ((!A380PrimComputerFctl_U.in.fg_logic.ap_1_engaged) &&
      (!A380PrimComputerFctl_U.in.fg_logic.ap_2_engaged));
    if (rtb_DataTypeConversion_ah && (A380PrimComputerFctl_U.in.general_logic.adr_computation_data.V_ias_kn > std::fmin
         (look1_binlxpw(rtb_Switch_nb, A380PrimComputerFctl_P.uDLookupTable1_bp01Data,
      ...
      A380PrimComputerFctl_DWork.sProtActive = (rtb_AND11_p || A380PrimComputerFctl_DWork.sProtActive);
    }

    A380PrimComputerFctl_DWork.sProtActive = ((A380PrimComputerFctl_U.in.general_logic.adr_computation_data.V_ias_kn >=
      rtb_Y_k) && rtb_DataTypeConversion_ah && rtb_AND11_p && A380PrimComputerFctl_DWork.sProtActive);
    ...
    A380PrimComputerFctl_DWork.sProtActive_g = (((!A380PrimComputerFctl_U.in.general_logic.on_ground) && rtb_AND11_p &&
    ...
    A380PrimComputerFctl_DWork.sProtActive_g = ((A380PrimComputerFctl_U.in.data.time.simulation_time -
      ...
      (!A380PrimComputerFctl_U.in.general_logic.on_ground) && rtb_AND11_p && A380PrimComputerFctl_DWork.sProtActive_g);
    ...
    if ((A380PrimComputerFctl_U.in.general_logic.adr_computation_data.V_ias_kn <= std::fmin(365.0,
          ...
          A380PrimComputerFctl_U.in.general_logic.adr_computation_data.mach * (look1_binlxpw(rtb_Switch_nb,
           ...
           0.01))) || ((activeLaw != a380_efcs_law::NormalLaw) && (activeLaw != a380_efcs_law::AlternateLaw1A)) ||
        (A380PrimComputerFctl_DWork.eventTime == 0.0)) {
      A380PrimComputerFctl_DWork.eventTime = A380PrimComputerFctl_U.in.data.time.simulation_time;
    }
    ...
    rtb_NOT_k = (((!A380PrimComputerFctl_U.in.general_logic.on_ground) && (((nz != 0) &&
      ...
      (A380PrimComputerFctl_U.in.general_logic.adr_computation_data.alpha_deg > rtb_Sum6 + 0.25)) && rtb_AND11_p) ||
    ...
    A380PrimComputerFctl_MATLABFunction_n((A380PrimComputerFctl_U.in.data.analog_inputs.speed_brake_lever_pos <
      ...
      A380PrimComputerFctl_P.ConfirmNode_isRisingEdge_c, A380PrimComputerFctl_P.ConfirmNode_timeDelay_g, &rtb_y_kc,
    ...
    A380PrimComputerFctl_DWork.Memory_PreviousInput = A380PrimComputerFctl_P.Logic_table[(((static_cast<uint32_T>
      (rtb_NOT_k) << 1) + rtb_y_kc) << 1) + A380PrimComputerFctl_DWork.Memory_PreviousInput];
    ...
    A380PrimComputerFctl_RateLimiter_d(rtb_Switch_nb, A380PrimComputerFctl_P.RateLimiterGenericVariableTs24_up,
      ...
      &rtb_Gain_c, &A380PrimComputerFctl_DWork.sf_RateLimiter_nd);
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.speed_brake_inhibited = rtb_NOT_k;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.speed_brake_command_deg = rtb_Gain_c;
    A380PrimComputerFctl_MATLABFunction_f(A380PrimComputerFctl_U.in.general_logic.on_ground,
      A380PrimComputerFctl_P.PulseNode7_isRisingEdge, &rtb_y_d, &A380PrimComputerFctl_DWork.sf_MATLABFunction_ny);
    A380PrimComputerFctl_MATLABFunction_f(A380PrimComputerFctl_U.in.general_logic.on_ground,
      A380PrimComputerFctl_P.PulseNode6_isRisingEdge, &rtb_NOT_k, &A380PrimComputerFctl_DWork.sf_MATLABFunction_gc);
    A380PrimComputerFctl_DWork.Memory_PreviousInput_a = A380PrimComputerFctl_P.Logic_table_h[(((static_cast<uint32_T>
      (rtb_y_d || (((A380PrimComputerFctl_U.in.data.analog_inputs.left_body_wheel_speed <
                   ...
                   ((A380PrimComputerFctl_U.in.data.analog_inputs.right_body_wheel_speed <
                    ...
                    (A380PrimComputerFctl_U.in.data.analog_inputs.right_wing_wheel_speed <
                     A380PrimComputerFctl_P.CompareToConstant14_const)))) << 1) + rtb_NOT_k) << 1) +
    ...
    A380PrimComputerFctl_MoreThan((A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_1_pos <
      A380PrimComputerFctl_P.CompareToConstant11_const), (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_2_pos <
      A380PrimComputerFctl_P.CompareToConstant19_const), (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_3_pos <
      A380PrimComputerFctl_P.CompareToConstant20_const), (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_4_pos <
      A380PrimComputerFctl_P.CompareToConstant21_const), &rtb_y_d, A380PrimComputerFctl_P.MoreThan1_moreThan);
    rtb_y_kc = (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_2_pos <
                A380PrimComputerFctl_P.CompareToConstant12_const);
    rtb_DataTypeConversion_ah = (rtb_y_kc || (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_3_pos <
      A380PrimComputerFctl_P.CompareToConstant15_const));
    A380PrimComputerFctl_MoreThan((A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_1_pos <=
      A380PrimComputerFctl_P.CompareToConstant29_const), (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_2_pos <=
      A380PrimComputerFctl_P.CompareToConstant16_const), (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_3_pos <=
      A380PrimComputerFctl_P.CompareToConstant17_const), (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_4_pos <=
      A380PrimComputerFctl_P.CompareToConstant18_const), &rtb_y_kc, A380PrimComputerFctl_P.MoreThan_moreThan);
    rtb_y_kc = ((((A380PrimComputerFctl_U.in.data.analog_inputs.speed_brake_lever_pos >
                   A380PrimComputerFctl_P.CompareToConstant26_const) || rtb_NOT_k) && rtb_y_d) ||
                (rtb_DataTypeConversion_ah && rtb_y_kc));
    A380PrimComputerFctl_MATLABFunction_f(false, A380PrimComputerFctl_P.PulseNode5_isRisingEdge, &rtb_y_d,
      &A380PrimComputerFctl_DWork.sf_MATLABFunction_m1);
    rtb_y_nz = (A380PrimComputerFctl_U.in.data.analog_inputs.right_wing_wheel_speed >=
                A380PrimComputerFctl_P.CompareToConstant4_const_k);
    rtb_DataTypeConversion_ah = (((A380PrimComputerFctl_U.in.data.analog_inputs.left_body_wheel_speed >=
      A380PrimComputerFctl_P.CompareToConstant7_const) ||
      (A380PrimComputerFctl_U.in.data.analog_inputs.left_wing_wheel_speed >=
       A380PrimComputerFctl_P.CompareToConstant8_const)) &&
      ((A380PrimComputerFctl_U.in.data.analog_inputs.right_body_wheel_speed >=
        A380PrimComputerFctl_P.CompareToConstant3_const_n) || rtb_y_nz) &&
      A380PrimComputerFctl_DWork.Memory_PreviousInput_a);
    A380PrimComputerFctl_DWork.Delay1_DSTATE_b = (rtb_y_kc && (rtb_y_d || rtb_DataTypeConversion_ah ||
    ...
    A380PrimComputerFctl_MATLABFunction_f(false, A380PrimComputerFctl_P.PulseNode4_isRisingEdge,
      &rtb_DataTypeConversion_ah, &A380PrimComputerFctl_DWork.sf_MATLABFunction_ff);
    A380PrimComputerFctl_DWork.Delay2_DSTATE = (rtb_y_kc && (rtb_DataTypeConversion_ah ||
    ...
    A380PrimComputerFctl_DWork.Delay3_DSTATE = (rtb_NOT_k &&
      ((A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_1_pos <=
       ...
       (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_2_pos <=
        A380PrimComputerFctl_P.CompareToConstant2_const_k)) && (rtb_y_d || A380PrimComputerFctl_DWork.Delay3_DSTATE));
    rtb_y_kc = ((!A380PrimComputerFctl_DWork.Delay1_DSTATE_b) && (A380PrimComputerFctl_DWork.Delay2_DSTATE ||
      A380PrimComputerFctl_DWork.Delay3_DSTATE));
    if (rtb_y_kc) {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant5_Value;
    } else {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant6_Value;
    }

    A380PrimComputerFctl_RateLimiter(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterVariableTs4_up,
      A380PrimComputerFctl_P.RateLimiterVariableTs4_lo, A380PrimComputerFctl_U.in.data.time.dt,
      A380PrimComputerFctl_P.RateLimiterVariableTs4_InitialCondition, &rtb_Gain_c,
      &A380PrimComputerFctl_DWork.sf_RateLimiter_gu);
    if (A380PrimComputerFctl_DWork.Delay1_DSTATE_b) {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant_Value;
    } else {
      rtb_Switch11_a = rtb_Gain_c;
    }

    A380PrimComputerFctl_RateLimiter(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterVariableTs6_up,
      A380PrimComputerFctl_P.RateLimiterVariableTs6_lo, A380PrimComputerFctl_U.in.data.time.dt,
      A380PrimComputerFctl_P.RateLimiterVariableTs6_InitialCondition, &rtb_Gain_c,
      &A380PrimComputerFctl_DWork.sf_RateLimiter_ip);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
       A380PrimComputerFctl_P.BitfromLabel_bit_l, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_y_nz);
    rtb_DataTypeConversion_ah = ((rtb_y_bl == 0U) && rtb_y_nz);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
       A380PrimComputerFctl_P.BitfromLabel1_bit_cm, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word, &rtb_y_d);
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.spoiler_lift_active =
      (A380PrimComputerFctl_U.in.general_logic.on_ground && (rtb_DataTypeConversion_ah || ((rtb_y_bl == 0U) && rtb_y_d)));
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ground_spoilers_armed = rtb_NOT_k;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.phased_lift_dumping_active = rtb_y_kc;
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
       A380PrimComputerFctl_P.BitfromLabel_bit_e, &rtb_y_bl);
    rtb_DataTypeConversion_ah = (rtb_y_bl == 0U);
    A380PrimComputerFctl_MATLABFunction
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_y_kc);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
       A380PrimComputerFctl_P.BitfromLabel1_bit_d, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word, &rtb_y_d);
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.aileron_droop_active = ((rtb_DataTypeConversion_ah && rtb_y_kc) ||
      ((rtb_y_bl == 0U) && rtb_y_d));
    A380PrimComputerFctl_MATLABFunction_f(A380PrimComputerFctl_U.in.general_logic.on_ground,
      A380PrimComputerFctl_P.PulseNode1_isRisingEdge_a, &rtb_y_kc, &A380PrimComputerFctl_DWork.sf_MATLABFunction_c4);
    A380PrimComputerFctl_MATLABFunction_f(A380PrimComputerFctl_U.in.general_logic.on_ground,
      A380PrimComputerFctl_P.PulseNode2_isRisingEdge, &rtb_DataTypeConversion_ah,
      &A380PrimComputerFctl_DWork.sf_MATLABFunction_bw);
    leftInboardElevEngaged = !rtb_thsEngaged;
    A380PrimComputerFctl_DWork.Memory_PreviousInput_m = A380PrimComputerFctl_P.Logic_table_p
      [(((rtb_DataTypeConversion_ah || A380PrimComputerFctl_DWork.Delay_DSTATE_e || leftInboardElevEngaged) + (
          static_cast<uint32_T>(rtb_y_kc) << 1)) << 1) + A380PrimComputerFctl_DWork.Memory_PreviousInput_m];
    A380PrimComputerFctl_MATLABFunction_f(rtb_NOT_k, A380PrimComputerFctl_P.PulseNode4_isRisingEdge_j,
      &rtb_DataTypeConversion_ah, &A380PrimComputerFctl_DWork.sf_MATLABFunction_bmt);
    A380PrimComputerFctl_MATLABFunction_f((A380PrimComputerFctl_U.in.general_logic.engine_running &&
      (A380PrimComputerFctl_U.in.general_logic.is_green_hydraulic_power_avail ||
       A380PrimComputerFctl_U.in.general_logic.is_yellow_hydraulic_power_avail)),
      A380PrimComputerFctl_P.PulseNode3_isRisingEdge, &rtb_y_nz, &A380PrimComputerFctl_DWork.sf_MATLABFunction_ixk);
    rtb_y_kc = (A380PrimComputerFctl_U.in.general_logic.adr_computation_data.V_ias_kn >
                A380PrimComputerFctl_P.CompareToConstant2_const_i);
    rtb_y_d = ((rtb_DataTypeConversion_ah || rtb_y_nz) && (!rtb_y_kc));
    rtb_DataTypeConversion_ah = (A380PrimComputerFctl_U.in.general_logic.flap_handle_index !=
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE);
    A380PrimComputerFctl_MoreThan((A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_1_pos >
      A380PrimComputerFctl_P.CompareToConstant10_const_k), (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_2_pos
      > A380PrimComputerFctl_P.CompareToConstant3_const_k),
      (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_3_pos > A380PrimComputerFctl_P.CompareToConstant4_const_j),
      (A380PrimComputerFctl_U.in.data.analog_inputs.thr_lever_4_pos > A380PrimComputerFctl_P.CompareToConstant5_const),
      &rtb_y_nz, A380PrimComputerFctl_P.MoreThan_moreThan_p);
    A380PrimComputerFctl_MATLABFunction_f((rtb_DataTypeConversion_ah || (!rtb_NOT_k) || rtb_y_nz),
      A380PrimComputerFctl_P.PulseNode5_isRisingEdge_g, &rtb_DataTypeConversion_ah,
      &A380PrimComputerFctl_DWork.sf_MATLABFunction_m3);
    rtb_NOT_k = (rtb_y_kc && rtb_DataTypeConversion_ah);
    A380PrimComputerFctl_MATLABFunction_n(A380PrimComputerFctl_U.in.general_logic.on_ground,
      A380PrimComputerFctl_U.in.data.time.dt, A380PrimComputerFctl_P.ConfirmNode_isRisingEdge_ju,
      A380PrimComputerFctl_P.ConfirmNode_timeDelay_m, &rtb_y_kc, &A380PrimComputerFctl_DWork.sf_MATLABFunction_im);
    rtb_y_kc = ((rtb_y_d || rtb_NOT_k) && rtb_y_kc);
    A380PrimComputerFctl_DWork.DelayOneStep_DSTATE = A380PrimComputerFctl_P.Logic_table_k[((((!rtb_y_kc) &&
      (!A380PrimComputerFctl_DWork.Delay_DSTATE_e) && A380PrimComputerFctl_DWork.DelayOneStep_DSTATE) +
      (static_cast<uint32_T>(rtb_y_kc) << 1)) << 1) + A380PrimComputerFctl_DWork.Memory_PreviousInput_o];
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.fctl_law_status_word,
       A380PrimComputerFctl_P.BitfromLabel2_bit_pt, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction(&A380PrimComputerFctl_U.in.data.bus_inputs.prim_x_bus.fctl.fctl_law_status_word,
      &rtb_DataTypeConversion_ah);
    if ((rtb_y_bl != 0U) && rtb_DataTypeConversion_ah) {
    ...
    A380PrimComputerFctl_MATLABFunction_p(rtb_Switch_i_0, A380PrimComputerFctl_P.BitfromLabel3_bit_g, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction_c(rtb_Switch_i_0, &rtb_y_d);
    if (rtb_AND18_c) {
      rtb_y_kc = ((!A380PrimComputerFctl_U.in.general_logic.on_ground) && (activeLaw !=
        A380PrimComputerFctl_P.EnumeratedConstant4_Value) && (!rtb_AND20));
    } else {
      rtb_y_kc = ((rtb_y_bl != 0U) && rtb_y_d);
    }

    if (A380PrimComputerFctl_DWork.DelayOneStep_DSTATE) {
      rtb_Switch_nb = look1_binlcpw(A380PrimComputerFctl_U.in.flight_envelope.computed_gross_weight_cg_percent,
        A380PrimComputerFctl_P.uDLookupTable_bp01Data_p, A380PrimComputerFctl_P.uDLookupTable_tableData_a, 2U);
    } else {
      rtb_Switch_nb = A380PrimComputerFctl_P.Constant_Value_k;
    }

    rtb_Switch_nb = rtb_Switch1_d - rtb_Switch_nb;
    A380PrimComputerFctl_DWork.Delay_DSTATE_e = A380PrimComputerFctl_P.Logic_table_d[(((rtb_y_kc || (std::abs
      (rtb_Switch_nb) <= A380PrimComputerFctl_P.CompareToConstant1_const_c) || leftInboardElevEngaged ||
      A380PrimComputerFctl_U.in.data.discrete_inputs.pitch_trim_down_pressed ||
      A380PrimComputerFctl_U.in.data.discrete_inputs.pitch_trim_up_pressed) + (static_cast<uint32_T>
      (A380PrimComputerFctl_DWork.DelayOneStep_DSTATE ||
       ((A380PrimComputerFctl_U.in.general_logic.adr_computation_data.V_ias_kn <=
         A380PrimComputerFctl_P.CompareToConstant_const_d) && A380PrimComputerFctl_DWork.Memory_PreviousInput_m)) << 1))
      << 1) + A380PrimComputerFctl_DWork.Memory_PreviousInput_k];
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
       A380PrimComputerFctl_P.BitfromLabel4_bit_a, &rtb_y_ph);
    rtb_NOT_k = (rtb_y_ph != 0U);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
       A380PrimComputerFctl_P.BitfromLabel_bit_h, &rtb_y_ph);
    A380PrimComputerFctl_MATLABFunction
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_y_nz);
    rtb_y_d = (((!rtb_NOT_k) || (rtb_y_ph == 0U)) && rtb_y_nz);
    A380PrimComputerFctl_MATLABFunction
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_y_nz);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
       A380PrimComputerFctl_P.BitfromLabel6_bit_m, &rtb_y_ph);
    rtb_NOT_k = (rtb_y_ph != 0U);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_U.in.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
       A380PrimComputerFctl_P.BitfromLabel5_bit_o, &rtb_y_ph);
    if (rtb_y_d || (rtb_y_nz && ((!rtb_NOT_k) || (rtb_y_ph == 0U)))) {
      abs_rate_c = 0.25;
    } else {
      abs_rate_c = 0.15;
    }
    ...
    if (A380PrimComputerFctl_DWork.Delay_DSTATE_e) {
      rtb_Switch_nb *= A380PrimComputerFctl_P.Gain_Gain_e;
      ...
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ths_manual_mode_c_deg_s = abs_rate_c;
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.left_outboard_aileron_engaged = rtb_AND4;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.right_outboard_aileron_engaged = rtb_AND3_bu;
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.spoiler_pair_4_engaged = rtb_AND7;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.spoiler_pair_5_engaged = rtb_AND8;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.spoiler_pair_6_engaged = rtb_AND16;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.spoiler_pair_7_engaged = rtb_AND11_b;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.spoiler_pair_8_engaged = rtb_AND2_ac;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.left_inboard_elevator_engaged = rtb_AND1_l;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.right_inboard_elevator_engaged = rtb_AND14;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.left_outboard_elevator_engaged = rtb_AND5_e;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.right_outboard_elevator_engaged = rtb_AND4_d;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.ths_engaged = rtb_AND6_b;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.upper_rudder_engaged = rtb_AND3_k;
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.ths_deg = rtb_Switch1_d;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.law_capability = rtb_pitchLawCapability;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_law = activeLaw;
    rtb_DataTypeConversion_ah = (rtb_AND11_p || (activeLaw == a380_efcs_law::AlternateLaw1B) || (activeLaw ==
      a380_efcs_law::AlternateLaw1C));
    if (rtb_DataTypeConversion_ah || (activeLaw == a380_efcs_law::AlternateLaw2A) || (activeLaw == a380_efcs_law::
         AlternateLaw2B)) {
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_pitch_law = a380_pitch_law::NzLaw;
    } else if (activeLaw == a380_efcs_law::DirectLaw) {
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_pitch_law = a380_pitch_law::DirectLaw;
    } else {
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_pitch_law = a380_pitch_law::None;
    }

    if (rtb_DataTypeConversion_ah) {
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_lateral_law = a380_lateral_law::YStarLaw;
    } else if ((activeLaw == a380_efcs_law::AlternateLaw2A) || (activeLaw == a380_efcs_law::AlternateLaw2B) ||
               (activeLaw == a380_efcs_law::DirectLaw)) {
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_lateral_law = a380_lateral_law::DirectLaw;
    } else {
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_lateral_law = a380_lateral_law::None;
    }

    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.abnormal_condition_law_active = rtb_AND16_n;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.flare_law_override_active = rtb_AND20;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim = rtb_AND18_c;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.prim_capability_score = rtb_score;
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.elevator_3_avail = rtb_y_la;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.elevator_3_engaged = rtb_y_m;
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.left_aileron_1_avail = rtb_OR1_h;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.left_aileron_1_engaged = rtb_OR1_h;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.left_aileron_2_avail = rtb_OR1_l;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.left_aileron_2_engaged = rtb_OR_o;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.right_aileron_1_avail = rtb_OR_i;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.right_aileron_1_engaged = rtb_OR_i;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.right_aileron_2_avail = rtb_OR2_o;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.right_aileron_2_engaged = rtb_OR_cc;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.left_spoiler_hydraulic_mode_avail = leftSpoilerHydraulicModeAvail;
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.rudder_2_hydraulic_mode_engaged = rtb_AND2;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.rudder_2_electric_mode_engaged = rudder2HydraulicModeHasPriority;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.aileron_antidroop_active =
      A380PrimComputerFctl_DWork.Delay1_DSTATE_b;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.eha_ebha_elec_mode_inhibited = rtb_OR_jr;
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.left_sidestick_priority_locked = rtb_OR_b;
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.right_sidestick_priority_locked = rtb_AND12;
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ground_spoiler_command_deg = rtb_Gain_c;
    ...
    A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ths_automatic_mode_active = rtb_y_kc;
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fg_logic.ap_1_engaged) {
      ...
      rtb_Switch1_d = A380PrimComputerFctl_B.BusAssignment_nw.fg_laws.ap_fd_1.autopilot.Beta_c_deg;
    } else {
      rtb_Switch_nb = A380PrimComputerFctl_B.BusAssignment_nw.fg_laws.ap_fd_2.autopilot.Phi_c_deg;
      rtb_Switch1_d = A380PrimComputerFctl_B.BusAssignment_nw.fg_laws.ap_fd_2.autopilot.Beta_c_deg;
    }
    ...
    LawMDLOBJ2.step(&A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
                    ...
                    &rtb_Switch1_d, &rtb_OR1_l, &rtb_xi_deg, &rtb_zeta_deg);
    ...
    A380PrimComputerFctl_RateLimiter(A380PrimComputerFctl_P.Gain8_Gain * rtb_Switch_nb,
      ...
      A380PrimComputerFctl_P.RateLimiterVariableTs1_InitialCondition, &rtb_Y_o,
      &A380PrimComputerFctl_DWork.sf_RateLimiter_it);
    rtb_OR_jr = (A380PrimComputerFctl_B.BusAssignment_nw.general_logic.on_ground ||
                 (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_lateral_law !=
                  A380PrimComputerFctl_P.EnumeratedConstant_Value_g));
    if (rtb_OR_jr) {
      rtb_Y_o = rtb_Switch_nb;
      rtb_Switch1_d = rtb_Switch_nb;
    } else {
      rtb_Switch1_d = A380PrimComputerFctl_P.Gain1_Gain * rtb_Y_o;
    }

    A380PrimComputerFctl_TransportDelay(rtb_Switch1_d, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt, rtb_OR_jr,
      &rtb_y_bq, &A380PrimComputerFctl_DWork.sf_TransportDelay);
    if (rtb_y_bq > A380PrimComputerFctl_P.Saturation3_UpperSat) {
      rtb_Switch_nb = A380PrimComputerFctl_P.Saturation3_UpperSat;
    } else if (rtb_y_bq < A380PrimComputerFctl_P.Saturation3_LowerSat) {
      rtb_Switch_nb = A380PrimComputerFctl_P.Saturation3_LowerSat;
    } else {
      rtb_Switch_nb = rtb_y_bq;
    }

    if (rtb_Switch1_d > A380PrimComputerFctl_P.Saturation_UpperSat_f) {
      rtb_Y_k = A380PrimComputerFctl_P.Saturation_UpperSat_f;
    } else if (rtb_Switch1_d < A380PrimComputerFctl_P.Saturation_LowerSat_hn) {
      rtb_Y_k = A380PrimComputerFctl_P.Saturation_LowerSat_hn;
    } else {
      rtb_Y_k = rtb_Switch1_d;
    }

    rtb_Switch1_d = (((rtb_Switch1_d - rtb_Y_k) + rtb_y_bq) - rtb_Switch_nb) + rtb_Y_o;
    if (rtb_Switch1_d > A380PrimComputerFctl_P.Saturation2_UpperSat_k) {
      rtb_Switch1_d = A380PrimComputerFctl_P.Saturation2_UpperSat_k;
    } else if (rtb_Switch1_d < A380PrimComputerFctl_P.Saturation2_LowerSat_o) {
      rtb_Switch1_d = A380PrimComputerFctl_P.Saturation2_LowerSat_o;
    }

    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.aileron_droop_active) {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant2_Value;
    } else {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant1_Value;
    }

    A380PrimComputerFctl_RateLimiter(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterVariableTs2_up,
      A380PrimComputerFctl_P.RateLimiterVariableTs2_lo, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
      A380PrimComputerFctl_P.RateLimiterVariableTs2_InitialCondition, &rtb_Gain_c,
      &A380PrimComputerFctl_DWork.sf_RateLimiter);
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.aileron_antidroop_active) {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant4_Value;
    } else {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant3_Value;
    }

    A380PrimComputerFctl_RateLimiter(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterVariableTs3_up,
      A380PrimComputerFctl_P.RateLimiterVariableTs3_lo, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
      A380PrimComputerFctl_P.RateLimiterVariableTs3_InitialCondition, &rtb_y_bq,
      &A380PrimComputerFctl_DWork.sf_RateLimiter_m);
    rtb_right_spoiler_2_deg = rtb_Gain_c + rtb_y_bq;
    rtb_Sum6 = A380PrimComputerFctl_P.Gain4_Gain * rtb_Switch1_d + rtb_right_spoiler_2_deg;
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Sum6, A380PrimComputerFctl_P.RateLimiterGenericVariableTs4_up,
      ...
      ((!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.left_outboard_aileron_engaged) ||
       (!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim)), &rtb_y_bq,
    ...
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.prim_x_bus.fctl.fctl_law_status_word,
       A380PrimComputerFctl_P.BitfromLabel_bit_c, &rtb_y_cf);
    A380PrimComputerFctl_MATLABFunction
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.prim_x_bus.fctl.fctl_law_status_word, &rtb_y_kc);
    if ((rtb_y_cf != 0U) && rtb_y_kc) {
      rtb_Switch_left_inboard_aileron_command_deg_Data =
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      ...
      abs_rate_c = rtb_Switch_left_inboard_aileron_command_deg_Data;
    }
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_left_midboard_aileron_deg = rtb_y_bq;
    } else {
    ...
    rtb_Switch1_d += rtb_right_spoiler_2_deg;
    if (rtb_Switch1_d > rtb_outerAilUpperLim) {
      rtb_Switch1_d = rtb_outerAilUpperLim;
    } else if (rtb_Switch1_d < rtb_outerAilLowerLim) {
      rtb_Switch1_d = rtb_outerAilLowerLim;
    }

    A380PrimComputerFctl_RateLimiter_h(rtb_Switch1_d, A380PrimComputerFctl_P.RateLimiterGenericVariableTs5_up,
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_Switch1_d = rtb_y_bq;
    } else {
      rtb_Switch1_d = rtb_Switch_right_outboard_aileron_command_deg_Data;
    }

    rtb_right_spoiler_2_deg = A380PrimComputerFctl_P.Gain5_Gain *
    ...
    A380PrimComputerFctl_RateLimiter_l(rtb_outerAilUpperLim, A380PrimComputerFctl_P.RateLimiterGenericVariableTs28_up,
      ...
      A380PrimComputerFctl_P.reset_Value_p, &rtb_y_bq, &A380PrimComputerFctl_DWork.sf_RateLimiter_a);
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.spoiler_lift_active) {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant9_Value;
    } else {
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant8_Value;
    }

    A380PrimComputerFctl_RateLimiter_d(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs25_up,
    ...
    rtb_left_spoiler_3_deg = std::fmin(rtb_y_bq *
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.speed_brake_command_deg, rtb_Y);
    if (rtb_NOT_k) {
      rtb_Switch11_a = rtb_right_spoiler_2_deg;
    } else {
      rtb_Switch11_a = rtb_left_spoiler_3_deg;
    }

    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs8_up,
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs9_up,
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs10_up,
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_left_spoiler_2_deg = rtb_y_bq;
    } else {
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_right_spoiler_2_deg = rtb_y_bq;
    } else {
      rtb_right_spoiler_2_deg = rtb_Switch_right_spoiler_2_command_deg_Data;
    }

    if (A380PrimComputerFctl_P.Constant7_Value_o) {
      rtb_left_spoiler_3_deg = rtb_Y_o;
    } else {
      rtb_left_spoiler_3_deg = std::abs(rtb_Y_o) + A380PrimComputerFctl_P.Bias_Bias;
      ...
      rtb_left_spoiler_3_deg = rtb_left_spoiler_3_deg * static_cast<real_T>(c_nz) * A380PrimComputerFctl_P.Gain6_Gain;
    }

    rtb_Gain2 = A380PrimComputerFctl_P.Gain2_Gain * rtb_left_spoiler_3_deg;
    switch (static_cast<int32_T>(A380PrimComputerFctl_B.BusAssignment_nw.general_logic.flap_handle_index)) {
     case 2:
      rtb_Gain_c = 0.37777777777777777;
      break;
     ...
     case 4:
      rtb_Gain_c = 0.066666666666666666;
      break;
     ...
     default:
      rtb_Gain_c = 0.44444444444444442;
      break;
    }

    A380PrimComputerFctl_RateLimiter_l(rtb_Gain_c, A380PrimComputerFctl_P.RateLimiterGenericVariableTs27_up,
      A380PrimComputerFctl_P.RateLimiterGenericVariableTs27_lo, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
      A380PrimComputerFctl_P.reset_Value_n, &rtb_y_bq, &A380PrimComputerFctl_DWork.sf_RateLimiter_oa);
    A380PrimComputerFctl_Spoiler345Computation(rtb_Gain2, std::fmin(rtb_y_bq *
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.speed_brake_command_deg, rtb_Y), &rtb_y_bq, &rtb_Gain_c);
    if (rtb_NOT_k) {
      rtb_Switch11_a = A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ground_spoiler_command_deg;
    } else {
      rtb_Switch11_a = rtb_y_bq;
    }

    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs14_up,
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs15_up,
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_Y_o = rtb_handleIndex;
    } else {
      rtb_Y_o = rtb_Switch_right_spoiler_3_command_deg_Data;
    }
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs12_up,
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs13_up,
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs18_up,
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_Switch7_e = rtb_y_bq;
    } else {
      rtb_Switch7_e = rtb_Switch_left_spoiler_5_command_deg_Data;
    }

    if (rtb_NOT_k) {
      rtb_Gain_c = A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ground_spoiler_command_deg;
    }

    A380PrimComputerFctl_RateLimiter_h(rtb_Gain_c, A380PrimComputerFctl_P.RateLimiterGenericVariableTs19_up,
    ...
    switch (static_cast<int32_T>(A380PrimComputerFctl_B.BusAssignment_nw.general_logic.flap_handle_index)) {
     case 2:
      rtb_Gain_c = 0.46666666666666667;
      break;
     ...
     case 4:
      rtb_Gain_c = 0.22222222222222221;
      break;
    ...
    A380PrimComputerFctl_RateLimiter_l(rtb_Gain_c, A380PrimComputerFctl_P.RateLimiterGenericVariableTs26_up,
      A380PrimComputerFctl_P.RateLimiterGenericVariableTs26_lo, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
      A380PrimComputerFctl_P.reset_Value_nc, &rtb_y_bq, &A380PrimComputerFctl_DWork.sf_RateLimiter_l3);
    A380PrimComputerFctl_Spoiler345Computation(rtb_Gain2, std::fmin(rtb_y_bq *
      A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.speed_brake_command_deg, rtb_Y), &rtb_y_bq, &rtb_Gain_c);
    if (rtb_NOT_k) {
      rtb_Switch11_a = A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ground_spoiler_command_deg;
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs16_up,
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs17_up,
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      ...
      rtb_Switch3_h = rtb_Switch_right_spoiler_6_command_deg_Data;
    }
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs22_up,
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs23_up,
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Switch11_a, A380PrimComputerFctl_P.RateLimiterGenericVariableTs20_up,
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg = rtb_y_bq;
    } else {
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Gain_c, A380PrimComputerFctl_P.RateLimiterGenericVariableTs21_up,
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_right_spoiler_8_deg = rtb_y_bq;
    } else {
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_right_spoiler_8_deg =
        rtb_Switch_right_spoiler_8_command_deg_Data;
    }

    rtb_Gain_c = look1_binlxpw(A380PrimComputerFctl_B.BusAssignment_nw.general_logic.adr_computation_data.V_ias_kn,
    ...
    A380PrimComputerFctl_RateLimiter(A380PrimComputerFctl_P.Gain9_Gain * rtb_Y,
      ...
      A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
      A380PrimComputerFctl_P.RateLimiterVariableTs5_InitialCondition, &rtb_y_bq,
      &A380PrimComputerFctl_DWork.sf_RateLimiter_dg);
    if (rtb_OR_jr) {
      rtb_Switch23 = rtb_Y;
    } else {
      rtb_Y = rtb_y_bq;
      rtb_Switch23 = A380PrimComputerFctl_P.Gain7_Gain * rtb_y_bq;
    }
    ...
    A380PrimComputerFctl_TransportDelay(rtb_Y, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt, rtb_OR_jr,
      &rtb_y_bq, &A380PrimComputerFctl_DWork.sf_TransportDelay_c);
    rtb_Y = (rtb_Switch23 - rtb_handleIndex) + rtb_y_bq;
    if (rtb_Y > rtb_Gain_c) {
      rtb_Y = rtb_Gain_c;
    } else {
      rtb_Gain_c *= A380PrimComputerFctl_P.Gain_Gain;
      if (rtb_Y < rtb_Gain_c) {
        rtb_Y = rtb_Gain_c;
      }
    }
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.lateral_surface_positions.upper_rudder_deg >
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation6_UpperSat;
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation6_LowerSat;
    } else {
      rtb_Switch11_a = A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.lateral_surface_positions.upper_rudder_deg;
    }
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_Y, A380PrimComputerFctl_P.RateLimiterGenericVariableTs6_up,
      ...
      rtb_Switch11_a, ((!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.upper_rudder_engaged) ||
                       (!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim)), &rtb_Gain_c,
      &A380PrimComputerFctl_DWork.sf_RateLimiter_lv);
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_y_bq = rtb_Gain_c;
    } else {
      rtb_y_bq = rtb_Switch_upper_rudder_command_deg_Data;
    }
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.lateral_surface_positions.lower_rudder_deg >
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation5_UpperSat;
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation5_LowerSat;
    } else {
      rtb_Switch11_a = A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.lateral_surface_positions.lower_rudder_deg;
    }
    ...
    A380PrimComputerFctl_RateLimiter_h(rtb_handleIndex, A380PrimComputerFctl_P.RateLimiterGenericVariableTs7_up,
      ...
      rtb_Switch11_a, ((!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.lower_rudder_engaged) ||
                       (!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim)), &rtb_Gain_c,
      &A380PrimComputerFctl_DWork.sf_RateLimiter_pw);
    if (!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_Gain_c = rtb_Switch_lower_rudder_command_deg_Data;
    }

    rtb_Switch23 = rtb_Gain_c;
    rtb_Gain_jw = A380PrimComputerFctl_P.DiscreteDerivativeVariableTs_Gain *
      A380PrimComputerFctl_B.BusAssignment_nw.general_logic.ir_computation_data.theta_dot_deg_s;
    A380PrimComputerFctl_LagFilter((rtb_Gain_jw - A380PrimComputerFctl_DWork.Delay_DSTATE) /
    ...
    rtb_Gain_c = (((A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.left_inboard_elevator_deg
                    + A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.right_inboard_elevator_deg)
                   + A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.left_outboard_elevator_deg)
                  + A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.right_outboard_elevator_deg)
    ...
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
       A380PrimComputerFctl_P.BitfromLabel_bit_j, &rtb_y_cf);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
       A380PrimComputerFctl_P.BitfromLabel1_bit_h, &rtb_y_df);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
       A380PrimComputerFctl_P.BitfromLabel2_bit_he, &rtb_y_gf);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
       A380PrimComputerFctl_P.BitfromLabel3_bit_l, &rtb_y_ei);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
       A380PrimComputerFctl_P.BitfromLabel4_bit_nn, &rtb_y_bl);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
       A380PrimComputerFctl_P.BitfromLabel5_bit_f, &rtb_y_ph);
    if (rtb_y_cf != 0U) {
      rtb_handleIndex = 0.0;
    } else if ((rtb_y_df != 0U) && (rtb_y_ph != 0U)) {
      rtb_handleIndex = 1.0;
    } else if ((rtb_y_df != 0U) && (rtb_y_ph == 0U)) {
      rtb_handleIndex = 2.0;
    } else if (rtb_y_gf != 0U) {
    ...
    rtb_OR_jr = (A380PrimComputerFctl_B.BusAssignment_nw.general_logic.tracking_mode_on || (static_cast<real_T>
      ...
      A380PrimComputerFctl_P.CompareToConstant_const_b));
    if (A380PrimComputerFctl_B.BusAssignment_nw.fg_logic.ap_1_engaged) {
    ...
    rtb_OR1_h = (A380PrimComputerFctl_B.BusAssignment_nw.fg_logic.ap_1_engaged ||
                 A380PrimComputerFctl_B.BusAssignment_nw.fg_logic.ap_2_engaged);
    rtb_y_kc = (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_law ==
                A380PrimComputerFctl_P.EnumeratedConstant1_Value_a);
    rtb_OR2_o = ((A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_law ==
                  A380PrimComputerFctl_P.EnumeratedConstant_Value_j) || rtb_y_kc);
    LawMDLOBJ4.step(&A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
                    ...
                    &rtb_Gain_c, &A380PrimComputerFctl_B.BusAssignment_nw.data.analog_inputs.ths_pos_deg,
      ...
      (&A380PrimComputerFctl_RGND)), &A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.total_sidestick_pitch_command,
                    ...
                    &rtb_OR1_h, &rtb_OR2_o,
                    &A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.flare_law_override_active, &rtb_eta_deg,
    ...
    switch (static_cast<int32_T>(A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_pitch_law)) {
     case 1:
      rtb_eta_deg_h = rtb_eta_deg;
      break;

     case 2:
      rtb_eta_deg_h = rtb_eta_deg_c;
      break;

     default:
      rtb_eta_deg_h = A380PrimComputerFctl_P.Constant_Value_j;
      break;
    }
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.left_inboard_elevator_deg >
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation3_UpperSat_o;
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation3_LowerSat_f;
    } else {
      rtb_Switch11_a =
        A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.left_inboard_elevator_deg;
    }

    A380PrimComputerFctl_RateLimiter_h(rtb_eta_deg_h, A380PrimComputerFctl_P.RateLimiterGenericVariableTs_up_b,
      A380PrimComputerFctl_P.RateLimiterGenericVariableTs_lo_c, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
      rtb_Switch11_a,
      ((!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.left_inboard_elevator_engaged) ||
       (!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim)), &rtb_Gain_c,
      &A380PrimComputerFctl_DWork.sf_RateLimiter_mp);
    A380PrimComputerFctl_MATLABFunction_p
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.prim_x_bus.fctl.fctl_law_status_word,
       A380PrimComputerFctl_P.BitfromLabel_bit_hy, &rtb_y_ph);
    A380PrimComputerFctl_MATLABFunction
      (&A380PrimComputerFctl_B.BusAssignment_nw.data.bus_inputs.prim_x_bus.fctl.fctl_law_status_word, &rtb_y_kc);
    if ((rtb_y_ph != 0U) && rtb_y_kc) {
      rtb_Switch_left_inboard_aileron_command_deg_Data =
    ...
    if (!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_Gain_c = rtb_Switch_left_inboard_aileron_command_deg_Data;
    }
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.right_inboard_elevator_deg >
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation2_UpperSat_l;
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation2_LowerSat_l;
    } else {
      rtb_Switch11_a =
        A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.right_inboard_elevator_deg;
    }

    A380PrimComputerFctl_RateLimiter_h(rtb_eta_deg_h, A380PrimComputerFctl_P.RateLimiterGenericVariableTs1_up_g,
      A380PrimComputerFctl_P.RateLimiterGenericVariableTs1_lo_a, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
      rtb_Switch11_a,
      ((!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.right_inboard_elevator_engaged) ||
       (!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim)), &rtb_Y,
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.left_outboard_elevator_deg >
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation_UpperSat_g;
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation_LowerSat_c;
    } else {
      rtb_Switch11_a =
        A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.left_outboard_elevator_deg;
    }

    A380PrimComputerFctl_RateLimiter_h(rtb_eta_deg_h, A380PrimComputerFctl_P.RateLimiterGenericVariableTs2_up_d,
      A380PrimComputerFctl_P.RateLimiterGenericVariableTs2_lo_m, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
      rtb_Switch11_a,
      ((!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.left_outboard_elevator_engaged) ||
       (!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim)), &rtb_handleIndex,
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.right_outboard_elevator_deg >
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation1_UpperSat_m;
      ...
      rtb_Switch11_a = A380PrimComputerFctl_P.Saturation1_LowerSat_b;
    } else {
      rtb_Switch11_a =
        A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.right_outboard_elevator_deg;
    }

    A380PrimComputerFctl_RateLimiter_h(rtb_eta_deg_h, A380PrimComputerFctl_P.RateLimiterGenericVariableTs3_up_m,
      A380PrimComputerFctl_P.RateLimiterGenericVariableTs3_lo_p, A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt,
      rtb_Switch11_a,
      ((!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.right_outboard_elevator_engaged) ||
    ...
    switch (static_cast<int32_T>(A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_pitch_law)) {
     case 1:
      rtb_Switch11_a = rtb_eta_trim_limit_up;
      break;

     case 2:
      rtb_Switch11_a = rtb_eta_trim_limit_up_n;
      break;

     default:
      rtb_Switch11_a = A380PrimComputerFctl_P.Constant2_Value_g;
      break;
    }
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ths_automatic_mode_active) {
      switch (static_cast<int32_T>(A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_pitch_law)) {
       case 1:
        rtb_eta_deg_h = rtb_eta_trim_dot_deg_s;
        break;

       case 2:
        rtb_eta_deg_h = rtb_eta_trim_dot_deg_s_l;
        break;
      ...
      rtb_eta_deg_h = A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ths_manual_mode_c_deg_s;
    }

    rtb_eta_deg_h = A380PrimComputerFctl_P.DiscreteTimeIntegratorVariableTsLimit_Gain * rtb_eta_deg_h *
      A380PrimComputerFctl_B.BusAssignment_nw.data.time.dt;
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ths_automatic_mode_active) {
      rtb_DataTypeConversion_ah = ((!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.surface_statuses.ths_engaged) ||
        (!A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim));
    } else {
      rtb_DataTypeConversion_ah = !A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ths_engaged;
    }

    A380PrimComputerFctl_DWork.icLoad = (rtb_DataTypeConversion_ah || A380PrimComputerFctl_DWork.icLoad);
    if (A380PrimComputerFctl_DWork.icLoad) {
      A380PrimComputerFctl_DWork.Delay_DSTATE_m =
        A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.pitch_surface_positions.ths_deg - rtb_eta_deg_h;
    }

    A380PrimComputerFctl_DWork.Delay_DSTATE_m += rtb_eta_deg_h;
    if (A380PrimComputerFctl_DWork.Delay_DSTATE_m > rtb_Switch11_a) {
      A380PrimComputerFctl_DWork.Delay_DSTATE_m = rtb_Switch11_a;
    } else {
      switch (static_cast<int32_T>(A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.active_pitch_law)) {
       case 1:
        rtb_Switch11_a = rtb_eta_trim_limit_lo;
        break;

       case 2:
        rtb_Switch11_a = rtb_eta_trim_limit_lo_o;
        break;

       default:
        rtb_Switch11_a = A380PrimComputerFctl_P.Constant3_Value_m;
        break;
      }
    ...
    if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.is_master_prim) {
      rtb_Switch11_a = A380PrimComputerFctl_DWork.Delay_DSTATE_m;
    } else if (A380PrimComputerFctl_B.BusAssignment_nw.fctl_logic.ths_automatic_mode_active) {
      rtb_Switch11_a = rtb_Switch_left_outboard_aileron_command_deg_Data;
    } else {
      rtb_Switch11_a = A380PrimComputerFctl_DWork.Delay_DSTATE_m;
    }

    A380PrimComputerFctl_B.BusAssignment_m.laws.lateral_law_outputs.left_inboard_aileron_deg = abs_rate_c;
    ...
    A380PrimComputerFctl_B.BusAssignment_m.laws.lateral_law_outputs.right_outboard_aileron_deg = rtb_Switch1_d;
    ...
    A380PrimComputerFctl_B.BusAssignment_m.laws.lateral_law_outputs.right_spoiler_3_deg = rtb_Y_o;
    ...
    A380PrimComputerFctl_B.BusAssignment_m.laws.lateral_law_outputs.right_spoiler_6_deg = rtb_Switch3_h;
    ...
    A380PrimComputerFctl_B.BusAssignment_m.laws.lateral_law_outputs.left_spoiler_8_deg =
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg;
    A380PrimComputerFctl_B.BusAssignment_m.laws.lateral_law_outputs.right_spoiler_8_deg =
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_right_spoiler_8_deg;
    A380PrimComputerFctl_B.BusAssignment_m.laws.lateral_law_outputs.upper_rudder_deg = rtb_y_bq;
    A380PrimComputerFctl_B.BusAssignment_m.laws.lateral_law_outputs.lower_rudder_deg = rtb_Switch23;
    A380PrimComputerFctl_B.BusAssignment_m.laws.pitch_law_outputs.left_inboard_elevator_deg = rtb_Gain_c;
    ...
    A380PrimComputerFctl_B.BusAssignment_m.laws.pitch_law_outputs.ths_deg = rtb_Switch11_a;
    if (A380PrimComputerFctl_B.BusAssignment_m.data.discrete_inputs.is_unit_1) {
      rtb_eta_deg_h = abs_rate_c;
      ...
      rtb_elevator2Command = rtb_Gain_c;
      rtb_elevator3Command = rtb_Switch_k;
      rtb_rudder1Command = rtb_y_bq;
      ...
      rtb_eta_deg_h = rtb_Sum6;
      rtb_rightAileron1Command = rtb_Switch1_d;
      rtb_leftAileron2Command = abs_rate_c;
      ...
      rtb_eta_deg_h = rtb_left_midboard_aileron_deg;
      rtb_rightAileron1Command = rtb_Switch_nb;
      rtb_leftAileron2Command = rtb_Sum6;
      rtb_rightAileron2Command = rtb_Switch1_d;
      rtb_elevator1Command = rtb_Gain_c;
    ...
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(abs_rate_c);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant20_Value;
    }

    rtb_Switch_left_inboard_aileron_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Y_k);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant14_Value;
    }

    rtb_Switch_right_inboard_aileron_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_left_midboard_aileron_deg);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant13_Value;
    }

    rtb_Switch_left_midboard_aileron_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch_nb);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant12_Value;
    }

    rtb_Switch_right_midboard_aileron_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Sum6);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant11_Value_a;
    }

    rtb_Switch_left_outboard_aileron_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch1_d);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant10_Value_b;
    }

    rtb_Switch_right_outboard_aileron_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_outerAilUpperLim);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant9_Value_o;
    }

    rtb_Switch_left_spoiler_1_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_outerAilLowerLim);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant8_Value_j;
    }

    rtb_Switch_right_spoiler_1_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_left_spoiler_2_deg);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant24_Value;
    }

    rtb_Switch_left_spoiler_2_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_right_spoiler_2_deg);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant23_Value;
    }

    rtb_Switch_right_spoiler_2_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_left_spoiler_3_deg);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant7_Value_k;
    }

    rtb_Switch_left_spoiler_3_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Y_o);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant6_Value_h;
    }

    rtb_Switch_right_spoiler_3_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch9_f);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant26_Value;
    }

    rtb_Switch_left_spoiler_4_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch8_o);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant25_Value;
    }

    rtb_Switch_right_spoiler_4_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch7_e);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant28_Value;
    }

    rtb_Switch_left_spoiler_5_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch6_i);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant27_Value;
    }

    rtb_Switch_right_spoiler_5_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Gain2);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant5_Value_a;
    }

    rtb_Switch_left_spoiler_6_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch3_h);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant4_Value_b;
    }

    rtb_Switch_right_spoiler_6_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
        (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_7_deg);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant30_Value;
    }

    rtb_Switch_left_spoiler_7_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
        (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_right_spoiler_7_deg);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant29_Value;
    }

    rtb_Switch_right_spoiler_7_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
        (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_left_spoiler_8_deg);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant32_Value;
    }

    rtb_Switch_left_spoiler_8_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
        (rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_right_spoiler_8_deg);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant31_Value;
    }

    rtb_Switch_right_spoiler_8_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Gain_c);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant3_Value_k;
    }

    rtb_Switch_upper_rudder_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Y);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant33_Value;
    }

    rtb_Switch_lower_rudder_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_handleIndex);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant34_Value;
    }

    rtb_left_outboard_elevator_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch_k);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant35_Value;
    }

    rtb_right_outboard_elevator_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch11_a);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant2_Value_kh;
    }

    rtb_ths_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_y_bq);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant1_Value_a;
    }

    rtb_upper_rudder_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.is_master_prim) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>(rtb_Switch23);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_P.Constant15_Value;
    }

    rtb_lower_rudder_command_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.capt_pitch_stick_pos);
    rtb_Gain_go = A380PrimComputerFctl_P.Gain_Gain_n * A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.fo_pitch_stick_pos);
    rtb_Gain1_e = A380PrimComputerFctl_P.Gain1_Gain_i * A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.capt_roll_stick_pos);
    rtb_Gain2_l = A380PrimComputerFctl_P.Gain2_Gain_g * A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.fo_roll_stick_pos);
    rtb_Gain3_p = A380PrimComputerFctl_P.Gain3_Gain_a * A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.rudder_pedal_pos);
    rtb_Gain4_o = A380PrimComputerFctl_P.Gain4_Gain_h * A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate, &rtb_aileron_status_word_Data);
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.left_aileron_1_pos_deg);
    rtb_left_aileron_1_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.left_aileron_2_pos_deg);
    rtb_left_aileron_2_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.right_aileron_1_pos_deg);
    rtb_right_aileron_1_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.right_aileron_2_pos_deg);
    rtb_right_aileron_2_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate, &rtb_spoiler_status_word_Data);
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.left_spoiler_pos_deg);
    rtb_left_spoiler_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.right_spoiler_pos_deg);
    rtb_right_spoiler_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate, &rtb_elevator_status_word_Data);
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.elevator_1_pos_deg);
    rtb_elevator_1_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.elevator_2_pos_deg);
    rtb_elevator_2_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.elevator_3_pos_deg);
    rtb_elevator_3_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.analog_inputs.ths_pos_deg);
    rtb_ths_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    ...
    rtb_fctl_rudder_2_position_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_MATLABFunction1(A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.law_capability,
      &rtb_VectorConcatenate_o[0], &rtb_VectorConcatenate_o[1], &rtb_VectorConcatenate_o[2]);
    rtb_VectorConcatenate_o[3] = A380PrimComputerFctl_P.Constant21_Value;
    rtb_VectorConcatenate_o[4] = A380PrimComputerFctl_P.Constant21_Value;
    A380PrimComputerFctl_MATLABFunction1(A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.active_law,
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_o, &rtb_fctl_discrete_status_word_1_Data);
    rtb_y_df = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant2_Value);
    if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_lost) {
      rtb_y_bl = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant2_Value);
    } else if ((A380PrimComputerFctl_P.EnumeratedConstant4_Value_k ==
                A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.active_law) &&
               A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_visible) {
      rtb_y_bl = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    } else {
      rtb_y_bl = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant_Value);
    }
    ...
    if (rtb_OR_i) {
      if ((A380PrimComputerFctl_P.EnumeratedConstant3_Value !=
           A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.active_law) &&
          A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_visible) {
        rtb_y_df = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant1_Value);
      } else {
        rtb_y_df = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant_Value);
      }
    }
    ...
    rtb_y_bl = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant2_Value_l);
    if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_lost) {
      rtb_y_ei = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant2_Value_l);
    } else {
      rtb_y_ei = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant1_Value_j);
    }

    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.gamma_a_deg);
    rtb_gamma_a_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.gamma_t_deg);
    rtb_gamma_t_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.beta_target_deg);
    rtb_sideslip_target_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.v_ls_kn);
    rtb_v_ls_kn_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.v_stall_kn);
    rtb_v_stall_kn_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.v_c_trend_kn);
    rtb_speed_trend_kn_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.v_3_kn);
    rtb_v_3_kn_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.v_4_kn);
    rtb_v_4_kn_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.v_man_kn);
    rtb_v_man_kn_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.v_max_kn);
    rtb_v_max_kn_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (rtb_OR_i) {
      if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_visible &&
        ...
        rtb_y_bl = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant1_Value_j);
      } else {
        rtb_y_bl = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant_Value_e);
      }
    }

    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.v_fe_next_kn);
    rtb_v_fe_next_kn_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_o, &A380PrimComputerFctl_DWork.DelayInput1_DSTATE);
    rtb_fe_discrete_word_1_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.pfd_spd_target_kts);
    rtb_pfd_spd_tgt_kts_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.short_term_managed_spd_kts);
    rtb_pfd_short_term_mngd_spd_kts_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    rtb_OR_jr = !A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.trk_fpa_active;
    rtb_NOT_k = (A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.vs_fpa_dashes || rtb_OR_jr);
    if (rtb_NOT_k) {
      rtb_y_cf = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant_Value_i);
    } else {
      rtb_y_cf = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    }
    ...
    rtb_runway_hdg_memorized_deg_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.adcn_inputs.fms.preset_mach);
    rtb_preset_mach_from_fms_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.adcn_inputs.fms.preset_spd_kts);
    rtb_preset_speed_from_fms_kts_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.fg_laws.ap_fd_1.flight_director.Phi_c_deg);
    rtb_roll_fd_command_1_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.fg_laws.ap_fd_1.flight_director.Theta_c_deg);
    rtb_pitch_fd_command_1_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.fg_laws.ap_fd_1.flight_director.Beta_c_deg);
    rtb_yaw_fd_command_1_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.fg_laws.ap_fd_2.flight_director.Phi_c_deg);
    rtb_roll_fd_command_2_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.fg_laws.ap_fd_2.flight_director.Theta_c_deg);
    rtb_pitch_fd_command_2_Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_o, &rtb_y_f5);
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_o, &rtb_y_k1);
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_pw, &rtb_y_h);
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_pw, &rtb_y_kz);
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_pw, &rtb_y_kf);
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_pw, &rtb_y_bd);
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_pw, &rtb_y_gs);
    ...
    A380PrimComputerFctl_MATLABFunction_g(rtb_VectorConcatenate_pw, &rtb_y_fh);
    ...
    if (A380PrimComputerFctl_B.BusAssignment_m.data.adcn_inputs.fms.show_speed_margins) {
      rtb_y_ph = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    } else {
      rtb_y_ph = static_cast<uint32_T>(A380PrimComputerFctl_P.EnumeratedConstant_Value_i);
    }

    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.adcn_inputs.fms.v_lower_margin_kts);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.low_target_speed_margin_kts.Data =
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.data.adcn_inputs.fms.v_upper_margin_kts);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.high_target_speed_margin_kts.Data =
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    if (A380PrimComputerFctl_B.BusAssignment_m.fg_logic.ap_1_engaged) {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
        (A380PrimComputerFctl_B.BusAssignment_m.fg_laws.ap_fd_1.Nosewheel_c);
    } else {
      A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
        (A380PrimComputerFctl_B.BusAssignment_m.fg_laws.ap_fd_2.Nosewheel_c);
    }

    A380PrimComputerFctl_Y.out.bus_outputs.fg.nosewheel_cmd_deg.Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
      (A380PrimComputerFctl_B.BusAssignment_m.fg_laws.n_1_c_percent);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.n1_command_percent.Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = static_cast<real32_T>
    ...
    rtb_DataTypeConversion_ah = (A380PrimComputerFctl_B.BusAssignment_m.fg_logic.ap_1_engaged ||
      A380PrimComputerFctl_B.BusAssignment_m.fg_logic.ap_2_engaged);
    A380PrimComputerFctl_Y.out.discrete_outputs.ap_engaged = rtb_DataTypeConversion_ah;
    ...
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.ths_engaged) {
      A380PrimComputerFctl_Y.out.analog_outputs.ths_pos_order_deg = rtb_Switch11_a;
    } else {
    ...
    if (A380PrimComputerFctl_B.BusAssignment_m.fctl_logic.left_aileron_1_engaged) {
      A380PrimComputerFctl_Y.out.analog_outputs.left_aileron_1_pos_order_deg = rtb_eta_deg_h;
    } else {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_sidestick_pitch_command_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_sidestick_pitch_command_deg.Data = rtb_Gain_go;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_sidestick_pitch_command_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_sidestick_pitch_command_deg.Data = rtb_Gain1_e;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_sidestick_roll_command_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_sidestick_roll_command_deg.Data = rtb_Gain2_l;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_sidestick_roll_command_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_sidestick_roll_command_deg.Data = rtb_Gain3_p;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.rudder_pedal_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.rudder_pedal_position_deg.Data = rtb_Gain4_o;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_aileron_1_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_aileron_1_position_deg.Data = rtb_left_aileron_1_position_deg_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_aileron_2_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_aileron_2_position_deg.Data = rtb_left_aileron_2_position_deg_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_aileron_1_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_aileron_1_position_deg.Data =
      rtb_right_aileron_1_position_deg_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_aileron_2_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_aileron_2_position_deg.Data =
      rtb_right_aileron_2_position_deg_Data;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_spoiler_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.left_spoiler_position_deg.Data = rtb_left_spoiler_position_deg_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_spoiler_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.right_spoiler_position_deg.Data = rtb_right_spoiler_position_deg_Data;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.elevator_1_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.elevator_1_position_deg.Data = rtb_elevator_1_position_deg_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.elevator_2_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.elevator_2_position_deg.Data = rtb_elevator_2_position_deg_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.elevator_3_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.elevator_3_position_deg.Data = rtb_elevator_3_position_deg_Data;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.rudder_2_position_deg.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value);
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.rudder_2_position_deg.Data = rtb_fctl_rudder_2_position_deg_Data;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.v_alpha_lim_kn.SSM = rtb_y_gf;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.v_alpha_lim_kn.Data = rtb_fctl_v_alpha_lim_kn_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.v_alpha_prot_kn.SSM = rtb_y_gf;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.v_alpha_prot_kn.Data = rtb_fctl_v_alpha_prot_kn_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.v_alpha_stall_warn_kn.SSM = rtb_y_df;
    A380PrimComputerFctl_Y.out.bus_outputs.fctl.v_alpha_stall_warn_kn.Data = rtb_fctl_v_alpha_stall_warn_kn_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fe.gamma_a_deg.SSM = rtb_y_ei;
    A380PrimComputerFctl_Y.out.bus_outputs.fe.gamma_a_deg.Data = rtb_gamma_a_deg_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fe.gamma_t_deg.SSM = rtb_y_ei;
    A380PrimComputerFctl_Y.out.bus_outputs.fe.gamma_t_deg.Data = rtb_gamma_t_deg_Data;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fe.sideslip_target_deg.Data = rtb_sideslip_target_deg_Data;
    if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_lost) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fe.v_ls_kn.Data = rtb_v_ls_kn_Data;
    if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_lost) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fe.v_stall_kn.Data = rtb_v_stall_kn_Data;
    if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_lost) {
      A380PrimComputerFctl_Y.out.bus_outputs.fe.speed_trend_kn.SSM = static_cast<uint32_T>
        (A380PrimComputerFctl_P.EnumeratedConstant2_Value_l);
    } else {
      A380PrimComputerFctl_Y.out.bus_outputs.fe.speed_trend_kn.SSM = static_cast<uint32_T>
        (A380PrimComputerFctl_P.EnumeratedConstant1_Value_j);
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fe.speed_trend_kn.Data = rtb_speed_trend_kn_Data;
    if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_lost) {
      A380PrimComputerFctl_Y.out.bus_outputs.fe.v_3_kn.SSM = static_cast<uint32_T>
        (A380PrimComputerFctl_P.EnumeratedConstant2_Value_l);
    } else if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_visible &&
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fe.v_3_kn.Data = rtb_v_3_kn_Data;
    if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_lost) {
      A380PrimComputerFctl_Y.out.bus_outputs.fe.v_4_kn.SSM = static_cast<uint32_T>
        (A380PrimComputerFctl_P.EnumeratedConstant2_Value_l);
    } else if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_visible &&
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fe.v_4_kn.Data = rtb_v_4_kn_Data;
    if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_lost) {
      A380PrimComputerFctl_Y.out.bus_outputs.fe.v_man_kn.SSM = static_cast<uint32_T>
        (A380PrimComputerFctl_P.EnumeratedConstant2_Value_l);
    } else if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_visible &&
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fe.v_man_kn.Data = rtb_v_man_kn_Data;
    if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_lost) {
      A380PrimComputerFctl_Y.out.bus_outputs.fe.v_max_kn.SSM = static_cast<uint32_T>
        (A380PrimComputerFctl_P.EnumeratedConstant2_Value_l);
    } else if (A380PrimComputerFctl_B.BusAssignment_m.flight_envelope.speed_scale_visible) {
      A380PrimComputerFctl_Y.out.bus_outputs.fe.v_max_kn.SSM = static_cast<uint32_T>
        (A380PrimComputerFctl_P.EnumeratedConstant1_Value_j);
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fe.v_max_kn.Data = rtb_v_max_kn_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fe.v_fe_next_kn.SSM = rtb_y_bl;
    A380PrimComputerFctl_Y.out.bus_outputs.fe.v_fe_next_kn.Data = rtb_v_fe_next_kn_Data;
    A380PrimComputerFctl_Y.out.bus_outputs.fe.discrete_word_1.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value_j);
    A380PrimComputerFctl_Y.out.bus_outputs.fe.discrete_word_1.Data = rtb_fe_discrete_word_1_Data;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.pfd_spd_tgt_kts.Data = rtb_pfd_spd_tgt_kts_Data;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.pfd_short_term_mngd_spd_kts.Data = rtb_pfd_short_term_mngd_spd_kts_Data;
    if (A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.spd_mach_dashes ||
    ...
    if (A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.hdg_trk_dashes || rtb_OR_jr) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.selected_fpa_deg.SSM = rtb_y_cf;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.runway_hdg_memorized_deg.Data = rtb_runway_hdg_memorized_deg_Data;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.preset_mach_from_fms.Data = rtb_preset_mach_from_fms_Data;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.preset_speed_from_fms_kts.Data = rtb_preset_speed_from_fms_kts_Data;
    rtb_OR_jr = !A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.lateral_modes.rollout_submode_active;
    rtb_OR1_h = (A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.any_lateral_mode_engaged &&
                 (!A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.lateral_modes.rwy_loc_submode_active) &&
                 rtb_OR_jr);
    if (rtb_OR1_h) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.roll_fd_command_1.Data = rtb_roll_fd_command_1_Data;
    rtb_OR_jr = (A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.any_longitudinal_mode_engaged && rtb_OR_jr);
    if (rtb_OR_jr) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.pitch_fd_command_1.Data = rtb_pitch_fd_command_1_Data;
    rtb_OR_i = (A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.lateral_modes.rwy_loc_submode_active ||
                A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.lateral_modes.rollout_submode_active ||
                A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.lateral_modes.align_submode_active);
    if (rtb_OR_i) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.yaw_fd_command_1.Data = rtb_yaw_fd_command_1_Data;
    if (rtb_OR1_h) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.roll_fd_command_2.Data = rtb_roll_fd_command_2_Data;
    if (rtb_OR_jr) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.pitch_fd_command_2.Data = rtb_pitch_fd_command_2_Data;
    if (rtb_OR_i) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_1.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_1.Data = rtb_y_f5;
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.ats_discrete_word.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.ats_discrete_word.Data = rtb_y_k1;
    A380PrimComputerFctl_Y.out.bus_outputs.fg.ats_fma_discrete_word.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.ats_fma_discrete_word.Data = rtb_y_h;
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_2.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_2.Data = rtb_y_kz;
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_3.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_3.Data = rtb_y_kf;
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_4.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_4.Data = rtb_y_bd;
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_5.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_5.Data = rtb_y_gs;
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_6.SSM = static_cast<uint32_T>
      (A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    A380PrimComputerFctl_Y.out.bus_outputs.fg.discrete_word_6.Data = rtb_y_fh;
    A380PrimComputerFctl_Y.out.bus_outputs.fg.low_target_speed_margin_kts.SSM = rtb_y_ph;
    A380PrimComputerFctl_Y.out.bus_outputs.fg.high_target_speed_margin_kts.SSM = rtb_y_ph;
    if (A380PrimComputerFctl_B.BusAssignment_m.fg_mode_logic.lateral_modes.rollout_submode_active &&
        rtb_DataTypeConversion_ah) {
      A380PrimComputerFctl_Y.out.bus_outputs.fg.nosewheel_cmd_deg.SSM = static_cast<uint32_T>
        (A380PrimComputerFctl_P.EnumeratedConstant1_Value_g);
    } else {
      A380PrimComputerFctl_Y.out.bus_outputs.fg.nosewheel_cmd_deg.SSM = static_cast<uint32_T>
        (A380PrimComputerFctl_P.EnumeratedConstant_Value_i);
    ...
    if (A380PrimComputerFctl_B.BusAssignment_m.data.adcn_inputs.fms.flex_temp_deg_c !=
        A380PrimComputerFctl_P.CompareToConstant_const_d5) {
    ...
    A380PrimComputerFctl_Y.out.bus_outputs.fg.flx_to_temp_deg_c.Data = A380PrimComputerFctl_DWork.DelayInput1_DSTATE;
    ...
    A380PrimComputerFctl_DWork.Delay_DSTATE_c = rtb_OR_b;
    A380PrimComputerFctl_DWork.Delay1_DSTATE = rtb_AND12;
    A380PrimComputerFctl_DWork.DelayInput1_DSTATE = A380PrimComputerFctl_U.in.general_logic.flap_handle_index;
    A380PrimComputerFctl_DWork.Memory_PreviousInput_o = A380PrimComputerFctl_DWork.DelayOneStep_DSTATE;
    A380PrimComputerFctl_DWork.Memory_PreviousInput_k = A380PrimComputerFctl_DWork.Delay_DSTATE_e;
    A380PrimComputerFctl_DWork.Delay_DSTATE = rtb_Gain_jw;
...
{
  A380PrimComputerFctl_U.in = A380PrimComputerFctl_rtZprim_outputs;
  A380PrimComputerFctl_Y.out = A380PrimComputerFctl_rtZprim_outputs;
  A380PrimComputerFctl_DWork.Delay_DSTATE_c = A380PrimComputerFctl_P.Delay_InitialCondition;
  A380PrimComputerFctl_DWork.Delay1_DSTATE = A380PrimComputerFctl_P.Delay1_InitialCondition;
  A380PrimComputerFctl_DWork.Memory_PreviousInput = A380PrimComputerFctl_P.SRFlipFlop_initial_condition;
  A380PrimComputerFctl_DWork.Memory_PreviousInput_a = A380PrimComputerFctl_P.SRFlipFlop1_initial_condition;
  ...
  A380PrimComputerFctl_DWork.Delay_DSTATE = A380PrimComputerFctl_P.DiscreteDerivativeVariableTs_InitialCondition;
  A380PrimComputerFctl_DWork.icLoad = true;
  A380PrimComputerFctl_PulseRejectNode_Init(&A380PrimComputerFctl_DWork.PulseRejectNode,
    &A380PrimComputerFctl_P.PulseRejectNode);
  A380PrimComputerFctl_PulseRejectNode_Init(&A380PrimComputerFctl_DWork.PulseRejectNode1,
    &A380PrimComputerFctl_P.PulseRejectNode1);
  LawMDLOBJ2.init();
