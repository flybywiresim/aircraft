#ifndef A380FgOuterLoops_h_
#define A380FgOuterLoops_h_
#include "rtwtypes.h"
#include "A380FgOuterLoops_types.h"
#include <cstring>

class A380FgOuterLoops final
{
 public:
  struct rtDW_LagFilter_A380FgOuterLoops_T {
    real_T pY;
    real_T pU;
  ...
  struct rtDW_RateLimiter_A380FgOuterLoops_T {
    real_T pY;
    boolean_T pY_not_empty;
  };

  struct rtDW_MATLABFunction_A380FgOuterLoops_j_T {
    real_T limit;
    real_T lastPsi;
  ...
  struct rtDW_Chart_A380FgOuterLoops_T {
    uint8_T is_active_c10_A380FgOuterLoops;
    uint8_T is_c10_A380FgOuterLoops;
  };

  struct rtDW_RateLimiter_A380FgOuterLoops_o_T {
    real_T pY;
    boolean_T pY_not_empty;
  };

  struct rtDW_Chart_A380FgOuterLoops_k_T {
    uint8_T is_active_c15_A380FgOuterLoops;
    uint8_T is_c15_A380FgOuterLoops;
  };

  struct rtDW_storevalue_A380FgOuterLoops_T {
    real_T storage;
    boolean_T storage_not_empty;
  };

  struct rtDW_LeadLagFilter_A380FgOuterLoops_T {
    real_T pY;
    real_T pU;
    boolean_T pY_not_empty;
    boolean_T pU_not_empty;
  ...
  struct rtDW_WashoutFilter_A380FgOuterLoops_T {
    real_T pY;
    real_T pU;
    boolean_T pY_not_empty;
    boolean_T pU_not_empty;
  ...
  struct BlockIO_A380FgOuterLoops_T {
    real_T u;
  };

  struct D_Work_A380FgOuterLoops_T {
    real_T Delay_DSTATE;
    ...
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_mv;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_iz;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_i5;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_g;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_av;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_mr;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_ag;
    rtDW_RateLimiter_A380FgOuterLoops_T sf_RateLimiter_b;
    rtDW_RateLimiter_A380FgOuterLoops_o_T sf_RateLimiter_jx;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_hj;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_j;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_ip;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_eq;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_ay;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_k;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_h;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_oer;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_c;
    rtDW_storevalue_A380FgOuterLoops_T sf_storevalue_f;
    rtDW_RateLimiter_A380FgOuterLoops_o_T sf_RateLimiter_j;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_bd;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_l;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_ft;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_c;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_f5;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_fd;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_k;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_e;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_a;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_mm;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_m;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_oe;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_m;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_l;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_b;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_i;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_or;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_e;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_d;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_o;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter_k;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_o;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_l;
    rtDW_WashoutFilter_A380FgOuterLoops_T sf_WashoutFilter;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter_n;
    rtDW_LeadLagFilter_A380FgOuterLoops_T sf_LeadLagFilter;
    rtDW_Chart_A380FgOuterLoops_T sf_Chart_b;
    rtDW_MATLABFunction_A380FgOuterLoops_j_T sf_MATLABFunction_n;
    rtDW_RateLimiter_A380FgOuterLoops_o_T sf_RateLimiter_g;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_g;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_f;
    rtDW_storevalue_A380FgOuterLoops_T sf_storevalue;
    rtDW_Chart_A380FgOuterLoops_k_T sf_Chart_h;
    rtDW_RateLimiter_A380FgOuterLoops_o_T sf_RateLimiter_k;
    rtDW_RateLimiter_A380FgOuterLoops_o_T sf_RateLimiter_o;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_n;
    rtDW_Chart_A380FgOuterLoops_k_T sf_Chart_k;
    rtDW_RateLimiter_A380FgOuterLoops_o_T sf_RateLimiter_e;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_i;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_a;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter_m;
    rtDW_Chart_A380FgOuterLoops_T sf_Chart;
    rtDW_MATLABFunction_A380FgOuterLoops_j_T sf_MATLABFunction_g;
    rtDW_RateLimiter_A380FgOuterLoops_T sf_RateLimiter;
    rtDW_LagFilter_A380FgOuterLoops_T sf_LagFilter;
  };

  struct Parameters_A380FgOuterLoops_T {
    ...
    real_T ScheduledGain_BreakpointsForDimension1_ia[3];
    ...
    real_T HighPassFilter_C3_ec;
    real_T LowPassFilter_C3_a;
    real_T HighPassFilter_C3_ah;
    ...
    real_T Gain_Gain_jz;
    real_T fpmtoms_Gain;
    real_T kntoms_Gain_dv;
    real_T Saturation_UpperSat_d;
    real_T Saturation_LowerSat_kh;
    real_T Gain_Gain_hi;
    ...
    real_T Saturation_LowerSat_bs;
    real_T Gain_Gain_dn;
    real_T Gain1_Gain_pm1;
  ...
  void init();
  A380FgOuterLoops(A380FgOuterLoops const&) = delete;
  A380FgOuterLoops& operator= (A380FgOuterLoops const&) & = delete;
  A380FgOuterLoops(A380FgOuterLoops &&) = delete;
  A380FgOuterLoops& operator= (A380FgOuterLoops &&) = delete;
  void step(const ap_laws_input *rtu_in, ap_raw_output *rty_out);
  void reset();
  A380FgOuterLoops();
  ~A380FgOuterLoops();
 private:
  BlockIO_A380FgOuterLoops_T A380FgOuterLoops_B;
  D_Work_A380FgOuterLoops_T A380FgOuterLoops_DWork;
  static Parameters_A380FgOuterLoops_T A380FgOuterLoops_rtP;
  static void A380FgOuterLoops_MATLABFunction(real_T rtu_tau, real_T rtu_zeta, real_T *rty_k2, real_T *rty_k1);
  static void A380FgOuterLoops_LagFilter_Reset(rtDW_LagFilter_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_LagFilter(real_T rtu_U, real_T rtu_C1, real_T rtu_dt, real_T *rty_Y,
    rtDW_LagFilter_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_RateLimiter_Reset(rtDW_RateLimiter_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_RateLimiter(real_T rtu_u, real_T rtu_up, real_T rtu_lo, real_T rtu_Ts, real_T rtu_init,
    real_T *rty_Y, rtDW_RateLimiter_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_MATLABFunction_j_Init(rtDW_MATLABFunction_A380FgOuterLoops_j_T *localDW);
  static void A380FgOuterLoops_MATLABFunction_k_Reset(rtDW_MATLABFunction_A380FgOuterLoops_j_T *localDW);
  static void A380FgOuterLoops_MATLABFunction_g(real_T rtu_Psi_c, real_T rtu_dPsi, real_T rtu_Phi_c, real_T *rty_up,
    real_T *rty_lo, rtDW_MATLABFunction_A380FgOuterLoops_j_T *localDW);
  static void A380FgOuterLoops_Chart_Init(real_T *rty_out);
  static void A380FgOuterLoops_Chart_Reset(real_T *rty_out, rtDW_Chart_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_Chart(real_T rtu_right, real_T rtu_left, boolean_T rtu_use_short_path, real_T *rty_out,
    rtDW_Chart_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_RateLimiter_i_Reset(rtDW_RateLimiter_A380FgOuterLoops_o_T *localDW);
  static void A380FgOuterLoops_RateLimiter_e(boolean_T rtu_u, real_T rtu_up, real_T rtu_lo, real_T rtu_Ts, real_T
    rtu_init, real_T *rty_Y, rtDW_RateLimiter_A380FgOuterLoops_o_T *localDW);
  static void A380FgOuterLoops_Chart_p_Init(real_T *rty_out);
  static void A380FgOuterLoops_Chart_k_Reset(real_T *rty_out, rtDW_Chart_A380FgOuterLoops_k_T *localDW);
  static void A380FgOuterLoops_Chart_k(real_T rtu_right, real_T rtu_left, real_T rtu_use_short_path, real_T *rty_out,
    rtDW_Chart_A380FgOuterLoops_k_T *localDW);
  static void A380FgOuterLoops_storevalue_Reset(rtDW_storevalue_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_storevalue(boolean_T rtu_active, real_T rtu_u, real_T *rty_y,
    rtDW_storevalue_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_LeadLagFilter_Reset(rtDW_LeadLagFilter_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_LeadLagFilter(real_T rtu_U, real_T rtu_C1, real_T rtu_C2, real_T rtu_C3, real_T rtu_C4,
    real_T rtu_dt, real_T *rty_Y, rtDW_LeadLagFilter_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_WashoutFilter_Reset(rtDW_WashoutFilter_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_WashoutFilter(real_T rtu_U, real_T rtu_C1, real_T rtu_dt, real_T *rty_Y,
    rtDW_WashoutFilter_A380FgOuterLoops_T *localDW);
  static void A380FgOuterLoops_V_LSSpeedSelection1(real_T rtu_V_c, real_T rtu_VLS, real_T *rty_y);
  static void A380FgOuterLoops_SpeedProtectionSignalSelection(const ap_laws_output *rtu_in, real_T rtu_VS_FD, real_T
  ...
  static void A380FgOuterLoops_VSLimiter(real_T rtu_u, const ap_laws_output *rtu_in, real_T *rty_y);
  static void A380FgOuterLoops_SignalEnablerGSTrack(real_T rtu_u, boolean_T rtu_e, real_T *rty_y);
  static void A380FgOuterLoops_Voter1(real_T rtu_u1, real_T rtu_u2, real_T rtu_u3, real_T *rty_Y);
};

extern A380FgOuterLoops::Parameters_A380FgOuterLoops_T A380FgOuterLoops_rtP;
