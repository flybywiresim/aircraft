...
real_T Autothrust::Autothrust_timeSinceConditionArmedActive(real_T in_time_simulation_time, athr_status status)
{
  if (!Autothrust_DWork.eventTime_not_empty_p) {
    Autothrust_DWork.eventTime_e = in_time_simulation_time;
    Autothrust_DWork.eventTime_not_empty_p = true;
  }

  if ((status == athr_status::DISENGAGED) || (Autothrust_DWork.eventTime_e == 0.0)) {
    Autothrust_DWork.eventTime_e = in_time_simulation_time;
  }

  return in_time_simulation_time - Autothrust_DWork.eventTime_e;
}
...
void Autothrust::step()
{
  ...
  result_tmp = std::sin(Theta_rad);
  Theta_rad = std::cos(Theta_rad);
  rtb_Saturation = std::sin(Phi_rad);
  Phi_rad = std::cos(Phi_rad);
  result_tmp_0[0] = Theta_rad;
  result_tmp_0[3] = 0.0;
  result_tmp_0[6] = -result_tmp;
  result_tmp_0[1] = rtb_Saturation * result_tmp;
  result_tmp_0[4] = Phi_rad;
  result_tmp_0[7] = Theta_rad * rtb_Saturation;
  result_tmp_0[2] = Phi_rad * result_tmp;
  result_tmp_0[5] = 0.0 - rtb_Saturation;
  result_tmp_0[8] = Phi_rad * Theta_rad;
  result[0] = Autothrust_U.in.data.bx_m_s2;
  result[1] = Autothrust_U.in.data.by_m_s2;
  result[2] = Autothrust_U.in.data.bz_m_s2;
  result_tmp = 0.0;
  Phi_rad = 0.0;
  Theta_rad = 0.0;
  for (i = 0; i < 3; i++) {
    rtb_Switch_f_idx_2 = result[i];
    result_tmp += result_tmp_0[3 * i] * rtb_Switch_f_idx_2;
    Phi_rad += result_tmp_0[3 * i + 1] * rtb_Switch_f_idx_2;
    Theta_rad += result_tmp_0[3 * i + 2] * rtb_Switch_f_idx_2;
  }
  ...
  rtb_Saturation1 = Autothrust_P.Gain1_Gain_n * Autothrust_U.in.data.gear_strut_compression_2 -
    Autothrust_P.Constant1_Value_l;
  if (rtb_Saturation1 > Autothrust_P.Saturation1_UpperSat_g) {
    rtb_Saturation1 = Autothrust_P.Saturation1_UpperSat_g;
  } else if (rtb_Saturation1 < Autothrust_P.Saturation1_LowerSat_o) {
    rtb_Saturation1 = Autothrust_P.Saturation1_LowerSat_o;
  }
  ...
  rtb_BusAssignment_n.data.ax_m_s2 = result_tmp;
  rtb_BusAssignment_n.data.ay_m_s2 = Phi_rad;
  rtb_BusAssignment_n.data.az_m_s2 = Theta_rad;
  ...
  Autothrust_TimeSinceCondition(Autothrust_U.in.time.simulation_time, Autothrust_U.in.input.ATHR_disconnect,
    &rtb_Saturation1, &Autothrust_DWork.sf_TimeSinceCondition_o);
  Autothrust_DWork.Memory_PreviousInput = Autothrust_P.Logic_table[(((static_cast<uint32_T>(rtb_Saturation1 >=
  ...
  latch_tmp = ((Autothrust_U.in.input.flex_temperature_degC > Autothrust_U.in.data.TAT_degC) &&
               (Autothrust_U.in.input.flex_temperature_degC != 0.0) && (Autothrust_U.in.input.flight_phase < 3.0) &&
               (rtb_on_ground != 0));
  Autothrust_DWork.latch = ((latch_tmp && (Autothrust_U.in.input.TLA_1_deg == 35.0) && (Autothrust_U.in.input.TLA_2_deg ==
  ...
  rtb_y_h = (latch_tmp || ((rtb_on_ground == 0) && Autothrust_DWork.latch));
  ...
  rtb_r_d0 = (Autothrust_U.in.time.simulation_time - Autothrust_DWork.eventTime_i >=
  ...
  Autothrust_DWork.Memory_PreviousInput_m = Autothrust_P.Logic_table_m[(((static_cast<uint32_T>
    (Autothrust_DWork.Delay_DSTATE_as) << 1) + rtb_r_d0) << 1) + Autothrust_DWork.Memory_PreviousInput_m];
  rtb_BusAssignment_n.data_computed.ATHR_push = (rtb_Compare && (!Autothrust_DWork.Memory_PreviousInput_m));
  Autothrust_TimeSinceCondition(Autothrust_U.in.time.simulation_time, (rtb_on_ground != 0), &rtb_Saturation1,
  ...
  if ((!Autothrust_U.in.input.is_TCAS_active) || (Autothrust_DWork.eventTime_c == 0.0)) {
    Autothrust_DWork.eventTime_c = Autothrust_U.in.time.simulation_time;
  }
  ...
  Autothrust_DWork.sInhibit = (((!Autothrust_DWork.sInhibit) || (Autothrust_U.in.time.simulation_time -
    Autothrust_DWork.eventTime_c <= 5.0) || ((Autothrust_U.in.input.TLA_1_deg >= 25.0) &&
    (Autothrust_U.in.input.TLA_2_deg >= 25.0) && (Autothrust_U.in.input.TLA_3_deg >= 25.0) &&
  ...
  rtb_BusAssignment_n.data_computed.is_FLX_active = (latch_tmp || ((rtb_on_ground == 0) && Autothrust_DWork.latch));
  rtb_BusAssignment_n.data_computed.ATHR_disabled = Autothrust_DWork.Memory_PreviousInput;
  rtb_BusAssignment_n.data_computed.time_since_touchdown = rtb_Saturation1;
  rtb_BusAssignment_n.data_computed.alpha_floor_inhibited = Autothrust_DWork.sInhibit;
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_1_deg, &result_tmp, &rtb_r_k);
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_2_deg, &Phi_rad, &rtb_r_d0);
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_3_deg, &Theta_rad, &latch_tmp);
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_4_deg, &rtb_Saturation, &rtb_NOT1_c);
  condition_AP_FD_ATHR_Specific = !Autothrust_DWork.Memory_PreviousInput;
  Autothrust_DWork.condition_TOGA_latch = (((!Autothrust_DWork.prev_SRS_TO_GA_mode_active) &&
    (Autothrust_U.in.input.is_SRS_TO_mode_active || Autothrust_U.in.input.is_SRS_GA_mode_active)) ||
  ...
  if ((!Autothrust_DWork.condition_TOGA_latch) || (Autothrust_DWork.eventTime_p == 0.0)) {
    Autothrust_DWork.eventTime_p = Autothrust_U.in.time.simulation_time;
  }

  if (Autothrust_U.in.time.simulation_time - Autothrust_DWork.eventTime_p >= 0.3) {
    condition_TOGA = true;
  ...
  rtb_r_e = ((!Autothrust_DWork.sInhibit) && Autothrust_U.in.input.alpha_floor_condition &&
  ...
  rtb_Saturation1 = Autothrust_U.in.time.simulation_time - Autothrust_DWork.eventTime_a;
  Autothrust_DWork.ATHR_ENGAGED = ((condition_AP_FD_ATHR_Specific && (((rtb_on_ground == 0) &&
    (!Autothrust_DWork.ATHR_ENGAGED) && rtb_BusAssignment_n.data_computed.ATHR_push) || condition_TOGA || rtb_r_e ||
    (Autothrust_U.in.input.is_TCAS_active && (!Autothrust_DWork.prev_condition_TCAS)))) ||
    (condition_AP_FD_ATHR_Specific && ((!rtb_BusAssignment_n.data_computed.ATHR_push) || (!Autothrust_DWork.ATHR_ENGAGED)
    || Autothrust_U.in.input.is_LAND_mode_active) && (!Autothrust_U.in.input.ATHR_disconnect) && ((rtb_Saturation1 < 0.3)
    || (rtb_Saturation1 >= 0.5)) && Autothrust_DWork.ATHR_ENGAGED));
  condition_AP_FD_ATHR_Specific = (Autothrust_DWork.ATHR_ENGAGED && (rtb_out || rtb_r_e));
  ...
  Autothrust_DWork.prev_condition_AlphaFloor = (Autothrust_U.in.input.alpha_floor_condition &&
    (!Autothrust_DWork.sInhibit));
  Autothrust_DWork.prev_condition_TCAS = Autothrust_U.in.input.is_TCAS_active;
  Autothrust_DWork.prev_SRS_TO_GA_mode_active = (Autothrust_U.in.input.is_SRS_TO_mode_active ||
    Autothrust_U.in.input.is_SRS_GA_mode_active);
  ...
  rtb_Saturation1 = maximum_Y6vyn2io(tmp);
  ...
  condition_TOGA = (((Autothrust_U.in.data.is_engine_operative_1 && (Autothrust_U.in.input.TLA_1_deg == 35.0)) ||
                     ((!Autothrust_U.in.data.is_engine_operative_1) && (Autothrust_U.in.input.TLA_1_deg <= 35.0))) &&
                    ...
                    ((Autothrust_U.in.data.is_engine_operative_3 && (Autothrust_U.in.input.TLA_4_deg == 35.0)) ||
                     ((!Autothrust_U.in.data.is_engine_operative_3) && (Autothrust_U.in.input.TLA_4_deg <= 35.0))));
  rtb_r_e = (Autothrust_U.in.input.alpha_floor_condition && (!Autothrust_DWork.sInhibit));
  Autothrust_DWork.pConditionAlphaFloor = (rtb_r_e || ((status != athr_status::DISENGAGED) &&
  ...
  if (status == athr_status::DISENGAGED) {
  ...
  } else if ((status == athr_status::ENGAGED_ARMED) && rtb_y_h && (rtb_Saturation1 == 35.0)) {
    ...
    Autothrust_DWork.pMode = athr_mode::MAN_MCT;
             ...
             condition_AP_FD_ATHR_Specific && condition_TOGA) {
    ...
    Autothrust_DWork.pMode = athr_mode::THR_CLB;
             ...
             ((Autothrust_U.in.data.is_engine_operative_1 && Autothrust_U.in.data.is_engine_operative_2 &&
               Autothrust_U.in.data.is_engine_operative_4 && Autothrust_U.in.data.is_engine_operative_3 &&
               (Autothrust_U.in.input.TLA_1_deg < 25.0) && (Autothrust_U.in.input.TLA_2_deg < 25.0) &&
               (Autothrust_U.in.input.TLA_3_deg < 25.0) && (Autothrust_U.in.input.TLA_4_deg < 25.0)) ||
              (condition_AP_FD_ATHR_Specific && (Autothrust_U.in.data.is_engine_operative_1 &&
                (Autothrust_U.in.input.TLA_1_deg < 35.0) && Autothrust_U.in.data.is_engine_operative_2 &&
                (Autothrust_U.in.input.TLA_2_deg < 35.0) && Autothrust_U.in.data.is_engine_operative_4 &&
                (Autothrust_U.in.input.TLA_3_deg < 35.0) && Autothrust_U.in.data.is_engine_operative_3 &&
  ...
  } else if ((status == athr_status::ENGAGED_ARMED) && ((Autothrust_U.in.data.is_engine_operative_1 &&
               Autothrust_U.in.data.is_engine_operative_2 && Autothrust_U.in.data.is_engine_operative_4 &&
               Autothrust_U.in.data.is_engine_operative_3 && (rtb_Saturation1 > 25.0) && (rtb_Saturation1 < 35.0)) ||
              ((rtb_Saturation1 > 35.0) && (rtb_Saturation1 < 45.0)))) {
  ...
  Autothrust_DWork.condition_THR_LK = (((status == athr_status::DISENGAGED) && (Autothrust_DWork.pStatus != athr_status::
    DISENGAGED) && (!Autothrust_U.in.input.ATHR_disconnect) && ((Autothrust_U.in.data.is_engine_operative_1 &&
    Autothrust_U.in.data.is_engine_operative_2 && Autothrust_U.in.data.is_engine_operative_4 &&
    Autothrust_U.in.data.is_engine_operative_3 && (Autothrust_U.in.input.TLA_1_deg == 25.0) &&
    (Autothrust_U.in.input.TLA_2_deg == 25.0) && (Autothrust_U.in.input.TLA_3_deg == 25.0) &&
    (Autothrust_U.in.input.TLA_4_deg == 25.0)) || (condition_AP_FD_ATHR_Specific && condition_TOGA))) ||
  ...
  if (rtb_Saturation1 < Autothrust_U.in.input.TLA_3_deg) {
    rtb_Saturation1 = Autothrust_U.in.input.TLA_3_deg;
  }

  if (rtb_Saturation1 < Autothrust_U.in.input.TLA_4_deg) {
    rtb_Saturation1 = Autothrust_U.in.input.TLA_4_deg;
  }

  if (rtb_on_ground == 0) {
    rtb_Saturation1 = std::fmax(0.0, rtb_Saturation1);
  }

  if ((rtb_on_ground == 0) || ((!Autothrust_U.in.data.is_engine_operative_1) &&
       (!Autothrust_U.in.data.is_engine_operative_2) && (!Autothrust_U.in.data.is_engine_operative_4) &&
       (!Autothrust_U.in.data.is_engine_operative_3))) {
    ...
    } else if (rtb_Saturation1 > 35.0) {
      Autothrust_Y.out.output.thrust_limit_type = athr_thrust_limit_type::TOGA;
      Autothrust_Y.out.output.thrust_limit_percent = Autothrust_U.in.input.thrust_limit_TOGA_percent;
    } else if (rtb_Saturation1 > 25.0) {
      if (!rtb_y_h) {
    ...
    if ((!rtb_y_h) || (rtb_Saturation1 > 35.0)) {
      Autothrust_Y.out.output.thrust_limit_type = athr_thrust_limit_type::TOGA;
      Autothrust_Y.out.output.thrust_limit_percent = Autothrust_U.in.input.thrust_limit_TOGA_percent;
    } else {
      Autothrust_Y.out.output.thrust_limit_type = athr_thrust_limit_type::FLEX;
  ...
  condition_TOGA = rtb_r_d0;
  rtb_r_d0 = ((status == athr_status::ENGAGED_ACTIVE) && (((Autothrust_U.in.input.TLA_1_deg <= 35.0) &&
    (Autothrust_U.in.input.TLA_2_deg <= 35.0) && (Autothrust_U.in.input.TLA_3_deg <= 35.0) &&
  ...
  Autothrust_DWork.pThrustMemoActive = ((((Autothrust_U.in.input.ATHR_push && (status != athr_status::DISENGAGED)) ||
    (rtb_r_e && Autothrust_DWork.pUseAutoThrustControl && (!Autothrust_U.in.input.ATHR_disconnect))) &&
    ((Autothrust_U.in.data.is_engine_operative_1 && Autothrust_U.in.data.is_engine_operative_2 &&
      Autothrust_U.in.data.is_engine_operative_4 && Autothrust_U.in.data.is_engine_operative_3 &&
      (Autothrust_U.in.input.TLA_1_deg == 25.0) && (Autothrust_U.in.input.TLA_2_deg == 25.0) &&
      (Autothrust_U.in.input.TLA_3_deg == 25.0) && (Autothrust_U.in.input.TLA_4_deg == 25.0)) ||
     (((!Autothrust_U.in.data.is_engine_operative_1) || (!Autothrust_U.in.data.is_engine_operative_2) ||
      ...
      (((Autothrust_U.in.data.is_engine_operative_1 && (Autothrust_U.in.input.TLA_1_deg == 35.0)) ||
       ...
       ((Autothrust_U.in.data.is_engine_operative_4 && (Autothrust_U.in.input.TLA_3_deg == 35.0)) ||
        ((!Autothrust_U.in.data.is_engine_operative_4) && (Autothrust_U.in.input.TLA_3_deg <= 35.0))) &&
       ((Autothrust_U.in.data.is_engine_operative_3 && (Autothrust_U.in.input.TLA_4_deg == 35.0)) ||
        ((!Autothrust_U.in.data.is_engine_operative_3) && (Autothrust_U.in.input.TLA_4_deg <= 35.0))))))) || (rtb_r_e &&
    ((Autothrust_U.in.input.TLA_1_deg == 25.0) || (Autothrust_U.in.input.TLA_1_deg == 35.0) ||
     (Autothrust_U.in.input.TLA_2_deg == 25.0) || (Autothrust_U.in.input.TLA_2_deg == 35.0) ||
     (Autothrust_U.in.input.TLA_3_deg == 25.0) || (Autothrust_U.in.input.TLA_3_deg == 35.0) ||
     (Autothrust_U.in.input.TLA_4_deg == 25.0) || (Autothrust_U.in.input.TLA_4_deg == 35.0)) &&
    Autothrust_DWork.pThrustMemoActive));
  Autothrust_DWork.pUseAutoThrustControl = rtb_r_d0;
  if (Autothrust_U.in.data.is_engine_operative_1 && Autothrust_U.in.data.is_engine_operative_2 &&
      Autothrust_U.in.data.is_engine_operative_4 && Autothrust_U.in.data.is_engine_operative_3) {
    rtb_Switch_oq = Autothrust_U.in.input.thrust_limit_CLB_percent;
  } else {
    rtb_Switch_oq = Autothrust_U.in.input.thrust_limit_MCT_percent;
  }
  ...
  rtb_Switch_c5 = result[i] - Autothrust_U.in.data.V_ias_kn;
  rtb_Switch_fk = Autothrust_P.Gain1_Gain_ot * rtb_Gain3;
  if (Autothrust_U.in.data.V_gnd_kn > Autothrust_P.Saturation_UpperSat_f) {
    rtb_Switch_j = Autothrust_P.Saturation_UpperSat_f;
  } else if (Autothrust_U.in.data.V_gnd_kn < Autothrust_P.Saturation_LowerSat_ev) {
    rtb_Switch_j = Autothrust_P.Saturation_LowerSat_ev;
  } else {
    rtb_Switch_j = Autothrust_U.in.data.V_gnd_kn;
  }
  ...
  Autothrust_WashoutFilter(Autothrust_P._Gain * (1.0 / std::sqrt(rtb_Switch_f_idx_2) * (Autothrust_P.GStoGS_CAS_Gain *
    (Autothrust_P.ktstomps_Gain * rtb_Switch_j))), Autothrust_P.WashoutFilter_C1, Autothrust_U.in.time.dt,
    &rtb_Saturation1, &Autothrust_DWork.sf_WashoutFilter);
  ...
  Autothrust_LeadLagFilter(rtb_Saturation1 - Autothrust_P.g_Gain * (Autothrust_P.Gain1_Gain_c *
    (Autothrust_P.Gain_Gain_j * ((Autothrust_P.Gain1_Gain_n0 * rtb_Gain2 - Autothrust_P.Gain1_Gain_j *
    (Autothrust_P.Gain_Gain_c * std::atan(Autothrust_P.fpmtoms_Gain * Autothrust_U.in.data.H_dot_fpm / rtb_Gain_m))) *
    (Autothrust_P.Constant_Value - std::cos(rtb_Switch_fk)) + std::sin(rtb_Switch_fk) * std::sin
    ...
    Autothrust_P.HighPassFilter_C3, Autothrust_P.HighPassFilter_C4, Autothrust_U.in.time.dt, &rtb_y_p,
  ...
  Autothrust_LeadLagFilter(Autothrust_P.ktstomps_Gain_h * rtb_Switch_f_idx_2, Autothrust_P.LowPassFilter_C1,
    ...
    &rtb_Saturation1, &Autothrust_DWork.sf_LeadLagFilter_h);
  rtb_Switch_fk = (rtb_y_p + rtb_Saturation1) * Autothrust_P.mpstokts_Gain * Autothrust_P.Gain4_Gain * look1_binlxpw
    (rtb_Switch_c5, Autothrust_P.ScheduledGain1_BreakpointsForDimension1, Autothrust_P.ScheduledGain1_Table, 4U) +
    rtb_Switch_c5;
  rtb_Gain_m = Autothrust_P.DiscreteDerivativeVariableTs_Gain * rtb_Switch_fk;
  Autothrust_LagFilter(Autothrust_P.Gain5_Gain * ((rtb_Gain_m - Autothrust_DWork.Delay_DSTATE) / Autothrust_U.in.time.dt),
                       Autothrust_P.LagFilter_C1, Autothrust_U.in.time.dt, &rtb_Switch_c5,
                       &Autothrust_DWork.sf_LagFilter);
  ...
  Autothrust_WashoutFilter(Autothrust_P.Gain2_Gain_c * rtb_Gain2, Autothrust_P.WashoutFilter_C1_c,
    Autothrust_U.in.time.dt, &rtb_Saturation1, &Autothrust_DWork.sf_WashoutFilter_h);
  ...
  switch (static_cast<int32_T>(rtb_Switch_f_idx_2)) {
   case 0:
    rtb_Switch_fk = Autothrust_P.Constant1_Value;
    break;

   case 1:
    rtb_Switch_fk = ((Autothrust_P.Gain_Gain * rtb_Switch_fk + rtb_Switch_c5) + (Autothrust_P.Gain1_Gain * rtb_Gain2 +
      Autothrust_P.Gain3_Gain * rtb_Saturation1)) * look1_binlxpw(std::fmin(std::fmin(std::fmin
    ...
    if (rtb_Switch_fk > Autothrust_P.Saturation1_UpperSat) {
      rtb_Switch_fk = Autothrust_P.Saturation1_UpperSat;
    } else if (rtb_Switch_fk < Autothrust_P.Saturation1_LowerSat) {
      rtb_Switch_fk = Autothrust_P.Saturation1_LowerSat;
    }
    break;

   case 2:
    rtb_Switch_fk = Autothrust_P.Gain1_Gain_p * look1_binlxpw(std::fmin(std::fmin(std::fmin
      (rtb_BusAssignment_n.data.commanded_engine_N1_1_percent, rtb_BusAssignment_n.data.commanded_engine_N1_2_percent),
      rtb_BusAssignment_n.data.commanded_engine_N1_3_percent), rtb_BusAssignment_n.data.commanded_engine_N1_4_percent),
      Autothrust_P.uDLookupTable_bp01Data, Autothrust_P.uDLookupTable_tableData, 6U);
    if (rtb_Switch_fk > Autothrust_P.Saturation_UpperSat) {
      rtb_Switch_fk = Autothrust_P.Saturation_UpperSat;
    } else if (rtb_Switch_fk < Autothrust_P.Saturation_LowerSat) {
      rtb_Switch_fk = Autothrust_P.Saturation_LowerSat;
    }
    break;

   case 3:
    rtb_Switch_fk = Autothrust_P.Gain1_Gain_o * look1_binlxpw(std::fmin(std::fmin(std::fmin
      (rtb_BusAssignment_n.data.commanded_engine_N1_1_percent, rtb_BusAssignment_n.data.commanded_engine_N1_2_percent),
      rtb_BusAssignment_n.data.commanded_engine_N1_3_percent), rtb_BusAssignment_n.data.commanded_engine_N1_4_percent),
      Autothrust_P.uDLookupTable_bp01Data_b, Autothrust_P.uDLookupTable_tableData_o, 6U);
    if (rtb_Switch_fk > Autothrust_P.Saturation_UpperSat_a) {
      rtb_Switch_fk = Autothrust_P.Saturation_UpperSat_a;
    } else if (rtb_Switch_fk < Autothrust_P.Saturation_LowerSat_a) {
      rtb_Switch_fk = Autothrust_P.Saturation_LowerSat_a;
    }
    break;

   default:
    rtb_Switch_fk = Autothrust_P.RETARD_Value;
    break;
  }

  rtb_Switch_fk = Autothrust_P.DiscreteTimeIntegratorVariableTsLimit_Gain * rtb_Switch_fk * Autothrust_U.in.time.dt;
  rtb_r_e = (mode == Autothrust_P.CompareToConstant2_const_c);
  rtb_r_d0 = (mode == Autothrust_P.CompareToConstant3_const_k);
  Autothrust_DWork.icLoad = ((status != Autothrust_P.CompareToConstant_const_d) || (rtb_r_e || rtb_r_d0) ||
  ...
  Autothrust_DWork.Delay_DSTATE_k += rtb_Switch_fk;
  if (Autothrust_DWork.Delay_DSTATE_k > rtb_Switch_oq) {
    Autothrust_DWork.Delay_DSTATE_k = rtb_Switch_oq;
  ...
  if (Autothrust_DWork.pUseAutoThrustControl) {
    if ((mode == Autothrust_P.CompareToConstant2_const_h) || (mode == Autothrust_P.CompareToConstant3_const)) {
      ...
      if (Autothrust_U.in.input.thrust_limit_TOGA_percent < rtb_Saturation) {
        rtb_Switch_f_idx_3 = rtb_Saturation;
      } else {
  ...
  Autothrust_Y.out.output.is_in_reverse_1 = rtb_r_k;
  Autothrust_A380XN1fanprotection(Autothrust_U.in.data.V_ias_kn, rtb_Gain2, &rtb_y_p);
  Autothrust_MATLABFunction(rtb_y_p - Autothrust_U.in.data.engine_N1_1_percent, &rtb_Saturation1, &rtb_r_d0);
  if (rtb_r_d0) {
    Autothrust_DWork.Delay_DSTATE_e = Autothrust_P.DiscreteTimeIntegratorVariableTs_InitialCondition;
  }

  Autothrust_DWork.Delay_DSTATE_e += Autothrust_P.Gain_Gain_l * rtb_Saturation1 *
  ...
  rtb_Switch_fk = (rtb_y_p + Autothrust_DWork.Delay_DSTATE_e) - rtb_BusAssignment_n.data.commanded_engine_N1_1_percent;
  if (rtb_r_k) {
    Autothrust_DWork.Delay_DSTATE_n = Autothrust_P.DiscreteTimeIntegratorVariableTs_InitialCondition_p;
  }

  Autothrust_DWork.Delay_DSTATE_n += Autothrust_P.Gain_Gain_d3 * rtb_Switch_fk *
  ...
  Autothrust_DWork.Delay_DSTATE_l += Autothrust_P.Gain1_Gain_h * rtb_Switch_fk *
  ...
  Autothrust_MATLABFunction(rtb_Switch_c5 - Autothrust_U.in.data.engine_N1_2_percent, &rtb_y_p, &rtb_r_d0);
  if (rtb_r_d0) {
  ...
  rtb_Switch_oq = (rtb_Switch_c5 + Autothrust_DWork.Delay_DSTATE_a) -
    rtb_BusAssignment_n.data.commanded_engine_N1_2_percent;
  if (condition_TOGA) {
    Autothrust_DWork.Delay_DSTATE_lz = Autothrust_P.DiscreteTimeIntegratorVariableTs_InitialCondition_n;
  }

  Autothrust_DWork.Delay_DSTATE_lz += Autothrust_P.Gain_Gain_b * rtb_Switch_oq *
  ...
  Autothrust_MATLABFunction(rtb_Switch_j - Autothrust_U.in.data.engine_N1_3_percent, &rtb_Switch_c5, &rtb_r_e);
  if (rtb_r_e) {
    Autothrust_DWork.Delay_DSTATE_au = Autothrust_P.DiscreteTimeIntegratorVariableTs_InitialCondition_i;
  }

  Autothrust_DWork.Delay_DSTATE_au += Autothrust_P.Gain_Gain_i * rtb_Switch_c5 *
  ...
  rtb_Switch_c5 = (rtb_Switch_j + Autothrust_DWork.Delay_DSTATE_au) -
  ...
  rtb_Switch_j = Autothrust_P.Gain_Gain_n * rtb_Switch_c5 * Autothrust_P.DiscreteTimeIntegratorVariableTs_Gain_e *
    Autothrust_U.in.time.dt + Autothrust_DWork.Delay_DSTATE_j;
  if (rtb_Switch_j > Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_e) {
    Autothrust_DWork.Delay_DSTATE_j = Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_e;
  } else if (rtb_Switch_j < Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_n) {
    Autothrust_DWork.Delay_DSTATE_j = Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_n;
  } else {
    Autothrust_DWork.Delay_DSTATE_j = rtb_Switch_j;
  }
  ...
  Autothrust_DWork.Delay_DSTATE_o += Autothrust_P.Gain1_Gain_a * rtb_Switch_c5 *
  ...
  Autothrust_MATLABFunction(rtb_Switch_fk - Autothrust_U.in.data.engine_N1_4_percent, &rtb_Switch_j, &rtb_r_k);
  if (rtb_r_k) {
    Autothrust_DWork.Delay_DSTATE_e1 = Autothrust_P.DiscreteTimeIntegratorVariableTs_InitialCondition_fg;
  }

  Autothrust_DWork.Delay_DSTATE_e1 += Autothrust_P.Gain_Gain_a * rtb_Switch_j *
  ...
  rtb_Switch_j = (rtb_Switch_fk + Autothrust_DWork.Delay_DSTATE_e1) -
  ...
  rtb_Switch_fk = Autothrust_P.Gain_Gain_p * rtb_Switch_j * Autothrust_P.DiscreteTimeIntegratorVariableTs_Gain_n *
    Autothrust_U.in.time.dt + Autothrust_DWork.Delay_DSTATE_lr;
  if (rtb_Switch_fk > Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_g) {
    Autothrust_DWork.Delay_DSTATE_lr = Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_g;
  } else if (rtb_Switch_fk < Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_p) {
    Autothrust_DWork.Delay_DSTATE_lr = Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_p;
  } else {
    Autothrust_DWork.Delay_DSTATE_lr = rtb_Switch_fk;
  }
  ...
  Autothrust_DWork.Delay_DSTATE_p += Autothrust_P.Gain1_Gain_pv * rtb_Switch_j *
  ...
  Autothrust_ThrustMode1(Autothrust_U.in.input.TLA_4_deg, &rtb_Switch_fk);
  ...
  Autothrust_Y.out.output.sim_thrust_mode_3 = rtb_Switch_c5;
  Autothrust_Y.out.output.sim_thrust_mode_4 = rtb_Switch_fk;
  ...
  Autothrust_Y.out.output.N1_TLA_4_percent = rtb_Saturation;
  Autothrust_Y.out.output.is_in_reverse_2 = condition_TOGA;
  Autothrust_Y.out.output.is_in_reverse_3 = latch_tmp;
  ...
  rtb_r_d0 = (((!Autothrust_U.in.input.is_SRS_TO_mode_active) || ((Autothrust_U.in.data.H_ind_ft >=
    ...
    Autothrust_U.in.input.thrust_reduction_altitude_go_around) && (!Autothrust_DWork.inhibitAboveThrustReductionAltitude)))
              && ((Autothrust_U.in.data.H_radio_ft > 400.0) || (Autothrust_U.in.input.flight_phase > 2.0)) &&
              ((!Autothrust_U.in.input.is_TCAS_active) || (Autothrust_U.in.input.target_TCAS_RA_rate_fpm <= 500.0) ||
               (Autothrust_U.in.input.TLA_1_deg <= 25.0) || (Autothrust_U.in.input.TLA_2_deg <= 25.0) ||
               (Autothrust_U.in.input.TLA_3_deg <= 25.0) || (Autothrust_U.in.input.TLA_4_deg <= 25.0)));
  if ((status != athr_status::DISENGAGED) && (Autothrust_DWork.pMode != athr_mode::A_FLOOR) && (Autothrust_DWork.pMode
       != athr_mode::TOGA_LK) && (rtb_on_ground == 0) && (rtb_r_d0 || (Autothrust_U.in.input.is_TCAS_active &&
    ...
    Autothrust_Y.out.output.mode_message = athr_mode_message::LVR_CLB;
             ...
             (Autothrust_DWork.pMode != athr_mode::TOGA_LK) && (rtb_on_ground == 0) && rtb_r_d0 &&
             ((!Autothrust_U.in.data.is_engine_operative_1) || (!Autothrust_U.in.data.is_engine_operative_2) ||
              (!Autothrust_U.in.data.is_engine_operative_4) || (!Autothrust_U.in.data.is_engine_operative_3)) &&
