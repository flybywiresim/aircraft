...
void Autothrust::step()
{
  ...
  real_T rtb_BusAssignment_e_output_N1_TLA_3_percent;
  real_T rtb_BusAssignment_e_output_N1_TLA_4_percent;
  real_T rtb_Gain2;
  real_T rtb_Gain3;
  real_T rtb_Gain_m;
  ...
  rtb_Saturation = (Autothrust_U.in.data.engine_N1_1_percent + Autothrust_U.in.data.commanded_engine_N1_1_percent) -
    Autothrust_U.in.data.corrected_engine_N1_1_percent;
  Phi_rad = (Autothrust_U.in.data.engine_N1_2_percent + Autothrust_U.in.data.commanded_engine_N1_2_percent) -
    Autothrust_U.in.data.corrected_engine_N1_2_percent;
  rtb_Switch_d = (Autothrust_U.in.data.engine_N1_3_percent + Autothrust_U.in.data.commanded_engine_N1_3_percent) -
    Autothrust_U.in.data.corrected_engine_N1_3_percent;
  Theta_rad = (Autothrust_U.in.data.engine_N1_4_percent + Autothrust_U.in.data.commanded_engine_N1_4_percent) -
    Autothrust_U.in.data.corrected_engine_N1_4_percent;
  Autothrust_TimeSinceCondition(Autothrust_U.in.time.simulation_time, Autothrust_U.in.input.ATHR_disconnect, &rtb_y_p,
    &Autothrust_DWork.sf_TimeSinceCondition_o);
  Autothrust_DWork.Memory_PreviousInput = Autothrust_P.Logic_table[(((static_cast<uint32_T>(rtb_y_p >=
  ...
  rtb_r_e = ((Autothrust_U.in.input.flex_temperature_degC > Autothrust_U.in.data.TAT_degC) &&
             (Autothrust_U.in.input.flex_temperature_degC != 0.0) && (Autothrust_U.in.input.flight_phase < 3.0));
  Autothrust_DWork.latch = ((rtb_r_e && (rtb_on_ground != 0) && (Autothrust_U.in.input.TLA_1_deg == 35.0) &&
  ...
  rtb_y_o = ((rtb_r_e && (rtb_on_ground != 0)) || ((rtb_on_ground == 0) && Autothrust_DWork.latch));
  ...
  rtb_r_i = (Autothrust_U.in.time.simulation_time - Autothrust_DWork.eventTime_jx >=
  ...
  Autothrust_DWork.Memory_PreviousInput_m = Autothrust_P.Logic_table_m[(((static_cast<uint32_T>
    (Autothrust_DWork.Delay_DSTATE_as) << 1) + rtb_r_i) << 1) + Autothrust_DWork.Memory_PreviousInput_m];
  rtb_NOT1_c = (rtb_Compare && (!Autothrust_DWork.Memory_PreviousInput_m));
  Autothrust_TimeSinceCondition(Autothrust_U.in.time.simulation_time, rtb_on_ground != 0, &rtb_y_p,
  ...
  rtb_BusAssignment_n.data.is_engine_operative_3 = Autothrust_U.in.data.is_engine_operative_3;
  rtb_BusAssignment_n.data.is_engine_operative_4 = Autothrust_U.in.data.is_engine_operative_3;
  rtb_BusAssignment_n.data.commanded_engine_N1_1_percent = rtb_Saturation;
  rtb_BusAssignment_n.data.commanded_engine_N1_2_percent = Phi_rad;
  rtb_BusAssignment_n.data.commanded_engine_N1_3_percent = rtb_Switch_d;
  rtb_BusAssignment_n.data.commanded_engine_N1_4_percent = Theta_rad;
  ...
  result_tmp = std::fmax(15.0 - 0.0019812 * Autothrust_U.in.data.H_ft, -56.5);
  rtb_BusAssignment_n.data.ISA_degC = result_tmp;
  ...
  rtb_BusAssignment_n.data_computed.is_FLX_active = ((rtb_r_e && (rtb_on_ground != 0)) || ((rtb_on_ground == 0) &&
    Autothrust_DWork.latch));
  rtb_BusAssignment_n.data_computed.ATHR_push = rtb_NOT1_c;
  rtb_BusAssignment_n.data_computed.ATHR_disabled = Autothrust_DWork.Memory_PreviousInput;
  rtb_BusAssignment_n.data_computed.time_since_touchdown = rtb_y_p;
  rtb_BusAssignment_n.data_computed.alpha_floor_inhibited = Autothrust_DWork.sInhibit;
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_1_deg, &Phi_rad, &rtb_r_e);
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_2_deg, &rtb_Switch_d, &rtb_r_i);
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_3_deg, &Theta_rad,
    &Autothrust_DWork.Delay_DSTATE_as);
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_4_deg,
    &rtb_BusAssignment_e_output_N1_TLA_4_percent, &rtb_NOT1_c);
  ...
  rtb_y_p = Autothrust_U.in.time.simulation_time - Autothrust_DWork.eventTime_o;
  ATHR_ENGAGED_tmp = !Autothrust_DWork.ATHR_ENGAGED;
  rtb_r_n = !Autothrust_U.in.input.ATHR_disconnect;
  Autothrust_DWork.ATHR_ENGAGED = ((condition_AP_FD_ATHR_Specific && (((rtb_on_ground == 0) && ATHR_ENGAGED_tmp &&
    ...
    Autothrust_U.in.input.is_LAND_mode_active) && rtb_r_n && ((rtb_y_p < 0.3) || (rtb_y_p >= 0.5)) &&
  ...
  if (status == athr_status::DISENGAGED) {
  ...
  } else if ((status == athr_status::ENGAGED_ARMED) && rtb_y_o && (rtb_y_p == 35.0)) {
    ...
    if ((status == athr_status::ENGAGED_ACTIVE) && (Autothrust_U.in.input.mode_requested == 3.0) &&
      ...
      Autothrust_DWork.pMode = athr_mode::THR_MCT;
               ...
               Autothrust_U.in.data.is_engine_operative_1 && Autothrust_U.in.data.is_engine_operative_2 && (rtb_y_p ==
                25.0)) {
      ...
      } else if ((status == athr_status::ENGAGED_ARMED) && ((condition_TOGA && (rtb_y_p > 25.0) && (rtb_y_p < 35.0)) ||
                  ((rtb_y_p > 35.0) && (rtb_y_p < 45.0)))) {
  ...
  Autothrust_DWork.condition_THR_LK = (((status == athr_status::DISENGAGED) && (Autothrust_DWork.pStatus != athr_status::
    DISENGAGED) && rtb_r_n && ((condition_AlphaFloor && (Autothrust_U.in.input.TLA_1_deg == 25.0) &&
  ...
  if ((rtb_on_ground == 0) || (condition_AP_FD_ATHR_Specific && condition_AlphaFloor_tmp)) {
    ...
    } else if (rtb_y_p > 35.0) {
      Autothrust_Y.out.output.thrust_limit_type = athr_thrust_limit_type::TOGA;
      Autothrust_Y.out.output.thrust_limit_percent = Autothrust_U.in.input.thrust_limit_TOGA_percent;
    } else if (rtb_y_p > 25.0) {
      if (!rtb_y_o) {
  ...
  rtb_BusAssignment_e_output_N1_TLA_2_percent = rtb_Switch_d;
  rtb_BusAssignment_e_output_N1_TLA_3_percent = Theta_rad;
  condition_TOGA = rtb_r_i;
  rtb_r_i = ((status == athr_status::ENGAGED_ACTIVE) && (((Autothrust_U.in.input.TLA_1_deg <= 35.0) &&
    (Autothrust_U.in.input.TLA_2_deg <= 35.0)) || Autothrust_U.in.input.alpha_floor_condition));
  pThrustMemoActive_tmp = !rtb_r_i;
  Autothrust_DWork.pThrustMemoActive = ((((Autothrust_U.in.input.ATHR_push && (status != athr_status::DISENGAGED)) ||
    (pThrustMemoActive_tmp && Autothrust_DWork.pUseAutoThrustControl && rtb_r_n)) && ((condition_AlphaFloor &&
  ...
  Autothrust_DWork.pUseAutoThrustControl = rtb_r_i;
  if (Autothrust_U.in.data.is_engine_operative_1 && Autothrust_U.in.data.is_engine_operative_2) {
  ...
  rtb_Switch_d = v[i] - Autothrust_U.in.data.V_ias_kn;
  rtb_Switch_fs = Autothrust_P.Gain1_Gain_ot * rtb_Gain3;
  if (Autothrust_U.in.data.ambient_density_kg_per_m3 > Autothrust_P.Saturation2_UpperSat) {
    rtb_Switch_f_idx_0 = Autothrust_P.Saturation2_UpperSat;
  } else if (Autothrust_U.in.data.ambient_density_kg_per_m3 < Autothrust_P.Saturation2_LowerSat) {
    rtb_Switch_f_idx_0 = Autothrust_P.Saturation2_LowerSat;
  } else {
    rtb_Switch_f_idx_0 = Autothrust_U.in.data.ambient_density_kg_per_m3;
  }

  if (Autothrust_U.in.data.V_gnd_kn > Autothrust_P.Saturation_UpperSat_f) {
    rtb_y_hw = Autothrust_P.Saturation_UpperSat_f;
  } else if (Autothrust_U.in.data.V_gnd_kn < Autothrust_P.Saturation_LowerSat_ev) {
    rtb_y_hw = Autothrust_P.Saturation_LowerSat_ev;
  } else {
    rtb_y_hw = Autothrust_U.in.data.V_gnd_kn;
  }

  Autothrust_WashoutFilter(Autothrust_P._Gain * (1.0 / std::sqrt(rtb_Switch_f_idx_0) * (Autothrust_P.GStoGS_CAS_Gain *
    (Autothrust_P.ktstomps_Gain * rtb_y_hw))), Autothrust_P.WashoutFilter_C1, Autothrust_U.in.time.dt, &rtb_y_p,
  ...
  Autothrust_LeadLagFilter(rtb_y_p - Autothrust_P.g_Gain * (Autothrust_P.Gain1_Gain_c * (Autothrust_P.Gain_Gain_j *
    ...
    cos(rtb_Switch_fs)) + std::sin(rtb_Switch_fs) * std::sin(Autothrust_P.Gain1_Gain_d *
    ...
    Autothrust_P.HighPassFilter_C4, Autothrust_U.in.time.dt, &rtb_y_hw, &Autothrust_DWork.sf_LeadLagFilter);
  if (Autothrust_U.in.data.V_ias_kn > Autothrust_P.Saturation1_UpperSat_c) {
    rtb_Switch_f_idx_0 = Autothrust_P.Saturation1_UpperSat_c;
  } else if (Autothrust_U.in.data.V_ias_kn < Autothrust_P.Saturation1_LowerSat_g) {
    rtb_Switch_f_idx_0 = Autothrust_P.Saturation1_LowerSat_g;
  } else {
    rtb_Switch_f_idx_0 = Autothrust_U.in.data.V_ias_kn;
  }

  Autothrust_LeadLagFilter(Autothrust_P.ktstomps_Gain_h * rtb_Switch_f_idx_0, Autothrust_P.LowPassFilter_C1,
    Autothrust_P.LowPassFilter_C2, Autothrust_P.LowPassFilter_C3, Autothrust_P.LowPassFilter_C4, Autothrust_U.in.time.dt,
    &rtb_y_p, &Autothrust_DWork.sf_LeadLagFilter_h);
  rtb_Switch_fs = (rtb_y_hw + rtb_y_p) * Autothrust_P.mpstokts_Gain * Autothrust_P.Gain4_Gain * look1_binlxpw
    (rtb_Switch_d, Autothrust_P.ScheduledGain1_BreakpointsForDimension1, Autothrust_P.ScheduledGain1_Table, 4U) +
    rtb_Switch_d;
  rtb_Gain_m = Autothrust_P.DiscreteDerivativeVariableTs_Gain * rtb_Switch_fs;
  ...
  Autothrust_LagFilter(Autothrust_U.in.data.nz_g, Autothrust_P.LagFilter1_C1, Autothrust_U.in.time.dt, &rtb_y_hw,
                       &Autothrust_DWork.sf_LagFilter_a);
  rtb_y_hw -= std::cos(Autothrust_P.Gain1_Gain_p1 * rtb_Gain2) / std::cos(Autothrust_P.Gain1_Gain_di * rtb_Gain3);
  Autothrust_WashoutFilter(Autothrust_P.Gain2_Gain_c * rtb_y_hw, Autothrust_P.WashoutFilter_C1_c,
  ...
  switch (static_cast<int32_T>(rtb_Switch_f_idx_0)) {
   ...
   case 1:
    rtb_Switch_fs = ((Autothrust_P.Gain_Gain * rtb_Switch_fs + rtb_Switch_d) + (Autothrust_P.Gain1_Gain * rtb_y_hw +
      Autothrust_P.Gain3_Gain * rtb_y_p)) * look1_binlxpw(std::fmin(rtb_Saturation, rtb_Saturation),
    ...
    if (rtb_Switch_fs > Autothrust_P.Saturation1_UpperSat) {
      rtb_Switch_fs = Autothrust_P.Saturation1_UpperSat;
    } else if (rtb_Switch_fs < Autothrust_P.Saturation1_LowerSat) {
      rtb_Switch_fs = Autothrust_P.Saturation1_LowerSat;
    }
    break;

   case 2:
    rtb_Switch_fs = Autothrust_P.Gain1_Gain_p * look1_binlxpw(std::fmin(rtb_Saturation, rtb_Saturation),
      Autothrust_P.uDLookupTable_bp01Data, Autothrust_P.uDLookupTable_tableData, 6U);
    if (rtb_Switch_fs > Autothrust_P.Saturation_UpperSat) {
      rtb_Switch_fs = Autothrust_P.Saturation_UpperSat;
    } else if (rtb_Switch_fs < Autothrust_P.Saturation_LowerSat) {
      rtb_Switch_fs = Autothrust_P.Saturation_LowerSat;
    }
    break;

   case 3:
    rtb_Switch_fs = Autothrust_P.Gain1_Gain_o * look1_binlxpw(std::fmin(rtb_Saturation, rtb_Saturation),
      Autothrust_P.uDLookupTable_bp01Data_b, Autothrust_P.uDLookupTable_tableData_o, 6U);
    if (rtb_Switch_fs > Autothrust_P.Saturation_UpperSat_a) {
      rtb_Switch_fs = Autothrust_P.Saturation_UpperSat_a;
    } else if (rtb_Switch_fs < Autothrust_P.Saturation_LowerSat_a) {
      rtb_Switch_fs = Autothrust_P.Saturation_LowerSat_a;
    }
    break;

   default:
    rtb_Switch_fs = Autothrust_P.RETARD_Value;
    break;
  }

  rtb_Switch_fs = Autothrust_P.DiscreteTimeIntegratorVariableTsLimit_Gain * rtb_Switch_fs * Autothrust_U.in.time.dt;
  rtb_r_n = (mode == Autothrust_P.CompareToConstant2_const_c);
  rtb_r_i = (mode == Autothrust_P.CompareToConstant3_const_k);
  Autothrust_DWork.icLoad = ((status != Autothrust_P.CompareToConstant_const_d) || (rtb_r_n || rtb_r_i) ||
    Autothrust_DWork.icLoad);
  if (Autothrust_DWork.icLoad) {
    Autothrust_DWork.Delay_DSTATE_k = std::fmax(rtb_Saturation, rtb_BusAssignment_n.data.commanded_engine_N1_2_percent)
      - rtb_Switch_fs;
  }
  ...
  if (Autothrust_DWork.pUseAutoThrustControl) {
    if ((mode == Autothrust_P.CompareToConstant2_const_h) || (mode == Autothrust_P.CompareToConstant3_const)) {
      if (Autothrust_U.in.input.thrust_limit_TOGA_percent < Phi_rad) {
        ...
        rtb_Switch_f_idx_0 = Autothrust_U.in.input.thrust_limit_TOGA_percent;
      }

      if (Autothrust_U.in.input.thrust_limit_TOGA_percent < rtb_BusAssignment_e_output_N1_TLA_2_percent) {
      ...
      if (Autothrust_U.in.input.thrust_limit_TOGA_percent < rtb_BusAssignment_e_output_N1_TLA_3_percent) {
        rtb_Switch_f_idx_2 = rtb_BusAssignment_e_output_N1_TLA_3_percent;
      } else {
        rtb_Switch_f_idx_2 = Autothrust_U.in.input.thrust_limit_TOGA_percent;
      }

      if (Autothrust_U.in.input.thrust_limit_TOGA_percent < rtb_BusAssignment_e_output_N1_TLA_4_percent) {
        rtb_Switch_f_idx_3 = rtb_BusAssignment_e_output_N1_TLA_4_percent;
      } else {
      ...
      if (Autothrust_DWork.Delay_DSTATE_k > Phi_rad) {
        ...
        rtb_Switch_f_idx_0 = Autothrust_DWork.Delay_DSTATE_k;
      }

      if (Autothrust_DWork.Delay_DSTATE_k > rtb_BusAssignment_e_output_N1_TLA_2_percent) {
        rtb_Switch_f_idx_1 = rtb_BusAssignment_e_output_N1_TLA_2_percent;
      } else if (Autothrust_DWork.Delay_DSTATE_k < Autothrust_U.in.input.thrust_limit_IDLE_percent) {
        rtb_Switch_f_idx_1 = Autothrust_U.in.input.thrust_limit_IDLE_percent;
      } else {
        rtb_Switch_f_idx_1 = Autothrust_DWork.Delay_DSTATE_k;
      }

      if (Autothrust_DWork.Delay_DSTATE_k > rtb_BusAssignment_e_output_N1_TLA_3_percent) {
        rtb_Switch_f_idx_2 = rtb_BusAssignment_e_output_N1_TLA_3_percent;
      } else if (Autothrust_DWork.Delay_DSTATE_k < Autothrust_U.in.input.thrust_limit_IDLE_percent) {
      ...
      if (Autothrust_DWork.Delay_DSTATE_k > rtb_BusAssignment_e_output_N1_TLA_4_percent) {
        rtb_Switch_f_idx_3 = rtb_BusAssignment_e_output_N1_TLA_4_percent;
      } else if (Autothrust_DWork.Delay_DSTATE_k < Autothrust_U.in.input.thrust_limit_IDLE_percent) {
  ...
  Autothrust_Y.out.output.is_in_reverse_1 = rtb_r_e;
  Autothrust_MATLABFunction(rtb_Switch_f_idx_0 - Autothrust_U.in.data.engine_N1_1_percent, &rtb_y_p, &rtb_r_i);
  if (rtb_r_i) {
    Autothrust_DWork.Delay_DSTATE_e = Autothrust_P.DiscreteTimeIntegratorVariableTs_InitialCondition;
  }

  Autothrust_DWork.Delay_DSTATE_e += Autothrust_P.Gain_Gain_l * rtb_y_p *
  ...
  rtb_Switch_fs = (rtb_Switch_f_idx_0 + Autothrust_DWork.Delay_DSTATE_e) - rtb_Saturation;
  if (rtb_r_e) {
    Autothrust_DWork.Delay_DSTATE_n = Autothrust_P.DiscreteTimeIntegratorVariableTs_InitialCondition_p;
  }

  Autothrust_DWork.Delay_DSTATE_n += Autothrust_P.Gain_Gain_d3 * rtb_Switch_fs *
  ...
  Autothrust_MATLABFunction(rtb_Switch_f_idx_1 - Autothrust_U.in.data.engine_N1_2_percent, &rtb_y_hw, &rtb_r_i);
  if (rtb_r_i) {
    Autothrust_DWork.Delay_DSTATE_a = Autothrust_P.DiscreteTimeIntegratorVariableTs_InitialCondition_f;
  }

  Autothrust_DWork.Delay_DSTATE_a += Autothrust_P.Gain_Gain_f * rtb_y_hw *
  ...
  Theta_rad = (rtb_Switch_f_idx_1 + Autothrust_DWork.Delay_DSTATE_a) -
  ...
  Autothrust_DWork.Delay_DSTATE_lz += Autothrust_P.Gain_Gain_b * Theta_rad *
  ...
  Autothrust_DWork.Delay_DSTATE_h += Autothrust_P.Gain1_Gain_g * Theta_rad *
  ...
  Autothrust_MATLABFunction(rtb_Switch_f_idx_2 - Autothrust_U.in.data.engine_N1_3_percent, &rtb_Switch_d, &rtb_r_n);
  if (rtb_r_n) {
  ...
  Phi_rad = Autothrust_P.Gain_Gain_n * rtb_Switch_d * Autothrust_P.DiscreteTimeIntegratorVariableTs_Gain_e *
    Autothrust_U.in.time.dt + Autothrust_DWork.Delay_DSTATE_j;
  if (Phi_rad > Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_e) {
    Autothrust_DWork.Delay_DSTATE_j = Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_e;
  } else if (Phi_rad < Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_n) {
    Autothrust_DWork.Delay_DSTATE_j = Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_n;
  } else {
    Autothrust_DWork.Delay_DSTATE_j = Phi_rad;
  }
  ...
  Autothrust_MATLABFunction(rtb_Switch_f_idx_3 - Autothrust_U.in.data.engine_N1_4_percent, &Phi_rad, &rtb_r_e);
  if (rtb_r_e) {
    Autothrust_DWork.Delay_DSTATE_e1 = Autothrust_P.DiscreteTimeIntegratorVariableTs_InitialCondition_fg;
  }

  Autothrust_DWork.Delay_DSTATE_e1 += Autothrust_P.Gain_Gain_a * Phi_rad *
  ...
  Phi_rad = (rtb_Switch_f_idx_3 + Autothrust_DWork.Delay_DSTATE_e1) -
  ...
  rtb_Saturation = Autothrust_P.Gain_Gain_p * Phi_rad * Autothrust_P.DiscreteTimeIntegratorVariableTs_Gain_n *
    Autothrust_U.in.time.dt + Autothrust_DWork.Delay_DSTATE_lr;
  if (rtb_Saturation > Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_g) {
    Autothrust_DWork.Delay_DSTATE_lr = Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_g;
  } else if (rtb_Saturation < Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_p) {
    Autothrust_DWork.Delay_DSTATE_lr = Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_p;
  } else {
    Autothrust_DWork.Delay_DSTATE_lr = rtb_Saturation;
  }
  ...
  Autothrust_DWork.Delay_DSTATE_p += Autothrust_P.Gain1_Gain_pv * Phi_rad *
  ...
  Autothrust_ThrustMode1(Autothrust_U.in.input.TLA_4_deg, &rtb_Saturation);
  ...
  Autothrust_Y.out.data.Psi_magnetic_deg = Autothrust_U.in.data.Psi_magnetic_deg;
  Autothrust_Y.out.data.Psi_magnetic_track_deg = Autothrust_U.in.data.Psi_magnetic_track_deg;
  ...
  Autothrust_Y.out.data.is_engine_operative_3 = Autothrust_U.in.data.is_engine_operative_3;
  Autothrust_Y.out.data.is_engine_operative_4 = Autothrust_U.in.data.is_engine_operative_3;
  Autothrust_Y.out.data.commanded_engine_N1_1_percent = rtb_BusAssignment_n.data.commanded_engine_N1_1_percent;
  Autothrust_Y.out.data.commanded_engine_N1_2_percent = rtb_BusAssignment_n.data.commanded_engine_N1_2_percent;
  Autothrust_Y.out.data.commanded_engine_N1_3_percent = rtb_BusAssignment_n.data.commanded_engine_N1_3_percent;
  Autothrust_Y.out.data.commanded_engine_N1_4_percent = rtb_BusAssignment_n.data.commanded_engine_N1_4_percent;
  ...
  Autothrust_Y.out.data.engine_N1_3_percent = Autothrust_U.in.data.engine_N1_3_percent;
  Autothrust_Y.out.data.engine_N1_4_percent = Autothrust_U.in.data.engine_N1_4_percent;
  Autothrust_Y.out.data.TAT_degC = Autothrust_U.in.data.TAT_degC;
  Autothrust_Y.out.data.OAT_degC = Autothrust_U.in.data.OAT_degC;
  Autothrust_Y.out.data.ISA_degC = result_tmp;
  Autothrust_Y.out.data.ambient_density_kg_per_m3 = Autothrust_U.in.data.ambient_density_kg_per_m3;
  ...
  Autothrust_Y.out.output.sim_thrust_mode_4 = rtb_Saturation;
  Autothrust_Y.out.output.N1_TLA_2_percent = rtb_BusAssignment_e_output_N1_TLA_2_percent;
  Autothrust_Y.out.output.N1_TLA_3_percent = rtb_BusAssignment_e_output_N1_TLA_3_percent;
  Autothrust_Y.out.output.N1_TLA_4_percent = rtb_BusAssignment_e_output_N1_TLA_4_percent;
