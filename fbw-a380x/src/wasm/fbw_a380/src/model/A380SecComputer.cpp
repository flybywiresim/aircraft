...
void A380SecComputer::step()
{
  ...
  if (A380SecComputer_U.in.sim_data.computer_running) {
    ...
    A380SecComputer_MATLABFunction(&A380SecComputer_U.in.bus_inputs.prim_3_bus.fctl_law_status_word, &rtb_y_i2);
    if (rtb_AND_n) {
    ...
    if (A380SecComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_y_a = A380SecComputer_U.in.bus_inputs.prim_1_bus.aileron_status_word.SSM;
      ...
      rtb_y_a = A380SecComputer_U.in.bus_inputs.prim_2_bus.aileron_status_word.SSM;
      rtb_alpha = A380SecComputer_U.in.bus_inputs.prim_2_bus.aileron_status_word.Data;
    } else {
      rtb_y_a = A380SecComputer_U.in.bus_inputs.prim_3_bus.aileron_status_word.SSM;
    ...
    if (A380SecComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_2_bus.aileron_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.aileron_status_word.Data;
    } else {
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_1_bus.aileron_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_1_bus.aileron_status_word.Data;
    }
    ...
    if (A380SecComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_3_bus.aileron_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_3_bus.aileron_status_word.Data;
    } else {
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_1_bus.aileron_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_1_bus.aileron_status_word.Data;
    }
    ...
    if (A380SecComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_1_bus.elevator_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_1_bus.elevator_status_word.Data;
    } else if (A380SecComputer_U.in.discrete_inputs.is_unit_2) {
      ...
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_status_word.Data;
    } else {
      ...
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_status_word.Data;
    }
    ...
    A380SecComputer_MATLABFunction(&rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_mi,
      &rtb_Compare_l);
    if (A380SecComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_y_a = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_status_word.SSM;
      rtb_alpha = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_status_word.Data;
    } else {
      rtb_y_a = A380SecComputer_U.in.bus_inputs.prim_1_bus.elevator_status_word.SSM;
    ...
    if (A380SecComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_y_a = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_status_word.SSM;
    ...
    if (A380SecComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_1_bus.rudder_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_1_bus.rudder_status_word.Data;
    } else {
      ...
      if (A380SecComputer_U.in.discrete_inputs.is_unit_2) {
        rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_status_word.SSM;
        rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_status_word.Data;
      } else {
        rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_status_word.SSM;
        rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_status_word.Data;
      }
    }
    ...
    if (rtb_DataTypeConversion_i == A380SecComputer_P.CompareToConstant3_const) {
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_1_bus.discrete_status_word_1.SSM;
      ...
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_2_bus.discrete_status_word_1.SSM;
      rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_gp.Data =
        A380SecComputer_U.in.bus_inputs.prim_2_bus.discrete_status_word_1.Data;
    } else {
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_3_bus.discrete_status_word_1.SSM;
      rtb_BusConversion_InsertedFor_MATLABFunction_at_inport_0_BusCreator1_gp.Data =
    ...
    switch (A380SecComputer_B.logic.master_prim) {
     case 0:
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_1_bus.fg_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_1_bus.fg_status_word.Data;
      break;
     ...
     case 2:
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_2_bus.fg_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.fg_status_word.Data;
      break;

     default:
      rtb_SSM_in = A380SecComputer_U.in.bus_inputs.prim_3_bus.fg_status_word.SSM;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_3_bus.fg_status_word.Data;
      break;
    }
    ...
    if (A380SecComputer_B.logic.master_prim == A380SecComputer_P.CompareToConstant_const_f) {
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_1_bus.left_inboard_aileron_command_deg.Data;
      ...
      rtb_mach_d = A380SecComputer_U.in.bus_inputs.prim_1_bus.left_spoiler_1_command_deg.Data;
      ...
      rtb_Data_c2 = A380SecComputer_U.in.bus_inputs.prim_1_bus.upper_rudder_command_deg.Data;
      rtb_Data_e3 = A380SecComputer_U.in.bus_inputs.prim_1_bus.lower_rudder_command_deg.Data;
      A380SecComputer_Y.out.bus_outputs.aileron_status_word.Data =
        A380SecComputer_U.in.bus_inputs.prim_1_bus.radio_height_1_ft.Data;
      A380SecComputer_Y.out.bus_outputs.spoiler_status_word.Data =
        A380SecComputer_U.in.bus_inputs.prim_1_bus.radio_height_2_ft.Data;
      ...
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_inboard_aileron_command_deg.Data;
      ...
      rtb_mach_d = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_1_command_deg.Data;
      ...
      rtb_Data_c2 = A380SecComputer_U.in.bus_inputs.prim_2_bus.upper_rudder_command_deg.Data;
      rtb_Data_e3 = A380SecComputer_U.in.bus_inputs.prim_2_bus.lower_rudder_command_deg.Data;
      A380SecComputer_Y.out.bus_outputs.aileron_status_word.Data =
        A380SecComputer_U.in.bus_inputs.prim_2_bus.radio_height_1_ft.Data;
      A380SecComputer_Y.out.bus_outputs.spoiler_status_word.Data =
        A380SecComputer_U.in.bus_inputs.prim_2_bus.radio_height_2_ft.Data;
      A380SecComputer_Y.out.bus_outputs.elevator_status_word.Data =
      ...
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_inboard_aileron_command_deg.Data;
      ...
      rtb_mach_d = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_1_command_deg.Data;
      ...
      rtb_Data_c2 = A380SecComputer_U.in.bus_inputs.prim_3_bus.upper_rudder_command_deg.Data;
      rtb_Data_e3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.lower_rudder_command_deg.Data;
      A380SecComputer_Y.out.bus_outputs.aileron_status_word.Data =
        A380SecComputer_U.in.bus_inputs.prim_3_bus.radio_height_1_ft.Data;
      A380SecComputer_Y.out.bus_outputs.spoiler_status_word.Data =
        A380SecComputer_U.in.bus_inputs.prim_3_bus.radio_height_2_ft.Data;
      A380SecComputer_Y.out.bus_outputs.elevator_status_word.Data =
    ...
    if (A380SecComputer_B.logic.master_prim == A380SecComputer_P.CompareToConstant_const_fs) {
      ...
      rtb_mach_d = A380SecComputer_U.in.bus_inputs.prim_1_bus.left_outboard_elevator_command_deg.Data;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_1_bus.right_outboard_elevator_command_deg.Data;
      ...
      rtb_mach_d = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_outboard_elevator_command_deg.Data;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_outboard_elevator_command_deg.Data;
      ...
      rtb_mach_d = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_outboard_elevator_command_deg.Data;
      rtb_Data_i5 = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_outboard_elevator_command_deg.Data;
    ...
    A380SecComputer_B.SSM_es = A380SecComputer_U.in.bus_inputs.prim_1_bus.radio_height_1_ft.SSM;
    A380SecComputer_B.Data_ku = A380SecComputer_U.in.bus_inputs.prim_1_bus.radio_height_1_ft.Data;
    A380SecComputer_B.right_aileron_1_pos_deg = A380SecComputer_U.in.analog_inputs.right_aileron_1_pos_deg;
    A380SecComputer_B.SSM_gi1 = A380SecComputer_U.in.bus_inputs.prim_1_bus.radio_height_2_ft.SSM;
    A380SecComputer_B.Data_jp = A380SecComputer_U.in.bus_inputs.prim_1_bus.radio_height_2_ft.Data;
    A380SecComputer_B.SSM_jz = A380SecComputer_U.in.bus_inputs.prim_1_bus.fctl_law_status_word.SSM;
    A380SecComputer_B.Data_nu = A380SecComputer_U.in.bus_inputs.prim_1_bus.fctl_law_status_word.Data;
    A380SecComputer_B.SSM_kt = A380SecComputer_U.in.bus_inputs.prim_1_bus.discrete_status_word_1.SSM;
    A380SecComputer_B.Data_br = A380SecComputer_U.in.bus_inputs.prim_1_bus.discrete_status_word_1.Data;
    A380SecComputer_B.SSM_ds = A380SecComputer_U.in.bus_inputs.prim_1_bus.fe_status_word.SSM;
    A380SecComputer_B.Data_ae = A380SecComputer_U.in.bus_inputs.prim_1_bus.fe_status_word.Data;
    A380SecComputer_B.SSM_eg = A380SecComputer_U.in.bus_inputs.prim_1_bus.fg_status_word.SSM;
    A380SecComputer_B.Data_pe = A380SecComputer_U.in.bus_inputs.prim_1_bus.fg_status_word.Data;
    A380SecComputer_B.right_aileron_2_pos_deg = A380SecComputer_U.in.analog_inputs.right_aileron_2_pos_deg;
    A380SecComputer_B.SSM_a0 = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_inboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_fy = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_inboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_cv = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_inboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_na = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_inboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_ea = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_midboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_my = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_midboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_p4 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_midboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_i4 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_midboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_m2 = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_outboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_cx = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_outboard_aileron_command_deg.Data;
    A380SecComputer_B.left_spoiler_1_pos_deg = A380SecComputer_U.in.analog_inputs.left_spoiler_1_pos_deg;
    A380SecComputer_B.SSM_bt0 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_outboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_nz = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_outboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_nr = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_1_command_deg.SSM;
    A380SecComputer_B.Data_id = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_1_command_deg.Data;
    A380SecComputer_B.SSM_fr = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_1_command_deg.SSM;
    A380SecComputer_B.Data_o2 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_1_command_deg.Data;
    A380SecComputer_B.SSM_cc = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_2_command_deg.SSM;
    A380SecComputer_B.Data_gqq = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_2_command_deg.Data;
    A380SecComputer_B.SSM_lm = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_2_command_deg.SSM;
    A380SecComputer_B.Data_md = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_2_command_deg.Data;
    A380SecComputer_B.right_spoiler_1_pos_deg = A380SecComputer_U.in.analog_inputs.right_spoiler_1_pos_deg;
    A380SecComputer_B.SSM_mkm = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_3_command_deg.SSM;
    A380SecComputer_B.Data_cz = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_3_command_deg.Data;
    A380SecComputer_B.SSM_jhd = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_3_command_deg.SSM;
    A380SecComputer_B.Data_pm = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_3_command_deg.Data;
    A380SecComputer_B.SSM_av = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_4_command_deg.SSM;
    A380SecComputer_B.Data_bj = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_4_command_deg.Data;
    A380SecComputer_B.SSM_ira = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_4_command_deg.SSM;
    A380SecComputer_B.Data_ox = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_4_command_deg.Data;
    A380SecComputer_B.SSM_ge = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_5_command_deg.SSM;
    A380SecComputer_B.Data_pe5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_5_command_deg.Data;
    A380SecComputer_B.left_spoiler_2_pos_deg = A380SecComputer_U.in.analog_inputs.left_spoiler_2_pos_deg;
    A380SecComputer_B.SSM_lv = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_5_command_deg.SSM;
    A380SecComputer_B.Data_jj = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_5_command_deg.Data;
    A380SecComputer_B.SSM_cg = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_6_command_deg.SSM;
    A380SecComputer_B.Data_p5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_6_command_deg.Data;
    A380SecComputer_B.SSM_be = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_6_command_deg.SSM;
    A380SecComputer_B.Data_ekl = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_6_command_deg.Data;
    A380SecComputer_B.SSM_axb = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_7_command_deg.SSM;
    A380SecComputer_B.Data_nd = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_7_command_deg.Data;
    A380SecComputer_B.SSM_nz = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_7_command_deg.SSM;
    A380SecComputer_B.Data_n2 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_7_command_deg.Data;
    A380SecComputer_B.right_spoiler_2_pos_deg = A380SecComputer_U.in.analog_inputs.right_spoiler_2_pos_deg;
    A380SecComputer_B.SSM_cx = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_8_command_deg.SSM;
    A380SecComputer_B.Data_dl = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_8_command_deg.Data;
    A380SecComputer_B.SSM_gh = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_8_command_deg.SSM;
    A380SecComputer_B.Data_gs2 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_8_command_deg.Data;
    A380SecComputer_B.SSM_ks = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_inboard_elevator_command_deg.SSM;
    A380SecComputer_B.Data_h4 = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_inboard_elevator_command_deg.Data;
    A380SecComputer_B.SSM_pw = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_inboard_elevator_command_deg.SSM;
    A380SecComputer_B.Data_e3 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_inboard_elevator_command_deg.Data;
    A380SecComputer_B.SSM_fh = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_outboard_elevator_command_deg.SSM;
    A380SecComputer_B.Data_f5h = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_outboard_elevator_command_deg.Data;
    ...
    A380SecComputer_B.SSM_gzn = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_outboard_elevator_command_deg.SSM;
    A380SecComputer_B.Data_an = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_outboard_elevator_command_deg.Data;
    A380SecComputer_B.SSM_oo = A380SecComputer_U.in.bus_inputs.prim_2_bus.ths_command_deg.SSM;
    A380SecComputer_B.Data_i4o = A380SecComputer_U.in.bus_inputs.prim_2_bus.ths_command_deg.Data;
    A380SecComputer_B.SSM_evh = A380SecComputer_U.in.bus_inputs.prim_2_bus.upper_rudder_command_deg.SSM;
    A380SecComputer_B.Data_af = A380SecComputer_U.in.bus_inputs.prim_2_bus.upper_rudder_command_deg.Data;
    A380SecComputer_B.SSM_cn = A380SecComputer_U.in.bus_inputs.prim_2_bus.lower_rudder_command_deg.SSM;
    A380SecComputer_B.Data_bm = A380SecComputer_U.in.bus_inputs.prim_2_bus.lower_rudder_command_deg.Data;
    A380SecComputer_B.SSM_co = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_sidestick_pitch_command_deg.SSM;
    A380SecComputer_B.Data_dk = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_sidestick_pitch_command_deg.Data;
    A380SecComputer_B.rudder_2_pos_deg = A380SecComputer_U.in.analog_inputs.rudder_2_pos_deg;
    A380SecComputer_B.SSM_pe = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_sidestick_pitch_command_deg.SSM;
    A380SecComputer_B.Data_nv = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_sidestick_pitch_command_deg.Data;
    A380SecComputer_B.SSM_cgz = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_sidestick_roll_command_deg.SSM;
    A380SecComputer_B.Data_jpf = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_sidestick_roll_command_deg.Data;
    A380SecComputer_B.SSM_fw = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_sidestick_roll_command_deg.SSM;
    A380SecComputer_B.Data_i5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_sidestick_roll_command_deg.Data;
    A380SecComputer_B.SSM_h4 = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_pedal_position_deg.SSM;
    A380SecComputer_B.Data_k2 = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_pedal_position_deg.Data;
    A380SecComputer_B.SSM_cb3 = A380SecComputer_U.in.bus_inputs.prim_2_bus.aileron_status_word.SSM;
    A380SecComputer_B.Data_as = A380SecComputer_U.in.bus_inputs.prim_2_bus.aileron_status_word.Data;
    A380SecComputer_B.rudder_pedal_pos_deg = A380SecComputer_U.in.analog_inputs.rudder_pedal_pos_deg;
    A380SecComputer_B.SSM_pj = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_aileron_1_position_deg.SSM;
    A380SecComputer_B.Data_gk = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_aileron_1_position_deg.Data;
    A380SecComputer_B.SSM_dv = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_aileron_2_position_deg.SSM;
    A380SecComputer_B.Data_jl = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_aileron_2_position_deg.Data;
    A380SecComputer_B.SSM_i4 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_aileron_1_position_deg.SSM;
    A380SecComputer_B.Data_e32 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_aileron_1_position_deg.Data;
    A380SecComputer_B.SSM_fm = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_aileron_2_position_deg.SSM;
    A380SecComputer_B.Data_ih = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_aileron_2_position_deg.Data;
    A380SecComputer_B.SSM_e5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.spoiler_status_word.SSM;
    A380SecComputer_B.Data_du = A380SecComputer_U.in.bus_inputs.prim_2_bus.spoiler_status_word.Data;
    A380SecComputer_B.rudder_trim_actual_pos_deg = A380SecComputer_U.in.analog_inputs.rudder_trim_actual_pos_deg;
    A380SecComputer_B.SSM_bf = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_position_deg.SSM;
    A380SecComputer_B.Data_nx = A380SecComputer_U.in.bus_inputs.prim_2_bus.left_spoiler_position_deg.Data;
    A380SecComputer_B.SSM_fd = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_position_deg.SSM;
    A380SecComputer_B.Data_n0 = A380SecComputer_U.in.bus_inputs.prim_2_bus.right_spoiler_position_deg.Data;
    A380SecComputer_B.SSM_fv = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_status_word.SSM;
    A380SecComputer_B.Data_eqi = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_status_word.Data;
    A380SecComputer_B.SSM_dt = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_1_position_deg.SSM;
    A380SecComputer_B.Data_om = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_1_position_deg.Data;
    A380SecComputer_B.SSM_j5 = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_2_position_deg.SSM;
    A380SecComputer_B.Data_nr = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_2_position_deg.Data;
    A380SecComputer_B.SSM_ng = A380SecComputer_U.in.bus_inputs.adr_1_bus.altitude_standard_ft.SSM;
    A380SecComputer_B.SSM_cs = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_3_position_deg.SSM;
    A380SecComputer_B.Data_p3 = A380SecComputer_U.in.bus_inputs.prim_2_bus.elevator_3_position_deg.Data;
    A380SecComputer_B.SSM_ls = A380SecComputer_U.in.bus_inputs.prim_2_bus.ths_position_deg.SSM;
    A380SecComputer_B.Data_nb = A380SecComputer_U.in.bus_inputs.prim_2_bus.ths_position_deg.Data;
    A380SecComputer_B.SSM_dg = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_status_word.SSM;
    A380SecComputer_B.Data_hd = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_status_word.Data;
    A380SecComputer_B.SSM_d3 = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_1_position_deg.SSM;
    A380SecComputer_B.Data_al = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_1_position_deg.Data;
    A380SecComputer_B.SSM_p2 = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_2_position_deg.SSM;
    A380SecComputer_B.Data_gu = A380SecComputer_U.in.bus_inputs.prim_2_bus.rudder_2_position_deg.Data;
    A380SecComputer_B.Data_ix = A380SecComputer_U.in.bus_inputs.adr_1_bus.altitude_standard_ft.Data;
    A380SecComputer_B.SSM_bo0 = A380SecComputer_U.in.bus_inputs.prim_2_bus.radio_height_1_ft.SSM;
    A380SecComputer_B.Data_do = A380SecComputer_U.in.bus_inputs.prim_2_bus.radio_height_1_ft.Data;
    A380SecComputer_B.SSM_bc = A380SecComputer_U.in.bus_inputs.prim_2_bus.radio_height_2_ft.SSM;
    A380SecComputer_B.Data_hu = A380SecComputer_U.in.bus_inputs.prim_2_bus.radio_height_2_ft.Data;
    A380SecComputer_B.SSM_h0 = A380SecComputer_U.in.bus_inputs.prim_2_bus.fctl_law_status_word.SSM;
    A380SecComputer_B.Data_pm1 = A380SecComputer_U.in.bus_inputs.prim_2_bus.fctl_law_status_word.Data;
    A380SecComputer_B.SSM_giz = A380SecComputer_U.in.bus_inputs.prim_2_bus.discrete_status_word_1.SSM;
    A380SecComputer_B.Data_i2y = A380SecComputer_U.in.bus_inputs.prim_2_bus.discrete_status_word_1.Data;
    A380SecComputer_B.SSM_mqp = A380SecComputer_U.in.bus_inputs.prim_2_bus.fe_status_word.SSM;
    A380SecComputer_B.Data_pg = A380SecComputer_U.in.bus_inputs.prim_2_bus.fe_status_word.Data;
    A380SecComputer_B.SSM_ba = A380SecComputer_U.in.bus_inputs.adr_1_bus.altitude_corrected_ft.SSM;
    A380SecComputer_B.SSM_in = A380SecComputer_U.in.bus_inputs.prim_2_bus.fg_status_word.SSM;
    A380SecComputer_B.Data_ni = A380SecComputer_U.in.bus_inputs.prim_2_bus.fg_status_word.Data;
    A380SecComputer_B.SSM_ff = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_inboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_fr = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_inboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_ic = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_inboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_cn = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_inboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_fs = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_midboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_nxl = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_midboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_ja = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_midboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_jh = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_midboard_aileron_command_deg.Data;
    A380SecComputer_B.Data_gl = A380SecComputer_U.in.bus_inputs.adr_1_bus.altitude_corrected_ft.Data;
    A380SecComputer_B.SSM_js = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_outboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_gn = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_outboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_is3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_outboard_aileron_command_deg.SSM;
    A380SecComputer_B.Data_myb = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_outboard_aileron_command_deg.Data;
    A380SecComputer_B.SSM_ag = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_1_command_deg.SSM;
    A380SecComputer_B.Data_l2 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_1_command_deg.Data;
    A380SecComputer_B.SSM_f5 = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_1_command_deg.SSM;
    A380SecComputer_B.Data_o5o = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_1_command_deg.Data;
    A380SecComputer_B.SSM_ph = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_2_command_deg.SSM;
    A380SecComputer_B.Data_l5 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_2_command_deg.Data;
    A380SecComputer_B.SSM_jw = A380SecComputer_U.in.bus_inputs.adr_1_bus.mach.SSM;
    A380SecComputer_B.SSM_jy = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_2_command_deg.SSM;
    A380SecComputer_B.Data_dc2 = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_2_command_deg.Data;
    A380SecComputer_B.SSM_j1 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_3_command_deg.SSM;
    A380SecComputer_B.Data_gr = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_3_command_deg.Data;
    A380SecComputer_B.SSM_ov = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_3_command_deg.SSM;
    A380SecComputer_B.Data_gp = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_3_command_deg.Data;
    A380SecComputer_B.SSM_mx = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_4_command_deg.SSM;
    A380SecComputer_B.Data_i3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_4_command_deg.Data;
    A380SecComputer_B.SSM_b4 = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_4_command_deg.SSM;
    A380SecComputer_B.Data_et = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_4_command_deg.Data;
    A380SecComputer_B.Data_mc = A380SecComputer_U.in.bus_inputs.adr_1_bus.mach.Data;
    A380SecComputer_B.SSM_gb = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_5_command_deg.SSM;
    A380SecComputer_B.Data_k3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_5_command_deg.Data;
    A380SecComputer_B.SSM_oh = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_5_command_deg.SSM;
    A380SecComputer_B.Data_f2 = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_5_command_deg.Data;
    A380SecComputer_B.SSM_mm5 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_6_command_deg.SSM;
    A380SecComputer_B.Data_gh = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_6_command_deg.Data;
    A380SecComputer_B.SSM_br = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_6_command_deg.SSM;
    A380SecComputer_B.Data_ed = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_6_command_deg.Data;
    A380SecComputer_B.SSM_c2 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_7_command_deg.SSM;
    A380SecComputer_B.Data_o2j = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_7_command_deg.Data;
    ...
    A380SecComputer_B.SSM_ktr = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_7_command_deg.SSM;
    A380SecComputer_B.Data_i43 = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_7_command_deg.Data;
    A380SecComputer_B.SSM_gl = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_8_command_deg.SSM;
    A380SecComputer_B.Data_ic = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_8_command_deg.Data;
    A380SecComputer_B.SSM_my = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_8_command_deg.SSM;
    A380SecComputer_B.Data_ak = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_8_command_deg.Data;
    A380SecComputer_B.SSM_j3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_inboard_elevator_command_deg.SSM;
    A380SecComputer_B.Data_jg = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_inboard_elevator_command_deg.Data;
    A380SecComputer_B.SSM_go = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_inboard_elevator_command_deg.SSM;
    A380SecComputer_B.Data_cu = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_inboard_elevator_command_deg.Data;
    A380SecComputer_B.Data_ep = A380SecComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data;
    A380SecComputer_B.SSM_e5c = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_outboard_elevator_command_deg.SSM;
    A380SecComputer_B.Data_d3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_outboard_elevator_command_deg.Data;
    A380SecComputer_B.SSM_dk = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_outboard_elevator_command_deg.SSM;
    A380SecComputer_B.Data_bt = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_outboard_elevator_command_deg.Data;
    A380SecComputer_B.SSM_evc = A380SecComputer_U.in.bus_inputs.prim_3_bus.ths_command_deg.SSM;
    A380SecComputer_B.Data_e0 = A380SecComputer_U.in.bus_inputs.prim_3_bus.ths_command_deg.Data;
    A380SecComputer_B.SSM_kk = A380SecComputer_U.in.bus_inputs.prim_3_bus.upper_rudder_command_deg.SSM;
    A380SecComputer_B.Data_jl3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.upper_rudder_command_deg.Data;
    A380SecComputer_B.SSM_af = A380SecComputer_U.in.bus_inputs.prim_3_bus.lower_rudder_command_deg.SSM;
    A380SecComputer_B.Data_nm = A380SecComputer_U.in.bus_inputs.prim_3_bus.lower_rudder_command_deg.Data;
    A380SecComputer_B.SSM_npr = A380SecComputer_U.in.bus_inputs.adr_1_bus.airspeed_true_kn.SSM;
    A380SecComputer_B.SSM_ew = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_sidestick_pitch_command_deg.SSM;
    A380SecComputer_B.Data_ia = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_sidestick_pitch_command_deg.Data;
    A380SecComputer_B.SSM_lt = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_sidestick_pitch_command_deg.SSM;
    A380SecComputer_B.Data_j0 = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_sidestick_pitch_command_deg.Data;
    A380SecComputer_B.SSM_ger = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_sidestick_roll_command_deg.SSM;
    A380SecComputer_B.Data_bs = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_sidestick_roll_command_deg.Data;
    A380SecComputer_B.SSM_pxo = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_sidestick_roll_command_deg.SSM;
    A380SecComputer_B.Data_hp = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_sidestick_roll_command_deg.Data;
    A380SecComputer_B.SSM_co2 = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_pedal_position_deg.SSM;
    A380SecComputer_B.Data_ct = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_pedal_position_deg.Data;
    A380SecComputer_B.Data_pc = A380SecComputer_U.in.bus_inputs.adr_1_bus.airspeed_true_kn.Data;
    A380SecComputer_B.SSM_ny = A380SecComputer_U.in.bus_inputs.prim_3_bus.aileron_status_word.SSM;
    A380SecComputer_B.Data_nzt = A380SecComputer_U.in.bus_inputs.prim_3_bus.aileron_status_word.Data;
    A380SecComputer_B.SSM_l4 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_aileron_1_position_deg.SSM;
    A380SecComputer_B.Data_c0 = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_aileron_1_position_deg.Data;
    A380SecComputer_B.SSM_nm = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_aileron_2_position_deg.SSM;
    A380SecComputer_B.Data_ojg = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_aileron_2_position_deg.Data;
    A380SecComputer_B.SSM_nh = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_aileron_1_position_deg.SSM;
    A380SecComputer_B.Data_lm = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_aileron_1_position_deg.Data;
    A380SecComputer_B.SSM_dl = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_aileron_2_position_deg.SSM;
    A380SecComputer_B.Data_fz = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_aileron_2_position_deg.Data;
    A380SecComputer_B.SSM_dx = A380SecComputer_U.in.bus_inputs.adr_1_bus.vertical_speed_ft_min.SSM;
    A380SecComputer_B.SSM_a5h = A380SecComputer_U.in.bus_inputs.prim_3_bus.spoiler_status_word.SSM;
    A380SecComputer_B.Data_oz = A380SecComputer_U.in.bus_inputs.prim_3_bus.spoiler_status_word.Data;
    A380SecComputer_B.SSM_fl = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_position_deg.SSM;
    A380SecComputer_B.Data_gf = A380SecComputer_U.in.bus_inputs.prim_3_bus.left_spoiler_position_deg.Data;
    A380SecComputer_B.SSM_p3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_position_deg.SSM;
    A380SecComputer_B.Data_nn = A380SecComputer_U.in.bus_inputs.prim_3_bus.right_spoiler_position_deg.Data;
    A380SecComputer_B.SSM_ns = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_status_word.SSM;
    A380SecComputer_B.Data_a0z = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_status_word.Data;
    A380SecComputer_B.SSM_bm = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_1_position_deg.SSM;
    A380SecComputer_B.Data_fk = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_1_position_deg.Data;
    A380SecComputer_B.Data_bu = A380SecComputer_U.in.bus_inputs.adr_1_bus.vertical_speed_ft_min.Data;
    A380SecComputer_B.SSM_nl = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_2_position_deg.SSM;
    A380SecComputer_B.Data_o23 = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_2_position_deg.Data;
    A380SecComputer_B.SSM_grm = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_3_position_deg.SSM;
    A380SecComputer_B.Data_g3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.elevator_3_position_deg.Data;
    A380SecComputer_B.SSM_gzm = A380SecComputer_U.in.bus_inputs.prim_3_bus.ths_position_deg.SSM;
    A380SecComputer_B.Data_icc = A380SecComputer_U.in.bus_inputs.prim_3_bus.ths_position_deg.Data;
    A380SecComputer_B.SSM_oi = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_status_word.SSM;
    A380SecComputer_B.Data_pwf = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_status_word.Data;
    A380SecComputer_B.SSM_aa = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_1_position_deg.SSM;
    A380SecComputer_B.Data_gvk = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_1_position_deg.Data;
    A380SecComputer_B.SSM_fvk = A380SecComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.SSM;
    A380SecComputer_B.SSM_lw = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_2_position_deg.SSM;
    A380SecComputer_B.Data_ln = A380SecComputer_U.in.bus_inputs.prim_3_bus.rudder_2_position_deg.Data;
    A380SecComputer_B.SSM_fa = A380SecComputer_U.in.bus_inputs.prim_3_bus.radio_height_1_ft.SSM;
    A380SecComputer_B.Data_ka = A380SecComputer_U.in.bus_inputs.prim_3_bus.radio_height_1_ft.Data;
    A380SecComputer_B.SSM_lbx = A380SecComputer_U.in.bus_inputs.prim_3_bus.radio_height_2_ft.SSM;
    A380SecComputer_B.Data_mp = A380SecComputer_U.in.bus_inputs.prim_3_bus.radio_height_2_ft.Data;
    A380SecComputer_B.SSM_n3 = A380SecComputer_U.in.bus_inputs.prim_3_bus.fctl_law_status_word.SSM;
    A380SecComputer_B.Data_m4 = A380SecComputer_U.in.bus_inputs.prim_3_bus.fctl_law_status_word.Data;
    A380SecComputer_B.SSM_a1 = A380SecComputer_U.in.bus_inputs.prim_3_bus.discrete_status_word_1.SSM;
    A380SecComputer_B.Data_fki = A380SecComputer_U.in.bus_inputs.prim_3_bus.discrete_status_word_1.Data;
    A380SecComputer_B.Data_bv = A380SecComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data;
    A380SecComputer_B.SSM_p1 = A380SecComputer_U.in.bus_inputs.prim_3_bus.fe_status_word.SSM;
    A380SecComputer_B.Data_m21 = A380SecComputer_U.in.bus_inputs.prim_3_bus.fe_status_word.Data;
    A380SecComputer_B.SSM_cn2 = A380SecComputer_U.in.bus_inputs.prim_3_bus.fg_status_word.SSM;
    A380SecComputer_B.Data_nbg = A380SecComputer_U.in.bus_inputs.prim_3_bus.fg_status_word.Data;
    A380SecComputer_B.SSM_an3 = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_sidestick_pitch_command_deg.SSM;
    A380SecComputer_B.Data_l25 = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_sidestick_pitch_command_deg.Data;
    A380SecComputer_B.SSM_c3 = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_sidestick_pitch_command_deg.SSM;
    A380SecComputer_B.Data_ki = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_sidestick_pitch_command_deg.Data;
    A380SecComputer_B.SSM_dp = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_sidestick_roll_command_deg.SSM;
    A380SecComputer_B.Data_p5p = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_sidestick_roll_command_deg.Data;
    A380SecComputer_B.SSM_boy = A380SecComputer_U.in.bus_inputs.adr_1_bus.corrected_average_static_pressure.SSM;
    A380SecComputer_B.SSM_lg = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_sidestick_roll_command_deg.SSM;
    A380SecComputer_B.Data_nry = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_sidestick_roll_command_deg.Data;
    A380SecComputer_B.SSM_cm = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_pedal_position_deg.SSM;
    A380SecComputer_B.Data_mh = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_pedal_position_deg.Data;
    A380SecComputer_B.SSM_hl = A380SecComputer_U.in.bus_inputs.sec_x_bus.aileron_status_word.SSM;
    A380SecComputer_B.Data_ll = A380SecComputer_U.in.bus_inputs.sec_x_bus.aileron_status_word.Data;
    A380SecComputer_B.SSM_irh = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_aileron_1_position_deg.SSM;
    A380SecComputer_B.Data_hy = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_aileron_1_position_deg.Data;
    A380SecComputer_B.SSM_b42 = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_aileron_2_position_deg.SSM;
    A380SecComputer_B.Data_j04 = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_aileron_2_position_deg.Data;
    A380SecComputer_B.Data_pf = A380SecComputer_U.in.bus_inputs.adr_1_bus.corrected_average_static_pressure.Data;
    A380SecComputer_B.SSM_anz = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_aileron_1_position_deg.SSM;
    A380SecComputer_B.Data_pl = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_aileron_1_position_deg.Data;
    A380SecComputer_B.SSM_d2 = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_aileron_2_position_deg.SSM;
    A380SecComputer_B.Data_gb = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_aileron_2_position_deg.Data;
    A380SecComputer_B.SSM_gov = A380SecComputer_U.in.bus_inputs.sec_x_bus.spoiler_status_word.SSM;
    A380SecComputer_B.Data_hq = A380SecComputer_U.in.bus_inputs.sec_x_bus.spoiler_status_word.Data;
    A380SecComputer_B.SSM_nb = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_spoiler_1_position_deg.SSM;
    A380SecComputer_B.Data_ai = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_spoiler_1_position_deg.Data;
    A380SecComputer_B.SSM_pe3 = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_spoiler_1_position_deg.SSM;
    A380SecComputer_B.Data_gfr = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_spoiler_1_position_deg.Data;
    ...
    A380SecComputer_B.SSM_jx = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_spoiler_2_position_deg.SSM;
    A380SecComputer_B.Data_czp = A380SecComputer_U.in.bus_inputs.sec_x_bus.left_spoiler_2_position_deg.Data;
    A380SecComputer_B.SSM_npl = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_spoiler_2_position_deg.SSM;
    A380SecComputer_B.Data_fm = A380SecComputer_U.in.bus_inputs.sec_x_bus.right_spoiler_2_position_deg.Data;
    A380SecComputer_B.SSM_gf = A380SecComputer_U.in.bus_inputs.sec_x_bus.elevator_status_word.SSM;
    A380SecComputer_B.Data_jsg = A380SecComputer_U.in.bus_inputs.sec_x_bus.elevator_status_word.Data;
    A380SecComputer_B.SSM_gbi = A380SecComputer_U.in.bus_inputs.sec_x_bus.elevator_1_position_deg.SSM;
    A380SecComputer_B.Data_g1 = A380SecComputer_U.in.bus_inputs.sec_x_bus.elevator_1_position_deg.Data;
    A380SecComputer_B.SSM_fhm = A380SecComputer_U.in.bus_inputs.sec_x_bus.elevator_2_position_deg.SSM;
    A380SecComputer_B.Data_j4 = A380SecComputer_U.in.bus_inputs.sec_x_bus.elevator_2_position_deg.Data;
    A380SecComputer_B.Data_jyh = A380SecComputer_U.in.bus_inputs.adr_2_bus.altitude_standard_ft.Data;
    A380SecComputer_B.SSM_ltj = A380SecComputer_U.in.bus_inputs.sec_x_bus.elevator_3_position_deg.SSM;
    A380SecComputer_B.Data_e4 = A380SecComputer_U.in.bus_inputs.sec_x_bus.elevator_3_position_deg.Data;
    A380SecComputer_B.SSM_hn = A380SecComputer_U.in.bus_inputs.sec_x_bus.ths_position_deg.SSM;
    A380SecComputer_B.Data_ghs = A380SecComputer_U.in.bus_inputs.sec_x_bus.ths_position_deg.Data;
    A380SecComputer_B.SSM_h3 = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_status_word.SSM;
    A380SecComputer_B.Data_bmk = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_status_word.Data;
    A380SecComputer_B.SSM_bfs = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_1_position_deg.SSM;
    A380SecComputer_B.Data_lzt = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_1_position_deg.Data;
    A380SecComputer_B.SSM_p0 = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_2_position_deg.SSM;
    A380SecComputer_B.Data_kn = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_2_position_deg.Data;
    A380SecComputer_B.SSM_fu = A380SecComputer_U.in.bus_inputs.adr_2_bus.altitude_corrected_ft.SSM;
    A380SecComputer_B.SSM_hr = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_trim_actual_pos_deg.SSM;
    A380SecComputer_B.Data_nab = A380SecComputer_U.in.bus_inputs.sec_x_bus.rudder_trim_actual_pos_deg.Data;
    A380SecComputer_B.SSM_bi = A380SecComputer_U.in.bus_inputs.sec_x_bus.fctl_law_status_word.SSM;
    A380SecComputer_B.Data_lgf = A380SecComputer_U.in.bus_inputs.sec_x_bus.fctl_law_status_word.Data;
    A380SecComputer_B.SSM_bd = A380SecComputer_U.in.bus_inputs.sec_x_bus.misc_data_status_word.SSM;
    A380SecComputer_B.Data_fpq = A380SecComputer_U.in.bus_inputs.sec_x_bus.misc_data_status_word.Data;
    A380SecComputer_B.SSM_omt = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_sidestick_pitch_command_deg.SSM;
    A380SecComputer_B.Data_dt = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_sidestick_pitch_command_deg.Data;
    A380SecComputer_B.SSM_la = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_sidestick_pitch_command_deg.SSM;
    A380SecComputer_B.Data_b1 = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_sidestick_pitch_command_deg.Data;
    A380SecComputer_B.Data_nmr = A380SecComputer_U.in.bus_inputs.adr_2_bus.altitude_corrected_ft.Data;
    A380SecComputer_B.SSM_l1 = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_sidestick_roll_command_deg.SSM;
    A380SecComputer_B.Data_ea = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_sidestick_roll_command_deg.Data;
    A380SecComputer_B.SSM_dy = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_sidestick_roll_command_deg.SSM;
    A380SecComputer_B.Data_nib = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_sidestick_roll_command_deg.Data;
    A380SecComputer_B.SSM_ie = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_pedal_position_deg.SSM;
    A380SecComputer_B.Data_i2t = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_pedal_position_deg.Data;
    A380SecComputer_B.SSM_kf = A380SecComputer_U.in.bus_inputs.sec_y_bus.aileron_status_word.SSM;
    A380SecComputer_B.Data_ng = A380SecComputer_U.in.bus_inputs.sec_y_bus.aileron_status_word.Data;
    A380SecComputer_B.SSM_p5l = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_aileron_1_position_deg.SSM;
    A380SecComputer_B.Data_h31 = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_aileron_1_position_deg.Data;
    A380SecComputer_B.SSM_g3 = A380SecComputer_U.in.bus_inputs.adr_2_bus.mach.SSM;
    A380SecComputer_B.SSM_b3 = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_aileron_2_position_deg.SSM;
    A380SecComputer_B.Data_ew = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_aileron_2_position_deg.Data;
    A380SecComputer_B.SSM_dxv = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_aileron_1_position_deg.SSM;
    A380SecComputer_B.Data_j1s = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_aileron_1_position_deg.Data;
    A380SecComputer_B.SSM_mxz = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_aileron_2_position_deg.SSM;
    A380SecComputer_B.Data_j5 = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_aileron_2_position_deg.Data;
    A380SecComputer_B.SSM_kk4 = A380SecComputer_U.in.bus_inputs.sec_y_bus.spoiler_status_word.SSM;
    A380SecComputer_B.Data_cw = A380SecComputer_U.in.bus_inputs.sec_y_bus.spoiler_status_word.Data;
    A380SecComputer_B.SSM_cy = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_spoiler_1_position_deg.SSM;
    A380SecComputer_B.Data_gqa = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_spoiler_1_position_deg.Data;
    A380SecComputer_B.Data_hz = A380SecComputer_U.in.bus_inputs.adr_2_bus.mach.Data;
    A380SecComputer_B.SSM_ju = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_spoiler_1_position_deg.SSM;
    A380SecComputer_B.Data_fri = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_spoiler_1_position_deg.Data;
    A380SecComputer_B.SSM_ey = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_spoiler_2_position_deg.SSM;
    A380SecComputer_B.Data_cm = A380SecComputer_U.in.bus_inputs.sec_y_bus.left_spoiler_2_position_deg.Data;
    A380SecComputer_B.SSM_jr = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_spoiler_2_position_deg.SSM;
    A380SecComputer_B.Data_czj = A380SecComputer_U.in.bus_inputs.sec_y_bus.right_spoiler_2_position_deg.Data;
    A380SecComputer_B.SSM_hs = A380SecComputer_U.in.bus_inputs.sec_y_bus.elevator_status_word.SSM;
    A380SecComputer_B.Data_mb = A380SecComputer_U.in.bus_inputs.sec_y_bus.elevator_status_word.Data;
    A380SecComputer_B.SSM_mx3 = A380SecComputer_U.in.bus_inputs.sec_y_bus.elevator_1_position_deg.SSM;
    A380SecComputer_B.Data_gk4 = A380SecComputer_U.in.bus_inputs.sec_y_bus.elevator_1_position_deg.Data;
    A380SecComputer_B.SSM_er = A380SecComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.SSM;
    A380SecComputer_B.SSM_hm = A380SecComputer_U.in.bus_inputs.sec_y_bus.elevator_2_position_deg.SSM;
    A380SecComputer_B.Data_gbt = A380SecComputer_U.in.bus_inputs.sec_y_bus.elevator_2_position_deg.Data;
    A380SecComputer_B.SSM_dm = A380SecComputer_U.in.bus_inputs.sec_y_bus.elevator_3_position_deg.SSM;
    A380SecComputer_B.Data_p0 = A380SecComputer_U.in.bus_inputs.sec_y_bus.elevator_3_position_deg.Data;
    A380SecComputer_B.SSM_fk = A380SecComputer_U.in.bus_inputs.sec_y_bus.ths_position_deg.SSM;
    A380SecComputer_B.Data_dn = A380SecComputer_U.in.bus_inputs.sec_y_bus.ths_position_deg.Data;
    A380SecComputer_B.SSM_lm1 = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_status_word.SSM;
    A380SecComputer_B.Data_iyw = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_status_word.Data;
    A380SecComputer_B.SSM_nc = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_1_position_deg.SSM;
    A380SecComputer_B.Data_p5d = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_1_position_deg.Data;
    A380SecComputer_B.Data_oo = A380SecComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.Data;
    A380SecComputer_B.SSM_e4 = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_2_position_deg.SSM;
    A380SecComputer_B.Data_ho = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_2_position_deg.Data;
    A380SecComputer_B.SSM_bw = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_trim_actual_pos_deg.SSM;
    A380SecComputer_B.Data_kqr = A380SecComputer_U.in.bus_inputs.sec_y_bus.rudder_trim_actual_pos_deg.Data;
    A380SecComputer_B.SSM_na = A380SecComputer_U.in.bus_inputs.sec_y_bus.fctl_law_status_word.SSM;
    A380SecComputer_B.Data_omv = A380SecComputer_U.in.bus_inputs.sec_y_bus.fctl_law_status_word.Data;
    A380SecComputer_B.SSM_lf = A380SecComputer_U.in.bus_inputs.sec_y_bus.misc_data_status_word.SSM;
    A380SecComputer_B.Data_mby = A380SecComputer_U.in.bus_inputs.sec_y_bus.misc_data_status_word.Data;
    A380SecComputer_B.SSM_oz = A380SecComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.SSM;
    A380SecComputer_B.Data_hk = A380SecComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
    A380SecComputer_B.tailstrike_protection_on = A380SecComputer_U.in.sim_data.tailstrike_protection_on;
    A380SecComputer_B.SSM_mub = A380SecComputer_U.in.bus_inputs.adr_2_bus.vertical_speed_ft_min.SSM;
    A380SecComputer_B.Data_hg = A380SecComputer_U.in.bus_inputs.adr_2_bus.vertical_speed_ft_min.Data;
    A380SecComputer_B.SSM_li = A380SecComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM;
    A380SecComputer_B.Data_bi = A380SecComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
    A380SecComputer_B.SSM_hcd = A380SecComputer_U.in.bus_inputs.adr_2_bus.corrected_average_static_pressure.SSM;
    A380SecComputer_B.Data_i4u = A380SecComputer_U.in.bus_inputs.adr_2_bus.corrected_average_static_pressure.Data;
    A380SecComputer_B.SSM_php = A380SecComputer_U.in.bus_inputs.ir_1_bus.discrete_word_1.SSM;
    A380SecComputer_B.Data_ik = A380SecComputer_U.in.bus_inputs.ir_1_bus.discrete_word_1.Data;
    A380SecComputer_B.SSM_ma = A380SecComputer_U.in.bus_inputs.ir_1_bus.latitude_deg.SSM;
    A380SecComputer_B.Data_dq = A380SecComputer_U.in.bus_inputs.ir_1_bus.latitude_deg.Data;
    A380SecComputer_B.computer_running = A380SecComputer_U.in.sim_data.computer_running;
    A380SecComputer_B.SSM_jut = A380SecComputer_U.in.bus_inputs.ir_1_bus.longitude_deg.SSM;
    A380SecComputer_B.Data_pv = A380SecComputer_U.in.bus_inputs.ir_1_bus.longitude_deg.Data;
    A380SecComputer_B.SSM_kh = A380SecComputer_U.in.bus_inputs.ir_1_bus.ground_speed_kn.SSM;
    A380SecComputer_B.Data_p1d = A380SecComputer_U.in.bus_inputs.ir_1_bus.ground_speed_kn.Data;
    A380SecComputer_B.SSM_h2 = A380SecComputer_U.in.bus_inputs.ir_1_bus.track_angle_true_deg.SSM;
    A380SecComputer_B.Data_lyv = A380SecComputer_U.in.bus_inputs.ir_1_bus.track_angle_true_deg.Data;
    A380SecComputer_B.SSM_ago = A380SecComputer_U.in.bus_inputs.ir_1_bus.heading_true_deg.SSM;
    A380SecComputer_B.Data_ke = A380SecComputer_U.in.bus_inputs.ir_1_bus.heading_true_deg.Data;
    A380SecComputer_B.SSM_ep = A380SecComputer_U.in.bus_inputs.ir_1_bus.wind_speed_kn.SSM;
    A380SecComputer_B.Data_cv = A380SecComputer_U.in.bus_inputs.ir_1_bus.wind_speed_kn.Data;
    A380SecComputer_B.sec_overhead_button_pressed = A380SecComputer_U.in.discrete_inputs.sec_overhead_button_pressed;
    A380SecComputer_B.SSM_kc = A380SecComputer_U.in.bus_inputs.ir_1_bus.wind_direction_true_deg.SSM;
    A380SecComputer_B.Data_pfh = A380SecComputer_U.in.bus_inputs.ir_1_bus.wind_direction_true_deg.Data;
    A380SecComputer_B.SSM_cnf = A380SecComputer_U.in.bus_inputs.ir_1_bus.track_angle_magnetic_deg.SSM;
    A380SecComputer_B.Data_jy4 = A380SecComputer_U.in.bus_inputs.ir_1_bus.track_angle_magnetic_deg.Data;
    A380SecComputer_B.SSM_lwa = A380SecComputer_U.in.bus_inputs.ir_1_bus.heading_magnetic_deg.SSM;
    A380SecComputer_B.Data_o1 = A380SecComputer_U.in.bus_inputs.ir_1_bus.heading_magnetic_deg.Data;
    A380SecComputer_B.SSM_aq = A380SecComputer_U.in.bus_inputs.ir_1_bus.drift_angle_deg.SSM;
    A380SecComputer_B.Data_ga = A380SecComputer_U.in.bus_inputs.ir_1_bus.drift_angle_deg.Data;
    A380SecComputer_B.SSM_ja2 = A380SecComputer_U.in.bus_inputs.ir_1_bus.flight_path_angle_deg.SSM;
    A380SecComputer_B.Data_kd = A380SecComputer_U.in.bus_inputs.ir_1_bus.flight_path_angle_deg.Data;
  ...
  A380SecComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_true_kn.SSM = A380SecComputer_B.SSM_oz;
  A380SecComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_true_kn.Data = A380SecComputer_B.Data_hk;
  A380SecComputer_Y.out.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.SSM = A380SecComputer_B.SSM_mub;
  A380SecComputer_Y.out.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.Data = A380SecComputer_B.Data_hg;
  A380SecComputer_Y.out.data.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM = A380SecComputer_B.SSM_li;
  A380SecComputer_Y.out.data.bus_inputs.adr_2_bus.aoa_corrected_deg.Data = A380SecComputer_B.Data_bi;
  A380SecComputer_Y.out.data.bus_inputs.adr_2_bus.corrected_average_static_pressure.SSM = A380SecComputer_B.SSM_hcd;
  A380SecComputer_Y.out.data.bus_inputs.adr_2_bus.corrected_average_static_pressure.Data = A380SecComputer_B.Data_i4u;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.discrete_word_1.SSM = A380SecComputer_B.SSM_php;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.discrete_word_1.Data = A380SecComputer_B.Data_ik;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.latitude_deg.SSM = A380SecComputer_B.SSM_ma;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.latitude_deg.Data = A380SecComputer_B.Data_dq;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.longitude_deg.SSM = A380SecComputer_B.SSM_jut;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.longitude_deg.Data = A380SecComputer_B.Data_pv;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.ground_speed_kn.SSM = A380SecComputer_B.SSM_kh;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.ground_speed_kn.Data = A380SecComputer_B.Data_p1d;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.track_angle_true_deg.SSM = A380SecComputer_B.SSM_h2;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.track_angle_true_deg.Data = A380SecComputer_B.Data_lyv;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.heading_true_deg.SSM = A380SecComputer_B.SSM_ago;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.heading_true_deg.Data = A380SecComputer_B.Data_ke;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.wind_speed_kn.SSM = A380SecComputer_B.SSM_ep;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.wind_speed_kn.Data = A380SecComputer_B.Data_cv;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.wind_direction_true_deg.SSM = A380SecComputer_B.SSM_kc;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.wind_direction_true_deg.Data = A380SecComputer_B.Data_pfh;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.track_angle_magnetic_deg.SSM = A380SecComputer_B.SSM_cnf;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.track_angle_magnetic_deg.Data = A380SecComputer_B.Data_jy4;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.heading_magnetic_deg.SSM = A380SecComputer_B.SSM_lwa;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.heading_magnetic_deg.Data = A380SecComputer_B.Data_o1;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.drift_angle_deg.SSM = A380SecComputer_B.SSM_aq;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.drift_angle_deg.Data = A380SecComputer_B.Data_ga;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.flight_path_angle_deg.SSM = A380SecComputer_B.SSM_ja2;
  A380SecComputer_Y.out.data.bus_inputs.ir_1_bus.flight_path_angle_deg.Data = A380SecComputer_B.Data_kd;
  ...
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.radio_height_1_ft.SSM = A380SecComputer_B.SSM_es;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.radio_height_1_ft.Data = A380SecComputer_B.Data_ku;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.radio_height_2_ft.SSM = A380SecComputer_B.SSM_gi1;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.radio_height_2_ft.Data = A380SecComputer_B.Data_jp;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.fctl_law_status_word.SSM = A380SecComputer_B.SSM_jz;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.fctl_law_status_word.Data = A380SecComputer_B.Data_nu;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.discrete_status_word_1.SSM = A380SecComputer_B.SSM_kt;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.discrete_status_word_1.Data = A380SecComputer_B.Data_br;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.fe_status_word.SSM = A380SecComputer_B.SSM_ds;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.fe_status_word.Data = A380SecComputer_B.Data_ae;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.fg_status_word.SSM = A380SecComputer_B.SSM_eg;
  A380SecComputer_Y.out.data.bus_inputs.prim_1_bus.fg_status_word.Data = A380SecComputer_B.Data_pe;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_inboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_a0;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_inboard_aileron_command_deg.Data = A380SecComputer_B.Data_fy;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_inboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_cv;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_inboard_aileron_command_deg.Data = A380SecComputer_B.Data_na;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_midboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_ea;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_midboard_aileron_command_deg.Data = A380SecComputer_B.Data_my;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_midboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_p4;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_midboard_aileron_command_deg.Data = A380SecComputer_B.Data_i4;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_outboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_m2;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_outboard_aileron_command_deg.Data = A380SecComputer_B.Data_cx;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_outboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_bt0;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_outboard_aileron_command_deg.Data = A380SecComputer_B.Data_nz;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_1_command_deg.SSM = A380SecComputer_B.SSM_nr;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_1_command_deg.Data = A380SecComputer_B.Data_id;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_1_command_deg.SSM = A380SecComputer_B.SSM_fr;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_1_command_deg.Data = A380SecComputer_B.Data_o2;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_2_command_deg.SSM = A380SecComputer_B.SSM_cc;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_2_command_deg.Data = A380SecComputer_B.Data_gqq;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_2_command_deg.SSM = A380SecComputer_B.SSM_lm;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_2_command_deg.Data = A380SecComputer_B.Data_md;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_3_command_deg.SSM = A380SecComputer_B.SSM_mkm;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_3_command_deg.Data = A380SecComputer_B.Data_cz;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_3_command_deg.SSM = A380SecComputer_B.SSM_jhd;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_3_command_deg.Data = A380SecComputer_B.Data_pm;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_4_command_deg.SSM = A380SecComputer_B.SSM_av;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_4_command_deg.Data = A380SecComputer_B.Data_bj;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_4_command_deg.SSM = A380SecComputer_B.SSM_ira;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_4_command_deg.Data = A380SecComputer_B.Data_ox;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_5_command_deg.SSM = A380SecComputer_B.SSM_ge;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_5_command_deg.Data = A380SecComputer_B.Data_pe5;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_5_command_deg.SSM = A380SecComputer_B.SSM_lv;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_5_command_deg.Data = A380SecComputer_B.Data_jj;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_6_command_deg.SSM = A380SecComputer_B.SSM_cg;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_6_command_deg.Data = A380SecComputer_B.Data_p5;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_6_command_deg.SSM = A380SecComputer_B.SSM_be;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_6_command_deg.Data = A380SecComputer_B.Data_ekl;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_7_command_deg.SSM = A380SecComputer_B.SSM_axb;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_7_command_deg.Data = A380SecComputer_B.Data_nd;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_7_command_deg.SSM = A380SecComputer_B.SSM_nz;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_7_command_deg.Data = A380SecComputer_B.Data_n2;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_8_command_deg.SSM = A380SecComputer_B.SSM_cx;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_8_command_deg.Data = A380SecComputer_B.Data_dl;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_8_command_deg.SSM = A380SecComputer_B.SSM_gh;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_8_command_deg.Data = A380SecComputer_B.Data_gs2;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_inboard_elevator_command_deg.SSM = A380SecComputer_B.SSM_ks;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_inboard_elevator_command_deg.Data = A380SecComputer_B.Data_h4;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_inboard_elevator_command_deg.SSM = A380SecComputer_B.SSM_pw;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_inboard_elevator_command_deg.Data = A380SecComputer_B.Data_e3;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_outboard_elevator_command_deg.SSM = A380SecComputer_B.SSM_fh;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_outboard_elevator_command_deg.Data = A380SecComputer_B.Data_f5h;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_outboard_elevator_command_deg.SSM = A380SecComputer_B.SSM_gzn;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_outboard_elevator_command_deg.Data = A380SecComputer_B.Data_an;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.ths_command_deg.SSM = A380SecComputer_B.SSM_oo;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.ths_command_deg.Data = A380SecComputer_B.Data_i4o;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.upper_rudder_command_deg.SSM = A380SecComputer_B.SSM_evh;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.upper_rudder_command_deg.Data = A380SecComputer_B.Data_af;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.lower_rudder_command_deg.SSM = A380SecComputer_B.SSM_cn;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.lower_rudder_command_deg.Data = A380SecComputer_B.Data_bm;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_sidestick_pitch_command_deg.SSM = A380SecComputer_B.SSM_co;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_sidestick_pitch_command_deg.Data = A380SecComputer_B.Data_dk;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_sidestick_pitch_command_deg.SSM = A380SecComputer_B.SSM_pe;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_sidestick_pitch_command_deg.Data = A380SecComputer_B.Data_nv;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_sidestick_roll_command_deg.SSM = A380SecComputer_B.SSM_cgz;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_sidestick_roll_command_deg.Data = A380SecComputer_B.Data_jpf;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_sidestick_roll_command_deg.SSM = A380SecComputer_B.SSM_fw;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_sidestick_roll_command_deg.Data = A380SecComputer_B.Data_i5;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.rudder_pedal_position_deg.SSM = A380SecComputer_B.SSM_h4;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.rudder_pedal_position_deg.Data = A380SecComputer_B.Data_k2;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.aileron_status_word.SSM = A380SecComputer_B.SSM_cb3;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.aileron_status_word.Data = A380SecComputer_B.Data_as;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_aileron_1_position_deg.SSM = A380SecComputer_B.SSM_pj;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_aileron_1_position_deg.Data = A380SecComputer_B.Data_gk;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_aileron_2_position_deg.SSM = A380SecComputer_B.SSM_dv;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_aileron_2_position_deg.Data = A380SecComputer_B.Data_jl;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_aileron_1_position_deg.SSM = A380SecComputer_B.SSM_i4;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_aileron_1_position_deg.Data = A380SecComputer_B.Data_e32;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_aileron_2_position_deg.SSM = A380SecComputer_B.SSM_fm;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_aileron_2_position_deg.Data = A380SecComputer_B.Data_ih;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.spoiler_status_word.SSM = A380SecComputer_B.SSM_e5;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.spoiler_status_word.Data = A380SecComputer_B.Data_du;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_position_deg.SSM = A380SecComputer_B.SSM_bf;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.left_spoiler_position_deg.Data = A380SecComputer_B.Data_nx;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_position_deg.SSM = A380SecComputer_B.SSM_fd;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.right_spoiler_position_deg.Data = A380SecComputer_B.Data_n0;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.elevator_status_word.SSM = A380SecComputer_B.SSM_fv;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.elevator_status_word.Data = A380SecComputer_B.Data_eqi;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.elevator_1_position_deg.SSM = A380SecComputer_B.SSM_dt;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.elevator_1_position_deg.Data = A380SecComputer_B.Data_om;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.elevator_2_position_deg.SSM = A380SecComputer_B.SSM_j5;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.elevator_2_position_deg.Data = A380SecComputer_B.Data_nr;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.elevator_3_position_deg.SSM = A380SecComputer_B.SSM_cs;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.elevator_3_position_deg.Data = A380SecComputer_B.Data_p3;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.ths_position_deg.SSM = A380SecComputer_B.SSM_ls;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.ths_position_deg.Data = A380SecComputer_B.Data_nb;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.rudder_status_word.SSM = A380SecComputer_B.SSM_dg;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.rudder_status_word.Data = A380SecComputer_B.Data_hd;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.rudder_1_position_deg.SSM = A380SecComputer_B.SSM_d3;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.rudder_1_position_deg.Data = A380SecComputer_B.Data_al;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.rudder_2_position_deg.SSM = A380SecComputer_B.SSM_p2;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.rudder_2_position_deg.Data = A380SecComputer_B.Data_gu;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.radio_height_1_ft.SSM = A380SecComputer_B.SSM_bo0;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.radio_height_1_ft.Data = A380SecComputer_B.Data_do;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.radio_height_2_ft.SSM = A380SecComputer_B.SSM_bc;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.radio_height_2_ft.Data = A380SecComputer_B.Data_hu;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.fctl_law_status_word.SSM = A380SecComputer_B.SSM_h0;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.fctl_law_status_word.Data = A380SecComputer_B.Data_pm1;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.discrete_status_word_1.SSM = A380SecComputer_B.SSM_giz;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.discrete_status_word_1.Data = A380SecComputer_B.Data_i2y;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.fe_status_word.SSM = A380SecComputer_B.SSM_mqp;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.fe_status_word.Data = A380SecComputer_B.Data_pg;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.fg_status_word.SSM = A380SecComputer_B.SSM_in;
  A380SecComputer_Y.out.data.bus_inputs.prim_2_bus.fg_status_word.Data = A380SecComputer_B.Data_ni;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_inboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_ff;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_inboard_aileron_command_deg.Data = A380SecComputer_B.Data_fr;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_inboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_ic;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_inboard_aileron_command_deg.Data = A380SecComputer_B.Data_cn;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_midboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_fs;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_midboard_aileron_command_deg.Data = A380SecComputer_B.Data_nxl;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_midboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_ja;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_midboard_aileron_command_deg.Data = A380SecComputer_B.Data_jh;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_outboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_js;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_outboard_aileron_command_deg.Data = A380SecComputer_B.Data_gn;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_outboard_aileron_command_deg.SSM = A380SecComputer_B.SSM_is3;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_outboard_aileron_command_deg.Data = A380SecComputer_B.Data_myb;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_1_command_deg.SSM = A380SecComputer_B.SSM_ag;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_1_command_deg.Data = A380SecComputer_B.Data_l2;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_1_command_deg.SSM = A380SecComputer_B.SSM_f5;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_1_command_deg.Data = A380SecComputer_B.Data_o5o;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_2_command_deg.SSM = A380SecComputer_B.SSM_ph;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_2_command_deg.Data = A380SecComputer_B.Data_l5;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_2_command_deg.SSM = A380SecComputer_B.SSM_jy;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_2_command_deg.Data = A380SecComputer_B.Data_dc2;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_3_command_deg.SSM = A380SecComputer_B.SSM_j1;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_3_command_deg.Data = A380SecComputer_B.Data_gr;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_3_command_deg.SSM = A380SecComputer_B.SSM_ov;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_3_command_deg.Data = A380SecComputer_B.Data_gp;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_4_command_deg.SSM = A380SecComputer_B.SSM_mx;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_4_command_deg.Data = A380SecComputer_B.Data_i3;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_4_command_deg.SSM = A380SecComputer_B.SSM_b4;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_4_command_deg.Data = A380SecComputer_B.Data_et;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_5_command_deg.SSM = A380SecComputer_B.SSM_gb;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_5_command_deg.Data = A380SecComputer_B.Data_k3;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_5_command_deg.SSM = A380SecComputer_B.SSM_oh;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_5_command_deg.Data = A380SecComputer_B.Data_f2;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_6_command_deg.SSM = A380SecComputer_B.SSM_mm5;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_6_command_deg.Data = A380SecComputer_B.Data_gh;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_6_command_deg.SSM = A380SecComputer_B.SSM_br;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_6_command_deg.Data = A380SecComputer_B.Data_ed;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_7_command_deg.SSM = A380SecComputer_B.SSM_c2;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_7_command_deg.Data = A380SecComputer_B.Data_o2j;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_7_command_deg.SSM = A380SecComputer_B.SSM_ktr;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_7_command_deg.Data = A380SecComputer_B.Data_i43;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_8_command_deg.SSM = A380SecComputer_B.SSM_gl;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_8_command_deg.Data = A380SecComputer_B.Data_ic;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_8_command_deg.SSM = A380SecComputer_B.SSM_my;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_8_command_deg.Data = A380SecComputer_B.Data_ak;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_inboard_elevator_command_deg.SSM = A380SecComputer_B.SSM_j3;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_inboard_elevator_command_deg.Data = A380SecComputer_B.Data_jg;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_inboard_elevator_command_deg.SSM = A380SecComputer_B.SSM_go;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_inboard_elevator_command_deg.Data = A380SecComputer_B.Data_cu;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_outboard_elevator_command_deg.SSM = A380SecComputer_B.SSM_e5c;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_outboard_elevator_command_deg.Data = A380SecComputer_B.Data_d3;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_outboard_elevator_command_deg.SSM = A380SecComputer_B.SSM_dk;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_outboard_elevator_command_deg.Data = A380SecComputer_B.Data_bt;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.ths_command_deg.SSM = A380SecComputer_B.SSM_evc;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.ths_command_deg.Data = A380SecComputer_B.Data_e0;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.upper_rudder_command_deg.SSM = A380SecComputer_B.SSM_kk;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.upper_rudder_command_deg.Data = A380SecComputer_B.Data_jl3;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.lower_rudder_command_deg.SSM = A380SecComputer_B.SSM_af;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.lower_rudder_command_deg.Data = A380SecComputer_B.Data_nm;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_sidestick_pitch_command_deg.SSM = A380SecComputer_B.SSM_ew;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_sidestick_pitch_command_deg.Data = A380SecComputer_B.Data_ia;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_sidestick_pitch_command_deg.SSM = A380SecComputer_B.SSM_lt;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_sidestick_pitch_command_deg.Data = A380SecComputer_B.Data_j0;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_sidestick_roll_command_deg.SSM = A380SecComputer_B.SSM_ger;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_sidestick_roll_command_deg.Data = A380SecComputer_B.Data_bs;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_sidestick_roll_command_deg.SSM = A380SecComputer_B.SSM_pxo;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_sidestick_roll_command_deg.Data = A380SecComputer_B.Data_hp;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.rudder_pedal_position_deg.SSM = A380SecComputer_B.SSM_co2;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.rudder_pedal_position_deg.Data = A380SecComputer_B.Data_ct;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.aileron_status_word.SSM = A380SecComputer_B.SSM_ny;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.aileron_status_word.Data = A380SecComputer_B.Data_nzt;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_aileron_1_position_deg.SSM = A380SecComputer_B.SSM_l4;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_aileron_1_position_deg.Data = A380SecComputer_B.Data_c0;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_aileron_2_position_deg.SSM = A380SecComputer_B.SSM_nm;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_aileron_2_position_deg.Data = A380SecComputer_B.Data_ojg;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_aileron_1_position_deg.SSM = A380SecComputer_B.SSM_nh;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_aileron_1_position_deg.Data = A380SecComputer_B.Data_lm;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_aileron_2_position_deg.SSM = A380SecComputer_B.SSM_dl;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_aileron_2_position_deg.Data = A380SecComputer_B.Data_fz;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.spoiler_status_word.SSM = A380SecComputer_B.SSM_a5h;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.spoiler_status_word.Data = A380SecComputer_B.Data_oz;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_position_deg.SSM = A380SecComputer_B.SSM_fl;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.left_spoiler_position_deg.Data = A380SecComputer_B.Data_gf;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_position_deg.SSM = A380SecComputer_B.SSM_p3;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.right_spoiler_position_deg.Data = A380SecComputer_B.Data_nn;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.elevator_status_word.SSM = A380SecComputer_B.SSM_ns;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.elevator_status_word.Data = A380SecComputer_B.Data_a0z;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.elevator_1_position_deg.SSM = A380SecComputer_B.SSM_bm;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.elevator_1_position_deg.Data = A380SecComputer_B.Data_fk;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.elevator_2_position_deg.SSM = A380SecComputer_B.SSM_nl;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.elevator_2_position_deg.Data = A380SecComputer_B.Data_o23;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.elevator_3_position_deg.SSM = A380SecComputer_B.SSM_grm;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.elevator_3_position_deg.Data = A380SecComputer_B.Data_g3;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.ths_position_deg.SSM = A380SecComputer_B.SSM_gzm;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.ths_position_deg.Data = A380SecComputer_B.Data_icc;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.rudder_status_word.SSM = A380SecComputer_B.SSM_oi;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.rudder_status_word.Data = A380SecComputer_B.Data_pwf;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.rudder_1_position_deg.SSM = A380SecComputer_B.SSM_aa;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.rudder_1_position_deg.Data = A380SecComputer_B.Data_gvk;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.rudder_2_position_deg.SSM = A380SecComputer_B.SSM_lw;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.rudder_2_position_deg.Data = A380SecComputer_B.Data_ln;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.radio_height_1_ft.SSM = A380SecComputer_B.SSM_fa;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.radio_height_1_ft.Data = A380SecComputer_B.Data_ka;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.radio_height_2_ft.SSM = A380SecComputer_B.SSM_lbx;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.radio_height_2_ft.Data = A380SecComputer_B.Data_mp;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.fctl_law_status_word.SSM = A380SecComputer_B.SSM_n3;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.fctl_law_status_word.Data = A380SecComputer_B.Data_m4;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.discrete_status_word_1.SSM = A380SecComputer_B.SSM_a1;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.discrete_status_word_1.Data = A380SecComputer_B.Data_fki;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.fe_status_word.SSM = A380SecComputer_B.SSM_p1;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.fe_status_word.Data = A380SecComputer_B.Data_m21;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.fg_status_word.SSM = A380SecComputer_B.SSM_cn2;
  A380SecComputer_Y.out.data.bus_inputs.prim_3_bus.fg_status_word.Data = A380SecComputer_B.Data_nbg;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_sidestick_pitch_command_deg.SSM = A380SecComputer_B.SSM_an3;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_sidestick_pitch_command_deg.Data = A380SecComputer_B.Data_l25;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_sidestick_pitch_command_deg.SSM = A380SecComputer_B.SSM_c3;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_sidestick_pitch_command_deg.Data = A380SecComputer_B.Data_ki;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_sidestick_roll_command_deg.SSM = A380SecComputer_B.SSM_dp;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_sidestick_roll_command_deg.Data = A380SecComputer_B.Data_p5p;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_sidestick_roll_command_deg.SSM = A380SecComputer_B.SSM_lg;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_sidestick_roll_command_deg.Data = A380SecComputer_B.Data_nry;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_pedal_position_deg.SSM = A380SecComputer_B.SSM_cm;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_pedal_position_deg.Data = A380SecComputer_B.Data_mh;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.aileron_status_word.SSM = A380SecComputer_B.SSM_hl;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.aileron_status_word.Data = A380SecComputer_B.Data_ll;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_aileron_1_position_deg.SSM = A380SecComputer_B.SSM_irh;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_aileron_1_position_deg.Data = A380SecComputer_B.Data_hy;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_aileron_2_position_deg.SSM = A380SecComputer_B.SSM_b42;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_aileron_2_position_deg.Data = A380SecComputer_B.Data_j04;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_aileron_1_position_deg.SSM = A380SecComputer_B.SSM_anz;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_aileron_1_position_deg.Data = A380SecComputer_B.Data_pl;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_aileron_2_position_deg.SSM = A380SecComputer_B.SSM_d2;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_aileron_2_position_deg.Data = A380SecComputer_B.Data_gb;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.spoiler_status_word.SSM = A380SecComputer_B.SSM_gov;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.spoiler_status_word.Data = A380SecComputer_B.Data_hq;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_spoiler_1_position_deg.SSM = A380SecComputer_B.SSM_nb;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_spoiler_1_position_deg.Data = A380SecComputer_B.Data_ai;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_spoiler_1_position_deg.SSM = A380SecComputer_B.SSM_pe3;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_spoiler_1_position_deg.Data = A380SecComputer_B.Data_gfr;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_spoiler_2_position_deg.SSM = A380SecComputer_B.SSM_jx;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.left_spoiler_2_position_deg.Data = A380SecComputer_B.Data_czp;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_spoiler_2_position_deg.SSM = A380SecComputer_B.SSM_npl;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.right_spoiler_2_position_deg.Data = A380SecComputer_B.Data_fm;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.elevator_status_word.SSM = A380SecComputer_B.SSM_gf;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.elevator_status_word.Data = A380SecComputer_B.Data_jsg;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.elevator_1_position_deg.SSM = A380SecComputer_B.SSM_gbi;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.elevator_1_position_deg.Data = A380SecComputer_B.Data_g1;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.elevator_2_position_deg.SSM = A380SecComputer_B.SSM_fhm;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.elevator_2_position_deg.Data = A380SecComputer_B.Data_j4;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.elevator_3_position_deg.SSM = A380SecComputer_B.SSM_ltj;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.elevator_3_position_deg.Data = A380SecComputer_B.Data_e4;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.ths_position_deg.SSM = A380SecComputer_B.SSM_hn;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.ths_position_deg.Data = A380SecComputer_B.Data_ghs;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_status_word.SSM = A380SecComputer_B.SSM_h3;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_status_word.Data = A380SecComputer_B.Data_bmk;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_1_position_deg.SSM = A380SecComputer_B.SSM_bfs;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_1_position_deg.Data = A380SecComputer_B.Data_lzt;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_2_position_deg.SSM = A380SecComputer_B.SSM_p0;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_2_position_deg.Data = A380SecComputer_B.Data_kn;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_trim_actual_pos_deg.SSM = A380SecComputer_B.SSM_hr;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.rudder_trim_actual_pos_deg.Data = A380SecComputer_B.Data_nab;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.fctl_law_status_word.SSM = A380SecComputer_B.SSM_bi;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.fctl_law_status_word.Data = A380SecComputer_B.Data_lgf;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.misc_data_status_word.SSM = A380SecComputer_B.SSM_bd;
  A380SecComputer_Y.out.data.bus_inputs.sec_x_bus.misc_data_status_word.Data = A380SecComputer_B.Data_fpq;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_sidestick_pitch_command_deg.SSM = A380SecComputer_B.SSM_omt;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_sidestick_pitch_command_deg.Data = A380SecComputer_B.Data_dt;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_sidestick_pitch_command_deg.SSM = A380SecComputer_B.SSM_la;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_sidestick_pitch_command_deg.Data = A380SecComputer_B.Data_b1;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_sidestick_roll_command_deg.SSM = A380SecComputer_B.SSM_l1;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_sidestick_roll_command_deg.Data = A380SecComputer_B.Data_ea;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_sidestick_roll_command_deg.SSM = A380SecComputer_B.SSM_dy;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_sidestick_roll_command_deg.Data = A380SecComputer_B.Data_nib;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_pedal_position_deg.SSM = A380SecComputer_B.SSM_ie;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_pedal_position_deg.Data = A380SecComputer_B.Data_i2t;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.aileron_status_word.SSM = A380SecComputer_B.SSM_kf;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.aileron_status_word.Data = A380SecComputer_B.Data_ng;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_aileron_1_position_deg.SSM = A380SecComputer_B.SSM_p5l;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_aileron_1_position_deg.Data = A380SecComputer_B.Data_h31;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_aileron_2_position_deg.SSM = A380SecComputer_B.SSM_b3;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_aileron_2_position_deg.Data = A380SecComputer_B.Data_ew;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_aileron_1_position_deg.SSM = A380SecComputer_B.SSM_dxv;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_aileron_1_position_deg.Data = A380SecComputer_B.Data_j1s;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_aileron_2_position_deg.SSM = A380SecComputer_B.SSM_mxz;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_aileron_2_position_deg.Data = A380SecComputer_B.Data_j5;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.spoiler_status_word.SSM = A380SecComputer_B.SSM_kk4;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.spoiler_status_word.Data = A380SecComputer_B.Data_cw;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_spoiler_1_position_deg.SSM = A380SecComputer_B.SSM_cy;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_spoiler_1_position_deg.Data = A380SecComputer_B.Data_gqa;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_spoiler_1_position_deg.SSM = A380SecComputer_B.SSM_ju;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_spoiler_1_position_deg.Data = A380SecComputer_B.Data_fri;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_spoiler_2_position_deg.SSM = A380SecComputer_B.SSM_ey;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.left_spoiler_2_position_deg.Data = A380SecComputer_B.Data_cm;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_spoiler_2_position_deg.SSM = A380SecComputer_B.SSM_jr;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.right_spoiler_2_position_deg.Data = A380SecComputer_B.Data_czj;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.elevator_status_word.SSM = A380SecComputer_B.SSM_hs;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.elevator_status_word.Data = A380SecComputer_B.Data_mb;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.elevator_1_position_deg.SSM = A380SecComputer_B.SSM_mx3;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.elevator_1_position_deg.Data = A380SecComputer_B.Data_gk4;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.elevator_2_position_deg.SSM = A380SecComputer_B.SSM_hm;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.elevator_2_position_deg.Data = A380SecComputer_B.Data_gbt;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.elevator_3_position_deg.SSM = A380SecComputer_B.SSM_dm;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.elevator_3_position_deg.Data = A380SecComputer_B.Data_p0;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.ths_position_deg.SSM = A380SecComputer_B.SSM_fk;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.ths_position_deg.Data = A380SecComputer_B.Data_dn;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_status_word.SSM = A380SecComputer_B.SSM_lm1;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_status_word.Data = A380SecComputer_B.Data_iyw;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_1_position_deg.SSM = A380SecComputer_B.SSM_nc;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_1_position_deg.Data = A380SecComputer_B.Data_p5d;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_2_position_deg.SSM = A380SecComputer_B.SSM_e4;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_2_position_deg.Data = A380SecComputer_B.Data_ho;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_trim_actual_pos_deg.SSM = A380SecComputer_B.SSM_bw;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.rudder_trim_actual_pos_deg.Data = A380SecComputer_B.Data_kqr;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.fctl_law_status_word.SSM = A380SecComputer_B.SSM_na;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.fctl_law_status_word.Data = A380SecComputer_B.Data_omv;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.misc_data_status_word.SSM = A380SecComputer_B.SSM_lf;
  A380SecComputer_Y.out.data.bus_inputs.sec_y_bus.misc_data_status_word.Data = A380SecComputer_B.Data_mby;
...
void A380SecComputer::initialize()
{
  ...
  A380SecComputer_B.SSM_oz = A380SecComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_true_kn.SSM;
  A380SecComputer_B.Data_hk = A380SecComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
  A380SecComputer_B.SSM_mub = A380SecComputer_P.out_Y0.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.SSM;
  A380SecComputer_B.Data_hg = A380SecComputer_P.out_Y0.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.Data;
  A380SecComputer_B.SSM_li = A380SecComputer_P.out_Y0.data.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM;
  A380SecComputer_B.Data_bi = A380SecComputer_P.out_Y0.data.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
  A380SecComputer_B.SSM_hcd = A380SecComputer_P.out_Y0.data.bus_inputs.adr_2_bus.corrected_average_static_pressure.SSM;
  A380SecComputer_B.Data_i4u = A380SecComputer_P.out_Y0.data.bus_inputs.adr_2_bus.corrected_average_static_pressure.Data;
  A380SecComputer_B.SSM_php = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.discrete_word_1.SSM;
  A380SecComputer_B.Data_ik = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.discrete_word_1.Data;
  A380SecComputer_B.SSM_ma = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.latitude_deg.SSM;
  A380SecComputer_B.Data_dq = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.latitude_deg.Data;
  A380SecComputer_B.SSM_jut = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.longitude_deg.SSM;
  A380SecComputer_B.Data_pv = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.longitude_deg.Data;
  A380SecComputer_B.SSM_kh = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.ground_speed_kn.SSM;
  A380SecComputer_B.Data_p1d = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.ground_speed_kn.Data;
  A380SecComputer_B.SSM_h2 = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.track_angle_true_deg.SSM;
  A380SecComputer_B.Data_lyv = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.track_angle_true_deg.Data;
  A380SecComputer_B.SSM_ago = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.heading_true_deg.SSM;
  A380SecComputer_B.Data_ke = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.heading_true_deg.Data;
  A380SecComputer_B.SSM_ep = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.wind_speed_kn.SSM;
  A380SecComputer_B.Data_cv = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.wind_speed_kn.Data;
  A380SecComputer_B.SSM_kc = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.wind_direction_true_deg.SSM;
  A380SecComputer_B.Data_pfh = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.wind_direction_true_deg.Data;
  A380SecComputer_B.SSM_cnf = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.track_angle_magnetic_deg.SSM;
  A380SecComputer_B.Data_jy4 = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.track_angle_magnetic_deg.Data;
  A380SecComputer_B.SSM_lwa = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.heading_magnetic_deg.SSM;
  A380SecComputer_B.Data_o1 = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.heading_magnetic_deg.Data;
  A380SecComputer_B.SSM_aq = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.drift_angle_deg.SSM;
  A380SecComputer_B.Data_ga = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.drift_angle_deg.Data;
  A380SecComputer_B.SSM_ja2 = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.flight_path_angle_deg.SSM;
  A380SecComputer_B.Data_kd = A380SecComputer_P.out_Y0.data.bus_inputs.ir_1_bus.flight_path_angle_deg.Data;
  ...
  A380SecComputer_B.SSM_es = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.radio_height_1_ft.SSM;
  A380SecComputer_B.Data_ku = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.radio_height_1_ft.Data;
  A380SecComputer_B.SSM_gi1 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.radio_height_2_ft.SSM;
  A380SecComputer_B.Data_jp = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.radio_height_2_ft.Data;
  A380SecComputer_B.SSM_jz = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.fctl_law_status_word.SSM;
  A380SecComputer_B.Data_nu = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.fctl_law_status_word.Data;
  A380SecComputer_B.SSM_kt = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.discrete_status_word_1.SSM;
  A380SecComputer_B.Data_br = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.discrete_status_word_1.Data;
  A380SecComputer_B.SSM_ds = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.fe_status_word.SSM;
  A380SecComputer_B.Data_ae = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.fe_status_word.Data;
  A380SecComputer_B.SSM_eg = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.fg_status_word.SSM;
  A380SecComputer_B.Data_pe = A380SecComputer_P.out_Y0.data.bus_inputs.prim_1_bus.fg_status_word.Data;
  A380SecComputer_B.SSM_a0 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_inboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_fy = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_inboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_cv = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_inboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_na = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_inboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_ea = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_midboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_my = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_midboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_p4 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_midboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_i4 =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_midboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_m2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_outboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_cx = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_outboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_bt0 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_outboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_nz =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_outboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_nr = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_1_command_deg.SSM;
  A380SecComputer_B.Data_id = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_1_command_deg.Data;
  A380SecComputer_B.SSM_fr = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_1_command_deg.SSM;
  A380SecComputer_B.Data_o2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_1_command_deg.Data;
  A380SecComputer_B.SSM_cc = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_2_command_deg.SSM;
  A380SecComputer_B.Data_gqq = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_2_command_deg.Data;
  A380SecComputer_B.SSM_lm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_2_command_deg.SSM;
  A380SecComputer_B.Data_md = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_2_command_deg.Data;
  A380SecComputer_B.SSM_mkm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_3_command_deg.SSM;
  A380SecComputer_B.Data_cz = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_3_command_deg.Data;
  A380SecComputer_B.SSM_jhd = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_3_command_deg.SSM;
  A380SecComputer_B.Data_pm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_3_command_deg.Data;
  A380SecComputer_B.SSM_av = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_4_command_deg.SSM;
  A380SecComputer_B.Data_bj = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_4_command_deg.Data;
  A380SecComputer_B.SSM_ira = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_4_command_deg.SSM;
  A380SecComputer_B.Data_ox = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_4_command_deg.Data;
  A380SecComputer_B.SSM_ge = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_5_command_deg.SSM;
  A380SecComputer_B.Data_pe5 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_5_command_deg.Data;
  A380SecComputer_B.SSM_lv = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_5_command_deg.SSM;
  A380SecComputer_B.Data_jj = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_5_command_deg.Data;
  A380SecComputer_B.SSM_cg = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_6_command_deg.SSM;
  A380SecComputer_B.Data_p5 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_6_command_deg.Data;
  A380SecComputer_B.SSM_be = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_6_command_deg.SSM;
  A380SecComputer_B.Data_ekl = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_6_command_deg.Data;
  A380SecComputer_B.SSM_axb = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_7_command_deg.SSM;
  A380SecComputer_B.Data_nd = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_7_command_deg.Data;
  A380SecComputer_B.SSM_nz = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_7_command_deg.SSM;
  A380SecComputer_B.Data_n2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_7_command_deg.Data;
  A380SecComputer_B.SSM_cx = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_8_command_deg.SSM;
  A380SecComputer_B.Data_dl = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_8_command_deg.Data;
  A380SecComputer_B.SSM_gh = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_8_command_deg.SSM;
  A380SecComputer_B.Data_gs2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_8_command_deg.Data;
  A380SecComputer_B.SSM_ks = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_inboard_elevator_command_deg.SSM;
  A380SecComputer_B.Data_h4 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_inboard_elevator_command_deg.Data;
  A380SecComputer_B.SSM_pw = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_inboard_elevator_command_deg.SSM;
  A380SecComputer_B.Data_e3 =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_inboard_elevator_command_deg.Data;
  A380SecComputer_B.SSM_fh = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_outboard_elevator_command_deg.SSM;
  A380SecComputer_B.Data_f5h =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_outboard_elevator_command_deg.Data;
  A380SecComputer_B.SSM_gzn =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_outboard_elevator_command_deg.SSM;
  A380SecComputer_B.Data_an =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_outboard_elevator_command_deg.Data;
  A380SecComputer_B.SSM_oo = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.ths_command_deg.SSM;
  A380SecComputer_B.Data_i4o = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.ths_command_deg.Data;
  A380SecComputer_B.SSM_evh = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.upper_rudder_command_deg.SSM;
  A380SecComputer_B.Data_af = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.upper_rudder_command_deg.Data;
  A380SecComputer_B.SSM_cn = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.lower_rudder_command_deg.SSM;
  A380SecComputer_B.Data_bm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.lower_rudder_command_deg.Data;
  A380SecComputer_B.SSM_co = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_sidestick_pitch_command_deg.SSM;
  A380SecComputer_B.Data_dk = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_sidestick_pitch_command_deg.Data;
  A380SecComputer_B.SSM_pe = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_sidestick_pitch_command_deg.SSM;
  A380SecComputer_B.Data_nv = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_sidestick_pitch_command_deg.Data;
  A380SecComputer_B.SSM_cgz = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_sidestick_roll_command_deg.SSM;
  A380SecComputer_B.Data_jpf = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_sidestick_roll_command_deg.Data;
  A380SecComputer_B.SSM_fw = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_sidestick_roll_command_deg.SSM;
  A380SecComputer_B.Data_i5 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_sidestick_roll_command_deg.Data;
  A380SecComputer_B.SSM_h4 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.rudder_pedal_position_deg.SSM;
  A380SecComputer_B.Data_k2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.rudder_pedal_position_deg.Data;
  A380SecComputer_B.SSM_cb3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.aileron_status_word.SSM;
  A380SecComputer_B.Data_as = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.aileron_status_word.Data;
  A380SecComputer_B.SSM_pj = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_aileron_1_position_deg.SSM;
  A380SecComputer_B.Data_gk = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_aileron_1_position_deg.Data;
  A380SecComputer_B.SSM_dv = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_aileron_2_position_deg.SSM;
  A380SecComputer_B.Data_jl = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_aileron_2_position_deg.Data;
  A380SecComputer_B.SSM_i4 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_aileron_1_position_deg.SSM;
  A380SecComputer_B.Data_e32 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_aileron_1_position_deg.Data;
  A380SecComputer_B.SSM_fm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_aileron_2_position_deg.SSM;
  A380SecComputer_B.Data_ih = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_aileron_2_position_deg.Data;
  A380SecComputer_B.SSM_e5 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.spoiler_status_word.SSM;
  A380SecComputer_B.Data_du = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.spoiler_status_word.Data;
  A380SecComputer_B.SSM_bf = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_position_deg.SSM;
  A380SecComputer_B.Data_nx = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.left_spoiler_position_deg.Data;
  A380SecComputer_B.SSM_fd = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_position_deg.SSM;
  A380SecComputer_B.Data_n0 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.right_spoiler_position_deg.Data;
  A380SecComputer_B.SSM_fv = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.elevator_status_word.SSM;
  A380SecComputer_B.Data_eqi = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.elevator_status_word.Data;
  A380SecComputer_B.SSM_dt = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.elevator_1_position_deg.SSM;
  A380SecComputer_B.Data_om = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.elevator_1_position_deg.Data;
  A380SecComputer_B.SSM_j5 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.elevator_2_position_deg.SSM;
  A380SecComputer_B.Data_nr = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.elevator_2_position_deg.Data;
  A380SecComputer_B.SSM_cs = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.elevator_3_position_deg.SSM;
  A380SecComputer_B.Data_p3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.elevator_3_position_deg.Data;
  A380SecComputer_B.SSM_ls = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.ths_position_deg.SSM;
  A380SecComputer_B.Data_nb = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.ths_position_deg.Data;
  A380SecComputer_B.SSM_dg = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.rudder_status_word.SSM;
  A380SecComputer_B.Data_hd = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.rudder_status_word.Data;
  A380SecComputer_B.SSM_d3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.rudder_1_position_deg.SSM;
  A380SecComputer_B.Data_al = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.rudder_1_position_deg.Data;
  A380SecComputer_B.SSM_p2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.rudder_2_position_deg.SSM;
  A380SecComputer_B.Data_gu = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.rudder_2_position_deg.Data;
  A380SecComputer_B.SSM_bo0 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.radio_height_1_ft.SSM;
  A380SecComputer_B.Data_do = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.radio_height_1_ft.Data;
  A380SecComputer_B.SSM_bc = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.radio_height_2_ft.SSM;
  A380SecComputer_B.Data_hu = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.radio_height_2_ft.Data;
  A380SecComputer_B.SSM_h0 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.fctl_law_status_word.SSM;
  A380SecComputer_B.Data_pm1 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.fctl_law_status_word.Data;
  A380SecComputer_B.SSM_giz = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.discrete_status_word_1.SSM;
  A380SecComputer_B.Data_i2y = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.discrete_status_word_1.Data;
  A380SecComputer_B.SSM_mqp = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.fe_status_word.SSM;
  A380SecComputer_B.Data_pg = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.fe_status_word.Data;
  A380SecComputer_B.SSM_in = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.fg_status_word.SSM;
  A380SecComputer_B.Data_ni = A380SecComputer_P.out_Y0.data.bus_inputs.prim_2_bus.fg_status_word.Data;
  A380SecComputer_B.SSM_ff = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_inboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_fr = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_inboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_ic = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_inboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_cn = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_inboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_fs = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_midboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_nxl =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_midboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_ja = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_midboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_jh =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_midboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_js = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_outboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_gn = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_outboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_is3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_outboard_aileron_command_deg.SSM;
  A380SecComputer_B.Data_myb =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_outboard_aileron_command_deg.Data;
  A380SecComputer_B.SSM_ag = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_1_command_deg.SSM;
  A380SecComputer_B.Data_l2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_1_command_deg.Data;
  A380SecComputer_B.SSM_f5 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_1_command_deg.SSM;
  A380SecComputer_B.Data_o5o = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_1_command_deg.Data;
  A380SecComputer_B.SSM_ph = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_2_command_deg.SSM;
  A380SecComputer_B.Data_l5 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_2_command_deg.Data;
  A380SecComputer_B.SSM_jy = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_2_command_deg.SSM;
  A380SecComputer_B.Data_dc2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_2_command_deg.Data;
  A380SecComputer_B.SSM_j1 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_3_command_deg.SSM;
  A380SecComputer_B.Data_gr = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_3_command_deg.Data;
  A380SecComputer_B.SSM_ov = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_3_command_deg.SSM;
  A380SecComputer_B.Data_gp = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_3_command_deg.Data;
  A380SecComputer_B.SSM_mx = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_4_command_deg.SSM;
  A380SecComputer_B.Data_i3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_4_command_deg.Data;
  A380SecComputer_B.SSM_b4 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_4_command_deg.SSM;
  A380SecComputer_B.Data_et = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_4_command_deg.Data;
  A380SecComputer_B.SSM_gb = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_5_command_deg.SSM;
  A380SecComputer_B.Data_k3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_5_command_deg.Data;
  A380SecComputer_B.SSM_oh = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_5_command_deg.SSM;
  A380SecComputer_B.Data_f2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_5_command_deg.Data;
  A380SecComputer_B.SSM_mm5 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_6_command_deg.SSM;
  A380SecComputer_B.Data_gh = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_6_command_deg.Data;
  A380SecComputer_B.SSM_br = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_6_command_deg.SSM;
  A380SecComputer_B.Data_ed = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_6_command_deg.Data;
  A380SecComputer_B.SSM_c2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_7_command_deg.SSM;
  A380SecComputer_B.Data_o2j = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_7_command_deg.Data;
  A380SecComputer_B.SSM_ktr = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_7_command_deg.SSM;
  A380SecComputer_B.Data_i43 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_7_command_deg.Data;
  A380SecComputer_B.SSM_gl = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_8_command_deg.SSM;
  A380SecComputer_B.Data_ic = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_8_command_deg.Data;
  A380SecComputer_B.SSM_my = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_8_command_deg.SSM;
  A380SecComputer_B.Data_ak = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_8_command_deg.Data;
  A380SecComputer_B.SSM_j3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_inboard_elevator_command_deg.SSM;
  A380SecComputer_B.Data_jg = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_inboard_elevator_command_deg.Data;
  A380SecComputer_B.SSM_go = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_inboard_elevator_command_deg.SSM;
  A380SecComputer_B.Data_cu =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_inboard_elevator_command_deg.Data;
  A380SecComputer_B.SSM_e5c = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_outboard_elevator_command_deg.SSM;
  A380SecComputer_B.Data_d3 =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_outboard_elevator_command_deg.Data;
  A380SecComputer_B.SSM_dk = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_outboard_elevator_command_deg.SSM;
  A380SecComputer_B.Data_bt =
    A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_outboard_elevator_command_deg.Data;
  A380SecComputer_B.SSM_evc = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.ths_command_deg.SSM;
  A380SecComputer_B.Data_e0 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.ths_command_deg.Data;
  A380SecComputer_B.SSM_kk = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.upper_rudder_command_deg.SSM;
  A380SecComputer_B.Data_jl3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.upper_rudder_command_deg.Data;
  A380SecComputer_B.SSM_af = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.lower_rudder_command_deg.SSM;
  A380SecComputer_B.Data_nm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.lower_rudder_command_deg.Data;
  A380SecComputer_B.SSM_ew = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_sidestick_pitch_command_deg.SSM;
  A380SecComputer_B.Data_ia = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_sidestick_pitch_command_deg.Data;
  A380SecComputer_B.SSM_lt = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_sidestick_pitch_command_deg.SSM;
  A380SecComputer_B.Data_j0 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_sidestick_pitch_command_deg.Data;
  A380SecComputer_B.SSM_ger = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_sidestick_roll_command_deg.SSM;
  A380SecComputer_B.Data_bs = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_sidestick_roll_command_deg.Data;
  A380SecComputer_B.SSM_pxo = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_sidestick_roll_command_deg.SSM;
  A380SecComputer_B.Data_hp = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_sidestick_roll_command_deg.Data;
  A380SecComputer_B.SSM_co2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.rudder_pedal_position_deg.SSM;
  A380SecComputer_B.Data_ct = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.rudder_pedal_position_deg.Data;
  A380SecComputer_B.SSM_ny = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.aileron_status_word.SSM;
  A380SecComputer_B.Data_nzt = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.aileron_status_word.Data;
  A380SecComputer_B.SSM_l4 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_aileron_1_position_deg.SSM;
  A380SecComputer_B.Data_c0 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_aileron_1_position_deg.Data;
  A380SecComputer_B.SSM_nm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_aileron_2_position_deg.SSM;
  A380SecComputer_B.Data_ojg = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_aileron_2_position_deg.Data;
  A380SecComputer_B.SSM_nh = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_aileron_1_position_deg.SSM;
  A380SecComputer_B.Data_lm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_aileron_1_position_deg.Data;
  A380SecComputer_B.SSM_dl = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_aileron_2_position_deg.SSM;
  A380SecComputer_B.Data_fz = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_aileron_2_position_deg.Data;
  A380SecComputer_B.SSM_a5h = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.spoiler_status_word.SSM;
  A380SecComputer_B.Data_oz = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.spoiler_status_word.Data;
  A380SecComputer_B.SSM_fl = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_position_deg.SSM;
  A380SecComputer_B.Data_gf = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.left_spoiler_position_deg.Data;
  A380SecComputer_B.SSM_p3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_position_deg.SSM;
  A380SecComputer_B.Data_nn = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.right_spoiler_position_deg.Data;
  A380SecComputer_B.SSM_ns = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.elevator_status_word.SSM;
  A380SecComputer_B.Data_a0z = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.elevator_status_word.Data;
  A380SecComputer_B.SSM_bm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.elevator_1_position_deg.SSM;
  A380SecComputer_B.Data_fk = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.elevator_1_position_deg.Data;
  A380SecComputer_B.SSM_nl = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.elevator_2_position_deg.SSM;
  A380SecComputer_B.Data_o23 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.elevator_2_position_deg.Data;
  A380SecComputer_B.SSM_grm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.elevator_3_position_deg.SSM;
  A380SecComputer_B.Data_g3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.elevator_3_position_deg.Data;
  A380SecComputer_B.SSM_gzm = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.ths_position_deg.SSM;
  A380SecComputer_B.Data_icc = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.ths_position_deg.Data;
  A380SecComputer_B.SSM_oi = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.rudder_status_word.SSM;
  A380SecComputer_B.Data_pwf = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.rudder_status_word.Data;
  A380SecComputer_B.SSM_aa = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.rudder_1_position_deg.SSM;
  A380SecComputer_B.Data_gvk = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.rudder_1_position_deg.Data;
  A380SecComputer_B.SSM_lw = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.rudder_2_position_deg.SSM;
  A380SecComputer_B.Data_ln = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.rudder_2_position_deg.Data;
  A380SecComputer_B.SSM_fa = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.radio_height_1_ft.SSM;
  A380SecComputer_B.Data_ka = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.radio_height_1_ft.Data;
  A380SecComputer_B.SSM_lbx = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.radio_height_2_ft.SSM;
  A380SecComputer_B.Data_mp = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.radio_height_2_ft.Data;
  A380SecComputer_B.SSM_n3 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.fctl_law_status_word.SSM;
  A380SecComputer_B.Data_m4 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.fctl_law_status_word.Data;
  A380SecComputer_B.SSM_a1 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.discrete_status_word_1.SSM;
  A380SecComputer_B.Data_fki = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.discrete_status_word_1.Data;
  A380SecComputer_B.SSM_p1 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.fe_status_word.SSM;
  A380SecComputer_B.Data_m21 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.fe_status_word.Data;
  A380SecComputer_B.SSM_cn2 = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.fg_status_word.SSM;
  A380SecComputer_B.Data_nbg = A380SecComputer_P.out_Y0.data.bus_inputs.prim_3_bus.fg_status_word.Data;
  A380SecComputer_B.SSM_an3 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_sidestick_pitch_command_deg.SSM;
  A380SecComputer_B.Data_l25 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_sidestick_pitch_command_deg.Data;
  A380SecComputer_B.SSM_c3 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_sidestick_pitch_command_deg.SSM;
  A380SecComputer_B.Data_ki = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_sidestick_pitch_command_deg.Data;
  A380SecComputer_B.SSM_dp = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_sidestick_roll_command_deg.SSM;
  A380SecComputer_B.Data_p5p = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_sidestick_roll_command_deg.Data;
  A380SecComputer_B.SSM_lg = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_sidestick_roll_command_deg.SSM;
  A380SecComputer_B.Data_nry = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_sidestick_roll_command_deg.Data;
  A380SecComputer_B.SSM_cm = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_pedal_position_deg.SSM;
  A380SecComputer_B.Data_mh = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_pedal_position_deg.Data;
  A380SecComputer_B.SSM_hl = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.aileron_status_word.SSM;
  A380SecComputer_B.Data_ll = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.aileron_status_word.Data;
  A380SecComputer_B.SSM_irh = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_aileron_1_position_deg.SSM;
  A380SecComputer_B.Data_hy = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_aileron_1_position_deg.Data;
  A380SecComputer_B.SSM_b42 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_aileron_2_position_deg.SSM;
  A380SecComputer_B.Data_j04 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_aileron_2_position_deg.Data;
  A380SecComputer_B.SSM_anz = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_aileron_1_position_deg.SSM;
  A380SecComputer_B.Data_pl = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_aileron_1_position_deg.Data;
  A380SecComputer_B.SSM_d2 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_aileron_2_position_deg.SSM;
  A380SecComputer_B.Data_gb = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_aileron_2_position_deg.Data;
  A380SecComputer_B.SSM_gov = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.spoiler_status_word.SSM;
  A380SecComputer_B.Data_hq = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.spoiler_status_word.Data;
  A380SecComputer_B.SSM_nb = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_spoiler_1_position_deg.SSM;
  A380SecComputer_B.Data_ai = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_spoiler_1_position_deg.Data;
  A380SecComputer_B.SSM_pe3 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_spoiler_1_position_deg.SSM;
  A380SecComputer_B.Data_gfr = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_spoiler_1_position_deg.Data;
  A380SecComputer_B.SSM_jx = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_spoiler_2_position_deg.SSM;
  A380SecComputer_B.Data_czp = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.left_spoiler_2_position_deg.Data;
  A380SecComputer_B.SSM_npl = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_spoiler_2_position_deg.SSM;
  A380SecComputer_B.Data_fm = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.right_spoiler_2_position_deg.Data;
  A380SecComputer_B.SSM_gf = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.elevator_status_word.SSM;
  A380SecComputer_B.Data_jsg = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.elevator_status_word.Data;
  A380SecComputer_B.SSM_gbi = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.elevator_1_position_deg.SSM;
  A380SecComputer_B.Data_g1 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.elevator_1_position_deg.Data;
  A380SecComputer_B.SSM_fhm = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.elevator_2_position_deg.SSM;
  A380SecComputer_B.Data_j4 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.elevator_2_position_deg.Data;
  A380SecComputer_B.SSM_ltj = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.elevator_3_position_deg.SSM;
  A380SecComputer_B.Data_e4 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.elevator_3_position_deg.Data;
  A380SecComputer_B.SSM_hn = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.ths_position_deg.SSM;
  A380SecComputer_B.Data_ghs = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.ths_position_deg.Data;
  A380SecComputer_B.SSM_h3 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_status_word.SSM;
  A380SecComputer_B.Data_bmk = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_status_word.Data;
  A380SecComputer_B.SSM_bfs = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_1_position_deg.SSM;
  A380SecComputer_B.Data_lzt = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_1_position_deg.Data;
  A380SecComputer_B.SSM_p0 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_2_position_deg.SSM;
  A380SecComputer_B.Data_kn = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_2_position_deg.Data;
  A380SecComputer_B.SSM_hr = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_trim_actual_pos_deg.SSM;
  A380SecComputer_B.Data_nab = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.rudder_trim_actual_pos_deg.Data;
  A380SecComputer_B.SSM_bi = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.fctl_law_status_word.SSM;
  A380SecComputer_B.Data_lgf = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.fctl_law_status_word.Data;
  A380SecComputer_B.SSM_bd = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.misc_data_status_word.SSM;
  A380SecComputer_B.Data_fpq = A380SecComputer_P.out_Y0.data.bus_inputs.sec_x_bus.misc_data_status_word.Data;
  A380SecComputer_B.SSM_omt = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_sidestick_pitch_command_deg.SSM;
  A380SecComputer_B.Data_dt = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_sidestick_pitch_command_deg.Data;
  A380SecComputer_B.SSM_la = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_sidestick_pitch_command_deg.SSM;
  A380SecComputer_B.Data_b1 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_sidestick_pitch_command_deg.Data;
  A380SecComputer_B.SSM_l1 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_sidestick_roll_command_deg.SSM;
  A380SecComputer_B.Data_ea = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_sidestick_roll_command_deg.Data;
  A380SecComputer_B.SSM_dy = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_sidestick_roll_command_deg.SSM;
  A380SecComputer_B.Data_nib = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_sidestick_roll_command_deg.Data;
  A380SecComputer_B.SSM_ie = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_pedal_position_deg.SSM;
  A380SecComputer_B.Data_i2t = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_pedal_position_deg.Data;
  A380SecComputer_B.SSM_kf = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.aileron_status_word.SSM;
  A380SecComputer_B.Data_ng = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.aileron_status_word.Data;
  A380SecComputer_B.SSM_p5l = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_aileron_1_position_deg.SSM;
  A380SecComputer_B.Data_h31 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_aileron_1_position_deg.Data;
  A380SecComputer_B.SSM_b3 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_aileron_2_position_deg.SSM;
  A380SecComputer_B.Data_ew = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_aileron_2_position_deg.Data;
  A380SecComputer_B.SSM_dxv = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_aileron_1_position_deg.SSM;
  A380SecComputer_B.Data_j1s = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_aileron_1_position_deg.Data;
  A380SecComputer_B.SSM_mxz = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_aileron_2_position_deg.SSM;
  A380SecComputer_B.Data_j5 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_aileron_2_position_deg.Data;
  A380SecComputer_B.SSM_kk4 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.spoiler_status_word.SSM;
  A380SecComputer_B.Data_cw = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.spoiler_status_word.Data;
  A380SecComputer_B.SSM_cy = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_spoiler_1_position_deg.SSM;
  A380SecComputer_B.Data_gqa = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_spoiler_1_position_deg.Data;
  A380SecComputer_B.SSM_ju = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_spoiler_1_position_deg.SSM;
  A380SecComputer_B.Data_fri = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_spoiler_1_position_deg.Data;
  A380SecComputer_B.SSM_ey = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_spoiler_2_position_deg.SSM;
  A380SecComputer_B.Data_cm = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.left_spoiler_2_position_deg.Data;
  A380SecComputer_B.SSM_jr = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_spoiler_2_position_deg.SSM;
  A380SecComputer_B.Data_czj = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.right_spoiler_2_position_deg.Data;
  A380SecComputer_B.SSM_hs = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.elevator_status_word.SSM;
  A380SecComputer_B.Data_mb = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.elevator_status_word.Data;
  A380SecComputer_B.SSM_mx3 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.elevator_1_position_deg.SSM;
  A380SecComputer_B.Data_gk4 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.elevator_1_position_deg.Data;
  A380SecComputer_B.SSM_hm = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.elevator_2_position_deg.SSM;
  A380SecComputer_B.Data_gbt = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.elevator_2_position_deg.Data;
  A380SecComputer_B.SSM_dm = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.elevator_3_position_deg.SSM;
  A380SecComputer_B.Data_p0 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.elevator_3_position_deg.Data;
  A380SecComputer_B.SSM_fk = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.ths_position_deg.SSM;
  A380SecComputer_B.Data_dn = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.ths_position_deg.Data;
  A380SecComputer_B.SSM_lm1 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_status_word.SSM;
  A380SecComputer_B.Data_iyw = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_status_word.Data;
  A380SecComputer_B.SSM_nc = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_1_position_deg.SSM;
  A380SecComputer_B.Data_p5d = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_1_position_deg.Data;
  A380SecComputer_B.SSM_e4 = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_2_position_deg.SSM;
  A380SecComputer_B.Data_ho = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_2_position_deg.Data;
  A380SecComputer_B.SSM_bw = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_trim_actual_pos_deg.SSM;
  A380SecComputer_B.Data_kqr = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.rudder_trim_actual_pos_deg.Data;
  A380SecComputer_B.SSM_na = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.fctl_law_status_word.SSM;
  A380SecComputer_B.Data_omv = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.fctl_law_status_word.Data;
  A380SecComputer_B.SSM_lf = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.misc_data_status_word.SSM;
  A380SecComputer_B.Data_mby = A380SecComputer_P.out_Y0.data.bus_inputs.sec_y_bus.misc_data_status_word.Data;
