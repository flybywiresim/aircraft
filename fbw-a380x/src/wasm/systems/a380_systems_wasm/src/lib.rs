...
async fn systems(mut gauge: msfs::Gauge) -> Result<(), Box<dyn Error>> {
    ...
    .with_failures(vec![
        ...
        (21_011, FailureType::OcsmAutoPartition(OcsmId::One)),
        (21_012, FailureType::OcsmAutoPartition(OcsmId::Two)),
        (21_013, FailureType::OcsmAutoPartition(OcsmId::Three)),
        (21_014, FailureType::OcsmAutoPartition(OcsmId::Four)),
        (21_015, FailureType::Ocsm(OcsmId::One, Channel::ChannelOne)),
        (21_016, FailureType::Ocsm(OcsmId::One, Channel::ChannelTwo)),
        (21_017, FailureType::Ocsm(OcsmId::Two, Channel::ChannelOne)),
        (21_018, FailureType::Ocsm(OcsmId::Two, Channel::ChannelTwo)),
        (
            21_019,
        ...
        (21_021, FailureType::Ocsm(OcsmId::Four, Channel::ChannelOne)),
        (21_022, FailureType::Ocsm(OcsmId::Four, Channel::ChannelTwo)),
        (21_023, FailureType::AgsApp(CpiomId::B1)),
        (21_024, FailureType::AgsApp(CpiomId::B2)),
        (21_025, FailureType::AgsApp(CpiomId::B3)),
        (21_026, FailureType::AgsApp(CpiomId::B4)),
        (21_027, FailureType::TcsApp(CpiomId::B1)),
        (21_028, FailureType::TcsApp(CpiomId::B2)),
        (21_029, FailureType::TcsApp(CpiomId::B3)),
        (21_030, FailureType::TcsApp(CpiomId::B4)),
        (21_031, FailureType::VcsApp(CpiomId::B1)),
        (21_032, FailureType::VcsApp(CpiomId::B2)),
        (21_033, FailureType::VcsApp(CpiomId::B3)),
        (21_034, FailureType::VcsApp(CpiomId::B4)),
        (21_035, FailureType::CpcsApp(CpiomId::B1)),
        (21_036, FailureType::CpcsApp(CpiomId::B2)),
        (21_037, FailureType::CpcsApp(CpiomId::B3)),
        (21_038, FailureType::CpcsApp(CpiomId::B4)),
