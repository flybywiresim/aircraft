...
impl A380AirDataInertialReferenceSystem {
    pub fn new(context: &mut InitContext) -> Self {
        ...
        Self {
            ...
            sensor_complex_1: IntegratedAirDataSensorsComplex::new(context, AdiruNumber::One),
            sensor_complex_2: IntegratedAirDataSensorsComplex::new(context, AdiruNumber::Two),
            sensor_complex_3: IntegratedAirDataSensorsComplex::new(context, AdiruNumber::Three),
        }
    }
    ...
    pub fn update(
        ...
        AdiruNumber::into_iter().for_each(|adiru_num| {
            // For the ADR input:
            // Nr. | Input 1 | Input 2
            // ----|---------|--------
            // 1   | ADR 3   | ADR 2
            ...
            let sensor_complex = match adiru_num {
                AdiruNumber::One => &mut self.sensor_complex_1,
                AdiruNumber::Two => &mut self.sensor_complex_2,
                AdiruNumber::Three => &mut self.sensor_complex_3,
            };
...
impl Index<AdiruNumber> for A380AirDataInertialReferenceSystem {
...
impl IndexMut<AdiruNumber> for A380AirDataInertialReferenceSystem {
...
impl AdirsDiscreteOutputs for A380AirDataInertialReferenceSystem {
    fn low_speed_warning_1(&self, adiru_number: usize) -> bool {
        AirDataReferenceDiscreteOutput::discrete_outputs(
            &self[adiru_number.try_into().unwrap_or_default()],
        )
        .low_speed_warning_1
    }
...
impl AdirsMeasurementOutputs for A380AirDataInertialReferenceSystem {
    fn is_fully_aligned(&self, adiru_number: usize) -> bool {
        InertialReferenceBusOutput::bus_outputs(&self[adiru_number.try_into().unwrap_or_default()])
            .discrete_word_1
            .get_bit(13)
    }
    ...
    fn altitude(&self, adiru_number: usize) -> Arinc429Word<Length> {
        AirDataReferenceBusOutput::bus_outputs(&self[adiru_number.try_into().unwrap_or_default()])
            .standard_altitude
    }
    fn angle_of_attack(&self, adiru_number: usize) -> Arinc429Word<Angle> {
        AirDataReferenceBusOutput::bus_outputs(&self[adiru_number.try_into().unwrap_or_default()])
            .corrected_angle_of_attack
    }
...
impl AdirsToAirCondInterface for A380AirDataInertialReferenceSystem {
    ...
    fn baro_correction(&self, adiru_number: usize) -> Arinc429Word<Pressure> {
        let word = AirDataReferenceBusOutput::bus_outputs(
            &self[adiru_number.try_into().unwrap_or_default()],
        )
...
impl A380AdirsElectricalHarness {
    pub fn new(context: &mut InitContext) -> Self {
        Self {
            adiru_1_electrical_harness: A380AdiruElectricalHarness::new(context, AdiruNumber::One),
            adiru_2_electrical_harness: A380AdiruElectricalHarness::new(context, AdiruNumber::Two),
            adiru_3_electrical_harness: A380AdiruElectricalHarness::new(
                context,
                AdiruNumber::Three,
            ),
    ...
    fn get_adiru_electrical_harness(&self, num: AdiruNumber) -> &A380AdiruElectricalHarness {
        &self[num]
    }
    ...
    fn probe_supply_logic(
        ...
        match num {
            AdiruNumber::One => is_1_powered,
            AdiruNumber::Two => powered_2,
            AdiruNumber::Three => is_3_powered,
        }
    }
...
impl Index<AdiruNumber> for A380AdirsElectricalHarness {
...
impl IndexMut<AdiruNumber> for A380AdirsElectricalHarness {
    fn index_mut(&mut self, num: AdiruNumber) -> &mut Self::Output {
        match num {
    ...
    pub fn new(context: &mut InitContext, num: AdiruNumber) -> Self {
        ...
        let mut result = Self {
            ...
            primary_powersupply: match num {
                ...
                AdiruNumber::Two => ElectricalBusType::AlternatingCurrent(4),
                AdiruNumber::Three => ElectricalBusType::AlternatingCurrentEssential,
            },
            primary_powered: is_powered,
            primary_powersupply_2: match num {
                AdiruNumber::One => None,
                AdiruNumber::Two => None,
                AdiruNumber::Three => Some(ElectricalBusType::AlternatingCurrent(1)),
            },
            primary_2_powered: is_powered,

            backup_powersupply: match num {
                AdiruNumber::One => ElectricalBusType::DirectCurrentHot(1),
                AdiruNumber::Two => ElectricalBusType::DirectCurrent(2),
                AdiruNumber::Three => ElectricalBusType::DirectCurrentHot(3),
            },
            backup_powersupply_relay_switching: match num {
                AdiruNumber::One => Some(ElectricalBusType::DirectCurrentEssential),
                AdiruNumber::Two => None,
