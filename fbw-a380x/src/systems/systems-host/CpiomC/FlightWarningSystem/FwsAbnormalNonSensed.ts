...
export class FwsAbnormalNonSensed {
  ...
  public ewdAbnormalNonSensed: EwdAbnormalDict = {
    ...
    270900004: {
      ...
      notActiveWhenItemActive: [],
      whichItemsToShow: () => [
        !this.fws.flapLever3 && !this.fws.flapLeverFull,
        this.fws.sfccSlatFlapsSystemStatusWord.bitValueOr(20, false),
        !this.fws.flapLever3 && !this.fws.flapLeverFull && !this.fws.flapLever2,
        !this.fws.flapLever3 && !this.fws.flapLeverFull && !this.fws.flapLever2,
        true,
        true,
        true,
      ...
      limitationsApprLdg: () => [
        this.fws.flapLever3 ? '270400001' : '',
        ...(!this.fws.flapLever3 && !this.fws.flapLeverFull ? ['220400001', '800400004', '800400003'] : ''),
      ],
      inopSysApprLdg: () => ['320300007'],
      info: () => ['220200011'],
    },
