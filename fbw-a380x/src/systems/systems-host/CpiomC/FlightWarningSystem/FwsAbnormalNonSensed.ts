  ...
  public ewdAbnormalNonSensed: EwdAbnormalDict = {
    ...
    320900001: {
      ...
      whichItemsToShow: () => [
        ...
        true,
        true,
        this.fws.jettisonArm.get() || this.fws.jettisonActive.get(),
        this.fws.jettisonArm.get() || this.fws.jettisonActive.get(),
        true,
        true,
        true,
    ...
    320900002: {
      ...
      whichItemsToShow: () => [
        ...
        true,
        true,
        true, // should these be sensed depending on which L/G is affected?
        true,
        true,
        true,
        true,
    ...
    990900004: {
      ...
      whichItemsChecked: () => [
        ...
        false,
        false,
        false, // FIXME when ELT added, should be sensed
        false,
        this.fws.allBleedsOff.get(),
        false,
        this.fws.ditchingPbOn.get(),
        false,
        false,
        false,
        false,
    ...
    990900007: {
      ...
      whichItemsChecked: () => [
        ...
        !this.fws.jettisonActive.get(),
        false, // FIXME when trim tk added, should be sensed
        this.fws.gearLeverPos.get(), // TODO confirm boolean value
        false,
        false,
        this.fws.spoilersArmed.get(),
        false, // FIXME when ELT added, should be sensed
