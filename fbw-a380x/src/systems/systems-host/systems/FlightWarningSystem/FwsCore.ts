...
export class FwsCore {
  ...
  update(_deltaTime: number) {
    ...
    this.eng1BleedPbOff.set(SimVar.GetSimVarValue('A:BLEED AIR ENGINE:1', SimVarValueType.Bool));
    this.eng2BleedPbOff.set(SimVar.GetSimVarValue('A:BLEED AIR ENGINE:2', SimVarValueType.Bool));
    this.eng3BleedPbOff.set(SimVar.GetSimVarValue('A:BLEED AIR ENGINE:3', SimVarValueType.Bool));
    this.eng4BleedPbOff.set(SimVar.GetSimVarValue('A:BLEED AIR ENGINE:4', SimVarValueType.Bool));
