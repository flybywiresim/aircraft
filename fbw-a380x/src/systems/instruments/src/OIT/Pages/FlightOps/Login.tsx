...
export const LoginPage: FC = () => {
    ...
    return (
        <>
            <text x={512} y={152} fontSize={22} fill="#fff" textAnchor="middle">FLT OPS Domain</text>
            <text x={512} y={204} fontSize={17} fill="#fff" textAnchor="middle">Login Page</text>
            <text x={512} y={260} fontSize={22} fill="#fff" textAnchor="middle">{displayPosition}</text>
