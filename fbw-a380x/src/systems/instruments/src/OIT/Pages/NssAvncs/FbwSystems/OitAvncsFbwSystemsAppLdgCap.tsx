...
export class OitAvncsFbwSystemsAppLdgCap extends DestroyableComponent<OitAvncsFbwSystemsAppLdgCapProps> {
  ...
  private readonly ap1Engaged = RegisteredSimVar.createBoolean('L:A32NX_AUTOPILOT_1_ACTIVE');
  private readonly ap2Engaged = RegisteredSimVar.createBoolean('L:A32NX_AUTOPILOT_2_ACTIVE');
  ...
  private readonly prim1Healthy = RegisteredSimVar.createBoolean('L:A32NX_PRIM_1_HEALTHY');
  private readonly prim2Healthy = RegisteredSimVar.createBoolean('L:A32NX_PRIM_2_HEALTHY');
  private readonly prim3Healthy = RegisteredSimVar.createBoolean('L:A32NX_PRIM_3_HEALTHY');
  private readonly onePrimHealthy = Subject.create(false);
  private readonly twoPrimHealthy = Subject.create(false);

  private readonly sec1Healthy = RegisteredSimVar.createBoolean('L:A32NX_SEC_1_HEALTHY');
  private readonly sec2Healthy = RegisteredSimVar.createBoolean('L:A32NX_SEC_2_HEALTHY');
  private readonly sec3Healthy = RegisteredSimVar.createBoolean('L:A32NX_SEC_3_HEALTHY');
  ...
  private readonly fcdc1Healthy = RegisteredSimVar.createBoolean('L:A32NX_FCDC_1_HEALTHY');
  private readonly fcdc2Healthy = RegisteredSimVar.createBoolean('L:A32NX_FCDC_2_HEALTHY');
  private readonly oneFcdcHealthy = Subject.create(false);
  private readonly twoFcdcHealthy = Subject.create(false);

  private readonly antiskidAvailableSimVar = RegisteredSimVar.createBoolean('A:ANTISKID BRAKES ACTIVE');
  ...
  private readonly engine1Combustion = RegisteredSimVar.createBoolean('A:ENG COMBUSTION:1');
  private readonly engine2Combustion = RegisteredSimVar.createBoolean('A:ENG COMBUSTION:2');
  private readonly engine3Combustion = RegisteredSimVar.createBoolean('A:ENG COMBUSTION:3');
  private readonly engine4Combustion = RegisteredSimVar.createBoolean('A:ENG COMBUSTION:4');
  private readonly apuGen1ContactorClosed = RegisteredSimVar.createBoolean('L:A32NX_ELEC_CONTACTOR_990XS1_IS_CLOSED');
  private readonly apuGen2ContactorClosed = RegisteredSimVar.createBoolean('L:A32NX_ELEC_CONTACTOR_990XS2_IS_CLOSED');
