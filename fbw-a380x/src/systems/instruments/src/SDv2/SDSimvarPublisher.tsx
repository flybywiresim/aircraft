...
export class SDSimvarPublisher extends UpdatableSimVarPublisher<SDSimvars> {
  private static simvars = new Map<keyof SDSimvars, SimVarPublisherEntry<any>>([
    ...
    ['sec1RudderStatusWord', { name: 'L:A32NX_SEC_1_RUDDER_STATUS_WORD', type: SimVarValueType.Number }],
    ['sec3RudderStatusWord', { name: 'L:A32NX_SEC_3_RUDDER_STATUS_WORD', type: SimVarValueType.Number }],
    ['sec1RudderTrimPosition', { name: 'L:A32NX_SEC_1_RUDDER_ACTUAL_POSITION', type: SimVarValueType.Number }],
