        ...
        return (
            <>
                <g id="SelectedAltLowerGroup" ref={this.selectedAltLowerGroupRef}>
                    <text id="SelectedAltLowerText" ref={this.selectedAltLowerText} class="FontMedium EndAlign Cyan" x="137.7511" y="128.70299" style="white-space: pre">{this.textSub}</text>
                ...
                <g id="SelectedAltUpperGroup" ref={this.selectedAltUpperGroupRef}>
                    <text id="SelectedAltUpperText" ref={this.selectedAltUpperText} class="FontMedium EndAlign Cyan" x="138.22987" y="37.250134" style="white-space: pre">{this.textSub}</text>
            ...
            <>
                ...
                <g id="AltimeterGroup">
                    ...
                    <g ref={this.qfeGroup} id="QFEGroup">
                        ...
                        <text id="AltimeterSettingText" class="FontMedium StartAlign Cyan" x="131" y="138.09006">{this.text}</text>
                    </g>
                </g>
            </>
        );
