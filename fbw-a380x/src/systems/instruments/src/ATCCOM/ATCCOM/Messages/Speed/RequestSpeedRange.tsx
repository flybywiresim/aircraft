...
export const RequestSpeedRange: FC<MessageVisualizationProps> = ({ x = 0, y = 0, index, messageElements, onDelete }) => {
    ...
    return (
        <MessageElement x={x} y={y} onDelete={onDelete}>
            <Layer>
                <text x={75} fontSize={22} fill="white">REQUEST SPD/MACH</text>
            </Layer>
            <Layer>
                <text x={10} fontSize={22} fill="white">FROM</text>
                <TextBox
                    x={80}
                    y={-28}
                    maxLength={3}
            ...
            <Layer>
                <text x={37} fontSize={22} fill="white">TO</text>
                <TextBox
                    x={80}
                    y={-28}
                    maxLength={3}
