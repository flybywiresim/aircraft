...
export const Page: FC = () => (
    <Layer x={0} y={140}>
        { /* ADS-C */ }
        <text x={280} y={25} fontSize={22} fill="#fff">ADS-C EMERGENCY</text>
        ...
        <Button x={552} y={438} width={210} height={64}>
            <text x={203} y={22} fill="white" fontSize={22} textAnchor="end" dominantBaseline="central">
                <tspan x={203} dy={6}>REQUEST</tspan>
                <tspan x={203} dy={26}>VOICE CONTACT</tspan>
            </text>
        </Button>
        <Button x={552} y={502} width={210} height={64}>
            <text x={203} y={22} fill="white" fontSize={22} textAnchor="end" dominantBaseline="central">
                <tspan x={203} dy={6}>ENDURANCE</tspan>
                <tspan x={203} dy={26}>&amp; PERSONS</tspan>
            </text>
        </Button>
