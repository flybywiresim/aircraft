            ...
            <LegacyCdsDisplayUnit ref={ref} displayUnitId={DisplayUnitID.CaptMfd}>
                <MFDMessageManagerProvider>
                    <g style={{ pointerEvents: hideCursor ? 'none' : 'auto', cursor: 'none' }}>
                        ...
                        <text x={593} y={22} fontSize={24} fill="white">{flightNumber}</text>
                        ...
                        <Switch>
                            ...
                            <Route path="/fms">
                                <FlightPlanProvider><FMS /></FlightPlanProvider>
                            </Route>
                            <Route path="/atccom">
                                <ATCCOM />
                            </Route>
...
export const Cursor: React.FC<Position> = ({ x, y }) => (
    <g stroke="#ffff00" fill="none" strokeWidth={2.5} style={{ pointerEvents: 'none', transform: `translate(${x}px, ${y}px)` }}>
