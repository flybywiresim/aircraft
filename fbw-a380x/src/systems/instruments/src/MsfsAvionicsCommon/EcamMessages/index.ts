...
export const EcamInfos: { [n: string]: string } = {
  ...
  340200011: '\x1b\xa0\xa0<3mPITCH TRGT : 3°',
  340200012: '\x1b\xa0\xa0<3mALL ENG THR : SEE FCOM', //TODO add table
  340200013: '\x1b<3mFOR DESCENT:',
  340200014: '\x1b\xa0\xa0<3mPITCH TRGT : 1.25°',
  340200015: '\x1b\xa0\xa0<3mALL THR LEVERS IDLE',
  340200016: '\x1b<3mIF RADOME DESTRUCTION :',
  340200017: '\x1b<3mINCREASE THRUST BY 5 %',
