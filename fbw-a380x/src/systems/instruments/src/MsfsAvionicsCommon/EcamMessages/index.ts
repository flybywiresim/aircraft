...
export const EcamMemos: { [n: string]: string } = {
  ...
  '300000004': '\x1b<3mL WINDSHEILD HEATG',
  '300000005': '\x1b<3mL SLIDG WINDOW HEATG',
  '300000006': '\x1b<3mL FIXED WINDOW HEATG',
  '300000007': '\x1b<3mR WINDSHEILD HEATG',
  '300000008': '\x1b<3mR SLIDG WINDOW HEATG',
  '300000009': '\x1b<3mR FIXED WINDOW HEATG',
...
export const EcamLimitations: { [n: string]: string } = {
  ...
  210400002: '\x1b<5mMAX FL : 230/MEA-MORA',
