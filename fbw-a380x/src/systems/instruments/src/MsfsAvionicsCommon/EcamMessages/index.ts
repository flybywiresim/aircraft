...
export const EcamMemos: { [n: string]: { text: string; order?: number } } = {
  ...
  '320000002': { text: '\x1b<3mPARK BRK ON', order: 6 },
  ...
  '230000009': { text: '\x1b<3mRMP 1+2+3 OFF', order: 12 },
  '230000010': { text: '\x1b<3mRMP 1+3 OFF', order: 13 },
  '230000011': { text: '\x1b<3mRMP 2+3 OFF', order: 14 },
  '230000012': { text: '\x1b<3mRMP 3 OFF', order: 15 },
  '230000013': { text: '\x1b<3mSATCOM ALERT', order: 16 },
  '460000003': { text: '\x1b<3mCOMPANY ALERT', order: 17 },
  '460000004': { text: '\x1b<3mCOMPANY ALERT:PRNTR', order: 18 },
  '460000001': { text: '\x1b<3mCOMPANY MSG', order: 19 },
  '460000002': { text: '\x1b<3mCOMPANY MSG:PRNTR', order: 20 },
  '460000005': { text: '\x1b<3mCALL COMPANY', order: 21 },
  '271000001': { text: '\x1b<3mGND SPLRs ARMED', order: 22 },
  '241000001': { text: '\x1b<4mELEC EXT PWR', order: 23 },
  '241000002': { text: '\x1b<3mELEC EXT PWR', order: 24 },
  '322000001': { text: '\x1b<4mN/W STEER DISC', order: 25 },
  '322000002': { text: '\x1b<3mN/W STEER DISC', order: 26 },
  '340000001': { text: '\x1b<3mTRUE NORTH REF', order: 27 },
  '333000001': { text: '\x1b<3mSTROBE LT OFF', order: 28 },

  '230000015': { text: '\x1b<3mVHF VOICE', order: 29 },
  '230000007': { text: '\x1b<3mHF VOICE', order: 30 },
  '230000005': { text: '\x1b<3mCPNY DTLNK NOT AVAIL', order: 31 },
  '230000006': { text: '\x1b<3mGND HF DATALINK OVRD', order: 32 },
  '230000014': { text: '\x1b<3mVHF DTLNK MAN SCAN', order: 33 },
  '280000006': { text: '\x1b<3mJETTISON IN PROGRESS', order: 34 },
  '280000010': { text: '\x1b<4mREFUEL PNL DOOR OPEN', order: 35 },
  '280000011': { text: '\x1b<3mREFUEL PNL DOOR OPEN', order: 36 },
  '280000004': { text: '\x1b<3mFWD XFR IN PROGRESS', order: 37 },
  '280000002': { text: '\x1b<3mCOLDFUEL OUTR TK XFR', order: 38 },
  '280000007': { text: '\x1b<3mOUTR TK XFR IN PROG', order: 39 },
  '280000005': { text: '\x1b<3mGND XFR IN PROGRESS', order: 40 },
  '280000012': { text: '\x1b<3mTRIM TK XFRD', order: 41 },
  '280000008': { text: '\x1b<3mOUTR TKs XFRD', order: 42 },

  '343000002': { text: '\x1b<3mALT RPTG OFF', order: 43 },
  '343000003': { text: '\x1b<3mXPDR STBY', order: 44 },
  '343000001': { text: '\x1b<3mTCAS STBY', order: 45 },

  '300000001': { text: '\x1b<3mENG A-ICE', order: 46 },
  '300000002': { text: '\x1b<3mWING A-ICE', order: 47 },
  '300000003': { text: '\x1b<3mICE NOT DETECTED', order: 48 },
  '709000001': { text: '\x1b<3mIGNITION', order: 49 },

  '340002701': { text: '\x1b<3mIR 1 IN ATT ALIGN', order: 50 },
  '340002702': { text: '\x1b<3mIR 2 IN ATT ALIGN', order: 51 },
  '340002703': { text: '\x1b<3mIR 3 IN ATT ALIGN', order: 52 },
  '340002704': { text: '\x1b<3mIR 1+2 IN ATT ALIGN', order: 53 },
  '340002705': { text: '\x1b<3mIR 1+3 IN ATT ALIGN', order: 54 },
  '340002706': { text: '\x1b<3mIR 2+3 IN ATT ALIGN', order: 55 },
  '340002707': { text: '\x1b<3mIR 1+2+3 IN ATT ALIGN', order: 56 },
  '340003001': { text: '\x1b<3mIR IN ALIGN > 7 MN', order: 57 },
  '340003002': { text: '\x1b<4mIR IN ALIGN > 7 MN', order: 58 },
  '340003003': { text: '\x1b<3mIR IN ALIGN 6 MN', order: 59 },
  '340003004': { text: '\x1b<4mIR IN ALIGN 6 MN', order: 60 },
  '340003005': { text: '\x1b<3mIR IN ALIGN 5 MN', order: 61 },
  '340003006': { text: '\x1b<4mIR IN ALIGN 5 MN', order: 62 },
  '340003007': { text: '\x1b<3mIR IN ALIGN 4 MN', order: 63 },
  '340003008': { text: '\x1b<4mIR IN ALIGN 4 MN', order: 64 },
  '340003101': { text: '\x1b<3mIR IN ALIGN 3 MN', order: 65 },
  '340003102': { text: '\x1b<4mIR IN ALIGN 3 MN', order: 66 },
  '340003103': { text: '\x1b<3mIR IN ALIGN 2 MN', order: 67 },
  '340003104': { text: '\x1b<4mIR IN ALIGN 2 MN', order: 68 },
  '340003105': { text: '\x1b<3mIR IN ALIGN 1 MN', order: 69 },
  '340003106': { text: '\x1b<4mIR IN ALIGN 1 MN', order: 70 },
  '340003107': { text: '\x1b<3mIR IN ALIGN', order: 71 },
  '340003108': { text: '\x1b<4mIR IN ALIGN', order: 72 },
  '340003109': { text: '\x1b<3mIR ALIGNED', order: 73 },

  '000017001': { text: '\x1b<3mAPU AVAIL', order: 74 },
  '000018001': { text: '\x1b<3mAPU BLEED', order: 75 },

  '342000004': { text: '\x1b<3mWXR ON', order: 76 },
  '342000005': { text: '\x1b<4mWXR OFF', order: 77 },
  '342000001': { text: '\x1b<4mPRED W/S OFF', order: 78 },
  '342000002': { text: '\x1b<3mPRED W/S OFF', order: 79 },
  '342000003': { text: '\x1b<3mWXR TURB OFF', order: 80 },

  '341000001': { text: '\x1b<3mGPWS OFF', order: 81 },
  '341000002': { text: '\x1b<3mTAWS FLAP MODE OFF', order: 82 },
  '341000003': { text: '\x1b<3mTAWS G/S MODE OFF', order: 83 },
  '341000005': { text: '\x1b<3mTERR STBY', order: 84 },
  '341000004': { text: '\x1b<3mTERR SYS OFF', order: 85 },

  '210000001': { text: '\x1b<3mHI ALT AIRPORT', order: 86 },

  '230000001': { text: '\x1b<3mCAPT ON RMP 3', order: 87 },
  '230000002': { text: '\x1b<3mF/O ON RMP 3', order: 88 },
  '230000003': { text: '\x1b<3mCAPT+F/O ON RMP 3', order: 89 },
  '317000001': { text: '\x1b<3mCLOCK INT', order: 90 },
  '280000001': { text: '\x1b<3mCROSSFEED OPEN', order: 91 },
  '280000013': { text: '\x1b<4mCROSSFEED OPEN', order: 92 },

  '230000004': { text: '\x1b<3mCABIN READY', order: 93 },

  '335000002': { text: '\x1b<3mNO SMOKING', order: 94 },
  '335000001': { text: '\x1b<3mSEAT BELTS', order: 95 },
  '335000003': { text: '\x1b<3mNO MOBILE', order: 96 },

  '243000001': { text: '\x1b<3mREMOTE C/B CTL ON', order: 97 },

  '280000009': { text: '\x1b<3mREFUEL IN PROGRESS', order: 98 },
  '280000003': { text: '\x1b<3mDEFUEL IN PROGRESS', order: 99 },

  '340068001': { text: '\x1b<3mADIRS SWTG', order: 100 },
  '221000001': { text: '\x1b<3mFMS SWTG', order: 101 },

  '290000001': { text: '\x1b<3mG ELEC PMP A CTL', order: 102 },
  '290000002': { text: '\x1b<3mG ELEC PMP B CTL', order: 103 },
  '290000003': { text: '\x1b<3mY ELEC PMP A CTL', order: 104 },
  '290000004': { text: '\x1b<3mY ELEC PMP B CTL', order: 105 },

  '321000002': { text: '\x1b<3mL/G GRVTY EXTN', order: 106 },
  '321000001': { text: '\x1b<3mFLT L/G DOWN', order: 107 },
  '240000001': { text: '\x1b<3mCOMMERCIAL PART SHED', order: 108 },

  '230000008': { text: '\x1b<3mPA IN USE', order: 109 },
};
