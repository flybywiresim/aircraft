...
export const EcamMemos: { [n: string]: { text: string; order?: number } } = {
  ...
  '350000001': { text: '\x1b<3mOXY PAX SYS ON', order: 10 },
  '350000002': { text: '\x1b<4mOXY PAX SYS ON', order: 11 },
  '280000001': { text: '\x1b<3mCROSSFEED OPEN', order: 12 },
  '280000013': { text: '\x1b<4mCROSSFEED OPEN', order: 13 },
  '320000002': { text: '\x1b<3mPARK BRK ON', order: 14 },
  '230000009': { text: '\x1b<3mRMP 1+2+3 OFF', order: 15 },
  '230000010': { text: '\x1b<3mRMP 1+3 OFF', order: 16 },
  '230000011': { text: '\x1b<3mRMP 2+3 OFF', order: 17 },
  '230000012': { text: '\x1b<3mRMP 3 OFF', order: 18 },
  '230000013': { text: '\x1b<3mSATCOM ALERT', order: 19 },
  '460000003': { text: '\x1b<3mCOMPANY ALERT', order: 20 },
  '460000004': { text: '\x1b<3mCOMPANY ALERT:PRNTR', order: 21 },
  '460000001': { text: '\x1b<3mCOMPANY MSG', order: 22 },
  '460000002': { text: '\x1b<3mCOMPANY MSG:PRNTR', order: 23 },
  '460000005': { text: '\x1b<3mCALL COMPANY', order: 24 },
  '271000001': { text: '\x1b<3mGND SPLRs ARMED', order: 25 },
  '241000001': { text: '\x1b<4mELEC EXT PWR', order: 26 },
  '241000002': { text: '\x1b<3mELEC EXT PWR', order: 27 },
  '322000001': { text: '\x1b<4mN/W STEER DISC', order: 28 },
  '322000002': { text: '\x1b<3mN/W STEER DISC', order: 29 },
  '340000001': { text: '\x1b<3mTRUE NORTH REF', order: 30 },
  '333000001': { text: '\x1b<3mSTROBE LT OFF', order: 31 },

  '230000015': { text: '\x1b<3mVHF VOICE', order: 32 },
  '230000007': { text: '\x1b<3mHF VOICE', order: 33 },
  '230000005': { text: '\x1b<3mCPNY DTLNK NOT AVAIL', order: 34 },
  '230000006': { text: '\x1b<3mGND HF DATALINK OVRD', order: 35 },
  '230000014': { text: '\x1b<3mVHF DTLNK MAN SCAN', order: 36 },
  '280000006': { text: '\x1b<3mJETTISON IN PROGRESS', order: 37 },
  '280000010': { text: '\x1b<4mREFUEL PNL DOOR OPEN', order: 38 },
  '280000011': { text: '\x1b<3mREFUEL PNL DOOR OPEN', order: 39 },
  '280000004': { text: '\x1b<3mFWD XFR IN PROGRESS', order: 40 },
  '280000002': { text: '\x1b<3mCOLDFUEL OUTR TK XFR', order: 41 },
  '280000007': { text: '\x1b<3mOUTR TK XFR IN PROG', order: 42 },
  '280000005': { text: '\x1b<3mGND XFR IN PROGRESS', order: 43 },
  '280000012': { text: '\x1b<3mTRIM TK XFRD', order: 44 },
  '280000008': { text: '\x1b<3mOUTR TKs XFRD', order: 45 },

  '343000002': { text: '\x1b<3mALT RPTG OFF', order: 46 },
  '343000003': { text: '\x1b<3mXPDR STBY', order: 47 },
  '343000001': { text: '\x1b<3mTCAS STBY', order: 48 },

  '300000001': { text: '\x1b<3mENG A-ICE', order: 49 },
  '300000002': { text: '\x1b<3mWING A-ICE', order: 50 },
  '300000003': { text: '\x1b<3mICE NOT DETECTED', order: 51 },
  '709000001': { text: '\x1b<3mIGNITION', order: 52 },

  '340002701': { text: '\x1b<3mIR 1 IN ATT ALIGN', order: 53 },
  '340002702': { text: '\x1b<3mIR 2 IN ATT ALIGN', order: 54 },
  '340002703': { text: '\x1b<3mIR 3 IN ATT ALIGN', order: 55 },
  '340002704': { text: '\x1b<3mIR 1+2 IN ATT ALIGN', order: 56 },
  '340002705': { text: '\x1b<3mIR 1+3 IN ATT ALIGN', order: 57 },
  '340002706': { text: '\x1b<3mIR 2+3 IN ATT ALIGN', order: 58 },
  '340002707': { text: '\x1b<3mIR 1+2+3 IN ATT ALIGN', order: 59 },
  '340003001': { text: '\x1b<3mIR IN ALIGN > 7 MN', order: 60 },
  '340003002': { text: '\x1b<4mIR IN ALIGN > 7 MN', order: 61 },
  '340003003': { text: '\x1b<3mIR IN ALIGN 6 MN', order: 62 },
  '340003004': { text: '\x1b<4mIR IN ALIGN 6 MN', order: 63 },
  '340003005': { text: '\x1b<3mIR IN ALIGN 5 MN', order: 64 },
  '340003006': { text: '\x1b<4mIR IN ALIGN 5 MN', order: 65 },
  '340003007': { text: '\x1b<3mIR IN ALIGN 4 MN', order: 66 },
  '340003008': { text: '\x1b<4mIR IN ALIGN 4 MN', order: 67 },
  '340003101': { text: '\x1b<3mIR IN ALIGN 3 MN', order: 68 },
  '340003102': { text: '\x1b<4mIR IN ALIGN 3 MN', order: 69 },
  '340003103': { text: '\x1b<3mIR IN ALIGN 2 MN', order: 70 },
  '340003104': { text: '\x1b<4mIR IN ALIGN 2 MN', order: 71 },
  '340003105': { text: '\x1b<3mIR IN ALIGN 1 MN', order: 72 },
  '340003106': { text: '\x1b<4mIR IN ALIGN 1 MN', order: 73 },
  '340003107': { text: '\x1b<3mIR IN ALIGN', order: 74 },
  '340003108': { text: '\x1b<4mIR IN ALIGN', order: 75 },
  '340003109': { text: '\x1b<3mIR ALIGNED', order: 76 },

  '000017001': { text: '\x1b<3mAPU AVAIL', order: 77 },
  '000018001': { text: '\x1b<3mAPU BLEED', order: 78 },

  '342000004': { text: '\x1b<3mWXR ON', order: 79 },
  '342000005': { text: '\x1b<4mWXR OFF', order: 80 },
  '342000001': { text: '\x1b<4mPRED W/S OFF', order: 81 },
  '342000002': { text: '\x1b<3mPRED W/S OFF', order: 82 },
  '342000003': { text: '\x1b<3mWXR TURB OFF', order: 83 },

  '341000001': { text: '\x1b<3mGPWS OFF', order: 84 },
  '341000002': { text: '\x1b<3mTAWS FLAP MODE OFF', order: 85 },
  '341000003': { text: '\x1b<3mTAWS G/S MODE OFF', order: 86 },
  '341000005': { text: '\x1b<3mTERR STBY', order: 87 },
  '341000004': { text: '\x1b<3mTERR SYS OFF', order: 88 },

  '210000001': { text: '\x1b<3mHI ALT AIRPORT', order: 89 },

  '230000001': { text: '\x1b<3mCAPT ON RMP 3', order: 90 },
  '230000002': { text: '\x1b<3mF/O ON RMP 3', order: 91 },
  '230000003': { text: '\x1b<3mCAPT+F/O ON RMP 3', order: 92 },
  '317000001': { text: '\x1b<3mCLOCK INT', order: 93 },

  '230000004': { text: '\x1b<3mCABIN READY', order: 94 },

  '335000002': { text: '\x1b<3mNO SMOKING', order: 95 },
  '335000001': { text: '\x1b<3mSEAT BELTS', order: 96 },
  '335000003': { text: '\x1b<3mNO MOBILE', order: 97 },

  '243000001': { text: '\x1b<3mREMOTE C/B CTL ON', order: 98 },

  '280000009': { text: '\x1b<3mREFUEL IN PROGRESS', order: 99 },
  '280000003': { text: '\x1b<3mDEFUEL IN PROGRESS', order: 100 },

  '340068001': { text: '\x1b<3mADIRS SWTG', order: 101 },
  '221000001': { text: '\x1b<3mFMS SWTG', order: 102 },

  '290000001': { text: '\x1b<3mG ELEC PMP A CTL', order: 103 },
  '290000002': { text: '\x1b<3mG ELEC PMP B CTL', order: 104 },
  '290000003': { text: '\x1b<3mY ELEC PMP A CTL', order: 105 },
  '290000004': { text: '\x1b<3mY ELEC PMP B CTL', order: 106 },

  '321000002': { text: '\x1b<3mL/G GRVTY EXTN', order: 107 },
  '321000001': { text: '\x1b<3mFLT L/G DOWN', order: 108 },
  '240000001': { text: '\x1b<3mCOMMERCIAL PART SHED', order: 109 },

  '230000008': { text: '\x1b<3mPA IN USE', order: 110 },
};
