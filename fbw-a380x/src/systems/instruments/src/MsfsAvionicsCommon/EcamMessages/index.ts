...
export const EcamMemos: { [n: string]: { text: string; order?: number } } = {
  // TODO revisit order numbers once more accurate reference is available. Many guesses used to fill the gaps.
  // TO MEMO
  '000001001': { text: ' \x1b<7m\x1b4mT.O\x1bm' },
  '000001002': { text: '   \x1b<5m-SEAT BELTS ....ON' },
  '000001003': { text: '   \x1b<3m-SEAT BELTS ON' },
  '000001006': { text: '   \x1b<5m-GND SPLRs ....ARM' },
  '000001007': { text: '   \x1b<3m-GND SPLRs ARM' },
  '000001008': { text: '   \x1b<5m-FLAPS ........T.O' },
  '000001009': { text: '   \x1b<3m-FLAPS : T.O' },
  '000001010': { text: '   \x1b<5m-AUTO BRK .....RTO' },
  '000001011': { text: '   \x1b<3m-AUTO BRK RTO' },
  '000001012': { text: '   \x1b<5m-T.O CONFIG ..TEST' },
  '000001013': { text: '   \x1b<3m-T.O CONFIG NORM' },
  // LDG MEMO
  '000002001': { text: ' \x1b<7m\x1b4mLDG\x1bm' },
  '000002002': { text: '   \x1b<5m-SEAT BELTS ....ON' },
  '000002003': { text: '   \x1b<3m-SEAT BELTS ON' },
  '000002006': { text: '   \x1b<5m-LDG GEAR ....DOWN' },
  '000002007': { text: '   \x1b<3m-LDG GEAR DOWN' },
  '000002008': { text: '   \x1b<5m-GND SPLRs ....ARM' },
  '000002009': { text: '   \x1b<3m-GND SPLRs ARM' },
  '000002010': { text: '   \x1b<5m-FLAPS ........LDG' },
  '000002011': { text: '   \x1b<3m-FLAPS : LDG' },
  // Special Memos
  '314000001': { text: '\x1b<6mT.O INHIBIT', order: 1 },
  '314000002': { text: '\x1b<6mLDG INHIBIT', order: 2 },
  '220000001': { text: '\x1b<2mAP OFF', order: 3 },
  '220000002': { text: '\x1b<4mA/THR OFF', order: 4 },
  '320000001': { text: '\x1b<4mAUTO BRK OFF', order: 5 },
  // Normal Memos in order of importance
  '221000002': { text: '\x1b<4mDEST EFOB', order: 7 },
  '242000001': { text: '\x1b<4mRAT OUT', order: 8 },
  '242000002': { text: '\x1b<3mRAT OUT', order: 9 },
  '210000002': { text: '\x1b<4mRAM AIR', order: 10 },
  '210000003': { text: '\x1b<3mRAM AIR', order: 11 },
  '350000001': { text: '\x1b<3mOXY PAX SYS ON', order: 12 },
  '350000002': { text: '\x1b<4mOXY PAX SYS ON', order: 13 },
  '280000001': { text: '\x1b<3mCROSSFEED OPEN', order: 14 },
  '280000013': { text: '\x1b<4mCROSSFEED OPEN', order: 15 },
  '320000002': { text: '\x1b<3mPARK BRK ON', order: 16 },
  '230000009': { text: '\x1b<3mRMP 1+2+3 OFF', order: 17 },
  '230000010': { text: '\x1b<3mRMP 1+3 OFF', order: 18 },
  '230000011': { text: '\x1b<3mRMP 2+3 OFF', order: 19 },
  '230000012': { text: '\x1b<3mRMP 3 OFF', order: 20 },
  '271000001': { text: '\x1b<3mGND SPLRs ARMED', order: 21 },
  '241000001': { text: '\x1b<4mELEC EXT PWR', order: 22 },
  '241000002': { text: '\x1b<3mELEC EXT PWR', order: 23 },
  '322000001': { text: '\x1b<4mN/W STEER DISC', order: 24 },
  '322000002': { text: '\x1b<3mN/W STEER DISC', order: 25 },
  '230000013': { text: '\x1b<3mSATCOM ALERT', order: 26 },
  '460000003': { text: '\x1b<3mCOMPANY ALERT', order: 27 },
  '460000004': { text: '\x1b<3mCOMPANY ALERT:PRNTR', order: 28 },
  '460000001': { text: '\x1b<3mCOMPANY MSG', order: 29 },
  '460000002': { text: '\x1b<3mCOMPANY MSG:PRNTR', order: 30 },
  '460000005': { text: '\x1b<3mCALL COMPANY', order: 31 },
  '340000001': { text: '\x1b<3mTRUE NORTH REF', order: 32 },
  '333000001': { text: '\x1b<3mSTROBE LT OFF', order: 33 },
  '230000015': { text: '\x1b<3mVHF VOICE', order: 34 },
  '230000007': { text: '\x1b<3mHF VOICE', order: 35 },
  '230000005': { text: '\x1b<3mCPNY DTLNK NOT AVAIL', order: 36 },
  '230000006': { text: '\x1b<3mGND HF DATALINK OVRD', order: 37 },
  '230000014': { text: '\x1b<3mVHF DTLNK MAN SCAN', order: 38 },
  '280000006': { text: '\x1b<3mJETTISON IN PROGRESS', order: 39 },
  '280000010': { text: '\x1b<4mREFUEL PNL DOOR OPEN', order: 40 },
  '280000011': { text: '\x1b<3mREFUEL PNL DOOR OPEN', order: 41 },
  '280000004': { text: '\x1b<3mFWD XFR IN PROGRESS', order: 42 },
  '280000002': { text: '\x1b<3mCOLDFUEL OUTR TK XFR', order: 43 },
  '280000007': { text: '\x1b<3mOUTR TK XFR IN PROG', order: 44 },
  '280000005': { text: '\x1b<3mGND XFR IN PROGRESS', order: 45 },
  '280000012': { text: '\x1b<3mTRIM TK XFRD', order: 46 },
  '280000008': { text: '\x1b<3mOUTR TKs XFRD', order: 47 },

  '343000002': { text: '\x1b<3mALT RPTG OFF', order: 48 },
  '343000003': { text: '\x1b<3mXPDR STBY', order: 49 },
  '343000001': { text: '\x1b<3mTCAS STBY', order: 50 },

  '300000001': { text: '\x1b<3mENG A-ICE', order: 51 },
  '300000002': { text: '\x1b<3mWING A-ICE', order: 52 },
  '300000003': { text: '\x1b<3mICE NOT DETECTED', order: 53 },
  '709000001': { text: '\x1b<3mIGNITION', order: 54 },

  '340002701': { text: '\x1b<3mIR 1 IN ATT ALIGN', order: 55 },
  '340002702': { text: '\x1b<3mIR 2 IN ATT ALIGN', order: 56 },
  '340002703': { text: '\x1b<3mIR 3 IN ATT ALIGN', order: 57 },
  '340002704': { text: '\x1b<3mIR 1+2 IN ATT ALIGN', order: 58 },
  '340002705': { text: '\x1b<3mIR 1+3 IN ATT ALIGN', order: 59 },
  '340002706': { text: '\x1b<3mIR 2+3 IN ATT ALIGN', order: 60 },
  '340002707': { text: '\x1b<3mIR 1+2+3 IN ATT ALIGN', order: 61 },
  '340003001': { text: '\x1b<3mIR IN ALIGN > 7 MN', order: 62 },
  '340003002': { text: '\x1b<4mIR IN ALIGN > 7 MN', order: 63 },
  '340003003': { text: '\x1b<3mIR IN ALIGN 6 MN', order: 64 },
  '340003004': { text: '\x1b<4mIR IN ALIGN 6 MN', order: 65 },
  '340003005': { text: '\x1b<3mIR IN ALIGN 5 MN', order: 66 },
  '340003006': { text: '\x1b<4mIR IN ALIGN 5 MN', order: 67 },
  '340003007': { text: '\x1b<3mIR IN ALIGN 4 MN', order: 68 },
  '340003008': { text: '\x1b<4mIR IN ALIGN 4 MN', order: 69 },
  '340003101': { text: '\x1b<3mIR IN ALIGN 3 MN', order: 70 },
  '340003102': { text: '\x1b<4mIR IN ALIGN 3 MN', order: 71 },
  '340003103': { text: '\x1b<3mIR IN ALIGN 2 MN', order: 72 },
  '340003104': { text: '\x1b<4mIR IN ALIGN 2 MN', order: 73 },
  '340003105': { text: '\x1b<3mIR IN ALIGN 1 MN', order: 74 },
  '340003106': { text: '\x1b<4mIR IN ALIGN 1 MN', order: 75 },
  '340003107': { text: '\x1b<3mIR IN ALIGN', order: 76 },
  '340003108': { text: '\x1b<4mIR IN ALIGN', order: 77 },
  '340003109': { text: '\x1b<3mIR ALIGNED', order: 78 },

  '000017001': { text: '\x1b<3mAPU AVAIL', order: 79 },
  '000018001': { text: '\x1b<3mAPU BLEED', order: 80 },

  '342000004': { text: '\x1b<3mWXR ON', order: 81 },
  '342000005': { text: '\x1b<4mWXR OFF', order: 82 },
  '342000001': { text: '\x1b<4mPRED W/S OFF', order: 83 },
  '342000002': { text: '\x1b<3mPRED W/S OFF', order: 84 },
  '342000003': { text: '\x1b<3mWXR TURB OFF', order: 85 },

  '341000001': { text: '\x1b<3mGPWS OFF', order: 86 },
  '341000002': { text: '\x1b<3mTAWS FLAP MODE OFF', order: 87 },
  '341000003': { text: '\x1b<3mTAWS G/S MODE OFF', order: 88 },
  '341000005': { text: '\x1b<3mTERR STBY', order: 89 },
  '341000004': { text: '\x1b<3mTERR SYS OFF', order: 90 },

  '210000001': { text: '\x1b<3mHI ALT AIRPORT', order: 91 },

  '230000001': { text: '\x1b<3mCAPT ON RMP 3', order: 92 },
  '230000002': { text: '\x1b<3mF/O ON RMP 3', order: 93 },
  '230000003': { text: '\x1b<3mCAPT+F/O ON RMP 3', order: 94 },
  '317000001': { text: '\x1b<3mCLOCK INT', order: 95 },

  '230000004': { text: '\x1b<3mCABIN READY', order: 96 },

  '335000002': { text: '\x1b<3mNO SMOKING', order: 97 },
  '335000001': { text: '\x1b<3mSEAT BELTS', order: 98 },
  '335000003': { text: '\x1b<3mNO MOBILE', order: 99 },

  '243000001': { text: '\x1b<3mREMOTE C/B CTL ON', order: 100 },

  '280000009': { text: '\x1b<3mREFUEL IN PROGRESS', order: 101 },
  '280000003': { text: '\x1b<3mDEFUEL IN PROGRESS', order: 102 },

  '340068001': { text: '\x1b<3mADIRS SWTG', order: 103 },
  '221000001': { text: '\x1b<3mFMS SWTG', order: 104 },

  '290000001': { text: '\x1b<3mG ELEC PMP A CTL', order: 105 },
  '290000002': { text: '\x1b<3mG ELEC PMP B CTL', order: 106 },
  '290000003': { text: '\x1b<3mY ELEC PMP A CTL', order: 107 },
  '290000004': { text: '\x1b<3mY ELEC PMP B CTL', order: 108 },

  '321000002': { text: '\x1b<3mL/G GRVTY EXTN', order: 109 },
  '321000001': { text: '\x1b<3mFLT L/G DOWN', order: 110 },
  '240000001': { text: '\x1b<3mCOMMERCIAL PART SHED', order: 111 },

  '230000008': { text: '\x1b<3mPA IN USE', order: 112 },
};
