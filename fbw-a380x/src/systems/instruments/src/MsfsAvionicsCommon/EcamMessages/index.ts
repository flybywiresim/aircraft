...
export const EcamMemos: { [n: string]: { text: string; order?: number } } = {
  ...
  '241000001': { text: '\x1b<4mELEC EXT PWR', order: 21 },
  '241000002': { text: '\x1b<3mELEC EXT PWR', order: 22 },
  '322000001': { text: '\x1b<4mN/W STEER DISC', order: 23 },
  '322000002': { text: '\x1b<3mN/W STEER DISC', order: 24 },
  '230000013': { text: '\x1b<3mSATCOM ALERT', order: 25 },
  '460000003': { text: '\x1b<3mCOMPANY ALERT', order: 26 },
  '460000004': { text: '\x1b<3mCOMPANY ALERT:PRNTR', order: 27 },
  '460000001': { text: '\x1b<3mCOMPANY MSG', order: 28 },
  '460000002': { text: '\x1b<3mCOMPANY MSG:PRNTR', order: 29 },
  '460000005': { text: '\x1b<3mCALL COMPANY', order: 30 },
  '340000001': { text: '\x1b<3mTRUE NORTH REF', order: 31 },
  '333000001': { text: '\x1b<3mSTROBE LT OFF', order: 32 },
  '230000015': { text: '\x1b<3mVHF VOICE', order: 33 },
  '230000007': { text: '\x1b<3mHF VOICE', order: 34 },
  '230000005': { text: '\x1b<3mCPNY DTLNK NOT AVAIL', order: 35 },
  '230000006': { text: '\x1b<3mGND HF DATALINK OVRD', order: 36 },
  '230000014': { text: '\x1b<3mVHF DTLNK MAN SCAN', order: 37 },
  '271000001': { text: '\x1b<3mGND SPLRs ARMED', order: 38 },
