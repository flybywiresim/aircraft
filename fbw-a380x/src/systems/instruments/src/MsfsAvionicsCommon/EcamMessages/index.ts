...
export const EcamMemos: { [n: string]: { text: string; order?: number } } = {
  ...
  '300000001': { text: '\x1b<3mENG A-ICE', order: 39 },
  '300000002': { text: '\x1b<3mWING A-ICE', order: 40 },
  '300000003': { text: '\x1b<3mICE NOT DETECTED', order: 41 },

  '280000006': { text: '\x1b<3mJETTISON IN PROGRESS', order: 42 },
  '280000010': { text: '\x1b<4mREFUEL PNL DOOR OPEN', order: 43 },
  '280000011': { text: '\x1b<3mREFUEL PNL DOOR OPEN', order: 44 },
  '280000004': { text: '\x1b<3mFWD XFR IN PROGRESS', order: 45 },
  '280000002': { text: '\x1b<3mCOLDFUEL OUTR TK XFR', order: 46 },
  '280000007': { text: '\x1b<3mOUTR TK XFR IN PROG', order: 47 },
  '280000005': { text: '\x1b<3mGND XFR IN PROGRESS', order: 48 },
  '280000012': { text: '\x1b<3mTRIM TK XFRD', order: 49 },
  '280000008': { text: '\x1b<3mOUTR TKs XFRD', order: 50 },

  '343000002': { text: '\x1b<3mALT RPTG OFF', order: 51 },
  '343000003': { text: '\x1b<3mXPDR STBY', order: 52 },
  '343000001': { text: '\x1b<3mTCAS STBY', order: 53 },
