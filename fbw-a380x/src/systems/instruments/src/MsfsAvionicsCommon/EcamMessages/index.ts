...
export const EcamMemos: { [n: string]: { text: string; order?: number } } = {
  ...
  '271000001': { text: '\x1b<3mGND SPLRs ARMED', order: 19 },
  '241000001': { text: '\x1b<4mELEC EXT PWR', order: 20 },
  '241000002': { text: '\x1b<3mELEC EXT PWR', order: 21 },
  '322000001': { text: '\x1b<4mN/W STEER DISC', order: 22 },
  '322000002': { text: '\x1b<3mN/W STEER DISC', order: 23 },
  '230000013': { text: '\x1b<3mSATCOM ALERT', order: 24 },
  '460000003': { text: '\x1b<3mCOMPANY ALERT', order: 25 },
  '460000004': { text: '\x1b<3mCOMPANY ALERT:PRNTR', order: 26 },
  '460000001': { text: '\x1b<3mCOMPANY MSG', order: 27 },
  '460000002': { text: '\x1b<3mCOMPANY MSG:PRNTR', order: 28 },
  '460000005': { text: '\x1b<3mCALL COMPANY', order: 29 },
