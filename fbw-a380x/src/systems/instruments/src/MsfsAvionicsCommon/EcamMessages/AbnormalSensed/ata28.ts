...
export const EcamAbnormalSensedAta28: { [n: number]: AbnormalProcedure } = {
  ...
  280900003: {
    ...
    sensed: false,
    items: [
      { name: 'DELAY T.O', sensed: true },
      { name: 'EMER OUTR TK XFR ON OR FEED TKs NOT BALANCED', condition: true, sensed: false },
      { name: 'NO FUEL LEAK', condition: true, sensed: false, level: 1 },
      {
        name: 'IMBALANCE BETWEEN FEED TKs 1 & 4 (IMBALANCE MORE THAN 2000 KG)',
        condition: true,
        sensed: false,
        level: 2,
      },
      { name: 'FUEL CONSUMPT INCRSD', sensed: false, level: 2 },
      { name: 'FMS PRED UNRELIABLE', sensed: false, level: 2, style: ChecklistLineStyle.Green },
      { name: 'CROSSFEED 1', labelNotCompleted: 'ON', sensed: true, level: 2 },
      { name: 'CROSSFEED 4', labelNotCompleted: 'ON', sensed: true, level: 2 },
      { name: 'FEED TK 1 QTY LESS THAN FEED TK 4 QTY', condition: true, sensed: false, level: 2 },
      { name: 'FEED TK 1 STBY PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'FEED TK 1 MAIN PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'WHEN FEED TKs 1 & 4 BALANCED', condition: true, sensed: false, level: 3 },
      { name: 'FEED TK 1 MAIN PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'FEED TK 1 STBY PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'CROSSFEED 1', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      { name: 'CROSSFEED 4', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      { name: 'FEED TK 4 QTY LESS THAN FEED TK 1 QTY', condition: true, sensed: false, level: 2 },
      { name: 'FEED TK 4 STBY PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'FEED TK 4 MAIN PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'WHEN FEED TKs 1 & 4 BALANCED', condition: true, sensed: false, level: 3 },
      { name: 'FEED TK 4 MAIN PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'FEED TK 4 STBY PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'CROSSFEED 1', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      { name: 'CROSSFEED 4', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      {
        name: 'IMBALANCE BETWEEN FEED TKs 2 & 3 (IMBALANCE MORE THAN 2000 KG)',
        condition: true,
        sensed: false,
        level: 2,
      },
      { name: 'FUEL CONSUMPT INCRSD', sensed: false, level: 2 },
      { name: 'FMS PRED UNRELIABLE', sensed: false, level: 2, style: ChecklistLineStyle.Green },
      { name: 'CROSSFEED 2', labelNotCompleted: 'ON', sensed: true, level: 2 },
      { name: 'CROSSFEED 3', labelNotCompleted: 'ON', sensed: true, level: 2 },
      { name: 'FEED TK 2 QTY LESS THAN FEED TK 3 QTY', condition: true, sensed: false, level: 2 },
      { name: 'FEED TK 2 STBY PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'FEED TK 2 MAIN PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'WHEN FEED TKs 2 & 3 BALANCED', condition: true, sensed: false, level: 3 },
      { name: 'FEED TK 2 MAIN PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'FEED TK 2 STBY PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'CROSSFEED 2', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      { name: 'CROSSFEED 3', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      { name: 'FEED TK 3 QTY LESS THAN FEED TK 2 QTY', condition: true, sensed: false, level: 2 },
      { name: 'FEED TK 3 STBY PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'FEED TK 3 MAIN PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'WHEN FEED TKs 2 & 3 BALANCED', condition: true, sensed: false, level: 3 },
      { name: 'FEED TK 3 MAIN PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'FEED TK 3 STBY PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'CROSSFEED 2', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      { name: 'CROSSFEED 3', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      {
        name: 'EMER OUTR TK XFR IN PROGRESS OR COMPLETED',
        condition: true,
        sensed: false,
        level: 2,
      },
      { name: 'ALL CROSSFEEDS', labelNotCompleted: 'ON', sensed: true, level: 3 },
      { name: 'FEED TK 2 STBY PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'FEED TK 2 MAIN PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'FEED TK 3 STBY PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      { name: 'FEED TK 3 MAIN PMP', labelNotCompleted: 'OFF', sensed: true, level: 3 },
      {
        name: 'WHEN EACH OUTR TK QTY LESS THAN 500 KG AND FEED TKs BALANCED (WITHIN 2000 KG)',
        condition: true,
        sensed: false,
        level: 3,
      },
      ...
      { name: 'FEED TK 3 MAIN PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'FEED TK 3 STBY PMP', labelNotCompleted: 'ON', sensed: true, level: 4 },
      { name: 'ALL CROSSFEEDS', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      {
        name: 'FEED TK 1 QTY LESS THAN FEED TK 2 AND FEED TK 4 QTY LESS THAN FEED TK 3',
        condition: true,
        sensed: false,
        level: 2,
      },
      ...
      { name: 'ALL CROSSFEEDS', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      {
        name: 'INR TKs NOT BALANCED',
        condition: true,
        sensed: false,
        level: 2,
      },
      { name: 'TKs BALANCING : ONE PAIR AT A TIME', sensed: false, level: 3, style: ChecklistLineStyle.Green },
      { name: 'FUEL CONSUMPT INCRSD', sensed: false, level: 3 },
      { name: 'FMS PRED UNRELIABLE', sensed: false, level: 3, style: ChecklistLineStyle.Green },
      { name: 'CHECK FEED TKs QTY TO AVOID OVERFLOW', sensed: false, level: 3 },
      {
        name: 'FOR LIGHTER TK',
        condition: true,
        sensed: false,
      ...
      { name: 'INR TK AFT PMP', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      { name: 'INR TK XFR', labelNotCompleted: 'MAN', sensed: true, level: 4 },
      {
        name: 'WHEN INR TKs BALANCED',
        condition: true,
        sensed: false,
        level: 4,
      },
      { name: 'INR TK XFR', labelNotCompleted: 'AUTO', sensed: true, level: 5 },
      { name: 'INR TK AFT PMP', labelNotCompleted: 'ON', sensed: true, level: 5 },
      {
        name: 'MID TKs NOT BALANCED',
        condition: true,
        sensed: false,
        level: 2,
      },
      ...
      { name: 'MID TK AFT PMP', labelNotCompleted: 'OFF', sensed: true, level: 4 },
      { name: 'MID TK XFR', labelNotCompleted: 'MAN', sensed: true, level: 4 },
      {
        name: 'WHEN MID TKs BALANCED',
        condition: true,
        sensed: false,
        level: 4,
      },
      { name: 'MID TK XFR', labelNotCompleted: 'AUTO', sensed: true, level: 5 },
      { name: 'MID TK AFT PMP', labelNotCompleted: 'ON', sensed: true, level: 5 },
      {
        name: 'OUTR TKs NOT BALANCED',
        condition: true,
        sensed: false,
        level: 2,
      },
      { name: 'OUTR TKs MAN BALANCING NOT AVAIL', sensed: false, level: 3, style: ChecklistLineStyle.Green },
      { name: 'FUEL CONSUMPT INCRSD', sensed: false, level: 3 },
      { name: 'FMS PRED UNRELIABLE', sensed: false, level: 3, style: ChecklistLineStyle.Green },
    ],
  },
