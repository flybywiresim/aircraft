...
export const EcamAbnormalSensedAta34: { [n: number]: AbnormalProcedure } = {
  ...
  340900003: {
    ...
    items: [
      ...
      { name: 'BELOW FL 100|12.5°', sensed: true, style: ChecklistLineStyle.GreenTable, level: 1 }, // [14]
      { name: 'BETWEEN FL 100 & FL 250|10°', sensed: true, style: ChecklistLineStyle.GreenTable, level: 1 }, // [15]
      { name: 'ABOVE FL 250|5°', sensed: true, style: ChecklistLineStyle.GreenTable, level: 1 }, // [16]
