...
export const EcamAbnormalSensedAta34: { [n: number]: AbnormalProcedure } = {
  ...
  340900003: {
    ...
    items: [
      ...
      { name: 'RISK OF UNDUE OVERSPEED WARNING', sensed: false, style: ChecklistLineStyle.Green, level: 1 }, // [21]
      { name: 'FMS POSITION / GPS PAGE', labelNotCompleted: 'SELECT', sensed: false, level: 1 }, // [22]
