...
export const EcamAbnormalSensedAta34: { [n: number]: AbnormalProcedure } = {
  ...
  340900003: {
    ...
    items: [
      ...
      { name: 'WHEN ALTITUDE PERMITS LEVEL FLT :', condition: true, sensed: false, level: 1 }, // [23]
      ...
      { name: 'AVOID ICING CONDs', sensed: false, level: 3 }, // [44]
      { name: 'CABIN ALT MODE', labelNotCompleted: 'MAN', sensed: true, level: 1 }, // [45]
      { name: 'ACFT CRZ FL|CABIN ALT TRGT', sensed: true, style: ChecklistLineStyle.GreenTable, level: 2 }, // [46]
      { name: '250|2900', sensed: true, style: ChecklistLineStyle.GreenTable, level: 2 }, // [47]
      { name: '200|2150', sensed: true, style: ChecklistLineStyle.GreenTable, level: 2 }, // [48]
      { name: '150|1500', sensed: true, style: ChecklistLineStyle.GreenTable, level: 2 }, // [49]
      { name: '100|900', sensed: true, style: ChecklistLineStyle.GreenTable, level: 2 }, // [50]
      { name: 'CABIN ALT TRGT', labelNotCompleted: 'AS RQRD', sensed: false, level: 1 }, // [51]
      { name: 'GA THR : TOGA ONLY', sensed: false, level: 2 }, // [52]
