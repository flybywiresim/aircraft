...
export const EcamAbnormalSensedAta34: { [n: number]: AbnormalProcedure } = {
  ...
  340900003: {
    ...
    items: [
      ...
      { name: 'ALL THR LEVERS', labelNotCompleted: 'MCT', sensed: true, level: 2 }, // [8]
      ...
      { name: '|PITCH TRGT', sensed: true, style: ChecklistLineStyle.GreenTable }, // [13]
      { name: 'BELOW FL 100|12.5°', sensed: true, style: ChecklistLineStyle.GreenTable }, // [14]
      { name: 'BETWEEN FL 100 & FL 250|10°', sensed: true, style: ChecklistLineStyle.GreenTable }, // [15]
      { name: 'ABOVE FL 250|5°', sensed: true, style: ChecklistLineStyle.GreenTable }, // [16]
      { name: 'IN CLIMB: ADJUST PITCH TRGT', sensed: false, level: 1 }, // [17]
      { name: 'FLAPS', labelNotCompleted: 'SELECT CONF 3', sensed: false, level: 2 }, // [18]
      ...
      { name: 'AIR DATA (ADRs/STBY INSTR)', labelNotCompleted: 'XCHECK', sensed: false, level: 1 }, // [23]
      { name: 'AT LEAST ONE AIR DATA RELIABLE :', condition: true, sensed: false, level: 1 }, // [24]
      { name: 'RELIABLE AIR DATA', labelNotCompleted: 'USE', sensed: false, level: 2 }, // [25]
      { name: 'AT LEAST ONE ADR : KEEP ON', sensed: false, level: 2 }, // [26]
      { name: 'UNRELIABLE ADRs', labelNotCompleted: 'OFF', sensed: false, level: 2 }, // [27]
      { name: 'NO AIR DATA RELIABLE :', condition: true, sensed: false, level: 1 }, // [28]
      { name: 'ADR 1+2+3 P/Bs', labelNotCompleted: 'OFF', sensed: true, level: 2 }, // [29]
      { name: 'SPEED', labelNotCompleted: 'FLY THE GREEN', sensed: false, level: 2 }, // [30]
      { name: 'FPV / VV AVAIL', sensed: false, style: ChecklistLineStyle.Green, level: 2 }, // [31]
      ...
      { name: 'AIR DATA (ADRs/STBY INSTR)', labelNotCompleted: 'XCHECK', sensed: false }, // [51]
      { name: 'AT LEAST ONE AIR DATA RELIABLE :', condition: true, sensed: false, level: 1 }, // [52]
      { name: 'RELIABLE AIR DATA', labelNotCompleted: 'USE', sensed: false, level: 2 }, // [53]
      { name: 'AT LEAST ONE ADR : KEEP ON', sensed: false, level: 2 }, // [54]
      { name: 'UNRELIABLE ADRs', labelNotCompleted: 'OFF', sensed: false, level: 2 }, // [55]
      { name: 'NO AIR DATA RELIABLE :', condition: true, sensed: false, level: 1 }, // [56]
      { name: 'ONE ADR : KEEP ON', sensed: false, level: 2 }, // [57]
      { name: 'TWO ADR P/Bs', labelNotCompleted: 'OFF', sensed: false, level: 2 }, // [58]
      { name: 'GA THR : TOGA ONLY', sensed: false, style: ChecklistLineStyle.Cyan, level: 2 }, // [59]
    ],
  },
};
