...
const A380Cond = () => {
    return (
        <>
            ...
            <text x={77} y={142} className="White F23 MiddleAlign">AVNCS</text>
            <text x={458} y={152} className="White F23 MiddleAlign">TO</text>
            <text x={442} y={249} className="White F23 MiddleAlign">TO</text>
            <text x={77} y={284} className="White F23 MiddleAlign">AVNCS</text>
            <text x={195} y={305} className="White F23 MiddleAlign">CRG</text>
            <text x={340} y={305} className="White F23 MiddleAlign">REST</text>
            <text x={535} y={305} className="White F23 MiddleAlign">CRG</text>
            <text x={680} y={305} className="White F23 MiddleAlign">BULK</text>
            <text x={395} y={501} className="White F23 MiddleAlign">MIX AIR</text>
            <text x={395} y={530} className="White F23 MiddleAlign">RAM AIR</text>
            <text x={330} y={585} className="White F23 MiddleAlign">1</text>
            <text x={465} y={585} className="White F23 MiddleAlign">2</text>
            <text x={395} y={585} className="White F23 MiddleAlign">HOT AIR</text>
