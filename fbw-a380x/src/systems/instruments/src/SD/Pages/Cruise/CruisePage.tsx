...
export const CruisePage = () => {
    ...
    return (
        <>
            ...
            {/* Fuel Flow */}
            <text className="F29 Underline White" x={15} y={80}>FUEL</text>
            ...
            <text className="F29 LS1 EndAlign Green" x={112} y={127}>{engine1FuelFlowDisplay}</text>
            <text className="F29 LS1 EndAlign Green" x={263} y={127}>{engine2FuelFlowDisplay}</text>
            <text className="F29 LS1 EndAlign Green" x={578} y={127}>{engine3FuelFlowDisplay}</text>
            <text className="F29 LS1 EndAlign Green" x={730} y={127}>{engine4FuelFlowDisplay}</text>

            <text className="F26 MiddleAlign White" x={383} y={99}>FF</text>
            <text className="F22 MiddleAlign Cyan" x={383} y={131}>KG/H</text>
            ...
            <text className="F29 LS1 EndAlign Green" x={122} y={227}>{engine1FuelUsedDisplay}</text>
            <text className="F29 LS1 EndAlign Green" x={273} y={227}>{engine2FuelUsedDisplay}</text>
            <text className="F29 LS1 EndAlign Green" x={588} y={227}>{engine3FuelUsedDisplay}</text>
            <text className="F29 LS1 EndAlign Green" x={740} y={227}>{engine4FuelUsedDisplay}</text>

            <text className="F26 MiddleAlign White" x={383} y={199}>FU</text>
            <text className="F26 MiddleAlign White" x={383} y={228}>TOTAL</text>
            <text className="F29 LS1 EndAlign Green" x={428} y={265}>{engineTotalFuelUsedDisplay}</text>
            <text className="F22 MiddleAlign Cyan" x={383} y={285}>KG</text>

            <text className="F29 Underline White" x={18} y={330}>AIR</text>
