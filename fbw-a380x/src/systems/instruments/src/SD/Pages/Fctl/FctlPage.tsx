...
export const FctlPage = () => {
    ...
    for (let i = 0; i < 8; i++) {
        spoilersLeft.push(<Spoiler x={147 + 26 * i} y={545} side={SpoilerSide.Left} position={8 - i as any} onGround={onGround} />);
        spoilersRight.push(<Spoiler x={425 + 26 * i} y={545} side={SpoilerSide.Right} position={i + 1 as any} onGround={onGround} />);
    }
