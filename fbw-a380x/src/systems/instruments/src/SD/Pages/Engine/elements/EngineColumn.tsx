...
const EngineColumn: FC<Position & EngineNumber & IgnitionActive & EngineColumnProps> = ({ x, y, engine, ignition, anyEngineRunning }) => {
    ...
    const [oilQuantity] = useSimVar(`L:A32NX_ENGINE_TOTAL_OIL:${engine}`, 'number', 500); // TODO: Update with correct SimVars
    ...
    return (
        <>
            ...
            {!starterValveOpen && !ignition
                && <NacelleTemperatureGauge x={x} y={y + 536} engine={engine} active={engineRunningOrIgnitionOn} value={240} />}
