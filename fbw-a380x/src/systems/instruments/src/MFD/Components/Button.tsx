...
export const Button: FC<ButtonProps> = ({
    x = 0, y = 0, width = 0, height = 41, children, onClick, disabled, fill, highlighted, textBackgroundColor, textColor, strokeWidth = 5,
    defaultColor = 'white', hoverColor = 'cyan', activeColor = 'grey',
}) => {
    ...
    const handleChild = (child) => {
        ...
        return <text ref={textRef} x={width / 2} y={height / 2} fill={textFill} fontSize={22} textAnchor="middle" dominantBaseline="central">{child}</text>;
    };
