...
import { ConsumerValue, EventBus, SimVarValueType, Subject, UnitType } from '@microsoft/msfs-sdk';
import { Arinc429Register, Arinc429SignStatusMatrix, Arinc429Word, FmsOansData } from '@flybywiresim/fbw-sdk';
