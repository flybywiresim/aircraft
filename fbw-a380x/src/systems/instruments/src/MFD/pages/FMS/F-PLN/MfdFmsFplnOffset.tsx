...
export class MfdFmsFplnOffset extends FmsPage<MfdFmsFplnOffsetProps> {
  ...
  private offsetStartpWpt = Subject.create<string>('');

  private offsetEndpWpt = Subject.create<string>('');
      ...
      <>
        ...
        <div class="fr">
          <div class="mfd-fms-fpln-labeled-box-container" style="flex-grow: 1;">
            ...
            <div class="mfd-fms-offset-start-dropdown-div">
              <DropdownMenu
            ...
            <div class="mfd-fms-offset-end-dropdown=div">
              <DropdownMenu
                ref={this.dropdownMenuRef}
