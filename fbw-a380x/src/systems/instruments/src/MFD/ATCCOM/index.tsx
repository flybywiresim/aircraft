    ...
    return (
        <Button x={278} y={45} width={155} height={60} onClick={() => history.push(`${path}/report_&_modify`)}>
            ...
            <rect
                ...
                fill="none"
            />
            <text ref={textRefFirstLine} x={72} y={20} fill="white" fontSize={22} textAnchor="middle" dominantBaseline="central">
                REPORT
            </text>
            <text ref={textRefSecondLine} x={72} y={41} fill="white" fontSize={22} textAnchor="middle" dominantBaseline="central">
                &amp; MODIFY
            </text>
        </Button>
    );
    ...
    return (
        <Button x={433} y={45} width={130} height={60} onClick={() => history.push(`${path}/msg_record`)}>
            ...
            <text ref={textRef} x={63} y={30} fill="white" fontSize={22} textAnchor="middle">
                <tspan dx={16} dy={-10} dominantBaseline="central">MSG</tspan>
                <tspan dx={-63} dy={25} dominantBaseline="central">RECORD</tspan>
            </text>
        </Button>
    );
};
    ...
    return (
        <Button x={667} y={45} width={98} height={60} onClick={() => history.push(`${path}/emergency`)}>
            ...
            <rect
                ...
                fill="none"
            />
            <text ref={textRef} x={49} y={30} fill="black" fontSize={22} textAnchor="middle" dominantBaseline="central">EMER</text>
        </Button>
    );
};
...
const StatusBar: React.FC = () => {
    ...
    return (
        <>
            ...
            <text x={18} y={134} letterSpacing={1.5} fill="black" fontSize={28}>{statusText}</text>
        </>
    );
};
