...
export const WhenCanWeExpectSpeedRange: FC<MessageVisualizationProps> = ({ x = 0, y = 0, index, messageElements, onDelete }) => {
    ...
    return (
        <MessageElement x={x} y={y} onDelete={onDelete}>
            <Layer>
                <text x={10} fontSize={22} fill="white">WHEN CAN WE EXPECT SPD/MACH</text>
            </Layer>
            <Layer>
                <text x={107} fontSize={22} fill="white">FROM</text>
                <TextBox
                    x={180}
                    y={-28}
                    maxLength={3}
            ...
            <Layer>
                <text x={134} fontSize={22} fill="white">TO</text>
                <TextBox
                    x={180}
                    y={-28}
                    maxLength={3}
