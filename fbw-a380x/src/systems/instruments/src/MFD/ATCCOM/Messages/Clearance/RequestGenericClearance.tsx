...
export const RequestGenericClearance: FC<MessageVisualizationProps> = ({ x = 0, y = 0, index, messageElements, onDelete }) => (
    <MessageElement x={x} y={y} onDelete={onDelete}>
        <Layer>
            <text x={30} fontSize={22} fill="white">REQUEST CLEARANCE</text>
        </Layer>
        <Layer>
            <text x={15} fontSize={22} fill="white">WILL BE SENT TO ATC: ----</text>
        </Layer>
    </MessageElement>
);
