...
export const WhenCanWeExpectLowerLevel: FC<MessageVisualizationProps> = ({ x = 0, y = 0, index, messageElements, onDelete }) => {
    ...
    return (
        <MessageElement x={x} y={y} onDelete={onDelete}>
            ...
            <Layer>
                <text x={10} fontSize={22} fill="white">LOWER LEVEL</text>
            </Layer>
        </MessageElement>
    );
};
