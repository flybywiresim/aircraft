...
export const RequestITP: FC<MessageVisualizationProps> = ({ x = 0, y = 0, onDelete }) => (
    <>
        ...
        <text x={197} y={37} fontSize={22} fill="white">ITP REQUEST</text>
        <text x={138} y={300} fontSize={22} fill="white">PREPARE ITP REQUEST</text>
        <text x={77} y={340} fontSize={22} fill="white">IN SURV / TRAFFIC / ITP PAGE</text>
