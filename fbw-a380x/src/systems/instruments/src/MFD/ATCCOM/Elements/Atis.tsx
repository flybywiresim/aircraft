...
export const Atis: FC<AtisProps> = ({ x = 0, y = 0, airport, arrival }) => {
    const updatePrintTitle = (
        <>
            <tspan dx={5} dy={-7}>UPDATE</tspan>
            <tspan dx={-96} dy={25}>OR PRINT</tspan>
        </>
    );
    ...
    return (
        <Layer x={x} y={y}>
            <text fill="white" fontSize={27} textAnchor="start">
                <tspan x={15} y={97}>EDDF DEP ATIS K 1005Z RWY 25C ILS RWY 25C</tspan>
                <tspan x={15} dy={36}>RWY 25L CLOSED TRANS LVL 5000FT TWY N1 N2 N5</tspan>
                <tspan x={15} dy={36}>L CLSD EXPECT TKOF FROM L6 3266M AVLB IF</tspan>
                <tspan x={15} dy={36}>UNABLE DV PREFLIGHT WIND 27012KT VIS 10KM</tspan>
                <tspan x={15} dy={36}>CLOUD FEW011 BKN041 OVC054 TEMP ......</tspan>
            </text>
            ...
            <text x={230} y={42} fill="white" fontSize={22}>K 1005Z</text>
