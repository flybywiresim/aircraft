...
| Name                                             | Type    | Description                                                                                                |
|:-------------------------------------------------|:--------|:-----------------------------------------------------------------------------------------------------------|
| A32NX_ELEC_AC_1_BUS_IS_POWERED                   | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_AC_2_BUS_IS_POWERED                   | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_AC_ESS_BUS_IS_POWERED                 | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_AC_ESS_SHED_BUS_IS_POWERED            | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_AC_GND_FLT_SVC_BUS_IS_POWERED         | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_AC_STAT_INV_BUS_IS_POWERED            | Boolean | True when the given bus is powered.                                                                        |
...
| A32NX_ELEC_CONTACTOR_10KA_AND_5KA_IS_CLOSED      | Boolean | True when the contactor is CLOSED: 10KA_AND_5KA: The two contactors leading to the APU start motor         |
| A32NX_ELEC_CONTACTOR_11XU1_IS_CLOSED             | Boolean | True when the contactor is CLOSED: 11XU1: AC BUS tie 1 contactor                                           |
| A32NX_ELEC_CONTACTOR_11XU2_IS_CLOSED             | Boolean | True when the contactor is CLOSED: 11XU2: AC BUS tie 2 contactor                                           |
| A32NX_ELEC_CONTACTOR_12XN_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 12XN: Contactor from EXT PWR to TR2 and AC GND/FLT SVC BUS.             |
| A32NX_ELEC_CONTACTOR_14PU_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 14PU: Contactor from AC BUS 2 to TR2 and AC GND/FLT SVC BUS.            |
| A32NX_ELEC_CONTACTOR_15XE1_IS_CLOSED             | Boolean | True when the contactor is CLOSED: 15XE1: Contactor between AC ESS BUS and TR ESS + EMER GEN               |
| A32NX_ELEC_CONTACTOR_15XE2_IS_CLOSED             | Boolean | True when the contactor is CLOSED: 15XE2: Contactor between the static inverter and AC ESS BUS             |
| A32NX_ELEC_CONTACTOR_1PC1_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 1PC1: DC BAT BUS feed contactor between DC BUS 1 and DC BAT BUS         |
| A32NX_ELEC_CONTACTOR_1PC2_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 1PC2: DC BAT BUS feed contactor between DC BUS 2 and DC BAT BUS         |
| A32NX_ELEC_CONTACTOR_2XB1_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 2XB1: Contactor between battery 1 and the static inverter               |
| A32NX_ELEC_CONTACTOR_2XB2_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 2XB2: Contactor between battery 2 and the DC ESS BUS                    |
| A32NX_ELEC_CONTACTOR_2XE_IS_CLOSED               | Boolean | True when the contactor is CLOSED: 2XE: Emergency generator contactor                                      |
| A32NX_ELEC_CONTACTOR_3PE_IS_CLOSED               | Boolean | True when the contactor is CLOSED: 3PE: Transformer rectifier ESS contactor between TR ESS and DC ESS BUS  |
| A32NX_ELEC_CONTACTOR_3PX_IS_CLOSED               | Boolean | True when the contactor is CLOSED: 3PX: Contactor from TR2 to DC GND/FLT SVC BUS.                          |
| A32NX_ELEC_CONTACTOR_3XC1_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 3XC1: AC ESS feed contactor between AC BUS 1 and AC ESS BUS             |
| A32NX_ELEC_CONTACTOR_3XC2_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 3XC2: AC ESS feed contactor between AC BUS 2 and AC ESS BUS             |
| A32NX_ELEC_CONTACTOR_3XG_IS_CLOSED               | Boolean | True when the contactor is CLOSED: 3XG: External power contactor                                           |
| A32NX_ELEC_CONTACTOR_3XS_IS_CLOSED               | Boolean | True when the contactor is CLOSED: 3XS: APU generator contactor                                            |
| A32NX_ELEC_CONTACTOR_4PC_IS_CLOSED               | Boolean | True when the contactor is CLOSED: 4PC: Contactor between DC BAT BUS and DC ESS BUS                        |
| A32NX_ELEC_CONTACTOR_5PU1_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 5PU1: Transformer rectifier 1 contactor between TR1 and DC BUS 1        |
| A32NX_ELEC_CONTACTOR_5PU2_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 5PU2: Transformer rectifier 2 contactor between TR2 and DC BUS 2        |
| A32NX_ELEC_CONTACTOR_6PB1_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 6PB1: Battery 1 contactor                                               |
...
| A32NX_ELEC_CONTACTOR_6PB2_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 6PB2: Battery 2 contactor                                               |
...
| A32NX_ELEC_CONTACTOR_8PH_IS_CLOSED               | Boolean | True when the contactor is CLOSED: 8PH: DC ESS SHED contactor                                              |
| A32NX_ELEC_CONTACTOR_8PN_IS_CLOSED               | Boolean | True when the contactor is CLOSED: 8PN: Contactor from DC BUS 2 to DC GND/FLT SVC BUS.                     |
| A32NX_ELEC_CONTACTOR_8XH_IS_CLOSED               | Boolean | True when the contactor is CLOSED: 8XH: AC ESS SHED contactor                                              |
| A32NX_ELEC_CONTACTOR_9XU1_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 9XU1: Engine generator line contactor 1                                 |
| A32NX_ELEC_CONTACTOR_9XU2_IS_CLOSED              | Boolean | True when the contactor is CLOSED: 9XU2: Engine generator line contactor 2                                 |
| A32NX_ELEC_DC_1_BUS_IS_POWERED                   | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_DC_2_BUS_IS_POWERED                   | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_DC_BAT_BUS_IS_POWERED                 | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_DC_ESS_BUS_IS_POWERED                 | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_DC_ESS_SHED_BUS_IS_POWERED            | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_DC_GND_FLT_SVC_BUS_IS_POWERED         | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_DC_HOT_1_BUS_IS_POWERED               | Boolean | True when the given bus is powered.                                                                        |
| A32NX_ELEC_DC_HOT_2_BUS_IS_POWERED               | Boolean | True when the given bus is powered.                                                                        |
