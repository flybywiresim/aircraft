...
- [P3D XML Gauge Reference](https://www.prepar3d.com/SDK/SimObject%20Creation%20Kit/Panels%20and%20Gauges%20SDK/creating%20xml%20gauges.html) - still applies to FS2020.
...
### Symlink project files to your simulator
...
```cmd
mklink /J "C:\Users\<user>\AppData\Roaming\Microsoft Flight Simulator\Packages\Community\flybywire-aircraft-a320-neo" "C:\path\to\cloned\repo\flybywire-aircraft-a320-neo"
```
