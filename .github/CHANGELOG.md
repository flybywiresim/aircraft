...
102. [AP] Further improved ALT CST* and ALT CST conditions - @aguther (Andreas Guther)
103. [MCDU] Added support for connecting MCDU to external devices - @tyler58546 (tyler58546)
104. [ATHR] Improvement of ATHR laws - @IbrahimK42(IbrahimK42), @aguther (Andreas Guther)
105. [MISC] Fixed flap configuration in final.flt and runway.flt files -  @donstim (donbikes#4084)
106. [MISC] Added Home Cockpit mode to remove backlight bleed and reflections in displays - @ssewell (Shane Sewell)
107. [EFB] Added Reset to Defaults button to EFB throttle calibration page - @frankkopp (Cdr_Maverick#6475)
108. [HYD] Added more accurate simulation model of PTU - @Gurgel100 (Pascal)
109. [BLEED] Fix potential NaN calculations for fast flows - @Crocket63
110. [HYD] Reservoirs connected to pneumatics and first failures - @Crocket63
111. [ATSU] Don't include airport as a waypoint in route uplink - @tracernz (Mike)
112. [HYD] Increased reservoirs air pressure to avoid low air fault on pumps - @Crocket63
113. [EFB] Fix FAA TAF option - @tracernz (Mike)
114. [AP] Improved SPD/MACH law to be more robust in edge cases - @IbrahimK42 (IbrahimK42)
115. [FBW] Improved normal law (flight path stability when speed changed, pitch rates) - @aguther (Andreas Guther)
116. [AP] Improved ALT engage conditions (now +/- 40 ft and 0.8 s) - @aguther (Andreas Guther)
117. [AP] Inhibit ALT* for 3 s after changing FCU altitude - @aguther (Andreas Guther)
118. [AP] Separated and improved Nz used by different autopilot laws - @aguther (Andreas Guther)
119. [AP] Improved HDG/TRK law on small changes - @aguther (Andreas Guther)
120. [AP] Do not disengage SRS on RTO, engage it only in FLX detent when FLX is configured - @aguther (Andreas Guther)
121. [ATHR] Improved thrust limits, FLX limits now CLB when entered into FMGC - @aguther (Andreas Guther)
122. [AP] Improved LOC ALGIN and ROLL OUT during Autoland - @aguther (Andreas Guther)
123. [HYD] Simple hydraulic model placeholder for flaps and slats - @Crocket63
124. [FBW] Fix: do not compensate ground spoilers in C* law - @aguther (Andreas Guther)
125. [AP] Fix: adjustment of vertical speed limitation in SPD/MACH law - @IbrahimK42 (IbrahimK42)
126. [MISC] Animation speed/behaviors for button, switches and knobs - @bouveng (Johan Bouveng)
127. [AP] Added Autoland capability for special terrain profiles, i.e. KSEA 16R - @aguther (Andreas Guther)
128. [ATHR] Adjustment of ATHR SPD/MACH gains - @IbrahimK42 (IbrahimK42)
129. [HYD] Simplified max step loop updater - @Crocket63
130. [ATHR] Fix ATHR Alt Soft Mode - @IbrahimK42 (IbrahimK42)
131. 
132. ## 0.7.0

133. [HYD] First building block, more to come. Hydraulics do not impact the sim YET. - @crocket6 (crocket)
134. [HYD] Connected hydraulics element to electrical buses. - @crocket6 (crocket)
135. [ENGINE] Fixed fuel consumption model - @Taz5150 (TazX [Z+2]#0405)
136. [ENGINE] Fixed fuel flow being 0 at Start-up  - @Taz5150 (TazX [Z+2]#0405)
137. [MCDU] Fixed input and display issues on PERF/W&B and INIT pages - @felixharnstrom (Felix Härnström)
138. [MCDU] Progress page only shows GPS Primary when it should - @Username23-23 (NONAmr2433 #8777)
139. [ND] Add VOR/ADF needles to ILS arc display - @tracernz (Mike)
140. [MCDU] Add hard sign to temp field on PERF APPR, remove FLS/FINAL APP, adjust alignment - @tracernz (Mike)
141. [ADIRS] Add on delay for ON BAT light - @tracernz (Mike)
142. [MISC] Added 3D brake gauge - @tyler58546 (tyler58546), @DarkOfNova (DarkOfNova)
143. [ECAM] Refactor flight control page to use React - @RichardPilbery (tricky_dicky#3571)
144. [ELEC] The BCL commands the BAT contactor be closed when the BAT push button is moved from OFF to AUTO - @davidwalschots (David Walschots)
145. [MCDU] Implement BRG/DIST function on PROG page - @tracernz (Mike)
146. [MCDU] Fix max page number on duplicate waypoint selection - @tracernz (Mike)
147. [MCDU] Show max distance of 9999 NM on duplicate waypoint selection - @tracernz (Mike)
148. [DU] Display units only run their self-test when unpowered over 10 seconds - @davidwalschots (David Walschots)
149. [DISPLAYS] RMP backlight, ATC and RTPI font color and backlight - @marcman86 (marcman86#4907)
150. [RMP] Enabled LED indicators when testing ANN lights - @ImenesFBW (Imenes)
151. [EFB] Fix fuel tank capacity values - @donstim (donbikes#4084)
152. [MISC] Fixed EVAC button animation - @tyler58546 (tyler58546)
153. [ECAM] Improved alternating of igniters - @joseph-tobin (joseph#1001)
154. [TEXTURE] Upscaled the existing FBW livery to 8K - @FoxinTale (Aubrey)
155. [CHECKLISTS] Added missing Fuel Pumps checkpoint - @sidnov (sidnov#8337)
156. [ELEC] All external and internal lights are powered by the correct electrical bus. - @davidwalschots (David Walschots)
157. [ELEC] Equipment such as wipers and display units are powered by the correct electrical bus - @davidwalschots (David Walschots)
158. [ELEC] Button and indication lights are powered by the correct electrical bus - @davidwalschots (David Walschots)
159. [ELEC] Engines keep running when electrical systems are lost - @davidwalschots (David Walschots)
160. [ELEC] When turning the BAT pb to AUTO, the battery charge limiter has a 1 second startup delay - @davidwalschots (David Walschots)
161. [MCDU] Fixed entry of in.Hg baro settings ending in zero - @tracernz(Mike)
162. [PFD] Reimplemented and improved PFD in react - @lukecologne (lukecologne#1156)
163. [FBW] New custom fly-by-wire system - @aguther (Andreas Guther)
164. [AUTOPILOT] New custom autopilot system - @aguther (Andreas Guther)
165. [AUTOTHRUST] New custom autothrust system - @aguther (Andreas Guther)
166. [ENGINE] New engine model with custom EGT and fuel flow logic - @Taz5150 (TazX [Z+2]#0405)
167. [FLIGHTMODEL] New flight model adapted to new engine model - @donstim (donbikes#4084)
168. [FLIGHTMODEL] Added separated flaps position for 1 and 1+F - @donstim (donbikes#4084), @aguther (Andreas Guther)
169. [FLIGHTMODEL] Custom spoiler logic and realistic impact on flight model - @donstim (donbikes#4084), @aguther (Andreas Guther)
170. [EFB] Added throttle calibration for autothrust system - @Saschl (saschl#9432)
171. [ECAM] Add REFUELG message to upper ECAM when refuelling via fuel page on EFB - @sidnov (sidnov#8337)
172. [EFB] Disabled LINK MCDU button on dashboard page - @ExampleWasTaken (ExampleWasTaken#0886)
173. [MCDU] Do not show duplicate names page with 1 option, fix return key - @tracernz (Mike)
174. [MCDU] Removed invalid chars from- and updated AOC TELEX warning message - @ExampleWasTaken (ExampleWasTaken#0886)
175. [ND] Fix Behaviour of TAS and Wind Info displayed inflight and on Take-Off - @ChruutvoLuzi (ChruutvoLuzi#8902)
176. [SOUND] Improved engine, ground roll, and ambience sounds - @hotshotp (Boris)
177. [SOUND] Added CVR test sound - @hotshotp (Boris)
178. [ELEC] Pushing the GEN 1 LINE push button to OFF opens the GEN 1 contactor - @davidwalschots (David Walschots)
179. [ELEC] Add ground service electrical buses - @davidwalschots (David Walschots)
180. [FLIGHTMODEL] Fixed excessive weathervaning stability - @donstim (donbikes#4084)
181. [AUTOPILOT] Improved ROLL OUT and G/S laws - @aguther (Andreas Guther)
182. [FMGC] Added VS descent phase initiation - @MisterChocker (Leon)
183. [SOUND] Added glareshield chrono button sound - @ImenesFBW (Imenes)
184. [MCDU] Disallow ATIS request when no airport is specified - @ExampleWasTaken (ExampleWasTaken#0886)
185. [FBW] New high angle of attack and high speed protection - @lukecologne (luke), @aguther (Andreas Guther)
186. [FBW] Adapt pitch attitude protection for configuration - @aguther (Andreas Guther)
187. [FBW] Realistic rudder pedals animation only following pilot input or trim - @aguther (Andreas Guther)
188. [FCU] Added more custom events that can be triggered via SimConnect to control the FCU - @aguther (Andreas Guther)
189. [MISC] Autobrake can be armed via keybindings - @Saschl (saschl#9432)
190. [FWC] Fix pushing of MASTER WARN and MASTER CAUT not disabling aural warnings - @davidwalschots (David Walschots)
191. [ELEC] EMER ELEC PWR overhead MAN ON push button triggers emergency generator start (RAT not yet simulated) - @davidwalschots (David Walschots)
192. [ELEC] RAT & EMER GEN fault light illuminates when applicable - @davidwalschots (David Walschots)
193. [FBW] Realistic rudder trim deflection and reset rate - @aguther (Andreas Guther)
194. [FBW] Elevator trim wheels no longer move when stop is reached - @aguther (Andreas Guther)
195. [AP] Improved V/S and FPA speed protection mode - @aguther (Andreas Guther)
196. [MISC] Seatbelt sign state can be toggled via external events - @Saschl (saschl#9432)
197. [MISC] Standby instrument brightness buttons can now be held down rather than pressed to -/+ brightness - @2hwk (2Cas#1022)
198. [AP] Fixed and improved mode transitions related to LAND modes - @aguther (Andreas Guther)
199. [ENGINE] Adapt engine IDLE N1 based on environmental conditions - @Taz5150 (TazX [Z+2]#0405), @aguther (Andreas Guther)
200. [ECAM] Added hydraulics page on SD - @RichardPilbery (tricky_dicky[Z+0]#3571)
201. [ND] ND Waypoint Icon Size, Icon Outlines, Airplane Icon Color and Outline - @marcman86 (marcman86#4907)
202. [ELEC] ENG FIRE push button deactivates IDG - @davidwalschots (David Walschots)
203. [AP] Improved OP CLB/DES, CLB/DES speed hold characteristics - @aguther (Andreas Guther)
204. [MCDU] Fixed sometimes bad error message on crz fl entry - @MisterChocker (Leon)
205. [ECP] Corrected EMER CANC ECAM button emissive behavior - @ImenesFBW (Imenes)
206. [ECAM] Change flight control page to use hydraulic simulation vars - @lukecologne (luke)
207. [HYD] Blue electric pump override button changed to momentary latched - @Crocket63 (crocket)
208. [LIGHTS] Add OVHD ANN LT DIM functionality - @bouveng (Johan Bouveng)
209. [PFD] Add baro setting flash when passing TA/TL - @lukecologne (luke)
210. [FLIGHT MODEL] Fix flap transition bounce - @donstim (donbikes#4084)
211. [FBW] Added visual aileron droop and anti-droop - @aguther (Andreas Guther)
212. [FLIGHT MODEL] Force usage of modern flight model - @aguther (Andreas Guther)
213. [MODEL] Reverse thrust animation no longer proportional to thrust lever position - @tracernz (Mike)
214. [HYD] Brakes are now connected to hydraulic system - @crocket63 (crocket)
215. [ADIRS] Fix ADIRUs not aligned starting on runway - @davidwalschots (David Walschots)
216. [FLIGHT MODEL] Adds new parameters introduced by SU4 - @donstim (donbikes#4084)
217. [LIGHTS] Correct Korry button labels - @tracernz (Mike), @tyler58546 (tyler58546)
218. [OVHD] Correct EVAC button behaviours - @tracernz (Mike)
219. [OVHD] Fix invisible fault emissive decal on centre fuel pump 2 - @tracernz (Mike)
220. [VFX] Add APU exhaust heat blur effect - @wpine215 (Iceman)
221. [MCDU] Improve robustness of Lat/Lon & P-B/P-B input parsing - @tracernz (Mike)
222. [RTPI] Add separate RTPI font file - @sidnov (Sid)
223. [AP+PFD] Added triple click and FMA mode reversion logic - @aguther (Andreas Guther)
224. [AP] Automatically arm NAV on ground when flight plan becomes available - @aguther (Andreas Guther)
225. [FCU] Automatically connect flight directors when FCU is powered on - @aguther (Andreas Guther)
226. [HYD] New custom auto brakes replace default one - @crocket63 (crocket)
227. [MISC] Chrono auto-brightness - @sidnov (Sid)
228. [AP] Improved disengage conditions for ROLL OUT and when excessive pitch or roll attitude - @aguther (Andreas Guther)
229. [FBW] Improved ground spoiler logic - @aguther (Andreas Guther)
230. [ATHR] Fixed incorrect THR LK activation when A/THR disconnect buttons have been used - @aguther (Andreas Guther)
231. [ECAM] Convert Cruise page to React - @RichardPilbery (tricky_dicky[Z+0]#3571)
232. [ATHR] Support flight director off take-off procedure - @aguther (Andreas Guther)
233. [MCDU] Fixed tropo entry validation - @MisterChocker (Leon)
234. [AP/FMGC] Improved managed speed and V2 validity - @aguther (Andreas Guther)
235. [FCU] Init FCU with SPD 100 kn, HDG = 0° and ALT 100 ft - @aguther (Andreas Guther)
236. [FBW] Inhibit alpha floor and protection law for 10 s after flight start / plane reload - @aguther (Andreas Guther)
237. [FLIGHT MODEL] Increased gear drag, reduced flap drag - @donstim (donbikes#4084)
238. [ATHR/FADEC] Fixed potential engagement of reverse thrust in flight - @aguther (Andreas Guther)
239. [ECAM] Fix REFUELG message being shown on ECAM even when refueling is complete - @BlueberryKing (BlueberryKing#6641)
240. [MCDU] ILS auto-tuning for departure and improved for approach - @tracernz (Mike)
241. [MCDU] Added clear scratchpad on CLR held down - @tracernz (Mike) and @MisterChocker (Leon)
242. [MCDU] Fixed performance page refresh on flight phase transition - @MisterChocker (Leon)
243. [FMGC] Added reset of fmgc variables - @MisterChocker (Leon)
244. [ATHR] Fixed permanent A/THR disconnect (15s press) not being able to activate with 3D button on thrust levers - @aguther (Andreas Guther)
245. [ND] TCAS symbols correctly display in 10, 20, 40nm ARC/ROSE views + bug fixes - @2hwk (2Cas#1022)
246. [ENGINE] Cold Engine start-up model (primary parameters) - @Taz5150 (TazX [Z+2]#0405)
247. [ATSU] Aircraft can only be fueled when on ground - @erso44 (Ersin Karakilic)
248. [ATHR/FWC] Adapted take-off A/THR engagement and added thrust lever not set warning - @aguther (Andreas Guther)
249. [TEXTURE] Added a white dot to the test button and corrected DISCH alignment on the fire panel - @ImenesFBW (Imenes)
250. [ECAM] Added ISA DEV to ECAM - @BlueberryKing (BlueberryKing#6641)
251. [AOC] Reworked airport handling on AOC Weather Request Page - @MisterChocker (Leon)
252. [EFB] Add flypad themed simbrief maps to EFB/OFP - @bouveng (Johan Bouveng)
253. [SOUND] Added blue and yellow electric hydraulic pump sounds - @hotshotp (Boris)
254. [SOUND] Further improved ambience and engine sounds - @hotshotp (Boris)
255. [ELEC] Improve electrical system implementation to allow for implementing advanced scenarios - @davidwalschots (David Walschots)
256. [MCDU] MCDU accepts direct keyboard input (enabled by new option in A32NX Realism Settings). - @2hwk (2Cas#1022)
257. [ISIS] Implement automatic brightness adjustment for standby instrument - @BlueberryKing (BlueberryKing#6641)
258. [HYD] Fixed catering door movement wrongly starting the yellow elec pump - @crocket63 (crocket)
259. [SOUND] Added custom FCU and GPWS, push-button sounds @ImenesFBW - (Imenes)
260. [ECAM] Implement amber REV message while reverser doors are in transit. - @BlueberryKing (BlueberryKing#6641)
261. [HYD] Switched hydraulics to new engine model simvars - @Crocket63 (crocket)
262. [LIGHTS] New potentiometer for lights, emissives and screens. - @bouveng (Johan Bouveng)
263. [SOUND] Improved engine startup sound and added wiper sounds - @hotshotp (Boris)
264. [FCU] Fix FCU DISPLAY AC1 BUS power. - @bouveng (Johan Bouveng)
265. [HYD] Fixed autobrake inputs response for rotating knob type controllers - @Crocket63 (crocket)
266. [ECAM] Autoswitch ECAM pages use proper FWC phase logic - @2hwk (2Cas#1022)
267. [HYD] Added basic LGCIU implementation with per wheel weight on wheels sensors - @Crocket63 (crocket)
268. [MISC] Improved logic for chronometer operations - @sidnov (Sid)
269. [DISPLAYS] Fix Self-Test no longer triggers when spawning from an in-flight state i.e. cruise/landing/takeoff on runway - @2hwk (2Cas#1022)
270. [SOUND] Improved engine startup, idle sounds, and cabin wind - @hotshotp (Boris)
271. [MODEL] Swap EFIS WPT and VOR D buttons - @tracernz (Mike)
272. [MODEL] Fix no-smoking/no-PED switch animation - @tracernz (Mike)
273. [DISPLAYS] Add pixelated screens - @bouveng (Johan Bouveng)
274. [ADIRS] Simple ATT mode implementation (does not yet include HDG entry) - @davidwalschots (David Walschots)
275. [ADIRS] The longest instead of the shortest remaining alignment time is displayed on the upper ECAM - @davidwalschots (David Walschots)
276. [ADIRS] IR1, IR3, or IR2 can be pushed OFF to disconnect output of IR information from that particular ADIRU - @davidwalschots (David Walschots)
277. [ADIRS] ADR1, ADR3, or ADR2 can be pushed OFF to disconnect output of ADR information from that particular ADIRU - @davidwalschots (David Walschots)
278. [ADIRS] GPS PRIMARY LOST is only indicated when none of the IRs are aligned or ON - @davidwalschots (David Walschots)
279. [ADIRS] Switching panel's ATT HDG and AIR DATA knobs functionality - @davidwalschots (David Walschots)
280. [ADIRS] Upper ECAM shows IR x IN ATT ALIGN when any ADIRU is in ATT mode alignment  - @davidwalschots (David Walschots)
281. [ADIRS] Wind, TAS, and GS indications depend on availability of IR and ADR data - @davidwalschots (David Walschots)
282. [ADIRS] SAT, TAT, and ISA indications depend on the selected ADR (1 or 3) - @davidwalschots (David Walschots)
283. [PRESS] First implementation of automatic pressurization system - @MJuhe (Miquel)
284. [MISC] Added annunciator lights to interactive checklist - @oim1 (oim)
285. [MISC] Workaround for altitude issues of MSFS - @aguther (Andreas Guther)
286. [MODEL] Un-mirror sharklet textures - @tracernz (Mike)
287. [DISPLAYS] Improved pixelated screens, only appears when camera is close to displays - @2hwk (2Cas#1022)
288. [MISC] Change back to airliner hud in external view for SU5 - @donstim (donbikes#4084)
289. [TEXTURE] Improved cockpit textures and screen reflections - @MoreRightRudder (Mike), @tyler58546 (tyler58546)
290. [MCDU] DEST EFOB and ALT DEST EFOB amber coloring fixed - @erso44 (Ersin Karakilic)
291. [EFB] Add tabbed settings page to EFB - @ErickSharp (Erick [Z-6]#6484)
292. [FCU] Added LVAR for selected speed and only fill active LVAR for VS or FPA mode
293. [MODEL] Removed unused material to fix potential crash to desktop - @aguther (Andreas Guther)
294. [ARCH] Failures are supported - @davidwalschots (David Walschots)
295. [HYD] Updated fix for autobrake rotating knob type controllers - @Crocket63 (crocket)
296. [MODEL] Fix Cockpit Door Video Toggle - @sidnov (Sid)
297. [MISC] Added JP, FI, SE, NO and NL language support for tooltips. - @kpotschi (MelodyConnor)
298. [ECAM] Rewrite fuel page for React - @Benjozork (Benjamin Dupont) and @RichardPilbery (tricky_dicky[Z+0]#3571)
299. [LIGHTS] Added workaround for missing lighting definitions in Asobo templates - @cloudynetwork (Peter Joseph)
300. [MODEL] Change ECAM button lights to white - @tracernz (Mike)
301. [GPWS] Fix "retard" callout so it plays at less than 20 ft radio altitude with autopilot off - @donstim (donbikes#4084)
302. [FADAC] Fix "fuel used. Fuel used is reset to zero when an engine is restarted on the gound. - john P Maguire#9027
303. [SOUNDS] Replace all remaining Asobo sounds - @hotshotp (boris#8008)
304. [SOUNDS] Implement an early version of closed vs open cockpit door sounds - @hotshotp (boris#8008)
305. [OVHD] CVR ground test auto-resets on first engine start - @tracernz (Mike)
306. [GENERAL] Added Notification to user via popup + notification when settings change requires aircraft reload. - @2hwk (2Cas#1022
307. [ECAM] ENG oil temperature amber while below takeoff minimum - @tracernz (Mike)
308. [MISC] Sync settings across instruments - @tracernz (Mike)
309. [MCDU] Remove some settings from MCDU the are now in the FlyPad - @tracernz (Mike)
310. [EFB] Persist sound and EFB settings correctly - @tracernz (Mike)
