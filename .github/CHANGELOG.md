...
1. [MISC] Fixed broken landing gear tooltip - @2hwk (2Cas#1022)
...
1. [SD] Add proper background colour for SD - @tracernz (Mike)
...
1. [PFD] Fixed RNP <= 0.3 indications to appear more reliably and consistently - @tracernz (Mike)
...
1. [SD] Fix SD page initialisation - @juliansebline (Julian Sebline#8476)
...
1. [SD] Fix ISA deviation - @mico975 (mico#3145)
1. [FWC] Fixed engine idle tolerance - @tracernz (Mike)
