...
41. [SD] Connect SD BLEED page APU bleed pressure indication to correct ADRs - @BlueberryKing (BlueberryKing)
42. [EFB] Change the order of the weather dashboard elements to reflect the order of the MCDU APPR PERF phase - @oim (oim1)
