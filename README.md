...
Open the zip that you downloaded from one of the links above, and drag the flybywire-aircraft-a32nx folder inside the zip into your Community folder.

See below for the location of your Community folder:

For the Microsoft Store edition AND/OR Gamepass edition:
- Copy the "flybywire-aircraft-a32nx" folder into your community package folder. It is located in:
...
- Please make sure you're copying the "flybywire-aircraft-a32nx" folder into your community package folder, NOT the "a32nx" folder.
...
A: The mod is added on top of the default A320neo from Asobo. If you want to uninstall it and revert to the original aircraft, just delete the flybywire-aircraft-a32nx folder in your community folder.
