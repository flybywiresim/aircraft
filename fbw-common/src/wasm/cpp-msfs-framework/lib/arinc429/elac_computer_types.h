...
enum class pitch_efcs_law : int32_T { NormalLaw = 0, AlternateLaw1, AlternateLaw2, DirectLaw, None };
...
enum class SignStatusMatrix : int32_T { FailureWarning = 0, NoComputedData, FunctionalTest, NormalOperation };
...
enum class lateral_efcs_law : int32_T { NormalLaw = 0, DirectLaw, None };
