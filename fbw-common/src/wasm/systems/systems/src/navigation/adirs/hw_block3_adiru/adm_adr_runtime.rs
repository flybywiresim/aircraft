...
impl AdmAirDataReferenceRuntime {
    ...
    fn update_baro_corrections(&mut self, fcu: &impl FlightControlUnitBusOutput) {
        ...
        self.baro_correction_1_ft =
            AdmAirDataReferenceRuntime::calculate_baro_alt_correction(self.baro_correction_1_hpa);
        ...
        self.baro_correction_2_ft =
            AdmAirDataReferenceRuntime::calculate_baro_alt_correction(self.baro_correction_2_hpa);
    ...
    fn update_pressure_altitude_and_vs(&mut self, context: &UpdateContext) {
        self.pressure_altitude_ft =
            AdmAirDataReferenceRuntime::calculate_altitude_from_static_pressure(Pressure::new::<
                hectopascal,
            >(
                self.averaged_static_pressure_hpa,
            ))
    ...
    pub fn set_bus_outputs(&self, bus: &mut AirDataReferenceBusOutputs) {
        ...
        AdmAirDataReferenceRuntime::update_altitude_word(
            self.pressure_altitude_ft,
