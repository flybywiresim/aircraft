...
bitflags! {
    ...
    pub(super) struct IrMaintFlags: u32 {
        const ALIGNMENT_NOT_READY = 0b0000000000000000001 << 10;
        const REV_ATT_MODE = 0b0000000000000000010 << 10;
        const NAV_MODE = 0b0000000000000000100 << 10;
        const VALID_SET_HEADING = 0b0000000000000001000 << 10;
        const ATTITUDE_INVALID = 0b0000000000000010000 << 10;
        const DC_FAIL = 0b0000000000000100000 << 10;
        const ON_DC = 0b0000000000001000000 << 10;
        const ADR_FAULT = 0b0000000000010000000 << 10;
        const IR_FAULT = 0b0000000000100000000 << 10;
        const DC_FAIL_ON_DC = 0b0000000001000000000 << 10;
        const ALIGN_FAULT = 0b0000000010000000000 << 10;
        const NO_IRS_INITIAL = 0b0000000100000000000 << 10;
        const EXCESS_MOTION_ERROR = 0b0000001000000000000 << 10;
        const ADR_IR_FAULT = 0b0000010000000000000 << 10;
        const EXTREME_LATITUDE = 0b0000100000000000000 << 10;
        const ALIGN_7_10_MINUTES = 0b0111000000000000000 << 10;
        const ALIGN_6_MINUTES = 0b0110000000000000000 << 10;
        const ALIGN_5_MINUTES = 0b0101000000000000000 << 10;
        const ALIGN_4_MINUTES = 0b0100000000000000000 << 10;
        const ALIGN_3_MINUTES = 0b0011000000000000000 << 10;
        const ALIGN_2_MINUTES = 0b0010000000000000000 << 10;
        const ALIGN_1_MINUTES = 0b0001000000000000000 << 10;
        const COMPUTED_LATITUDE_MISCOMPARE = 0b1000000000000000000 << 10;
    }
}
