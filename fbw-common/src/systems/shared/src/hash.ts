 ...
 * @param seed A seed for the hash. Defaults to 0.
 * @returns The computed hash.
 */
export function cyrb53_string(str: string, seed = 0): number {
...
/**
 * Hashes an array buffer as bytes using the cyrb53 hash.
 * @param buffer The buffer to hash.
 * @param seed A seed for the hash. Defaults to 0.
 * @returns The computed hash.
 */
export function cyrb53_bytes(buffer: ArrayBuffer, seed = 0): number {
