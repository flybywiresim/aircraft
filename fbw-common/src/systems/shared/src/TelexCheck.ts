...
export class TelexCheck {
  public showPopup(): void {
    const telexPopupState = NXDataStore.getLegacy('TELEX_POPUP_SHOWN', 'false');
    ...
    if (telexPopupState === 'false') {
      popup.showPopUp(
        ...
        'small',
        () => NXDataStore.setLegacy('CONFIG_ONLINE_FEATURES_STATUS', 'ENABLED'),
        () => NXDataStore.setLegacy('CONFIG_ONLINE_FEATURES_STATUS', 'DISABLED'),
      );
      NXDataStore.setLegacy('TELEX_POPUP_SHOWN', 'true');
    }
  }
}
