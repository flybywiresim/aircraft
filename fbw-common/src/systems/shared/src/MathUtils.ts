...
export class MathUtils {
   ...
   public static tableInterpolation(table: number[][], i: number, j: number): number {
       ...
       const interpolatedRowAtC1 = r1 === r2 ? table[r1][c1] : MathUtils.interpolate(i, table[r1][0], table[r2][0], table[r1][c1], table[r2][c1]);
       const interpolatedRowAtC2 = r1 === r2 ? table[r1][c2] : MathUtils.interpolate(i, table[r1][0], table[r2][0], table[r1][c2], table[r2][c2]);
