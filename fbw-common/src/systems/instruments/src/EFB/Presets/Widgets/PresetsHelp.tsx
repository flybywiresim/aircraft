      ...
      <div className="w-full space-y-2 ">
        ...
        <p className="text-2xl">
          <ul className="list-disc leading-9">
            ...
            <li>
              Save current interior lighting levels by clicking on "Save Preset" button of the corresponding preset when
              the aircraft is powered.
            </li>
            <li>
              Rename a preset by clicking on the current name and entering a new name. The new name will be saved after
        ...
        <p className="text-2xl">
          Aircraft Presets act as a virtual Co-Pilot supporting you setting up the aircraft correctly while you are
          preparing the flight management system. The Aircraft Presets do not cover the FMS and FCU setup.
        </p>
        ...
        <p className="text-2xl">
          <ul className="list-disc text-2xl leading-9">
            <li>
              When clicking on a preset button the corresponding preset procedure will be started. This happens in real
              time as if a Co-Pilot would execute the setup.
            </li>
            <li>
            ...
            <li>
              ...
              the current step is finished. The aircraft will be in a state in-between two presets. You can always press
              a preset again and let it run until completion to make sure a procedure is complete.
            </li>
            <li>
