...
const additionalSetting = [
  ...
  defaultChancePerTakeOff,
  defaultProbabilityLowSpeed,
  defaultProbabilityMedSpeed,
  defaultMinSpeed,
  defaultMinMedSpeed,
  defaultMedHighSpeed,
  defaultHGLMaxHundredsFeet,
];
...
const generatorSettingComponents = (
  ...
  const chanceClimbing =
    Math.round(
      10000 *
        (1 -
          settings[genNumber * numberOfSettingsPerGenerator + ChanceLowIndex] -
          settings[genNumber * numberOfSettingsPerGenerator + ChanceMediumIndex]),
    ) / 100;
