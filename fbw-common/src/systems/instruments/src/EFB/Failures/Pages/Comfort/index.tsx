...
const ATAChapterCard = ({ ataNumber, description, title }: ATAChapterCardProps) => {
    ...
    return (
        ...
        >
            <div
                className="flex w-1/5 items-center justify-center rounded-md bg-theme-accent font-title text-5xl font-bold"
            >
                {`ATA ${ataNumber}`}
    ...
    <>
        <Route exact path="/failures/comfort">
            ...
            {filteredChapters.length === 0 && (
                <div className="mt-4 flex items-center justify-center rounded-md border-2 border-theme-accent" style={{ height: '48rem' }}>
