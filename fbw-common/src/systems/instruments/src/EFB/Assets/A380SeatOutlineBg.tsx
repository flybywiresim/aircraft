...
export const A380SeatOutlineBg = ({ stroke, highlight }: SeatOutlineBgProps) => (
    ...
    >
        <g id="BASE_SVG" opacity="0.75">
            ...
            <path id="Rudder" d="M574.021,72.492C574.021,70.182 597.351,63.942 633.791,63.942C651.901,63.942 784.991,72.412 784.991,72.412L784.991,72.592C784.991,72.592 651.901,81.062 633.791,81.062C597.351,81.062 574.021,74.812 574.021,72.502L574.021,72.492Z" stroke={stroke} strokeWidth={0.25} />
