...
export const ThrottleConfig = ({ isShown, onClose }: ThrottleConfigProps) => {
  ...
  const axisSelectGroup = (
    <SelectGroup>
      <SelectItem selected={axisNum === 1} onSelect={() => setAxisNum(1)}>
        1
      </SelectItem>
      <SelectItem selected={axisNum === 2} onSelect={() => setAxisNum(2)}>
        2
      </SelectItem>
      {airframe === 'A380_842' && (
        <SelectItem selected={axisNum === 4} onSelect={() => setAxisNum(4)}>
          4
        </SelectItem>
      )}
    </SelectGroup>
