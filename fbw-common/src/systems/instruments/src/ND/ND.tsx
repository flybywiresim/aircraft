...
export class NDComponent<T extends number> extends DisplayComponent<NDProps<T>> {
    ...
    onAfterRender(node: VNode) {
        ...
        const sub = this.props.bus.getSubscriber<GenericFcuEvents & GenericDisplayManagementEvents & GenericFmsEvents & NDControlEvents & NDSimvars & OansControlEvents>();
...
class ToWaypointIndicator extends DisplayComponent<ToWaypointIndicatorProps> {
    private readonly sub = this.props.bus.getSubscriber<ClockEvents & GenericDisplayManagementEvents & GenericFcuEvents & NDSimvars & GenericFmsEvents>();
