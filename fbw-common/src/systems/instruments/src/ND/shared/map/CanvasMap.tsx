...
import { EfisNdMode, EfisVectorsGroup, NdSymbol, NdSymbolTypeFlags, NdTraffic, MathUtils, PathVector } from '@flybywiresim/fbw-sdk';
    ...
    private handleNewTraffic(newTraffic: NdTraffic[]) {
        ...
        if (this.mapMode.get() !== EfisNdMode.PLAN) {
            newTraffic.forEach((intruder: NdTraffic) => {
                ...
                case EfisNdMode.ARC:
                    tcasMask = [[-384, -83], [-384, 227], [-264, 227], [-210, 286], [-210, 370], [210, 370],
                        [210, 227], [267, 166], [384, 166], [384, -83], [340, -128], [300, -163], [240, -204.5],
                        [180, -233], [100, -255], [0, -265], [-100, -255], [-180, -233], [-240, -204.5],
                        [-300, -163], [-340, -128], [-384, -83]];
                    break;
