...
import { ArmedLateralMode, GenericFlightGuidanceEvents, LateralMode, isArmed } from '../types/GenericFlightGuidanceEvents';
...
export class TrackLine extends DisplayComponent<TrackLineProps> {
    ...
    private readonly sub = this.props.bus.getSubscriber<GenericDisplayManagementEvents & GenericFlightGuidanceEvents & NDSimvars & GenericFcuEvents>();
