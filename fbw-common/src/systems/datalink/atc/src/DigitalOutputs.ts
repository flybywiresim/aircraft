...
import { AtcRmpMessages } from './databus/RmpBus';
...
export class DigitalOutputs {
  ...
  private publisher: Publisher<AtcAocMessages & AtcAocRouterMessages & AtcFmsMessages & AtcRmpMessages> = null;
  ...
  constructor(
    ...
    this.publisher = this.bus.getPublisher<AtcAocMessages & AtcAocRouterMessages & AtcFmsMessages & AtcRmpMessages>();
  ...
  public sendRmpFrequency(frequency: number): void {
    ...
    this.publisher.pub('atcHandoverFrequency', frequencyWord, true, false);
  }
  ...
  public resetRmpFrequency(): void {
    ...
    this.publisher.pub('atcHandoverFrequency', emptyWord, true, false);
  }
