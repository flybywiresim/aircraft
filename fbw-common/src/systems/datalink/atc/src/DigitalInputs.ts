...
export class DigitalInputs {
    ...
    public connectedCallback(): void {
        ...
        this.subscriber.on('atcRegisterCpdlcMessages').handle((data) => this.fireAndForgetWithParameter(DigitalInputs.enhanceReceivedMessages(data), this.callbacks.registerMessages));
        this.subscriber.on('atcRegisterDclMessages').handle((data) => this.fireAndForgetWithParameter(DigitalInputs.enhanceReceivedMessages(data), this.callbacks.registerMessages));
        this.subscriber.on('atcRegisterOclMessages').handle((data) => this.fireAndForgetWithParameter(DigitalInputs.enhanceReceivedMessages(data), this.callbacks.registerMessages));
    ...
    public addDataCallback<K extends keyof AtcDigitalInputCallbacks>(event: K, callback: AtcDigitalInputCallbacks[K]): void {
