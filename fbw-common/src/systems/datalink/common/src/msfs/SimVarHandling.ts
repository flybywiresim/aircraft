...
export class SimVarHandling extends SimVarPublisher<SimVars> {
    ...
    public initialize(): void {
        ...
        this.subscriber.on('msfsUtcMonth').handle((month: number) => this.datalinkPublisher.pub('utcMonth', month, false, false));
        this.subscriber.on('msfsUtcDayOfMonth').handle((day: number) => this.datalinkPublisher.pub('utcDayOfMonth', day, false, false));
        ...
        this.subscriber.on('msfsVhf3Powered').handle((powered: number) => this.datalinkPublisher.pub('vhf3Powered', powered !== 0, false, false));
