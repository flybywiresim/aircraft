...
export class CpdlcMessageContentPosition extends CpdlcMessageContent {
  ...
  public validateAndReplaceContent(value: string[]): { matched: boolean; remaining: string[] } {
    ...
    if (this.IndexStart < value.length && this.IndexStart > -1) {
      if (
        InputValidation.validateScratchpadWaypoint(value[this.IndexStart]) === AtsuStatusCodes.Ok &&
...
export class CpdlcMessageContentVerticalRate extends CpdlcMessageContent {
  ...
  public validateAndReplaceContent(value: string[]): { matched: boolean; remaining: string[] } {
    ...
    if (this.IndexStart + 3 < value.length && this.IndexStart > -1) {
      if (
        value[this.IndexStart + 1] === 'FEET' &&
        value[this.IndexStart + 2] === 'PER' &&
        value[this.IndexStart + 3] === 'MINUTE'
      ) {
...
export class CpdlcMessageContentLegTypeTime extends CpdlcMessageContent {
  ...
  public validateAndReplaceContent(value: string[]): { matched: boolean; remaining: string[] } {
    ...
    if (this.IndexStart + 1 < value.length && this.IndexStart > -1 && /^[0-9]{1}$/.test(value[this.IndexStart])) {
      if (
        value[this.IndexStart + 1] === 'MIN' ||
        value[this.IndexStart + 1] === 'MINS' ||
        value[this.IndexStart + 1] === 'MINUTES'
      ) {
...
export const CpdlcMessagesDownlink: { [identification: string]: [string[], CpdlcMessageElement] } = {
  ...
  DM6: [
    ['REQUEST %s'],
    new CpdlcMessageElement(
      'DM6',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentLevel(1)],
      CpdlcMessageExpectedResponseType.Yes,
    ),
  ],
  DM7: [
    ['REQUEST BLOCK %s TO %s'],
    new CpdlcMessageElement(
      'DM7',
      [FansMode.FansA],
  ...
  DM8: [
    ['REQUEST CRUISE CLIMB TO %s'],
    new CpdlcMessageElement(
      'DM8',
      [FansMode.FansA],
      [new CpdlcMessageContentLevel(4)],
      CpdlcMessageExpectedResponseType.Yes,
    ),
  ],
  DM9: [
    ...
    new CpdlcMessageElement(
      'DM9',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentLevel(3)],
      CpdlcMessageExpectedResponseType.Yes,
    ),
  ],
  DM10: [
    ['REQUEST DESCEND TO %s'],
    new CpdlcMessageElement(
      'DM10',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentLevel(3)],
  ...
  DM16: [
    ['AT %s REQUEST OFFSET %s %s OF ROUTE'],
    new CpdlcMessageElement(
      'DM16',
      [FansMode.FansA],
  ...
  DM18: [
    ...
    new CpdlcMessageElement(
      'DM18',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentSpeed(1)],
      CpdlcMessageExpectedResponseType.Yes,
    ),
  ],
  DM19: [
  ...
  DM20: [
    ...
    new CpdlcMessageElement('DM20', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  DM21: [
    ['REQUEST VOICE CONTACT %s'],
    new CpdlcMessageElement(
      'DM21',
      [FansMode.FansA],
  ...
  DM23: [
    ...
    new CpdlcMessageElement(
      'DM23',
      [FansMode.FansA],
      [new CpdlcMessageContentProcedure(1)],
      CpdlcMessageExpectedResponseType.Yes,
    ),
  ],
  DM25: [
    ...
    new CpdlcMessageElement(
      'DM25',
      [FansMode.FansA],
      [new CpdlcMessageContentFreetext(1, 2)],
      CpdlcMessageExpectedResponseType.Yes,
    ),
  ],
  DM26: [
    ['REQUEST WEATHER DEVIATION TO %s VIA %s'],
    new CpdlcMessageElement(
      'DM26',
      [FansMode.FansA],
  ...
  DM27: [
    ['REQUEST WEATHER DEVIATION UP TO %s %s OF ROUTE'],
    new CpdlcMessageElement(
      'DM27',
      [FansMode.FansA, FansMode.FansB],
  ...
  DM31: [
    ...
    new CpdlcMessageElement(
      'DM31',
      [FansMode.FansA],
      [new CpdlcMessageContentPosition(1)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM32: [
  ...
  DM33: [
    ...
    new CpdlcMessageElement(
      'DM33',
      [FansMode.FansA],
      [new CpdlcMessageContentPosition(2)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM34: [
    ...
    new CpdlcMessageElement(
      'DM34',
      [FansMode.FansA],
      [new CpdlcMessageContentSpeed(2)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM35: [
    ...
    new CpdlcMessageElement(
      'DM35',
      [FansMode.FansA],
      [new CpdlcMessageContentDegree(2)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM36: [
    ['PRESENT GROUND TRACK %s'],
    new CpdlcMessageElement(
      'DM36',
      [FansMode.FansA],
      [new CpdlcMessageContentDegree(3)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM37: [
    ['MAINTAINING %s', 'LEVEL %s'],
    new CpdlcMessageElement(
      'DM37',
      [FansMode.FansA],
      [new CpdlcMessageContentLevel(1)],
  ...
  DM40: [
    ...
    new CpdlcMessageElement(
      'DM40',
      [FansMode.FansA],
      [new CpdlcMessageContentFreetext(2, -1)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  ...
  DM47: [
    ...
    new CpdlcMessageElement(
      'DM47',
      [FansMode.FansA],
      [new CpdlcMessageContentSquawk(1)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM48: [
    ['POSITION REPORT'],
    new CpdlcMessageElement('DM48', [FansMode.FansA], CpdlcMessageExpectedResponseType.Roger),
  ],
  DM49: [
    ['WHEN CAN WE EXPECT %s'],
    new CpdlcMessageElement(
      'DM49',
      [FansMode.FansA],
      [new CpdlcMessageContentSpeed(4)],
      CpdlcMessageExpectedResponseType.Yes,
    ),
  ],
  DM50: [
    ['WHEN CAN WE EXPECT %s TO %s'],
    new CpdlcMessageElement(
      'DM50',
      [FansMode.FansA],
  ...
  DM51: [
    ...
    new CpdlcMessageElement('DM51', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  DM52: [
    ['WHEN CAN WE EXPECT LOWER LEVEL'],
    new CpdlcMessageElement('DM52', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  DM53: [
    ['WHEN CAN WE EXPECT HIGHER LEVEL'],
    new CpdlcMessageElement('DM53', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  DM54: [
    ['WHEN CAN WE EXPECT CRUISE CLIMB TO %s'],
    new CpdlcMessageElement(
      'DM54',
      [FansMode.FansA],
      [new CpdlcMessageContentLevel(7)],
      CpdlcMessageExpectedResponseType.Yes,
    ),
  ],
  DM55: [
    ['PAN PAN PAN'],
    new CpdlcMessageElement('DM55', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.Yes, true),
  ],
  DM56: [
    ['MAYDAY MAYDAY MAYDAY'],
    new CpdlcMessageElement('DM56', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.Yes, true),
  ],
  DM57: [
    ['%s FUEL REMAINING AND %s PERSONS ON BOARD'],
    new CpdlcMessageElement(
      'DM57',
      [FansMode.FansA, FansMode.FansB],
  ...
  DM58: [
    ['CANCEL EMERGENCY'],
    new CpdlcMessageElement('DM58', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.Yes, true),
  ],
  DM59: [
    ['DIVERTING TO %s VIA %s'],
    new CpdlcMessageElement(
      'DM59',
      [FansMode.FansA, FansMode.FansB],
  ...
  DM62: [
    ...
    new CpdlcMessageElement(
      'DM62',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentFreetext(1, -1)],
      CpdlcMessageExpectedResponseType.Yes,
      true,
    ),
  ],
  DM63: [
    ...
    new CpdlcMessageElement('DM63', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.No),
  ],
  DM65: [
    ['DUE TO WEATHER'],
    new CpdlcMessageElement('DM65', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.No),
  ],
  DM66: [
    ['DUE TO AIRCRAFT PERFORMANCE'],
    new CpdlcMessageElement('DM66', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.No),
  ],
  DM67: [
    ['%s'],
    new CpdlcMessageElement(
      'DM67',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentFreetext(0, -1)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM68: [
  ...
  DM69: [
    ['REQUEST VMC DESCEND'],
    new CpdlcMessageElement('DM69', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  DM70: [
    ['REQUEST HEADING %s'],
    new CpdlcMessageElement(
  ...
  DM74: [
    ...
    new CpdlcMessageElement('DM74', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  DM75: [
    ['AT PILOTS DISCRETION'],
    new CpdlcMessageElement('DM75', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  DM76: [
    ['REACHING BLOCK %s TO %s'],
    new CpdlcMessageElement(
      'DM76',
      [FansMode.FansA],
      [new CpdlcMessageContentLevel(2), new CpdlcMessageContentLevel(4)],
  ...
  DM79: [
    ...
    new CpdlcMessageElement(
      'DM79',
      [FansMode.FansA],
      [new CpdlcMessageContentAtis(1)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM80: [
    ['DEVIATING UP TO %s %s OF ROUTE'],
    new CpdlcMessageElement(
      'DM80',
      [FansMode.FansA],
  ...
  DM84: [
    ...
    new CpdlcMessageElement(
      'DM84',
      [FansMode.FansA],
      [new CpdlcMessageContentSpeed(3)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM85: [
    ['WE CAN ACCEPT %s %s AT %s'],
    new CpdlcMessageElement(
      'DM85',
      [FansMode.FansA],
  ...
  DM87: [
    ['WHEN CAN WE EXPECT CLIMB TO %s'],
    new CpdlcMessageElement(
      'DM87',
      [FansMode.FansA],
      [new CpdlcMessageContentLevel(6)],
      CpdlcMessageExpectedResponseType.Yes,
    ),
  ],
  DM88: [
    ['WHEN CAN WE EXPECT DESCEND TO %s'],
    new CpdlcMessageElement(
      'DM88',
      [FansMode.FansA],
      [new CpdlcMessageContentLevel(6)],
  ...
  DM99: [
    ...
    new CpdlcMessageElement('DM99', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.No, true),
  ],
  DM100: [
    ['LOGICAL ACKNOWLEDGEMENT'],
    new CpdlcMessageElement('DM100', [FansMode.FansB], CpdlcMessageExpectedResponseType.No),
  ],
  DM104: [
    ['ETA %s %s'],
    new CpdlcMessageElement(
      'DM104',
      [FansMode.FansA],
      [new CpdlcMessageContentPosition(1), new CpdlcMessageContentTime(2)],
      CpdlcMessageExpectedResponseType.No,
    ),
  ],
  DM106: [
  ...
  DM107: [
    ...
    new CpdlcMessageElement('DM107', [FansMode.FansB], CpdlcMessageExpectedResponseType.No),
  ],
  DM109: [
    ['TOP OF DESCENT %s'],
    new CpdlcMessageElement(
  ...
  DM9998: [
    ['REQUEST LOGON'],
    new CpdlcMessageElement('DM9998', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.Yes),
  ],
  DM9999: [
    ['LOGOFF'],
    new CpdlcMessageElement('DM9999', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.No),
  ],
};
...
export const CpdlcMessagesUplink: { [identification: string]: [string[], CpdlcMessageElement] } = {
  ...
  UM11: [
    ['EXPECT CRUISE CLIMB AT %s'],
    new CpdlcMessageElement(
      'UM11',
      [FansMode.FansA],
      [new CpdlcMessageContentTime(4)],
      CpdlcMessageExpectedResponseType.Roger,
    ),
  ],
  UM12: [
    ...
    new CpdlcMessageElement(
      'UM12',
      [FansMode.FansA],
      [new CpdlcMessageContentPosition(4)],
      CpdlcMessageExpectedResponseType.Roger,
    ),
  ],
  UM19: [
  ...
  UM20: [
    ['CLIMB TO %s', 'CLIMB TO AND MAINTAIN %s'],
    new CpdlcMessageElement(
      'UM20',
      [FansMode.FansA, FansMode.FansB],
  ...
  UM21: [
    ['AT %s CLIMB TO %s', 'AT %s CLIMB TO AND MAINTAIN %s'],
    new CpdlcMessageElement(
      'UM21',
      [FansMode.FansA],
  ...
  UM23: [
    ['DESCEND TO %s', 'DESCEND TO AND MAINTAIN %s'],
    new CpdlcMessageElement(
      'UM23',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentLevel(2, 4)],
  ...
  UM24: [
    ['AT %s DESCEND TO %s', 'AT %s DESCEND TO AND MAINTAIN %s'],
    new CpdlcMessageElement(
      'UM24',
      [FansMode.FansA],
      [new CpdlcMessageContentTime(1, true), new CpdlcMessageContentLevel(4, 6)],
  ...
  UM31: [
    ['CLIMB TO MAINTAIN BLOCK %s TO %s'],
    new CpdlcMessageElement(
      'UM31',
      [FansMode.FansA, FansMode.FansB],
  ...
  UM32: [
    ['DESCEND TO MAINTAIN BLOCK %s TO %s'],
    new CpdlcMessageElement(
      'UM32',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentLevel(4), new CpdlcMessageContentLevel(6)],
  ...
  UM35: [
    ['WHEN ABOVE %s COMMENCE CRUISE CLIMB', 'CRUISE CLIMB ABOVE %s'],
    new CpdlcMessageElement(
      'UM35',
      [FansMode.FansA],
  ...
  UM61: [
    ['CROSS %s AT AND MAINTAIN %s AT %s'],
    new CpdlcMessageElement(
      'UM61',
      [FansMode.FansA, FansMode.FansB],
  ...
  UM62: [
    ['AT %s CROSS %s AT AND MAINTAIN %s'],
    new CpdlcMessageElement(
      'UM62',
      [FansMode.FansA],
  ...
  UM63: [
    ['AT %s CROSS %s AT AND MAINTAIN %s AT %s'],
    new CpdlcMessageElement(
      'UM63',
      [FansMode.FansA],
      [
        new CpdlcMessageContentTime(1),
        new CpdlcMessageContentPosition(3),
        new CpdlcMessageContentLevel(7),
        new CpdlcMessageContentSpeed(9),
      ],
      CpdlcMessageExpectedResponseType.WilcoUnable,
    ),
  ],
  ...
  UM65: [
    ['AT %s OFFSET %s %s OF ROUTE'],
    new CpdlcMessageElement(
      'UM65',
      [FansMode.FansA],
      [
        new CpdlcMessageContentPosition(1, true),
        new CpdlcMessageContentDistance(3),
        new CpdlcMessageContentDirection(4),
      ],
      CpdlcMessageExpectedResponseType.WilcoUnable,
    ),
  ],
  ...
  UM67: [
    ...
    new CpdlcMessageElement('UM67', [FansMode.FansA], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM68: [
    ['REJOIN ROUTE BY %s'],
    new CpdlcMessageElement(
  ...
  UM70: [
    ['EXPECT BACK ON ROUTE BY %s'],
    new CpdlcMessageElement(
      'UM70',
      [FansMode.FansA],
      [new CpdlcMessageContentPosition(5)],
      CpdlcMessageExpectedResponseType.WilcoUnable,
    ),
  ],
  UM71: [
    ...
    new CpdlcMessageElement(
      'UM71',
      [FansMode.FansA],
      [new CpdlcMessageContentTime(5)],
      CpdlcMessageExpectedResponseType.WilcoUnable,
    ),
  ],
  UM72: [
    ['RESUME OWN NAVIGATION'],
    new CpdlcMessageElement('UM72', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  ...
  UM82: [
    ['CLEARED TO DEVIATE UP TO %s %s OF ROUTE'],
    new CpdlcMessageElement(
      'UM82',
      [FansMode.FansA, FansMode.FansB],
  ...
  UM91: [
    [
      'HOLD AT %s MAINTAIN %s INBOUND TRACK %s %s TURNS %s',
      'HOLD AT %s MAINTAIN %s INBOUND TRACK %s %s TURN LEG TIME %s',
    ],
    new CpdlcMessageElement(
      'UM91',
      [FansMode.FansA],
      [
        new CpdlcMessageContentPosition(2),
        new CpdlcMessageContentLevel(4),
        new CpdlcMessageContentDegree(7),
        new CpdlcMessageContentDirection(8),
        new CpdlcMessageContentLegType(12),
      ],
      CpdlcMessageExpectedResponseType.WilcoUnable,
    ),
  ],
  UM92: [
    ['HOLD AT %s AS PUBLISHED MAINTAIN %s'],
    new CpdlcMessageElement(
      'UM92',
      [FansMode.FansA, FansMode.FansB],
  ...
  UM96: [
    ['CONTINUE PRESENT HEADING', 'FLY PRESENT HEADING'],
    new CpdlcMessageElement('UM96', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM97: [
    ['AT %s FLY HEADING %s'],
    new CpdlcMessageElement(
  ...
  UM100: [
    ...
    new CpdlcMessageElement(
      'UM100',
      [FansMode.FansA],
      [new CpdlcMessageContentTime(1), new CpdlcMessageContentSpeed(3)],
      CpdlcMessageExpectedResponseType.Roger,
    ),
  ],
  UM101: [
  ...
  UM107: [
    ...
    new CpdlcMessageElement('UM107', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM108: [
    ['MAINTAIN %s OR GREATER'],
    new CpdlcMessageElement(
      'UM108',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentSpeed(1)],
  ...
  UM112: [
    ['INCREASE SPEED TO %s OR GREATER'],
    new CpdlcMessageElement(
      'UM112',
      [FansMode.FansA],
      [new CpdlcMessageContentSpeed(3)],
  ...
  UM116: [
    ['RESUME NORMAL SPEED'],
    new CpdlcMessageElement('UM116', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM117: [
    ['CONTACT %s %s'],
    new CpdlcMessageElement(
  ...
  UM118: [
    ...
    new CpdlcMessageElement(
      ...
      [
        new CpdlcMessageContentPosition(1, true),
        new CpdlcMessageContentAtcUnit(3),
        new CpdlcMessageContentFrequency(4),
      ],
      CpdlcMessageExpectedResponseType.WilcoUnable,
    ),
  ],
  ...
  UM124: [
    ['STOP SQUAWK'],
    new CpdlcMessageElement('UM124', [FansMode.FansA], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM125: [
    ['SQUAWK MODE CHARLIE', 'SQUAWK ALTITUDE'],
    new CpdlcMessageElement('UM125', [FansMode.FansA], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM126: [
    ['STOP SQUAWK MODE CHARLIE', 'STOP SQUAWK ALTITUDE'],
    new CpdlcMessageElement('UM126', [FansMode.FansA], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM127: [
    ['REPORT BACK ON ROUTE'],
    new CpdlcMessageElement('UM127', [FansMode.FansA], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM128: [
    ['REPORT LEAVING %s'],
    new CpdlcMessageElement(
  ...
  UM129: [
    ['REPORT MAINTAINING %s', 'REPORT LEVEL %s'],
    new CpdlcMessageElement(
      'UM129',
      [FansMode.FansA],
      [new CpdlcMessageContentLevel(2, true)],
  ...
  UM130: [
    ...
    new CpdlcMessageElement(
      'UM130',
      [FansMode.FansA],
      [new CpdlcMessageContentPosition(2, true)],
      CpdlcMessageExpectedResponseType.WilcoUnable,
    ),
  ],
  UM131: [
    ['REPORT REMAINING FUEL AND PERSONS ON BOARD', 'REPORT REMAINING FUEL AND SOULS ON BOARD'],
    new CpdlcMessageElement('UM131', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes, true),
  ],
  UM132: [
    ['REPORT POSITION', 'CONFIRM POSITION'],
    new CpdlcMessageElement('UM132', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM133: [
    ['REPORT PRESENT LEVEL'],
    new CpdlcMessageElement('UM133', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM134: [
    ['REPORT SPEED', 'CONFIRM SPEED'],
    new CpdlcMessageElement('UM134', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM135: [
    ['CONFIRM ASSIGNED LEVEL'],
    new CpdlcMessageElement('UM135', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM136: [
    ['CONFIRM ASSIGNED SPEED'],
    new CpdlcMessageElement('UM136', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM137: [
    ['CONFIRM ASSIGNED ROUTE'],
    new CpdlcMessageElement('UM137', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM138: [
    ['CONFIRM TIME OVER REPORTED WAYPOINT'],
    new CpdlcMessageElement('UM138', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM139: [
    ['CONFIRM REPORTED WAYPOINT'],
    new CpdlcMessageElement('UM139', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM140: [
    ['CONFIRM NEXT WAYPOINT'],
    new CpdlcMessageElement('UM140', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM141: [
    ['CONFIRM NEXT WAYPOINT ETA'],
    new CpdlcMessageElement('UM141', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM142: [
    ['CONFIRM ENSUING WAYPOINT'],
    new CpdlcMessageElement('UM142', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM143: [
    ['CONFIRM REQUEST'],
    new CpdlcMessageElement('UM143', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM144: [['CONFIRM SQUAWK'], new CpdlcMessageElement('UM144', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes)],
  UM145: [
    ['REPORT HEADING', 'CONFIRM HEADING'],
    new CpdlcMessageElement('UM145', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM146: [
    ['REPORT GROUND TRACK', 'CONFIRM GROUND TRACK'],
    new CpdlcMessageElement('UM146', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM147: [
    ['REQUEST POSITION REPORT'],
    new CpdlcMessageElement('UM147', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM148: [
    ['WHEN CAN YOU ACCEPT %s'],
    new CpdlcMessageElement(
      'UM148',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentLevel(4)],
  ...
  UM152: [
    ['WHEN CAN YOU ACCEPT %s %s OFFSET'],
    new CpdlcMessageElement(
      'UM152',
      [FansMode.FansA],
  ...
  UM153: [
    ...
    new CpdlcMessageElement(
      'UM153',
      [FansMode.FansA],
      [new CpdlcMessageContentAltimeter(1)],
      CpdlcMessageExpectedResponseType.Roger,
    ),
  ],
  UM154: [
    ['RADAR SERVICE TERMINATED', 'RADAR SERVICES TERMINATED'],
    new CpdlcMessageElement('UM154', [FansMode.FansA], CpdlcMessageExpectedResponseType.Roger),
  ],
  UM155: [
    ['RADAR CONTACT %s'],
    new CpdlcMessageElement(
  ...
  UM156: [
    ['RADAR CONTACT LOST'],
    new CpdlcMessageElement('UM156', [FansMode.FansA], CpdlcMessageExpectedResponseType.Roger),
  ],
  UM157: [
    ['CHECK STUCK MICROPHONE %s'],
    new CpdlcMessageElement(
      'UM157',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentFrequency(3)],
  ...
  UM161: [
    ['END SERVICE'],
    new CpdlcMessageElement('UM161', [FansMode.FansA], CpdlcMessageExpectedResponseType.NotRequired),
  ],
  UM162: [
    ['MESSAGE NOT SUPPORTED BY THIS ATS UNIT', 'SERVICE UNAVAILABLE'],
    new CpdlcMessageElement('UM162', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.NotRequired),
  ],
  ...
  UM176: [
    ...
    new CpdlcMessageElement('UM176', [FansMode.FansA], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM177: [
    ['AT PILOTS DISCRETION'],
    new CpdlcMessageElement('UM177', [FansMode.FansA], CpdlcMessageExpectedResponseType.No),
  ],
  UM179: [
    ['SQUAWK IDENT'],
    new CpdlcMessageElement('UM179', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.WilcoUnable),
  ],
  UM180: [
    ['REPORT REACHING BLOCK %s TO %s'],
    new CpdlcMessageElement(
      'UM180',
      [FansMode.FansA],
  ...
  UM181: [
    ['REPORT DISTANCE TO %s', 'REPORT DISTANCE FROM %s'],
    new CpdlcMessageElement(
      'UM181',
      [FansMode.FansA],
      [new CpdlcMessageContentPosition(3)],
  ...
  UM182: [
    ['CONFIRM ATIS CODE'],
    new CpdlcMessageElement('UM182', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM183: [
    ['%s'],
    new CpdlcMessageElement(
  ...
  UM184: [
    ['AT TIME %s REPORT DISTANCE TO %s', 'AT TIME %s REPORT DISTANCE FROM %s'],
    new CpdlcMessageElement(
      'UM184',
      [FansMode.FansA],
  ...
  UM222: [
    ...
    new CpdlcMessageElement('UM222', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.Roger),
  ],
  UM227: [
    ['LOGICAL ACKNOWLEDGEMENT'],
    new CpdlcMessageElement('UM227', [FansMode.FansB], CpdlcMessageExpectedResponseType.Roger),
  ],
  UM228: [
    ['REPORT ETA %s'],
    new CpdlcMessageElement(
  ...
  UM231: [
    ...
    new CpdlcMessageElement('UM231', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM232: [
    ['STATE TOP OF DESCENT'],
    new CpdlcMessageElement('UM232', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.Yes),
  ],
  UM242: [
    ['TRANSMIT ADS-B IDENT'],
    new CpdlcMessageElement('UM242', [FansMode.FansA], CpdlcMessageExpectedResponseType.Roger),
  ],
  UM244: [
    ['IDENTIFICATION TERMINATED'],
    new CpdlcMessageElement('UM244', [FansMode.FansA], CpdlcMessageExpectedResponseType.Roger),
  ],
  UM9995: [
    ['LOGOFF'],
    new CpdlcMessageElement('UM9995', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.NotRequired),
  ],
  UM9996: [
    ['UNABLE %s'],
    new CpdlcMessageElement(
  ...
  UM9997: [
    ['LOGON ACCEPTED'],
    new CpdlcMessageElement('UM9997', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.NotRequired),
  ],
  UM9998: [
    ['HANDOVER %s'],
    new CpdlcMessageElement(
      'UM9998',
      [FansMode.FansA, FansMode.FansB],
      [new CpdlcMessageContentAtcUnit(1)],
      CpdlcMessageExpectedResponseType.NotRequired,
    ),
  ],
  UM9999: [
