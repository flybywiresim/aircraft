...
export class NXApi {
    ...
    static updateTelex() {
        ...
        const updateBody = NXApi.buildTelexBody(null);
        const headers = {
            'Content-Type': 'application/json',
            'Authorization': NXApi.buildToken(null),
        };
    ...
    static getTelexMessages() {
        ...
        const headers = { Authorization: NXApi.buildToken(null) };
    ...
    static buildToken(tokenOverride: string) {
        return `Bearer ${tokenOverride !== null ? tokenOverride : NXApi.accessToken}`;
    }

    static buildTelexBody(flightNo: string) {
