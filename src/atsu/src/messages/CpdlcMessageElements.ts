...
export const CpdlcMessagesDownlink: { [identification: string]: [string[], CpdlcMessageElement] } = {
    ...
    DM32: [['PRESENT LEVEL %s', 'PRESENT ALTITUDE %s'], new CpdlcMessageElement('DM32', [FansMode.FansA, FansMode.FansB], [new CpdlcMessageContentLevel(2)],
    ...
    DM38: [['ASSIGNED LEVEL %s', 'ASSIGNED ALTITUDE %s'], new CpdlcMessageElement('DM38', [FansMode.FansA, FansMode.FansB], [new CpdlcMessageContentLevel(2)],
        CpdlcMessageExpectedResponseType.No)],
    ...
    DM48: [['POSITION REPORT OVHD %s AT %s/%s PPOS:%s AT %s/%s ACTIVE %s AT %s NEXT %s %s'], new CpdlcMessageElement('DM48', [FansMode.FansA],
        [new CpdlcMessageContentPosition(3), new CpdlcMessageContentTime(5), new CpdlcMessageContentLevel(5), new CpdlcMessageContentPosition(7),
            new CpdlcMessageContentTime(9), new CpdlcMessageContentLevel(9), new CpdlcMessageContentPosition(11), new CpdlcMessageContentTime(13),
            new CpdlcMessageContentPosition(15), new CpdlcMessageContentFreetext(16, -1)], CpdlcMessageExpectedResponseType.No)],
...
export const CpdlcMessagesUplink: { [identification: string]: [string[], CpdlcMessageElement] } = {
    ...
    UM36: [['EXPEDITE CLIMB TO %s'], new CpdlcMessageElement('UM36', [FansMode.FansA], [new CpdlcMessageContentLevel(3)], CpdlcMessageExpectedResponseType.WilcoUnable)],
    UM37: [['EXPEDITE DESCENT TO %s'], new CpdlcMessageElement('UM37', [FansMode.FansA], [new CpdlcMessageContentLevel(3)], CpdlcMessageExpectedResponseType.WilcoUnable)],
    ...
    UM133: [['REPORT PRESENT LEVEL', 'CONFIRM ALTITUDE'], new CpdlcMessageElement('UM133', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes)],
    UM134: [['REPORT SPEED', 'CONFIRM SPEED'], new CpdlcMessageElement('UM134', [FansMode.FansA], CpdlcMessageExpectedResponseType.Yes)],
    UM135: [['CONFIRM ASSIGNED LEVEL', 'CONFIRM ASSIGNED ALTITUDE'], new CpdlcMessageElement('UM135', [FansMode.FansA, FansMode.FansB], CpdlcMessageExpectedResponseType.Yes)],
