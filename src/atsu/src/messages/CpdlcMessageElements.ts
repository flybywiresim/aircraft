...
export const CpdlcMessagesDownlink: { [identification: string]: [string[], CpdlcMessageElement] } = {
    ...
    DM13: [['AT %s REQUEST CLIMB TO %s'], new CpdlcMessageElement('DM11', [FansMode.FansA], [new CpdlcMessageContentTime(1), new CpdlcMessageContentLevel(5)]), CpdlcMessageExpectedResponseType.Yes],
    DM14: [['AT %s REQUEST DESCEND TO %s'], new CpdlcMessageElement('DM12', [FansMode.FansA], [new CpdlcMessageContentTime(1), new CpdlcMessageContentLevel(5)], CpdlcMessageExpectedResponseType.Yes)],
    ...
    DM50: [['WHEN CAN WE EXCEPT %s TO %s'], new CpdlcMessageElement('DM50', [FansMode.FansA], [new CpdlcMessageContentSpeed(4), new CpdlcMessageContentSpeed(6)], CpdlcMessageExpectedResponseType.Yes)],
