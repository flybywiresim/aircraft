...
impl A320SimulatorReadWriter {
    pub fn new() -> Result<Self, Box<dyn std::error::Error>> {
        Ok(A320SimulatorReadWriter {
            ...
            apu_bleed_fault: NamedVariable::from("A32NX_OVHD_PNEU_APU_BLEED_PB_HAS_FAULT"),
            apu_bleed_sw_on: NamedVariable::from("A32NX_OVHD_PNEU_APU_BLEED_PB_IS_ON"),
            ...
            apu_fire_button_released: NamedVariable::from("A32NX_APU_FIRE_BUTTON_RELEASED"),
            ...
            apu_gen_frequency: NamedVariable::from("A32NX_ELEC_APU_GEN_1_FREQUENCY"),
            apu_gen_frequency_within_normal_range: NamedVariable::from("A32NX_ELEC_APU_GEN_1_FREQUENCY_NORMAL"),
            apu_gen_sw_on: AircraftVariable::from("APU GENERATOR SWITCH", "Bool", 0)?,
            apu_gen_voltage: NamedVariable::from("A32NX_ELEC_APU_GEN_1_POTENTIAL"),
            ...
            apu_master_sw: NamedVariable::from("A32NX_OVHD_APU_MASTER_SW_PB_IS_ON"),
            apu_master_sw_fault: NamedVariable::from("A32NX_OVHD_APU_MASTER_SW_PB_HAS_FAULT"),
            apu_n: NamedVariable::from("A32NX_APU_N"),
            apu_start_contactor_energized: NamedVariable::from(
                "A32NX_APU_START_CONTACTOR_ENERGIZED",
            ),
            apu_start_sw_available: NamedVariable::from("A32NX_OVHD_APU_START_PB_IS_AVAILABLE"),
            apu_start_sw_on: NamedVariable::from("A32NX_OVHD_APU_START_PB_IS_ON"),
