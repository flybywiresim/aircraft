...
impl A320SimulatorReadWriter {
    pub fn new() -> Result<Self, Box<dyn std::error::Error>> {
        Ok(A320SimulatorReadWriter {
            ...
            apu_bleed_fault: NamedVariable::from("A32NX_APU_BLEED_PB_FAULT"),
            apu_bleed_sw_on: NamedVariable::from("A32NX_APU_BLEED_PB_ON"),
            ...
            apu_master_sw: NamedVariable::from("A32NX_APU_MASTER_SW_PB_ON"),
            apu_master_sw_fault: NamedVariable::from("A32NX_APU_MASTER_SW_PB_FAULT"),
            ...
            apu_start_sw_on: NamedVariable::from("A32NX_APU_START_PB_ON"),
