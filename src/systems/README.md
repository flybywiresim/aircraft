...
3. Run `cargo build --target wasm32-wasi` in the console at the top-level of the a32nx repository. Make sure to have downloaded the `Samples` folder of the SDK (needed to be downloaded separately from the core) in order to build `msfs-rs`.
