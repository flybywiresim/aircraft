...
struct A320SimulatorReaderWriter {
    ...
    turb_eng_n2_1: AircraftVariable,
    turb_eng_n2_2: AircraftVariable,
...
impl A320SimulatorReaderWriter {
    fn new() -> Result<Self, Box<dyn std::error::Error>> {
        Ok(A320SimulatorReaderWriter {
            ...
            turb_eng_n2_1: AircraftVariable::from("TURB ENG N2", "Percent", 1)?,
            turb_eng_n2_2: AircraftVariable::from("TURB ENG N2", "Percent", 2)?,
...
impl SimulatorReaderWriter for A320SimulatorReaderWriter {
    fn read(&mut self, name: &str) -> f64 {
        match name {
            ...
            "TURB ENG N2:1" => self.turb_eng_n2_1.get(),
            "TURB ENG N2:2" => self.turb_eng_n2_2.get(),
