...
pub(super) struct A320FwcAcquisition {
    ...
    dmc_1_discrete_status_word: Arinc429Acquisition<u32>,
    dmc_2_discrete_status_word: Arinc429Acquisition<u32>,
}
...
impl Default for A320FwcAcquisition {
    fn default() -> Self {
        Self {
            ...
            dmc_1_discrete_status_word: Arinc429Acquisition::new(Duration::from_millis(60)),
            dmc_2_discrete_status_word: Arinc429Acquisition::new(Duration::from_millis(60)),
        }
    }
}
...
impl A320FwcAcquisition {
    pub fn acquire(&mut self) -> A320FwcParameterTable {
        A320FwcParameterTable {
            ...
            hundred_above_for_mda_mdh_request_1: self.dmc_1_discrete_status_word.read_bit(20),
            hundred_above_for_mda_mdh_request_2: self.dmc_2_discrete_status_word.read_bit(20),
            minimum_for_mda_mdh_request_1: self.dmc_1_discrete_status_word.read_bit(21),
            minimum_for_mda_mdh_request_2: self.dmc_2_discrete_status_word.read_bit(21),
    ...
    fn receive_arinc429(&mut self, inputs: &A320FwcInputs) {
        ...
        self.dmc_1_discrete_status_word
            .receive(inputs.dmc_1_discrete_status_word());
        self.dmc_2_discrete_status_word
            .receive(inputs.dmc_2_discrete_status_word());
    }
}
