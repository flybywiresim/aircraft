...
class A380LateralNormalLaw final
{
 public:
  ...
  struct D_Work_A380LateralNormalLaw_T {
    ...
    rtDW_RateLimiter_A380LateralNormalLaw_T sf_RateLimiter_h;
    rtDW_RateLimiter_A380LateralNormalLaw_T sf_RateLimiter_ie;
    rtDW_RateLimiter_A380LateralNormalLaw_T sf_RateLimiter_f;
  ...
  struct rtC_A380LateralNormalLaw_T {
  ...
  struct Parameters_A380LateralNormalLaw_T {
    ...
    real_T ScheduledGain_BreakpointsForDimension1_h[9];
    real_T ScheduledGain1_BreakpointsForDimension1_n[5];
    ...
    real_T RateLimiterVariableTs2_InitialCondition_k;
    ...
    real_T ScheduledGain_Table_l[9];
    real_T ScheduledGain1_Table_k[5];
    ...
    real_T Saturation_UpperSat_eh;
    real_T Saturation_LowerSat_i;
    real_T Gain1_Gain_i;
    real_T Constant_Value_kl;
  ...
  void step(const real_T *rtu_In_time_dt, const real_T *rtu_In_Theta_deg, const real_T *rtu_In_Phi_deg, const real_T
            *rtu_In_r_deg_s, const real_T *rtu_In_pk_deg_s, const real_T *rtu_In_V_ias_kn, const real_T *rtu_In_V_tas_kn,
            const real_T *rtu_In_delta_xi_pos, const real_T *rtu_In_delta_zeta_pos, const boolean_T *rtu_In_on_ground,
            const boolean_T *rtu_In_tracking_mode_on, const boolean_T *rtu_In_high_aoa_prot_active, const boolean_T
            *rtu_In_high_speed_prot_active, const real_T *rtu_In_ap_phi_c_deg, const real_T *rtu_In_ap_beta_c_deg, const
...
extern const A380LateralNormalLaw::rtC_A380LateralNormalLaw_T A380LateralNormalLaw_ConstB;
