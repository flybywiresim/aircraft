import { NXUnits } from '@fmgc/utils/NXUnits';
...
export class A32NX_Refuel {
    ...
    update(_deltaTime) {
        ...
        const RInnCurrentSimVar = SimVar.GetSimVarValue('FUEL TANK RIGHT MAIN QUANTITY', 'Gallons');
        const ROutCurrentSimVar = SimVar.GetSimVarValue('FUEL TANK RIGHT AUX QUANTITY', 'Gallons');
        let centerCurrent = centerCurrentSimVar as any;
        let LInnCurrent = LInnCurrentSimVar as any;
        let LOutCurrent = LOutCurrentSimVar as any;
        let RInnCurrent = RInnCurrentSimVar as any;
        let ROutCurrent = ROutCurrentSimVar as any;
