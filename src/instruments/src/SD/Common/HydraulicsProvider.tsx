...
export const HydraulicsProvider: React.FC = ({ children }) => {
    const [greenPress] = useSimVar('L:A32NX_HYD_GREEN_SYSTEM1_SECTION_PRESSURE', 'number', 1000);
    const [yellowPress] = useSimVar('L:A32NX_HYD_YELLOW_SYSTEM1_SECTION_PRESSURE', 'number', 1000);
    const [bluePress] = useSimVar('L:A32NX_HYD_BLUE_SYSTEM1_SECTION_PRESSURE', 'number', 1000);
