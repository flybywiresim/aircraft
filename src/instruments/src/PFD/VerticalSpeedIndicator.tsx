...
export const VerticalSpeedIndicator = memo(({ radioAlt, verticalSpeed }: VerticalSpeedIndicatorProps) => {
    console.log(`Root -> VerticalSpeedIndicator: render: ${radioAlt}, ${verticalSpeed}`);

    const absVSpeed = Math.abs(verticalSpeed);

    let isAmber = false;
    if (absVSpeed > 6000 || (radioAlt < 2500 && radioAlt > 1000 && verticalSpeed < -2000) || (radioAlt < 1000 && verticalSpeed < -1200)) {
        isAmber = true;
    }
...
export const VerticalSpeedIndicatorFixed = memo(() => (
    <>
...
export const VerticalSpeedIndicatorFail = memo(() => (
    <>
        <path className="TapeBackground" d="m151.84 131.72 4.1301-15.623v-70.556l-4.1301-15.623h-5.5404v101.8z" />
        <g id="VSpeedFailText">
