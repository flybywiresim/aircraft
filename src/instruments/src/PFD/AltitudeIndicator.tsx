        ...
        return (
            ...
            <>
                ...
                <g ref={this.tcasFailed} style="display: none">
                    <text class="Blink9Seconds FontLarge Amber EndAlign" x="141.5" y="100">T</text>
                    <text class="Blink9Seconds FontLarge Amber EndAlign" x="141.5" y="105.5">C</text>
                    <text class="Blink9Seconds FontLarge Amber EndAlign" x="141.5" y="110.75">A</text>
                    <text class="Blink9Seconds FontLarge Amber EndAlign" x="141.5" y="116">S</text>
                </g>
