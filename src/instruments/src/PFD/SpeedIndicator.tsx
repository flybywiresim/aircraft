    ...
    render(): VNode {
        return (
            <g ref={this.entireComponentRef} id="SpeedMargins" style="display: none;">
                <path ref={this.upperSpeedMarginRef} id="UpperSpeedMargin" class="Fill Magenta" d="m19.7 81.895 h 5.3577 v 0.7 h-5.3577 z" />
                <path ref={this.lowerSpeedMarginRef} id="LowerSpeedMargin" class="Fill Magenta" d="m19.7 81.895 h 5.3577 v 0.7 h-5.3577 z" />
            </g>
        );
    }
