...
export const SelectItem: React.FC<SelectItemProps> = (props) => (
    <span
        ...
        className={`${props.classNames} text-lg font-medium ${props.selected ? 'bg-blue-light-contrast text-blue-darkest' : 'text-white'} hover:bg-blue-light-contrast py-2 px-3.5 rounded-lg`}
    >
        {props.children}
    </span>
);
