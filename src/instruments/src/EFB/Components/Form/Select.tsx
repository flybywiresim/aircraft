...
export const SelectItem: React.FC<SelectItemProps> = (props) => (
    <span
        ...
        className={`${props.classNames} text-lg font-medium
    ${props.selected ? 'bg-blue-light-contrast text-blue-darkest' : 'text-white'} py-2 px-3.5 rounded-lg cursor-pointer`}
    >
        {props.children}
    </span>
);
...
export const VerticalSelectGroup: React.FC = (props) => (
    <div className="bg-blue-dark flex flex-col justify-between rounded-lg">
        {props.children}
    </div>
);
