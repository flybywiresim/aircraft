...
const createOrchestrator = () => new FailuresOrchestrator('A32NX', [
    ...
    [A320Failure.Elac1Failure, 'ELAC 1'],
    [A320Failure.Elac2Failure, 'ELAC 2'],
    [A320Failure.Sec1Failure, 'SEC 1'],
    [A320Failure.Sec2Failure, 'SEC 2'],
    [A320Failure.Sec3Failure, 'SEC 3'],
    [A320Failure.Fac1Failure, 'FAC 1'],
    [A320Failure.Fac2Failure, 'FAC 2'],
    [A320Failure.Fcdc1Failure, 'FCDC 1'],
    [A320Failure.Fcdc2Failure, 'FCDC 2'],
    ...
    [A320Failure.LgciuPowerSupply1, 'LGCIU 1 Power supply'],
    ...
    [A320Failure.GearProxSensorDamageGearUplockNose1, 'Proximity Sensor Uplock Damage Center Gear #1'],
