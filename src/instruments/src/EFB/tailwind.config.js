...
module.exports = {
    ...
    theme: {
        ...
        fontFamily: {
            mono: ['JetBrains Mono'],
            body: ['Inter', 'NotoSansKR', 'NotoSansJP', 'NotoSansSC', 'NotoSansArabic', 'NotoSansThai', 'NotoSansHebrew'],
            title: ['Manrope', 'NotoSansKR', 'NotoSansJP', 'NotoSansSC', 'NotoSansArabic', 'NotoSansThai', 'NotoSansHebrew'],
            rmp: ['AirbusRMP'],
        },
    },
