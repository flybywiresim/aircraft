                    ...
                    <div className="grid grid-cols-4 auto-rows-auto">
                        {sortedCharts.map((pinnedChart, index) => (
                            <div className={`${index && index % 4 !== 0 && 'ml-4'} ${index >= 4 && 'mt-4'} flex flex-col`}>
                                {editMode && (
                                    <div
                                        className="py-3 w-full text-center hover:text-red-500 bg-red-500 rounded-t-md border-2 border-red-500 transition duration-100 text-theme-body hover:bg-theme-body"
                                        onClick={() => {
