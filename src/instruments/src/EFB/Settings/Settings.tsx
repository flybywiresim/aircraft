...
import { DiagnosticsPage } from './Diagnostic/DiagnosticsPage';
                ...
                !showDiagnostics
                    ? (
                        <div className="bg-navy-lighter rounded-xl px-6 shadow-lg divide-y divide-gray-700 flex flex-col">
                            ...
                            <div className="py-4 flex flex-row justify-between items-center">
                                <span className="text-lg text-gray-300">Diagnostic Page</span>
                                <div className="flex flex-row items-center py-1.5">
                                    <Button className="bg-teal-light-contrast border-teal-light-contrast" text="Open" onClick={() => setShowDiagnostics(true)} />
                                </div>
                            </div>
                        </div>
                    )
                    : <DiagnosticsPage isShown={showDiagnostics} onClose={() => setShowDiagnostics(false)} />
            }
        </>
    );
};
