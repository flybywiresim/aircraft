                ...
                { parseInt(dualAxis) !== 0
                    ...
                    && (
                        ...
                        <div className="flex flex-row justify-center">
                            ...
                            <BaseThrottleConfig disabled={false} throttleNumber={1} throttleCount={parseInt(dualAxis) === 0 ? 2 : 1} activeIndex={selectedIndex} />

                            <div className="w-8" />
                            <BaseThrottleConfig disabled={parseInt(dualAxis) === 0} throttleNumber={2} throttleCount={1} activeIndex={selectedIndex} />

                            <div className="h-100 flex flex-row ml-12">
                ...
                {/*  { parseInt(dualAxis) === 0
                    && (
                        <div className="flex flex-row justify-center">
                            ...
                            <BaseThrottleConfig disabled throttleNumber={1} throttleCount={2} activeIndex={selectedIndex} />
                            <div className="h-100 flex flex-row ml-12">
