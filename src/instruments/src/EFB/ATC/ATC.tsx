        ...
        <div>
            ...
            { (atisSource === 'IVAO' || atisSource === 'VATSIM') ? (
                <div className="w-full h-efb">
                    ...
                    <div className="flex flex-row mt-8 h-96 rounded-lg border border-theme-accent divide-x divide-theme-accent">
                        <div className="flex flex-col justify-between p-6">
                            <div>
                                <p>Active</p>
                                <div className="flex justify-center items-center mt-4 w-72 h-24 font-rmp text-6xl text-theme-highlight rounded-lg border border-theme-accent">
                                    {displayedActiveFrequency && displayedActiveFrequency}
                                </div>
                            </div>
                            <div>
                                <p>Standby</p>
                                <div className="flex justify-center items-center mt-4 w-72 h-24 font-rmp text-6xl text-yellow-500 rounded-lg border border-theme-accent">
                ...
                <div className="flex flex-col justify-center items-center mt-4 space-y-8 w-full h-efb rounded-lg border-2 border-theme-accent shadow-md">
                    ...
                    <Link
                        ...
                        className="flex justify-center items-center py-2 px-16 space-x-4 bg-theme-highlight rounded-lg border-2 border-theme-secondary focus:outline-none"
                    >
                        <Gear size={26} />
