...
export const securingAircraftChecklist = {
    ...
    items: [
        ...
        },
        {
            ...
            result: 'OFF',
            condition: () => {
                const [v1] = useSimVar('L:A32NX_OXYGEN_PASSENGER_LIGHT_ON', 'Number');
                return v1 === 0;
            },
        },
        {
        ...
        },
        {
            ...
            result: 'OFF',
            condition: () => {
                const [v1] = useSimVar('L:XMLVAR_SWITCH_OVHD_INTLT_EMEREXIT_POSITION', 'Number');
                return v1 === 2;
            },
        },
        {
        ...
        },
        {
            ...
            result: 'OFF',
            condition: () => {
                const [v1] = useSimVar('L:A32NX_OVHD_APU_MASTER_SW_PB_IS_ON', 'Number');
                const [v2] = useSimVar('L:A32NX_OVHD_ELEC_BAT_1_PB_IS_AUTO', 'Number');
                const [v3] = useSimVar('L:A32NX_OVHD_ELEC_BAT_2_PB_IS_AUTO', 'Number');
                return v1 === 0 && v2 === 0 && v3 === 0;
            },
        },
    ],
