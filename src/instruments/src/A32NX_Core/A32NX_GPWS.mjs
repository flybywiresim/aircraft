...
import { soundList } from './A32NX_SoundManager.mjs';
...
export default class A32NX_GPWS {
    constructor(_core) {
    ...
    UpdateAltState(radioAlt) {
        ...
        case 'overRetard':
            ...
            break;
        case 'retardPlaying':
            if (SimVar.GetSimVarValue('GENERAL ENG THROTTLE LEVER POSITION:1', 'Percent over 100') <= 0.05
                || SimVar.GetSimVarValue('GENERAL ENG THROTTLE LEVER POSITION:2', 'Percent over 100') <= 0.05) {
