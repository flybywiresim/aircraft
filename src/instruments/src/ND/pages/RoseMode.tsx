...
export const RoseMode: FC<RoseModeProps> = ({ symbols, adirsAlign, rangeSetting, mode, side, ppos, mapHidden, weatherEnabled }) => {
    ...
    if (adirsAlign) {
        return (
            <>
                {weatherEnabled && (
                    <text x={678} y={618} fontSize={23} className="Green">
                        {'    WX'}
