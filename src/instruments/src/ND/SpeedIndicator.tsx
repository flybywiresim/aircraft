...
export const SpeedIndicator: FC<AdirsTasDrivenIndicatorProps> = ({ adirsState, tas }) => {
    ...
    return (
        <Layer x={2} y={24}>
            ...
            <text x={74} y={0} fontSize={25} textAnchor="end" className="Green">
                {(adirsState === 2) ? (
            ...
            <text x={82} y={0} fontSize={20} className="White">TAS</text>
            <text x={181} y={0} fontSize={25} textAnchor="end" className="Green">
                {(adirsState === 2 && tas >= 60) ? (
