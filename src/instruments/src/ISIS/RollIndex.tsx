...
const SideslipIndicator: React.FC = () => {
    ...
    return (
        <path id="SideSlipIndicator" className="StrokeWhite FillBackground" strokeWidth={3} transform={`translate(${sideslipIndicatorIndexOffset} 0)`} d="M 244 138 h24 l 5 9 h -34 z" />
    );
};
...
export const RollIndex: React.FC = () => (
    <g id="RollIndex">
        ...
        <path className="StrokeWhite FillBackground" strokeWidth={3} d="M256 118 l10 18 h-20z" />
        <SideslipIndicator />
    </g>
);
