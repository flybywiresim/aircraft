...
class VSpeedTcas extends DisplayComponent<VSpeedTcasProps> {
    ...
    public update(state: TcasState) {
        if (state.tcasState !== 2) {
            this.tcasGroup.instance.classList.add('HideLocDiamond');
            this.nonCorrective.instance.classList.add('HideLocDiamond');
        } else if (state.isTcasCorrective) {
            this.tcasGroup.instance.classList.remove('HideLocDiamond');
            this.background.instance.classList.remove('HideLocDiamond');
            ...
            this.background.instance.classList.add('HideLocDiamond');
            this.nonCorrective.instance.classList.add('HideLocDiamond');
