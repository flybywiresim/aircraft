...
OUTPUT_A32NX="${DIR}/../../flybywire-aircraft-a320-neo/SimObjects/AirPlanes/FlyByWire_A320_NEO/panel/fadec.wasm"
OUTPUT_A380="${DIR}/../../flybywire-aircraft-a380-841/SimObjects/AirPlanes/fbw_a380X/panel/fadec.wasm"
...
clang++ \
  ...
  -I "${MSFS_SDK}/SimConnect SDK/include" \
  -I "${DIR}/../fbw/src/inih" \
  "${DIR}/a380_fadec/src/FadecGauge.cpp"
