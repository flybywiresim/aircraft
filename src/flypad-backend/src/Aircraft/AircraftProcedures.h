...
static vector<ProcedureStep*>* TAXI_CONFIG_ON = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"Autobrake Max",        308, false, 2000,  "(L:A32NX_AUTOBRAKES_ARMED_MODE) 3 ==",             "3 (>L:A32NX_AUTOBRAKES_ARMED_MODE_SET)"},
...
static vector<ProcedureStep*>* TAXI_CONFIG_OFF = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"Autobrake Off",         318, false, 2000, "(L:A32NX_AUTOBRAKES_ARMED_MODE) 0 ==", "0 (>L:A32NX_AUTOBRAKES_ARMED_MODE_SET)"},
