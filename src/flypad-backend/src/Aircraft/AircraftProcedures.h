...
static vector<ProcedureStep*>* TURNAROUND_CONFIG_ON = new vector<ProcedureStep*>{
  new ProcedureStep {"BAT1 On",                  1010, false, 100,  "(L:A32NX_OVHD_ELEC_BAT_1_PB_IS_AUTO)",                  "1 (>L:A32NX_OVHD_ELEC_BAT_1_PB_IS_AUTO)"},
  ...
  new ProcedureStep {"APU Master On",            1040, false, 3000, "(L:A32NX_ENGINE_STATE:1) 1 == "
                                                                    "(L:A32NX_ENGINE_STATE:2) 1 == && "
  ...
  new ProcedureStep {"AC BUS Avail Check",       1060, true,  2000, "",                                                      "(L:A32NX_ELEC_AC_1_BUS_IS_POWERED)"},
  ...
  new ProcedureStep {"FWC Initialization Check", 1065, true,  5000, "",                                                      "(L:A32NX_FWC_FLIGHT_PHASE)"},
  ...
  new ProcedureStep{"APU Avail Check",           1150, true,  2000, "",                                                      "(L:A32NX_OVHD_APU_MASTER_SW_PB_IS_ON) ! (L:A32NX_OVHD_APU_START_PB_IS_AVAILABLE) ||"},
...
static vector<ProcedureStep*>* PUSHBACK_CONFIG_ON = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"ADIRS 1 Await Alignment", 2150, true,  2000, "",                                            "(L:A32NX_ADIRS_ADIRU_1_STATE) 2 =="},
  new ProcedureStep{"ADIRS 2 Await Alignment", 2160, true,  2000, "",                                            "(L:A32NX_ADIRS_ADIRU_2_STATE) 2 =="},
  new ProcedureStep{"ADIRS 3 Await Alignment", 2170, true,  2000, "",                                            "(L:A32NX_ADIRS_ADIRU_3_STATE) 2 =="},
};
...
static vector<ProcedureStep*>* TAXI_CONFIG_ON = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"ENG 2 Avail Check",    3020, true,  5000,  "",                                                 "(L:A32NX_ENGINE_STATE:2) 1 =="},
  new ProcedureStep{"ENG 1 ON",             3030, false, 60000, "(A:FUELSYSTEM VALVE OPEN:1, Bool)",                "1 (>K:FUELSYSTEM_VALVE_OPEN)"},
  new ProcedureStep{"ENG 1 Avail Check",    3040, true,  5000,  "",                                                 "(L:A32NX_ENGINE_STATE:1) 1 =="},
