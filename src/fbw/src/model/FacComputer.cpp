...
void FacComputer::step()
{
  ...
  if (FacComputer_U.in.sim_data.computer_running) {
    ...
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_1, &rtb_y_e);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_2,
      FacComputer_P.BitfromLabel_bit, &rtb_y_hl);
    FacComputer_MATLABFunction_p(FacComputer_U.in.discrete_inputs.nose_gear_pressed == (rtb_y_hl != 0U),
      FacComputer_U.in.time.dt, FacComputer_P.ConfirmNode_isRisingEdge, FacComputer_P.ConfirmNode_timeDelay,
      &rtb_DataTypeConversion_dl, &FacComputer_DWork.sf_MATLABFunction_ax);
    rtb_y_e = (rtb_y_e && rtb_DataTypeConversion_dl);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_2,
      FacComputer_P.BitfromLabel5_bit, &rtb_y_hl);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_2,
      FacComputer_P.BitfromLabel6_bit, &rtb_y_ph);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_3,
      FacComputer_P.BitfromLabel7_bit, &rtb_y_b);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_3,
      FacComputer_P.BitfromLabel8_bit, &rtb_y);
    if (rtb_y_e) {
      FacComputer_B.logic.left_main_gear_pressed = (rtb_y_hl != 0U);
      FacComputer_B.logic.right_main_gear_pressed = (rtb_y_ph != 0U);
      FacComputer_B.logic.main_gear_out = ((rtb_y_b != 0U) || (rtb_y != 0U));
    } else if (rtb_AND1) {
    ...
    rtb_DataTypeConversion_dl = (FacComputer_U.in.discrete_inputs.rudder_trim_reset_button && (!rtb_y_d2));
    ...
    if (FacComputer_P.PulseNode_isRisingEdge) {
      rtb_y_b1 = (rtb_DataTypeConversion_dl && (!FacComputer_DWork.previousInput));
    } else {
      rtb_y_b1 = ((!rtb_DataTypeConversion_dl) && FacComputer_DWork.previousInput);
    }

    FacComputer_DWork.previousInput = rtb_DataTypeConversion_dl;
    ...
    FacComputer_DWork.Memory_PreviousInput = FacComputer_P.Logic_table
      [(((FacComputer_U.in.discrete_inputs.rudder_trim_switch_left ||
          FacComputer_U.in.discrete_inputs.rudder_trim_switch_right || rtb_y_d2 || (std::abs(rtb_Sum_l) <=
           FacComputer_P.CompareToConstant_const)) + (static_cast<uint32_T>(rtb_y_b1) << 1)) << 1) +
      FacComputer_DWork.Memory_PreviousInput];
    FacComputer_B.logic.lgciu_own_valid = rtb_y_e;
    FacComputer_B.logic.all_lgciu_lost = ((!rtb_y_e) && (!rtb_AND1));
    ...
    rtb_y_e = ((FacComputer_U.in.bus_inputs.adr_opp_bus.airspeed_computed_kn.SSM == static_cast<uint32_T>
                (SignStatusMatrix::FailureWarning)) || (FacComputer_U.in.bus_inputs.adr_opp_bus.aoa_corrected_deg.SSM ==
                static_cast<uint32_T>(SignStatusMatrix::FailureWarning)));
    rtb_DataTypeConversion_dl = ((FacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM == static_cast<uint32_T>
      (SignStatusMatrix::FailureWarning)) || (FacComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.SSM ==
      static_cast<uint32_T>(SignStatusMatrix::FailureWarning)));
    rtb_y_b1 = ((FacComputer_U.in.bus_inputs.ir_own_bus.body_yaw_rate_deg_s.SSM != static_cast<uint32_T>
    ...
    } else if (!rtb_DataTypeConversion_dl) {
    ...
    FacComputer_B.logic.double_self_detected_adr_failure = ((rtb_AND1 && rtb_y_e) || (rtb_AND1 &&
      rtb_DataTypeConversion_dl) || (rtb_y_e && rtb_DataTypeConversion_dl));
    FacComputer_B.logic.double_self_detected_ir_failure = ((rtb_y_b1 && rtb_irOppInvalid) || (rtb_y_b1 && rtb_ir3Invalid)
    ...
    rtb_y_e = (FacComputer_U.in.discrete_inputs.yaw_damper_has_hyd_press &&
               FacComputer_U.in.discrete_inputs.fac_engaged_from_switch);
    rtb_AND1 = !FacComputer_U.in.discrete_inputs.is_unit_1;
    rtb_DataTypeConversion_dl = (FacComputer_U.in.discrete_inputs.is_unit_1 || (rtb_AND1 &&
      (!FacComputer_U.in.discrete_inputs.yaw_damper_opp_engaged)));
    FacComputer_B.logic.yaw_damper_engaged = (rtb_y_e && rtb_DataTypeConversion_dl);
    FacComputer_B.logic.yaw_damper_can_engage = rtb_y_e;
    FacComputer_B.logic.yaw_damper_has_priority = rtb_DataTypeConversion_dl;
    rtb_y_e = (FacComputer_U.in.discrete_inputs.rudder_trim_actuator_healthy &&
               FacComputer_U.in.discrete_inputs.fac_engaged_from_switch);
    rtb_DataTypeConversion_dl = (FacComputer_U.in.discrete_inputs.is_unit_1 || (rtb_AND1 &&
      (!FacComputer_U.in.discrete_inputs.rudder_trim_opp_engaged)));
    FacComputer_B.logic.rudder_trim_engaged = (rtb_y_e && rtb_DataTypeConversion_dl);
    FacComputer_B.logic.rudder_trim_can_engage = rtb_y_e;
    FacComputer_B.logic.rudder_trim_has_priority = rtb_DataTypeConversion_dl;
    rtb_y_e = (FacComputer_U.in.discrete_inputs.rudder_travel_lim_actuator_healthy &&
               FacComputer_U.in.discrete_inputs.fac_engaged_from_switch);
    ...
    FacComputer_B.logic.rudder_travel_lim_engaged = (rtb_y_e && rtb_AND1);
    FacComputer_B.logic.rudder_travel_lim_can_engage = rtb_y_e;
    FacComputer_B.logic.rudder_travel_lim_has_priority = rtb_AND1;
    FacComputer_MATLABFunction_p(!FacComputer_B.logic.on_ground, FacComputer_U.in.time.dt,
      FacComputer_P.ConfirmNode_isRisingEdge_o, FacComputer_P.ConfirmNode_timeDelay_l, &rtb_DataTypeConversion_dl,
      &FacComputer_DWork.sf_MATLABFunction_p);
    FacComputer_B.logic.speed_scale_lost = FacComputer_P.Constant_Value_b5;
    FacComputer_B.logic.speed_scale_visible = rtb_DataTypeConversion_dl;
    ...
    FacComputer_MATLABFunction_d(rtb_y_e, rtb_DataTypeConversion_dl, rtb_y_b1, rtb_irOppInvalid, rtb_ir3Invalid, rtb_y_c
    ...
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1, &rtb_y_e);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel9_bit, &rtb_y_c);
    rtb_DataTypeConversion_dl = ((rtb_y_c != 0U) && rtb_y_e);
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1, &rtb_y_e);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel8_bit_i, &rtb_y_c);
    rtb_y_e = (rtb_DataTypeConversion_dl || ((rtb_y_c != 0U) && rtb_y_e));
    guard1 = false;
    ...
    if (guard1) {
      if ((rtb_alpha_floor_inhib != 0) || (!rtb_AND1) || (!rtb_y_e)) {
        FacComputer_DWork.sAlphaFloor = 0.0;
      }
    }
    ...
    FacComputer_MATLABFunction_d(rtb_AND1, rtb_y_e, rtb_DataTypeConversion_dl, rtb_y_b1, rtb_irOppInvalid, rtb_y_c != 0U,
      &rtb_Switch4_f);
    ...
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel4_bit_k, &rtb_y_hl);
    ...
    if (FacComputer_B.logic.yaw_damper_engaged) {
      ...
      if (rtb_y_d2 || ((rtb_y_lp != 0U) && FacComputer_U.in.discrete_inputs.elac_2_healthy && (rtb_y_hl != 0U))) {
        if (rtb_y_d2) {
