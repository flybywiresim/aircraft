...
class PitchNormalLaw final
{
 public:
  ...
  struct D_Work_PitchNormalLaw_T {
    ...
    rtDW_RateLimiter_PitchNormalLaw_T sf_RateLimiter_ct;
    rtDW_LagFilter_PitchNormalLaw_T sf_LagFilter_f;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter_h;
    rtDW_RateLimiter_PitchNormalLaw_T sf_RateLimiter_l;
    rtDW_RateLimiter_PitchNormalLaw_T sf_RateLimiter_nx;
    rtDW_RateLimiter_PitchNormalLaw_T sf_RateLimiter_c2;
    ...
    rtDW_LagFilter_PitchNormalLaw_T sf_LagFilter_g3;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter_d;
    rtDW_LagFilter_PitchNormalLaw_T sf_LagFilter_g;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter_l;
    rtDW_LagFilter_PitchNormalLaw_T sf_LagFilter_i;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter_k;
    rtDW_LagFilter_PitchNormalLaw_T sf_LagFilter_k;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter;
    rtDW_LagFilter_PitchNormalLaw_T sf_LagFilter_n;
  ...
  struct Parameters_PitchNormalLaw_T {
    ...
    real_T DiscreteDerivativeVariableTs_Gain_g4;
    ...
    real_T DiscreteDerivativeVariableTs1_InitialCondition_l3;
    real_T RateLimiterVariableTs6_InitialCondition_d;
    ...
    real_T DiscreteTimeIntegratorVariableTs_LowerLimit_j;
    ...
    real_T RateLimiterVariableTs6_lo_i;
    ...
    real_T RateLimiterVariableTs6_up_j;
    ...
    real_T uDLookupTable_bp01Data_l0[5];
    real_T uDLookupTable_bp02Data[5];
    real_T Saturation3_UpperSat_l;
    real_T Saturation3_LowerSat_hp;
 ...
 private:
  ...
  static void PitchNormalLaw_LagFilter(real_T rtu_U, real_T rtu_C1, real_T rtu_dt, real_T *rty_Y,
    rtDW_LagFilter_PitchNormalLaw_T *localDW);
  static void PitchNormalLaw_RateLimiter(real_T rtu_u, real_T rtu_up, real_T rtu_lo, real_T rtu_Ts, real_T rtu_init,
    real_T *rty_Y, rtDW_RateLimiter_PitchNormalLaw_T *localDW);
  static void PitchNormalLaw_eta_trim_limit_lofreeze(real_T rtu_eta_trim, boolean_T rtu_trigger, real_T *rty_y,
    rtDW_eta_trim_limit_lofreeze_PitchNormalLaw_T *localDW);
  static void PitchNormalLaw_WashoutFilter(real_T rtu_U, real_T rtu_C1, real_T rtu_dt, real_T *rty_Y,
