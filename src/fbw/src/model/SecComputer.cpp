...
namespace SecComputerNamespace
{
...
namespace SecComputerNamespace
{
  void SecComputer::step()
  {
    ...
    real_T rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_right_aileron_command_deg;
    real_T rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_yaw_damper_command_deg;
    real_T rtb_Gain;
    ...
    SecComputer_MATLABFunction(!SecComputer_U.in.discrete_inputs.green_low_pressure, SecComputer_U.in.time.dt,
      SecComputer_P.ConfirmNode2_isRisingEdge, SecComputer_P.ConfirmNode2_timeDelay, &rtb_AND4,
      &SecComputer_DWork.sf_MATLABFunction_h);
    rtb_logic_crg1_is_blue_hydraulic_power_avail = rtb_AND1;
    rtb_logic_crg1_is_green_hydraulic_power_avail = rtb_AND4;
    ...
    SecComputer_MATLABFunction_g(SecComputer_U.in.discrete_inputs.fo_priority_takeover_pressed,
      SecComputer_P.PulseNode1_isRisingEdge, &rtb_AND4, &SecComputer_DWork.sf_MATLABFunction_n);
    if (rtb_AND1) {
    ...
    if (SecComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_AND1 = ((!SecComputer_U.in.discrete_inputs.l_elev_servo_failed) &&
                  rtb_logic_crg1_is_blue_hydraulic_power_avail);
      rtb_AND4 = ((!SecComputer_U.in.discrete_inputs.r_elev_servo_failed) &&
                  rtb_logic_crg1_is_blue_hydraulic_power_avail);
    } else {
      rtb_AND1 = ((!SecComputer_U.in.discrete_inputs.l_elev_servo_failed) &&
                  rtb_logic_crg1_is_green_hydraulic_power_avail);
      rtb_AND4 = ((!SecComputer_U.in.discrete_inputs.r_elev_servo_failed) && rtb_AND3);
    }

    canEngageInPitch = ((rtb_AND1 || rtb_AND4) && (!SecComputer_U.in.discrete_inputs.is_unit_3));
    if (SecComputer_U.in.discrete_inputs.is_unit_1) {
    ...
    switch (static_cast<int32_T>(SecComputer_P.Constant1_Value_a)) {
     case 0:
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_yaw_damper_command_deg = 0.0;
      break;

     case 1:
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_yaw_damper_command_deg = rtb_zeta_deg;
      break;

     default:
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_yaw_damper_command_deg =
        SecComputer_P.Constant_Value_c;
      break;
    }

    rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_right_aileron_command_deg = rtb_eta_deg_a;
    ...
    SecComputer_Y.out.discrete_outputs.right_elevator_ok = rtb_AND4;
    ...
    rtb_VectorConcatenate[7] = rtb_AND4;
    ...
    SecComputer_Y.out.laws.lateral_law_outputs.right_aileron_command_deg =
      rtb_BusConversion_InsertedFor_BusAssignment_at_inport_1_BusCreator1_right_aileron_command_deg;
    ...
    SecComputer_Y.out.logic.right_elevator_avail = rtb_AND4;
