  ...
  if (SecComputer_U.in.sim_data.computer_running) {
    ...
    rtb_OR6 = ((SecComputer_U.in.bus_inputs.ir_2_bus.pitch_angle_deg.SSM == static_cast<uint32_T>(SignStatusMatrix::
      ...
      FailureWarning)) || (SecComputer_U.in.bus_inputs.ir_2_bus.roll_att_rate_deg_s.SSM == static_cast<uint32_T>
                (SignStatusMatrix::FailureWarning)) || SecComputer_P.Constant_Value_l);
    rtb_singleIrFault = (rtb_y_kc || rtb_OR6);
    rtb_doubleIrFault = (rtb_y_kc && rtb_OR6);
    rtb_AND1_h = !rtb_OR1;
    rtb_AND4_a = !rtb_y_nd;
    if (rtb_AND1_h && rtb_AND4_a) {
    ...
    rtb_y_nd = (rtb_DataTypeConversion_h && (!rtb_OR6));
    ...
    rtb_AND4_a = (rtb_y_nd || (rtb_AND4_a && (!rtb_OR6)) || (rtb_DataTypeConversion_h && rtb_AND4_a));
    SecComputer_MATLABFunction(&SecComputer_U.in.bus_inputs.lgciu_1_bus.discrete_word_3,
    ...
    SecComputer_MATLABFunction(&SecComputer_U.in.bus_inputs.lgciu_1_bus.discrete_word_3, SecComputer_P.BitfromLabel8_bit,
      &rtb_Switch7_c);
    rtb_DataTypeConversion_h = (rtb_DataTypeConversion_k && rtb_y_nd && ((!rtb_DataTypeConversion_h) && (!rtb_AND1_h) &&
      (rtb_Switch7_c == 0U)));
    SecComputer_MATLABFunction(&SecComputer_U.in.bus_inputs.lgciu_2_bus.discrete_word_3,
    ...
    SecComputer_MATLABFunction(&SecComputer_U.in.bus_inputs.lgciu_2_bus.discrete_word_3, SecComputer_P.BitfromLabel1_bit,
      &rtb_Switch7_c);
    rtb_y_nd = (rtb_OR6 && rtb_y_nd && ((!rtb_AND1_h) && (!rtb_DataTypeConversion_k) && (rtb_Switch7_c == 0U)));
    ...
    SecComputer_MATLABFunction_c((rtb_Switch7_c != 0U) && rtb_y_b && rtb_OR1_gd, SecComputer_U.in.time.dt,
      SecComputer_P.ConfirmNode1_isRisingEdge_f, SecComputer_P.ConfirmNode1_timeDelay_c, &rtb_OR6,
      &SecComputer_DWork.sf_MATLABFunction_dw);
    rtb_OR6 = ((rtb_DataTypeConversion_h && rtb_y_e) || (rtb_y_kc && rtb_NOT3) || (rtb_y_nd && rtb_OR6));
    rtb_y_e = rtb_OR6;
    ...
    SecComputer_MATLABFunction_e(SecComputer_U.in.discrete_inputs.fo_priority_takeover_pressed,
      SecComputer_P.PulseNode1_isRisingEdge, &rtb_OR6, &SecComputer_DWork.sf_MATLABFunction_nu);
    if (rtb_AND1_h) {
    ...
    if (SecComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_DataTypeConversion_k = ((!SecComputer_U.in.discrete_inputs.r_elev_servo_failed) && rtb_y_kc);
    }
    ...
    spoiler_pair_1_avail = ((!SecComputer_U.in.discrete_inputs.l_spoiler_1_servo_failed) &&
      (!SecComputer_U.in.discrete_inputs.r_spoiler_1_servo_failed) && rtb_AND1_h);
    ...
    rtb_AND1_e = ((rtb_Switch7_c != 0U) && rtb_AND4_a);
    ...
    if (rtb_doubleIrFault || (rtb_OR6 && (!rtb_y_e))) {
      rtb_pitchLawCapability = pitch_efcs_law::DirectLaw;
               ...
               ((!rtb_AND1_e) && ((rtb_Switch7_c == 0U) || (!rtb_AND1_h)) && ((!rtb_OR1_gd) ||
    ...
    rtb_OR6 = (SecComputer_P.Constant_Value_c || (SecComputer_U.in.discrete_inputs.pitch_not_avail_elac_1 &&
                SecComputer_U.in.discrete_inputs.pitch_not_avail_elac_2 &&
    ...
    SecComputer_DWork.Memory_PreviousInput = SecComputer_P.Logic_table[(((static_cast<uint32_T>(rtb_OR6) << 1) +
    ...
    SecComputer_B.logic.speed_brake_inhibited = (rtb_OR6 || SecComputer_DWork.Memory_PreviousInput);
    ...
    rtb_OR6 = (rtb_y_b || ((SecComputer_U.in.analog_inputs.wheel_speed_left < SecComputer_P.CompareToConstant11_const) &&
    ...
    SecComputer_DWork.Memory_PreviousInput_n = SecComputer_P.Logic_table_i[(((static_cast<uint32_T>(rtb_OR6) << 1) +
    ...
    rtb_OR6 = (SecComputer_U.in.analog_inputs.spd_brk_lever_pos < SecComputer_P.CompareToConstant_const_m);
    SecComputer_DWork.Delay1_DSTATE_i = (((((SecComputer_U.in.analog_inputs.spd_brk_lever_pos >
      SecComputer_P.CompareToConstant15_const) || rtb_OR6) && ((SecComputer_U.in.analog_inputs.thr_lever_1_pos <=
    ...
    SecComputer_DWork.Delay_DSTATE_n = (((((SecComputer_U.in.analog_inputs.spd_brk_lever_pos >
      SecComputer_P.CompareToConstant10_const) || rtb_OR6) && ((SecComputer_U.in.analog_inputs.thr_lever_1_pos <=
    ...
    SecComputer_B.logic.can_engage_in_pitch = rtb_DataTypeConversion_h;
    SecComputer_B.logic.has_priority_in_pitch = rtb_NOT3;
    SecComputer_B.logic.left_elevator_avail = rtb_OR1_gd;
    SecComputer_B.logic.right_elevator_avail = rtb_DataTypeConversion_k;
    SecComputer_B.logic.is_engaged_in_roll = ((spoiler_pair_1_avail || spoiler_pair_2_avail) &&
    ...
    SecComputer_B.logic.spoiler_pair_1_avail = spoiler_pair_1_avail;
    ...
    SecComputer_B.logic.ground_spoilers_armed = rtb_OR6;
    ...
    rtb_OR6 = (SecComputer_B.logic.ground_spoilers_out || SecComputer_B.logic.partial_lift_dumping_active);
    ...
    if (SecComputer_U.in.bus_inputs.elac_1_bus.roll_spoiler_command_deg.SSM == static_cast<uint32_T>(SignStatusMatrix::
      ...
      rtb_OR16 = (rtb_y != 0U);
      rtb_OR1_k = (rtb_DataTypeConversion1 != 0U);
    ...
    LawMDLOBJ2.step(&SecComputer_U.in.time.dt, &SecComputer_B.logic.ir_computation_data.n_z_g,
      ...
      (&SecComputer_RGND)), &SecComputer_B.logic.total_sidestick_pitch_command, &rtb_OR16, &rtb_eta_deg,
                    &rtb_eta_trim_deg);
    ...
    rtb_AND1_h = !SecComputer_U.in.discrete_inputs.ths_motor_fault;
    if (SecComputer_B.logic.is_engaged_in_pitch && rtb_AND1_h) {
    ...
    rtb_AND4_a = (SecComputer_B.logic.is_engaged_in_pitch && SecComputer_B.logic.left_elevator_avail);
    SecComputer_Y.out.discrete_outputs.left_elevator_damping_mode = rtb_AND4_a;
    SecComputer_Y.out.discrete_outputs.right_elevator_damping_mode = rtb_AND4_a;
    SecComputer_Y.out.discrete_outputs.ths_active = (SecComputer_B.logic.is_engaged_in_pitch && rtb_AND1_h);
