...
void AutothrustModelClass::step()
{
  ...
  if ((!Autothrust_DWork.condition_TOGA_latch) || (Autothrust_DWork.eventTime_n == 0.0)) {
    Autothrust_DWork.eventTime_n = Autothrust_U.in.time.simulation_time;
  }

  if (Autothrust_U.in.time.simulation_time - Autothrust_DWork.eventTime_n >= 0.3) {
    condition_TOGA = true;
  ...
  Autothrust_DWork.ATHR_ENGAGED = ((condition_AP_FD_ATHR_Specific && (((rtb_on_ground == 0) && ATHR_ENGAGED_tmp &&
    ...
    Autothrust_U.in.input.is_LAND_mode_active) && rtb_r_d && ((ATHR_ENGAGED_tmp_0 || ATHR_ENGAGED_tmp_1) &&
  ...
  Autothrust_DWork.pThrustMemoActive = ((((Autothrust_U.in.input.ATHR_push && (status != athr_status_DISENGAGED)) ||
    (ATHR_ENGAGED_tmp_1 && Autothrust_DWork.pUseAutoThrustControl && rtb_r_d)) && ((condition_TOGA &&
  ...
  switch (static_cast<int32_T>(rtb_Switch_m)) {
   ...
   case 1:
    rtb_Switch_m = ((Autothrust_P.Gain_Gain * rtb_Cos1 + rtb_Y_m) + (Autothrust_P.Gain1_Gain * rtb_Gain2 +
      Autothrust_P.Gain3_Gain * rtb_Switch_dx)) * look1_binlxpw(static_cast<real_T>
      (Autothrust_U.in.input.is_alt_soft_mode_active), Autothrust_P.ScheduledGain3_BreakpointsForDimension1,
      Autothrust_P.ScheduledGain3_Table, 1U) * look1_binlxpw(static_cast<real_T>
      (Autothrust_U.in.input.is_approach_mode_active), Autothrust_P.ScheduledGain4_BreakpointsForDimension1,
      Autothrust_P.ScheduledGain4_Table, 1U) * look1_binlxpw(std::fmin
