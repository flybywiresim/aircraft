...
void AutothrustModelClass::step()
{
  ...
  rtb_Saturation = std::fmax(15.0 - 0.0019812 * Autothrust_U.in.data.H_ft, -56.5);
  ...
  Autothrust_RateLimiterwithThreshold(Autothrust_U.in.input.thrust_limit_IDLE_percent + look2_binlxpw(static_cast<real_T>
    ...
    Autothrust_P.RateLimiterThresholdVariableTs_Threshold, &rtb_y_bn, &Autothrust_DWork.sf_RateLimiterwithThreshold_d);
  Autothrust_RateLimiterwithThreshold(look2_binlxpw(Autothrust_U.in.data.TAT_degC, Autothrust_U.in.data.H_ft,
    ...
    Autothrust_P.RateLimiterThresholdVariableTs2_Threshold, &rtb_y_f3, &Autothrust_DWork.sf_RateLimiterwithThreshold_h);
  ...
  rtb_Sum_ew = rtb_y_f3 + rtb_Switch_m;
  Autothrust_RateLimiterwithThreshold((look1_binlxpw(static_cast<real_T>
    ...
    Autothrust_P.RateLimiterThresholdVariableTs_Threshold_b, &rtb_y_f3, &Autothrust_DWork.sf_RateLimiterwithThreshold_m);
  rtb_Max_g = std::fmax(look2_binlxpw(look2_binlxpw(Autothrust_U.in.data.H_ft, std::fmax(std::fmax(std::fmin
    (Autothrust_U.in.input.flex_temperature_degC, rtb_Saturation + 55.0), rtb_Saturation + 29.0),
    Autothrust_U.in.data.OAT_degC), Autothrust_P.Right_bp01Data, Autothrust_P.Right_bp02Data,
    Autothrust_P.Right_tableData, Autothrust_P.Right_maxIndex, 10U), Autothrust_U.in.data.TAT_degC,
    Autothrust_P.Left_bp01Data, Autothrust_P.Left_bp02Data, Autothrust_P.Left_tableData, Autothrust_P.Left_maxIndex, 2U)
                        + rtb_y_f3, rtb_Sum_ew);
  Autothrust_RateLimiterwithThreshold(look2_binlxpw(Autothrust_U.in.data.TAT_degC, Autothrust_U.in.data.H_ft,
    ...
    Autothrust_P.RateLimiterThresholdVariableTs2_Threshold_m, &rtb_y_f3,
  ...
  Autothrust_RateLimiterwithThreshold(look2_binlxpw(Autothrust_U.in.data.TAT_degC, Autothrust_U.in.data.H_ft,
    ...
    Autothrust_P.RateLimiterThresholdVariableTs2_Threshold_i, &rtb_y_f3, &Autothrust_DWork.sf_RateLimiterwithThreshold_n);
  ...
  rtb_Switch1_k = rtb_y_f3 + rtb_Switch_dx;
  rtb_Switch2_k = rtb_y_bn;
  Autothrust_TimeSinceCondition(Autothrust_U.in.time.simulation_time, Autothrust_U.in.input.ATHR_disconnect, &rtb_y_bn,
    &Autothrust_DWork.sf_TimeSinceCondition_o);
  Autothrust_DWork.Memory_PreviousInput = Autothrust_P.Logic_table[(((static_cast<uint32_T>(rtb_y_bn >=
  ...
  rtb_y_a = ((rtb_Compare_e && (rtb_on_ground != 0)) || ((rtb_on_ground == 0) && Autothrust_DWork.latch));
  ...
  Autothrust_TimeSinceCondition(Autothrust_U.in.time.simulation_time, rtb_on_ground != 0, &rtb_y_bn,
  ...
  rtb_BusAssignment_n.data_computed.time_since_touchdown = rtb_y_bn;
  rtb_BusAssignment_n.data_computed.alpha_floor_inhibited = Autothrust_DWork.sInhibit;
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_1_deg, &rtb_y_f3, &rtb_Compare_e);
  Autothrust_TLAComputation1(&rtb_BusAssignment_n, Autothrust_U.in.input.TLA_2_deg, &rtb_y_bn, &rtb_NOT1_m);
  ...
  rtb_OATCornerPoint = std::fmax(Autothrust_U.in.input.TLA_1_deg, Autothrust_U.in.input.TLA_2_deg);
  ...
  } else if ((status == athr_status_ENGAGED_ARMED) && rtb_y_a && (rtb_OATCornerPoint == 35.0)) {
  ...
  if (rtb_on_ground == 0) {
    rtb_OATCornerPoint = std::fmax(0.0, rtb_OATCornerPoint);
  }
  ...
  if ((rtb_on_ground == 0) || (condition_AP_FD_ATHR_Specific && condition_AlphaFloor_tmp)) {
    ...
    if ((!rtb_y_a) || (rtb_OATCornerPoint > 35.0)) {
      Autothrust_Y.out.output.thrust_limit_type = athr_thrust_limit_type_TOGA;
      Autothrust_Y.out.output.thrust_limit_percent = rtb_Switch1_k;
    } else {
      Autothrust_Y.out.output.thrust_limit_type = athr_thrust_limit_type_FLEX;
  ...
  rtb_Sum_h = v[i] - Autothrust_U.in.data.V_ias_kn;
  ...
  switch (static_cast<int32_T>(denom_tmp)) {
   ...
   case 1:
    rtb_Switch_dx = ((1.0 - (std::fmax(1.0, std::fmin(10.0, rtb_Divide)) - 1.0) * 0.1111111111111111) * 0.5 * (std::fmin
   ...
   case 2:
    rtb_Switch_dx = (rtb_Switch2_k - std::fmax(Phi_rad, Theta_rad)) * Autothrust_P.Gain_Gain;
    break;

   default:
    rtb_Switch_dx = (rtb_Sum_ew - std::fmax(Phi_rad, Theta_rad)) * Autothrust_P.Gain_Gain_m;
    break;
  }
  ...
  if (Autothrust_DWork.icLoad) {
    Autothrust_DWork.Delay_DSTATE_k = std::fmax(Phi_rad, Theta_rad) - rtb_Switch_dx;
  }
  ...
  if (Autothrust_DWork.pUseAutoThrustControl) {
    if ((mode == Autothrust_P.CompareToConstant2_const_h) || (mode == Autothrust_P.CompareToConstant3_const)) {
      if (rtb_Switch1_k < rtb_y_f3) {
        rtb_Sum_h = rtb_y_f3;
      } else {
        rtb_Sum_h = rtb_Switch1_k;
      }

      if (rtb_Switch1_k < rtb_y_bn) {
        rtb_Divide = rtb_y_bn;
      } else {
        rtb_Divide = rtb_Switch1_k;
      }
    } else {
      if (Autothrust_DWork.Delay_DSTATE_j > rtb_y_f3) {
        rtb_Sum_h = rtb_y_f3;
      ...
      if (Autothrust_DWork.Delay_DSTATE_j > rtb_y_bn) {
        rtb_Divide = rtb_y_bn;
      } else if (Autothrust_DWork.Delay_DSTATE_j < rtb_Switch2_k) {
  ...
  Autothrust_Y.out.output.N1_TLA_1_percent = rtb_y_f3;
  Autothrust_Y.out.output.N1_TLA_2_percent = rtb_y_bn;
  ...
  Autothrust_ThrustMode1(Autothrust_U.in.input.TLA_1_deg, &rtb_y_f3);
  ...
  Autothrust_Y.out.output.sim_thrust_mode_1 = rtb_y_f3;
