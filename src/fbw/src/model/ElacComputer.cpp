...
void ElacComputer::step()
{
  ...
  if (ElacComputer_U.in.sim_data.computer_running) {
    ...
    boolean_T rtb_DataTypeConversion_cc;
    boolean_T rtb_DataTypeConversion_f;
    boolean_T rtb_OR;
    boolean_T rtb_OR1;
    boolean_T rtb_OR3;
    boolean_T rtb_OR4;
    ...
    ElacComputer_B.laws.lateral_law_outputs.left_aileron_command_deg = rtb_n_x;
    ...
    rtb_AND1 = ((rtb_Switch11 != 0U) && rtb_AND_ai);
    ...
    rtb_AND2 = ((rtb_Switch11 != 0U) && rtb_y_i);
    ...
    ElacComputer_MATLABFunction_c((!ElacComputer_U.in.discrete_inputs.yellow_low_pressure) && rtb_y_i,
      ...
      &rtb_AND2_p, &ElacComputer_DWork.sf_MATLABFunction_cj);
    ...
    ElacComputer_MATLABFunction_c((!ElacComputer_U.in.discrete_inputs.blue_low_pressure) && rtb_y_i,
      ...
      &rtb_AND_ai, &ElacComputer_DWork.sf_MATLABFunction_g2);
    ...
    ElacComputer_B.logic.is_yellow_hydraulic_power_avail = rtb_AND2_p;
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1,
      ElacComputer_P.BitfromLabel_bit_c, &rtb_Switch11);
    ...
    rtb_AND2_p = (rtb_AND2_p || (rtb_Switch11 != 0U));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_3,
    ...
    if ((ElacComputer_U.in.discrete_inputs.fac_1_yaw_control_lost &&
        ...
        ((ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1.SSM != static_cast<uint32_T>(SignStatusMatrix::
          ...
          static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) && ((!rtb_y_i) && (rtb_Switch11 != 0U))) ||
        ((!rtb_AND3_b) && (!rtb_AND1_h) && (!rtb_AND4) && (!rtb_AND2_p) && (!rtb_AND_ai))) {
      rtb_lateralLawCapability = lateral_efcs_law::DirectLaw;
    } else {
      rtb_lateralLawCapability = lateral_efcs_law::NormalLaw;
    }

    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_2, &rtb_AND3_b);
    ...
    rtb_AND3_b = (((!rtb_AND3_b) && (!rtb_y_i)) || (rtb_AND_ai && (rtb_Switch11 != 0U)));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_2,
    ...
    rtb_AND2_p = ((rtb_Switch11 != 0U) && rtb_AND2_p);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
    ...
    rtb_DataTypeConversion_by = ((rtb_doubleIrFault && rtb_DataTypeConversion_cc) || (rtb_DataTypeConversion_by &&
      alternate1Condition_tmp) || (rtb_doubleAdrFault && alternate1Condition_tmp && alternate1Condition_tmp) ||
      alternate2Condition_tmp);
    if (rtb_tripleIrFault || ((rtb_DataTypeConversion_f || rtb_DataTypeConversion_by || rtb_AND2 ||
          (rtb_lateralLawCapability == lateral_efcs_law::DirectLaw)) && ((ElacComputer_B.in_flight != 0.0) &&
          ((rtb_AND_ai && (!rtb_AND3_b)) || ((rtb_AND2_p || ((rtb_Switch11 != 0U) && rtb_y_i)) && rtb_AND3_b))))) {
      rtb_pitchLawCapability = pitch_efcs_law::DirectLaw;
    } else if (rtb_DataTypeConversion_f) {
    ...
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel_bit_h, &rtb_y_ga);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2,
    ...
    if ((rtb_DataTypeConversion1_j != 0U) && (rtb_Switch11 == 0U)) {
      rtb_oppElacRollCapability = lateral_efcs_law::NormalLaw;
    } else if ((rtb_DataTypeConversion1_j == 0U) && (rtb_Switch11 != 0U)) {
    ...
    if (hasPriorityInPitch && rtb_isEngagedInPitch) {
      ...
      if ((rtb_y_ga != 0U) && (rtb_Switch15 == 0U)) {
        priorityPitchPitchLawCap = pitch_efcs_law::NormalLaw;
      } else if ((rtb_y_ga == 0U) && (rtb_Switch15 != 0U)) {
    ...
    rtb_AND_ai = (rtb_AND2_p && ElacComputer_DWork.Memory_PreviousInput);
    ...
    rtb_DataTypeConversion_by = (rtb_Switch11 != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
    ...
    rtb_DataTypeConversion_f = (rtb_Switch11 != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_e, &rtb_Switch11);
    rtb_DataTypeConversion_cc = (rtb_Switch11 != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel5_bit_a, &rtb_Switch11);
    ElacComputer_MATLABFunction_o(rtb_DataTypeConversion_by, rtb_y_i, rtb_AND3_b, rtb_DataTypeConversion_f,
      rtb_DataTypeConversion_cc, rtb_Switch11 != 0U, &rtb_handleIndex);
    ...
    if (rtb_V_ias <= std::fmin(365.0, (look1_binlxpw(rtb_DataTypeConversion8_g, ElacComputer_P.uDLookupTable_bp01Data,
           ElacComputer_P.uDLookupTable_tableData, 3U) + 0.01) * rtb_handleIndex)) {
      ElacComputer_DWork.eventTime = ElacComputer_U.in.time.simulation_time;
    ...
    if (ElacComputer_U.in.discrete_inputs.ap_1_disengaged && ElacComputer_U.in.discrete_inputs.ap_2_disengaged) {
      ElacComputer_DWork.sProtActive = ((rtb_V_ias > std::fmin(look1_binlxpw(rtb_DataTypeConversion8_g,
        ElacComputer_P.uDLookupTable1_bp01Data, ElacComputer_P.uDLookupTable1_tableData, 3U), rtb_handleIndex *
    ...
    ElacComputer_DWork.sProtActive = ((rtb_V_ias >= rtb_Switch1) && (rtb_DataTypeConversion_by &&
    ...
    ElacComputer_RateLimiter(rtb_DataTypeConversion8_g, ElacComputer_P.RateLimiterVariableTs_up_i,
      ...
      ElacComputer_P.RateLimiterVariableTs_InitialCondition_e,
      &ElacComputer_B.laws.lateral_law_outputs.left_aileron_command_deg, &ElacComputer_DWork.sf_RateLimiter);
    ...
    rtb_tripleAdrFault = ((rtb_y_ga != 0U) && rtb_AND3_b);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
    ...
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel1_bit_h, &rtb_y_ga);
    rtb_doubleIrFault = (rtb_y_ga != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel2_bit_f, &rtb_y_ga);
    rtb_tripleIrFault = (rtb_y_ga != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel3_bit_c, &rtb_y_ga);
    rtb_AND1 = (rtb_y_ga != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_n, &rtb_y_ga);
    rtb_AND2 = (rtb_y_ga != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
    ...
    rtb_tripleAdrFault = (rtb_y_ga != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel1_bit_h1, &rtb_y_ga);
    rtb_doubleIrFault = (rtb_y_ga != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel2_bit_g, &rtb_y_ga);
    rtb_tripleIrFault = (rtb_y_ga != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel3_bit_b, &rtb_y_ga);
    rtb_AND1 = (rtb_y_ga != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_i, &rtb_y_ga);
    rtb_AND2 = (rtb_y_ga != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
    ...
    switch (static_cast<int32_T>(ElacComputer_B.logic.active_pitch_law)) {
     case 0:
      rtb_Switch1 = rtb_eta_trim_limit_up;
      break;

     case 1:
     case 2:
      rtb_Switch1 = rtb_eta_trim_limit_up_d;
      break;
     ...
     default:
      rtb_Switch1 = ElacComputer_P.Constant2_Value_l;
      break;
    }
    ...
    ElacComputer_MATLABFunction_cw(rtb_VectorConcatenate_a, &rtb_V_tas);
    ...
    rtb_AND1 = (ElacComputer_B.logic.is_engaged_in_pitch && ElacComputer_B.logic.left_elevator_avail);
    ElacComputer_Y.out.discrete_outputs.left_elevator_damping_mode = rtb_AND1;
    ElacComputer_Y.out.discrete_outputs.right_elevator_damping_mode = rtb_AND1;
    ...
    ElacComputer_B.SSM_cui = ElacComputer_U.in.bus_inputs.fmgc_1_bus.fg_radio_height_ft.SSM;
    ElacComputer_B.Data_of = ElacComputer_U.in.bus_inputs.fmgc_1_bus.fg_radio_height_ft.Data;
    ElacComputer_B.SSM_mq = ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_p_ail_cmd_deg.SSM;
    ElacComputer_B.Data_lg = ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_p_ail_cmd_deg.Data;
    ElacComputer_B.SSM_ni = ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_p_splr_cmd_deg.SSM;
    ElacComputer_B.Data_n4 = ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_p_splr_cmd_deg.Data;
    ElacComputer_B.l_ail_servo_failed = ElacComputer_U.in.discrete_inputs.l_ail_servo_failed;
    ElacComputer_B.SSM_df = ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_r_cmd_deg.SSM;
    ElacComputer_B.Data_ot = ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_r_cmd_deg.Data;
    ElacComputer_B.SSM_oe = ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_q_cmd_deg.SSM;
    ElacComputer_B.Data_gv = ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_q_cmd_deg.Data;
    ElacComputer_B.SSM_ha = ElacComputer_U.in.bus_inputs.fmgc_2_bus.fg_radio_height_ft.SSM;
    ElacComputer_B.Data_ou = ElacComputer_U.in.bus_inputs.fmgc_2_bus.fg_radio_height_ft.Data;
    ElacComputer_B.SSM_op = ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_p_ail_cmd_deg.SSM;
    ElacComputer_B.Data_dh = ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_p_ail_cmd_deg.Data;
    ElacComputer_B.SSM_a50 = ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_p_splr_cmd_deg.SSM;
    ElacComputer_B.Data_ph = ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_p_splr_cmd_deg.Data;
    ...
    ElacComputer_B.SSM_og = ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_r_cmd_deg.SSM;
    ElacComputer_B.Data_gs = ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_r_cmd_deg.Data;
    ElacComputer_B.SSM_a4 = ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_q_cmd_deg.SSM;
    ElacComputer_B.Data_fd4 = ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_q_cmd_deg.Data;
    ElacComputer_B.SSM_bv = ElacComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.SSM;
    ElacComputer_B.Data_hm = ElacComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data;
    ElacComputer_B.SSM_bo = ElacComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.SSM;
    ElacComputer_B.Data_i2 = ElacComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data;
    ElacComputer_B.SSM_d1 = ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_component_status_word.SSM;
    ElacComputer_B.Data_og = ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_component_status_word.Data;
    ElacComputer_B.r_ail_servo_failed = ElacComputer_U.in.discrete_inputs.r_ail_servo_failed;
    ElacComputer_B.SSM_hy = ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word.SSM;
    ElacComputer_B.Data_fv = ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word.Data;
    ElacComputer_B.SSM_gi = ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word.SSM;
    ElacComputer_B.Data_oc = ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word.Data;
    ElacComputer_B.SSM_pp = ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_actual_position_deg.SSM;
    ElacComputer_B.Data_kq = ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_actual_position_deg.Data;
    ElacComputer_B.SSM_iab = ElacComputer_U.in.bus_inputs.sfcc_1_bus.flap_actual_position_deg.SSM;
    ElacComputer_B.Data_ne = ElacComputer_U.in.bus_inputs.sfcc_1_bus.flap_actual_position_deg.Data;
    ElacComputer_B.SSM_jtv = ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_component_status_word.SSM;
    ElacComputer_B.Data_it = ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_component_status_word.Data;
    ElacComputer_B.r_elev_servo_failed = ElacComputer_U.in.discrete_inputs.r_elev_servo_failed;
    ElacComputer_B.SSM_fy = ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_system_status_word.SSM;
    ElacComputer_B.Data_ch = ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_system_status_word.Data;
    ElacComputer_B.SSM_d4 = ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word.SSM;
    ElacComputer_B.Data_bb = ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word.Data;
    ElacComputer_B.SSM_ars = ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_actual_position_deg.SSM;
    ElacComputer_B.Data_ol = ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_actual_position_deg.Data;
    ElacComputer_B.SSM_din = ElacComputer_U.in.bus_inputs.sfcc_2_bus.flap_actual_position_deg.SSM;
    ElacComputer_B.Data_hw = ElacComputer_U.in.bus_inputs.sfcc_2_bus.flap_actual_position_deg.Data;
    ElacComputer_B.SSM_m3 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_1.SSM;
    ElacComputer_B.Data_hs = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_1.Data;
    ElacComputer_B.ths_override_active = ElacComputer_U.in.discrete_inputs.ths_override_active;
    ElacComputer_B.SSM_np = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_2.SSM;
    ElacComputer_B.Data_fj = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_2.Data;
    ElacComputer_B.SSM_ax = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_3.SSM;
    ElacComputer_B.Data_ky = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_3.Data;
    ElacComputer_B.SSM_cl = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_4.SSM;
    ElacComputer_B.Data_h5 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_4.Data;
    ElacComputer_B.SSM_es = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_5.SSM;
    ElacComputer_B.Data_ku = ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_5.Data;
    ElacComputer_B.SSM_gi1 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.capt_roll_command_deg.SSM;
    ElacComputer_B.Data_jp = ElacComputer_U.in.bus_inputs.fcdc_1_bus.capt_roll_command_deg.Data;
    ElacComputer_B.yellow_low_pressure = ElacComputer_U.in.discrete_inputs.yellow_low_pressure;
    ElacComputer_B.SSM_jz = ElacComputer_U.in.bus_inputs.fcdc_1_bus.fo_roll_command_deg.SSM;
    ElacComputer_B.Data_nu = ElacComputer_U.in.bus_inputs.fcdc_1_bus.fo_roll_command_deg.Data;
    ElacComputer_B.SSM_kt = ElacComputer_U.in.bus_inputs.fcdc_1_bus.rudder_pedal_position_deg.SSM;
    ElacComputer_B.Data_br = ElacComputer_U.in.bus_inputs.fcdc_1_bus.rudder_pedal_position_deg.Data;
    ElacComputer_B.SSM_ds = ElacComputer_U.in.bus_inputs.fcdc_1_bus.capt_pitch_command_deg.SSM;
    ElacComputer_B.Data_ae = ElacComputer_U.in.bus_inputs.fcdc_1_bus.capt_pitch_command_deg.Data;
    ElacComputer_B.SSM_eg = ElacComputer_U.in.bus_inputs.fcdc_1_bus.fo_pitch_command_deg.SSM;
    ElacComputer_B.Data_pe = ElacComputer_U.in.bus_inputs.fcdc_1_bus.fo_pitch_command_deg.Data;
    ElacComputer_B.SSM_a0 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.aileron_left_pos_deg.SSM;
    ElacComputer_B.Data_fy = ElacComputer_U.in.bus_inputs.fcdc_1_bus.aileron_left_pos_deg.Data;
    ElacComputer_B.capt_priority_takeover_pressed = ElacComputer_U.in.discrete_inputs.capt_priority_takeover_pressed;
    ElacComputer_B.SSM_cv = ElacComputer_U.in.bus_inputs.fcdc_1_bus.elevator_left_pos_deg.SSM;
    ElacComputer_B.Data_na = ElacComputer_U.in.bus_inputs.fcdc_1_bus.elevator_left_pos_deg.Data;
    ElacComputer_B.SSM_ea = ElacComputer_U.in.bus_inputs.fcdc_1_bus.aileron_right_pos_deg.SSM;
    ElacComputer_B.Data_my = ElacComputer_U.in.bus_inputs.fcdc_1_bus.aileron_right_pos_deg.Data;
    ElacComputer_B.SSM_p4 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.elevator_right_pos_deg.SSM;
    ElacComputer_B.Data_i4 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.elevator_right_pos_deg.Data;
    ElacComputer_B.SSM_m2 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.horiz_stab_trim_pos_deg.SSM;
    ElacComputer_B.Data_cx = ElacComputer_U.in.bus_inputs.fcdc_1_bus.horiz_stab_trim_pos_deg.Data;
    ElacComputer_B.SSM_bt0 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_1_left_pos_deg.SSM;
    ElacComputer_B.Data_nz = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_1_left_pos_deg.Data;
    ElacComputer_B.fo_priority_takeover_pressed = ElacComputer_U.in.discrete_inputs.fo_priority_takeover_pressed;
    ElacComputer_B.SSM_nr = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_2_left_pos_deg.SSM;
    ElacComputer_B.Data_id = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_2_left_pos_deg.Data;
    ElacComputer_B.SSM_fr = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_3_left_pos_deg.SSM;
    ElacComputer_B.Data_o2 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_3_left_pos_deg.Data;
    ElacComputer_B.SSM_cc = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_4_left_pos_deg.SSM;
    ElacComputer_B.Data_gqq = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_4_left_pos_deg.Data;
    ElacComputer_B.SSM_lm = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_5_left_pos_deg.SSM;
    ElacComputer_B.Data_md = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_5_left_pos_deg.Data;
    ElacComputer_B.SSM_mkm = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_1_right_pos_deg.SSM;
    ElacComputer_B.Data_cz = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_1_right_pos_deg.Data;
    ElacComputer_B.blue_low_pressure = ElacComputer_U.in.discrete_inputs.blue_low_pressure;
    ElacComputer_B.SSM_jhd = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_2_right_pos_deg.SSM;
    ElacComputer_B.Data_pm = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_2_right_pos_deg.Data;
    ElacComputer_B.SSM_av = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_3_right_pos_deg.SSM;
    ElacComputer_B.Data_bj = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_3_right_pos_deg.Data;
    ElacComputer_B.SSM_ira = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_4_right_pos_deg.SSM;
    ElacComputer_B.Data_ox = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_4_right_pos_deg.Data;
    ElacComputer_B.SSM_ge = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_5_right_pos_deg.SSM;
    ElacComputer_B.Data_pe5 = ElacComputer_U.in.bus_inputs.fcdc_1_bus.spoiler_5_right_pos_deg.Data;
    ElacComputer_B.SSM_lv = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_1.SSM;
    ElacComputer_B.Data_jj = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_1.Data;
    ElacComputer_B.green_low_pressure = ElacComputer_U.in.discrete_inputs.green_low_pressure;
    ElacComputer_B.SSM_cg = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_2.SSM;
    ElacComputer_B.Data_p5 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_2.Data;
    ElacComputer_B.SSM_be = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_3.SSM;
    ElacComputer_B.Data_ekl = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_3.Data;
    ElacComputer_B.SSM_axb = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_4.SSM;
    ElacComputer_B.Data_nd = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_4.Data;
    ElacComputer_B.SSM_nz = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_5.SSM;
    ElacComputer_B.Data_n2 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_5.Data;
    ElacComputer_B.SSM_cx = ElacComputer_U.in.bus_inputs.fcdc_2_bus.capt_roll_command_deg.SSM;
    ElacComputer_B.Data_dl = ElacComputer_U.in.bus_inputs.fcdc_2_bus.capt_roll_command_deg.Data;
    ElacComputer_B.elac_engaged_from_switch = ElacComputer_U.in.discrete_inputs.elac_engaged_from_switch;
    ElacComputer_B.SSM_gh = ElacComputer_U.in.bus_inputs.fcdc_2_bus.fo_roll_command_deg.SSM;
    ElacComputer_B.Data_gs2 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.fo_roll_command_deg.Data;
    ElacComputer_B.SSM_ks = ElacComputer_U.in.bus_inputs.fcdc_2_bus.rudder_pedal_position_deg.SSM;
    ElacComputer_B.Data_h4 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.rudder_pedal_position_deg.Data;
    ElacComputer_B.SSM_pw = ElacComputer_U.in.bus_inputs.fcdc_2_bus.capt_pitch_command_deg.SSM;
    ElacComputer_B.Data_e3 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.capt_pitch_command_deg.Data;
    ElacComputer_B.SSM_fh = ElacComputer_U.in.bus_inputs.fcdc_2_bus.fo_pitch_command_deg.SSM;
    ElacComputer_B.Data_f5h = ElacComputer_U.in.bus_inputs.fcdc_2_bus.fo_pitch_command_deg.Data;
    ElacComputer_B.SSM_gzn = ElacComputer_U.in.bus_inputs.fcdc_2_bus.aileron_left_pos_deg.SSM;
    ElacComputer_B.Data_an = ElacComputer_U.in.bus_inputs.fcdc_2_bus.aileron_left_pos_deg.Data;
    ...
    ElacComputer_B.SSM_oo = ElacComputer_U.in.bus_inputs.fcdc_2_bus.elevator_left_pos_deg.SSM;
    ElacComputer_B.Data_i4o = ElacComputer_U.in.bus_inputs.fcdc_2_bus.elevator_left_pos_deg.Data;
    ElacComputer_B.SSM_evh = ElacComputer_U.in.bus_inputs.fcdc_2_bus.aileron_right_pos_deg.SSM;
    ElacComputer_B.Data_af = ElacComputer_U.in.bus_inputs.fcdc_2_bus.aileron_right_pos_deg.Data;
    ElacComputer_B.SSM_cn = ElacComputer_U.in.bus_inputs.fcdc_2_bus.elevator_right_pos_deg.SSM;
    ElacComputer_B.Data_bm = ElacComputer_U.in.bus_inputs.fcdc_2_bus.elevator_right_pos_deg.Data;
    ElacComputer_B.SSM_co = ElacComputer_U.in.bus_inputs.fcdc_2_bus.horiz_stab_trim_pos_deg.SSM;
    ElacComputer_B.Data_dk = ElacComputer_U.in.bus_inputs.fcdc_2_bus.horiz_stab_trim_pos_deg.Data;
    ElacComputer_B.SSM_pe = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_1_left_pos_deg.SSM;
    ElacComputer_B.Data_nv = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_1_left_pos_deg.Data;
    ElacComputer_B.capt_pitch_stick_pos = ElacComputer_U.in.analog_inputs.capt_pitch_stick_pos;
    ElacComputer_B.SSM_cgz = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_2_left_pos_deg.SSM;
    ElacComputer_B.Data_jpf = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_2_left_pos_deg.Data;
    ElacComputer_B.SSM_fw = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_3_left_pos_deg.SSM;
    ElacComputer_B.Data_i5 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_3_left_pos_deg.Data;
    ElacComputer_B.SSM_h4 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_4_left_pos_deg.SSM;
    ElacComputer_B.Data_k2 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_4_left_pos_deg.Data;
    ElacComputer_B.SSM_cb3 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_5_left_pos_deg.SSM;
    ElacComputer_B.Data_as = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_5_left_pos_deg.Data;
    ElacComputer_B.SSM_pj = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_1_right_pos_deg.SSM;
    ElacComputer_B.Data_gk = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_1_right_pos_deg.Data;
    ElacComputer_B.fo_pitch_stick_pos = ElacComputer_U.in.analog_inputs.fo_pitch_stick_pos;
    ElacComputer_B.SSM_dv = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_2_right_pos_deg.SSM;
    ElacComputer_B.Data_jl = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_2_right_pos_deg.Data;
    ElacComputer_B.SSM_i4 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_3_right_pos_deg.SSM;
    ElacComputer_B.Data_e32 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_3_right_pos_deg.Data;
    ElacComputer_B.SSM_fm = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_4_right_pos_deg.SSM;
    ElacComputer_B.Data_ih = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_4_right_pos_deg.Data;
    ElacComputer_B.SSM_e5 = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_5_right_pos_deg.SSM;
    ElacComputer_B.Data_du = ElacComputer_U.in.bus_inputs.fcdc_2_bus.spoiler_5_right_pos_deg.Data;
    ElacComputer_B.SSM_bf = ElacComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.SSM;
    ElacComputer_B.Data_nx = ElacComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.Data;
    ElacComputer_B.capt_roll_stick_pos = ElacComputer_U.in.analog_inputs.capt_roll_stick_pos;
    ElacComputer_B.SSM_fd = ElacComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.SSM;
    ElacComputer_B.Data_n0 = ElacComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data;
    ElacComputer_B.SSM_fv = ElacComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.SSM;
    ElacComputer_B.Data_eqi = ElacComputer_U.in.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.Data;
    ElacComputer_B.SSM_dt = ElacComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.SSM;
    ElacComputer_B.Data_om = ElacComputer_U.in.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.Data;
    ElacComputer_B.SSM_j5 = ElacComputer_U.in.bus_inputs.sec_1_bus.left_elevator_position_deg.SSM;
    ElacComputer_B.Data_nr = ElacComputer_U.in.bus_inputs.sec_1_bus.left_elevator_position_deg.Data;
    ElacComputer_B.SSM_ng = ElacComputer_U.in.bus_inputs.sec_1_bus.right_elevator_position_deg.SSM;
    ElacComputer_B.Data_p3 = ElacComputer_U.in.bus_inputs.sec_1_bus.right_elevator_position_deg.Data;
    ElacComputer_B.fo_roll_stick_pos = ElacComputer_U.in.analog_inputs.fo_roll_stick_pos;
    ElacComputer_B.SSM_cs = ElacComputer_U.in.bus_inputs.sec_1_bus.ths_position_deg.SSM;
    ElacComputer_B.Data_nb = ElacComputer_U.in.bus_inputs.sec_1_bus.ths_position_deg.Data;
    ElacComputer_B.SSM_ls = ElacComputer_U.in.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.SSM;
    ElacComputer_B.Data_hd = ElacComputer_U.in.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.Data;
    ElacComputer_B.SSM_dg = ElacComputer_U.in.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.SSM;
    ElacComputer_B.Data_al = ElacComputer_U.in.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.Data;
    ElacComputer_B.SSM_d3 = ElacComputer_U.in.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.SSM;
    ElacComputer_B.Data_gu = ElacComputer_U.in.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.Data;
    ElacComputer_B.SSM_p2 = ElacComputer_U.in.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.SSM;
    ElacComputer_B.Data_ix = ElacComputer_U.in.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.Data;
    ElacComputer_B.left_elevator_pos_deg = ElacComputer_U.in.analog_inputs.left_elevator_pos_deg;
    ElacComputer_B.SSM_bo0 = ElacComputer_U.in.bus_inputs.sec_1_bus.speed_brake_lever_command_deg.SSM;
    ElacComputer_B.Data_do = ElacComputer_U.in.bus_inputs.sec_1_bus.speed_brake_lever_command_deg.Data;
    ElacComputer_B.SSM_bc = ElacComputer_U.in.bus_inputs.sec_1_bus.thrust_lever_angle_1_deg.SSM;
    ElacComputer_B.Data_hu = ElacComputer_U.in.bus_inputs.sec_1_bus.thrust_lever_angle_1_deg.Data;
    ElacComputer_B.SSM_h0 = ElacComputer_U.in.bus_inputs.sec_1_bus.thrust_lever_angle_2_deg.SSM;
    ElacComputer_B.Data_pm1 = ElacComputer_U.in.bus_inputs.sec_1_bus.thrust_lever_angle_2_deg.Data;
    ElacComputer_B.SSM_giz = ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1.SSM;
    ElacComputer_B.Data_i2y = ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1.Data;
    ElacComputer_B.SSM_mqp = ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_2.SSM;
    ElacComputer_B.Data_pg = ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_2.Data;
    ElacComputer_B.right_elevator_pos_deg = ElacComputer_U.in.analog_inputs.right_elevator_pos_deg;
    ElacComputer_B.SSM_ba = ElacComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.SSM;
    ElacComputer_B.Data_ni = ElacComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.Data;
    ElacComputer_B.SSM_in = ElacComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.SSM;
    ElacComputer_B.Data_fr = ElacComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.Data;
    ElacComputer_B.SSM_ff = ElacComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.SSM;
    ElacComputer_B.Data_cn = ElacComputer_U.in.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.Data;
    ElacComputer_B.SSM_ic = ElacComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.SSM;
    ElacComputer_B.Data_nxl = ElacComputer_U.in.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.Data;
    ElacComputer_B.SSM_fs = ElacComputer_U.in.bus_inputs.sec_2_bus.left_elevator_position_deg.SSM;
    ElacComputer_B.Data_jh = ElacComputer_U.in.bus_inputs.sec_2_bus.left_elevator_position_deg.Data;
    ElacComputer_B.ths_pos_deg = ElacComputer_U.in.analog_inputs.ths_pos_deg;
    ElacComputer_B.SSM_ja = ElacComputer_U.in.bus_inputs.sec_2_bus.right_elevator_position_deg.SSM;
    ElacComputer_B.Data_gl = ElacComputer_U.in.bus_inputs.sec_2_bus.right_elevator_position_deg.Data;
    ElacComputer_B.SSM_js = ElacComputer_U.in.bus_inputs.sec_2_bus.ths_position_deg.SSM;
    ElacComputer_B.Data_gn = ElacComputer_U.in.bus_inputs.sec_2_bus.ths_position_deg.Data;
    ElacComputer_B.SSM_is3 = ElacComputer_U.in.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.SSM;
    ElacComputer_B.Data_myb = ElacComputer_U.in.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.Data;
    ElacComputer_B.SSM_ag = ElacComputer_U.in.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.SSM;
    ElacComputer_B.Data_l2 = ElacComputer_U.in.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.Data;
    ElacComputer_B.SSM_f5 = ElacComputer_U.in.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.SSM;
    ElacComputer_B.Data_o5o = ElacComputer_U.in.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.Data;
    ElacComputer_B.left_aileron_pos_deg = ElacComputer_U.in.analog_inputs.left_aileron_pos_deg;
    ElacComputer_B.SSM_ph = ElacComputer_U.in.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.SSM;
    ElacComputer_B.Data_l5 = ElacComputer_U.in.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.Data;
    ElacComputer_B.SSM_jw = ElacComputer_U.in.bus_inputs.sec_2_bus.speed_brake_lever_command_deg.SSM;
    ElacComputer_B.Data_dc2 = ElacComputer_U.in.bus_inputs.sec_2_bus.speed_brake_lever_command_deg.Data;
    ElacComputer_B.SSM_jy = ElacComputer_U.in.bus_inputs.sec_2_bus.thrust_lever_angle_1_deg.SSM;
    ElacComputer_B.Data_gr = ElacComputer_U.in.bus_inputs.sec_2_bus.thrust_lever_angle_1_deg.Data;
    ElacComputer_B.SSM_j1 = ElacComputer_U.in.bus_inputs.sec_2_bus.thrust_lever_angle_2_deg.SSM;
    ElacComputer_B.Data_gp = ElacComputer_U.in.bus_inputs.sec_2_bus.thrust_lever_angle_2_deg.Data;
    ElacComputer_B.SSM_ov = ElacComputer_U.in.bus_inputs.sec_2_bus.discrete_status_word_1.SSM;
    ElacComputer_B.Data_i3 = ElacComputer_U.in.bus_inputs.sec_2_bus.discrete_status_word_1.Data;
    ElacComputer_B.right_aileron_pos_deg = ElacComputer_U.in.analog_inputs.right_aileron_pos_deg;
    ElacComputer_B.SSM_mx = ElacComputer_U.in.bus_inputs.sec_2_bus.discrete_status_word_2.SSM;
    ElacComputer_B.Data_et = ElacComputer_U.in.bus_inputs.sec_2_bus.discrete_status_word_2.Data;
    ElacComputer_B.SSM_b4 = ElacComputer_U.in.bus_inputs.elac_opp_bus.left_aileron_position_deg.SSM;
    ElacComputer_B.Data_mc = ElacComputer_U.in.bus_inputs.elac_opp_bus.left_aileron_position_deg.Data;
    ElacComputer_B.SSM_gb = ElacComputer_U.in.bus_inputs.elac_opp_bus.right_aileron_position_deg.SSM;
    ElacComputer_B.Data_k3 = ElacComputer_U.in.bus_inputs.elac_opp_bus.right_aileron_position_deg.Data;
    ElacComputer_B.SSM_oh = ElacComputer_U.in.bus_inputs.elac_opp_bus.left_elevator_position_deg.SSM;
    ElacComputer_B.Data_f2 = ElacComputer_U.in.bus_inputs.elac_opp_bus.left_elevator_position_deg.Data;
    ElacComputer_B.SSM_mm5 = ElacComputer_U.in.bus_inputs.elac_opp_bus.right_elevator_position_deg.SSM;
    ElacComputer_B.Data_gh = ElacComputer_U.in.bus_inputs.elac_opp_bus.right_elevator_position_deg.Data;
    ...
    ElacComputer_B.SSM_br = ElacComputer_U.in.bus_inputs.elac_opp_bus.ths_position_deg.SSM;
    ElacComputer_B.Data_ed = ElacComputer_U.in.bus_inputs.elac_opp_bus.ths_position_deg.Data;
    ElacComputer_B.SSM_c2 = ElacComputer_U.in.bus_inputs.elac_opp_bus.left_sidestick_pitch_command_deg.SSM;
    ElacComputer_B.Data_o2j = ElacComputer_U.in.bus_inputs.elac_opp_bus.left_sidestick_pitch_command_deg.Data;
    ElacComputer_B.SSM_hc = ElacComputer_U.in.bus_inputs.elac_opp_bus.right_sidestick_pitch_command_deg.SSM;
    ElacComputer_B.Data_i43 = ElacComputer_U.in.bus_inputs.elac_opp_bus.right_sidestick_pitch_command_deg.Data;
    ElacComputer_B.SSM_ktr = ElacComputer_U.in.bus_inputs.elac_opp_bus.left_sidestick_roll_command_deg.SSM;
    ElacComputer_B.Data_ic = ElacComputer_U.in.bus_inputs.elac_opp_bus.left_sidestick_roll_command_deg.Data;
    ElacComputer_B.SSM_gl = ElacComputer_U.in.bus_inputs.elac_opp_bus.right_sidestick_roll_command_deg.SSM;
    ElacComputer_B.Data_ak = ElacComputer_U.in.bus_inputs.elac_opp_bus.right_sidestick_roll_command_deg.Data;
    ElacComputer_B.load_factor_acc_1_g = ElacComputer_U.in.analog_inputs.load_factor_acc_1_g;
    ElacComputer_B.SSM_my = ElacComputer_U.in.bus_inputs.elac_opp_bus.rudder_pedal_position_deg.SSM;
    ElacComputer_B.Data_jg = ElacComputer_U.in.bus_inputs.elac_opp_bus.rudder_pedal_position_deg.Data;
    ElacComputer_B.SSM_j3 = ElacComputer_U.in.bus_inputs.elac_opp_bus.aileron_command_deg.SSM;
    ElacComputer_B.Data_cu = ElacComputer_U.in.bus_inputs.elac_opp_bus.aileron_command_deg.Data;
    ElacComputer_B.SSM_go = ElacComputer_U.in.bus_inputs.elac_opp_bus.roll_spoiler_command_deg.SSM;
    ElacComputer_B.Data_ep = ElacComputer_U.in.bus_inputs.elac_opp_bus.roll_spoiler_command_deg.Data;
    ElacComputer_B.SSM_e5c = ElacComputer_U.in.bus_inputs.elac_opp_bus.yaw_damper_command_deg.SSM;
    ElacComputer_B.Data_d3 = ElacComputer_U.in.bus_inputs.elac_opp_bus.yaw_damper_command_deg.Data;
    ElacComputer_B.SSM_dk = ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_1.SSM;
    ElacComputer_B.Data_bt = ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_1.Data;
    ElacComputer_B.load_factor_acc_2_g = ElacComputer_U.in.analog_inputs.load_factor_acc_2_g;
    ElacComputer_B.SSM_evc = ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2.SSM;
    ElacComputer_B.Data_e0 = ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2.Data;
    ...
    ElacComputer_B.SSM_kk = ElacComputer_U.in.bus_inputs.adr_1_bus.altitude_standard_ft.SSM;
    ElacComputer_B.Data_jl3 = ElacComputer_U.in.bus_inputs.adr_1_bus.altitude_standard_ft.Data;
    ElacComputer_B.SSM_af = ElacComputer_U.in.bus_inputs.adr_1_bus.altitude_corrected_ft.SSM;
    ElacComputer_B.Data_nm = ElacComputer_U.in.bus_inputs.adr_1_bus.altitude_corrected_ft.Data;
    ElacComputer_B.tracking_mode_on_override = ElacComputer_U.in.sim_data.tracking_mode_on_override;
    ElacComputer_B.SSM_npr = ElacComputer_U.in.bus_inputs.adr_1_bus.mach.SSM;
    ElacComputer_B.Data_ia = ElacComputer_U.in.bus_inputs.adr_1_bus.mach.Data;
    ElacComputer_B.SSM_ew = ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.SSM;
    ElacComputer_B.Data_j0 = ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data;
    ElacComputer_B.SSM_lt = ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_true_kn.SSM;
    ElacComputer_B.Data_bs = ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_true_kn.Data;
    ElacComputer_B.SSM_ger = ElacComputer_U.in.bus_inputs.adr_1_bus.vertical_speed_ft_min.SSM;
    ElacComputer_B.Data_hp = ElacComputer_U.in.bus_inputs.adr_1_bus.vertical_speed_ft_min.Data;
    ElacComputer_B.SSM_pxo = ElacComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.SSM;
    ElacComputer_B.Data_ct = ElacComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data;
    ElacComputer_B.tailstrike_protection_on = ElacComputer_U.in.sim_data.tailstrike_protection_on;
    ElacComputer_B.SSM_co2 = ElacComputer_U.in.bus_inputs.adr_2_bus.altitude_standard_ft.SSM;
    ElacComputer_B.Data_pc = ElacComputer_U.in.bus_inputs.adr_2_bus.altitude_standard_ft.Data;
    ElacComputer_B.SSM_ny = ElacComputer_U.in.bus_inputs.adr_2_bus.altitude_corrected_ft.SSM;
    ElacComputer_B.Data_nzt = ElacComputer_U.in.bus_inputs.adr_2_bus.altitude_corrected_ft.Data;
    ElacComputer_B.SSM_l4 = ElacComputer_U.in.bus_inputs.adr_2_bus.mach.SSM;
    ElacComputer_B.Data_c0 = ElacComputer_U.in.bus_inputs.adr_2_bus.mach.Data;
    ElacComputer_B.SSM_nm = ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.SSM;
    ElacComputer_B.Data_ojg = ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.Data;
    ElacComputer_B.SSM_nh = ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.SSM;
    ElacComputer_B.Data_lm = ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
    ElacComputer_B.computer_running = ElacComputer_U.in.sim_data.computer_running;
    ElacComputer_B.SSM_dl = ElacComputer_U.in.bus_inputs.adr_2_bus.vertical_speed_ft_min.SSM;
    ElacComputer_B.Data_fz = ElacComputer_U.in.bus_inputs.adr_2_bus.vertical_speed_ft_min.Data;
    ElacComputer_B.SSM_dx = ElacComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM;
    ElacComputer_B.Data_oz = ElacComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
    ElacComputer_B.SSM_a5h = ElacComputer_U.in.bus_inputs.adr_3_bus.altitude_standard_ft.SSM;
    ElacComputer_B.Data_gf = ElacComputer_U.in.bus_inputs.adr_3_bus.altitude_standard_ft.Data;
    ElacComputer_B.SSM_fl = ElacComputer_U.in.bus_inputs.adr_3_bus.altitude_corrected_ft.SSM;
    ElacComputer_B.Data_nn = ElacComputer_U.in.bus_inputs.adr_3_bus.altitude_corrected_ft.Data;
    ElacComputer_B.SSM_p3 = ElacComputer_U.in.bus_inputs.adr_3_bus.mach.SSM;
    ElacComputer_B.Data_a0z = ElacComputer_U.in.bus_inputs.adr_3_bus.mach.Data;
    ElacComputer_B.ground_spoilers_active_1 = ElacComputer_U.in.discrete_inputs.ground_spoilers_active_1;
    ElacComputer_B.SSM_ns = ElacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM;
    ElacComputer_B.Data_fk = ElacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.Data;
    ElacComputer_B.SSM_bm = ElacComputer_U.in.bus_inputs.adr_3_bus.airspeed_true_kn.SSM;
    ElacComputer_B.Data_bu = ElacComputer_U.in.bus_inputs.adr_3_bus.airspeed_true_kn.Data;
    ElacComputer_B.SSM_nl = ElacComputer_U.in.bus_inputs.adr_3_bus.vertical_speed_ft_min.SSM;
    ElacComputer_B.Data_o23 = ElacComputer_U.in.bus_inputs.adr_3_bus.vertical_speed_ft_min.Data;
    ElacComputer_B.SSM_grm = ElacComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.SSM;
    ElacComputer_B.Data_g3 = ElacComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.Data;
    ElacComputer_B.SSM_gzm = ElacComputer_U.in.bus_inputs.ir_1_bus.discrete_word_1.SSM;
    ElacComputer_B.Data_icc = ElacComputer_U.in.bus_inputs.ir_1_bus.discrete_word_1.Data;
  ...
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.altitude_standard_ft.SSM = ElacComputer_B.SSM_kk;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.altitude_standard_ft.Data = ElacComputer_B.Data_jl3;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.altitude_corrected_ft.SSM = ElacComputer_B.SSM_af;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.altitude_corrected_ft.Data = ElacComputer_B.Data_nm;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.mach.SSM = ElacComputer_B.SSM_npr;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.mach.Data = ElacComputer_B.Data_ia;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.airspeed_computed_kn.SSM = ElacComputer_B.SSM_ew;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.airspeed_computed_kn.Data = ElacComputer_B.Data_j0;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.airspeed_true_kn.SSM = ElacComputer_B.SSM_lt;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.airspeed_true_kn.Data = ElacComputer_B.Data_bs;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.vertical_speed_ft_min.SSM = ElacComputer_B.SSM_ger;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.vertical_speed_ft_min.Data = ElacComputer_B.Data_hp;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.aoa_corrected_deg.SSM = ElacComputer_B.SSM_pxo;
  ElacComputer_Y.out.data.bus_inputs.adr_1_bus.aoa_corrected_deg.Data = ElacComputer_B.Data_ct;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.altitude_standard_ft.SSM = ElacComputer_B.SSM_co2;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.altitude_standard_ft.Data = ElacComputer_B.Data_pc;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.altitude_corrected_ft.SSM = ElacComputer_B.SSM_ny;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.altitude_corrected_ft.Data = ElacComputer_B.Data_nzt;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.mach.SSM = ElacComputer_B.SSM_l4;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.mach.Data = ElacComputer_B.Data_c0;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_computed_kn.SSM = ElacComputer_B.SSM_nm;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_computed_kn.Data = ElacComputer_B.Data_ojg;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_true_kn.SSM = ElacComputer_B.SSM_nh;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.airspeed_true_kn.Data = ElacComputer_B.Data_lm;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.SSM = ElacComputer_B.SSM_dl;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.Data = ElacComputer_B.Data_fz;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM = ElacComputer_B.SSM_dx;
  ElacComputer_Y.out.data.bus_inputs.adr_2_bus.aoa_corrected_deg.Data = ElacComputer_B.Data_oz;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.altitude_standard_ft.SSM = ElacComputer_B.SSM_a5h;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.altitude_standard_ft.Data = ElacComputer_B.Data_gf;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.altitude_corrected_ft.SSM = ElacComputer_B.SSM_fl;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.altitude_corrected_ft.Data = ElacComputer_B.Data_nn;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.mach.SSM = ElacComputer_B.SSM_p3;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.mach.Data = ElacComputer_B.Data_a0z;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM = ElacComputer_B.SSM_ns;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.airspeed_computed_kn.Data = ElacComputer_B.Data_fk;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.airspeed_true_kn.SSM = ElacComputer_B.SSM_bm;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.airspeed_true_kn.Data = ElacComputer_B.Data_bu;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.vertical_speed_ft_min.SSM = ElacComputer_B.SSM_nl;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.vertical_speed_ft_min.Data = ElacComputer_B.Data_o23;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.aoa_corrected_deg.SSM = ElacComputer_B.SSM_grm;
  ElacComputer_Y.out.data.bus_inputs.adr_3_bus.aoa_corrected_deg.Data = ElacComputer_B.Data_g3;
  ElacComputer_Y.out.data.bus_inputs.ir_1_bus.discrete_word_1.SSM = ElacComputer_B.SSM_gzm;
  ElacComputer_Y.out.data.bus_inputs.ir_1_bus.discrete_word_1.Data = ElacComputer_B.Data_icc;
  ...
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.fg_radio_height_ft.SSM = ElacComputer_B.SSM_cui;
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.fg_radio_height_ft.Data = ElacComputer_B.Data_of;
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.delta_p_ail_cmd_deg.SSM = ElacComputer_B.SSM_mq;
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.delta_p_ail_cmd_deg.Data = ElacComputer_B.Data_lg;
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.delta_p_splr_cmd_deg.SSM = ElacComputer_B.SSM_ni;
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.delta_p_splr_cmd_deg.Data = ElacComputer_B.Data_n4;
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.delta_r_cmd_deg.SSM = ElacComputer_B.SSM_df;
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.delta_r_cmd_deg.Data = ElacComputer_B.Data_ot;
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.delta_q_cmd_deg.SSM = ElacComputer_B.SSM_oe;
  ElacComputer_Y.out.data.bus_inputs.fmgc_1_bus.delta_q_cmd_deg.Data = ElacComputer_B.Data_gv;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.fg_radio_height_ft.SSM = ElacComputer_B.SSM_ha;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.fg_radio_height_ft.Data = ElacComputer_B.Data_ou;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.delta_p_ail_cmd_deg.SSM = ElacComputer_B.SSM_op;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.delta_p_ail_cmd_deg.Data = ElacComputer_B.Data_dh;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.delta_p_splr_cmd_deg.SSM = ElacComputer_B.SSM_a50;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.delta_p_splr_cmd_deg.Data = ElacComputer_B.Data_ph;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.delta_r_cmd_deg.SSM = ElacComputer_B.SSM_og;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.delta_r_cmd_deg.Data = ElacComputer_B.Data_gs;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.delta_q_cmd_deg.SSM = ElacComputer_B.SSM_a4;
  ElacComputer_Y.out.data.bus_inputs.fmgc_2_bus.delta_q_cmd_deg.Data = ElacComputer_B.Data_fd4;
  ElacComputer_Y.out.data.bus_inputs.ra_1_bus.radio_height_ft.SSM = ElacComputer_B.SSM_bv;
  ElacComputer_Y.out.data.bus_inputs.ra_1_bus.radio_height_ft.Data = ElacComputer_B.Data_hm;
  ElacComputer_Y.out.data.bus_inputs.ra_2_bus.radio_height_ft.SSM = ElacComputer_B.SSM_bo;
  ElacComputer_Y.out.data.bus_inputs.ra_2_bus.radio_height_ft.Data = ElacComputer_B.Data_i2;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.slat_flap_component_status_word.SSM = ElacComputer_B.SSM_d1;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.slat_flap_component_status_word.Data = ElacComputer_B.Data_og;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word.SSM = ElacComputer_B.SSM_hy;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word.Data = ElacComputer_B.Data_fv;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word.SSM = ElacComputer_B.SSM_gi;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word.Data = ElacComputer_B.Data_oc;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.slat_actual_position_deg.SSM = ElacComputer_B.SSM_pp;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.slat_actual_position_deg.Data = ElacComputer_B.Data_kq;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.flap_actual_position_deg.SSM = ElacComputer_B.SSM_iab;
  ElacComputer_Y.out.data.bus_inputs.sfcc_1_bus.flap_actual_position_deg.Data = ElacComputer_B.Data_ne;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.slat_flap_component_status_word.SSM = ElacComputer_B.SSM_jtv;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.slat_flap_component_status_word.Data = ElacComputer_B.Data_it;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.slat_flap_system_status_word.SSM = ElacComputer_B.SSM_fy;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.slat_flap_system_status_word.Data = ElacComputer_B.Data_ch;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word.SSM = ElacComputer_B.SSM_d4;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word.Data = ElacComputer_B.Data_bb;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.slat_actual_position_deg.SSM = ElacComputer_B.SSM_ars;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.slat_actual_position_deg.Data = ElacComputer_B.Data_ol;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.flap_actual_position_deg.SSM = ElacComputer_B.SSM_din;
  ElacComputer_Y.out.data.bus_inputs.sfcc_2_bus.flap_actual_position_deg.Data = ElacComputer_B.Data_hw;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_1.SSM = ElacComputer_B.SSM_m3;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_1.Data = ElacComputer_B.Data_hs;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_2.SSM = ElacComputer_B.SSM_np;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_2.Data = ElacComputer_B.Data_fj;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_3.SSM = ElacComputer_B.SSM_ax;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_3.Data = ElacComputer_B.Data_ky;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_4.SSM = ElacComputer_B.SSM_cl;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_4.Data = ElacComputer_B.Data_h5;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_5.SSM = ElacComputer_B.SSM_es;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.efcs_status_word_5.Data = ElacComputer_B.Data_ku;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.capt_roll_command_deg.SSM = ElacComputer_B.SSM_gi1;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.capt_roll_command_deg.Data = ElacComputer_B.Data_jp;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.fo_roll_command_deg.SSM = ElacComputer_B.SSM_jz;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.fo_roll_command_deg.Data = ElacComputer_B.Data_nu;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.rudder_pedal_position_deg.SSM = ElacComputer_B.SSM_kt;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.rudder_pedal_position_deg.Data = ElacComputer_B.Data_br;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.capt_pitch_command_deg.SSM = ElacComputer_B.SSM_ds;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.capt_pitch_command_deg.Data = ElacComputer_B.Data_ae;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.fo_pitch_command_deg.SSM = ElacComputer_B.SSM_eg;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.fo_pitch_command_deg.Data = ElacComputer_B.Data_pe;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.aileron_left_pos_deg.SSM = ElacComputer_B.SSM_a0;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.aileron_left_pos_deg.Data = ElacComputer_B.Data_fy;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.elevator_left_pos_deg.SSM = ElacComputer_B.SSM_cv;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.elevator_left_pos_deg.Data = ElacComputer_B.Data_na;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.aileron_right_pos_deg.SSM = ElacComputer_B.SSM_ea;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.aileron_right_pos_deg.Data = ElacComputer_B.Data_my;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.elevator_right_pos_deg.SSM = ElacComputer_B.SSM_p4;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.elevator_right_pos_deg.Data = ElacComputer_B.Data_i4;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.horiz_stab_trim_pos_deg.SSM = ElacComputer_B.SSM_m2;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.horiz_stab_trim_pos_deg.Data = ElacComputer_B.Data_cx;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_1_left_pos_deg.SSM = ElacComputer_B.SSM_bt0;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_1_left_pos_deg.Data = ElacComputer_B.Data_nz;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_2_left_pos_deg.SSM = ElacComputer_B.SSM_nr;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_2_left_pos_deg.Data = ElacComputer_B.Data_id;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_3_left_pos_deg.SSM = ElacComputer_B.SSM_fr;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_3_left_pos_deg.Data = ElacComputer_B.Data_o2;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_4_left_pos_deg.SSM = ElacComputer_B.SSM_cc;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_4_left_pos_deg.Data = ElacComputer_B.Data_gqq;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_5_left_pos_deg.SSM = ElacComputer_B.SSM_lm;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_5_left_pos_deg.Data = ElacComputer_B.Data_md;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_1_right_pos_deg.SSM = ElacComputer_B.SSM_mkm;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_1_right_pos_deg.Data = ElacComputer_B.Data_cz;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_2_right_pos_deg.SSM = ElacComputer_B.SSM_jhd;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_2_right_pos_deg.Data = ElacComputer_B.Data_pm;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_3_right_pos_deg.SSM = ElacComputer_B.SSM_av;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_3_right_pos_deg.Data = ElacComputer_B.Data_bj;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_4_right_pos_deg.SSM = ElacComputer_B.SSM_ira;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_4_right_pos_deg.Data = ElacComputer_B.Data_ox;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_5_right_pos_deg.SSM = ElacComputer_B.SSM_ge;
  ElacComputer_Y.out.data.bus_inputs.fcdc_1_bus.spoiler_5_right_pos_deg.Data = ElacComputer_B.Data_pe5;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_1.SSM = ElacComputer_B.SSM_lv;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_1.Data = ElacComputer_B.Data_jj;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_2.SSM = ElacComputer_B.SSM_cg;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_2.Data = ElacComputer_B.Data_p5;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_3.SSM = ElacComputer_B.SSM_be;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_3.Data = ElacComputer_B.Data_ekl;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_4.SSM = ElacComputer_B.SSM_axb;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_4.Data = ElacComputer_B.Data_nd;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_5.SSM = ElacComputer_B.SSM_nz;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.efcs_status_word_5.Data = ElacComputer_B.Data_n2;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.capt_roll_command_deg.SSM = ElacComputer_B.SSM_cx;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.capt_roll_command_deg.Data = ElacComputer_B.Data_dl;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.fo_roll_command_deg.SSM = ElacComputer_B.SSM_gh;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.fo_roll_command_deg.Data = ElacComputer_B.Data_gs2;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.rudder_pedal_position_deg.SSM = ElacComputer_B.SSM_ks;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.rudder_pedal_position_deg.Data = ElacComputer_B.Data_h4;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.capt_pitch_command_deg.SSM = ElacComputer_B.SSM_pw;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.capt_pitch_command_deg.Data = ElacComputer_B.Data_e3;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.fo_pitch_command_deg.SSM = ElacComputer_B.SSM_fh;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.fo_pitch_command_deg.Data = ElacComputer_B.Data_f5h;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.aileron_left_pos_deg.SSM = ElacComputer_B.SSM_gzn;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.aileron_left_pos_deg.Data = ElacComputer_B.Data_an;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.elevator_left_pos_deg.SSM = ElacComputer_B.SSM_oo;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.elevator_left_pos_deg.Data = ElacComputer_B.Data_i4o;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.aileron_right_pos_deg.SSM = ElacComputer_B.SSM_evh;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.aileron_right_pos_deg.Data = ElacComputer_B.Data_af;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.elevator_right_pos_deg.SSM = ElacComputer_B.SSM_cn;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.elevator_right_pos_deg.Data = ElacComputer_B.Data_bm;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.horiz_stab_trim_pos_deg.SSM = ElacComputer_B.SSM_co;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.horiz_stab_trim_pos_deg.Data = ElacComputer_B.Data_dk;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_1_left_pos_deg.SSM = ElacComputer_B.SSM_pe;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_1_left_pos_deg.Data = ElacComputer_B.Data_nv;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_2_left_pos_deg.SSM = ElacComputer_B.SSM_cgz;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_2_left_pos_deg.Data = ElacComputer_B.Data_jpf;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_3_left_pos_deg.SSM = ElacComputer_B.SSM_fw;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_3_left_pos_deg.Data = ElacComputer_B.Data_i5;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_4_left_pos_deg.SSM = ElacComputer_B.SSM_h4;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_4_left_pos_deg.Data = ElacComputer_B.Data_k2;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_5_left_pos_deg.SSM = ElacComputer_B.SSM_cb3;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_5_left_pos_deg.Data = ElacComputer_B.Data_as;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_1_right_pos_deg.SSM = ElacComputer_B.SSM_pj;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_1_right_pos_deg.Data = ElacComputer_B.Data_gk;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_2_right_pos_deg.SSM = ElacComputer_B.SSM_dv;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_2_right_pos_deg.Data = ElacComputer_B.Data_jl;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_3_right_pos_deg.SSM = ElacComputer_B.SSM_i4;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_3_right_pos_deg.Data = ElacComputer_B.Data_e32;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_4_right_pos_deg.SSM = ElacComputer_B.SSM_fm;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_4_right_pos_deg.Data = ElacComputer_B.Data_ih;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_5_right_pos_deg.SSM = ElacComputer_B.SSM_e5;
  ElacComputer_Y.out.data.bus_inputs.fcdc_2_bus.spoiler_5_right_pos_deg.Data = ElacComputer_B.Data_du;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.SSM = ElacComputer_B.SSM_bf;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.Data = ElacComputer_B.Data_nx;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.SSM = ElacComputer_B.SSM_fd;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data = ElacComputer_B.Data_n0;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.SSM = ElacComputer_B.SSM_fv;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.Data = ElacComputer_B.Data_eqi;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.SSM = ElacComputer_B.SSM_dt;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.Data = ElacComputer_B.Data_om;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_elevator_position_deg.SSM = ElacComputer_B.SSM_j5;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_elevator_position_deg.Data = ElacComputer_B.Data_nr;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_elevator_position_deg.SSM = ElacComputer_B.SSM_ng;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_elevator_position_deg.Data = ElacComputer_B.Data_p3;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.ths_position_deg.SSM = ElacComputer_B.SSM_cs;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.ths_position_deg.Data = ElacComputer_B.Data_nb;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.SSM = ElacComputer_B.SSM_ls;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.Data = ElacComputer_B.Data_hd;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.SSM = ElacComputer_B.SSM_dg;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.Data = ElacComputer_B.Data_al;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.SSM = ElacComputer_B.SSM_d3;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.Data = ElacComputer_B.Data_gu;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.SSM = ElacComputer_B.SSM_p2;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.Data = ElacComputer_B.Data_ix;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.speed_brake_lever_command_deg.SSM = ElacComputer_B.SSM_bo0;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.speed_brake_lever_command_deg.Data = ElacComputer_B.Data_do;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.thrust_lever_angle_1_deg.SSM = ElacComputer_B.SSM_bc;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.thrust_lever_angle_1_deg.Data = ElacComputer_B.Data_hu;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.thrust_lever_angle_2_deg.SSM = ElacComputer_B.SSM_h0;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.thrust_lever_angle_2_deg.Data = ElacComputer_B.Data_pm1;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.discrete_status_word_1.SSM = ElacComputer_B.SSM_giz;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.discrete_status_word_1.Data = ElacComputer_B.Data_i2y;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.discrete_status_word_2.SSM = ElacComputer_B.SSM_mqp;
  ElacComputer_Y.out.data.bus_inputs.sec_1_bus.discrete_status_word_2.Data = ElacComputer_B.Data_pg;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.SSM = ElacComputer_B.SSM_ba;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.Data = ElacComputer_B.Data_ni;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.SSM = ElacComputer_B.SSM_in;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.Data = ElacComputer_B.Data_fr;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.SSM = ElacComputer_B.SSM_ff;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.Data = ElacComputer_B.Data_cn;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.SSM = ElacComputer_B.SSM_ic;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.Data = ElacComputer_B.Data_nxl;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_elevator_position_deg.SSM = ElacComputer_B.SSM_fs;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_elevator_position_deg.Data = ElacComputer_B.Data_jh;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_elevator_position_deg.SSM = ElacComputer_B.SSM_ja;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_elevator_position_deg.Data = ElacComputer_B.Data_gl;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.ths_position_deg.SSM = ElacComputer_B.SSM_js;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.ths_position_deg.Data = ElacComputer_B.Data_gn;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.SSM = ElacComputer_B.SSM_is3;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.Data = ElacComputer_B.Data_myb;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.SSM = ElacComputer_B.SSM_ag;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.Data = ElacComputer_B.Data_l2;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.SSM = ElacComputer_B.SSM_f5;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.Data = ElacComputer_B.Data_o5o;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.SSM = ElacComputer_B.SSM_ph;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.Data = ElacComputer_B.Data_l5;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.speed_brake_lever_command_deg.SSM = ElacComputer_B.SSM_jw;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.speed_brake_lever_command_deg.Data = ElacComputer_B.Data_dc2;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.thrust_lever_angle_1_deg.SSM = ElacComputer_B.SSM_jy;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.thrust_lever_angle_1_deg.Data = ElacComputer_B.Data_gr;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.thrust_lever_angle_2_deg.SSM = ElacComputer_B.SSM_j1;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.thrust_lever_angle_2_deg.Data = ElacComputer_B.Data_gp;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.discrete_status_word_1.SSM = ElacComputer_B.SSM_ov;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.discrete_status_word_1.Data = ElacComputer_B.Data_i3;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.discrete_status_word_2.SSM = ElacComputer_B.SSM_mx;
  ElacComputer_Y.out.data.bus_inputs.sec_2_bus.discrete_status_word_2.Data = ElacComputer_B.Data_et;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.left_aileron_position_deg.SSM = ElacComputer_B.SSM_b4;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.left_aileron_position_deg.Data = ElacComputer_B.Data_mc;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.right_aileron_position_deg.SSM = ElacComputer_B.SSM_gb;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.right_aileron_position_deg.Data = ElacComputer_B.Data_k3;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.left_elevator_position_deg.SSM = ElacComputer_B.SSM_oh;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.left_elevator_position_deg.Data = ElacComputer_B.Data_f2;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.right_elevator_position_deg.SSM = ElacComputer_B.SSM_mm5;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.right_elevator_position_deg.Data = ElacComputer_B.Data_gh;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.ths_position_deg.SSM = ElacComputer_B.SSM_br;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.ths_position_deg.Data = ElacComputer_B.Data_ed;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.left_sidestick_pitch_command_deg.SSM = ElacComputer_B.SSM_c2;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.left_sidestick_pitch_command_deg.Data = ElacComputer_B.Data_o2j;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.right_sidestick_pitch_command_deg.SSM = ElacComputer_B.SSM_hc;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.right_sidestick_pitch_command_deg.Data = ElacComputer_B.Data_i43;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.left_sidestick_roll_command_deg.SSM = ElacComputer_B.SSM_ktr;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.left_sidestick_roll_command_deg.Data = ElacComputer_B.Data_ic;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.right_sidestick_roll_command_deg.SSM = ElacComputer_B.SSM_gl;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.right_sidestick_roll_command_deg.Data = ElacComputer_B.Data_ak;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.rudder_pedal_position_deg.SSM = ElacComputer_B.SSM_my;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.rudder_pedal_position_deg.Data = ElacComputer_B.Data_jg;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.aileron_command_deg.SSM = ElacComputer_B.SSM_j3;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.aileron_command_deg.Data = ElacComputer_B.Data_cu;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.roll_spoiler_command_deg.SSM = ElacComputer_B.SSM_go;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.roll_spoiler_command_deg.Data = ElacComputer_B.Data_ep;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.yaw_damper_command_deg.SSM = ElacComputer_B.SSM_e5c;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.yaw_damper_command_deg.Data = ElacComputer_B.Data_d3;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.discrete_status_word_1.SSM = ElacComputer_B.SSM_dk;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.discrete_status_word_1.Data = ElacComputer_B.Data_bt;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.discrete_status_word_2.SSM = ElacComputer_B.SSM_evc;
  ElacComputer_Y.out.data.bus_inputs.elac_opp_bus.discrete_status_word_2.Data = ElacComputer_B.Data_e0;
...
void ElacComputer::initialize()
{
  ...
  ElacComputer_B.SSM_kk = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.altitude_standard_ft.SSM;
  ElacComputer_B.Data_jl3 = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.altitude_standard_ft.Data;
  ElacComputer_B.SSM_af = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.altitude_corrected_ft.SSM;
  ElacComputer_B.Data_nm = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.altitude_corrected_ft.Data;
  ElacComputer_B.SSM_npr = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.mach.SSM;
  ElacComputer_B.Data_ia = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.mach.Data;
  ElacComputer_B.SSM_ew = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.airspeed_computed_kn.SSM;
  ElacComputer_B.Data_j0 = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.airspeed_computed_kn.Data;
  ElacComputer_B.SSM_lt = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.airspeed_true_kn.SSM;
  ElacComputer_B.Data_bs = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.airspeed_true_kn.Data;
  ElacComputer_B.SSM_ger = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.vertical_speed_ft_min.SSM;
  ElacComputer_B.Data_hp = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.vertical_speed_ft_min.Data;
  ElacComputer_B.SSM_pxo = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.aoa_corrected_deg.SSM;
  ElacComputer_B.Data_ct = ElacComputer_P.out_Y0.data.bus_inputs.adr_1_bus.aoa_corrected_deg.Data;
  ElacComputer_B.SSM_co2 = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.altitude_standard_ft.SSM;
  ElacComputer_B.Data_pc = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.altitude_standard_ft.Data;
  ElacComputer_B.SSM_ny = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.altitude_corrected_ft.SSM;
  ElacComputer_B.Data_nzt = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.altitude_corrected_ft.Data;
  ElacComputer_B.SSM_l4 = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.mach.SSM;
  ElacComputer_B.Data_c0 = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.mach.Data;
  ElacComputer_B.SSM_nm = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_computed_kn.SSM;
  ElacComputer_B.Data_ojg = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_computed_kn.Data;
  ElacComputer_B.SSM_nh = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_true_kn.SSM;
  ElacComputer_B.Data_lm = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
  ElacComputer_B.SSM_dl = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.SSM;
  ElacComputer_B.Data_fz = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.vertical_speed_ft_min.Data;
  ElacComputer_B.SSM_dx = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.aoa_corrected_deg.SSM;
  ElacComputer_B.Data_oz = ElacComputer_P.out_Y0.data.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
  ElacComputer_B.SSM_a5h = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.altitude_standard_ft.SSM;
  ElacComputer_B.Data_gf = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.altitude_standard_ft.Data;
  ElacComputer_B.SSM_fl = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.altitude_corrected_ft.SSM;
  ElacComputer_B.Data_nn = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.altitude_corrected_ft.Data;
  ElacComputer_B.SSM_p3 = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.mach.SSM;
  ElacComputer_B.Data_a0z = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.mach.Data;
  ElacComputer_B.SSM_ns = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM;
  ElacComputer_B.Data_fk = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.airspeed_computed_kn.Data;
  ElacComputer_B.SSM_bm = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.airspeed_true_kn.SSM;
  ElacComputer_B.Data_bu = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.airspeed_true_kn.Data;
  ElacComputer_B.SSM_nl = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.vertical_speed_ft_min.SSM;
  ElacComputer_B.Data_o23 = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.vertical_speed_ft_min.Data;
  ElacComputer_B.SSM_grm = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.aoa_corrected_deg.SSM;
  ElacComputer_B.Data_g3 = ElacComputer_P.out_Y0.data.bus_inputs.adr_3_bus.aoa_corrected_deg.Data;
  ElacComputer_B.SSM_gzm = ElacComputer_P.out_Y0.data.bus_inputs.ir_1_bus.discrete_word_1.SSM;
  ElacComputer_B.Data_icc = ElacComputer_P.out_Y0.data.bus_inputs.ir_1_bus.discrete_word_1.Data;
  ...
  ElacComputer_B.SSM_cui = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.fg_radio_height_ft.SSM;
  ElacComputer_B.Data_of = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.fg_radio_height_ft.Data;
  ElacComputer_B.SSM_mq = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.delta_p_ail_cmd_deg.SSM;
  ElacComputer_B.Data_lg = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.delta_p_ail_cmd_deg.Data;
  ElacComputer_B.SSM_ni = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.delta_p_splr_cmd_deg.SSM;
  ElacComputer_B.Data_n4 = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.delta_p_splr_cmd_deg.Data;
  ElacComputer_B.SSM_df = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.delta_r_cmd_deg.SSM;
  ElacComputer_B.Data_ot = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.delta_r_cmd_deg.Data;
  ElacComputer_B.SSM_oe = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.delta_q_cmd_deg.SSM;
  ElacComputer_B.Data_gv = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_1_bus.delta_q_cmd_deg.Data;
  ElacComputer_B.SSM_ha = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.fg_radio_height_ft.SSM;
  ElacComputer_B.Data_ou = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.fg_radio_height_ft.Data;
  ElacComputer_B.SSM_op = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.delta_p_ail_cmd_deg.SSM;
  ElacComputer_B.Data_dh = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.delta_p_ail_cmd_deg.Data;
  ElacComputer_B.SSM_a50 = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.delta_p_splr_cmd_deg.SSM;
  ElacComputer_B.Data_ph = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.delta_p_splr_cmd_deg.Data;
  ElacComputer_B.SSM_og = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.delta_r_cmd_deg.SSM;
  ElacComputer_B.Data_gs = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.delta_r_cmd_deg.Data;
  ElacComputer_B.SSM_a4 = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.delta_q_cmd_deg.SSM;
  ElacComputer_B.Data_fd4 = ElacComputer_P.out_Y0.data.bus_inputs.fmgc_2_bus.delta_q_cmd_deg.Data;
  ElacComputer_B.SSM_bv = ElacComputer_P.out_Y0.data.bus_inputs.ra_1_bus.radio_height_ft.SSM;
  ElacComputer_B.Data_hm = ElacComputer_P.out_Y0.data.bus_inputs.ra_1_bus.radio_height_ft.Data;
  ElacComputer_B.SSM_bo = ElacComputer_P.out_Y0.data.bus_inputs.ra_2_bus.radio_height_ft.SSM;
  ElacComputer_B.Data_i2 = ElacComputer_P.out_Y0.data.bus_inputs.ra_2_bus.radio_height_ft.Data;
  ElacComputer_B.SSM_d1 = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.slat_flap_component_status_word.SSM;
  ElacComputer_B.Data_og = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.slat_flap_component_status_word.Data;
  ElacComputer_B.SSM_hy = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word.SSM;
  ElacComputer_B.Data_fv = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word.Data;
  ElacComputer_B.SSM_gi = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word.SSM;
  ElacComputer_B.Data_oc = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word.Data;
  ElacComputer_B.SSM_pp = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.slat_actual_position_deg.SSM;
  ElacComputer_B.Data_kq = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.slat_actual_position_deg.Data;
  ElacComputer_B.SSM_iab = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.flap_actual_position_deg.SSM;
  ElacComputer_B.Data_ne = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_1_bus.flap_actual_position_deg.Data;
  ElacComputer_B.SSM_jtv = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.slat_flap_component_status_word.SSM;
  ElacComputer_B.Data_it = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.slat_flap_component_status_word.Data;
  ElacComputer_B.SSM_fy = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.slat_flap_system_status_word.SSM;
  ElacComputer_B.Data_ch = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.slat_flap_system_status_word.Data;
  ElacComputer_B.SSM_d4 = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word.SSM;
  ElacComputer_B.Data_bb = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word.Data;
  ElacComputer_B.SSM_ars = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.slat_actual_position_deg.SSM;
  ElacComputer_B.Data_ol = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.slat_actual_position_deg.Data;
  ElacComputer_B.SSM_din = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.flap_actual_position_deg.SSM;
  ElacComputer_B.Data_hw = ElacComputer_P.out_Y0.data.bus_inputs.sfcc_2_bus.flap_actual_position_deg.Data;
  ElacComputer_B.SSM_m3 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_1.SSM;
  ElacComputer_B.Data_hs = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_1.Data;
  ElacComputer_B.SSM_np = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_2.SSM;
  ElacComputer_B.Data_fj = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_2.Data;
  ElacComputer_B.SSM_ax = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_3.SSM;
  ElacComputer_B.Data_ky = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_3.Data;
  ElacComputer_B.SSM_cl = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_4.SSM;
  ElacComputer_B.Data_h5 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_4.Data;
  ElacComputer_B.SSM_es = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_5.SSM;
  ElacComputer_B.Data_ku = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.efcs_status_word_5.Data;
  ElacComputer_B.SSM_gi1 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.capt_roll_command_deg.SSM;
  ElacComputer_B.Data_jp = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.capt_roll_command_deg.Data;
  ElacComputer_B.SSM_jz = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.fo_roll_command_deg.SSM;
  ElacComputer_B.Data_nu = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.fo_roll_command_deg.Data;
  ElacComputer_B.SSM_kt = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.rudder_pedal_position_deg.SSM;
  ElacComputer_B.Data_br = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.rudder_pedal_position_deg.Data;
  ElacComputer_B.SSM_ds = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.capt_pitch_command_deg.SSM;
  ElacComputer_B.Data_ae = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.capt_pitch_command_deg.Data;
  ElacComputer_B.SSM_eg = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.fo_pitch_command_deg.SSM;
  ElacComputer_B.Data_pe = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.fo_pitch_command_deg.Data;
  ElacComputer_B.SSM_a0 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.aileron_left_pos_deg.SSM;
  ElacComputer_B.Data_fy = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.aileron_left_pos_deg.Data;
  ElacComputer_B.SSM_cv = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.elevator_left_pos_deg.SSM;
  ElacComputer_B.Data_na = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.elevator_left_pos_deg.Data;
  ElacComputer_B.SSM_ea = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.aileron_right_pos_deg.SSM;
  ElacComputer_B.Data_my = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.aileron_right_pos_deg.Data;
  ElacComputer_B.SSM_p4 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.elevator_right_pos_deg.SSM;
  ElacComputer_B.Data_i4 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.elevator_right_pos_deg.Data;
  ElacComputer_B.SSM_m2 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.horiz_stab_trim_pos_deg.SSM;
  ElacComputer_B.Data_cx = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.horiz_stab_trim_pos_deg.Data;
  ElacComputer_B.SSM_bt0 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_1_left_pos_deg.SSM;
  ElacComputer_B.Data_nz = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_1_left_pos_deg.Data;
  ElacComputer_B.SSM_nr = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_2_left_pos_deg.SSM;
  ElacComputer_B.Data_id = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_2_left_pos_deg.Data;
  ElacComputer_B.SSM_fr = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_3_left_pos_deg.SSM;
  ElacComputer_B.Data_o2 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_3_left_pos_deg.Data;
  ElacComputer_B.SSM_cc = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_4_left_pos_deg.SSM;
  ElacComputer_B.Data_gqq = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_4_left_pos_deg.Data;
  ElacComputer_B.SSM_lm = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_5_left_pos_deg.SSM;
  ElacComputer_B.Data_md = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_5_left_pos_deg.Data;
  ElacComputer_B.SSM_mkm = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_1_right_pos_deg.SSM;
  ElacComputer_B.Data_cz = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_1_right_pos_deg.Data;
  ElacComputer_B.SSM_jhd = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_2_right_pos_deg.SSM;
  ElacComputer_B.Data_pm = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_2_right_pos_deg.Data;
  ElacComputer_B.SSM_av = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_3_right_pos_deg.SSM;
  ElacComputer_B.Data_bj = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_3_right_pos_deg.Data;
  ElacComputer_B.SSM_ira = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_4_right_pos_deg.SSM;
  ElacComputer_B.Data_ox = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_4_right_pos_deg.Data;
  ElacComputer_B.SSM_ge = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_5_right_pos_deg.SSM;
  ElacComputer_B.Data_pe5 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_1_bus.spoiler_5_right_pos_deg.Data;
  ElacComputer_B.SSM_lv = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_1.SSM;
  ElacComputer_B.Data_jj = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_1.Data;
  ElacComputer_B.SSM_cg = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_2.SSM;
  ElacComputer_B.Data_p5 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_2.Data;
  ElacComputer_B.SSM_be = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_3.SSM;
  ElacComputer_B.Data_ekl = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_3.Data;
  ElacComputer_B.SSM_axb = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_4.SSM;
  ElacComputer_B.Data_nd = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_4.Data;
  ElacComputer_B.SSM_nz = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_5.SSM;
  ElacComputer_B.Data_n2 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.efcs_status_word_5.Data;
  ElacComputer_B.SSM_cx = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.capt_roll_command_deg.SSM;
  ElacComputer_B.Data_dl = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.capt_roll_command_deg.Data;
  ElacComputer_B.SSM_gh = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.fo_roll_command_deg.SSM;
  ElacComputer_B.Data_gs2 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.fo_roll_command_deg.Data;
  ElacComputer_B.SSM_ks = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.rudder_pedal_position_deg.SSM;
  ElacComputer_B.Data_h4 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.rudder_pedal_position_deg.Data;
  ElacComputer_B.SSM_pw = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.capt_pitch_command_deg.SSM;
  ElacComputer_B.Data_e3 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.capt_pitch_command_deg.Data;
  ElacComputer_B.SSM_fh = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.fo_pitch_command_deg.SSM;
  ElacComputer_B.Data_f5h = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.fo_pitch_command_deg.Data;
  ElacComputer_B.SSM_gzn = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.aileron_left_pos_deg.SSM;
  ElacComputer_B.Data_an = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.aileron_left_pos_deg.Data;
  ElacComputer_B.SSM_oo = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.elevator_left_pos_deg.SSM;
  ElacComputer_B.Data_i4o = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.elevator_left_pos_deg.Data;
  ElacComputer_B.SSM_evh = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.aileron_right_pos_deg.SSM;
  ElacComputer_B.Data_af = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.aileron_right_pos_deg.Data;
  ElacComputer_B.SSM_cn = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.elevator_right_pos_deg.SSM;
  ElacComputer_B.Data_bm = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.elevator_right_pos_deg.Data;
  ElacComputer_B.SSM_co = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.horiz_stab_trim_pos_deg.SSM;
  ElacComputer_B.Data_dk = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.horiz_stab_trim_pos_deg.Data;
  ElacComputer_B.SSM_pe = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_1_left_pos_deg.SSM;
  ElacComputer_B.Data_nv = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_1_left_pos_deg.Data;
  ElacComputer_B.SSM_cgz = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_2_left_pos_deg.SSM;
  ElacComputer_B.Data_jpf = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_2_left_pos_deg.Data;
  ElacComputer_B.SSM_fw = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_3_left_pos_deg.SSM;
  ElacComputer_B.Data_i5 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_3_left_pos_deg.Data;
  ElacComputer_B.SSM_h4 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_4_left_pos_deg.SSM;
  ElacComputer_B.Data_k2 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_4_left_pos_deg.Data;
  ElacComputer_B.SSM_cb3 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_5_left_pos_deg.SSM;
  ElacComputer_B.Data_as = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_5_left_pos_deg.Data;
  ElacComputer_B.SSM_pj = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_1_right_pos_deg.SSM;
  ElacComputer_B.Data_gk = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_1_right_pos_deg.Data;
  ElacComputer_B.SSM_dv = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_2_right_pos_deg.SSM;
  ElacComputer_B.Data_jl = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_2_right_pos_deg.Data;
  ElacComputer_B.SSM_i4 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_3_right_pos_deg.SSM;
  ElacComputer_B.Data_e32 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_3_right_pos_deg.Data;
  ElacComputer_B.SSM_fm = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_4_right_pos_deg.SSM;
  ElacComputer_B.Data_ih = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_4_right_pos_deg.Data;
  ElacComputer_B.SSM_e5 = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_5_right_pos_deg.SSM;
  ElacComputer_B.Data_du = ElacComputer_P.out_Y0.data.bus_inputs.fcdc_2_bus.spoiler_5_right_pos_deg.Data;
  ElacComputer_B.SSM_bf = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.SSM;
  ElacComputer_B.Data_nx = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_spoiler_1_position_deg.Data;
  ElacComputer_B.SSM_fd = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.SSM;
  ElacComputer_B.Data_n0 = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_spoiler_1_position_deg.Data;
  ElacComputer_B.SSM_fv = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.SSM;
  ElacComputer_B.Data_eqi = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_spoiler_2_position_deg.Data;
  ElacComputer_B.SSM_dt = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.SSM;
  ElacComputer_B.Data_om = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_spoiler_2_position_deg.Data;
  ElacComputer_B.SSM_j5 = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_elevator_position_deg.SSM;
  ElacComputer_B.Data_nr = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_elevator_position_deg.Data;
  ElacComputer_B.SSM_ng = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_elevator_position_deg.SSM;
  ElacComputer_B.Data_p3 = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_elevator_position_deg.Data;
  ElacComputer_B.SSM_cs = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.ths_position_deg.SSM;
  ElacComputer_B.Data_nb = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.ths_position_deg.Data;
  ElacComputer_B.SSM_ls = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.SSM;
  ElacComputer_B.Data_hd = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_sidestick_pitch_command_deg.Data;
  ElacComputer_B.SSM_dg = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.SSM;
  ElacComputer_B.Data_al = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_sidestick_pitch_command_deg.Data;
  ElacComputer_B.SSM_d3 = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.SSM;
  ElacComputer_B.Data_gu = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.left_sidestick_roll_command_deg.Data;
  ElacComputer_B.SSM_p2 = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.SSM;
  ElacComputer_B.Data_ix = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.right_sidestick_roll_command_deg.Data;
  ElacComputer_B.SSM_bo0 = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.speed_brake_lever_command_deg.SSM;
  ElacComputer_B.Data_do = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.speed_brake_lever_command_deg.Data;
  ElacComputer_B.SSM_bc = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.thrust_lever_angle_1_deg.SSM;
  ElacComputer_B.Data_hu = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.thrust_lever_angle_1_deg.Data;
  ElacComputer_B.SSM_h0 = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.thrust_lever_angle_2_deg.SSM;
  ElacComputer_B.Data_pm1 = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.thrust_lever_angle_2_deg.Data;
  ElacComputer_B.SSM_giz = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.discrete_status_word_1.SSM;
  ElacComputer_B.Data_i2y = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.discrete_status_word_1.Data;
  ElacComputer_B.SSM_mqp = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.discrete_status_word_2.SSM;
  ElacComputer_B.Data_pg = ElacComputer_P.out_Y0.data.bus_inputs.sec_1_bus.discrete_status_word_2.Data;
  ElacComputer_B.SSM_ba = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.SSM;
  ElacComputer_B.Data_ni = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_spoiler_1_position_deg.Data;
  ElacComputer_B.SSM_in = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.SSM;
  ElacComputer_B.Data_fr = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_spoiler_1_position_deg.Data;
  ElacComputer_B.SSM_ff = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.SSM;
  ElacComputer_B.Data_cn = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_spoiler_2_position_deg.Data;
  ElacComputer_B.SSM_ic = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.SSM;
  ElacComputer_B.Data_nxl = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_spoiler_2_position_deg.Data;
  ElacComputer_B.SSM_fs = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_elevator_position_deg.SSM;
  ElacComputer_B.Data_jh = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_elevator_position_deg.Data;
  ElacComputer_B.SSM_ja = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_elevator_position_deg.SSM;
  ElacComputer_B.Data_gl = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_elevator_position_deg.Data;
  ElacComputer_B.SSM_js = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.ths_position_deg.SSM;
  ElacComputer_B.Data_gn = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.ths_position_deg.Data;
  ElacComputer_B.SSM_is3 = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.SSM;
  ElacComputer_B.Data_myb = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_sidestick_pitch_command_deg.Data;
  ElacComputer_B.SSM_ag = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.SSM;
  ElacComputer_B.Data_l2 = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_sidestick_pitch_command_deg.Data;
  ElacComputer_B.SSM_f5 = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.SSM;
  ElacComputer_B.Data_o5o = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.left_sidestick_roll_command_deg.Data;
  ElacComputer_B.SSM_ph = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.SSM;
  ElacComputer_B.Data_l5 = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.right_sidestick_roll_command_deg.Data;
  ElacComputer_B.SSM_jw = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.speed_brake_lever_command_deg.SSM;
  ElacComputer_B.Data_dc2 = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.speed_brake_lever_command_deg.Data;
  ElacComputer_B.SSM_jy = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.thrust_lever_angle_1_deg.SSM;
  ElacComputer_B.Data_gr = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.thrust_lever_angle_1_deg.Data;
  ElacComputer_B.SSM_j1 = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.thrust_lever_angle_2_deg.SSM;
  ElacComputer_B.Data_gp = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.thrust_lever_angle_2_deg.Data;
  ElacComputer_B.SSM_ov = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.discrete_status_word_1.SSM;
  ElacComputer_B.Data_i3 = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.discrete_status_word_1.Data;
  ElacComputer_B.SSM_mx = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.discrete_status_word_2.SSM;
  ElacComputer_B.Data_et = ElacComputer_P.out_Y0.data.bus_inputs.sec_2_bus.discrete_status_word_2.Data;
  ElacComputer_B.SSM_b4 = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.left_aileron_position_deg.SSM;
  ElacComputer_B.Data_mc = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.left_aileron_position_deg.Data;
  ElacComputer_B.SSM_gb = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.right_aileron_position_deg.SSM;
  ElacComputer_B.Data_k3 = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.right_aileron_position_deg.Data;
  ElacComputer_B.SSM_oh = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.left_elevator_position_deg.SSM;
  ElacComputer_B.Data_f2 = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.left_elevator_position_deg.Data;
  ElacComputer_B.SSM_mm5 = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.right_elevator_position_deg.SSM;
  ElacComputer_B.Data_gh = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.right_elevator_position_deg.Data;
  ElacComputer_B.SSM_br = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.ths_position_deg.SSM;
  ElacComputer_B.Data_ed = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.ths_position_deg.Data;
  ElacComputer_B.SSM_c2 = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.left_sidestick_pitch_command_deg.SSM;
  ElacComputer_B.Data_o2j = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.left_sidestick_pitch_command_deg.Data;
  ElacComputer_B.SSM_hc = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.right_sidestick_pitch_command_deg.SSM;
  ElacComputer_B.Data_i43 = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.right_sidestick_pitch_command_deg.Data;
  ElacComputer_B.SSM_ktr = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.left_sidestick_roll_command_deg.SSM;
  ElacComputer_B.Data_ic = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.left_sidestick_roll_command_deg.Data;
  ElacComputer_B.SSM_gl = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.right_sidestick_roll_command_deg.SSM;
  ElacComputer_B.Data_ak = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.right_sidestick_roll_command_deg.Data;
  ElacComputer_B.SSM_my = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.rudder_pedal_position_deg.SSM;
  ElacComputer_B.Data_jg = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.rudder_pedal_position_deg.Data;
  ElacComputer_B.SSM_j3 = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.aileron_command_deg.SSM;
  ElacComputer_B.Data_cu = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.aileron_command_deg.Data;
  ElacComputer_B.SSM_go = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.roll_spoiler_command_deg.SSM;
  ElacComputer_B.Data_ep = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.roll_spoiler_command_deg.Data;
  ElacComputer_B.SSM_e5c = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.yaw_damper_command_deg.SSM;
  ElacComputer_B.Data_d3 = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.yaw_damper_command_deg.Data;
  ElacComputer_B.SSM_dk = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.discrete_status_word_1.SSM;
  ElacComputer_B.Data_bt = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.discrete_status_word_1.Data;
  ElacComputer_B.SSM_evc = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.discrete_status_word_2.SSM;
  ElacComputer_B.Data_e0 = ElacComputer_P.out_Y0.data.bus_inputs.elac_opp_bus.discrete_status_word_2.Data;
