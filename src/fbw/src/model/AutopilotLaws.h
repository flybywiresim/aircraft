...
class AutopilotLawsModelClass
{
 public:
  ...
  struct D_Work_AutopilotLaws_T {
    ...
    rtDW_WashoutFilter_AutopilotLaws_T sf_WashoutFilter_e;
    rtDW_LagFilter_AutopilotLaws_T sf_LagFilter_gg;
    rtDW_LagFilter_AutopilotLaws_T sf_LagFilter_an;
  ...
  struct Parameters_AutopilotLaws_T {
    ...
    real_T ScheduledGain_BreakpointsForDimension1_e[8];
