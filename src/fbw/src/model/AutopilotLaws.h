...
class AutopilotLawsModelClass {
 public:
  struct rtDW_Chart_AutopilotLaws_T {
    uint8_T is_active_c10_srSgcGQg2zvTgc1tMselx4F_ap_library;
    uint8_T is_c10_srSgcGQg2zvTgc1tMselx4F_ap_library;
  };
  ...
  struct rtDW_Chart_AutopilotLaws_c_T {
    uint8_T is_active_c10_s7y0WEx1xKopCu1ds66dilB_ap_library;
    uint8_T is_c10_s7y0WEx1xKopCu1ds66dilB_ap_library;
  };
  ...
  struct D_Work_AutopilotLaws_T {
    ...
    rtDW_LagFilter_AutopilotLaws_T sf_LagFilter_el;
    ...
    rtDW_RateLimiter_AutopilotLaws_T sf_RateLimiter_m;
  ...
  struct Parameters_AutopilotLaws_T {
    ...
    real_T Saturation_UpperSat_ja;
    real_T Saturation_LowerSat_e;
    real_T Gain_Gain_mq;
    real_T Gain1_Gain_eo;
    real_T Gain_Gain_fi;
    real_T Gain_Gain_hp;
    real_T Gain1_Gain_o;
    ...
    real_T Gain_Gain_j;
    real_T Gain1_Gain_mw;
    real_T Gain_Gain_fu;
    real_T Gain_Gain_i;
    real_T Gain1_Gain_lv;
    real_T Saturation_UpperSat_a;
    real_T Saturation_LowerSat_em;
    real_T Gain_Gain_i2;
    ...
    real_T kntoms_Gain_if;
    real_T Saturation_UpperSat_go;
    real_T Saturation_LowerSat_cx;
    real_T Gain_Gain_nu;
    real_T Bias_Bias;
 ...
 private:
  ...
  static void AutopilotLaws_SpeedProtectionMode1(const ap_laws_output *rtu_in, real_T rtu_VS_FD, real_T rtu_VS_AP,
    real_T rtu_VLS_FD, real_T rtu_VLS_AP, real_T rtu_VMAX_FD, real_T rtu_VMAX_AP, real_T *rty_FD, real_T *rty_AP);
