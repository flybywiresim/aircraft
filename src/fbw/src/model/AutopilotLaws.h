...
class AutopilotLawsModelClass
{
 public:
  ...
  struct D_Work_AutopilotLaws_T {
    ...
    rtDW_WashoutFilter_AutopilotLaws_T sf_WashoutFilter_fl;
    rtDW_LeadLagFilter_AutopilotLaws_T sf_LeadLagFilter_e0;
    rtDW_LeadLagFilter_AutopilotLaws_T sf_LeadLagFilter_gq;
    rtDW_WashoutFilter_AutopilotLaws_T sf_WashoutFilter_m;
    rtDW_LeadLagFilter_AutopilotLaws_T sf_LeadLagFilter_ae;
    rtDW_LeadLagFilter_AutopilotLaws_T sf_LeadLagFilter_h;
    rtDW_LagFilter_AutopilotLaws_T sf_LagFilter_ds;
    rtDW_RateLimiter_AutopilotLaws_T sf_RateLimiter_k;
    ...
    rtDW_WashoutFilter_AutopilotLaws_T sf_WashoutFilter_ni;
    ...
    rtDW_LagFilter_AutopilotLaws_T sf_LagFilter_fx;
    rtDW_LagFilter_AutopilotLaws_T sf_LagFilter_d;
    rtDW_LagFilter_AutopilotLaws_T sf_LagFilter_l;
    rtDW_WashoutFilter_AutopilotLaws_T sf_WashoutFilter_g0;
    rtDW_LeadLagFilter_AutopilotLaws_T sf_LeadLagFilter_cb;
    rtDW_LeadLagFilter_AutopilotLaws_T sf_LeadLagFilter_n;
    rtDW_WashoutFilter_AutopilotLaws_T sf_WashoutFilter_bl;
  ...
  struct Parameters_AutopilotLaws_T {
    ...
    real_T LowPassFilter_C1_c;
    real_T WashoutFilter_C1_j;
    real_T HighPassFilter_C1_o;
    real_T LowPassFilter_C1_b;
    real_T WashoutFilter_C1_er;
    ...
    real_T WashoutFilter_C1_bb;
    real_T HighPassFilter_C1_f;
    real_T LowPassFilter_C1_d2;
    real_T WashoutFilter_C1_o0;
    real_T HighPassFilter_C1_c;
    ...
    real_T HighPassFilter_C2_n;
    real_T LowPassFilter_C2_ne;
    real_T HighPassFilter_C2_ks;
    ...
    real_T HighPassFilter_C3_cv;
    real_T LowPassFilter_C3_ag;
    real_T HighPassFilter_C4;
    real_T LowPassFilter_C4;
    real_T HighPassFilter_C4_e;
    ...
    real_T HighPassFilter_C4_gc;
    real_T LowPassFilter_C4_e;
    real_T HighPassFilter_C4_gn;
    real_T LowPassFilter_C4_ez;
    real_T HighPassFilter_C4_k;
    ...
    real_T CompareToConstant_const_o1;
    ...
    real_T Constant1_Value_hs;
    real_T Gain5_Gain_ll;
    ...
    real_T _Gain_d;
    real_T ktstomps_Gain_dt;
    real_T ug_Gain_g;
    real_T Gain1_Gain_lu;
    real_T Gain_Gain_d4;
    real_T Constant2_Value_j;
    real_T Constant1_Value_ps;
    real_T Gain1_Gain_e;
    real_T Gain_Gain_p2;
    real_T Switch_Threshold_h;
    real_T Gain1_Gain_dv4;
    real_T Gain_Gain_fl;
    ...
    real_T _Gain_b;
    real_T ktstomps_Gain_b1;
    real_T ug_Gain_c;
    real_T Gain1_Gain_jy;
    real_T Gain_Gain_ai;
    ...
    real_T Saturation_UpperSat_iq;
    real_T Saturation_LowerSat_pn;
    real_T Gain_Gain_j;
    ...
    real_T Gain_Gain_cb;
    real_T Constant4_Value_j;
    real_T Constant3_Value_g;
    real_T Gain1_Gain_iu;
    real_T Gain_Gain_ou;
    real_T Switch_Threshold_jr;
    real_T Gain1_Gain_pm1;
    real_T Gain_Gain_n3;
    real_T fpmtoms_Gain_h;
    real_T kntoms_Gain_lb;
    real_T Saturation_UpperSat_ig;
    real_T Saturation_LowerSat_i2;
    real_T Gain_Gain_er;
    real_T Gain1_Gain_b5;
    real_T fpmtoms_Gain_c;
    real_T kntoms_Gain_ms;
    real_T Saturation_UpperSat_b1;
    real_T Saturation_LowerSat_ms;
    real_T Gain_Gain_mr;
    real_T Gain1_Gain_mg;
    real_T Constant_Value_n;
    real_T Gain1_Gain_eu;
    real_T Gain1_Gain_jd;
    real_T Gain1_Gain_kq;
    real_T Gain_Gain_gb;
    real_T Gain1_Gain_jf;
    real_T g_Gain_a;
    real_T ktstomps_Gain_bi;
    ...
    real_T Constant1_Value_i1;
    real_T Gain1_Gain_ni;
    real_T Gain_Gain_dm;
    real_T Switch_Threshold_nm;
    ...
    real_T Gain1_Gain_bb;
    real_T Gain_Gain_if;
    real_T Switch_Threshold_oz;
    ...
    real_T kntoms_Gain_ly;
    real_T Saturation_UpperSat_ds;
    ...
    real_T Constant2_Value_fj;
    real_T Gain4_Gain_oy;
    real_T Gain5_Gain_cs;
    ...
    real_T fpmtoms_Gain_m1;
    real_T kntoms_Gain_i5;
    real_T Saturation_UpperSat_jl;
    real_T Saturation_LowerSat_i3;
    real_T Gain_Gain_lw;
    real_T Gain1_Gain_cw;
    real_T Gain1_Gain_ph;
    real_T fpmtoms_Gain_dt;
    real_T kntoms_Gain_fn;
    real_T Saturation_UpperSat_cr;
    real_T Saturation_LowerSat_p5;
    real_T Gain_Gain_hm;
    ...
    real_T Gain_Gain_dno;
    real_T Gain1_Gain_fb;
    real_T g_Gain_l;
    real_T ktstomps_Gain_k;
    real_T GStoGS_CAS_Gain_c;
    real_T _Gain_l;
    real_T ktstomps_Gain_gy;
    real_T ug_Gain_o;
    real_T Gain1_Gain_pw;
    real_T Gain_Gain_cz;
    real_T Gain1_Gain_kh;
    real_T Gain_Gain_i2;
    real_T Constant3_Value_ep;
    real_T ftmintoms_Gain_i;
    real_T kntoms_Gain_iu;
    real_T Saturation_UpperSat_l5;
    real_T Saturation_LowerSat_kw;
    real_T Gain_Gain_ji;
