...
class FlyByWireModelClass {
 public:
  ...
  struct D_Work_FlyByWire_T {
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_aw;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_hy;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_cj;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_pe;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_g3;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_c;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_hq;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_h;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_mu;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_o;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_k;
    rtDW_WashoutFilter_FlyByWire_T sf_WashoutFilter_k;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_l;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_m;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_jj;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_i;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_e;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_j;
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_dz;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_n;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_aj;
  ...
  struct Parameters_FlyByWire_T {
    ...
    real_T Gain4_Gain_o;
    real_T Gain7_Gain;
    real_T Saturation_UpperSat_jp;
    real_T Saturation_LowerSat_prr;
