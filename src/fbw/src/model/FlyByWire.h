...
class FlyByWireModelClass
{
 public:
  ...
  struct D_Work_FlyByWire_T {
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_lg;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_aq;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_oq;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_c;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_in;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_ok;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_g;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_oh;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_i;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_e1;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_e3;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_ny;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_l;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_ob;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_eq;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_l;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_o0;
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_o;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_fb;
    ...
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_o;
    rtDW_WashoutFilter_FlyByWire_T sf_WashoutFilter_e;
    ...
    rtDW_WashoutFilter_FlyByWire_T sf_WashoutFilter_g;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_ee;
    rtDW_WashoutFilter_FlyByWire_T sf_WashoutFilter_m;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_a;
    rtDW_WashoutFilter_FlyByWire_T sf_WashoutFilter_p;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_b;
    rtDW_WashoutFilter_FlyByWire_T sf_WashoutFilter_f;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_e;
    rtDW_WashoutFilter_FlyByWire_T sf_WashoutFilter;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_m;
  ...
  struct Parameters_FlyByWire_T {
    ...
    real_T Constant_Value_kq;
    real_T Saturation_UpperSat_dj;
    real_T Saturation_LowerSat_dv;
