...
typedef struct {
  ...
  real_T Delay_DSTATE_op;
  real_T Delay_DSTATE_m1;
...
struct Parameters_FlyByWire_T_ {
  ...
  real_T Saturation_LowerSat_ds;
  real_T Constant_Value_k;
  real_T Delay_InitialCondition_ii;
  ...
  real_T Saturation_UpperSat_pw;
  real_T Saturation_LowerSat_lt;
