...
class FlyByWireModelClass {
 public:
  ...
  struct D_Work_FlyByWire_T {
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_e0;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_k;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_pi;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_le;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_l;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_of;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_e5;
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_i;
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_nc;
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_mg;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_o4;
  ...
  struct Parameters_FlyByWire_T {
    ...
    real_T Saturation_LowerSat_p2;
    real_T Constant_Value_pg;
    real_T Switch2_Threshold_p;
    real_T Gain4_Gain_o;
    real_T Gain7_Gain;
    real_T Saturation_UpperSat_h;
    real_T Saturation_LowerSat_jc;
    real_T Constant_Value_jfy;
    ...
    real_T Saturation_UpperSat_pq;
    real_T Saturation_LowerSat_en;
    real_T Constant_Value_pgr;
    real_T Saturation_UpperSat_eq;
    real_T Saturation_LowerSat_n;
    real_T Saturation_UpperSat_lm;
    real_T Saturation_LowerSat_np;
