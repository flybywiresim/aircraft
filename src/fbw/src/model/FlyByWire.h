...
class FlyByWireModelClass
{
 public:
  ...
  struct D_Work_FlyByWire_T {
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_kr;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_kb;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_l;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_j3;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_l4;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_nw;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_n3;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_lz;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_m;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_ny;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_br;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_a2;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_a;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_d;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_l5;
  ...
  struct Parameters_FlyByWire_T {
    ...
    real_T Saturation_LowerSat_a3;
    real_T Constant_Value_i;
    real_T Saturation_UpperSat_gx;
    ...
    real_T Saturation_UpperSat_a1;
    real_T Saturation_LowerSat_hv;
    ...
    real_T Saturation_LowerSat_hfo;
