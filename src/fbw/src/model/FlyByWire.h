...
class FlyByWireModelClass {
 public:
  ...
  struct D_Work_FlyByWire_T {
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_al;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_d;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_fr;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_a;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_dx;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_h1;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_ha;
    rtDW_LagFilter_FlyByWire_T sf_LagFilter_hq;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_f;
    rtDW_WashoutFilter_FlyByWire_T sf_WashoutFilter_e;
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_he;
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_i0;
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_hn;
    ...
    rtDW_RateLimiter_FlyByWire_T sf_RateLimiter_ix;
  ...
  struct Parameters_FlyByWire_T {
    ...
    real_T Saturation_LowerSat_fp;
    real_T Constant_Value_a;
    real_T Switch2_Threshold_p;
    real_T Gain4_Gain_o;
    real_T Gain7_Gain;
    real_T Saturation_UpperSat_ls;
    real_T Saturation_LowerSat_mj;
    real_T Constant_Value_m3m;
