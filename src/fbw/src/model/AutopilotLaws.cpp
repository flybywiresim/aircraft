...
void AutopilotLawsModelClass::step()
{
  ...
  AutopilotLaws_MATLABFunction(AutopilotLaws_P.tau_Value_c, AutopilotLaws_P.zeta_Value_h, &rtb_Y_o, &a);
  ...
  AutopilotLaws_LagFilter(L + AutopilotLaws_P.Gain3_Gain_i * ((rtb_dme - AutopilotLaws_DWork.Delay_DSTATE_e) /
    AutopilotLaws_U.in.time.dt), AutopilotLaws_P.LagFilter_C1, AutopilotLaws_U.in.time.dt, &rtb_Y_j5,
  ...
  switch (static_cast<int32_T>(rtb_Saturation)) {
   ...
   case 3:
    rtb_Add1_a = AutopilotLaws_P.Gain_Gain_c * AutopilotLaws_U.in.data.flight_guidance_xtk_nmi * a /
      AutopilotLaws_U.in.data.V_gnd_kn;
    if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat) {
      rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat;
    } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat) {
      rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat;
    }

    b_R = AutopilotLaws_U.in.data.flight_guidance_phi_deg - (AutopilotLaws_P.Gain2_Gain *
      AutopilotLaws_U.in.data.flight_guidance_tae_deg + rtb_Add1_a) * rtb_Y_o * AutopilotLaws_U.in.data.V_gnd_kn;
    break;
  ...
  rtb_Add1_a = static_cast<real_T>(rtb_Compare_l) - AutopilotLaws_DWork.pY;
  ...
  rtb_Add1_a = b_R - AutopilotLaws_DWork.Delay_DSTATE_h;
  ...
  AutopilotLaws_RateLimiter(static_cast<real_T>(rtb_Compare_o1), AutopilotLaws_P.RateLimiterVariableTs_up_b,
    ...
    AutopilotLaws_P.RateLimiterVariableTs_InitialCondition_i, &rtb_Y_j5, &AutopilotLaws_DWork.sf_RateLimiter_d);
  ...
  rtb_Add1_a = AutopilotLaws_P.Gain_Gain_ft * rtb_Y_j5 + Phi2;
  b_R = AutopilotLaws_P.kntoms_Gain * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_n) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_n;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_d) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_d;
  }
  ...
  rtb_Add1_a = (rtb_Add1_a - AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain / b_R;
  if (rtb_Add1_a > 1.0) {
    rtb_Add1_a = 1.0;
  } else if (rtb_Add1_a < -1.0) {
    rtb_Add1_a = -1.0;
  }

  rtb_Saturation1 = AutopilotLaws_P.Gain_Gain_k * std::asin(rtb_Add1_a);
  ...
  AutopilotLaws_DWork.wasActive_l = rtb_Compare_o1;
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_h * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_d) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_d;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_nr) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_nr;
  }

  rtb_Add1_a = (b_R - AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain_c / rtb_Add1_a;
  if (rtb_Add1_a > 1.0) {
    rtb_Add1_a = 1.0;
  } else if (rtb_Add1_a < -1.0) {
    rtb_Add1_a = -1.0;
  ...
  R = AutopilotLaws_P.Gain_Gain_es * std::asin(rtb_Add1_a);
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_m * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_j) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_j;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_i) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_i;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) *
  ...
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_b * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_ei) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_ei;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_dz) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_dz;
  }
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_j5 - AutopilotLaws_P.g_Gain * (AutopilotLaws_P.Gain1_Gain_lp *
    ...
    rtb_Add1_a))) * (AutopilotLaws_P.Constant_Value_dy - std::cos(b_R)) + std::sin(b_R) * std::sin
  ...
  L = (AutopilotLaws_P.Gain1_Gain_ik * b_R + rtb_Tsxlo) * AutopilotLaws_P.Gain_Gain_aj;
  if (b_L > AutopilotLaws_P.Switch_Threshold_l) {
    b_R = AutopilotLaws_P.Constant1_Value;
  } else {
    b_R = AutopilotLaws_P.Gain5_Gain_g * L;
  }
  ...
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_p * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_h) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_h;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_e) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_e;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_a * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) *
  ...
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_l * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_i) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_i;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_h) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_h;
  }
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_j5 - AutopilotLaws_P.g_Gain_h * (AutopilotLaws_P.Gain1_Gain_dv *
    ...
    rtb_Add1_a))) * (AutopilotLaws_P.Constant_Value_cg - std::cos(b_R)) + std::sin(b_R) * std::sin
  ...
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, R, AutopilotLaws_P.VS_Gain * R, rtb_Sum2_o,
    ...
    &L, &rtb_out_f);
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_hx * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_nd) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_nd;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_a) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_a;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_i * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) *
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_m * (AutopilotLaws_P.GStoGS_CAS_Gain_o * b_R),
    AutopilotLaws_P.WashoutFilter_C1_l, AutopilotLaws_U.in.time.dt, &rtb_Y_h, &AutopilotLaws_DWork.sf_WashoutFilter_j);
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_d * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_g) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_g;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_aw) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_aw;
  }

  AutopilotLaws_LeadLagFilter(rtb_Y_h - AutopilotLaws_P.g_Gain_g * (AutopilotLaws_P.Gain1_Gain_be *
    ...
    rtb_Add1_a))) * (AutopilotLaws_P.Constant_Value_j - R) + rtb_Tsxlo * std::sin(AutopilotLaws_P.Gain1_Gain_hy *
    AutopilotLaws_U.in.data.Psi_magnetic_track_deg - AutopilotLaws_P.Gain1_Gain_j2 *
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_n * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4_g, AutopilotLaws_U.in.time.dt, &rtb_Y_h, &AutopilotLaws_DWork.sf_LeadLagFilter_as);
  b_R = (b_R + rtb_Y_h) * AutopilotLaws_P.ug_Gain_l;
  ...
  if ((b_L > AutopilotLaws_P.CompareToConstant_const_a) && (rtb_Tsxlo < AutopilotLaws_P.CompareToConstant1_const_n) &&
  ...
  R = (AutopilotLaws_P.Gain_Gain_ce * R - Phi2) + b_R;
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_a * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_l) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_l;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_hm) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_hm;
  }

  rtb_Add1_a = (AutopilotLaws_U.in.input.H_dot_c_fpm - AutopilotLaws_U.in.data.H_dot_ft_min) *
    AutopilotLaws_P.ftmintoms_Gain_l / rtb_Add1_a;
  if (rtb_Add1_a > 1.0) {
    rtb_Add1_a = 1.0;
  } else if (rtb_Add1_a < -1.0) {
    rtb_Add1_a = -1.0;
  ...
  rtb_Y_o = AutopilotLaws_P.Gain_Gain_ey * std::asin(rtb_Add1_a);
  AutopilotLaws_VSLimiter(AutopilotLaws_P.VS_Gain_h * rtb_Y_o, AutopilotLaws_U.in.data.V_tas_kn, &rtb_Y_h);
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_o * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_f) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_f;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_c) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_c;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_o * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) *
  ...
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_db * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_hb) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_hb;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_k) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_k;
  }
  ...
  AutopilotLaws_LeadLagFilter(b_R - AutopilotLaws_P.g_Gain_m * (AutopilotLaws_P.Gain1_Gain_kdq *
    ...
    rtb_Add1_a))) * (AutopilotLaws_P.Constant_Value_od - rtb_Sum2_o) + rtb_Cos1_pk * std::sin(rtb_Add3_gy)))),
  ...
  rtb_Cos1_pk = (AutopilotLaws_P.Gain1_Gain_ovr * b_R + rtb_Tsxlo) * AutopilotLaws_P.Gain_Gain_jy;
  if (b_L > AutopilotLaws_P.Switch_Threshold_o) {
    b_R = AutopilotLaws_P.Constant1_Value_m5;
  } else {
    b_R = AutopilotLaws_P.Gain5_Gain_h * rtb_Cos1_pk;
  }
  ...
  if (rtb_Tsxlo <= b_R) {
    if (b_L > AutopilotLaws_P.Switch1_Threshold_c) {
      ...
      b_R = AutopilotLaws_P.Gain6_Gain_a * rtb_Cos1_pk;
    }
  ...
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_bq * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_ba) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_ba;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_p) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_p;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_p * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) *
  ...
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_l5 * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_b3) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_b3;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_es) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_es;
  }
  ...
  AutopilotLaws_LeadLagFilter(b_R - AutopilotLaws_P.g_Gain_gr * (AutopilotLaws_P.Gain1_Gain_hv *
    ...
    rtb_Add1_a))) * (AutopilotLaws_P.Constant_Value_ia - rtb_Sum2_o) + rtb_Cos1_pk * std::sin(rtb_Add3_n2)))),
  ...
  if (b_L > AutopilotLaws_P.Switch_Threshold_a) {
    b_R = AutopilotLaws_P.Constant1_Value_mi;
  } else {
    b_R = AutopilotLaws_P.Gain5_Gain_gm * rtb_Tsxlo;
  }

  rtb_Cos1_pk = rtb_Y_j5 * AutopilotLaws_P.Gain1_Gain_gy;
  if (rtb_Cos1_pk <= b_R) {
    if (b_L > AutopilotLaws_P.Switch1_Threshold_b) {
  ...
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Y_o, rtb_Y_h, rtb_Add3_gy,
    ...
    (AutopilotLaws_U.in.data.H_ft, AutopilotLaws_P.uDLookupTable_bp01Data_l, AutopilotLaws_P.uDLookupTable_tableData_c,
     3U), &rtb_Cos1_pk, &rtb_Sum2_o);
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_c * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_oz) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_oz;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_ou) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_ou;
  }

  rtb_Add3_gy = AutopilotLaws_U.in.input.FPA_c_deg - std::atan(AutopilotLaws_P.fpmtoms_Gain_ps *
    AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) * AutopilotLaws_P.Gain_Gain_g;
  AutopilotLaws_VSLimiter(AutopilotLaws_P.Gain_Gain_c3 * rtb_Add3_gy, AutopilotLaws_U.in.data.V_tas_kn, &rtb_Y_o);
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_cv * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_bb) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_bb;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_a4) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_a4;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_d * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) *
  ...
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_k * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_pj) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_pj;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_py) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_py;
  }
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_h - AutopilotLaws_P.g_Gain_l * (AutopilotLaws_P.Gain1_Gain_n4 *
    ...
    rtb_Add1_a))) * (AutopilotLaws_P.Constant_Value_l - rtb_Tsxlo) + rtb_Add3_n2 * std::sin
  ...
  rtb_Y_h = (AutopilotLaws_U.in.data.V_ias_kn - rtb_Y_h) * AutopilotLaws_P.Gain1_Gain_m1;
  if (rtb_Y_h <= b_R) {
  ...
  rtb_Sum2_fo = (AutopilotLaws_P.Gain_Gain_d0 * rtb_Add1_a - Phi2) + b_R;
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_hi * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_c) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_c;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_hd) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_hd;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_o2 * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) *
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_h - AutopilotLaws_P.g_Gain_hq * (AutopilotLaws_P.Gain1_Gain_mx *
    ...
    rtb_Tsxlo))) * (AutopilotLaws_P.Constant_Value_f - rtb_Add1_a) + rtb_Add3_n2 * std::sin
  ...
  b_R = (b_R + rtb_Y_h) * AutopilotLaws_P.ug_Gain_e;
  ...
  if (b_L > AutopilotLaws_P.Switch_Threshold_g) {
  ...
  if (rtb_Y_j5 <= b_R) {
    if (b_L > AutopilotLaws_P.Switch1_Threshold_h) {
  ...
  b_R += AutopilotLaws_P.Gain_Gain_gx * rtb_Add1_a - Phi2;
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Add3_gy, rtb_Y_o, rtb_Sum2_fo,
    AutopilotLaws_P.Gain_Gain_fnw * rtb_Sum2_fo, b_R, AutopilotLaws_P.Gain_Gain_ko * b_R, look1_binlxpw
    (AutopilotLaws_U.in.data.H_ft, AutopilotLaws_P.uDLookupTable_bp01Data_d, AutopilotLaws_P.uDLookupTable_tableData_cr,
     3U), &rtb_FD_a, &rtb_Add3_n2);
  b_L = AutopilotLaws_P.Gain2_Gain_m * AutopilotLaws_U.in.data.H_dot_ft_min *
    AutopilotLaws_P.DiscreteDerivativeVariableTs1_Gain;
  Phi2 = b_L - AutopilotLaws_DWork.Delay_DSTATE_hi;
  ...
  AutopilotLaws_WashoutFilter(Phi2, AutopilotLaws_P.WashoutFilter1_C1, AutopilotLaws_U.in.time.dt, &rtb_Y_h,
  ...
  AutopilotLaws_SignalEnablerGSTrack(AutopilotLaws_P.Gain4_Gain_g * rtb_Y_h, rtb_Compare_o1, &rtb_Y_h);
  ...
  AutopilotLaws_SignalEnablerGSTrack(AutopilotLaws_P.Gain3_Gain_c * (rtb_Y_h + b_R * look1_binlxpw
  ...
  AutopilotLaws_storevalue(rtb_Saturation == AutopilotLaws_P.CompareToConstant6_const,
    AutopilotLaws_Y.out.data.nav_gs_deg, &rtb_Y_h, &AutopilotLaws_DWork.sf_storevalue_g);
  if (rtb_Y_h > AutopilotLaws_P.Saturation_UpperSat_e0) {
    Phi2 = AutopilotLaws_P.Saturation_UpperSat_e0;
  } else if (rtb_Y_h < AutopilotLaws_P.Saturation_LowerSat_ph) {
    Phi2 = AutopilotLaws_P.Saturation_LowerSat_ph;
  } else {
    Phi2 = rtb_Y_h;
  }

  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_k4 * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_eb) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_eb;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_gk) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_gk;
  }

  b_R = std::atan(AutopilotLaws_P.fpmtoms_Gain_g4 * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) *
    AutopilotLaws_P.Gain_Gain_ow;
  AutopilotLaws_SignalEnablerGSTrack(AutopilotLaws_P.Gain2_Gain_l * (Phi2 - b_R), rtb_Compare_o1, &rtb_Y_h);
  AutopilotLaws_Voter1(rtb_Tsxlo + rtb_Y_h, AutopilotLaws_P.Gain1_Gain_d4 * ((Phi2 + AutopilotLaws_P.Bias_Bias) - b_R),
                       AutopilotLaws_P.Gain_Gain_eyl * ((Phi2 + AutopilotLaws_P.Bias1_Bias) - b_R), &rtb_Sum2_fo);
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_U.in.data.H_ind_ft, AutopilotLaws_P.WashoutFilter_C1_ej,
    AutopilotLaws_U.in.time.dt, &rtb_Y_h, &AutopilotLaws_DWork.sf_WashoutFilter_b);
  ...
  rtb_Y_o = (rtb_Y_h + Phi2) * AutopilotLaws_P.DiscreteDerivativeVariableTs2_Gain;
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_U.in.data.H_dot_ft_min, AutopilotLaws_P.WashoutFilter1_C1_g,
    AutopilotLaws_U.in.time.dt, &rtb_Y_h, &AutopilotLaws_DWork.sf_WashoutFilter_f);
  b_R = Phi2 + rtb_Y_h;
  ...
  AutopilotLaws_DWork.wasActive = rtb_Compare_o1;
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_av * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_ew) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_ew;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_an) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_an;
  }

  rtb_Add1_a = (Phi2 - b_R) * AutopilotLaws_P.ftmintoms_Gain_j / rtb_Add1_a;
  if (rtb_Add1_a > 1.0) {
    rtb_Add1_a = 1.0;
  } else if (rtb_Add1_a < -1.0) {
    rtb_Add1_a = -1.0;
  ...
  rtb_Gain_of = AutopilotLaws_P.Gain_Gain_by * std::asin(rtb_Add1_a);
  rtb_Sum_ae = AutopilotLaws_P.Constant1_Value_o - rtb_GainTheta;
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_iv * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_je) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_je;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_hf) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_hf;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_n * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Add1_a) *
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_ks * (AutopilotLaws_P.GStoGS_CAS_Gain_n2 * b_R),
    AutopilotLaws_P.WashoutFilter_C1_d, AutopilotLaws_U.in.time.dt, &rtb_Y_h, &AutopilotLaws_DWork.sf_WashoutFilter_l);
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_ka * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_dh) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_dh;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_m2) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_m2;
  }

  AutopilotLaws_LeadLagFilter(rtb_Y_h - AutopilotLaws_P.g_Gain_l0 * (AutopilotLaws_P.Gain1_Gain_et *
    ...
    rtb_Add1_a))) * (AutopilotLaws_P.Constant_Value_f3 - rtb_GainTheta1) + rtb_Tsxlo * std::sin
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_il * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4_p, AutopilotLaws_U.in.time.dt, &rtb_Y_h, &AutopilotLaws_DWork.sf_LeadLagFilter_j0);
  b_R = (b_R + rtb_Y_h) * AutopilotLaws_P.ug_Gain_c;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_ejc * Phi2;
  rtb_GainTheta1 = b_R + rtb_Tsxlo;
  rtb_Add1_a = AutopilotLaws_P.Constant2_Value_k - AutopilotLaws_U.in.data.H_ind_ft;
  ...
  if ((rtb_Add1_a > AutopilotLaws_P.CompareToConstant_const_h) && (rtb_Tsxlo <
    ...
    if (rtb_Add1_a > AutopilotLaws_P.Switch2_Threshold_b) {
      rtb_Y_h = AutopilotLaws_P.Constant1_Value_mq;
    } else {
      rtb_Y_h = AutopilotLaws_P.Gain5_Gain_k * rtb_Tsxlo;
    }

    if (b_R > rtb_Y_h) {
      b_R = rtb_Y_h;
    } else {
      if (rtb_Add1_a > AutopilotLaws_P.Switch1_Threshold_n) {
  ...
  rtb_Add1_a = AutopilotLaws_P.kntoms_Gain_iw * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Add1_a > AutopilotLaws_P.Saturation_UpperSat_jt) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_UpperSat_jt;
  } else if (rtb_Add1_a < AutopilotLaws_P.Saturation_LowerSat_ih) {
    rtb_Add1_a = AutopilotLaws_P.Saturation_LowerSat_ih;
  }

  rtb_Add1_a = (AutopilotLaws_P.Constant_Value_iaf - AutopilotLaws_U.in.data.H_dot_ft_min) *
    AutopilotLaws_P.ftmintoms_Gain_lv / rtb_Add1_a;
  if (rtb_Add1_a > 1.0) {
    rtb_Add1_a = 1.0;
  } else if (rtb_Add1_a < -1.0) {
    rtb_Add1_a = -1.0;
  ...
  rtb_Tsxlo = AutopilotLaws_P.Gain_Gain_o1 * std::asin(rtb_Add1_a);
  ...
  switch (static_cast<int32_T>(rtb_Saturation)) {
   ...
   case 6:
    Phi2 = AutopilotLaws_P.Gain1_Gain_d * rtb_Sum2_fo;
    break;
   ...
   case 7:
    if (rtb_on_ground > AutopilotLaws_P.Switch1_Threshold_j) {
      ...
      Phi2 = (AutopilotLaws_P.Gain1_Gain_ix * rtb_Y_j5 + rtb_Gain5) + rtb_Gain_of;
    }
    break;
  }
  ...
  switch (static_cast<int32_T>(rtb_Saturation)) {
   ...
   case 7:
    if (rtb_on_ground > AutopilotLaws_P.Switch_Threshold) {
      ...
      b_R = (AutopilotLaws_P.Gain3_Gain * rtb_Y_j5 + rtb_Gain5) + AutopilotLaws_P.VS_Gain_e * rtb_Gain_of;
    }
    break;
  }
  ...
  rtb_Add1_a = b_R - AutopilotLaws_DWork.Delay_DSTATE_h2;
  ...
  AutopilotLaws_RateLimiter(AutopilotLaws_Y.out.output.ap_on, AutopilotLaws_P.RateLimiterVariableTs_up_i,
    ...
    AutopilotLaws_P.RateLimiterVariableTs_InitialCondition_p, &rtb_Y_h, &AutopilotLaws_DWork.sf_RateLimiter_e);
  if (rtb_Y_h > AutopilotLaws_P.Saturation_UpperSat_ix) {
    b_R = AutopilotLaws_P.Saturation_UpperSat_ix;
  } else if (rtb_Y_h < AutopilotLaws_P.Saturation_LowerSat_eq) {
  ...
  AutopilotLaws_DWork.Delay_DSTATE_hi = b_L;
