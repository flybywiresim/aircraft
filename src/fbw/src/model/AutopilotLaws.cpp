...
void AutopilotLawsModelClass::step()
{
  ...
  switch (static_cast<int32_T>(rtb_Saturation)) {
   ...
   case 3:
    rtb_Gain_b5 = AutopilotLaws_P.Gain_Gain_c * AutopilotLaws_U.in.data.flight_guidance_xtk_nmi * a /
      AutopilotLaws_U.in.data.V_gnd_kn;
    if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat) {
      rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat;
    } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat) {
      rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat;
    }

    b_R = AutopilotLaws_U.in.data.flight_guidance_phi_deg - (AutopilotLaws_P.Gain2_Gain *
      AutopilotLaws_U.in.data.flight_guidance_tae_deg + rtb_Gain_b5) * rtb_Y_m * AutopilotLaws_U.in.data.V_gnd_kn;
    break;
  ...
  rtb_Gain_b5 = static_cast<real_T>(rtb_Compare_l) - AutopilotLaws_DWork.pY;
  ...
  rtb_Gain_b5 = b_R - AutopilotLaws_DWork.Delay_DSTATE_h;
  ...
  rtb_Gain_b5 = AutopilotLaws_P.Gain_Gain_ft * rtb_Y_e + Phi2;
  b_R = AutopilotLaws_P.kntoms_Gain * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_n) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_n;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_d) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_d;
  }
  ...
  rtb_Gain_b5 = (rtb_Gain_b5 - AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain / b_R;
  if (rtb_Gain_b5 > 1.0) {
    rtb_Gain_b5 = 1.0;
  } else if (rtb_Gain_b5 < -1.0) {
    rtb_Gain_b5 = -1.0;
  }

  rtb_Saturation1 = AutopilotLaws_P.Gain_Gain_k * std::asin(rtb_Gain_b5);
  ...
  AutopilotLaws_DWork.wasActive_c = rtb_Compare_o1;
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_h * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_d) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_d;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_nr) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_nr;
  }

  rtb_Gain_b5 = (b_R - AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain_c / rtb_Gain_b5;
  if (rtb_Gain_b5 > 1.0) {
    rtb_Gain_b5 = 1.0;
  } else if (rtb_Gain_b5 < -1.0) {
    rtb_Gain_b5 = -1.0;
  ...
  R = AutopilotLaws_P.Gain_Gain_es * std::asin(rtb_Gain_b5);
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_m * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_oc) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_oc;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_m) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_m;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) *
  ...
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_g * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_no) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_no;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_h) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_h;
  }
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_e - AutopilotLaws_P.g_Gain * (AutopilotLaws_P.Gain1_Gain_i4u *
    ...
    rtb_Gain_b5))) * (AutopilotLaws_P.Constant_Value_c4 - std::cos(b_R)) + std::sin(b_R) * std::sin
  ...
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_hn * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_i) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_i;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_ma) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_ma;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_j * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) *
  ...
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_gg * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_kx) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_kx;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_a) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_a;
  }
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_e - AutopilotLaws_P.g_Gain_c * (AutopilotLaws_P.Gain1_Gain_jg *
    ...
    rtb_Gain_b5))) * (AutopilotLaws_P.Constant_Value_l - std::cos(b_R)) + std::sin(b_R) * std::sin
  ...
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_a * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_bj) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_bj;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_j) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_j;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_gg * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) *
  ...
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_j * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_ig) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_ig;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_i) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_i;
  }
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_j - AutopilotLaws_P.g_Gain_a * (AutopilotLaws_P.Gain1_Gain_iv *
    ...
    rtb_Gain_b5))) * (AutopilotLaws_P.Constant_Value_ix - R) + rtb_Tsxlo * std::sin(AutopilotLaws_P.Gain1_Gain_mz0 *
  ...
  AutopilotLaws_Voter1(AutopilotLaws_U.in.data.VLS_kn, AutopilotLaws_U.in.input.V_c_kn, AutopilotLaws_U.in.data.VMAX_kn,
                       &rtb_Sum2_p);
  rtb_Sum2_p = (AutopilotLaws_U.in.data.V_ias_kn - rtb_Sum2_p) * AutopilotLaws_P.Gain1_Gain_hy;
  if (rtb_Sum2_p <= b_R) {
  ...
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_au * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_l) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_l;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_hm) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_hm;
  }

  rtb_Gain_b5 = (AutopilotLaws_U.in.input.H_dot_c_fpm - AutopilotLaws_U.in.data.H_dot_ft_min) *
    AutopilotLaws_P.ftmintoms_Gain_l / rtb_Gain_b5;
  if (rtb_Gain_b5 > 1.0) {
    rtb_Gain_b5 = 1.0;
  } else if (rtb_Gain_b5 < -1.0) {
    rtb_Gain_b5 = -1.0;
  ...
  rtb_Y_m = AutopilotLaws_P.Gain_Gain_ey * std::asin(rtb_Gain_b5);
  AutopilotLaws_VSLimiter(AutopilotLaws_P.VS_Gain_h * rtb_Y_m, AutopilotLaws_U.in.data.V_tas_kn, &rtb_Y_j);
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_k * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_iv) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_iv;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_c) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_c;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_a * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) *
    AutopilotLaws_P.Gain_Gain_ab;
  b_R = AutopilotLaws_P.Gain1_Gain_m3 * rtb_GainTheta1;
  rtb_Sum2_p = std::cos(b_R);
  rtb_Cos1_e = std::sin(b_R);
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_mi * AutopilotLaws_U.in.data.Psi_magnetic_track_deg;
  rtb_Add3_o = rtb_Tsxlo - AutopilotLaws_P.Gain1_Gain_g * AutopilotLaws_U.in.data.Psi_magnetic_deg;
  b_R = AutopilotLaws_P.ktstomps_Gain_d * AutopilotLaws_U.in.data.V_gnd_kn;
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_g * (AutopilotLaws_P.GStoGS_CAS_Gain_d * b_R),
    AutopilotLaws_P.WashoutFilter_C1_a, AutopilotLaws_U.in.time.dt, &b_R, &AutopilotLaws_DWork.sf_WashoutFilter_gq);
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_m1 * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_f) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_f;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_p) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_p;
  }

  AutopilotLaws_LeadLagFilter(b_R - AutopilotLaws_P.g_Gain_d * (AutopilotLaws_P.Gain1_Gain_ns *
    (AutopilotLaws_P.Gain_Gain_na * ((AutopilotLaws_P.Gain1_Gain_d2 * rtb_GainTheta - AutopilotLaws_P.Gain1_Gain_eh *
    (AutopilotLaws_P.Gain_Gain_g1 * std::atan(AutopilotLaws_P.fpmtoms_Gain_g1 * AutopilotLaws_U.in.data.H_dot_ft_min /
    rtb_Gain_b5))) * (AutopilotLaws_P.Constant_Value_o - rtb_Sum2_p) + rtb_Cos1_e * std::sin(rtb_Add3_o)))),
    AutopilotLaws_P.HighPassFilter_C1_b, AutopilotLaws_P.HighPassFilter_C2_ag, AutopilotLaws_P.HighPassFilter_C3_j,
    AutopilotLaws_P.HighPassFilter_C4_g, AutopilotLaws_U.in.time.dt, &rtb_Tsxlo,
    &AutopilotLaws_DWork.sf_LeadLagFilter_kw);
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_p * AutopilotLaws_U.in.data.V_ias_kn,
    AutopilotLaws_P.LowPassFilter_C1_m, AutopilotLaws_P.LowPassFilter_C2_f, AutopilotLaws_P.LowPassFilter_C3_e,
    AutopilotLaws_P.LowPassFilter_C4_d, AutopilotLaws_U.in.time.dt, &b_R, &AutopilotLaws_DWork.sf_LeadLagFilter_j);
  b_R = (rtb_Tsxlo + b_R) * AutopilotLaws_P.ug_Gain_f;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_cb * Phi2;
  rtb_Sum2_p = b_R + rtb_Tsxlo;
  rtb_Gain_b5 = (AutopilotLaws_P.Gain1_Gain_fs * b_R + rtb_Tsxlo) * AutopilotLaws_P.Gain_Gain_ng;
  if (b_L > AutopilotLaws_P.Switch_Threshold_bg) {
    b_R = AutopilotLaws_P.Constant1_Value_g;
  } else {
    b_R = AutopilotLaws_P.Gain5_Gain_p * rtb_Gain_b5;
  }

  AutopilotLaws_V_LSSpeedSelection1(AutopilotLaws_U.in.input.V_c_kn, AutopilotLaws_U.in.data.VLS_kn, &rtb_Tsxlo);
  rtb_Tsxlo = (AutopilotLaws_U.in.data.V_ias_kn - rtb_Tsxlo) * AutopilotLaws_P.Gain1_Gain_gb;
  if (rtb_Tsxlo <= b_R) {
    if (b_L > AutopilotLaws_P.Switch1_Threshold_c) {
      b_R = AutopilotLaws_P.Constant_Value_c;
    } else {
      b_R = AutopilotLaws_P.Gain6_Gain_kk * rtb_Gain_b5;
    }
  ...
  rtb_Add3_o = (AutopilotLaws_P.Gain_Gain_jt * rtb_Sum2_p - Phi2) + b_R;
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_d * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_iq) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_iq;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_pn) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_pn;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_n * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) *
    AutopilotLaws_P.Gain_Gain_jtj;
  b_R = AutopilotLaws_P.Gain1_Gain_bi * rtb_GainTheta1;
  rtb_Sum2_p = std::cos(b_R);
  rtb_Cos1_e = std::sin(b_R);
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_hve * AutopilotLaws_U.in.data.Psi_magnetic_track_deg;
  rtb_Add3_nx = rtb_Tsxlo - AutopilotLaws_P.Gain1_Gain_fy * AutopilotLaws_U.in.data.Psi_magnetic_deg;
  b_R = AutopilotLaws_P.ktstomps_Gain_g * AutopilotLaws_U.in.data.V_gnd_kn;
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_ec * (AutopilotLaws_P.GStoGS_CAS_Gain_j * b_R),
    AutopilotLaws_P.WashoutFilter_C1_b, AutopilotLaws_U.in.time.dt, &b_R, &AutopilotLaws_DWork.sf_WashoutFilter_c);
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_kj * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_n0) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_n0;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_l) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_l;
  }

  AutopilotLaws_LeadLagFilter(b_R - AutopilotLaws_P.g_Gain_f * (AutopilotLaws_P.Gain1_Gain_ge *
    (AutopilotLaws_P.Gain_Gain_fs * ((AutopilotLaws_P.Gain1_Gain_cf * rtb_GainTheta - AutopilotLaws_P.Gain1_Gain_n2 *
    (AutopilotLaws_P.Gain_Gain_bm * std::atan(AutopilotLaws_P.fpmtoms_Gain_p * AutopilotLaws_U.in.data.H_dot_ft_min /
    rtb_Gain_b5))) * (AutopilotLaws_P.Constant_Value_e - rtb_Sum2_p) + rtb_Cos1_e * std::sin(rtb_Add3_nx)))),
    AutopilotLaws_P.HighPassFilter_C1_d, AutopilotLaws_P.HighPassFilter_C2_d, AutopilotLaws_P.HighPassFilter_C3_e,
    AutopilotLaws_P.HighPassFilter_C4_m, AutopilotLaws_U.in.time.dt, &rtb_Tsxlo,
    &AutopilotLaws_DWork.sf_LeadLagFilter_pl);
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_b * AutopilotLaws_U.in.data.V_ias_kn,
    AutopilotLaws_P.LowPassFilter_C1_i, AutopilotLaws_P.LowPassFilter_C2_m, AutopilotLaws_P.LowPassFilter_C3_ee,
    AutopilotLaws_P.LowPassFilter_C4_m, AutopilotLaws_U.in.time.dt, &b_R, &AutopilotLaws_DWork.sf_LeadLagFilter_by);
  b_R = (rtb_Tsxlo + b_R) * AutopilotLaws_P.ug_Gain_n;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_ny * Phi2;
  rtb_Sum2_p = b_R + rtb_Tsxlo;
  rtb_Tsxlo = (AutopilotLaws_P.Gain1_Gain_mzh * b_R + rtb_Tsxlo) * AutopilotLaws_P.Gain_Gain_or;
  if (b_L > AutopilotLaws_P.Switch_Threshold_mv) {
    b_R = AutopilotLaws_P.Constant1_Value_di;
  } else {
    b_R = AutopilotLaws_P.Gain5_Gain_k * rtb_Tsxlo;
  }

  rtb_Gain_b5 = rtb_Y_e * AutopilotLaws_P.Gain1_Gain_oz;
  if (rtb_Gain_b5 <= b_R) {
    if (b_L > AutopilotLaws_P.Switch1_Threshold_p) {
      b_R = AutopilotLaws_P.Constant_Value_n;
    } else {
      b_R = AutopilotLaws_P.Gain6_Gain_i * rtb_Tsxlo;
    }
  ...
  b_R += AutopilotLaws_P.Gain_Gain_pz * rtb_Sum2_p - Phi2;
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Y_m, rtb_Y_j, rtb_Add3_o,
    AutopilotLaws_P.Gain_Gain_hx * rtb_Add3_o, b_R, AutopilotLaws_P.Gain_Gain_hn * b_R, &rtb_Cos1_e, &rtb_Sum2_p);
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_c * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_oz) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_oz;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_ou) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_ou;
  }

  rtb_Add3_o = AutopilotLaws_U.in.input.FPA_c_deg - std::atan(AutopilotLaws_P.fpmtoms_Gain_ps *
    AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) * AutopilotLaws_P.Gain_Gain_gt;
  AutopilotLaws_VSLimiter(AutopilotLaws_P.Gain_Gain_c3 * rtb_Add3_o, AutopilotLaws_U.in.data.V_tas_kn, &rtb_Y_m);
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_aa * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_pp) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_pp;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_ap) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_ap;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_lh * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) *
    AutopilotLaws_P.Gain_Gain_hy;
  b_R = AutopilotLaws_P.Gain1_Gain_bv * rtb_GainTheta1;
  rtb_Tsxlo = std::cos(b_R);
  rtb_Add3_nx = std::sin(b_R);
  ...
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_hk * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_id) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_id;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_ij) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_ij;
  }
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_j - AutopilotLaws_P.g_Gain_j * (AutopilotLaws_P.Gain1_Gain_fr *
    ...
    rtb_Gain_b5))) * (AutopilotLaws_P.Constant_Value_h - rtb_Tsxlo) + rtb_Add3_nx * std::sin
  ...
  rtb_Sum2_g = (AutopilotLaws_P.Gain_Gain_f5 * rtb_Gain_b5 - Phi2) + b_R;
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_n * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_an) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_an;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_fk) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_fk;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_mt * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) *
  ...
  rtb_Gain_b5 = std::cos(b_R);
  rtb_Add3_nx = std::sin(b_R);
  b_R = AutopilotLaws_P.ktstomps_Gain_dt * AutopilotLaws_U.in.data.V_gnd_kn;
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_gk * (AutopilotLaws_P.GStoGS_CAS_Gain_e * b_R),
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_j - AutopilotLaws_P.g_Gain_da * (AutopilotLaws_P.Gain1_Gain_mc *
    ...
    rtb_Tsxlo))) * (AutopilotLaws_P.Constant_Value_ixi - rtb_Gain_b5) + rtb_Add3_nx * std::sin
    ...
    AutopilotLaws_P.HighPassFilter_C2_j, AutopilotLaws_P.HighPassFilter_C3_ed, AutopilotLaws_P.HighPassFilter_C4_cm,
  ...
  b_R += AutopilotLaws_P.Gain_Gain_p2 * rtb_Gain_b5 - Phi2;
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Add3_o, rtb_Y_m, rtb_Sum2_g,
    AutopilotLaws_P.Gain_Gain_p0 * rtb_Sum2_g, b_R, AutopilotLaws_P.Gain_Gain_dv * b_R, &rtb_FD_d, &rtb_Add3_nx);
  ...
  rtb_Add3_o = AutopilotLaws_P.DiscreteDerivativeVariableTs_Gain_o * rtb_Y_m;
  AutopilotLaws_LagFilter(rtb_Y_m + AutopilotLaws_P.Gain3_Gain_n * ((rtb_Add3_o - AutopilotLaws_DWork.Delay_DSTATE_n) /
  ...
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_fb * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_nm) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_nm;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_ai) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_ai;
  }

  b_R = std::atan(AutopilotLaws_P.fpmtoms_Gain_ac * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) *
  ...
  AutopilotLaws_DWork.wasActive = rtb_Compare_o1;
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_av * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_ew) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_ew;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_an) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_an;
  }

  rtb_Gain_b5 = (Phi2 - b_R) * AutopilotLaws_P.ftmintoms_Gain_j / rtb_Gain_b5;
  if (rtb_Gain_b5 > 1.0) {
    rtb_Gain_b5 = 1.0;
  } else if (rtb_Gain_b5 < -1.0) {
    rtb_Gain_b5 = -1.0;
  ...
  rtb_Gain_ij = AutopilotLaws_P.Gain_Gain_by * std::asin(rtb_Gain_b5);
  rtb_Sum_ae = AutopilotLaws_P.Constant1_Value_o - rtb_GainTheta;
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_jj * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_kw) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_kw;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_k) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_k;
  }

  Phi2 = std::atan(AutopilotLaws_P.fpmtoms_Gain_f * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_b5) *
    AutopilotLaws_P.Gain_Gain_ik;
  b_R = AutopilotLaws_P.Gain1_Gain_dw * rtb_GainTheta1;
  rtb_GainTheta1 = std::cos(b_R);
  rtb_Tsxlo = std::sin(b_R);
  b_R = AutopilotLaws_P.ktstomps_Gain_ga * AutopilotLaws_U.in.data.V_gnd_kn;
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_m * (AutopilotLaws_P.GStoGS_CAS_Gain_ij * b_R),
    AutopilotLaws_P.WashoutFilter_C1_l, AutopilotLaws_U.in.time.dt, &rtb_Y_j, &AutopilotLaws_DWork.sf_WashoutFilter_k2);
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_p * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_i1) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_i1;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_fwy) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_fwy;
  }

  AutopilotLaws_LeadLagFilter(rtb_Y_j - AutopilotLaws_P.g_Gain_g * (AutopilotLaws_P.Gain1_Gain_ie *
    (AutopilotLaws_P.Gain_Gain_ar * ((AutopilotLaws_P.Gain1_Gain_a1 * rtb_GainTheta - AutopilotLaws_P.Gain1_Gain_oga *
    (AutopilotLaws_P.Gain_Gain_pk * std::atan(AutopilotLaws_P.fpmtoms_Gain_k * AutopilotLaws_U.in.data.H_dot_ft_min /
    rtb_Gain_b5))) * (AutopilotLaws_P.Constant_Value_k - rtb_GainTheta1) + rtb_Tsxlo * std::sin
    (AutopilotLaws_P.Gain1_Gain_hf * AutopilotLaws_U.in.data.Psi_magnetic_track_deg - AutopilotLaws_P.Gain1_Gain_ik *
     AutopilotLaws_U.in.data.Psi_magnetic_deg)))), AutopilotLaws_P.HighPassFilter_C1_m,
    AutopilotLaws_P.HighPassFilter_C2_o, AutopilotLaws_P.HighPassFilter_C3_d, AutopilotLaws_P.HighPassFilter_C4_e,
    AutopilotLaws_U.in.time.dt, &b_R, &AutopilotLaws_DWork.sf_LeadLagFilter_ck);
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_jy * AutopilotLaws_U.in.data.V_ias_kn,
    AutopilotLaws_P.LowPassFilter_C1_d, AutopilotLaws_P.LowPassFilter_C2_pe, AutopilotLaws_P.LowPassFilter_C3_g,
    AutopilotLaws_P.LowPassFilter_C4_mm, AutopilotLaws_U.in.time.dt, &rtb_Y_j, &AutopilotLaws_DWork.sf_LeadLagFilter_fv);
  b_R = (b_R + rtb_Y_j) * AutopilotLaws_P.ug_Gain_o;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_bww * Phi2;
  rtb_GainTheta1 = b_R + rtb_Tsxlo;
  rtb_Gain_b5 = AutopilotLaws_P.Constant2_Value_kz - AutopilotLaws_U.in.data.H_ind_ft;
  rtb_Tsxlo = (AutopilotLaws_P.Gain1_Gain_f5 * b_R + rtb_Tsxlo) * AutopilotLaws_P.Gain_Gain_my;
  if (rtb_Gain_b5 > AutopilotLaws_P.Switch2_Threshold_g) {
    b_R = AutopilotLaws_P.Constant1_Value_c;
  } else {
    b_R = AutopilotLaws_P.Gain5_Gain_l * rtb_Tsxlo;
  }

  rtb_Y_j = (AutopilotLaws_U.in.data.V_ias_kn - AutopilotLaws_U.in.input.V_c_kn) * AutopilotLaws_P.Gain1_Gain_ev;
  if (rtb_Y_j <= b_R) {
    if (rtb_Gain_b5 > AutopilotLaws_P.Switch1_Threshold_e) {
      b_R = AutopilotLaws_P.Gain1_Gain_db * rtb_Tsxlo;
      if (AutopilotLaws_P.Constant2_Value_k > b_R) {
        b_R = AutopilotLaws_P.Constant2_Value_k;
      }
    } else {
      b_R = AutopilotLaws_P.Gain6_Gain_f * rtb_Tsxlo;
    }
  ...
  rtb_GainTheta1 = (AutopilotLaws_P.Gain_Gain_bn * rtb_GainTheta1 - Phi2) + b_R;
  rtb_Gain_b5 = AutopilotLaws_P.kntoms_Gain_i * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Gain_b5 > AutopilotLaws_P.Saturation_UpperSat_j) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_UpperSat_j;
  } else if (rtb_Gain_b5 < AutopilotLaws_P.Saturation_LowerSat_ih) {
    rtb_Gain_b5 = AutopilotLaws_P.Saturation_LowerSat_ih;
  }

  rtb_Gain_b5 = (AutopilotLaws_P.Constant_Value_ia - AutopilotLaws_U.in.data.H_dot_ft_min) *
    AutopilotLaws_P.ftmintoms_Gain_lv / rtb_Gain_b5;
  if (rtb_Gain_b5 > 1.0) {
    rtb_Gain_b5 = 1.0;
  } else if (rtb_Gain_b5 < -1.0) {
    rtb_Gain_b5 = -1.0;
  ...
  rtb_Tsxlo = AutopilotLaws_P.Gain_Gain_o1 * std::asin(rtb_Gain_b5);
  ...
  AutopilotLaws_Voter1(rtb_Sum_ae, AutopilotLaws_P.Gain_Gain_m1 * rtb_GainTheta1, AutopilotLaws_P.VS_Gain_nx * rtb_Tsxlo,
                       &b_R);
  switch (static_cast<int32_T>(rtb_Saturation)) {
   case 0:
  ...
  rtb_Gain_b5 = b_R - AutopilotLaws_DWork.Delay_DSTATE_h2;
  ...
  AutopilotLaws_DWork.Delay_DSTATE_n = rtb_Add3_o;
