...
void AutopilotLawsModelClass::step()
{
  ...
  AutopilotLaws_LagFilter(Phi2 + AutopilotLaws_P.Gain3_Gain_i * AutopilotLaws_DWork.DelayInput1_DSTATE,
    AutopilotLaws_P.LagFilter_C1, AutopilotLaws_U.in.time.dt, &rtb_Y_d, &AutopilotLaws_DWork.sf_LagFilter_m);
  ...
  switch (static_cast<int32_T>(rtb_error_d)) {
   ...
   case 5:
    ...
    rtb_Add3_j4 = (rtb_Y_d * look1_binlxpw(AutopilotLaws_U.in.data.V_tas_kn,
  ...
  AutopilotLaws_LagFilter(AutopilotLaws_P.Gain_Gain_lu * (AutopilotLaws_DWork.DelayInput1_DSTATE - rtb_GainTheta1),
    AutopilotLaws_P.LagFilter_C1_a, AutopilotLaws_U.in.time.dt, &rtb_Y_d, &AutopilotLaws_DWork.sf_LagFilter_mp);
  ...
  AutopilotLaws_Y.out.output.flight_director.Phi_c_deg = rtb_Y_d;
  ...
  rtb_Y_d = AutopilotLaws_P.Gain_Gain_ey * std::asin(rtb_Add3_j4);
  ...
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Y_d, std::fmax(-rtb_Y_pf, std::fmin(rtb_Y_pf,
    AutopilotLaws_P.VS_Gain_h * rtb_Y_d)), rtb_Add3_g, AutopilotLaws_P.Gain_Gain_h4 * rtb_Add3_g, Phi2,
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_kb * (AutopilotLaws_P.GStoGS_CAS_Gain_o *
    AutopilotLaws_DWork.DelayInput1_DSTATE), AutopilotLaws_P.WashoutFilter_C1_j, AutopilotLaws_U.in.time.dt, &rtb_Y_d,
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_k * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4_dt, AutopilotLaws_U.in.time.dt, &rtb_Y_d, &AutopilotLaws_DWork.sf_LeadLagFilter_kp);
  AutopilotLaws_DWork.DelayInput1_DSTATE = (rtb_Gain1_pj + rtb_Y_d) * AutopilotLaws_P.ug_Gain_n;
  ...
  rtb_Y_d = (AutopilotLaws_U.in.data.V_ias_kn - rtb_Y_d) * AutopilotLaws_P.Gain1_Gain_m1;
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_ip * (AutopilotLaws_P.GStoGS_CAS_Gain_e *
    AutopilotLaws_DWork.DelayInput1_DSTATE), AutopilotLaws_P.WashoutFilter_C1_c, AutopilotLaws_U.in.time.dt, &rtb_Y_d,
  ...
  AutopilotLaws_DWork.DelayInput1_DSTATE = (rtb_Gain1_pj + rtb_Y_d) * AutopilotLaws_P.ug_Gain_e;
  ...
  Phi2 = AutopilotLaws_P.Gain4_Gain_j * rtb_Gain1_pj;
  ...
  AutopilotLaws_SignalEnablerGSTrack(Phi2, rtb_Compare_l, &rtb_Gain1_pj);
  ...
  AutopilotLaws_LagFilter(rtb_Y_d + (rtb_Add3_i - AutopilotLaws_DWork.Delay_DSTATE_n) / AutopilotLaws_U.in.time.dt *
  ...
  AutopilotLaws_SignalEnablerGSTrack(AutopilotLaws_P.Gain3_Gain_c * (rtb_Gain1_pj +
    AutopilotLaws_DWork.DelayInput1_DSTATE * look1_binlxpw(AutopilotLaws_U.in.data.H_radio_ft,
    AutopilotLaws_P.ScheduledGain_BreakpointsForDimension1_e, AutopilotLaws_P.ScheduledGain_Table_l, 7U)),
  ...
  rtb_Y_d = AutopilotLaws_P.Gain5_Gain_c * AutopilotLaws_U.in.data.bz_m_s2;
  ...
  switch (static_cast<int32_T>(rtb_error_d)) {
   ...
   case 7:
    if (rtb_on_ground > AutopilotLaws_P.Switch1_Threshold_j) {
      ...
      b_L = ((AutopilotLaws_P.Gain1_Gain_i * rtb_Y_pf + rtb_Y_d) + rtb_Sum1_g * rtb_uDLookupTable_m) *
  ...
  if (rtb_on_ground <= AutopilotLaws_P.Switch_Threshold_c) {
    rtb_Gain4 = ((rtb_Y_d + a) + rtb_uDLookupTable_m * b_L) + rtb_Saturation;
  }
  ...
  AutopilotLaws_Y.out.output.flare_law.delta_Theta_bz_deg = rtb_Y_d;
