...
void AutopilotLawsModelClass::step()
{
  ...
  AutopilotLaws_MATLABFunction(AutopilotLaws_P.tau_Value_c, AutopilotLaws_P.zeta_Value_h, &a, &rtb_Y_nl);
  ...
  AutopilotLaws_LagFilter(L, AutopilotLaws_P.LagFilter_C1, AutopilotLaws_U.in.time.dt, &rtb_Y_k,
  ...
  switch (static_cast<int32_T>(rtb_Saturation)) {
   ...
   case 3:
    rtb_Gain_ar0 = AutopilotLaws_P.Gain_Gain_c * AutopilotLaws_U.in.data.flight_guidance_xtk_nmi * rtb_Y_nl /
    ...
    b_R = rtb_Y_k - (AutopilotLaws_P.Gain2_Gain * AutopilotLaws_U.in.data.flight_guidance_tae_deg + rtb_Gain_ar0) * a *
      AutopilotLaws_U.in.data.V_gnd_kn;
    break;
  ...
  rtb_Gain_ar0 = static_cast<real_T>(rtb_Compare_l) - AutopilotLaws_DWork.pY;
  a = std::abs(AutopilotLaws_P.RateLimiterVariableTs_up_n) * AutopilotLaws_U.in.time.dt;
  if (rtb_Gain_ar0 < a) {
    a = rtb_Gain_ar0;
  }

  Phi2 = -std::abs(AutopilotLaws_P.RateLimiterVariableTs_lo_k) * AutopilotLaws_U.in.time.dt;
  if (a > Phi2) {
    Phi2 = a;
  }

  AutopilotLaws_DWork.pY += Phi2;
  switch (static_cast<int32_T>(rtb_Saturation)) {
   case 0:
  ...
  rtb_Gain_ar0 = b_R - AutopilotLaws_DWork.Delay_DSTATE_h;
  a = AutopilotLaws_P.Constant2_Value_h * AutopilotLaws_U.in.time.dt;
  if (rtb_Gain_ar0 < a) {
    a = rtb_Gain_ar0;
  }

  Phi2 = AutopilotLaws_P.Gain1_Gain_kf * AutopilotLaws_P.Constant2_Value_h * AutopilotLaws_U.in.time.dt;
  if (a > Phi2) {
    Phi2 = a;
  }

  AutopilotLaws_DWork.Delay_DSTATE_h += Phi2;
  ...
  if (rtb_Y_j5 > AutopilotLaws_P.Saturation_UpperSat_m) {
    ...
    rtb_out_f = AutopilotLaws_P.Saturation_LowerSat_fw;
  } else {
    rtb_out_f = rtb_Y_j5;
  }
  ...
  AutopilotLaws_Y.out.output.autopilot.Phi_c_deg = (AutopilotLaws_P.Constant_Value_ii - rtb_out_f) * rtb_GainTheta1 +
    rtb_Y_k * rtb_out_f;
  ...
  if (AutopilotLaws_U.in.input.ALT_soft_mode_active) {
    rtb_out_f = (AutopilotLaws_U.in.input.V_c_kn - AutopilotLaws_U.in.data.V_ias_kn) * AutopilotLaws_P.Gain1_Gain_b;
    if (rtb_out_f > AutopilotLaws_P.Saturation1_UpperSat) {
      rtb_out_f = AutopilotLaws_P.Saturation1_UpperSat;
    } else if (rtb_out_f < AutopilotLaws_P.Saturation1_LowerSat) {
      rtb_out_f = AutopilotLaws_P.Saturation1_LowerSat;
    }
  } else {
    rtb_out_f = AutopilotLaws_P.Constant1_Value_h;
  }
  ...
  rtb_Gain_ar0 = AutopilotLaws_P.Gain_Gain_ft * rtb_Y_j5 + rtb_out_f;
  b_R = AutopilotLaws_P.kntoms_Gain * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Gain_ar0 > AutopilotLaws_P.Saturation_UpperSat_n) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_UpperSat_n;
  } else if (rtb_Gain_ar0 < AutopilotLaws_P.Saturation_LowerSat_d) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_LowerSat_d;
  }
  ...
  rtb_Gain_ar0 = (rtb_Gain_ar0 - AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain / b_R;
  if (rtb_Gain_ar0 > 1.0) {
    rtb_Gain_ar0 = 1.0;
  ...
  rtb_Saturation1 = AutopilotLaws_P.Gain_Gain_k * std::asin(rtb_Gain_ar0);
  ...
  if ((!AutopilotLaws_DWork.wasActive_l) && rtb_Compare_o1) {
    ...
    b_R += rtb_out_f * AutopilotLaws_DWork.dH_offset;
    AutopilotLaws_DWork.k = AutopilotLaws_U.in.data.H_dot_ft_min / b_R;
  ...
  AutopilotLaws_DWork.wasActive_l = rtb_Compare_o1;
  rtb_Gain_ar0 = AutopilotLaws_P.kntoms_Gain_h * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Gain_ar0 > AutopilotLaws_P.Saturation_UpperSat_d) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_UpperSat_d;
  } else if (rtb_Gain_ar0 < AutopilotLaws_P.Saturation_LowerSat_nr) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_LowerSat_nr;
  }

  rtb_Gain_ar0 = (b_R - AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain_c / rtb_Gain_ar0;
  if (rtb_Gain_ar0 > 1.0) {
    rtb_Gain_ar0 = 1.0;
  } else if (rtb_Gain_ar0 < -1.0) {
    rtb_Gain_ar0 = -1.0;
  ...
  b_L = AutopilotLaws_P.Gain_Gain_es * std::asin(rtb_Gain_ar0);
  ...
  rtb_out_f = std::atan(AutopilotLaws_P.fpmtoms_Gain * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) *
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_j5 - AutopilotLaws_P.g_Gain * (AutopilotLaws_P.Gain1_Gain_lp *
    ...
    rtb_Gain_ar0))) * (AutopilotLaws_P.Constant_Value_dy - std::cos(b_R)) + std::sin(b_R) * std::sin
    ...
    AutopilotLaws_P.HighPassFilter_C3, AutopilotLaws_P.HighPassFilter_C4, AutopilotLaws_U.in.time.dt, &rtb_Y_k,
  ...
  b_R = (rtb_Y_k + rtb_Y_j5) * AutopilotLaws_P.ug_Gain;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_bf * rtb_out_f;
  L = b_R + rtb_Tsxlo;
  ...
  rtb_Y_nl = (AutopilotLaws_U.in.data.V_ias_kn - rtb_Y_j5) * AutopilotLaws_P.Gain1_Gain_oz;
  if (rtb_Y_nl <= b_R) {
  ...
  rtb_Gain_du = (AutopilotLaws_P.Gain_Gain_b0 * L - rtb_out_f) + b_R;
  ...
  rtb_out_f = std::atan(AutopilotLaws_P.fpmtoms_Gain_a * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) *
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_j5 - AutopilotLaws_P.g_Gain_h * (AutopilotLaws_P.Gain1_Gain_dv *
    ...
    rtb_Gain_ar0))) * (AutopilotLaws_P.Constant_Value_cg - std::cos(b_R)) + std::sin(b_R) * std::sin
    ...
    AutopilotLaws_U.in.time.dt, &rtb_Y_k, &AutopilotLaws_DWork.sf_LeadLagFilter_h);
  ...
  b_R = (rtb_Y_k + rtb_Y_j5) * AutopilotLaws_P.ug_Gain_a;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_hm * rtb_out_f;
  L = b_R + rtb_Tsxlo;
  R = AutopilotLaws_P.Constant1_Value_b4 - AutopilotLaws_P.Constant2_Value_c;
  rtb_Y_nl = (AutopilotLaws_P.Gain1_Gain_mz * b_R + rtb_Tsxlo) * AutopilotLaws_P.Gain_Gain_ie;
  if (R > AutopilotLaws_P.Switch_Threshold_b) {
    b_R = AutopilotLaws_P.Constant1_Value_a;
  } else {
    b_R = AutopilotLaws_P.Gain5_Gain_l * rtb_Y_nl;
  }
  ...
  if (rtb_Tsxlo <= b_R) {
    if (R > AutopilotLaws_P.Switch1_Threshold_f) {
      ...
      b_R = AutopilotLaws_P.Gain6_Gain_j * rtb_Y_nl;
    }
  ...
  b_R += AutopilotLaws_P.Gain_Gain_kj * L - rtb_out_f;
  ...
  rtb_out_f = std::atan(AutopilotLaws_P.fpmtoms_Gain_i * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) *
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_m * (AutopilotLaws_P.GStoGS_CAS_Gain_o * b_R),
    AutopilotLaws_P.WashoutFilter_C1_l, AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_WashoutFilter_j);
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_nl - AutopilotLaws_P.g_Gain_g * (AutopilotLaws_P.Gain1_Gain_be *
    ...
    rtb_Gain_ar0))) * (AutopilotLaws_P.Constant_Value_j - b_L) + rtb_Gain_du * std::sin(AutopilotLaws_P.Gain1_Gain_hy *
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_n * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4_g, AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_LeadLagFilter_as);
  b_R = (b_R + rtb_Y_nl) * AutopilotLaws_P.ug_Gain_l;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_g1 * rtb_out_f;
  b_L = b_R + rtb_Tsxlo;
  ...
  if ((Phi2 > AutopilotLaws_P.CompareToConstant_const_a) && (rtb_Gain_du < AutopilotLaws_P.CompareToConstant1_const_n) &&
    ...
    if (Phi2 > AutopilotLaws_P.Switch2_Threshold) {
      rtb_Y_nl = AutopilotLaws_P.Constant1_Value_mf;
    } else {
      rtb_Y_nl = AutopilotLaws_P.Gain5_Gain_f * rtb_Gain_du;
    }
  ...
  b_L = (AutopilotLaws_P.Gain_Gain_ce * b_L - rtb_out_f) + b_R;
  rtb_Gain_ar0 = AutopilotLaws_P.kntoms_Gain_a * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Gain_ar0 > AutopilotLaws_P.Saturation_UpperSat_l) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_UpperSat_l;
  } else if (rtb_Gain_ar0 < AutopilotLaws_P.Saturation_LowerSat_hm) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_LowerSat_hm;
  }

  rtb_Gain_du = AutopilotLaws_U.in.input.H_dot_c_fpm - AutopilotLaws_U.in.data.H_dot_ft_min;
  rtb_Gain_ar0 = rtb_Gain_du * AutopilotLaws_P.ftmintoms_Gain_l / rtb_Gain_ar0;
  if (rtb_Gain_ar0 > 1.0) {
    rtb_Gain_ar0 = 1.0;
  } else if (rtb_Gain_ar0 < -1.0) {
    rtb_Gain_ar0 = -1.0;
  ...
  rtb_Y_k = AutopilotLaws_P.Gain_Gain_ey * std::asin(rtb_Gain_ar0);
  AutopilotLaws_VSLimiter(AutopilotLaws_P.VS_Gain_h * rtb_Y_k, AutopilotLaws_U.in.data.V_tas_kn, &rtb_Y_nl);
  ...
  rtb_out_f = std::atan(AutopilotLaws_P.fpmtoms_Gain_o * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) *
    AutopilotLaws_P.Gain_Gain_lx;
  b_R = AutopilotLaws_P.Gain1_Gain_hi * rtb_GainTheta1;
  rtb_Cos_f2 = std::cos(b_R);
  ...
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_gf * rtb_out_f;
  rtb_Cos_f2 = b_R + rtb_Tsxlo;
  rtb_Cos1_pk = AutopilotLaws_P.Constant3_Value_h1 - AutopilotLaws_P.Constant4_Value_f;
  rtb_Gain_ar0 = (AutopilotLaws_P.Gain1_Gain_ovr * b_R + rtb_Tsxlo) * AutopilotLaws_P.Gain_Gain_jy;
  ...
  rtb_Add3_gy = (AutopilotLaws_P.Gain_Gain_j * rtb_Cos_f2 - rtb_out_f) + b_R;
  ...
  rtb_out_f = std::atan(AutopilotLaws_P.fpmtoms_Gain_p * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) *
  ...
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_ot * rtb_out_f;
  rtb_Cos_f2 = b_R + rtb_Tsxlo;
  ...
  rtb_Gain_ar0 = rtb_Y_j5 * AutopilotLaws_P.Gain1_Gain_gy;
  if (rtb_Gain_ar0 <= b_R) {
  ...
  b_R += AutopilotLaws_P.Gain_Gain_dm * rtb_Cos_f2 - rtb_out_f;
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Y_k, rtb_Y_nl, rtb_Add3_gy,
    AutopilotLaws_P.Gain_Gain_h4 * rtb_Add3_gy, b_R, AutopilotLaws_P.Gain_Gain_eq * b_R,
    AutopilotLaws_P.Constant_Value_ga, &rtb_Cos1_pk, &rtb_Cos_f2);
  ...
  rtb_Add3_gy = AutopilotLaws_U.in.input.FPA_c_deg - std::atan(AutopilotLaws_P.fpmtoms_Gain_ps *
    AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) * AutopilotLaws_P.Gain_Gain_g;
  AutopilotLaws_VSLimiter(AutopilotLaws_P.Gain_Gain_c3 * rtb_Add3_gy, AutopilotLaws_U.in.data.V_tas_kn, &rtb_Y_k);
  ...
  rtb_out_f = std::atan(AutopilotLaws_P.fpmtoms_Gain_d * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) *
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_kb * (AutopilotLaws_P.GStoGS_CAS_Gain_o5 * b_R),
    AutopilotLaws_P.WashoutFilter_C1_j, AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_WashoutFilter_h);
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_nl - AutopilotLaws_P.g_Gain_l * (AutopilotLaws_P.Gain1_Gain_n4 *
    ...
    rtb_Gain_ar0))) * (AutopilotLaws_P.Constant_Value_l - rtb_Tsxlo) + rtb_Add3_n2 * std::sin
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_k * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4_dt, AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_LeadLagFilter_k);
  b_R = (b_R + rtb_Y_nl) * AutopilotLaws_P.ug_Gain_n;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_b1 * rtb_out_f;
  rtb_Gain_ar0 = b_R + rtb_Tsxlo;
  ...
  AutopilotLaws_V_LSSpeedSelection1(AutopilotLaws_U.in.input.V_c_kn, AutopilotLaws_U.in.data.VLS_kn, &rtb_Y_nl);
  rtb_Y_nl = (AutopilotLaws_U.in.data.V_ias_kn - rtb_Y_nl) * AutopilotLaws_P.Gain1_Gain_m1;
  if (rtb_Y_nl <= b_R) {
  ...
  rtb_Add3_n2 = (AutopilotLaws_P.Gain_Gain_d0 * rtb_Gain_ar0 - rtb_out_f) + b_R;
  ...
  if (rtb_Gain_ar0 > AutopilotLaws_P.Saturation_UpperSat_c) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_UpperSat_c;
  } else if (rtb_Gain_ar0 < AutopilotLaws_P.Saturation_LowerSat_hd) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_LowerSat_hd;
  }

  rtb_out_f = std::atan(AutopilotLaws_P.fpmtoms_Gain_o2 * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) *
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_ip * (AutopilotLaws_P.GStoGS_CAS_Gain_e * b_R),
    AutopilotLaws_P.WashoutFilter_C1_c, AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_WashoutFilter_g5);
  AutopilotLaws_LeadLagFilter(rtb_Y_nl - AutopilotLaws_P.g_Gain_hq * (AutopilotLaws_P.Gain1_Gain_mx *
    ...
    rtb_Tsxlo))) * (AutopilotLaws_P.Constant_Value_f - rtb_Gain_ar0) + rtb_Cos1_k * std::sin
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_mh * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4_f, AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_LeadLagFilter_a);
  b_R = (b_R + rtb_Y_nl) * AutopilotLaws_P.ug_Gain_e;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_be1 * rtb_out_f;
  rtb_Y_nl = b_R + rtb_Tsxlo;
  ...
  b_R += AutopilotLaws_P.Gain_Gain_gx * rtb_Y_nl - rtb_out_f;
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Add3_gy, rtb_Y_k, rtb_Add3_n2,
    AutopilotLaws_P.Gain_Gain_fnw * rtb_Add3_n2, b_R, AutopilotLaws_P.Gain_Gain_ko * b_R,
    AutopilotLaws_P.Constant_Value_fo, &rtb_FD_a, &rtb_Cos1_k);
  ...
  rtb_out_f = rtb_Add3_gy - AutopilotLaws_DWork.Delay_DSTATE_hi;
  AutopilotLaws_LagFilter(rtb_out_f / AutopilotLaws_U.in.time.dt, AutopilotLaws_P.LagFilter2_C1_k,
    AutopilotLaws_U.in.time.dt, &rtb_out_f, &AutopilotLaws_DWork.sf_LagFilter_b);
  AutopilotLaws_WashoutFilter(rtb_out_f, AutopilotLaws_P.WashoutFilter1_C1, AutopilotLaws_U.in.time.dt, &rtb_Y_nl,
  ...
  AutopilotLaws_SignalEnablerGSTrack(AutopilotLaws_P.Gain4_Gain_g * rtb_Y_nl, rtb_Compare_o1, &rtb_Y_nl);
  ...
  AutopilotLaws_LagFilter(rtb_Y_k + AutopilotLaws_P.Gain3_Gain_n * ((rtb_Add3_n2 - AutopilotLaws_DWork.Delay_DSTATE_n) /
  ...
  AutopilotLaws_SignalEnablerGSTrack(AutopilotLaws_P.Gain3_Gain_c * (rtb_Y_nl + b_R * look1_binlxpw
  ...
  AutopilotLaws_storevalue(rtb_Saturation == AutopilotLaws_P.CompareToConstant6_const,
    AutopilotLaws_Y.out.data.nav_gs_deg, &rtb_Y_nl, &AutopilotLaws_DWork.sf_storevalue_g);
  if (rtb_Y_nl > AutopilotLaws_P.Saturation_UpperSat_e0) {
    rtb_out_f = AutopilotLaws_P.Saturation_UpperSat_e0;
  } else if (rtb_Y_nl < AutopilotLaws_P.Saturation_LowerSat_ph) {
    rtb_out_f = AutopilotLaws_P.Saturation_LowerSat_ph;
  } else {
    rtb_out_f = rtb_Y_nl;
  }

  rtb_Gain_ar0 = AutopilotLaws_P.kntoms_Gain_k4 * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_ar0 > AutopilotLaws_P.Saturation_UpperSat_eb) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_UpperSat_eb;
  } else if (rtb_Gain_ar0 < AutopilotLaws_P.Saturation_LowerSat_gk) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_LowerSat_gk;
  }

  b_R = std::atan(AutopilotLaws_P.fpmtoms_Gain_g4 * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) *
    AutopilotLaws_P.Gain_Gain_ow;
  AutopilotLaws_SignalEnablerGSTrack(AutopilotLaws_P.Gain2_Gain_l * (rtb_out_f - b_R), rtb_Compare_o1, &rtb_Y_nl);
  AutopilotLaws_Voter1(rtb_Tsxlo + rtb_Y_nl, AutopilotLaws_P.Gain1_Gain_d4 * ((rtb_out_f + AutopilotLaws_P.Bias_Bias) -
    b_R), AutopilotLaws_P.Gain_Gain_eyl * ((rtb_out_f + AutopilotLaws_P.Bias1_Bias) - b_R), &rtb_Y_h);
  rtb_out_f = rtb_GainTheta - AutopilotLaws_P.Constant2_Value_f;
  rtb_Gain4_m = AutopilotLaws_P.Gain4_Gain_o * rtb_out_f;
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_U.in.data.H_ind_ft, AutopilotLaws_P.WashoutFilter_C1_ej,
    AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_WashoutFilter_b);
  ...
  AutopilotLaws_LagFilter(b_R, AutopilotLaws_P.LagFilter_C1_p, AutopilotLaws_U.in.time.dt, &rtb_out_f,
    &AutopilotLaws_DWork.sf_LagFilter_ov);
  rtb_Y_k = (rtb_Y_nl + rtb_out_f) * AutopilotLaws_P.DiscreteDerivativeVariableTs2_Gain;
  rtb_out_f = (rtb_Y_k - AutopilotLaws_DWork.Delay_DSTATE_p) / AutopilotLaws_U.in.time.dt;
  AutopilotLaws_LagFilter(AutopilotLaws_P.Gain2_Gain_f * rtb_out_f, AutopilotLaws_P.LagFilter3_C1,
    AutopilotLaws_U.in.time.dt, &rtb_out_f, &AutopilotLaws_DWork.sf_LagFilter_f);
  AutopilotLaws_WashoutFilter(AutopilotLaws_U.in.data.H_dot_ft_min, AutopilotLaws_P.WashoutFilter1_C1_g,
    AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_WashoutFilter_f);
  b_R = rtb_out_f + rtb_Y_nl;
  ...
  if (rtb_Compare_o1) {
    rtb_out_f = -1.0 / AutopilotLaws_DWork.Tau * (AutopilotLaws_U.in.data.H_radio_ft + AutopilotLaws_DWork.H_bias) *
      60.0;
  } else {
    rtb_out_f = b_R;
  }
  ...
  AutopilotLaws_DWork.wasActive = rtb_Compare_o1;
  rtb_Gain_ar0 = AutopilotLaws_P.kntoms_Gain_av * AutopilotLaws_U.in.data.V_gnd_kn;
  if (rtb_Gain_ar0 > AutopilotLaws_P.Saturation_UpperSat_ew) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_UpperSat_ew;
  } else if (rtb_Gain_ar0 < AutopilotLaws_P.Saturation_LowerSat_an) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_LowerSat_an;
  }

  rtb_Gain_ar0 = (rtb_out_f - b_R) * AutopilotLaws_P.ftmintoms_Gain_j / rtb_Gain_ar0;
  if (rtb_Gain_ar0 > 1.0) {
    rtb_Gain_ar0 = 1.0;
  } else if (rtb_Gain_ar0 < -1.0) {
    rtb_Gain_ar0 = -1.0;
  ...
  rtb_out_f = std::atan(AutopilotLaws_P.fpmtoms_Gain_n * AutopilotLaws_U.in.data.H_dot_ft_min / rtb_Gain_ar0) *
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_ks * (AutopilotLaws_P.GStoGS_CAS_Gain_n2 * b_R),
    AutopilotLaws_P.WashoutFilter_C1_d, AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_WashoutFilter_l);
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_nl - AutopilotLaws_P.g_Gain_l0 * (AutopilotLaws_P.Gain1_Gain_et *
    ...
    rtb_Gain_ar0))) * (AutopilotLaws_P.Constant_Value_f3 - rtb_GainTheta1) + rtb_Tsxlo * std::sin
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_il * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4_p, AutopilotLaws_U.in.time.dt, &rtb_Y_nl, &AutopilotLaws_DWork.sf_LeadLagFilter_j0);
  b_R = (b_R + rtb_Y_nl) * AutopilotLaws_P.ug_Gain_c;
  rtb_Tsxlo = AutopilotLaws_P.Gain1_Gain_ejc * rtb_out_f;
  rtb_GainTheta1 = b_R + rtb_Tsxlo;
  rtb_Y_nl = AutopilotLaws_P.Constant2_Value_kz - AutopilotLaws_U.in.data.H_ind_ft;
  ...
  if ((rtb_Y_nl > AutopilotLaws_P.CompareToConstant_const_h) && (rtb_Tsxlo < AutopilotLaws_P.CompareToConstant1_const_g)
      && (b_R < AutopilotLaws_P.CompareToConstant2_const_m)) {
    b_R = AutopilotLaws_P.Constant_Value_gj;
  } else {
    if (rtb_Y_nl > AutopilotLaws_P.Switch2_Threshold_b) {
      rtb_Gain_ar0 = AutopilotLaws_P.Constant1_Value_mq;
    } else {
      rtb_Gain_ar0 = AutopilotLaws_P.Gain5_Gain_k * rtb_Tsxlo;
    }

    if (b_R > rtb_Gain_ar0) {
      b_R = rtb_Gain_ar0;
    } else {
      if (rtb_Y_nl > AutopilotLaws_P.Switch1_Threshold_n) {
        rtb_Y_nl = AutopilotLaws_P.Gain1_Gain_n * rtb_Tsxlo;
        if (AutopilotLaws_P.Constant2_Value_i > rtb_Y_nl) {
          rtb_Y_nl = AutopilotLaws_P.Constant2_Value_i;
        }
      } else {
        rtb_Y_nl = AutopilotLaws_P.Gain6_Gain_o * rtb_Tsxlo;
      }
  ...
  rtb_GainTheta1 = (AutopilotLaws_P.Gain_Gain_p2 * rtb_GainTheta1 - rtb_out_f) + b_R;
  rtb_Gain_ar0 = AutopilotLaws_P.kntoms_Gain_iw * AutopilotLaws_U.in.data.V_tas_kn;
  if (rtb_Gain_ar0 > AutopilotLaws_P.Saturation_UpperSat_jt) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_UpperSat_jt;
  } else if (rtb_Gain_ar0 < AutopilotLaws_P.Saturation_LowerSat_ih) {
    rtb_Gain_ar0 = AutopilotLaws_P.Saturation_LowerSat_ih;
  }

  rtb_Gain_ar0 = (AutopilotLaws_P.Constant_Value_iaf - AutopilotLaws_U.in.data.H_dot_ft_min) *
    AutopilotLaws_P.ftmintoms_Gain_lv / rtb_Gain_ar0;
  if (rtb_Gain_ar0 > 1.0) {
    rtb_Gain_ar0 = 1.0;
  } else if (rtb_Gain_ar0 < -1.0) {
    rtb_Gain_ar0 = -1.0;
  ...
  rtb_Y_nl = AutopilotLaws_P.Gain_Gain_o1 * std::asin(rtb_Gain_ar0);
  AutopilotLaws_Voter1(rtb_Sum_ae, rtb_GainTheta1, rtb_Y_nl, &rtb_out_f);
  ...
  switch (static_cast<int32_T>(rtb_Saturation)) {
   ...
   case 6:
    R = AutopilotLaws_P.Gain1_Gain_d * rtb_Y_h;
    break;
   ...
   case 7:
    if (rtb_on_ground > AutopilotLaws_P.Switch1_Threshold_j) {
      ...
      R = (AutopilotLaws_P.Gain1_Gain_ix * rtb_Y_j5 + rtb_Gain5) + rtb_Gain_n1;
    }
    break;
  ...
  if (R > AutopilotLaws_P.Constant1_Value_i) {
    rtb_out_f = AutopilotLaws_P.Constant1_Value_i;
  } else {
    rtb_out_f = AutopilotLaws_P.Gain1_Gain_nu * AutopilotLaws_P.Constant1_Value_i;
    if (R >= rtb_out_f) {
      rtb_out_f = R;
    }
  }
  ...
  AutopilotLaws_Voter1(rtb_Sum_ae, AutopilotLaws_P.Gain_Gain_jx * rtb_GainTheta1, AutopilotLaws_P.VS_Gain_nx * rtb_Y_nl,
                       &a);
  switch (static_cast<int32_T>(rtb_Saturation)) {
   case 0:
   ...
   case 7:
    if (rtb_on_ground > AutopilotLaws_P.Switch_Threshold) {
      ...
      b_R = (AutopilotLaws_P.Gain3_Gain * rtb_Y_j5 + rtb_Gain5) + AutopilotLaws_P.VS_Gain_e * rtb_Gain_n1;
    }
    break;
  ...
  rtb_Gain_ar0 = b_R - AutopilotLaws_DWork.Delay_DSTATE_h2;
  a = AutopilotLaws_P.Constant2_Value_h1 * AutopilotLaws_U.in.time.dt;
  if (rtb_Gain_ar0 < a) {
    a = rtb_Gain_ar0;
  }

  Phi2 = AutopilotLaws_P.Gain1_Gain_i0l * AutopilotLaws_P.Constant2_Value_h1 * AutopilotLaws_U.in.time.dt;
  if (a > Phi2) {
    Phi2 = a;
  }

  AutopilotLaws_DWork.Delay_DSTATE_h2 += Phi2;
  ...
  AutopilotLaws_RateLimiter(AutopilotLaws_Y.out.output.ap_on, AutopilotLaws_P.RateLimiterVariableTs_up_i,
    ...
    AutopilotLaws_P.RateLimiterVariableTs_InitialCondition_p, &rtb_Y_nl, &AutopilotLaws_DWork.sf_RateLimiter_eb);
  if (rtb_Y_nl > AutopilotLaws_P.Saturation_UpperSat_ix) {
    b_R = AutopilotLaws_P.Saturation_UpperSat_ix;
  } else if (rtb_Y_nl < AutopilotLaws_P.Saturation_LowerSat_eq) {
