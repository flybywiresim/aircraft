...
const uint8_T FlyByWire_IN_Ground_n{ 3U };
...
void FlyByWireModelClass::step()
{
  ...
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, rtb_Gainqk, rtb_Gain, rtb_Gainpk, &rtb_Y_jr,
  ...
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, FlyByWire_P.Gainqk1_Gain * (FlyByWire_P.Gain_Gain_e *
    ...
    FlyByWire_P.Gainpk1_Gain * (FlyByWire_P.Gain_Gain_nm * FlyByWire_U.in.data.p_dot_rad_s2), &rtb_Y_ip, &rtb_Y_pa,
    &rtb_Y_gk);
  ...
  rtb_BusAssignment_sim_data_qk_deg_s = rtb_Y_jr;
  rtb_BusAssignment_sim_input_delta_eta_pos = rtb_uDLookupTable_g;
  rtb_BusAssignment_sim_input_delta_xi_pos = rtb_Limiterxi;
  FlyByWire_LagFilter(FlyByWire_U.in.data.alpha_deg, FlyByWire_P.LagFilter_C1, FlyByWire_U.in.time.dt, &rtb_Y_jr,
                      &FlyByWire_DWork.sf_LagFilter_in);
  FlyByWire_RateLimiter(look2_binlxpw(FlyByWire_U.in.data.V_mach, FlyByWire_U.in.data.flaps_handle_index,
    ...
    FlyByWire_P.alphamax_maxIndex, 4U), FlyByWire_P.RateLimiterVariableTs2_up, FlyByWire_P.RateLimiterVariableTs2_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs2_InitialCondition, &rtb_Y_hb,
                        &FlyByWire_DWork.sf_RateLimiter_aq);
  FlyByWire_RateLimiter(look1_binlxpw(FlyByWire_U.in.data.flaps_handle_index, FlyByWire_P.alpha0_bp01Data,
    FlyByWire_P.alpha0_tableData, 5U), FlyByWire_P.RateLimiterVariableTs3_up, FlyByWire_P.RateLimiterVariableTs3_lo,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_lg);
  FlyByWire_CalculateV_alpha_max(FlyByWire_U.in.data.V_ias_kn, rtb_Y_jr, rtb_Y, rtb_Y_hb, &rtb_Limiterxi);
  ...
  FlyByWire_RateLimiter(look2_binlxpw(FlyByWire_U.in.data.V_mach, FlyByWire_U.in.data.flaps_handle_index,
    ...
    FlyByWire_P.alphaprotection_maxIndex, 4U), FlyByWire_P.RateLimiterVariableTs_up,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition, &rtb_Y_bj, &FlyByWire_DWork.sf_RateLimiter_c);
  if (FlyByWire_U.in.time.simulation_time - FlyByWire_DWork.eventTime <= FlyByWire_P.CompareToConstant_const) {
    rtb_Y_bj = rtb_Y_hb;
  }

  FlyByWire_CalculateV_alpha_max(FlyByWire_U.in.data.V_ias_kn, rtb_Y_jr, rtb_Y, rtb_Y_bj, &rtb_uDLookupTable_g);
  FlyByWire_RateLimiter(look2_binlxpw(FlyByWire_U.in.data.V_mach, FlyByWire_U.in.data.flaps_handle_index,
    ...
    FlyByWire_P.alphafloor_maxIndex, 4U), FlyByWire_P.RateLimiterVariableTs1_up, FlyByWire_P.RateLimiterVariableTs1_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs1_InitialCondition, &rtb_Y_pc,
                        &FlyByWire_DWork.sf_RateLimiter_oq);
  FlyByWire_Y.out.sim.data.rk_dot_deg_s2 = rtb_Y_pa;
  FlyByWire_Y.out.sim.data.pk_dot_deg_s2 = rtb_Y_gk;
  ...
  if ((rtb_BusAssignment_sim_input_delta_eta_pos >= -0.03125) || (rtb_Y_jr >= rtb_Y_hb) ||
      (FlyByWire_DWork.resetEventTime == 0.0)) {
    FlyByWire_DWork.resetEventTime = FlyByWire_U.in.time.simulation_time;
  }

  if ((rtb_on_ground == 0) && (FlyByWire_U.in.data.autopilot_custom_on == 0.0) && (rtb_Y_jr > rtb_Y_bj) &&
      (FlyByWire_DWork.Delay_DSTATE > 10.0)) {
    FlyByWire_DWork.sProtActive_f = 1.0;
  }
  ...
  if ((FlyByWire_U.in.time.simulation_time - FlyByWire_DWork.resetEventTime > 0.5) ||
      (rtb_BusAssignment_sim_input_delta_eta_pos < -0.5) || ((FlyByWire_U.in.data.H_radio_ft < 200.0) &&
       (rtb_BusAssignment_sim_input_delta_eta_pos < 0.5) && (rtb_Y_jr < rtb_Y_bj - 2.0)) || (rtb_on_ground != 0)) {
    FlyByWire_DWork.sProtActive_f = 0.0;
  }

  rtb_Y = FlyByWire_P.DiscreteDerivativeVariableTs_Gain * FlyByWire_U.in.data.V_ias_kn;
  FlyByWire_LagFilter((rtb_Y - FlyByWire_DWork.Delay_DSTATE_m) / FlyByWire_U.in.time.dt, FlyByWire_P.LagFilter_C1_a,
                      FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_LagFilter);
  ...
  if ((rtb_alpha_floor_inhib == 0) && (FlyByWire_U.in.data.V_mach < 0.6)) {
    ...
    if ((rtb_Y_jr > rtb_Y_pc + std::fmin(std::fmax(rtb_Y_gk, static_cast<real_T>(rtb_nz_limit_lo_g)), 0.0)) &&
        (FlyByWire_DWork.Delay_DSTATE > 10.0)) {
  ...
  if (guard1) {
    if ((rtb_alpha_floor_inhib != 0) || (FlyByWire_DWork.sProtActive_f == 0.0)) {
  ...
  FlyByWire_GetIASforMach4(FlyByWire_U.in.data.V_mach, FlyByWire_P.Constant6_Value, FlyByWire_U.in.data.V_ias_kn,
    &rtb_Y_pa);
  rtb_Min3 = std::fmin(FlyByWire_P.Constant5_Value, rtb_Y_pa);
  ...
  if (!FlyByWire_DWork.eventTime_not_empty_p) {
    FlyByWire_DWork.eventTime_f = FlyByWire_U.in.time.simulation_time;
    FlyByWire_DWork.eventTime_not_empty_p = true;
  }
  ...
  {
    FlyByWire_DWork.eventTime_f = FlyByWire_U.in.time.simulation_time;
  } else if (FlyByWire_DWork.eventTime_f == 0.0) {
    FlyByWire_DWork.eventTime_f = FlyByWire_U.in.time.simulation_time;
  }

  FlyByWire_GetIASforMach4(FlyByWire_U.in.data.V_mach, FlyByWire_P.Constant8_Value, FlyByWire_U.in.data.V_ias_kn,
    &rtb_Y_gk);
  rtb_Min5 = std::fmin(FlyByWire_P.Constant7_Value, rtb_Y_gk);
  FlyByWire_Y.out.sim.data.qk_dot_deg_s2 = rtb_Y_ip;
  ...
  FlyByWire_Y.out.sim.data_speeds_aoa.alpha_filtered_deg = rtb_Y_jr;
  ...
  FlyByWire_Y.out.sim.data_computed.protection_ap_disc = (((rtb_on_ground == 0) && (((rtb_ap_special_disc != 0) &&
    (rtb_Y_jr > rtb_Y_hb)) || (rtb_Y_jr > rtb_Y_bj + 0.25))) || (FlyByWire_U.in.time.simulation_time -
    FlyByWire_DWork.eventTime_f > 3.0) || (FlyByWire_DWork.sProtActive != 0.0) || (FlyByWire_DWork.sProtActive_f != 0.0));
  FlyByWire_eta_trim_limit_lofreeze(rtb_Delay_jj, FlyByWire_DWork.sProtActive_f, &rtb_Y_gk,
    &FlyByWire_DWork.sf_eta_trim_limit_lofreeze);
  if (FlyByWire_DWork.sProtActive_f > FlyByWire_P.Switch_Threshold_h) {
    rtb_BusAssignment_cs_pitch_data_computed_eta_trim_deg_limit_lo = rtb_Y_gk;
  } else {
    rtb_BusAssignment_cs_pitch_data_computed_eta_trim_deg_limit_lo = FlyByWire_P.Constant3_Value;
  }

  FlyByWire_eta_trim_limit_lofreeze(rtb_Delay_jj, FlyByWire_DWork.sProtActive, &rtb_Y_gk,
    &FlyByWire_DWork.sf_eta_trim_limit_upfreeze);
  if (FlyByWire_DWork.sProtActive > FlyByWire_P.Switch1_Threshold_k) {
    rtb_BusAssignment_cs_pitch_data_computed_eta_trim_deg_limit_up = rtb_Y_gk;
  } else {
  ...
  if (FlyByWire_DWork.is_active_c3_FlyByWire == 0U) {
    ...
    FlyByWire_DWork.is_c3_FlyByWire = FlyByWire_IN_Ground_n;
  ...
  if (FlyByWire_B.in_flight > FlyByWire_P.Saturation_UpperSat_er) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_er;
  } else if (FlyByWire_B.in_flight < FlyByWire_P.Saturation_LowerSat_a) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_a;
  } else {
    rtb_Y_jr = FlyByWire_B.in_flight;
  }

  FlyByWire_RateLimiter(rtb_Y_jr, FlyByWire_P.RateLimiterVariableTs_up_d, FlyByWire_P.RateLimiterVariableTs_lo_c,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_d, &rtb_Y_hh,
  ...
  if (FlyByWire_DWork.is_active_c6_FlyByWire == 0U) {
    ...
    if ((rtb_Y_hh < 1.0) && (FlyByWire_U.in.data.V_tas_kn > 70.0) && ((FlyByWire_U.in.data.thrust_lever_1_pos >= 35.0) ||
  ...
  } else if ((rtb_Y_hh == 1.0) || (FlyByWire_U.in.data.H_radio_ft > 400.0) || ((FlyByWire_U.in.data.V_tas_kn < 70.0) &&
  ...
  FlyByWire_LagFilter(rtb_GainTheta, FlyByWire_P.LagFilter_C1_n, FlyByWire_U.in.time.dt, &rtb_Y_gk,
  ...
  if (FlyByWire_DWork.is_active_c2_FlyByWire == 0U) {
    ...
    rtb_in_flare = 0;
    FlyByWire_B.flare_Theta_c_deg = rtb_Y_gk;
    ...
    switch (FlyByWire_DWork.is_c2_FlyByWire) {
     ...
     case FlyByWire_IN_Flare_Set_Rate:
      if (FlyByWire_P.ManualSwitch1_CurrentSetting == 1) {
        rtb_Y_jr = FlyByWire_P.Constant1_Value_f;
      } else {
        rtb_Y_jr = FlyByWire_P.Constant_Value_jz;
      }

      if ((FlyByWire_U.in.data.H_radio_ft <= 30.0) || (rtb_Y_jr == 1.0)) {
     ...
     case FlyByWire_IN_Flare_Store_Theta_c_deg:
      if ((FlyByWire_U.in.data.H_radio_ft > 50.0) && (rtb_ManualSwitch == 0.0)) {
        ...
        FlyByWire_B.flare_Theta_c_rate_deg_s = -(rtb_Y_gk + 2.0) / 8.0;
  ...
  FlyByWire_RateLimiter(rtb_nz_limit_up_g, FlyByWire_P.RateLimiterVariableTs1_up_n,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_fb);
  ...
  FlyByWire_RateLimiter(rtb_nz_limit_up_g, FlyByWire_P.RateLimiterVariableTs2_up_f,
                        ...
                        FlyByWire_P.RateLimiterVariableTs2_InitialCondition_b, &rtb_Y_m,
  ...
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_nz_limit_lo_g), FlyByWire_P.RateLimiterVariableTs3_up_c,
                        ...
                        FlyByWire_P.RateLimiterVariableTs3_InitialCondition_b, &rtb_Y_dj,
  ...
  FlyByWire_DWork.Delay_DSTATE_a += std::fmax(std::fmin(FlyByWire_B.flare_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_a,
  ...
  FlyByWire_Y.out.pitch.data_computed.flare_Theta_deg = rtb_Y_gk;
  ...
  if (rtb_nz_limit_up_g > FlyByWire_P.Saturation3_UpperSat) {
    rtb_Gain_gf = FlyByWire_P.Saturation3_UpperSat;
  } else if (rtb_nz_limit_up_g < FlyByWire_P.Saturation3_LowerSat) {
    rtb_Gain_gf = FlyByWire_P.Saturation3_LowerSat;
  } else {
    rtb_Gain_gf = rtb_nz_limit_up_g;
  }
  ...
  rtb_Limiterxi = look1_binlxpw(static_cast<real_T>(FlyByWire_U.in.data.tailstrike_protection_on) * look2_binlxpw
    ...
    rtb_Gain_gf + rtb_nz_limit_up_g, FlyByWire_P.PitchRateDemand_bp01Data, FlyByWire_P.PitchRateDemand_tableData, 2U);
  ...
  rtb_Gain_gf = FlyByWire_P.Gain1_Gain_i * rtb_Limiterxi1 * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_b;
  FlyByWire_LagFilter(rtb_BusAssignment_sim_data_qk_deg_s + FlyByWire_P.Gain5_Gain * rtb_Y_ip,
                      FlyByWire_P.LagFilter_C1_i, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_LagFilter_o);
  rtb_uDLookupTable_g = (((((rtb_Gain_gf - FlyByWire_DWork.Delay_DSTATE_k) / FlyByWire_U.in.time.dt +
    FlyByWire_P.Gain_Gain_h * rtb_Limiterxi1) * FlyByWire_P.Gain1_Gain_a + (rtb_nz_limit_up_g -
    FlyByWire_DWork.Delay_DSTATE_d) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain) + (rtb_Y_gk - rtb_Limiterxi) *
    FlyByWire_P.Gain4_Gain) + FlyByWire_P.Gain6_Gain_f * rtb_Y_ip) * (FlyByWire_P.Constant2_Value_l - rtb_Y_hh) *
  ...
  if (rtb_on_ground > FlyByWire_P.Switch_Threshold_he) {
    if (rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg > FlyByWire_P.Saturation_UpperSat_g5) {
      rtb_uDLookupTable_g = FlyByWire_P.Saturation_UpperSat_g5;
  ...
  FlyByWire_RateLimiter(FlyByWire_U.in.data.autopilot_custom_Theta_c_deg, FlyByWire_P.RateLimiterVariableTs1_up_k,
                        ...
                        FlyByWire_P.RateLimiterVariableTs1_InitialCondition_hb, &rtb_Y_am,
  ...
  FlyByWire_RateLimiter(rtb_BusAssignment_sim_input_delta_eta_pos, FlyByWire_P.RateLimiterVariableTs_up_f,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition_c, &rtb_Y_jq,
  ...
  FlyByWire_DWork.Delay1_DSTATE_i = 1.0 / rtb_Saturation3 * (FlyByWire_P.Constant_Value_hz - rtb_Limiterxi2) *
    FlyByWire_DWork.Delay1_DSTATE_i + (rtb_Divide_o + FlyByWire_DWork.Delay_DSTATE_mj) * (rtb_Limiterxi2 /
    rtb_Saturation3);
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_ke) {
    rtb_Limiterxi2 = (rtb_Y_am - rtb_GainTheta) * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
      FlyByWire_P.ScheduledGain_BreakpointsForDimension1, FlyByWire_P.ScheduledGain_Table, 6U);
  } else {
    rtb_Y_am = look1_binlxpw(rtb_Y_jq, FlyByWire_P.Loaddemand_bp01Data, FlyByWire_P.Loaddemand_tableData, 2U);
    if (rtb_in_flare > FlyByWire_P.Switch_Threshold) {
      rtb_Y_jq = (FlyByWire_DWork.Delay_DSTATE_a - rtb_GainTheta) * FlyByWire_P.Gain_Gain;
      if (rtb_Y_jq > FlyByWire_P.Saturation_UpperSat) {
        rtb_Y_jq = FlyByWire_P.Saturation_UpperSat;
      } else if (rtb_Y_jq < FlyByWire_P.Saturation_LowerSat) {
        rtb_Y_jq = FlyByWire_P.Saturation_LowerSat;
      }
    } else {
      rtb_Y_jq = FlyByWire_P.Constant_Value_m;
    }

    if (FlyByWire_DWork.Delay_DSTATE_g > FlyByWire_P.Saturation_UpperSat_g) {
      rtb_Saturation_k = FlyByWire_P.Saturation_UpperSat_g;
    } else if (FlyByWire_DWork.Delay_DSTATE_g < FlyByWire_P.Saturation_LowerSat_f) {
      rtb_Saturation_k = FlyByWire_P.Saturation_LowerSat_f;
    } else {
      rtb_Saturation_k = FlyByWire_DWork.Delay_DSTATE_g;
    }
    ...
    if (FlyByWire_DWork.sProtActive > FlyByWire_P.Switch2_Threshold) {
      omega_0 = (((((rtb_v_target - FlyByWire_U.in.data.V_ias_kn) * FlyByWire_P.Gain6_Gain +
                  ...
                  rtb_BusAssignment_sim_data_qk_deg_s) + FlyByWire_P.qk_dot_gain1_Gain * rtb_Y_ip) *
        FlyByWire_P.HSP_gain_Gain;
      if (rtb_Y_am > FlyByWire_P.Saturation8_UpperSat) {
        rtb_Switch2_j = FlyByWire_P.Saturation8_UpperSat;
      } else if (rtb_Y_am < FlyByWire_P.Saturation8_LowerSat) {
        rtb_Switch2_j = FlyByWire_P.Saturation8_LowerSat;
      } else {
        rtb_Switch2_j = rtb_Y_am;
      }
    ...
    rtb_Limiterxi2 = ((FlyByWire_P.Constant_Value_mg - rtb_Saturation_k) * rtb_Y_am + rtb_Switch2_j * rtb_Saturation_k)
      + rtb_Y_jq;
  }

  rtb_Y_am = FlyByWire_P.DiscreteDerivativeVariableTs1_Gain * rtb_BusAssignment_sim_data_qk_deg_s;
  ...
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_nz_limit_lo_g) - std::fmin(5.0, std::fmax(0.0, 5.0 -
    (FlyByWire_U.in.data.V_ias_kn - (FlyByWire_U.in.data.VLS_kn + 5.0)) * 0.25)), FlyByWire_P.RateLimiterVariableTs6_up,
                        ...
                        FlyByWire_P.RateLimiterVariableTs6_InitialCondition, &rtb_Y_jq, &FlyByWire_DWork.sf_RateLimiter);
  rtb_Loaddemand2 = FlyByWire_P.Gain1_Gain_d * rtb_GainTheta;
  omega_0 = FlyByWire_P.Gain2_Gain_g * rtb_Y_jq - rtb_Loaddemand2;
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation3_UpperSat_k) {
    rtb_Y_jr = FlyByWire_P.Saturation3_UpperSat_k;
  } else if (FlyByWire_U.in.data.V_tas_kn < FlyByWire_P.Saturation3_LowerSat_l) {
    rtb_Y_jr = FlyByWire_P.Saturation3_LowerSat_l;
  } else {
    rtb_Y_jr = FlyByWire_U.in.data.V_tas_kn;
  }
  ...
  rtb_Saturation3 = (FlyByWire_P.Gain1_Gain_c4 * rtb_BusAssignment_sim_data_qk_deg_s * (FlyByWire_P.Gain_Gain_i4 *
    FlyByWire_P.Vm_currentms_Value_l) + rtb_Gain_ei) - (look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
    FlyByWire_P.uDLookupTable_bp01Data_f, FlyByWire_P.uDLookupTable_tableData_c, 6U) / (FlyByWire_P.Gain5_Gain_k *
    rtb_Y_jr) + FlyByWire_P.Bias_Bias) * ((rtb_Limiterxi + look1_binlxpw(omega_0, FlyByWire_P.Loaddemand1_bp01Data,
    FlyByWire_P.Loaddemand1_tableData, 2U)) - rtb_Limiterxi);
  rtb_Y_jq = rtb_Saturation3 * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.DLUT_bp01Data,
    FlyByWire_P.DLUT_tableData, 1U) * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_l;
  rtb_Saturation_k = FlyByWire_P.DiscreteDerivativeVariableTs2_Gain * FlyByWire_U.in.data.V_tas_kn;
  FlyByWire_LagFilter((rtb_Saturation_k - FlyByWire_DWork.Delay_DSTATE_i2) / FlyByWire_U.in.time.dt,
                      FlyByWire_P.LagFilter_C1_j, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_LagFilter_e);
  if (rtb_Y_gk > FlyByWire_P.SaturationV_dot_UpperSat) {
    rtb_Y_gk = FlyByWire_P.SaturationV_dot_UpperSat;
  } else if (rtb_Y_gk < FlyByWire_P.SaturationV_dot_LowerSat) {
    rtb_Y_gk = FlyByWire_P.SaturationV_dot_LowerSat;
  }

  rtb_Sum1_jv = (((rtb_Y_am - FlyByWire_DWork.Delay_DSTATE_aa) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_j +
                  rtb_Saturation3 * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data,
    FlyByWire_P.PLUT_tableData, 1U)) + (rtb_Y_jq - FlyByWire_DWork.Delay_DSTATE_ib) / FlyByWire_U.in.time.dt) +
    FlyByWire_P.Gain_Gain_de * rtb_Y_gk;
  FlyByWire_WashoutFilter(std::fmin(FlyByWire_U.in.data.spoilers_left_pos, FlyByWire_U.in.data.spoilers_right_pos),
    FlyByWire_P.WashoutFilter_C1, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_WashoutFilter_f);
  if (rtb_Y_gk > FlyByWire_P.SaturationSpoilers_UpperSat) {
    rtb_Y_cw = FlyByWire_P.SaturationSpoilers_UpperSat;
  } else if (rtb_Y_gk < FlyByWire_P.SaturationSpoilers_LowerSat) {
    rtb_Y_cw = FlyByWire_P.SaturationSpoilers_LowerSat;
  } else {
    rtb_Y_cw = rtb_Y_gk;
  }
  ...
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation3_UpperSat_l) {
    rtb_Y_jr = FlyByWire_P.Saturation3_UpperSat_l;
  } else if (FlyByWire_U.in.data.V_tas_kn < FlyByWire_P.Saturation3_LowerSat_n) {
    rtb_Y_jr = FlyByWire_P.Saturation3_LowerSat_n;
  } else {
    rtb_Y_jr = FlyByWire_U.in.data.V_tas_kn;
  }

  rtb_Saturation3 = (FlyByWire_P.Gain1_Gain_g * rtb_BusAssignment_sim_data_qk_deg_s * (FlyByWire_P.Gain_Gain_g *
    FlyByWire_P.Vm_currentms_Value_e) + rtb_Gain_ei) - (look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
    FlyByWire_P.uDLookupTable_bp01Data_d, FlyByWire_P.uDLookupTable_tableData_e, 6U) / (FlyByWire_P.Gain5_Gain_i *
    rtb_Y_jr) + FlyByWire_P.Bias_Bias_b) * (rtb_Y_m - rtb_Limiterxi);
  rtb_Gain_di = rtb_Saturation3 * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.DLUT_bp01Data_p,
    FlyByWire_P.DLUT_tableData_p, 1U) * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_f;
  rtb_Gain_mb = FlyByWire_P.DiscreteDerivativeVariableTs2_Gain_g * FlyByWire_U.in.data.V_tas_kn;
  FlyByWire_LagFilter((rtb_Gain_mb - FlyByWire_DWork.Delay_DSTATE_cb) / FlyByWire_U.in.time.dt,
                      FlyByWire_P.LagFilter_C1_d, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_LagFilter_ee);
  if (rtb_Y_gk > FlyByWire_P.SaturationV_dot_UpperSat_e) {
    rtb_Y_gk = FlyByWire_P.SaturationV_dot_UpperSat_e;
  } else if (rtb_Y_gk < FlyByWire_P.SaturationV_dot_LowerSat_c) {
    rtb_Y_gk = FlyByWire_P.SaturationV_dot_LowerSat_c;
  }

  rtb_Sum1_h = (((rtb_Switch2_j - FlyByWire_DWork.Delay_DSTATE_o) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_jk +
                 rtb_Saturation3 * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data_j,
    FlyByWire_P.PLUT_tableData_j, 1U)) + (rtb_Gain_di - FlyByWire_DWork.Delay_DSTATE_in) / FlyByWire_U.in.time.dt) +
    FlyByWire_P.Gain_Gain_f * rtb_Y_gk;
  FlyByWire_WashoutFilter(std::fmin(FlyByWire_U.in.data.spoilers_left_pos, FlyByWire_U.in.data.spoilers_right_pos),
    FlyByWire_P.WashoutFilter_C1_c, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_WashoutFilter_g);
  if (rtb_Y_gk > FlyByWire_P.SaturationSpoilers_UpperSat_h) {
    y = FlyByWire_P.SaturationSpoilers_UpperSat_h;
  } else if (rtb_Y_gk < FlyByWire_P.SaturationSpoilers_LowerSat_h) {
  ...
  FlyByWire_RateLimiter(rtb_BusAssignment_sim_input_delta_eta_pos, FlyByWire_P.RateLimiterVariableTs2_up_b,
                        ...
                        FlyByWire_P.RateLimiterVariableTs2_InitialCondition_j, &rtb_Y_ln,
                        &FlyByWire_DWork.sf_RateLimiter_e);
  rtb_y_nz = (rtb_Y_hb - rtb_Y_bj) * rtb_Y_ln;
  FlyByWire_LagFilter(FlyByWire_U.in.data.alpha_deg, FlyByWire_P.LagFilter1_C1, FlyByWire_U.in.time.dt, &rtb_Y_gk,
                      &FlyByWire_DWork.sf_LagFilter_k);
  rtb_Saturation3 = rtb_Y_gk - rtb_Y_bj;
  FlyByWire_WashoutFilter(std::fmax(std::fmax(0.0, rtb_GainTheta - 22.5), std::fmax(0.0, (std::abs(rtb_GainPhi) - 3.0) /
    6.0)), FlyByWire_P.WashoutFilter_C1_j, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_WashoutFilter_e);
  rtb_Saturation3 = (rtb_y_nz - rtb_Saturation3) - rtb_Y_gk;
  rtb_Y_ln = FlyByWire_P.Subsystem1_Gain * rtb_Saturation3;
  rtb_Divide_k = (rtb_Y_ln - FlyByWire_DWork.Delay_DSTATE_ps) / FlyByWire_U.in.time.dt;
  rtb_Delay_jj = FlyByWire_U.in.time.dt * FlyByWire_P.Subsystem1_C1;
  rtb_Minup = rtb_Delay_jj + FlyByWire_P.Constant_Value_k;
  FlyByWire_DWork.Delay1_DSTATE_o = 1.0 / rtb_Minup * (FlyByWire_P.Constant_Value_k - rtb_Delay_jj) *
  ...
  rtb_Divide_m1 = (rtb_Minup - FlyByWire_DWork.Delay_DSTATE_l) / FlyByWire_U.in.time.dt;
  ...
  FlyByWire_DWork.Delay_DSTATE_kd += std::fmax(std::fmin(FlyByWire_DWork.sProtActive_f - FlyByWire_DWork.Delay_DSTATE_kd,
    FlyByWire_P.RateLimiterVariableTs5_up * FlyByWire_U.in.time.dt), FlyByWire_U.in.time.dt *
    FlyByWire_P.RateLimiterVariableTs5_lo);
  if (FlyByWire_DWork.Delay_DSTATE_kd > FlyByWire_P.Saturation_UpperSat_p) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_p;
  } else if (FlyByWire_DWork.Delay_DSTATE_kd < FlyByWire_P.Saturation_LowerSat_d) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_d;
  } else {
    rtb_Y_jr = FlyByWire_DWork.Delay_DSTATE_kd;
  }
  ...
  omega_0 = (((FlyByWire_P.precontrol_gain_Gain * FlyByWire_DWork.Delay1_DSTATE_o + rtb_alpha_err_gain) +
             ...
             rtb_BusAssignment_sim_data_qk_deg_s) + FlyByWire_P.qk_dot_gain_Gain * rtb_Y_ip;
  ...
  rtb_Y_ip = omega_0 * rtb_Y_jr;
  rtb_Y_pa = FlyByWire_P.Constant_Value_a - rtb_Y_jr;
  ...
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation3_UpperSat_p) {
    rtb_Y_jr = FlyByWire_P.Saturation3_UpperSat_p;
  } else if (FlyByWire_U.in.data.V_tas_kn < FlyByWire_P.Saturation3_LowerSat_i) {
    rtb_Y_jr = FlyByWire_P.Saturation3_LowerSat_i;
  } else {
    rtb_Y_jr = FlyByWire_U.in.data.V_tas_kn;
  }
  ...
  rtb_Y_jr = rtb_Limiterxi1 - ((rtb_uDLookupTable_g / std::cos(FlyByWire_P.Gain1_Gain_b * rtb_Saturation3) +
    rtb_Limiterxi2) - rtb_Limiterxi) * (look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.uDLookupTable_bp01Data_j,
    FlyByWire_P.uDLookupTable_tableData_l, 6U) / (FlyByWire_P.Gain5_Gain_g * rtb_Y_jr) + FlyByWire_P.Bias_Bias_d);
  rtb_Saturation3 = rtb_Y_jr * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.DLUT_bp01Data_a,
  ...
  FlyByWire_LagFilter((rtb_alpha_err_gain - FlyByWire_DWork.Delay_DSTATE_f) / FlyByWire_U.in.time.dt,
                      FlyByWire_P.LagFilter_C1_h, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_LagFilter_b);
  if (rtb_Y_gk > FlyByWire_P.SaturationV_dot_UpperSat_ee) {
    rtb_uDLookupTable_g = FlyByWire_P.SaturationV_dot_UpperSat_ee;
  } else if (rtb_Y_gk < FlyByWire_P.SaturationV_dot_LowerSat_m) {
    rtb_uDLookupTable_g = FlyByWire_P.SaturationV_dot_LowerSat_m;
  } else {
    rtb_uDLookupTable_g = rtb_Y_gk;
  }

  FlyByWire_WashoutFilter(std::fmin(FlyByWire_U.in.data.spoilers_left_pos, FlyByWire_U.in.data.spoilers_right_pos),
    FlyByWire_P.WashoutFilter_C1_e, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_WashoutFilter_p);
  if (rtb_Y_gk > FlyByWire_P.SaturationSpoilers_UpperSat_c) {
    rtb_Y_gk = FlyByWire_P.SaturationSpoilers_UpperSat_c;
  } else if (rtb_Y_gk < FlyByWire_P.SaturationSpoilers_LowerSat_n) {
    rtb_Y_gk = FlyByWire_P.SaturationSpoilers_LowerSat_n;
  }

  omega_0 = ((((rtb_Delay_jj - FlyByWire_DWork.Delay_DSTATE_gg) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_l +
               rtb_Y_jr * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data_h,
    FlyByWire_P.PLUT_tableData_e, 1U)) + (rtb_Saturation3 - FlyByWire_DWork.Delay_DSTATE_mz) / FlyByWire_U.in.time.dt) +
             FlyByWire_P.Gain_Gain_o * rtb_uDLookupTable_g) + rtb_Y_gk * look1_binlxpw(FlyByWire_U.in.data.H_radio_ft,
    FlyByWire_P.ScheduledGain_BreakpointsForDimension1_d, FlyByWire_P.ScheduledGain_Table_b, 3U);
  rtb_Gain_kq = FlyByWire_P.DiscreteDerivativeVariableTs1_Gain_p * rtb_BusAssignment_sim_data_qk_deg_s;
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation3_UpperSat_b) {
    rtb_Y_jr = FlyByWire_P.Saturation3_UpperSat_b;
  } else if (FlyByWire_U.in.data.V_tas_kn < FlyByWire_P.Saturation3_LowerSat_c) {
    rtb_Y_jr = FlyByWire_P.Saturation3_LowerSat_c;
  } else {
    rtb_Y_jr = FlyByWire_U.in.data.V_tas_kn;
  }

  rtb_Y_jr = (FlyByWire_P.Gain1_Gain_gs * rtb_BusAssignment_sim_data_qk_deg_s * (FlyByWire_P.Gain_Gain_hy *
    FlyByWire_P.Vm_currentms_Value_c) + rtb_Gain_ei) - (look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
    FlyByWire_P.uDLookupTable_bp01Data_lk, FlyByWire_P.uDLookupTable_tableData_p, 6U) / (FlyByWire_P.Gain5_Gain_e *
    rtb_Y_jr) + FlyByWire_P.Bias_Bias_dw) * (rtb_Y_dj - rtb_Limiterxi);
  rtb_Gain_cm = rtb_Y_jr * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.DLUT_bp01Data_f,
    FlyByWire_P.DLUT_tableData_a, 1U) * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_bf;
  rtb_Gain_hd = FlyByWire_P.DiscreteDerivativeVariableTs2_Gain_j * FlyByWire_U.in.data.V_tas_kn;
  FlyByWire_LagFilter((rtb_Gain_hd - FlyByWire_DWork.Delay_DSTATE_d2) / FlyByWire_U.in.time.dt,
                      FlyByWire_P.LagFilter_C1_d2, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_LagFilter_a);
  if (rtb_Y_gk > FlyByWire_P.SaturationV_dot_UpperSat_j) {
    rtb_uDLookupTable_g = FlyByWire_P.SaturationV_dot_UpperSat_j;
  } else if (rtb_Y_gk < FlyByWire_P.SaturationV_dot_LowerSat_m3) {
  ...
  FlyByWire_WashoutFilter(std::fmin(FlyByWire_U.in.data.spoilers_left_pos, FlyByWire_U.in.data.spoilers_right_pos),
    FlyByWire_P.WashoutFilter_C1_a, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_WashoutFilter_m);
  if (rtb_Y_gk > FlyByWire_P.SaturationSpoilers_UpperSat_ci) {
    rtb_Y_gk = FlyByWire_P.SaturationSpoilers_UpperSat_ci;
  } else if (rtb_Y_gk < FlyByWire_P.SaturationSpoilers_LowerSat_j) {
    rtb_Y_gk = FlyByWire_P.SaturationSpoilers_LowerSat_j;
  }

  rtb_Limitereta = ((((rtb_Gain_kq - FlyByWire_DWork.Delay_DSTATE_n4) / FlyByWire_U.in.time.dt *
                      FlyByWire_P.Gain3_Gain_c + rtb_Y_jr * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
    FlyByWire_P.PLUT_bp01Data_i, FlyByWire_P.PLUT_tableData_l, 1U)) + (rtb_Gain_cm - FlyByWire_DWork.Delay_DSTATE_e3) /
                     FlyByWire_U.in.time.dt) + FlyByWire_P.Gain_Gain_f0 * rtb_uDLookupTable_g) + rtb_Y_gk *
    look1_binlxpw(FlyByWire_U.in.data.H_radio_ft, FlyByWire_P.ScheduledGain_BreakpointsForDimension1_n,
  ...
  FlyByWire_VoterAttitudeProtection(rtb_uDLookupTable_g, rtb_Y_ip + rtb_Y_pa * omega_0, rtb_Limitereta, &rtb_Y_gk);
  ...
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation3_UpperSat_d) {
    rtb_Y_jr = FlyByWire_P.Saturation3_UpperSat_d;
  } else if (FlyByWire_U.in.data.V_tas_kn < FlyByWire_P.Saturation3_LowerSat_a) {
    rtb_Y_jr = FlyByWire_P.Saturation3_LowerSat_a;
  } else {
    rtb_Y_jr = FlyByWire_U.in.data.V_tas_kn;
  }
  ...
  rtb_Y_jr = (FlyByWire_P.Gain1_Gain_gh * rtb_BusAssignment_sim_data_qk_deg_s * (FlyByWire_P.Gain_Gain_et *
    FlyByWire_P.Vm_currentms_Value_h) + rtb_Gain_ei) - (look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
    FlyByWire_P.uDLookupTable_bp01Data_le, FlyByWire_P.uDLookupTable_tableData_j, 6U) / (FlyByWire_P.Gain5_Gain_p *
    rtb_Y_jr) + FlyByWire_P.Bias_Bias_n) * ((rtb_Limiterxi + look1_binlxpw(omega_0, FlyByWire_P.Loaddemand2_bp01Data,
    FlyByWire_P.Loaddemand2_tableData, 2U)) - rtb_Limiterxi);
  rtb_Gain_ei = rtb_Y_jr * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.DLUT_bp01Data_ai,
  ...
  FlyByWire_LagFilter((rtb_Loaddemand2 - FlyByWire_DWork.Delay_DSTATE_ak) / FlyByWire_U.in.time.dt,
                      FlyByWire_P.LagFilter_C1_e, FlyByWire_U.in.time.dt, &rtb_Y_pa, &FlyByWire_DWork.sf_LagFilter_m);
  if (rtb_Y_pa > FlyByWire_P.SaturationV_dot_UpperSat_d) {
    y = FlyByWire_P.SaturationV_dot_UpperSat_d;
  } else if (rtb_Y_pa < FlyByWire_P.SaturationV_dot_LowerSat_d) {
  ...
  FlyByWire_WashoutFilter(std::fmin(FlyByWire_U.in.data.spoilers_left_pos, FlyByWire_U.in.data.spoilers_right_pos),
    FlyByWire_P.WashoutFilter_C1_ji, FlyByWire_U.in.time.dt, &rtb_Y_pa, &FlyByWire_DWork.sf_WashoutFilter);
  omega_0 = rtb_Y_cw * look1_binlxpw(FlyByWire_U.in.data.H_radio_ft,
    FlyByWire_P.ScheduledGain_BreakpointsForDimension1_m, FlyByWire_P.ScheduledGain_Table_e, 3U) + rtb_Sum1_jv;
  if (rtb_Y_pa > FlyByWire_P.SaturationSpoilers_UpperSat_j) {
    rtb_Y_pa = FlyByWire_P.SaturationSpoilers_UpperSat_j;
  } else if (rtb_Y_pa < FlyByWire_P.SaturationSpoilers_LowerSat_f) {
    rtb_Y_pa = FlyByWire_P.SaturationSpoilers_LowerSat_f;
  }

  rtb_uDLookupTable_g = ((((rtb_Sum1_h - FlyByWire_DWork.Delay_DSTATE_c5) / FlyByWire_U.in.time.dt *
    FlyByWire_P.Gain3_Gain_n + rtb_Y_jr * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data_b,
    FlyByWire_P.PLUT_tableData_j5, 1U)) + (rtb_Gain_ei - FlyByWire_DWork.Delay_DSTATE_no) / FlyByWire_U.in.time.dt) +
    FlyByWire_P.Gain_Gain_fw * y) + rtb_Y_pa * look1_binlxpw(FlyByWire_U.in.data.H_radio_ft,
  ...
  } else if (omega_0 < FlyByWire_P.Saturation_LowerSat_fc) {
    omega_0 = FlyByWire_P.Saturation_LowerSat_fc;
  }
  ...
  FlyByWire_VoterAttitudeProtection(omega_0, rtb_Y_gk, rtb_uDLookupTable_g, &rtb_Y_gk);
  rtb_Limitereta = rtb_Y_gk * look1_binlxpw(FlyByWire_U.in.time.dt, FlyByWire_P.ScheduledGain_BreakpointsForDimension1_c,
    FlyByWire_P.ScheduledGain_Table_p, 4U);
  rtb_Y_jr = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_k * rtb_Limitereta * FlyByWire_U.in.time.dt;
  FlyByWire_DWork.icLoad_e = ((rtb_Y_hh == 0.0) || (rtb_alpha_floor_inhib != 0) || FlyByWire_DWork.icLoad_e);
  if (FlyByWire_DWork.icLoad_e) {
    ...
    FlyByWire_DWork.Delay_DSTATE_f1 = rtb_LimiteriH_n - rtb_Y_jr;
  }

  FlyByWire_DWork.Delay_DSTATE_f1 += rtb_Y_jr;
  ...
  if (rtb_Y_hh > FlyByWire_P.Saturation_UpperSat_n) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_n;
  } else if (rtb_Y_hh < FlyByWire_P.Saturation_LowerSat_a0) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_a0;
  } else {
    rtb_Y_jr = rtb_Y_hh;
  }

  rtb_uDLookupTable_g = FlyByWire_DWork.Delay_DSTATE_f1 * rtb_Y_jr;
  rtb_Limiterxi = FlyByWire_P.Constant_Value_kq - rtb_Y_jr;
  if (rtb_ManualSwitch > FlyByWire_P.Saturation_UpperSat_dj) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_dj;
  } else if (rtb_ManualSwitch < FlyByWire_P.Saturation_LowerSat_dv) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_dv;
  } else {
    rtb_Y_jr = rtb_ManualSwitch;
  }

  rtb_LimiteriH_n = ((FlyByWire_P.Constant_Value_d - rtb_Y_jr) * rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg
                     + rtb_LimiteriH * rtb_Y_jr) * rtb_Limiterxi + rtb_uDLookupTable_g;
  ...
  rtb_Y_jr = FlyByWire_P.Gain_Gain_ip * rtb_uDLookupTable_g * FlyByWire_P.DiscreteTimeIntegratorVariableTsLimit_Gain *
  ...
  if (FlyByWire_DWork.icLoad_i) {
    FlyByWire_DWork.Delay_DSTATE_h = rtb_eta_trim_deg_reset_deg - rtb_Y_jr;
  }

  FlyByWire_DWork.Delay_DSTATE_h += rtb_Y_jr;
  ...
  FlyByWire_DWork.Delay_DSTATE_io += std::fmax(std::fmin(FlyByWire_DWork.Delay_DSTATE_h -
    FlyByWire_DWork.Delay_DSTATE_io, rtb_eta_trim_deg_rate_limit_up_deg_s * FlyByWire_U.in.time.dt),
    FlyByWire_U.in.time.dt * rtb_eta_trim_deg_rate_limit_lo_deg_s);
  FlyByWire_Y.out.pitch.law_normal.Cstar_g = rtb_Limiterxi1;
  FlyByWire_Y.out.pitch.law_normal.eta_dot_deg_s = rtb_Y_gk;
  ...
  if (rtb_nz_limit_lo_g > FlyByWire_P.Saturation_UpperSat_pm) {
    rtb_uDLookupTable_g = FlyByWire_P.Saturation_UpperSat_pm;
  ...
  FlyByWire_RateLimiter(rtb_uDLookupTable_g, FlyByWire_P.RateLimiterVariableTs_up_k,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition_f, &rtb_Y_cw,
                        &FlyByWire_DWork.sf_RateLimiter_o0);
  FlyByWire_LagFilter(FlyByWire_U.in.data.engine_2_thrust_lbf - FlyByWire_U.in.data.engine_1_thrust_lbf,
                      FlyByWire_P.LagFilter1_C1_j, FlyByWire_U.in.time.dt, &rtb_Y_ip, &FlyByWire_DWork.sf_LagFilter_l);
  if (FlyByWire_U.in.data.alpha_deg > FlyByWire_P.Saturation_UpperSat_l) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_l;
  } else if (FlyByWire_U.in.data.alpha_deg < FlyByWire_P.Saturation_LowerSat_cj) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_cj;
  } else {
    rtb_Y_jr = FlyByWire_U.in.data.alpha_deg;
  }

  FlyByWire_LagFilter(rtb_Y_jr, FlyByWire_P.LagFilter2_C1, FlyByWire_U.in.time.dt, &rtb_Y_pa,
                      &FlyByWire_DWork.sf_LagFilter_eq);
  FlyByWire_LagFilter(FlyByWire_U.in.data.engine_1_thrust_lbf - FlyByWire_U.in.data.engine_2_thrust_lbf,
                      FlyByWire_P.LagFilter3_C1, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_LagFilter_ob);
  ...
  rtb_Y_ip = (rtb_Y_pa * rtb_Y_gk * FlyByWire_P.Gain5_Gain_l + FlyByWire_P.Gain4_Gain_f * rtb_Y_ip) / rtb_Limiterxi /
    rtb_Limiterxi * FlyByWire_P.Gain_Gain_oq;
  rtb_Y_pa = FlyByWire_P.Gain_Gain_c * rtb_BusAssignment_sim_input_delta_xi_pos;
  ...
  } else if (FlyByWire_DWork.sProtActive_f > FlyByWire_P.Switch2_Threshold_i) {
  ...
  rtb_Y_jr = FlyByWire_P.Gain1_Gain_bq * rtb_BusAssignment_sim_input_delta_xi_pos + rtb_uDLookupTable_g;
  if (rtb_Y_jr > FlyByWire_P.Saturation_UpperSat_a) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_a;
  } else if (rtb_Y_jr < FlyByWire_P.Saturation_LowerSat_o) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_o;
  }
  ...
  rtb_uDLookupTable_g = std::fmin(rtb_uDLookupTable_g, std::fmax(rtb_Limiterxi, rtb_Y_jr * rtb_Y_cw)) *
    FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_m * FlyByWire_U.in.time.dt;
  FlyByWire_DWork.icLoad_l = ((rtb_Y_cw == 0.0) || (rtb_alpha_floor_inhib != 0) ||
  ...
  rtb_Y_gk = rtb_Limiterxi1 * 122.0 * 17.9 * -0.090320788790706555 / 1.0E+6;
  omega_0 = 0.0;
  ...
  y = -(omega_0 * omega_0) / rtb_Y_gk;
  FlyByWire_DWork.Delay_DSTATE_eu = ((-(rtb_Limiterxi1 / rtb_Limiterxi * 122.0 * 320.40999999999997 * -0.487 / 1.0E+6 +
    1.414 * omega_0) / rtb_Y_gk * (FlyByWire_P.Gain1_Gain_cb * rtb_pk) + FlyByWire_P.Gain1_Gain_bqd * rtb_GainPhi * y) +
  ...
  if (FlyByWire_DWork.pY > FlyByWire_P.Saturation_UpperSat_k) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation_UpperSat_k;
  } else if (FlyByWire_DWork.pY < FlyByWire_P.Saturation_LowerSat_i) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation_LowerSat_i;
  } else {
    rtb_Limiterxi1 = FlyByWire_DWork.pY;
  }

  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Y_jr;
  y = rtb_uDLookupTable_g;
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation_UpperSat_ek) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_ek;
  } else if (FlyByWire_U.in.data.V_tas_kn < FlyByWire_P.Saturation_LowerSat_j) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_j;
  } else {
    rtb_Y_jr = FlyByWire_U.in.data.V_tas_kn;
  }

  omega_0 = (rtb_Gain - std::sin(FlyByWire_P.Gain1_Gain_f * rtb_uDLookupTable_g) * FlyByWire_P.Constant2_Value_p * std::
             cos(FlyByWire_P.Gain1_Gain_l * rtb_GainTheta) / (FlyByWire_P.Gain6_Gain_k * rtb_Y_jr) *
  ...
  rtb_Limiterxi1 = (FlyByWire_P.Constant_Value_b - rtb_Limiterxi1) * rtb_uDLookupTable_g + omega_0 * rtb_Limiterxi1;
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_on_ground), FlyByWire_P.RateLimiterVariableTs_up_f1,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition_fa, &rtb_Y_jr,
                        &FlyByWire_DWork.sf_RateLimiter_e1);
  if (rtb_Y_jr > FlyByWire_P.Saturation_UpperSat_kc) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_kc;
  } else if (rtb_Y_jr < FlyByWire_P.Saturation_LowerSat_m) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_m;
  }

  rtb_uDLookupTable_g = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg * rtb_Y_jr;
  rtb_Limiterxi = FlyByWire_P.Constant_Value_gs - rtb_Y_jr;
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch2_Threshold_n) {
    rtb_Y_jr = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Y_ip;
  } else {
    rtb_Y_jr = rtb_BusAssignment_a_sim_input_delta_zeta_pos * look1_binlxpw(FlyByWire_U.in.data.V_ias_kn,
  ...
  rtb_Y_gk = FlyByWire_U.in.data.V_ias_kn * 0.5144;
  if (FlyByWire_U.in.data.V_ias_kn >= 60.0) {
    omega_0 = FlyByWire_U.in.data.beta_deg;
    rtb_Y_gk = rtb_Y_gk * rtb_Y_gk * 0.6125 * 122.0 / (70000.0 * Vtas);
    Vtas = (((rtb_Y_gk * 0.814 * FlyByWire_U.in.data.beta_deg * 3.1415926535897931 / 180.0 + -(rtb_Gain *
               3.1415926535897931 / 180.0)) + y * 3.1415926535897931 / 180.0 * (9.81 / Vtas)) + rtb_Y_gk * 3.172 *
  ...
  FlyByWire_LagFilter((rtb_Y_jr - omega_0) * look1_binlxpw(FlyByWire_U.in.data.V_ias_kn,
    FlyByWire_P.ScheduledGain1_BreakpointsForDimension1_a, FlyByWire_P.ScheduledGain1_Table_o, 4U) - Vtas,
                      FlyByWire_P.LagFilter_C1_em, FlyByWire_U.in.time.dt, &rtb_Y_gk, &FlyByWire_DWork.sf_LagFilter_i);
  omega_0 = rtb_Y_jr * look1_binlxpw(FlyByWire_U.in.data.V_ias_kn, FlyByWire_P.ScheduledGain_BreakpointsForDimension1_cf,
    FlyByWire_P.ScheduledGain_Table_d, 8U) + rtb_Y_gk;
  ...
  rtb_Limiterxi = rtb_Y_cw + FlyByWire_U.in.data.autopilot_custom_on;
  if (rtb_Limiterxi > FlyByWire_P.Saturation1_UpperSat_e) {
    rtb_Y_jr = FlyByWire_P.Saturation1_UpperSat_e;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation1_LowerSat_l) {
    rtb_Y_jr = FlyByWire_P.Saturation1_LowerSat_l;
  } else {
    rtb_Y_jr = rtb_Limiterxi;
  }

  if (rtb_Y_jr > FlyByWire_P.Saturation_UpperSat_o) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_o;
  } else if (rtb_Y_jr < FlyByWire_P.Saturation_LowerSat_jf) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_jf;
  }

  rtb_Y_gk = (FlyByWire_P.Constant_Value_cs - rtb_Y_jr) * rtb_Y_pa + FlyByWire_DWork.Delay_DSTATE_eu * rtb_Y_jr;
  ...
  if (rtb_Limiterxi > FlyByWire_P.Saturation_UpperSat_ga) {
    rtb_Y_jr = FlyByWire_P.Saturation_UpperSat_ga;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation_LowerSat_g) {
    rtb_Y_jr = FlyByWire_P.Saturation_LowerSat_g;
  } else {
    rtb_Y_jr = rtb_Limiterxi;
  }

  rtb_Limiterxi = (FlyByWire_P.Constant_Value_hr - rtb_Y_jr) * rtb_Sum1_jv + rtb_uDLookupTable_g * rtb_Y_jr;
  if (FlyByWire_U.in.data.H_radio_ft <= FlyByWire_P.CompareToConstant_const_o) {
    rtb_Y_jr = FlyByWire_P.Constant2_Value_d;
  } else {
    rtb_Y_jr = rtb_uDLookupTable_g - rtb_Limiterxi1;
  }

  rtb_Y_jr = FlyByWire_P.Gain4_Gain_e * rtb_Y_jr * FlyByWire_P.DiscreteTimeIntegratorVariableTs1_Gain *
    FlyByWire_U.in.time.dt;
  ...
  if (FlyByWire_DWork.icLoad_d) {
    FlyByWire_DWork.Delay_DSTATE_f3 = rtb_BusAssignment_a_sim_data_zeta_trim_deg - rtb_Y_jr;
  }

  FlyByWire_DWork.Delay_DSTATE_f3 += rtb_Y_jr;
  ...
  FlyByWire_DWork.Delay_DSTATE_mp += std::fmax(std::fmin(FlyByWire_DWork.Delay_DSTATE_f3 -
    FlyByWire_DWork.Delay_DSTATE_mp, FlyByWire_P.Constant_Value_l * FlyByWire_U.in.time.dt), FlyByWire_U.in.time.dt *
  ...
  FlyByWire_RateLimiter(rtb_LimiteriH_n, FlyByWire_P.RateLimitereta_up, FlyByWire_P.RateLimitereta_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimitereta_InitialCondition, &rtb_Y_jr,
                        &FlyByWire_DWork.sf_RateLimiter_oh);
  FlyByWire_RateLimiter(rtb_Y_gk, FlyByWire_P.RateLimiterxi_up, FlyByWire_P.RateLimiterxi_lo, FlyByWire_U.in.time.dt,
                        FlyByWire_P.RateLimiterxi_InitialCondition, &Vtas, &FlyByWire_DWork.sf_RateLimiter_g);
  FlyByWire_RateLimiter(rtb_Limiterxi, FlyByWire_P.RateLimiterzeta_up, FlyByWire_P.RateLimiterzeta_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterzeta_InitialCondition, &rtb_Y_ja,
                        &FlyByWire_DWork.sf_RateLimiter_ok);
  ...
  FlyByWire_Y.out.sim.data_computed.high_aoa_prot_active = FlyByWire_DWork.sProtActive_f;
  ...
  FlyByWire_Y.out.sim.data_speeds_aoa.alpha_max_deg = rtb_Y_hb;
  FlyByWire_Y.out.sim.data_speeds_aoa.alpha_prot_deg = rtb_Y_bj;
  FlyByWire_Y.out.sim.data_speeds_aoa.alpha_floor_deg = rtb_Y_pc;
  ...
  FlyByWire_Y.out.pitch.data_computed.in_flight_gain = rtb_Y_hh;
  FlyByWire_Y.out.pitch.data_computed.in_rotation_gain = rtb_ManualSwitch;
  FlyByWire_Y.out.pitch.data_computed.nz_limit_up_g = rtb_Y_m;
  FlyByWire_Y.out.pitch.data_computed.nz_limit_lo_g = rtb_Y_dj;
  ...
  FlyByWire_Y.out.pitch.law_normal.protection_alpha_c_deg = rtb_Y_bj + rtb_y_nz;
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_io;
  FlyByWire_Y.out.roll.data_computed.delta_xi_deg = rtb_Y_pa;
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = rtb_Y_cw;
  FlyByWire_Y.out.roll.data_computed.zeta_trim_deg_should_write = (FlyByWire_U.in.data.autopilot_custom_on != 0.0);
  FlyByWire_Y.out.roll.data_computed.beta_target_deg = rtb_Y_ip;
  ...
  u0 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_io;
  ...
  u0 = FlyByWire_P.Gainxi1_Gain_e * rtb_Y_ja;
  ...
  rtb_Y_gk = rtb_GainPhi * 0.5144;
  FlyByWire_RateLimiter(0.814 / std::sqrt(1.3734E+6 / (149.45000000000002 * (rtb_Y_gk * rtb_Y_gk))) * (rtb_GainTheta *
    rtb_BusAssignment_a_sim_input_delta_zeta_pos), FlyByWire_P.RateLimiterVariableTs1_up_p,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_e3);
  FlyByWire_DWork.Delay_DSTATE_m = rtb_Y;
  FlyByWire_DWork.Delay_DSTATE_d = rtb_nz_limit_up_g;
  FlyByWire_DWork.Delay_DSTATE_k = rtb_Gain_gf;
  ...
  FlyByWire_DWork.Delay_DSTATE_mj = rtb_Divide_o;
  FlyByWire_DWork.Delay_DSTATE_aa = rtb_Y_am;
  FlyByWire_DWork.Delay_DSTATE_ib = rtb_Y_jq;
  FlyByWire_DWork.Delay_DSTATE_i2 = rtb_Saturation_k;
  FlyByWire_DWork.Delay_DSTATE_o = rtb_Switch2_j;
  FlyByWire_DWork.Delay_DSTATE_in = rtb_Gain_di;
  FlyByWire_DWork.Delay_DSTATE_cb = rtb_Gain_mb;
  FlyByWire_DWork.Delay_DSTATE_ps = rtb_Y_ln;
  FlyByWire_DWork.Delay_DSTATE_c1 = rtb_Divide_k;
  FlyByWire_DWork.Delay_DSTATE_l = rtb_Minup;
  FlyByWire_DWork.Delay_DSTATE_n = rtb_Divide_m1;
  FlyByWire_DWork.Delay_DSTATE_gg = rtb_Delay_jj;
  FlyByWire_DWork.Delay_DSTATE_mz = rtb_Saturation3;
  FlyByWire_DWork.Delay_DSTATE_f = rtb_alpha_err_gain;
  FlyByWire_DWork.Delay_DSTATE_n4 = rtb_Gain_kq;
  FlyByWire_DWork.Delay_DSTATE_e3 = rtb_Gain_cm;
  FlyByWire_DWork.Delay_DSTATE_d2 = rtb_Gain_hd;
  FlyByWire_DWork.Delay_DSTATE_c5 = rtb_Sum1_h;
  FlyByWire_DWork.Delay_DSTATE_no = rtb_Gain_ei;
  FlyByWire_DWork.Delay_DSTATE_ak = rtb_Loaddemand2;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_m = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_a = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_d = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_d;
  FlyByWire_DWork.Delay_DSTATE_k = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_k;
  ...
  FlyByWire_DWork.Delay_DSTATE_mj = FlyByWire_P.Delay_InitialCondition_l;
  ...
  FlyByWire_DWork.Delay_DSTATE_aa = FlyByWire_P.DiscreteDerivativeVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_ib = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_kb;
  FlyByWire_DWork.Delay_DSTATE_i2 = FlyByWire_P.DiscreteDerivativeVariableTs2_InitialCondition_i;
  FlyByWire_DWork.Delay_DSTATE_o = FlyByWire_P.DiscreteDerivativeVariableTs1_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_in = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_m;
  FlyByWire_DWork.Delay_DSTATE_cb = FlyByWire_P.DiscreteDerivativeVariableTs2_InitialCondition_iw;
  ...
  FlyByWire_DWork.Delay_DSTATE_kd = FlyByWire_P.RateLimiterVariableTs5_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_gg = FlyByWire_P.DiscreteDerivativeVariableTs1_InitialCondition_fh;
  FlyByWire_DWork.Delay_DSTATE_mz = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_f = FlyByWire_P.DiscreteDerivativeVariableTs2_InitialCondition_h;
  FlyByWire_DWork.Delay_DSTATE_n4 = FlyByWire_P.DiscreteDerivativeVariableTs1_InitialCondition_h;
  FlyByWire_DWork.Delay_DSTATE_e3 = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_j;
  FlyByWire_DWork.Delay_DSTATE_d2 = FlyByWire_P.DiscreteDerivativeVariableTs2_InitialCondition_o;
  FlyByWire_DWork.Delay_DSTATE_c5 = FlyByWire_P.DiscreteDerivativeVariableTs1_InitialCondition_i;
  FlyByWire_DWork.Delay_DSTATE_no = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_p;
  FlyByWire_DWork.Delay_DSTATE_ak = FlyByWire_P.DiscreteDerivativeVariableTs2_InitialCondition_d;
  FlyByWire_DWork.icLoad_e = true;
  FlyByWire_DWork.icLoad_i = true;
  FlyByWire_DWork.Delay_DSTATE_io = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
