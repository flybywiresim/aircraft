...
void FlyByWireModelClass::step()
{
  ...
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, FlyByWire_P.Gainqk1_Gain * (FlyByWire_P.Gain_Gain_e *
    ...
    FlyByWire_P.Gainpk1_Gain * (FlyByWire_P.Gain_Gain_nm * FlyByWire_U.in.data.p_dot_rad_s2), &rtb_Y_cp, &rtb_Y_p,
    &rtb_Y_by);
  ...
  FlyByWire_RateLimiter(look2_binlxpw(FlyByWire_U.in.data.V_mach, FlyByWire_U.in.data.flaps_handle_index,
    ...
    FlyByWire_P.alphamax_maxIndex, 4U), FlyByWire_P.RateLimiterVariableTs2_up, FlyByWire_P.RateLimiterVariableTs2_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs2_InitialCondition, &rtb_Y_gk,
  ...
  FlyByWire_CalculateV_alpha_max(FlyByWire_U.in.data.V_ias_kn, rtb_Gain1_b, rtb_Y, rtb_Y_gk, &rtb_Limiterxi);
  ...
  FlyByWire_RateLimiter(look2_binlxpw(FlyByWire_U.in.data.V_mach, FlyByWire_U.in.data.flaps_handle_index,
    ...
    FlyByWire_P.alphaprotection_maxIndex, 4U), FlyByWire_P.RateLimiterVariableTs_up,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition, &rtb_Y_ky,
                        &FlyByWire_DWork.sf_RateLimiter_kb);
  if (FlyByWire_U.in.time.simulation_time - FlyByWire_DWork.eventTime <= FlyByWire_P.CompareToConstant_const) {
    rtb_Y_ky = rtb_Y_gk;
  }

  FlyByWire_CalculateV_alpha_max(FlyByWire_U.in.data.V_ias_kn, rtb_Gain1_b, rtb_Y, rtb_Y_ky, &rtb_uDLookupTable_g);
  FlyByWire_RateLimiter(look2_binlxpw(FlyByWire_U.in.data.V_mach, FlyByWire_U.in.data.flaps_handle_index,
    ...
    FlyByWire_P.alphafloor_maxIndex, 4U), FlyByWire_P.RateLimiterVariableTs1_up, FlyByWire_P.RateLimiterVariableTs1_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs1_InitialCondition, &rtb_Y_dy,
                        &FlyByWire_DWork.sf_RateLimiter_kr);
  FlyByWire_Y.out.sim.data.rk_dot_deg_s2 = rtb_Y_p;
  FlyByWire_Y.out.sim.data.pk_dot_deg_s2 = rtb_Y_by;
  ...
  if ((rtb_BusAssignment_sim_input_delta_eta_pos >= -0.03125) || (rtb_Gain1_b >= rtb_Y_gk) ||
      (FlyByWire_DWork.resetEventTime == 0.0)) {
    FlyByWire_DWork.resetEventTime = FlyByWire_U.in.time.simulation_time;
  }

  if ((rtb_on_ground == 0) && (FlyByWire_U.in.data.autopilot_custom_on == 0.0) && (rtb_Gain1_b > rtb_Y_ky) &&
  ...
  if ((FlyByWire_U.in.time.simulation_time - FlyByWire_DWork.resetEventTime > 0.5) ||
      (rtb_BusAssignment_sim_input_delta_eta_pos < -0.5) || ((FlyByWire_U.in.data.H_radio_ft < 200.0) &&
       (rtb_BusAssignment_sim_input_delta_eta_pos < 0.5) && (rtb_Gain1_b < rtb_Y_ky - 2.0)) || (rtb_on_ground != 0)) {
    FlyByWire_DWork.sProtActive_f = 0.0;
  }

  rtb_Y = FlyByWire_P.DiscreteDerivativeVariableTs_Gain * FlyByWire_U.in.data.V_ias_kn;
  FlyByWire_LagFilter((rtb_Y - FlyByWire_DWork.Delay_DSTATE_g) / FlyByWire_U.in.time.dt, FlyByWire_P.LagFilter_C1_a,
                      FlyByWire_U.in.time.dt, &rtb_Y_by, &FlyByWire_DWork.sf_LagFilter);
  ...
  if ((rtb_alpha_floor_inhib == 0) && (FlyByWire_U.in.data.V_mach < 0.6)) {
    ...
    if ((rtb_Gain1_b > rtb_Y_dy + std::fmin(std::fmax(rtb_Y_by, static_cast<real_T>(rtb_nz_limit_lo_g)), 0.0)) &&
        (FlyByWire_DWork.Delay_DSTATE > 10.0)) {
  ...
  FlyByWire_GetIASforMach4(FlyByWire_U.in.data.V_mach, FlyByWire_P.Constant6_Value, FlyByWire_U.in.data.V_ias_kn,
    &rtb_Y_p);
  rtb_Min3 = std::fmin(FlyByWire_P.Constant5_Value, rtb_Y_p);
  rtb_uDLookupTable_g = rtb_GainTheta - std::cos(FlyByWire_P.Gain1_Gain_p * rtb_GainPhi) * FlyByWire_U.in.data.alpha_deg;
  ...
  FlyByWire_GetIASforMach4(FlyByWire_U.in.data.V_mach, FlyByWire_P.Constant8_Value, FlyByWire_U.in.data.V_ias_kn,
    &rtb_Y_by);
  rtb_Min5 = std::fmin(FlyByWire_P.Constant7_Value, rtb_Y_by);
  FlyByWire_Y.out.sim.data.qk_dot_deg_s2 = rtb_Y_cp;
  ...
  FlyByWire_RateLimiter(L_xi, FlyByWire_P.RateLimiterVariableTs_up_d, FlyByWire_P.RateLimiterVariableTs_lo_c,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_d, &rtb_Y_iw,
  ...
  if (FlyByWire_DWork.is_active_c6_FlyByWire == 0U) {
    ...
    if ((rtb_Y_iw < 1.0) && (FlyByWire_U.in.data.V_tas_kn > 70.0) && ((FlyByWire_U.in.data.thrust_lever_1_pos >= 35.0) ||
  ...
  } else if ((rtb_Y_iw == 1.0) || (FlyByWire_U.in.data.H_radio_ft > 400.0) || ((FlyByWire_U.in.data.V_tas_kn < 70.0) &&
  ...
  FlyByWire_LagFilter(rtb_GainTheta, FlyByWire_P.LagFilter_C1_n, FlyByWire_U.in.time.dt, &rtb_Y_by,
                      &FlyByWire_DWork.sf_LagFilter_e);
  ...
  if (FlyByWire_DWork.is_active_c2_FlyByWire == 0U) {
    ...
    rtb_in_flare = 0;
    FlyByWire_B.flare_Theta_c_deg = rtb_Y_by;
    ...
    switch (FlyByWire_DWork.is_c2_FlyByWire) {
     ...
     case FlyByWire_IN_Flare_Store_Theta_c_deg:
      if ((FlyByWire_U.in.data.H_radio_ft > 50.0) && (rtb_ManualSwitch == 0.0)) {
        ...
        FlyByWire_B.flare_Theta_c_rate_deg_s = -(rtb_Y_by + 2.0) / 8.0;
  ...
  FlyByWire_RateLimiter(rtb_nz_limit_up_g, FlyByWire_P.RateLimiterVariableTs2_up_f,
                        ...
                        FlyByWire_P.RateLimiterVariableTs2_InitialCondition_b, &rtb_Y_h,
  ...
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_nz_limit_lo_g), FlyByWire_P.RateLimiterVariableTs3_up_c,
                        ...
                        FlyByWire_P.RateLimiterVariableTs3_InitialCondition_b, &rtb_Y_cl,
  ...
  FlyByWire_DWork.Delay_DSTATE_o += std::fmax(std::fmin(FlyByWire_B.flare_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_o,
  ...
  FlyByWire_Y.out.pitch.data_computed.flare_Theta_deg = rtb_Y_by;
  ...
  if (rtb_nz_limit_up_g > FlyByWire_P.Saturation3_UpperSat) {
    rtb_Gain_jc = FlyByWire_P.Saturation3_UpperSat;
  } else if (rtb_nz_limit_up_g < FlyByWire_P.Saturation3_LowerSat) {
    rtb_Gain_jc = FlyByWire_P.Saturation3_LowerSat;
  } else {
    rtb_Gain_jc = rtb_nz_limit_up_g;
  }
  ...
  rtb_uDLookupTable_g = look1_binlxpw(static_cast<real_T>(FlyByWire_U.in.data.tailstrike_protection_on) * look2_binlxpw
    ...
    rtb_Gain_jc + rtb_nz_limit_up_g, FlyByWire_P.PitchRateDemand_bp01Data, FlyByWire_P.PitchRateDemand_tableData, 2U);
  ...
  rtb_Gain_jc = FlyByWire_P.Gain1_Gain_i * rtb_Limiterxi * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_b;
  FlyByWire_LagFilter(rtb_qk + FlyByWire_P.Gain5_Gain * rtb_Y_cp, FlyByWire_P.LagFilter_C1_i, FlyByWire_U.in.time.dt,
                      &rtb_Y_by, &FlyByWire_DWork.sf_LagFilter_k);
  rtb_Gain1_b = (((((rtb_Gain_jc - FlyByWire_DWork.Delay_DSTATE_a) / FlyByWire_U.in.time.dt + FlyByWire_P.Gain_Gain_h *
                    rtb_Limiterxi) * FlyByWire_P.Gain1_Gain_a + (rtb_nz_limit_up_g - FlyByWire_DWork.Delay_DSTATE_f) /
                   FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_p) + (rtb_Y_by - rtb_uDLookupTable_g) *
                  FlyByWire_P.Gain4_Gain_g) + FlyByWire_P.Gain6_Gain_f * rtb_Y_cp) * (FlyByWire_P.Constant2_Value_l -
    rtb_Y_iw) * FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain * FlyByWire_U.in.time.dt;
  ...
  if (FlyByWire_DWork.icLoad) {
    FlyByWire_DWork.Delay_DSTATE_e = FlyByWire_P.Constant_Value_hn - rtb_Gain1_b;
  }
  ...
  rtb_Gain1_b = std::cos(FlyByWire_P.Gain1_Gain_pv * rtb_GainTheta);
  ...
  if (rtb_GainPhi > FlyByWire_P.Saturation_UpperSat_d) {
    rtb_Gain_ju = FlyByWire_P.Saturation_UpperSat_d;
  } else if (rtb_GainPhi < FlyByWire_P.Saturation_LowerSat_pr) {
    rtb_Gain_ju = FlyByWire_P.Saturation_LowerSat_pr;
  } else {
    rtb_Gain_ju = rtb_GainPhi;
  }

  rtb_Divide_ke = rtb_Gain1_b / std::cos(FlyByWire_P.Gain1_Gain_b * rtb_Gain_ju);
  FlyByWire_RateLimiter(FlyByWire_U.in.data.autopilot_custom_Theta_c_deg, FlyByWire_P.RateLimiterVariableTs1_up_k,
                        ...
                        FlyByWire_P.RateLimiterVariableTs1_InitialCondition_hb, &rtb_Y_ab,
  ...
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_nz_limit_lo_g) - std::fmin(5.0, std::fmax(0.0, 5.0 -
    (FlyByWire_U.in.data.V_ias_kn - (FlyByWire_U.in.data.VLS_kn + 5.0)) * 0.25)), FlyByWire_P.RateLimiterVariableTs6_up,
                        ...
                        FlyByWire_P.RateLimiterVariableTs6_InitialCondition, &rtb_Y_kw, &FlyByWire_DWork.sf_RateLimiter);
  ...
  rtb_Divide_np = (rtb_Gain_ju - FlyByWire_DWork.Delay_DSTATE_j) / FlyByWire_U.in.time.dt;
  ...
  rtb_Divide_a = (rtb_Gain_gt - FlyByWire_DWork.Delay_DSTATE_p) / FlyByWire_U.in.time.dt;
  ...
  FlyByWire_DWork.Delay_DSTATE_g3 += std::fmax(std::fmin(FlyByWire_DWork.sProtActive - FlyByWire_DWork.Delay_DSTATE_g3,
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_ke) {
    rtb_Gain1_b = (rtb_Y_ab - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    rtb_Gain1_b = FlyByWire_P.Gain1_Gain * rtb_GainTheta;
    rtb_Y_ab = rtb_Divide1 - rtb_Divide_ke;
    rtb_Loaddemand = look1_binlxpw(rtb_Y_k, FlyByWire_P.Loaddemand_bp01Data, FlyByWire_P.Loaddemand_tableData, 2U);
    if (FlyByWire_DWork.Delay_DSTATE_g3 > FlyByWire_P.Saturation_UpperSat_k) {
      rtb_Y_k = FlyByWire_P.Saturation_UpperSat_k;
    } else if (FlyByWire_DWork.Delay_DSTATE_g3 < FlyByWire_P.Saturation_LowerSat_l) {
      rtb_Y_k = FlyByWire_P.Saturation_LowerSat_l;
    } else {
      rtb_Y_k = FlyByWire_DWork.Delay_DSTATE_g3;
    }

    if (FlyByWire_DWork.sProtActive > FlyByWire_P.Switch2_Threshold) {
      rtb_Y_by = (((((rtb_v_target - FlyByWire_U.in.data.V_ias_kn) * FlyByWire_P.Gain6_Gain +
                   ...
                   rtb_qk) + FlyByWire_P.qk_dot_gain1_Gain * rtb_Y_cp) * FlyByWire_P.HSP_gain_Gain;
      ...
      if (rtb_Y_by > FlyByWire_P.Saturation4_UpperSat) {
        rtb_Y_by = FlyByWire_P.Saturation4_UpperSat;
      } else if (rtb_Y_by < FlyByWire_P.Saturation4_LowerSat) {
        rtb_Y_by = FlyByWire_P.Saturation4_LowerSat;
      }

      rtb_Switch_c += rtb_Y_by;
    } else {
      rtb_Switch_c = FlyByWire_P.Constant1_Value;
    }

    rtb_Loaddemand = (FlyByWire_P.Constant_Value_h - rtb_Y_k) * rtb_Loaddemand + rtb_Switch_c * rtb_Y_k;
    ...
    rtb_Y_by = FlyByWire_P.Gain2_Gain * rtb_Y_kw - rtb_Gain1_b;
    if (rtb_Y_by > FlyByWire_P.Saturation1_UpperSat) {
      rtb_Y_by = FlyByWire_P.Saturation1_UpperSat;
    } else if (rtb_Y_by < FlyByWire_P.Saturation1_LowerSat) {
      rtb_Y_by = FlyByWire_P.Saturation1_LowerSat;
    }

    rtb_Y_k = look1_binlxpw(rtb_Y_by, FlyByWire_P.Loaddemand1_bp01Data, FlyByWire_P.Loaddemand1_tableData, 2U) +
      rtb_Y_ab;
    if (rtb_Loaddemand <= rtb_Y_k) {
      rtb_Y_by = FlyByWire_P.Gain3_Gain * FlyByWire_P.Theta_max3_Value - rtb_Gain1_b;
      if (rtb_Y_by > FlyByWire_P.Saturation2_UpperSat) {
        rtb_Y_by = FlyByWire_P.Saturation2_UpperSat;
      } else if (rtb_Y_by < FlyByWire_P.Saturation2_LowerSat) {
        rtb_Y_by = FlyByWire_P.Saturation2_LowerSat;
      }

      rtb_Y_k = look1_binlxpw(rtb_Y_by, FlyByWire_P.Loaddemand2_bp01Data, FlyByWire_P.Loaddemand2_tableData, 2U) +
        rtb_Y_ab;
      if (rtb_Loaddemand >= rtb_Y_k) {
        rtb_Y_k = rtb_Loaddemand;
      }
    }

    rtb_Gain1_b = rtb_Y_k + rtb_Switch_c;
  }

  rtb_Gain1_b += rtb_Divide_ke;
  if (rtb_Gain1_b > rtb_Y_h) {
    rtb_Gain1_b = rtb_Y_h;
  } else if (rtb_Gain1_b < rtb_Y_cl) {
    rtb_Gain1_b = rtb_Y_cl;
  }
  ...
  rtb_Switch_c = (rtb_Y_gk - rtb_Y_ky) * rtb_Divide_ke;
  FlyByWire_LagFilter(FlyByWire_U.in.data.alpha_deg, FlyByWire_P.LagFilter1_C1, FlyByWire_U.in.time.dt, &rtb_Y_by,
  ...
  if ((!FlyByWire_DWork.pY_not_empty_n) || (!FlyByWire_DWork.pU_not_empty)) {
    FlyByWire_DWork.pU = rtb_Divide_ke;
    FlyByWire_DWork.pU_not_empty = true;
    FlyByWire_DWork.pY_m = rtb_Divide_ke;
    FlyByWire_DWork.pY_not_empty_n = true;
  }

  rtb_Y_kw = FlyByWire_U.in.time.dt * FlyByWire_P.WashoutFilter_C1;
  rtb_Y_k = 2.0 / (rtb_Y_kw + 2.0);
  FlyByWire_DWork.pY_m = (2.0 - rtb_Y_kw) / (rtb_Y_kw + 2.0) * FlyByWire_DWork.pY_m + (rtb_Divide_ke * rtb_Y_k -
    FlyByWire_DWork.pU * rtb_Y_k);
  FlyByWire_DWork.pU = rtb_Divide_ke;
  rtb_Limiterxi = (rtb_Switch_c - (rtb_Y_by - rtb_Y_ky)) - FlyByWire_DWork.pY_m;
  rtb_Divide_ke = FlyByWire_P.Subsystem1_Gain * rtb_Limiterxi;
  rtb_Y_kw = (rtb_Divide_ke - FlyByWire_DWork.Delay_DSTATE_ps) / FlyByWire_U.in.time.dt;
  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.Subsystem1_C1;
  rtb_Y_k = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_k;
  FlyByWire_DWork.Delay1_DSTATE_o = 1.0 / rtb_Y_k * (FlyByWire_P.Constant_Value_k - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_o + (rtb_Y_kw + FlyByWire_DWork.Delay_DSTATE_c1) * (rtb_Limiterxi1 / rtb_Y_k);
  rtb_alpha_err_gain = FlyByWire_P.alpha_err_gain_Gain * rtb_Limiterxi;
  rtb_Y_k = FlyByWire_P.Subsystem3_Gain * FlyByWire_U.in.data.V_ias_kn;
  rtb_Y_ab = (rtb_Y_k - FlyByWire_DWork.Delay_DSTATE_l) / FlyByWire_U.in.time.dt;
  ...
  FlyByWire_DWork.Delay1_DSTATE_n = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_c - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_n + (rtb_Y_ab + FlyByWire_DWork.Delay_DSTATE_n) * (rtb_Limiterxi / rtb_Limiterxi1);
  FlyByWire_DWork.Delay_DSTATE_k += std::fmax(std::fmin(FlyByWire_DWork.sProtActive_f - FlyByWire_DWork.Delay_DSTATE_k,
    FlyByWire_P.RateLimiterVariableTs5_up * FlyByWire_U.in.time.dt), FlyByWire_U.in.time.dt *
    FlyByWire_P.RateLimiterVariableTs5_lo);
  if (FlyByWire_DWork.Delay_DSTATE_k > FlyByWire_P.Saturation_UpperSat_gy) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation_UpperSat_gy;
  } else if (FlyByWire_DWork.Delay_DSTATE_k < FlyByWire_P.Saturation_LowerSat_k) {
  ...
  rtb_Y_by = (((FlyByWire_P.precontrol_gain_Gain * FlyByWire_DWork.Delay1_DSTATE_o + rtb_alpha_err_gain) +
               FlyByWire_P.v_dot_gain_Gain * FlyByWire_DWork.Delay1_DSTATE_n) + FlyByWire_P.qk_gain_Gain * rtb_qk) +
    FlyByWire_P.qk_dot_gain_Gain * rtb_Y_cp;
  rtb_Limiterxi = ((rtb_Loaddemand - FlyByWire_DWork.Delay_DSTATE_b) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_l
                   + rtb_Limiterxi * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data,
    FlyByWire_P.PLUT_tableData, 1U)) + (rtb_Divide1 - FlyByWire_DWork.Delay_DSTATE_ar) / FlyByWire_U.in.time.dt;
  if (rtb_Y_by > FlyByWire_P.Saturation3_UpperSat_c) {
    rtb_Y_by = FlyByWire_P.Saturation3_UpperSat_c;
  } else if (rtb_Y_by < FlyByWire_P.Saturation3_LowerSat_h) {
    rtb_Y_by = FlyByWire_P.Saturation3_LowerSat_h;
  }
  ...
  rtb_Limiterxi = (FlyByWire_P.Constant_Value_o - rtb_Limiterxi1) * rtb_Limiterxi + rtb_Y_by * rtb_Limiterxi1;
  ...
  FlyByWire_DWork.icLoad_e = ((rtb_Y_iw == 0.0) || (rtb_alpha_floor_inhib != 0) || FlyByWire_DWork.icLoad_e);
  ...
  if (rtb_Y_iw > FlyByWire_P.Saturation_UpperSat_h) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_h;
  } else if (rtb_Y_iw < FlyByWire_P.Saturation_LowerSat_a3) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_a3;
  } else {
    rtb_Gain1_b = rtb_Y_iw;
  }

  rtb_uDLookupTable_g = FlyByWire_DWork.Delay_DSTATE_f1 * rtb_Gain1_b;
  rtb_Y_cp = FlyByWire_P.Constant_Value_i - rtb_Gain1_b;
  if (rtb_ManualSwitch > FlyByWire_P.Saturation_UpperSat_gx) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_gx;
  } else if (rtb_ManualSwitch < FlyByWire_P.Saturation_LowerSat_n) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_n;
  } else {
    rtb_Gain1_b = rtb_ManualSwitch;
  }

  rtb_LimiteriH = ((FlyByWire_P.Constant_Value_oo - rtb_Gain1_b) *
                   rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg + rtb_Limitereta * rtb_Gain1_b) * rtb_Y_cp +
    rtb_uDLookupTable_g;
  ...
  FlyByWire_DWork.Delay_DSTATE_ia += std::fmax(std::fmin(FlyByWire_DWork.Delay_DSTATE_h -
    FlyByWire_DWork.Delay_DSTATE_ia, rtb_eta_trim_deg_rate_limit_up_deg_s * FlyByWire_U.in.time.dt),
  ...
  FlyByWire_RateLimiter(rtb_uDLookupTable_g, FlyByWire_P.RateLimiterVariableTs_up_k,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition_f, &rtb_Y_c,
                        &FlyByWire_DWork.sf_RateLimiter_l5);
  FlyByWire_LagFilter(FlyByWire_U.in.data.engine_2_thrust_lbf - FlyByWire_U.in.data.engine_1_thrust_lbf,
                      FlyByWire_P.LagFilter1_C1_j, FlyByWire_U.in.time.dt, &rtb_Y_cp, &FlyByWire_DWork.sf_LagFilter_d);
  ...
  FlyByWire_LagFilter(L_xi, FlyByWire_P.LagFilter2_C1, FlyByWire_U.in.time.dt, &rtb_Y_p, &FlyByWire_DWork.sf_LagFilter_a);
  FlyByWire_LagFilter(FlyByWire_U.in.data.engine_1_thrust_lbf - FlyByWire_U.in.data.engine_2_thrust_lbf,
                      FlyByWire_P.LagFilter3_C1, FlyByWire_U.in.time.dt, &rtb_Y_by, &FlyByWire_DWork.sf_LagFilter_a2);
  ...
  rtb_Y_cp = (rtb_Y_p * rtb_Y_by * FlyByWire_P.Gain5_Gain_l + FlyByWire_P.Gain4_Gain_f * rtb_Y_cp) / rtb_Limiterxi /
    rtb_Limiterxi * FlyByWire_P.Gain_Gain_o;
  rtb_Y_p = FlyByWire_P.Gain_Gain_c * rtb_BusAssignment_sim_input_delta_xi_pos;
  ...
  if (rtb_Gain1_b > FlyByWire_P.Saturation_UpperSat_a) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_a;
  ...
  rtb_uDLookupTable_g = std::fmin(rtb_uDLookupTable_g, std::fmax(rtb_Limiterxi, rtb_Gain1_b * rtb_Y_c)) *
    FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_m * FlyByWire_U.in.time.dt;
  FlyByWire_DWork.icLoad_l = ((rtb_Y_c == 0.0) || (rtb_alpha_floor_inhib != 0) ||
    (FlyByWire_U.in.data.autopilot_custom_on != 0.0) || FlyByWire_DWork.icLoad_l);
  if (FlyByWire_DWork.icLoad_l) {
    FlyByWire_DWork.Delay_DSTATE_d = rtb_GainPhi - rtb_uDLookupTable_g;
  }

  FlyByWire_DWork.Delay_DSTATE_d += rtb_uDLookupTable_g;
  if (FlyByWire_DWork.Delay_DSTATE_d > FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit_n) {
    FlyByWire_DWork.Delay_DSTATE_d = FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit_n;
  } else if (FlyByWire_DWork.Delay_DSTATE_d < FlyByWire_P.DiscreteTimeIntegratorVariableTs_LowerLimit_c) {
    FlyByWire_DWork.Delay_DSTATE_d = FlyByWire_P.DiscreteTimeIntegratorVariableTs_LowerLimit_c;
  }

  if (FlyByWire_DWork.Delay_DSTATE_d > FlyByWire_P.Saturation_UpperSat_gn) {
    rtb_Limiterxi = FlyByWire_P.Saturation_UpperSat_gn;
  } else if (FlyByWire_DWork.Delay_DSTATE_d < FlyByWire_P.Saturation_LowerSat_en) {
    rtb_Limiterxi = FlyByWire_P.Saturation_LowerSat_en;
  } else {
    rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_d;
  }
  ...
  rtb_Y_by = rtb_Limiterxi * rtb_Limiterxi * 0.6125;
  L_xi = rtb_Y_by * 122.0 * 17.9 * -0.090320788790706555 / 1.0E+6;
  omega_0 = 0.0;
  ...
  FlyByWire_DWork.Delay_DSTATE_eu = ((-(rtb_Y_by / rtb_Limiterxi * 122.0 * 320.40999999999997 * -0.487 / 1.0E+6 + 1.414 *
    omega_0) / L_xi * (FlyByWire_P.Gain1_Gain_c * rtb_pk) + FlyByWire_P.Gain1_Gain_bqd * rtb_GainPhi * rtb_Limiterxi1) +
  ...
  FlyByWire_RateLimiter(rtb_Gain1_o, FlyByWire_P.RateLimiterVariableTs_up_i, FlyByWire_P.RateLimiterVariableTs_lo_g,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_br);
  ...
  if (FlyByWire_DWork.pY > FlyByWire_P.Saturation_UpperSat_a1) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation_UpperSat_a1;
  } else if (FlyByWire_DWork.pY < FlyByWire_P.Saturation_LowerSat_hv) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation_LowerSat_hv;
  } else {
  ...
  rtb_Y_by = (rtb_Gain - std::sin(FlyByWire_P.Gain1_Gain_f * rtb_uDLookupTable_g) * FlyByWire_P.Constant2_Value_p * std::
  ...
  if (rtb_Y_by > FlyByWire_P.Saturation1_UpperSat_j) {
    rtb_Y_by = FlyByWire_P.Saturation1_UpperSat_j;
  } else if (rtb_Y_by < FlyByWire_P.Saturation1_LowerSat_a) {
    rtb_Y_by = FlyByWire_P.Saturation1_LowerSat_a;
  }
  ...
  rtb_Limiterxi1 = (FlyByWire_P.Constant_Value_e - rtb_Limiterxi1) * rtb_Limiterxi + rtb_Y_by * rtb_Limiterxi1;
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_on_ground), FlyByWire_P.RateLimiterVariableTs_up_f1,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_lz);
  if (rtb_Gain1_b > FlyByWire_P.Saturation_UpperSat_i) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_i;
  } else if (rtb_Gain1_b < FlyByWire_P.Saturation_LowerSat_hf) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_hf;
  }

  rtb_uDLookupTable_g = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg * rtb_Gain1_b;
  rtb_Limiterxi = FlyByWire_P.Constant_Value_mk - rtb_Gain1_b;
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch2_Threshold_n) {
    rtb_Gain1_b = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Y_cp;
  } else {
  ...
  rtb_Y_by = FlyByWire_U.in.data.V_ias_kn * 0.5144;
  if (FlyByWire_U.in.data.V_ias_kn >= 60.0) {
    L_xi = FlyByWire_U.in.data.beta_deg;
    rtb_Y_by = rtb_Y_by * rtb_Y_by * 0.6125 * 122.0 / (70000.0 * Vtas);
    Vtas = (((rtb_Y_by * 0.814 * FlyByWire_U.in.data.beta_deg * 3.1415926535897931 / 180.0 + -(rtb_Gain *
               3.1415926535897931 / 180.0)) + omega_0 * 3.1415926535897931 / 180.0 * (9.81 / Vtas)) + rtb_Y_by * 3.172 *
  ...
  FlyByWire_LagFilter((rtb_Gain1_b - L_xi) * look1_binlxpw(FlyByWire_U.in.data.V_ias_kn,
    FlyByWire_P.ScheduledGain1_BreakpointsForDimension1_a, FlyByWire_P.ScheduledGain1_Table_o, 4U) - Vtas,
                      FlyByWire_P.LagFilter_C1_e, FlyByWire_U.in.time.dt, &rtb_Y_by, &FlyByWire_DWork.sf_LagFilter_n3);
  rtb_Y_by += rtb_Gain1_b * look1_binlxpw(FlyByWire_U.in.data.V_ias_kn,
    FlyByWire_P.ScheduledGain_BreakpointsForDimension1_c, FlyByWire_P.ScheduledGain_Table_d, 8U);
  if (rtb_Y_by > FlyByWire_P.Saturation_UpperSat_p4) {
    rtb_Y_by = FlyByWire_P.Saturation_UpperSat_p4;
  } else if (rtb_Y_by < FlyByWire_P.Saturation_LowerSat_he) {
    rtb_Y_by = FlyByWire_P.Saturation_LowerSat_he;
  }

  rtb_uDLookupTable_g = (rtb_Limiterxi * rtb_Y_by + rtb_uDLookupTable_g) + rtb_Limiterxi1;
  rtb_Limiterxi = rtb_Y_c + FlyByWire_U.in.data.autopilot_custom_on;
  ...
  if (rtb_Gain1_b > FlyByWire_P.Saturation_UpperSat_pg) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_pg;
  } else if (rtb_Gain1_b < FlyByWire_P.Saturation_LowerSat_m) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_m;
  }

  Vtas = (FlyByWire_P.Constant_Value_p - rtb_Gain1_b) * rtb_Y_p + FlyByWire_DWork.Delay_DSTATE_eu * rtb_Gain1_b;
  if (rtb_Limiterxi > FlyByWire_P.Saturation_UpperSat_eq) {
    rtb_Limiterxi = FlyByWire_P.Saturation_UpperSat_eq;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation_LowerSat_nm) {
    rtb_Limiterxi = FlyByWire_P.Saturation_LowerSat_nm;
  }

  if (rtb_Limiterxi > FlyByWire_P.Saturation_UpperSat_pj) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_pj;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation_LowerSat_hfo) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_hfo;
  } else {
    rtb_Gain1_b = rtb_Limiterxi;
  }

  rtb_Limiterxi = (FlyByWire_P.Constant_Value_mn - rtb_Gain1_b) * rtb_Gain1_o + rtb_uDLookupTable_g * rtb_Gain1_b;
  ...
  FlyByWire_RateLimiter(rtb_LimiteriH, FlyByWire_P.RateLimitereta_up, FlyByWire_P.RateLimitereta_lo,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_nw);
  FlyByWire_RateLimiter(Vtas, FlyByWire_P.RateLimiterxi_up, FlyByWire_P.RateLimiterxi_lo, FlyByWire_U.in.time.dt,
                        FlyByWire_P.RateLimiterxi_InitialCondition, &L_xi, &FlyByWire_DWork.sf_RateLimiter_l4);
  FlyByWire_RateLimiter(rtb_Limiterxi, FlyByWire_P.RateLimiterzeta_up, FlyByWire_P.RateLimiterzeta_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterzeta_InitialCondition, &rtb_Y_oh,
                        &FlyByWire_DWork.sf_RateLimiter_j3);
  ...
  rtb_Y_by = FlyByWire_P.Gain_Gain_i * FlyByWire_U.in.data.gear_animation_pos_0 - FlyByWire_P.Constant_Value_g;
  if (rtb_Y_by > FlyByWire_P.Saturation_UpperSat_e) {
    FlyByWire_Y.out.sim.data.gear_strut_compression_0 = FlyByWire_P.Saturation_UpperSat_e;
  } else if (rtb_Y_by < FlyByWire_P.Saturation_LowerSat_e) {
    FlyByWire_Y.out.sim.data.gear_strut_compression_0 = FlyByWire_P.Saturation_LowerSat_e;
  } else {
    FlyByWire_Y.out.sim.data.gear_strut_compression_0 = rtb_Y_by;
  }
  ...
  FlyByWire_Y.out.sim.data_speeds_aoa.alpha_max_deg = rtb_Y_gk;
  FlyByWire_Y.out.sim.data_speeds_aoa.alpha_prot_deg = rtb_Y_ky;
  FlyByWire_Y.out.sim.data_speeds_aoa.alpha_floor_deg = rtb_Y_dy;
  ...
  FlyByWire_Y.out.pitch.data_computed.in_flight_gain = rtb_Y_iw;
  FlyByWire_Y.out.pitch.data_computed.in_rotation_gain = rtb_ManualSwitch;
  FlyByWire_Y.out.pitch.data_computed.nz_limit_up_g = rtb_Y_h;
  FlyByWire_Y.out.pitch.data_computed.nz_limit_lo_g = rtb_Y_cl;
  ...
  FlyByWire_Y.out.pitch.law_normal.protection_alpha_c_deg = rtb_Y_ky + rtb_Switch_c;
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_ia;
  FlyByWire_Y.out.roll.data_computed.delta_xi_deg = rtb_Y_p;
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = rtb_Y_c;
  FlyByWire_Y.out.roll.data_computed.zeta_trim_deg_should_write = (FlyByWire_U.in.data.autopilot_custom_on != 0.0);
  FlyByWire_Y.out.roll.data_computed.beta_target_deg = rtb_Y_cp;
  ...
  u0 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_ia;
  ...
  u0 = FlyByWire_P.Gainxi1_Gain_e * rtb_Y_oh;
  ...
  rtb_Y_by = rtb_GainPhi * 0.5144;
  FlyByWire_RateLimiter(0.814 / std::sqrt(1.3734E+6 / (149.45000000000002 * (rtb_Y_by * rtb_Y_by))) * (rtb_GainTheta *
  ...
  FlyByWire_DWork.Delay_DSTATE_g = rtb_Y;
  FlyByWire_DWork.Delay_DSTATE_f = rtb_nz_limit_up_g;
  FlyByWire_DWork.Delay_DSTATE_a = rtb_Gain_jc;
  ...
  FlyByWire_DWork.Delay_DSTATE_c1 = rtb_Y_kw;
  FlyByWire_DWork.Delay_DSTATE_l = rtb_Y_k;
  FlyByWire_DWork.Delay_DSTATE_n = rtb_Y_ab;
  FlyByWire_DWork.Delay_DSTATE_b = rtb_Loaddemand;
  FlyByWire_DWork.Delay_DSTATE_ar = rtb_Divide1;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_ia = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
