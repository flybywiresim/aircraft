...
void FlyByWireModelClass::step()
{
  ...
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, rtb_Gainqk, rtb_Gain, rtb_Gainpk, &rtb_Y_h, &rtb_Y_l, &rtb_Y_pf);
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, FlyByWire_P.Gainqk1_Gain * (FlyByWire_P.Gain_Gain_e *
    ...
    FlyByWire_P.Gainpk1_Gain * (FlyByWire_P.Gain_Gain_nm * FlyByWire_U.in.data.p_dot_rad_s2), &rtb_Y_p, &rtb_Y_k,
    &rtb_Y_g);
  ...
  FlyByWire_Y.out.sim.data.rk_dot_deg_s2 = rtb_Y_k;
  FlyByWire_Y.out.sim.data.pk_dot_deg_s2 = rtb_Y_g;
  ...
  FlyByWire_LagFilter((rtb_Gain_kh - FlyByWire_DWork.Delay_DSTATE_d) / FlyByWire_U.in.time.dt,
                      FlyByWire_P.LagFilter_C1_a, FlyByWire_U.in.time.dt, &rtb_Y_g, &FlyByWire_DWork.sf_LagFilter);
  ...
  if ((rtb_alpha_floor_inhib == 0) && (FlyByWire_U.in.data.V_mach < 0.6)) {
    ...
    if ((rtb_Limiterxi1 > rtb_Gain1_b + std::fmin(std::fmax(rtb_Y_g, static_cast<real_T>(rtb_nz_limit_lo_g)), 0.0)) &&
        (FlyByWire_DWork.Delay_DSTATE > 10.0)) {
  ...
  FlyByWire_GetIASforMach4(FlyByWire_U.in.data.V_mach, FlyByWire_P.Constant6_Value, FlyByWire_U.in.data.V_ias_kn,
    &rtb_Y_k);
  rtb_Min3 = std::fmin(FlyByWire_P.Constant5_Value, rtb_Y_k);
  ...
  if ((FlyByWire_U.in.data.autopilot_custom_on == 0.0) && (FlyByWire_U.in.data.V_ias_kn > std::fmin(look1_binlxpw
        (rtb_LimiteriH, FlyByWire_P.uDLookupTable1_bp01Data, FlyByWire_P.uDLookupTable1_tableData, 3U),
        FlyByWire_U.in.data.V_ias_kn / FlyByWire_U.in.data.V_mach * look1_binlxpw(rtb_LimiteriH,
  ...
  if (FlyByWire_U.in.data.V_ias_kn <= std::fmin(365.0, FlyByWire_U.in.data.V_ias_kn / FlyByWire_U.in.data.V_mach *
       (look1_binlxpw(rtb_LimiteriH, FlyByWire_P.uDLookupTable_bp01Data, FlyByWire_P.uDLookupTable_tableData, 3U) + 0.01)))
  {
    FlyByWire_DWork.eventTime_b = FlyByWire_U.in.time.simulation_time;
  ...
  FlyByWire_GetIASforMach4(FlyByWire_U.in.data.V_mach, FlyByWire_P.Constant8_Value, FlyByWire_U.in.data.V_ias_kn,
    &rtb_Y_g);
  rtb_Min5 = std::fmin(FlyByWire_P.Constant7_Value, rtb_Y_g);
  FlyByWire_Y.out.sim.data.qk_deg_s = rtb_Y_h;
  FlyByWire_Y.out.sim.data.rk_deg_s = rtb_Y_l;
  rtb_BusAssignment_a_sim_data_pk_deg_s = rtb_Y_pf;
  rtb_BusAssignment_a_sim_data_qk_dot_deg_s2 = rtb_Y_p;
  ...
  FlyByWire_RateLimiter(u0_1, FlyByWire_P.RateLimiterVariableTs_up_d, FlyByWire_P.RateLimiterVariableTs_lo_c,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_d, &rtb_Y_pf,
  ...
  if (FlyByWire_DWork.is_active_c6_FlyByWire == 0U) {
    ...
    if ((rtb_Y_pf < 1.0) && (FlyByWire_U.in.data.V_tas_kn > 70.0) && ((FlyByWire_U.in.data.thrust_lever_1_pos >= 35.0) ||
  ...
  } else if ((rtb_Y_pf == 1.0) || (FlyByWire_U.in.data.H_radio_ft > 400.0) || ((FlyByWire_U.in.data.V_tas_kn < 70.0) &&
  ...
  FlyByWire_LagFilter(rtb_GainTheta, FlyByWire_P.LagFilter_C1_n, FlyByWire_U.in.time.dt, &rtb_Y_l,
  ...
  if (FlyByWire_DWork.is_active_c2_FlyByWire == 0U) {
    ...
    rtb_in_flare = 0;
    FlyByWire_B.flare_Theta_c_deg = rtb_Y_l;
    ...
    switch (FlyByWire_DWork.is_c2_FlyByWire) {
     ...
     case FlyByWire_IN_Flare_Store_Theta_c_deg:
      if ((FlyByWire_U.in.data.H_radio_ft > 50.0) && (rtb_ManualSwitch == 0.0)) {
        ...
        FlyByWire_B.flare_Theta_c_rate_deg_s = -(rtb_Y_l + 2.0) / 8.0;
  ...
  FlyByWire_RateLimiter(rtb_ManualSwitch, FlyByWire_P.RateLimiterVariableTs1_up_n,
                        ...
                        FlyByWire_P.RateLimiterVariableTs1_InitialCondition_h, &rtb_Y_p,
  ...
  FlyByWire_RateLimiter(rtb_nz_limit_up_g, FlyByWire_P.RateLimiterVariableTs2_up_f,
                        ...
                        FlyByWire_P.RateLimiterVariableTs2_InitialCondition_b, &rtb_Y_k,
  ...
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_nz_limit_lo_g), FlyByWire_P.RateLimiterVariableTs3_up_c,
                        ...
                        FlyByWire_P.RateLimiterVariableTs3_InitialCondition_b, &rtb_Y_g,
  ...
  rtb_Limitereta_d = rtb_Y_h;
  rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg = FlyByWire_P.Gain_Gain_d *
    rtb_BusAssignment_sim_input_delta_eta_pos;
  rtb_BusAssignment_cs_pitch_data_computed_nz_limit_lo_g = rtb_Y_g;
  FlyByWire_Y.out.pitch.data_computed.flare_Theta_deg = rtb_Y_l;
  FlyByWire_RateLimiter(rtb_BusAssignment_sim_input_delta_eta_pos, FlyByWire_P.RateLimiterVariableTs_up_dl,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition_n, &rtb_Y_g,
                        &FlyByWire_DWork.sf_RateLimiter_l);
  if (rtb_Y_g > FlyByWire_P.Saturation3_UpperSat) {
    rtb_Gain_ob = FlyByWire_P.Saturation3_UpperSat;
  } else if (rtb_Y_g < FlyByWire_P.Saturation3_LowerSat) {
  ...
  rtb_LimiteriH = look1_binlxpw(static_cast<real_T>(FlyByWire_U.in.data.tailstrike_protection_on) * look2_binlxpw
    ...
    rtb_Gain_ob + rtb_Y_g, FlyByWire_P.PitchRateDemand_bp01Data, FlyByWire_P.PitchRateDemand_tableData, 2U);
  rtb_Gain_ob = FlyByWire_P.DiscreteDerivativeVariableTs_Gain_c * rtb_LimiteriH;
  rtb_Limiterxi = rtb_Y_h - rtb_LimiteriH;
  rtb_Gain_ly = FlyByWire_P.Gain1_Gain_i * rtb_Limiterxi * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_b;
  FlyByWire_LagFilter(rtb_Y_h + FlyByWire_P.Gain5_Gain * rtb_BusAssignment_a_sim_data_qk_dot_deg_s2,
                      FlyByWire_P.LagFilter_C1_i, FlyByWire_U.in.time.dt, &rtb_Y_g, &FlyByWire_DWork.sf_LagFilter_p);
  rtb_Gain1_b = (((((rtb_Gain_ly - FlyByWire_DWork.Delay_DSTATE_dd) / FlyByWire_U.in.time.dt + FlyByWire_P.Gain_Gain_h *
                   ...
                   FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_p) + (rtb_Y_g - rtb_LimiteriH) *
                  FlyByWire_P.Gain4_Gain_g) + FlyByWire_P.Gain6_Gain_f * rtb_BusAssignment_a_sim_data_qk_dot_deg_s2) *
    (FlyByWire_P.Constant2_Value_l - rtb_Y_pf) * FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain *
    FlyByWire_U.in.time.dt;
  FlyByWire_DWork.icLoad = (((rtb_BusAssignment_sim_input_delta_eta_pos <= FlyByWire_P.Constant_Value_j) &&
    (rtb_on_ground != 0)) || (rtb_Y_p == 0.0) || (rtb_alpha_floor_inhib != 0) || FlyByWire_DWork.icLoad);
  ...
  rtb_LimiteriH = FlyByWire_P.Gain1_Gain_j * rtb_Y_h * (FlyByWire_P.Gain_Gain_dc * FlyByWire_P.Vm_currentms_Value) +
  ...
  FlyByWire_RateLimiter(FlyByWire_U.in.data.autopilot_custom_Theta_c_deg, FlyByWire_P.RateLimiterVariableTs1_up_k,
                        ...
                        FlyByWire_P.RateLimiterVariableTs1_InitialCondition_hb, &rtb_Y_l,
  ...
  FlyByWire_RateLimiter(rtb_BusAssignment_sim_input_delta_eta_pos, FlyByWire_P.RateLimiterVariableTs_up_f,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition_c, &rtb_Y_h,
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_ke) {
    rtb_Gain1_b = (rtb_Y_l - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    rtb_Gain1_b = FlyByWire_P.Gain1_Gain * rtb_GainTheta;
    rtb_Y_l = rtb_Divide1 - rtb_Limiterxi2;
    rtb_Loaddemand = look1_binlxpw(rtb_Y_h, FlyByWire_P.Loaddemand_bp01Data, FlyByWire_P.Loaddemand_tableData, 2U);
    if (FlyByWire_DWork.Delay_DSTATE_g > FlyByWire_P.Saturation_UpperSat_o) {
      rtb_Y_h = FlyByWire_P.Saturation_UpperSat_o;
    } else if (FlyByWire_DWork.Delay_DSTATE_g < FlyByWire_P.Saturation_LowerSat_k) {
      rtb_Y_h = FlyByWire_P.Saturation_LowerSat_k;
    } else {
      rtb_Y_h = FlyByWire_DWork.Delay_DSTATE_g;
    }
    ...
    if (FlyByWire_DWork.sProtActive > FlyByWire_P.Switch2_Threshold) {
      u0_1 = (((((rtb_v_target - FlyByWire_U.in.data.V_ias_kn) * FlyByWire_P.Gain6_Gain +
                ...
                * FlyByWire_DWork.Delay1_DSTATE_i) + FlyByWire_P.qk_gain_HSP_Gain * rtb_Limitereta_d) +
              FlyByWire_P.qk_dot_gain1_Gain * rtb_BusAssignment_a_sim_data_qk_dot_deg_s2) * FlyByWire_P.HSP_gain_Gain;
      ...
      } else if (u0_1 < FlyByWire_P.Saturation4_LowerSat) {
    ...
    rtb_Loaddemand = (FlyByWire_P.Constant_Value_k - rtb_Y_h) * rtb_Loaddemand + rtb_Switch_c * rtb_Y_h;
    ...
    u0_1 = FlyByWire_P.Gain2_Gain * rtb_Y - rtb_Gain1_b;
    if (u0_1 > FlyByWire_P.Saturation1_UpperSat) {
      u0_1 = FlyByWire_P.Saturation1_UpperSat;
    } else if (u0_1 < FlyByWire_P.Saturation1_LowerSat) {
      u0_1 = FlyByWire_P.Saturation1_LowerSat;
    }

    rtb_Y_h = look1_binlxpw(u0_1, FlyByWire_P.Loaddemand1_bp01Data, FlyByWire_P.Loaddemand1_tableData, 2U) + rtb_Y_l;
    if (rtb_Loaddemand <= rtb_Y_h) {
      u0_1 = FlyByWire_P.Gain3_Gain * FlyByWire_P.Theta_max3_Value - rtb_Gain1_b;
      if (u0_1 > FlyByWire_P.Saturation2_UpperSat) {
        u0_1 = FlyByWire_P.Saturation2_UpperSat;
      } else if (u0_1 < FlyByWire_P.Saturation2_LowerSat) {
        u0_1 = FlyByWire_P.Saturation2_LowerSat;
      }

      rtb_Y_h = look1_binlxpw(u0_1, FlyByWire_P.Loaddemand2_bp01Data, FlyByWire_P.Loaddemand2_tableData, 2U) + rtb_Y_l;
      if (rtb_Loaddemand >= rtb_Y_h) {
        rtb_Y_h = rtb_Loaddemand;
      }
    }

    rtb_Gain1_b = rtb_Y_h + rtb_Switch_c;
  }

  rtb_Gain1_b += rtb_Limiterxi2;
  if (rtb_Gain1_b > rtb_Y_k) {
    rtb_Gain1_b = rtb_Y_k;
  ...
  FlyByWire_RateLimiter(rtb_BusAssignment_sim_input_delta_eta_pos, FlyByWire_P.RateLimiterVariableTs2_up_b,
                        ...
                        FlyByWire_P.RateLimiterVariableTs2_InitialCondition_j, &rtb_Y_g,
                        &FlyByWire_DWork.sf_RateLimiter_p);
  rtb_Switch_c = (rtb_BusAssignment_c_sim_data_speeds_aoa_alpha_max_deg - rtb_Switch) * rtb_Y_g;
  FlyByWire_LagFilter(FlyByWire_U.in.data.alpha_deg, FlyByWire_P.LagFilter1_C1, FlyByWire_U.in.time.dt, &rtb_Y_g,
                      &FlyByWire_DWork.sf_LagFilter_h);
  rtb_Limiterxi = rtb_Y_g - rtb_Switch;
  FlyByWire_WashoutFilter(std::fmax(std::fmax(0.0, rtb_GainTheta - 22.5), std::fmax(0.0, (std::abs(rtb_GainPhi) - 3.0) /
    6.0)), FlyByWire_P.WashoutFilter_C1, FlyByWire_U.in.time.dt, &rtb_Y_g, &FlyByWire_DWork.sf_WashoutFilter);
  rtb_Limiterxi = (rtb_Switch_c - rtb_Limiterxi) - rtb_Y_g;
  rtb_Y = FlyByWire_P.Subsystem1_Gain * rtb_Limiterxi;
  rtb_Y_h = (rtb_Y - FlyByWire_DWork.Delay_DSTATE_ps) / FlyByWire_U.in.time.dt;
  ...
  FlyByWire_DWork.Delay1_DSTATE_o = 1.0 / rtb_Limiterxi2 * (FlyByWire_P.Constant_Value_kr - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_o + (rtb_Y_h + FlyByWire_DWork.Delay_DSTATE_c1) * (rtb_Limiterxi1 / rtb_Limiterxi2);
  rtb_Y_g = FlyByWire_P.alpha_err_gain_Gain * rtb_Limiterxi;
  rtb_Y_l = FlyByWire_P.Subsystem3_Gain * FlyByWire_U.in.data.V_ias_kn;
  rtb_Limiterxi2 = (rtb_Y_l - FlyByWire_DWork.Delay_DSTATE_l) / FlyByWire_U.in.time.dt;
  ...
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation3_UpperSat_p) {
    u0_1 = FlyByWire_P.Saturation3_UpperSat_p;
  } else if (FlyByWire_U.in.data.V_tas_kn < FlyByWire_P.Saturation3_LowerSat_i) {
    u0_1 = FlyByWire_P.Saturation3_LowerSat_i;
  } else {
  ...
  rtb_Limiterxi = rtb_LimiteriH - (look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.uDLookupTable_bp01Data_j,
    FlyByWire_P.uDLookupTable_tableData_l, 6U) / (FlyByWire_P.Gain5_Gain_g * u0_1) + FlyByWire_P.Bias_Bias) *
  ...
  u0_1 = (((FlyByWire_P.precontrol_gain_Gain * FlyByWire_DWork.Delay1_DSTATE_o + rtb_Y_g) + FlyByWire_P.v_dot_gain_Gain *
           FlyByWire_DWork.Delay1_DSTATE_n) + FlyByWire_P.qk_gain_Gain * rtb_Limitereta_d) +
  ...
  } else if (u0_1 < FlyByWire_P.Saturation3_LowerSat_h) {
  ...
  rtb_Limiterxi = (FlyByWire_P.Constant_Value_p - rtb_Limiterxi1) * rtb_Limiterxi + u0_1 * rtb_Limiterxi1;
  ...
  FlyByWire_DWork.icLoad_e = ((rtb_Y_pf == 0.0) || (rtb_alpha_floor_inhib != 0) || FlyByWire_DWork.icLoad_e);
  if (FlyByWire_DWork.icLoad_e) {
    ...
    FlyByWire_DWork.Delay_DSTATE_f1 = u0_1 - rtb_Gain1_b;
  }
  ...
  if (rtb_Y_pf > FlyByWire_P.Saturation_UpperSat_g4) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_g4;
  } else if (rtb_Y_pf < FlyByWire_P.Saturation_LowerSat_l) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_l;
  } else {
    rtb_Gain1_b = rtb_Y_pf;
  }

  rtb_LimiteriH = FlyByWire_DWork.Delay_DSTATE_f1 * rtb_Gain1_b;
  rtb_Y_g = FlyByWire_P.Constant_Value_o - rtb_Gain1_b;
  if (rtb_Y_p > FlyByWire_P.Saturation_UpperSat_c) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_c;
  } else if (rtb_Y_p < FlyByWire_P.Saturation_LowerSat_m) {
  ...
  rtb_LimiteriH_n = ((FlyByWire_P.Constant_Value_ju - rtb_Gain1_b) *
                     rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg + rtb_Limitereta * rtb_Gain1_b) * rtb_Y_g +
    rtb_LimiteriH;
  ...
  FlyByWire_DWork.Delay_DSTATE_ea += std::fmax(std::fmin(FlyByWire_DWork.Delay_DSTATE_h -
    FlyByWire_DWork.Delay_DSTATE_ea, rtb_ManualSwitch * FlyByWire_U.in.time.dt), FlyByWire_U.in.time.dt *
    rtb_eta_trim_deg_rate_limit_lo_deg_s);
  FlyByWire_Y.out.pitch.data_computed.in_flight_gain = rtb_Y_pf;
  FlyByWire_Y.out.pitch.data_computed.in_rotation_gain = rtb_Y_p;
  FlyByWire_Y.out.pitch.data_computed.nz_limit_up_g = rtb_Y_k;
  FlyByWire_Y.out.pitch.law_normal.eta_dot_deg_s = rtb_Limiterxi;
  rtb_Y_pf = look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.uDLookupTable_bp01Data_f,
    FlyByWire_P.uDLookupTable_tableData_f, 3U);
  rtb_Gain1_o = FlyByWire_P.Gain1_Gain_jh * rtb_BusAssignment_sim_input_delta_zeta_pos;
  if (rtb_Gain1_o > rtb_Y_pf) {
    rtb_Gain1_o = rtb_Y_pf;
  } else {
    rtb_Y_pf *= FlyByWire_P.Gain2_Gain_n;
    if (rtb_Gain1_o < rtb_Y_pf) {
      rtb_Gain1_o = rtb_Y_pf;
    }
  }
  ...
  FlyByWire_RateLimiter(rtb_LimiteriH, FlyByWire_P.RateLimiterVariableTs_up_k, FlyByWire_P.RateLimiterVariableTs_lo_fs,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_f, &rtb_Y_pf,
  ...
  FlyByWire_LagFilter(FlyByWire_U.in.data.engine_2_thrust_lbf - FlyByWire_U.in.data.engine_1_thrust_lbf,
                      FlyByWire_P.LagFilter1_C1_j, FlyByWire_U.in.time.dt, &rtb_Y_p, &FlyByWire_DWork.sf_LagFilter_f);
  if (FlyByWire_U.in.data.alpha_deg > FlyByWire_P.Saturation_UpperSat_l) {
    ...
    u0_1 = FlyByWire_P.Saturation_LowerSat_cj;
  } else {
    u0_1 = FlyByWire_U.in.data.alpha_deg;
  }

  FlyByWire_LagFilter(u0_1, FlyByWire_P.LagFilter2_C1, FlyByWire_U.in.time.dt, &rtb_Y_k,
  ...
  FlyByWire_LagFilter(FlyByWire_U.in.data.engine_1_thrust_lbf - FlyByWire_U.in.data.engine_2_thrust_lbf,
                      FlyByWire_P.LagFilter3_C1, FlyByWire_U.in.time.dt, &rtb_Y_g, &FlyByWire_DWork.sf_LagFilter_a);
  ...
  rtb_Y_p = (rtb_Y_k * rtb_Y_g * FlyByWire_P.Gain5_Gain_l + FlyByWire_P.Gain4_Gain_f * rtb_Y_p) / rtb_Limiterxi /
  ...
  if (FlyByWire_DWork.sProtActive > FlyByWire_P.Switch3_Threshold) {
    rtb_LimiteriH = look1_binlxpw(rtb_GainPhi, FlyByWire_P.BankAngleProtection2_bp01Data,
      FlyByWire_P.BankAngleProtection2_tableData, 4U);
  } else if (FlyByWire_DWork.sProtActive_c > FlyByWire_P.Switch2_Threshold_f) {
    rtb_LimiteriH = look1_binlxpw(rtb_GainPhi, FlyByWire_P.BankAngleProtection_bp01Data,
      FlyByWire_P.BankAngleProtection_tableData, 8U);
  } else {
    rtb_LimiteriH = look1_binlxpw(rtb_GainPhi, FlyByWire_P.BankAngleProtection1_bp01Data,
      FlyByWire_P.BankAngleProtection1_tableData, 8U);
  }

  rtb_Gain1_b = FlyByWire_P.Gain1_Gain_m * rtb_BusAssignment_sim_input_delta_xi_pos + rtb_LimiteriH;
  ...
  if (FlyByWire_DWork.Delay_DSTATE_i5 >= 25.0) {
    rtb_Y_k = rtb_BusAssignment_a_sim_data_pk_deg_s;
  } else if (FlyByWire_DWork.Delay_DSTATE_i5 <= -25.0) {
    rtb_LimiteriH = rtb_BusAssignment_a_sim_data_pk_deg_s;
  }

  rtb_LimiteriH = std::fmin(rtb_LimiteriH, std::fmax(rtb_Y_k, rtb_Gain1_b * rtb_Y_pf)) *
    FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_d * FlyByWire_U.in.time.dt;
  FlyByWire_DWork.icLoad_m = ((rtb_Y_pf == 0.0) || (rtb_alpha_floor_inhib != 0) ||
  ...
  FlyByWire_RateLimiter(rtb_LimiteriH, FlyByWire_P.RateLimiterVariableTs_up_m, FlyByWire_P.RateLimiterVariableTs_lo_g,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_j, &rtb_Y_g,
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch_Threshold_p) {
    ...
    rtb_LimiteriH = rtb_Y_g;
  }

  rtb_Y_k = std::fmax(FlyByWire_U.in.data.V_ias_kn, 80.0) * 0.5144;
  rtb_Limiterxi = rtb_Y_k * rtb_Y_k * 0.6125;
  rtb_Y_g = rtb_Limiterxi * 122.0 * 17.9 * -0.090320788790706555 / 1.0E+6;
  rtb_Limiterxi1 = 0.0;
  ...
  u0_1 = -(rtb_Limiterxi1 * rtb_Limiterxi1) / rtb_Y_g;
  FlyByWire_DWork.Delay_DSTATE_i5 = ((-(rtb_Limiterxi / rtb_Y_k * 122.0 * 320.40999999999997 * -0.487 / 1.0E+6 + 1.414 *
    rtb_Limiterxi1) / rtb_Y_g * (FlyByWire_P.Gain1_Gain_mu * rtb_BusAssignment_a_sim_data_pk_deg_s) +
    FlyByWire_P.Gain1_Gain_d * rtb_GainPhi * u0_1) + FlyByWire_P.Gain1_Gain_be * rtb_LimiteriH * -u0_1) * look1_binlxpw
    (FlyByWire_U.in.time.dt, FlyByWire_P.ScheduledGain_BreakpointsForDimension1_f, FlyByWire_P.ScheduledGain_Table_l, 4U)
    * FlyByWire_P.Gain_Gain_j;
  FlyByWire_RateLimiter(rtb_Gain1_o, FlyByWire_P.RateLimiterVariableTs_up_mm, FlyByWire_P.RateLimiterVariableTs_lo_p,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc, &rtb_Y_k,
                        &FlyByWire_DWork.sf_RateLimiter_lp);
  FlyByWire_LagFilter(rtb_Gain, FlyByWire_P.LagFilter_C1_d, FlyByWire_U.in.time.dt, &rtb_Y_g,
                      &FlyByWire_DWork.sf_LagFilter_c);
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation_UpperSat_lo) {
    u0_1 = FlyByWire_P.Saturation_UpperSat_lo;
  ...
  u0_1 = (rtb_Y_g - std::sin(FlyByWire_P.Gain1_Gain_br * rtb_LimiteriH) * FlyByWire_P.Constant2_Value_li * std::cos
          (FlyByWire_P.Gain1_Gain_cq * rtb_GainTheta) / (FlyByWire_P.Gain6_Gain_j * u0_1) * FlyByWire_P.Gain_Gain_cd) *
    look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.ScheduledGain_BreakpointsForDimension1_k,
                  FlyByWire_P.ScheduledGain_Table_k, 6U);
  FlyByWire_WashoutFilter(rtb_Gain, FlyByWire_P.WashoutFilter_C1_i, FlyByWire_U.in.time.dt, &rtb_Y_g,
    &FlyByWire_DWork.sf_WashoutFilter_i);
  rtb_Limiterxi1 = rtb_Y_g * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_on_ground), FlyByWire_P.RateLimiterVariableTs_up_dlj,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition_p, &rtb_Y_g,
                        &FlyByWire_DWork.sf_RateLimiter_d);
  if (rtb_Y_g > FlyByWire_P.Saturation_UpperSat_d1) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_d1;
  } else if (rtb_Y_g < FlyByWire_P.Saturation_LowerSat_j) {
  ...
  rtb_Sum1_e = FlyByWire_P.Constant_Value_i - rtb_Gain1_b;
  if (FlyByWire_U.in.data.V_ias_kn >= 60.0) {
    u0_1 = FlyByWire_U.in.data.beta_deg;
  } else {
    u0_1 = 0.0;
  }

  FlyByWire_LagFilter(u0_1, FlyByWire_P.LagFilter_C1_c, FlyByWire_U.in.time.dt, &rtb_Y_k,
                      &FlyByWire_DWork.sf_LagFilter_d);
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch2_Threshold_p) {
    u0_1 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Y_p;
  } else {
    u0_1 = FlyByWire_P.Constant3_Value_p;
  }

  FlyByWire_LagFilter(u0_1, FlyByWire_P.LagFilter1_C1_f, FlyByWire_U.in.time.dt, &rtb_Y_g,
  ...
  rtb_Gain1_b = rtb_Y_g - rtb_Y_k;
  rtb_Y_k = FlyByWire_P.Gain4_Gain_o * rtb_Gain1_b;
  ...
  FlyByWire_RateLimiter(rtb_Y_k + FlyByWire_DWork.Delay_DSTATE_gt, FlyByWire_P.RateLimiterVariableTs1_up_p,
                        FlyByWire_P.RateLimiterVariableTs1_lo_hd, FlyByWire_U.in.time.dt,
                        FlyByWire_P.RateLimiterVariableTs1_InitialCondition_f, &rtb_Y_g,
  ...
  rtb_Gain1_b = ((rtb_Sum1_e * rtb_Y_g + rtb_LimiteriH) * rtb_Gain1_b + (FlyByWire_P.Constant_Value_l - rtb_Gain1_b) *
  ...
  FlyByWire_DWork.Delay_DSTATE_j5 += std::fmax(std::fmin(FlyByWire_DWork.Delay_DSTATE_fz -
    FlyByWire_DWork.Delay_DSTATE_j5, FlyByWire_P.Constant_Value_b * FlyByWire_U.in.time.dt), FlyByWire_U.in.time.dt *
    FlyByWire_P.Constant1_Value_a);
  rtb_Limiterxi = rtb_Y_pf + FlyByWire_U.in.data.autopilot_custom_on;
  ...
  rtb_Y_k = (FlyByWire_P.Constant_Value_l1 - rtb_Gain1_b) * rtb_BusAssignment_p_roll_data_computed_delta_xi_deg +
  ...
  FlyByWire_RateLimiter(rtb_Y_k, FlyByWire_P.RateLimiterxi_up, FlyByWire_P.RateLimiterxi_lo, FlyByWire_U.in.time.dt,
                        FlyByWire_P.RateLimiterxi_InitialCondition, &rtb_Limiterxi, &FlyByWire_DWork.sf_RateLimiter_h);
  FlyByWire_RateLimiter(rtb_Y_g, FlyByWire_P.RateLimiterzeta_up, FlyByWire_P.RateLimiterzeta_lo, FlyByWire_U.in.time.dt,
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = rtb_Y_pf;
  FlyByWire_Y.out.roll.data_computed.zeta_trim_deg_should_write = (FlyByWire_U.in.data.autopilot_custom_on != 0.0);
  FlyByWire_Y.out.roll.data_computed.beta_target_deg = rtb_Y_p;
  ...
  FlyByWire_Y.out.roll.output.xi_deg = rtb_Y_k;
  FlyByWire_Y.out.roll.output.zeta_deg = rtb_Y_g;
  ...
  FlyByWire_DWork.Delay_DSTATE_c1 = rtb_Y_h;
  FlyByWire_DWork.Delay_DSTATE_l = rtb_Y_l;
