...
void FlyByWireModelClass::step()
{
  ...
  rtb_Divide1 = FlyByWire_P.Gain1_Gain_n * rtb_Limiterxi * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_e;
  ...
  rtb_Limiterxi = (((rtb_Loaddemand - FlyByWire_DWork.Delay_DSTATE_ca) / FlyByWire_U.in.time.dt *
                    FlyByWire_P.Gain3_Gain_l + FlyByWire_P.Gain_Gain_c * rtb_Limiterxi) + (rtb_Divide1 -
    FlyByWire_DWork.Delay_DSTATE_jv) / FlyByWire_U.in.time.dt) * look1_binlxpw(FlyByWire_U.in.data.V_ias_kn,
    FlyByWire_P.DLUT_bp01Data, FlyByWire_P.DLUT_tableData, 4U);
  ...
  rtb_BusAssignment_p_roll_data_computed_delta_xi_deg = FlyByWire_P.Gain_Gain_cs *
