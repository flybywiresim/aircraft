...
void FlyByWireModelClass::step()
{
  ...
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, rtb_Gainqk, rtb_Gain, rtb_Gainpk, &rtb_qk, &rtb_Y, &rtb_Y_p);
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, FlyByWire_P.Gainqk1_Gain * (FlyByWire_P.Gain_Gain_e *
    ...
    FlyByWire_P.Gainpk1_Gain * (FlyByWire_P.Gain_Gain_nm * FlyByWire_U.in.data.p_dot_rad_s2), &rtb_Y_e, &rtb_Y_g,
    &rtb_Y_k);
  ...
  FlyByWire_RateLimiter(look2_binlxpw(FlyByWire_U.in.data.V_mach, FlyByWire_U.in.data.flaps_handle_index,
    ...
    FlyByWire_P.alphaprotection_maxIndex, 4U), FlyByWire_P.RateLimiterVariableTs_up,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_al);
  ...
  FlyByWire_Y.out.sim.data.rk_dot_deg_s2 = rtb_Y_g;
  ...
  rtb_Gain_a = FlyByWire_P.DiscreteDerivativeVariableTs_Gain * FlyByWire_U.in.data.V_ias_kn;
  FlyByWire_LagFilter((rtb_Gain_a - FlyByWire_DWork.Delay_DSTATE_k) / FlyByWire_U.in.time.dt, FlyByWire_P.LagFilter_C1_a,
                      FlyByWire_U.in.time.dt, &rtb_Y_k, &FlyByWire_DWork.sf_LagFilter);
  ...
  FlyByWire_GetIASforMach4(FlyByWire_U.in.data.V_mach, FlyByWire_P.Constant6_Value, FlyByWire_U.in.data.V_ias_kn,
    &rtb_Y_g);
  if (FlyByWire_P.Constant5_Value < rtb_Y_g) {
    rtb_Min3 = FlyByWire_P.Constant5_Value;
  } else {
    rtb_Min3 = rtb_Y_g;
  }

  rtb_LimiteriH = rtb_GainTheta - std::cos(FlyByWire_P.Gain1_Gain_i * rtb_GainPhi) * FlyByWire_U.in.data.alpha_deg;
  if (FlyByWire_U.in.data.autopilot_custom_on == 0.0) {
    rtb_Sum1_i = look1_binlxpw(rtb_LimiteriH, FlyByWire_P.uDLookupTable1_bp01Data, FlyByWire_P.uDLookupTable1_tableData,
      3U);
    rtb_Sum1_h = FlyByWire_U.in.data.V_ias_kn / FlyByWire_U.in.data.V_mach * look1_binlxpw(rtb_LimiteriH,
      FlyByWire_P.uDLookupTable2_bp01Data, FlyByWire_P.uDLookupTable2_tableData, 3U);
    if (rtb_Sum1_i < rtb_Sum1_h) {
      rtb_Sum1_h = rtb_Sum1_i;
    }

    if (FlyByWire_U.in.data.V_ias_kn > rtb_Sum1_h) {
  ...
  rtb_BusAssignment_a_sim_data_pk_deg_s = rtb_Y_p;
  ...
  FlyByWire_Y.out.sim.data_computed.protection_ap_disc = (((rtb_on_ground == 0) && (((rtb_ap_special_disc != 0) &&
    ...
    (FlyByWire_DWork.sProtActive_c != 0.0));
  FlyByWire_eta_trim_limit_lofreeze(rtb_Gainpk2, FlyByWire_DWork.sProtActive_c, &rtb_Y_k,
  ...
  if (FlyByWire_B.in_flight > FlyByWire_P.Saturation_UpperSat_er) {
    rtb_Sum1_i = FlyByWire_P.Saturation_UpperSat_er;
  } else if (FlyByWire_B.in_flight < FlyByWire_P.Saturation_LowerSat_a) {
    rtb_Sum1_i = FlyByWire_P.Saturation_LowerSat_a;
  } else {
    rtb_Sum1_i = FlyByWire_B.in_flight;
  }

  FlyByWire_RateLimiter(rtb_Sum1_i, FlyByWire_P.RateLimiterVariableTs_up_d, FlyByWire_P.RateLimiterVariableTs_lo_c,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_d, &rtb_Y_p,
  ...
  if (FlyByWire_DWork.is_active_c6_FlyByWire == 0U) {
    ...
    if ((rtb_Y_p < 1.0) && (FlyByWire_U.in.data.V_tas_kn > 70.0) && ((FlyByWire_U.in.data.thrust_lever_1_pos >= 35.0) ||
  ...
  } else if ((rtb_Y_p == 1.0) || (FlyByWire_U.in.data.H_radio_ft > 400.0) || ((FlyByWire_U.in.data.V_tas_kn < 70.0) &&
    ...
    switch (FlyByWire_DWork.is_c2_FlyByWire) {
     ...
     case FlyByWire_IN_Flare_Set_Rate:
      if (FlyByWire_P.ManualSwitch1_CurrentSetting == 1) {
        rtb_Sum1_i = FlyByWire_P.Constant1_Value_f;
      } else {
        rtb_Sum1_i = FlyByWire_P.Constant_Value_jz;
      }

      if ((FlyByWire_U.in.data.H_radio_ft <= 30.0) || (rtb_Sum1_i == 1.0)) {
  ...
  FlyByWire_RateLimiter(rtb_nz_limit_up_g, FlyByWire_P.RateLimiterVariableTs2_up_f,
                        ...
                        FlyByWire_P.RateLimiterVariableTs2_InitialCondition_b, &rtb_Y_g,
  ...
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_nz_limit_lo_g), FlyByWire_P.RateLimiterVariableTs3_up_c,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_hn);
  ...
  rtb_Sum1_i = FlyByWire_B.flare_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_g;
  rtb_Sum1_h = std::abs(FlyByWire_B.flare_Theta_c_rate_deg_s) * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_i < rtb_Sum1_h) {
    rtb_Sum1_h = rtb_Sum1_i;
  }

  rtb_Sum1_i = FlyByWire_U.in.time.dt * FlyByWire_B.flare_Theta_c_rate_deg_s;
  if (rtb_Sum1_h > rtb_Sum1_i) {
    rtb_Sum1_i = rtb_Sum1_h;
  }

  FlyByWire_DWork.Delay_DSTATE_g += rtb_Sum1_i;
  rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg = FlyByWire_P.Gain_Gain_d *
    rtb_BusAssignment_sim_input_delta_eta_pos;
  rtb_BusAssignment_cs_pitch_data_computed_in_flight_gain = rtb_Y_p;
  rtb_BusAssignment_cs_pitch_data_computed_in_rotation_gain = rtb_Y_e;
  ...
  FlyByWire_RateLimiter(rtb_BusAssignment_sim_input_delta_eta_pos, FlyByWire_P.RateLimiterVariableTs_up_dl,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_ix);
  if (rtb_Y_k > FlyByWire_P.Saturation3_UpperSat) {
    rtb_Gain_k = FlyByWire_P.Saturation3_UpperSat;
  } else if (rtb_Y_k < FlyByWire_P.Saturation3_LowerSat) {
    rtb_Gain_k = FlyByWire_P.Saturation3_LowerSat;
  } else {
    rtb_Gain_k = rtb_Y_k;
  }
  ...
  rtb_LimiteriH = look1_binlxpw(static_cast<real_T>(FlyByWire_U.in.data.tailstrike_protection_on) * look2_binlxpw
    ...
    rtb_Gain_k + rtb_Y_k, FlyByWire_P.PitchRateDemand_bp01Data, FlyByWire_P.PitchRateDemand_tableData, 2U);
  rtb_Gain_k = FlyByWire_P.DiscreteDerivativeVariableTs_Gain_c * rtb_LimiteriH;
  rtb_Limiterxi = rtb_qk - rtb_LimiteriH;
  rtb_Gain_n = FlyByWire_P.Gain1_Gain_io * rtb_Limiterxi * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_b;
  FlyByWire_LagFilter(rtb_qk + FlyByWire_P.Gain5_Gain * rtb_BusAssignment_a_sim_data_qk_dot_deg_s2,
                      FlyByWire_P.LagFilter_C1_i, FlyByWire_U.in.time.dt, &rtb_Y_k, &FlyByWire_DWork.sf_LagFilter_a);
  rtb_Gain1_b = (((((rtb_Gain_n - FlyByWire_DWork.Delay_DSTATE_ge) / FlyByWire_U.in.time.dt + FlyByWire_P.Gain_Gain_h *
                    rtb_Limiterxi) * FlyByWire_P.Gain1_Gain_a + (rtb_Gain_k - FlyByWire_DWork.Delay_DSTATE_f) /
    ...
    (FlyByWire_P.Constant2_Value_l - rtb_Y_p) * FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain *
    FlyByWire_U.in.time.dt;
  FlyByWire_DWork.icLoad = (((rtb_BusAssignment_sim_input_delta_eta_pos <= FlyByWire_P.Constant_Value_j) &&
    (rtb_on_ground != 0)) || (rtb_Y_e == 0.0) || (rtb_alpha_floor_inhib != 0) || FlyByWire_DWork.icLoad);
  ...
  rtb_Sum1_i = rtb_BusAssignment_sim_input_delta_eta_pos - FlyByWire_DWork.Delay_DSTATE_i;
  rtb_Sum1_h = FlyByWire_P.RateLimiterVariableTs3_up_m * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_i < rtb_Sum1_h) {
    rtb_Sum1_h = rtb_Sum1_i;
  }

  rtb_Sum1_i = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs3_lo_e;
  if (rtb_Sum1_h > rtb_Sum1_i) {
    rtb_Sum1_i = rtb_Sum1_h;
  }

  FlyByWire_DWork.Delay_DSTATE_i += rtb_Sum1_i;
  rtb_Sum1_i = (rtb_Min3 - rtb_Min5) * FlyByWire_DWork.Delay_DSTATE_i;
  if (rtb_Sum1_i <= 0.0) {
    rtb_Sum1_i = 0.0;
  }

  rtb_v_target = rtb_Min3 + rtb_Sum1_i;
  if (rtb_GainPhi > FlyByWire_P.Saturation_UpperSat_d) {
    rtb_Gain_aj = FlyByWire_P.Saturation_UpperSat_d;
  } else if (rtb_GainPhi < FlyByWire_P.Saturation_LowerSat_pr) {
    rtb_Gain_aj = FlyByWire_P.Saturation_LowerSat_pr;
  } else {
    rtb_Gain_aj = rtb_GainPhi;
  }

  rtb_Limiterxi2 = rtb_Gain1_b / std::cos(FlyByWire_P.Gain1_Gain_b * rtb_Gain_aj);
  FlyByWire_RateLimiter(FlyByWire_U.in.data.autopilot_custom_Theta_c_deg, FlyByWire_P.RateLimiterVariableTs1_up_k,
                        ...
                        FlyByWire_P.RateLimiterVariableTs1_InitialCondition_hb, &rtb_Y_e,
                        &FlyByWire_DWork.sf_RateLimiter_i);
  rtb_Sum1_h = 5.0 - (FlyByWire_U.in.data.V_ias_kn - (FlyByWire_U.in.data.VLS_kn + 5.0)) * 0.25;
  if (0.0 > rtb_Sum1_h) {
    rtb_Sum1_h = 0.0;
  }
  ...
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_nz_limit_lo_g) - rtb_Sum1_h, FlyByWire_P.RateLimiterVariableTs6_up,
  ...
  FlyByWire_RateLimiter(rtb_BusAssignment_sim_input_delta_eta_pos, FlyByWire_P.RateLimiterVariableTs_up_f,
                        ...
                        FlyByWire_P.RateLimiterVariableTs_InitialCondition_c, &rtb_Y_p,
                        &FlyByWire_DWork.sf_RateLimiter_h);
  rtb_Gain_aj = FlyByWire_P.Subsystem2_Gain * rtb_v_target;
  rtb_Divide_m = (rtb_Gain_aj - FlyByWire_DWork.Delay_DSTATE_j) / FlyByWire_U.in.time.dt;
  ...
  rtb_Gain_ir = FlyByWire_P.Subsystem_Gain * FlyByWire_U.in.data.V_ias_kn;
  rtb_Divide_e = (rtb_Gain_ir - FlyByWire_DWork.Delay_DSTATE_p) / FlyByWire_U.in.time.dt;
  ...
  rtb_Sum1_i = FlyByWire_DWork.sProtActive - FlyByWire_DWork.Delay_DSTATE_g3;
  rtb_Sum1_h = FlyByWire_P.RateLimiterVariableTs4_up * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_i < rtb_Sum1_h) {
    rtb_Sum1_h = rtb_Sum1_i;
  }

  rtb_Sum1_i = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs4_lo;
  if (rtb_Sum1_h > rtb_Sum1_i) {
    rtb_Sum1_i = rtb_Sum1_h;
  }

  FlyByWire_DWork.Delay_DSTATE_g3 += rtb_Sum1_i;
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_ke) {
    rtb_Gain1_b = (rtb_Y_e - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    rtb_Gain1_b = FlyByWire_P.Gain1_Gain * rtb_GainTheta;
    rtb_Y_e = rtb_Divide1 - rtb_Limiterxi2;
    rtb_Loaddemand = look1_binlxpw(rtb_Y_p, FlyByWire_P.Loaddemand_bp01Data, FlyByWire_P.Loaddemand_tableData, 2U);
    if (FlyByWire_DWork.Delay_DSTATE_g3 > FlyByWire_P.Saturation_UpperSat_b) {
      rtb_Y_p = FlyByWire_P.Saturation_UpperSat_b;
    } else if (FlyByWire_DWork.Delay_DSTATE_g3 < FlyByWire_P.Saturation_LowerSat_o) {
      rtb_Y_p = FlyByWire_P.Saturation_LowerSat_o;
    } else {
      rtb_Y_p = FlyByWire_DWork.Delay_DSTATE_g3;
    }

    if (FlyByWire_DWork.sProtActive > FlyByWire_P.Switch2_Threshold) {
      rtb_Sum1_i = (((((rtb_v_target - FlyByWire_U.in.data.V_ias_kn) * FlyByWire_P.Gain6_Gain +
      ...
      if (rtb_Sum1_i > FlyByWire_P.Saturation4_UpperSat) {
        rtb_Sum1_i = FlyByWire_P.Saturation4_UpperSat;
      } else if (rtb_Sum1_i < FlyByWire_P.Saturation4_LowerSat) {
        rtb_Sum1_i = FlyByWire_P.Saturation4_LowerSat;
      }

      rtb_Switch_c += rtb_Sum1_i;
    } else {
      rtb_Switch_c = FlyByWire_P.Constant1_Value;
    }

    rtb_Loaddemand = (FlyByWire_P.Constant_Value_l - rtb_Y_p) * rtb_Loaddemand + rtb_Switch_c * rtb_Y_p;
    ...
    rtb_Sum1_i = FlyByWire_P.Gain2_Gain * rtb_Y - rtb_Gain1_b;
    if (rtb_Sum1_i > FlyByWire_P.Saturation1_UpperSat) {
      rtb_Sum1_i = FlyByWire_P.Saturation1_UpperSat;
    } else if (rtb_Sum1_i < FlyByWire_P.Saturation1_LowerSat) {
      rtb_Sum1_i = FlyByWire_P.Saturation1_LowerSat;
    }

    rtb_Y_p = look1_binlxpw(rtb_Sum1_i, FlyByWire_P.Loaddemand1_bp01Data, FlyByWire_P.Loaddemand1_tableData, 2U) +
      rtb_Y_e;
    if (rtb_Loaddemand <= rtb_Y_p) {
      rtb_Sum1_i = FlyByWire_P.Gain3_Gain * FlyByWire_P.Theta_max3_Value - rtb_Gain1_b;
      if (rtb_Sum1_i > FlyByWire_P.Saturation2_UpperSat) {
        rtb_Sum1_i = FlyByWire_P.Saturation2_UpperSat;
      } else if (rtb_Sum1_i < FlyByWire_P.Saturation2_LowerSat) {
        rtb_Sum1_i = FlyByWire_P.Saturation2_LowerSat;
      }

      rtb_Y_p = look1_binlxpw(rtb_Sum1_i, FlyByWire_P.Loaddemand2_bp01Data, FlyByWire_P.Loaddemand2_tableData, 2U) +
        rtb_Y_e;
      if (rtb_Loaddemand >= rtb_Y_p) {
        rtb_Y_p = rtb_Loaddemand;
      }
    }

    rtb_Gain1_b = rtb_Y_p + rtb_Switch_c;
  }

  rtb_Gain1_b += rtb_Limiterxi2;
  if (rtb_Gain1_b > rtb_Y_g) {
    rtb_Gain1_b = rtb_Y_g;
  ...
  rtb_Sum1_h = (std::abs(rtb_GainPhi) - 3.0) / 6.0;
  if (0.0 > rtb_Sum1_h) {
    rtb_Sum1_h = 0.0;
  }
  ...
  FlyByWire_WashoutFilter(rtb_Sum1_h, FlyByWire_P.WashoutFilter_C1, FlyByWire_U.in.time.dt, &rtb_Y_k,
  ...
  rtb_Y_p = (rtb_Y - FlyByWire_DWork.Delay_DSTATE_ps) / FlyByWire_U.in.time.dt;
  ...
  FlyByWire_DWork.Delay1_DSTATE_o = 1.0 / rtb_Limiterxi2 * (FlyByWire_P.Constant_Value_k - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_o + (rtb_Y_p + FlyByWire_DWork.Delay_DSTATE_c1) * (rtb_Limiterxi1 / rtb_Limiterxi2);
  rtb_Y_k = FlyByWire_P.alpha_err_gain_Gain * rtb_Limiterxi;
  rtb_Y_e = FlyByWire_P.Subsystem3_Gain * FlyByWire_U.in.data.V_ias_kn;
  rtb_Limiterxi2 = (rtb_Y_e - FlyByWire_DWork.Delay_DSTATE_l) / FlyByWire_U.in.time.dt;
  ...
  FlyByWire_DWork.Delay1_DSTATE_n = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_c - rtb_Limiterxi) *
    ...
    rtb_Limiterxi1);
  rtb_Sum1_i = FlyByWire_DWork.sProtActive_c - FlyByWire_DWork.Delay_DSTATE_kd;
  rtb_Sum1_h = FlyByWire_P.RateLimiterVariableTs5_up * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_i < rtb_Sum1_h) {
    rtb_Sum1_h = rtb_Sum1_i;
  }

  rtb_Sum1_i = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs5_lo;
  if (rtb_Sum1_h > rtb_Sum1_i) {
    rtb_Sum1_i = rtb_Sum1_h;
  }

  FlyByWire_DWork.Delay_DSTATE_kd += rtb_Sum1_i;
  if (FlyByWire_DWork.Delay_DSTATE_kd > FlyByWire_P.Saturation_UpperSat_c) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation_UpperSat_c;
  ...
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation3_UpperSat_p) {
    rtb_Sum1_i = FlyByWire_P.Saturation3_UpperSat_p;
  } else if (FlyByWire_U.in.data.V_tas_kn < FlyByWire_P.Saturation3_LowerSat_i) {
    rtb_Sum1_i = FlyByWire_P.Saturation3_LowerSat_i;
  } else {
    rtb_Sum1_i = FlyByWire_U.in.data.V_tas_kn;
  }

  rtb_Limiterxi = rtb_LimiteriH - (look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.uDLookupTable_bp01Data_j,
    FlyByWire_P.uDLookupTable_tableData_l, 6U) / (FlyByWire_P.Gain5_Gain_g * rtb_Sum1_i) + FlyByWire_P.Bias_Bias) *
  ...
  rtb_Sum1_i = (((FlyByWire_P.precontrol_gain_Gain * FlyByWire_DWork.Delay1_DSTATE_o + rtb_Y_k) +
  ...
  rtb_Limiterxi = ((rtb_Loaddemand - FlyByWire_DWork.Delay_DSTATE_a) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_l
                   + rtb_Limiterxi * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data,
    FlyByWire_P.PLUT_tableData, 1U)) + (rtb_Divide1 - FlyByWire_DWork.Delay_DSTATE_ld) / FlyByWire_U.in.time.dt;
  if (rtb_Sum1_i > FlyByWire_P.Saturation3_UpperSat_c) {
    rtb_Sum1_i = FlyByWire_P.Saturation3_UpperSat_c;
  } else if (rtb_Sum1_i < FlyByWire_P.Saturation3_LowerSat_h) {
    rtb_Sum1_i = FlyByWire_P.Saturation3_LowerSat_h;
  }
  ...
  rtb_Limiterxi = (FlyByWire_P.Constant_Value_b - rtb_Limiterxi1) * rtb_Limiterxi + rtb_Sum1_i * rtb_Limiterxi1;
  ...
  if (FlyByWire_DWork.icLoad_e) {
    if (FlyByWire_B.in_flight > FlyByWire_P.Switch_Threshold_d) {
      rtb_Sum1_i = rtb_Gainpk4;
    } else {
      rtb_Sum1_i = rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg;
    }

    FlyByWire_DWork.Delay_DSTATE_f1 = rtb_Sum1_i - rtb_Gain1_b;
  }
  ...
  if (rtb_BusAssignment_cs_pitch_data_computed_in_flight_gain > FlyByWire_P.Saturation_UpperSat_i) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_i;
  } else if (rtb_BusAssignment_cs_pitch_data_computed_in_flight_gain < FlyByWire_P.Saturation_LowerSat_m) {
  ...
  rtb_Sum1_i = FlyByWire_P.Constant_Value_jg - rtb_Gain1_b;
  if (rtb_BusAssignment_cs_pitch_data_computed_in_rotation_gain > FlyByWire_P.Saturation_UpperSat_n) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_n;
  } else if (rtb_BusAssignment_cs_pitch_data_computed_in_rotation_gain < FlyByWire_P.Saturation_LowerSat_b) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_b;
  } else {
    rtb_Gain1_b = rtb_BusAssignment_cs_pitch_data_computed_in_rotation_gain;
  }

  rtb_LimiteriH_n = ((FlyByWire_P.Constant_Value_cr - rtb_Gain1_b) *
                     rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg + rtb_Limitereta * rtb_Gain1_b) * rtb_Sum1_i
    + rtb_LimiteriH;
  ...
  rtb_Sum1_i = FlyByWire_DWork.Delay_DSTATE_h - FlyByWire_DWork.Delay_DSTATE_en;
  rtb_Sum1_h = rtb_ManualSwitch * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_i < rtb_Sum1_h) {
    rtb_Sum1_h = rtb_Sum1_i;
  }

  rtb_Sum1_i = FlyByWire_U.in.time.dt * rtb_eta_trim_deg_rate_limit_lo_deg_s;
  if (rtb_Sum1_h > rtb_Sum1_i) {
    rtb_Sum1_i = rtb_Sum1_h;
  }

  FlyByWire_DWork.Delay_DSTATE_en += rtb_Sum1_i;
  FlyByWire_Y.out.pitch.data_computed.nz_limit_up_g = rtb_Y_g;
  ...
  FlyByWire_RateLimiter(rtb_LimiteriH, FlyByWire_P.RateLimiterVariableTs_up_k, FlyByWire_P.RateLimiterVariableTs_lo_fs,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_i0);
  FlyByWire_LagFilter(FlyByWire_U.in.data.engine_1_thrust_lbf - FlyByWire_U.in.data.engine_2_thrust_lbf,
                      FlyByWire_P.LagFilter_C1_l, FlyByWire_U.in.time.dt, &rtb_Y_g, &FlyByWire_DWork.sf_LagFilter_m);
  rtb_Product_pc = rtb_Y_g * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  if (FlyByWire_DWork.sProtActive > FlyByWire_P.Switch3_Threshold) {
    rtb_Sum1_i = look1_binlxpw(rtb_GainPhi, FlyByWire_P.BankAngleProtection2_bp01Data,
      FlyByWire_P.BankAngleProtection2_tableData, 4U);
  } else if (FlyByWire_DWork.sProtActive_c > FlyByWire_P.Switch2_Threshold_f) {
    rtb_Sum1_i = look1_binlxpw(rtb_GainPhi, FlyByWire_P.BankAngleProtection_bp01Data,
      FlyByWire_P.BankAngleProtection_tableData, 8U);
  } else {
    rtb_Sum1_i = look1_binlxpw(rtb_GainPhi, FlyByWire_P.BankAngleProtection1_bp01Data,
      FlyByWire_P.BankAngleProtection1_tableData, 8U);
  }

  rtb_Gain1_b = FlyByWire_P.Gain1_Gain_m * rtb_BusAssignment_sim_input_delta_xi_pos + rtb_Sum1_i;
  ...
  FlyByWire_RateLimiter(rtb_Gain1_o, FlyByWire_P.RateLimiterVariableTs_up_m, FlyByWire_P.RateLimiterVariableTs_lo_p,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc, &rtb_Y_g,
  ...
  rtb_Sum1_i = FlyByWire_P.Gain_Gain_a1 * rtb_Y_g + FlyByWire_DWork.Delay_DSTATE_ho;
  if (rtb_Sum1_i > FlyByWire_P.Saturation_UpperSat_f) {
    rtb_Sum1_i = FlyByWire_P.Saturation_UpperSat_f;
  } else if (rtb_Sum1_i < FlyByWire_P.Saturation_LowerSat_f) {
    rtb_Sum1_i = FlyByWire_P.Saturation_LowerSat_f;
  }

  FlyByWire_RateLimiter(rtb_Sum1_i, FlyByWire_P.RateLimiterVariableTs_up_ms, FlyByWire_P.RateLimiterVariableTs_lo_g,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_j, &rtb_Y_k,
                        &FlyByWire_DWork.sf_RateLimiter_he);
  ...
  if (FlyByWire_U.in.data.V_ias_kn > 80.0) {
    rtb_Sum1_i = FlyByWire_U.in.data.V_ias_kn;
  } else {
    rtb_Sum1_i = 80.0;
  }

  rtb_Sum1_i *= 0.5144;
  rtb_Limiterxi1 = rtb_Sum1_i * rtb_Sum1_i * 0.6125;
  rtb_Sum1_i = rtb_Limiterxi1 / rtb_Sum1_i * 122.0 * 320.40999999999997 * -2.078 / 1.376155E+6;
  rtb_Limiterxi1 = rtb_Limiterxi1 * 122.0 * 17.9 * -0.291 / 1.376155E+6;
  rtb_Limiterxi = -(-rtb_Sum1_i * -rtb_Sum1_i) / rtb_Limiterxi1;
  rtb_Limiterxi_o = ((-(2.0 * -rtb_Sum1_i + rtb_Sum1_i) / rtb_Limiterxi1 * rtb_BusAssignment_a_sim_data_pk_deg_s +
  ...
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation_UpperSat_l) {
    rtb_Sum1_i = FlyByWire_P.Saturation_UpperSat_l;
  } else if (FlyByWire_U.in.data.V_tas_kn < FlyByWire_P.Saturation_LowerSat_l) {
    rtb_Sum1_i = FlyByWire_P.Saturation_LowerSat_l;
  } else {
    rtb_Sum1_i = FlyByWire_U.in.data.V_tas_kn;
  }

  rtb_Sum1_i = (rtb_Y_k - std::sin(FlyByWire_P.Gain1_Gain_br * rtb_LimiteriH) * FlyByWire_P.Constant2_Value_li * std::
                cos(FlyByWire_P.Gain1_Gain_c * rtb_GainTheta) / (FlyByWire_P.Gain6_Gain_j * rtb_Sum1_i) *
  ...
  if (rtb_Sum1_i > FlyByWire_P.Saturation1_UpperSat_h) {
    rtb_Sum1_i = FlyByWire_P.Saturation1_UpperSat_h;
  } else if (rtb_Sum1_i < FlyByWire_P.Saturation1_LowerSat_g) {
    rtb_Sum1_i = FlyByWire_P.Saturation1_LowerSat_g;
  }
  ...
  rtb_Limiterxi1 = rtb_BusAssignment_p_roll_data_computed_in_flight_gain * rtb_Sum1_i + rtb_Limiterxi;
  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Gain1_b;
  FlyByWire_Y.out.roll.law_normal.Phi_c_deg = rtb_LimiteriH;
  rtb_Limiterxi = rtb_Y_g;
  ...
  if (rtb_Y_k > FlyByWire_P.Saturation_UpperSat_e5) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_e5;
  } else if (rtb_Y_k < FlyByWire_P.Saturation_LowerSat_fp) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_fp;
  } else {
    rtb_Gain1_b = rtb_Y_k;
  }

  rtb_LimiteriH = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg * rtb_Gain1_b;
  rtb_Sum1_h = FlyByWire_P.Constant_Value_a - rtb_Gain1_b;
  if (FlyByWire_U.in.data.V_ias_kn >= 60.0) {
    rtb_Sum1_i = FlyByWire_U.in.data.beta_deg;
  } else {
    rtb_Sum1_i = 0.0;
  }

  FlyByWire_LagFilter(rtb_Sum1_i, FlyByWire_P.LagFilter_C1_c, FlyByWire_U.in.time.dt, &rtb_Y_g,
                      &FlyByWire_DWork.sf_LagFilter_hq);
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch2_Threshold_p) {
    rtb_Sum1_i = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Product_pc;
  } else {
    rtb_Sum1_i = FlyByWire_P.Constant3_Value_p;
  }

  FlyByWire_LagFilter(rtb_Sum1_i, FlyByWire_P.LagFilter1_C1_f, FlyByWire_U.in.time.dt, &rtb_Y_k,
                      &FlyByWire_DWork.sf_LagFilter_ha);
  ...
  rtb_Gain1_b = rtb_Y_k - rtb_Y_g;
  rtb_Y_g = FlyByWire_P.Gain4_Gain_o * rtb_Gain1_b;
  ...
  FlyByWire_RateLimiter(rtb_Y_g + FlyByWire_DWork.Delay_DSTATE_gt, FlyByWire_P.RateLimiterVariableTs1_up_p,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_h1);
  if (static_cast<real_T>(rtb_NOT2) > FlyByWire_P.Saturation_UpperSat_ls) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_ls;
  } else if (static_cast<real_T>(rtb_NOT2) < FlyByWire_P.Saturation_LowerSat_mj) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_mj;
  } else {
    rtb_Gain1_b = rtb_NOT2;
  }

  rtb_Gain1_b = ((rtb_Sum1_h * rtb_Y_k + rtb_LimiteriH) * rtb_Gain1_b + (FlyByWire_P.Constant_Value_m3m - rtb_Gain1_b) *
  ...
  rtb_Sum1_i = FlyByWire_DWork.Delay_DSTATE_fz - FlyByWire_DWork.Delay_DSTATE_hd;
  rtb_Sum1_h = FlyByWire_P.Constant_Value_ba * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_i < rtb_Sum1_h) {
    rtb_Sum1_h = rtb_Sum1_i;
  }

  rtb_Sum1_i = FlyByWire_U.in.time.dt * FlyByWire_P.Constant1_Value_a;
  if (rtb_Sum1_h > rtb_Sum1_i) {
    rtb_Sum1_i = rtb_Sum1_h;
  }

  FlyByWire_DWork.Delay_DSTATE_hd += rtb_Sum1_i;
  rtb_Sum1_i = rtb_BusAssignment_p_roll_data_computed_in_flight_gain + FlyByWire_U.in.data.autopilot_custom_on;
  if (rtb_Sum1_i > FlyByWire_P.Saturation1_UpperSat_e) {
    rtb_Gain1_b = FlyByWire_P.Saturation1_UpperSat_e;
  } else if (rtb_Sum1_i < FlyByWire_P.Saturation1_LowerSat_l) {
    rtb_Gain1_b = FlyByWire_P.Saturation1_LowerSat_l;
  } else {
    rtb_Gain1_b = rtb_Sum1_i;
  }

  if (rtb_Gain1_b > FlyByWire_P.Saturation_UpperSat_ci) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_ci;
  } else if (rtb_Gain1_b < FlyByWire_P.Saturation_LowerSat_o4) {
    rtb_Gain1_b = FlyByWire_P.Saturation_LowerSat_o4;
  }

  rtb_Y_g = (FlyByWire_P.Constant_Value_e - rtb_Gain1_b) * rtb_BusAssignment_p_roll_data_computed_delta_xi_deg +
    rtb_Limiterxi_o * rtb_Gain1_b;
  if (rtb_Sum1_i > FlyByWire_P.Saturation_UpperSat_eq) {
    rtb_Sum1_i = FlyByWire_P.Saturation_UpperSat_eq;
  } else if (rtb_Sum1_i < FlyByWire_P.Saturation_LowerSat_n) {
    rtb_Sum1_i = FlyByWire_P.Saturation_LowerSat_n;
  }

  if (rtb_Sum1_i > FlyByWire_P.Saturation_UpperSat_k) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_k;
  } else if (rtb_Sum1_i < FlyByWire_P.Saturation_LowerSat_k) {
  ...
  rtb_Gain1_b = (FlyByWire_P.Constant_Value_cp - rtb_Gain1_b) * rtb_Gain1_o;
  ...
  FlyByWire_RateLimiter(rtb_LimiteriH_n, FlyByWire_P.RateLimitereta_up, FlyByWire_P.RateLimitereta_lo,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_dx);
  FlyByWire_RateLimiter(rtb_Y_g, FlyByWire_P.RateLimiterxi_up, FlyByWire_P.RateLimiterxi_lo, FlyByWire_U.in.time.dt,
                        FlyByWire_P.RateLimiterxi_InitialCondition, &rtb_Limiterxi, &FlyByWire_DWork.sf_RateLimiter_a);
  FlyByWire_RateLimiter(rtb_Y_k, FlyByWire_P.RateLimiterzeta_up, FlyByWire_P.RateLimiterzeta_lo, FlyByWire_U.in.time.dt,
                        ...
                        &FlyByWire_DWork.sf_RateLimiter_fr);
  ...
  rtb_Sum1_i = FlyByWire_P.Gain_Gain_i * FlyByWire_U.in.data.gear_animation_pos_0 - FlyByWire_P.Constant_Value_g;
  if (rtb_Sum1_i > FlyByWire_P.Saturation_UpperSat_e) {
    FlyByWire_Y.out.sim.data.gear_strut_compression_0 = FlyByWire_P.Saturation_UpperSat_e;
  } else if (rtb_Sum1_i < FlyByWire_P.Saturation_LowerSat_e) {
    FlyByWire_Y.out.sim.data.gear_strut_compression_0 = FlyByWire_P.Saturation_LowerSat_e;
  } else {
    FlyByWire_Y.out.sim.data.gear_strut_compression_0 = rtb_Sum1_i;
  }
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_en;
  ...
  FlyByWire_Y.out.roll.data_computed.beta_target_deg = rtb_Product_pc;
  FlyByWire_Y.out.roll.law_normal.xi_deg = rtb_Limiterxi_o;
  FlyByWire_Y.out.roll.law_normal.zeta_deg = rtb_LimiteriH;
  FlyByWire_Y.out.roll.output.xi_deg = rtb_Y_g;
  FlyByWire_Y.out.roll.output.zeta_deg = rtb_Y_k;
  FlyByWire_Y.out.roll.output.zeta_trim_deg = FlyByWire_DWork.Delay_DSTATE_hd;
  ...
  u0 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_en;
  ...
  u0 = FlyByWire_P.Gainxi2_Gain * FlyByWire_DWork.Delay_DSTATE_hd;
  ...
  FlyByWire_DWork.Delay_DSTATE_k = rtb_Gain_a;
  FlyByWire_DWork.Delay_DSTATE_f = rtb_Gain_k;
  FlyByWire_DWork.Delay_DSTATE_ge = rtb_Gain_n;
  FlyByWire_DWork.icLoad = false;
  FlyByWire_DWork.Delay_DSTATE_j = rtb_Gain_aj;
  FlyByWire_DWork.Delay_DSTATE_c = rtb_Divide_m;
  FlyByWire_DWork.Delay_DSTATE_p = rtb_Gain_ir;
  FlyByWire_DWork.Delay_DSTATE_m = rtb_Divide_e;
  FlyByWire_DWork.Delay_DSTATE_ps = rtb_Y;
  FlyByWire_DWork.Delay_DSTATE_c1 = rtb_Y_p;
  FlyByWire_DWork.Delay_DSTATE_l = rtb_Y_e;
  FlyByWire_DWork.Delay_DSTATE_n = rtb_Limiterxi2;
  FlyByWire_DWork.Delay_DSTATE_a = rtb_Loaddemand;
  FlyByWire_DWork.Delay_DSTATE_ld = rtb_Divide1;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_ge = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_k;
  ...
  FlyByWire_DWork.Delay_DSTATE_a = FlyByWire_P.DiscreteDerivativeVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_ld = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_c;
  FlyByWire_DWork.icLoad_e = true;
  FlyByWire_DWork.icLoad_i = true;
  FlyByWire_DWork.Delay_DSTATE_en = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.icLoad_m = true;
  FlyByWire_DWork.icLoad_id = true;
  FlyByWire_DWork.Delay_DSTATE_hd = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i4;
