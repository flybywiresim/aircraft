...
void FlyByWireModelClass::step()
{
  ...
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, FlyByWire_P.Gainqk1_Gain * (FlyByWire_P.Gain_Gain_e *
    ...
    FlyByWire_P.Gainpk1_Gain * (FlyByWire_P.Gain_Gain_nm * FlyByWire_U.in.data.p_dot_rad_s2), &rtb_Y_b, &rtb_Y_d,
    &rtb_Y_gj);
  ...
  rtb_Gain1_nl = FlyByWire_P.Gaineta_Gain * FlyByWire_U.in.input.delta_eta_pos;
  ...
  rtb_BusAssignment_sim_input_delta_eta_pos = rtb_Gain1_nl;
  ...
  FlyByWire_RateLimiter(look1_binlxpw(FlyByWire_U.in.data.flaps_handle_index, FlyByWire_P.alpha0_bp01Data,
    FlyByWire_P.alpha0_tableData, 5U), FlyByWire_P.RateLimiterVariableTs3_up, FlyByWire_P.RateLimiterVariableTs3_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs3_InitialCondition, &rtb_Gain1_nl,
                        &FlyByWire_DWork.sf_RateLimiter_b5);
  FlyByWire_CalculateV_alpha_max(FlyByWire_U.in.data.V_ias_kn, rtb_Limiterxi1, rtb_Gain1_nl, rtb_LimiteriH,
    &rtb_Limiterxi2);
  ...
  FlyByWire_CalculateV_alpha_max(FlyByWire_U.in.data.V_ias_kn, rtb_Limiterxi1, rtb_Gain1_nl, rtb_Switch, &rtb_Limiterxi);
  FlyByWire_RateLimiter(look2_binlxpw(FlyByWire_U.in.data.V_mach, FlyByWire_U.in.data.flaps_handle_index,
    ...
    FlyByWire_P.alphafloor_maxIndex, 4U), FlyByWire_P.RateLimiterVariableTs1_up, FlyByWire_P.RateLimiterVariableTs1_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs1_InitialCondition, &rtb_Gain1_nl,
  ...
  FlyByWire_Y.out.sim.data_speeds_aoa.alpha_floor_deg = rtb_Gain1_nl;
  ...
  if ((rtb_alpha_floor_inhib == 0) && (FlyByWire_U.in.data.V_mach < 0.6)) {
    ...
    if ((rtb_Limiterxi1 > rtb_Gain1_nl + rtb_Y_gj) && (FlyByWire_DWork.Delay_DSTATE > 10.0)) {
  ...
  rtb_BusAssignment_a_sim_data_qk_dot_deg_s2 = rtb_Y_b;
  ...
  FlyByWire_RateLimiter(rtb_ManualSwitch, FlyByWire_P.RateLimiterVariableTs1_up_n,
                        ...
                        FlyByWire_P.RateLimiterVariableTs1_InitialCondition_h, &rtb_Y_b,
  ...
  rtb_Gain1_nl = (((((rtb_Gain_g - FlyByWire_DWork.Delay_DSTATE_dd) / FlyByWire_U.in.time.dt + FlyByWire_P.Gain_Gain_h *
  ...
  FlyByWire_DWork.icLoad = (((rtb_BusAssignment_sim_input_delta_eta_pos <= FlyByWire_P.Constant_Value_j) &&
    (rtb_on_ground != 0)) || (rtb_Y_b == 0.0) || (rtb_alpha_floor_inhib != 0) || FlyByWire_DWork.icLoad);
  if (FlyByWire_DWork.icLoad) {
    FlyByWire_DWork.Delay_DSTATE_e = FlyByWire_P.Constant_Value_h - rtb_Gain1_nl;
  }

  FlyByWire_DWork.Delay_DSTATE_e += rtb_Gain1_nl;
  ...
  if (rtb_on_ground > FlyByWire_P.Switch_Threshold_he) {
    if (rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg > FlyByWire_P.Saturation_UpperSat_g) {
      rtb_Gain1_nl = FlyByWire_P.Saturation_UpperSat_g;
    } else if (rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg < FlyByWire_P.Saturation_LowerSat_p) {
      rtb_Gain1_nl = FlyByWire_P.Saturation_LowerSat_p;
    } else {
      rtb_Gain1_nl = rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg;
    }
  } else {
    rtb_Gain1_nl = FlyByWire_P.Constant1_Value_i;
  }

  rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_e + rtb_Gain1_nl;
  rtb_Gain1_nl = std::cos(FlyByWire_P.Gain1_Gain_p * rtb_GainTheta);
  rtb_Divide1 = rtb_Gain1_nl / std::cos(FlyByWire_P.Gain1_Gain_pa * rtb_GainPhi);
  ...
  rtb_Limiterxi2 = rtb_Gain1_nl / std::cos(FlyByWire_P.Gain1_Gain_b * rtb_Gain_iw);
  ...
  rtb_Gain1_nl = FlyByWire_U.in.time.dt * FlyByWire_P.Subsystem2_C1;
  rtb_Limiterxi = rtb_Gain1_nl + FlyByWire_P.Constant_Value_m3;
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_m3 - rtb_Gain1_nl) *
    FlyByWire_DWork.Delay1_DSTATE + (rtb_Divide_m + FlyByWire_DWork.Delay_DSTATE_c) * (rtb_Gain1_nl / rtb_Limiterxi);
  ...
  rtb_Gain1_nl = FlyByWire_U.in.time.dt * FlyByWire_P.Subsystem_C1;
  rtb_Limiterxi = rtb_Gain1_nl + FlyByWire_P.Constant_Value_hz;
  FlyByWire_DWork.Delay1_DSTATE_i = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_hz - rtb_Gain1_nl) *
    FlyByWire_DWork.Delay1_DSTATE_i + (rtb_Divide_e + FlyByWire_DWork.Delay_DSTATE_m) * (rtb_Gain1_nl / rtb_Limiterxi);
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_ke) {
    rtb_Gain1_nl = (rtb_Y_c - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    rtb_Gain1_nl = FlyByWire_P.Gain1_Gain * rtb_GainTheta;
    ...
    rtb_Sum1_d5 = FlyByWire_P.Gain2_Gain * rtb_Y - rtb_Gain1_nl;
    ...
    rtb_Y_o = look1_binlxpw(rtb_Sum1_d5, FlyByWire_P.Loaddemand1_bp01Data, FlyByWire_P.Loaddemand1_tableData, 2U) +
      rtb_Limiterxi;
    if (rtb_Y_c <= rtb_Y_o) {
      rtb_Sum1_d5 = FlyByWire_P.Gain3_Gain * FlyByWire_P.Theta_max3_Value - rtb_Gain1_nl;
    ...
    rtb_Gain1_nl = rtb_Y_o + rtb_Switch_c;
  }

  rtb_Gain1_nl += rtb_Limiterxi2;
  if (rtb_Gain1_nl > rtb_Y_d) {
    rtb_Gain1_nl = rtb_Y_d;
  } else if (rtb_Gain1_nl < rtb_BusAssignment_cs_pitch_data_computed_nz_limit_lo_g) {
    rtb_Gain1_nl = rtb_BusAssignment_cs_pitch_data_computed_nz_limit_lo_g;
  }
  ...
  FlyByWire_WashoutFilter(rtb_Sum1_c, FlyByWire_P.WashoutFilter_C1, FlyByWire_U.in.time.dt, &rtb_Y_gj,
  ...
  FlyByWire_Y.out.pitch.law_normal.nz_c_g = rtb_Gain1_nl;
  FlyByWire_Y.out.pitch.law_normal.Cstar_g = rtb_LimiteriH;
  rtb_Gain1_nl = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_k * rtb_Limiterxi * FlyByWire_U.in.time.dt;
  ...
  if (FlyByWire_DWork.icLoad_e) {
    ...
    FlyByWire_DWork.Delay_DSTATE_f1 = rtb_Sum1_d5 - rtb_Gain1_nl;
  }

  FlyByWire_DWork.Delay_DSTATE_f1 += rtb_Gain1_nl;
  ...
  if (rtb_BusAssignment_cs_pitch_data_computed_in_flight_gain > FlyByWire_P.Saturation_UpperSat_g4) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_UpperSat_g4;
  } else if (rtb_BusAssignment_cs_pitch_data_computed_in_flight_gain < FlyByWire_P.Saturation_LowerSat_l) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_LowerSat_l;
  } else {
    rtb_Gain1_nl = rtb_BusAssignment_cs_pitch_data_computed_in_flight_gain;
  }

  rtb_LimiteriH = FlyByWire_DWork.Delay_DSTATE_f1 * rtb_Gain1_nl;
  rtb_Sum1_d5 = FlyByWire_P.Constant_Value_o - rtb_Gain1_nl;
  if (rtb_Y_b > FlyByWire_P.Saturation_UpperSat_c) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_UpperSat_c;
  } else if (rtb_Y_b < FlyByWire_P.Saturation_LowerSat_m) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_LowerSat_m;
  } else {
    rtb_Gain1_nl = rtb_Y_b;
  }

  rtb_LimiteriH_n = ((FlyByWire_P.Constant_Value_ju - rtb_Gain1_nl) *
                     rtb_BusAssignment_cs_pitch_data_computed_delta_eta_deg + rtb_Limitereta * rtb_Gain1_nl) *
  ...
  rtb_Gain1_nl = FlyByWire_P.Gain_Gain_ip * rtb_LimiteriH * FlyByWire_P.DiscreteTimeIntegratorVariableTsLimit_Gain *
    FlyByWire_U.in.time.dt;
  FlyByWire_DWork.icLoad_i = (rtb_eta_trim_deg_reset || FlyByWire_DWork.icLoad_i);
  if (FlyByWire_DWork.icLoad_i) {
    FlyByWire_DWork.Delay_DSTATE_h = rtb_nz_limit_up_g - rtb_Gain1_nl;
  }

  FlyByWire_DWork.Delay_DSTATE_h += rtb_Gain1_nl;
  ...
  FlyByWire_Y.out.pitch.data_computed.in_rotation_gain = rtb_Y_b;
  ...
  rtb_Y_b = look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.uDLookupTable_bp01Data_f,
    FlyByWire_P.uDLookupTable_tableData_f, 3U);
  rtb_Gain1_h = FlyByWire_P.Gain1_Gain_jh * rtb_BusAssignment_sim_input_delta_zeta_pos;
  if (rtb_Gain1_h > rtb_Y_b) {
    rtb_Gain1_h = rtb_Y_b;
  } else {
    rtb_Y_b *= FlyByWire_P.Gain2_Gain_n;
    if (rtb_Gain1_h < rtb_Y_b) {
      rtb_Gain1_h = rtb_Y_b;
    }
  }
  ...
  if (rtb_nz_limit_lo_g > FlyByWire_P.Saturation_UpperSat_p) {
    rtb_Y_b = FlyByWire_P.Saturation_UpperSat_p;
  } else if (rtb_nz_limit_lo_g < FlyByWire_P.Saturation_LowerSat_h) {
    rtb_Y_b = FlyByWire_P.Saturation_LowerSat_h;
  } else {
    rtb_Y_b = rtb_nz_limit_lo_g;
  }

  FlyByWire_RateLimiter(rtb_Y_b, FlyByWire_P.RateLimiterVariableTs_up_k, FlyByWire_P.RateLimiterVariableTs_lo_fs,
  ...
  FlyByWire_LagFilter(rtb_Sum1_d5 * rtb_Y_gj, FlyByWire_P.LagFilter2_C1, FlyByWire_U.in.time.dt, &rtb_Y_b,
                      &FlyByWire_DWork.sf_LagFilter_lj);
  FlyByWire_RateLimiter(rtb_Gain1_h, FlyByWire_P.RateLimiterVariableTs_up_m, FlyByWire_P.RateLimiterVariableTs_lo_p,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc, &rtb_Y_d,
                        &FlyByWire_DWork.sf_RateLimiter_lp);
  rtb_Gain1_nl = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_d * rtb_Y_b * FlyByWire_U.in.time.dt;
  ...
  if (FlyByWire_DWork.icLoad_m) {
    FlyByWire_DWork.Delay_DSTATE_ho = rtb_GainPhi - rtb_Gain1_nl;
  }

  FlyByWire_DWork.Delay_DSTATE_ho += rtb_Gain1_nl;
  ...
  rtb_Sum1_d5 = FlyByWire_P.Gain_Gain_a1 * rtb_Y_d + FlyByWire_DWork.Delay_DSTATE_ho;
  ...
  FlyByWire_RateLimiter(rtb_Sum1_d5, FlyByWire_P.RateLimiterVariableTs_up_ms, FlyByWire_P.RateLimiterVariableTs_lo_g,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_j, &rtb_Y_gj,
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch_Threshold_p) {
    if (rtb_alpha_floor_inhib > FlyByWire_P.Switch1_Threshold) {
      rtb_Gain1_nl = rtb_GainPhi;
    } else {
      rtb_Gain1_nl = FlyByWire_U.in.data.autopilot_custom_Phi_c_deg;
    }
  } else {
    rtb_Gain1_nl = rtb_Y_gj;
  }
  ...
  rtb_Sum1_d5 = (rtb_Y_gj - std::sin(FlyByWire_P.Gain1_Gain_br * rtb_Gain1_nl) * FlyByWire_P.Constant2_Value_li * std::
  ...
  FlyByWire_Y.out.roll.law_normal.Phi_c_deg = rtb_Gain1_nl;
  rtb_BusAssignment_e_roll_law_normal_xi_deg = (((rtb_Gain1_nl - rtb_GainPhi) * FlyByWire_P.Gain_Gain_le +
    FlyByWire_P.Gain2_Gain_p * rtb_Y_b) + FlyByWire_P.Gain1_Gain_hw * rtb_BusAssignment_a_sim_data_pk_deg_s *
    FlyByWire_P.Gain1_Gain_cn) * FlyByWire_P.Gain3_Gain_li;
  rtb_Limiterxi1 = rtb_Y_d;
  ...
  if (rtb_Y_gj > FlyByWire_P.Saturation_UpperSat_d1) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_UpperSat_d1;
  } else if (rtb_Y_gj < FlyByWire_P.Saturation_LowerSat_j) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_LowerSat_j;
  } else {
    rtb_Gain1_nl = rtb_Y_gj;
  }

  rtb_LimiteriH = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg * rtb_Gain1_nl;
  rtb_Sum1_c = FlyByWire_P.Constant_Value_i - rtb_Gain1_nl;
  ...
  FlyByWire_LagFilter(rtb_Sum1_d5, FlyByWire_P.LagFilter1_C1_f, FlyByWire_U.in.time.dt, &rtb_Y_gj,
  ...
  rtb_Gain1_nl = rtb_Y_gj - rtb_Y_d;
  rtb_Y_d = FlyByWire_P.Gain4_Gain_o * rtb_Gain1_nl;
  rtb_Gain1_nl = FlyByWire_P.Gain7_Gain * rtb_Gain1_nl * FlyByWire_P.DiscreteTimeIntegratorVariableTs1_Gain *
    FlyByWire_U.in.time.dt;
  FlyByWire_DWork.icLoad_id = ((!rtb_AND) || FlyByWire_DWork.icLoad_id);
  if (FlyByWire_DWork.icLoad_id) {
    FlyByWire_DWork.Delay_DSTATE_gt = FlyByWire_P.fbw_output_MATLABStruct.roll.output.zeta_deg - rtb_Gain1_nl;
  }

  FlyByWire_DWork.Delay_DSTATE_gt += rtb_Gain1_nl;
  ...
  if (static_cast<real_T>(rtb_NOT2) > FlyByWire_P.Saturation_UpperSat_k) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_UpperSat_k;
  } else if (static_cast<real_T>(rtb_NOT2) < FlyByWire_P.Saturation_LowerSat_ae) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_LowerSat_ae;
  } else {
    rtb_Gain1_nl = rtb_NOT2;
  }

  rtb_Gain1_nl = ((rtb_Sum1_c * rtb_Y_gj + rtb_LimiteriH) * rtb_Gain1_nl + (FlyByWire_P.Constant_Value_l - rtb_Gain1_nl)
                  * FlyByWire_P.Constant3_Value_l) + rtb_Limiterxi;
  rtb_LimiteriH = rtb_Limiterxi1 + rtb_Gain1_nl;
  if (FlyByWire_U.in.data.H_radio_ft <= FlyByWire_P.CompareToConstant_const_g) {
    rtb_Gain1_nl = FlyByWire_P.Constant2_Value_c;
  }

  rtb_Gain1_nl = FlyByWire_P.Gain4_Gain_h * rtb_Gain1_nl * FlyByWire_P.DiscreteTimeIntegratorVariableTs1_Gain_e *
    FlyByWire_U.in.time.dt;
  ...
  if (FlyByWire_DWork.icLoad_c) {
    FlyByWire_DWork.Delay_DSTATE_fz = rtb_BusAssignment_sim_data_zeta_trim_deg - rtb_Gain1_nl;
  }

  FlyByWire_DWork.Delay_DSTATE_fz += rtb_Gain1_nl;
  ...
  rtb_Limiterxi = rtb_BusAssignment_p_roll_data_computed_in_flight_gain + FlyByWire_U.in.data.autopilot_custom_on;
  if (rtb_Limiterxi > FlyByWire_P.Saturation1_UpperSat_e) {
    rtb_Gain1_nl = FlyByWire_P.Saturation1_UpperSat_e;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation1_LowerSat_l) {
    rtb_Gain1_nl = FlyByWire_P.Saturation1_LowerSat_l;
  } else {
    rtb_Gain1_nl = rtb_Limiterxi;
  }

  if (rtb_Gain1_nl > FlyByWire_P.Saturation_UpperSat_ll) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_UpperSat_ll;
  } else if (rtb_Gain1_nl < FlyByWire_P.Saturation_LowerSat_og) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_LowerSat_og;
  }

  rtb_Y_d = (FlyByWire_P.Constant_Value_l1 - rtb_Gain1_nl) * rtb_BusAssignment_p_roll_data_computed_delta_xi_deg +
    rtb_BusAssignment_e_roll_law_normal_xi_deg * rtb_Gain1_nl;
  ...
  if (rtb_Limiterxi > FlyByWire_P.Saturation_UpperSat_i) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_UpperSat_i;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation_LowerSat_fr) {
    rtb_Gain1_nl = FlyByWire_P.Saturation_LowerSat_fr;
  } else {
    rtb_Gain1_nl = rtb_Limiterxi;
  }

  rtb_Limiterxi = rtb_LimiteriH * rtb_Gain1_nl;
  rtb_Gain1_nl = (FlyByWire_P.Constant_Value_f - rtb_Gain1_nl) * rtb_Gain1_h;
  rtb_Limiterxi += rtb_Gain1_nl;
  rtb_Y_gj = rtb_Limiterxi;
  FlyByWire_RateLimiter(rtb_LimiteriH_n, FlyByWire_P.RateLimitereta_up, FlyByWire_P.RateLimitereta_lo,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimitereta_InitialCondition, &rtb_Gain1_nl,
  ...
  FlyByWire_RateLimiter(rtb_Y_gj, FlyByWire_P.RateLimiterzeta_up, FlyByWire_P.RateLimiterzeta_lo, FlyByWire_U.in.time.dt,
  ...
  FlyByWire_Y.out.roll.data_computed.delta_zeta_deg = rtb_Gain1_h;
  ...
  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Y_b;
  ...
  FlyByWire_Y.out.roll.output.zeta_deg = rtb_Y_gj;
  FlyByWire_Y.out.roll.output.zeta_trim_deg = FlyByWire_DWork.Delay_DSTATE_j5;
  u0 = FlyByWire_P.Gaineta_Gain_d * rtb_Gain1_nl;
