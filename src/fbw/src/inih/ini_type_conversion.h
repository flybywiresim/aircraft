...
class INITypeConversion {
 public:
  ...
  static bool getBoolean(mINI::INIStructure structure,
  ...
  static double getDouble(mINI::INIStructure structure,
                          const std::string& section,
                          const std::string& key,
  ...
  static int getInteger(mINI::INIStructure structure,
                        const std::string& section,
                        const std::string& key,
                        int defaultValue = 0) {
    if (!structure.has(section) || !structure.get(section).has(key)) {
