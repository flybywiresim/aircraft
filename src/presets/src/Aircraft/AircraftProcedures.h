...
static vector<ProcedureStep*>* PUSHBACK_CONFIG_ON = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"PWS Auto",                207, false, 1000, "(L:A32NX_SWITCH_RADAR_PWS_POSITION) 1 ==",    "1 (>L:A32NX_SWITCH_RADAR_PWS_POSITION)"},
...
static vector<ProcedureStep*>* PUSHBACK_CONFIG_OFF = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"PWS Off",         221, false, 1000, "(L:A32NX_SWITCH_RADAR_PWS_POSITION) 0 ==",             "0 (>L:A32NX_SWITCH_RADAR_PWS_POSITION)"},
...
static vector<ProcedureStep*>* TAXI_CONFIG_ON = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"Autobrake Max",        308, false, 2000,  "(L:A32NX_AUTOBRAKES_ARMED_MODE) 3 ==",             "0 (>K:A32NX.AUTOBRAKE_SET_MAX)"},
...
static vector<ProcedureStep*>* TAXI_CONFIG_OFF = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"Autobrake Off",         318, false, 2000, "(L:A32NX_AUTOBRAKES_ARMED_MODE) 0 ==", "0 (>K:A32NX.AUTOBRAKE_SET_DISARM)"},
