...
static vector<ProcedureStep*>* TURNAROUND_CONFIG_ON = new vector<ProcedureStep*>{
  ...
  new ProcedureStep {"ADIRS 3 Nav",        110, false, 500,  "(L:A32NX_OVHD_ADIRS_IR_3_MODE_SELECTOR_KNOB) 1 ==", "1 (>L:A32NX_OVHD_ADIRS_IR_3_MODE_SELECTOR_KNOB)"},
  new ProcedureStep {"GND CTL On",         111, false, 500,  "(L:A32NX_ENGINE_STATE:1) 1 == "
                                                           "(L:A32NX_ENGINE_STATE:2) 1 == || "
  ...
  new ProcedureStep{"NO SMOKING Auto",     113, false, 500,  "(L:XMLVAR_SWITCH_OVHD_INTLT_NOSMOKING_POSITION) 1 ==", "1 (>L:XMLVAR_SWITCH_OVHD_INTLT_NOSMOKING_POSITION)"},
  new ProcedureStep{"EMER EXT Lt Arm",     114, false, 500,  "(L:XMLVAR_SWITCH_OVHD_INTLT_EMEREXIT_POSITION) 1 ==",  "1 (>L:XMLVAR_SWITCH_OVHD_INTLT_EMEREXIT_POSITION)"},
...
static vector<ProcedureStep*>* TURNAROUND_CONFIG_OFF = new vector<ProcedureStep*>{
  new ProcedureStep{"NO SMOKING Off",    117, false, 500,  "(L:XMLVAR_SWITCH_OVHD_INTLT_NOSMOKING_POSITION) 2 ==", "2 (>L:XMLVAR_SWITCH_OVHD_INTLT_NOSMOKING_POSITION)"},
  ...
  new ProcedureStep{"Crew Oxy Off",      119, false, 500,  "(L:PUSH_OVHD_OXYGEN_CREW) 1 ==",                    "1 (>L:PUSH_OVHD_OXYGEN_CREW)"},
  new ProcedureStep{"GND CTL Off",       120, false, 500,  "(L:A32NX_RCDR_GROUND_CONTROL_ON) 0 ==",             "0 (>L:A32NX_RCDR_GROUND_CONTROL_ON)"},
  ...
  new ProcedureStep{"APU Bleed Off",     125, false, 1000, "(L:A32NX_OVHD_PNEU_APU_BLEED_PB_IS_ON) 0 ==",       "0 (>L:A32NX_OVHD_PNEU_APU_BLEED_PB_IS_ON)"},
  new ProcedureStep{"APU Master Off",    126, false, 1000, "(L:A32NX_OVHD_APU_MASTER_SW_PB_IS_ON) 0 ==",        "0 (>L:A32NX_OVHD_APU_MASTER_SW_PB_IS_ON)"},
...
static vector<ProcedureStep*>* PUSHBACK_CONFIG_ON = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"FUEL PUMP 6 On",          206, false, 1500, "(A:FUELSYSTEM PUMP SWITCH:6, Bool)",                   "6 (>K:FUELSYSTEM_PUMP_ON)"},
  new ProcedureStep{"Radar PWS On",            207, false, 500,  "(L:A32NX_SWITCH_RADAR_PWS_POSITION) 1 ==",             "1 (>L:A32NX_SWITCH_RADAR_PWS_POSITION)"},
  new ProcedureStep{"Transponder On",          208, false, 500,  "(L:A32NX_TRANSPONDER_MODE) 1 ==",                      "1 (>L:A32NX_TRANSPONDER_MODE)"},
  new ProcedureStep{"ATC ALT RPTG On",         209, false, 500,  "(L:A32NX_SWITCH_ATC_ALT) 1 ==",                        "1 (>L:A32NX_SWITCH_ATC_ALT)"},
  ...
  new ProcedureStep{"Strobe Auto",             212, false, 500,  "(A:LIGHT STROBE, Bool)",                               "1 (>L:STROBE_0_AUTO) 0 (>K:STROBES_ON)"},
  new ProcedureStep{"Beacon On",               213, false, 500,  "(A:LIGHT BEACON, Bool)",                               "0 (>K:BEACON_LIGHTS_ON)"},
  new ProcedureStep{"SEAT BELTS On",           214, false, 500,  "(A:CABIN SEATBELTS ALERT SWITCH:1, BOOL)",             "(A:CABIN SEATBELTS ALERT SWITCH:1, BOOL) ! if{ 1 (>K:CABIN_SEATBELTS_ALERT_SWITCH_TOGGLE) }"},
...
static vector<ProcedureStep*>* PUSHBACK_CONFIG_OFF = new vector<ProcedureStep*>{
  new ProcedureStep{"Strobe Off",      218, false, 500,  "(A:LIGHT STROBE, Bool) !",                             "0 (>L:STROBE_0_AUTO) 0 (>K:STROBES_OFF)"},
  new ProcedureStep{"Beacon Off",      219, false, 500,  "(A:LIGHT BEACON, Bool) !",                             "0 (>K:BEACON_LIGHTS_OFF)"},
  new ProcedureStep{"SEAT BELTS Off",  220, false, 500,  "(A:CABIN SEATBELTS ALERT SWITCH:1, BOOL) !",           "(A:CABIN SEATBELTS ALERT SWITCH:1, BOOL) if{ 1 (>K:CABIN_SEATBELTS_ALERT_SWITCH_TOGGLE) }"},
  new ProcedureStep{"Radar PWS Off",   221, false, 500,  "(L:A32NX_SWITCH_RADAR_PWS_POSITION) 0 ==",             "0 (>L:A32NX_SWITCH_RADAR_PWS_POSITION)"},
  new ProcedureStep{"Transponder Off", 222, false, 500,  "(L:A32NX_TRANSPONDER_MODE) 0 ==",                      "0 (>L:A32NX_TRANSPONDER_MODE)"},
  new ProcedureStep{"ATC ALT RPTG Off",223, false, 500,  "(L:A32NX_SWITCH_ATC_ALT) 1 ==",                        "1 (>L:A32NX_SWITCH_ATC_ALT)"},
  ...
  new ProcedureStep{"COCKPIT DOOR OP", 225, false, 1500, "(L:A32NX_COCKPIT_DOOR_LOCKED) 0 ==",                   "0 (>L:A32NX_COCKPIT_DOOR_LOCKED)"},
...
static vector<ProcedureStep*>* TAXI_CONFIG_ON = new vector<ProcedureStep*>{
  new ProcedureStep{"ENG MODE SEL START",   300, false, 2000,  "(L:A32NX_ENGINE_STATE:1) 1 == "
                                                               "(L:A32NX_ENGINE_STATE:2) 1 == && "
  ...
  new ProcedureStep{"ENG 2 ON",             301, false, 50000, "(A:FUELSYSTEM VALVE OPEN:2, Bool)",                "2 (>K:FUELSYSTEM_VALVE_OPEN)"},
  new ProcedureStep{"ENG 2 Avail Check",    302, true,  5000,  "",                                                 "(L:A32NX_ENGINE_STATE:2) 1 =="},
  new ProcedureStep{"ENG 1 ON",             303, false, 50000, "(A:FUELSYSTEM VALVE OPEN:1, Bool)",                "1 (>K:FUELSYSTEM_VALVE_OPEN)"},
  new ProcedureStep{"ENG 1 Avail Check",    304, true,  5000,  "",                                                 "(L:A32NX_ENGINE_STATE:1) 1 =="},
  new ProcedureStep{"ENG MODE SEL NORM",    305, false, 2000,  "(A:TURB ENG IGNITION SWITCH EX1:1, Bool) 1 == "
                                                              "(A:TURB ENG IGNITION SWITCH EX1:2, Bool) 1 == &&", "1 (>K:TURBINE_IGNITION_SWITCH_SET1) 1 (>K:TURBINE_IGNITION_SWITCH_SET2)"},
  new ProcedureStep{"APU Bleed Off",        306, false, 1000,  "(L:A32NX_OVHD_PNEU_APU_BLEED_PB_IS_ON) 0 ==",      "0 (>L:A32NX_OVHD_PNEU_APU_BLEED_PB_IS_ON)"},
  new ProcedureStep{"APU Master Off",       307, false, 1000,  "(L:A32NX_OVHD_APU_MASTER_SW_PB_IS_ON) 0 ==",       "0 (>L:A32NX_OVHD_APU_MASTER_SW_PB_IS_ON)"},
  new ProcedureStep{"Autobrake Max",        308, false, 1000,  "(L:A32NX_AUTOBRAKES_ARMED_MODE) 3 ==",             "3 (>L:A32NX_AUTOBRAKES_ARMED_MODE)"},
  new ProcedureStep{"Spoiler Arm",          309, false, 1000,  "(L:A32NX_SPOILERS_ARMED) 1 ==",                    "1 (>K:SPOILERS_ARM_SET)"},
  new ProcedureStep{"Rudder Trim Reset",    310, false, 1000,  "(A:RUDDER TRIM, Radians) 0 ==",                    "0 (>K:RUDDER_TRIM_SET)"},
  new ProcedureStep{"Flaps 1",              311, false, 1500,  "(L:A32NX_FLAPS_HANDLE_INDEX) 1 ==",                "1 (>L:A32NX_FLAPS_HANDLE_INDEX)"},
  new ProcedureStep{"NOSE Lt Taxi",         312, false, 500,   "(A:CIRCUIT SWITCH ON:20, Bool)",                   "0 (>L:LIGHTING_LANDING_1) (A:CIRCUIT SWITCH ON:20, Bool) ! if{ 20 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
  ...
  new ProcedureStep{"RWY TURN OFF Lt R On", 314, false, 500,   "(A:CIRCUIT SWITCH ON:22, Bool)",                   "(A:CIRCUIT SWITCH ON:22, Bool) ! if{ 22 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
};

static vector<ProcedureStep*>* TAXI_CONFIG_OFF = new vector<ProcedureStep*>{
  new ProcedureStep{"NOSE Lt Taxi",          315, false, 500,  "(A:CIRCUIT SWITCH ON:20, Bool) !",     "2 (>L:LIGHTING_LANDING_1) (A:CIRCUIT SWITCH ON:20, Bool) if{ 20 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
  ...
  new ProcedureStep{"RWY TURN OFF Lt R Off", 317, false, 1500,  "(A:CIRCUIT SWITCH ON:22, Bool) !",     "(A:CIRCUIT SWITCH ON:22, Bool) if{ 22 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
  new ProcedureStep{"Autobrake Off",         318, false, 1000, "(L:A32NX_AUTOBRAKES_ARMED_MODE) 0 ==", "0 (>L:A32NX_AUTOBRAKES_ARMED_MODE)"},
  new ProcedureStep{"Spoiler Disarm",        319, false, 1000, "(L:A32NX_SPOILERS_ARMED) 0 ==",        "0 (>K:SPOILERS_ARM_SET)"},
  new ProcedureStep{"Rudder Trim Reset",     320, false, 1000, "(A:RUDDER TRIM, Radians) 0 ==",        "0 (>K:RUDDER_TRIM_SET)"},
  new ProcedureStep{"Flaps 0",               321, false, 1000, "(L:A32NX_FLAPS_HANDLE_INDEX) 0 ==",    "0 (>L:A32NX_FLAPS_HANDLE_INDEX)"},
  new ProcedureStep{"ENG 1 Off",             322, false, 1000, "(A:FUELSYSTEM VALVE OPEN:1, Bool) !",  "1 (>K:FUELSYSTEM_VALVE_CLOSE)"},
  new ProcedureStep{"ENG 2 Off",             323, false, 1000, "(A:FUELSYSTEM VALVE OPEN:2, Bool) !",  "2 (>K:FUELSYSTEM_VALVE_CLOSE)"},
  new ProcedureStep{"ENG 1 N2 <3%",          324, true,  1000, "",                                     "(L:A32NX_ENGINE_N1:1) 3 <"},
...
static vector<ProcedureStep*>* TAKEOFF_CONFIG_ON = new vector<ProcedureStep*>{
  ...
  new ProcedureStep{"TCAS Switch TA/RA", 402, false, 1500, "(L:A32NX_SWITCH_TCAS_POSITION) 2 ==",    "2 (>L:A32NX_SWITCH_TCAS_POSITION)"},
  new ProcedureStep{"NOSE Lt Takeoff",   403, false, 500,  "(A:CIRCUIT SWITCH ON:17, Bool)",         "(A:CIRCUIT SWITCH ON:17, Bool) ! if{ 17 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
  new ProcedureStep{"LL Lt L On",        404, false, 500,  "(A:CIRCUIT SWITCH ON:18, Bool)",         "0 (>L:LIGHTING_LANDING_2) 0 (>L:LANDING_2_RETRACTED) (A:CIRCUIT SWITCH ON:18, Bool) ! if{ 18 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
  new ProcedureStep{"LL Lt R On",        405, false, 500,  "(A:CIRCUIT SWITCH ON:19, Bool)",         "0 (>L:LIGHTING_LANDING_3) 0 (>L:LANDING_3_RETRACTED) (A:CIRCUIT SWITCH ON:19, Bool) ! if{ 19 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
};

static vector<ProcedureStep*>* TAKEOFF_CONFIG_OFF = new vector<ProcedureStep*>{
  new ProcedureStep{"LL Lt L Off",       406, false, 500,  "(A:CIRCUIT SWITCH ON:18, Bool) ! (L:LANDING_2_RETRACTED) &&", "2 (>L:LIGHTING_LANDING_2) 1 (>L:LANDING_2_RETRACTED) (A:CIRCUIT SWITCH ON:18, Bool) if{ 18 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
  new ProcedureStep{"LL Lt R Off",       407, false, 500,  "(A:CIRCUIT SWITCH ON:19, Bool) ! (L:LANDING_3_RETRACTED) &&", "2 (>L:LIGHTING_LANDING_3) 1 (>L:LANDING_3_RETRACTED) (A:CIRCUIT SWITCH ON:19, Bool) if{ 19 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
  new ProcedureStep{"NOSE Lt Takeoff",   408, false, 1500, "(A:CIRCUIT SWITCH ON:17, Bool) !",                            "(A:CIRCUIT SWITCH ON:17, Bool) if{ 17 (>K:ELECTRICAL_CIRCUIT_TOGGLE)"},
  new ProcedureStep{"TCAS Switch TA/RA", 409, false, 1000, "(L:A32NX_SWITCH_TCAS_POSITION) 0 ==",                         "0 (>L:A32NX_SWITCH_TCAS_POSITION)"},
  new ProcedureStep{"WX Radar Off",      410, false, 500,  "(L:XMLVAR_A320_WEATHERRADAR_SYS) 1 ==",                       "1 (>L:XMLVAR_A320_WEATHERRADAR_SYS)"},
