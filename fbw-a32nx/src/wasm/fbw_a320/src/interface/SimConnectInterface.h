...
class SimConnectInterface {
 public:
  enum Events {
    ...
    AXIS_AILERONS_SET,
    AXIS_RUDDER_SET,
    SECONDARY_AXIS_ELEVATOR_SET,
    SECONDARY_AXIS_AILERONS_SET,
    RUDDER_SET,
    RUDDER_LEFT,
    RUDDER_AXIS_PLUS,
    RUDDER_CENTER,
    ...
    AILERONS_LEFT,
    AILERONS_RIGHT,
    A32NX_SECONDARY_AILERON_SET,
    A32NX_SECONDARY_AILERONS_LEFT,
    A32NX_SECONDARY_AILERONS_RIGHT,
    CENTER_AILER_RUDDER,
    A32NX_SECONDARY_CENTER_AILER_RUDDER,
    ELEVATOR_SET,
    ELEV_DOWN,
    ELEV_UP,
    A32NX_SECONDARY_ELEVATOR_SET,
    A32NX_SECONDARY_ELEV_DOWN,
    A32NX_SECONDARY_ELEV_UP,
    AP_MASTER,
    AUTOPILOT_OFF,
    AUTOPILOT_ON,
    ...
    A32NX_SECONDARY_AP_INSTINCTIVE_DISC,
