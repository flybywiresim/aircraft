...
void ElacComputer::step()
{
  ...
  boolean_T rtb_aileronDroopActive;
  ...
  if (ElacComputer_U.in.sim_data.computer_running) {
    ...
    if (rtb_ra1Invalid && rtb_NOT_ac) {
      ...
      if (rtb_OR3 && rtb_NOT_ac) {
        ...
        if ((rtb_AND2 && rtb_NOT_ac) || (rtb_AND2 && rtb_OR4)) {
          rtb_V_ias = (ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data +
    ...
    if (rtb_ra1Invalid && rtb_NOT_ac) {
      ...
      if (rtb_OR3 && rtb_NOT_ac) {
        ...
        rtb_AND2 = (rtb_OR1 && rtb_AND2);
        if ((rtb_AND2 && rtb_NOT_ac) || (rtb_AND2 && rtb_OR6)) {
          rtb_alpha = (ElacComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.Data +
                       ElacComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.Data) / 2.0F;
          rtb_phi = (ElacComputer_U.in.bus_inputs.ir_1_bus.roll_angle_deg.Data +
                     ElacComputer_U.in.bus_inputs.ir_3_bus.roll_angle_deg.Data) / 2.0F;
        ...
        } else if (rtb_leftElevatorAvail && rtb_NOT_ac) {
          rtb_alpha = ElacComputer_U.in.bus_inputs.ir_2_bus.pitch_angle_deg.Data;
          rtb_phi = ElacComputer_U.in.bus_inputs.ir_2_bus.roll_angle_deg.Data;
          rtb_q = ElacComputer_U.in.bus_inputs.ir_2_bus.body_pitch_rate_deg_s.Data;
          rtb_r = ElacComputer_U.in.bus_inputs.ir_2_bus.body_yaw_rate_deg_s.Data;
    ...
    } else if ((rtb_ra1Invalid && rtb_NOT_ac) || (rtb_AND2 && rtb_OR)) {
    ...
    u0 = rtb_DataTypeConversion7 + rtb_handleIndex_o;
    ...
    canEngageInPitch = ((!ElacComputer_U.in.discrete_inputs.r_elev_servo_failed) &&
                        (!ElacComputer_U.in.discrete_inputs.l_elev_servo_failed) && rtb_isEngagedInPitch && rtb_NOT_ac);
    ...
    if (rtb_isEngagedInRoll && rtb_NOT_ac && (ElacComputer_U.in.bus_inputs.elac_opp_bus.aileron_command_deg.SSM ==
         static_cast<uint32_T>(SignStatusMatrix::NormalOperation))) {
    ...
    rtb_OR_e1 = (rtb_NOT_kl || (rtb_y_g != 0U));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_3,
    ...
    if ((ElacComputer_U.in.discrete_inputs.fac_1_yaw_control_lost &&
        ...
        ((ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1.SSM != static_cast<uint32_T>(SignStatusMatrix::
          ...
          static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) && ((!rtb_y_aq) && (rtb_y_g != 0U))) ||
    ...
    rtb_OR1_i = (((!rtb_y_k) && (!rtb_y_aq)) || (rtb_NOT_k && (rtb_y_g != 0U)));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_2,
    ...
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_y_k);
    rtb_AND2_j = ((rtb_y_g != 0U) && rtb_y_k);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel1_bit_jr, &rtb_y_g);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word, &rtb_y_aq);
    rtb_AND3_j = ((rtb_y_g != 0U) && rtb_y_aq);
    ...
    rtb_DataTypeConversion_e = !ElacComputer_P.Constant_Value_ad;
    rtb_OR1_me = ((!rtb_y_aq) && rtb_ap_authorised && (((!rtb_tripleAdrFault) && ((rtb_mach > 0.91) || (rtb_Y < -10.0) ||
      (rtb_Y > 40.0) || (rtb_V_ias > 440.0F) || (rtb_V_ias < 60.0F))) || ((!rtb_tripleIrFault) && ((!rtb_doubleIrFault) ||
      rtb_DataTypeConversion_e) && ((abnormalCondition_tmp > 125.0) || ((rtb_alpha > 50.0F) || (rtb_alpha < -30.0F))))));
    ElacComputer_DWork.abnormalConditionWasActive = (rtb_OR1_me || (rtb_ap_authorised &&
      ElacComputer_DWork.abnormalConditionWasActive));
    rtb_aileronDroopActive = ((!rtb_leftElevatorAvail) || (!rtb_OR3));
    ...
    rtb_y_aq = (rtb_groundSettingHasPriority || rtb_tripleAdrFault || ElacComputer_DWork.abnormalConditionWasActive ||
                (rtb_AND4 && rtb_OR_e1 && rtb_aileronDroopActive));
    rtb_y_k = !ElacComputer_P.Constant1_Value_b;
    rtb_groundSettingHasPriority = ((rtb_doubleIrFault && rtb_DataTypeConversion_e) || (rtb_groundSettingHasPriority &&
      rtb_y_k) || (rtb_doubleAdrFault && rtb_y_k && rtb_y_k) || rtb_aileronDroopActive);
    if (rtb_tripleIrFault || ((rtb_y_aq || rtb_groundSettingHasPriority || rtb_AND2 || (rtb_lateralLawCapability ==
           lateral_efcs_law::DirectLaw)) && ((ElacComputer_B.in_flight != 0.0) && ((rtb_NOT_k && (!rtb_OR1_i)) ||
           ((rtb_AND2_j || rtb_AND3_j) && rtb_OR1_i))))) {
    ...
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel_bit_h, &rtb_y_c);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2,
    ...
    if (hasPriorityInPitch && rtb_isEngagedInPitch) {
      ...
      if ((rtb_y_c != 0U) && (rtb_Switch18 == 0U)) {
        priorityPitchPitchLawCap = pitch_efcs_law::NormalLaw;
      } else if ((rtb_y_c == 0U) && (rtb_Switch18 != 0U)) {
    ...
    ElacComputer_MATLABFunction_g4((ElacComputer_B.in_flight != 0.0), ElacComputer_P.PulseNode_isRisingEdge_g, &rtb_y_aq,
    ...
    rtb_groundSettingHasPriority = ((rtb_isEngagedInPitch && (ElacComputer_B.in_flight != 0.0) &&
      ((priorityPitchPitchLawCap != ElacComputer_P.EnumeratedConstant_Value_i) && rtb_AND3_b)) || rtb_NOT_k);
    ...
    rtb_OR1_i = (rtb_y_g != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel2_bit_n, &rtb_y_g);
    rtb_AND2_j = (rtb_y_g != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel3_bit_g, &rtb_y_g);
    rtb_AND3_j = (rtb_y_g != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_e, &rtb_y_g);
    rtb_DataTypeConversion_e = (rtb_y_g != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel5_bit_a, &rtb_y_g);
    ElacComputer_MATLABFunction_o(rtb_y_aq, rtb_OR1_i, rtb_AND2_j, rtb_AND3_j, rtb_DataTypeConversion_e, (rtb_y_g != 0U),
      &rtb_handleIndex);
    ...
    if (ElacComputer_U.in.discrete_inputs.ap_1_disengaged && ElacComputer_U.in.discrete_inputs.ap_2_disengaged &&
        (rtb_V_ias > std::fmin(look1_binlxpw(rtb_Y_d, ElacComputer_P.uDLookupTable1_bp01Data,
          ...
          (rtb_Y_d, ElacComputer_P.uDLookupTable2_bp01Data, ElacComputer_P.uDLookupTable2_tableData, 3U)))) {
    ...
    ElacComputer_DWork.sProtActive = ((rtb_V_ias >= rtb_DataTypeConversion3_m) && (rtb_AND1_h && rtb_NOT_k &&
    ...
    ElacComputer_DWork.sProtActive_g = ((rtb_ap_authorised && rtb_NOT_k && rtb_AND1_h && (rtb_Y > rtb_handleIndex) &&
    ...
    if ((rtb_V_ias <= std::fmin(365.0, static_cast<real_T>(rtb_V_ias) / rtb_mach * (look1_binlxpw(rtb_Y_d,
    ...
    ElacComputer_MATLABFunction_g(&ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_q_cmd_deg, &rtb_y_k);
    rtb_OR1_i = !ElacComputer_U.in.discrete_inputs.ap_1_disengaged;
    rtb_AND2_j = (rtb_OR1_i && rtb_NOT_kl && rtb_y_k);
    ElacComputer_MATLABFunction_g(&ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_p_ail_cmd_deg, &rtb_AND3_b);
    ElacComputer_MATLABFunction_g(&ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_q_cmd_deg, &rtb_y_k);
    rtb_AND3_j = !ElacComputer_U.in.discrete_inputs.ap_2_disengaged;
    rtb_DataTypeConversion_e = (rtb_AND3_j && rtb_AND3_b && rtb_y_k);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel_bit_e, &rtb_y_g);
    rtb_NOT_ac = (rtb_y_g == 0U);
    ...
    rtb_NOT_ac = ((rtb_NOT_ac && rtb_NOT_kl) || ((rtb_y_g == 0U) && rtb_y_k));
    rtb_aileronDroopActive = (rtb_NOT_ac && ((leftAileronAvail && rightAileronAvail) ||
      ((!ElacComputer_U.in.discrete_inputs.opp_left_aileron_lost) && rightAileronAvail) || (leftAileronAvail &&
      (!ElacComputer_U.in.discrete_inputs.opp_right_aileron_lost))));
    rtb_aileronAntidroopActive = (rtb_aileronAntidroopActive && rtb_NOT_ac && (rtb_alpha < 2.5F) && rtb_AND1_h &&
      (rtb_activeLateralLaw == lateral_efcs_law::NormalLaw));
    ...
    rtb_NOT_k = (rtb_AND2_j || rtb_DataTypeConversion_e);
    LawMDLOBJ2.step(&ElacComputer_U.in.time.dt, &rtb_Y_d_tmp_tmp, &rtb_DataTypeConversion5, &rtb_Y_n, &rtb_zeta_deg_f,
                    ...
                    &ElacComputer_DWork.sProtActive_g, &ElacComputer_DWork.sProtActive, &rtb_DataTypeConversion6,
    ...
    if (rtb_leftAileronCrossCommandActive) {
      ...
      rtb_Y_d = ElacComputer_P.Gain_Gain * rtb_DataTypeConversion6 + rtb_Y_n;
    }
    ...
    if (rtb_rightAileronCrossCommandActive) {
      ...
      rtb_Y_d = rtb_DataTypeConversion6 + rtb_Y_n;
    }
    ...
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel_bit_a2, &rtb_y_c);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_NOT_kl);
    rtb_NOT_ac = ((rtb_y_c != 0U) && rtb_NOT_kl);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel1_bit_p, &rtb_y_c);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word, &rtb_y_k);
    if (rtb_NOT_ac || ((rtb_y_c != 0U) && rtb_y_k)) {
      rtb_Y_d = rtb_DataTypeConversion6;
    } else {
      rtb_Y_n = std::abs(rtb_DataTypeConversion6) + ElacComputer_P.Bias_Bias;
      if (rtb_Y_n > ElacComputer_P.Saturation_UpperSat) {
        rtb_Y_n = ElacComputer_P.Saturation_UpperSat;
      } else if (rtb_Y_n < ElacComputer_P.Saturation_LowerSat) {
        rtb_Y_n = ElacComputer_P.Saturation_LowerSat;
      }
      ...
      rtb_Y_d = rtb_Y_n * static_cast<real_T>(rtb_ap_special_disc) * ElacComputer_P.Gain2_Gain;
    }

    rtb_Y_n = ElacComputer_P.Gain1_Gain_b * rtb_Y_d;
    switch (static_cast<int32_T>(rtb_activeLateralLaw)) {
     case 0:
    ...
    rtb_DataTypeConversion7 = rtb_handleIndex_o;
    rtb_Y_p = ElacComputer_P.DiscreteDerivativeVariableTs_Gain * rtb_theta_dot;
    ElacComputer_LagFilter((rtb_Y_p - ElacComputer_DWork.Delay_DSTATE) / ElacComputer_U.in.time.dt,
      ElacComputer_P.LagFilter_C1_e, ElacComputer_U.in.time.dt, &rtb_Y_d, &ElacComputer_DWork.sf_LagFilter);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel_bit_p, &rtb_y_c);
    rtb_NOT_ac = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel1_bit_h, &rtb_y_c);
    rtb_y_k = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel2_bit_f, &rtb_y_c);
    rtb_AND1_h = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel3_bit_c, &rtb_y_c);
    rtb_AND3_b = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_n, &rtb_y_c);
    rtb_NOT_kl = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel5_bit_p, &rtb_y_c);
    ElacComputer_MATLABFunction_o(rtb_NOT_ac, rtb_y_k, rtb_AND1_h, rtb_AND3_b, rtb_NOT_kl, (rtb_y_c != 0U),
      &rtb_handleIndex_o);
    ...
    LawMDLOBJ5.step(&ElacComputer_U.in.time.dt, &rtb_BusAssignment_f_logic_ir_computation_data_n_z_g, &rtb_Y_d_tmp_tmp,
      ...
      (&ElacComputer_RGND)), &rtb_DataTypeConversion3_m, &rtb_DataTypeConversion8,
                    ...
                    &u0_0, &rtb_ra1Invalid, &rtb_DataTypeConversion_au, &rtb_NOT_ac, &ElacComputer_DWork.sProtActive_g,
    ...
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel_bit_n, &rtb_y_c);
    rtb_NOT_ac = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel1_bit_h1, &rtb_y_c);
    rtb_NOT_k = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel2_bit_g, &rtb_y_c);
    rtb_y_k = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel3_bit_b, &rtb_y_c);
    rtb_AND1_h = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_i, &rtb_y_c);
    rtb_AND3_b = (rtb_y_c != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel5_bit_l, &rtb_y_c);
    ElacComputer_MATLABFunction_o(rtb_NOT_ac, rtb_NOT_k, rtb_y_k, rtb_AND1_h, rtb_AND3_b, (rtb_y_c != 0U),
      &rtb_handleIndex_m);
    ...
    LawMDLOBJ3.step(&ElacComputer_U.in.time.dt, &rtb_BusAssignment_f_logic_ir_computation_data_n_z_g, &rtb_Y_d_tmp_tmp,
      ...
      const_cast<real_T*>(&ElacComputer_RGND)), &ElacComputer_U.in.analog_inputs.ths_pos_deg, &rtb_eta_trim_limit_lo_d,
                    ...
                    &rtb_BusConversion_InsertedFor_BusAssignment_at_inport_8_BusCreator1_V_tas_kn, &rtb_handleIndex_m, (
      const_cast<real_T*>(&ElacComputer_RGND)), (const_cast<real_T*>(&ElacComputer_RGND)), &u0_0, &rtb_Y_d, &rtb_NOT_ac,
    ...
    rtb_AND3_b = (rtb_NOT_ac && (rtb_AND3_b || (rtb_y_g != 0U)));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_1,
    ...
    rtb_AND1_h = ((rtb_AND1_h || (rtb_y_g != 0U)) && rtb_NOT_ac);
    ...
    rtb_VectorConcatenate[17] = (rtb_NOT_k || ((rtb_y_g == 0U) &&
      (ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1.SSM == static_cast<uint32_T>(SignStatusMatrix::
      NormalOperation))));
    ...
    rtb_VectorConcatenate_a[10] = rtb_aileronDroopActive;
    rtb_VectorConcatenate_a[11] = (rtb_OR1_i || rtb_AND3_j);
    ...
    ElacComputer_Y.out.laws.lateral_law_outputs.roll_spoiler_command_deg = rtb_Y_n;
    ...
    ElacComputer_Y.out.logic.aileron_droop_active = rtb_aileronDroopActive;
    ...
    ElacComputer_Y.out.logic.ap_1_control = rtb_AND2_j;
    ElacComputer_Y.out.logic.ap_2_control = rtb_DataTypeConversion_e;
    ...
    if (static_cast<real_T>(rtb_isEngagedInRoll) > ElacComputer_P.Switch12_Threshold) {
      ElacComputer_Y.out.bus_outputs.roll_spoiler_command_deg.Data = static_cast<real32_T>(rtb_Y_n);
    } else {
