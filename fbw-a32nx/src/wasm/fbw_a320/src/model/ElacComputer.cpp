...
void ElacComputer::step()
{
  ...
  real_T rtb_DataTypeConversion_lc;
  ...
  boolean_T rtb_DataTypeConversion_en;
  boolean_T rtb_NOT1;
  ...
  if (ElacComputer_U.in.sim_data.computer_running) {
    if (!ElacComputer_DWork.Runtime_MODE) {
      ...
      ElacComputer_DWork.previousInput_not_empty = false;
    ...
    ElacComputer_MATLABFunction_c(((ElacComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data > 50.0F) &&
      ...
      ElacComputer_P.ConfirmNode2_isRisingEdge, ElacComputer_P.ConfirmNode2_timeDelay, &rtb_y_f,
    ...
    ElacComputer_DWork.ra1CoherenceRejected = (rtb_y_f || ElacComputer_DWork.ra1CoherenceRejected);
    ...
    ElacComputer_MATLABFunction_m(ElacComputer_U.in.analog_inputs.yellow_hyd_pressure_psi,
      ElacComputer_P.HysteresisNode2_highTrigger, ElacComputer_P.HysteresisNode2_lowTrigger, &rtb_y_f,
      &ElacComputer_DWork.sf_MATLABFunction_jg);
    ElacComputer_MATLABFunction_c(((!ElacComputer_U.in.discrete_inputs.yellow_low_pressure) && rtb_y_f),
    ...
    ElacComputer_MATLABFunction_m(ElacComputer_U.in.analog_inputs.blue_hyd_pressure_psi,
      ElacComputer_P.HysteresisNode1_highTrigger, ElacComputer_P.HysteresisNode1_lowTrigger, &rtb_y_f,
      &ElacComputer_DWork.sf_MATLABFunction_mi);
    ElacComputer_MATLABFunction_c(((!ElacComputer_U.in.discrete_inputs.blue_low_pressure) && rtb_y_f),
    ...
    ElacComputer_MATLABFunction_m(ElacComputer_U.in.analog_inputs.green_hyd_pressure_psi,
      ElacComputer_P.HysteresisNode3_highTrigger, ElacComputer_P.HysteresisNode3_lowTrigger, &rtb_y_f,
      &ElacComputer_DWork.sf_MATLABFunction_br);
    ElacComputer_MATLABFunction_c(((!ElacComputer_U.in.discrete_inputs.green_low_pressure) && rtb_y_f),
      ElacComputer_U.in.time.dt, ElacComputer_P.ConfirmNode2_isRisingEdge_j, ElacComputer_P.ConfirmNode2_timeDelay_k,
      &rtb_y_f, &ElacComputer_DWork.sf_MATLABFunction_gfx);
    ...
    ElacComputer_MATLABFunction_c(ElacComputer_U.in.discrete_inputs.capt_priority_takeover_pressed,
      ...
      &rtb_NOT_k, &ElacComputer_DWork.sf_MATLABFunction_fq);
    ElacComputer_MATLABFunction_c(ElacComputer_U.in.discrete_inputs.fo_priority_takeover_pressed,
      ...
      &rtb_y_f, &ElacComputer_DWork.sf_MATLABFunction_oy);
    if (rtb_NOT_k) {
    ...
    if (ElacComputer_U.in.discrete_inputs.is_unit_1) {
      ...
      rtb_OR1 = ((!ElacComputer_U.in.discrete_inputs.r_elev_servo_failed) && rtb_NOT_kl);
    }

    rtb_isEngagedInRoll = !ElacComputer_U.in.discrete_inputs.ths_motor_fault;
    rtb_thsAvail = (rtb_isEngagedInRoll && (rtb_NOT_kl || rtb_OR7));
    if (ElacComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_NOT_ac = rtb_OR6;
    } else {
      rtb_NOT_ac = ((rtb_NOT_kl && rtb_OR7) || ((!rtb_OR6) && (rtb_OR7 || rtb_NOT_kl)));
    }

    canEngageInPitch = ((!ElacComputer_U.in.discrete_inputs.r_elev_servo_failed) &&
                        (!ElacComputer_U.in.discrete_inputs.l_elev_servo_failed) && rtb_isEngagedInRoll && rtb_NOT_ac);
    ...
    rtb_BusAssignment_n_logic_is_yellow_hydraulic_power_avail = rtb_NOT_kl;
    ...
    if ((ElacComputer_U.in.discrete_inputs.fac_1_yaw_control_lost &&
        ...
        ((ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1.SSM != static_cast<uint32_T>(SignStatusMatrix::
          ...
          static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) && ((!rtb_NOT1) && (rtb_y_aw != 0U))) ||
    ...
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sec_2_bus.discrete_status_word_2, &rtb_y_f);
    ...
    rtb_NOT1 = (((!rtb_AND3_b) && (!rtb_y_f)) || (rtb_NOT_k && (rtb_y_aw != 0U)));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_2,
    ...
    rtb_AND2_j = ((rtb_y_aw != 0U) && rtb_NOT_kl);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel1_bit_jr, &rtb_y_aw);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word, &rtb_y_f);
    rtb_AND3_j = ((rtb_y_aw != 0U) && rtb_y_f);
    ElacComputer_MATLABFunction_c(ElacComputer_U.in.sim_data.slew_on, ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode_isRisingEdge_o, ElacComputer_P.ConfirmNode_timeDelay_d, &rtb_y_f,
    ...
    rtb_NOT_kl = !ElacComputer_P.Constant_Value_ad;
    rtb_OR1_me = ((!rtb_y_f) && rtb_ap_authorised && (((!rtb_tripleAdrFault) && ((rtb_mach > 0.91) || (rtb_Y < -10.0) ||
      (rtb_Y > 40.0) || (rtb_V_ias > 440.0F) || (rtb_V_ias < 60.0F))) || ((!rtb_tripleIrFault) && ((!rtb_doubleIrFault) ||
      rtb_NOT_kl) && ((abnormalCondition_tmp > 125.0) || ((rtb_alpha > 50.0F) || (rtb_alpha < -30.0F))))));
    ElacComputer_DWork.abnormalConditionWasActive = (rtb_OR1_me || (rtb_ap_authorised &&
      ElacComputer_DWork.abnormalConditionWasActive));
    rtb_DataTypeConversion_cz = ((!rtb_OR3) || (!rtb_OR1));
    rtb_AND4 = !leftAileronAvail;
    rtb_OR_e1 = !rightAileronAvail;
    rtb_DataTypeConversion_en = (casValid_tmp_tmp || rtb_tripleAdrFault || ElacComputer_DWork.abnormalConditionWasActive
      || (rtb_AND4 && rtb_OR_e1 && rtb_DataTypeConversion_cz));
    rtb_y_f = !ElacComputer_P.Constant1_Value_b;
    rtb_DataTypeConversion_cz = ((rtb_doubleIrFault && rtb_NOT_kl) || (casValid_tmp_tmp && rtb_y_f) ||
      (rtb_doubleAdrFault && rtb_y_f && rtb_y_f) || rtb_DataTypeConversion_cz);
    if (rtb_tripleIrFault || ((rtb_DataTypeConversion_en || rtb_DataTypeConversion_cz || casValid ||
          (rtb_lateralLawCapability == lateral_efcs_law::DirectLaw)) && ((ElacComputer_B.in_flight != 0.0) &&
          ((rtb_OR_eo && (!rtb_NOT1)) || ((rtb_AND2_j || rtb_AND3_j) && rtb_NOT1))))) {
      rtb_pitchLawCapability = pitch_efcs_law::DirectLaw;
    } else if (rtb_DataTypeConversion_en) {
    ...
    if (!ElacComputer_DWork.previousInput_not_empty) {
      ElacComputer_DWork.previousInput = ElacComputer_P.PulseNode_isRisingEdge;
      ElacComputer_DWork.previousInput_not_empty = true;
    }

    if (ElacComputer_P.PulseNode_isRisingEdge) {
      rtb_NOT1 = ((ElacComputer_B.in_flight != 0.0) && (!ElacComputer_DWork.previousInput));
    } else {
      rtb_NOT1 = ((ElacComputer_B.in_flight == 0.0) && ElacComputer_DWork.previousInput);
    }

    ElacComputer_DWork.previousInput = (ElacComputer_B.in_flight != 0.0);
    rtb_OR_eo = ((ElacComputer_U.in.discrete_inputs.is_unit_1 && rtb_thsAvail && canEngageInPitch) ||
    ...
    ElacComputer_DWork.Memory_PreviousInput = ElacComputer_P.Logic_table[((((!rtb_OR_eo) || (rtb_Y_o <=
      ElacComputer_P.CompareToConstant_const_m) || ElacComputer_U.in.discrete_inputs.ths_override_active) + (
      static_cast<uint32_T>(rtb_NOT1) << 1)) << 1) + ElacComputer_DWork.Memory_PreviousInput];
    rtb_NOT_k = (rtb_OR_eo && ElacComputer_DWork.Memory_PreviousInput);
    rtb_AND3_b = !rtb_OR1_me;
    rtb_NOT1 = ((rtb_isEngagedInPitch && (ElacComputer_B.in_flight != 0.0) && ((priorityPitchPitchLawCap !=
    ...
    rtb_DataTypeConversion_en = (rtb_y_aw != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_e, &rtb_y_aw);
    rtb_DataTypeConversion_cz = (rtb_y_aw != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel5_bit_a, &rtb_y_aw);
    ElacComputer_MATLABFunction_o(rtb_OR_eo, rtb_AND2_j, rtb_AND3_j, rtb_DataTypeConversion_en,
      rtb_DataTypeConversion_cz, (rtb_y_aw != 0U), &rtb_handleIndex);
    ...
    rtb_AND2_j = ((priorityPitchPitchLawCap == pitch_efcs_law::NormalLaw) || (rtb_activeLateralLaw == lateral_efcs_law::
      NormalLaw));
    if (ElacComputer_U.in.discrete_inputs.ap_1_disengaged && ElacComputer_U.in.discrete_inputs.ap_2_disengaged &&
      ...
      ElacComputer_DWork.sProtActive = (rtb_AND2_j || ElacComputer_DWork.sProtActive);
    }

    rtb_AND1_h = (ElacComputer_U.in.discrete_inputs.ap_1_disengaged && ElacComputer_U.in.discrete_inputs.ap_2_disengaged);
    ElacComputer_DWork.sProtActive = ((rtb_V_ias >= rtb_DataTypeConversion3_m) && (rtb_AND1_h && rtb_AND2_j &&
    ...
    ElacComputer_DWork.sProtActive_f = ((rtb_ap_authorised && rtb_AND2_j && rtb_AND1_h && (rtb_Y > rtb_handleIndex) &&
    ...
    ElacComputer_DWork.sProtActive_f = ((ElacComputer_U.in.time.simulation_time - ElacComputer_DWork.resetEventTime <=
      ...
      && rtb_ap_authorised && rtb_AND2_j && ElacComputer_DWork.sProtActive_f);
    ...
    rtb_NOT_k = ((rtb_ap_authorised && (((rtb_ap_special_disc != 0) && (rtb_Y > rtb_Switch3_p)) || (rtb_Y >
      rtb_handleIndex + 0.25)) && rtb_AND2_j) || (ElacComputer_U.in.time.simulation_time - ElacComputer_DWork.eventTime >
    ...
    rtb_AND2_j = (casValid_tmp_tmp && rtb_NOT_kl && rtb_y_f);
    ...
    rtb_AND3_n_tmp = !ElacComputer_U.in.discrete_inputs.ap_2_disengaged;
    rtb_AND3_j = (rtb_AND3_n_tmp && rtb_AND3_b && rtb_y_f);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
    ...
    rtb_DataTypeConversion_en = (rtb_NOT_ac && ((leftAileronAvail && rightAileronAvail) ||
      ((!ElacComputer_U.in.discrete_inputs.opp_left_aileron_lost) && rightAileronAvail) || (leftAileronAvail &&
      (!ElacComputer_U.in.discrete_inputs.opp_right_aileron_lost))));
    rtb_DataTypeConversion_cz = (casValid_tmp && rtb_NOT_ac && (rtb_alpha < 2.5F) && rtb_AND1_h && (rtb_activeLateralLaw
    ...
    rtb_NOT_k = (rtb_AND2_j || rtb_AND3_j);
    ...
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_NOT_kl);
    rtb_NOT_ac = ((rtb_y_o != 0U) && rtb_NOT_kl);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel1_bit_p, &rtb_y_o);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word, &rtb_y_f);
    if (rtb_NOT_ac || ((rtb_y_o != 0U) && rtb_y_f)) {
    ...
    ElacComputer_MATLABFunction_o(rtb_NOT_ac, rtb_y_f, rtb_NOT_kl, rtb_AND1_h, rtb_AND3_b, (rtb_y_o != 0U),
      &rtb_handleIndex_c);
    ...
    rtb_DataTypeConversion_lc = (ElacComputer_B.in_flight != 0.0);
    ...
    LawMDLOBJ5.step(&ElacComputer_U.in.time.dt, &rtb_BusAssignment_f_logic_ir_computation_data_n_z_g, &rtb_Y_n_tmp_tmp,
      ...
      (&ElacComputer_RGND)), &rtb_DataTypeConversion3_m, &rtb_DataTypeConversion8,
                    ...
                    &u0_0, &rtb_ra1Invalid, &rtb_DataTypeConversion_lc, &rtb_NOT_ac, &ElacComputer_DWork.sProtActive_f,
    ...
    ElacComputer_MATLABFunction_o(rtb_NOT_ac, rtb_y_f, rtb_NOT_k, rtb_NOT_kl, rtb_AND1_h, (rtb_y_o != 0U),
      &rtb_handleIndex_e);
    ...
    rtb_y_f = (priorityPitchPitchLawCap != ElacComputer_P.EnumeratedConstant_Value_b);
    LawMDLOBJ3.step(&ElacComputer_U.in.time.dt, &rtb_BusAssignment_f_logic_ir_computation_data_n_z_g, &rtb_Y_n_tmp_tmp,
      ...
      const_cast<real_T*>(&ElacComputer_RGND)), (const_cast<real_T*>(&ElacComputer_RGND)), &u0_0, &rtb_Y_o, &rtb_NOT_ac,
                    &rtb_y_f, &rtb_eta_deg_o, &rtb_eta_trim_dot_deg_s_a, &rtb_eta_trim_limit_lo_h,
    ...
    ElacComputer_DWork.icLoad = ((!rtb_NOT1) || ElacComputer_DWork.icLoad);
    ...
    rtb_VectorConcatenate_a[10] = rtb_DataTypeConversion_en;
    rtb_VectorConcatenate_a[11] = (casValid_tmp_tmp || rtb_AND3_n_tmp);
    ...
    ElacComputer_Y.out.logic.ths_active_commanded = rtb_NOT1;
    ElacComputer_Y.out.logic.ths_ground_setting_active = rtb_OR_eo;
    ...
    ElacComputer_Y.out.logic.aileron_droop_active = rtb_DataTypeConversion_en;
    ElacComputer_Y.out.logic.aileron_antidroop_active = rtb_DataTypeConversion_cz;
    ...
    ElacComputer_Y.out.logic.ap_2_control = rtb_AND3_j;
    ...
    rtb_ra1Invalid = (rtb_NOT1 && rtb_thsAvail);
