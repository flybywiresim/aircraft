...
void ElacComputer::ElacComputer_MATLABFunction_l_Reset(rtDW_MATLABFunction_ElacComputer_g_T *localDW)
{
...
void ElacComputer::ElacComputer_MATLABFunction_c(boolean_T rtu_u, real_T rtu_Ts, boolean_T rtu_isRisingEdge, real_T
  rtu_timeDelay, boolean_T *rty_y, rtDW_MATLABFunction_ElacComputer_g_T *localDW)
{
...
void ElacComputer::ElacComputer_MATLABFunction_cf(boolean_T rtu_deviation1To2, boolean_T rtu_deviation1To3, boolean_T
...
void ElacComputer::ElacComputer_MATLABFunction_h(const base_arinc_429 *rtu_u, real32_T *rty_y)
{
  *rty_y = rtu_u->Data;
}
...
void ElacComputer::step()
{
  ...
  boolean_T rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail;
  boolean_T rtb_BusAssignment_fh_logic_is_green_hydraulic_power_avail;
  boolean_T rtb_BusAssignment_n_logic_cas_or_mach_disagree;
  boolean_T rtb_BusAssignment_nz_logic_alpha_disagree;
  boolean_T rtb_Equal;
  boolean_T rtb_NOT1;
  boolean_T rtb_NOT_h;
  boolean_T rtb_OR1_c;
  ...
  if (ElacComputer_U.in.sim_data.computer_running) {
    if (!ElacComputer_DWork.Runtime_MODE) {
      ...
      ElacComputer_DWork.Memory_PreviousInput_n = ElacComputer_P.SRFlipFlop2_initial_condition_m;
      ElacComputer_DWork.Memory_PreviousInput_f = ElacComputer_P.SRFlipFlop2_initial_condition_a;
      ElacComputer_DWork.Memory_PreviousInput_e = ElacComputer_P.SRFlipFlop1_initial_condition;
      ElacComputer_DWork.Memory_PreviousInput_m = ElacComputer_P.SRFlipFlop1_initial_condition_f;
      ElacComputer_DWork.Memory_PreviousInput_l = ElacComputer_P.SRFlipFlop1_initial_condition_g;
      ElacComputer_DWork.Memory_PreviousInput_fd = ElacComputer_P.SRFlipFlop_initial_condition;
      ElacComputer_DWork.Memory_PreviousInput_h = ElacComputer_P.SRFlipFlop_initial_condition_g;
      ElacComputer_DWork.Memory_PreviousInput_j = ElacComputer_P.SRFlipFlop_initial_condition_c;
      ...
      ElacComputer_DWork.Memory_PreviousInput_no = ElacComputer_P.SRFlipFlop_initial_condition_j;
      ...
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_jz);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_lf);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_jl);
      ...
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_cy);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_l);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_ik);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_ps);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_ox0);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_iz);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_ci);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_m0);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_iu);
      ...
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_cj);
      ElacComputer_MATLABFunction_k_Reset(&ElacComputer_DWork.sf_MATLABFunction_mi);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_g2);
      ElacComputer_MATLABFunction_k_Reset(&ElacComputer_DWork.sf_MATLABFunction_br);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_gfx);
      ...
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_j2);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_g24);
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_nb);
      ElacComputer_DWork.abnormalConditionWasActive = false;
      ElacComputer_MATLABFunction_h_Reset(&ElacComputer_DWork.sf_MATLABFunction_l0x);
      ...
      LawMDLOBJ3.reset();
      LawMDLOBJ4.reset();
      ElacComputer_MATLABFunction_l_Reset(&ElacComputer_DWork.sf_MATLABFunction_fb);
    ...
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel_bit, &rtb_y_kb);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_OR_ou);
    rtb_OR_ou = ((rtb_y_kb != 0U) && rtb_OR_ou);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel1_bit, &rtb_y_kb);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word, &rtb_OR1_c);
    ElacComputer_MATLABFunction_c((std::abs(ElacComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data -
      ...
      &rtb_OR_b, &ElacComputer_DWork.sf_MATLABFunction_jz);
    rtb_OR2_n = (rtP_elac_logic_output_MATLABStruct.triple_adr_failure ||
                 (rtP_elac_logic_output_MATLABStruct.double_adr_failure &&
                  rtP_elac_logic_output_MATLABStruct.cas_or_mach_disagree));
    ElacComputer_MATLABFunction_c(((ElacComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data > 50.0F) &&
      ...
      NormalOperation)) && (rtP_elac_logic_output_MATLABStruct.adr_computation_data.V_ias_kn > 200.0) && rtb_OR2_n),
      ElacComputer_U.in.time.dt, ElacComputer_P.ConfirmNode2_isRisingEdge, ElacComputer_P.ConfirmNode2_timeDelay,
      &rtb_y_e5, &ElacComputer_DWork.sf_MATLABFunction_lf);
    ElacComputer_MATLABFunction_c(((ElacComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data > 50.0F) &&
      ...
      &rtb_y_lu, &ElacComputer_DWork.sf_MATLABFunction_jl);
    ElacComputer_DWork.ra1CoherenceRejected = (rtb_y_e5 || ElacComputer_DWork.ra1CoherenceRejected);
    ElacComputer_DWork.ra2CoherenceRejected = (rtb_y_lu || ElacComputer_DWork.ra2CoherenceRejected);
    rtb_OR2_n = ((ElacComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.SSM == static_cast<uint32_T>(SignStatusMatrix::
      FailureWarning)) || ElacComputer_DWork.ra1CoherenceRejected);
    rtb_OR_ht = ((ElacComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.SSM == static_cast<uint32_T>(SignStatusMatrix::
    ...
    if ((!rtb_OR_ou) && ((rtb_y_kb == 0U) || (!rtb_OR1_c))) {
      ElacComputer_DWork.configFullEventTime = ElacComputer_U.in.time.simulation_time;
    }

    rtb_Equal = !rtb_OR_ht;
    rtb_NOT_h = !rtb_OR2_n;
    rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail = (rtb_NOT_h && rtb_Equal);
    if (rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail) {
      if (rtb_OR_b) {
    ...
    } else if ((rtb_OR2_n && rtb_Equal) || (rtb_NOT_h && rtb_OR_ht)) {
      if ((rtP_elac_logic_output_MATLABStruct.adr_computation_data.V_ias_kn > 180.0) &&
          (rtP_elac_logic_output_MATLABStruct.triple_adr_failure ||
           (rtP_elac_logic_output_MATLABStruct.double_adr_failure &&
            rtP_elac_logic_output_MATLABStruct.cas_or_mach_disagree))) {
        rtb_raComputationValue = 250.0F;
      } else if (rtb_OR_ht) {
    ...
    rtb_OR_ou = (rtb_OR2_n && rtb_OR_ht);
    if (rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail) {
      if (rtb_OR_b) {
        if (ElacComputer_U.in.time.simulation_time > ElacComputer_DWork.configFullEventTime + 10.0) {
          rtb_y_mk = std::fmin(ElacComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data,
                               ElacComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data);
        } else {
          rtb_y_mk = 250.0F;
        }
      } else {
        rtb_y_mk = (ElacComputer_U.in.bus_inputs.ra_1_bus.radio_height_ft.Data +
                    ElacComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data) / 2.0F;
      }
    } else if ((rtb_OR2_n && rtb_Equal) || (rtb_NOT_h && rtb_OR_ht)) {
      if ((rtP_elac_logic_output_MATLABStruct.adr_computation_data.V_ias_kn > 180.0) &&
        ...
        rtb_y_mk = ElacComputer_U.in.bus_inputs.ra_2_bus.radio_height_ft.Data;
      }
    } else {
      rtb_y_mk = 250.0F;
    }

    rtb_y_e5 = ((rtb_y_mk < ElacComputer_P.CompareToConstant_const) && (!rtb_OR_ou));
    rtb_OR2_n = ((ElacComputer_U.in.discrete_inputs.lgciu_1_left_main_gear_pressed &&
                 ...
                 (((ElacComputer_U.in.discrete_inputs.lgciu_1_left_main_gear_pressed &&
                    ElacComputer_U.in.discrete_inputs.lgciu_1_right_main_gear_pressed) ||
                   (ElacComputer_U.in.discrete_inputs.lgciu_2_left_main_gear_pressed &&
                    ElacComputer_U.in.discrete_inputs.lgciu_2_right_main_gear_pressed)) && rtb_y_e5) || (rtb_y_e5 &&
      (ElacComputer_U.in.discrete_inputs.ground_spoilers_active_1 &&
       ElacComputer_U.in.discrete_inputs.ground_spoilers_active_2)));
    rtb_OR_fh = ((ElacComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.SSM != static_cast<uint32_T>(SignStatusMatrix::
      ...
      static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) ||
                 (ElacComputer_U.in.bus_inputs.ir_1_bus.pitch_att_rate_deg_s.SSM != static_cast<uint32_T>
                  (SignStatusMatrix::NormalOperation)) || (ElacComputer_U.in.bus_inputs.ir_1_bus.roll_att_rate_deg_s.SSM
      != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) || ElacComputer_P.Constant_Value_ay);
    rtb_OR_cg = ((ElacComputer_U.in.bus_inputs.ir_2_bus.pitch_angle_deg.SSM != static_cast<uint32_T>(SignStatusMatrix::
      ...
      static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) ||
                 (ElacComputer_U.in.bus_inputs.ir_2_bus.pitch_att_rate_deg_s.SSM != static_cast<uint32_T>
                  (SignStatusMatrix::NormalOperation)) || (ElacComputer_U.in.bus_inputs.ir_2_bus.roll_att_rate_deg_s.SSM
      != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) || ElacComputer_P.Constant_Value_ay);
    rtb_OR_b = ((ElacComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.SSM != static_cast<uint32_T>(SignStatusMatrix::
      ...
      static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) ||
                (ElacComputer_U.in.bus_inputs.ir_3_bus.pitch_att_rate_deg_s.SSM != static_cast<uint32_T>
                 (SignStatusMatrix::NormalOperation)) || (ElacComputer_U.in.bus_inputs.ir_3_bus.roll_att_rate_deg_s.SSM
      != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) || ElacComputer_P.Constant_Value_ay);
    rtb_OR1_c = (rtb_OR_fh && rtb_OR_cg);
    rtb_y_l = (rtb_OR_fh && rtb_OR_b);
    rtb_OR_ht = (rtb_OR1_c || rtb_y_l || (rtb_OR_cg && rtb_OR_b));
    rtb_OR1_c = (rtb_OR1_c && rtb_OR_b);
    rtb_Equal = !rtb_OR_cg;
    rtb_NOT_h = !rtb_OR_b;
    rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail = (rtb_OR_fh && rtb_NOT_h);
    if (rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail && rtb_Equal) {
    ...
    } else if ((!rtb_OR_fh) && rtb_OR_b && rtb_Equal) {
    ...
    } else if (((!rtb_OR_fh) && rtb_NOT_h && rtb_Equal) || ((!rtb_OR_fh) && (!rtb_OR_b) && rtb_OR_cg)) {
      rtb_theta = (ElacComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.Data +
                   ElacComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.Data) / 2.0F;
      rtb_phi = (ElacComputer_U.in.bus_inputs.ir_1_bus.roll_angle_deg.Data +
                 ElacComputer_U.in.bus_inputs.ir_3_bus.roll_angle_deg.Data) / 2.0F;
      ...
      rtb_phi_dot = (ElacComputer_U.in.bus_inputs.ir_1_bus.roll_att_rate_deg_s.Data +
                     ElacComputer_U.in.bus_inputs.ir_3_bus.roll_att_rate_deg_s.Data) / 2.0F;
    } else if ((!rtb_OR_fh) && rtb_OR_b && rtb_OR_cg) {
      rtb_theta = ElacComputer_U.in.bus_inputs.ir_1_bus.pitch_angle_deg.Data;
      rtb_phi = ElacComputer_U.in.bus_inputs.ir_1_bus.roll_angle_deg.Data;
      rtb_q = ElacComputer_U.in.bus_inputs.ir_1_bus.body_pitch_rate_deg_s.Data;
      rtb_r = ElacComputer_U.in.bus_inputs.ir_1_bus.body_yaw_rate_deg_s.Data;
      ...
      rtb_theta_dot = ElacComputer_U.in.bus_inputs.ir_1_bus.pitch_att_rate_deg_s.Data;
      rtb_phi_dot = ElacComputer_U.in.bus_inputs.ir_1_bus.roll_att_rate_deg_s.Data;
    } else if (rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail && rtb_OR_cg) {
    ...
    ElacComputer_MATLABFunction_h(&ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn, &rtb_y_mk);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn, &rtb_OR_fh);
    if (rtb_OR_fh) {
      ElacComputer_B.u_ce = rtb_y_mk;
    }

    ElacComputer_MATLABFunction_h(&ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn, &rtb_y_mk);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn, &rtb_OR_fh);
    if (rtb_OR_fh) {
      ElacComputer_B.u_cef = rtb_y_mk;
    }

    rtb_y_mk = std::abs(ElacComputer_B.u_ce - ElacComputer_B.u_cef);
    rtb_Equal = (rtb_y_mk > ElacComputer_P.SourceMonitoringPairwise_threshold);
    ElacComputer_MATLABFunction_h(&ElacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn, &rtb_y_mk);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn, &rtb_OR_fh);
    if (rtb_OR_fh) {
      ElacComputer_B.u_c = rtb_y_mk;
    }

    rtb_y_mk = std::abs(ElacComputer_B.u_cef - ElacComputer_B.u_c);
    ElacComputer_MATLABFunction_cf(rtb_Equal, (std::abs(ElacComputer_B.u_ce - ElacComputer_B.u_c) >
      ElacComputer_P.SourceMonitoringPairwise_threshold), (rtb_y_mk > ElacComputer_P.SourceMonitoringPairwise_threshold),
      &rtb_OR_b, &rtb_OR_cg, &rtb_OR_fh);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn, &rtb_Equal);
    ElacComputer_MATLABFunction_c((rtb_OR_b && rtb_Equal), ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode_isRisingEdge_n, ElacComputer_P.SourceMonitoringPairwise_timeDelay, &rtb_y_l,
      &ElacComputer_DWork.sf_MATLABFunction_cy);
    ElacComputer_DWork.Memory_PreviousInput = ElacComputer_P.Logic_table[(((static_cast<uint32_T>(rtb_y_l) << 1) +
      rtb_OR2_n) << 1) + ElacComputer_DWork.Memory_PreviousInput];
    ElacComputer_MATLABFunction_h(&ElacComputer_U.in.bus_inputs.adr_1_bus.mach, &rtb_y_mk);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_1_bus.mach, &rtb_OR_b);
    if (rtb_OR_b) {
      ElacComputer_B.u_oq = rtb_y_mk;
    }

    ElacComputer_MATLABFunction_h(&ElacComputer_U.in.bus_inputs.adr_2_bus.mach, &rtb_y_mk);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_2_bus.mach, &rtb_OR_b);
    if (rtb_OR_b) {
      ElacComputer_B.u_oql = rtb_y_mk;
    }

    rtb_y_mk = std::abs(ElacComputer_B.u_oq - ElacComputer_B.u_oql);
    rtb_OR_b = (rtb_y_mk > ElacComputer_P.SourceMonitoringPairwise1_threshold);
    ElacComputer_MATLABFunction_h(&ElacComputer_U.in.bus_inputs.adr_3_bus.mach, &rtb_y_mk);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_3_bus.mach, &rtb_Equal);
    if (rtb_Equal) {
      ElacComputer_B.u_o = rtb_y_mk;
    }

    rtb_y_mk = std::abs(ElacComputer_B.u_oql - ElacComputer_B.u_o);
    ElacComputer_MATLABFunction_cf(rtb_OR_b, (std::abs(ElacComputer_B.u_oq - ElacComputer_B.u_o) >
      ElacComputer_P.SourceMonitoringPairwise1_threshold), (rtb_y_mk >
      ElacComputer_P.SourceMonitoringPairwise1_threshold), &rtb_y_ew, &rtb_y_l, &rtb_Equal);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_1_bus.mach, &rtb_y_gh);
    ElacComputer_MATLABFunction_c((rtb_y_ew && rtb_y_gh), ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode_isRisingEdge_o, ElacComputer_P.SourceMonitoringPairwise1_timeDelay, &rtb_OR_b,
      &ElacComputer_DWork.sf_MATLABFunction_l);
    ElacComputer_DWork.Memory_PreviousInput_n = ElacComputer_P.Logic_table_e[(((static_cast<uint32_T>(rtb_OR_b) << 1) +
      rtb_OR2_n) << 1) + ElacComputer_DWork.Memory_PreviousInput_n];
    ElacComputer_MATLABFunction_h(&ElacComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg, &rtb_y_mk);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg, &rtb_OR_b);
    if (rtb_OR_b) {
      ElacComputer_B.u_l = rtb_y_mk;
    }

    ElacComputer_MATLABFunction_h(&ElacComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg, &rtb_y_mk);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg, &rtb_OR_b);
    if (rtb_OR_b) {
      ElacComputer_B.u_lq = rtb_y_mk;
    }

    rtb_y_mk = std::abs(ElacComputer_B.u_l - ElacComputer_B.u_lq);
    rtb_y_ew = (rtb_y_mk > ElacComputer_P.SourceMonitoringPairwise2_threshold);
    ElacComputer_MATLABFunction_h(&ElacComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg, &rtb_y_mk);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg, &rtb_OR_b);
    if (rtb_OR_b) {
      ElacComputer_B.u = rtb_y_mk;
    }

    ElacComputer_MATLABFunction_cf(rtb_y_ew, (std::abs(ElacComputer_B.u_l - ElacComputer_B.u) >
      ElacComputer_P.SourceMonitoringPairwise2_threshold), (std::abs(ElacComputer_B.u_lq - ElacComputer_B.u) >
      ElacComputer_P.SourceMonitoringPairwise2_threshold), &rtb_y_e5, &rtb_y_lu, &rtb_OR_b);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg, &rtb_y_gh);
    ElacComputer_MATLABFunction_c((rtb_y_e5 && rtb_y_gh), ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode_isRisingEdge_c, ElacComputer_P.SourceMonitoringPairwise2_timeDelay, &rtb_y_ew,
      &ElacComputer_DWork.sf_MATLABFunction_ik);
    ElacComputer_DWork.Memory_PreviousInput_f = ElacComputer_P.Logic_table_k[(((static_cast<uint32_T>(rtb_y_ew) << 1) +
      rtb_OR2_n) << 1) + ElacComputer_DWork.Memory_PreviousInput_f];
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn, &rtb_y_ew);
    ElacComputer_MATLABFunction_c((rtb_OR_cg && rtb_y_ew), ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode1_isRisingEdge_p, ElacComputer_P.SourceMonitoringPairwise_timeDelay, &rtb_y_gh,
      &ElacComputer_DWork.sf_MATLABFunction_ps);
    ElacComputer_DWork.Memory_PreviousInput_e = ElacComputer_P.Logic_table_a[(((static_cast<uint32_T>(rtb_y_gh) << 1) +
      rtb_OR2_n) << 1) + ElacComputer_DWork.Memory_PreviousInput_e];
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_2_bus.mach, &rtb_y_ew);
    ElacComputer_MATLABFunction_c((rtb_y_l && rtb_y_ew), ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode1_isRisingEdge_f, ElacComputer_P.SourceMonitoringPairwise1_timeDelay, &rtb_OR_cg,
      &ElacComputer_DWork.sf_MATLABFunction_ox0);
    ElacComputer_DWork.Memory_PreviousInput_m = ElacComputer_P.Logic_table_eo[(((static_cast<uint32_T>(rtb_OR_cg) << 1)
      + rtb_OR2_n) << 1) + ElacComputer_DWork.Memory_PreviousInput_m];
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg, &rtb_OR_cg);
    ElacComputer_MATLABFunction_c((rtb_y_lu && rtb_OR_cg), ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode1_isRisingEdge_n, ElacComputer_P.SourceMonitoringPairwise2_timeDelay, &rtb_y_l,
      &ElacComputer_DWork.sf_MATLABFunction_iz);
    ElacComputer_DWork.Memory_PreviousInput_l = ElacComputer_P.Logic_table_f[(((static_cast<uint32_T>(rtb_y_l) << 1) +
      rtb_OR2_n) << 1) + ElacComputer_DWork.Memory_PreviousInput_l];
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn, &rtb_OR_cg);
    ElacComputer_MATLABFunction_c((rtb_OR_fh && rtb_OR_cg), ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode2_isRisingEdge_n, ElacComputer_P.SourceMonitoringPairwise_timeDelay, &rtb_y_l,
      &ElacComputer_DWork.sf_MATLABFunction_ci);
    ElacComputer_DWork.Memory_PreviousInput_fd = ElacComputer_P.Logic_table_c[(((static_cast<uint32_T>(rtb_y_l) << 1) +
      rtb_OR2_n) << 1) + ElacComputer_DWork.Memory_PreviousInput_fd];
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_3_bus.mach, &rtb_OR_cg);
    ElacComputer_MATLABFunction_c((rtb_Equal && rtb_OR_cg), ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode2_isRisingEdge_a, ElacComputer_P.SourceMonitoringPairwise1_timeDelay, &rtb_OR_fh,
      &ElacComputer_DWork.sf_MATLABFunction_m0);
    ElacComputer_DWork.Memory_PreviousInput_h = ElacComputer_P.Logic_table_b[(((static_cast<uint32_T>(rtb_OR_fh) << 1) +
      rtb_OR2_n) << 1) + ElacComputer_DWork.Memory_PreviousInput_h];
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg, &rtb_OR_fh);
    ElacComputer_MATLABFunction_c((rtb_OR_b && rtb_OR_fh), ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode2_isRisingEdge_h, ElacComputer_P.SourceMonitoringPairwise2_timeDelay, &rtb_Equal,
      &ElacComputer_DWork.sf_MATLABFunction_iu);
    ElacComputer_DWork.Memory_PreviousInput_j = ElacComputer_P.Logic_table_p[(((static_cast<uint32_T>(rtb_Equal) << 1) +
      rtb_OR2_n) << 1) + ElacComputer_DWork.Memory_PreviousInput_j];
    rtb_y_e5 = (ElacComputer_DWork.Memory_PreviousInput || ElacComputer_DWork.Memory_PreviousInput_n);
    rtb_y_l = ((ElacComputer_U.in.bus_inputs.adr_1_bus.mach.SSM == static_cast<uint32_T>(SignStatusMatrix::
      ...
      FailureWarning)) || rtb_y_e5 || ElacComputer_DWork.Memory_PreviousInput_f);
    rtb_AND1_h = (ElacComputer_DWork.Memory_PreviousInput_e || ElacComputer_DWork.Memory_PreviousInput_m);
    rtb_y_ew = ((ElacComputer_U.in.bus_inputs.adr_2_bus.mach.SSM == static_cast<uint32_T>(SignStatusMatrix::
      ...
      FailureWarning)) || rtb_AND1_h || ElacComputer_DWork.Memory_PreviousInput_l);
    rtb_y_lu = (ElacComputer_DWork.Memory_PreviousInput_fd || ElacComputer_DWork.Memory_PreviousInput_h);
    rtb_y_gh = ((ElacComputer_U.in.bus_inputs.adr_3_bus.mach.SSM == static_cast<uint32_T>(SignStatusMatrix::
      ...
      FailureWarning)) || rtb_y_lu || ElacComputer_DWork.Memory_PreviousInput_j);
    rtb_OR_fh = (rtb_y_l && rtb_y_ew);
    rtb_doubleAdrFault = (rtb_OR_fh || (rtb_y_l && rtb_y_gh) || (rtb_y_ew && rtb_y_gh));
    rtb_tripleAdrFault = (rtb_OR_fh && rtb_y_gh);
    rtb_BusAssignment_n_logic_cas_or_mach_disagree = (rtb_y_e5 || rtb_AND1_h || rtb_y_lu);
    rtb_Equal = !rtb_y_gh;
    rtb_NOT_h = !rtb_y_ew;
    rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail = (rtb_y_l && rtb_NOT_h);
    if (rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail && rtb_Equal) {
      rtb_y_mk = (ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.Data +
    ...
    } else if ((!rtb_y_l) && rtb_y_ew && rtb_Equal) {
      rtb_y_mk = (ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data +
                  ElacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.Data) / 2.0F;
      ...
      rtb_alpha = (ElacComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data +
                   ElacComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.Data) / 2.0F;
    } else if (((!rtb_y_l) && rtb_NOT_h && rtb_Equal) || ((!rtb_y_l) && (!rtb_y_ew) && rtb_y_gh)) {
      rtb_y_mk = (ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data +
    ...
    } else if ((!rtb_y_l) && rtb_y_ew && rtb_y_gh) {
      rtb_y_mk = ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_computed_kn.Data;
      rtb_V_tas = ElacComputer_U.in.bus_inputs.adr_1_bus.airspeed_true_kn.Data;
      rtb_mach = ElacComputer_U.in.bus_inputs.adr_1_bus.mach.Data;
      rtb_alpha = ElacComputer_U.in.bus_inputs.adr_1_bus.aoa_corrected_deg.Data;
    } else if (rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail && rtb_y_gh) {
      rtb_y_mk = ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_computed_kn.Data;
      rtb_V_tas = ElacComputer_U.in.bus_inputs.adr_2_bus.airspeed_true_kn.Data;
      rtb_mach = ElacComputer_U.in.bus_inputs.adr_2_bus.mach.Data;
      rtb_alpha = ElacComputer_U.in.bus_inputs.adr_2_bus.aoa_corrected_deg.Data;
    } else if (rtb_OR_fh && rtb_Equal) {
      rtb_y_mk = ElacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.Data;
      ...
      switch (ElacComputer_DWork.is_c30_ElacComputer) {
       ...
       case ElacComputer_IN_FlightToGroundTransition:
        if (ElacComputer_U.in.time.simulation_time - ElacComputer_DWork.on_ground_time >= 5.0) {
          ElacComputer_DWork.is_c30_ElacComputer = ElacComputer_IN_Ground;
          ElacComputer_B.in_flight = 0.0;
        } else if ((!rtb_OR2_n) || (rtb_theta >= 2.5F)) {
          ElacComputer_DWork.on_ground_time = 0.0;
       ...
       default:
        if (((!rtb_OR2_n) && (rtb_theta > 8.0F)) || (rtb_raComputationValue > 400.0F)) {
          ElacComputer_DWork.on_ground_time = 0.0;
          ElacComputer_DWork.is_c30_ElacComputer = ElacComputer_IN_Flight;
          ElacComputer_B.in_flight = 1.0;
        } else {
    ...
    ElacComputer_MATLABFunction_m(ElacComputer_U.in.analog_inputs.yellow_hyd_pressure_psi,
      ElacComputer_P.HysteresisNode2_highTrigger, ElacComputer_P.HysteresisNode2_lowTrigger, &rtb_y_e5,
      &ElacComputer_DWork.sf_MATLABFunction_jg);
    ElacComputer_MATLABFunction_c(((!ElacComputer_U.in.discrete_inputs.yellow_low_pressure) && rtb_y_e5),
      ElacComputer_U.in.time.dt, ElacComputer_P.ConfirmNode_isRisingEdge_k, ElacComputer_P.ConfirmNode_timeDelay_n,
      &rtb_OR_b, &ElacComputer_DWork.sf_MATLABFunction_cj);
    ElacComputer_MATLABFunction_m(ElacComputer_U.in.analog_inputs.blue_hyd_pressure_psi,
      ElacComputer_P.HysteresisNode1_highTrigger, ElacComputer_P.HysteresisNode1_lowTrigger, &rtb_y_e5,
      &ElacComputer_DWork.sf_MATLABFunction_mi);
    ElacComputer_MATLABFunction_c(((!ElacComputer_U.in.discrete_inputs.blue_low_pressure) && rtb_y_e5),
      ElacComputer_U.in.time.dt, ElacComputer_P.ConfirmNode1_isRisingEdge_i, ElacComputer_P.ConfirmNode1_timeDelay_h,
      &rtb_y_lu, &ElacComputer_DWork.sf_MATLABFunction_g2);
    ElacComputer_MATLABFunction_m(ElacComputer_U.in.analog_inputs.green_hyd_pressure_psi,
      ElacComputer_P.HysteresisNode3_highTrigger, ElacComputer_P.HysteresisNode3_lowTrigger, &rtb_y_e5,
      &ElacComputer_DWork.sf_MATLABFunction_br);
    ElacComputer_MATLABFunction_c(((!ElacComputer_U.in.discrete_inputs.green_low_pressure) && rtb_y_e5),
      ElacComputer_U.in.time.dt, ElacComputer_P.ConfirmNode2_isRisingEdge_j, ElacComputer_P.ConfirmNode2_timeDelay_k,
      &rtb_y_e5, &ElacComputer_DWork.sf_MATLABFunction_gfx);
    rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail = rtb_y_lu;
    rtb_BusAssignment_fh_logic_is_green_hydraulic_power_avail = rtb_y_e5;
    ElacComputer_MATLABFunction_g4(ElacComputer_U.in.discrete_inputs.capt_priority_takeover_pressed,
      ElacComputer_P.PulseNode_isRisingEdge, &rtb_y_lu, &ElacComputer_DWork.sf_MATLABFunction_g4);
    ElacComputer_MATLABFunction_g4(ElacComputer_U.in.discrete_inputs.fo_priority_takeover_pressed,
      ElacComputer_P.PulseNode1_isRisingEdge, &rtb_y_e5, &ElacComputer_DWork.sf_MATLABFunction_nu);
    if (rtb_y_lu) {
    ...
    if (ElacComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_leftElevatorAvail = ((!ElacComputer_U.in.discrete_inputs.l_elev_servo_failed) &&
        rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail);
      rtb_rightElevatorAvail = ((!ElacComputer_U.in.discrete_inputs.r_elev_servo_failed) &&
        rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail);
    } else {
      rtb_leftElevatorAvail = ((!ElacComputer_U.in.discrete_inputs.l_elev_servo_failed) &&
        rtb_BusAssignment_fh_logic_is_green_hydraulic_power_avail);
      rtb_rightElevatorAvail = ((!ElacComputer_U.in.discrete_inputs.r_elev_servo_failed) && rtb_OR_b);
    }

    rtb_thsAvail = ((!ElacComputer_U.in.discrete_inputs.ths_motor_fault) && (rtb_OR_b ||
      rtb_BusAssignment_fh_logic_is_green_hydraulic_power_avail));
    if (ElacComputer_U.in.discrete_inputs.is_unit_1) {
      rtb_Equal = rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail;
    } else {
      rtb_Equal = ((rtb_OR_b && rtb_BusAssignment_fh_logic_is_green_hydraulic_power_avail) ||
                   ((!rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail) &&
                    (rtb_BusAssignment_fh_logic_is_green_hydraulic_power_avail || rtb_OR_b)));
    }
    ...
    canEngageInPitch = ((!ElacComputer_U.in.discrete_inputs.r_elev_servo_failed) &&
                        ...
                        (!ElacComputer_U.in.discrete_inputs.ths_motor_fault) && rtb_Equal);
    ...
    rtb_Equal = !hasPriorityInRoll;
    if ((!ElacComputer_U.in.discrete_inputs.is_unit_1) && rtb_Equal &&
    ...
    rtb_BusAssignment_p.logic.is_yellow_hydraulic_power_avail = rtb_OR_b;
    rtb_BusAssignment_nz_logic_alpha_disagree = (ElacComputer_DWork.Memory_PreviousInput_f ||
      ElacComputer_DWork.Memory_PreviousInput_l || ElacComputer_DWork.Memory_PreviousInput_j);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1,
      ElacComputer_P.BitfromLabel_bit_c, &rtb_y_kb);
    rtb_y_e5 = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1,
      ElacComputer_P.BitfromLabel1_bit_j, &rtb_y_kb);
    rtb_AND1_h = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_2_bus.discrete_status_word_1,
      ElacComputer_P.BitfromLabel2_bit, &rtb_y_kb);
    rtb_y_lu = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_3,
      ElacComputer_P.BitfromLabel3_bit, &rtb_y_kb);
    rtb_NOT_h = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_3,
      ElacComputer_P.BitfromLabel5_bit, &rtb_y_kb);
    rtb_OR_f = (rtb_NOT_h || (rtb_y_kb != 0U));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_3,
      ElacComputer_P.BitfromLabel4_bit, &rtb_y_kb);
    rtb_OR_b = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_3,
      ElacComputer_P.BitfromLabel6_bit, &rtb_y_kb);
    rtb_OR_b = (rtb_OR_b || (rtb_y_kb != 0U));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.fcdc_1_bus.efcs_status_word_1,
      ElacComputer_P.BitfromLabel7_bit, &rtb_y_kb);
    rtb_NOT1 = (rtb_y_kb == 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.fcdc_2_bus.efcs_status_word_1,
      ElacComputer_P.BitfromLabel8_bit, &rtb_y_kb);
    rtb_NOT_h = ((!leftAileronAvail) && (!rightAileronAvail));
    if ((ElacComputer_U.in.discrete_inputs.fac_1_yaw_control_lost &&
        ...
        ((ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_1.SSM != static_cast<uint32_T>(SignStatusMatrix::
          ...
          static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) && ((!rtb_NOT1) && (rtb_y_kb != 0U))) || ((!rtb_y_e5)
         && (!rtb_AND1_h) && (!rtb_y_lu) && (!rtb_OR_f) && (!rtb_OR_b)) || rtb_doubleAdrFault || rtb_OR_ht || rtb_NOT_h)
    {
    ...
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_2, &rtb_y_lu);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sec_2_bus.discrete_status_word_2, &rtb_AND1_h);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel4_bit_d, &rtb_y_kb);
    rtb_OR_b = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_2_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel5_bit_e, &rtb_y_kb);
    rtb_OR_f = (((!rtb_y_lu) && (!rtb_AND1_h)) || (rtb_OR_b && (rtb_y_kb != 0U)));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_1_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel6_bit_k, &rtb_y_kb);
    rtb_OR_b = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sec_2_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel7_bit_h, &rtb_y_kb);
    rtb_OR_b = (rtb_OR_b || (rtb_y_kb != 0U));
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel_bit_a, &rtb_y_kb);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_y_lu);
    rtb_NOT1 = ((rtb_y_kb != 0U) && rtb_y_lu);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel1_bit_jr, &rtb_y_kb);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word, &rtb_y_oi);
    ElacComputer_MATLABFunction_c(ElacComputer_U.in.sim_data.slew_on, ElacComputer_U.in.time.dt,
      ElacComputer_P.ConfirmNode_isRisingEdge_o3, ElacComputer_P.ConfirmNode_timeDelay_d, &rtb_y_e5,
      &ElacComputer_DWork.sf_MATLABFunction_nb);
    rtb_Y_m = std::abs(static_cast<real_T>(rtb_phi));
    rtb_y_lu = !rtb_OR2_n;
    rtb_AND1_h = ((!rtb_y_e5) && rtb_y_lu && (((!rtb_tripleAdrFault) && ((rtb_mach > 0.91) || (rtb_DataTypeConversion7 <
      -10.0) || (rtb_DataTypeConversion7 > 40.0) || (rtb_y_mk > 440.0F) || (rtb_y_mk < 60.0F))) || ((!rtb_OR1_c) &&
      ((!rtb_OR_ht) || (!ElacComputer_P.Constant_Value_ay)) && ((rtb_Y_m > 125.0) || ((rtb_theta > 50.0F) || (rtb_theta <
      -30.0F))))));
    ElacComputer_DWork.abnormalConditionWasActive = (rtb_AND1_h || (rtb_y_lu &&
      ElacComputer_DWork.abnormalConditionWasActive));
    rtb_y_e5 = ((!rtb_leftElevatorAvail) || (!rtb_rightElevatorAvail));
    rtb_NOT_h = ((rtb_doubleAdrFault && rtb_BusAssignment_n_logic_cas_or_mach_disagree) || rtb_tripleAdrFault ||
                 ElacComputer_DWork.abnormalConditionWasActive || (rtb_NOT_h && rtb_y_e5));
    alternate1Condition_tmp = !rtb_BusAssignment_n_logic_cas_or_mach_disagree;
    rtb_y_e5 = ((rtb_OR_ht && (!ElacComputer_P.Constant_Value_ay)) || (rtb_doubleAdrFault &&
      rtb_BusAssignment_nz_logic_alpha_disagree && alternate1Condition_tmp) || (rtb_doubleAdrFault &&
      (!rtb_BusAssignment_nz_logic_alpha_disagree) && alternate1Condition_tmp) || rtb_y_e5);
    if (rtb_OR1_c || (rtb_OR_ht && ElacComputer_P.Constant_Value_ay) || ((rtb_NOT_h || rtb_y_e5 || rtb_OR_ou ||
          (rtb_lateralLawCapability == lateral_efcs_law::DirectLaw)) && ((ElacComputer_B.in_flight != 0.0) && ((rtb_OR_b
            && (!rtb_OR_f)) || ((rtb_NOT1 || ((rtb_y_kb != 0U) && rtb_y_oi)) && rtb_OR_f))))) {
    ...
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel_bit_h, &rtb_y_b3);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel1_bit_e, &rtb_Switch18);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel2_bit_k, &rtb_DataTypeConversion1_j);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.elac_opp_bus.discrete_status_word_2,
      ElacComputer_P.BitfromLabel3_bit_m, &rtb_y_kb);
    if ((rtb_DataTypeConversion1_j != 0U) && (rtb_y_kb == 0U)) {
      rtb_oppElacRollCapability = lateral_efcs_law::NormalLaw;
    } else if ((rtb_DataTypeConversion1_j == 0U) && (rtb_y_kb != 0U)) {
    ...
    if (hasPriorityInPitch && rtb_isEngagedInPitch) {
      ...
      if ((rtb_y_b3 != 0U) && (rtb_Switch18 == 0U)) {
        priorityPitchPitchLawCap = pitch_efcs_law::NormalLaw;
      } else if ((rtb_y_b3 == 0U) && (rtb_Switch18 != 0U)) {
    ...
    } else if ((!rtb_Equal) && rtb_isEngagedInRoll) {
      rtb_oppElacRollCapability = lateral_efcs_law::None;
    }
    ...
    ElacComputer_MATLABFunction_g4((ElacComputer_B.in_flight != 0.0), ElacComputer_P.PulseNode_isRisingEdge_g, &rtb_y_e5,
      &ElacComputer_DWork.sf_MATLABFunction_l0x);
    rtb_OR_b = ((ElacComputer_U.in.discrete_inputs.is_unit_1 && rtb_thsAvail && canEngageInPitch) ||
    ...
    ElacComputer_DWork.Memory_PreviousInput_no = ElacComputer_P.Logic_table_h[((((!rtb_OR_b) || (rtb_Y_i <=
      ElacComputer_P.CompareToConstant_const_m) || ElacComputer_U.in.discrete_inputs.ths_override_active) + (
      static_cast<uint32_T>(rtb_y_e5) << 1)) << 1) + ElacComputer_DWork.Memory_PreviousInput_no];
    rtb_OR_b = (rtb_OR_b && ElacComputer_DWork.Memory_PreviousInput_no);
    rtb_BusAssignment_p.logic.ths_active_commanded = ((rtb_isEngagedInPitch && (ElacComputer_B.in_flight != 0.0) &&
      ((priorityPitchPitchLawCap != ElacComputer_P.EnumeratedConstant_Value_i) && (!rtb_AND1_h))) || rtb_OR_b);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel_bit_h2, &rtb_y_kb);
    rtb_NOT_h = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel1_bit_g, &rtb_y_kb);
    rtb_y_e5 = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel2_bit_n, &rtb_y_kb);
    rtb_OR_f = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel3_bit_g, &rtb_y_kb);
    rtb_NOT1 = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_e, &rtb_y_kb);
    rtb_y_oi = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel5_bit_a, &rtb_y_kb);
    ElacComputer_MATLABFunction_o(rtb_NOT_h, rtb_y_e5, rtb_OR_f, rtb_NOT1, rtb_y_oi, (rtb_y_kb != 0U),
      &rtb_handleIndex_l);
    ...
    if (rtb_OR2_n || (ElacComputer_DWork.eventTime_f == 0.0)) {
      ElacComputer_DWork.eventTime_f = ElacComputer_U.in.time.simulation_time;
    }
    ...
    ElacComputer_GetIASforMach4(static_cast<real_T>(rtb_mach), ElacComputer_P.Constant6_Value_b, static_cast<real_T>
      (rtb_y_mk), &rtb_DataTypeConversion3_m);
    ...
    ElacComputer_GetIASforMach4(static_cast<real_T>(rtb_mach), ElacComputer_P.Constant8_Value_h, static_cast<real_T>
      (rtb_y_mk), &rtb_handleIndex_l);
    rtb_BusAssignment_p.logic.high_speed_prot_hi_thresh_kn = std::fmin(ElacComputer_P.Constant7_Value_g,
      rtb_handleIndex_l);
    rtb_BusAssignment_p.logic.ths_ground_setting_active = rtb_OR_b;
    rtb_Y_i = rtb_theta - std::cos(ElacComputer_P.Gain1_Gain * rtb_phi) * rtb_DataTypeConversion7;
    rtb_OR_b = ((priorityPitchPitchLawCap == pitch_efcs_law::NormalLaw) || (rtb_activeLateralLaw == lateral_efcs_law::
      NormalLaw));
    if (ElacComputer_U.in.discrete_inputs.ap_1_disengaged && ElacComputer_U.in.discrete_inputs.ap_2_disengaged &&
        (rtb_y_mk > std::fmin(look1_binlxpw(rtb_Y_i, ElacComputer_P.uDLookupTable1_bp01Data,
           ElacComputer_P.uDLookupTable1_tableData, 3U), static_cast<real_T>(rtb_y_mk) / rtb_mach * look1_binlxpw
          (rtb_Y_i, ElacComputer_P.uDLookupTable2_bp01Data, ElacComputer_P.uDLookupTable2_tableData, 3U)))) {
      ElacComputer_DWork.sProtActive = (rtb_OR_b || ElacComputer_DWork.sProtActive);
    }

    ElacComputer_DWork.sProtActive = ((rtb_y_mk >= rtb_DataTypeConversion3_m) &&
      (ElacComputer_U.in.discrete_inputs.ap_1_disengaged && ElacComputer_U.in.discrete_inputs.ap_2_disengaged &&
       rtb_OR_b && ElacComputer_DWork.sProtActive));
    ...
    ElacComputer_DWork.sProtActive_l = ((rtb_y_lu && rtb_OR_b && (ElacComputer_U.in.discrete_inputs.ap_1_disengaged &&
    ...
    ElacComputer_DWork.sProtActive_l = ((ElacComputer_U.in.time.simulation_time - ElacComputer_DWork.resetEventTime <=
      ...
      rtb_DataTypeConversion8 - 2.0)) && rtb_y_lu && rtb_OR_b && ElacComputer_DWork.sProtActive_l);
    ...
    if ((rtb_y_mk <= std::fmin(365.0, static_cast<real_T>(rtb_y_mk) / rtb_mach * (look1_binlxpw(rtb_Y_i,
    ...
    rtb_OR_b = ((rtb_y_lu && (((rtb_ap_special_disc != 0) && (rtb_DataTypeConversion7 > rtb_Switch3_p)) ||
      (rtb_DataTypeConversion7 > rtb_DataTypeConversion8 + 0.25)) && rtb_OR_b) ||
                (ElacComputer_U.in.time.simulation_time - ElacComputer_DWork.eventTime > 3.0) ||
                ElacComputer_DWork.sProtActive || ElacComputer_DWork.sProtActive_l);
    ElacComputer_MATLABFunction_g(&ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_p_ail_cmd_deg, &rtb_NOT_h);
    ElacComputer_MATLABFunction_g(&ElacComputer_U.in.bus_inputs.fmgc_1_bus.delta_q_cmd_deg, &rtb_y_lu);
    rtb_BusAssignment_p.logic.ap_1_control = ((!ElacComputer_U.in.discrete_inputs.ap_1_disengaged) && rtb_NOT_h &&
      rtb_y_lu);
    ElacComputer_MATLABFunction_g(&ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_p_ail_cmd_deg, &rtb_y_e5);
    ElacComputer_MATLABFunction_g(&ElacComputer_U.in.bus_inputs.fmgc_2_bus.delta_q_cmd_deg, &rtb_y_lu);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel_bit_e, &rtb_y_kb);
    rtb_NOT_h = (rtb_y_kb == 0U);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word, &rtb_OR_f);
    ElacComputer_MATLABFunction_j(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel1_bit_d, &rtb_y_kb);
    ElacComputer_MATLABFunction(&ElacComputer_U.in.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word, &rtb_NOT1);
    rtb_NOT_h = ((rtb_NOT_h && rtb_OR_f) || ((rtb_y_kb == 0U) && rtb_NOT1));
    rtb_BusAssignment_p.data = ElacComputer_U.in;
    rtb_BusAssignment_p.laws = ElacComputer_P.Constant_Value;
    rtb_BusAssignment_p.logic.on_ground = rtb_OR2_n;
    ...
    rtb_BusAssignment_p.logic.left_elevator_avail = rtb_leftElevatorAvail;
    ...
    rtb_BusAssignment_p.logic.is_blue_hydraulic_power_avail = rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail;
    rtb_BusAssignment_p.logic.is_green_hydraulic_power_avail = rtb_BusAssignment_fh_logic_is_green_hydraulic_power_avail;
    ...
    rtb_BusAssignment_p.logic.ap_authorised = ((std::abs(u0) <= 0.5) && (std::abs(rtb_DataTypeConversion6) <= 0.5) &&
      ...
      -13.0F) && (rtb_Y_m <= 45.0) && ((!hasPriorityInPitch) || canEngageInPitch) && (rtb_Equal || canEngageInRoll) && (
      !rtb_OR_b))));
    rtb_BusAssignment_p.logic.ap_2_control = ((!ElacComputer_U.in.discrete_inputs.ap_2_disengaged) && rtb_y_e5 &&
      rtb_y_lu);
    rtb_BusAssignment_p.logic.protection_ap_disconnect = rtb_OR_b;
    ...
    rtb_BusAssignment_p.logic.adr_1_rejected = rtb_y_l;
    rtb_BusAssignment_p.logic.adr_2_rejected = rtb_y_ew;
    rtb_BusAssignment_p.logic.adr_3_rejected = rtb_y_gh;
    rtb_BusAssignment_p.logic.double_adr_failure = rtb_doubleAdrFault;
    rtb_BusAssignment_p.logic.triple_adr_failure = rtb_tripleAdrFault;
    rtb_BusAssignment_p.logic.cas_or_mach_disagree = rtb_BusAssignment_n_logic_cas_or_mach_disagree;
    rtb_BusAssignment_p.logic.alpha_disagree = rtb_BusAssignment_nz_logic_alpha_disagree;
    rtb_BusAssignment_p.logic.ir_1_rejected = rtP_elac_logic_output_MATLABStruct.ir_1_rejected;
    rtb_BusAssignment_p.logic.ir_2_rejected = rtP_elac_logic_output_MATLABStruct.ir_2_rejected;
    rtb_BusAssignment_p.logic.ir_3_rejected = rtP_elac_logic_output_MATLABStruct.ir_3_rejected;
    rtb_BusAssignment_p.logic.double_ir_failure = rtb_OR_ht;
    rtb_BusAssignment_p.logic.triple_ir_failure = rtb_OR1_c;
    rtb_BusAssignment_p.logic.ir_failure_not_self_detected = ElacComputer_P.Constant_Value_ay;
    rtb_BusAssignment_p.logic.adr_computation_data.V_ias_kn = rtb_y_mk;
    ...
    rtb_BusAssignment_p.logic.ir_computation_data.theta_deg = rtb_theta;
    ...
    rtb_BusAssignment_p.logic.dual_ra_failure = rtb_OR_ou;
    ...
    rtb_BusAssignment_p.logic.aileron_droop_active = (rtb_NOT_h && ((leftAileronAvail && rightAileronAvail) ||
    ...
    rtb_BusAssignment_p.logic.aileron_antidroop_active = (ElacComputer_U.in.discrete_inputs.ground_spoilers_active_1 &&
      ElacComputer_U.in.discrete_inputs.ground_spoilers_active_2 && rtb_NOT_h && (rtb_theta < 2.5F) &&
      (ElacComputer_U.in.discrete_inputs.ap_1_disengaged && ElacComputer_U.in.discrete_inputs.ap_2_disengaged) &&
      (rtb_activeLateralLaw == lateral_efcs_law::NormalLaw));
    if (rtb_BusAssignment_p.logic.ap_1_control) {
      rtb_raComputationValue = rtb_BusAssignment_p.data.bus_inputs.fmgc_1_bus.delta_p_ail_cmd_deg.Data;
      rtb_y_mk = rtb_BusAssignment_p.data.bus_inputs.fmgc_1_bus.delta_r_cmd_deg.Data;
    } else {
      rtb_raComputationValue = rtb_BusAssignment_p.data.bus_inputs.fmgc_2_bus.delta_p_ail_cmd_deg.Data;
      rtb_y_mk = rtb_BusAssignment_p.data.bus_inputs.fmgc_2_bus.delta_r_cmd_deg.Data;
    }

    rtb_DataTypeConversion6 = rtb_raComputationValue;
    ...
    rtb_DataTypeConversion7 = rtb_y_mk;
    ...
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel_bit_a2, &rtb_y_b3);
    ElacComputer_MATLABFunction(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_actual_position_word,
      &rtb_OR_ou);
    rtb_OR_ou = ((rtb_y_b3 != 0U) && rtb_OR_ou);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      ElacComputer_P.BitfromLabel1_bit_p, &rtb_y_b3);
    ElacComputer_MATLABFunction(&rtb_BusAssignment_p.data.bus_inputs.sfcc_2_bus.slat_flap_actual_position_word,
      &rtb_OR2_n);
    if (rtb_OR_ou || ((rtb_y_b3 != 0U) && rtb_OR2_n)) {
    ...
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel_bit_p, &rtb_y_b3);
    rtb_OR_ou = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel1_bit_h, &rtb_y_b3);
    rtb_OR2_n = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel2_bit_f, &rtb_y_b3);
    rtb_OR_ht = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel3_bit_c, &rtb_y_b3);
    rtb_OR1_c = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_n, &rtb_y_b3);
    rtb_OR_b = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel5_bit_p, &rtb_y_b3);
    ElacComputer_MATLABFunction_o(rtb_OR_ou, rtb_OR2_n, rtb_OR_ht, rtb_OR1_c, rtb_OR_b, (rtb_y_b3 != 0U),
      &rtb_handleIndex_l);
    if ((rtb_BusAssignment_p.data.bus_inputs.sec_1_bus.thrust_lever_angle_1_deg.SSM == static_cast<uint32_T>
        ...
        (rtb_BusAssignment_p.data.bus_inputs.sec_1_bus.thrust_lever_angle_2_deg.SSM == static_cast<uint32_T>
         (SignStatusMatrix::NormalOperation))) {
      rtb_raComputationValue = rtb_BusAssignment_p.data.bus_inputs.sec_1_bus.thrust_lever_angle_1_deg.Data;
      rtb_y_mk = rtb_BusAssignment_p.data.bus_inputs.sec_1_bus.thrust_lever_angle_2_deg.Data;
               ...
               (rtb_BusAssignment_p.data.bus_inputs.sec_2_bus.thrust_lever_angle_2_deg.SSM == static_cast<uint32_T>
                (SignStatusMatrix::NormalOperation))) {
      rtb_raComputationValue = rtb_BusAssignment_p.data.bus_inputs.sec_2_bus.thrust_lever_angle_1_deg.Data;
      rtb_y_mk = rtb_BusAssignment_p.data.bus_inputs.sec_2_bus.thrust_lever_angle_2_deg.Data;
    } else {
      rtb_raComputationValue = 0.0F;
      rtb_y_mk = 0.0F;
    }

    rtb_DataTypeConversion3_m = rtb_raComputationValue;
    rtb_DataTypeConversion8 = rtb_y_mk;
    ...
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel_bit_n, &rtb_y_b3);
    rtb_OR_ou = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel1_bit_h1, &rtb_y_b3);
    rtb_OR2_n = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel2_bit_g, &rtb_y_b3);
    rtb_OR_ht = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel3_bit_b, &rtb_y_b3);
    rtb_OR1_c = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel4_bit_i, &rtb_y_b3);
    rtb_OR_b = (rtb_y_b3 != 0U);
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sfcc_1_bus.slat_flap_system_status_word,
      ElacComputer_P.BitfromLabel5_bit_l, &rtb_y_b3);
    ElacComputer_MATLABFunction_o(rtb_OR_ou, rtb_OR2_n, rtb_OR_ht, rtb_OR1_c, rtb_OR_b, (rtb_y_b3 != 0U),
      &rtb_handleIndex_g);
    ...
    ElacComputer_MATLABFunction
      (&rtb_BusAssignment_p.data.bus_inputs.elac_opp_bus.elevator_double_pressurization_command_deg, &rtb_OR_ou);
    rtb_OR_ht = !rtb_BusAssignment_k.logic.is_engaged_in_pitch;
    rtb_OR_b = (rtb_OR_ht && rtb_OR_ou);
    if (rtb_OR_b) {
      rtb_Y_i = rtb_BusAssignment_k.data.bus_inputs.elac_opp_bus.elevator_double_pressurization_command_deg.Data;
    }

    if ((rtb_OR_b || rtb_BusAssignment_k.logic.is_engaged_in_pitch) && rtb_BusAssignment_k.logic.right_elevator_avail) {
      rtb_DataTypeConversion3_m = rtb_Y_i;
    } else {
      rtb_DataTypeConversion3_m = ElacComputer_P.Constant_Value_b;
    }

    if ((rtb_OR_ht && (!rtb_OR_b)) || (!rtb_BusAssignment_k.logic.left_elevator_avail)) {
    ...
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.elac_opp_bus.discrete_status_word_1,
      ElacComputer_P.BitfromLabel_bit_p3, &rtb_y_kb);
    rtb_y_e5 = (rtb_y_kb != 0U);
    ...
    ElacComputer_MATLABFunction_j(rtb_Switch1_g_0, ElacComputer_P.BitfromLabel2_bit_j, &rtb_y_kb);
    rtb_y_e5 = (rtb_OR2_n && (rtb_y_e5 || (rtb_y_kb != 0U)));
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.elac_opp_bus.discrete_status_word_1,
      ElacComputer_P.BitfromLabel1_bit_i, &rtb_y_kb);
    rtb_AND1_h = (rtb_y_kb != 0U);
    ElacComputer_MATLABFunction_j(rtb_Switch1_g_0, ElacComputer_P.BitfromLabel3_bit_mo, &rtb_y_kb);
    rtb_AND1_h = ((rtb_AND1_h || (rtb_y_kb != 0U)) && rtb_OR2_n);
    ElacComputer_MATLABFunction_c((rtb_BusAssignment_k.logic.is_yellow_hydraulic_power_avail ||
      ...
      ElacComputer_P.ConfirmNode_isRisingEdge_f, ElacComputer_P.ConfirmNode_timeDelay_p, &rtb_y_lu,
    ...
    if (ElacComputer_P.EnumeratedConstant2_Value == rtb_BusAssignment_k.logic.active_lateral_law) {
      rtb_y_b3 = static_cast<uint32_T>(ElacComputer_P.EnumeratedConstant1_Value);
      rtb_raComputationValue = static_cast<real32_T>(rtb_DataTypeConversion7);
    } else {
      rtb_y_b3 = static_cast<uint32_T>(ElacComputer_P.EnumeratedConstant_Value);
      rtb_raComputationValue = static_cast<real32_T>(ElacComputer_P.Constant7_Value);
    }

    if (rtb_OR2_n) {
      rtb_Switch18 = static_cast<uint32_T>(ElacComputer_P.EnumeratedConstant1_Value);
      rtb_theta = static_cast<real32_T>(rtb_BusAssignment_k.laws.pitch_law_outputs.elevator_command_deg);
    } else {
      rtb_theta = static_cast<real32_T>(ElacComputer_P.Constant8_Value);
    }
    ...
    ElacComputer_MATLABFunction_j(&rtb_BusAssignment_p.data.bus_inputs.sec_1_bus.discrete_status_word_1,
      ElacComputer_P.BitfromLabel_bit_es, &rtb_y_kb);
    ...
    rtb_VectorConcatenate[17] = (rtb_OR2_n || ((rtb_y_kb == 0U) &&
    ...
    ElacComputer_MATLABFunction_cw(rtb_VectorConcatenate, &rtb_y_mk);
    rtb_phi = rtb_y_mk;
    ...
    ElacComputer_MATLABFunction_cw(rtb_VectorConcatenate_a, &rtb_y_mk);
    rtb_q = rtb_y_mk;
    rtb_VectorConcatenate[0] = rtb_BusAssignment_k.logic.double_adr_failure;
    rtb_VectorConcatenate[1] = rtb_BusAssignment_k.logic.cas_or_mach_disagree;
    rtb_VectorConcatenate[2] = rtb_BusAssignment_k.logic.alpha_disagree;
    rtb_VectorConcatenate[3] = rtb_BusAssignment_k.logic.adr_1_rejected;
    rtb_VectorConcatenate[4] = rtb_BusAssignment_k.logic.adr_2_rejected;
    rtb_VectorConcatenate[5] = rtb_BusAssignment_k.logic.adr_3_rejected;
    rtb_VectorConcatenate[6] = rtb_BusAssignment_k.logic.double_ir_failure;
    rtb_VectorConcatenate[7] = rtb_BusAssignment_k.logic.ir_failure_not_self_detected;
    rtb_VectorConcatenate[8] = rtb_BusAssignment_k.logic.ir_1_rejected;
    rtb_VectorConcatenate[9] = rtb_BusAssignment_k.logic.ir_2_rejected;
    rtb_VectorConcatenate[10] = rtb_BusAssignment_k.logic.ir_3_rejected;
    rtb_VectorConcatenate[11] = ElacComputer_P.Constant11_Value;
    rtb_VectorConcatenate[12] = ElacComputer_P.Constant11_Value;
    rtb_VectorConcatenate[13] = ElacComputer_P.Constant11_Value;
    rtb_VectorConcatenate[14] = ElacComputer_P.Constant11_Value;
    rtb_VectorConcatenate[15] = ElacComputer_P.Constant11_Value;
    rtb_VectorConcatenate[16] = ElacComputer_P.Constant11_Value;
    rtb_VectorConcatenate[17] = ElacComputer_P.Constant11_Value;
    rtb_VectorConcatenate[18] = ElacComputer_P.Constant11_Value;
    ElacComputer_MATLABFunction_cw(rtb_VectorConcatenate, &rtb_y_mk);
    ...
    rtb_Equal = ((rtb_BusAssignment_k.logic.is_engaged_in_roll ||
                  rtb_BusAssignment_k.logic.left_aileron_crosscommand_active) &&
                 rtb_BusAssignment_k.logic.left_aileron_avail);
    ElacComputer_Y.out.discrete_outputs.left_aileron_active_mode = rtb_Equal;
    rtb_NOT_h = ((rtb_BusAssignment_k.logic.is_engaged_in_roll ||
                  rtb_BusAssignment_k.logic.right_aileron_crosscommand_active) &&
                 rtb_BusAssignment_k.logic.right_aileron_avail);
    ElacComputer_Y.out.discrete_outputs.right_aileron_active_mode = rtb_NOT_h;
    ElacComputer_Y.out.discrete_outputs.left_elevator_damping_mode = (rtb_BusAssignment_k.logic.is_engaged_in_pitch &&
      rtb_BusAssignment_k.logic.left_elevator_avail && (!rtb_y_e5));
    ...
    rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail = (rtb_BusAssignment_k.logic.ths_active_commanded &&
      rtb_BusAssignment_k.logic.ths_avail);
    ElacComputer_Y.out.discrete_outputs.ths_active = rtb_BusAssignment_fh_logic_is_blue_hydraulic_power_avail;
    ElacComputer_Y.out.discrete_outputs.batt_power_supply = rtb_y_lu;
    ...
    ElacComputer_Y.out.bus_outputs.yaw_damper_command_deg.SSM = rtb_y_b3;
    ElacComputer_Y.out.bus_outputs.yaw_damper_command_deg.Data = rtb_raComputationValue;
    ElacComputer_Y.out.bus_outputs.elevator_double_pressurization_command_deg.SSM = rtb_Switch18;
    ElacComputer_Y.out.bus_outputs.elevator_double_pressurization_command_deg.Data = rtb_theta;
    ...
    ElacComputer_Y.out.bus_outputs.discrete_status_word_1.SSM = static_cast<uint32_T>
      (ElacComputer_P.EnumeratedConstant1_Value);
    ElacComputer_Y.out.bus_outputs.discrete_status_word_1.Data = rtb_phi;
    ElacComputer_Y.out.bus_outputs.discrete_status_word_2.SSM = static_cast<uint32_T>
      (ElacComputer_P.EnumeratedConstant1_Value);
    ElacComputer_Y.out.bus_outputs.discrete_status_word_2.Data = rtb_q;
    ElacComputer_Y.out.bus_outputs.discrete_status_word_3.SSM = static_cast<uint32_T>
      (ElacComputer_P.EnumeratedConstant1_Value);
    ElacComputer_Y.out.bus_outputs.discrete_status_word_3.Data = rtb_y_mk;
...
void ElacComputer::initialize()
{
  ...
  ElacComputer_DWork.Delay_DSTATE_b = ElacComputer_P.Delay_InitialCondition;
  ElacComputer_DWork.icLoad = true;
  ElacComputer_B.u_ce = ElacComputer_P.Y_Y0_j;
  ElacComputer_B.u_cef = ElacComputer_P.Y_Y0;
  ElacComputer_B.u_c = ElacComputer_P.Y_Y0_d;
  ElacComputer_B.u_oq = ElacComputer_P.Y_Y0_g;
  ElacComputer_B.u_oql = ElacComputer_P.Y_Y0_a;
  ElacComputer_B.u_o = ElacComputer_P.Y_Y0_h;
  ElacComputer_B.u_l = ElacComputer_P.Y_Y0_aj;
  ElacComputer_B.u_lq = ElacComputer_P.Y_Y0_hw;
  ElacComputer_B.u = ElacComputer_P.Y_Y0_c;
  LawMDLOBJ2.init();
  LawMDLOBJ5.init();
  LawMDLOBJ3.init();
