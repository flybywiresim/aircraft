...
class FmgcOuterLoops final
{
 public:
  ...
  struct D_Work_FmgcOuterLoops_T {
    ...
    boolean_T prevVerticalLaw_not_empty_m;
    boolean_T prevTarget_not_empty_j;
    boolean_T islevelOffActive_o;
    boolean_T wasActive;
    boolean_T wasActive_not_empty;
    boolean_T pY_not_empty_a;
    boolean_T pU_not_empty;
    boolean_T wasActive_a;
    boolean_T wasActive_not_empty_h;
    boolean_T pY_not_empty_e;
    boolean_T pY_not_empty_c;
    boolean_T storage_not_empty_o;
    boolean_T storage_not_empty_i;
