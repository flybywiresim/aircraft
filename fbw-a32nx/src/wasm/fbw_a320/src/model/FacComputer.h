...
class FacComputer final
{
 public:
  ...
  struct rtDW_MATLABFunction_FacComputer_g_T {
    real_T timeSinceCondition;
    boolean_T output;
  };

  struct rtDW_MATLABFunction_FacComputer_d_T {
    real_T remainingTriggerTime;
    boolean_T previousInput;
  };

  struct rtDW_WashoutFilter_FacComputer_T {
    real_T pY;
    real_T pU;
    boolean_T pY_not_empty;
    boolean_T pU_not_empty;
  ...
  struct rtDW_RateLimiter_FacComputer_n_T {
    real_T pY;
    boolean_T pY_not_empty;
  };
  ...
  struct D_Work_FacComputer_T {
    ...
    rtDW_RateLimiter_FacComputer_n_T sf_RateLimiter_g0;
    rtDW_RateLimiter_FacComputer_n_T sf_RateLimiter_g;
    rtDW_WashoutFilter_FacComputer_T sf_WashoutFilter;
    rtDW_LagFilter_FacComputer_T sf_LagFilter_fb;
    rtDW_MATLABFunction_FacComputer_g_T sf_MATLABFunction_o;
    rtDW_MATLABFunction_FacComputer_d_T sf_MATLABFunction_ns;
    rtDW_MATLABFunction_FacComputer_d_T sf_MATLABFunction_a;
    rtDW_LagFilter_FacComputer_T sf_LagFilter_e;
    rtDW_LagFilter_FacComputer_T sf_LagFilter_fi;
    rtDW_MATLABFunction_FacComputer_g_T sf_MATLABFunction_n;
    rtDW_LagFilter_FacComputer_T sf_LagFilter_c4;
    rtDW_LagFilter_FacComputer_T sf_LagFilter_mt;
    rtDW_LagFilter_FacComputer_T sf_LagFilter_m;
  ...
  struct Parameters_FacComputer_T {
    ...
    real_T LagFilter2_C1_n;
    real_T LagFilter1_C1_b;
    real_T LagFilter1_C1_a;
    real_T LagFilter2_C1_f;
    ...
    real_T FlapFPPUtoSurfaceAngle_tableData[12];
    real_T FlapFPPUtoSurfaceAngle_bp01Data[12];
    real_T SlatFPPUtoSurfaceAngle_tableData[5];
    real_T SlatFPPUtoSurfaceAngle_bp01Data[5];
    ...
    real_T ktstoms_Gain;
    real_T Gain_Gain_p;
    real_T uDLookupTable_tableData_h[4];
    real_T uDLookupTable_bp01Data_o[4];
    real_T uDLookupTable3_tableData_d[4];
    real_T uDLookupTable3_bp01Data_k[4];
    real_T uDLookupTable1_tableData_n[4];
    real_T uDLookupTable1_bp01Data_i[4];
    real_T uDLookupTable2_tableData_i[4];
    real_T uDLookupTable2_bp01Data_k[4];
    real_T Saturation1_UpperSat_f;
    real_T Saturation1_LowerSat_e;
    real_T Bias_Bias_g;
 ...
 private:
  ...
  static void FacComputer_MATLABFunction_i(const base_arinc_429 *rtu_u, real32_T *rty_y);
  static void FacComputer_MATLABFunction_c_Reset(rtDW_MATLABFunction_FacComputer_g_T *localDW);
  static void FacComputer_MATLABFunction_n(boolean_T rtu_u, real_T rtu_Ts, boolean_T rtu_isRisingEdge, real_T
    rtu_timeDelay, boolean_T *rty_y, rtDW_MATLABFunction_FacComputer_g_T *localDW);
  static void FacComputer_MATLABFunction_i_Reset(rtDW_MATLABFunction_FacComputer_d_T *localDW);
  static void FacComputer_MATLABFunction_a(boolean_T rtu_u, real_T rtu_Ts, boolean_T *rty_y, real_T rtp_isRisingEdge,
    real_T rtp_retriggerable, real_T rtp_triggerDuration, rtDW_MATLABFunction_FacComputer_d_T *localDW);
  static void FacComputer_MATLABFunction2(real_T rtu_a, real_T rtu_b, real_T rtu_m_lbs, real_T *rty_v_s);
  static void FacComputer_WashoutFilter_Reset(rtDW_WashoutFilter_FacComputer_T *localDW);
  static void FacComputer_WashoutFilter(real_T rtu_U, real_T rtu_C1, real_T rtu_dt, real_T *rty_Y,
    rtDW_WashoutFilter_FacComputer_T *localDW);
  static void FacComputer_MATLABFunction_l(const base_arinc_429 *rtu_u, boolean_T *rty_y);
  static void FacComputer_RateLimiter_e_Reset(rtDW_RateLimiter_FacComputer_n_T *localDW);
  static void FacComputer_RateLimiter_g(real_T rtu_u, real_T rtu_up, real_T rtu_lo, real_T rtu_Ts, real_T rtu_init,
    boolean_T rtu_reset, real_T *rty_Y, rtDW_RateLimiter_FacComputer_n_T *localDW);
  static void FacComputer_RateLimiter_o_Reset(rtDW_RateLimiter_FacComputer_d_T *localDW);
