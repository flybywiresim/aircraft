...
void FcuComputer::step()
{
  ...
  if (FcuComputer_U.in.sim_data.computer_running) {
    ...
    FcuComputer_MATLABFunction_p(rtb_Equal8, rtb_OR3_j, &rtb_Equal9, &rtb_DataTypeConversion_d, &rtb_y_e,
    ...
    rtb_BusAssignment_m.logic.capt_efis.efis_filter = rtb_efisFilter;
    ...
    rtb_BusAssignment_m.logic.capt_efis.baro_qnh = rtb_DataTypeConversion_d;
    rtb_BusAssignment_m.logic.capt_efis.baro_qfe = rtb_y_e;
    ...
    FcuComputer_MATLABFunction_i(rtb_Switch1_2, FcuComputer_P.A429ValueOrDefault1_defaultValue, &rtb_y_cy);
    FcuComputer_MATLABFunction_i(rtb_Switch_heading_deg, FcuComputer_P.A429ValueOrDefault2_defaultValue, &rtb_y_b);
    FcuComputer_MATLABFunction_i(rtb_Switch_track_deg, FcuComputer_P.A429ValueOrDefault3_defaultValue, &rtb_y_h);
    FcuComputer_MATLABFunction_i(rtb_Switch_k_0, FcuComputer_P.A429ValueOrDefault4_defaultValue, &rtb_y_m);
    FcuComputer_MATLABFunction_i(rtb_Switch_vertical_speed_ft_min, FcuComputer_P.A429ValueOrDefault5_defaultValue,
      &rtb_y_gu);
    FcuComputer_MATLABFunction_i(rtb_Switch_fpa_deg, FcuComputer_P.A429ValueOrDefault6_defaultValue, &rtb_y_f);
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.hdg_trk_knob.pulled, FcuComputer_U.in.time.dt,
      &rtb_y_l0, FcuComputer_P.MTrigNode1_isRisingEdge, FcuComputer_P.MTrigNode1_retriggerable,
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.hdg_trk_knob.turns !=
      FcuComputer_P.CompareToConstant_const, FcuComputer_U.in.time.dt, &rtb_y_cp, FcuComputer_P.MTrigNode2_isRisingEdge,
    ...
    rtb_BusAssignment_m.logic.afs.hdg_trk_buttons.pulled = rtb_y_l0;
    rtb_BusAssignment_m.logic.afs.hdg_trk_buttons.turns = static_cast<int8_T>(rtb_y_cp);
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.spd_knob.pulled, FcuComputer_U.in.time.dt,
      &rtb_y_l0, FcuComputer_P.MTrigNode1_isRisingEdge_j, FcuComputer_P.MTrigNode1_retriggerable_d,
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.spd_knob.turns !=
      FcuComputer_P.CompareToConstant_const_p, FcuComputer_U.in.time.dt, &rtb_y_cp,
    ...
    rtb_BusAssignment_m.logic.afs.spd_mach_buttons.pulled = rtb_y_l0;
    rtb_BusAssignment_m.logic.afs.spd_mach_buttons.turns = static_cast<int8_T>(rtb_y_cp);
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.alt_knob.pulled, FcuComputer_U.in.time.dt,
      &rtb_y_l0, FcuComputer_P.MTrigNode1_isRisingEdge_o, FcuComputer_P.MTrigNode1_retriggerable_j,
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.alt_knob.turns !=
      FcuComputer_P.CompareToConstant_const_pg, FcuComputer_U.in.time.dt, &rtb_y_cp,
    ...
    rtb_BusAssignment_m.logic.afs.alt_buttons.pulled = rtb_y_l0;
    rtb_BusAssignment_m.logic.afs.alt_buttons.turns = static_cast<int8_T>(rtb_y_cp);
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.vs_fpa_knob.pulled, FcuComputer_U.in.time.dt,
      &rtb_y_l0, FcuComputer_P.MTrigNode1_isRisingEdge_c, FcuComputer_P.MTrigNode1_retriggerable_l,
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.vs_fpa_knob.turns !=
      FcuComputer_P.CompareToConstant_const_e, FcuComputer_U.in.time.dt, &rtb_y_cp,
    ...
    rtb_baroValueMode = static_cast<int8_T>(rtb_y_cp);
    rtb_BusAssignment_m.logic.afs.vs_fpa_buttons.pushed = rtb_OR3_j;
    rtb_BusAssignment_m.logic.afs.vs_fpa_buttons.pulled = rtb_y_l0;
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.appr_button_pressed, FcuComputer_U.in.time.dt,
      &rtb_y_l0, FcuComputer_P.MTrigNode2_isRisingEdge_p, FcuComputer_P.MTrigNode2_retriggerable_c,
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.spd_mach_button_pressed,
      FcuComputer_U.in.time.dt, &rtb_y_cp, FcuComputer_P.MTrigNode3_isRisingEdge, FcuComputer_P.MTrigNode3_retriggerable,
    ...
    rtb_BusAssignment_m.logic.afs.appr_pushed = rtb_y_l0;
    rtb_BusAssignment_m.logic.afs.spd_mach_switching_pushed = rtb_y_cp;
    ...
    rtb_BusAssignment_m.logic.fo_efis.baro_qfe = rtb_y_e;
    if (rtb_fmgc1Priority) {
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch_k_0, &rtb_y_cp);
    rtb_AND_g = ((rtb_Switch1_oa != 0U) && rtb_y_cp);
    FcuComputer_MATLABFunction_a(rtb_Switch_k_0, FcuComputer_P.BitfromLabel1_bit, &rtb_Switch1_oa);
    rtb_AND1_l = (rtb_y_cp && (rtb_Switch1_oa != 0U));
    if (rtb_fmgc1Priority) {
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch1_2, &rtb_y_cp);
    rtb_OR3_j = ((rtb_Equal7 || (rtb_Switch1_oa != 0U)) && rtb_y_cp);
    if (rtb_fmgc1Priority) {
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch2_0, &rtb_y_l0);
    rtb_Equal9 = ((rtb_y_e || rtb_Equal7 || rtb_DataTypeConversion_d || rtb_Equal9 || rtb_Equal8 || (rtb_Switch1_oa !=
      0U)) && rtb_y_l0);
    ...
    rtb_BusAssignment_m.logic.afs.hdg_trk_selected = (rtb_y_l0 && (rtb_Equal8 || (rtb_Switch1_oa != 0U)));
    FcuComputer_MATLABFunction_m(rtb_Switch1_2, &rtb_y_cp);
    FcuComputer_MATLABFunction_a(rtb_Switch1_2, FcuComputer_P.BitfromLabel2_bit_l, &rtb_Switch1_oa);
    rtb_BusAssignment_m.logic.afs.hdg_trk_preset_available = (rtb_y_cp && (rtb_Switch1_oa != 0U));
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch1_2, &rtb_y_l0);
    rtb_AND2_m = ((rtb_DataTypeConversion_d || rtb_y_e || rtb_Equal7 || (rtb_Switch1_oa != 0U)) && rtb_y_l0);
    if (rtb_fmgc1Priority) {
    ...
    rtb_Equal8 = (rtb_y_cp && (rtb_Switch1_oa != 0U));
    ...
    rtb_y_l0 = (rtb_Equal6 || (rtb_Switch1_oa != 0U));
    ...
    rtb_y_cp = ((!rtb_Equal6) && (!rtb_DataTypeConversion_d) && (rtb_Switch1_oa == 0U));
    ...
    rtb_DataTypeConversion_d = (rtb_Equal8 || (rtb_y_l0 && rtb_y_cp) || rtb_Equal6 || rtb_DataTypeConversion_d ||
      rtb_y_e || rtb_Equal7 || (rtb_Switch1_oa != 0U));
    FcuComputer_MATLABFunction_m(rtb_Switch1_2, &rtb_y_e);
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch_k_0, &rtb_y_cp);
    rtb_BusAssignment_m.logic.afs.exped_active = ((rtb_Switch1_oa != 0U) && rtb_y_cp);
    if (rtb_fmgc1Priority) {
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch_k_0, &rtb_y_l0);
    if (rtb_fmgc1Priority) {
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch1_2, &rtb_y_cp);
    rtb_Equal6 = ((rtb_Equal6 || (rtb_Switch1_oa != 0U)) && rtb_y_cp && rtb_y_l0);
    if (rtb_fmgc1Priority) {
    ...
    rtb_Equal7 = (rtb_y_cp && (rtb_Equal7 || rtb_Equal8 || (rtb_Switch1_oa != 0U)) && rtb_y_l0 && (!rtb_Equal6));
    ...
    rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.v_mach = rtb_y_cy;
    rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.hdg_deg = rtb_y_b;
    rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.trk_deg = rtb_y_h;
    rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.alt_ft = rtb_y_m;
    rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.vs_ft_min = rtb_y_gu;
    rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.fpa_deg = rtb_y_f;
    rtb_BusAssignment_m.logic.afs.any_ap_fd_engaged = (FcuComputer_U.in.discrete_inputs.ap_1_engaged ||
    ...
    rtb_BusAssignment_m.logic.afs.lvl_ch_managed = (rtb_AND2_m || (rtb_DataTypeConversion_d && rtb_y_e));
    rtb_BusAssignment_m.logic.afs.lvl_ch_vs_fpa = (rtb_y_e && rtb_OR_o);
    ...
    rtb_BusAssignment_m.logic.afs.vs_fpa_buttons.turns = rtb_baroValueMode;
    ...
    rtb_BusAssignment_m.logic.afs.loc_only_active = rtb_Equal7;
    rtb_BusAssignment_m.logic.afs.appr_active = rtb_Equal6;
    FcuComputer_MATLABFunction_d(rtb_AND_g, FcuComputer_P.PulseNode_isRisingEdge_l, &rtb_Equal7,
      &FcuComputer_DWork.sf_MATLABFunction_kl);
    rtb_OR3_j = ((!rtb_AND1_l) && (!rtb_AND_g));
    FcuComputer_MATLABFunction1(&rtb_BusAssignment_m, rtb_Equal7, rtb_AND1_l || rtb_OR3_j ||
    ...
    if (!FcuComputer_DWork.pValue_not_empty_i) {
      FcuComputer_DWork.pValue_g = rtb_y;
    ...
    FcuComputer_DWork.pValue_g += static_cast<real32_T>(FcuComputer_U.in.discrete_inputs.afs_inputs.spd_knob.turns);
    FcuComputer_DWork.pValue_g = std::fmax(std::fmin(FcuComputer_DWork.pValue_g, 399.0F), 100.0F);
    FcuComputer_DWork.pValue_g = std::round(FcuComputer_DWork.pValue_g);
    FcuComputer_DWork.prevMachActive = false;
    rtb_BusAssignment_m.logic.afs.spd_mach_display_value = FcuComputer_DWork.pValue_g;
    ...
    FcuComputer_MATLABFunction_d((!rtb_BusAssignment_m.logic.afs.hdg_trk_selected) &&
      rtb_BusAssignment_m.logic.afs.any_ap_fd_engaged, FcuComputer_P.PulseNode_isRisingEdge_hz, &rtb_y_cp,
    ...
    FcuComputer_MATLABFunction1(&rtb_BusAssignment_m, rtb_y_cp, rtb_BusAssignment_m.logic.afs.hdg_trk_selected ||
      (!rtb_BusAssignment_m.logic.afs.any_ap_fd_engaged) ||
      (FcuComputer_U.in.discrete_inputs.afs_inputs.hdg_trk_knob.turns != FcuComputer_P.CompareToConstant_const_es) ||
      rtb_Equal7, &FcuComputer_DWork.Delay_DSTATE, &FcuComputer_DWork.sf_MATLABFunction1);
    if (!FcuComputer_DWork.pValue_not_empty_o) {
      if (FcuComputer_DWork.p_trk_fpa_active) {
        ...
        FcuComputer_DWork.pValue_e = rtb_y_b;
        FcuComputer_DWork.pValue_not_empty_o = true;
      }
    }
    ...
    if (FcuComputer_DWork.prevTrkFpaActive_g != FcuComputer_DWork.p_trk_fpa_active) {
      if (FcuComputer_DWork.p_trk_fpa_active) {
        rtb_y_cy = FcuComputer_DWork.pValue_e - rtb_y_b;
      } else {
        rtb_y_cy = FcuComputer_DWork.pValue_e - rtb_y_h;
      }

      if (rtb_y_cy > 180.0F) {
        rtb_y_cy -= 360.0F;
      } else if (rtb_y_cy < -180.0F) {
        rtb_y_cy += 360.0F;
      }

      rtb_y_cy = std::abs(rtb_y_cy);
      if ((rtb_y_cy < 5.0F) && FcuComputer_DWork.p_trk_fpa_active) {
        FcuComputer_DWork.pValue_e = rtb_y_h;
      } else if ((rtb_y_cy < 5.0F) && (!FcuComputer_DWork.p_trk_fpa_active)) {
        FcuComputer_DWork.pValue_e = rtb_y_b;
      }
    }
    ...
    rtb_BusAssignment_m.logic.afs.alt_display_value = FcuComputer_DWork.pValue_a;
    FcuComputer_MATLABFunction_d((!rtb_BusAssignment_m.logic.afs.lvl_ch_vs_fpa) &&
      rtb_BusAssignment_m.logic.afs.any_ap_fd_engaged, FcuComputer_P.PulseNode1_isRisingEdge_e, &rtb_Equal7,
      &FcuComputer_DWork.sf_MATLABFunction_kw);
    rtb_OR3_j = !rtb_BusAssignment_m.logic.afs.any_ap_fd_engaged;
    ...
    FcuComputer_MATLABFunction1(&rtb_BusAssignment_m, rtb_Equal7, rtb_BusAssignment_m.logic.afs.lvl_ch_vs_fpa ||
      rtb_OR3_j || rtb_Equal6, &rtb_Equal6, &FcuComputer_DWork.sf_MATLABFunction1_o);
    ...
    if (!FcuComputer_DWork.pValue_not_empty) {
      if (FcuComputer_DWork.p_trk_fpa_active) {
        FcuComputer_DWork.pValue = rtb_y_f;
        FcuComputer_DWork.pValue_not_empty = true;
      } else {
        FcuComputer_DWork.pValue = rtb_y_gu;
        FcuComputer_DWork.pValue_not_empty = true;
      }
    }
    ...
    FcuComputer_DWork.prevTrkFpaActive = FcuComputer_DWork.p_trk_fpa_active;
    rtb_y_e = rtb_Equal6;
    FcuComputer_MATLABFunction(FcuComputer_DWork.pValue_e != FcuComputer_DWork.DelayInput1_DSTATE[0],
    ...
    FcuComputer_MATLABFunction(FcuComputer_DWork.pValue_a != FcuComputer_DWork.DelayInput1_DSTATE[1],
    ...
    FcuComputer_MATLABFunction(FcuComputer_DWork.pValue_g != FcuComputer_DWork.DelayInput1_DSTATE[3],
    ...
    if (rtb_fmgc1Priority) {
      rtb_Switch1_oa = FcuComputer_U.in.bus_inputs.fmgc_1_bus.ats_fma_discrete_word.SSM;
      rtb_y = FcuComputer_U.in.bus_inputs.fmgc_1_bus.ats_fma_discrete_word.Data;
      ...
      rtb_Switch1_oa = FcuComputer_U.in.bus_inputs.fmgc_2_bus.ats_fma_discrete_word.SSM;
      rtb_y = FcuComputer_U.in.bus_inputs.fmgc_2_bus.ats_fma_discrete_word.Data;
    ...
    rtb_VectorConcatenate[6] = (rtb_BusAssignment_m.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant7_Value_k);
    rtb_VectorConcatenate[7] = (rtb_BusAssignment_m.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant6_Value_l);
    rtb_VectorConcatenate[8] = (rtb_BusAssignment_m.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant8_Value_a);
    rtb_VectorConcatenate[9] = (rtb_BusAssignment_m.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant9_Value_g);
    rtb_VectorConcatenate[10] = (rtb_BusAssignment_m.logic.capt_efis.efis_filter ==
      FcuComputer_P.EnumeratedConstant10_Value_b);
    rtb_VectorConcatenate[11] = rtb_BusAssignment_m.logic.capt_efis.ls_on;
    rtb_DataTypeConversion_d = !rtb_BusAssignment_m.logic.capt_efis.fd_on;
    rtb_VectorConcatenate[12] = rtb_DataTypeConversion_d;
    ...
    rtb_VectorConcatenate[18] = rtb_BusAssignment_m.logic.capt_efis.baro_qnh;
    ...
    rtb_Equal9 = !rtb_BusAssignment_m.logic.fo_efis.fd_on;
    rtb_VectorConcatenate[12] = rtb_Equal9;
    ...
    rtb_VectorConcatenate[15] = rtb_DataTypeConversion_d;
    rtb_VectorConcatenate[16] = rtb_Equal9;
    ...
    rtb_DataTypeConversion_d = !FcuComputer_DWork.p_trk_fpa_active;
    rtb_VectorConcatenate[13] = rtb_DataTypeConversion_d;
    ...
    FcuComputer_MATLABFunction_e(rtb_VectorConcatenate, &rtb_y_gu);
    if (rtb_fmgc1Priority) {
    ...
    FcuComputer_Y.out.logic.afs.any_ap_fd_engaged = rtb_BusAssignment_m.logic.afs.any_ap_fd_engaged;
    ...
    FcuComputer_Y.out.logic.afs.spd_mach_display_value = FcuComputer_DWork.pValue_g;
    ...
    FcuComputer_Y.out.logic.afs.vs_fpa_dashes = rtb_y_e;
    ...
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.cstr_light_on =
      (rtb_BusAssignment_m.logic.capt_efis.efis_filter == FcuComputer_P.EnumeratedConstant7_Value);
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.wpt_light_on = (rtb_BusAssignment_m.logic.capt_efis.efis_filter
      == FcuComputer_P.EnumeratedConstant6_Value);
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.vord_light_on =
      (rtb_BusAssignment_m.logic.capt_efis.efis_filter == FcuComputer_P.EnumeratedConstant8_Value);
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.ndb_light_on = (rtb_BusAssignment_m.logic.capt_efis.efis_filter
      == FcuComputer_P.EnumeratedConstant9_Value);
    FcuComputer_Y.out.discrete_outputs.capt_efis_outputs.arpt_light_on =
      (rtb_BusAssignment_m.logic.capt_efis.efis_filter == FcuComputer_P.EnumeratedConstant10_Value);
    ...
    FcuComputer_Y.out.discrete_outputs.afs_outputs.spd_mach_value = FcuComputer_DWork.pValue_g;
    ...
    FcuComputer_Y.out.discrete_outputs.afs_outputs.vs_fpa_dashes = rtb_y_e;
    ...
    FcuComputer_Y.out.bus_outputs.selected_spd_kts.Data = FcuComputer_DWork.pValue_g;
    if (rtb_y_e || FcuComputer_DWork.p_trk_fpa_active) {
    ...
    FcuComputer_Y.out.bus_outputs.selected_mach.Data = FcuComputer_DWork.pValue_g;
    if (FcuComputer_DWork.Delay_DSTATE || rtb_DataTypeConversion_d) {
    ...
    if (rtb_y_e || rtb_DataTypeConversion_d) {
    ...
    FcuComputer_Y.out.bus_outputs.ats_fma_discrete_word.SSM = rtb_Switch1_oa;
    FcuComputer_Y.out.bus_outputs.ats_fma_discrete_word.Data = rtb_y;
    ...
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_left.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_left.Data = rtb_y_m;
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_right.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_right.Data = rtb_y_h;
    ...
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_2.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_2.Data = rtb_y_f;
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_1.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_1.Data = rtb_y_gu;
    ...
    FcuComputer_DWork.DelayInput1_DSTATE[0] = FcuComputer_DWork.pValue_e;
    FcuComputer_DWork.DelayInput1_DSTATE[1] = FcuComputer_DWork.pValue_a;
    FcuComputer_DWork.DelayInput1_DSTATE[2] = FcuComputer_DWork.pValue;
    FcuComputer_DWork.DelayInput1_DSTATE[3] = FcuComputer_DWork.pValue_g;
  } else {
