...
class FmgcComputer final
{
 public:
  ...
  struct rtDW_MATLABFunction_FmgcComputer_f4_T {
  ...
  struct D_Work_FmgcComputer_T {
    ...
    boolean_T Memory_PreviousInput_me;
    ...
    boolean_T Memory_PreviousInput_db;
    boolean_T Memory_PreviousInput_m3;
    ...
    boolean_T Memory_PreviousInput_dy;
    boolean_T Memory_PreviousInput_j;
    boolean_T Memory_PreviousInput_ly;
    boolean_T Memory_PreviousInput_a;
    boolean_T Memory_PreviousInput_cvs;
    boolean_T Memory_PreviousInput_lqs;
    ...
    boolean_T Memory_PreviousInput_b30;
    ...
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_pl4;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_g0;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_an;
    ...
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_d5y;
    ...
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_lrr;
    ...
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_hdx;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_hd1;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_ppo;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_dln;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_ppu;
    ...
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_gb;
    ...
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_kdu;
    ...
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_hwv;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_bqs;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_ec;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_om;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_ks;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_gd;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_nf;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_g1;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_cj;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_lpr;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_l2;
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_hy;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_ogt;
    ...
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_ifq;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_ck;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_j5r;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_bqw;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_af;
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_j4z;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_pum;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_fh;
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_kz1;
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_mnt;
    ...
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_gky;
    ...
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_e3;
    ...
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_hhd;
    ...
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_fwv;
    ...
    rtDW_MATLABFunction_FmgcComputer_f4_T sf_MATLABFunction_m3;
    ...
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_pa;
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_pge;
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_o;
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_lr;
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_khy;
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_ap;
  ...
  struct Parameters_FmgcComputer_T {
    ...
    real_T BitfromLabel_bit_cd;
    real_T BitfromLabel1_bit_j;
    real_T BitfromLabel2_bit_av;
    real_T BitfromLabel3_bit_p;
    real_T BitfromLabel_bit_d;
    real_T BitfromLabel2_bit_m;
    real_T BitfromLabel1_bit_iu;
    real_T BitfromLabel_bit_fn;
    ...
    real_T BitfromLabel5_bit_k;
    real_T BitfromLabel6_bit_b;
    real_T BitfromLabel7_bit_h;
    real_T BitfromLabel8_bit_a;
    ...
    real_T MTrigNode_isRisingEdge_jm;
    real_T MTrigNode_isRisingEdge_m;
    real_T MTrigNode_isRisingEdge_dj;
    ...
    real_T MTrigNode_retriggerable_pl;
    ...
    real_T SourceMonitoringPairwise1_timeDelay;
    ...
    real_T ConfirmNode_timeDelay_hu;
    ...
    real_T MTrigNode_triggerDuration_ag;
    ...
    real32_T CompareToConstant_const_odr;
    real32_T CompareToConstant1_const_hy;
    ...
    real32_T SourceMonitoringPairwise1_threshold;
    ...
    boolean_T SRFlipFlop1_initial_condition_pd;
    ...
    boolean_T SRFlipFlop_initial_condition_mm;
    boolean_T SRFlipFlop_initial_condition_p;
    boolean_T SRFlipFlop_initial_condition_lo;
    ...
    boolean_T SRFlipFlop_initial_condition_bw;
    boolean_T SRFlipFlop_initial_condition_hy;
    boolean_T SRFlipFlop_initial_condition_n;
    boolean_T SRFlipFlop_initial_condition_nn;
    ...
    boolean_T SRFlipFlop2_initial_condition_k;
    ...
    boolean_T ConfirmNode2_isRisingEdge_o;
    ...
    boolean_T ConfirmNode_isRisingEdge_p4;
    ...
    boolean_T PulseNode3_isRisingEdge_ae;
    boolean_T PulseNode5_isRisingEdge_c;
    boolean_T PulseNode2_isRisingEdge_j;
    boolean_T PulseNode1_isRisingEdge_d;
    boolean_T PulseNode_isRisingEdge_g;
    boolean_T PulseNode4_isRisingEdge_p;
    boolean_T ConfirmNode_isRisingEdge_fh;
    boolean_T PulseNode_isRisingEdge_k5;
    boolean_T PulseNode7_isRisingEdge;
    boolean_T PulseNode3_isRisingEdge_fg;
    boolean_T PulseNode4_isRisingEdge_o;
    boolean_T PulseNode2_isRisingEdge_l;
    boolean_T PulseNode1_isRisingEdge_hz;
    boolean_T PulseNode6_isRisingEdge;
    boolean_T PulseNode5_isRisingEdge_j;
    boolean_T ConfirmNode_isRisingEdge_fy;
    boolean_T PulseNode1_isRisingEdge_cs;
    boolean_T PulseNode2_isRisingEdge_o;
    boolean_T ConfirmNode_isRisingEdge_n;
    boolean_T PulseNode_isRisingEdge_gu;
    ...
    boolean_T ConfirmNode_isRisingEdge_caj;
    ...
    boolean_T Logic_table_bv[16];
    boolean_T Constant_Value_j;
    boolean_T Logic_table_hz[16];
    boolean_T Logic_table_da[16];
    ...
    boolean_T Logic_table_gf[16];
    boolean_T Logic_table_mb[16];
 ...
 private:
  ...
  static void FmgcComputer_MATLABFunction_k(boolean_T rtu_deviation1To2, boolean_T rtu_deviation1To3, boolean_T
    rtu_deviation2To3, boolean_T *rty_source1Failed, boolean_T *rty_source2Failed, boolean_T *rty_source3Failed);
  static void FmgcComputer_MATLABFunction_d_Reset(rtDW_MATLABFunction_FmgcComputer_f4_T *localDW);
  static void FmgcComputer_MATLABFunction_m3(boolean_T rtu_u, real_T rtu_Ts, boolean_T *rty_y, real_T rtp_isRisingEdge,
    real_T rtp_retriggerable, real_T rtp_triggerDuration, rtDW_MATLABFunction_FmgcComputer_f4_T *localDW);
