...
class FmgcComputer final
{
 public:
  ...
  struct D_Work_FmgcComputer_T {
    ...
    boolean_T Memory_PreviousInput_ed;
    ...
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_odc;
    ...
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_bsj;
    ...
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_de;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_bsi;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_od;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_fbp;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_ju;
    rtDW_MATLABFunction_FmgcComputer_c_T sf_MATLABFunction_ae;
    rtDW_MATLABFunction_FmgcComputer_k_T sf_MATLABFunction_jym;
    rtDW_MATLABFunction_FmgcComputer_f_T sf_MATLABFunction_eg;
  ...
  struct Parameters_FmgcComputer_T {
    ...
    real_T ConfirmNode_timeDelay_fz;
    ...
    real_T MTrigNode_triggerDuration_ca;
    ...
    real32_T CompareToConstant_const_fz;
    ...
    boolean_T PulseNode_isRisingEdge_mk;
