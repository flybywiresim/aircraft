...
void Autothrust::step()
{
  ...
  rtb_Switch_m = std::sin(Phi_rad);
  Phi_rad = std::cos(Phi_rad);
  result_tmp[0] = Theta_rad;
  result_tmp[3] = 0.0;
  result_tmp[6] = -rtb_Saturation;
  result_tmp[1] = rtb_Switch_m * rtb_Saturation;
  result_tmp[4] = Phi_rad;
  result_tmp[7] = Theta_rad * rtb_Switch_m;
  result_tmp[2] = Phi_rad * rtb_Saturation;
  result_tmp[5] = 0.0 - rtb_Switch_m;
  result_tmp[8] = Phi_rad * Theta_rad;
  for (i = 0; i < 3; i++) {
  ...
  Phi_rad = Autothrust_P.Gain1_Gain_n * Autothrust_U.in.data.gear_strut_compression_2 - Autothrust_P.Constant1_Value;
  ...
  Autothrust_DWork.Memory_PreviousInput_m = Autothrust_P.Logic_table_m[(((Autothrust_U.in.time.simulation_time -
    Autothrust_DWork.eventTime_l >= Autothrust_P.CompareToConstant2_const) + (static_cast<uint32_T>
  ...
  rtb_BusAssignment_e_output_is_in_reverse_1 = ((Autothrust_U.in.input.flex_temperature_degC >
    ...
    (Autothrust_U.in.input.flight_phase < 3.0) && (rtb_on_ground != 0));
  Autothrust_DWork.latch = ((rtb_BusAssignment_e_output_is_in_reverse_1 && (Autothrust_U.in.input.TLA_1_deg == 35.0) &&
  ...
  rtb_y_o = (rtb_BusAssignment_e_output_is_in_reverse_1 || ((rtb_on_ground == 0) && Autothrust_DWork.latch));
  ...
  rtb_BusAssignment_n.data_computed.ATHR_push = (Autothrust_DWork.Delay_DSTATE_as &&
    (!Autothrust_DWork.Memory_PreviousInput_m));
  ...
  Phi_rad = Autothrust_U.in.time.simulation_time - Autothrust_DWork.eventTime_p;
  ATHR_ENGAGED_tmp = !Autothrust_DWork.ATHR_ENGAGED;
  rtb_r_g = !Autothrust_U.in.input.ATHR_disconnect;
  Autothrust_DWork.ATHR_ENGAGED = ((condition_AP_FD_ATHR_Specific && (((rtb_on_ground == 0) && ATHR_ENGAGED_tmp &&
    ...
    Autothrust_U.in.input.is_LAND_mode_active) && rtb_r_g && ((Phi_rad < 0.3) || (Phi_rad >= 0.5)) &&
  ...
  if (status == athr_status::DISENGAGED) {
  ...
  } else if ((status == athr_status::ENGAGED_ARMED) && rtb_y_o && (Phi_rad == 35.0)) {
    ...
    if ((status == athr_status::ENGAGED_ACTIVE) && (Autothrust_U.in.input.mode_requested == 3.0) &&
      ...
      if ((status == athr_status::ENGAGED_ACTIVE) && (Autothrust_U.in.input.mode_requested == 3.0) && ((condition_TOGA &&
      ...
      } else if ((status == athr_status::ENGAGED_ARMED) && ((condition_TOGA && (Phi_rad > 25.0) && (Phi_rad < 35.0)) ||
  ...
  Autothrust_DWork.condition_THR_LK = (((status == athr_status::DISENGAGED) && (Autothrust_DWork.pStatus != athr_status::
    DISENGAGED) && rtb_r_g && ((condition_TOGA && (Autothrust_U.in.input.TLA_1_deg == 25.0) &&
    ...
    (Autothrust_U.in.input.TLA_1_deg <= 35.0)))) || (((!Autothrust_DWork.condition_THR_LK) || ((status == athr_status::
    DISENGAGED) && ((Autothrust_U.in.input.TLA_1_deg == 25.0) || (Autothrust_U.in.input.TLA_2_deg == 25.0) ||
  ...
  cUseAutoThrustControl = ((status == athr_status::ENGAGED_ACTIVE) && (((Autothrust_U.in.input.TLA_1_deg <= 35.0) &&
  ...
  Autothrust_DWork.pThrustMemoActive = ((((Autothrust_U.in.input.ATHR_push && (status != athr_status::DISENGAGED)) ||
    (pThrustMemoActive_tmp && Autothrust_DWork.pUseAutoThrustControl && rtb_r_g)) && ((condition_TOGA &&
  ...
  if ((!Autothrust_U.in.input.tracking_mode_on_override) > Autothrust_P.Switch2_Threshold) {
    if (Autothrust_U.in.input.mode_requested > Autothrust_P.Saturation_UpperSat_l) {
      rtb_Switch2 = Autothrust_P.Saturation_UpperSat_l;
    } else if (Autothrust_U.in.input.mode_requested < Autothrust_P.Saturation_LowerSat_i) {
      rtb_Switch2 = Autothrust_P.Saturation_LowerSat_i;
    } else {
      rtb_Switch2 = Autothrust_U.in.input.mode_requested;
    }
  } else {
    rtb_Switch2 = Autothrust_P.Constant1_Value_k;
  }
  ...
  rtb_Y_e = result[i] - Autothrust_U.in.data.V_ias_kn;
  rtb_y_cq = Autothrust_P.Gain1_Gain_n0 * rtb_Gain2;
  ...
  Autothrust_LeadLagFilter(rtb_Switch_m - Autothrust_P.g_Gain * (Autothrust_P.Gain1_Gain_c * (Autothrust_P.Gain_Gain_j *
    ((rtb_y_cq - Autothrust_P.Gain1_Gain_j * (Autothrust_P.Gain_Gain_c * std::atan(Autothrust_P.fpmtoms_Gain *
  ...
  rtb_Switch_m = (rtb_Switch_dx + rtb_Switch_m) * Autothrust_P.mpstokts_Gain * Autothrust_P.Gain4_Gain * look1_binlxpw
    (rtb_Y_e, Autothrust_P.ScheduledGain1_BreakpointsForDimension1, Autothrust_P.ScheduledGain1_Table, 4U) + rtb_Y_e;
  rtb_Cos = Autothrust_P.DiscreteDerivativeVariableTs_Gain * rtb_Switch_m;
  Autothrust_LagFilter((rtb_Cos - Autothrust_DWork.Delay_DSTATE) / Autothrust_U.in.time.dt, Autothrust_P.LagFilter_C1,
                       Autothrust_U.in.time.dt, &rtb_Y_e, &Autothrust_DWork.sf_LagFilter);
  Autothrust_LagFilter(Autothrust_U.in.data.nz_g, Autothrust_P.LagFilter1_C1, Autothrust_U.in.time.dt, &rtb_y_cq,
                       &Autothrust_DWork.sf_LagFilter_a);
  rtb_Gain2 = rtb_y_cq - std::cos(Autothrust_P.Gain1_Gain_p1 * rtb_Gain2) / std::cos(Autothrust_P.Gain1_Gain_di *
    rtb_Gain3);
  ...
  switch (static_cast<int32_T>(rtb_Switch2)) {
   case 0:
    rtb_Switch_m = Autothrust_P.Constant1_Value_k;
    break;

   case 1:
    rtb_Switch_m = ((Autothrust_P.Gain_Gain * rtb_Switch_m + rtb_Y_e) + (Autothrust_P.Gain1_Gain * rtb_Gain2 +
  ...
  rtb_r_g = (mode == Autothrust_P.CompareToConstant2_const_c);
  condition_TOGA = (mode == Autothrust_P.CompareToConstant3_const_k);
  Autothrust_DWork.icLoad = ((status != Autothrust_P.CompareToConstant_const_d) || (rtb_r_g || condition_TOGA) ||
  ...
  condition_TOGA = !rtb_BusAssignment_e_output_is_in_reverse_1;
  if (condition_TOGA) {
  ...
  Autothrust_MATLABFunction(rtb_Gain3 - Autothrust_U.in.data.engine_N1_2_percent, &rtb_Switch_dx, &rtb_r_g);
  if (rtb_r_g) {
  ...
  rtb_y_cq = Autothrust_P.Gain_Gain_b * rtb_Switch_dx * Autothrust_P.DiscreteTimeIntegratorVariableTs_Gain_k *
    Autothrust_U.in.time.dt + Autothrust_DWork.Delay_DSTATE_lz;
  if (rtb_y_cq > Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_p) {
    Autothrust_DWork.Delay_DSTATE_lz = Autothrust_P.DiscreteTimeIntegratorVariableTs_UpperLimit_p;
  } else if (rtb_y_cq < Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_e) {
    Autothrust_DWork.Delay_DSTATE_lz = Autothrust_P.DiscreteTimeIntegratorVariableTs_LowerLimit_e;
  } else {
    Autothrust_DWork.Delay_DSTATE_lz = rtb_y_cq;
  }
  ...
  Autothrust_ThrustMode1(Autothrust_U.in.input.TLA_2_deg, &rtb_y_cq);
  ...
  Autothrust_Y.out.output.sim_thrust_mode_2 = rtb_y_cq;
  ...
  if ((status != athr_status::DISENGAGED) && (Autothrust_DWork.pMode != athr_mode::A_FLOOR) && (Autothrust_DWork.pMode
       != athr_mode::TOGA_LK) && (rtb_on_ground == 0) && (condition_TOGA || (Autothrust_U.in.input.is_TCAS_active &&
    ...
    Autothrust_Y.out.output.mode_message = athr_mode_message::LVR_CLB;
             ...
             (Autothrust_DWork.pMode != athr_mode::TOGA_LK) && (rtb_on_ground == 0) && condition_TOGA &&
