...
void FmgcComputer::step()
{
  ...
  boolean_T rtb_y_p;
  boolean_T rtb_y_p3;
  athr_fma_message rtb_y_bf;
  athr_fma_mode rtb_y_mi;
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    if (!FmgcComputer_DWork.Runtime_MODE) {
      ...
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_bj);
    ...
    rtb_y_kb = ((FmgcComputer_U.in.discrete_inputs.eng_opp_stop && FmgcComputer_U.in.discrete_inputs.eng_own_stop &&
                 rtb_y_h) || rtb_y_p3);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
    ...
    raOwnInvalid = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_y_os) || rtb_AND_nk) &&
    ...
    rtb_y_aj = !FmgcComputer_P.Constant1_Value.fac_speeds_failure;
    rtb_y_j5 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active;
    rtb_OR_ko = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active;
    raOppInvalid = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || rtb_AND_nk) && (rtb_y_aj ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (rtb_ap_fd_condition_tmp_0 || (rtb_OR_fz && rtb_y_j5
    ...
    FmgcComputer_MATLABFunction_k(FmgcComputer_U.in.discrete_inputs.fcu_ap_button, FmgcComputer_P.PulseNode_isRisingEdge,
      &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_il);
    ...
    rtb_y_g1 = !raOwnInvalid;
    fdOppOff = (rtb_y_g1 || (!raOppInvalid) || (!rtb_NOT3));
    rtb_fmgcOppPriority = !FmgcComputer_U.in.discrete_inputs.is_unit_1;
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((fdOppOff || (rtb_y_bo &&
      ...
      FmgcComputer_P.CompareToConstant5_const))) || (rtb_y_ft && rtb_y_h)) + (static_cast<uint32_T>(rtb_y_bo &&
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_y_kb && raOppInvalid && raOwnInvalid && rtb_NOT3) << 1)) << 1) +
    ...
    low_i = static_cast<int32_T>((((static_cast<uint32_T>(rtb_y_bo && FmgcComputer_DWork.Memory_PreviousInput) << 1) +
    ...
    FmgcComputer_MATLABFunction_k(rtb_y_p3, FmgcComputer_P.PulseNode1_isRisingEdge_h, &rtb_y_aq,
    ...
    FmgcComputer_MATLABFunction_k((rtb_y_ft && (rtb_y_gl < FmgcComputer_P.CompareToConstant1_const)),
      FmgcComputer_P.PulseNode2_isRisingEdge_n, &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_d4);
    ...
    rtb_y_aj = ((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active ||
                 FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_g1) && rtb_ap_fd_condition_tmp && rtb_y_aj);
    rtb_ap_fd_condition_tmp = (rtb_y_g1 || (!rtb_y_aj));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(raOwnInvalid && rtb_y_aj &&
      ((rtb_Compare_bj && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_y_aq || rtb_y_hq)) << 1) +
      ...
      (!rtP_fmgc_ap_fd_logic_output_MATLABStruct.lateral_modes.land_active)) ||
       FmgcComputer_U.in.discrete_inputs.athr_instinctive_disc || rtb_y_bo)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_p];
    rtb_fmgcOppPriority_tmp = !rtb_Logic_a2[0];
    rtb_y_g1 = !fdOwnOff;
    rtb_y_aj = !FmgcComputer_DWork.Delay_DSTATE_k;
    ...
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_y_g1) && (rtb_y_ft || rtb_y_aj) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_ft || rtb_y_g1) && (rtb_OR2_l || rtb_y_aj) &&
    ...
    rtb_y_g1 = (rtb_fmgcOppPriority && (rtb_fmgcOppPriority_tmp || rtb_y_p3));
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_m, &rtb_y_lt);
    ...
    if (rtb_y_lt > rtb_y_gl) {
      rtb_y_aq = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft < rtb_y_lt) &&
    ...
    rtb_OR2_l = ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed ||
                 ...
                 (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != 0.0) && rtb_y_aq);
    if (rtb_OR2_l) {
      rtb_altCstrOrFcu = FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft;
    } else {
      rtb_altCstrOrFcu = rtb_y_lt;
    }
    ...
    rtb_NOT1_j = (rtb_y_gl < FmgcComputer_P.CompareToConstant3_const_n);
    rtb_NOT3 = !rtb_NOT1_j;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_nw);
    rtb_y_nw = (rtb_NOT1_j && (rtb_y_gl > FmgcComputer_P.CompareToConstant4_const) && rtb_y_nw);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b, &rtb_y_gl);
    rtb_NOT1_j = (rtb_y_gl < FmgcComputer_P.CompareToConstant5_const_a);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_e2);
    FmgcComputer_MATLABFunction_k((rtb_NOT3 || rtb_y_nw || (!rtb_NOT1_j) || (rtb_NOT1_j && (rtb_y_gl >
      FmgcComputer_P.CompareToConstant6_const) && rtb_y_e2)), FmgcComputer_P.PulseNode_isRisingEdge_p, &rtb_y_aq,
    ...
    rtb_y_e2 = (rtb_Compare_dw || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
    ...
    rtb_y_p = (rtb_y_e2 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active);
    FmgcComputer_DWork.Memory_PreviousInput_k = FmgcComputer_P.Logic_table_b[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_p ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_aq))) + (static_cast<uint32_T>(rtb_NOT3) <<
    ...
    rtb_NOT1_j = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_kh(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active,
      ...
      &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_ngt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_f4_logic_ils_computation_data_runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_m, &rtb_y_lt);
    ...
    rtb_DataTypeConversion2_kb = std::abs(rtb_y_lt - rtb_y_gl);
    ...
    rtb_NOT3 = ((rtb_NOT1_j && (rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active) && ((rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_cq) && rtb_y_aq && (rtb_DataTypeConversion2_kb <=
    ...
    FmgcComputer_MATLABFunction_kh(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_l,
      FmgcComputer_P.ConfirmNode_timeDelay_f, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_jl);
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg,
      &rtb_Compare_bj);
    FmgcComputer_DWork.Memory_PreviousInput_c = FmgcComputer_P.Logic_table_hz[(((((!rtb_y_aq) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_trk_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp || (!rtb_Compare_bj)) + (
    ...
    FmgcComputer_MATLABFunction_j((rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_l),
      FmgcComputer_U.in.time.dt, &rtb_y_aq, FmgcComputer_P.MTrigNode_isRisingEdge_j,
    ...
    FmgcComputer_MATLABFunction_kh(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hu,
      FmgcComputer_P.ConfirmNode_timeDelay_j, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_kz1);
    FmgcComputer_DWork.Memory_PreviousInput_b = FmgcComputer_P.Logic_table_d[(((((!rtb_y_aq) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_NOT3) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_b];
    ...
    rtb_y_f = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1);
    ...
    FmgcComputer_MATLABFunction_kh(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_f, FmgcComputer_P.ConfirmNode_timeDelay_d, &rtb_y_aq,
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_own_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_f, &rtb_y_hy);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_c, &rtb_y_lt);
    ...
    rtb_NOT1_n_tmp = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active;
    rtb_NOT1_n_tmp_0 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active;
    rtb_TmpSignalConversionAtSFunctionInport3_idx_2 =
      !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active;
    rtb_NOT1_j = (rtb_ap_fd_condition_tmp_1 && (rtb_y_f || (rtb_y_nw && (FmgcComputer_P.Constant_Value_l && rtb_y_ed &&
      (rtb_y_hq || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_g)) && rtb_ap_fd_condition_tmp_0 &&
      rtb_y_bo && (!rtb_y_aq) && (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 &&
      (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed))) && rtb_appInop_idx_1 && rtb_OR2_l_tmp &&
      rtb_NOT1_n_tmp && rtb_NOT1_n_tmp_0 && rtb_Compare_bj && rtb_Compare_bj && (((rtb_y_m == rtb_y_hy) && (rtb_y_lt ==
    ...
    rtb_OR4_e = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    rtb_y_n5 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    ...
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_j, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_eb2);
    rtb_AND8 = (rtb_y_n5 && rtb_y_aq);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_l, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_c, &rtb_y_aq,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_AND_nk || ((!rtb_OR4_e) &&
      (!rtb_y_n5) && FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed) || ((rtb_OR4_e && rtb_Compare_bj) ||
      rtb_AND8) || (rtb_y_bo && FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed) || rtb_y_aq ||
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_NOT1_j) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction_kh((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_d),
      ...
      &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_cr);
    rtb_AND_nk = (rtb_Compare_bj && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active && rtb_y_aq)));
    FmgcComputer_MATLABFunction_kh(rtb_AND_nk, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_d,
      FmgcComputer_P.ConfirmNode_timeDelay_a, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_op);
    rtb_y_bo = !rtb_y_aq;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_f, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_a, &rtb_y_aq,
    ...
    rtb_AND8 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active);
    rtb_Logic_d_idx_0_tmp = (rtb_AND8 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    rtb_Logic_d_idx_0_tmp_0 = (rtb_Logic_d_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_y_p ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active || (rtb_Logic_d_idx_0_tmp_0 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active)) && rtb_y_bo) ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || (rtb_fmgcOppPriority_tmp && rtb_y_p3 &&
      rtb_y_aq && rtb_Compare_bj) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_AND_nk) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay2_DSTATE.flare_law.condition_Flare &&
      ...
      FmgcComputer_P.ConfirmNode1_isRisingEdge_d, FmgcComputer_P.ConfirmNode1_timeDelay_dj, &rtb_y_bo,
      &FmgcComputer_DWork.sf_MATLABFunction_j2);
    FmgcComputer_DWork.Memory_PreviousInput_bc = FmgcComputer_P.Logic_table_bp[(((static_cast<uint32_T>(rtb_y_bo) << 1)
    ...
    rtb_NOT1_j = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1);
    rtb_y_bs = (rtb_y_hq || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_lj) || rtb_dualRaFailure);
    FmgcComputer_MATLABFunction_kh(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed,
      ...
      &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_pu);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    rtb_y_p = (rtb_y_nw && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid);
    rtb_y_f = (rtb_y_p && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && FmgcComputer_P.Constant_Value_hg &&
               rtb_y_bs && rtb_OR_fz && (rtb_appInop_idx_1 && rtb_NOT1_n_tmp && rtb_OR2_l_tmp && rtb_NOT1_n_tmp_0 &&
                rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && (!rtb_y_aq) && rtb_y_hq));
    rtb_OR4_e = (rtb_ap_fd_condition_tmp_1 && (rtb_NOT1_j || rtb_y_f));
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_k, &rtb_y_aq,
    ...
    rtb_y_a = !FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid;
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c
      [(((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_a || rtb_y_aq || (rtb_y_hq &&
           FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed) || rtb_y_f || rtb_Logic_gj_idx_0_tmp) + (
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    low_i = static_cast<int32_T>((((rtb_Logic_gj_idx_0_tmp || ((rowIdx_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
    ...
    FmgcComputer_MATLABFunction_kh(rtb_y_h, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_m,
      FmgcComputer_P.ConfirmNode_timeDelay_j5, &rtb_y_bs, &FmgcComputer_DWork.sf_MATLABFunction_hvs);
    rtb_y_f = (rtb_handleIndex >= FmgcComputer_P.CompareToConstant_const_j);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
    ...
    FmgcComputer_MATLABFunction_k((rtb_Compare_bj || (rtb_y_gl >= FmgcComputer_P.CompareToConstant5_const_k)),
      FmgcComputer_P.PulseNode_isRisingEdge_c, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_fn);
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_OR_o_tmp && (!rtb_y_bs) && rtb_y_f &&
      rtb_y_aq));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hj,
      FmgcComputer_P.ConfirmNode_timeDelay_a3, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_lm);
    FmgcComputer_DWork.Memory_PreviousInput_i = FmgcComputer_P.Logic_table_o[((((rtb_Logic_gj_idx_0_tmp || (rtb_y_e2 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) && (!rtb_y_aq)) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_P.PulseNode_isRisingEdge_f, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_pn);
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw && (rtb_NOT1_n_tmp_0 &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active) && rtb_y_aq)));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_mf,
      FmgcComputer_P.ConfirmNode_timeDelay_dw, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_mtz);
    FmgcComputer_DWork.Memory_PreviousInput_e = FmgcComputer_P.Logic_table_c2[(((rtb_Logic_gj_idx_0_tmp ||
    ...
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode3_isRisingEdge_l, &rtb_y_f,
      &FmgcComputer_DWork.sf_MATLABFunction_gb);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel4_bit_k, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_y_aq,
    ...
    rtb_OR_fz = (rtb_NOT1_n_tmp && rtb_NOT1_n_tmp_0);
    rtb_Compare_bj = (rtb_y_n5 && rtb_y_f && (rtb_OR_fz && rtb_TmpSignalConversionAtSFunctionInport3_idx_0 &&
      rtb_ap_fd_condition_tmp_1) && (!rtb_y_aq));
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed ||
      ...
      &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_aj);
    rtb_OR_o_tmp = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active;
    rtb_NOT1_n_tmp = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active;
    rtb_y_bo = (rtb_y_aq && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && (rtb_OR_fz && rtb_OR_o_tmp &&
      rtb_NOT1_n_tmp && rtb_ap_fd_condition_tmp_1));
    rtb_OR4_e = rtb_y_n5;
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_b, &rtb_y_aq,
    ...
    rtb_Compare_bj = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_Compare_ji_tmp &&
                       rtb_TmpSignalConversionAtSFunctionInport3_idx_2) || rtb_Compare_bj || rtb_y_bo || (rtb_y_n5 &&
      rtb_OR4_g && rtb_y_aq) || (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_i, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_di2);
    rtb_NOT1_j = (rtb_y_kb && rtb_y_aq && rtb_ap_fd_condition_tmp_1 && (rtb_NOT1_n_tmp_0 || (rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_a)));
    rtb_y_f = rtb_OR_pj;
    FmgcComputer_MATLABFunction_k(rtb_y_ft, FmgcComputer_P.PulseNode4_isRisingEdge_e, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_a5);
    rtb_y_bs = ((!FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged) && rtb_OR2_l_tmp);
    rtb_OR_fz = ((rtb_y_bo && rtb_y_g1) || (rtb_y_nw && (rtb_NOT1_j || (rtb_OR_pj && rtb_y_aq && rtb_y_bs) ||
      rtb_Compare_bj)));
    FmgcComputer_MATLABFunction_kh(rtb_OR_fz, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_a,
      FmgcComputer_P.ConfirmNode_timeDelay_a2, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_hdw);
    FmgcComputer_DWork.Memory_PreviousInput_f2 = FmgcComputer_P.Logic_table_i[(((((!rtb_y_aq) && (rtb_Logic_d_idx_0_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_OR_fz) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_f2];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_k(FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid,
      FmgcComputer_P.PulseNode3_isRisingEdge_e, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_hu);
    rtb_y_hq = ((!rtP_fmgc_ap_fd_logic_output_MATLABStruct.any_lateral_mode_engaged) ||
                FmgcComputer_DWork.Memory_PreviousInput_c);
    rtb_NOT1_j = rtb_y_hq;
    rtb_OR4_e = (rtb_y_h && (((!rtb_y_bo) && (!rtb_OR4_e)) || rtb_y_aq) && rtb_y_hq);
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Memory_PreviousInput_dv, FmgcComputer_P.PulseNode4_isRisingEdge_b,
      &rtb_NOT1_j, &FmgcComputer_DWork.sf_MATLABFunction_id);
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_P.PulseNode7_isRisingEdge, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_bj);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_bo);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_bs);
    rtb_y_bo = (rtb_y_bo || rtb_y_bs);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_g1) || (rtb_y_p && ((rtb_OR_o_tmp && rtb_NOT1_n_tmp &&
      rtb_ap_fd_condition_tmp_1 && rtb_y_f) || rtb_OR4_e || rtb_NOT1_j || (rtb_y_aq && (!rtb_y_bo)))));
    FmgcComputer_MATLABFunction_k(rtb_y_bo, FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_f,
    ...
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      ...
      FmgcComputer_P.PulseNode6_isRisingEdge, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_jd);
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Memory_PreviousInput_dv, FmgcComputer_P.PulseNode5_isRisingEdge_a,
      &rtb_NOT1_j, &FmgcComputer_DWork.sf_MATLABFunction_ew);
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_f || rtb_y_bs || rtb_y_aq ||
      rtb_Compare_ji_tmp || rtb_NOT1_j || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_Compare_bj) << 1)) << 1) +
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw &&
      ...
      FmgcComputer_P.CompareToConstant_const_oh) || rtb_dualRaFailure) && (rtb_NOT1_n_tmp_0 || (rtb_raComputationData >=
    ...
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_co,
      FmgcComputer_P.ConfirmNode_timeDelay_d1, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_ge4);
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((rtb_Compare_ji_tmp ||
      rtb_Logic_gj_idx_0_tmp || ((rtb_Logic_d_idx_0_tmp_0 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) &&
      (!rtb_y_aq))) + (static_cast<uint32_T>(rtb_Compare_bj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ip];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_o, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_k4c);
    rtb_OR4_e = rtb_y_ed;
    rtb_y_ed = (rtb_y_aq && rtb_y_ed && (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_m) &&
    ...
    rtb_OR4_g = (rtb_OR4_g && rtb_y_aq && FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed);
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed,
      FmgcComputer_P.PulseNode3_isRisingEdge_d, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_mne);
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_OR4_e) && rtb_y_bo) ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_OR4_g || rtb_y_aq) + (static_cast<
      uint32_T>((rtb_Compare_bj && rtb_y_g1) || (rtb_y_nw && (rtb_y_p || rtb_y_ed))) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_o, &rtb_y_hy);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_k_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o, &rtb_y_lt);
    ...
    if (low_i == high_i) {
      ...
      if (rtb_DataTypeConversion1_d > 5.0) {
        if (std::abs(rtb_y_lt) <= 5.0F) {
          rtb_Compare_bj = true;
        } else {
          if (rtb_y_lt < 0.0F) {
            low_ip1 = -1;
          } else {
            low_ip1 = (rtb_y_lt > 0.0F);
          }
      ...
      if (guard1) {
        ...
        rtb_Compare_bj = ((rtb_DataTypeConversion1_d >= std::abs(rtb_y_lt)) && (high_i == low_ip1));
      }
    } else {
    ...
    if (rtb_DataTypeConversion2_kb < 115.0F) {
      rtb_y_lt = std::abs(rtb_y_hy);
      if (rtb_y_hy < 0.0F) {
        high_i = -1;
      } else {
        high_i = (rtb_y_hy > 0.0F);
      }

      if (((rtb_DataTypeConversion2_kb > 25.0F) && ((rtb_y_lt < 10.0F) && ((low_i != high_i) && rtb_Compare_bj))) ||
          (rtb_y_lt < 1.92)) {
        rtb_Compare_bj = (rtb_Compare_bj || ((rtb_DataTypeConversion2_kb < 15.0F) && (rtb_y_lt < 1.1)));
      } else {
        rtb_Compare_bj = false;
      }
    } else {
    ...
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_at,
      FmgcComputer_P.ConfirmNode_timeDelay_h4, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_p4);
    rtb_y_bo = (rtb_AND8 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active);
    FmgcComputer_DWork.Memory_PreviousInput_cv = FmgcComputer_P.Logic_table_g4[(((((!rtb_y_aq) && (rtb_y_bo ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction_kh((rtb_DataTypeConversion1_d < FmgcComputer_P.CompareToConstant1_const_n),
      ...
      &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_is);
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active && rtb_y_aq));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ea,
      FmgcComputer_P.ConfirmNode_timeDelay_es, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_pr);
    FmgcComputer_DWork.Memory_PreviousInput_lq = FmgcComputer_P.Logic_table_j[(((((!rtb_y_aq) && (rtb_y_bo ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
    ...
    rtb_DataTypeConversion2_kb = rtb_y_gl - rtb_y_m;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_j, &rtb_y_hy);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jm, &rtb_y_lt);
    ...
    rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s.Data =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_Data;
    if (rtb_DataTypeConversion2_kb < 0.0F) {
      rtb_y_aq = (rtb_y_lt <= 0.0F);
    } else {
      rtb_y_aq = ((rtb_DataTypeConversion2_kb > 0.0F) && (rtb_y_lt >= 0.0F));
    }

    rtb_OR4_g = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active) && rtb_y_j5 && rtb_OR_ko &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_ap_fd_condition_tmp_1 && ((!rtb_y_aq) ||
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_h, &rtb_y_lt);
    rtb_y_gl = std::abs(rtb_y_lt);
    high_i = 7;
    low_i = 0;
    low_ip1 = 2;
    ...
    if (rtb_y_lt < 0.0F) {
      ...
      high_i = (rtb_y_lt > 0.0F);
    }

    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_g1) || (rtb_y_nw &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed && (!rtb_y_aq) && ((std::fmin(3000.0F, std::fmax(80.0F,
      rtb_y_hy * rtb_y_hy / ((((rtb_DataTypeConversion2_kb * static_cast<real32_T>(c[low_i]) + static_cast<real32_T>
      ...
      (rtb_OR2_l_tmp && rtb_appInop_idx_1))));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_hux, FmgcComputer_P.ConfirmNode_timeDelay_lk, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_hw);
    FmgcComputer_DWork.Memory_PreviousInput_ne = FmgcComputer_P.Logic_table_nz[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_p3 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
    ...
    FmgcComputer_MATLABFunction_kh((std::abs(rtb_altCstrOrFcu - rtb_y_gl) < FmgcComputer_P.CompareToConstant_const_f),
      ...
      &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_ee);
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && rtb_y_aq));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lj,
      FmgcComputer_P.ConfirmNode_timeDelay_b, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_dt);
    FmgcComputer_DWork.Memory_PreviousInput_cb = FmgcComputer_P.Logic_table_ob[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_Compare_dw || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
    ...
    rtb_y_aq = !FmgcComputer_DWork.Delay_DSTATE.any_longitudinal_mode_engaged;
    rtb_y_bo = rtb_y_aq;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mr, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oi, &rtb_y_gl);
    rtb_DataTypeConversion2_bh = rtb_y_lt - rtb_y_gl;
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_o3_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue, &rtb_y_lt);
    ...
    rtb_y_p = (rtb_y_lt > rtb_y_gl + FmgcComputer_P.Bias1_Bias);
    rtb_y_p3 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_NOT1_j = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    rtb_NOT1_n_tmp_0 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && rtb_OR_o_tmp && rtb_NOT1_n_tmp);
    rtb_Compare_bj = ((rtb_OR_pj && rtb_y_ed && rtb_y_aq) || rtb_AND8 ||
      ...
      ((FmgcComputer_P.EnumeratedConstant_Value_p == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant2_Value) || rtb_NOT1_n_tmp_0 ||
       rtb_y_a)) || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && (std::abs(FmgcComputer_B.u_ly
      - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_om)) || (rtb_y_p3 && (rtb_DataTypeConversion2_bh >
      FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_NOT1_j && (rtb_DataTypeConversion2_bh <
      FmgcComputer_P.CompareToConstant2_const_g)) || ((rtb_y_p3 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (rtb_DataTypeConversion2_kb > rtb_y_lt) &&
      rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k) || (rtb_NOT1_j && rtb_y_p && rtb_fmgcOppPriority_tmp
    ...
    FmgcComputer_MATLABFunction_k((rtb_NOT1_j || (rtb_DataTypeConversion1_e != 0U)),
      FmgcComputer_P.PulseNode_isRisingEdge_d, &rtb_y_f, &FmgcComputer_DWork.sf_MATLABFunction_nd);
    rtb_NOT1_j = (rtb_y_kb && rtb_y_f && rtb_ap_fd_condition_tmp_1);
    ...
    rtb_y_bo = ((rtb_y_bo && rtb_y_g1) || (rtb_y_nw && (rtb_NOT1_j || (rtb_OR_pj && rtb_y_p && rtb_y_aq) ||
      rtb_Compare_bj)));
    FmgcComputer_MATLABFunction_kh(rtb_y_bo, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lu,
      FmgcComputer_P.ConfirmNode_timeDelay_ll, &rtb_NOT1_j, &FmgcComputer_DWork.sf_MATLABFunction_gbq);
    FmgcComputer_DWork.Memory_PreviousInput_fg = FmgcComputer_P.Logic_table_ny[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_AND_e_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_NOT1_j))) + (static_cast<uint32_T>(rtb_y_bo)
    ...
    rtb_Compare_bj = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_et, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oj, &rtb_y_gl);
    rtb_y_f = (rtb_y_lt > rtb_y_gl);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_px, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_b, &rtb_y_aq,
    ...
    rtb_OR4_e = (rtb_OR_pj && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_f && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_bo || (rtb_y_aq &&
      rtb_AND_e_tmp && (rtb_OR2_l && (std::abs(rtb_altCstrOrFcu - rtb_y_gl) <= FmgcComputer_P.CompareToConstant2_const_d)))));
    rtb_NOT1_j = (rtb_y_h || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jt, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_os, &rtb_y_gl);
    rtb_y_p = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_NOT1_j && (!rtb_y_f)) || (rtb_y_p
      || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) || (rtb_y_lt < rtb_y_gl) || (rtb_AND_e_tmp &&
      (rtb_Compare_ji_tmp || rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_a)) ||
      ((FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant3_Value) ||
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant4_Value)) ||
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>((rtb_Compare_bj && rtb_y_g1) || (rtb_y_nw && (rtb_OR4_e ||
      (rtb_NOT1_j && rtb_y_f)))) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ma];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_bj = (rtb_Compare_bj && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_h, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_n, &rtb_y_gl);
    rtb_NOT1_j = (rtb_y_lt > rtb_y_gl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    FmgcComputer_MATLABFunction_k((rtb_y_gl > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode_isRisingEdge_bg, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_df);
    rtb_y_bs = (rtb_y_aq || (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_j4,
      &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_dd);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_TmpSignalConversionAtSFunctionInport3_idx_1 = (rtb_y_nw &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible && rtb_y_kb);
    rtb_OR_o_tmp = !rtb_AND_e_tmp;
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_g1) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 &&
      (rtb_ap_fd_condition_tmp_1 && rtb_OR_ko) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_NOT1_j &&
      ...
      ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed && rtb_y_bs) || (rtb_y_aq && (rtb_OR_o_tmp ||
    ...
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_fc,
      FmgcComputer_P.ConfirmNode_timeDelay_nn, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_ir);
    rtb_y_hq = (rowIdx_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_ec = FmgcComputer_P.Logic_table_kw[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_hq ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_Compare_bj = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_nh, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_g1) || (rtb_y_nw && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant1_Value_c) && (FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant2_Value_pi) && rtb_NOT1_j && rtb_appCapability_idx_0 &&
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_cj, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he[(((rtb_y_p ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active || (rtb_y_lt > rtb_y_gl) || rtb_NOT1_n_tmp_0 ||
      ((FmgcComputer_P.EnumeratedConstant_Value_b == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant6_Value)) || rtb_y_a ||
      (rtb_AND_e_tmp && rtb_Compare_ji_tmp) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_Compare_bj) << 1)) <<
    ...
    rtb_Compare_bj = (rtb_Compare_bj && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mo, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_fq,
      &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_kd);
    rtb_y_ed = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.des_armed;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_m, &rtb_y_gl);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_g1) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && (rtb_OR_ko &&
      rtb_ap_fd_condition_tmp_1 && (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active) &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_OR2_l_tmp && rtb_appInop_idx_1) && rtb_appCapability_idx_0 &&
      ...
      (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE_n)) || (rtb_y_aq &&
      (rtb_OR_o_tmp || (rtb_AND_e_tmp && rtb_y_ed && (rtb_Compare_ji_tmp || (std::abs(rtb_altCstrOrFcu - rtb_y_gl) >
    ...
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_j,
      FmgcComputer_P.ConfirmNode_timeDelay_dy, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_n5);
    ...
    rtb_appCapability_idx_0 = (rtb_AND_e_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    FmgcComputer_DWork.Memory_PreviousInput_b3 = FmgcComputer_P.Logic_table_cv[(((rtb_Logic_gj_idx_0_tmp ||
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ht, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_y_bs = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && rtb_y_bs),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_jo, FmgcComputer_P.ConfirmNode_timeDelay_jo,
      &rtb_y_bs, &FmgcComputer_DWork.sf_MATLABFunction_moh);
    rtb_y_f = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
                ((FmgcComputer_P.EnumeratedConstant_Value_c == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                 ...
                 rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_a)) || rtb_y_bs);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_y_bs = (rtb_y_ed || rtb_y_f || (rtb_y_p && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_a)));
    rtb_Compare_ji_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_g1) || (rtb_Compare_ji_tmp && rtb_NOT1_j && rtb_y_bs));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ae = FmgcComputer_P.Logic_table_jq[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_hq ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_OR4_e = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_i, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_y_f = (rtb_y_f || rtb_y_bs);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_g1) || (rtb_Compare_ji_tmp && (rtb_y_lt < rtb_y_gl) && rtb_y_f));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ev = FmgcComputer_P.Logic_table_l[(((rtb_Logic_gj_idx_0_tmp ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw && (rtb_y_f && rtb_y_j5 && rtb_OR_ko))) << 1) +
    ...
    rtb_NOT1_j = (((rtb_DataTypeConversion2_kb < FmgcComputer_DWork.DelayInput1_DSTATE_b) && (rtb_Nosewheel_c <
      FmgcComputer_P.CompareToConstant1_const_n2)) || (rtb_Nosewheel_c < FmgcComputer_P.CompareToConstant2_const_iq));
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_j5);
    rtb_y_bo = (rtb_y_nw && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_y_n5 && rtb_NOT1_j &&
                rtb_y_j5);
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || rtb_y_bo);
    ...
    rtb_y_j5 = (rtb_AND_e_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_nu = FmgcComputer_P.Logic_table_d3[(((((!rtb_y_bo) && (rtb_y_j5 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    rtb_OR_ko = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_nw && rtb_OR4_e &&
    ...
    rtb_y_j5 = FmgcComputer_P.Logic_table_fi[(((((!rtb_y_bo) && (rtb_y_j5 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_OR_ko) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_as];
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_hd, &rtb_y_lj);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pc, &rtb_y_mw);
    ...
    rtb_OR_ko = ((rtb_Compare_bj && (rtb_y_lt < rtb_y_gl + 3.0F) && (rtb_y_m < -rtb_Nosewheel_c)) || (rtb_Compare_bj &&
      (rtb_y_lt > rtb_y_hy - 3.0F) && (rtb_y_m > rtb_Nosewheel_c)));
    FmgcComputer_MATLABFunction_j((rtb_OR_ko || rtb_OR2_l_tmp || rtb_y_p3 || rtb_y_e2), FmgcComputer_U.in.time.dt,
    ...
    FmgcComputer_MATLABFunction_j((rtb_y_e2 || rtb_Compare_bj), FmgcComputer_U.in.time.dt, &rtb_Compare_bj,
    ...
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_aq);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_n5);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_k(((rtb_y_aq || rtb_y_n5 || (rtb_DataTypeConversion1_e != 0U)) && (rtb_y_bo ||
      rtb_Compare_bj)), FmgcComputer_P.PulseNode_isRisingEdge_py, &rtb_NOT1_j, &FmgcComputer_DWork.sf_MATLABFunction_esv);
    ...
    rtb_y_bo = (rtb_NOT1_j && rtb_Compare_bj);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_kh(rtb_Logic_gj_idx_0_tmp, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_nz, FmgcComputer_P.ConfirmNode_timeDelay_a5, &rtb_NOT1_j,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bw = FmgcComputer_P.Logic_table_bs[((((!rtb_Compare_bj) || rtb_OR_fz ||
      apCondition_tmp || FmgcComputer_DWork.Memory_PreviousInput_ip || rtb_OR4_e || rtb_NOT1_j) + (static_cast<uint32_T>
    ...
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1);
    rtb_y_bo = rtb_y_nw;
    FmgcComputer_MATLABFunction_kh(rtb_OR_pj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_b4,
      FmgcComputer_P.ConfirmNode1_timeDelay_h, &rtb_NOT1_j, &FmgcComputer_DWork.sf_MATLABFunction_hjm);
    FmgcComputer_MATLABFunction_k(rtb_NOT1_j, FmgcComputer_P.PulseNode3_isRisingEdge_ko, &rtb_y_bo,
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mh, &rtb_y_lt);
    rtb_y_hq = !FmgcComputer_DWork.Memory_PreviousInput_k;
    rtb_NOT1_j = (FmgcComputer_U.in.fms_inputs.preset_spd_mach_activate && (rtb_y_hq || (rtb_y_gl <= rtb_y_lt)));
    ...
    rtb_y_bs = (rtb_y_hq && rtb_ap_fd_condition_tmp_0 && (!FmgcComputer_DWork.Memory_PreviousInput_nu) && (!rtb_y_j5) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_d));
    rtb_y_aq = (rtb_Compare_bj || (rtb_y_nw && (((FmgcComputer_P.Constant_Value_k !=
      FmgcComputer_DWork.DelayInput1_DSTATE_f) && rtb_OR_pj) || ((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant_const_dy) && rtb_y_bo && rtb_y_bs) || rtb_y_aq || rtb_OR4_e || rtb_NOT1_j ||
      (rtb_y_p && rtb_OR_pj && rtb_y_bs))));
    FmgcComputer_MATLABFunction_kh(rtb_y_aq, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ch,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cu = FmgcComputer_P.Logic_table_kg
      [((((FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active && (!rtb_Compare_bj)) || (rtb_y_h && (rtb_y_bo ||
            rtb_OR4_e))) + (static_cast<uint32_T>(rtb_y_aq) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cu];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_5,
    ...
    FmgcComputer_MATLABFunction_k(rtb_y_bo, FmgcComputer_P.PulseNode2_isRisingEdge_iu, &rtb_NOT1_j,
      &FmgcComputer_DWork.sf_MATLABFunction_ft);
    rtb_NOT1_j = (rtb_y_ft && rtb_NOT1_j);
    rtb_OR4_e = ((rtb_y_f && rtb_y_bo) || (rtb_OR4_e && rtb_y_bo && rtb_y_ft) || rtb_NOT1_j);
    rtb_y_aq = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_k(rtb_y_aq, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_f,
      &FmgcComputer_DWork.sf_MATLABFunction_mrn);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ie, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_jp, &rtb_y_bs,
    ...
    FmgcComputer_MATLABFunction_k((rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active ||
      ...
      FmgcComputer_P.PulseNode4_isRisingEdge_n, &rtb_NOT1_j, &FmgcComputer_DWork.sf_MATLABFunction_lr);
    rtb_y_bo = ((rtb_y_h && rtb_OR4_e) || (rtb_y_f || rtb_y_bs || rtb_NOT1_j));
    rtb_OR4_e = (FmgcComputer_U.in.fms_inputs.v_managed_kts != FmgcComputer_P.CompareToConstant2_const_m);
    rtb_NOT1_j = (FmgcComputer_U.in.fms_inputs.v_2_kts != FmgcComputer_P.CompareToConstant3_const_j);
    rtb_y_bo = (rtb_Compare_bj || (rtb_y_nw && rtb_y_bo && (rtb_OR4_e || rtb_NOT1_j)));
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_c2,
      &rtb_NOT1_j, &FmgcComputer_DWork.sf_MATLABFunction_mw);
    FmgcComputer_DWork.Delay_DSTATE_c = FmgcComputer_P.Logic_table_ap[(((static_cast<uint32_T>
      (((!FmgcComputer_DWork.Delay_DSTATE_c) && rtb_NOT1_j) || FmgcComputer_U.in.fms_inputs.fms_mach_mode_activate ||
       (FmgcComputer_U.in.fms_inputs.preset_spd_mach_activate && (FmgcComputer_U.in.fms_inputs.preset_mach >
      FmgcComputer_P.CompareToConstant1_const_b3))) << 1) + ((rtb_NOT1_j && FmgcComputer_DWork.Delay_DSTATE_c) ||
    ...
    rtb_y_mw = std::pow((std::pow(FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach.Data *
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_4_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_c, &rtb_y_lt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_3_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_j, &rtb_y_hy);
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_i, &rtb_y_lj);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_cz, &rtb_y_m);
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_i) {
      ...
      rtb_Nosewheel_c = rtb_y_lj + static_cast<real_T>(high_i);
      rtb_pfdTarget = rtb_y_m - 5.0;
      if (rtb_y_m - 5.0 > rtb_Nosewheel_c) {
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_h) {
      if (FmgcComputer_DWork.Memory_PreviousInput_d || FmgcComputer_DWork.Memory_PreviousInput_l ||
        ...
        rtb_Switch_e[0] = std::fmax(std::fmax(std::fmax(static_cast<real_T>(rtb_y_gl), static_cast<real_T>(rtb_y_lt)),
          static_cast<real_T>(rtb_y_hy)), FmgcComputer_B.u_l);
      ...
      if (FmgcComputer_DWork.Delay_DSTATE_c) {
        rtb_y_lt = std::sqrt(rtb_y_mw - 1.0F) * 1479.1F;
      } else {
        rtb_y_lt = FmgcComputer_U.in.bus_inputs.fcu_bus.selected_spd_kts.Data;
      }

      rtb_Switch_e[0] = rtb_y_lt;
      rtb_Switch_e[1] = rtb_y_lt;
    }
    ...
    rtb_y_bo = (rtb_appCapability_idx_0 || FmgcComputer_DWork.Memory_PreviousInput_cb ||
                ...
                FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_y_j5 || FmgcComputer_DWork.Memory_PreviousInput_ae ||
    ...
    } else if (FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_y_j5 || FmgcComputer_DWork.Memory_PreviousInput_d) {
    ...
    rtb_Logic_gj_idx_0_tmp = (rtb_NOT3 || FmgcComputer_DWork.Memory_PreviousInput_e ||
      FmgcComputer_DWork.Memory_PreviousInput_cv || FmgcComputer_DWork.Memory_PreviousInput_lq || rtb_OR_fz ||
      apCondition_tmp || FmgcComputer_DWork.Memory_PreviousInput_ip || FmgcComputer_DWork.Memory_PreviousInput_d);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4, &rtb_y_aq);
    rtb_Compare_bj = ((rtb_Compare_bj || ((rtb_DataTypeConversion1_e != 0U) && rtb_y_aq)) &&
                      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged);
    rtb_y_aq = (rtb_Logic_a2[0] && (FmgcComputer_DWork.Memory_PreviousInput_l ||
      FmgcComputer_DWork.Memory_PreviousInput_d));
    rtb_y_n5 = ((!fdOppOff) && (FmgcComputer_U.in.discrete_inputs.fwc_own_valid ||
    ...
    rtb_appInop_idx_1 = (rtb_y_n5 && (!rtb_ap_fd_condition_tmp) && rtb_bothRaValid);
    rtb_y_ed = (FmgcComputer_U.in.discrete_inputs.fwc_own_valid && FmgcComputer_U.in.discrete_inputs.fwc_opp_valid &&
                ...
                rtb_bothRaValid && rtb_BusAssignment_o_logic_both_ils_valid && rtb_adrOppInvalid && rtb_adrOwnInvalid &&
                FmgcComputer_U.in.discrete_inputs.bscu_own_valid && FmgcComputer_U.in.discrete_inputs.bscu_opp_valid &&
                rtb_irOwnInvalid);
    rtb_appCapability_idx_2 = (FmgcComputer_DWork.pLand3FailOp || (rtb_y_ed && rtb_y_aq && rtb_Compare_bj &&
      FmgcComputer_DWork.Delay_DSTATE_k));
    rtb_appCapability_idx_0 = !rtb_appCapability_idx_2;
    apCondition_tmp_0 = (FmgcComputer_DWork.pLand3FailPass || (rtb_appInop_idx_1 && rtb_y_aq &&
      FmgcComputer_DWork.Delay_DSTATE_k && rtb_appCapability_idx_0));
    rtb_appCapability_idx_0 = (rtb_y_n5 && rtb_y_aq && (!apCondition_tmp_0) && rtb_appCapability_idx_0);
    rtb_y_n5 = !rtb_y_n5;
    rtb_appInop_idx_1 = !rtb_appInop_idx_1;
    rtb_y_ed = !rtb_y_ed;
    if ((rtb_raComputationData < 100.0F) && (rtb_y_aq || rtb_Compare_bj)) {
    ...
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_k);
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_p, &rtb_y_lj);
    rtb_DataTypeConversion32 = rtb_y_lj;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_j, &rtb_y_lt);
    rtb_DataTypeConversion39 = rtb_y_lt;
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_ir_computation_data_track_angle_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault8_defaultValue, &rtb_y_m);
    if (!rtb_Compare_bj) {
      FmgcComputer_B.u_lyjj = rtb_y_m;
    }

    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue_a, &rtb_y_m);
    if (rtb_Compare_bj) {
      rtb_DataTypeConversion10 = FmgcComputer_B.u_lyjj;
    } else {
      rtb_DataTypeConversion10 = rtb_y_m;
    }

    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fc, &rtb_y_hy);
    rtb_DataTypeConversion41 = rtb_y_hy;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_f, &rtb_y_m);
    rtb_DataTypeConversion42 = rtb_y_m;
    rtb_y_aq = (rtb_y_j5 || FmgcComputer_DWork.Memory_PreviousInput_d);
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_pfdTarget,
                    ...
                    &rtb_DataTypeConversion25, &rtb_y_k, &rtb_DataTypeConversion23,
      ...
      (&FmgcComputer_RGND)), &rtb_Gain3, &(&rtb_Logic_a2[0])[0], &rtb_active_lateral_law, &rtb_active_longitudinal_law,
                    ...
                    &rtb_y_aq, &rtb_Phi_loc_c, &rtb_Nosewheel_c, &rtb_Theta_c_deg, &rtb_Phi_c_deg, &rtb_Beta_c_deg,
    ...
    FmgcComputer_MATLABFunction_k((rtb_y_ha != 0U), FmgcComputer_P.PulseNode3_isRisingEdge_ng, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_k);
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_y_aq) << 1)
      + rtb_y_aj) << 1) + FmgcComputer_DWork.Memory_PreviousInput_hu];
    rtb_BusAssignment_b_logic_ra_computation_data_ft = rtb_Switch1_a;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_hw, &rtb_y_lt);
    rtb_y_k = (rtb_y_lt >= FmgcComputer_P.CompareToConstant_const_hq);
    rtb_y_aq = (rtb_y_lt <= FmgcComputer_P.CompareToConstant2_const_di);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o2, &rtb_y_lt);
    rtb_y_hq = (rtb_y_lt >= FmgcComputer_P.CompareToConstant1_const_h4);
    rtb_NOT1_j = (rtb_y_lt <= FmgcComputer_P.CompareToConstant3_const_d);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_p);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_a);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_k, &rtb_y_lt);
    rtb_Compare_jz = (rtb_y_lt > FmgcComputer_P.CompareToConstant4_const_p);
    rtb_OR4_e = (rtb_y_lt <= FmgcComputer_P.CompareToConstant6_const_h);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_l, &rtb_y_lt);
    rtb_pfdTarget = rtb_Product_a;
    rtb_NOT1_j = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_k &&
      rtb_y_aq && rtb_y_hq && rtb_NOT1_j) || ((!rtb_y_p) && (!rtb_y_a) && rtb_BusAssignment_h_logic_one_engine_out &&
      (rtb_Compare_jz && rtb_OR4_e && (rtb_y_lt > FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_lt <=
      FmgcComputer_P.CompareToConstant7_const)))));
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_m, &rtb_y_lt);
    rtb_Switch1_a = rtb_y_lt;
    rtb_y_k = (rtb_y_lt < FmgcComputer_P.CompareToConstant8_const);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_fk, &rtb_y_lt);
    rtb_y_p = (rtb_NOT1_j && ((rtb_Switch1_a < FmgcComputer_P.CompareToConstant10_const) || (rtb_y_lt <
      FmgcComputer_P.CompareToConstant11_const) || (rtb_BusAssignment_h_logic_one_engine_out && (rtb_y_k || (rtb_y_lt <
    ...
    rtb_y_k = !FmgcComputer_DWork.Memory_PreviousInput_hu;
    rtb_y_a = (((rtb_y_ha != 0U) && rtb_y_g1) || (rtb_y_nw && rtb_y_hq && rtb_y_k));
    FmgcComputer_MATLABFunction_kh(rtb_y_a, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_b,
      FmgcComputer_P.ConfirmNode_timeDelay_gu, &rtb_y_hq, &FmgcComputer_DWork.sf_MATLABFunction_ay);
    rtb_y_aq = (FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active ||
                FmgcComputer_DWork.Delay1_DSTATE.retard_mode_active);
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_aj || ((rtb_y_aq ||
      FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_hq))) + (static_cast<uint32_T>(rtb_y_a) << 1))
    ...
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_y_g1) || (rtb_y_nw && rtb_y_hq && rtb_y_k));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_aj || ((rtb_y_aq ||
    ...
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_y_g1) || (rtb_y_nw && FmgcComputer_DWork.Memory_PreviousInput_d &&
      rtb_Logic_a2[0] && (rtb_raComputationData <= FmgcComputer_P.CompareToConstant_const_e3) && rtb_y_k));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_o = FmgcComputer_P.Logic_table_acc[(((rtb_y_aj ||
    ...
    rtb_y_bf = athr_fma_message::NONE;
    rtb_y_k = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_k);
    if (rtb_y_k && FmgcComputer_DWork.Memory_PreviousInput_kr &&
      ...
      rtb_y_bf = athr_fma_message::LVR_CLB;
    } else if (rtb_y_k && FmgcComputer_DWork.Memory_PreviousInput_km &&
      ...
      rtb_y_bf = athr_fma_message::LVR_MCT;
    } else if (rtb_y_k && rtb_ap_fd_condition_tmp_0 &&
               (((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 24.0F) &&
                 (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 26.0F) &&
                 ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 26.0F))) ||
                ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 24.0F) &&
                 ...
                 ((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 26.0F))))) {
      rtb_y_bf = athr_fma_message::LVR_ASYM;
    }
    ...
    rtb_y_lt = std::fmax(FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data,
                         FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_k);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_nw);
    rtb_y_k = (rtb_y_k || rtb_y_nw);
    rtb_y_mi = athr_fma_mode::NONE;
    rtb_y_aq = !rtb_NOT1_j;
    rtb_ap_fd_condition_tmp_0 = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_aq);
    if (rtb_ap_fd_condition_tmp_0 && (rtb_y_lt > 44.0F)) {
      rtb_y_mi = athr_fma_mode::MAN_TOGA;
    } else {
      rtb_y_nw = (rtb_ap_fd_condition_tmp_0 && (rtb_y_lt > 34.0F) && (rtb_y_lt < 36.0F));
      if (rtb_y_nw && rtb_y_k) {
        rtb_y_mi = athr_fma_mode::MAN_FLEX;
      } else if (rtb_y_nw && (!rtb_y_k)) {
        rtb_y_mi = athr_fma_mode::MAN_MCT;
      } else if (rtb_ap_fd_condition_tmp_0 && (rtb_y_lt > 24.0F)) {
        rtb_y_mi = athr_fma_mode::MAN_THR;
      } else {
        rtb_ap_fd_condition_tmp_0 = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_NOT1_j);
        rtb_y_nw = (rtb_ap_fd_condition_tmp_0 && FmgcComputer_DWork.Memory_PreviousInput_cm);
        if (rtb_y_nw && (!FmgcComputer_DWork.Delay_DSTATE_c)) {
          rtb_y_mi = athr_fma_mode::SPEED;
        } else if (rtb_y_nw && FmgcComputer_DWork.Delay_DSTATE_c) {
          rtb_y_mi = athr_fma_mode::MACH;
        } else {
          rtb_y_nw = (rtb_ap_fd_condition_tmp_0 && FmgcComputer_DWork.Memory_PreviousInput_bh);
          rtb_y_k = !rtb_OR_pj;
          if (rtb_y_nw && (rtb_y_lt > 34.0F) && rtb_y_k) {
            rtb_y_mi = athr_fma_mode::THR_MCT;
          } else if (rtb_y_nw && (rtb_y_lt > 24.0F) && rtb_y_k) {
            rtb_y_mi = athr_fma_mode::THR_CLB;
          } else if (rtb_y_nw && (rtb_y_lt < 25.0F) && rtb_y_k) {
            rtb_y_mi = athr_fma_mode::THR_LVR;
            ...
            rtb_y_mi = athr_fma_mode::THR_IDLE;
          } else {
            ...
            if (rtb_ap_fd_condition_tmp_0 && (rtb_y_ha != 0U)) {
              rtb_y_mi = athr_fma_mode::A_FLOOR;
            } else if (rtb_ap_fd_condition_tmp_0 && (rtb_y_ha == 0U)) {
              rtb_y_mi = athr_fma_mode::TOGA_LK;
            }
          }
        }
      }
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_hv, &rtb_y_m);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_i, &rtb_y_lt);
    v[0] = rtb_y_m;
    v[1] = static_cast<real32_T>(rtb_Switch_e[0]);
    v[2] = rtb_y_lt;
    if (rtb_y_m < static_cast<real32_T>(rtb_Switch_e[0])) {
      if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_lt) {
        high_i = 1;
      } else if (rtb_y_m < rtb_y_lt) {
        high_i = 2;
      } else {
        high_i = 0;
      }
      ...
      high_i = 0;
    } else if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_lt) {
      high_i = 2;
    } else {
      high_i = 1;
    }
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
      FmgcComputer_P.A429ValueOrDefault11_defaultValue, &rtb_y_lt);
    rtb_DataTypeConversion1_d = FmgcComputer_P.Gain1_Gain_a * rtb_y_lt;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault10_defaultValue, &rtb_y_lt);
    rtb_DataTypeConversion8 = FmgcComputer_P.fpmtoms_Gain * rtb_y_lt;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_ground_speed_kn,
      FmgcComputer_P.A429ValueOrDefault8_defaultValue_i, &rtb_y_lt);
    rtb_Switch1_a = rtb_y_lt;
    rtb_DataTypeConversion2_i = FmgcComputer_P.kntoms_Gain * rtb_y_lt;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault12_defaultValue, &rtb_y_lt);
    rtb_Product_a = FmgcComputer_P.Gain1_Gain_h * rtb_y_lt;
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault13_defaultValue, &rtb_y_lt);
    rtb_DataTypeConversion5 = FmgcComputer_P.Gain1_Gain_f * rtb_y_lt;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_track_angle_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault14_defaultValue, &rtb_y_lt);
    ...
    FmgcComputer_LeadLagFilter(FmgcComputer_DWork.pY_f - FmgcComputer_P.g_Gain * (FmgcComputer_P.Gain1_Gain_d *
      ...
      (FmgcComputer_P.Gain1_Gain_p * rtb_y_lt - rtb_DataTypeConversion5)))), FmgcComputer_P.HighPassFilter_C1,
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault9_defaultValue, &rtb_y_lt);
    if (rtb_y_lt > FmgcComputer_P.Saturation1_UpperSat_l) {
      rtb_Switch1_a = FmgcComputer_P.Saturation1_UpperSat_l;
    } else if (rtb_y_lt < FmgcComputer_P.Saturation1_LowerSat_i) {
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_body_normal_accel_g,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_bv, &rtb_y_m);
    FmgcComputer_LagFilter(rtb_y_m, FmgcComputer_P.LagFilter1_C1, FmgcComputer_U.in.time.dt, &rtb_y_lt,
      &FmgcComputer_DWork.sf_LagFilter_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fg, &rtb_y_m);
    rtb_Cos_h = std::cos(FmgcComputer_P.Gain1_Gain_hk * rtb_y_m);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_mp, &rtb_y_m);
    rtb_Cos_h = rtb_y_lt - rtb_Cos_h / std::cos(FmgcComputer_P.Gain1_Gain_go * rtb_y_m);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_n1_actual_percent,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue_e, &rtb_y_m);
    ...
    if (FmgcComputer_U.in.sim_data.tracking_mode_on_override) {
      ...
      rtb_Switch1_a = ((FmgcComputer_P.Gain_Gain * rtb_DataTypeConversion1_d + FmgcComputer_DWork.pY_d) +
        ...
        * look1_iflf_binlxpw(std::fmin(rtb_y_m, rtb_DataTypeConversion2_bh),
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_aj || rtb_y_aq || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_pw_logic_ils_computation_data_runway_heading_deg, &rtb_y_aj);
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_y_m);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_5.Data = rtb_y_m;
    ...
    rtb_VectorConcatenate[9] = rtb_y_n5;
    rtb_VectorConcatenate[10] = rtb_appInop_idx_1;
    rtb_VectorConcatenate[11] = rtb_y_ed;
    ...
    rtb_VectorConcatenate[3] = rtb_NOT1_j;
    ...
    rtb_VectorConcatenate[14] = rtb_y_p;
    ...
    rtb_VectorConcatenate_bw[0] = (rtb_y_mi == athr_fma_mode::MAN_TOGA);
    rtb_VectorConcatenate_bw[1] = ((rtb_y_mi == athr_fma_mode::MAN_MCT) || (rtb_y_mi == athr_fma_mode::THR_MCT));
    rtb_VectorConcatenate_bw[2] = (rtb_y_mi == athr_fma_mode::MAN_FLEX);
    rtb_VectorConcatenate_bw[3] = (rtb_y_mi == athr_fma_mode::THR_CLB);
    rtb_VectorConcatenate_bw[4] = ((rtb_y_mi == athr_fma_mode::MAN_THR) || (rtb_y_mi == athr_fma_mode::THR_LVR));
    rtb_VectorConcatenate_bw[5] = (rtb_y_mi == athr_fma_mode::THR_IDLE);
    rtb_VectorConcatenate_bw[6] = (rtb_y_mi == athr_fma_mode::A_FLOOR);
    rtb_VectorConcatenate_bw[7] = (rtb_y_mi == athr_fma_mode::TOGA_LK);
    rtb_VectorConcatenate_bw[8] = (rtb_y_mi == athr_fma_mode::SPEED);
    rtb_VectorConcatenate_bw[9] = (rtb_y_mi == athr_fma_mode::MACH);
    rtb_VectorConcatenate_bw[10] = (rtb_y_bf == athr_fma_message::LVR_ASYM);
    rtb_VectorConcatenate_bw[11] = (rtb_y_bf == athr_fma_message::LVR_CLB);
    rtb_VectorConcatenate_bw[12] = (rtb_y_bf == athr_fma_message::LVR_MCT);
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_bw, &rtb_y_lj);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_fma_discrete_word.Data = rtb_y_lj;
    ...
    rtb_VectorConcatenate_f[9] = (FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_y_j5);
    rtb_VectorConcatenate_f[10] = (FmgcComputer_DWork.Memory_PreviousInput_ne ||
      FmgcComputer_DWork.Memory_PreviousInput_nu);
    rtb_VectorConcatenate_f[11] = (FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_y_j5);
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_f, &rtb_y_lt);
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_f, &rtb_y_hy);
    FmgcComputer_Y.out.data = FmgcComputer_U.in;
    FmgcComputer_Y.out.logic.on_ground = rtb_y_h;
    FmgcComputer_Y.out.logic.gnd_eng_stop_flt_5s = rtb_y_kb;
    ...
    FmgcComputer_Y.out.logic.fac_lg_data_failure = rtb_y_os;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.gs_trk_active = rtb_y_j5;
    ...
    FmgcComputer_Y.out.ap_fd_logic.fmgc_opp_mode_sync = rtb_y_g1;
    FmgcComputer_Y.out.ap_fd_logic.any_ap_fd_engaged = rtb_y_ft;
    FmgcComputer_Y.out.ap_fd_logic.any_lateral_mode_engaged = rtb_Logic_gj_idx_0_tmp;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_mode_reversion = rtb_y_e2;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_2_inop = rtb_y_n5;
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_passive_inop = rtb_appInop_idx_1;
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_op_inop = rtb_y_ed;
    ...
    FmgcComputer_Y.out.athr.athr_active = rtb_NOT1_j;
    FmgcComputer_Y.out.athr.athr_limited = rtb_y_p;
    ...
    FmgcComputer_Y.out.athr.fma_mode = rtb_y_mi;
    FmgcComputer_Y.out.athr.fma_message = rtb_y_bf;
    ...
    if (rtb_y_aj || rtb_BusAssignment_b_logic_ils_tune_inhibit) {
    ...
    rtb_y_aq = !FmgcComputer_DWork.Memory_PreviousInput_m;
    if (rtb_Logic_gj_idx_0_tmp && (!FmgcComputer_DWork.Memory_PreviousInput_c) && rtb_y_aq) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_4.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_4.Data = rtb_y_m;
    if (rtb_OR2_l) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.Data = rtb_y_lj;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.Data = rtb_y_lt;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_6.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_6.Data = rtb_y_hy;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_4.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_4.Data = rtb_y_m;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.Data = rtb_y_lj;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.Data = rtb_y_lt;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active = rtb_y_j5;
    ...
    FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync = rtb_y_g1;
    FmgcComputer_DWork.Delay_DSTATE.any_ap_fd_engaged = rtb_y_ft;
    FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged = rtb_Logic_gj_idx_0_tmp;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_mode_reversion = rtb_y_e2;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_2_inop = rtb_y_n5;
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_passive_inop = rtb_appInop_idx_1;
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_op_inop = rtb_y_ed;
    ...
    FmgcComputer_DWork.Memory_PreviousInput_as = rtb_y_j5;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.athr_active = rtb_NOT1_j;
    FmgcComputer_DWork.Delay1_DSTATE.athr_limited = rtb_y_p;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.fma_mode = rtb_y_mi;
    FmgcComputer_DWork.Delay1_DSTATE.fma_message = rtb_y_bf;
