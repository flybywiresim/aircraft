...
void FmgcComputer::step()
{
  ...
  boolean_T rtb_Logic_gj_idx_0_tmp_0;
  boolean_T rtb_Logic_gj_idx_0_tmp_tmp;
  boolean_T rtb_Logic_oq_idx_0;
  boolean_T rtb_Memory;
  boolean_T rtb_Memory_n;
  boolean_T rtb_NOR1;
  boolean_T rtb_NOR1_a;
  boolean_T rtb_NOR1_d;
  boolean_T rtb_NOR1_h;
  boolean_T rtb_NOT3;
  boolean_T rtb_OR2_l;
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    if (!FmgcComputer_DWork.Runtime_MODE) {
      ...
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_h4);
    ...
    rtb_irOwnInvalid = (rtb_y_jw || (rtb_y_ha != 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_own_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit, &rtb_y_ha);
    rtb_AND10_b = (rtb_y_ha != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel3_bit, &rtb_y_ha);
    rtb_irOwnInvalid = ((!rtb_irOwnInvalid) || ((!rtb_AND10_b) && (rtb_y_ha == 0U)) || (!FmgcComputer_P.Constant_Value_a)
    ...
    rtb_ir3Invalid = (FmgcComputer_U.in.discrete_inputs.fac_opp_healthy &&
                      FmgcComputer_U.in.discrete_inputs.fac_own_healthy && rtb_y_jw && (rtb_y_m || (rtb_y_ha != 0U)));
    ...
    rtb_AND10_b = (rtb_y_ha == 0U);
    FmgcComputer_MATLABFunction_f(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5, &rtb_y_dh);
    rtb_NOR1_a = (rtb_NOR1 && rtb_y_m && rtb_AND10_b && rtb_y_dh);
    rtb_AND10_k = ((!rtb_y_dh) || (!rtb_AND10_b));
    rtb_OR_pj = !rtb_NOR1_a;
    FmgcComputer_MATLABFunction_kh(rtb_OR_pj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge,
      FmgcComputer_P.ConfirmNode1_timeDelay, &rtb_y_dh, &FmgcComputer_DWork.sf_MATLABFunction_f);
    rtb_NOR1_d = ((FmgcComputer_U.in.discrete_inputs.eng_opp_stop && FmgcComputer_U.in.discrete_inputs.eng_own_stop &&
                   rtb_NOR1_a) || rtb_y_dh);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
    ...
    FmgcComputer_MATLABFunction_f(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5, &rtb_y_dh);
    FmgcComputer_Y.out.logic.fac_flap_slat_data_failure = ((rtb_DataTypeConversion1_e != 0U) || (!rtb_y_dh));
    ...
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.localizer_deviation_deg, &rtb_y_dh);
    rtb_NOR1 = (rtb_y_dv && rtb_y_dh);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_own_bus.glideslope_deviation_deg, &rtb_y_dv);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_own_bus.localizer_deviation_deg, &rtb_y_dh);
    rtb_y_m = (rtb_y_dv && rtb_y_dh);
    rtb_AND10_b = ((!rtb_NOR1) && (!rtb_y_m));
    rtb_BusAssignment_o_logic_both_ils_valid = (rtb_NOR1 && rtb_y_m);
    if (rtb_y_m) {
    ...
    rtb_NOR1 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active ||
    ...
    rtb_BusAssignment_b_logic_ils_tune_inhibit = rtb_NOR1;
    ...
    raOwnInvalid = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_AND10_k) || rtb_AND_cf) &&
    ...
    rtb_Compare_j5 = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed;
    ...
    FmgcComputer_MATLABFunction_k(FmgcComputer_U.in.discrete_inputs.ap_opp_engaged,
      FmgcComputer_P.PulseNode2_isRisingEdge, &rtb_y_dh, &FmgcComputer_DWork.sf_MATLABFunction_cb);
    rtb_OR2_l_tmp = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active;
    rtb_OR_fz = (rtb_Compare_j5 && rtb_ap_fd_condition_tmp_1);
    ...
    rtb_NOR1 = (rtb_y_hq >= FmgcComputer_P.CompareToConstant3_const);
    ...
    apCondition_tmp = !rtb_irOwnInvalid;
    ...
    rtb_NOR1_h = !raOwnInvalid;
    fdOppOff = (rtb_NOR1_h || (!raOppInvalid) || (!rtb_NOT3));
    rtb_fmgcOppPriority = !FmgcComputer_U.in.discrete_inputs.is_unit_1;
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((fdOppOff || (rtb_Compare_pf &&
      FmgcComputer_DWork.Delay_DSTATE_p) || FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc || ((rtb_y_dh &&
      rtb_OR2_l) || (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged && rtb_y_dv && rtb_fmgcOppPriority)) ||
      (rtb_NOR1_a && (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_NOR1 || (rtb_y_hq >=
      FmgcComputer_P.CompareToConstant5_const))) || (rtb_y_c && rtb_NOR1_a)) + (static_cast<uint32_T>(rtb_Compare_pf &&
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_NOR1_d && raOppInvalid && raOwnInvalid && rtb_NOT3) << 1)) << 1) +
    ...
    low_i = static_cast<int32_T>((((static_cast<uint32_T>(rtb_Compare_pf && FmgcComputer_DWork.Memory_PreviousInput) <<
      1) + ((!rtb_y_c) || FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc)) << 1) +
    ...
    FmgcComputer_MATLABFunction_k(FmgcComputer_U.in.discrete_inputs.fcu_athr_button,
      FmgcComputer_P.PulseNode_isRisingEdge_k, &rtb_OR4_e, &FmgcComputer_DWork.sf_MATLABFunction_o);
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      ...
      &rtb_Memory, &FmgcComputer_DWork.sf_MATLABFunction_kq);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
    ...
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync &&
      (!FmgcComputer_U.in.discrete_inputs.athr_opp_engaged)), FmgcComputer_P.PulseNode4_isRisingEdge, &rtb_y_dh,
      &FmgcComputer_DWork.sf_MATLABFunction_e5p);
    rtb_ap_fd_condition_tmp_2 = ((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active ||
      FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active) && (!FmgcComputer_DWork.Memory_PreviousInput_g1) &&
      rtb_ap_fd_condition_tmp && rtb_ap_fd_condition_tmp_2);
    rtb_ap_fd_condition_tmp = (rtb_NOR1_h || (!rtb_ap_fd_condition_tmp_2));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(raOwnInvalid &&
      rtb_ap_fd_condition_tmp_2 && ((rtb_OR4_e && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_Memory
      || rtb_y_dv)) << 1) + (rtb_ap_fd_condition_tmp || rtb_y_dh || (FmgcComputer_DWork.Delay_DSTATE_k && rtb_OR4_e && (
    ...
    rtb_y_jw = !rtb_Logic_a2[0];
    rtb_NOR1_h = !fdOwnOff;
    rtb_ap_fd_condition_tmp_2 = !FmgcComputer_DWork.Delay_DSTATE_k;
    ...
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_y_jw && (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged ||
      rtb_NOR1_h) && (rtb_y_c || rtb_ap_fd_condition_tmp_2) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_y_jw || FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) &&
      (rtb_y_c || rtb_NOR1_h) && (rtb_OR2_l || rtb_ap_fd_condition_tmp_2) && (rtb_Logic_a2[0] || fdOwnOff ||
      FmgcComputer_DWork.Delay_DSTATE_k || (!FmgcComputer_U.in.discrete_inputs.fmgc_opp_healthy)))));
    rtb_y_dh = !FmgcComputer_U.in.discrete_inputs.ap_opp_engaged;
    rtb_NOR1_h = (rtb_fmgcOppPriority && (rtb_y_jw || rtb_y_dh));
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_m, &rtb_y_g);
    ...
    rtb_y_l4 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    rtb_OR2_l = (rtb_appCapability_idx_0 && FmgcComputer_DWork.Delay_DSTATE.alt_cstr_applicable && rtb_y_l4 &&
                 FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid);
    if (rtb_y_g > rtb_y_hq) {
      rtb_y_k = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft < rtb_y_g) &&
    ...
    rtb_OR2_l = ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed ||
                 ...
                 (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != 0.0) && rtb_y_k);
    if (rtb_OR2_l) {
      rtb_altCstrOrFcu = FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft;
    } else {
      rtb_altCstrOrFcu = rtb_y_g;
    }
    ...
    FmgcComputer_MATLABFunction_kh(rtb_NOR1_a, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_h,
      FmgcComputer_P.ConfirmNode_timeDelay_i, &rtb_Memory, &FmgcComputer_DWork.sf_MATLABFunction_hz);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_l2, &rtb_y_hq);
    rtb_y_dv = (rtb_y_hq < FmgcComputer_P.CompareToConstant3_const_n);
    rtb_NOT3 = !rtb_y_dv;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_Compare_pf);
    rtb_AND_bi = (rtb_y_dv && (rtb_y_hq > FmgcComputer_P.CompareToConstant4_const) && rtb_Compare_pf);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b, &rtb_y_hq);
    rtb_y_dv = (rtb_y_hq < FmgcComputer_P.CompareToConstant5_const_a);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_fb);
    FmgcComputer_MATLABFunction_k((rtb_NOT3 || rtb_AND_bi || (!rtb_y_dv) || (rtb_y_dv && (rtb_y_hq >
      FmgcComputer_P.CompareToConstant6_const) && rtb_y_fb)), FmgcComputer_P.PulseNode_isRisingEdge_p, &rtb_Compare_pf,
      &FmgcComputer_DWork.sf_MATLABFunction_gk);
    rtb_AND_bi = !rtb_NOR1_h;
    rtb_appInop_idx_2 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active;
    rtb_y_k = (rtb_AND_bi && rtb_appInop_idx_2 && rtb_OR2_l_tmp);
    rtb_NOT3 = (((FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant1_const_k) &&
                 (rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_y_k && rtb_Memory &&
    ...
    rtb_Memory_n = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
                    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    rtb_Logic_gj_idx_0_tmp_tmp = (rtb_Memory_n || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
    ...
    rtb_Logic_gj_idx_0_tmp_0 = (rtb_Logic_gj_idx_0_tmp_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active);
    FmgcComputer_DWork.Memory_PreviousInput_k = FmgcComputer_P.Logic_table_b[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_Logic_gj_idx_0_tmp_0 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_Compare_pf))) +
      (static_cast<uint32_T>(rtb_NOT3) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_k];
    ...
    rtb_y_dv = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_j(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active,
      FmgcComputer_U.in.time.dt, &rtb_Compare_pf, FmgcComputer_P.MTrigNode_isRisingEdge_d,
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_f4_logic_ils_computation_data_runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_m, &rtb_y_g);
    ...
    rtb_DataTypeConversion2_m = std::abs(rtb_y_g - rtb_y_hq);
    ...
    FmgcComputer_MATLABFunction_kh(rtb_NOR1_a, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_p,
      FmgcComputer_P.ConfirmNode_timeDelay_o, &rtb_Memory, &FmgcComputer_DWork.sf_MATLABFunction_fm);
    if (rtb_y_hq < 0.0F) {
    ...
    rtb_NOT3 = ((rtb_y_dv && (rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active) && ((rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_cq) && rtb_Compare_pf && (rtb_DataTypeConversion2_m <=
      FmgcComputer_P.CompareToConstant2_const_b) && (rtb_DataTypeConversion1_d <
      FmgcComputer_P.CompareToConstant1_const_i) && FmgcComputer_P.Constant_Value_j && rtb_NOT3 && rtb_Memory)));
    ...
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg, &rtb_Memory);
    FmgcComputer_DWork.Memory_PreviousInput_c = FmgcComputer_P.Logic_table_hz[(((((!rtb_Compare_pf) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_trk_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp || (!rtb_Memory)) + (
    ...
    rtb_y_c4 = ((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ek, &rtb_y_aq);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_c, &rtb_y_g);
    ...
    rtb_y_m = !rtb_BusAssignment_h_logic_engine_running;
    rtb_AND1_g = !rtb_AND10_b;
    rtb_Memory = !FmgcComputer_P.Constant2_Value_p;
    rtb_y_j_tmp = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active;
    rtb_y_ey = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active;
    rtb_y_dv = (rtb_ap_fd_condition_tmp_1 && (rtb_y_c4 || (rtb_AND_bi && (FmgcComputer_P.Constant_Value_l && rtb_AND1_g &&
      (rtb_y_m || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_g)) && rtb_ap_fd_condition_tmp_0 &&
      rtb_OR4_e && (!rtb_Compare_pf) && (rtb_y_ey && (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed))) &&
      rtb_appInop_idx_2 && rtb_OR2_l_tmp && (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active) && rtb_y_j_tmp &&
      rtb_Memory && rtb_Memory && ((rtb_y_aq == rtb_DataTypeConversion2_m) && (rtb_y_g == rtb_y_hq)))));
    rtb_NOR1 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    ...
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active ||
      ...
      &rtb_Memory, &FmgcComputer_DWork.sf_MATLABFunction_kb);
    ...
    rtb_y_fb = (rtb_appInop_idx_1 && rtb_Compare_pf);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_AND_cf || ((!rtb_NOR1) &&
      (!rtb_appInop_idx_1) && FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed) || ((rtb_NOR1 && rtb_Memory) ||
      rtb_y_fb) || (rtb_OR4_e && FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed) || rtb_Compare_pf ||
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_y_dv) << 1)) << 1) +
    ...
    rtb_AND_cf = (rtb_Memory && (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
    ...
    FmgcComputer_MATLABFunction_kh(rtb_NOR1_a, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode2_isRisingEdge,
      FmgcComputer_P.ConfirmNode2_timeDelay, &rtb_Memory, &FmgcComputer_DWork.sf_MATLABFunction_fo);
    rtb_y_fb = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active);
    rtb_Logic_d_idx_0_tmp = (rtb_y_fb || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    rtb_AND10_b = (rtb_Logic_d_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
                   FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_Logic_gj_idx_0_tmp_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active || (rtb_AND10_b ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active)) && rtb_OR4_e) ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || (rtb_y_jw && rtb_y_dh &&
      rtb_Compare_pf && rtb_Memory) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_AND_cf) << 1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_d];
    rtb_y_c4 = (FmgcComputer_U.in.discrete_inputs.bscu_opp_valid || FmgcComputer_U.in.discrete_inputs.bscu_own_valid);
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      ...
      FmgcComputer_U.in.discrete_inputs.right_wheel_spd_abv_70_kts) && rtb_y_c4) || ((!rtb_y_c4) && rtb_NOR1_a))),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_b, FmgcComputer_P.ConfirmNode1_timeDelay_e,
      &rtb_y_dh, &FmgcComputer_DWork.sf_MATLABFunction_mb);
    FmgcComputer_DWork.Memory_PreviousInput_m = FmgcComputer_P.Logic_table_m[(((static_cast<uint32_T>(rtb_y_dh) << 1) +
    ...
    rtb_y_dv = ((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h);
    rtb_Memory = (rtb_y_m || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_lj) || rtb_dualRaFailure);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_e, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_h,
      &rtb_Compare_pf, &FmgcComputer_DWork.sf_MATLABFunction_d3);
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c[(((static_cast<uint32_T>
      (rtb_ap_fd_condition_tmp_1 && rtb_y_dv) << 1) + false) << 1) + FmgcComputer_DWork.Memory_PreviousInput_dv];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
      FmgcComputer_P.BitfromLabel_bit_a, &rtb_DataTypeConversion1_e);
    low_i = static_cast<int32_T>((((static_cast<uint32_T>((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) << 1) + false)
    ...
    FmgcComputer_MATLABFunction_kh(rtb_NOR1_a, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_m,
    ...
    rtb_Compare_j5 = (rtb_y_hq >= FmgcComputer_P.CompareToConstant3_const_i);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d, &rtb_y_hq);
    FmgcComputer_MATLABFunction_k((rtb_Compare_j5 || (rtb_y_hq >= FmgcComputer_P.CompareToConstant5_const_k)),
      FmgcComputer_P.PulseNode_isRisingEdge_c, &rtb_Compare_pf, &FmgcComputer_DWork.sf_MATLABFunction_fn);
    rtb_Memory = (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_y_k && (!rtb_Memory) && (rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_j) && rtb_Compare_pf));
    FmgcComputer_MATLABFunction_kh(rtb_Memory, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hj,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i = FmgcComputer_P.Logic_table_o[(((rtb_Logic_gj_idx_0_tmp ||
      ...
      (rtb_Memory) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_i];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    rtb_Memory = (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi && (rtb_y_j_tmp && rtb_Compare_pf)));
    FmgcComputer_MATLABFunction_kh(rtb_Memory, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_mf,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_e = FmgcComputer_P.Logic_table_c2[(((rtb_Logic_gj_idx_0_tmp ||
      ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_Compare_pf))) + (static_cast<uint32_T>
      (rtb_Memory) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_e];
    FmgcComputer_MATLABFunction_k(rtb_y_c, FmgcComputer_P.PulseNode1_isRisingEdge_e, &rtb_Compare_pf,
    ...
    rtb_y_dh = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active;
    rtb_Logic_gj_idx_0_tmp_tmp = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active;
    rtb_y_m = (rtb_y_dh && rtb_Logic_gj_idx_0_tmp_tmp);
    rtb_y_dv = rtb_y_m;
    rtb_y_c4 = (rtb_Logic_d_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel4_bit_k, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_y_dv,
    ...
    rtb_NOR1 = (rtb_appInop_idx_1 && rtb_Compare_pf && ((!rtb_y_m) || (!rtb_y_c4)) && (!rtb_y_dv));
    ...
    rtb_y_k = !FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid;
    rtb_Memory = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_y_k && rtb_y_ey) || rtb_OR4_e ||
                  rtb_NOR1 || (rtb_appInop_idx_1 && rtb_OR_fz && rtb_Compare_pf));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    rtb_OR_fz = ((rtb_OR4_e && rtb_NOR1_h) || (rtb_AND_bi && ((rtb_NOR1_d && rtb_Compare_pf && rtb_ap_fd_condition_tmp_1
      && (rtb_y_j_tmp || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_a))) || rtb_Memory)));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_f2 = FmgcComputer_P.Logic_table_i[(((((!rtb_Compare_pf) && rtb_y_c4) ||
    ...
    rtb_Compare_j5 = (FmgcComputer_DWork.Memory_PreviousInput_f2 && (rtb_DataTypeConversion1_e == 0U));
    apCondition_tmp = rtb_Memory;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    rtb_NOR1 = (rtb_y_m && rtb_ap_fd_condition_tmp_1 && rtb_Compare_pf);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_OR4_e);
    ...
    rtb_y_j_tmp = ((!rtP_fmgc_ap_fd_logic_output_MATLABStruct.any_lateral_mode_engaged) ||
                   FmgcComputer_DWork.Memory_PreviousInput_c);
    rtb_y_c4 = rtb_y_j_tmp;
    rtb_Memory = ((rtb_Memory && rtb_NOR1_h) || (rtb_AND_bi && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid &&
      (rtb_NOR1 || (rtb_NOR1_a && (((!rtb_OR4_e) && (!rtb_y_dv)) || rtb_Compare_pf) && rtb_y_j_tmp))));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_OR4_e);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_NOR1);
    FmgcComputer_MATLABFunction_k((rtb_OR4_e || rtb_NOR1), FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_Compare_pf,
      &FmgcComputer_DWork.sf_MATLABFunction_h0);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_p, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_k, &rtb_y_c4,
      &FmgcComputer_DWork.sf_MATLABFunction_jle);
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_Compare_pf || rtb_y_c4 ||
      (rtb_appInop_idx_1 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) || rtb_y_k ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_Memory) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_i1];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel_bit_nk, &rtb_DataTypeConversion1_e);
    rtb_Memory = (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((rtb_y_k || rtb_Logic_gj_idx_0_tmp ||
      ((rtb_AND10_b || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_Compare_pf))) + (static_cast<
      uint32_T>(rtb_Memory) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ip];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_o, &rtb_DataTypeConversion1_e);
    rtb_Memory = (rtb_DataTypeConversion1_e != 0U);
    rtb_OR4_e = rtb_AND_bi;
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_cs, &rtb_NOR1,
      &FmgcComputer_DWork.sf_MATLABFunction_ma);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_ls, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_o,
      &rtb_Compare_pf, &FmgcComputer_DWork.sf_MATLABFunction_k4c);
    rtb_AND1_g = (rtb_Compare_pf && rtb_AND1_g && (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_m) &&
    ...
    FmgcComputer_MATLABFunction_kh(rtb_AND1_g, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_n,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_OR4_e) && rtb_Compare_pf) ||
      ...
      rtb_NOR1_h) || (rtb_AND_bi && (rtb_NOR1 || rtb_AND1_g))) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_a];
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_k_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o, &rtb_y_g);
    ...
    if (low_i == high_i) {
      ...
      if (rtb_DataTypeConversion1_d > 5.0) {
        if (std::abs(rtb_y_g) <= 5.0F) {
          rtb_Compare_pf = true;
        } else {
          if (rtb_y_g < 0.0F) {
            low_ip1 = -1;
          } else {
            low_ip1 = (rtb_y_g > 0.0F);
          }
      ...
      if (guard1) {
        ...
        rtb_Compare_pf = ((rtb_DataTypeConversion1_d >= std::abs(rtb_y_g)) && (high_i == low_ip1));
      }
    } else {
    ...
    if (dPsi_1 < 115.0F) {
      rtb_y_g = std::abs(rtb_DataTypeConversion2_m);
      ...
      if (((dPsi_1 > 25.0F) && ((rtb_y_g < 10.0F) && ((low_i != high_i) && rtb_Compare_pf))) || (rtb_y_g < 1.92)) {
        rtb_Compare_pf = (rtb_Compare_pf || ((dPsi_1 < 15.0F) && (rtb_y_g < 1.1)));
      } else {
        rtb_Compare_pf = false;
      }
    } else {
    ...
    rtb_y_fb = (rtb_y_fb || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active);
    FmgcComputer_DWork.Memory_PreviousInput_cv = FmgcComputer_P.Logic_table_g4[(((((!rtb_Compare_pf) && (rtb_y_fb ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_Memory) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cv];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_lq = FmgcComputer_P.Logic_table_j[(((((!rtb_Compare_pf) && (rtb_y_fb ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_Memory) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_lq];
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pm, &rtb_y_aq);
    dPsi_1 = rtb_y_hq - rtb_y_aq;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jm, &rtb_y_g);
    if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) {
      rtb_y_g = rtb_DataTypeConversion2_m;
    ...
    rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s.Data =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_Data;
    if (dPsi_1 < 0.0F) {
      rtb_y_k = (rtb_y_g <= 0.0F);
    } else {
      rtb_y_k = ((dPsi_1 > 0.0F) && (rtb_y_g >= 0.0F));
    }

    rtb_AND1_g = (rtb_OR2_l_tmp && rtb_appInop_idx_2);
    rtb_y_fb = (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active) && rtb_Logic_oq_idx_0 && rtb_OR_ko &&
      rtb_y_ey && rtb_ap_fd_condition_tmp_1 && ((!rtb_y_k) ||
      ((!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) &&
       (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active))) && (rtb_AND1_g || (dPsi_1 <=
    ...
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_Compare_pf,
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_h, &rtb_y_g);
    dPsi_2 = std::abs(rtb_y_g);
    high_i = 7;
    low_i = 0;
    low_ip1 = 2;
    ...
    rtb_DataTypeConversion2_m = rtb_y_g * 0.00508F;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_Memory = ((rtb_Memory && rtb_NOR1_h) || (rtb_AND_bi && FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed
      && (!rtb_Compare_pf) && ((std::fmin(3000.0F, std::fmax(80.0F, rtb_DataTypeConversion2_m *
      rtb_DataTypeConversion2_m / ((((dPsi_1 * static_cast<real32_T>(c[low_i]) + static_cast<real32_T>(c[low_i + 6])) *
      dPsi_1 + static_cast<real32_T>(c[low_i + 12])) * dPsi_1 + static_cast<real32_T>(c[low_i + 18])) * 9.81F) *
      3.28084F)) > rtb_Nosewheel_c) && (static_cast<int32_T>(rtb_Phi_c_deg) == high_i)) && ((rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_l5) || rtb_AND1_g)));
    FmgcComputer_MATLABFunction_kh(rtb_Memory, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hux,
      FmgcComputer_P.ConfirmNode_timeDelay_lk, &rtb_Compare_pf, &FmgcComputer_DWork.sf_MATLABFunction_hw);
    rtb_Logic_gj_idx_0_tmp_0 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active);
    FmgcComputer_DWork.Memory_PreviousInput_ne = FmgcComputer_P.Logic_table_nz[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_Logic_gj_idx_0_tmp_0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_Compare_pf))) + (static_cast<uint32_T>
      (rtb_Memory) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ne];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Memory = ((rtb_Memory && (rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cb = FmgcComputer_P.Logic_table_ob[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_Memory_n || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_Compare_pf))) + (static_cast<uint32_T>
      (rtb_Memory) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cb];
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_m, &rtb_y_hq);
    rtb_Memory_n = (FmgcComputer_DWork.Memory_PreviousInput_cb && (std::abs(FmgcComputer_U.in.fms_inputs.cruise_alt_ft -
    ...
    FmgcComputer_MATLABFunction_k(rtb_y_c, FmgcComputer_P.PulseNode1_isRisingEdge_ky, &rtb_Compare_pf,
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mr, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oi, &rtb_y_hq);
    rtb_DataTypeConversion2_m = rtb_y_g - rtb_y_hq;
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_o3_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue, &rtb_y_g);
    rtb_AND1_g = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_y_m = ((rtb_AND1_g || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (rtb_y_hq +
                FmgcComputer_P.Bias_Bias_e > rtb_y_g) && rtb_y_jw && FmgcComputer_DWork.Delay_DSTATE_k);
    ...
    rtb_NOR1 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    rtb_AND10_b = (rtb_NOR1 && (rtb_y_g > rtb_y_hq + FmgcComputer_P.Bias1_Bias) && rtb_y_jw &&
                   FmgcComputer_DWork.Delay_DSTATE_k);
    rtb_y_k = !FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid;
    rtb_y_jw = (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && rtb_y_dh && rtb_Logic_gj_idx_0_tmp_tmp);
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active) && rtb_Compare_pf) ||
                  (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active &&
                   ((FmgcComputer_P.EnumeratedConstant_Value_p == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                    ...
                    rtb_y_jw || rtb_y_k)) || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && (std::
      abs(FmgcComputer_B.u_ly - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_om)) || (rtb_AND1_g &&
      (rtb_DataTypeConversion2_m > FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_NOR1 &&
      (rtb_DataTypeConversion2_m < FmgcComputer_P.CompareToConstant2_const_g)) || rtb_y_m || rtb_AND10_b);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_NOR1 = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel5_bit_n, &rtb_DataTypeConversion1_e);
    rtb_y_dv = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_k((rtb_NOR1 || (rtb_DataTypeConversion1_e != 0U)),
      FmgcComputer_P.PulseNode_isRisingEdge_d, &rtb_y_dv, &FmgcComputer_DWork.sf_MATLABFunction_nd);
    rtb_NOR1 = (rtb_NOR1_d && rtb_y_dv && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_AND_bi && (rtb_NOR1 || rtb_Memory)));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_pf, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lu,
      FmgcComputer_P.ConfirmNode_timeDelay_ll, &rtb_NOR1, &FmgcComputer_DWork.sf_MATLABFunction_gbq);
    FmgcComputer_DWork.Memory_PreviousInput_fg = FmgcComputer_P.Logic_table_ny[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_appCapability_idx_0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_NOR1))) + (static_cast<uint32_T>
    ...
    rtb_AND1_g = ((rtb_DataTypeConversion1_e != 0U) && FmgcComputer_DWork.Memory_PreviousInput_fg);
    rtb_y_dh = (FmgcComputer_DWork.Memory_PreviousInput_fg && (rtb_DataTypeConversion1_e == 0U));
    rtb_Logic_gj_idx_0_tmp_tmp = rtb_Memory;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_jh, &rtb_DataTypeConversion1_e);
    rtb_Compare_pf = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_et, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oj, &rtb_y_hq);
    rtb_y_dv = (rtb_y_g > rtb_y_hq);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_px, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_b, &rtb_y_m,
      &FmgcComputer_DWork.sf_MATLABFunction_p3z);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_c, &rtb_y_hq);
    rtb_y_c4 = (rtb_appCapability_idx_0 && rtb_OR2_l);
    rtb_OR4_e = (rtb_OR_pj && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_dv && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_c4 || (rtb_y_m &&
      rtb_appCapability_idx_0 && (rtb_OR2_l && (std::abs(rtb_altCstrOrFcu - rtb_y_hq) <=
      FmgcComputer_P.CompareToConstant2_const_d)))));
    rtb_NOR1 = (rtb_NOR1_a || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
    ...
    rtb_y_dv = ((FmgcComputer_U.in.fms_inputs.acceleration_alt_ft != FmgcComputer_P.CompareToConstant_const_lz) &&
                ...
                rtb_Memory && rtb_y_j_tmp);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jt, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_os, &rtb_y_hq);
    rtb_y_j_tmp = !rtb_OR2_l;
    rtb_Logic_d_idx_0_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_NOR1 && (!rtb_y_dv)) ||
      (rtb_Logic_d_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
       ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
         FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) && rtb_y_j_tmp) ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) || (rtb_y_g < rtb_y_hq) ||
      (rtb_appCapability_idx_0 && (rtb_y_j_tmp || rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_k)) ||
      ...
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>((rtb_Compare_pf && rtb_NOR1_h) || (rtb_AND_bi && (rtb_OR4_e ||
      (rtb_NOR1 && rtb_y_dv)))) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ma];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_h, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_n, &rtb_y_hq);
    rtb_NOR1 = (rtb_y_g > rtb_y_hq);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    FmgcComputer_MATLABFunction_k((rtb_y_hq > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode_isRisingEdge_bg, &rtb_Memory, &FmgcComputer_DWork.sf_MATLABFunction_df);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    rtb_y_m = (rtb_y_j_tmp || (std::abs(rtb_altCstrOrFcu - rtb_y_hq) > FmgcComputer_P.CompareToConstant2_const_a));
    rtb_TmpSignalConversionAtSFunctionInport3_idx_2 = (rtb_AND_bi &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible && rtb_NOR1_d);
    rtb_Compare_l0_tmp = !rtb_appCapability_idx_0;
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_OR4_e &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_NOR1 &&
      ...
      ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed && (rtb_Memory ||
      (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE))) || (rtb_AND10_b &&
      (rtb_Compare_l0_tmp || (rtb_appCapability_idx_0 && (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed) &&
      rtb_y_m))))));
    ...
    rtb_Memory = (rtb_Logic_gj_idx_0_tmp_0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    rtb_AND10_b = (rtb_Memory || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ec = FmgcComputer_P.Logic_table_kw[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_AND10_b || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
    ...
    rtb_Compare_pf = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_nh, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_mc, &rtb_y_hq);
    rtb_NOR1 = (rtb_y_g < rtb_y_hq);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_nq, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_f, &rtb_y_m,
      &FmgcComputer_DWork.sf_MATLABFunction_mrk);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_k, &rtb_y_hq);
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_AND_bi && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase
      != FmgcComputer_P.EnumeratedConstant1_Value_c) && (FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant2_Value_pi) && rtb_NOR1 && rtb_y_l4 &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_c4 || (rtb_y_m && rtb_appCapability_idx_0 &&
      (rtb_OR2_l && (std::abs(rtb_altCstrOrFcu - rtb_y_hq) <= FmgcComputer_P.CompareToConstant2_const_e)))))));
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_cj, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he[(((rtb_Logic_d_idx_0_tmp ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active || (rtb_y_g > rtb_y_hq) || rtb_y_jw ||
      ((FmgcComputer_P.EnumeratedConstant_Value_b == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant6_Value)) || rtb_y_k ||
      (rtb_appCapability_idx_0 && rtb_y_j_tmp) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_Compare_pf) << 1))
    ...
    rtb_OR4_e = (rtb_OR_ko && rtb_ap_fd_condition_tmp_1 &&
                 (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active) && rtb_y_ey && rtb_OR2_l_tmp &&
                 rtb_appInop_idx_2);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mo, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_OR4_e &&
      rtb_y_l4 && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_dv &&
      ...
      FmgcComputer_DWork.DelayInput1_DSTATE_n)) || (rtb_y_jw && (rtb_Compare_l0_tmp || (rtb_appCapability_idx_0 &&
      rtb_y_m && (rtb_y_j_tmp || (std::abs(rtb_altCstrOrFcu - rtb_y_hq) > FmgcComputer_P.CompareToConstant2_const_l))))))));
    ...
    rtb_y_jw = (rtb_Memory || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active);
    rtb_appCapability_idx_0 = (rtb_y_jw || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ht, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d2, &rtb_y_hq);
    rtb_NOR1 = (rtb_y_g > rtb_y_hq);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel4_bit_d, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_n, &rtb_y_m,
      &FmgcComputer_DWork.sf_MATLABFunction_f0h);
    rtb_Memory = rtb_TmpSignalConversionAtSFunctionInport3_idx_0;
    rtb_y_c4 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && rtb_y_c4),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_jo, FmgcComputer_P.ConfirmNode_timeDelay_jo,
      &rtb_y_c4, &FmgcComputer_DWork.sf_MATLABFunction_moh);
    rtb_y_dv = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
                 ((FmgcComputer_P.EnumeratedConstant_Value_c == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                  ...
                  rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_k)) || rtb_y_c4);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_y_c4 = (rtb_y_m || rtb_y_dv || (rtb_Memory && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_k)));
    rtb_Compare_l0_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_Compare_l0_tmp && rtb_NOR1 && rtb_y_c4));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ae = FmgcComputer_P.Logic_table_jq[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_AND10_b || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
    ...
    rtb_OR2_l_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ae && rtb_y_dv);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_OR4_e = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_i, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_dp, &rtb_y_hq);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel4_bit_i, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_fw, &rtb_y_dv,
    ...
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active &&
      ...
      FmgcComputer_P.ConfirmNode_isRisingEdge_fq, FmgcComputer_P.ConfirmNode_timeDelay_lp, &rtb_y_c4,
      &FmgcComputer_DWork.sf_MATLABFunction_hj);
    rtb_y_dv = (rtb_y_dv || rtb_y_c4);
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_Compare_l0_tmp && (rtb_y_g < rtb_y_hq) && rtb_y_dv));
    ...
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_b, &rtb_y_dv,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi && (rtb_y_dv && rtb_Logic_oq_idx_0 && rtb_OR_ko)))
    ...
    rtb_NOR1 = (((dPsi_1 < FmgcComputer_DWork.DelayInput1_DSTATE_b) && (rtb_Nosewheel_c <
    ...
    rtb_Memory = (rtb_AND_bi && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_appInop_idx_1 && rtb_NOR1
                  && rtb_Memory);
    rtb_Compare_pf = ((rtb_Compare_pf && (rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || rtb_Memory);
    ...
    rtb_Logic_oq_idx_0 = (rtb_y_jw || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_nu = FmgcComputer_P.Logic_table_d3[(((((!rtb_Memory) && (rtb_Logic_oq_idx_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    rtb_OR_ko = ((rtb_Compare_pf && (rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi && rtb_OR4_e &&
    ...
    rtb_Logic_oq_idx_0 = FmgcComputer_P.Logic_table_fi[(((((!rtb_Memory) && (rtb_Logic_oq_idx_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_hd, &rtb_y_dq);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_ir_computation_data_flight_path_angle_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_i, &rtb_y_aq);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pc, &rtb_y_ev);
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_f, &rtb_y_g);
    rtb_appCapability_idx_0 = (rtb_AND1_g || rtb_y_dh);
    if (rtb_AND1_g) {
      dPsi_2 -= rtb_y_ev;
      rtb_Nosewheel_c = 50.0;
    } else {
      dPsi_2 = rtb_y_aq - rtb_y_dq;
      rtb_Nosewheel_c = 0.1;
    }

    rtb_Compare_pf = (rtb_Logic_a2[0] && rtb_appCapability_idx_0);
    rtb_OR_ko = ((rtb_Compare_pf && (rtb_y_g < rtb_y_hq + 3.0F) && (dPsi_2 < -rtb_Nosewheel_c)) || (rtb_Compare_pf &&
      (rtb_y_g > rtb_DataTypeConversion2_m - 3.0F) && (dPsi_2 > rtb_Nosewheel_c)));
    FmgcComputer_MATLABFunction_j((rtb_OR_ko || rtb_OR2_l_tmp || rtb_Logic_gj_idx_0_tmp_tmp || apCondition_tmp),
    ...
    FmgcComputer_MATLABFunction_j((rtb_Logic_gj_idx_0_tmp_tmp || rtb_Compare_pf), FmgcComputer_U.in.time.dt, &rtb_OR4_e,
    ...
    rtb_y_jw = rtb_Compare_pf;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_OR4_e);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_l4);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_k(((rtb_OR4_e || rtb_y_l4 || (rtb_DataTypeConversion1_e != 0U)) && (rtb_Memory ||
      rtb_Compare_pf)), FmgcComputer_P.PulseNode_isRisingEdge_py, &rtb_NOR1, &FmgcComputer_DWork.sf_MATLABFunction_esv);
    rtb_OR4_e = rtb_ap_fd_condition_tmp_0;
    rtb_Compare_pf = (rtb_Compare_pf || rtb_NOR1_a || ((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_c)
      && rtb_ap_fd_condition_tmp_0));
    rtb_Memory = (rtb_NOR1 && rtb_Compare_pf);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_kh(rtb_Logic_gj_idx_0_tmp, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_nz, FmgcComputer_P.ConfirmNode_timeDelay_a5, &rtb_NOR1,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bw = FmgcComputer_P.Logic_table_bs[((((!rtb_Compare_pf) || rtb_OR_fz ||
      rtb_Compare_j5 || FmgcComputer_DWork.Memory_PreviousInput_ip || rtb_OR4_e || rtb_NOR1) + (static_cast<uint32_T>
    ...
    rtb_Compare_pf = ((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h);
    FmgcComputer_MATLABFunction_kh(rtb_OR_pj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_b4,
      FmgcComputer_P.ConfirmNode1_timeDelay_h, &rtb_y_dv, &FmgcComputer_DWork.sf_MATLABFunction_hjm);
    FmgcComputer_MATLABFunction_k(rtb_y_dv, FmgcComputer_P.PulseNode3_isRisingEdge_k, &rtb_y_c4,
    ...
    rtb_Memory = (rtb_Logic_gj_idx_0_tmp && rtb_ap_fd_condition_tmp_0 && (!FmgcComputer_DWork.Memory_PreviousInput_nu) &&
                  (!rtb_Logic_oq_idx_0) && (!FmgcComputer_DWork.Memory_PreviousInput_d));
    rtb_NOR1 = ((FmgcComputer_U.in.fms_inputs.v_managed_kts == FmgcComputer_P.CompareToConstant_const_dy) && rtb_y_c4 &&
                rtb_Memory);
    FmgcComputer_MATLABFunction_k(rtb_y_c, FmgcComputer_P.PulseNode1_isRisingEdge_kl, &rtb_y_c4,
      &FmgcComputer_DWork.sf_MATLABFunction_dtd);
    rtb_y_dv = (rtb_y_c4 && (FmgcComputer_U.in.fms_inputs.fms_flight_phase != FmgcComputer_P.EnumeratedConstant_Value_ad));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_gv, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_f, &rtb_y_c4,
      &FmgcComputer_DWork.sf_MATLABFunction_d5);
    rtb_y_c4 = (rtb_y_c4 && rtb_NOR1_d);
    FmgcComputer_MATLABFunction_k((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant1_const_e), FmgcComputer_P.PulseNode4_isRisingEdge_a, &rtb_y_m,
      &FmgcComputer_DWork.sf_MATLABFunction_aa);
    rtb_OR4_e = (((FmgcComputer_P.Constant_Value_k != FmgcComputer_DWork.DelayInput1_DSTATE_f) && rtb_OR_pj) || rtb_NOR1
                 || rtb_y_dv || rtb_y_c4 || (rtb_y_m && rtb_OR_pj && rtb_Memory));
    rtb_y_l4 = (rtb_Compare_pf || (rtb_AND_bi && rtb_OR4_e));
    FmgcComputer_MATLABFunction_kh(rtb_y_l4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ch,
    ...
    FmgcComputer_MATLABFunction_k(rtb_y_c, FmgcComputer_P.PulseNode5_isRisingEdge, &rtb_OR4_e,
      &FmgcComputer_DWork.sf_MATLABFunction_kzm);
    FmgcComputer_DWork.Memory_PreviousInput_cu = FmgcComputer_P.Logic_table_kg
      [((((FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active && (!rtb_Compare_pf)) || (rtb_NOR1_a && (rtb_Memory ||
            rtb_OR4_e))) + (static_cast<uint32_T>(rtb_y_l4) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cu];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_5,
      FmgcComputer_P.BitfromLabel_bit_kq, &rtb_DataTypeConversion1_e);
    rtb_Compare_pf = ((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h);
    FmgcComputer_MATLABFunction_k(rtb_y_c, FmgcComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_dv,
    ...
    FmgcComputer_MATLABFunction_k(rtb_Memory, FmgcComputer_P.PulseNode2_isRisingEdge_iu, &rtb_NOR1,
      &FmgcComputer_DWork.sf_MATLABFunction_ft);
    rtb_NOR1 = (rtb_y_c && rtb_NOR1);
    rtb_AND10_b = ((rtb_y_dv && rtb_Memory) || (rtb_OR4_e && rtb_Memory && rtb_y_c) || rtb_NOR1);
    rtb_y_k = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_k(rtb_y_k, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_dv,
      &FmgcComputer_DWork.sf_MATLABFunction_mrn);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ie, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_jp, &rtb_y_c4,
    ...
    FmgcComputer_MATLABFunction_k((rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active ||
      ...
      FmgcComputer_P.PulseNode4_isRisingEdge_n, &rtb_NOR1, &FmgcComputer_DWork.sf_MATLABFunction_lr);
    rtb_OR4_e = (FmgcComputer_U.in.fms_inputs.v_managed_kts != FmgcComputer_P.CompareToConstant2_const_m);
    rtb_Memory = (rtb_Compare_pf || (rtb_AND_bi && ((rtb_NOR1_a && rtb_AND10_b) || (rtb_y_dv || rtb_y_c4 || rtb_NOR1)) &&
      (rtb_OR4_e || (FmgcComputer_U.in.fms_inputs.v_2_kts != FmgcComputer_P.CompareToConstant3_const_j))));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_h = FmgcComputer_P.Logic_table_ds
      [((((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && (!rtb_Compare_pf)) || (rtb_NOR1_a &&
           (rtb_ap_fd_condition_tmp_0 && rtb_Logic_gj_idx_0_tmp) && rtb_OR4_e)) + (static_cast<uint32_T>(rtb_Memory) <<
          1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_h];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_adr_computation_data_corrected_average_static_pressure,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_b, &rtb_y_g);
    y = std::pow((std::pow(rtb_y_hq * rtb_y_hq * 0.2F + 1.0F, 3.5F) - 1.0F) * (rtb_y_g / 1013.25F) + 1.0F, 0.285714298F);
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_man_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_h, &rtb_y_g);
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_i) {
      ...
      rtb_Nosewheel_c = rtb_y_ev + static_cast<real_T>(high_i);
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_h) {
      if (FmgcComputer_DWork.Memory_PreviousInput_d || FmgcComputer_DWork.Memory_PreviousInput_l ||
        ...
        rtb_Switch_e[0] = std::fmax(std::fmax(std::fmax(static_cast<real_T>(rtb_y_g), static_cast<real_T>
          (rtb_DataTypeConversion2_m)), static_cast<real_T>(rtb_y_aq)), FmgcComputer_B.u_l);
    ...
    rtb_Memory = (rtb_appCapability_idx_0 || FmgcComputer_DWork.Memory_PreviousInput_cb ||
                  ...
                  FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_Logic_oq_idx_0 ||
    ...
    } else if (rtb_Compare_j5 || FmgcComputer_DWork.Memory_PreviousInput_b || FmgcComputer_DWork.Memory_PreviousInput_e)
    {
    ...
    } else if (FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_Logic_oq_idx_0 ||
               FmgcComputer_DWork.Memory_PreviousInput_d) {
    ...
    } else if (rtb_AND1_g || rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.tcas_active) {
    ...
    rtb_Logic_gj_idx_0_tmp = (rtb_NOT3 || FmgcComputer_DWork.Memory_PreviousInput_e ||
      ...
      rtb_Compare_j5 || FmgcComputer_DWork.Memory_PreviousInput_ip || FmgcComputer_DWork.Memory_PreviousInput_d);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4, &rtb_OR4_e);
    rtb_Compare_pf = ((rtb_Compare_pf || ((rtb_DataTypeConversion1_e != 0U) && rtb_OR4_e)) &&
                      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged);
    rtb_OR4_e = (rtb_Logic_a2[0] && (FmgcComputer_DWork.Memory_PreviousInput_l ||
      FmgcComputer_DWork.Memory_PreviousInput_d));
    rtb_y_l4 = ((!fdOppOff) && (FmgcComputer_U.in.discrete_inputs.fwc_own_valid ||
    ...
    rtb_appInop_idx_1 = (rtb_y_l4 && (!rtb_ap_fd_condition_tmp) && rtb_bothRaValid);
    ...
    rtb_appCapability_idx_0 = (rtb_y_l4 && rtb_OR4_e && (!apCondition_tmp_0) && rtb_appCapability_idx_0);
    rtb_y_l4 = !rtb_y_l4;
    ...
    rtb_AND10_b = ((rtb_DataTypeConversion1_e != 0U) && rtb_Compare_pf);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4,
    ...
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_jl);
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_p, &rtb_y_ev);
    rtb_DataTypeConversion32 = rtb_y_ev;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_i, &rtb_y_dq);
    rtb_DataTypeConversion26 = rtb_y_dq;
    ...
    rtb_OR4_e = (rtb_Logic_oq_idx_0 || FmgcComputer_DWork.Memory_PreviousInput_d);
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_pfdTarget,
                    ...
                    &rtb_DataTypeConversion25, &rtb_y_jl, &rtb_DataTypeConversion23,
                    ...
                    &rtb_DataTypeConversion32, &rtb_DataTypeConversion26, &rtb_NOR1_a, (const_cast<real_T*>
      (&FmgcComputer_RGND)), &rtb_Gain3, &(&rtb_Logic_a2[0])[0], &rtb_active_lateral_law, &rtb_active_longitudinal_law,
                    ...
                    &rtb_OR4_e, &rtb_Phi_loc_c, &rtb_Nosewheel_c, &rtb_Theta_c_deg, &rtb_Phi_c_deg, &rtb_Beta_c_deg,
    ...
    FmgcComputer_MATLABFunction_k((rtb_y_ha != 0U), FmgcComputer_P.PulseNode3_isRisingEdge_ng, &rtb_y_dv,
      &FmgcComputer_DWork.sf_MATLABFunction_k);
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_y_dv) << 1)
    ...
    rtb_y_jl = (rtb_y_g >= FmgcComputer_P.CompareToConstant_const_hq);
    rtb_OR4_e = (rtb_y_g <= FmgcComputer_P.CompareToConstant2_const_di);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o2, &rtb_y_g);
    rtb_NOR1 = (rtb_y_g >= FmgcComputer_P.CompareToConstant1_const_h4);
    rtb_y_dv = (rtb_y_g <= FmgcComputer_P.CompareToConstant3_const_d);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_ey);
    ...
    rtb_y_c4 = (rtb_y_g > FmgcComputer_P.CompareToConstant4_const_p);
    rtb_y_m = (rtb_y_g <= FmgcComputer_P.CompareToConstant6_const_h);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_l, &rtb_y_g);
    rtb_y_jl = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_jl &&
      rtb_OR4_e && rtb_NOR1 && rtb_y_dv) || ((!rtb_y_ey) && (!rtb_y_k) && rtb_BusAssignment_h_logic_one_engine_out &&
      (rtb_y_c4 && rtb_y_m && (rtb_y_g > FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_g <=
    ...
    FmgcComputer_MATLABFunction_k((((rtb_active_longitudinal_law == vertical_law::SPD_MACH) ||
      ...
      FmgcComputer_DWork.Delay_DSTATE_k), FmgcComputer_P.PulseNode_isRisingEdge_o, &rtb_NOR1,
      &FmgcComputer_DWork.sf_MATLABFunction_j);
    rtb_y_c4 = !FmgcComputer_DWork.Memory_PreviousInput_hu;
    rtb_OR4_e = rtb_y_c4;
    rtb_NOR1 = (((rtb_y_ha != 0U) && rtb_NOR1_h) || (rtb_AND_bi && rtb_NOR1 && rtb_y_c4));
    FmgcComputer_MATLABFunction_kh(rtb_NOR1, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_b,
      FmgcComputer_P.ConfirmNode_timeDelay_gu, &rtb_OR4_e, &FmgcComputer_DWork.sf_MATLABFunction_ay);
    rtb_y_dv = (FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_ap_fd_condition_tmp_2 ||
      ((rtb_y_dv || FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_OR4_e))) + (static_cast<uint32_T>
      (rtb_NOR1) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_bh];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.ats_discrete_word,
    ...
    FmgcComputer_MATLABFunction_k(((((rtb_active_longitudinal_law == vertical_law::NONE) &&
      ...
      FmgcComputer_P.PulseNode_isRisingEdge_fz, &rtb_NOR1, &FmgcComputer_DWork.sf_MATLABFunction_ge);
    rtb_OR4_e = rtb_y_c4;
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_NOR1_h) || (rtb_AND_bi && rtb_NOR1 && rtb_y_c4));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_ap_fd_condition_tmp_2 ||
      ((rtb_y_dv || FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active) && (!rtb_OR4_e))) + (static_cast<uint32_T>
    ...
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_NOR1_h) || (rtb_AND_bi && FmgcComputer_DWork.Memory_PreviousInput_d &&
      rtb_Logic_a2[0] && rtb_OR4_e && rtb_y_c4));
    ...
    rtb_NOR1 = (FmgcComputer_DWork.Memory_PreviousInput_b3 || FmgcComputer_DWork.Memory_PreviousInput_ev ||
                rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active);
    rtb_OR4_e = (rtb_NOR1 || rtb_Logic_b[0]);
    FmgcComputer_DWork.Memory_PreviousInput_kr = FmgcComputer_P.Logic_table_b3[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_AND1_g ||
        rtb_y_dh) && rtb_ap_fd_condition_tmp_0) << 1) + (rtb_BusAssignment_h_logic_one_engine_out || rtb_NOR1_a ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_km = FmgcComputer_P.Logic_table_mj[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_AND1_g ||
        rtb_y_dh) && rtb_BusAssignment_h_logic_one_engine_out) << 1) + (rtb_ap_fd_condition_tmp_0 || rtb_NOR1_a ||
    ...
    rtb_OR_pj = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_c4);
    ...
    rtb_y_g = std::fmax(FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data,
    ...
    rtb_y_k = !rtb_y_jl;
    rtb_ap_fd_condition_tmp_0 = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_k);
    if (rtb_ap_fd_condition_tmp_0 && (rtb_y_g > 44.0F)) {
      rtb_y_ib = athr_fma_mode::MAN_TOGA;
    } else {
      rtb_AND_bi = (rtb_ap_fd_condition_tmp_0 && (rtb_y_g > 34.0F) && (rtb_y_g < 36.0F));
      if (rtb_AND_bi && rtb_OR_pj) {
        rtb_y_ib = athr_fma_mode::MAN_FLEX;
      } else if (rtb_AND_bi && (!rtb_OR_pj)) {
        rtb_y_ib = athr_fma_mode::MAN_MCT;
      } else if (rtb_ap_fd_condition_tmp_0 && (rtb_y_g > 24.0F)) {
        rtb_y_ib = athr_fma_mode::MAN_THR;
      } else {
        rtb_ap_fd_condition_tmp_0 = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_jl);
        rtb_AND_bi = (rtb_ap_fd_condition_tmp_0 && FmgcComputer_DWork.Memory_PreviousInput_cm);
        if (rtb_AND_bi && (!FmgcComputer_DWork.Delay_DSTATE_c)) {
          rtb_y_ib = athr_fma_mode::SPEED;
        } else if (rtb_AND_bi && FmgcComputer_DWork.Delay_DSTATE_c) {
          rtb_y_ib = athr_fma_mode::MACH;
        } else {
          rtb_AND_bi = (rtb_ap_fd_condition_tmp_0 && FmgcComputer_DWork.Memory_PreviousInput_bh);
          rtb_OR_pj = !rtb_OR4_e;
          if (rtb_AND_bi && (rtb_y_g > 34.0F) && rtb_OR_pj) {
            rtb_y_ib = athr_fma_mode::THR_MCT;
          } else if (rtb_AND_bi && (rtb_y_g > 24.0F) && rtb_OR_pj) {
            rtb_y_ib = athr_fma_mode::THR_CLB;
          } else if (rtb_AND_bi && (rtb_y_g < 25.0F) && rtb_OR_pj) {
            rtb_y_ib = athr_fma_mode::THR_LVR;
          } else if (rtb_ap_fd_condition_tmp_0 && ((FmgcComputer_DWork.Memory_PreviousInput_bh && rtb_OR4_e) ||
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_km, &rtb_y_dq);
    ...
    if (dPsi_2 < static_cast<real32_T>(rtb_Switch_e[0])) {
      if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_g) {
        high_i = 1;
      } else if (dPsi_2 < rtb_y_g) {
        high_i = 2;
      } else {
        high_i = 0;
      }
      ...
      high_i = 0;
    } else if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_g) {
      high_i = 2;
    } else {
      high_i = 1;
    }

    rtb_DataTypeConversion2_m = v[high_i] - rtb_y_dq;
    ...
    rtb_DataTypeConversion1_d = FmgcComputer_P.Gain1_Gain_a * rtb_y_g;
    ...
    rtb_DataTypeConversion8 = FmgcComputer_P.fpmtoms_Gain * rtb_y_g;
    ...
    rtb_Switch1_a = rtb_y_g;
    rtb_DataTypeConversion2_e = FmgcComputer_P.kntoms_Gain * rtb_y_g;
    ...
    rtb_Product_a = FmgcComputer_P.Gain1_Gain_h * rtb_y_g;
    ...
    rtb_DataTypeConversion5 = FmgcComputer_P.Gain1_Gain_f * rtb_y_g;
    ...
    FmgcComputer_LeadLagFilter(FmgcComputer_DWork.pY_f - FmgcComputer_P.g_Gain * (FmgcComputer_P.Gain1_Gain_d *
      ...
      (FmgcComputer_P.Gain1_Gain_p * rtb_y_g - rtb_DataTypeConversion5)))), FmgcComputer_P.HighPassFilter_C1,
    ...
    if (rtb_y_g > FmgcComputer_P.Saturation1_UpperSat_l) {
      rtb_Switch1_a = FmgcComputer_P.Saturation1_UpperSat_l;
    } else if (rtb_y_g < FmgcComputer_P.Saturation1_LowerSat_i) {
    ...
    FmgcComputer_LagFilter(dPsi_2, FmgcComputer_P.LagFilter1_C1, FmgcComputer_U.in.time.dt, &rtb_y_g,
    ...
    rtb_Cos_h = rtb_y_g - rtb_Cos_h / std::cos(FmgcComputer_P.Gain1_Gain_go * dPsi_2);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_n1_actual_percent,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_e, &rtb_y_dq);
    ...
    FmgcComputer_DWork.pY += std::fmax(std::fmin(static_cast<real_T>(rtb_Memory_n) - FmgcComputer_DWork.pY, std::abs
    ...
    if (FmgcComputer_U.in.sim_data.tracking_mode_on_override) {
      ...
      rtb_Switch1_a = ((FmgcComputer_P.Gain_Gain * rtb_DataTypeConversion1_d + FmgcComputer_DWork.pY_d) +
        ...
        * look1_iflf_binlxpw(std::fmin(dPsi_2, rtb_y_dq), FmgcComputer_P.ScheduledGain2_BreakpointsForDimension1,
    ...
    FmgcComputer_DWork.icLoad = (rtb_ap_fd_condition_tmp_2 || rtb_y_k || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    rtb_VectorConcatenate[9] = rtb_y_l4;
    ...
    rtb_VectorConcatenate[13] = rtb_AND10_b;
    ...
    rtb_VectorConcatenate[3] = rtb_y_jl;
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_y_dq);
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_bw, &rtb_y_ev);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_fma_discrete_word.Data = rtb_y_ev;
    rtb_VectorConcatenate_bw[0] = FmgcComputer_DWork.Memory_PreviousInput_bw;
    rtb_VectorConcatenate_bw[1] = rtb_y_fb;
    ...
    rtb_VectorConcatenate_f[0] = (FmgcComputer_DWork.Memory_PreviousInput_ec ||
      FmgcComputer_DWork.Memory_PreviousInput_ae ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_VectorConcatenate_f[1] = rtb_NOR1;
    ...
    rtb_VectorConcatenate_f[6] = rtb_AND1_g;
    rtb_VectorConcatenate_f[7] = rtb_y_dh;
    rtb_VectorConcatenate_f[8] = (FmgcComputer_DWork.Memory_PreviousInput_ne ||
      FmgcComputer_DWork.Memory_PreviousInput_cb);
    rtb_VectorConcatenate_f[9] = (FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_Logic_oq_idx_0);
    rtb_VectorConcatenate_f[10] = (FmgcComputer_DWork.Memory_PreviousInput_ne ||
      FmgcComputer_DWork.Memory_PreviousInput_nu);
    rtb_VectorConcatenate_f[11] = (FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_Logic_oq_idx_0);
    ...
    rtb_VectorConcatenate_f[15] = rtb_Memory_n;
    ...
    rtb_VectorConcatenate_f[6] = rtb_Compare_j5;
    ...
    rtb_VectorConcatenate_f[17] = rtb_y_jw;
    ...
    FmgcComputer_Y.out.logic.on_ground = rtb_NOR1_a;
    FmgcComputer_Y.out.logic.gnd_eng_stop_flt_5s = rtb_NOR1_d;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.trk_active = rtb_Compare_j5;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.vs_active = rtb_AND1_g;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.fpa_active = rtb_y_dh;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.fma_dash_display = rtb_Memory_n;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.gs_capt_active = FmgcComputer_DWork.Memory_PreviousInput_nu;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.gs_trk_active = rtb_Logic_oq_idx_0;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.tcas_active =
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.tcas_active;
    FmgcComputer_Y.out.ap_fd_logic.armed_modes.alt_acq_armed = rtb_y_fb;
    ...
    FmgcComputer_Y.out.ap_fd_logic.fmgc_opp_mode_sync = rtb_NOR1_h;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_mode_reversion = apCondition_tmp;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_mode_reversion_vs = rtb_Logic_gj_idx_0_tmp_tmp;
    ...
    FmgcComputer_Y.out.ap_fd_logic.roll_fd_bars_flashing = rtb_y_jw;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_2_inop = rtb_y_l4;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_passive_capacity = rtb_AND10_b;
    ...
    FmgcComputer_Y.out.athr.athr_active = rtb_y_jl;
    ...
    FmgcComputer_Y.out.athr.thrust_target_idle = rtb_OR4_e;
    ...
    if (rtb_OR_pj || rtb_BusAssignment_b_logic_ils_tune_inhibit) {
    ...
    rtb_y_k = !FmgcComputer_DWork.Memory_PreviousInput_m;
    if (rtb_Logic_gj_idx_0_tmp && (!FmgcComputer_DWork.Memory_PreviousInput_c) && rtb_y_k) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.Data = rtb_y_dq;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.Data = rtb_y_ev;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.Data = rtb_y_dq;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.Data = rtb_y_ev;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active = rtb_Compare_j5;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active = rtb_AND1_g;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active = rtb_y_dh;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fma_dash_display = rtb_Memory_n;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active = FmgcComputer_DWork.Memory_PreviousInput_nu;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active = rtb_Logic_oq_idx_0;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active =
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.tcas_active;
    FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed = rtb_y_fb;
    ...
    FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync = rtb_NOR1_h;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_mode_reversion_vs = rtb_Logic_gj_idx_0_tmp_tmp;
    ...
    FmgcComputer_DWork.Delay_DSTATE.roll_fd_bars_flashing = rtb_y_jw;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_2_inop = rtb_y_l4;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_passive_capacity = rtb_AND10_b;
    ...
    FmgcComputer_DWork.Memory_PreviousInput_as = rtb_Logic_oq_idx_0;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.athr_active = rtb_y_jl;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.thrust_target_idle = rtb_OR4_e;
