...
void FmgcComputer::step()
{
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    ...
    rtb_y_p5 = (rtb_y_p && rtb_y_bo && rtb_y_ed && rtb_y_p3);
    ...
    rtb_y_h = ((FmgcComputer_U.in.discrete_inputs.eng_opp_stop && FmgcComputer_U.in.discrete_inputs.eng_own_stop &&
                rtb_y_p5) || rtb_y_p3);
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
    ...
    rtb_ap_fd_condition = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || rtb_AND_cf) && (rtb_y_g ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (rtb_ap_fd_condition_tmp_0 ||
      (rtb_ap_fd_condition_tmp_1 && rtb_y_k && rtb_ap_fd_condition_tmp_3 && rtb_ap_fd_condition_tmp_2)) &&
      (rtb_ap_fd_condition_tmp || rtb_AND_cf) && (!rtb_y_ft));
    ...
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((fdOppOff || (rtb_y_bo &&
      ...
      rtb_OR2_l) || (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged && rtb_y_hq && rtb_fmgcOppPriority)) || (rtb_y_p5 &&
      (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_p || (rtb_y_gl >=
      FmgcComputer_P.CompareToConstant5_const))) || (rtb_y_ft && rtb_y_p5)) + (static_cast<uint32_T>(rtb_y_bo &&
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_y_h && rtb_ap_fd_condition && rtb_ap_fd_athr_condition && apCondition)
    ...
    FmgcComputer_MATLABFunction_g((rtb_y_ft && (rtb_y_gl < FmgcComputer_P.CompareToConstant1_const)),
      FmgcComputer_P.PulseNode2_isRisingEdge_n, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_d4);
    ...
    rtb_ap_fd_condition_tmp = (rtb_y_if || (!rtb_y_g));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(rtb_ap_fd_athr_condition &&
      rtb_y_g && ((rtb_y_ed && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_Compare_bj || rtb_y_bo ||
      ...
      FmgcComputer_U.in.discrete_inputs.athr_instinctive_disc || rtb_y_aq)) << 1) +
    ...
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_y_if) && (rtb_y_ft || rtb_y_g) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_ft || rtb_y_if) && (rtb_OR2_l || rtb_y_g) &&
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_m_logic_adr_computation_data_vertical_speed_ft_min,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_c, &rtb_y_hnn);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel5_bit_b, &rtb_DataTypeConversion1_e);
    rtb_y_n2 = !rtb_y_p;
    if (rtb_y_n2 || (rtb_DataTypeConversion1_e == 0U)) {
      FmgcComputer_B.u_lyjjlj = rtb_y_hnn;
    }
    ...
    rtb_y_gj = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active ||
    ...
    rtb_AND_iz = (rtb_y_gj && FmgcComputer_DWork.Delay_DSTATE.alt_cstr_applicable && rtb_appInop_idx_0 &&
                  FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid);
    if (rtb_y_fd > rtb_y_gl) {
      rtb_OR_bg = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft < rtb_y_fd) &&
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_p5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_h,
    ...
    rtb_NOT3 = !rtb_y_p3;
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_b4i);
    rtb_y_b4i = (rtb_y_p3 && (rtb_y_gl > FmgcComputer_P.CompareToConstant4_const) && rtb_y_b4i);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b, &rtb_y_gl);
    rtb_y_p3 = (rtb_y_gl < FmgcComputer_P.CompareToConstant5_const_a);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_iz);
    FmgcComputer_MATLABFunction_g((rtb_NOT3 || rtb_y_b4i || (!rtb_y_p3) || (rtb_y_p3 && (rtb_y_gl >
      FmgcComputer_P.CompareToConstant6_const) && rtb_y_iz)), FmgcComputer_P.PulseNode_isRisingEdge_p, &rtb_y_aq,
    ...
    rtb_AND1_c0 = (rtb_y_iz && rtb_appInop_idx_2 && rtb_OR2_l_tmp);
    rtb_NOT3 = (((FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant1_const_k) &&
                 (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_AND1_c0 && rtb_Compare_bj &&
    ...
    rtb_DataTypeConversion2_kb = std::abs(rtb_y_fd - rtb_y_gl);
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_p5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_p,
    ...
    rtb_NOT3 = ((rtb_y_p3 && (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_iz &&
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg, &rtb_y_b4i);
    FmgcComputer_DWork.Memory_PreviousInput_c = FmgcComputer_P.Logic_table_hz[(((((!rtb_y_aq) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_trk_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_OR_bg || (!rtb_y_b4i)) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction_j((rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_l),
      FmgcComputer_U.in.time.dt, &rtb_y_aq, FmgcComputer_P.MTrigNode_isRisingEdge_jv,
    ...
    rtb_NOT3 = rtb_y_ed;
    rtb_y_b4i = (FmgcComputer_DWork.Memory_PreviousInput_c || FmgcComputer_DWork.Memory_PreviousInput_b);
    ...
    rtb_y_f5 = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_if);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ek, &rtb_y_hnn);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_own_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_f, &rtb_y_fy);
    ...
    rtb_GreaterThan3_tmp_1 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active;
    rtb_Compare_j3 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active;
    rtb_y_p3 = (rtb_ap_fd_condition_tmp_2 && (rtb_y_f5 || (rtb_y_iz && (FmgcComputer_P.Constant_Value_l &&
      rtb_GreaterThan3_tmp && (rtb_y_hq || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_g)) &&
      rtb_ap_fd_condition_tmp_0 && rtb_y_ed && (!rtb_y_aq) && (rtb_Compare_j3 &&
      (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed))) && rtb_appInop_idx_2 && rtb_OR2_l_tmp &&
      rtb_GreaterThan3_tmp_0 && rtb_GreaterThan3_tmp_1 && rtb_Compare_bj && rtb_Compare_bj && (((rtb_y_hnn == rtb_y_fy) &&
      (rtb_y_fd == rtb_y_gl)) || (!rtb_BusAssignment_o_logic_both_ils_valid)))));
    ...
    rtb_AND8 = (rtb_appInop_idx_1 && rtb_y_aq);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_l, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_c, &rtb_y_aq,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_AND_cf || ((!rtb_NOT_b) &&
      ...
      rtb_AND8) || (rtb_y_ed && FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed) || rtb_y_aq || rtb_OR_bg ||
    ...
    rtb_AND_cf = (rtb_Compare_bj && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_iz &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_a, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_fa);
    FmgcComputer_MATLABFunction_a(rtb_y_p5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode2_isRisingEdge_l,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_y_p ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active)) && rtb_y_ed) ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || (rtb_fmgcOppPriority_tmp && rtb_y_bo &&
      rtb_y_aq && rtb_Compare_bj) || rtb_OR_bg) + (static_cast<uint32_T>(rtb_AND_cf) << 1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_d];
    rtb_y_f5 = (FmgcComputer_U.in.discrete_inputs.bscu_opp_valid || FmgcComputer_U.in.discrete_inputs.bscu_own_valid);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      ...
      FmgcComputer_U.in.discrete_inputs.right_wheel_spd_abv_70_kts) && rtb_y_f5) || ((!rtb_y_f5) && rtb_y_p5))),
    ...
    rtb_AND_cf = (rtb_ap_fd_condition_tmp_0 && FmgcComputer_DWork.Delay2_DSTATE.flare_law.condition_Flare &&
                  FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active);
    ...
    rtb_y_p3 = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_if);
    rtb_y_am = (rtb_y_hq || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_lj) || rtb_dualRaFailure);
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_le, FmgcComputer_P.ConfirmNode_timeDelay_n, &rtb_y_aq,
    ...
    rtb_y_p = (rtb_y_iz && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid);
    rtb_y_f5 = (rtb_y_p && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && FmgcComputer_P.Constant_Value_hg &&
                rtb_y_am && rtb_ap_fd_condition_tmp_1 && (rtb_appInop_idx_2 && rtb_GreaterThan3_tmp_0 && rtb_OR2_l_tmp &&
      rtb_GreaterThan3_tmp_1 && rtb_Compare_j3 && (!rtb_y_aq) && rtb_y_hq));
    rtb_NOT_b = (rtb_ap_fd_condition_tmp_2 && (rtb_y_p3 || rtb_y_f5));
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_li,
      &rtb_y_f5, &FmgcComputer_DWork.sf_MATLABFunction_bk);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c
      [(((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_bo || rtb_y_aq || (rtb_y_hq &&
           FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed) || rtb_y_f5 || rtb_OR_bg ||
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_iz &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_p5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_m,
      FmgcComputer_P.ConfirmNode_timeDelay_j5, &rtb_y_am, &FmgcComputer_DWork.sf_MATLABFunction_hvs);
    rtb_y_f5 = (rtb_handleIndex >= FmgcComputer_P.CompareToConstant_const_ja);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_AND1_c0 && (!rtb_y_am) && rtb_y_f5 &&
      rtb_y_aq));
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_iz && (rtb_GreaterThan3_tmp_1 &&
    ...
    rtb_y_ed = (rtb_GreaterThan3_tmp_0 && rtb_GreaterThan3_tmp_1);
    rtb_Compare_bj = (rtb_appInop_idx_1 && rtb_y_f5 && (rtb_y_ed && rtb_TmpSignalConversionAtSFunctionInport3_idx_0 &&
      rtb_ap_fd_condition_tmp_2) && (!rtb_y_aq));
    ...
    rtb_y_hq = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active;
    rtb_GreaterThan3_tmp_0 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active;
    rtb_y_ed = (rtb_y_aq && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && (rtb_y_ed && rtb_y_hq &&
      rtb_GreaterThan3_tmp_0 && rtb_ap_fd_condition_tmp_2));
    rtb_NOT_b = rtb_appInop_idx_1;
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_b, &rtb_y_aq,
    ...
    rtb_Compare_bj = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_AND1_c0 && rtb_Compare_j3) ||
                      rtb_Compare_bj || rtb_y_ed || (rtb_appInop_idx_1 && rtb_NOT_ou && rtb_y_aq) ||
                      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_i, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_di2);
    rtb_y_p3 = (rtb_y_h && rtb_y_aq && rtb_ap_fd_condition_tmp_2 && (rtb_GreaterThan3_tmp_1 || (rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_a)));
    rtb_y_f5 = rtb_OR_m4;
    FmgcComputer_MATLABFunction_g(rtb_y_ft, FmgcComputer_P.PulseNode4_isRisingEdge_e, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_a5);
    rtb_NOT_b = !FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged;
    rtb_y_am = (rtb_NOT_b && rtb_OR2_l_tmp);
    rtb_y_ed = ((rtb_y_ed && rtb_y_if) || (rtb_y_iz && (rtb_y_p3 || (rtb_OR_m4 && rtb_y_aq && rtb_y_am) ||
      rtb_Compare_bj)));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_f2 = FmgcComputer_P.Logic_table_i[(((((!rtb_y_aq) && (rtb_AND8 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_j, &rtb_y_f5,
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_am);
    ...
    rtb_NOT_b = (rtb_y_p5 && (((!rtb_y_ed) && (!rtb_y_am)) || rtb_y_aq) && rtb_y_p3);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed,
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_ed);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_am);
    rtb_y_ed = (rtb_y_ed || rtb_y_am);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_y_p && ((rtb_y_hq && rtb_GreaterThan3_tmp_0 &&
      rtb_ap_fd_condition_tmp_2 && rtb_y_f5) || rtb_NOT_b || rtb_y_p3 || (rtb_y_aq && (!rtb_y_ed)))));
    FmgcComputer_MATLABFunction_g(rtb_y_ed, FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_f5,
      &FmgcComputer_DWork.sf_MATLABFunction_h0);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_p, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_k, &rtb_y_am,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_f5 || rtb_y_am || rtb_y_aq ||
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_iz &&
      ...
      FmgcComputer_P.CompareToConstant_const_oh) || rtb_dualRaFailure) && (rtb_GreaterThan3_tmp_1 ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((rtb_AND1_c0 || rtb_OR_bg ||
      ((rtb_Logic_d_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_aq))) + (
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_o, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_k4c);
    rtb_NOT_b = rtb_GreaterThan3_tmp;
    rtb_AND1_c0 = (rtb_y_aq && rtb_GreaterThan3_tmp && (rtb_raComputationData >=
    ...
    rtb_NOT_ou = (rtb_NOT_ou && rtb_y_aq && FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_NOT_b) && rtb_y_ed) ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_NOT_ou || rtb_y_aq) + (
      static_cast<uint32_T>((rtb_Compare_bj && rtb_y_if) || (rtb_y_iz && (rtb_y_p || rtb_AND1_c0))) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_o, &rtb_y_fy);
    ...
    if (low_i == absVsTarget) {
      ...
      if (guard1) {
        ...
        rtb_Compare_bj = ((rtb_DataTypeConversion1_d >= std::abs(rtb_y_fd)) && (absVsTarget == low_ip1));
      }
    } else {
    ...
    if (rtb_DataTypeConversion2_kb < 115.0F) {
      rtb_y_fd = std::abs(rtb_y_fy);
      if (rtb_y_fy < 0.0F) {
        absVsTarget = -1;
      } else {
        absVsTarget = (rtb_y_fy > 0.0F);
      }

      if (((rtb_DataTypeConversion2_kb > 25.0F) && ((rtb_y_fd < 10.0F) && ((low_i != absVsTarget) && rtb_Compare_bj))) ||
          (rtb_y_fd < 1.92)) {
        rtb_Compare_bj = (rtb_Compare_bj || ((rtb_DataTypeConversion2_kb < 15.0F) && (rtb_y_fd < 1.1)));
      } else {
        rtb_Compare_bj = false;
      }
    } else {
    ...
    rtb_y_ed = (rtb_Logic_d_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active);
    FmgcComputer_DWork.Memory_PreviousInput_cv = FmgcComputer_P.Logic_table_g4[(((((!rtb_y_aq) && (rtb_y_ed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_lq = FmgcComputer_P.Logic_table_j[(((((!rtb_y_aq) && (rtb_y_ed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_OR_bg) + (static_cast<uint32_T>(rtb_Compare_bj)
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pm, &rtb_y_hnn);
    rtb_DataTypeConversion2_kb = rtb_y_gl - rtb_y_hnn;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_j, &rtb_y_fy);
    ...
    if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) {
      ...
      if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active && rtb_y_n2) {
    ...
    rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s.Data =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_Data;
    if (rtb_DataTypeConversion2_kb < 0.0F) {
      rtb_y_n2 = (rtb_y_fd <= 0.0F);
    } else {
      rtb_y_n2 = ((rtb_DataTypeConversion2_kb > 0.0F) && (rtb_y_fd >= 0.0F));
    }

    rtb_NOT_ou = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_iz &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active) && rtb_y_k && rtb_ap_fd_condition_tmp_3 &&
      rtb_Compare_j3 && rtb_ap_fd_condition_tmp_2 && ((!rtb_y_n2) ||
      ((!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) &&
       (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active) && rtb_Compare_dw)) &&
      (((!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active) &&
    ...
    rtb_y_fy = rtb_y_fd * 0.00508F;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_d, &rtb_y_gl);
    rtb_Phi_c_deg = rtb_altCstrOrFcu - rtb_y_gl;
    rtb_y_p3 = (std::fmin(3000.0F, std::fmax(80.0F, rtb_y_fy * rtb_y_fy / ((((rtb_DataTypeConversion2_kb * static_cast<
      real32_T>(c[low_i]) + static_cast<real32_T>(c[low_i + 6])) * rtb_DataTypeConversion2_kb + static_cast<real32_T>
      (c[low_i + 12])) * rtb_DataTypeConversion2_kb + static_cast<real32_T>(c[low_i + 18])) * 9.81F) * 3.28084F)) > std::
                abs(rtb_Phi_c_deg));
    ...
    rtb_NOT_b = (FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed && (!rtb_y_aq) && (rtb_y_p3 && (static_cast<
      int32_T>(rtb_Phi_c_deg) == absVsTarget)));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel7_bit_j, &rtb_DataTypeConversion1_e);
    rtb_y_am = rtb_y_n5;
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_y_iz && rtb_NOT_b && ((rtb_raComputationData >=
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hux,
      FmgcComputer_P.ConfirmNode_timeDelay_lk, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_hw);
    ...
    FmgcComputer_MATLABFunction_a((std::abs(rtb_altCstrOrFcu - rtb_y_gl) < FmgcComputer_P.CompareToConstant_const_f),
      ...
      &rtb_y_am, &FmgcComputer_DWork.sf_MATLABFunction_ee);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel7_bit_k, &rtb_DataTypeConversion1_e);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_y_iz &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && rtb_y_am && (rtb_Compare_dw ||
      ((rtb_DataTypeConversion1_e == 0U) && (FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode ==
    ...
    rtb_y_ed = (std::abs(FmgcComputer_U.in.fms_inputs.cruise_alt_ft - rtb_y_gl) <
                FmgcComputer_P.CompareToConstant1_const_a);
    rtb_AND1_c0 = !rtb_AND_iz;
    rtb_Compare_dw = (FmgcComputer_DWork.Memory_PreviousInput_cb && rtb_AND1_c0 && rtb_y_ed);
    ...
    rtb_Logic_gj_idx_0_tmp_tmp_tmp = rtb_y_am;
    ...
    rtb_y_aq = (rtb_Compare_bj && rtb_y_ed);
    ...
    rtb_DataTypeConversion2_bh = rtb_y_fd - rtb_y_gl;
    ...
    rtb_GreaterThan3_tmp = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_GreaterThan3_tmp_1 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    rtb_y_n2 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && rtb_y_hq && rtb_GreaterThan3_tmp_0);
    rtb_Compare_bj = (rtb_y_aq || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active && (rtb_y_ed ||
      ...
      ((FmgcComputer_P.EnumeratedConstant_Value_p == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant2_Value) || rtb_y_n2 ||
       rtb_y_bo)) || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && (std::abs(FmgcComputer_B.u_ly
      - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_omz)) || (rtb_GreaterThan3_tmp &&
      (rtb_DataTypeConversion2_bh > FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_GreaterThan3_tmp_1 &&
      (rtb_DataTypeConversion2_bh < FmgcComputer_P.CompareToConstant2_const_g)) || ((rtb_GreaterThan3_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (rtb_DataTypeConversion2_kb > rtb_y_fd) &&
      rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k) || (rtb_GreaterThan3_tmp_1 && (rtb_y_fd > rtb_y_gl +
    ...
    rtb_y_f5 = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_g((rtb_y_p3 || (rtb_DataTypeConversion1_e != 0U)),
      FmgcComputer_P.PulseNode_isRisingEdge_d, &rtb_y_f5, &FmgcComputer_DWork.sf_MATLABFunction_nd);
    rtb_y_p3 = (rtb_y_h && rtb_y_f5 && rtb_ap_fd_condition_tmp_2);
    ...
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ld,
      FmgcComputer_P.ConfirmNode_timeDelay_op, &rtb_y_am, &FmgcComputer_DWork.sf_MATLABFunction_cz);
    rtb_y_ed = ((rtb_y_ed && rtb_y_if) || (rtb_y_iz && (rtb_y_p3 || (rtb_OR_m4 && rtb_y_p && rtb_NOT_b) || (rtb_y_am &&
      rtb_NOT_b) || rtb_Compare_bj)));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fg = FmgcComputer_P.Logic_table_ny[(((rtb_OR_bg || ((rtb_y_gj ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
    ...
    rtb_GreaterThan3_tmp_1 = rtb_Compare_bj;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    rtb_y_f5 = (rtb_y_fd > rtb_y_gl);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_px, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_b, &rtb_y_aq,
      &FmgcComputer_DWork.sf_MATLABFunction_p3z);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_c, &rtb_y_gl);
    rtb_y_p = (rtb_y_gj && rtb_AND_iz);
    rtb_NOT_b = (rtb_OR_m4 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_f5 && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_p || (rtb_y_aq &&
      rtb_y_gj && (rtb_AND_iz && (std::abs(rtb_altCstrOrFcu - rtb_y_gl) <= FmgcComputer_P.CompareToConstant2_const_d)))));
    rtb_y_p3 = (rtb_y_p5 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue, &rtb_y_gl);
    rtb_y_f5 = ((FmgcComputer_U.in.fms_inputs.acceleration_alt_ft != FmgcComputer_P.CompareToConstant_const_lz) &&
    ...
    rowIdx_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_y_p3 && (!rtb_y_f5)) ||
      (rowIdx_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) || (rtb_y_fd < rtb_y_gl) || (rtb_y_gj &&
      (rtb_AND1_c0 || rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_bo)) ||
      ...
      static_cast<uint32_T>((rtb_Compare_bj && rtb_y_if) || (rtb_y_iz && (rtb_NOT_b || (rtb_y_p3 && rtb_y_f5)))) << 1)) <<
    ...
    FmgcComputer_MATLABFunction_g((rtb_y_gl > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode_isRisingEdge_bg, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_dfk);
    rtb_y_am = (rtb_y_aq || (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    rtb_TmpSignalConversionAtSFunctionInport3_idx_2 = (rtb_y_iz &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible && rtb_y_h);
    rtb_GreaterThan3_tmp_0 = !rtb_y_gj;
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 &&
      ...
      ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed && rtb_y_am) || (rtb_y_aq && (rtb_GreaterThan3_tmp_0 ||
      (rtb_y_gj && (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed) && rtb_y_ed))))));
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_y_iz && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_p || (rtb_y_ed && rtb_y_gj && (rtb_AND_iz &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he[(((rowIdx_tmp ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active || (rtb_y_fd > rtb_y_gl) || rtb_y_n2 ||
      ...
      (rtb_y_gj && rtb_AND1_c0) || rtb_OR_bg) + (static_cast<uint32_T>(rtb_Compare_bj) << 1)) << 1) +
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 &&
      (rtb_ap_fd_condition_tmp_3 && rtb_ap_fd_condition_tmp_2 &&
       (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active) && rtb_Compare_j3 && rtb_OR2_l_tmp &&
       rtb_appInop_idx_2) && rtb_appInop_idx_0 && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_f5 &&
      ...
      FmgcComputer_DWork.DelayInput1_DSTATE_n)) || (rtb_y_aq && (rtb_GreaterThan3_tmp_0 || (rtb_y_gj && rtb_y_ed &&
    ...
    rtb_y_n2 = (rowIdx_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active);
    rtb_AND1_c0 = (rtb_y_n2 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    ...
    rtb_y_am = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && rtb_y_am),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_jo, FmgcComputer_P.ConfirmNode_timeDelay_jo,
      &rtb_y_am, &FmgcComputer_DWork.sf_MATLABFunction_moh);
    rtb_y_f5 = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
                 ((FmgcComputer_P.EnumeratedConstant_Value_c == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                  ...
                  rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_bo)) || rtb_y_am);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_y_am = (rtb_y_ed || rtb_y_f5 || (rtb_y_p && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_GreaterThan3_tmp_0 && rtb_y_p3 && rtb_y_am));
    ...
    rtb_OR2_l_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ae && rtb_y_f5);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_fw, &rtb_y_f5,
    ...
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active &&
      ...
      FmgcComputer_P.ConfirmNode_isRisingEdge_fq, FmgcComputer_P.ConfirmNode_timeDelay_lp, &rtb_y_am,
      &FmgcComputer_DWork.sf_MATLABFunction_hj);
    rtb_y_f5 = (rtb_y_f5 || rtb_y_am);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_GreaterThan3_tmp_0 && (rtb_y_fd < rtb_y_gl) && rtb_y_f5));
    ...
    rtb_y_ed = rtb_y_iz;
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_b, &rtb_y_f5,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_iz && (rtb_y_f5 && rtb_y_k && rtb_ap_fd_condition_tmp_3)))
      << 1) + (rtb_y_ed || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
    ...
    rtb_y_ed = (rtb_y_iz && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_appInop_idx_1 &&
      ...
      FmgcComputer_P.CompareToConstant1_const_n2)) || (rtb_Nosewheel_c < FmgcComputer_P.CompareToConstant2_const_iq)) &&
                rtb_y_ed);
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || rtb_y_ed);
    ...
    rtb_y_k = (rtb_y_n2 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_nu = FmgcComputer_P.Logic_table_d3[(((((!rtb_y_ed) && (rtb_y_k ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_iz && rtb_NOT_b &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_as = FmgcComputer_P.Logic_table_fi[(((((!rtb_y_ed) && (rtb_y_k ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_y_ed = (rtb_y_iz && rtb_NOT1_i);
    FmgcComputer_DWork.Memory_PreviousInput_n0 = FmgcComputer_P.Logic_table_id[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_ed && FmgcComputer_U.in.discrete_inputs.tcas_ta_display))
    ...
    rtb_y_ed = ((rtb_Compare_bj && rtb_y_if) || (rtb_y_ed && rtb_NOT_b));
    ...
    low_i = static_cast<int32_T>(((((rtb_OR_bg || (rtb_y_k ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_hd, &rtb_y_el);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_ir_computation_data_flight_path_angle_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_i, &rtb_y_hnn);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pc, &rtb_y_lc);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_b, &rtb_y_fy);
    ...
    rtb_y_aq = (rtb_fmgcOppPriority_tmp || rtb_GreaterThan3_tmp);
    if (rtb_fmgcOppPriority_tmp) {
      rtb_DataTypeConversion2_bh -= rtb_y_lc;
      rtb_Nosewheel_c = 50.0;
    } else {
      rtb_DataTypeConversion2_bh = rtb_y_hnn - rtb_y_el;
      rtb_Nosewheel_c = 0.1;
    }

    rtb_Compare_bj = (rtb_Logic_a2[0] && rtb_y_aq);
    rtb_y_k = ((rtb_Compare_bj && (rtb_y_fd < rtb_y_gl + 3.0F) && (rtb_DataTypeConversion2_bh < -rtb_Nosewheel_c)) ||
               (rtb_Compare_bj && (rtb_y_fd > rtb_y_fy - 3.0F) && (rtb_DataTypeConversion2_bh > rtb_Nosewheel_c)));
    FmgcComputer_MATLABFunction_j((rtb_y_k || rtb_OR2_l_tmp || rtb_GreaterThan3_tmp_1 || rtb_AND8),
    ...
    FmgcComputer_MATLABFunction_j((rtb_GreaterThan3_tmp_1 || rtb_Compare_bj), FmgcComputer_U.in.time.dt, &rtb_y_ed,
    ...
    FmgcComputer_MATLABFunction_j((rtb_AND8 || rtb_Compare_bj), FmgcComputer_U.in.time.dt, &rtb_Compare_bj,
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_n2);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_gj);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_g(((rtb_y_n2 || rtb_y_gj || (rtb_DataTypeConversion1_e != 0U)) && (rtb_y_ed ||
    ...
    rtb_Compare_bj = (rtb_Compare_bj || rtb_y_p5 || ((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_c) &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bw = FmgcComputer_P.Logic_table_bs[((((!rtb_Compare_bj) ||
      rtb_ap_fd_condition_tmp_1 || rtb_Logic_gj_idx_0_tmp_tmp || FmgcComputer_DWork.Memory_PreviousInput_ip || rtb_NOT_b
    ...
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_if);
    rtb_y_ed = rtb_y_iz;
    ...
    rtb_y_p3 = (FmgcComputer_U.in.fms_inputs.preset_spd_mach_activate && (rtb_y_hq || (rtb_y_gl <= rtb_y_fd)));
    ...
    rtb_y_am = (rtb_y_hq && rtb_ap_fd_condition_tmp_0 && (!FmgcComputer_DWork.Memory_PreviousInput_nu) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_as) && (!FmgcComputer_DWork.Memory_PreviousInput_d));
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode7_isRisingEdge_h, &rtb_y_f5,
      &FmgcComputer_DWork.sf_MATLABFunction_itu);
    rtb_y_n2 = (rtb_Compare_bj || (rtb_y_iz && (((FmgcComputer_P.Constant_Value_k !=
      FmgcComputer_DWork.DelayInput1_DSTATE_f) && rtb_OR_m4) || ((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant_const_dy) && rtb_y_bo && rtb_y_am) || rtb_y_ed || rtb_NOT_b || rtb_y_p3 ||
      (rtb_y_p && rtb_OR_m4 && rtb_y_am) || rtb_y_f5)));
    FmgcComputer_MATLABFunction_a(rtb_y_n2, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ch,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cu = FmgcComputer_P.Logic_table_kg
      [((((FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active && (!rtb_Compare_bj)) || (rtb_y_p5 && (rtb_y_ed ||
            rtb_NOT_b))) + (static_cast<uint32_T>(rtb_y_n2) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cu];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_5,
      FmgcComputer_P.BitfromLabel_bit_kq, &rtb_DataTypeConversion1_e);
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_if);
    FmgcComputer_MATLABFunction_g(rtb_y_ft, FmgcComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_f5,
    ...
    rtb_NOT_b = ((rtb_y_f5 && rtb_y_ed) || (rtb_NOT_b && rtb_y_ed && rtb_y_ft) || rtb_y_p3);
    rtb_y_n2 = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_g(rtb_y_n2, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_f5,
      &FmgcComputer_DWork.sf_MATLABFunction_mrn);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ie, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_jp, &rtb_y_am,
    ...
    rtb_y_ed = ((rtb_y_p5 && rtb_NOT_b) || (rtb_y_f5 || rtb_y_am || rtb_y_p3));
    ...
    rtb_y_ed = (rtb_Compare_bj || (rtb_y_iz && rtb_y_ed && (rtb_NOT_b || rtb_y_p3)));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_hk = FmgcComputer_P.Logic_table_ds
      [((((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && (!rtb_Compare_bj)) || (rtb_y_p5 &&
    ...
    rtb_y_lc = std::pow((std::pow(FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach.Data *
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_3_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_j, &rtb_y_fy);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_i, &rtb_y_el);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_cz, &rtb_y_hnn);
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_i) {
      ...
      rtb_Nosewheel_c = rtb_y_el + static_cast<real_T>(absVsTarget);
      rtb_pfdTarget = rtb_y_hnn - 5.0;
      if (rtb_y_hnn - 5.0 > rtb_Nosewheel_c) {
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_hk) {
      if (FmgcComputer_DWork.Memory_PreviousInput_d || FmgcComputer_DWork.Memory_PreviousInput_l ||
        ...
        rtb_Switch_e[0] = std::fmax(std::fmax(std::fmax(static_cast<real_T>(rtb_y_gl), static_cast<real_T>(rtb_y_fd)),
          static_cast<real_T>(rtb_y_fy)), FmgcComputer_B.u_l);
      ...
      if (FmgcComputer_DWork.Delay_DSTATE_c) {
        rtb_y_fd = std::sqrt(rtb_y_lc - 1.0F) * 1479.1F;
      } else {
    ...
    rtb_y_ed = (rtb_y_aq || FmgcComputer_DWork.Memory_PreviousInput_cb || FmgcComputer_DWork.Memory_PreviousInput_ne ||
    ...
    rtb_ap_fd_condition_tmp_0 = (rtb_y_b4i || FmgcComputer_DWork.Memory_PreviousInput_el ||
      FmgcComputer_DWork.Memory_PreviousInput_cv || FmgcComputer_DWork.Memory_PreviousInput_lq ||
      rtb_ap_fd_condition_tmp_1 || rtb_Logic_gj_idx_0_tmp_tmp || FmgcComputer_DWork.Memory_PreviousInput_ip ||
      FmgcComputer_DWork.Memory_PreviousInput_d);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4, &rtb_y_n2);
    rtb_Compare_bj = ((rtb_Compare_bj || ((rtb_DataTypeConversion1_e != 0U) && rtb_y_n2)) &&
                      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged);
    rtb_y_n2 = (rtb_Logic_a2[0] && (FmgcComputer_DWork.Memory_PreviousInput_l ||
      FmgcComputer_DWork.Memory_PreviousInput_d));
    ...
    rtb_y_aq = (rtb_appInop_idx_0 && (!rtb_ap_fd_condition_tmp) && rtb_bothRaValid);
    ...
    rtb_appCapability_idx_2 = (FmgcComputer_DWork.pLand3FailOp || (rtb_appInop_idx_2 && rtb_y_n2 && rtb_Compare_bj &&
      FmgcComputer_DWork.Delay_DSTATE_k));
    rtb_y_gj = !rtb_appCapability_idx_2;
    apCondition_tmp = (FmgcComputer_DWork.pLand3FailPass || (rtb_y_aq && rtb_y_n2 && FmgcComputer_DWork.Delay_DSTATE_k &&
      rtb_y_gj));
    rtb_y_gj = (rtb_appInop_idx_0 && rtb_y_n2 && (!apCondition_tmp) && rtb_y_gj);
    rtb_appInop_idx_0 = !rtb_appInop_idx_0;
    rtb_appInop_idx_1 = !rtb_y_aq;
    rtb_appInop_idx_2 = !rtb_appInop_idx_2;
    if ((rtb_raComputationData < 100.0F) && (rtb_y_n2 || rtb_Compare_bj)) {
    ...
    if (rtb_Logic_a2[0] && FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) {
      if (FmgcComputer_U.in.discrete_inputs.is_unit_1) {
        rtb_TmpSignalConversionAtSFunctionInport3_idx_0 = rtb_y_gj;
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_ap);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_p, &rtb_y_lc);
    rtb_DataTypeConversion32 = rtb_y_lc;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_i, &rtb_y_el);
    rtb_DataTypeConversion26 = rtb_y_el;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_j, &rtb_y_fy);
    rtb_DataTypeConversion39 = rtb_y_fy;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fc, &rtb_y_hnn);
    if (rtb_Logic_ac[0]) {
      rtb_Switch1 = rtb_BusAssignment_hk_ap_fd_logic_tcas_vs_target;
    } else {
      rtb_Switch1 = rtb_y_hnn;
    }
    ...
    rtb_y_n2 = (FmgcComputer_DWork.Memory_PreviousInput_as || FmgcComputer_DWork.Memory_PreviousInput_d);
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_pfdTarget,
                    ...
                    &rtb_DataTypeConversion25, &rtb_y_ap, &rtb_DataTypeConversion23,
                    ...
                    &rtb_DataTypeConversion32, &rtb_DataTypeConversion26, &rtb_y_p5, (const_cast<real_T*>
      (&FmgcComputer_RGND)), &rtb_Gain3, &(&rtb_Logic_a2[0])[0], &rtb_active_lateral_law, &rtb_active_longitudinal_law,
                    ...
                    &(&rtb_Logic_b[0])[0], &rtb_y_n2, &rtb_Phi_loc_c, &rtb_Nosewheel_c, &rtb_Theta_c_deg, &rtb_Phi_c_deg,
                    &rtb_Beta_c_deg, &rtb_Product_p2, &rtb_Switch1_a, &rtb_Beta_c_deg_e, &rtb_Compare_bj,
    ...
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode3_isRisingEdge_l4, &rtb_y_f5,
    ...
    low_i = static_cast<int32_T>((((rtb_AND1_c0 || (rtb_y_hq && ((rtb_DataTypeConversion2_bh <
      ...
      static_cast<uint32_T>(rtb_y_f5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_j);
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_P.Logic_table_lwo[static_cast<uint32_T>(low_i) + 8U] && (rtb_y_ha != 0U)),
      FmgcComputer_P.PulseNode3_isRisingEdge_ng, &rtb_y_aq, &FmgcComputer_DWork.sf_MATLABFunction_k);
    ...
    rtb_y_ap = (rtb_y_fd >= FmgcComputer_P.CompareToConstant_const_hq);
    rtb_y_n2 = (rtb_y_fd <= FmgcComputer_P.CompareToConstant2_const_di);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o2, &rtb_y_fd);
    rtb_y_aq = (rtb_y_fd >= FmgcComputer_P.CompareToConstant1_const_h4);
    rtb_Compare_j3 = (rtb_y_fd <= FmgcComputer_P.CompareToConstant3_const_d);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_f5);
    ...
    rtb_pfdTarget = rtb_Product_p2;
    rtb_y_aq = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_ap &&
      rtb_y_n2 && rtb_y_aq && rtb_Compare_j3) || ((!rtb_y_f5) && (!rtb_y_p3) && rtb_BusAssignment_h_logic_one_engine_out
    ...
    rtb_y_ap = (rtb_y_fd < FmgcComputer_P.CompareToConstant8_const);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_fk, &rtb_y_fd);
    rtb_Compare_j3 = (rtb_y_aq && ((rtb_Switch1_a < FmgcComputer_P.CompareToConstant10_const) || (rtb_y_fd <
      FmgcComputer_P.CompareToConstant11_const) || (rtb_BusAssignment_h_logic_one_engine_out && (rtb_y_ap || (rtb_y_fd <
    ...
    rtb_y_ap = !FmgcComputer_DWork.Memory_PreviousInput_hu;
    rtb_y_f5 = (((rtb_y_ha != 0U) && rtb_y_if) || (rtb_y_iz && rtb_y_hq && rtb_y_ap));
    FmgcComputer_MATLABFunction_a(rtb_y_f5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_b,
      FmgcComputer_P.ConfirmNode_timeDelay_gu, &rtb_y_hq, &FmgcComputer_DWork.sf_MATLABFunction_ay);
    rtb_y_n2 = (FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active ||
                FmgcComputer_DWork.Delay1_DSTATE.retard_mode_active);
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_g || ((rtb_y_n2 ||
      FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_hq))) + (static_cast<uint32_T>(rtb_y_f5) << 1))
    ...
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_if) || (rtb_y_iz && rtb_y_hq && rtb_y_ap));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_g || ((rtb_y_n2 ||
    ...
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_if) || (rtb_y_iz && FmgcComputer_DWork.Memory_PreviousInput_d &&
      rtb_Logic_a2[0] && (rtb_raComputationData <= FmgcComputer_P.CompareToConstant_const_e3) && rtb_y_ap));
    ...
    rtb_y_iz = (FmgcComputer_DWork.Memory_PreviousInput_b3 || FmgcComputer_DWork.Memory_PreviousInput_ev ||
                rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active);
    rtb_OR_m4 = (rtb_y_iz || rtb_Logic_b[0]);
    FmgcComputer_DWork.Memory_PreviousInput_kr = FmgcComputer_P.Logic_table_b3[(((static_cast<uint32_T>
      ...
      || rtb_y_p5 || ((FmgcComputer_P.EnumeratedConstant_Value_by == FmgcComputer_U.in.fms_inputs.fms_flight_phase) &&
                      (rtb_adrComputationBus_altitude_corrected_ft_Data <
    ...
    FmgcComputer_DWork.Memory_PreviousInput_km = FmgcComputer_P.Logic_table_mj[(((static_cast<uint32_T>
      ...
      || rtb_y_p5 || ((FmgcComputer_P.EnumeratedConstant1_Value_e == FmgcComputer_U.in.fms_inputs.fms_flight_phase) &&
                      (rtb_adrComputationBus_altitude_corrected_ft_Data <
                       FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft)))) << 1) +
    ...
    rtb_y_ap = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_ap);
    if (rtb_y_ap && ((FmgcComputer_DWork.Memory_PreviousInput_kr && ((rtb_DataTypeConversion2_bh > rtb_y_fd +
    ...
    } else if (rtb_y_ap && FmgcComputer_DWork.Memory_PreviousInput_km &&
    ...
    } else if (rtb_y_ap && rtb_OR_bg && (((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 24.0F) &&
                 (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 26.0F) &&
                 ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 26.0F))) ||
                ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 24.0F) &&
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_ap);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_n2);
    rtb_OR_bg = (rtb_y_ap || rtb_y_n2);
    rtb_y_j = athr_fma_mode::NONE;
    rtb_y_ap = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_p);
    if (rtb_y_ap && (rtb_Max_a > 44.0F)) {
      rtb_y_j = athr_fma_mode::MAN_TOGA;
    } else {
      rtb_y_n2 = (rtb_y_ap && (rtb_Max_a > 34.0F) && (rtb_Max_a < 36.0F));
      if (rtb_y_n2 && rtb_OR_bg) {
        rtb_y_j = athr_fma_mode::MAN_FLEX;
      } else if (rtb_y_n2 && (!rtb_OR_bg)) {
        rtb_y_j = athr_fma_mode::MAN_MCT;
      } else if (rtb_y_ap && (rtb_Max_a > 24.0F)) {
        rtb_y_j = athr_fma_mode::MAN_THR;
      } else {
        rtb_y_ap = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_aq);
        rtb_y_n2 = (rtb_y_ap && FmgcComputer_DWork.Memory_PreviousInput_cm);
        if (rtb_y_n2 && (!FmgcComputer_DWork.Delay_DSTATE_c)) {
          rtb_y_j = athr_fma_mode::SPEED;
        } else if (rtb_y_n2 && FmgcComputer_DWork.Delay_DSTATE_c) {
          rtb_y_j = athr_fma_mode::MACH;
        } else {
          rtb_y_n2 = (rtb_y_ap && FmgcComputer_DWork.Memory_PreviousInput_bh);
          rtb_OR_bg = !rtb_OR_m4;
          if (rtb_y_n2 && (rtb_Max_a > 34.0F) && rtb_OR_bg) {
            rtb_y_j = athr_fma_mode::THR_MCT;
          } else if (rtb_y_n2 && (rtb_Max_a > 24.0F) && rtb_OR_bg) {
            rtb_y_j = athr_fma_mode::THR_CLB;
          } else if (rtb_y_n2 && (rtb_Max_a < 25.0F) && rtb_OR_bg) {
            rtb_y_j = athr_fma_mode::THR_LVR;
          } else if (rtb_y_ap && ((FmgcComputer_DWork.Memory_PreviousInput_bh && rtb_OR_m4) ||
                                  FmgcComputer_DWork.Memory_PreviousInput_o)) {
            rtb_y_j = athr_fma_mode::THR_IDLE;
          } else {
            rtb_y_ap = (rtb_y_ap && FmgcComputer_DWork.Memory_PreviousInput_hu);
            if (rtb_y_ap && (rtb_y_ha != 0U)) {
              rtb_y_j = athr_fma_mode::A_FLOOR;
            } else if (rtb_y_ap && (rtb_y_ha == 0U)) {
              rtb_y_j = athr_fma_mode::TOGA_LK;
            }
          }
        }
      }
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_km, &rtb_y_el);
    ...
    rtb_DataTypeConversion2_bh = v[absVsTarget] - rtb_y_el;
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_g || rtb_y_p || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    rtb_VectorConcatenate[5] = rtb_y_gj;
    ...
    rtb_VectorConcatenate[3] = rtb_y_aq;
    ...
    rtb_VectorConcatenate[14] = rtb_Compare_j3;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_el);
    rtb_VectorConcatenate_bw[0] = (rtb_y_j == athr_fma_mode::MAN_TOGA);
    rtb_VectorConcatenate_bw[1] = ((rtb_y_j == athr_fma_mode::MAN_MCT) || (rtb_y_j == athr_fma_mode::THR_MCT));
    rtb_VectorConcatenate_bw[2] = (rtb_y_j == athr_fma_mode::MAN_FLEX);
    rtb_VectorConcatenate_bw[3] = (rtb_y_j == athr_fma_mode::THR_CLB);
    rtb_VectorConcatenate_bw[4] = ((rtb_y_j == athr_fma_mode::MAN_THR) || (rtb_y_j == athr_fma_mode::THR_LVR));
    rtb_VectorConcatenate_bw[5] = (rtb_y_j == athr_fma_mode::THR_IDLE);
    rtb_VectorConcatenate_bw[6] = (rtb_y_j == athr_fma_mode::A_FLOOR);
    rtb_VectorConcatenate_bw[7] = (rtb_y_j == athr_fma_mode::TOGA_LK);
    rtb_VectorConcatenate_bw[8] = (rtb_y_j == athr_fma_mode::SPEED);
    rtb_VectorConcatenate_bw[9] = (rtb_y_j == athr_fma_mode::MACH);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_bw, &rtb_y_lc);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_fma_discrete_word.Data = rtb_y_lc;
    ...
    rtb_VectorConcatenate_f[0] = (FmgcComputer_DWork.Memory_PreviousInput_ec ||
      FmgcComputer_DWork.Memory_PreviousInput_ae ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_VectorConcatenate_f[1] = rtb_y_iz;
    ...
    rtb_VectorConcatenate_f[0] = rtb_y_b4i;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_f, &rtb_y_fy);
    ...
    FmgcComputer_Y.out.logic.on_ground = rtb_y_p5;
    FmgcComputer_Y.out.logic.gnd_eng_stop_flt_5s = rtb_y_h;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.rwy_active = rtb_y_b4i;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_mode_reversion_vs = rtb_GreaterThan3_tmp_1;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_2_capability = rtb_y_gj;
    ...
    FmgcComputer_Y.out.athr.athr_active = rtb_y_aq;
    FmgcComputer_Y.out.athr.athr_limited = rtb_Compare_j3;
    ...
    FmgcComputer_Y.out.athr.fma_mode = rtb_y_j;
    ...
    rtb_y_ap = !FmgcComputer_DWork.Memory_PreviousInput_m;
    if (rtb_ap_fd_condition_tmp_0 && (!FmgcComputer_DWork.Memory_PreviousInput_c) && rtb_y_ap) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.Data = rtb_y_el;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.Data = rtb_y_lc;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.Data = rtb_y_fy;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.Data = rtb_y_el;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.Data = rtb_y_lc;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.Data = rtb_y_fy;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active = rtb_y_b4i;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_mode_reversion_vs = rtb_GreaterThan3_tmp_1;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_2_capability = rtb_y_gj;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.athr_active = rtb_y_aq;
    FmgcComputer_DWork.Delay1_DSTATE.athr_limited = rtb_Compare_j3;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.fma_mode = rtb_y_j;
