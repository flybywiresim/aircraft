...
void FmgcComputer::step()
{
  ...
  boolean_T altCstrApplicable_tmp;
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    ...
    rtb_Compare_d0 = (rtb_AND_bi && rtb_OR4_e);
    if (rtb_Compare_d0) {
    ...
    rtb_irOwnInvalid = (rtb_ir3Invalid || (rtb_y_ha != 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_own_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit, &rtb_y_ha);
    rtb_y_jw = (rtb_y_ha != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel3_bit, &rtb_y_ha);
    rtb_irOwnInvalid = ((!rtb_irOwnInvalid) || ((!rtb_y_jw) && (rtb_y_ha == 0U)) || (!FmgcComputer_P.Constant_Value_a) ||
    ...
    rtb_ir3Invalid = (FmgcComputer_U.in.discrete_inputs.fac_opp_healthy &&
                      FmgcComputer_U.in.discrete_inputs.fac_own_healthy && rtb_ir3Invalid && (rtb_y_m || (rtb_y_ha != 0U)));
    ...
    rtb_NOR1_a = (rtb_NOR1 && rtb_y_m && rtb_y_jw && rtb_y_dh);
    rtb_y_a = ((!rtb_y_dh) || (!rtb_y_jw));
    ...
    if (rtb_Compare_d0) {
      rtb_y_kz = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else if (raOwnInvalid && rtb_OR4_e) {
      rtb_y_kz = FmgcComputer_U.in.bus_inputs.ra_opp_bus.radio_height_ft.Data;
    } else if (rtb_AND_bi && raOppInvalid) {
      rtb_y_kz = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else {
      rtb_y_kz = 250.0F;
    ...
    raOwnInvalid = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_y_a) || rtb_AND_cf) &&
                    (FmgcComputer_U.in.fms_inputs.fm_valid || rtb_AND_cf ||
                     (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active && (rtb_y_kz < 700.0F))));
    ...
    FmgcComputer_MATLABFunction_j((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rollout_submode_active && (std::abs
      (FmgcComputer_B.u_ly - rtb_y_p) > FmgcComputer_P.CompareToConstant_const_h)), FmgcComputer_U.in.time.dt, &rtb_y_js,
      FmgcComputer_P.MTrigNode_isRisingEdge, FmgcComputer_P.MTrigNode_retriggerable,
    ...
    FmgcComputer_Y.out.logic.ils_failure = rtb_y_jw;
    ...
    FmgcComputer_MATLABFunction_k(rtb_BusAssignment_h_logic_engine_running, FmgcComputer_P.PulseNode3_isRisingEdge,
      &rtb_y_js, &FmgcComputer_DWork.sf_MATLABFunction_jp);
    ...
    FmgcComputer_MATLABFunction_k(rtb_OR2_l, FmgcComputer_P.PulseNode1_isRisingEdge, &rtb_y_ow,
    ...
    rtb_NOR1 = (rtb_y_p >= FmgcComputer_P.CompareToConstant3_const);
    ...
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((fdOppOff || (rtb_Compare_pf &&
      ...
      rtb_OR2_l) || (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged && rtb_y_ow && rtb_fmgcOppPriority)) ||
      (rtb_NOR1_a && (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_NOR1 || (rtb_y_p >=
      FmgcComputer_P.CompareToConstant5_const))) || (rtb_y_js && rtb_NOR1_a)) + (static_cast<uint32_T>(rtb_Compare_pf &&
    ...
    low_i = static_cast<int32_T>((((static_cast<uint32_T>(rtb_Compare_pf && FmgcComputer_DWork.Memory_PreviousInput) <<
      1) + ((!rtb_y_js) || FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc)) << 1) +
    ...
    FmgcComputer_MATLABFunction_k((rtb_y_ha != 0U), FmgcComputer_P.PulseNode3_isRisingEdge_a, &rtb_y_ow,
    ...
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(raOwnInvalid &&
      ...
      || rtb_y_ow)) << 1) + (rtb_ap_fd_condition_tmp || rtb_y_dh || (FmgcComputer_DWork.Delay_DSTATE_k && rtb_OR4_e && (
    ...
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_NOR1_h) && (rtb_y_js || rtb_ap_fd_condition_tmp_2) &&
      rtb_OR2_l)) && (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_js || rtb_NOR1_h) && (rtb_OR2_l ||
      rtb_ap_fd_condition_tmp_2) && (rtb_Logic_a2[0] || fdOwnOff || FmgcComputer_DWork.Delay_DSTATE_k ||
      (!FmgcComputer_U.in.discrete_inputs.fmgc_opp_healthy)))));
    rtb_y_dh = !FmgcComputer_U.in.discrete_inputs.ap_opp_engaged;
    rtb_NOR1_h = (rtb_fmgcOppPriority && (rtb_fmgcOppPriority_tmp || rtb_y_dh));
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_m, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_m_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_c, &rtb_y_p);
    if (rtb_y_kz > rtb_y_p) {
      rtb_OR4_e = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft < rtb_y_kz) &&
                   (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft + 250.0 > rtb_y_p));
    } else {
      rtb_OR4_e = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft > rtb_y_kz) &&
                   (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft - 250.0 < rtb_y_p));
    }

    altCstrApplicable_tmp = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active ||
    ...
    rtb_OR2_l = ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed ||
                  ...
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active || (altCstrApplicable_tmp &&
      FmgcComputer_DWork.Delay_DSTATE.alt_cstr_applicable)) && rtb_appInop_idx_0 &&
                 FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_OR4_e);
    if (rtb_OR2_l) {
      rtb_altCstrOrFcu = FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft;
    } else {
      rtb_altCstrOrFcu = rtb_y_kz;
    }
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_l2, &rtb_y_p);
    rtb_y_ow = (rtb_y_p < FmgcComputer_P.CompareToConstant3_const_n);
    rtb_NOT3 = !rtb_y_ow;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_Compare_pf);
    rtb_AND_bi = (rtb_y_ow && (rtb_y_p > FmgcComputer_P.CompareToConstant4_const) && rtb_Compare_pf);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b, &rtb_y_p);
    rtb_y_ow = (rtb_y_p < FmgcComputer_P.CompareToConstant5_const_a);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_c);
    FmgcComputer_MATLABFunction_k((rtb_NOT3 || rtb_AND_bi || (!rtb_y_ow) || (rtb_y_ow && (rtb_y_p >
    ...
    rtb_Compare_kg = (rtb_AND_bi && rtb_appInop_idx_2 && rtb_OR2_l_tmp);
    rtb_NOT3 = (((FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant1_const_k) &&
                 (rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_Compare_kg && rtb_Memory &&
    ...
    rtb_Compare_d0 = (rtb_Memory_n || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
                      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
    ...
    rtb_Logic_gj_idx_0_tmp = (rtb_Compare_d0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active
      || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active);
    FmgcComputer_DWork.Memory_PreviousInput_k = FmgcComputer_P.Logic_table_b[(((rtb_y_e || ((rtb_Logic_gj_idx_0_tmp ||
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_f4_logic_ils_computation_data_runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_m, &rtb_y_kz);
    ...
    rtb_DataTypeConversion2_l = std::abs(rtb_y_kz - rtb_y_p);
    ...
    rtb_NOT3 = ((rtb_y_ow && (rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi &&
      ...
      && FmgcComputer_P.Constant_Value_j && rtb_NOT3 && rtb_Memory)));
    ...
    rtb_NOR1 = ((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ek, &rtb_y_dm);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_c, &rtb_y_kz);
    ...
    rtb_y_j_tmp_0 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active;
    rtb_TmpSignalConversionAtSFunctionInport3_idx_1 =
      !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active;
    rtb_y_ow = (rtb_ap_fd_condition_tmp_1 && (rtb_NOR1 || (rtb_AND_bi && (FmgcComputer_P.Constant_Value_l && rtb_y_j_tmp
      && (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_g) && rtb_ap_fd_condition_tmp_0 && rtb_OR4_e &&
      (!rtb_Compare_pf) && (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 &&
      (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed))) && rtb_appInop_idx_2 && rtb_OR2_l_tmp &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active) && rtb_y_j_tmp_0 && rtb_Memory && rtb_Memory &&
      ((rtb_y_dm == rtb_DataTypeConversion2_l) && (rtb_y_kz == rtb_y_p)))));
    rtb_y_jw = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    rtb_y_oz = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    ...
    rtb_y_c = (rtb_y_oz && rtb_Compare_pf);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_AND_cf || ((!rtb_y_jw) && (!rtb_y_oz)
      && FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed) || ((rtb_y_jw && rtb_Memory) || rtb_y_c) || (rtb_OR4_e &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed) || rtb_Compare_pf || rtb_y_e) + (static_cast<uint32_T>
      (rtb_y_ow) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_l];
    ...
    rtb_y_jw = (rtb_y_c || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    rtb_y_m = (rtb_y_jw || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
               FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_Logic_gj_idx_0_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active || (rtb_y_m ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active)) && rtb_OR4_e) ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || (rtb_fmgcOppPriority_tmp && rtb_y_dh &&
      rtb_Compare_pf && rtb_Memory) || rtb_y_e) + (static_cast<uint32_T>(rtb_AND_cf) << 1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_d];
    rtb_NOR1 = (FmgcComputer_U.in.discrete_inputs.bscu_opp_valid || FmgcComputer_U.in.discrete_inputs.bscu_own_valid);
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      ...
      FmgcComputer_U.in.discrete_inputs.right_wheel_spd_abv_70_kts) && rtb_NOR1) || ((!rtb_NOR1) && rtb_NOR1_a))),
    ...
    rtb_y_ow = ((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h);
    rtb_Memory = ((!rtb_BusAssignment_h_logic_engine_running) || (rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_lj) || rtb_dualRaFailure);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c[(((static_cast<uint32_T>
      (rtb_ap_fd_condition_tmp_1 && rtb_y_ow) << 1) + false) << 1) + FmgcComputer_DWork.Memory_PreviousInput_dv];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_NOR1 = (rtb_handleIndex >= FmgcComputer_P.CompareToConstant_const_j);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_p, &rtb_y_p);
    rtb_Compare_j5 = (rtb_y_p >= FmgcComputer_P.CompareToConstant3_const_i);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d, &rtb_y_p);
    FmgcComputer_MATLABFunction_k((rtb_Compare_j5 || (rtb_y_p >= FmgcComputer_P.CompareToConstant5_const_k)),
      FmgcComputer_P.PulseNode_isRisingEdge_c, &rtb_Compare_pf, &FmgcComputer_DWork.sf_MATLABFunction_fn);
    rtb_Memory = (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_Compare_kg && (!rtb_Memory) && rtb_NOR1 &&
      rtb_Compare_pf));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i = FmgcComputer_P.Logic_table_o[(((rtb_y_e || ((rtb_Compare_d0 ||
    ...
    rtb_Memory = (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi && (rtb_y_j_tmp_0 && rtb_Compare_pf)));
    ...
    rtb_y_ow = (rtb_y_jw || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel4_bit_k, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_NOR1,
    ...
    rtb_y_jw = (rtb_y_oz && rtb_Compare_pf && (!rtb_y_ow) && (!rtb_NOR1));
    ...
    rtb_Compare_kg = !FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid;
    rtb_Memory = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_Compare_kg &&
                   rtb_TmpSignalConversionAtSFunctionInport3_idx_1) || rtb_OR4_e || rtb_y_jw || (rtb_y_oz && rtb_OR_fz &&
      rtb_Compare_pf));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    rtb_OR_fz = ((rtb_OR4_e && rtb_NOR1_h) || (rtb_AND_bi && ((rtb_NOR1_d && rtb_Compare_pf && rtb_ap_fd_condition_tmp_1
      && (rtb_y_j_tmp_0 || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_a))) || rtb_Memory)));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_f2 = FmgcComputer_P.Logic_table_i[(((((!rtb_Compare_pf) && rtb_y_ow) ||
    ...
    rtb_Compare_d0 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active;
    rtb_y_ow = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active;
    rtb_y_jw = (rtb_Compare_d0 && rtb_y_ow && rtb_ap_fd_condition_tmp_1 && rtb_Compare_pf);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_dh);
    ...
    rtb_y_j_tmp_0 = ((!rtP_fmgc_ap_fd_logic_output_MATLABStruct.any_lateral_mode_engaged) ||
                     FmgcComputer_DWork.Memory_PreviousInput_c);
    rtb_NOR1 = rtb_y_j_tmp_0;
    rtb_Memory = ((rtb_Memory && rtb_NOR1_h) || (rtb_AND_bi && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid &&
      (rtb_y_jw || (rtb_NOR1_a && (((!rtb_y_dh) && (!rtb_OR4_e)) || rtb_Compare_pf) && rtb_y_j_tmp_0))));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_dh);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_OR4_e);
    FmgcComputer_MATLABFunction_k((rtb_y_dh || rtb_OR4_e), FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_Compare_pf,
      &FmgcComputer_DWork.sf_MATLABFunction_h0);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_p, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_k, &rtb_NOR1,
      &FmgcComputer_DWork.sf_MATLABFunction_jle);
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_Compare_pf || rtb_NOR1 || (rtb_y_oz
      || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) || rtb_Compare_kg ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((rtb_Compare_kg || rtb_y_e || ((rtb_y_m ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_Compare_pf))) + (static_cast<uint32_T>
    ...
    rtb_y_dh = (rtb_Compare_pf && rtb_y_j_tmp && (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_m) &&
    ...
    FmgcComputer_MATLABFunction_kh(rtb_y_dh, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_n,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_OR4_e) && rtb_Compare_pf) ||
      ...
      rtb_NOR1_h) || (rtb_AND_bi && (rtb_NOR1 || rtb_y_dh))) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_a];
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_k_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o, &rtb_y_kz);
    rtb_y_p = (rtb_y_p - static_cast<real32_T>(FmgcComputer_B.u_ly + 360.0)) + 360.0F;
    if (rtb_y_p == 0.0F) {
      dPsi_1 = 0.0F;
    } else {
    ...
    if (low_i == high_i) {
      ...
      if (rtb_DataTypeConversion1 > 5.0) {
        if (std::abs(rtb_y_kz) <= 5.0F) {
          rtb_Compare_pf = true;
        } else {
          if (rtb_y_kz < 0.0F) {
            low_ip1 = -1;
          } else {
            low_ip1 = (rtb_y_kz > 0.0F);
          }
      ...
      if (guard1) {
        ...
        rtb_Compare_pf = ((rtb_DataTypeConversion1 >= std::abs(rtb_y_kz)) && (high_i == low_ip1));
      }
    } else {
      rtb_Compare_pf = false;
    }

    rtb_y_kz = std::abs(rtb_y_p);
    if (rtb_y_kz < 115.0F) {
      ...
      if (((rtb_y_kz > 25.0F) && ((dPsi_1 < 10.0F) && ((low_i != high_i) && rtb_Compare_pf))) || (dPsi_1 < 1.92)) {
        rtb_Compare_pf = (rtb_Compare_pf || ((rtb_y_kz < 15.0F) && (dPsi_1 < 1.1)));
      } else {
        rtb_Compare_pf = false;
      }
    } else {
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pm, &rtb_y_dm);
    dPsi_1 = rtb_y_p - rtb_y_dm;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jm, &rtb_y_kz);
    if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) {
      rtb_y_kz = rtb_DataTypeConversion2_l;
    ...
    rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s.Data =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_Data;
    if (dPsi_1 < 0.0F) {
      rtb_OR4_e = (rtb_y_kz <= 0.0F);
    } else {
      rtb_OR4_e = ((dPsi_1 > 0.0F) && (rtb_y_kz >= 0.0F));
    }

    rtb_y_dh = (rtb_OR2_l_tmp && rtb_appInop_idx_2);
    rtb_Logic_gj_idx_0_tmp = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active;
    rtb_BusAssignment_gt_ap_fd_logic_armed_modes_alt_acq_armed_tmp =
      !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active;
    rtb_y_c = (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi && rtb_Logic_gj_idx_0_tmp &&
                rtb_BusAssignment_gt_ap_fd_logic_armed_modes_alt_acq_armed_tmp && rtb_Logic_oq_idx_0 && rtb_OR_ko &&
                rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && rtb_ap_fd_condition_tmp_1 && ((!rtb_OR4_e) ||
      ((!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) &&
       (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active))) && (rtb_y_dh || (dPsi_1 <=
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_h, &rtb_y_kz);
    rtb_y_p = std::abs(rtb_y_kz);
    high_i = 7;
    low_i = 0;
    low_ip1 = 2;
    ...
    rtb_DataTypeConversion2_l = rtb_y_p - static_cast<real32_T>(b[low_i]);
    dPsi_1 = rtb_y_kz * 0.00508F;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_d, &rtb_y_p);
    rtb_Phi_c_deg = rtb_altCstrOrFcu - rtb_y_p;
    ...
    if (rtb_y_kz < 0.0F) {
      ...
      high_i = (rtb_y_kz > 0.0F);
    }

    rtb_Memory = ((rtb_Memory && rtb_NOR1_h) || (rtb_AND_bi && FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed
      && (!rtb_Compare_pf) && ((std::fmin(3000.0F, std::fmax(80.0F, dPsi_1 * dPsi_1 / ((((rtb_DataTypeConversion2_l *
      static_cast<real32_T>(c[low_i]) + static_cast<real32_T>(c[low_i + 6])) * rtb_DataTypeConversion2_l +
      static_cast<real32_T>(c[low_i + 12])) * rtb_DataTypeConversion2_l + static_cast<real32_T>(c[low_i + 18])) * 9.81F)
      * 3.28084F)) > rtb_Nosewheel_c) && (static_cast<int32_T>(rtb_Phi_c_deg) == high_i)) && ((rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_l5) || rtb_y_dh)));
    ...
    rtb_Logic_hy_idx_0_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active);
    ...
    FmgcComputer_MATLABFunction_kh((std::abs(rtb_altCstrOrFcu - rtb_y_p) < FmgcComputer_P.CompareToConstant_const_f),
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cb = FmgcComputer_P.Logic_table_ob[(((rtb_y_e || ((rtb_Memory_n ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
    ...
    rtb_Memory_n = (FmgcComputer_DWork.Memory_PreviousInput_cb && (std::abs(FmgcComputer_U.in.fms_inputs.cruise_alt_ft -
      rtb_y_p) < FmgcComputer_P.CompareToConstant1_const_a));
    ...
    if (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) {
      FmgcComputer_B.u_l = rtb_altCstrOrFcu;
    }

    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mr, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oi, &rtb_y_p);
    rtb_DataTypeConversion2_l = rtb_y_kz - rtb_y_p;
    rtb_y_dh = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    rtb_NOR1 = (rtb_y_dh && (rtb_DataTypeConversion2_l < FmgcComputer_P.CompareToConstant2_const_g));
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_o3_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue, &rtb_y_p);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_o3_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue, &rtb_y_kz);
    rtb_y_j_tmp = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_y_m = ((rtb_y_j_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (rtb_y_p +
                FmgcComputer_P.Bias_Bias_e > rtb_y_kz) && rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_o3_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue, &rtb_y_p);
    rtb_Compare_kg = !FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid;
    rtb_Memory_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && rtb_Compare_d0 && rtb_y_ow);
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active) && rtb_Compare_pf) ||
                  (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active &&
                   ((FmgcComputer_P.EnumeratedConstant_Value_p == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                    ...
                    rtb_Memory_tmp || rtb_Compare_kg)) ||
                  (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && (std::abs(FmgcComputer_B.u_l -
      rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_om)) || (rtb_y_j_tmp && (rtb_DataTypeConversion2_l >
      FmgcComputer_P.CompareToConstant1_const_o)) || rtb_NOR1 || rtb_y_m || (rtb_y_dh && (rtb_y_kz > rtb_y_p +
    ...
    rtb_y_jw = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_k((rtb_y_jw || (rtb_DataTypeConversion1_e != 0U)),
      FmgcComputer_P.PulseNode_isRisingEdge_d, &rtb_y_ow, &FmgcComputer_DWork.sf_MATLABFunction_nd);
    rtb_y_jw = (rtb_NOR1_d && rtb_y_ow && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_AND_bi && (rtb_y_jw || rtb_Memory)));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fg = FmgcComputer_P.Logic_table_ny[(((rtb_y_e || ((altCstrApplicable_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_jw))) + (static_cast<uint32_T>
    ...
    rtb_y_j_tmp = rtb_Memory;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_jh, &rtb_DataTypeConversion1_e);
    rtb_Compare_pf = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_et, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_Compare_d0 = (altCstrApplicable_tmp && rtb_OR2_l);
    rtb_OR4_e = (rtb_OR_pj && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 (rtb_y_kz > rtb_y_p) && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_Compare_d0);
    rtb_y_jw = (rtb_NOR1_a || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
    ...
    rtb_y_ow = ((FmgcComputer_U.in.fms_inputs.acceleration_alt_ft != FmgcComputer_P.CompareToConstant_const_lz) &&
                (FmgcComputer_U.in.fms_inputs.acceleration_alt_ft < rtb_y_p) &&
                ...
                rtb_Memory && rtb_y_j_tmp_0);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jt, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_os, &rtb_y_p);
    rtb_Logic_n3_idx_0_tmp = !rtb_OR2_l;
    rtb_Logic_n3_idx_0_tmp_0 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_y_jw && (!rtb_y_ow)) ||
      (rtb_Logic_n3_idx_0_tmp_0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) || (rtb_y_kz < rtb_y_p) || (altCstrApplicable_tmp
      && (rtb_Logic_n3_idx_0_tmp || rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_Compare_kg)) ||
      ...
      static_cast<uint32_T>((rtb_Compare_pf && rtb_NOR1_h) || (rtb_AND_bi && (rtb_OR4_e || (rtb_y_jw && rtb_y_ow)))) <<
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_h, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_n, &rtb_y_p);
    rtb_y_jw = (rtb_y_kz > rtb_y_p);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_j4, &rtb_y_p);
    FmgcComputer_MATLABFunction_k((rtb_y_p > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_j, &rtb_y_m,
      &FmgcComputer_DWork.sf_MATLABFunction_dd);
    rtb_NOR1 = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed;
    ...
    rtb_y_ow = (rtb_Logic_gj_idx_0_tmp && rtb_BusAssignment_gt_ap_fd_logic_armed_modes_alt_acq_armed_tmp);
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_OR4_e &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_jw &&
      ...
      (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE))) || (rtb_y_m && rtb_y_ow))));
    ...
    rtb_Memory = (rtb_Logic_hy_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    rtb_y_j_tmp_0 = (rtb_Memory || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_ec = FmgcComputer_P.Logic_table_kw[(((rtb_y_e || ((rtb_y_j_tmp_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_Compare_pf = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_nh, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_mc, &rtb_y_p);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_nq, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_f, &rtb_NOR1,
    ...
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_AND_bi && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_pi) && (rtb_y_kz < rtb_y_p) && rtb_appInop_idx_0 &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_Compare_d0)));
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_cj, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_b, &rtb_y_p);
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he[(((rtb_Logic_n3_idx_0_tmp_0 ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active || (rtb_y_kz > rtb_y_p) || rtb_Memory_tmp ||
      ((FmgcComputer_P.EnumeratedConstant_Value_b == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant6_Value)) || rtb_Compare_kg ||
      (altCstrApplicable_tmp && rtb_Logic_n3_idx_0_tmp) || rtb_y_e) + (static_cast<uint32_T>(rtb_Compare_pf) << 1)) << 1)
    ...
    rtb_OR4_e = (rtb_OR_ko && rtb_ap_fd_condition_tmp_1 &&
                 (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active) &&
                 rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && rtb_OR2_l_tmp && rtb_appInop_idx_2);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mo, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_OR4_e &&
      rtb_appInop_idx_0 && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_kz < rtb_y_p) &&
      ...
      FmgcComputer_DWork.DelayInput1_DSTATE_n)) || (rtb_y_jw && rtb_y_ow))));
    ...
    altCstrApplicable_tmp = (rtb_Memory || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active);
    rtb_appInop_idx_0 = (altCstrApplicable_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                         FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
                         FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    FmgcComputer_DWork.Memory_PreviousInput_b3 = FmgcComputer_P.Logic_table_cv[(((rtb_y_e || ((rtb_appInop_idx_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ht, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_NOR1 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && rtb_NOR1),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_jo, FmgcComputer_P.ConfirmNode_timeDelay_jo,
      &rtb_NOR1, &FmgcComputer_DWork.sf_MATLABFunction_moh);
    rtb_y_ow = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
                 ((FmgcComputer_P.EnumeratedConstant_Value_c == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                  ...
                  rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_Compare_kg)) || rtb_NOR1);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_e, &rtb_y_p);
    FmgcComputer_MATLABFunction_k((rtb_y_p > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode1_isRisingEdge_g, &rtb_Memory, &FmgcComputer_DWork.sf_MATLABFunction_lva);
    rtb_NOR1 = (rtb_y_m || rtb_y_ow || (rtb_Memory && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_Compare_kg)));
    rtb_Compare_d0 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_Compare_d0 && rtb_y_jw && rtb_NOR1));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ae = FmgcComputer_P.Logic_table_jq[(((rtb_y_e || ((rtb_y_j_tmp_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_OR2_l_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ae && rtb_y_ow);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_OR4_e = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_i, &rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_dp, &rtb_y_p);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel4_bit_i, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_fw, &rtb_y_ow,
    ...
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active &&
      ...
      FmgcComputer_P.ConfirmNode_isRisingEdge_fq, FmgcComputer_P.ConfirmNode_timeDelay_lp, &rtb_NOR1,
      &FmgcComputer_DWork.sf_MATLABFunction_hj);
    rtb_y_ow = (rtb_y_ow || rtb_NOR1);
    rtb_Compare_pf = ((rtb_Compare_pf && rtb_NOR1_h) || (rtb_Compare_d0 && (rtb_y_kz < rtb_y_p) && rtb_y_ow));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ev = FmgcComputer_P.Logic_table_l[(((rtb_y_e || ((rtb_appInop_idx_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
    ...
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_b, &rtb_y_ow,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h) || (rtb_AND_bi && (rtb_y_ow && rtb_Logic_oq_idx_0 && rtb_OR_ko)))
    ...
    rtb_y_jw = (((dPsi_1 < FmgcComputer_DWork.DelayInput1_DSTATE_b) && (rtb_Nosewheel_c <
    ...
    rtb_Memory = (rtb_AND_bi && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_y_oz && rtb_y_jw &&
                  rtb_Memory);
    ...
    rtb_Logic_oq_idx_0 = (altCstrApplicable_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_hd, &rtb_y_o);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_ir_computation_data_flight_path_angle_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_i, &rtb_y_dm);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_g, &rtb_y_le);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_d, &rtb_y_p);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_b, &rtb_DataTypeConversion2_l);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_f, &rtb_y_kz);
    rtb_appInop_idx_0 = (rtb_fmgcOppPriority_tmp || rtb_y_dh);
    if (rtb_fmgcOppPriority_tmp) {
      rtb_y_dm = rtb_y_le - rtb_DataTypeConversion7_d;
    ...
    rtb_Compare_pf = (rtb_Logic_a2[0] && rtb_appInop_idx_0);
    rtb_OR_ko = ((rtb_Compare_pf && (rtb_y_kz < rtb_y_p + 3.0F) && (rtb_y_dm < -rtb_Nosewheel_c)) || (rtb_Compare_pf &&
      (rtb_y_kz > rtb_DataTypeConversion2_l - 3.0F) && (rtb_y_dm > rtb_Nosewheel_c)));
    ...
    FmgcComputer_MATLABFunction_k(rtb_y_js, FmgcComputer_P.PulseNode_isRisingEdge_fo, &rtb_Compare_pf,
    ...
    altCstrApplicable_tmp = rtb_Compare_pf;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_OR4_e);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_oz);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_k(((rtb_OR4_e || rtb_y_oz || (rtb_DataTypeConversion1_e != 0U)) && (rtb_Memory ||
    ...
    FmgcComputer_MATLABFunction_k(rtb_y_ow, FmgcComputer_P.PulseNode3_isRisingEdge_k, &rtb_NOR1,
    ...
    rtb_Compare_d0 = (rtb_y_e && rtb_ap_fd_condition_tmp_0 && (!FmgcComputer_DWork.Memory_PreviousInput_nu) &&
                      (!rtb_Logic_oq_idx_0) && (!FmgcComputer_DWork.Memory_PreviousInput_d));
    rtb_y_jw = ((FmgcComputer_U.in.fms_inputs.v_managed_kts == FmgcComputer_P.CompareToConstant_const_dy) && rtb_NOR1 &&
                rtb_Compare_d0);
    FmgcComputer_MATLABFunction_k(rtb_y_js, FmgcComputer_P.PulseNode1_isRisingEdge_kl, &rtb_NOR1,
      &FmgcComputer_DWork.sf_MATLABFunction_dtd);
    rtb_y_ow = (rtb_NOR1 && (FmgcComputer_U.in.fms_inputs.fms_flight_phase != FmgcComputer_P.EnumeratedConstant_Value_ad));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_gv, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_f, &rtb_NOR1,
      &FmgcComputer_DWork.sf_MATLABFunction_d5);
    rtb_NOR1 = (rtb_NOR1 && rtb_NOR1_d);
    ...
    rtb_OR4_e = (((FmgcComputer_P.Constant_Value_k != FmgcComputer_DWork.DelayInput1_DSTATE_f) && rtb_OR_pj) || rtb_y_jw
                 || rtb_y_ow || rtb_NOR1 || (rtb_y_m && rtb_OR_pj && rtb_Compare_d0));
    rtb_y_oz = (rtb_Compare_pf || (rtb_AND_bi && rtb_OR4_e));
    FmgcComputer_MATLABFunction_kh(rtb_y_oz, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ch,
    ...
    FmgcComputer_MATLABFunction_k(rtb_y_js, FmgcComputer_P.PulseNode5_isRisingEdge, &rtb_OR4_e,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cu = FmgcComputer_P.Logic_table_kg
      [((((FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active && (!rtb_Compare_pf)) || (rtb_NOR1_a && (rtb_Memory ||
            rtb_OR4_e))) + (static_cast<uint32_T>(rtb_y_oz) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cu];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_5,
      FmgcComputer_P.BitfromLabel_bit_kq, &rtb_DataTypeConversion1_e);
    rtb_Compare_pf = ((rtb_DataTypeConversion1_e != 0U) && rtb_NOR1_h);
    FmgcComputer_MATLABFunction_k(rtb_y_js, FmgcComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_ow,
    ...
    rtb_y_jw = (rtb_y_js && rtb_y_jw);
    rtb_OR4_e = ((rtb_y_ow && rtb_Memory) || (rtb_OR4_e && rtb_Memory && rtb_y_js) || rtb_y_jw);
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Memory_PreviousInput_i ||
      FmgcComputer_DWork.Memory_PreviousInput_k), FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_ow,
      &FmgcComputer_DWork.sf_MATLABFunction_mrn);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ie, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_jp, &rtb_NOR1,
    ...
    rtb_Memory = (rtb_Compare_pf || (rtb_AND_bi && ((rtb_NOR1_a && rtb_OR4_e) || (rtb_y_ow || rtb_NOR1 || rtb_y_jw)) &&
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_adr_computation_data_corrected_average_static_pressure,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_b, &rtb_y_kz);
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_h) {
      ...
      rtb_Switch_e = std::sqrt(std::pow(rtb_y_kz / 1013.25F * (rtb_DataTypeConversion2_l - 1.0F) + 1.0F, 0.285714298F) -
        1.0F) * 1479.1F;
    } else {
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_man_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_h, &rtb_y_kz);
    if (FmgcComputer_DWork.Memory_PreviousInput_h) {
      rtb_DataTypeConversion1 = rtb_y_kz;
    } else {
      rtb_DataTypeConversion1 = FmgcComputer_P.Constant_Value_i;
    }

    rtb_y = std::fmax(rtb_DataTypeConversion1, rtb_Switch_e);
    rtb_Memory = (rtb_appInop_idx_0 || FmgcComputer_DWork.Memory_PreviousInput_cb ||
    ...
    rtb_ap_fd_condition_tmp_0 = (rtb_NOT3 || FmgcComputer_DWork.Memory_PreviousInput_e ||
    ...
    rtb_y_oz = (rtb_appInop_idx_0 && (!rtb_ap_fd_condition_tmp) && rtb_bothRaValid);
    ...
    apCondition_tmp_0 = (FmgcComputer_DWork.pLand3FailPass || (rtb_y_oz && rtb_OR4_e &&
      FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_e));
    rtb_y_e = (rtb_appInop_idx_0 && rtb_OR4_e && (!apCondition_tmp_0) && rtb_y_e);
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_chosen_fac_bus_estimated_sideslip_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_h, &rtb_y_le);
    rtb_DataTypeConversion27 = rtb_y_le;
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_p, &rtb_y_dm);
    rtb_DataTypeConversion32 = rtb_y_dm;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_j, &rtb_y_o);
    rtb_DataTypeConversion39 = rtb_y_o;
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_ir_computation_data_track_angle_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault8_defaultValue, &rtb_y_kz);
    if (!rtb_Compare_pf) {
      FmgcComputer_B.u_lyj = rtb_y_kz;
    }

    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue_a, &rtb_y_kz);
    if (rtb_Compare_pf) {
      rtb_DataTypeConversion10 = FmgcComputer_B.u_lyj;
    } else {
      rtb_DataTypeConversion10 = rtb_y_kz;
    }
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_f, &rtb_y_kz);
    rtb_DataTypeConversion42 = rtb_y_kz;
    ...
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_DataTypeConversion_cm,
                    ...
                    &rtb_DataTypeConversion20, &rtb_Gain, &rtb_Gain1, &rtb_Gain2, &FmgcComputer_B.u_ly,
                    &FmgcComputer_P.Constant_Value_m, &FmgcComputer_B.u, (const_cast<real_T*>(&FmgcComputer_RGND)),
                    &rtb_DataTypeConversion25, &rtb_y_h, &rtb_DataTypeConversion23,
      ...
      (&FmgcComputer_RGND)), &rtb_Gain3, &(&rtb_Logic_a2[0])[0], &rtb_active_lateral_law, &rtb_active_longitudinal_law,
                    ...
                    &rtb_DataTypeConversion42, &rtb_y,
                    ...
                    &rtb_Product_a, &rtb_Switch1, &rtb_Beta_c_deg_e, &rtb_Compare_pf, &rtb_H_dot_radio_fpm,
    ...
    FmgcComputer_MATLABFunction_k((rtb_y_ha != 0U), FmgcComputer_P.PulseNode3_isRisingEdge_ng, &rtb_y_ow,
      &FmgcComputer_DWork.sf_MATLABFunction_k);
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_y_ow) << 1)
    ...
    rtb_y_h = (rtb_y_p >= FmgcComputer_P.CompareToConstant_const_hq);
    rtb_OR4_e = (rtb_y_p <= FmgcComputer_P.CompareToConstant2_const_d);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o2, &rtb_y_p);
    rtb_y_jw = (rtb_y_p >= FmgcComputer_P.CompareToConstant1_const_h4);
    rtb_y_ow = (rtb_y_p <= FmgcComputer_P.CompareToConstant3_const_d);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_NOR1);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_m);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_k, &rtb_y_p);
    rtb_Compare_d0 = (rtb_y_p > FmgcComputer_P.CompareToConstant4_const_p);
    rtb_Compare_kg = (rtb_y_p <= FmgcComputer_P.CompareToConstant6_const_h);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_l, &rtb_y_p);
    rtb_y_h = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_h && rtb_OR4_e
      && rtb_y_jw && rtb_y_ow) || ((!rtb_NOR1) && (!rtb_y_m) && rtb_BusAssignment_h_logic_one_engine_out &&
      (rtb_Compare_d0 && rtb_Compare_kg && (rtb_y_p > FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_p <=
    ...
    rtb_Compare_d0 = !FmgcComputer_DWork.Memory_PreviousInput_hu;
    rtb_OR4_e = rtb_Compare_d0;
    rtb_y_jw = (((rtb_y_ha != 0U) && rtb_NOR1_h) || (rtb_AND_bi && rtb_y_jw && rtb_Compare_d0));
    ...
    rtb_y_ow = (FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_ap_fd_condition_tmp_2 ||
      ((rtb_y_ow || FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_OR4_e))) + (static_cast<uint32_T>
    ...
    rtb_OR4_e = rtb_Compare_d0;
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_NOR1_h) || (rtb_AND_bi && rtb_y_jw && rtb_Compare_d0));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_ap_fd_condition_tmp_2 ||
      ((rtb_y_ow || FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active) && (!rtb_OR4_e))) + (static_cast<uint32_T>
    ...
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_NOR1_h) || (rtb_AND_bi && FmgcComputer_DWork.Memory_PreviousInput_d &&
      rtb_Logic_a2[0] && rtb_OR4_e && rtb_Compare_d0));
    ...
    rtb_y_ow = (FmgcComputer_DWork.Memory_PreviousInput_b3 || FmgcComputer_DWork.Memory_PreviousInput_ev ||
                rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active);
    rtb_y_jw = (rtb_y_ow || rtb_Logic_b[0]);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_kr = FmgcComputer_P.Logic_table_b3[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        ...
        rtb_fmgcOppPriority_tmp || rtb_y_dh) && rtb_OR_pj) << 1) + (rtb_BusAssignment_h_logic_one_engine_out ||
      rtb_NOR1_a || ((FmgcComputer_P.EnumeratedConstant_Value_by == FmgcComputer_U.in.fms_inputs.fms_flight_phase) &&
                     (rtb_adrComputationBus_altitude_corrected_ft_Data <
    ...
    FmgcComputer_DWork.Memory_PreviousInput_km = FmgcComputer_P.Logic_table_mj[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_cb ||
        rtb_fmgcOppPriority_tmp || rtb_y_dh) && rtb_BusAssignment_h_logic_one_engine_out) << 1) + (rtb_OR_pj ||
      rtb_NOR1_a || ((FmgcComputer_P.EnumeratedConstant1_Value_e == FmgcComputer_U.in.fms_inputs.fms_flight_phase) &&
                     (rtb_adrComputationBus_altitude_corrected_ft_Data <
                      FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft)))) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_km];
    rtb_y_jj = athr_fma_message::NONE;
    rtb_AND_bi = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_Compare_d0);
    ...
    rtb_y_kz = std::fmax(FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data,
    ...
    if (rtb_AND_bi && (rtb_y_kz > 44.0F)) {
      rtb_y_k = athr_fma_mode::MAN_TOGA;
    } else {
      rtb_Compare_d0 = (rtb_AND_bi && (rtb_y_kz > 34.0F) && (rtb_y_kz < 36.0F));
      if (rtb_Compare_d0 && rtb_OR_pj) {
        rtb_y_k = athr_fma_mode::MAN_FLEX;
      } else if (rtb_Compare_d0 && (!rtb_OR_pj)) {
        rtb_y_k = athr_fma_mode::MAN_MCT;
      } else if (rtb_AND_bi && (rtb_y_kz > 24.0F)) {
        rtb_y_k = athr_fma_mode::MAN_THR;
      } else {
        rtb_AND_bi = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_h);
        rtb_Compare_d0 = (rtb_AND_bi && FmgcComputer_DWork.Memory_PreviousInput_cm);
        if (rtb_Compare_d0 && (!FmgcComputer_DWork.Delay_DSTATE_c)) {
          ...
          rtb_Compare_d0 = (rtb_AND_bi && FmgcComputer_DWork.Memory_PreviousInput_bh);
          rtb_OR_pj = !rtb_y_jw;
          if (rtb_Compare_d0 && (rtb_y_kz > 34.0F) && rtb_OR_pj) {
            rtb_y_k = athr_fma_mode::THR_MCT;
          } else if (rtb_Compare_d0 && (rtb_y_kz > 24.0F) && rtb_OR_pj) {
            rtb_y_k = athr_fma_mode::THR_CLB;
          } else if (rtb_Compare_d0 && (rtb_y_kz < 25.0F) && rtb_OR_pj) {
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_hv, &rtb_y_kz);
    ...
    v[2] = rtb_y_p;
    if (rtb_y_kz < static_cast<real32_T>(rtb_y)) {
      if (static_cast<real32_T>(rtb_y) < rtb_y_p) {
        high_i = 1;
      } else if (rtb_y_kz < rtb_y_p) {
        high_i = 2;
      } else {
        high_i = 0;
      }
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_body_normal_accel_g,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_bv, &rtb_y_kz);
    FmgcComputer_LagFilter(rtb_y_kz, FmgcComputer_P.LagFilter1_C1, FmgcComputer_U.in.time.dt, &rtb_y_p,
      &FmgcComputer_DWork.sf_LagFilter_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fg, &rtb_y_kz);
    rtb_Cos_h = std::cos(FmgcComputer_P.Gain1_Gain_hk * rtb_y_kz);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_m, &rtb_y_kz);
    rtb_Cos_h = rtb_y_p - rtb_Cos_h / std::cos(FmgcComputer_P.Gain1_Gain_go * rtb_y_kz);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_n1_actual_percent,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue_e, &rtb_y_kz);
    ...
    if (FmgcComputer_U.in.sim_data.tracking_mode_on_override) {
      ...
      rtb_Switch1 = ((FmgcComputer_P.Gain_Gain * rtb_DataTypeConversion1 + FmgcComputer_DWork.pY_d) +
        ...
        look1_iflf_binlxpw(std::fmin(rtb_y_kz, rtb_DataTypeConversion2_l),
    ...
    if (FmgcComputer_DWork.icLoad) {
      FmgcComputer_DWork.Delay_DSTATE_f = std::fmax
        (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_n1_actual_percent.Data,
         FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_n1_actual_percent.Data) - rtb_Switch1;
    }
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_y_kz);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_5.Data = rtb_y_kz;
    ...
    rtb_VectorConcatenate[10] = rtb_y_oz;
    ...
    rtb_VectorConcatenate[3] = rtb_y_h;
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_bw, &rtb_y_dm);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_fma_discrete_word.Data = rtb_y_dm;
    ...
    rtb_VectorConcatenate_f[0] = (FmgcComputer_DWork.Memory_PreviousInput_ec ||
      FmgcComputer_DWork.Memory_PreviousInput_ae ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_VectorConcatenate_f[1] = rtb_y_ow;
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_f, &rtb_y_le);
    ...
    rtb_VectorConcatenate_f[17] = altCstrApplicable_tmp;
    rtb_VectorConcatenate_f[18] = FmgcComputer_P.Constant8_Value;
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_f, &rtb_y_o);
    ...
    FmgcComputer_Y.out.logic.fac_lg_data_failure = rtb_y_a;
    ...
    FmgcComputer_Y.out.logic.rwy_hdg_memo = FmgcComputer_B.u_ly;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_mode_reversion_vs = rtb_y_j_tmp;
    ...
    FmgcComputer_Y.out.ap_fd_logic.roll_fd_bars_flashing = altCstrApplicable_tmp;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_passive_inop = rtb_y_oz;
    ...
    FmgcComputer_Y.out.athr.athr_active = rtb_y_h;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.runway_hdg_memorized_deg.Data = static_cast<real32_T>(FmgcComputer_B.u_ly);
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_4.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_4.Data = rtb_y_kz;
    if (rtb_OR2_l) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.Data = rtb_y_dm;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.Data = rtb_y_le;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.Data = rtb_y_o;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_4.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_4.Data = rtb_y_kz;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.Data = rtb_y_dm;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.Data = rtb_y_le;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.Data = rtb_y_o;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_mode_reversion_vs = rtb_y_j_tmp;
    ...
    FmgcComputer_DWork.Delay_DSTATE.roll_fd_bars_flashing = altCstrApplicable_tmp;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_passive_inop = rtb_y_oz;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.athr_active = rtb_y_h;
...
void FmgcComputer::initialize()
{
  ...
  FmgcComputer_DWork.Delay_DSTATE_i = FmgcComputer_P.DiscreteDerivativeVariableTs_InitialCondition;
  FmgcComputer_DWork.icLoad = true;
  FmgcComputer_B.u_ly = FmgcComputer_P.Y_Y0;
  FmgcComputer_B.u_l = FmgcComputer_P.Y_Y0_h;
  FmgcComputer_B.u = FmgcComputer_P.Y_Y0_c;
  FmgcComputer_B.u_lyj = FmgcComputer_P.Y_Y0_d;
  LawMDLOBJ1.init();
