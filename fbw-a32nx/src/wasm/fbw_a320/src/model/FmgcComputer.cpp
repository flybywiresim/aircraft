...
void FmgcComputer::step()
{
  ...
  boolean_T rtb_y_p;
  boolean_T rtb_y_p3;
  athr_fma_message rtb_y_gm;
  athr_fma_mode rtb_y_aj;
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    ...
    rtb_y_eq = (rtb_y_p && rtb_y_bo && rtb_y_ed && rtb_y_p3);
    ...
    rtb_y_dr = !FmgcComputer_P.Constant1_Value.fac_speeds_failure;
    rtb_ap_fd_condition_tmp_2 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active;
    rtb_y_bn = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active;
    rtb_ap_fd_condition = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || rtb_AND_cf) && (rtb_y_dr ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (rtb_Compare_mh || (rtb_ap_fd_condition_tmp_0 &&
      rtb_ap_fd_condition_tmp_2 && rtb_y_bn && rtb_ap_fd_condition_tmp_1)) && (rtb_ap_fd_condition_tmp || rtb_AND_cf) &&
      (!rtb_y_eb));
    ...
    rtb_BusAssignment_gk_logic_adr_computation_data_airspeed_computed_kn.SSM =
      rtb_adrComputationBus_airspeed_computed_kn_SSM;
    rtb_BusAssignment_gk_logic_adr_computation_data_airspeed_computed_kn.Data = rtb_Max_a;
    ...
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((static_cast<uint32_T>(rtb_y_bo &&
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_y_eg && rtb_ap_fd_condition && rtb_ap_fd_athr_condition && apCondition
      && ((rtb_y_f4 >= rtb_y_dd) && (rtb_y_dd >= rtb_y_n0) && (rtb_y_di >= FmgcComputer_P.CompareToConstant_const_hu) &&
          (rtb_y_di <= FmgcComputer_P.CompareToConstant1_const_bt) && (std::abs(rtb_y_py) <=
      FmgcComputer_P.CompareToConstant2_const_c))) << 1) + (fdOppOff || (rtb_y_bo && FmgcComputer_DWork.Delay_DSTATE_p) ||
      FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc || ((rtb_y_p3 && rtb_OR2_l) ||
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged && rtb_y_fpw && rtb_fmgcOppPriority)) || (rtb_y_eq &&
      (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_p || (rtb_Phi_c_deg >=
      FmgcComputer_P.CompareToConstant5_const))) || (rtb_y_eb && rtb_y_eq))) << 1) +
    ...
    FmgcComputer_MATLABFunction_g(FmgcComputer_U.in.discrete_inputs.fcu_athr_button,
      FmgcComputer_P.PulseNode_isRisingEdge_k, &rtb_Compare_a5, &FmgcComputer_DWork.sf_MATLABFunction_o1);
    ...
    FmgcComputer_MATLABFunction_g((rtb_y_eb && (rtb_y_py < FmgcComputer_P.CompareToConstant1_const)),
      FmgcComputer_P.PulseNode2_isRisingEdge_n, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_d4);
    ...
    rtb_y_dr = ((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active ||
                 FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_g1) && rtb_ap_fd_condition_tmp && rtb_y_dr);
    rtb_ap_fd_condition_tmp = (rtb_y_km || (!rtb_y_dr));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(rtb_ap_fd_athr_condition &&
      rtb_y_dr && ((rtb_Compare_a5 && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_Compare_du ||
      ...
      FmgcComputer_U.in.discrete_inputs.athr_instinctive_disc || rtb_y_h1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_p];
    rtb_fmgcOppPriority_tmp = !rtb_Logic_a2[0];
    rtb_y_km = !fdOwnOff;
    rtb_y_dr = !FmgcComputer_DWork.Delay_DSTATE_k;
    ...
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_y_km) && (rtb_y_eb || rtb_y_dr) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_eb || rtb_y_km) && (rtb_OR2_l || rtb_y_dr) &&
    ...
    rtb_y_km = (rtb_fmgcOppPriority && (rtb_fmgcOppPriority_tmp || rtb_y_p3));
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_m_logic_adr_computation_data_vertical_speed_ft_min,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_c, &rtb_y_f4);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel5_bit_b, &rtb_DataTypeConversion1_e);
    rtb_y_bv = !rtb_y_p;
    if (rtb_y_bv || (rtb_DataTypeConversion1_e == 0U)) {
      FmgcComputer_B.u_lyjjlj = rtb_y_f4;
    }
    ...
    rtb_y_j = !rtb_NOT1_i;
    FmgcComputer_MATLABFunction_j((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active && rtb_y_j),
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_m, &rtb_y_di);
    ...
    if (rtb_y_di > rtb_y_py) {
      rtb_Logic_gj_idx_0_tmp = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft < rtb_y_di) &&
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_eq, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_h,
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_k);
    rtb_y_k = (rtb_GreaterThan3 && (rtb_y_py > FmgcComputer_P.CompareToConstant4_const) && rtb_y_k);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_m);
    FmgcComputer_MATLABFunction_g((rtb_NOT3 || rtb_y_k || (!rtb_GreaterThan3) || (rtb_GreaterThan3 && (rtb_y_py >
      FmgcComputer_P.CompareToConstant6_const) && rtb_y_m)), FmgcComputer_P.PulseNode_isRisingEdge_p, &rtb_y_h1,
    ...
    rtb_y_bo = (rtb_Logic_gj_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active);
    FmgcComputer_DWork.Memory_PreviousInput_k = FmgcComputer_P.Logic_table_b[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_bo ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_h1))) + (static_cast<uint32_T>(rtb_NOT3) <<
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active,
      ...
      &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_ngt);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_f4_logic_ils_computation_data_runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_m, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_f4_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_o, &rtb_y_py);
    rtb_DataTypeConversion2_kb = std::abs(rtb_y_di - rtb_y_py);
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_eq, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_p,
    ...
    rtb_NOT3 = ((rtb_GreaterThan3 && (rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_m &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active) && ((rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_cq) && rtb_y_h1 && (rtb_DataTypeConversion2_kb <=
    ...
    FmgcComputer_MATLABFunction_a(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_l,
      FmgcComputer_P.ConfirmNode_timeDelay_f, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_jl);
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg, &rtb_y_k);
    FmgcComputer_DWork.Memory_PreviousInput_c = FmgcComputer_P.Logic_table_hz[(((((!rtb_y_h1) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_trk_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp || (!rtb_y_k)) + (
    ...
    FmgcComputer_MATLABFunction_j((rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_l),
      FmgcComputer_U.in.time.dt, &rtb_y_h1, FmgcComputer_P.MTrigNode_isRisingEdge_jv,
    ...
    FmgcComputer_MATLABFunction_a(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hu,
      FmgcComputer_P.ConfirmNode_timeDelay_j, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_kz1);
    FmgcComputer_DWork.Memory_PreviousInput_b = FmgcComputer_P.Logic_table_d[(((((!rtb_y_h1) &&
    ...
    rtb_y_k = (FmgcComputer_DWork.Memory_PreviousInput_c || FmgcComputer_DWork.Memory_PreviousInput_b);
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_f, FmgcComputer_P.ConfirmNode_timeDelay_d, &rtb_y_h1,
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ek, &rtb_y_f4);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_own_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_f, &rtb_y_n0);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_c, &rtb_y_di);
    ...
    rtb_y_ed = !rtb_BusAssignment_o_logic_ils_failure;
    ...
    rtb_AND1_c0 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active;
    rtb_Compare_ot = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active;
    rtb_GreaterThan3 = (rtb_ap_fd_condition_tmp_1 && (rtb_y_jqv || (rtb_y_m && (FmgcComputer_P.Constant_Value_l &&
      rtb_y_ed && (rtb_GreaterThan3_tmp || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_g)) &&
      rtb_Compare_mh && rtb_Compare_a5 && (!rtb_y_h1) && (rtb_Compare_ot &&
      (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed))) && rtb_appInop_idx_2 && rtb_OR2_l_tmp &&
      rtb_GreaterThan3_tmp_0 && rtb_AND1_c0 && rtb_Compare_du && rtb_Compare_du && (((rtb_y_f4 == rtb_y_n0) && (rtb_y_di
      == rtb_y_py)) || (!rtb_BusAssignment_o_logic_both_ils_valid)))));
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_j, &rtb_y_h1,
      &FmgcComputer_DWork.sf_MATLABFunction_eb2);
    rtb_AND8 = (rtb_appInop_idx_1 && rtb_y_h1);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_l, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_c, &rtb_y_h1,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_AND_cf || ((!rtb_NOT_b) &&
      ...
      rtb_AND8) || (rtb_Compare_a5 && FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed) || rtb_y_h1 ||
    ...
    FmgcComputer_MATLABFunction_a((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_d),
      ...
      &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_cr);
    rtb_AND_cf = (rtb_Compare_du && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_m &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active && rtb_y_h1)));
    FmgcComputer_MATLABFunction_a(rtb_AND_cf, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_d,
      FmgcComputer_P.ConfirmNode_timeDelay_a, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_op);
    rtb_Compare_a5 = !rtb_y_h1;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ft, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_a, &rtb_y_h1,
      &FmgcComputer_DWork.sf_MATLABFunction_fa);
    FmgcComputer_MATLABFunction_a(rtb_y_eq, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode2_isRisingEdge_l,
    ...
    rtb_AND8 = (rtb_Logic_d_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    rtb_Logic_d_idx_0_tmp = (rtb_AND8 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_y_bo ||
      ...
      rtb_y_h1 && rtb_Compare_du) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_AND_cf) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      ...
      FmgcComputer_U.in.discrete_inputs.right_wheel_spd_abv_70_kts) && rtb_y_jqv) || ((!rtb_y_jqv) && rtb_y_eq))),
    ...
    rtb_GreaterThan3 = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_km);
    rtb_y_bf = (rtb_GreaterThan3_tmp || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_lj) ||
                rtb_dualRaFailure);
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_le, FmgcComputer_P.ConfirmNode_timeDelay_n, &rtb_y_h1,
    ...
    rtb_y_p = (rtb_y_m && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid);
    rtb_y_jqv = (rtb_y_p && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && FmgcComputer_P.Constant_Value_hg &&
                 rtb_y_bf && rtb_ap_fd_condition_tmp_0 && (rtb_appInop_idx_2 && rtb_GreaterThan3_tmp_0 && rtb_OR2_l_tmp &&
      rtb_AND1_c0 && rtb_Compare_ot && (!rtb_y_h1) && rtb_y_fpw));
    rtb_NOT_b = (rtb_ap_fd_condition_tmp_1 && (rtb_GreaterThan3 || rtb_y_jqv));
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_k, &rtb_y_h1,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c
      [(((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_bo || rtb_y_h1 || (rtb_y_fpw
    ...
    rtb_y_p3 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active);
    rtb_GreaterThan3_tmp = (rtb_y_p3 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    rowIdx_tmp = (rtb_GreaterThan3_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active);
    absVsTarget = static_cast<int32_T>((((rtb_Logic_gj_idx_0_tmp || ((rowIdx_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_eq, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_m,
      FmgcComputer_P.ConfirmNode_timeDelay_j5, &rtb_y_bf, &FmgcComputer_DWork.sf_MATLABFunction_hvs);
    ...
    FmgcComputer_MATLABFunction_g((rtb_Compare_a5 || (rtb_y_py >= FmgcComputer_P.CompareToConstant5_const_k)),
      FmgcComputer_P.PulseNode_isRisingEdge_c, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_fn5);
    rtb_Compare_a5 = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_OR_o_tmp && (!rtb_y_bf) && rtb_y_jqv &&
      rtb_y_h1));
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hj,
      FmgcComputer_P.ConfirmNode_timeDelay_a3, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_lm);
    FmgcComputer_DWork.Memory_PreviousInput_i = FmgcComputer_P.Logic_table_o[((((rtb_Logic_gj_idx_0_tmp ||
      (rtb_Logic_gj_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) && (!rtb_y_h1)) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction_j(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_U.in.time.dt, &rtb_y_h1, FmgcComputer_P.MTrigNode_isRisingEdge_d,
    ...
    rtb_Compare_a5 = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_m && (rtb_AND1_c0 &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active) && rtb_y_h1)));
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_mf,
      FmgcComputer_P.ConfirmNode_timeDelay_dw, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_mtz);
    ...
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_y_h1,
    ...
    rtb_Compare_a5 = (rtb_GreaterThan3_tmp_0 && rtb_AND1_c0);
    rtb_Compare_du = (rtb_appInop_idx_1 && rtb_y_jqv && (rtb_Compare_a5 &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && rtb_ap_fd_condition_tmp_1) && (!rtb_y_h1));
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed ||
      ...
      &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_aj);
    ...
    rtb_Compare_a5 = (rtb_y_h1 && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && (rtb_Compare_a5 &&
      rtb_y_fpw && rtb_OR_o_tmp && rtb_ap_fd_condition_tmp_1));
    rtb_NOT_b = rtb_appInop_idx_1;
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_b, &rtb_y_h1,
    ...
    rtb_GreaterThan3_tmp_0 = !FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid;
    rtb_Compare_du = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_GreaterThan3_tmp_0 &&
                       rtb_Compare_ot) || rtb_Compare_du || rtb_Compare_a5 || (rtb_appInop_idx_1 && rtb_NOT_c &&
      rtb_y_h1) || (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_i, &rtb_y_h1,
      &FmgcComputer_DWork.sf_MATLABFunction_di2);
    rtb_GreaterThan3 = (rtb_y_eg && rtb_y_h1 && rtb_ap_fd_condition_tmp_1 && (rtb_AND1_c0 || (rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_a)));
    rtb_y_jqv = rtb_OR_m4;
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode4_isRisingEdge_e, &rtb_y_h1,
      &FmgcComputer_DWork.sf_MATLABFunction_a5);
    rtb_y_j_tmp = !FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged;
    rtb_y_bf = (rtb_y_j_tmp && rtb_OR2_l_tmp);
    rtb_Compare_a5 = ((rtb_Compare_a5 && rtb_y_km) || (rtb_y_m && (rtb_GreaterThan3 || (rtb_OR_m4 && rtb_y_h1 &&
      rtb_y_bf) || rtb_Compare_du)));
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_a,
      FmgcComputer_P.ConfirmNode_timeDelay_a2, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_hdw);
    FmgcComputer_DWork.Memory_PreviousInput_f2 = FmgcComputer_P.Logic_table_i[(((((!rtb_y_h1) && (rtb_AND8 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction_g(FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid,
      FmgcComputer_P.PulseNode3_isRisingEdge_e, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_hu);
    rtb_GreaterThan3 = !FmgcComputer_DWork.Delay_DSTATE.hdg_trk_preset_available;
    rtb_NOT_b = (rtb_GreaterThan3 || rtb_y_h1);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed,
      FmgcComputer_P.PulseNode4_isRisingEdge_b, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_idz);
    FmgcComputer_MATLABFunction_j(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_U.in.time.dt, &rtb_y_bf, FmgcComputer_P.MTrigNode_isRisingEdge_i,
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_y_p && ((rtb_y_fpw && rtb_OR_o_tmp &&
      rtb_ap_fd_condition_tmp_1 && rtb_y_jqv) || (rtb_y_eq && rtb_NOT_b && (rtb_y_j_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active)) || rtb_y_h1 || (rtb_y_bf &&
      rtb_GreaterThan3))));
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.hdg_trk_preset_available,
      FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_jqv, &FmgcComputer_DWork.sf_MATLABFunction_h0);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_p, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_k, &rtb_y_bf,
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      ...
      FmgcComputer_P.PulseNode6_isRisingEdge, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_jd);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_jqv || rtb_y_bf || rtb_y_h1 ||
      rtb_GreaterThan3_tmp_0 || rtb_GreaterThan3 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((rtb_GreaterThan3_tmp_0 ||
      rtb_Logic_gj_idx_0_tmp || ((rtb_Logic_d_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) &&
      (!rtb_y_h1))) + (static_cast<uint32_T>(rtb_Compare_a5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ip];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_o, &rtb_DataTypeConversion1_e);
    rtb_Compare_du = (rtb_DataTypeConversion1_e != 0U);
    rtb_Compare_a5 = rtb_y_m;
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_o, &rtb_y_h1,
      &FmgcComputer_DWork.sf_MATLABFunction_k4c);
    rtb_NOT_b = rtb_y_ed;
    rtb_AND1_c0 = (rtb_y_h1 && rtb_y_ed && (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_m) &&
    ...
    rtb_NOT_c = (rtb_NOT_c && rtb_y_h1 && FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed,
      FmgcComputer_P.PulseNode3_isRisingEdge_d, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_mne);
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_NOT_b) && rtb_Compare_a5) ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_NOT_c || rtb_y_h1) + (static_cast<
      uint32_T>((rtb_Compare_du && rtb_y_km) || (rtb_y_m && (rtb_y_p || rtb_AND1_c0))) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_o, &rtb_y_n0);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o, &rtb_y_di);
    ...
    if (low_ip1 == high_i) {
      ...
      if (rtb_DataTypeConversion1_d > 5.0) {
        if (std::abs(rtb_y_di) <= 5.0F) {
          rtb_Compare_a5 = true;
        } else {
          if (rtb_y_di < 0.0F) {
            absVsTarget = -1;
          } else {
            absVsTarget = (rtb_y_di > 0.0F);
          }
      ...
      if (guard1) {
        ...
        rtb_Compare_a5 = ((rtb_DataTypeConversion1_d >= std::abs(rtb_y_di)) && (high_i == absVsTarget));
      }
    } else {
    ...
    if (rtb_DataTypeConversion2_kb < 115.0F) {
      rtb_y_di = std::abs(rtb_y_n0);
      if (rtb_y_n0 < 0.0F) {
        high_i = -1;
      } else {
        high_i = (rtb_y_n0 > 0.0F);
      }

      if (((rtb_DataTypeConversion2_kb > 25.0F) && ((rtb_y_di < 10.0F) && ((low_ip1 != high_i) && rtb_Compare_a5))) ||
          (rtb_y_di < 1.92)) {
        rtb_Compare_a5 = (rtb_Compare_a5 || ((rtb_DataTypeConversion2_kb < 15.0F) && (rtb_y_di < 1.1)));
      } else {
        rtb_Compare_a5 = false;
      }
    } else {
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_at,
      FmgcComputer_P.ConfirmNode_timeDelay_h4, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_p4);
    rtb_Compare_du = (rtb_Logic_d_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active);
    FmgcComputer_DWork.Memory_PreviousInput_cv = FmgcComputer_P.Logic_table_g4[(((((!rtb_y_h1) && (rtb_Compare_du ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction_a((rtb_DataTypeConversion1_d < FmgcComputer_P.CompareToConstant1_const_n),
      ...
      &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_is);
    rtb_Compare_a5 = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_m &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active && rtb_y_h1));
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ea,
      FmgcComputer_P.ConfirmNode_timeDelay_es, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_pr);
    FmgcComputer_DWork.Memory_PreviousInput_lq = FmgcComputer_P.Logic_table_j[(((((!rtb_y_h1) && (rtb_Compare_du ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pm, &rtb_y_f4);
    rtb_DataTypeConversion2_kb = rtb_y_py - rtb_y_f4;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_j, &rtb_y_n0);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jm, &rtb_y_di);
    if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) {
      ...
      if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active && rtb_y_bv) {
        rtb_y_di = static_cast<real32_T>(rtb_Phi_c_deg);
      } else {
        rtb_y_di = 0.0F;
      }
    }
    ...
    rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s.Data =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_Data;
    if (rtb_DataTypeConversion2_kb < 0.0F) {
      rtb_y_bv = (rtb_y_di <= 0.0F);
    } else {
      rtb_y_bv = ((rtb_DataTypeConversion2_kb > 0.0F) && (rtb_y_di >= 0.0F));
    }

    rtb_Compare_a5 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active;
    rtb_NOT_c = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_m &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) && rtb_Compare_a5 &&
      rtb_ap_fd_condition_tmp_2 && rtb_y_bn && rtb_Compare_ot && rtb_ap_fd_condition_tmp_1 && ((!rtb_y_bv) ||
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_h, &rtb_y_di);
    rtb_y_py = std::abs(rtb_y_di);
    high_i = 7;
    absVsTarget = 0;
    low_ip1 = 2;
    ...
    if (rtb_y_di < 0.0F) {
      ...
      low_ip1 = (rtb_y_di > 0.0F);
    }

    rtb_NOT_b = (FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed && (!rtb_y_h1) && ((std::fmin(3000.0F, std::
      fmax(80.0F, rtb_y_n0 * rtb_y_n0 / ((((rtb_DataTypeConversion2_kb * static_cast<real32_T>(c[absVsTarget]) +
    ...
    rtb_y_bf = rtb_y_j;
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_y_m && rtb_NOT_b && ((rtb_raComputationData >=
      ...
      FmgcComputer_P.EnumeratedConstant3_Value_l) && (!rtb_y_j)))));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hux,
      FmgcComputer_P.ConfirmNode_timeDelay_lk, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_hw);
    ...
    FmgcComputer_MATLABFunction_a((std::abs(rtb_altCstrOrFcu - rtb_y_py) < FmgcComputer_P.CompareToConstant_const_f),
      ...
      &rtb_y_bf, &FmgcComputer_DWork.sf_MATLABFunction_ee);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel7_bit_k, &rtb_DataTypeConversion1_e);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_y_m &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && rtb_y_bf && (rtb_Compare_b ||
      ((rtb_DataTypeConversion1_e == 0U) && (FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode ==
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lj,
      FmgcComputer_P.ConfirmNode_timeDelay_b, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_dt);
    ...
    rtb_GreaterThan3_tmp_0 = !rtb_AND_iz;
    rtb_Compare_b = (FmgcComputer_DWork.Memory_PreviousInput_cb && rtb_GreaterThan3_tmp_0 &&
    ...
    rtb_Logic_gj_idx_0_tmp_tmp_tmp = rtb_y_bf;
    ...
    rtb_y_h1 = (rtb_Compare_du && rtb_y_ed);
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mr, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oi, &rtb_y_py);
    rtb_DataTypeConversion2_bh = rtb_y_di - rtb_y_py;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_o3_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_o, &rtb_y_py);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_o3_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_c, &rtb_y_di);
    ...
    rtb_y_p = (rtb_y_j || (FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode ==
                FmgcComputer_P.EnumeratedConstant3_Value_ls));
    rtb_y_bv = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_AND1_c0 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    rtb_OR_o_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && rtb_y_fpw && rtb_OR_o_tmp);
    rtb_Compare_du = (rtb_y_h1 || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active &&
      ...
      ((FmgcComputer_P.EnumeratedConstant_Value_p == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant2_Value) || rtb_OR_o_tmp ||
       rtb_y_bo)) || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && (std::abs(FmgcComputer_B.u_ly
      - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_omz)) || (rtb_y_bv && (rtb_DataTypeConversion2_bh >
      FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_AND1_c0 && (rtb_DataTypeConversion2_bh <
      FmgcComputer_P.CompareToConstant2_const_g)) || ((rtb_y_bv ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (rtb_DataTypeConversion2_kb > rtb_y_di) &&
      rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k && FmgcComputer_P.Constant_Value_md) || (rtb_AND1_c0 &&
    ...
    rtb_GreaterThan3 = (rtb_y_eg && rtb_y_jqv && rtb_ap_fd_condition_tmp_1);
    ...
    rtb_y_bf = rtb_y_j_tmp;
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ld,
      FmgcComputer_P.ConfirmNode_timeDelay_op, &rtb_y_bf, &FmgcComputer_DWork.sf_MATLABFunction_cz);
    rtb_Compare_a5 = ((rtb_Compare_a5 && rtb_y_km) || (rtb_y_m && (rtb_GreaterThan3 || (rtb_OR_m4 && rtb_y_p &&
      rtb_y_j_tmp) || (rtb_y_bf && rtb_y_j_tmp) || rtb_Compare_du)));
    ...
    rtb_AND1_c0 = ((rtb_DataTypeConversion1_e != 0U) && FmgcComputer_DWork.Memory_PreviousInput_fg);
    rtb_y_p3 = (FmgcComputer_DWork.Memory_PreviousInput_fg && (rtb_DataTypeConversion1_e == 0U));
    rtb_Logic_d_idx_0_tmp = rtb_Compare_du;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_jh, &rtb_DataTypeConversion1_e);
    rtb_Compare_du = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_et, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oj, &rtb_y_py);
    rtb_y_jqv = (rtb_y_di > rtb_y_py);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_px, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_b, &rtb_y_h1,
    ...
    rtb_NOT_b = (rtb_OR_m4 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_jqv && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_p || (rtb_y_h1 &&
      rtb_appCapability_idx_0 && (rtb_AND_iz && (std::abs(rtb_altCstrOrFcu - rtb_y_py) <=
      FmgcComputer_P.CompareToConstant2_const_d)))));
    rtb_GreaterThan3 = (rtb_y_eq || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_k, &rtb_y_py);
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jt, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_os, &rtb_y_py);
    rtb_TmpSignalConversionAtSFunctionInport3_idx_2 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_GreaterThan3 && (!rtb_y_jqv)) ||
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
       ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
         FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) && rtb_GreaterThan3_tmp_0) ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) || (rtb_y_di < rtb_y_py) ||
      (rtb_appCapability_idx_0 && (rtb_GreaterThan3_tmp_0 || rtb_TmpSignalConversionAtSFunctionInport3_idx_1 || rtb_y_bo))
      ...
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>((rtb_Compare_du && rtb_y_km) || (rtb_y_m && (rtb_NOT_b ||
      (rtb_GreaterThan3 && rtb_y_jqv)))) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ma];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_du = (rtb_Compare_du && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_h, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_n, &rtb_y_py);
    rtb_GreaterThan3 = (rtb_y_di > rtb_y_py);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    FmgcComputer_MATLABFunction_g((rtb_y_py > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode_isRisingEdge_bg, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_dfk);
    rtb_y_bf = (rtb_y_h1 || (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_j4,
      &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_dd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_d, &rtb_y_py);
    rtb_y_ed = (rtb_GreaterThan3_tmp_0 || (std::abs(rtb_altCstrOrFcu - rtb_y_py) >
      FmgcComputer_P.CompareToConstant2_const_a));
    rtb_Compare_a5 = (rtb_y_m && FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible && rtb_y_eg);
    rtb_y_fpw = !rtb_appCapability_idx_0;
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_Compare_a5 && (rtb_ap_fd_condition_tmp_1 && rtb_y_bn) &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
      ...
      ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed && rtb_y_bf) || (rtb_y_h1 && (rtb_y_fpw ||
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_fc,
      FmgcComputer_P.ConfirmNode_timeDelay_nn, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_ir);
    rtb_y_bv = (rowIdx_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_ec = FmgcComputer_P.Logic_table_kw[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_bv ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_Compare_du = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_nh, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_y_m && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_cj, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he
      [(((rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
          ...
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active || (rtb_y_di > rtb_y_py) || rtb_OR_o_tmp ||
          ...
          (rtb_appCapability_idx_0 && rtb_GreaterThan3_tmp_0) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
          (rtb_Compare_du) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_nt];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_du = (rtb_Compare_du && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mo, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_fq,
      &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_kd);
    rtb_y_ed = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.des_armed;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_m, &rtb_y_py);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_Compare_a5 && (rtb_y_bn && rtb_ap_fd_condition_tmp_1 &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active) && rtb_Compare_ot && rtb_OR2_l_tmp &&
      rtb_appInop_idx_2) && rtb_appInop_idx_0 && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_jqv &&
      ...
      FmgcComputer_DWork.DelayInput1_DSTATE_n)) || (rtb_y_h1 && (rtb_y_fpw || (rtb_appCapability_idx_0 && rtb_y_ed &&
      (rtb_GreaterThan3_tmp_0 || (std::abs(rtb_altCstrOrFcu - rtb_y_py) > FmgcComputer_P.CompareToConstant2_const_l))))))));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_j,
      FmgcComputer_P.ConfirmNode_timeDelay_dy, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_n5);
    rtb_OR_o_tmp = (rtb_GreaterThan3_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active);
    rtb_GreaterThan3_tmp = (rtb_OR_o_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    FmgcComputer_DWork.Memory_PreviousInput_b3 = FmgcComputer_P.Logic_table_cv[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_GreaterThan3_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_h1))) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ht, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_y_bf = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && rtb_y_bf),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_jo, FmgcComputer_P.ConfirmNode_timeDelay_jo,
      &rtb_y_bf, &FmgcComputer_DWork.sf_MATLABFunction_moh);
    rtb_y_jqv = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
                  ((FmgcComputer_P.EnumeratedConstant_Value_c == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                   ...
                   rtb_TmpSignalConversionAtSFunctionInport3_idx_1 || rtb_y_bo)) || rtb_y_bf);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_y_bf = (rtb_y_ed || rtb_y_jqv || (rtb_y_p && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 || rtb_y_bo)));
    rtb_y_fpw = (rtb_Compare_a5 && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_y_fpw && rtb_GreaterThan3 && rtb_y_bf));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ae = FmgcComputer_P.Logic_table_jq[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_bv ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_NOT_b = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_i, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_dp, &rtb_y_py);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel4_bit_i, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_f, &rtb_y_jqv,
    ...
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active &&
      ...
      FmgcComputer_P.ConfirmNode_isRisingEdge_fq, FmgcComputer_P.ConfirmNode_timeDelay_lp, &rtb_y_bf,
      &FmgcComputer_DWork.sf_MATLABFunction_hj);
    rtb_y_jqv = (rtb_y_jqv || rtb_y_bf);
    rtb_Compare_a5 = ((rtb_Compare_du && rtb_y_km) || (rtb_y_fpw && (rtb_y_di < rtb_y_py) && rtb_y_jqv));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ev = FmgcComputer_P.Logic_table_lw[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_GreaterThan3_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_NOT_b))) + (static_cast<uint32_T>
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_m && (rtb_y_jqv && rtb_ap_fd_condition_tmp_2 &&
      rtb_y_bn))) << 1) + (rtb_Compare_a5 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg,
      &rtb_Compare_a5);
    rtb_Compare_a5 = (rtb_y_m && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_appInop_idx_1 &&
    ...
    rtb_OR_o_tmp = (rtb_OR_o_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_nu = FmgcComputer_P.Logic_table_d3[(((((!rtb_Compare_a5) && (rtb_OR_o_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    rtb_Compare_du = ((rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_m && rtb_NOT_b &&
    ...
    rtb_OR_o_tmp = (rtb_OR_o_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active);
    FmgcComputer_DWork.Memory_PreviousInput_as = FmgcComputer_P.Logic_table_fi[(((((!rtb_Compare_a5) && (rtb_OR_o_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_Compare_a5 = (rtb_y_m && rtb_NOT1_i);
    FmgcComputer_DWork.Memory_PreviousInput_n0 = FmgcComputer_P.Logic_table_id[(((static_cast<uint32_T>
      ...
      rtb_y_j || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active)) << 1) +
    ...
    absVsTarget = static_cast<int32_T>(((((rtb_Logic_gj_idx_0_tmp || (rtb_OR_o_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cp = FmgcComputer_P.Logic_table_dj[(((static_cast<uint32_T>
      ((FmgcComputer_P.EnumeratedConstant1_Value_eq == FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode) &&
       rtb_Logic_gj_idx_0_tmp_tmp_tmp) << 1) + (rtb_Compare_a5 || rtb_Compare_du)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_cp];
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_bw, &rtb_y_py);
    rtb_y_n0 = rtb_y_py + FmgcComputer_P.Bias_Bias_m;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jb, &rtb_y_di);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_e, &rtb_y_py);
    rtb_NOT_b = (rtb_y_di < rtb_y_py + FmgcComputer_P.Bias1_Bias_c);
    rtb_GreaterThan3_tmp = (FmgcComputer_DWork.Memory_PreviousInput_b3 || FmgcComputer_DWork.Memory_PreviousInput_ev ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active);
    rtb_GreaterThan3 = rtb_GreaterThan3_tmp;
    rtb_y_fpw = (rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k);
    rtb_OR_o_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ec || FmgcComputer_DWork.Memory_PreviousInput_ae ||
                    rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_Compare_a5 = ((rtb_y_fpw && rtb_OR_o_tmp && (rtb_y_n0 < rtb_y_di)) || (rtb_y_fpw && rtb_NOT_b &&
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ds_logic_ir_computation_data_flight_path_angle_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_i, &rtb_y_f4);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pc, &rtb_y_g);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ds_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_g, &rtb_y_dd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_d, &rtb_y_py);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_b, &rtb_y_n0);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_f, &rtb_y_di);
    rtb_appCapability_idx_0 = (rtb_AND1_c0 || rtb_y_p3);
    if (rtb_AND1_c0) {
      rtb_DataTypeConversion2_bh = rtb_y_dd - rtb_y_g;
      rtb_Phi_c_deg = 50.0;
    } else {
      rtb_DataTypeConversion2_bh = rtb_y_f4 - rtb_DataTypeConversion2_bh;
      rtb_Phi_c_deg = 0.1;
    }

    rtb_Compare_du = (rtb_Logic_a2[0] && rtb_appCapability_idx_0);
    rtb_y_bn = ((rtb_Compare_du && (rtb_y_di < rtb_y_py + 3.0F) && (rtb_DataTypeConversion2_bh < -rtb_Phi_c_deg)) ||
                (rtb_Compare_du && (rtb_y_di > rtb_y_n0 - 3.0F) && (rtb_DataTypeConversion2_bh > rtb_Phi_c_deg)));
    FmgcComputer_MATLABFunction_j((rtb_y_bn || rtb_Compare_a5 || rtb_OR2_l_tmp || rtb_Logic_d_idx_0_tmp || rtb_AND8),
    ...
    rtb_GreaterThan3_tmp_0 = !rtb_Logic_ac[0];
    rtb_Compare_du = (rtb_Compare_a5 && rtb_GreaterThan3_tmp_0);
    FmgcComputer_MATLABFunction_j((rtb_Logic_d_idx_0_tmp || rtb_Compare_du), FmgcComputer_U.in.time.dt, &rtb_Compare_a5,
    ...
    rtb_ap_fd_condition_tmp_1 = rtb_NOT_b;
    rtb_fmgcOppPriority_tmp = rtb_Compare_a5;
    rtb_y_j = rtb_Compare_du;
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_h1);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_bv);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    rtb_Compare_du = (rtb_Compare_du || rtb_y_eq || ((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_c) &&
      rtb_Compare_mh));
    rtb_Compare_a5 = ((rtb_y_h1 || rtb_y_bv || (rtb_DataTypeConversion1_e != 0U)) && rtb_Compare_a5 && rtb_Compare_du);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_pq, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_NOT_b,
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mh, &rtb_y_di);
    rtb_y_ed = !FmgcComputer_DWork.Memory_PreviousInput_k;
    rtb_GreaterThan3 = (FmgcComputer_U.in.fms_inputs.preset_spd_mach_activate && (rtb_y_ed || (rtb_y_py <= rtb_y_di)));
    ...
    rtb_y_bf = (rtb_y_ed && rtb_Compare_mh && (!FmgcComputer_DWork.Memory_PreviousInput_nu) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_as) && (!FmgcComputer_DWork.Memory_PreviousInput_d));
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode7_isRisingEdge, &rtb_y_jqv,
      &FmgcComputer_DWork.sf_MATLABFunction_itu);
    rtb_y_h1 = (rtb_Compare_du || (rtb_y_m && (((FmgcComputer_P.Constant_Value_k !=
      FmgcComputer_DWork.DelayInput1_DSTATE_f) && rtb_OR_m4) || ((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant_const_dy) && rtb_y_bo && rtb_y_bf) || rtb_Compare_a5 || rtb_NOT_b ||
      rtb_GreaterThan3 || (rtb_y_p && rtb_OR_m4 && rtb_y_bf) || rtb_y_jqv)));
    FmgcComputer_MATLABFunction_a(rtb_y_h1, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ch,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cu = FmgcComputer_P.Logic_table_kg
      [((((FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active && (!rtb_Compare_du)) || (rtb_y_eq && (rtb_Compare_a5
            || rtb_NOT_b))) + (static_cast<uint32_T>(rtb_y_h1) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cu];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_5,
    ...
    rtb_NOT_b = ((rtb_y_jqv && rtb_Compare_a5) || (rtb_NOT_b && rtb_Compare_a5 && rtb_y_eb) || rtb_GreaterThan3);
    rtb_y_bv = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_g(rtb_y_bv, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_jqv,
      &FmgcComputer_DWork.sf_MATLABFunction_mrn);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ie, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_jp, &rtb_y_bf,
    ...
    rtb_Compare_a5 = ((rtb_y_eq && rtb_NOT_b) || (rtb_y_jqv || rtb_y_bf || rtb_GreaterThan3));
    ...
    rtb_Compare_a5 = (rtb_Compare_du || (rtb_y_m && rtb_Compare_a5 && (rtb_NOT_b || rtb_GreaterThan3)));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_hk = FmgcComputer_P.Logic_table_ds
      [((((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && (!rtb_Compare_du)) || (rtb_y_eq &&
           (rtb_Compare_mh && rtb_y_ed) && rtb_NOT_b)) + (static_cast<uint32_T>(rtb_Compare_a5) << 1)) << 1) +
    ...
    rtb_y_g = std::pow((std::pow(FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach.Data *
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_4_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_c, &rtb_y_di);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_m, &rtb_y_dd);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_cz, &rtb_y_f4);
    if (!FmgcComputer_DWork.vMemoEo_not_empty) {
      FmgcComputer_DWork.vMemoEo = rtb_y_dd;
      FmgcComputer_DWork.vMemoEo_not_empty = true;
    }

    if (!FmgcComputer_DWork.vMemoGa_not_empty) {
      FmgcComputer_DWork.vMemoGa = rtb_y_dd;
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_i) {
      ...
      rtb_Nosewheel_c = rtb_y_f4 - 5.0;
      if (rtb_y_f4 - 5.0 > rtb_Phi_c_deg) {
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_hk) {
      if (FmgcComputer_DWork.Memory_PreviousInput_d || FmgcComputer_DWork.Memory_PreviousInput_l ||
        ...
        rtb_Switch_e[0] = std::fmax(std::fmax(std::fmax(static_cast<real_T>(rtb_y_py), static_cast<real_T>(rtb_y_di)),
          static_cast<real_T>(rtb_y_n0)), FmgcComputer_B.u_l);
      ...
      if (FmgcComputer_DWork.Delay_DSTATE_c) {
        rtb_y_di = std::sqrt(rtb_y_g - 1.0F) * 1479.1F;
      } else {
        rtb_y_di = FmgcComputer_U.in.bus_inputs.fcu_bus.selected_spd_kts.Data;
      }

      rtb_Switch_e[0] = rtb_y_di;
      rtb_Switch_e[1] = rtb_y_di;
    }
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_mh, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_i,
      FmgcComputer_P.ConfirmNode1_timeDelay_df, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_hi);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_g, &rtb_y_f4);
    rtb_Phi_c_deg = rtb_y_f4;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_mz, &rtb_DataTypeConversion1_e);
    rtb_Compare_a5 = ((!rtb_Compare_du) || rtb_y_h1 || rtb_y_fpw || (rtb_Max_a > rtb_y_f4 + FmgcComputer_P.Bias_Bias) ||
                      (rtb_DataTypeConversion1_e != 0U));
    ...
    } else if (rtb_AND1_c0 || (rtb_Logic_ac[0] && (rtb_mode == tcas_submode::VS))) {
    ...
    rtb_Compare_mh = (rtb_y_k || FmgcComputer_DWork.Memory_PreviousInput_el ||
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4, &rtb_y_h1);
    rtb_Compare_du = ((rtb_Compare_du || ((rtb_DataTypeConversion1_e != 0U) && rtb_y_h1)) &&
                      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged);
    rtb_y_h1 = (rtb_Logic_a2[0] && (FmgcComputer_DWork.Memory_PreviousInput_l ||
      FmgcComputer_DWork.Memory_PreviousInput_d));
    ...
    rtb_y_bv = (rtb_appInop_idx_0 && (!rtb_ap_fd_condition_tmp) && rtb_bothRaValid);
    ...
    rtb_appCapability_idx_2 = (FmgcComputer_DWork.pLand3FailOp || (rtb_appInop_idx_2 && rtb_y_h1 && rtb_Compare_du &&
      FmgcComputer_DWork.Delay_DSTATE_k));
    rtb_appCapability_idx_0 = !rtb_appCapability_idx_2;
    apCondition_tmp = (FmgcComputer_DWork.pLand3FailPass || (rtb_y_bv && rtb_y_h1 && FmgcComputer_DWork.Delay_DSTATE_k &&
      rtb_appCapability_idx_0));
    rtb_appCapability_idx_0 = (rtb_appInop_idx_0 && rtb_y_h1 && (!apCondition_tmp) && rtb_appCapability_idx_0);
    rtb_appInop_idx_0 = !rtb_appInop_idx_0;
    rtb_appInop_idx_1 = !rtb_y_bv;
    rtb_appInop_idx_2 = !rtb_appInop_idx_2;
    if ((rtb_raComputationData < 100.0F) && (rtb_y_h1 || rtb_Compare_du)) {
    ...
    if (rtb_Logic_a2[0] && FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) {
      if (FmgcComputer_U.in.discrete_inputs.is_unit_1) {
        rtb_y_bo = rtb_appCapability_idx_0;
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_estimated_sideslip_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_h, &rtb_y_di);
    rtb_DataTypeConversion27 = rtb_y_di;
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_fa);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_p, &rtb_y_n0);
    rtb_DataTypeConversion32 = rtb_y_n0;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_i, &rtb_y_g);
    rtb_DataTypeConversion26 = rtb_y_g;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fc, &rtb_y_f4);
    if (rtb_Logic_ac[0]) {
      rtb_Switch1 = rtb_BusAssignment_hk_ap_fd_logic_tcas_vs_target;
    } else if (FmgcComputer_DWork.Memory_PreviousInput_b3) {
      rtb_Switch1 = FmgcComputer_U.in.fms_inputs.vs_target_ft_min;
    } else {
      rtb_Switch1 = rtb_y_f4;
    }

    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_f, &rtb_y_dd);
    if (FmgcComputer_DWork.Memory_PreviousInput_b3) {
      rtb_Switch3 = FmgcComputer_U.in.fms_inputs.vs_target_ft_min;
    } else {
      rtb_Switch3 = rtb_y_dd;
    }

    rtb_y_h1 = (FmgcComputer_DWork.Memory_PreviousInput_as || FmgcComputer_DWork.Memory_PreviousInput_d);
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_DataTypeConversion_cm,
                    ...
                    &rtb_DataTypeConversion32, &rtb_DataTypeConversion26, &rtb_y_eq, (const_cast<real_T*>
      (&FmgcComputer_RGND)), &rtb_Gain3, &(&rtb_Logic_a2[0])[0], &rtb_active_lateral_law, &rtb_active_longitudinal_law,
                    ...
                    &rtb_y_h1, &rtb_Phi_loc_c, &rtb_Nosewheel_c, &rtb_Theta_c_deg, &rtb_Phi_c_deg, &rtb_Beta_c_deg,
    ...
    FmgcComputer_MATLABFunction_a(rtb_Logic_ac[0], FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_oa,
      FmgcComputer_P.ConfirmNode_timeDelay_a0, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_a);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_p, &rtb_DataTypeConversion2_bh);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_k, &rtb_y_di);
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode3_isRisingEdge_l4, &rtb_y_bf,
      &FmgcComputer_DWork.sf_MATLABFunction_g);
    absVsTarget = static_cast<int32_T>((((rtb_GreaterThan3_tmp_0 || (rtb_y_h1 && ((rtb_DataTypeConversion2_bh <
      FmgcComputer_P.CompareToConstant_const_j) || (rtb_y_di < FmgcComputer_P.CompareToConstant1_const_d)))) + (
      static_cast<uint32_T>(rtb_y_bf) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_j);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_y_jqv) << 1)
      + rtb_y_dr) << 1) + FmgcComputer_DWork.Memory_PreviousInput_hu];
    rtb_BusAssignment_b_logic_ra_computation_data_ft = rtb_Switch1_a;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_hw, &rtb_y_di);
    rtb_y_fa = (rtb_y_di >= FmgcComputer_P.CompareToConstant_const_hq);
    rtb_y_h1 = (rtb_y_di <= FmgcComputer_P.CompareToConstant2_const_di);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o2, &rtb_y_di);
    rtb_y_bv = (rtb_y_di >= FmgcComputer_P.CompareToConstant1_const_h4);
    rtb_Compare_ot = (rtb_y_di <= FmgcComputer_P.CompareToConstant3_const_d);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_jqv);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_NOT_b);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_k, &rtb_y_di);
    rtb_y_p = (rtb_y_di > FmgcComputer_P.CompareToConstant4_const_p);
    rtb_y_ed = (rtb_y_di <= FmgcComputer_P.CompareToConstant6_const_h);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_l, &rtb_y_di);
    rtb_DataTypeConversion_cm = rtb_Product_p2;
    rtb_Compare_ot = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_fa &&
      rtb_y_h1 && rtb_y_bv && rtb_Compare_ot) || ((!rtb_y_jqv) && (!rtb_NOT_b) &&
      rtb_BusAssignment_h_logic_one_engine_out && (rtb_y_p && rtb_y_ed && (rtb_y_di >
      FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_di <= FmgcComputer_P.CompareToConstant7_const)))));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_m, &rtb_y_di);
    rtb_Switch1_a = rtb_y_di;
    rtb_y_fa = (rtb_y_di < FmgcComputer_P.CompareToConstant8_const);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_fk, &rtb_y_di);
    rtb_y_jqv = (rtb_Compare_ot && ((rtb_Switch1_a < FmgcComputer_P.CompareToConstant10_const) || (rtb_y_di <
      FmgcComputer_P.CompareToConstant11_const) || (rtb_BusAssignment_h_logic_one_engine_out && (rtb_y_fa || (rtb_y_di <
    ...
    FmgcComputer_MATLABFunction_g((((rtb_active_longitudinal_law == vertical_law::SPD_MACH) ||
      ...
      FmgcComputer_DWork.Delay_DSTATE_k), FmgcComputer_P.PulseNode_isRisingEdge_o, &rtb_y_h1,
      &FmgcComputer_DWork.sf_MATLABFunction_j);
    rtb_y_fa = !FmgcComputer_DWork.Memory_PreviousInput_hu;
    rtb_NOT_b = (((rtb_y_ha != 0U) && rtb_y_km) || (rtb_y_m && rtb_y_h1 && rtb_y_fa));
    FmgcComputer_MATLABFunction_a(rtb_NOT_b, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_b,
      FmgcComputer_P.ConfirmNode_timeDelay_gu, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_ay);
    rtb_y_bv = (FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active ||
                FmgcComputer_DWork.Delay1_DSTATE.retard_mode_active);
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_dr || ((rtb_y_bv ||
      FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_h1))) + (static_cast<uint32_T>(rtb_NOT_b) << 1))
    ...
    FmgcComputer_MATLABFunction_g(((((rtb_active_longitudinal_law == vertical_law::NONE) &&
      ...
      rtb_Logic_b[0]))) && FmgcComputer_DWork.Delay_DSTATE_k), FmgcComputer_P.PulseNode_isRisingEdge_fz, &rtb_y_h1,
      &FmgcComputer_DWork.sf_MATLABFunction_ge);
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_km) || (rtb_y_m && rtb_y_h1 && rtb_y_fa));
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_k,
      FmgcComputer_P.ConfirmNode_timeDelay_ez, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_ig);
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_dr || ((rtb_y_bv ||
      FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active) && (!rtb_y_h1))) + (static_cast<uint32_T>(rtb_OR_m4) << 1)) <<
      1) + FmgcComputer_DWork.Memory_PreviousInput_cm];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.ats_discrete_word,
      FmgcComputer_P.BitfromLabel_bit_hy, &rtb_y_ha);
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_km) || (rtb_y_m && FmgcComputer_DWork.Memory_PreviousInput_d &&
      rtb_Logic_a2[0] && (rtb_raComputationData <= FmgcComputer_P.CompareToConstant_const_e3) && rtb_y_fa));
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_cs,
      FmgcComputer_P.ConfirmNode_timeDelay_br, &rtb_y_h1, &FmgcComputer_DWork.sf_MATLABFunction_kh);
    FmgcComputer_DWork.Memory_PreviousInput_o = FmgcComputer_P.Logic_table_acc[(((rtb_y_dr ||
      ((FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active || FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active ||
        FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_h1))) + (static_cast<uint32_T>(rtb_OR_m4) <<
    ...
    rtb_OR_m4 = (rtb_GreaterThan3_tmp || rtb_Logic_b[0]);
    FmgcComputer_DWork.Memory_PreviousInput_kr = FmgcComputer_P.Logic_table_b3[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_AND1_c0 ||
        rtb_y_p3) && rtb_Logic_gj_idx_0_tmp) << 1) + (rtb_BusAssignment_h_logic_one_engine_out || rtb_y_eq ||
      ((FmgcComputer_P.EnumeratedConstant_Value_by == FmgcComputer_U.in.fms_inputs.fms_flight_phase) &&
       (rtb_adrComputationBus_altitude_corrected_ft_Data < FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft)))) << 1)
    ...
    FmgcComputer_DWork.Memory_PreviousInput_km = FmgcComputer_P.Logic_table_mj[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_AND1_c0 ||
        rtb_y_p3) && rtb_BusAssignment_h_logic_one_engine_out) << 1) + (rtb_Logic_gj_idx_0_tmp || rtb_y_eq ||
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_l, &rtb_y_di);
    rtb_y_p = !rtb_Compare_ot;
    rtb_y_gm = athr_fma_message::NONE;
    rtb_y_fa = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_fa);
    if (rtb_y_fa && ((FmgcComputer_DWork.Memory_PreviousInput_kr && ((rtb_DataTypeConversion2_bh > rtb_y_di +
            FmgcComputer_P.Bias_Bias_d) || (rtb_BusAssignment_hk_ap_fd_logic_tcas_vs_target <=
            FmgcComputer_P.CompareToConstant_const_eq) || rtb_GreaterThan3_tmp_0 || (!rtb_y_p))) || (rtb_Logic_ac[0] &&
          rtb_y_p && (rtb_BusAssignment_hk_ap_fd_logic_tcas_vs_target <= FmgcComputer_P.CompareToConstant1_const_ik))) &&
      ...
      rtb_y_gm = athr_fma_message::LVR_CLB;
    } else if (rtb_y_fa && FmgcComputer_DWork.Memory_PreviousInput_km &&
      ...
      rtb_y_gm = athr_fma_message::LVR_MCT;
    } else if (rtb_y_fa && rtb_Logic_gj_idx_0_tmp && (((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data
      > 24.0F) && (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 26.0F) &&
                ...
                ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 24.0F) &&
                 ...
                 ((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 26.0F))))) {
      rtb_y_gm = athr_fma_message::LVR_ASYM;
    }
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_fa);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_m);
    rtb_y_m = (rtb_y_fa || rtb_y_m);
    rtb_y_aj = athr_fma_mode::NONE;
    rtb_y_fa = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_p);
    if (rtb_y_fa && (rtb_Max_a > 44.0F)) {
      rtb_y_aj = athr_fma_mode::MAN_TOGA;
    } else {
      rtb_y_bv = (rtb_y_fa && (rtb_Max_a > 34.0F) && (rtb_Max_a < 36.0F));
      if (rtb_y_bv && rtb_y_m) {
        rtb_y_aj = athr_fma_mode::MAN_FLEX;
      } else if (rtb_y_bv && (!rtb_y_m)) {
        rtb_y_aj = athr_fma_mode::MAN_MCT;
      } else if (rtb_y_fa && (rtb_Max_a > 24.0F)) {
        rtb_y_aj = athr_fma_mode::MAN_THR;
      } else {
        rtb_y_fa = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_Compare_ot);
        rtb_y_bv = (rtb_y_fa && FmgcComputer_DWork.Memory_PreviousInput_cm);
        if (rtb_y_bv && (!FmgcComputer_DWork.Delay_DSTATE_c)) {
          rtb_y_aj = athr_fma_mode::SPEED;
        } else if (rtb_y_bv && FmgcComputer_DWork.Delay_DSTATE_c) {
          rtb_y_aj = athr_fma_mode::MACH;
        } else {
          rtb_y_bv = (rtb_y_fa && FmgcComputer_DWork.Memory_PreviousInput_bh);
          rtb_Logic_gj_idx_0_tmp = !rtb_OR_m4;
          if (rtb_y_bv && (rtb_Max_a > 34.0F) && rtb_Logic_gj_idx_0_tmp) {
            rtb_y_aj = athr_fma_mode::THR_MCT;
          } else if (rtb_y_bv && (rtb_Max_a > 24.0F) && rtb_Logic_gj_idx_0_tmp) {
            rtb_y_aj = athr_fma_mode::THR_CLB;
          } else if (rtb_y_bv && (rtb_Max_a < 25.0F) && rtb_Logic_gj_idx_0_tmp) {
            rtb_y_aj = athr_fma_mode::THR_LVR;
          } else if (rtb_y_fa && ((FmgcComputer_DWork.Memory_PreviousInput_bh && rtb_OR_m4) ||
                                  FmgcComputer_DWork.Memory_PreviousInput_o)) {
            rtb_y_aj = athr_fma_mode::THR_IDLE;
          } else {
            rtb_y_fa = (rtb_y_fa && FmgcComputer_DWork.Memory_PreviousInput_hu);
            if (rtb_y_fa && (rtb_y_ha != 0U)) {
              rtb_y_aj = athr_fma_mode::A_FLOOR;
            } else if (rtb_y_fa && (rtb_y_ha == 0U)) {
              rtb_y_aj = athr_fma_mode::TOGA_LK;
            }
          }
        }
      }
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_km, &rtb_y_g);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_i, &rtb_y_di);
    ...
    if (rtb_DataTypeConversion2_bh < static_cast<real32_T>(rtb_Switch_e[0])) {
      if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_di) {
        high_i = 1;
      } else if (rtb_DataTypeConversion2_bh < rtb_y_di) {
        high_i = 2;
      } else {
        high_i = 0;
      }
      ...
      high_i = 0;
    } else if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_di) {
      high_i = 2;
    } else {
      high_i = 1;
    }

    rtb_DataTypeConversion2_bh = v[high_i] - rtb_y_g;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
      FmgcComputer_P.A429ValueOrDefault11_defaultValue, &rtb_y_di);
    rtb_DataTypeConversion1_d = FmgcComputer_P.Gain1_Gain_a * rtb_y_di;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault10_defaultValue, &rtb_y_di);
    rtb_DataTypeConversion8 = FmgcComputer_P.fpmtoms_Gain * rtb_y_di;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_ground_speed_kn,
      FmgcComputer_P.A429ValueOrDefault8_defaultValue_i, &rtb_y_di);
    rtb_Switch1_a = rtb_y_di;
    rtb_DataTypeConversion2_i = FmgcComputer_P.kntoms_Gain * rtb_y_di;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault12_defaultValue, &rtb_y_di);
    rtb_Product_p2 = FmgcComputer_P.Gain1_Gain_h * rtb_y_di;
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault13_defaultValue, &rtb_y_di);
    rtb_DataTypeConversion5 = FmgcComputer_P.Gain1_Gain_f * rtb_y_di;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_track_angle_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault14_defaultValue, &rtb_y_di);
    ...
    FmgcComputer_LeadLagFilter(FmgcComputer_DWork.pY_f - FmgcComputer_P.g_Gain * (FmgcComputer_P.Gain1_Gain_d *
      ...
      (FmgcComputer_P.Gain1_Gain_p * rtb_y_di - rtb_DataTypeConversion5)))), FmgcComputer_P.HighPassFilter_C1,
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault9_defaultValue, &rtb_y_di);
    if (rtb_y_di > FmgcComputer_P.Saturation1_UpperSat_l) {
      rtb_Switch1_a = FmgcComputer_P.Saturation1_UpperSat_l;
    } else if (rtb_y_di < FmgcComputer_P.Saturation1_LowerSat_i) {
    ...
    FmgcComputer_LagFilter(rtb_DataTypeConversion2_bh, FmgcComputer_P.LagFilter1_C1, FmgcComputer_U.in.time.dt,
      &rtb_y_di, &FmgcComputer_DWork.sf_LagFilter_g);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
    ...
    rtb_Cos_h = rtb_y_di - rtb_Cos_h / std::cos(FmgcComputer_P.Gain1_Gain_go * rtb_DataTypeConversion2_bh);
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_dr || rtb_y_p || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach, &rtb_y_dr);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_spd_kts, &rtb_y_fa);
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_pw_logic_ils_computation_data_runway_heading_deg, &rtb_y_m);
    ...
    rtb_VectorConcatenate[13] = rtb_fmgcOppPriority_tmp;
    ...
    rtb_VectorConcatenate[16] = rtb_ap_fd_condition_tmp_2;
    rtb_VectorConcatenate[17] = rtb_ap_fd_condition_tmp_1;
    rtb_VectorConcatenate[18] = rtb_y_bn;
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_DataTypeConversion2_bh);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_g);
    rtb_VectorConcatenate_bw[0] = (rtb_y_aj == athr_fma_mode::MAN_TOGA);
    rtb_VectorConcatenate_bw[1] = ((rtb_y_aj == athr_fma_mode::MAN_MCT) || (rtb_y_aj == athr_fma_mode::THR_MCT));
    rtb_VectorConcatenate_bw[2] = (rtb_y_aj == athr_fma_mode::MAN_FLEX);
    rtb_VectorConcatenate_bw[3] = (rtb_y_aj == athr_fma_mode::THR_CLB);
    rtb_VectorConcatenate_bw[4] = ((rtb_y_aj == athr_fma_mode::MAN_THR) || (rtb_y_aj == athr_fma_mode::THR_LVR));
    rtb_VectorConcatenate_bw[5] = (rtb_y_aj == athr_fma_mode::THR_IDLE);
    rtb_VectorConcatenate_bw[6] = (rtb_y_aj == athr_fma_mode::A_FLOOR);
    rtb_VectorConcatenate_bw[7] = (rtb_y_aj == athr_fma_mode::TOGA_LK);
    rtb_VectorConcatenate_bw[8] = (rtb_y_aj == athr_fma_mode::SPEED);
    rtb_VectorConcatenate_bw[9] = (rtb_y_aj == athr_fma_mode::MACH);
    rtb_VectorConcatenate_bw[10] = (rtb_y_gm == athr_fma_message::LVR_ASYM);
    rtb_VectorConcatenate_bw[11] = (rtb_y_gm == athr_fma_message::LVR_CLB);
    rtb_VectorConcatenate_bw[12] = (rtb_y_gm == athr_fma_message::LVR_MCT);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_bw, &rtb_y_n0);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_fma_discrete_word.Data = rtb_y_n0;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_bw, &rtb_y_n0);
    rtb_VectorConcatenate_f[0] = rtb_OR_o_tmp;
    rtb_VectorConcatenate_f[1] = rtb_GreaterThan3_tmp;
    ...
    rtb_VectorConcatenate_f[6] = rtb_AND1_c0;
    rtb_VectorConcatenate_f[7] = rtb_y_p3;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_f, &rtb_y_di);
    rtb_VectorConcatenate_f[0] = rtb_y_k;
    ...
    rtb_VectorConcatenate_f[17] = rtb_y_j;
    ...
    FmgcComputer_Y.out.logic.on_ground = rtb_y_eq;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.rwy_active = rtb_y_k;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.vs_active = rtb_AND1_c0;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.fpa_active = rtb_y_p3;
    ...
    FmgcComputer_Y.out.ap_fd_logic.fd_auto_disengage = rtb_ap_fd_condition_tmp_2;
    FmgcComputer_Y.out.ap_fd_logic.ap_fd_mode_reversion = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_Y.out.ap_fd_logic.lateral_mode_reversion = rtb_AND8;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_mode_reversion_vs = rtb_Logic_d_idx_0_tmp;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_mode_reversion_op_clb = rtb_OR2_l_tmp;
    FmgcComputer_Y.out.ap_fd_logic.pitch_fd_bars_flashing = rtb_fmgcOppPriority_tmp;
    FmgcComputer_Y.out.ap_fd_logic.roll_fd_bars_flashing = rtb_y_j;
    FmgcComputer_Y.out.ap_fd_logic.loc_bc_selection = rtP_fmgc_ap_fd_logic_output_MATLABStruct.loc_bc_selection;
    FmgcComputer_Y.out.ap_fd_logic.vs_target_not_held = rtb_y_bn;
    ...
    FmgcComputer_Y.out.athr.fma_mode = rtb_y_aj;
    FmgcComputer_Y.out.athr.fma_message = rtb_y_gm;
    ...
    if ((!rtb_y_dr) && (!rtb_y_fa) && (!FmgcComputer_DWork.Memory_PreviousInput_hk)) {
    ...
    if (rtb_y_m || rtb_BusAssignment_b_logic_ils_tune_inhibit) {
    ...
    rtb_y_fa = !FmgcComputer_DWork.Memory_PreviousInput_m;
    if (rtb_Compare_mh && (!FmgcComputer_DWork.Memory_PreviousInput_c) && rtb_y_fa) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.Data = rtb_y_g;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.Data = rtb_y_n0;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.Data = rtb_y_di;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.Data = rtb_y_g;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.Data = rtb_y_n0;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.Data = rtb_y_di;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active = rtb_y_k;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active = rtb_AND1_c0;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active = rtb_y_p3;
    ...
    FmgcComputer_DWork.Delay_DSTATE.fd_auto_disengage = rtb_ap_fd_condition_tmp_2;
    FmgcComputer_DWork.Delay_DSTATE.ap_fd_mode_reversion = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_DWork.Delay_DSTATE.lateral_mode_reversion = rtb_AND8;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_mode_reversion_vs = rtb_Logic_d_idx_0_tmp;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_mode_reversion_op_clb = rtb_OR2_l_tmp;
    FmgcComputer_DWork.Delay_DSTATE.pitch_fd_bars_flashing = rtb_fmgcOppPriority_tmp;
    FmgcComputer_DWork.Delay_DSTATE.roll_fd_bars_flashing = rtb_y_j;
    FmgcComputer_DWork.Delay_DSTATE.loc_bc_selection = rtP_fmgc_ap_fd_logic_output_MATLABStruct.loc_bc_selection;
    FmgcComputer_DWork.Delay_DSTATE.vs_target_not_held = rtb_y_bn;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.fma_mode = rtb_y_aj;
    FmgcComputer_DWork.Delay1_DSTATE.fma_message = rtb_y_gm;
