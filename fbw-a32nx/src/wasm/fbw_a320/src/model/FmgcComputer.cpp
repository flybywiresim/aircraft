...
void FmgcComputer::step()
{
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    if (!FmgcComputer_DWork.Runtime_MODE) {
      ...
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_e3);
      ...
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_fi);
      ...
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ppu);
    ...
    rtb_y_lp3 = (rtb_y_p && rtb_y_bo && rtb_y_ed && rtb_y_p3);
    rtb_y_cz = ((!rtb_y_p3) || (!rtb_y_ed));
    rtb_OR_m4 = !rtb_y_lp3;
    ...
    rtb_y_km = ((FmgcComputer_U.in.discrete_inputs.eng_opp_stop && FmgcComputer_U.in.discrete_inputs.eng_own_stop &&
                 rtb_y_lp3) || rtb_y_p3);
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
    ...
    rtb_ap_fd_athr_condition = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_y_cz) || rtb_AND_cf) &&
    ...
    rtb_y_j = !FmgcComputer_P.Constant1_Value.fac_speeds_failure;
    ...
    rtb_ap_fd_condition = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || rtb_AND_cf) && (rtb_y_j ||
    ...
    rtb_NOT_m3 = (rtb_ap_fd_condition_tmp_0 && rtb_ap_fd_condition_tmp_1);
    rtb_OR2_l = (rtb_NOT_m3 && rtb_OR2_l_tmp);
    ...
    apCondition = ((!FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc) && (rtb_appCapability_idx_2 ||
      apCondition_tmp) && rtb_NOT_b);
    rtb_y_if = !rtb_ap_fd_athr_condition;
    fdOppOff = (rtb_y_if || (!rtb_ap_fd_condition) || (!apCondition));
    ...
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((fdOppOff || (rtb_y_bo &&
      ...
      rtb_OR2_l) || (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged && rtb_y_fpw && rtb_fmgcOppPriority)) ||
      (rtb_y_lp3 && (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_p || (rtb_y_py >=
      FmgcComputer_P.CompareToConstant5_const))) || (rtb_y_eb && rtb_y_lp3)) + (static_cast<uint32_T>(rtb_y_bo &&
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_y_km && rtb_ap_fd_condition && rtb_ap_fd_athr_condition && apCondition)
    ...
    rtb_y_j = ((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active ||
                FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active) && (!FmgcComputer_DWork.Memory_PreviousInput_g1)
               && rtb_ap_fd_condition_tmp && rtb_y_j);
    rtb_ap_fd_condition_tmp = (rtb_y_if || (!rtb_y_j));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(rtb_ap_fd_athr_condition &&
      rtb_y_j && ((rtb_Compare_a5 && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_Compare_du ||
    ...
    rtb_y_if = !fdOwnOff;
    rtb_y_j = !FmgcComputer_DWork.Delay_DSTATE_k;
    ...
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_y_if) && (rtb_y_eb || rtb_y_j) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_eb || rtb_y_if) && (rtb_OR2_l || rtb_y_j) &&
    ...
    rtb_y_if = (rtb_fmgcOppPriority && (rtb_fmgcOppPriority_tmp || rtb_y_bo));
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_lp3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_h,
    ...
    rtb_GreaterThan3 = (rtb_y_py < FmgcComputer_P.CompareToConstant3_const_n);
    rtb_NOT3 = !rtb_GreaterThan3;
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_b5);
    rtb_y_b5 = (rtb_GreaterThan3 && (rtb_y_py > FmgcComputer_P.CompareToConstant4_const) && rtb_y_b5);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b, &rtb_y_py);
    rtb_GreaterThan3 = (rtb_y_py < FmgcComputer_P.CompareToConstant5_const_a);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_ps);
    FmgcComputer_MATLABFunction_g((rtb_NOT3 || rtb_y_b5 || (!rtb_GreaterThan3) || (rtb_GreaterThan3 && (rtb_y_py >
      FmgcComputer_P.CompareToConstant6_const) && rtb_y_ps)), FmgcComputer_P.PulseNode_isRisingEdge_p, &rtb_y_af,
    ...
    rtb_AND1_c0 = (rtb_y_ps && rtb_appInop_idx_2 && rtb_OR2_l_tmp);
    rtb_NOT3 = (((FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant1_const_k) &&
                 (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_AND1_c0 && rtb_Compare_du &&
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_lp3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_p,
    ...
    rtb_NOT3 = ((rtb_GreaterThan3 && (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_ps &&
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg, &rtb_y_b5);
    FmgcComputer_DWork.Memory_PreviousInput_c = FmgcComputer_P.Logic_table_hz[(((((!rtb_y_af) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_trk_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp || (!rtb_y_b5)) + (
    ...
    rtb_y_b5 = (FmgcComputer_DWork.Memory_PreviousInput_c || FmgcComputer_DWork.Memory_PreviousInput_b);
    ...
    rtb_y_d = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_if);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    rtb_GreaterThan3 = (rtb_ap_fd_condition_tmp_1 && (rtb_y_d || (rtb_y_ps && (FmgcComputer_P.Constant_Value_l &&
    ...
    rtb_y_p3 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_AND_cf || ((!rtb_y_p3) &&
      (!rtb_appInop_idx_1) && FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed) || ((rtb_y_p3 && rtb_Compare_du) ||
      ...
      (rtb_GreaterThan3) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_l];
    ...
    rtb_AND_cf = (rtb_Compare_du && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_ps &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_lp3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode2_isRisingEdge_l,
    ...
    rtb_y_d = (FmgcComputer_U.in.discrete_inputs.bscu_opp_valid || FmgcComputer_U.in.discrete_inputs.bscu_own_valid);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      ...
      FmgcComputer_U.in.discrete_inputs.right_wheel_spd_abv_70_kts) && rtb_y_d) || ((!rtb_y_d) && rtb_y_lp3))),
    ...
    rtb_NOT_b = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      FmgcComputer_P.CompareToConstant1_const_h) && rtb_NOT_b);
    ...
    rtb_GreaterThan3 = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_if);
    ...
    rtb_y_p = (rtb_y_ps && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid);
    rtb_y_d = (rtb_y_p && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && FmgcComputer_P.Constant_Value_hg &&
    ...
    rtb_y_p3 = (rtb_ap_fd_condition_tmp_1 && (rtb_GreaterThan3 || rtb_y_d));
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_li, &rtb_y_d,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c
      [(((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_bo || rtb_y_af || (rtb_y_fpw
           && FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed) || rtb_y_d || rtb_Logic_gj_idx_0_tmp ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) + (static_cast<uint32_T>(rtb_y_p3) << 1)) << 1)
      + FmgcComputer_DWork.Memory_PreviousInput_dv];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
      FmgcComputer_P.BitfromLabel_bit_a, &rtb_DataTypeConversion1_e);
    rtb_Compare_a5 = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_ps &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ha,
    ...
    absVsTarget = static_cast<int32_T>((((rtb_Logic_gj_idx_0_tmp || ((rowIdx_tmp_0 ||
      ...
      (rtb_Compare_a5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_f);
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_lp3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_m,
      FmgcComputer_P.ConfirmNode_timeDelay_j5, &rtb_y_g, &FmgcComputer_DWork.sf_MATLABFunction_hvs);
    rtb_y_d = (rtb_handleIndex >= FmgcComputer_P.CompareToConstant_const_ja);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_p, &rtb_y_py);
    rtb_Compare_a5 = (rtb_y_py >= FmgcComputer_P.CompareToConstant3_const_i);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d, &rtb_y_py);
    FmgcComputer_MATLABFunction_g((rtb_Compare_a5 || (rtb_y_py >= FmgcComputer_P.CompareToConstant5_const_k)),
      FmgcComputer_P.PulseNode_isRisingEdge_c, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_fn);
    rtb_Compare_a5 = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_AND1_c0 && (!rtb_y_g) && rtb_y_d &&
      rtb_y_af));
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hj,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i = FmgcComputer_P.Logic_table_o[((((rtb_Logic_gj_idx_0_tmp ||
      ...
      (rtb_Compare_a5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_i];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel_bit_e, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_U.in.time.dt, &rtb_y_af, FmgcComputer_P.MTrigNode_isRisingEdge_d,
    ...
    rtb_Compare_a5 = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_ps && (rtb_GreaterThan3_tmp_2 &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_el = FmgcComputer_P.Logic_table_c2[(((rtb_Logic_gj_idx_0_tmp ||
      ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_af))) + (static_cast<uint32_T>
      (rtb_Compare_a5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_el];
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode3_isRisingEdge_l, &rtb_y_d,
    ...
    rtb_Compare_du = (rtb_appInop_idx_1 && rtb_y_d && (rtb_Compare_a5 && rtb_TmpSignalConversionAtSFunctionInport3_idx_0
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_j, &rtb_y_p3,
    ...
    rtb_Compare_du = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_AND1_c0 && rtb_Compare_ot) ||
                      rtb_Compare_du || rtb_Compare_a5 || (rtb_appInop_idx_1 && rtb_NOT_m3 && rtb_y_af) ||
                      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active && rtb_y_p3));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    rtb_GreaterThan3 = (rtb_y_km && rtb_y_af && rtb_ap_fd_condition_tmp_1 && (rtb_GreaterThan3_tmp_2 ||
      (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_a)));
    rtb_y_d = rtb_OR_m4;
    ...
    rtb_y_j_tmp = !FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged;
    rtb_y_g = (rtb_y_j_tmp && rtb_OR2_l_tmp);
    rtb_Compare_a5 = ((rtb_Compare_a5 && rtb_y_if) || (rtb_y_ps && (rtb_GreaterThan3 || (rtb_OR_m4 && rtb_y_af &&
      rtb_y_g) || rtb_Compare_du)));
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_j, &rtb_y_d,
    ...
    rtb_y_p3 = (rtb_GreaterThan3 || rtb_y_af);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed,
      FmgcComputer_P.PulseNode4_isRisingEdge_b, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_id);
    FmgcComputer_MATLABFunction_j(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_U.in.time.dt, &rtb_y_g, FmgcComputer_P.MTrigNode_isRisingEdge_i,
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_if) || (rtb_y_p && ((rtb_y_fpw && rtb_GreaterThan3_tmp_1 &&
      rtb_ap_fd_condition_tmp_1 && rtb_y_d) || (rtb_y_lp3 && rtb_y_p3 && (rtb_y_j_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active)) || rtb_y_af || (rtb_y_g && rtb_GreaterThan3))));
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.hdg_trk_preset_available,
      FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_d, &FmgcComputer_DWork.sf_MATLABFunction_h0);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Memory_PreviousInput_dv, FmgcComputer_P.PulseNode5_isRisingEdge_a,
      &rtb_GreaterThan3, &FmgcComputer_DWork.sf_MATLABFunction_ew);
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_d || rtb_y_g || rtb_y_af ||
      rtb_AND1_c0 || rtb_GreaterThan3 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_Compare_du) << 1)) << 1) +
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((rtb_AND1_c0 || rtb_Logic_gj_idx_0_tmp ||
      ...
      (rtb_Compare_a5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ip];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_o, &rtb_DataTypeConversion1_e);
    rtb_Compare_du = (rtb_DataTypeConversion1_e != 0U);
    rtb_Compare_a5 = rtb_y_ps;
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
    ...
    rtb_y_p3 = rtb_GreaterThan3_tmp_0;
    ...
    FmgcComputer_MATLABFunction_a(rtb_AND1_c0, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_n,
      FmgcComputer_P.ConfirmNode_timeDelay_g, &rtb_y_p3, &FmgcComputer_DWork.sf_MATLABFunction_ah);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed,
      FmgcComputer_P.PulseNode_isRisingEdge_g, &rtb_Compare_a5, &FmgcComputer_DWork.sf_MATLABFunction_ol);
    rtb_NOT_m3 = (rtb_NOT_m3 && rtb_y_af && FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed,
      FmgcComputer_P.PulseNode3_isRisingEdge_d, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_mne);
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_y_p3) && rtb_Compare_a5) ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_NOT_m3 || rtb_y_af) + (
      static_cast<uint32_T>((rtb_Compare_du && rtb_y_if) || (rtb_y_ps && (rtb_y_p || rtb_AND1_c0))) << 1)) << 1) +
    ...
    if (low_ip1 == high_i) {
      ...
      if (guard1) {
        ...
        rtb_Compare_a5 = ((rtb_DataTypeConversion1_d >= std::abs(rtb_y_fd)) && (high_i == absVsTarget));
      }
    } else {
      rtb_Compare_a5 = false;
    }
    ...
    if (rtb_DataTypeConversion2_kb < 115.0F) {
      ...
      if (((rtb_DataTypeConversion2_kb > 25.0F) && ((rtb_y_fd < 10.0F) && ((low_ip1 != high_i) && rtb_Compare_a5))) ||
          (rtb_y_fd < 1.92)) {
        rtb_Compare_a5 = (rtb_Compare_a5 || ((rtb_DataTypeConversion2_kb < 15.0F) && (rtb_y_fd < 1.1)));
      } else {
        rtb_Compare_a5 = false;
      }
    } else {
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      &rtb_Compare_du);
    rtb_Compare_a5 = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_ps &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed && rtb_Compare_a5 && rtb_Compare_du));
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_at,
      FmgcComputer_P.ConfirmNode_timeDelay_h4, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_p4);
    rtb_Compare_du = (rtb_Logic_d_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active);
    FmgcComputer_DWork.Memory_PreviousInput_cv = FmgcComputer_P.Logic_table_g4[(((((!rtb_y_af) && (rtb_Compare_du ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_Compare_a5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cv];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ea,
      FmgcComputer_P.ConfirmNode_timeDelay_es, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_pr);
    FmgcComputer_DWork.Memory_PreviousInput_lq = FmgcComputer_P.Logic_table_j[(((((!rtb_y_af) && (rtb_Compare_du ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_Compare_a5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_lq];
    ...
    rtb_NOT_m3 = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_ps &&
    ...
    rtb_y_p3 = (FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed && (!rtb_y_af) && ((std::fmin(3000.0F, std::
    ...
    rtb_y_g = rtb_y_j_0;
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_if) || (rtb_y_ps && rtb_y_p3 && ((rtb_raComputationData >=
    ...
    rtb_Logic_d_idx_0_tmp_tmp = rtb_y_p3;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_if) || (rtb_y_ps &&
    ...
    rtb_y_d = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_g((rtb_GreaterThan3 || (rtb_DataTypeConversion1_e != 0U)),
      FmgcComputer_P.PulseNode_isRisingEdge_d, &rtb_y_d, &FmgcComputer_DWork.sf_MATLABFunction_nd);
    rtb_GreaterThan3 = (rtb_y_km && rtb_y_d && rtb_ap_fd_condition_tmp_1);
    ...
    rtb_y_j_tmp = !FmgcComputer_DWork.Delay_DSTATE.any_longitudinal_mode_engaged;
    rtb_y_g = rtb_y_j_tmp;
    ...
    rtb_Compare_a5 = ((rtb_Compare_a5 && rtb_y_if) || (rtb_y_ps && (rtb_GreaterThan3 || (rtb_OR_m4 && rtb_y_p &&
      rtb_y_j_tmp) || (rtb_y_g && rtb_y_j_tmp) || rtb_Compare_du)));
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lu,
      FmgcComputer_P.ConfirmNode_timeDelay_ll, &rtb_GreaterThan3, &FmgcComputer_DWork.sf_MATLABFunction_gbq);
    FmgcComputer_DWork.Memory_PreviousInput_fg = FmgcComputer_P.Logic_table_ny[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_appCapability_idx_0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_GreaterThan3))) + (static_cast<uint32_T>
    ...
    rtb_y_p3 = (rtb_OR_m4 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                rtb_y_d && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_p || (rtb_y_af &&
      rtb_appCapability_idx_0 && (rtb_AND_iz && (std::abs(rtb_altCstrOrFcu - rtb_y_py) <=
      FmgcComputer_P.CompareToConstant2_const_d)))));
    rtb_GreaterThan3 = (rtb_y_lp3 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue, &rtb_y_py);
    rtb_y_d = ((FmgcComputer_U.in.fms_inputs.acceleration_alt_ft != FmgcComputer_P.CompareToConstant_const_lz) &&
    ...
    rtb_y_fpw = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_GreaterThan3 && (!rtb_y_d)) ||
      ...
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>((rtb_Compare_du && rtb_y_if) || (rtb_y_ps && (rtb_y_p3 ||
      (rtb_GreaterThan3 && rtb_y_d)))) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ma];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_GreaterThan3 = (rtb_y_fd > rtb_y_py);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_Compare_a5 = (rtb_y_ps && FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible && rtb_y_km);
    rtb_GreaterThan3_tmp_1 = !rtb_appCapability_idx_0;
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_if) || (rtb_Compare_a5 && (rtb_ap_fd_condition_tmp_1 &&
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_if) || (rtb_y_ps && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant1_Value_c) && (FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant2_Value_pi) && rtb_GreaterThan3 && rtb_appInop_idx_0 &&
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_if) || (rtb_Compare_a5 && (rtb_ap_fd_condition_tmp_2 &&
      ...
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_d && ((FmgcComputer_P.EnumeratedConstant_Value_m
      != FmgcComputer_U.in.fms_inputs.fms_flight_phase) && (FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
    ...
    rtb_Compare_du = (rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U));
    rtb_y_p3 = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
    ...
    rtb_y_d = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
    ...
    rtb_y_g = (rtb_y_ed || rtb_y_d || (rtb_y_p && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
                (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_bo)));
    rtb_GreaterThan3_tmp_1 = (rtb_Compare_a5 && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_if) || (rtb_GreaterThan3_tmp_1 && rtb_GreaterThan3 && rtb_y_g));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ca,
      FmgcComputer_P.ConfirmNode_timeDelay_ib, &rtb_y_p3, &FmgcComputer_DWork.sf_MATLABFunction_go);
    ...
    rtb_OR2_l_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ae && rtb_y_d);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_f, &rtb_y_d,
    ...
    rtb_y_d = (rtb_y_d || rtb_y_g);
    rtb_Compare_a5 = ((rtb_Compare_du && rtb_y_if) || (rtb_GreaterThan3_tmp_1 && (rtb_y_fd < rtb_y_py) && rtb_y_d));
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ep,
      FmgcComputer_P.ConfirmNode_timeDelay_ob, &rtb_y_p3, &FmgcComputer_DWork.sf_MATLABFunction_khd);
    FmgcComputer_DWork.Memory_PreviousInput_ev = FmgcComputer_P.Logic_table_lw[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_AND1_c0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_p3))) + (static_cast<uint32_T>
      (rtb_Compare_a5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ev];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_b, &rtb_DataTypeConversion1_e);
    rtb_Compare_a5 = rtb_y_ps;
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_b, &rtb_y_d,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_ps && (rtb_y_d && rtb_y_k && rtb_ap_fd_condition_tmp_2)))
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg,
      &rtb_Compare_a5);
    rtb_Compare_a5 = (rtb_y_ps && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_appInop_idx_1 &&
      ...
      FmgcComputer_P.CompareToConstant1_const_n2)) || (rtb_Nosewheel_c < FmgcComputer_P.CompareToConstant2_const_iq)) &&
                      rtb_Compare_a5);
    rtb_Compare_du = ((rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || rtb_Compare_a5);
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Memory_PreviousInput_nu, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_gr, FmgcComputer_P.ConfirmNode_timeDelay_m, &rtb_y_p3,
    ...
    rtb_Compare_du = ((rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_ps && rtb_y_p3 &&
    ...
    rtb_y_p3 = FmgcComputer_DWork.Memory_PreviousInput_n0;
    rtb_Compare_a5 = (rtb_y_ps && rtb_NOT1_i);
    FmgcComputer_DWork.Memory_PreviousInput_n0 = FmgcComputer_P.Logic_table_id[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_Compare_a5 &&
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_i, &rtb_y_p3,
      &FmgcComputer_DWork.sf_MATLABFunction_owv);
    rtb_Compare_a5 = ((rtb_Compare_du && rtb_y_if) || (rtb_Compare_a5 && rtb_y_p3));
    ...
    rtb_y_p3 = ((FmgcComputer_P.EnumeratedConstant1_Value_eq == FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode) &&
                rtb_Logic_gj_idx_0_tmp_tmp_tmp);
    FmgcComputer_DWork.Memory_PreviousInput_cp = FmgcComputer_P.Logic_table_dj[(((static_cast<uint32_T>(rtb_y_p3) << 1)
      + (rtb_Compare_a5 || rtb_Compare_du)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cp];
    ...
    rtb_Compare_a5 = (rtb_Logic_a2[0] && rtb_appCapability_idx_0);
    rtb_y_k = ((rtb_Compare_a5 && (rtb_y_fd < rtb_y_py + 3.0F) && (rtb_DataTypeConversion2_bh < -rtb_Phi_c_deg)) ||
               (rtb_Compare_a5 && (rtb_y_fd > rtb_y_eq - 3.0F) && (rtb_DataTypeConversion2_bh > rtb_Phi_c_deg)));
    FmgcComputer_MATLABFunction_j((rtb_y_k || rtb_OR2_l_tmp || rtb_GreaterThan3_tmp_2 || rtb_AND8),
      FmgcComputer_U.in.time.dt, &rtb_y_p3, FmgcComputer_P.MTrigNode2_isRisingEdge_p,
    ...
    rtb_ap_fd_condition_tmp_2 = rtb_y_p3;
    ...
    rtb_y_p3 = rtb_Compare_mh;
    rtb_Compare_du = (rtb_Compare_du || rtb_y_lp3 || ((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_c)
      && rtb_Compare_mh));
    rtb_Compare_a5 = ((rtb_y_af || rtb_y_n5 || (rtb_DataTypeConversion1_e != 0U)) && rtb_Compare_a5 && rtb_Compare_du);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_pq, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_y_p3,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bw = FmgcComputer_P.Logic_table_bs[((((!rtb_Compare_du) ||
      rtb_ap_fd_condition_tmp_0 || rtb_Logic_gj_idx_0_tmp_tmp || FmgcComputer_DWork.Memory_PreviousInput_ip || rtb_y_p3 ||
      rtb_GreaterThan3) + (static_cast<uint32_T>(rtb_Compare_a5) << 1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_bw];
    ...
    rtb_Compare_du = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_if);
    ...
    FmgcComputer_MATLABFunction_g(rtb_GreaterThan3, FmgcComputer_P.PulseNode3_isRisingEdge_ko, &rtb_y_bo,
    ...
    rtb_y_p3 = (FmgcComputer_U.in.fms_inputs.fms_flight_phase != FmgcComputer_P.EnumeratedConstant_Value_ad);
    rtb_Compare_a5 = (rtb_y_ed && rtb_y_p3);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_gv, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_f, &rtb_y_p3,
      &FmgcComputer_DWork.sf_MATLABFunction_d5);
    rtb_y_p3 = (rtb_y_p3 && rtb_y_km);
    ...
    rtb_GreaterThan3 = (FmgcComputer_U.in.fms_inputs.preset_spd_mach_activate && (rtb_GreaterThan3_tmp || (rtb_y_py <=
      rtb_y_fd)));
    ...
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode7_isRisingEdge, &rtb_y_d,
      &FmgcComputer_DWork.sf_MATLABFunction_itu);
    rtb_y_af = (rtb_Compare_du || (rtb_y_ps && (((FmgcComputer_P.Constant_Value_k !=
      FmgcComputer_DWork.DelayInput1_DSTATE_f) && rtb_OR_m4) || ((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant_const_dy) && rtb_y_bo && rtb_y_g) || rtb_Compare_a5 || rtb_y_p3 ||
      rtb_GreaterThan3 || (rtb_y_p && rtb_OR_m4 && rtb_y_g) || rtb_y_d)));
    ...
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode5_isRisingEdge_i, &rtb_y_p3,
      &FmgcComputer_DWork.sf_MATLABFunction_kzm);
    FmgcComputer_DWork.Memory_PreviousInput_cu = FmgcComputer_P.Logic_table_kg
      [((((FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active && (!rtb_Compare_du)) || (rtb_y_lp3 &&
           (rtb_Compare_a5 || rtb_y_p3))) + (static_cast<uint32_T>(rtb_y_af) << 1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_cu];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_5,
      FmgcComputer_P.BitfromLabel_bit_kq, &rtb_DataTypeConversion1_e);
    rtb_Compare_du = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_if);
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_d,
    ...
    FmgcComputer_MATLABFunction_g(rtb_BusAssignment_h_logic_engine_running, FmgcComputer_P.PulseNode5_isRisingEdge_b,
      &rtb_y_p3, &FmgcComputer_DWork.sf_MATLABFunction_hkc);
    FmgcComputer_MATLABFunction_g(rtb_Compare_a5, FmgcComputer_P.PulseNode2_isRisingEdge_iu, &rtb_GreaterThan3,
      &FmgcComputer_DWork.sf_MATLABFunction_ft);
    rtb_GreaterThan3 = (rtb_y_eb && rtb_GreaterThan3);
    rtb_y_p3 = ((rtb_y_d && rtb_Compare_a5) || (rtb_y_p3 && rtb_Compare_a5 && rtb_y_eb) || rtb_GreaterThan3);
    rtb_y_n5 = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_g(rtb_y_n5, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_d,
    ...
    FmgcComputer_MATLABFunction_g((rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active ||
      ...
      FmgcComputer_P.PulseNode4_isRisingEdge_n, &rtb_GreaterThan3, &FmgcComputer_DWork.sf_MATLABFunction_lr);
    rtb_Compare_a5 = ((rtb_y_lp3 && rtb_y_p3) || (rtb_y_d || rtb_y_g || rtb_GreaterThan3));
    rtb_y_p3 = (FmgcComputer_U.in.fms_inputs.v_managed_kts != FmgcComputer_P.CompareToConstant2_const_m);
    rtb_GreaterThan3 = (FmgcComputer_U.in.fms_inputs.v_2_kts != FmgcComputer_P.CompareToConstant3_const_j);
    rtb_Compare_a5 = (rtb_Compare_du || (rtb_y_ps && rtb_Compare_a5 && (rtb_y_p3 || rtb_GreaterThan3)));
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_U.in.fms_inputs.v_2_kts == FmgcComputer_P.CompareToConstant1_const_m),
      FmgcComputer_P.PulseNode6_isRisingEdge_k, &rtb_y_p3, &FmgcComputer_DWork.sf_MATLABFunction_dq);
    FmgcComputer_DWork.Memory_PreviousInput_hk = FmgcComputer_P.Logic_table_ds
      [((((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && (!rtb_Compare_du)) || (rtb_y_lp3 &&
           (rtb_Compare_mh && rtb_GreaterThan3_tmp) && rtb_y_p3)) + (static_cast<uint32_T>(rtb_Compare_a5) << 1)) << 1)
    ...
    FmgcComputer_DWork.Delay_DSTATE_c = FmgcComputer_P.Logic_table_ap[(((static_cast<uint32_T>
      ...
      FmgcComputer_P.CompareToConstant1_const_b3))) << 1) + ((rtb_GreaterThan3 && FmgcComputer_DWork.Delay_DSTATE_c) ||
    ...
    rtb_Compare_mh = (rtb_y_b5 || FmgcComputer_DWork.Memory_PreviousInput_el ||
    ...
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_DataTypeConversion_cm,
                    ...
                    &rtb_DataTypeConversion32, &rtb_DataTypeConversion26, &rtb_y_lp3, (const_cast<real_T*>
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_P.Logic_table_lwo[static_cast<uint32_T>(absVsTarget) + 8U] && (rtb_y_ha
      != 0U)), FmgcComputer_P.PulseNode3_isRisingEdge_ng, &rtb_y_d, &FmgcComputer_DWork.sf_MATLABFunction_k);
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_y_d) << 1) +
      rtb_y_j) << 1) + FmgcComputer_DWork.Memory_PreviousInput_hu];
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_d);
    ...
    rtb_y_p = (rtb_y_fd > FmgcComputer_P.CompareToConstant4_const_p);
    rtb_GreaterThan3 = (rtb_y_fd <= FmgcComputer_P.CompareToConstant6_const_h);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
    ...
    rtb_Compare_ot = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_cj &&
      rtb_y_af && rtb_y_n5 && rtb_Compare_ot) || ((!rtb_y_d) && (!rtb_y_p3) && rtb_BusAssignment_h_logic_one_engine_out &&
      (rtb_y_p && rtb_GreaterThan3 && (rtb_y_fd > FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_fd <=
    ...
    rtb_y_d = (rtb_Compare_ot && ((rtb_Switch1_a < FmgcComputer_P.CompareToConstant10_const) || (rtb_y_fd <
    ...
    rtb_y_p3 = (((rtb_y_ha != 0U) && rtb_y_if) || (rtb_y_ps && rtb_y_af && rtb_y_cj));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_j || ((rtb_y_n5 ||
    ...
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_if) || (rtb_y_ps && rtb_y_af && rtb_y_cj));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_j || ((rtb_y_n5 ||
    ...
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_if) || (rtb_y_ps && FmgcComputer_DWork.Memory_PreviousInput_d &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_o = FmgcComputer_P.Logic_table_acc[(((rtb_y_j ||
    ...
    rtb_y_ps = (FmgcComputer_DWork.Memory_PreviousInput_b3 || FmgcComputer_DWork.Memory_PreviousInput_ev ||
                rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active);
    rtb_OR_m4 = (rtb_y_ps || rtb_Logic_b[0]);
    FmgcComputer_DWork.Memory_PreviousInput_kr = FmgcComputer_P.Logic_table_b3[(((static_cast<uint32_T>
      ...
      (rtb_BusAssignment_h_logic_one_engine_out || rtb_y_lp3 || ((FmgcComputer_P.EnumeratedConstant_Value_by ==
    ...
    FmgcComputer_DWork.Memory_PreviousInput_km = FmgcComputer_P.Logic_table_mj[(((static_cast<uint32_T>
      ...
      (rtb_Logic_gj_idx_0_tmp || rtb_y_lp3 || ((FmgcComputer_P.EnumeratedConstant1_Value_e ==
      FmgcComputer_U.in.fms_inputs.fms_flight_phase) && (rtb_adrComputationBus_altitude_corrected_ft_Data <
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_j || rtb_y_p || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach, &rtb_y_j);
    ...
    rtb_VectorConcatenate[14] = rtb_y_d;
    ...
    rtb_VectorConcatenate_bw[1] = rtb_NOT_m3;
    ...
    rtb_VectorConcatenate_f[0] = (FmgcComputer_DWork.Memory_PreviousInput_ec ||
      FmgcComputer_DWork.Memory_PreviousInput_ae ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_VectorConcatenate_f[1] = rtb_y_ps;
    ...
    rtb_VectorConcatenate_f[0] = rtb_y_b5;
    ...
    rtb_VectorConcatenate_f[14] = rtb_NOT_b;
    ...
    FmgcComputer_Y.out.logic.on_ground = rtb_y_lp3;
    FmgcComputer_Y.out.logic.gnd_eng_stop_flt_5s = rtb_y_km;
    ...
    FmgcComputer_Y.out.logic.fac_lg_data_failure = rtb_y_cz;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.rwy_active = rtb_y_b5;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.align_submode_active = rtb_NOT_b;
    ...
    FmgcComputer_Y.out.ap_fd_logic.armed_modes.alt_acq_armed = rtb_NOT_m3;
    ...
    FmgcComputer_Y.out.ap_fd_logic.fmgc_opp_mode_sync = rtb_y_if;
    ...
    FmgcComputer_Y.out.athr.athr_limited = rtb_y_d;
    ...
    if ((!rtb_y_j) && (!rtb_y_cj) && (!FmgcComputer_DWork.Memory_PreviousInput_hk)) {
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_c || rtb_NOT_b || FmgcComputer_DWork.Memory_PreviousInput_m) {
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active = rtb_y_b5;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.align_submode_active = rtb_NOT_b;
    ...
    FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed = rtb_NOT_m3;
    ...
    FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync = rtb_y_if;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.athr_limited = rtb_y_d;
