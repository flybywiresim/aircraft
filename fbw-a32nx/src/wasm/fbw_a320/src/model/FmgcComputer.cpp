...
void FmgcComputer::step()
{
  ...
  boolean_T rtb_Compare_mh;
  boolean_T rtb_Compare_ot;
  boolean_T rtb_GreaterThan3_tmp;
  boolean_T rtb_GreaterThan3_tmp_0;
  boolean_T rtb_GreaterThan3_tmp_1;
  boolean_T rtb_GreaterThan3_tmp_2;
  boolean_T rtb_Logic_d_idx_0_tmp_tmp;
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    if (!FmgcComputer_DWork.Runtime_MODE) {
      ...
      FmgcComputer_MATLABFunction_j_Reset(&FmgcComputer_DWork.sf_MATLABFunction_oe);
    ...
    rtb_ir3Invalid = (FmgcComputer_U.in.bus_inputs.ra_opp_bus.radio_height_ft.SSM == static_cast<uint32_T>
                      (SignStatusMatrix::FailureWarning));
    rtb_y_cj = !rtb_ir3Invalid;
    rtb_y_n5 = !rtb_irOwnInvalid;
    rtb_Logic_gj_idx_0_tmp = (rtb_y_n5 && rtb_y_cj);
    if (rtb_Logic_gj_idx_0_tmp) {
      rtb_raComputationData = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else if (rtb_irOwnInvalid && rtb_y_cj) {
      rtb_raComputationData = FmgcComputer_U.in.bus_inputs.ra_opp_bus.radio_height_ft.Data;
    } else if (rtb_y_n5 && rtb_ir3Invalid) {
      rtb_raComputationData = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else {
    ...
    rtb_y_eg = ((FmgcComputer_U.in.discrete_inputs.eng_opp_stop && FmgcComputer_U.in.discrete_inputs.eng_own_stop &&
                 rtb_y_h) || rtb_y_p3);
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
    ...
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.glideslope_deviation_deg, &rtb_y_fpw);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.localizer_deviation_deg, &rtb_y_p3);
    rtb_y_p = (rtb_y_fpw && rtb_y_p3);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_own_bus.glideslope_deviation_deg, &rtb_y_fpw);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_own_bus.localizer_deviation_deg, &rtb_y_p3);
    rtb_y_bo = (rtb_y_fpw && rtb_y_p3);
    rtb_BusAssignment_o_logic_ils_failure = ((!rtb_y_p) && (!rtb_y_bo));
    ...
    rtb_y_ed = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.sensitivity_level,
      FmgcComputer_P.BitfromLabel2_bit_f, &rtb_DataTypeConversion1_e);
    rtb_NOT1_i = (rtb_y_p3 && (rtb_Phi_c_deg > FmgcComputer_P.CompareToConstant_const) && rtb_NOT1_i && rtb_y_ed &&
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_f_logic_ils_computation_data_runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue, &rtb_y_py);
    rtb_y_cj = !rtb_y_p;
    if (rtb_y_cj) {
      FmgcComputer_B.u_lyjj = rtb_y_py;
    }
    ...
    rtb_ap_fd_athr_condition = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_y_d) || rtb_AND_cf) &&
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_b_logic_ir_computation_data_heading_true_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue, &rtb_y_py);
    FmgcComputer_MATLABFunction_j((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rollout_submode_active && (std::abs
      (FmgcComputer_B.u_lyjj - rtb_y_py) > FmgcComputer_P.CompareToConstant_const_h)), FmgcComputer_U.in.time.dt,
      &rtb_y_eb, FmgcComputer_P.MTrigNode_isRisingEdge, FmgcComputer_P.MTrigNode_retriggerable,
    ...
    rtb_Compare_mh = !rtb_dualRaFailure;
    rtb_ap_fd_condition_tmp_0 = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed;
    rtb_ap_fd_condition_tmp_1 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active;
    rtb_y_o1 = !FmgcComputer_P.Constant1_Value.fac_speeds_failure;
    rtb_y_k = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active;
    rtb_ap_fd_condition_tmp_2 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active;
    rtb_ap_fd_condition = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || rtb_AND_cf) && (rtb_y_o1 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (rtb_Compare_mh || (rtb_ap_fd_condition_tmp_0 &&
      rtb_y_k && rtb_ap_fd_condition_tmp_2 && rtb_ap_fd_condition_tmp_1)) && (rtb_ap_fd_condition_tmp || rtb_AND_cf) &&
      (!rtb_y_eb));
    ...
    FmgcComputer_MATLABFunction_g(rtb_BusAssignment_h_logic_engine_running, FmgcComputer_P.PulseNode3_isRisingEdge,
      &rtb_y_eb, &FmgcComputer_DWork.sf_MATLABFunction_jp);
    ...
    rtb_NOT_c = (rtb_ap_fd_condition_tmp_0 && rtb_ap_fd_condition_tmp_1);
    rtb_OR2_l = (rtb_NOT_c && rtb_OR2_l_tmp);
    FmgcComputer_MATLABFunction_g(rtb_OR2_l, FmgcComputer_P.PulseNode1_isRisingEdge, &rtb_y_fpw,
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_l, &rtb_y_py);
    rtb_y_p = (rtb_y_py >= FmgcComputer_P.CompareToConstant3_const);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue, &rtb_y_py);
    rtb_NOT_m3 = !rtb_ir3Invalid;
    ...
    apCondition = ((!FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc) && (rtb_appCapability_idx_2 ||
      apCondition_tmp) && rtb_NOT_m3);
    rtb_y_km = !rtb_ap_fd_athr_condition;
    fdOppOff = (rtb_y_km || (!rtb_ap_fd_condition) || (!apCondition));
    ...
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((fdOppOff || (rtb_y_bo &&
      ...
      rtb_OR2_l) || (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged && rtb_y_fpw && rtb_fmgcOppPriority)) || (rtb_y_h &&
      (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_p || (rtb_y_py >=
      FmgcComputer_P.CompareToConstant5_const))) || (rtb_y_eb && rtb_y_h)) + (static_cast<uint32_T>(rtb_y_bo &&
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_y_eg && rtb_ap_fd_condition && rtb_ap_fd_athr_condition && apCondition)
      << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput];
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Memory_PreviousInput, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge, FmgcComputer_P.ConfirmNode_timeDelay, &rtb_y_eb,
      &FmgcComputer_DWork.sf_MATLABFunction_it);
    absVsTarget = static_cast<int32_T>((((static_cast<uint32_T>(rtb_y_bo && FmgcComputer_DWork.Memory_PreviousInput) <<
      1) + ((!rtb_y_eb) || FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc)) << 1) +
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_U.in.discrete_inputs.athr_instinctive_disc, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode1_isRisingEdge_n, FmgcComputer_P.ConfirmNode1_timeDelay_l, &rtb_y_eb,
      &FmgcComputer_DWork.sf_MATLABFunction_kz);
    FmgcComputer_DWork.Memory_PreviousInput_g1 = FmgcComputer_P.Logic_table_f[(((static_cast<uint32_T>(rtb_y_eb) << 1) +
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_n, &rtb_y_py);
    rtb_y_eb = (rtb_y_py < FmgcComputer_P.CompareToConstant_const_om);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_p, &rtb_y_py);
    FmgcComputer_MATLABFunction_g((rtb_y_eb && (rtb_y_py < FmgcComputer_P.CompareToConstant1_const)),
      FmgcComputer_P.PulseNode2_isRisingEdge_n, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_d4);
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync &&
      (!FmgcComputer_U.in.discrete_inputs.athr_opp_engaged)), FmgcComputer_P.PulseNode4_isRisingEdge, &rtb_y_fpw,
    ...
    rtb_y_o1 = ((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active ||
                 FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_g1) && rtb_ap_fd_condition_tmp && rtb_y_o1);
    rtb_ap_fd_condition_tmp = (rtb_y_km || (!rtb_y_o1));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(rtb_ap_fd_athr_condition &&
      rtb_y_o1 && ((rtb_Compare_a5 && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_Compare_du ||
                   rtb_y_bo || rtb_y_p3)) << 1) + (rtb_ap_fd_condition_tmp || rtb_y_fpw ||
      (FmgcComputer_DWork.Delay_DSTATE_k && rtb_Compare_a5 &&
       (!rtP_fmgc_ap_fd_logic_output_MATLABStruct.lateral_modes.land_active)) ||
      FmgcComputer_U.in.discrete_inputs.athr_instinctive_disc || rtb_y_af)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_p];
    rtb_fmgcOppPriority_tmp = !rtb_Logic_a2[0];
    rtb_y_km = !fdOwnOff;
    rtb_y_o1 = !FmgcComputer_DWork.Delay_DSTATE_k;
    rtb_y_eb = (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || FmgcComputer_U.in.discrete_inputs.fd_opp_engaged);
    rtb_OR2_l = (rtb_y_eb || FmgcComputer_U.in.discrete_inputs.athr_opp_engaged);
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_y_km) && (rtb_y_eb || rtb_y_o1) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_eb || rtb_y_km) && (rtb_OR2_l || rtb_y_o1) &&
    ...
    rtb_y_km = (rtb_fmgcOppPriority && (rtb_fmgcOppPriority_tmp || rtb_y_bo));
    ...
    rtb_BusAssignment_m_logic_adr_computation_data_vertical_speed_ft_min.Data =
      rtb_adrComputationBus_vertical_speed_ft_min_Data;
    rtb_y_eb = (rtb_Logic_a2[0] || FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || fdOwnOff ||
                FmgcComputer_U.in.discrete_inputs.fd_opp_engaged);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_m_logic_adr_computation_data_vertical_speed_ft_min,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_c, &rtb_y_mp);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel5_bit_b, &rtb_DataTypeConversion1_e);
    rtb_y_n5 = !rtb_y_p;
    if (rtb_y_n5 || (rtb_DataTypeConversion1_e == 0U)) {
      FmgcComputer_B.u_lyjjlj = rtb_y_mp;
    }
    ...
    rtb_y_j_0 = !rtb_NOT1_i;
    FmgcComputer_MATLABFunction_j((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active && rtb_y_j_0),
    ...
    rtb_Compare_b = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active;
    FmgcComputer_DWork.Delay_DSTATE_o = (FmgcComputer_DWork.Memory_PreviousInput_e && rtb_Compare_b);
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_m, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_j_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_c, &rtb_y_py);
    rtb_appCapability_idx_0 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active ||
    ...
    rtb_AND_iz = (rtb_appCapability_idx_0 && FmgcComputer_DWork.Delay_DSTATE.alt_cstr_applicable && rtb_appInop_idx_0 &&
                  FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid);
    if (rtb_y_fd > rtb_y_py) {
      rtb_Logic_gj_idx_0_tmp = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft < rtb_y_fd) &&
        ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft + 250.0 > rtb_y_py) || rtb_AND_iz));
    } else {
      rtb_Logic_gj_idx_0_tmp = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft > rtb_y_fd) &&
        ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft - 250.0 < rtb_y_py) || rtb_AND_iz));
    }
    ...
    rtb_AND_iz = ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed ||
                  ...
                  (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != 0.0) && rtb_Logic_gj_idx_0_tmp);
    if (rtb_AND_iz) {
      rtb_altCstrOrFcu = FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft;
    } else {
      rtb_altCstrOrFcu = rtb_y_fd;
    }
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_l2, &rtb_y_py);
    rtb_y_p3 = (rtb_y_py < FmgcComputer_P.CompareToConstant3_const_n);
    rtb_NOT3 = !rtb_y_p3;
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_no4);
    rtb_y_no4 = (rtb_y_p3 && (rtb_y_py > FmgcComputer_P.CompareToConstant4_const) && rtb_y_no4);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b, &rtb_y_py);
    rtb_y_p3 = (rtb_y_py < FmgcComputer_P.CompareToConstant5_const_a);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_j);
    FmgcComputer_MATLABFunction_g((rtb_NOT3 || rtb_y_no4 || (!rtb_y_p3) || (rtb_y_p3 && (rtb_y_py >
      FmgcComputer_P.CompareToConstant6_const) && rtb_y_j)), FmgcComputer_P.PulseNode_isRisingEdge_p, &rtb_y_af,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_k = FmgcComputer_P.Logic_table_b[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_p ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_af))) + (static_cast<uint32_T>(rtb_NOT3) <<
    ...
    if (rtb_y_py < 0.0F) {
      rtb_DataTypeConversion1_d = -rtb_y_py;
    } else {
      rtb_DataTypeConversion1_d = rtb_y_py;
    }

    rtb_NOT3 = ((rtb_y_p3 && (rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_j &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active) && ((rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_cq) && rtb_y_af && (rtb_DataTypeConversion2_kb <=
    ...
    FmgcComputer_MATLABFunction_a(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_l,
      FmgcComputer_P.ConfirmNode_timeDelay_f, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_jl);
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg, &rtb_y_no4);
    FmgcComputer_DWork.Memory_PreviousInput_c = FmgcComputer_P.Logic_table_hz[(((((!rtb_y_af) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_trk_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp || (!rtb_y_no4)) + (
    ...
    FmgcComputer_MATLABFunction_j((rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_l),
      FmgcComputer_U.in.time.dt, &rtb_y_af, FmgcComputer_P.MTrigNode_isRisingEdge_jv,
    ...
    FmgcComputer_MATLABFunction_a(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hu,
      FmgcComputer_P.ConfirmNode_timeDelay_j, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_kz1);
    FmgcComputer_DWork.Memory_PreviousInput_b = FmgcComputer_P.Logic_table_d[(((((!rtb_y_af) &&
    ...
    rtb_y_no4 = (FmgcComputer_DWork.Memory_PreviousInput_c || FmgcComputer_DWork.Memory_PreviousInput_b);
    ...
    rtb_y_jqv = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_km);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_f, FmgcComputer_P.ConfirmNode_timeDelay_d, &rtb_y_af,
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ek, &rtb_y_mp);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_own_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_f, &rtb_y_eq);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_c, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_own_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_o, &rtb_y_py);
    rtb_GreaterThan3_tmp = !rtb_BusAssignment_h_logic_engine_running;
    rtb_GreaterThan3_tmp_0 = !rtb_BusAssignment_o_logic_ils_failure;
    rtb_Compare_du = !FmgcComputer_P.Constant2_Value_p;
    rtb_GreaterThan3_tmp_1 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active;
    rtb_GreaterThan3_tmp_2 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active;
    rtb_Compare_ot = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active;
    rtb_y_p3 = (rtb_ap_fd_condition_tmp_1 && (rtb_y_jqv || (rtb_y_j && (FmgcComputer_P.Constant_Value_l &&
      rtb_GreaterThan3_tmp_0 && (rtb_GreaterThan3_tmp || (rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_g)) && rtb_Compare_mh && rtb_Compare_a5 && (!rtb_y_af) && (rtb_Compare_ot &&
      (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed))) && rtb_appInop_idx_2 && rtb_OR2_l_tmp &&
      rtb_GreaterThan3_tmp_1 && rtb_GreaterThan3_tmp_2 && rtb_Compare_du && rtb_Compare_du && (((rtb_y_mp == rtb_y_eq) &&
      (rtb_y_fd == rtb_y_py)) || (!rtb_BusAssignment_o_logic_both_ils_valid)))));
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_j, &rtb_y_af,
      &FmgcComputer_DWork.sf_MATLABFunction_eb2);
    rtb_AND8 = (rtb_appInop_idx_1 && rtb_y_af);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_l, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_c, &rtb_y_af,
      &FmgcComputer_DWork.sf_MATLABFunction_es);
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_AND_cf || ((!rtb_NOT_b) &&
      (!rtb_appInop_idx_1) && FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed) || ((rtb_NOT_b && rtb_Compare_du) ||
      rtb_AND8) || (rtb_Compare_a5 && FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed) || rtb_y_af ||
      rtb_Logic_gj_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) + (static_cast<uint32_T>
      (rtb_y_p3) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_l];
    ...
    FmgcComputer_MATLABFunction_a((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_d),
      ...
      &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_cr);
    rtb_AND_cf = (rtb_Compare_du && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_j &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active && rtb_y_af)));
    FmgcComputer_MATLABFunction_a(rtb_AND_cf, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_d,
      FmgcComputer_P.ConfirmNode_timeDelay_a, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_op);
    rtb_Compare_a5 = !rtb_y_af;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ft, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_a, &rtb_y_af,
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_h, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode2_isRisingEdge_l,
      FmgcComputer_P.ConfirmNode2_timeDelay_b, &rtb_Compare_du, &FmgcComputer_DWork.sf_MATLABFunction_fo0);
    rtb_Logic_d_idx_0_tmp_tmp = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active);
    rtb_AND8 = (rtb_Logic_d_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    rtb_y_ed = (rtb_AND8 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_y_p ||
      ...
      rtb_y_af && rtb_Compare_du) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_AND_cf) << 1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_d];
    rtb_y_jqv = (FmgcComputer_U.in.discrete_inputs.bscu_opp_valid || FmgcComputer_U.in.discrete_inputs.bscu_own_valid);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      ...
      FmgcComputer_U.in.discrete_inputs.right_wheel_spd_abv_70_kts) && rtb_y_jqv) || ((!rtb_y_jqv) && rtb_y_h))),
    ...
    rtb_NOT_m3 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      FmgcComputer_P.CompareToConstant1_const_h) && rtb_NOT_m3);
    rtb_AND_cf = (rtb_Compare_mh && FmgcComputer_DWork.Delay2_DSTATE.flare_law.condition_Flare &&
                  FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active);
    FmgcComputer_MATLABFunction_a(rtb_AND_cf, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_d,
      FmgcComputer_P.ConfirmNode1_timeDelay_dj, &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_j2);
    ...
    rtb_AND_cf = (rtb_AND_cf || FmgcComputer_DWork.Memory_PreviousInput_bc);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_l, &rtb_DataTypeConversion1_e);
    rtb_y_p3 = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_km);
    rtb_y_g = (rtb_GreaterThan3_tmp || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_lj) ||
               rtb_dualRaFailure);
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_le, FmgcComputer_P.ConfirmNode_timeDelay_n, &rtb_y_af,
      &FmgcComputer_DWork.sf_MATLABFunction_pu);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_e, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_h, &rtb_y_fpw,
      &FmgcComputer_DWork.sf_MATLABFunction_d3);
    rtb_y_p = (rtb_y_j && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid);
    rtb_y_jqv = (rtb_y_p && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && FmgcComputer_P.Constant_Value_hg &&
                 rtb_y_g && rtb_ap_fd_condition_tmp_0 && (rtb_appInop_idx_2 && rtb_GreaterThan3_tmp_1 && rtb_OR2_l_tmp &&
      rtb_GreaterThan3_tmp_2 && rtb_Compare_ot && (!rtb_y_af) && rtb_y_fpw));
    rtb_NOT_b = (rtb_ap_fd_condition_tmp_1 && (rtb_y_p3 || rtb_y_jqv));
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_k, &rtb_y_af,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_li,
      &rtb_y_jqv, &FmgcComputer_DWork.sf_MATLABFunction_bk);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c
      [(((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_bo || rtb_y_af || (rtb_y_fpw
           && FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed) || rtb_y_jqv || rtb_Logic_gj_idx_0_tmp ||
    ...
    rtb_Compare_du = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_j &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ha,
      FmgcComputer_P.ConfirmNode_timeDelay_on, &rtb_y_fpw, &FmgcComputer_DWork.sf_MATLABFunction_mm);
    rowIdx_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active);
    rtb_GreaterThan3_tmp = (rowIdx_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    rowIdx_tmp_0 = (rtb_GreaterThan3_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active);
    absVsTarget = static_cast<int32_T>((((rtb_Logic_gj_idx_0_tmp || ((rowIdx_tmp_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_fpw))) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_h, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_m,
      FmgcComputer_P.ConfirmNode_timeDelay_j5, &rtb_y_g, &FmgcComputer_DWork.sf_MATLABFunction_hvs);
    rtb_y_jqv = (rtb_handleIndex >= FmgcComputer_P.CompareToConstant_const_ja);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_p, &rtb_y_py);
    rtb_Compare_du = (rtb_y_py >= FmgcComputer_P.CompareToConstant3_const_i);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d, &rtb_y_py);
    FmgcComputer_MATLABFunction_g((rtb_Compare_du || (rtb_y_py >= FmgcComputer_P.CompareToConstant5_const_k)),
      FmgcComputer_P.PulseNode_isRisingEdge_c, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_fn);
    rtb_Compare_du = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_AND1_c0 && (!rtb_y_g) && rtb_y_jqv &&
      rtb_y_af));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hj,
      FmgcComputer_P.ConfirmNode_timeDelay_a3, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_lm);
    FmgcComputer_DWork.Memory_PreviousInput_i = FmgcComputer_P.Logic_table_o[((((rtb_Logic_gj_idx_0_tmp ||
    ...
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_P.PulseNode_isRisingEdge_f, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_pn);
    rtb_Compare_du = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_j && (rtb_GreaterThan3_tmp_2 &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active) && rtb_y_af)));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_mf,
      FmgcComputer_P.ConfirmNode_timeDelay_dw, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_mtz);
    FmgcComputer_DWork.Memory_PreviousInput_el = FmgcComputer_P.Logic_table_c2[(((rtb_Logic_gj_idx_0_tmp ||
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode3_isRisingEdge_l, &rtb_y_jqv,
      &FmgcComputer_DWork.sf_MATLABFunction_gb);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel4_bit_k, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_y_af,
    ...
    rtb_Compare_a5 = (rtb_GreaterThan3_tmp_1 && rtb_GreaterThan3_tmp_2);
    rtb_Compare_du = (rtb_appInop_idx_1 && rtb_y_jqv && (rtb_Compare_a5 &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && rtb_ap_fd_condition_tmp_1) && (!rtb_y_af));
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed ||
      ...
      &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_aj);
    rtb_y_fpw = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active;
    rtb_GreaterThan3_tmp_1 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active;
    rtb_Compare_a5 = (rtb_y_af && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && (rtb_Compare_a5 &&
      rtb_y_fpw && rtb_GreaterThan3_tmp_1 && rtb_ap_fd_condition_tmp_1));
    rtb_NOT_b = rtb_appInop_idx_1;
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_b, &rtb_y_af,
    ...
    rtb_Compare_du = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_AND1_c0 && rtb_Compare_ot) ||
                      rtb_Compare_du || rtb_Compare_a5 || (rtb_appInop_idx_1 && rtb_NOT_c && rtb_y_af) ||
                      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_i, &rtb_y_af,
      &FmgcComputer_DWork.sf_MATLABFunction_di2);
    rtb_y_p3 = (rtb_y_eg && rtb_y_af && rtb_ap_fd_condition_tmp_1 && (rtb_GreaterThan3_tmp_2 || (rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_a)));
    rtb_y_jqv = rtb_OR_m4;
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode4_isRisingEdge_e, &rtb_y_af,
      &FmgcComputer_DWork.sf_MATLABFunction_a5);
    rtb_NOT_b = !FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged;
    rtb_y_g = (rtb_NOT_b && rtb_OR2_l_tmp);
    rtb_Compare_a5 = ((rtb_Compare_a5 && rtb_y_km) || (rtb_y_j && (rtb_y_p3 || (rtb_OR_m4 && rtb_y_af && rtb_y_g) ||
      rtb_Compare_du)));
    FmgcComputer_MATLABFunction_a(rtb_Compare_a5, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_a,
      FmgcComputer_P.ConfirmNode_timeDelay_a2, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_hdw);
    FmgcComputer_DWork.Memory_PreviousInput_f2 = FmgcComputer_P.Logic_table_i[(((((!rtb_y_af) && (rtb_AND8 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_Compare_a5) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_f2];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_k, &rtb_DataTypeConversion1_e);
    rtb_ap_fd_condition_tmp_0 = ((rtb_DataTypeConversion1_e != 0U) && FmgcComputer_DWork.Memory_PreviousInput_f2);
    rtb_Logic_gj_idx_0_tmp_tmp = (FmgcComputer_DWork.Memory_PreviousInput_f2 && (rtb_DataTypeConversion1_e == 0U));
    rtb_AND8 = rtb_Compare_du;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_j, &rtb_y_jqv,
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_g);
    FmgcComputer_MATLABFunction_g(FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid,
      FmgcComputer_P.PulseNode3_isRisingEdge_e, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_hu);
    rtb_y_p3 = (rtb_NOT_b || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active);
    rtb_NOT_b = (rtb_y_h && (((!rtb_Compare_a5) && (!rtb_y_g)) || rtb_y_af) && rtb_y_p3);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed,
      FmgcComputer_P.PulseNode4_isRisingEdge_b, &rtb_y_p3, &FmgcComputer_DWork.sf_MATLABFunction_id);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_P.PulseNode7_isRisingEdge, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_bj);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_Compare_a5);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_g);
    rtb_Compare_a5 = (rtb_Compare_a5 || rtb_y_g);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_y_p && ((rtb_y_fpw && rtb_GreaterThan3_tmp_1 &&
      rtb_ap_fd_condition_tmp_1 && rtb_y_jqv) || rtb_NOT_b || rtb_y_p3 || (rtb_y_af && (!rtb_Compare_a5)))));
    FmgcComputer_MATLABFunction_g(rtb_Compare_a5, FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_jqv,
      &FmgcComputer_DWork.sf_MATLABFunction_h0);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_p, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_k, &rtb_y_g,
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      ...
      FmgcComputer_P.PulseNode6_isRisingEdge, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_jd);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_jqv || rtb_y_g || rtb_y_af ||
      rtb_AND1_c0 || rtb_y_p3 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active || rtb_Logic_gj_idx_0_tmp) + (
      static_cast<uint32_T>(rtb_Compare_du) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_i1];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    rtb_Compare_du = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_j &&
      ...
      FmgcComputer_P.CompareToConstant_const_oh) || rtb_dualRaFailure) && (rtb_GreaterThan3_tmp_2 ||
      (rtb_raComputationData >= FmgcComputer_P.CompareToConstant1_const_b))));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_co,
      FmgcComputer_P.ConfirmNode_timeDelay_d1, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_ge4);
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((rtb_AND1_c0 || rtb_Logic_gj_idx_0_tmp ||
      ((rtb_y_ed || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_af))) + (static_cast<uint32_T>
      (rtb_Compare_du) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ip];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_o, &rtb_DataTypeConversion1_e);
    rtb_Compare_du = (rtb_DataTypeConversion1_e != 0U);
    rtb_Compare_a5 = rtb_y_j;
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_o, &rtb_y_af,
      &FmgcComputer_DWork.sf_MATLABFunction_k4c);
    rtb_NOT_b = rtb_GreaterThan3_tmp_0;
    rtb_AND1_c0 = (rtb_y_af && rtb_GreaterThan3_tmp_0 && (rtb_raComputationData >=
    ...
    rtb_NOT_c = (rtb_NOT_c && rtb_y_af && FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed,
      FmgcComputer_P.PulseNode3_isRisingEdge_d, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_mne);
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_NOT_b) && rtb_Compare_a5) ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_NOT_c || rtb_y_af) + (static_cast<
      uint32_T>((rtb_Compare_du && rtb_y_km) || (rtb_y_j && (rtb_y_p || rtb_AND1_c0))) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_j, &rtb_y_py);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_o, &rtb_y_eq);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o, &rtb_y_fd);
    rtb_y_py = (rtb_y_py - static_cast<real32_T>(FmgcComputer_B.u_lyjj + 360.0)) + 360.0F;
    if (rtb_y_py == 0.0F) {
      rtb_DataTypeConversion2_kb = 0.0F;
    } else {
      rtb_DataTypeConversion2_kb = std::fmod(rtb_y_py, 360.0F);
      if (rtb_DataTypeConversion2_kb == 0.0F) {
        rtb_DataTypeConversion2_kb = 0.0F;
      } else if (rtb_y_py < 0.0F) {
    ...
    if (360.0F - rtb_DataTypeConversion2_kb == 0.0F) {
      ...
      rtb_y_py = std::fmod(360.0F - rtb_DataTypeConversion2_kb, 360.0F);
      if (rtb_y_py == 0.0F) {
        rtb_y_py = 0.0F;
    ...
    if (rtb_DataTypeConversion2_kb < rtb_y_py) {
      rtb_y_py = -rtb_DataTypeConversion2_kb;
    }
    ...
    if (low_ip1 == high_i) {
      ...
      if (rtb_DataTypeConversion1_d > 5.0) {
        if (std::abs(rtb_y_fd) <= 5.0F) {
          rtb_Compare_du = true;
        } else {
          if (rtb_y_fd < 0.0F) {
            absVsTarget = -1;
          } else {
            absVsTarget = (rtb_y_fd > 0.0F);
          }

          if (high_i != absVsTarget) {
            rtb_Compare_du = true;
          } else {
            guard1 = true;
          }
      ...
      if (guard1) {
        ...
        rtb_Compare_du = ((rtb_DataTypeConversion1_d >= std::abs(rtb_y_fd)) && (high_i == absVsTarget));
      }
    } else {
      rtb_Compare_du = false;
    }

    rtb_DataTypeConversion2_kb = std::abs(rtb_y_py);
    if (rtb_DataTypeConversion2_kb < 115.0F) {
      rtb_y_fd = std::abs(rtb_y_eq);
      if (rtb_y_eq < 0.0F) {
        high_i = -1;
      } else {
        high_i = (rtb_y_eq > 0.0F);
      }

      if (((rtb_DataTypeConversion2_kb > 25.0F) && ((rtb_y_fd < 10.0F) && ((low_ip1 != high_i) && rtb_Compare_du))) ||
          (rtb_y_fd < 1.92)) {
        rtb_Compare_du = (rtb_Compare_du || ((rtb_DataTypeConversion2_kb < 15.0F) && (rtb_y_fd < 1.1)));
      } else {
        rtb_Compare_du = false;
      }
    } else {
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_at,
      FmgcComputer_P.ConfirmNode_timeDelay_h4, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_p4);
    rtb_Compare_a5 = (rtb_Logic_d_idx_0_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active);
    FmgcComputer_DWork.Memory_PreviousInput_cv = FmgcComputer_P.Logic_table_g4[(((((!rtb_y_af) && (rtb_Compare_a5 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_b, &rtb_y_py);
    if (rtb_y_py < 0.0F) {
      rtb_DataTypeConversion1_d = -rtb_y_py;
    } else {
      rtb_DataTypeConversion1_d = rtb_y_py;
    ...
    FmgcComputer_MATLABFunction_a((rtb_DataTypeConversion1_d < FmgcComputer_P.CompareToConstant1_const_n),
      ...
      &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_is);
    rtb_Compare_du = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_j &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active && rtb_y_af));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ea,
      FmgcComputer_P.ConfirmNode_timeDelay_es, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_pr);
    FmgcComputer_DWork.Memory_PreviousInput_lq = FmgcComputer_P.Logic_table_j[(((((!rtb_y_af) && (rtb_Compare_a5 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_c5, &rtb_y_py);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pm, &rtb_y_mp);
    rtb_DataTypeConversion2_kb = rtb_y_py - rtb_y_mp;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_j, &rtb_y_eq);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jm, &rtb_y_fd);
    if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) {
      ...
      if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active && rtb_y_n5) {
        rtb_y_fd = static_cast<real32_T>(rtb_Phi_c_deg);
      } else {
        rtb_y_fd = 0.0F;
      }
    }
    ...
    rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s.Data =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_Data;
    if (rtb_DataTypeConversion2_kb < 0.0F) {
      rtb_y_n5 = (rtb_y_fd <= 0.0F);
    } else {
      rtb_y_n5 = ((rtb_DataTypeConversion2_kb > 0.0F) && (rtb_y_fd >= 0.0F));
    }

    rtb_Compare_a5 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active;
    rtb_NOT_c = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_j &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) && rtb_Compare_a5 && rtb_y_k &&
      rtb_ap_fd_condition_tmp_2 && rtb_Compare_ot && rtb_ap_fd_condition_tmp_1 && ((!rtb_y_n5) ||
      ((!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) &&
       (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active) && rtb_Compare_b)) && ((!rtb_y_ed) ||
      (rtb_DataTypeConversion2_kb <= FmgcComputer_P.CompareToConstant2_const_jy)) && rtb_y_eb &&
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_h, &rtb_y_fd);
    rtb_y_py = std::abs(rtb_y_fd);
    high_i = 7;
    absVsTarget = 0;
    low_ip1 = 2;
    while (high_i > low_ip1) {
      mid_i = ((absVsTarget + high_i) + 1) >> 1;
      if (static_cast<real_T>(rtb_y_py) >= b[mid_i - 1]) {
        absVsTarget = mid_i - 1;
        low_ip1 = mid_i + 1;
      } else {
        high_i = mid_i;
    ...
    rtb_DataTypeConversion2_kb = rtb_y_py - static_cast<real32_T>(b[absVsTarget]);
    rtb_y_eq = rtb_y_fd * 0.00508F;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_d, &rtb_y_py);
    rtb_Phi_c_deg = rtb_altCstrOrFcu - rtb_y_py;
    ...
    if (rtb_y_fd < 0.0F) {
      ...
      low_ip1 = (rtb_y_fd > 0.0F);
    }

    rtb_NOT_b = (FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed && (!rtb_y_af) && ((std::fmin(3000.0F, std::
      fmax(80.0F, rtb_y_eq * rtb_y_eq / ((((rtb_DataTypeConversion2_kb * static_cast<real32_T>(c[absVsTarget]) +
    ...
    rtb_y_g = rtb_y_j_0;
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_y_j && rtb_NOT_b && ((rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_l5) || (rtb_OR2_l_tmp && rtb_appInop_idx_2)) && (rtb_Compare_b ||
      ((rtb_DataTypeConversion1_e == 0U) && (FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode ==
      FmgcComputer_P.EnumeratedConstant3_Value_l) && (!rtb_y_j_0)))));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hux,
      FmgcComputer_P.ConfirmNode_timeDelay_lk, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_hw);
    FmgcComputer_DWork.Memory_PreviousInput_ne = FmgcComputer_P.Logic_table_nz[(((rtb_Logic_gj_idx_0_tmp || ((rowIdx_tmp
      || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
    ...
    rtb_Logic_d_idx_0_tmp_tmp = rtb_NOT_b;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_du = (rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U));
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_g, &rtb_y_py);
    FmgcComputer_MATLABFunction_a((std::abs(rtb_altCstrOrFcu - rtb_y_py) < FmgcComputer_P.CompareToConstant_const_f),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_nf, FmgcComputer_P.ConfirmNode_timeDelay_at,
      &rtb_y_g, &FmgcComputer_DWork.sf_MATLABFunction_ee);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel7_bit_k, &rtb_DataTypeConversion1_e);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_y_j &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && rtb_y_g && (rtb_Compare_b ||
      ((rtb_DataTypeConversion1_e == 0U) && (FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode ==
      FmgcComputer_P.EnumeratedConstant3_Value_p) && rtb_NOT1_i))));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lj,
      FmgcComputer_P.ConfirmNode_timeDelay_b, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_dt);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_no = FmgcComputer_P.Logic_table_ay[(((static_cast<uint32_T>(std::abs
      ...
      rtb_Compare_a5) << 1) + FmgcComputer_DWork.Memory_PreviousInput_no];
    rtb_AND1_c0 = !rtb_AND_iz;
    rtb_Compare_b = (FmgcComputer_DWork.Memory_PreviousInput_cb && rtb_AND1_c0 &&
    ...
    rtb_Logic_gj_idx_0_tmp_tmp_tmp = rtb_y_g;
    ...
    rtb_y_af = (rtb_Compare_du && rtb_y_ed);
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mr, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oi, &rtb_y_py);
    rtb_DataTypeConversion2_bh = rtb_y_fd - rtb_y_py;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_o3_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue, &rtb_y_py);
    rtb_DataTypeConversion2_kb = rtb_y_py + FmgcComputer_P.Bias_Bias_e;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_o3_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_o3_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue, &rtb_y_py);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel7_bit_o, &rtb_DataTypeConversion1_e);
    rtb_y_p = (rtb_y_j_0 || (FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode ==
                FmgcComputer_P.EnumeratedConstant3_Value_ls));
    rtb_GreaterThan3_tmp_0 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_GreaterThan3_tmp_2 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    rtb_y_n5 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && rtb_y_fpw && rtb_GreaterThan3_tmp_1);
    rtb_Compare_du = (rtb_y_af || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active &&
      (rtb_Compare_a5 || rtb_Compare_du)) || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active &&
      ((FmgcComputer_P.EnumeratedConstant_Value_p == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant2_Value) || rtb_y_n5 ||
       rtb_y_bo)) || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && (std::abs(FmgcComputer_B.u_ly
      - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_omz)) || (rtb_GreaterThan3_tmp_0 &&
      (rtb_DataTypeConversion2_bh > FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_GreaterThan3_tmp_2 &&
      (rtb_DataTypeConversion2_bh < FmgcComputer_P.CompareToConstant2_const_g)) || ((rtb_GreaterThan3_tmp_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (rtb_DataTypeConversion2_kb > rtb_y_fd) &&
      rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k) || (rtb_GreaterThan3_tmp_2 && (rtb_y_fd > rtb_y_py +
      FmgcComputer_P.Bias1_Bias) && rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k) ||
                      (((rtb_DataTypeConversion1_e == 0U) || rtb_y_j_0) &&
    ...
    rtb_y_jqv = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_g((rtb_y_p3 || (rtb_DataTypeConversion1_e != 0U)),
      FmgcComputer_P.PulseNode_isRisingEdge_d, &rtb_y_jqv, &FmgcComputer_DWork.sf_MATLABFunction_nd);
    rtb_y_p3 = (rtb_y_eg && rtb_y_jqv && rtb_ap_fd_condition_tmp_1);
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode1_isRisingEdge_ky, &rtb_y_p,
      &FmgcComputer_DWork.sf_MATLABFunction_dsw);
    rtb_NOT_b = !FmgcComputer_DWork.Delay_DSTATE.any_longitudinal_mode_engaged;
    rtb_y_g = rtb_NOT_b;
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ld,
      FmgcComputer_P.ConfirmNode_timeDelay_op, &rtb_y_g, &FmgcComputer_DWork.sf_MATLABFunction_cz);
    rtb_Compare_a5 = ((rtb_Compare_a5 && rtb_y_km) || (rtb_y_j && (rtb_y_p3 || (rtb_OR_m4 && rtb_y_p && rtb_NOT_b) ||
      (rtb_y_g && rtb_NOT_b) || rtb_Compare_du)));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fg = FmgcComputer_P.Logic_table_ny[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_appCapability_idx_0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
    ...
    rtb_GreaterThan3_tmp_0 = (FmgcComputer_DWork.Memory_PreviousInput_fg && (rtb_DataTypeConversion1_e == 0U));
    rtb_GreaterThan3_tmp_2 = rtb_Compare_du;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_jh, &rtb_DataTypeConversion1_e);
    rtb_Compare_du = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_et, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oj, &rtb_y_py);
    rtb_y_jqv = (rtb_y_fd > rtb_y_py);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_px, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_b, &rtb_y_af,
      &FmgcComputer_DWork.sf_MATLABFunction_p3z);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_c, &rtb_y_py);
    rtb_y_p = (rtb_appCapability_idx_0 && rtb_AND_iz);
    rtb_NOT_b = (rtb_OR_m4 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_jqv && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_p || (rtb_y_af &&
      rtb_appCapability_idx_0 && (rtb_AND_iz && (std::abs(rtb_altCstrOrFcu - rtb_y_py) <=
      FmgcComputer_P.CompareToConstant2_const_d)))));
    rtb_y_p3 = (rtb_y_h || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue, &rtb_y_py);
    rtb_y_jqv = ((FmgcComputer_U.in.fms_inputs.acceleration_alt_ft != FmgcComputer_P.CompareToConstant_const_lz) &&
                 (FmgcComputer_U.in.fms_inputs.acceleration_alt_ft < rtb_y_py) &&
                 ...
                 ((!rtP_fmgc_ap_fd_logic_output_MATLABStruct.any_lateral_mode_engaged) ||
                  FmgcComputer_DWork.Memory_PreviousInput_c));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jt, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_os, &rtb_y_py);
    rtb_y_fpw = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_y_p3 && (!rtb_y_jqv)) ||
      (rtb_y_fpw || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) || (rtb_y_fd < rtb_y_py) ||
      (rtb_appCapability_idx_0 && (rtb_AND1_c0 || rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_bo)) ||
      ...
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>((rtb_Compare_du && rtb_y_km) || (rtb_y_j && (rtb_NOT_b ||
      (rtb_y_p3 && rtb_y_jqv)))) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ma];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_du = (rtb_Compare_du && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_h, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_n, &rtb_y_py);
    rtb_y_p3 = (rtb_y_fd > rtb_y_py);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_j4, &rtb_y_py);
    FmgcComputer_MATLABFunction_g((rtb_y_py > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode_isRisingEdge_bg, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_dfk);
    rtb_y_g = (rtb_y_af || (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_j4,
      &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_dd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_d, &rtb_y_py);
    rtb_y_ed = (rtb_AND1_c0 || (std::abs(rtb_altCstrOrFcu - rtb_y_py) > FmgcComputer_P.CompareToConstant2_const_a));
    rtb_Compare_a5 = (rtb_y_j && FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible && rtb_y_eg);
    rtb_GreaterThan3_tmp_1 = !rtb_appCapability_idx_0;
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_Compare_a5 && (rtb_ap_fd_condition_tmp_1 &&
      rtb_ap_fd_condition_tmp_2) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
      ...
      ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed && rtb_y_g) || (rtb_y_af && (rtb_GreaterThan3_tmp_1 ||
      (rtb_appCapability_idx_0 && (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed) && rtb_y_ed))))));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_fc,
      FmgcComputer_P.ConfirmNode_timeDelay_nn, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_ir);
    ...
    rtb_Compare_du = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_nh, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_mc, &rtb_y_py);
    rtb_y_p3 = (rtb_y_fd < rtb_y_py);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_k, &rtb_y_py);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_y_j && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_p || (rtb_y_ed && rtb_appCapability_idx_0 &&
      (rtb_AND_iz && (std::abs(rtb_altCstrOrFcu - rtb_y_py) <= FmgcComputer_P.CompareToConstant2_const_e)))))));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_cj, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_b, &rtb_y_py);
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he[(((rtb_y_fpw ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active || (rtb_y_fd > rtb_y_py) || rtb_y_n5 ||
      ...
      (rtb_appCapability_idx_0 && rtb_AND1_c0) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_Compare_du) << 1))
    ...
    rtb_Compare_du = (rtb_Compare_du && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mo, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b5, &rtb_y_py);
    rtb_y_jqv = (rtb_y_fd < rtb_y_py);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_fq,
      &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_kd);
    rtb_y_ed = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.des_armed;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_m, &rtb_y_py);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_Compare_a5 && (rtb_ap_fd_condition_tmp_2 &&
      rtb_ap_fd_condition_tmp_1 && (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active) && rtb_Compare_ot &&
      rtb_OR2_l_tmp && rtb_appInop_idx_2) && rtb_appInop_idx_0 &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_jqv &&
      ...
      FmgcComputer_DWork.DelayInput1_DSTATE_n)) || (rtb_y_af && (rtb_GreaterThan3_tmp_1 || (rtb_appCapability_idx_0 &&
      rtb_y_ed && (rtb_AND1_c0 || (std::abs(rtb_altCstrOrFcu - rtb_y_py) > FmgcComputer_P.CompareToConstant2_const_l))))))));
    FmgcComputer_MATLABFunction_a(rtb_Compare_du, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_j,
      FmgcComputer_P.ConfirmNode_timeDelay_dy, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_n5);
    rtb_y_n5 = (rtb_GreaterThan3_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active);
    rtb_AND1_c0 = (rtb_y_n5 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
                   FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    FmgcComputer_DWork.Memory_PreviousInput_b3 = FmgcComputer_P.Logic_table_cv[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_AND1_c0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_af))) + (static_cast<uint32_T>
    ...
    rtb_Compare_du = (rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U));
    rtb_NOT_b = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ht, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d2, &rtb_y_py);
    rtb_y_p3 = (rtb_y_fd > rtb_y_py);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    rtb_y_g = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && rtb_y_g),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_jo, FmgcComputer_P.ConfirmNode_timeDelay_jo,
      &rtb_y_g, &FmgcComputer_DWork.sf_MATLABFunction_moh);
    rtb_y_jqv = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
                  ((FmgcComputer_P.EnumeratedConstant_Value_c == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                   ...
                   rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_bo)) || rtb_y_g);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_e, &rtb_y_py);
    FmgcComputer_MATLABFunction_g((rtb_y_py > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode1_isRisingEdge_g, &rtb_y_p, &FmgcComputer_DWork.sf_MATLABFunction_lva);
    rtb_y_g = (rtb_y_ed || rtb_y_jqv || (rtb_y_p && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
                (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_bo)));
    rtb_GreaterThan3_tmp_1 = (rtb_Compare_a5 && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_GreaterThan3_tmp_1 && rtb_y_p3 && rtb_y_g));
    ...
    rtb_OR2_l_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ae && rtb_y_jqv);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_NOT_b = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_i, &rtb_y_fd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_dp, &rtb_y_py);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel4_bit_i, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_fw,
      &rtb_y_jqv, &FmgcComputer_DWork.sf_MATLABFunction_ms);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active &&
      ...
      FmgcComputer_P.ConfirmNode_isRisingEdge_fq, FmgcComputer_P.ConfirmNode_timeDelay_lp, &rtb_y_g,
      &FmgcComputer_DWork.sf_MATLABFunction_hj);
    rtb_y_jqv = (rtb_y_jqv || rtb_y_g);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_km) || (rtb_GreaterThan3_tmp_1 && (rtb_y_fd < rtb_y_py) && rtb_y_jqv));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ev = FmgcComputer_P.Logic_table_lw[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_AND1_c0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_NOT_b))) + (static_cast<uint32_T>
    ...
    rtb_Compare_a5 = rtb_y_j;
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_b, &rtb_y_jqv,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_j && (rtb_y_jqv && rtb_y_k && rtb_ap_fd_condition_tmp_2)))
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_g, &rtb_y_py);
    FmgcComputer_LagFilter(rtb_y_py, FmgcComputer_P.LagFilter_C1, FmgcComputer_U.in.time.dt, &rtb_DataTypeConversion2_kb,
      &FmgcComputer_DWork.sf_LagFilter_k);
    if (rtb_y_py < 0.0F) {
      rtb_Nosewheel_c = -rtb_y_py;
    } else {
      rtb_Nosewheel_c = rtb_y_py;
    }
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg,
      &rtb_Compare_a5);
    rtb_Compare_a5 = (rtb_y_j && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_appInop_idx_1 &&
      ...
      FmgcComputer_P.CompareToConstant1_const_n2)) || (rtb_Nosewheel_c < FmgcComputer_P.CompareToConstant2_const_iq)) &&
                      rtb_Compare_a5);
    rtb_Compare_du = ((rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || rtb_Compare_a5);
    ...
    rtb_y_k = (rtb_y_n5 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_nu = FmgcComputer_P.Logic_table_d3[(((((!rtb_Compare_a5) && (rtb_y_k ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_k, &rtb_y_py);
    if (rtb_y_py < 0.0F) {
      rtb_DataTypeConversion1_d = -rtb_y_py;
    } else {
      rtb_DataTypeConversion1_d = rtb_y_py;
    ...
    rtb_Compare_du = ((rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U) && rtb_y_km) || (rtb_y_j && rtb_NOT_b &&
    ...
    rtb_y_k = (rtb_y_k || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active);
    FmgcComputer_DWork.Memory_PreviousInput_as = FmgcComputer_P.Logic_table_fi[(((((!rtb_Compare_a5) && (rtb_y_k ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_Compare_du) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_as];
    ...
    rtb_Compare_a5 = ((rtb_Compare_du && rtb_y_km) || (rtb_Compare_a5 && rtb_NOT_b));
    rtb_Compare_du = rtb_Logic_gj_idx_0_tmp;
    ...
    absVsTarget = static_cast<int32_T>(((((rtb_Logic_gj_idx_0_tmp || (rtb_y_k ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_h = FmgcComputer_P.Logic_table_oq[((((std::abs(FmgcComputer_B.u_lyj -
      ...
      static_cast<uint32_T>(rtb_Logic_d_idx_0_tmp_tmp) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_h];
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_ir_computation_data_flight_path_angle_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_i, &rtb_y_mp);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pc, &rtb_y_oy);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_g, &rtb_y_at);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_d, &rtb_y_py);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_b, &rtb_y_eq);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_f, &rtb_y_fd);
    rtb_appCapability_idx_0 = (rtb_fmgcOppPriority_tmp || rtb_GreaterThan3_tmp_0);
    if (rtb_fmgcOppPriority_tmp) {
      rtb_DataTypeConversion2_bh = rtb_y_at - rtb_y_oy;
      rtb_Phi_c_deg = 50.0;
    } else {
      rtb_DataTypeConversion2_bh = rtb_y_mp - rtb_DataTypeConversion2_bh;
      rtb_Phi_c_deg = 0.1;
    }

    rtb_Compare_du = (rtb_Logic_a2[0] && rtb_appCapability_idx_0);
    rtb_y_k = ((rtb_Compare_du && (rtb_y_fd < rtb_y_py + 3.0F) && (rtb_DataTypeConversion2_bh < -rtb_Phi_c_deg)) ||
               (rtb_Compare_du && (rtb_y_fd > rtb_y_eq - 3.0F) && (rtb_DataTypeConversion2_bh > rtb_Phi_c_deg)));
    FmgcComputer_MATLABFunction_j((rtb_y_k || rtb_OR2_l_tmp || rtb_GreaterThan3_tmp_2 || rtb_AND8),
    ...
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode_isRisingEdge_fo, &rtb_Compare_a5,
      &FmgcComputer_DWork.sf_MATLABFunction_h0f);
    rtb_AND1_c0 = !rtb_Logic_ac[0];
    rtb_Compare_du = (rtb_Compare_a5 && rtb_AND1_c0);
    FmgcComputer_MATLABFunction_j((rtb_GreaterThan3_tmp_2 || rtb_Compare_du), FmgcComputer_U.in.time.dt, &rtb_Compare_a5,
    ...
    FmgcComputer_MATLABFunction_j((rtb_AND8 || rtb_Compare_du), FmgcComputer_U.in.time.dt, &rtb_Compare_du,
    ...
    rtb_ap_fd_condition_tmp_2 = rtb_NOT_b;
    rtb_ap_fd_condition_tmp_1 = rtb_Compare_a5;
    rtb_y_j_0 = rtb_Compare_du;
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_af);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_n5);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_g(((rtb_y_af || rtb_y_n5 || (rtb_DataTypeConversion1_e != 0U)) && (rtb_Compare_a5 ||
      rtb_Compare_du)), FmgcComputer_P.PulseNode_isRisingEdge_py, &rtb_y_p3, &FmgcComputer_DWork.sf_MATLABFunction_esv);
    rtb_NOT_b = rtb_Compare_mh;
    ...
    FmgcComputer_MATLABFunction_a(rtb_Logic_gj_idx_0_tmp, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_nz, FmgcComputer_P.ConfirmNode_timeDelay_a5, &rtb_y_p3,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bw = FmgcComputer_P.Logic_table_bs[((((!rtb_Compare_du) ||
      rtb_ap_fd_condition_tmp_0 || rtb_Logic_gj_idx_0_tmp_tmp || FmgcComputer_DWork.Memory_PreviousInput_ip || rtb_NOT_b
    ...
    rtb_Compare_du = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_km);
    ...
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode1_isRisingEdge_kl, &rtb_y_ed,
    ...
    rtb_NOT_b = (rtb_NOT_b && rtb_y_eg);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ks_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_a, &rtb_y_py);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mh, &rtb_y_fd);
    rtb_GreaterThan3_tmp = !FmgcComputer_DWork.Memory_PreviousInput_k;
    rtb_y_p3 = (FmgcComputer_U.in.fms_inputs.preset_spd_mach_activate && (rtb_GreaterThan3_tmp || (rtb_y_py <= rtb_y_fd)));
    ...
    rtb_y_jqv = rtb_OR_m4;
    rtb_Compare_mh = !FmgcComputer_DWork.Memory_PreviousInput_i;
    rtb_y_g = (rtb_GreaterThan3_tmp && rtb_Compare_mh && (!FmgcComputer_DWork.Memory_PreviousInput_nu) &&
               (!FmgcComputer_DWork.Memory_PreviousInput_as) && (!FmgcComputer_DWork.Memory_PreviousInput_d));
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode7_isRisingEdge_h, &rtb_y_jqv,
      &FmgcComputer_DWork.sf_MATLABFunction_itu);
    rtb_y_af = (rtb_Compare_du || (rtb_y_j && (((FmgcComputer_P.Constant_Value_k !=
      FmgcComputer_DWork.DelayInput1_DSTATE_f) && rtb_OR_m4) || ((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant_const_dy) && rtb_y_bo && rtb_y_g) || rtb_Compare_a5 || rtb_NOT_b || rtb_y_p3 ||
      (rtb_y_p && rtb_OR_m4 && rtb_y_g) || rtb_y_jqv)));
    FmgcComputer_MATLABFunction_a(rtb_y_af, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ch,
    ...
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode5_isRisingEdge_i, &rtb_NOT_b,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cu = FmgcComputer_P.Logic_table_kg
      [((((FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active && (!rtb_Compare_du)) || (rtb_y_h && (rtb_Compare_a5 ||
            rtb_NOT_b))) + (static_cast<uint32_T>(rtb_y_af) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cu];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_5,
      FmgcComputer_P.BitfromLabel_bit_kq, &rtb_DataTypeConversion1_e);
    rtb_Compare_du = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_km);
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_jqv,
    ...
    rtb_y_p3 = (rtb_y_eb && rtb_y_p3);
    rtb_NOT_b = ((rtb_y_jqv && rtb_Compare_a5) || (rtb_NOT_b && rtb_Compare_a5 && rtb_y_eb) || rtb_y_p3);
    rtb_y_n5 = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_g(rtb_y_n5, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_jqv,
      &FmgcComputer_DWork.sf_MATLABFunction_mrn);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ie, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_jp, &rtb_y_g,
    ...
    rtb_Compare_a5 = ((rtb_y_h && rtb_NOT_b) || (rtb_y_jqv || rtb_y_g || rtb_y_p3));
    ...
    rtb_Compare_a5 = (rtb_Compare_du || (rtb_y_j && rtb_Compare_a5 && (rtb_NOT_b || rtb_y_p3)));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_hk = FmgcComputer_P.Logic_table_ds
      [((((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && (!rtb_Compare_du)) || (rtb_y_h &&
           (rtb_Compare_mh && rtb_GreaterThan3_tmp) && rtb_NOT_b)) + (static_cast<uint32_T>(rtb_Compare_a5) << 1)) << 1)
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_adr_computation_data_corrected_average_static_pressure,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_b, &rtb_y_py);
    rtb_y_oy = std::pow((std::pow(FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach.Data *
      FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach.Data * 0.2F + 1.0F, 3.5F) - 1.0F) * (rtb_y_py / 1013.25F) +
                        1.0F, 0.285714298F);
    if (rtb_y_cj) {
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_cz, &rtb_y_mp);
    if (!FmgcComputer_DWork.vMemoEo_not_empty) {
      FmgcComputer_DWork.vMemoEo = rtb_y_at;
      FmgcComputer_DWork.vMemoEo_not_empty = true;
    }

    if (!FmgcComputer_DWork.vMemoGa_not_empty) {
      FmgcComputer_DWork.vMemoGa = rtb_y_at;
    ...
    rtb_Logic_gj_idx_0_tmp = !rtb_BusAssignment_h_logic_one_engine_out;
    if (rtb_Logic_gj_idx_0_tmp) {
      FmgcComputer_DWork.vMemoEo = rtb_y_at;
    }
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_i) {
      ...
      rtb_Nosewheel_c = rtb_y_mp - 5.0;
      if (rtb_y_mp - 5.0 > rtb_Phi_c_deg) {
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_hk) {
      if (FmgcComputer_DWork.Memory_PreviousInput_d || FmgcComputer_DWork.Memory_PreviousInput_l ||
        ...
        rtb_Switch_e[0] = std::fmax(std::fmax(std::fmax(static_cast<real_T>(rtb_y_py), static_cast<real_T>(rtb_y_fd)),
          static_cast<real_T>(rtb_y_eq)), FmgcComputer_B.u_l);
      ...
      if (FmgcComputer_DWork.Delay_DSTATE_c) {
        rtb_y_fd = std::sqrt(rtb_y_oy - 1.0F) * 1479.1F;
      } else {
        rtb_y_fd = FmgcComputer_U.in.bus_inputs.fcu_bus.selected_spd_kts.Data;
      }

      rtb_Switch_e[0] = rtb_y_fd;
      rtb_Switch_e[1] = rtb_y_fd;
    }

    rtb_Compare_du = (FmgcComputer_DWork.Memory_PreviousInput_cb && (FmgcComputer_U.in.fms_inputs.fms_flight_phase ==
      FmgcComputer_P.EnumeratedConstant_Value_a4) && FmgcComputer_DWork.Delay_DSTATE_c &&
                      FmgcComputer_DWork.Delay_DSTATE_k);
    rtb_Phi_c_deg = std::abs(rtb_Switch_e[0] - rtb_Max_a);
    rtb_Compare_mh = (rtb_Phi_c_deg > FmgcComputer_P.CompareToConstant_const_hh);
    FmgcComputer_MATLABFunction_a(rtb_Compare_mh, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_i,
      FmgcComputer_P.ConfirmNode1_timeDelay_df, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_hi);
    FmgcComputer_MATLABFunction_a((rtb_Phi_c_deg > FmgcComputer_P.CompareToConstant1_const_c), FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode2_isRisingEdge_i, FmgcComputer_P.ConfirmNode2_timeDelay_i, &rtb_y_fpw,
      &FmgcComputer_DWork.sf_MATLABFunction_oe);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_g, &rtb_y_mp);
    rtb_Phi_c_deg = rtb_y_mp;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_mz, &rtb_DataTypeConversion1_e);
    rtb_Compare_a5 = ((!rtb_Compare_du) || rtb_y_af || rtb_y_fpw || (rtb_Max_a > rtb_y_mp + FmgcComputer_P.Bias_Bias) ||
                      (rtb_DataTypeConversion1_e != 0U));
    FmgcComputer_MATLABFunction_a((rtb_Compare_du && (!rtb_Compare_mh) && (!rtb_Compare_a5)), FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_dh, FmgcComputer_P.ConfirmNode_timeDelay_mf, &rtb_y_fpw,
      &FmgcComputer_DWork.sf_MATLABFunction_nj);
    absVsTarget = static_cast<int32_T>((((static_cast<uint32_T>(rtb_y_fpw) << 1) + rtb_Compare_a5) << 1) +
    ...
    } else if (rtb_Logic_gj_idx_0_tmp_tmp || FmgcComputer_DWork.Memory_PreviousInput_b ||
               FmgcComputer_DWork.Memory_PreviousInput_el) {
      rtb_active_lateral_law = lateral_law::TRACK;
    } else if (rtb_ap_fd_condition_tmp_0) {
    ...
    } else if (rtb_GreaterThan3_tmp_0) {
    ...
    rtb_Compare_mh = (rtb_y_no4 || FmgcComputer_DWork.Memory_PreviousInput_el ||
                      FmgcComputer_DWork.Memory_PreviousInput_cv || FmgcComputer_DWork.Memory_PreviousInput_lq ||
                      rtb_ap_fd_condition_tmp_0 || rtb_Logic_gj_idx_0_tmp_tmp ||
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4, &rtb_y_af);
    rtb_Compare_du = ((rtb_Compare_du || ((rtb_DataTypeConversion1_e != 0U) && rtb_y_af)) &&
                      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged);
    rtb_y_af = (rtb_Logic_a2[0] && (FmgcComputer_DWork.Memory_PreviousInput_l ||
      FmgcComputer_DWork.Memory_PreviousInput_d));
    ...
    rtb_y_n5 = (rtb_appInop_idx_0 && (!rtb_ap_fd_condition_tmp) && rtb_bothRaValid);
    ...
    rtb_appCapability_idx_2 = (FmgcComputer_DWork.pLand3FailOp || (rtb_appInop_idx_2 && rtb_y_af && rtb_Compare_du &&
      FmgcComputer_DWork.Delay_DSTATE_k));
    rtb_appCapability_idx_0 = !rtb_appCapability_idx_2;
    apCondition_tmp = (FmgcComputer_DWork.pLand3FailPass || (rtb_y_n5 && rtb_y_af && FmgcComputer_DWork.Delay_DSTATE_k &&
      rtb_appCapability_idx_0));
    rtb_appCapability_idx_0 = (rtb_appInop_idx_0 && rtb_y_af && (!apCondition_tmp) && rtb_appCapability_idx_0);
    rtb_appInop_idx_0 = !rtb_appInop_idx_0;
    rtb_appInop_idx_1 = !rtb_y_n5;
    rtb_appInop_idx_2 = !rtb_appInop_idx_2;
    if ((rtb_raComputationData < 100.0F) && (rtb_y_af || rtb_Compare_du)) {
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_estimated_sideslip_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_h, &rtb_y_fd);
    rtb_DataTypeConversion27 = rtb_y_fd;
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_cj);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_p, &rtb_y_eq);
    rtb_DataTypeConversion32 = rtb_y_eq;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_i, &rtb_y_oy);
    rtb_DataTypeConversion26 = rtb_y_oy;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_j, &rtb_y_py);
    rtb_DataTypeConversion39 = rtb_y_py;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fc, &rtb_y_mp);
    if (rtb_Logic_ac[0]) {
      rtb_Switch1 = rtb_BusAssignment_hk_ap_fd_logic_tcas_vs_target;
    } else if (FmgcComputer_DWork.Memory_PreviousInput_b3) {
      rtb_Switch1 = FmgcComputer_U.in.fms_inputs.vs_target_ft_min;
    } else {
      rtb_Switch1 = rtb_y_mp;
    }

    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_f, &rtb_y_at);
    if (FmgcComputer_DWork.Memory_PreviousInput_b3) {
      rtb_Switch3 = FmgcComputer_U.in.fms_inputs.vs_target_ft_min;
    } else {
      rtb_Switch3 = rtb_y_at;
    }

    rtb_y_af = (FmgcComputer_DWork.Memory_PreviousInput_as || FmgcComputer_DWork.Memory_PreviousInput_d);
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_DataTypeConversion_cm,
                    ...
                    &rtb_DataTypeConversion25, &rtb_y_cj, &rtb_DataTypeConversion23,
      ...
      (&FmgcComputer_RGND)), &rtb_Gain3, &(&rtb_Logic_a2[0])[0], &rtb_active_lateral_law, &rtb_active_longitudinal_law,
                    ...
                    &rtb_y_af, &rtb_Phi_loc_c, &rtb_Nosewheel_c, &rtb_Theta_c_deg, &rtb_Phi_c_deg, &rtb_Beta_c_deg,
                    &rtb_Product_p2, &rtb_Switch1_a, &rtb_Beta_c_deg_e, &rtb_Compare_du, &rtb_H_dot_radio_fpm,
    ...
    FmgcComputer_MATLABFunction_a(rtb_Logic_ac[0], FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_oa,
      FmgcComputer_P.ConfirmNode_timeDelay_a0, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_a);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_p, &rtb_DataTypeConversion2_bh);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_k, &rtb_y_fd);
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode3_isRisingEdge_l4, &rtb_y_g,
      &FmgcComputer_DWork.sf_MATLABFunction_g);
    absVsTarget = static_cast<int32_T>((((rtb_AND1_c0 || (rtb_y_af && ((rtb_DataTypeConversion2_bh <
      FmgcComputer_P.CompareToConstant_const_j) || (rtb_y_fd < FmgcComputer_P.CompareToConstant1_const_d)))) + (
      static_cast<uint32_T>(rtb_y_g) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_j);
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_P.Logic_table_lwo[static_cast<uint32_T>(absVsTarget) + 8U] && (rtb_y_ha
      != 0U)), FmgcComputer_P.PulseNode3_isRisingEdge_ng, &rtb_y_jqv, &FmgcComputer_DWork.sf_MATLABFunction_k);
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_y_jqv) << 1)
      + rtb_y_o1) << 1) + FmgcComputer_DWork.Memory_PreviousInput_hu];
    rtb_BusAssignment_b_logic_ra_computation_data_ft = rtb_Switch1_a;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_hw, &rtb_y_fd);
    rtb_y_cj = (rtb_y_fd >= FmgcComputer_P.CompareToConstant_const_hq);
    rtb_y_af = (rtb_y_fd <= FmgcComputer_P.CompareToConstant2_const_di);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o2, &rtb_y_fd);
    rtb_y_n5 = (rtb_y_fd >= FmgcComputer_P.CompareToConstant1_const_h4);
    rtb_Compare_ot = (rtb_y_fd <= FmgcComputer_P.CompareToConstant3_const_d);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_jqv);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_p3);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_k, &rtb_y_fd);
    rtb_NOT_b = (rtb_y_fd > FmgcComputer_P.CompareToConstant4_const_p);
    rtb_y_p = (rtb_y_fd <= FmgcComputer_P.CompareToConstant6_const_h);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_l, &rtb_y_fd);
    rtb_DataTypeConversion_cm = rtb_Product_p2;
    rtb_Compare_ot = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_cj &&
      rtb_y_af && rtb_y_n5 && rtb_Compare_ot) || ((!rtb_y_jqv) && (!rtb_y_p3) &&
      rtb_BusAssignment_h_logic_one_engine_out && (rtb_NOT_b && rtb_y_p && (rtb_y_fd >
      FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_fd <= FmgcComputer_P.CompareToConstant7_const)))));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_m, &rtb_y_fd);
    rtb_Switch1_a = rtb_y_fd;
    rtb_y_cj = (rtb_y_fd < FmgcComputer_P.CompareToConstant8_const);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_fk, &rtb_y_fd);
    rtb_y_jqv = (rtb_Compare_ot && ((rtb_Switch1_a < FmgcComputer_P.CompareToConstant10_const) || (rtb_y_fd <
      FmgcComputer_P.CompareToConstant11_const) || (rtb_BusAssignment_h_logic_one_engine_out && (rtb_y_cj || (rtb_y_fd <
    ...
    FmgcComputer_MATLABFunction_g((((rtb_active_longitudinal_law == vertical_law::SPD_MACH) ||
      ...
      FmgcComputer_DWork.Delay_DSTATE_k), FmgcComputer_P.PulseNode_isRisingEdge_o, &rtb_y_af,
      &FmgcComputer_DWork.sf_MATLABFunction_j);
    rtb_y_cj = !FmgcComputer_DWork.Memory_PreviousInput_hu;
    rtb_y_p3 = (((rtb_y_ha != 0U) && rtb_y_km) || (rtb_y_j && rtb_y_af && rtb_y_cj));
    FmgcComputer_MATLABFunction_a(rtb_y_p3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_b,
      FmgcComputer_P.ConfirmNode_timeDelay_gu, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_ay);
    rtb_y_n5 = (FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active ||
                FmgcComputer_DWork.Delay1_DSTATE.retard_mode_active);
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_o1 || ((rtb_y_n5 ||
      FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_af))) + (static_cast<uint32_T>(rtb_y_p3) << 1))
    ...
    FmgcComputer_MATLABFunction_g(((((rtb_active_longitudinal_law == vertical_law::NONE) &&
      ...
      rtb_Logic_b[0]))) && FmgcComputer_DWork.Delay_DSTATE_k), FmgcComputer_P.PulseNode_isRisingEdge_fz, &rtb_y_af,
      &FmgcComputer_DWork.sf_MATLABFunction_ge);
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_km) || (rtb_y_j && rtb_y_af && rtb_y_cj));
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_k,
      FmgcComputer_P.ConfirmNode_timeDelay_ez, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_ig);
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_o1 || ((rtb_y_n5 ||
      FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active) && (!rtb_y_af))) + (static_cast<uint32_T>(rtb_OR_m4) << 1)) <<
      1) + FmgcComputer_DWork.Memory_PreviousInput_cm];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.ats_discrete_word,
      FmgcComputer_P.BitfromLabel_bit_hy, &rtb_y_ha);
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_km) || (rtb_y_j && FmgcComputer_DWork.Memory_PreviousInput_d &&
      rtb_Logic_a2[0] && (rtb_raComputationData <= FmgcComputer_P.CompareToConstant_const_e3) && rtb_y_cj));
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_cs,
      FmgcComputer_P.ConfirmNode_timeDelay_br, &rtb_y_af, &FmgcComputer_DWork.sf_MATLABFunction_kh);
    FmgcComputer_DWork.Memory_PreviousInput_o = FmgcComputer_P.Logic_table_acc[(((rtb_y_o1 ||
      ((FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active || FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active ||
        FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_af))) + (static_cast<uint32_T>(rtb_OR_m4) <<
    ...
    rtb_y_j = (FmgcComputer_DWork.Memory_PreviousInput_b3 || FmgcComputer_DWork.Memory_PreviousInput_ev ||
               rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active);
    rtb_OR_m4 = (rtb_y_j || rtb_Logic_b[0]);
    FmgcComputer_DWork.Memory_PreviousInput_kr = FmgcComputer_P.Logic_table_b3[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        ...
        rtb_fmgcOppPriority_tmp || rtb_GreaterThan3_tmp_0) && rtb_Logic_gj_idx_0_tmp) << 1) +
    ...
    FmgcComputer_DWork.Memory_PreviousInput_km = FmgcComputer_P.Logic_table_mj[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_cb ||
        rtb_fmgcOppPriority_tmp || rtb_GreaterThan3_tmp_0) && rtb_BusAssignment_h_logic_one_engine_out) << 1) +
      (rtb_Logic_gj_idx_0_tmp || rtb_y_h || ((FmgcComputer_P.EnumeratedConstant1_Value_e ==
      FmgcComputer_U.in.fms_inputs.fms_flight_phase) && (rtb_adrComputationBus_altitude_corrected_ft_Data <
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_l, &rtb_y_fd);
    rtb_y_p = !rtb_Compare_ot;
    rtb_y_bf = athr_fma_message::NONE;
    rtb_y_cj = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_cj);
    if (rtb_y_cj && ((FmgcComputer_DWork.Memory_PreviousInput_kr && ((rtb_DataTypeConversion2_bh > rtb_y_fd +
    ...
    } else if (rtb_y_cj && FmgcComputer_DWork.Memory_PreviousInput_km &&
    ...
    } else if (rtb_y_cj && rtb_Logic_gj_idx_0_tmp && (((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_cj);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_af);
    rtb_y_af = (rtb_y_cj || rtb_y_af);
    rtb_y_mi = athr_fma_mode::NONE;
    rtb_y_cj = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_p);
    if (rtb_y_cj && (rtb_Max_a > 44.0F)) {
      rtb_y_mi = athr_fma_mode::MAN_TOGA;
    } else {
      rtb_y_n5 = (rtb_y_cj && (rtb_Max_a > 34.0F) && (rtb_Max_a < 36.0F));
      if (rtb_y_n5 && rtb_y_af) {
        rtb_y_mi = athr_fma_mode::MAN_FLEX;
      } else if (rtb_y_n5 && (!rtb_y_af)) {
        rtb_y_mi = athr_fma_mode::MAN_MCT;
      } else if (rtb_y_cj && (rtb_Max_a > 24.0F)) {
        rtb_y_mi = athr_fma_mode::MAN_THR;
      } else {
        rtb_y_cj = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_Compare_ot);
        rtb_y_n5 = (rtb_y_cj && FmgcComputer_DWork.Memory_PreviousInput_cm);
        if (rtb_y_n5 && (!FmgcComputer_DWork.Delay_DSTATE_c)) {
          rtb_y_mi = athr_fma_mode::SPEED;
        } else if (rtb_y_n5 && FmgcComputer_DWork.Delay_DSTATE_c) {
          rtb_y_mi = athr_fma_mode::MACH;
        } else {
          rtb_y_n5 = (rtb_y_cj && FmgcComputer_DWork.Memory_PreviousInput_bh);
          rtb_Logic_gj_idx_0_tmp = !rtb_OR_m4;
          if (rtb_y_n5 && (rtb_Max_a > 34.0F) && rtb_Logic_gj_idx_0_tmp) {
            rtb_y_mi = athr_fma_mode::THR_MCT;
          } else if (rtb_y_n5 && (rtb_Max_a > 24.0F) && rtb_Logic_gj_idx_0_tmp) {
            rtb_y_mi = athr_fma_mode::THR_CLB;
          } else if (rtb_y_n5 && (rtb_Max_a < 25.0F) && rtb_Logic_gj_idx_0_tmp) {
            rtb_y_mi = athr_fma_mode::THR_LVR;
          } else if (rtb_y_cj && ((FmgcComputer_DWork.Memory_PreviousInput_bh && rtb_OR_m4) ||
                                  FmgcComputer_DWork.Memory_PreviousInput_o)) {
            rtb_y_mi = athr_fma_mode::THR_IDLE;
          } else {
            rtb_y_cj = (rtb_y_cj && FmgcComputer_DWork.Memory_PreviousInput_hu);
            if (rtb_y_cj && (rtb_y_ha != 0U)) {
              rtb_y_mi = athr_fma_mode::A_FLOOR;
            } else if (rtb_y_cj && (rtb_y_ha == 0U)) {
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_km, &rtb_y_oy);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_i, &rtb_y_fd);
    ...
    if (rtb_DataTypeConversion2_bh < static_cast<real32_T>(rtb_Switch_e[0])) {
      if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_fd) {
        high_i = 1;
      } else if (rtb_DataTypeConversion2_bh < rtb_y_fd) {
        high_i = 2;
      } else {
        high_i = 0;
      }
      ...
      high_i = 0;
    } else if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_fd) {
      high_i = 2;
    } else {
      high_i = 1;
    }

    rtb_DataTypeConversion2_bh = v[high_i] - rtb_y_oy;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
      FmgcComputer_P.A429ValueOrDefault11_defaultValue, &rtb_y_fd);
    rtb_DataTypeConversion1_d = FmgcComputer_P.Gain1_Gain_a * rtb_y_fd;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault10_defaultValue, &rtb_y_fd);
    rtb_DataTypeConversion8 = FmgcComputer_P.fpmtoms_Gain * rtb_y_fd;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_ground_speed_kn,
      FmgcComputer_P.A429ValueOrDefault8_defaultValue_i, &rtb_y_fd);
    rtb_Switch1_a = rtb_y_fd;
    rtb_DataTypeConversion2_i = FmgcComputer_P.kntoms_Gain * rtb_y_fd;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault12_defaultValue, &rtb_y_fd);
    rtb_Product_p2 = FmgcComputer_P.Gain1_Gain_h * rtb_y_fd;
    rtb_DataTypeConversion3 = std::cos(rtb_Product_p2);
    rtb_DataTypeConversion4 = std::sin(rtb_Product_p2);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault13_defaultValue, &rtb_y_fd);
    rtb_DataTypeConversion5 = FmgcComputer_P.Gain1_Gain_f * rtb_y_fd;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_track_angle_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault14_defaultValue, &rtb_y_fd);
    ...
    rtb_Product_p2 = FmgcComputer_U.in.time.dt * FmgcComputer_P.WashoutFilter_C1;
    rtb_Switch1_a = 2.0 / (rtb_Product_p2 + 2.0);
    FmgcComputer_DWork.pY_f = (2.0 - rtb_Product_p2) / (rtb_Product_p2 + 2.0) * FmgcComputer_DWork.pY_f +
    ...
    FmgcComputer_LeadLagFilter(FmgcComputer_DWork.pY_f - FmgcComputer_P.g_Gain * (FmgcComputer_P.Gain1_Gain_d *
      ...
      (FmgcComputer_P.Gain1_Gain_p * rtb_y_fd - rtb_DataTypeConversion5)))), FmgcComputer_P.HighPassFilter_C1,
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault9_defaultValue, &rtb_y_fd);
    if (rtb_y_fd > FmgcComputer_P.Saturation1_UpperSat_l) {
      rtb_Switch1_a = FmgcComputer_P.Saturation1_UpperSat_l;
    } else if (rtb_y_fd < FmgcComputer_P.Saturation1_LowerSat_i) {
    ...
    rtb_DataTypeConversion1_d = (rtb_Product_p2 + rtb_Switch1_a) * FmgcComputer_P.mpstokts_Gain *
    ...
    rtb_DataTypeConversion8 = (FmgcComputer_DWork.Delay_DSTATE_i - rtb_Product_p2) / FmgcComputer_U.in.time.dt;
    ...
    rtb_Product_p2 = FmgcComputer_U.in.time.dt * FmgcComputer_P.LagFilter_C1_d;
    rtb_Switch1_a = rtb_Product_p2 / (rtb_Product_p2 + 2.0);
    FmgcComputer_DWork.pY_d = (2.0 - rtb_Product_p2) / (rtb_Product_p2 + 2.0) * FmgcComputer_DWork.pY_d +
    ...
    FmgcComputer_LagFilter(rtb_DataTypeConversion2_bh, FmgcComputer_P.LagFilter1_C1, FmgcComputer_U.in.time.dt,
      &rtb_y_fd, &FmgcComputer_DWork.sf_LagFilter_g);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
    ...
    rtb_Cos_h = rtb_y_fd - rtb_Cos_h / std::cos(FmgcComputer_P.Gain1_Gain_go * rtb_DataTypeConversion2_bh);
    ...
    rtb_Product_p2 = FmgcComputer_U.in.time.dt * FmgcComputer_P.WashoutFilter_C1_e;
    rtb_Switch1_a = 2.0 / (rtb_Product_p2 + 2.0);
    FmgcComputer_DWork.pY_p = static_cast<real32_T>((2.0 - rtb_Product_p2) / (rtb_Product_p2 + 2.0)) *
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_o1 || rtb_y_p || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach, &rtb_y_o1);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_spd_kts, &rtb_y_cj);
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_pw_logic_ils_computation_data_runway_heading_deg, &rtb_y_af);
    ...
    rtb_VectorConcatenate[13] = rtb_y_bo;
    ...
    rtb_VectorConcatenate[17] = rtb_ap_fd_condition_tmp_2;
    rtb_VectorConcatenate[18] = rtb_y_k;
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_DataTypeConversion2_bh);
    ...
    rtb_VectorConcatenate[3] = rtb_Compare_ot;
    ...
    rtb_VectorConcatenate[14] = rtb_y_jqv;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_oy);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_bw, &rtb_y_eq);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_fma_discrete_word.Data = rtb_y_eq;
    rtb_VectorConcatenate_bw[0] = FmgcComputer_DWork.Memory_PreviousInput_bw;
    rtb_VectorConcatenate_bw[1] = rtb_NOT_c;
    ...
    rtb_VectorConcatenate_f[0] = (FmgcComputer_DWork.Memory_PreviousInput_ec ||
      FmgcComputer_DWork.Memory_PreviousInput_ae ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_VectorConcatenate_f[1] = rtb_y_j;
    ...
    rtb_VectorConcatenate_f[7] = rtb_GreaterThan3_tmp_0;
    ...
    rtb_VectorConcatenate_f[15] = rtb_Compare_b;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_f, &rtb_y_fd);
    rtb_VectorConcatenate_f[0] = rtb_y_no4;
    ...
    rtb_VectorConcatenate_f[5] = rtb_ap_fd_condition_tmp_0;
    rtb_VectorConcatenate_f[6] = rtb_Logic_gj_idx_0_tmp_tmp;
    ...
    rtb_VectorConcatenate_f[14] = rtb_NOT_m3;
    ...
    rtb_VectorConcatenate_f[17] = rtb_y_j_0;
    rtb_VectorConcatenate_f[18] = FmgcComputer_P.Constant8_Value;
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_f, &rtb_y_py);
    ...
    FmgcComputer_Y.out.logic.gnd_eng_stop_flt_5s = rtb_y_eg;
    ...
    FmgcComputer_Y.out.logic.fac_lg_data_failure = rtb_y_d;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.rwy_active = rtb_y_no4;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.hdg_active = rtb_ap_fd_condition_tmp_0;
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.trk_active = rtb_Logic_gj_idx_0_tmp_tmp;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.align_submode_active = rtb_NOT_m3;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.fpa_active = rtb_GreaterThan3_tmp_0;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.fma_dash_display = rtb_Compare_b;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.flare_active = rtb_AND_cf;
    ...
    FmgcComputer_Y.out.ap_fd_logic.armed_modes.alt_acq_armed = rtb_NOT_c;
    ...
    FmgcComputer_Y.out.ap_fd_logic.fmgc_opp_mode_sync = rtb_y_km;
    FmgcComputer_Y.out.ap_fd_logic.any_ap_fd_engaged = rtb_y_eb;
    FmgcComputer_Y.out.ap_fd_logic.any_lateral_mode_engaged = rtb_Compare_mh;
    ...
    FmgcComputer_Y.out.ap_fd_logic.ap_fd_mode_reversion = rtb_ap_fd_condition_tmp_2;
    FmgcComputer_Y.out.ap_fd_logic.lateral_mode_reversion = rtb_AND8;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_mode_reversion_vs = rtb_GreaterThan3_tmp_2;
    ...
    FmgcComputer_Y.out.ap_fd_logic.roll_fd_bars_flashing = rtb_y_j_0;
    FmgcComputer_Y.out.ap_fd_logic.loc_bc_selection = rtP_fmgc_ap_fd_logic_output_MATLABStruct.loc_bc_selection;
    FmgcComputer_Y.out.ap_fd_logic.vs_target_not_held = rtb_y_k;
    ...
    FmgcComputer_Y.out.ap_fd_logic.tcas_alt_acq_cond = rtb_Logic_d_idx_0_tmp_tmp;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_passive_capacity = rtb_y_bo;
    ...
    FmgcComputer_Y.out.athr.athr_active = rtb_Compare_ot;
    FmgcComputer_Y.out.athr.athr_limited = rtb_y_jqv;
    ...
    if ((!rtb_y_o1) && (!rtb_y_cj) && (!FmgcComputer_DWork.Memory_PreviousInput_hk)) {
    ...
    if (rtb_y_af || rtb_BusAssignment_b_logic_ils_tune_inhibit) {
    ...
    rtb_y_cj = !FmgcComputer_DWork.Memory_PreviousInput_m;
    if (rtb_Compare_mh && (!FmgcComputer_DWork.Memory_PreviousInput_c) && rtb_y_cj) {
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_c || rtb_NOT_m3 || FmgcComputer_DWork.Memory_PreviousInput_m) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.Data = rtb_y_oy;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.Data = rtb_y_eq;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.Data = rtb_y_fd;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.Data = rtb_y_py;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.Data = rtb_y_oy;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.Data = rtb_y_eq;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.Data = rtb_y_fd;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.Data = rtb_y_py;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active = rtb_y_no4;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active = rtb_ap_fd_condition_tmp_0;
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active = rtb_Logic_gj_idx_0_tmp_tmp;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.align_submode_active = rtb_NOT_m3;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active = rtb_GreaterThan3_tmp_0;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.flare_active = rtb_AND_cf;
    ...
    FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed = rtb_NOT_c;
    ...
    FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync = rtb_y_km;
    FmgcComputer_DWork.Delay_DSTATE.any_ap_fd_engaged = rtb_y_eb;
    FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged = rtb_Compare_mh;
    ...
    FmgcComputer_DWork.Delay_DSTATE.ap_fd_mode_reversion = rtb_ap_fd_condition_tmp_2;
    FmgcComputer_DWork.Delay_DSTATE.lateral_mode_reversion = rtb_AND8;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_mode_reversion_vs = rtb_GreaterThan3_tmp_2;
    ...
    FmgcComputer_DWork.Delay_DSTATE.roll_fd_bars_flashing = rtb_y_j_0;
    FmgcComputer_DWork.Delay_DSTATE.loc_bc_selection = rtP_fmgc_ap_fd_logic_output_MATLABStruct.loc_bc_selection;
    FmgcComputer_DWork.Delay_DSTATE.vs_target_not_held = rtb_y_k;
    ...
    FmgcComputer_DWork.Delay_DSTATE.tcas_alt_acq_cond = rtb_Logic_d_idx_0_tmp_tmp;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_passive_capacity = rtb_y_bo;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.athr_active = rtb_Compare_ot;
    FmgcComputer_DWork.Delay1_DSTATE.athr_limited = rtb_y_jqv;
