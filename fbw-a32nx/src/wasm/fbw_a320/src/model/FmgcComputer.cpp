...
void FmgcComputer::step()
{
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    ...
    rtb_ap_fd_athr_condition = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_y_os) || in_land_or_ga_tmp) &&
    ...
    rtb_y_pp = !FmgcComputer_P.Constant1_Value.fac_speeds_failure;
    ...
    rtb_ap_fd_condition = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || in_land_or_ga_tmp) && (rtb_y_pp ||
    ...
    rtb_y_pp = ((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active ||
                 FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_g1) && rtb_ap_fd_condition_tmp && rtb_y_pp);
    rtb_ap_fd_condition_tmp = (rtb_y_if || (!rtb_y_pp));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(rtb_ap_fd_athr_condition &&
      rtb_y_pp && ((rtb_y_ed && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_Compare_bj || rtb_y_bo ||
    ...
    rtb_y_if = !fdOwnOff;
    rtb_y_pp = !FmgcComputer_DWork.Delay_DSTATE_k;
    ...
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_y_if) && (rtb_y_ft || rtb_y_pp) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_ft || rtb_y_if) && (rtb_OR2_l || rtb_y_pp) &&
    ...
    rtb_NOT3 = ((rtb_y_p3 && (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_e2 &&
    ...
    rtb_y_p3 = (rtb_ap_fd_condition_tmp_2 && (rtb_y_f5 || (rtb_y_e2 && (FmgcComputer_P.Constant_Value_l &&
      rtb_GreaterThan3_tmp && (rtb_y_hq || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_g)) &&
      rtb_ap_fd_condition_tmp_0 && rtb_y_ed && (!rtb_AND10_b) && (rtb_Compare_j3 &&
    ...
    rtb_y_ed = (rtb_Compare_bj && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_e2 &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_y_p ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active)) && rtb_y_f5) ||
    ...
    rtb_y_f5 = (rtb_y_p && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && FmgcComputer_P.Constant_Value_hg &&
      ...
      rtb_AND12 && rtb_Compare_j3 && (!rtb_AND10_b) && rtb_y_hq));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c
      [(((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
          ...
          (rtb_y_hq && FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed) || rtb_y_f5 || rtb_OR_bg ||
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_e2 &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_AND1_c0 && (!rtb_y_bs) && rtb_y_f5 &&
      rtb_AND10_b));
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_e2 && (rtb_AND12 &&
    ...
    rtb_Compare_bj = (rtb_appInop_idx_1 && rtb_y_f5 && (rtb_y_ed && rtb_TmpSignalConversionAtSFunctionInport3_idx_1 &&
    ...
    rtb_y_ed = (rtb_AND10_b && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && (rtb_y_ed && rtb_y_hq &&
    ...
    rtb_y_p3 = (rtb_y_h && rtb_AND10_b && rtb_ap_fd_condition_tmp_2 && (rtb_AND12 || (rtb_raComputationData >=
    ...
    rtb_y_bs = (rtb_NOT_b && rtb_OR2_l_tmp);
    rtb_y_ed = ((rtb_y_ed && rtb_y_if) || (rtb_y_e2 && (rtb_y_p3 || (rtb_OR_m4 && rtb_AND10_b && rtb_y_bs) ||
      rtb_Compare_bj)));
    ...
    rtb_NOT_b = (rtb_y_p5 && (((!rtb_y_ed) && (!rtb_y_bs)) || rtb_AND10_b) && rtb_y_p3);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed,
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_y_p && ((rtb_y_hq && rtb_GreaterThan3_tmp_0 &&
      rtb_ap_fd_condition_tmp_2 && rtb_y_f5) || rtb_NOT_b || rtb_y_p3 || (rtb_AND10_b && (!rtb_y_ed)))));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_f5 || rtb_y_bs || rtb_AND10_b ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_NOT_b) && rtb_y_ed) ||
      ...
      static_cast<uint32_T>((rtb_Compare_bj && rtb_y_if) || (rtb_y_e2 && (rtb_y_p || rtb_AND1_c0))) << 1)) << 1) +
    ...
    rtb_NOT_ou = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_e2 &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active) && rtb_y_adj && rtb_ap_fd_condition_tmp_3 &&
      rtb_Compare_j3 && rtb_ap_fd_condition_tmp_2 && ((!rtb_y_hn) ||
    ...
    rtb_y_bs = rtb_y_n5;
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_y_e2 && rtb_NOT_b && ((rtb_raComputationData >=
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_y_e2 &&
    ...
    rtb_y_f5 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_y_p3 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    rtb_y_hn = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && rtb_y_hq && rtb_GreaterThan3_tmp_0);
    rtb_Compare_bj = ((rtb_OR_m4 && rtb_AND10_b && rtb_GreaterThan3_tmp) || rtb_AND12 ||
      ...
      - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_omz)) || (rtb_y_f5 && (rtb_DataTypeConversion2_bh >
      FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_y_p3 && (rtb_DataTypeConversion2_bh <
      FmgcComputer_P.CompareToConstant2_const_g)) || ((rtb_y_f5 ||
    ...
    rtb_y_ed = ((rtb_y_ed && rtb_y_if) || (rtb_y_e2 && (rtb_y_p3 || (rtb_OR_m4 && rtb_y_p && rtb_GreaterThan3_tmp) ||
      rtb_Compare_bj)));
    ...
    rtb_NOT_b = (rtb_OR_m4 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_f5 && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_p || (rtb_AND10_b &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_y_p3 && (!rtb_y_f5)) ||
      ...
      static_cast<uint32_T>((rtb_Compare_bj && rtb_y_if) || (rtb_y_e2 && (rtb_NOT_b || (rtb_y_p3 && rtb_y_f5)))) << 1)) <<
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_y_e2 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
    ...
    rtb_y_bs = (rtb_y_ed || rtb_y_f5 || (rtb_y_p && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_GreaterThan3_tmp_0 && rtb_y_p3 && rtb_y_bs));
    ...
    rtb_y_f5 = (rtb_y_f5 || rtb_y_bs);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_if) || (rtb_GreaterThan3_tmp_0 && (rtb_y_lt < rtb_y_gl) && rtb_y_f5));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_e2 && (rtb_y_f5 && rtb_y_adj &&
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_if) || (rtb_y_e2 && rtb_NOT_b &&
    ...
    rtb_y_hn = (rtb_Compare_bj || (rtb_y_e2 && (((FmgcComputer_P.Constant_Value_k !=
      ...
      (rtb_y_p && rtb_OR_m4 && rtb_y_bs) || rtb_y_f5)));
    ...
    FmgcComputer_MATLABFunction_g(rtb_y_hn, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_f5,
    ...
    rtb_y_ed = ((rtb_y_p5 && rtb_NOT_b) || (rtb_y_f5 || rtb_y_bs || rtb_y_p3));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_AND10_b) <<
      1) + rtb_y_pp) << 1) + FmgcComputer_DWork.Memory_PreviousInput_hu];
    ...
    rtb_Compare_j3 = (rtb_y_lt <= FmgcComputer_P.CompareToConstant3_const_d);
    ...
    rtb_y_p = (rtb_y_lt > FmgcComputer_P.CompareToConstant4_const_p);
    rtb_NOT_b = (rtb_y_lt <= FmgcComputer_P.CompareToConstant6_const_h);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
    ...
    rtb_AND10_b = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_a22 &&
      rtb_y_hn && rtb_AND10_b && rtb_Compare_j3) || ((!rtb_y_f5) && (!rtb_y_p3) &&
      rtb_BusAssignment_h_logic_one_engine_out && (rtb_y_p && rtb_NOT_b && (rtb_y_lt >
      FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_lt <= FmgcComputer_P.CompareToConstant7_const)))));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
    ...
    rtb_Compare_j3 = (rtb_AND10_b && ((rtb_Switch1_a < FmgcComputer_P.CompareToConstant10_const) || (rtb_y_lt <
    ...
    rtb_y_f5 = (((rtb_y_ha != 0U) && rtb_y_if) || (rtb_y_e2 && rtb_y_hq && rtb_y_a22));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_pp || ((rtb_y_hn ||
    ...
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_if) || (rtb_y_e2 && rtb_y_hq && rtb_y_a22));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_pp || ((rtb_y_hn ||
    ...
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_if) || (rtb_y_e2 && FmgcComputer_DWork.Memory_PreviousInput_d &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_o = FmgcComputer_P.Logic_table_acc[(((rtb_y_pp ||
    ...
    rtb_y_p = !rtb_AND10_b;
    rtb_y_en = athr_fma_message::NONE;
    ...
    if (rtb_y_a22 && ((FmgcComputer_DWork.Memory_PreviousInput_kr && ((rtb_DataTypeConversion2_bh > rtb_y_lt +
      ...
      rtb_y_en = athr_fma_message::LVR_CLB;
      ...
      rtb_y_en = athr_fma_message::LVR_MCT;
      ...
      (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 26.0F) &&
                ...
                ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 24.0F) &&
                 ...
                 ((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 26.0F))))) {
      rtb_y_en = athr_fma_message::LVR_ASYM;
    }
    ...
    rtb_Product_p2 = FmgcComputer_P.Gain1_Gain_h * rtb_y_lt;
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_pp || rtb_y_p || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_pw_logic_ils_computation_data_runway_heading_deg, &rtb_y_pp);
    ...
    rtb_VectorConcatenate_bw[10] = (rtb_y_en == athr_fma_message::LVR_ASYM);
    rtb_VectorConcatenate_bw[11] = (rtb_y_en == athr_fma_message::LVR_CLB);
    rtb_VectorConcatenate_bw[12] = (rtb_y_en == athr_fma_message::LVR_MCT);
    ...
    FmgcComputer_Y.out.athr.fma_message = rtb_y_en;
    ...
    if (rtb_y_pp || rtb_BusAssignment_b_logic_ils_tune_inhibit) {
    ...
    FmgcComputer_DWork.Delay1_DSTATE.fma_message = rtb_y_en;
