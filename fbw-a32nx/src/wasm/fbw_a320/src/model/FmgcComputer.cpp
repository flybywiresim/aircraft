...
void FmgcComputer::step()
{
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    ...
    rtb_ap_fd_athr_condition = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_y_os) || rtb_AND_cf) &&
    ...
    rtb_ap_fd_condition = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || rtb_AND_cf) && (rtb_y_aj ||
    ...
    rtb_y_g1 = !rtb_ap_fd_athr_condition;
    fdOppOff = (rtb_y_g1 || (!rtb_ap_fd_condition) || (!apCondition));
    ...
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((fdOppOff || (rtb_y_bo &&
      ...
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_y_kb && rtb_ap_fd_condition && rtb_ap_fd_athr_condition && apCondition)
    ...
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(rtb_ap_fd_athr_condition &&
      rtb_y_aj && ((rtb_Compare_a5 && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_Compare_du ||
    ...
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_y_g1) && (rtb_y_eb || rtb_y_aj) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_eb || rtb_y_g1) && (rtb_OR2_l || rtb_y_aj) &&
    ...
    rtb_y_g1 = (rtb_fmgcOppPriority && (rtb_fmgcOppPriority_tmp || rtb_y_bo));
    ...
    rtb_NOT3 = (((FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant1_const_k) &&
                 (rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_AND1_c0 && rtb_Compare_du &&
    ...
    rtb_NOT3 = ((rtb_y_p3 && (rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_j &&
    ...
    rtb_y_p3 = (rtb_ap_fd_condition_tmp_1 && (rtb_y_f || (rtb_y_j && (FmgcComputer_P.Constant_Value_l &&
    ...
    rtb_AND_cf = (rtb_Compare_du && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_j &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
    ...
    rtb_y_p3 = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1);
    ...
    rtb_NOT_b = (rtb_ap_fd_condition_tmp_1 && (rtb_y_p3 || rtb_y_f));
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_li, &rtb_y_f,
    ...
    rtb_Compare_du = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_j &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    rtb_y_f = (rtb_handleIndex >= FmgcComputer_P.CompareToConstant_const_ja);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
    ...
    rtb_Compare_du = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_AND1_c0 && (!rtb_y_g) && rtb_y_f &&
      rtb_y_af));
    ...
    rtb_Compare_du = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_j && (rtb_GreaterThan3_tmp_2 &&
    ...
    rtb_Compare_du = (rtb_appInop_idx_1 && rtb_y_f && (rtb_Compare_a5 && rtb_TmpSignalConversionAtSFunctionInport3_idx_0
      && rtb_ap_fd_condition_tmp_1) && (!rtb_y_af));
    ...
    rtb_y_p3 = (rtb_y_kb && rtb_y_af && rtb_ap_fd_condition_tmp_1 && (rtb_GreaterThan3_tmp_2 || (rtb_raComputationData >=
    ...
    rtb_Compare_a5 = ((rtb_Compare_a5 && rtb_y_g1) || (rtb_y_j && (rtb_y_p3 || (rtb_OR_m4 && rtb_y_af && rtb_y_g) ||
      rtb_Compare_du)));
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_j, &rtb_y_f,
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_g1) || (rtb_y_p && ((rtb_y_fpw && rtb_GreaterThan3_tmp_1 &&
      rtb_ap_fd_condition_tmp_1 && rtb_y_f) || rtb_NOT_b || rtb_y_p3 || (rtb_y_af && (!rtb_Compare_a5)))));
    FmgcComputer_MATLABFunction_g(rtb_Compare_a5, FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_f,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_f || rtb_y_g || rtb_y_af ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_NOT_b) && rtb_Compare_a5) ||
      ...
      uint32_T>((rtb_Compare_du && rtb_y_g1) || (rtb_y_j && (rtb_y_p || rtb_AND1_c0))) << 1)) << 1) +
    ...
    rtb_NOT_c = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_j &&
    ...
    rtb_y_g = rtb_y_j_0;
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_g1) || (rtb_y_j && rtb_NOT_b && ((rtb_raComputationData >=
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_g1) || (rtb_y_j &&
    ...
    rtb_y_p3 = (rtb_y_kb && rtb_y_f && rtb_ap_fd_condition_tmp_1);
    ...
    rtb_Compare_a5 = ((rtb_Compare_a5 && rtb_y_g1) || (rtb_y_j && (rtb_y_p3 || (rtb_OR_m4 && rtb_y_p && rtb_NOT_b) ||
    ...
    rtb_NOT_b = (rtb_OR_m4 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_f && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_p || (rtb_y_af &&
    ...
    rtb_y_fpw = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_y_p3 && (!rtb_y_f)) || (rtb_y_fpw
      || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      ...
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>((rtb_Compare_du && rtb_y_g1) || (rtb_y_j && (rtb_NOT_b ||
      (rtb_y_p3 && rtb_y_f)))) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ma];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_a5 = (rtb_y_j && FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible && rtb_y_kb);
    rtb_GreaterThan3_tmp_1 = !rtb_appCapability_idx_0;
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_g1) || (rtb_Compare_a5 && (rtb_ap_fd_condition_tmp_1 &&
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_g1) || (rtb_y_j && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
    ...
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_g1) || (rtb_Compare_a5 && (rtb_ap_fd_condition_tmp_2 &&
      ...
      (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE_n)) || (rtb_y_af &&
      (rtb_GreaterThan3_tmp_1 || (rtb_appCapability_idx_0 && rtb_y_ed && (rtb_AND1_c0 || (std::abs(rtb_altCstrOrFcu -
      rtb_y_py) > FmgcComputer_P.CompareToConstant2_const_l))))))));
    ...
    rtb_y_g = (rtb_y_ed || rtb_y_f || (rtb_y_p && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
                (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_bo)));
    rtb_GreaterThan3_tmp_1 = (rtb_Compare_a5 && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_g1) || (rtb_GreaterThan3_tmp_1 && rtb_y_p3 && rtb_y_g));
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_fw, &rtb_y_f,
    ...
    rtb_y_f = (rtb_y_f || rtb_y_g);
    rtb_Compare_du = ((rtb_Compare_du && rtb_y_g1) || (rtb_GreaterThan3_tmp_1 && (rtb_y_fd < rtb_y_py) && rtb_y_f));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_j && (rtb_y_f && rtb_y_k && rtb_ap_fd_condition_tmp_2)))
    ...
    rtb_Compare_a5 = (rtb_y_j && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_appInop_idx_1 &&
      ...
      FmgcComputer_P.CompareToConstant1_const_n2)) || (rtb_Nosewheel_c < FmgcComputer_P.CompareToConstant2_const_iq)) &&
                      rtb_Compare_a5);
    rtb_Compare_du = ((rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || rtb_Compare_a5);
    ...
    rtb_Compare_du = ((rtb_Compare_du && (rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_y_j && rtb_NOT_b &&
    ...
    FmgcComputer_DWork.Memory_PreviousInput_n0 = FmgcComputer_P.Logic_table_id[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1) || (rtb_Compare_a5 &&
    ...
    rtb_Compare_a5 = ((rtb_Compare_du && rtb_y_g1) || (rtb_Compare_a5 && rtb_NOT_b));
    ...
    rtb_Compare_du = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1);
    ...
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode7_isRisingEdge_h, &rtb_y_f,
    ...
    rtb_y_af = (rtb_Compare_du || (rtb_y_j && (((FmgcComputer_P.Constant_Value_k !=
      ...
      (rtb_y_p && rtb_OR_m4 && rtb_y_g) || rtb_y_f)));
    ...
    rtb_Compare_du = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_g1);
    FmgcComputer_MATLABFunction_g(rtb_y_eb, FmgcComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_f,
    ...
    rtb_NOT_b = ((rtb_y_f && rtb_Compare_a5) || (rtb_NOT_b && rtb_Compare_a5 && rtb_y_eb) || rtb_y_p3);
    rtb_y_n5 = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_g(rtb_y_n5, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_f,
    ...
    rtb_Compare_a5 = ((rtb_y_h && rtb_NOT_b) || (rtb_y_f || rtb_y_g || rtb_y_p3));
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_P.Logic_table_lwo[static_cast<uint32_T>(absVsTarget) + 8U] && (rtb_y_ha
      != 0U)), FmgcComputer_P.PulseNode3_isRisingEdge_ng, &rtb_y_f, &FmgcComputer_DWork.sf_MATLABFunction_k);
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_y_f) << 1) +
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_f);
    ...
    rtb_Compare_ot = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_cj &&
      rtb_y_af && rtb_y_n5 && rtb_Compare_ot) || ((!rtb_y_f) && (!rtb_y_p3) && rtb_BusAssignment_h_logic_one_engine_out &&
      (rtb_NOT_b && rtb_y_p && (rtb_y_fd > FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_fd <=
    ...
    rtb_y_f = (rtb_Compare_ot && ((rtb_Switch1_a < FmgcComputer_P.CompareToConstant10_const) || (rtb_y_fd <
    ...
    rtb_y_p3 = (((rtb_y_ha != 0U) && rtb_y_g1) || (rtb_y_j && rtb_y_af && rtb_y_cj));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_aj || ((rtb_y_n5 ||
    ...
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_g1) || (rtb_y_j && rtb_y_af && rtb_y_cj));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_aj || ((rtb_y_n5 ||
    ...
    rtb_OR_m4 = (((rtb_y_ha != 0U) && rtb_y_g1) || (rtb_y_j && FmgcComputer_DWork.Memory_PreviousInput_d &&
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_aj || rtb_y_p || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_pw_logic_ils_computation_data_runway_heading_deg, &rtb_y_aj);
    ...
    rtb_VectorConcatenate[14] = rtb_y_f;
    ...
    FmgcComputer_Y.out.athr.athr_limited = rtb_y_f;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.athr_limited = rtb_y_f;
