...
void FmgcComputer::step()
{
  ...
  boolean_T rtb_BusAssignment_j_ap_fd_logic_tcas_ra_corrective;
  ...
  boolean_T rtb_NOT3;
  boolean_T rtb_NOT_c;
  boolean_T rtb_NOT_gj;
  boolean_T rtb_NOT_it;
  boolean_T rtb_NOT_k;
  boolean_T rtb_OR2_l;
  boolean_T rtb_OR_bg;
  boolean_T rtb_OR_m4;
  ...
  boolean_T rtb_y_oi;
  boolean_T rtb_y_pq;
  athr_fma_message rtb_y_j;
  athr_fma_mode rtb_y_eh;
  ...
  boolean_T Memory_PreviousInput_d_tmp_0;
  ...
  boolean_T rtb_y_a0_tmp;
  boolean_T rtb_y_aw1_tmp;
  boolean_T rtb_y_lh_tmp;
  if (FmgcComputer_U.in.sim_data.computer_running) {
    ...
    rtb_irOwnInvalid = (rtb_irOwnInvalid || (rtb_y_jm != 0U));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fac_own_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit, &rtb_y_jm);
    rtb_y_mu = (rtb_y_jm != 0U);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel3_bit, &rtb_y_jm);
    rtb_ir3Invalid = ((!rtb_irOwnInvalid) || ((!rtb_y_mu) && (rtb_y_jm == 0U)) || (!FmgcComputer_P.Constant_Value_a) ||
    ...
    rtb_y_mu = (rtb_y_jm == 0U);
    FmgcComputer_MATLABFunction_f(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5, &rtb_y_au);
    rtb_y_e = (rtb_y_i2 && rtb_y_fd && rtb_y_mu && rtb_y_au);
    rtb_y_d = ((!rtb_y_au) || (!rtb_y_mu));
    rtb_OR_m4 = !rtb_y_e;
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge,
      FmgcComputer_P.ConfirmNode1_timeDelay, &rtb_y_au, &FmgcComputer_DWork.sf_MATLABFunction_fw);
    rtb_y_ks = ((FmgcComputer_U.in.discrete_inputs.eng_opp_stop && FmgcComputer_U.in.discrete_inputs.eng_own_stop &&
                 rtb_y_e) || rtb_y_au);
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
    ...
    FmgcComputer_MATLABFunction_f(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5, &rtb_y_au);
    FmgcComputer_Y.out.logic.fac_flap_slat_data_failure = ((rtb_DataTypeConversion1_e != 0U) || (!rtb_y_au));
    ...
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.glideslope_deviation_deg, &rtb_y_ky);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.localizer_deviation_deg, &rtb_y_au);
    rtb_y_i2 = (rtb_y_ky && rtb_y_au);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_own_bus.glideslope_deviation_deg, &rtb_y_ky);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_own_bus.localizer_deviation_deg, &rtb_y_au);
    rtb_y_fd = (rtb_y_ky && rtb_y_au);
    ...
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.tcas_bus.sensitivity_level, &rtb_y_au);
    ...
    rtb_y_mu = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.sensitivity_level,
      FmgcComputer_P.BitfromLabel2_bit_f, &rtb_DataTypeConversion1_e);
    rtb_NOT1_i = (rtb_y_au && (rtb_Phi_c_deg > FmgcComputer_P.CompareToConstant_const) && rtb_NOT1_i && rtb_y_mu &&
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_f_logic_ils_computation_data_runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue, &rtb_y_ghj);
    rtb_y_oi = !rtb_y_i2;
    if (rtb_y_oi) {
      FmgcComputer_B.u_lyjj = rtb_y_ghj;
    }
    ...
    rtb_BusAssignment_b_logic_ils_tune_inhibit = rtb_y_i2;
    rtb_y_b0 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active);
    rtb_ap_fd_athr_condition = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_y_d) || rtb_y_b0) &&
      (FmgcComputer_U.in.fms_inputs.fm_valid || rtb_y_b0 ||
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_b_logic_ir_computation_data_heading_true_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue, &rtb_y_ghj);
    FmgcComputer_MATLABFunction_j((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rollout_submode_active && (std::abs
      (FmgcComputer_B.u_lyjj - rtb_y_ghj) > FmgcComputer_P.CompareToConstant_const_h)), FmgcComputer_U.in.time.dt,
      &rtb_y_l4, FmgcComputer_P.MTrigNode_isRisingEdge, FmgcComputer_P.MTrigNode_retriggerable,
    ...
    rtb_AND9 = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed;
    rtb_appInop_idx_2 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active;
    rtb_NOT_it = !FmgcComputer_P.Constant1_Value.fac_speeds_failure;
    rtb_y_m5 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active;
    rtb_ap_fd_condition_tmp_0 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active;
    rtb_ap_fd_condition = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || rtb_y_b0) && (rtb_NOT_it ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (rtb_Compare_ov || (rtb_AND9 && rtb_y_m5 &&
      rtb_ap_fd_condition_tmp_0 && rtb_appInop_idx_2)) && (rtb_ap_fd_condition_tmp || rtb_y_b0) && (!rtb_y_l4));
    ...
    FmgcComputer_MATLABFunction_g(FmgcComputer_U.in.discrete_inputs.fcu_ap_button, FmgcComputer_P.PulseNode_isRisingEdge,
      &rtb_y_m3u, &FmgcComputer_DWork.sf_MATLABFunction_il);
    FmgcComputer_MATLABFunction_g(rtb_BusAssignment_h_logic_engine_running, FmgcComputer_P.PulseNode3_isRisingEdge,
      &rtb_y_l4, &FmgcComputer_DWork.sf_MATLABFunction_jp);
    FmgcComputer_MATLABFunction_g(FmgcComputer_U.in.discrete_inputs.ap_opp_engaged,
      FmgcComputer_P.PulseNode2_isRisingEdge, &rtb_y_au, &FmgcComputer_DWork.sf_MATLABFunction_cb);
    rtb_OR2_l_tmp = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active;
    rtb_NOT_gj = (rtb_AND9 && rtb_appInop_idx_2);
    rtb_OR2_l = (rtb_NOT_gj && rtb_OR2_l_tmp);
    FmgcComputer_MATLABFunction_g(rtb_OR2_l, FmgcComputer_P.PulseNode1_isRisingEdge, &rtb_y_ky,
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_l, &rtb_y_ghj);
    rtb_y_i2 = (rtb_y_ghj >= FmgcComputer_P.CompareToConstant3_const);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue, &rtb_y_ghj);
    rtb_Phi_c_deg = rtb_y_ghj;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_gk_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_p, &rtb_y_ab);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_gk_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue, &rtb_y_ki);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_gk_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue, &rtb_y_js);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_gk_logic_ir_computation_data_pitch_angle_deg,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_gk_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue, &rtb_y_ghj);
    rtb_NOT_c = !rtb_ir3Invalid;
    rtb_TmpSignalConversionAtSFunctionInport3_idx_0 = !FmgcComputer_U.in.discrete_inputs.elac_own_ap_disc;
    rtb_TmpSignalConversionAtSFunctionInport3_idx_1 = !FmgcComputer_U.in.discrete_inputs.elac_opp_ap_disc;
    rtb_y_ea = ((!FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc) &&
                (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_TmpSignalConversionAtSFunctionInport3_idx_1) &&
                rtb_NOT_c);
    rtb_fmgcOppPriority = !rtb_ap_fd_athr_condition;
    fdOppOff = (rtb_fmgcOppPriority || (!rtb_ap_fd_condition) || (!rtb_y_ea));
    rtb_Logic_gj_idx_0_tmp = !FmgcComputer_U.in.discrete_inputs.is_unit_1;
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((static_cast<uint32_T>(rtb_y_m3u &&
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_y_ks && rtb_ap_fd_condition && rtb_ap_fd_athr_condition && rtb_y_ea &&
      ((rtb_y_ab >= rtb_y_ki) && (rtb_y_ki >= rtb_y_js) && (rtb_y_ce >= FmgcComputer_P.CompareToConstant_const_hu) &&
       (rtb_y_ce <= FmgcComputer_P.CompareToConstant1_const_bt) && (std::abs(rtb_y_ghj) <=
      FmgcComputer_P.CompareToConstant2_const_c))) << 1) + (fdOppOff || (rtb_y_m3u && FmgcComputer_DWork.Delay_DSTATE_p)
      || FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc || ((rtb_y_au && rtb_OR2_l) ||
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged && rtb_y_ky && rtb_Logic_gj_idx_0_tmp)) || (rtb_y_e &&
      (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_i2 || (rtb_Phi_c_deg >=
      FmgcComputer_P.CompareToConstant5_const))) || (rtb_y_l4 && rtb_y_e))) << 1) +
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Memory_PreviousInput, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge, FmgcComputer_P.ConfirmNode_timeDelay, &rtb_y_l4,
      &FmgcComputer_DWork.sf_MATLABFunction_it);
    absVsTarget = static_cast<int32_T>((((static_cast<uint32_T>(rtb_y_m3u && FmgcComputer_DWork.Memory_PreviousInput) <<
      1) + ((!rtb_y_l4) || FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc)) << 1) +
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_U.in.discrete_inputs.athr_instinctive_disc, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode1_isRisingEdge_n, FmgcComputer_P.ConfirmNode1_timeDelay_l, &rtb_y_l4,
      &FmgcComputer_DWork.sf_MATLABFunction_kz);
    FmgcComputer_DWork.Memory_PreviousInput_g1 = FmgcComputer_P.Logic_table_f[(((static_cast<uint32_T>(rtb_y_l4) << 1) +
    ...
    FmgcComputer_MATLABFunction_g(FmgcComputer_U.in.discrete_inputs.fcu_athr_button,
      FmgcComputer_P.PulseNode_isRisingEdge_k, &rtb_y_mu, &FmgcComputer_DWork.sf_MATLABFunction_o1);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      ...
      FmgcComputer_P.ConfirmNode2_isRisingEdge, FmgcComputer_P.ConfirmNode2_timeDelay, &rtb_y_au,
      &FmgcComputer_DWork.sf_MATLABFunction_mn);
    FmgcComputer_MATLABFunction_g(rtb_y_au, FmgcComputer_P.PulseNode1_isRisingEdge_h, &rtb_Compare_bj,
      &FmgcComputer_DWork.sf_MATLABFunction_jt);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_n, &rtb_y_ghj);
    rtb_y_l4 = (rtb_y_ghj < FmgcComputer_P.CompareToConstant_const_om);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_p, &rtb_y_ghj);
    FmgcComputer_MATLABFunction_g((rtb_y_l4 && (rtb_y_ghj < FmgcComputer_P.CompareToConstant1_const)),
      FmgcComputer_P.PulseNode2_isRisingEdge_n, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_d4);
    ...
    FmgcComputer_MATLABFunction_g((rtb_y_jm != 0U), FmgcComputer_P.PulseNode3_isRisingEdge_a, &rtb_y_m3u,
      &FmgcComputer_DWork.sf_MATLABFunction_ga);
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync &&
      (!FmgcComputer_U.in.discrete_inputs.athr_opp_engaged)), FmgcComputer_P.PulseNode4_isRisingEdge, &rtb_y_ky,
    ...
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active,
      FmgcComputer_P.PulseNode5_isRisingEdge, &rtb_y_au, &FmgcComputer_DWork.sf_MATLABFunction_ag);
    rtb_y_l4 = ((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active ||
                 FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_g1) && rtb_ap_fd_condition_tmp && rtb_NOT_it);
    rtb_ap_fd_condition_tmp = (rtb_fmgcOppPriority || (!rtb_y_l4));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(rtb_ap_fd_athr_condition &&
      rtb_y_l4 && ((rtb_y_mu && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_Compare_bj || rtb_y_m3u ||
                   rtb_y_au)) << 1) + (rtb_ap_fd_condition_tmp || rtb_y_ky || (FmgcComputer_DWork.Delay_DSTATE_k &&
      rtb_y_mu && (!rtP_fmgc_ap_fd_logic_output_MATLABStruct.lateral_modes.land_active)) ||
      FmgcComputer_U.in.discrete_inputs.athr_instinctive_disc || rtb_y_pq)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_p];
    rtb_fmgcOppPriority_tmp = !rtb_Logic_a2[0];
    rtb_fmgcOppPriority = !fdOwnOff;
    rtb_y_ea = !FmgcComputer_DWork.Delay_DSTATE_k;
    rtb_y_au = (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || FmgcComputer_U.in.discrete_inputs.fd_opp_engaged);
    rtb_y_l4 = (rtb_y_au || FmgcComputer_U.in.discrete_inputs.athr_opp_engaged);
    rtb_fmgcOppPriority = ((rtb_Logic_gj_idx_0_tmp || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_fmgcOppPriority) && (rtb_y_au || rtb_y_ea) && rtb_y_l4)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_au || rtb_fmgcOppPriority) && (rtb_y_l4 || rtb_y_ea) &&
      (rtb_Logic_a2[0] || fdOwnOff || FmgcComputer_DWork.Delay_DSTATE_k ||
       (!FmgcComputer_U.in.discrete_inputs.fmgc_opp_healthy)))));
    rtb_y_aw1_tmp = !FmgcComputer_U.in.discrete_inputs.ap_opp_engaged;
    rtb_y_l4 = (rtb_fmgcOppPriority && (rtb_fmgcOppPriority_tmp || rtb_y_aw1_tmp));
    ...
    rtb_BusAssignment_m_logic_adr_computation_data_vertical_speed_ft_min.Data =
      rtb_adrComputationBus_vertical_speed_ft_min_Data;
    rtb_OR2_l = (rtb_Logic_a2[0] || FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || fdOwnOff ||
                 FmgcComputer_U.in.discrete_inputs.fd_opp_engaged);
    ...
    rtb_NOT_it = (rtb_DataTypeConversion1_e == 0U);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel3_bit_m, &rtb_DataTypeConversion1_e);
    rtb_y_i2 = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel4_bit_p, &rtb_DataTypeConversion1_e);
    rtb_y_i2 = ((!rtb_NOT_it) || (!rtb_y_i2) || (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_m_logic_adr_computation_data_vertical_speed_ft_min,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_c, &rtb_y_ab);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel5_bit_b, &rtb_DataTypeConversion1_e);
    rtb_y_fd = !rtb_y_i2;
    if (rtb_y_fd || (rtb_DataTypeConversion1_e == 0U)) {
      FmgcComputer_B.u_lyjjlj = rtb_y_ab;
    }
    ...
    rtb_y_lh = !rtb_NOT1_i;
    FmgcComputer_MATLABFunction_j((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active && rtb_y_lh),
      FmgcComputer_U.in.time.dt, &rtb_NOT_it, FmgcComputer_P.MTrigNode_isRisingEdge_j,
    ...
    FmgcComputer_MATLABFunction_j(FmgcComputer_DWork.Delay_DSTATE_o, FmgcComputer_U.in.time.dt, &rtb_y_mu,
    ...
    rtb_BusAssignment_j_logic_adr_computation_data_altitude_corrected_ft.Data =
      rtb_adrComputationBus_altitude_corrected_ft_Data;
    rtb_BusAssignment_j_ap_fd_logic_tcas_ra_corrective = rtb_y_i2;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_m, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_j_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_c, &rtb_y_ghj);
    rtb_y_nt = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active);
    rtb_Compare_d0 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
                      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    rtb_AND_iz = (rtb_y_nt && FmgcComputer_DWork.Delay_DSTATE.alt_cstr_applicable && rtb_Compare_d0 &&
                  FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid);
    if (rtb_y_ce > rtb_y_ghj) {
      rtb_Logic_gj_idx_0_tmp = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft < rtb_y_ce) &&
        ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft + 250.0 > rtb_y_ghj) || rtb_AND_iz));
    } else {
      rtb_Logic_gj_idx_0_tmp = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft > rtb_y_ce) &&
        ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft - 250.0 < rtb_y_ghj) || rtb_AND_iz));
    }
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_l2, &rtb_y_ghj);
    rtb_GreaterThan3 = (rtb_y_ghj < FmgcComputer_P.CompareToConstant3_const_n);
    ...
    rtb_y_n = (rtb_GreaterThan3 && (rtb_y_ghj > FmgcComputer_P.CompareToConstant4_const) && rtb_y_n);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b, &rtb_y_ghj);
    rtb_GreaterThan3 = (rtb_y_ghj < FmgcComputer_P.CompareToConstant5_const_a);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_c);
    FmgcComputer_MATLABFunction_g((rtb_NOT3 || rtb_y_n || (!rtb_GreaterThan3) || (rtb_GreaterThan3 && (rtb_y_ghj >
      FmgcComputer_P.CompareToConstant6_const) && rtb_y_c)), FmgcComputer_P.PulseNode_isRisingEdge_p, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_gk);
    rtb_y_c = !rtb_y_l4;
    rtb_Compare_kg = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active;
    rtb_NOT3_tmp = (rtb_y_c && rtb_Compare_kg && rtb_OR2_l_tmp);
    rtb_NOT3 = (((FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant1_const_k) &&
                 (rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_NOT3_tmp && rtb_Compare_bj &&
      (FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant2_const) && (rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_b) && rtb_y_pq));
    FmgcComputer_MATLABFunction_a(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_c,
      FmgcComputer_P.ConfirmNode_timeDelay_h, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_fx);
    rtb_Logic_gj_idx_0_tmp = !rtb_OR2_l;
    Memory_PreviousInput_k_tmp_tmp = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active);
    Memory_PreviousInput_k_tmp_tmp_tmp = (Memory_PreviousInput_k_tmp_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    Memory_PreviousInput_k_tmp_tmp_0 = (Memory_PreviousInput_k_tmp_tmp_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
    ...
    rtb_y_i2 = (Memory_PreviousInput_k_tmp_tmp_0 ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active);
    FmgcComputer_DWork.Memory_PreviousInput_k = FmgcComputer_P.Logic_table_b[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_i2 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_pq))) + (static_cast<uint32_T>(rtb_NOT3) <<
    ...
    if (rtb_y_ghj < 0.0F) {
      rtb_DataTypeConversion1_d = -rtb_y_ghj;
    } else {
      rtb_DataTypeConversion1_d = rtb_y_ghj;
    }

    rtb_NOT3 = ((rtb_GreaterThan3 && (rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active) && ((rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_cq) && rtb_y_pq && (rtb_DataTypeConversion2_kb <=
    ...
    FmgcComputer_MATLABFunction_a(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_l,
      FmgcComputer_P.ConfirmNode_timeDelay_f, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_jl);
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg, &rtb_y_n);
    FmgcComputer_DWork.Memory_PreviousInput_c = FmgcComputer_P.Logic_table_hz[(((((!rtb_y_pq) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_trk_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp || (!rtb_y_n)) + (
    ...
    FmgcComputer_MATLABFunction_j((rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_l),
      FmgcComputer_U.in.time.dt, &rtb_y_pq, FmgcComputer_P.MTrigNode_isRisingEdge_jv,
    ...
    rtb_NOT3 = ((rtb_GreaterThan3 && (rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c &&
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed)) &&
      rtb_y_pq));
    FmgcComputer_MATLABFunction_a(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hu,
      FmgcComputer_P.ConfirmNode_timeDelay_j, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_kz1);
    FmgcComputer_DWork.Memory_PreviousInput_b = FmgcComputer_P.Logic_table_d[(((((!rtb_y_pq) &&
    ...
    rtb_NOT3 = rtb_y_mu;
    rtb_y_n = (FmgcComputer_DWork.Memory_PreviousInput_c || FmgcComputer_DWork.Memory_PreviousInput_b);
    ...
    rtb_y_ii = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_b, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_l, &rtb_y_mu,
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_f, FmgcComputer_P.ConfirmNode_timeDelay_d, &rtb_y_pq,
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ek, &rtb_y_ab);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_own_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_f, &rtb_y_js);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_c, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.ils_own_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_o, &rtb_y_ghj);
    rtb_GreaterThan3_tmp = !rtb_BusAssignment_h_logic_engine_running;
    rtb_appCapability_idx_2 = !rtb_BusAssignment_o_logic_ils_failure;
    rtb_y_ky = !FmgcComputer_P.Constant2_Value_p;
    ...
    rtb_GreaterThan3_tmp_1 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active;
    rtb_GreaterThan3 = (rtb_appInop_idx_2 && (rtb_y_ii || (rtb_y_c && (FmgcComputer_P.Constant_Value_l &&
      rtb_appCapability_idx_2 && (rtb_GreaterThan3_tmp || (rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_g)) && rtb_Compare_ov && rtb_y_mu && (!rtb_y_pq) && (rtb_GreaterThan3_tmp_1
      && (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed))) && rtb_Compare_kg && rtb_OR2_l_tmp &&
      rtb_GreaterThan3_tmp_0 && rtb_AND1_c0 && rtb_y_ky && rtb_y_ky && (((rtb_y_ab == rtb_y_js) && (rtb_y_ce ==
      rtb_y_ghj)) || (!rtb_BusAssignment_o_logic_both_ils_valid)))));
    rtb_NOT_k = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    rtb_y_a0_tmp = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_j, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_eb2);
    rtb_y_au = (rtb_y_a0_tmp && rtb_y_pq);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_l, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_c, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_es);
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_y_b0 || ((!rtb_NOT_k) &&
      (!rtb_y_a0_tmp) && FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed) || ((rtb_NOT_k && rtb_Compare_bj) ||
      rtb_y_au) || (rtb_y_mu && FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed) || rtb_y_pq ||
    ...
    FmgcComputer_MATLABFunction_a((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_d),
      ...
      &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_cr);
    rtb_y_au = (rtb_Compare_bj && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active && rtb_y_pq)));
    FmgcComputer_MATLABFunction_a(rtb_y_au, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_d,
      FmgcComputer_P.ConfirmNode_timeDelay_a, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_op);
    rtb_y_m3u = !rtb_y_pq;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ft, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_a, &rtb_y_pq,
    ...
    rtb_AND12 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active ||
                 FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active);
    Memory_PreviousInput_d_tmp = (rtb_AND12 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    Memory_PreviousInput_d_tmp_0 = (Memory_PreviousInput_d_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_y_i2 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active || (Memory_PreviousInput_d_tmp_0 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active)) && rtb_y_m3u) ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || (rtb_fmgcOppPriority_tmp &&
      rtb_y_aw1_tmp && rtb_y_pq && rtb_Compare_bj) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_y_au) << 1)) <<
      1) + FmgcComputer_DWork.Memory_PreviousInput_d];
    rtb_y_ii = (FmgcComputer_U.in.discrete_inputs.bscu_opp_valid || FmgcComputer_U.in.discrete_inputs.bscu_own_valid);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      ...
      FmgcComputer_U.in.discrete_inputs.right_wheel_spd_abv_70_kts) && rtb_y_ii) || ((!rtb_y_ii) && rtb_y_e))),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_b, FmgcComputer_P.ConfirmNode1_timeDelay_ef,
      &rtb_y_au, &FmgcComputer_DWork.sf_MATLABFunction_mb);
    FmgcComputer_DWork.Memory_PreviousInput_m = FmgcComputer_P.Logic_table_m[(((static_cast<uint32_T>(rtb_y_au) << 1) +
      rtb_appInop_idx_2) << 1) + FmgcComputer_DWork.Memory_PreviousInput_m];
    rtb_NOT_c = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      FmgcComputer_P.CompareToConstant1_const_h) && rtb_NOT_c);
    rtb_y_au = (rtb_Compare_ov && FmgcComputer_DWork.Delay2_DSTATE.flare_law.condition_Flare &&
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active);
    FmgcComputer_MATLABFunction_a(rtb_y_au, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_d,
      FmgcComputer_P.ConfirmNode1_timeDelay_dj, &rtb_y_m3u, &FmgcComputer_DWork.sf_MATLABFunction_j2);
    FmgcComputer_DWork.Memory_PreviousInput_bc = FmgcComputer_P.Logic_table_bp[(((static_cast<uint32_T>(rtb_y_m3u) << 1)
      + rtb_appInop_idx_2) << 1) + FmgcComputer_DWork.Memory_PreviousInput_bc];
    rtb_y_au = (rtb_y_au || FmgcComputer_DWork.Memory_PreviousInput_bc);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_l, &rtb_DataTypeConversion1_e);
    rtb_GreaterThan3 = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4);
    rtb_y_b0 = (rtb_GreaterThan3_tmp || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_lj) ||
                rtb_dualRaFailure);
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_le, FmgcComputer_P.ConfirmNode_timeDelay_n, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_pu);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_e, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_h, &rtb_y_ky,
      &FmgcComputer_DWork.sf_MATLABFunction_d3);
    rtb_y_i2 = (rtb_y_c && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid);
    rtb_y_ii = (rtb_y_i2 && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && FmgcComputer_P.Constant_Value_hg &&
                rtb_y_b0 && rtb_AND9 && (rtb_Compare_kg && rtb_GreaterThan3_tmp_0 && rtb_OR2_l_tmp && rtb_AND1_c0 &&
      rtb_GreaterThan3_tmp_1 && (!rtb_y_pq) && rtb_y_ky));
    rtb_NOT_k = (rtb_appInop_idx_2 && (rtb_GreaterThan3 || rtb_y_ii));
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_k, &rtb_y_pq,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_li,
      &rtb_y_ii, &FmgcComputer_DWork.sf_MATLABFunction_bk);
    rtb_y_aw1_tmp = !FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid;
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c
      [(((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_aw1_tmp || rtb_y_pq ||
          (rtb_y_ky && FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed) || rtb_y_ii ||
          rtb_Logic_gj_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) +
         (static_cast<uint32_T>(rtb_NOT_k) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_dv];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
      FmgcComputer_P.BitfromLabel_bit_a, &rtb_DataTypeConversion1_e);
    rtb_y_m3u = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_m3u, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ha,
      FmgcComputer_P.ConfirmNode_timeDelay_on, &rtb_y_ky, &FmgcComputer_DWork.sf_MATLABFunction_mm);
    rtb_OR_bg = (Memory_PreviousInput_k_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active);
    absVsTarget_tmp_tmp = (rtb_OR_bg || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    absVsTarget_tmp = (absVsTarget_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active);
    absVsTarget = static_cast<int32_T>((((rtb_Logic_gj_idx_0_tmp || ((absVsTarget_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_ky))) + (static_cast<uint32_T>(rtb_y_m3u) <<
    ...
    FmgcComputer_MATLABFunction_a(rtb_y_e, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_m,
      FmgcComputer_P.ConfirmNode_timeDelay_j5, &rtb_y_b0, &FmgcComputer_DWork.sf_MATLABFunction_hvs);
    rtb_y_ii = (rtb_handleIndex >= FmgcComputer_P.CompareToConstant_const_ja);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_p, &rtb_y_ghj);
    rtb_y_m3u = (rtb_y_ghj >= FmgcComputer_P.CompareToConstant3_const_i);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d, &rtb_y_ghj);
    FmgcComputer_MATLABFunction_g((rtb_y_m3u || (rtb_y_ghj >= FmgcComputer_P.CompareToConstant5_const_k)),
      FmgcComputer_P.PulseNode_isRisingEdge_c, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_fn5);
    rtb_y_m3u = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_NOT3_tmp && (!rtb_y_b0) && rtb_y_ii && rtb_y_pq));
    FmgcComputer_MATLABFunction_a(rtb_y_m3u, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hj,
      FmgcComputer_P.ConfirmNode_timeDelay_a3, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_lm);
    FmgcComputer_DWork.Memory_PreviousInput_i = FmgcComputer_P.Logic_table_o[((((rtb_Logic_gj_idx_0_tmp ||
      (Memory_PreviousInput_k_tmp_tmp_0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) && (!rtb_y_pq)) + (static_cast<uint32_T>(rtb_y_m3u) <<
    ...
    FmgcComputer_MATLABFunction_j(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_U.in.time.dt, &rtb_y_pq, FmgcComputer_P.MTrigNode_isRisingEdge_d,
    ...
    rtb_y_m3u = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c && (rtb_AND1_c0 &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active) && rtb_y_pq)));
    FmgcComputer_MATLABFunction_a(rtb_y_m3u, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_mf,
      FmgcComputer_P.ConfirmNode_timeDelay_dw, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_mtz);
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode3_isRisingEdge_l, &rtb_y_ii,
      &FmgcComputer_DWork.sf_MATLABFunction_gb);
    rtb_GreaterThan3_tmp = ((!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active));
    rtb_y_ky = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active;
    rtb_GreaterThan3 = (rtb_GreaterThan3_tmp && (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active) &&
                        (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active) &&
                        (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active) &&
                        (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active) && rtb_y_ky &&
                        (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel4_bit_k, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_y_pq,
    ...
    rtb_y_mu = (rtb_GreaterThan3_tmp_0 && rtb_AND1_c0);
    rtb_y_m3u = (rtb_y_a0_tmp && rtb_y_ii && (rtb_y_mu && rtb_TmpSignalConversionAtSFunctionInport3_idx_2 &&
      rtb_appInop_idx_2) && rtb_GreaterThan3 && (!rtb_y_pq));
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed ||
      ...
      &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_aj);
    rtb_GreaterThan3_tmp_0 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active;
    rtb_NOT3_tmp = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active;
    rtb_GreaterThan3 = (rtb_GreaterThan3 && rtb_y_pq && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                        (rtb_y_mu && rtb_GreaterThan3_tmp_0 && rtb_NOT3_tmp && rtb_appInop_idx_2));
    rtb_y_mu = rtb_y_a0_tmp;
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_b, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_at);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel5_bit_f, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_j, &rtb_y_mu,
      &FmgcComputer_DWork.sf_MATLABFunction_o3);
    Memory_PreviousInput_k_tmp_tmp_0 = !FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid;
    rtb_Compare_bj = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && Memory_PreviousInput_k_tmp_tmp_0 &&
                       rtb_GreaterThan3_tmp_1) || rtb_y_m3u || rtb_GreaterThan3 || (rtb_y_a0_tmp && rtb_NOT_gj &&
      rtb_y_pq) || (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active && rtb_y_mu));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    rtb_y_mu = (rtb_y_mu || (rtb_DataTypeConversion1_e != 0U));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel2_bit_i, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_i, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_di2);
    rtb_GreaterThan3 = (rtb_y_ks && rtb_y_pq && rtb_appInop_idx_2 && (rtb_AND1_c0 || (rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_a)));
    rtb_y_ii = rtb_OR_m4;
    FmgcComputer_MATLABFunction_g(rtb_OR2_l, FmgcComputer_P.PulseNode4_isRisingEdge_e, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_a5);
    rtb_y_lh_tmp = !FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged;
    rtb_y_b0 = (rtb_y_lh_tmp && rtb_OR2_l_tmp);
    rtb_y_m3u = ((rtb_y_mu && rtb_y_l4) || (rtb_y_c && (rtb_GreaterThan3 || (rtb_OR_m4 && rtb_y_pq && rtb_y_b0) ||
      rtb_Compare_bj)));
    FmgcComputer_MATLABFunction_a(rtb_y_m3u, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_a,
      FmgcComputer_P.ConfirmNode_timeDelay_a2, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_hdw);
    FmgcComputer_DWork.Memory_PreviousInput_f2 = FmgcComputer_P.Logic_table_i[(((((!rtb_y_pq) &&
      (Memory_PreviousInput_d_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_y_m3u) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_f2];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_k, &rtb_DataTypeConversion1_e);
    rtb_y_m3u = ((rtb_DataTypeConversion1_e != 0U) && FmgcComputer_DWork.Memory_PreviousInput_f2);
    rtb_AND9 = (FmgcComputer_DWork.Memory_PreviousInput_f2 && (rtb_DataTypeConversion1_e == 0U));
    Memory_PreviousInput_d_tmp = rtb_Compare_bj;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_j, &rtb_y_ii,
    ...
    FmgcComputer_MATLABFunction_g(FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid,
      FmgcComputer_P.PulseNode3_isRisingEdge_e, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_hu);
    rtb_GreaterThan3 = !FmgcComputer_DWork.Delay_DSTATE.hdg_trk_preset_available;
    rtb_NOT_k = (rtb_GreaterThan3 || rtb_y_pq);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed,
      FmgcComputer_P.PulseNode4_isRisingEdge_b, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_idz);
    FmgcComputer_MATLABFunction_j(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_U.in.time.dt, &rtb_y_b0, FmgcComputer_P.MTrigNode_isRisingEdge_i,
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_l4) || (rtb_y_i2 && ((rtb_GreaterThan3_tmp_0 && rtb_NOT3_tmp &&
      rtb_appInop_idx_2 && rtb_y_ii) || (rtb_y_e && rtb_NOT_k && (rtb_y_lh_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active)) || rtb_y_pq || (rtb_y_b0 &&
      rtb_GreaterThan3))));
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.hdg_trk_preset_available,
      FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_ii, &FmgcComputer_DWork.sf_MATLABFunction_h0);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_p, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_k, &rtb_y_b0,
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      ...
      FmgcComputer_P.PulseNode6_isRisingEdge, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_jd);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_ii || rtb_y_b0 || rtb_y_pq ||
      Memory_PreviousInput_k_tmp_tmp_0 || rtb_GreaterThan3 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
    ...
    FmgcComputer_MATLABFunction_j(FmgcComputer_U.in.fms_inputs.direct_to_nav_engage, FmgcComputer_U.in.time.dt,
      &rtb_y_pq, FmgcComputer_P.MTrigNode_isRisingEdge_h, FmgcComputer_P.MTrigNode_retriggerable_g,
      FmgcComputer_P.MTrigNode_triggerDuration_e, &FmgcComputer_DWork.sf_MATLABFunction_prl);
    rtb_y_mu = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c &&
      FmgcComputer_U.in.fms_inputs.nav_capture_condition && (FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed ||
      rtb_y_pq) && ((rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_oh) || rtb_dualRaFailure) &&
      (rtb_AND1_c0 || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant1_const_b))));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_co,
      FmgcComputer_P.ConfirmNode_timeDelay_d1, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_ge4);
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((Memory_PreviousInput_k_tmp_tmp_0 ||
      rtb_Logic_gj_idx_0_tmp || ((Memory_PreviousInput_d_tmp_0 ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_pq))) + (static_cast<uint32_T>(rtb_y_mu) <<
    ...
    rtb_y_mu = rtb_y_c;
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_cs, &rtb_y_i2,
      &FmgcComputer_DWork.sf_MATLABFunction_ma);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_ls, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_o, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_k4c);
    rtb_NOT_k = rtb_appCapability_idx_2;
    rtb_AND1_c0 = (rtb_y_pq && rtb_appCapability_idx_2 && (rtb_raComputationData >=
    ...
    FmgcComputer_MATLABFunction_a(rtb_AND1_c0, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_n,
      FmgcComputer_P.ConfirmNode_timeDelay_g, &rtb_NOT_k, &FmgcComputer_DWork.sf_MATLABFunction_ah);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed,
      FmgcComputer_P.PulseNode_isRisingEdge_g, &rtb_y_mu, &FmgcComputer_DWork.sf_MATLABFunction_ol);
    rtb_NOT_gj = (rtb_NOT_gj && rtb_y_pq && FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed,
      FmgcComputer_P.PulseNode3_isRisingEdge_d, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_mne);
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_NOT_k) && rtb_y_mu) ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_NOT_gj || rtb_y_pq) + (
      static_cast<uint32_T>((rtb_Compare_bj && rtb_y_l4) || (rtb_y_c && (rtb_y_i2 || rtb_AND1_c0))) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_j, &rtb_y_ghj);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_o, &rtb_y_js);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o, &rtb_y_ce);
    rtb_DataTypeConversion2_kb = (rtb_y_ghj - static_cast<real32_T>(FmgcComputer_B.u_lyjj + 360.0)) + 360.0F;
    if (rtb_DataTypeConversion2_kb == 0.0F) {
    ...
    if (360.0F - rtb_DataTypeConversion2_kb == 0.0F) {
      ...
      rtb_y_ghj = std::fmod(360.0F - rtb_DataTypeConversion2_kb, 360.0F);
    }

    if (rtb_DataTypeConversion2_kb < rtb_y_ghj) {
      rtb_y_ghj = -rtb_DataTypeConversion2_kb;
    }

    if (rtb_y_ghj < 0.0F) {
      high_i = -1;
    } else {
      high_i = (rtb_y_ghj > 0.0F);
    }
    ...
    if (high_i == low_ip1) {
      ...
      if (rtb_DataTypeConversion1_d > 5.0) {
        if (std::abs(rtb_y_ce) <= 5.0F) {
          rtb_y_mu = true;
        } else {
          if (rtb_y_ce < 0.0F) {
            absVsTarget = -1;
          } else {
            absVsTarget = (rtb_y_ce > 0.0F);
          }
      ...
      if (guard1) {
        ...
        rtb_y_mu = ((rtb_DataTypeConversion1_d >= std::abs(rtb_y_ce)) && (low_ip1 == absVsTarget));
      }
    } else {
      rtb_y_mu = false;
    }

    rtb_DataTypeConversion2_kb = std::abs(rtb_y_ghj);
    if (rtb_DataTypeConversion2_kb < 115.0F) {
      rtb_y_ce = std::abs(rtb_y_js);
      if (rtb_y_js < 0.0F) {
        low_ip1 = -1;
      } else {
        low_ip1 = (rtb_y_js > 0.0F);
      }

      if (((rtb_DataTypeConversion2_kb > 25.0F) && ((rtb_y_ce < 10.0F) && ((high_i != low_ip1) && rtb_y_mu))) ||
          (rtb_y_ce < 1.92)) {
        rtb_y_mu = (rtb_y_mu || ((rtb_DataTypeConversion2_kb < 15.0F) && (rtb_y_ce < 1.1)));
      } else {
        rtb_y_mu = false;
      }
    } else {
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      &rtb_Compare_bj);
    rtb_y_mu = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed && rtb_y_mu && rtb_Compare_bj));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_at,
      FmgcComputer_P.ConfirmNode_timeDelay_h4, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_p4);
    rtb_Compare_bj = (rtb_AND12 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active);
    FmgcComputer_DWork.Memory_PreviousInput_cv = FmgcComputer_P.Logic_table_g4[(((((!rtb_y_pq) && (rtb_Compare_bj ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_y_mu) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cv];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel_bit_es, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_b, &rtb_y_ghj);
    if (rtb_y_ghj < 0.0F) {
      rtb_DataTypeConversion1_d = -rtb_y_ghj;
    } else {
      rtb_DataTypeConversion1_d = rtb_y_ghj;
    ...
    FmgcComputer_MATLABFunction_a((rtb_DataTypeConversion1_d < FmgcComputer_P.CompareToConstant1_const_n),
      ...
      &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_is);
    rtb_y_mu = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active && rtb_y_pq));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ea,
      FmgcComputer_P.ConfirmNode_timeDelay_es, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_pr);
    FmgcComputer_DWork.Memory_PreviousInput_lq = FmgcComputer_P.Logic_table_j[(((((!rtb_y_pq) && (rtb_Compare_bj ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>
      (rtb_y_mu) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_lq];
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_c5, &rtb_y_ghj);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pm, &rtb_y_ab);
    rtb_DataTypeConversion2_kb = rtb_y_ghj - rtb_y_ab;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_j, &rtb_y_js);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jm, &rtb_y_ce);
    if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) {
      ...
      if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active && rtb_y_fd) {
        rtb_y_ce = static_cast<real32_T>(rtb_Phi_c_deg);
      } else {
        rtb_y_ce = 0.0F;
      }
    }
    ...
    rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s.Data =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_Data;
    if (rtb_DataTypeConversion2_kb < 0.0F) {
      rtb_y_fd = (rtb_y_ce <= 0.0F);
    } else {
      rtb_y_fd = ((rtb_DataTypeConversion2_kb > 0.0F) && (rtb_y_ce >= 0.0F));
    }

    rtb_y_ii = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active;
    rtb_AND1_c0 = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) && rtb_y_ii && rtb_y_m5 &&
      rtb_ap_fd_condition_tmp_0 && rtb_GreaterThan3_tmp_1 && rtb_appInop_idx_2 && ((!rtb_y_fd) || (rtb_GreaterThan3_tmp &&
      rtb_Compare_b)) && (((!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active)) || (rtb_DataTypeConversion2_kb <=
      FmgcComputer_P.CompareToConstant2_const_jy)) && rtb_OR2_l && FmgcComputer_DWork.Memory_PreviousInput_n));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_h, &rtb_y_ce);
    rtb_DataTypeConversion2_kb = std::abs(rtb_y_ce);
    high_i = 7;
    absVsTarget = 0;
    low_ip1 = 2;
    ...
    rtb_y_js = rtb_y_ce * 0.00508F;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_d, &rtb_y_ghj);
    rtb_Phi_c_deg = rtb_altCstrOrFcu - rtb_y_ghj;
    ...
    if (rtb_y_ce < 0.0F) {
      ...
      low_ip1 = (rtb_y_ce > 0.0F);
    }

    rtb_NOT_k = (FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed && (!rtb_y_pq) && ((std::fmin(3000.0F, std::
      fmax(80.0F, rtb_y_js * rtb_y_js / ((((rtb_DataTypeConversion2_kb * static_cast<real32_T>(c[absVsTarget]) +
    ...
    rtb_y_b0 = rtb_y_lh;
    rtb_y_mu = ((rtb_Compare_bj && rtb_y_l4) || (rtb_y_c && rtb_NOT_k && ((rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_l5) || (rtb_OR2_l_tmp && rtb_Compare_kg)) && (rtb_Compare_b ||
      ((rtb_DataTypeConversion1_e == 0U) && (FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode ==
      FmgcComputer_P.EnumeratedConstant3_Value_l) && (!rtb_y_lh)))));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hux,
      FmgcComputer_P.ConfirmNode_timeDelay_lk, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_hw);
    FmgcComputer_DWork.Memory_PreviousInput_ne = FmgcComputer_P.Logic_table_nz[(((rtb_Logic_gj_idx_0_tmp || ((rtb_OR_bg ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_pq))) + (static_cast<uint32_T>(rtb_y_mu) <<
      1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ne];
    rtb_NOT_gj = rtb_NOT_k;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_bj = (rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U));
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_g, &rtb_y_ghj);
    FmgcComputer_MATLABFunction_a((std::abs(rtb_altCstrOrFcu - rtb_y_ghj) < FmgcComputer_P.CompareToConstant_const_f),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_nf, FmgcComputer_P.ConfirmNode_timeDelay_at,
      &rtb_y_b0, &FmgcComputer_DWork.sf_MATLABFunction_ee);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel7_bit_k, &rtb_DataTypeConversion1_e);
    rtb_y_mu = ((rtb_Compare_bj && rtb_y_l4) || (rtb_y_c &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && rtb_y_b0 && (rtb_Compare_b ||
      ((rtb_DataTypeConversion1_e == 0U) && (FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode ==
      FmgcComputer_P.EnumeratedConstant3_Value_p) && rtb_NOT1_i))));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lj,
      FmgcComputer_P.ConfirmNode_timeDelay_b, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_dt);
    FmgcComputer_DWork.Memory_PreviousInput_cb = FmgcComputer_P.Logic_table_ob[(((rtb_Logic_gj_idx_0_tmp ||
      ((Memory_PreviousInput_k_tmp_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_pq))) + (static_cast<uint32_T>(rtb_y_mu) <<
      1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cb];
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_m, &rtb_y_ghj);
    rtb_y_mu = rtb_y_ii;
    FmgcComputer_DWork.Memory_PreviousInput_no = FmgcComputer_P.Logic_table_ay[(((static_cast<uint32_T>(std::abs
      (FmgcComputer_U.in.fms_inputs.cruise_alt_ft - rtb_y_ghj) < FmgcComputer_P.CompareToConstant1_const_a) << 1) +
      rtb_y_ii) << 1) + FmgcComputer_DWork.Memory_PreviousInput_no];
    rtb_OR_bg = !rtb_AND_iz;
    rtb_Compare_b = (FmgcComputer_DWork.Memory_PreviousInput_cb && rtb_OR_bg &&
    ...
    Memory_PreviousInput_k_tmp_tmp_tmp = rtb_y_b0;
    rtb_Compare_bj = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
                      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active);
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode3_isRisingEdge_n, &rtb_y_mu,
      &FmgcComputer_DWork.sf_MATLABFunction_fed);
    rtb_AND12 = (rtb_Compare_bj && rtb_y_mu);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active,
      FmgcComputer_P.PulseNode4_isRisingEdge_f, &rtb_y_mu, &FmgcComputer_DWork.sf_MATLABFunction_bbb);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mr, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oi, &rtb_y_ghj);
    rtb_DataTypeConversion2_bh = rtb_y_ce - rtb_y_ghj;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_o3_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_o, &rtb_y_ghj);
    rtb_DataTypeConversion2_kb = rtb_y_ghj + FmgcComputer_P.Bias_Bias_e;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_o3_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_c, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_o3_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue, &rtb_y_ghj);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.tcas_bus.vertical_resolution_advisory,
      FmgcComputer_P.BitfromLabel7_bit_o, &rtb_DataTypeConversion1_e);
    rtb_y_i2 = (rtb_y_lh || (FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode ==
      FmgcComputer_P.EnumeratedConstant3_Value_ls));
    Memory_PreviousInput_k_tmp_tmp_0 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_y_pq = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    rtb_y_fd = (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_GreaterThan3_tmp_0 && rtb_NOT3_tmp);
    rtb_Compare_bj = (rtb_AND12 || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active && (rtb_y_mu ||
      ...
      ((FmgcComputer_P.EnumeratedConstant_Value_p == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant2_Value) || rtb_y_fd ||
       rtb_y_aw1_tmp)) || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && (std::abs
      (FmgcComputer_B.u_ly - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_omz)) ||
                      (Memory_PreviousInput_k_tmp_tmp_0 && (rtb_DataTypeConversion2_bh >
      FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_y_pq && (rtb_DataTypeConversion2_bh <
      FmgcComputer_P.CompareToConstant2_const_g)) || ((Memory_PreviousInput_k_tmp_tmp_0 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (rtb_DataTypeConversion2_kb > rtb_y_ce) &&
      rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k && FmgcComputer_P.Constant_Value_m) || (rtb_y_pq &&
      (rtb_y_ce > rtb_y_ghj + FmgcComputer_P.Bias1_Bias) && rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k
      && FmgcComputer_P.Constant_Value_m) || (((rtb_DataTypeConversion1_e == 0U) || rtb_y_lh) &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active && rtb_y_i2));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_y_ii = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_g((rtb_GreaterThan3 || (rtb_DataTypeConversion1_e != 0U)),
      FmgcComputer_P.PulseNode_isRisingEdge_d, &rtb_y_ii, &FmgcComputer_DWork.sf_MATLABFunction_nd);
    rtb_GreaterThan3 = (rtb_y_ks && rtb_y_ii && rtb_appInop_idx_2);
    FmgcComputer_MATLABFunction_g(rtb_OR2_l, FmgcComputer_P.PulseNode1_isRisingEdge_ky, &rtb_y_i2,
      &FmgcComputer_DWork.sf_MATLABFunction_dsw);
    rtb_y_lh_tmp = !FmgcComputer_DWork.Delay_DSTATE.any_longitudinal_mode_engaged;
    rtb_y_b0 = rtb_y_lh_tmp;
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ld,
      FmgcComputer_P.ConfirmNode_timeDelay_op, &rtb_y_b0, &FmgcComputer_DWork.sf_MATLABFunction_cz);
    rtb_y_mu = ((rtb_y_mu && rtb_y_l4) || (rtb_y_c && (rtb_GreaterThan3 || (rtb_OR_m4 && rtb_y_i2 && rtb_y_lh_tmp) ||
      (rtb_y_b0 && rtb_y_lh_tmp) || rtb_Compare_bj)));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lu,
      FmgcComputer_P.ConfirmNode_timeDelay_ll, &rtb_GreaterThan3, &FmgcComputer_DWork.sf_MATLABFunction_gbq);
    FmgcComputer_DWork.Memory_PreviousInput_fg = FmgcComputer_P.Logic_table_ny[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_nt ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      ...
      (rtb_y_mu) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_fg];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    rtb_NOT3_tmp = rtb_Compare_bj;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_jh, &rtb_DataTypeConversion1_e);
    rtb_Compare_bj = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_et, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oj, &rtb_y_ghj);
    rtb_y_ii = (rtb_y_ce > rtb_y_ghj);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_px, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_b, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_p3z);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_c, &rtb_y_ghj);
    rtb_y_i2 = (rtb_y_nt && rtb_AND_iz);
    rtb_NOT_k = (rtb_OR_m4 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_ii && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_i2 || (rtb_y_pq &&
      rtb_y_nt && (rtb_AND_iz && (std::abs(rtb_altCstrOrFcu - rtb_y_ghj) <= FmgcComputer_P.CompareToConstant2_const_d)))));
    rtb_GreaterThan3 = (rtb_y_e || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_k, &rtb_y_ghj);
    rtb_y_ii = ((FmgcComputer_U.in.fms_inputs.acceleration_alt_ft != FmgcComputer_P.CompareToConstant_const_lz) &&
                (FmgcComputer_U.in.fms_inputs.acceleration_alt_ft < rtb_y_ghj) &&
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jt, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_os, &rtb_y_ghj);
    rtb_appCapability_idx_2 = (Memory_PreviousInput_k_tmp_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_GreaterThan3 && (!rtb_y_ii)) ||
      (rtb_appCapability_idx_2 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
       ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
         FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) && rtb_OR_bg) ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) || (rtb_y_ce < rtb_y_ghj) || (rtb_y_nt &&
      (rtb_OR_bg || rtb_TmpSignalConversionAtSFunctionInport3_idx_2 || rtb_y_aw1_tmp)) ||
      ...
      rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>((rtb_Compare_bj && rtb_y_l4) || (rtb_y_c && (rtb_NOT_k ||
      (rtb_GreaterThan3 && rtb_y_ii)))) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ma];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_bj = (rtb_Compare_bj && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_h, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_n, &rtb_y_ghj);
    rtb_GreaterThan3 = (rtb_y_ce > rtb_y_ghj);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_j4, &rtb_y_ghj);
    FmgcComputer_MATLABFunction_g((rtb_y_ghj > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode_isRisingEdge_bg, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_dfk);
    rtb_y_b0 = (rtb_y_pq || (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_j4,
      &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_dd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_d, &rtb_y_ghj);
    Memory_PreviousInput_k_tmp_tmp = (rtb_y_c && FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible &&
      rtb_y_ks);
    rtb_y_mu = ((rtb_Compare_bj && rtb_y_l4) || (Memory_PreviousInput_k_tmp_tmp && (rtb_appInop_idx_2 &&
      rtb_ap_fd_condition_tmp_0) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
      ...
      ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed && rtb_y_b0) || (rtb_y_pq && ((!rtb_y_nt) || (rtb_y_nt &&
      (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed) && (rtb_OR_bg || (std::abs(rtb_altCstrOrFcu - rtb_y_ghj) >
      FmgcComputer_P.CompareToConstant2_const_a))))))));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_fc,
      FmgcComputer_P.ConfirmNode_timeDelay_nn, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_ir);
    rtb_GreaterThan3_tmp = (absVsTarget_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_ec = FmgcComputer_P.Logic_table_kw[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_GreaterThan3_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_pq))) + (static_cast<uint32_T>(rtb_y_mu) <<
      1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ec];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_cq, &rtb_DataTypeConversion1_e);
    rtb_Compare_bj = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_nh, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_mc, &rtb_y_ghj);
    rtb_GreaterThan3 = (rtb_y_ce < rtb_y_ghj);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_nq, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_f, &rtb_y_mu,
      &FmgcComputer_DWork.sf_MATLABFunction_mrk);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_k, &rtb_y_ghj);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_l4) || (rtb_y_c && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant1_Value_c) && (FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant2_Value_pi) && rtb_GreaterThan3 && rtb_Compare_d0 &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_i2 || (rtb_y_mu && rtb_y_nt && (rtb_AND_iz &&
      (std::abs(rtb_altCstrOrFcu - rtb_y_ghj) <= FmgcComputer_P.CompareToConstant2_const_e)))))));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_cj, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_b, &rtb_y_ghj);
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he[(((rtb_appCapability_idx_2 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active || (rtb_y_ce > rtb_y_ghj) || rtb_y_fd ||
      ((FmgcComputer_P.EnumeratedConstant_Value_b == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant6_Value)) || rtb_y_aw1_tmp ||
      (rtb_y_nt && rtb_OR_bg) || rtb_Logic_gj_idx_0_tmp) + (static_cast<uint32_T>(rtb_Compare_bj) << 1)) << 1) +
    ...
    rtb_Compare_bj = (rtb_Compare_bj && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mo, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b5, &rtb_y_ghj);
    rtb_y_ii = (rtb_y_ce < rtb_y_ghj);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_fq,
      &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_kd);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_m, &rtb_y_ghj);
    rtb_y_mu = ((rtb_Compare_bj && rtb_y_l4) || (Memory_PreviousInput_k_tmp_tmp && (rtb_ap_fd_condition_tmp_0 &&
      rtb_appInop_idx_2 && rtb_y_ky && rtb_GreaterThan3_tmp_1 && rtb_OR2_l_tmp && rtb_Compare_kg) && rtb_Compare_d0 &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_ii && ((FmgcComputer_P.EnumeratedConstant_Value_m
      != FmgcComputer_U.in.fms_inputs.fms_flight_phase) && (FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE_n)) || (rtb_y_pq &&
      ((!rtb_y_nt) || (rtb_y_nt && (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.des_armed) && (rtb_OR_bg || (std::abs
      (rtb_altCstrOrFcu - rtb_y_ghj) > FmgcComputer_P.CompareToConstant2_const_l))))))));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_j,
      FmgcComputer_P.ConfirmNode_timeDelay_dy, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_n5);
    rtb_appCapability_idx_2 = (absVsTarget_tmp_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active);
    rtb_y_ky = (rtb_appCapability_idx_2 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    FmgcComputer_DWork.Memory_PreviousInput_b3 = FmgcComputer_P.Logic_table_cv[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_ky ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
    ...
    rtb_Compare_bj = (rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U));
    rtb_NOT_k = rtb_appInop_idx_2;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ht, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d2, &rtb_y_ghj);
    rtb_GreaterThan3 = (rtb_y_ce > rtb_y_ghj);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel4_bit_d, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_n, &rtb_y_mu,
      &FmgcComputer_DWork.sf_MATLABFunction_f0h);
    rtb_y_i2 = rtb_TmpSignalConversionAtSFunctionInport3_idx_2;
    rtb_y_fd = rtb_y_aw1_tmp;
    rtb_y_b0 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && rtb_y_b0),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_jo, FmgcComputer_P.ConfirmNode_timeDelay_jo,
      &rtb_y_b0, &FmgcComputer_DWork.sf_MATLABFunction_moh);
    rtb_y_ii = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
                 ((FmgcComputer_P.EnumeratedConstant_Value_c == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                  ...
                  rtb_TmpSignalConversionAtSFunctionInport3_idx_2 || rtb_y_aw1_tmp)) || rtb_y_b0);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_e, &rtb_y_ghj);
    FmgcComputer_MATLABFunction_g((rtb_y_ghj > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode1_isRisingEdge_g, &rtb_y_i2, &FmgcComputer_DWork.sf_MATLABFunction_lva);
    rtb_y_b0 = (rtb_y_mu || rtb_y_ii || (rtb_y_i2 && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 || rtb_y_aw1_tmp)));
    rtb_y_mu = ((rtb_Compare_bj && rtb_y_l4) || (Memory_PreviousInput_k_tmp_tmp && rtb_appInop_idx_2 && rtb_GreaterThan3
      && rtb_y_b0));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ca,
      FmgcComputer_P.ConfirmNode_timeDelay_ib, &rtb_NOT_k, &FmgcComputer_DWork.sf_MATLABFunction_go);
    FmgcComputer_DWork.Memory_PreviousInput_ae = FmgcComputer_P.Logic_table_jq[(((rtb_Logic_gj_idx_0_tmp ||
      ((rtb_GreaterThan3_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_NOT_k))) + (static_cast<uint32_T>(rtb_y_mu) <<
      1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ae];
    rtb_OR2_l_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ae && rtb_y_ii);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_NOT_k = rtb_appInop_idx_2;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_i, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_dp, &rtb_y_ghj);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel4_bit_i, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_f, &rtb_y_ii,
    ...
    FmgcComputer_MATLABFunction_a((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active &&
      ...
      FmgcComputer_P.ConfirmNode_isRisingEdge_fq, FmgcComputer_P.ConfirmNode_timeDelay_lp, &rtb_y_b0,
      &FmgcComputer_DWork.sf_MATLABFunction_hj);
    rtb_y_ii = (rtb_y_ii || rtb_y_b0);
    rtb_y_mu = ((rtb_Compare_bj && rtb_y_l4) || (Memory_PreviousInput_k_tmp_tmp && rtb_appInop_idx_2 && (rtb_y_ce <
      rtb_y_ghj) && rtb_y_ii));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ep,
      FmgcComputer_P.ConfirmNode_timeDelay_ob, &rtb_NOT_k, &FmgcComputer_DWork.sf_MATLABFunction_khd);
    FmgcComputer_DWork.Memory_PreviousInput_ev = FmgcComputer_P.Logic_table_lw[(((rtb_Logic_gj_idx_0_tmp || ((rtb_y_ky ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
    ...
    rtb_y_mu = rtb_y_c;
    FmgcComputer_MATLABFunction_g((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_b, &rtb_y_ii,
      &FmgcComputer_DWork.sf_MATLABFunction_pe);
    FmgcComputer_MATLABFunction_g(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed,
      FmgcComputer_P.PulseNode_isRisingEdge_lz, &rtb_y_mu, &FmgcComputer_DWork.sf_MATLABFunction_iv);
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c && (rtb_y_ii && rtb_y_m5 && rtb_ap_fd_condition_tmp_0)))
      << 1) + (rtb_y_mu || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
    ...
    rtb_NOT_k = rtb_y_a0_tmp;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_g, &rtb_y_ghj);
    FmgcComputer_LagFilter(rtb_y_ghj, FmgcComputer_P.LagFilter_C1, FmgcComputer_U.in.time.dt,
      &rtb_DataTypeConversion2_kb, &FmgcComputer_DWork.sf_LagFilter_k);
    if (rtb_y_ghj < 0.0F) {
      rtb_Nosewheel_c = -rtb_y_ghj;
    } else {
      rtb_Nosewheel_c = rtb_y_ghj;
    }

    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_mu);
    rtb_y_mu = (rtb_y_c && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_y_a0_tmp &&
      ...
      FmgcComputer_P.CompareToConstant1_const_n2)) || (rtb_Nosewheel_c < FmgcComputer_P.CompareToConstant2_const_iq)) &&
                rtb_y_mu);
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || rtb_y_mu);
    FmgcComputer_MATLABFunction_a(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_g,
      FmgcComputer_P.ConfirmNode_timeDelay_a3g, &rtb_y_mu, &FmgcComputer_DWork.sf_MATLABFunction_bs);
    rtb_y_pq = (rtb_appCapability_idx_2 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_nu = FmgcComputer_P.Logic_table_d3[(((((!rtb_y_mu) && (rtb_y_pq ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Memory_PreviousInput_nu, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_gr, FmgcComputer_P.ConfirmNode_timeDelay_m, &rtb_NOT_k,
      &FmgcComputer_DWork.sf_MATLABFunction_muf);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_k, &rtb_y_ghj);
    if (rtb_y_ghj < 0.0F) {
      rtb_DataTypeConversion1_d = -rtb_y_ghj;
    } else {
      rtb_DataTypeConversion1_d = rtb_y_ghj;
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_c && rtb_NOT_k &&
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_o,
      FmgcComputer_P.ConfirmNode_timeDelay_mu, &rtb_y_mu, &FmgcComputer_DWork.sf_MATLABFunction_db);
    rtb_y_pq = (rtb_y_pq || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active);
    FmgcComputer_DWork.Memory_PreviousInput_as = FmgcComputer_P.Logic_table_fi[(((((!rtb_y_mu) && (rtb_y_pq ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_NOT_k = FmgcComputer_DWork.Memory_PreviousInput_n0;
    rtb_y_mu = (rtb_y_c && rtb_NOT1_i);
    FmgcComputer_DWork.Memory_PreviousInput_n0 = FmgcComputer_P.Logic_table_id[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4) || (rtb_y_mu && FmgcComputer_U.in.discrete_inputs.tcas_ta_display))
      << 1) + ((!FmgcComputer_U.in.discrete_inputs.tcas_ta_display) || rtb_y_lh ||
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_i,
      &rtb_NOT_k, &FmgcComputer_DWork.sf_MATLABFunction_owv);
    rtb_y_mu = ((rtb_Compare_bj && rtb_y_l4) || (rtb_y_mu && rtb_NOT_k));
    rtb_Compare_bj = rtb_Logic_gj_idx_0_tmp;
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_jj,
      FmgcComputer_P.ConfirmNode_timeDelay_ae, &rtb_Compare_bj, &FmgcComputer_DWork.sf_MATLABFunction_jrd);
    absVsTarget = static_cast<int32_T>(((((rtb_Logic_gj_idx_0_tmp || (rtb_y_pq ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      ...
      (rtb_y_mu) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_i5);
    ...
    rtb_Compare_bj = (rtb_DataTypeConversion1_e == 0U);
    rtb_y_mu = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed;
    FmgcComputer_DWork.Memory_PreviousInput_h = FmgcComputer_P.Logic_table_oq[((((std::abs(FmgcComputer_B.u_lyj -
      rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_gh) || rtb_Compare_bj || rtb_y_mu) +
      (static_cast<uint32_T>(rtb_NOT_gj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_h];
    FmgcComputer_DWork.Memory_PreviousInput_cp = FmgcComputer_P.Logic_table_dj[(((static_cast<uint32_T>
      ((FmgcComputer_P.EnumeratedConstant1_Value_eq == FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode) &&
       Memory_PreviousInput_k_tmp_tmp_tmp) << 1) + (rtb_y_mu || rtb_Compare_bj)) << 1) +
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_bw, &rtb_y_ghj);
    rtb_y_js = rtb_y_ghj + FmgcComputer_P.Bias_Bias_m;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jb, &rtb_y_ce);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_e, &rtb_y_ghj);
    rtb_NOT_k = (rtb_y_ce < rtb_y_ghj + FmgcComputer_P.Bias1_Bias_c);
    ...
    rtb_y_mu = (rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k);
    Memory_PreviousInput_k_tmp_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ec ||
      FmgcComputer_DWork.Memory_PreviousInput_ae ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_y_mu = ((rtb_y_mu && Memory_PreviousInput_k_tmp_tmp && (rtb_y_js < rtb_y_ce)) || (rtb_y_mu && rtb_NOT_k &&
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ds_logic_ir_computation_data_flight_path_angle_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_i, &rtb_y_ab);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pc, &rtb_y_jv);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ds_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_g, &rtb_y_ki);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_d, &rtb_y_ghj);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_b, &rtb_y_js);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_kc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_f, &rtb_y_ce);
    rtb_appInop_idx_2 = (rtb_AND12 || rtb_GreaterThan3_tmp_0);
    if (rtb_AND12) {
      rtb_DataTypeConversion2_bh = rtb_y_ki - rtb_y_jv;
      rtb_Phi_c_deg = 50.0;
    } else {
      rtb_DataTypeConversion2_bh = rtb_y_ab - rtb_DataTypeConversion2_bh;
      rtb_Phi_c_deg = 0.1;
    }

    rtb_Compare_bj = (rtb_Logic_a2[0] && rtb_appInop_idx_2);
    rtb_y_m5 = ((rtb_Compare_bj && (rtb_y_ce < rtb_y_ghj + 3.0F) && (rtb_DataTypeConversion2_bh < -rtb_Phi_c_deg)) ||
                (rtb_Compare_bj && (rtb_y_ce > rtb_y_js - 3.0F) && (rtb_DataTypeConversion2_bh > rtb_Phi_c_deg)));
    FmgcComputer_MATLABFunction_j((rtb_y_m5 || rtb_y_mu || rtb_OR2_l_tmp || rtb_NOT3_tmp || Memory_PreviousInput_d_tmp),
      FmgcComputer_U.in.time.dt, &rtb_NOT_k, FmgcComputer_P.MTrigNode2_isRisingEdge_p,
    ...
    FmgcComputer_MATLABFunction_g(rtb_OR2_l, FmgcComputer_P.PulseNode_isRisingEdge_fo, &rtb_y_mu,
      &FmgcComputer_DWork.sf_MATLABFunction_h0f);
    rtb_OR_bg = !rtb_Logic_ac[0];
    rtb_Compare_bj = (rtb_y_mu && rtb_OR_bg);
    FmgcComputer_MATLABFunction_j((rtb_NOT3_tmp || rtb_Compare_bj), FmgcComputer_U.in.time.dt, &rtb_y_mu,
    ...
    FmgcComputer_MATLABFunction_j((Memory_PreviousInput_d_tmp || rtb_Compare_bj), FmgcComputer_U.in.time.dt,
    ...
    rtb_ap_fd_condition_tmp_0 = rtb_NOT_k;
    rtb_fmgcOppPriority_tmp = rtb_y_mu;
    rtb_y_a0_tmp = rtb_Compare_bj;
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_fd);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_pq);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_a(FmgcComputer_DWork.Memory_PreviousInput_i1, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode1_isRisingEdge_a, FmgcComputer_P.ConfirmNode1_timeDelay_b, &rtb_y_mu,
    ...
    rtb_y_mu = (rtb_y_mu || rtb_Compare_bj);
    rtb_NOT_k = rtb_Compare_ov;
    rtb_Compare_bj = (rtb_Compare_bj || rtb_y_e || ((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_c) &&
      rtb_Compare_ov));
    rtb_y_mu = ((rtb_y_fd || rtb_y_pq || (rtb_DataTypeConversion1_e != 0U)) && rtb_y_mu && rtb_Compare_bj);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_pq, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_NOT_k,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bw = FmgcComputer_P.Logic_table_bs[((((!rtb_Compare_bj) || rtb_y_m3u ||
      rtb_AND9 || FmgcComputer_DWork.Memory_PreviousInput_ip || rtb_NOT_k || rtb_GreaterThan3) + (static_cast<uint32_T>
      (rtb_y_mu) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_bw];
    ...
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4);
    rtb_y_mu = rtb_y_c;
    ...
    FmgcComputer_MATLABFunction_g(rtb_GreaterThan3, FmgcComputer_P.PulseNode3_isRisingEdge_ko, &rtb_y_fd,
      &FmgcComputer_DWork.sf_MATLABFunction_od);
    FmgcComputer_MATLABFunction_g(rtb_OR2_l, FmgcComputer_P.PulseNode1_isRisingEdge_kl, &rtb_y_mu,
      &FmgcComputer_DWork.sf_MATLABFunction_dtd);
    rtb_NOT_k = (FmgcComputer_U.in.fms_inputs.fms_flight_phase != FmgcComputer_P.EnumeratedConstant_Value_ad);
    rtb_y_mu = (rtb_y_mu && rtb_NOT_k);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_f,
      &rtb_NOT_k, &FmgcComputer_DWork.sf_MATLABFunction_d5);
    rtb_NOT_k = (rtb_NOT_k && rtb_y_ks);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_ks_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_a, &rtb_y_ghj);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mh, &rtb_y_ce);
    rtb_appCapability_idx_2 = !FmgcComputer_DWork.Memory_PreviousInput_k;
    rtb_GreaterThan3 = (FmgcComputer_U.in.fms_inputs.preset_spd_mach_activate && (rtb_appCapability_idx_2 || (rtb_y_ghj <=
      rtb_y_ce)));
    FmgcComputer_MATLABFunction_g((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant1_const_e), FmgcComputer_P.PulseNode4_isRisingEdge_a, &rtb_y_i2,
      &FmgcComputer_DWork.sf_MATLABFunction_aag);
    rtb_y_ii = rtb_OR_m4;
    rtb_Compare_ov = !FmgcComputer_DWork.Memory_PreviousInput_i;
    rtb_y_b0 = (rtb_appCapability_idx_2 && rtb_Compare_ov && (!FmgcComputer_DWork.Memory_PreviousInput_nu) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_as) && (!FmgcComputer_DWork.Memory_PreviousInput_d));
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode7_isRisingEdge, &rtb_y_ii,
      &FmgcComputer_DWork.sf_MATLABFunction_itu);
    rtb_y_fd = (rtb_Compare_bj || (rtb_y_c && (((FmgcComputer_P.Constant_Value_k !=
      FmgcComputer_DWork.DelayInput1_DSTATE_f) && rtb_OR_m4) || ((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant_const_dy) && rtb_y_fd && rtb_y_b0) || rtb_y_mu || rtb_NOT_k || rtb_GreaterThan3 ||
      (rtb_y_i2 && rtb_OR_m4 && rtb_y_b0) || rtb_y_ii)));
    FmgcComputer_MATLABFunction_a(rtb_y_fd, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ch,
    ...
    FmgcComputer_MATLABFunction_g(rtb_BusAssignment_h_logic_engine_running, FmgcComputer_P.PulseNode6_isRisingEdge_j,
      &rtb_y_mu, &FmgcComputer_DWork.sf_MATLABFunction_abn);
    FmgcComputer_MATLABFunction_g(rtb_OR2_l, FmgcComputer_P.PulseNode5_isRisingEdge_i, &rtb_NOT_k,
      &FmgcComputer_DWork.sf_MATLABFunction_kzm);
    FmgcComputer_DWork.Memory_PreviousInput_cu = FmgcComputer_P.Logic_table_kg
      [((((FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active && (!rtb_Compare_bj)) || (rtb_y_e && (rtb_y_mu ||
            rtb_NOT_k))) + (static_cast<uint32_T>(rtb_y_fd) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cu];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_5,
      FmgcComputer_P.BitfromLabel_bit_kq, &rtb_DataTypeConversion1_e);
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_l4);
    FmgcComputer_MATLABFunction_g(rtb_OR2_l, FmgcComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_ii,
      &FmgcComputer_DWork.sf_MATLABFunction_ab);
    rtb_y_mu = (FmgcComputer_U.in.fms_inputs.v_2_kts != FmgcComputer_P.CompareToConstant_const_e);
    FmgcComputer_MATLABFunction_g(rtb_BusAssignment_h_logic_engine_running, FmgcComputer_P.PulseNode5_isRisingEdge_b,
      &rtb_NOT_k, &FmgcComputer_DWork.sf_MATLABFunction_hkc);
    FmgcComputer_MATLABFunction_g(rtb_y_mu, FmgcComputer_P.PulseNode2_isRisingEdge_iu, &rtb_GreaterThan3,
      &FmgcComputer_DWork.sf_MATLABFunction_ft);
    rtb_GreaterThan3 = (rtb_OR2_l && rtb_GreaterThan3);
    rtb_NOT_k = ((rtb_y_ii && rtb_y_mu) || (rtb_NOT_k && rtb_y_mu && rtb_OR2_l) || rtb_GreaterThan3);
    rtb_y_fd = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_g(rtb_y_fd, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_ii,
      &FmgcComputer_DWork.sf_MATLABFunction_mrn);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ie, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_g((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_jp, &rtb_y_b0,
    ...
    rtb_y_mu = ((rtb_y_e && rtb_NOT_k) || (rtb_y_ii || rtb_y_b0 || rtb_GreaterThan3));
    rtb_NOT_k = (FmgcComputer_U.in.fms_inputs.v_managed_kts != FmgcComputer_P.CompareToConstant2_const_m);
    rtb_GreaterThan3 = (FmgcComputer_U.in.fms_inputs.v_2_kts != FmgcComputer_P.CompareToConstant3_const_j);
    rtb_y_mu = (rtb_Compare_bj || (rtb_y_c && rtb_y_mu && (rtb_NOT_k || rtb_GreaterThan3)));
    FmgcComputer_MATLABFunction_a(rtb_y_mu, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_h2,
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_U.in.fms_inputs.v_2_kts == FmgcComputer_P.CompareToConstant5_const_h),
      FmgcComputer_P.PulseNode7_isRisingEdge_c, &rtb_NOT_k, &FmgcComputer_DWork.sf_MATLABFunction_hpe);
    FmgcComputer_DWork.Memory_PreviousInput_hk = FmgcComputer_P.Logic_table_ds
      [((((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && (!rtb_Compare_bj)) || (rtb_y_e &&
           (rtb_Compare_ov && rtb_appCapability_idx_2 && rtb_y_oi) && (rtb_GreaterThan3 || rtb_NOT_k))) + (static_cast<
          uint32_T>(rtb_y_mu) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_hk];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_adr_computation_data_corrected_average_static_pressure,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_b, &rtb_y_ghj);
    rtb_y_jv = std::pow((std::pow(FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach.Data *
      FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach.Data * 0.2F + 1.0F, 3.5F) - 1.0F) * (rtb_y_ghj / 1013.25F) +
                        1.0F, 0.285714298F);
    if (rtb_y_oi) {
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_cz, &rtb_y_ab);
    if (!FmgcComputer_DWork.vMemoEo_not_empty) {
      FmgcComputer_DWork.vMemoEo = rtb_y_ki;
      FmgcComputer_DWork.vMemoEo_not_empty = true;
    }

    if (!FmgcComputer_DWork.vMemoGa_not_empty) {
      FmgcComputer_DWork.vMemoGa = rtb_y_ki;
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_i) {
      ...
      rtb_Nosewheel_c = rtb_y_ab - 5.0;
      if (rtb_y_ab - 5.0 > rtb_Phi_c_deg) {
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_hk) {
      if (FmgcComputer_DWork.Memory_PreviousInput_d || FmgcComputer_DWork.Memory_PreviousInput_l ||
        ...
        rtb_Switch_e[0] = std::fmax(std::fmax(std::fmax(static_cast<real_T>(rtb_y_ghj), static_cast<real_T>(rtb_y_ce)),
          static_cast<real_T>(rtb_y_js)), FmgcComputer_B.u_l);
      ...
      if (FmgcComputer_DWork.Delay_DSTATE_c) {
        rtb_y_ce = std::sqrt(rtb_y_jv - 1.0F) * 1479.1F;
      } else {
        rtb_y_ce = FmgcComputer_U.in.bus_inputs.fcu_bus.selected_spd_kts.Data;
      }

      rtb_Switch_e[0] = rtb_y_ce;
      rtb_Switch_e[1] = rtb_y_ce;
    }
    ...
    FmgcComputer_MATLABFunction_a(rtb_Compare_ov, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_i,
      FmgcComputer_P.ConfirmNode1_timeDelay_df, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_hi);
    FmgcComputer_MATLABFunction_a((rtb_Phi_c_deg > FmgcComputer_P.CompareToConstant1_const_c), FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode2_isRisingEdge_i, FmgcComputer_P.ConfirmNode2_timeDelay_i, &rtb_y_ky,
      &FmgcComputer_DWork.sf_MATLABFunction_oe);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_g, &rtb_y_ab);
    rtb_Phi_c_deg = rtb_y_ab;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_mz, &rtb_DataTypeConversion1_e);
    rtb_y_mu = ((!rtb_Compare_bj) || rtb_y_pq || rtb_y_ky || (rtb_Max_a > rtb_y_ab + FmgcComputer_P.Bias_Bias) ||
                (rtb_DataTypeConversion1_e != 0U));
    FmgcComputer_MATLABFunction_a((rtb_Compare_bj && (!rtb_Compare_ov) && (!rtb_y_mu)), FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_dh, FmgcComputer_P.ConfirmNode_timeDelay_mf, &rtb_y_ky,
      &FmgcComputer_DWork.sf_MATLABFunction_nj);
    absVsTarget = static_cast<int32_T>((((static_cast<uint32_T>(rtb_y_ky) << 1) + rtb_y_mu) << 1) +
    ...
    rtb_y_mu = (rtb_appInop_idx_2 || FmgcComputer_DWork.Memory_PreviousInput_cb ||
    ...
    rtb_Compare_ov = (rtb_y_n || FmgcComputer_DWork.Memory_PreviousInput_el ||
                      FmgcComputer_DWork.Memory_PreviousInput_cv || FmgcComputer_DWork.Memory_PreviousInput_lq ||
                      rtb_y_m3u || rtb_AND9 || FmgcComputer_DWork.Memory_PreviousInput_ip ||
                      FmgcComputer_DWork.Memory_PreviousInput_d);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4, &rtb_y_fd);
    rtb_Compare_bj = ((rtb_Compare_bj || ((rtb_DataTypeConversion1_e != 0U) && rtb_y_fd)) &&
                      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged);
    rtb_y_fd = (rtb_Logic_a2[0] && (FmgcComputer_DWork.Memory_PreviousInput_l ||
      FmgcComputer_DWork.Memory_PreviousInput_d));
    rtb_GreaterThan3 = ((!fdOppOff) && (FmgcComputer_U.in.discrete_inputs.fwc_own_valid ||
    ...
    rtb_y_ky = (rtb_GreaterThan3 && (!rtb_ap_fd_condition_tmp) && rtb_bothRaValid);
    rtb_y_pq = (FmgcComputer_U.in.discrete_inputs.fwc_own_valid && FmgcComputer_U.in.discrete_inputs.fwc_opp_valid &&
                FmgcComputer_U.in.discrete_inputs.powersupply_split && FmgcComputer_U.in.discrete_inputs.pfd_own_valid &&
                FmgcComputer_U.in.discrete_inputs.pfd_opp_valid && rtb_TmpSignalConversionAtSFunctionInport3_idx_0 &&
                rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && rtb_bothRaValid &&
                ...
                rtb_irOwnInvalid);
    rtb_appCapability_idx_2 = (FmgcComputer_DWork.pLand3FailOp || (rtb_y_pq && rtb_y_fd && rtb_Compare_bj &&
      FmgcComputer_DWork.Delay_DSTATE_k));
    rtb_y_i2 = !rtb_appCapability_idx_2;
    rtb_NOT_k = (FmgcComputer_DWork.pLand3FailPass || (rtb_y_ky && rtb_y_fd && FmgcComputer_DWork.Delay_DSTATE_k &&
      rtb_y_i2));
    rtb_y_i2 = (rtb_GreaterThan3 && rtb_y_fd && (!rtb_NOT_k) && rtb_y_i2);
    rtb_GreaterThan3 = !rtb_GreaterThan3;
    rtb_y_ky = !rtb_y_ky;
    rtb_appInop_idx_2 = !rtb_y_pq;
    if ((rtb_raComputationData < 100.0F) && (rtb_y_fd || rtb_Compare_bj)) {
      FmgcComputer_DWork.pLand3FailOp = rtb_appCapability_idx_2;
      FmgcComputer_DWork.pLand3FailPass = rtb_NOT_k;
    } else {
      FmgcComputer_DWork.pLand3FailOp = false;
      FmgcComputer_DWork.pLand3FailPass = false;
    }
    ...
    if (rtb_Logic_a2[0] && FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) {
      if (FmgcComputer_U.in.discrete_inputs.is_unit_1) {
        rtb_TmpSignalConversionAtSFunctionInport3_idx_0 = rtb_y_i2;
        rtb_TmpSignalConversionAtSFunctionInport3_idx_1 = rtb_NOT_k;
    ...
    rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg.Data =
      rtb_Switch_i_glideslope_deviation_deg_Data;
    FmgcComputer_DWork.Delay_DSTATE.any_longitudinal_mode_engaged = rtb_y_mu;
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_estimated_sideslip_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_h, &rtb_y_ce);
    rtb_DataTypeConversion27 = rtb_y_ce;
    ...
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_oi);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_p, &rtb_y_js);
    rtb_DataTypeConversion32 = rtb_y_js;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_i, &rtb_y_jv);
    rtb_DataTypeConversion26 = rtb_y_jv;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_j, &rtb_y_ghj);
    rtb_DataTypeConversion39 = rtb_y_ghj;
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fc, &rtb_y_ab);
    if (rtb_Logic_ac[0]) {
      rtb_Switch1 = rtb_BusAssignment_hk_ap_fd_logic_tcas_vs_target;
    } else if (FmgcComputer_DWork.Memory_PreviousInput_b3) {
      rtb_Switch1 = FmgcComputer_U.in.fms_inputs.vs_target_ft_min;
    } else {
      rtb_Switch1 = rtb_y_ab;
    }

    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_f, &rtb_y_ki);
    if (FmgcComputer_DWork.Memory_PreviousInput_b3) {
      rtb_Switch3 = FmgcComputer_U.in.fms_inputs.vs_target_ft_min;
    } else {
      rtb_Switch3 = rtb_y_ki;
    }

    rtb_y_fd = (FmgcComputer_DWork.Memory_PreviousInput_as || FmgcComputer_DWork.Memory_PreviousInput_d);
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_DataTypeConversion_cm,
                    ...
                    &FmgcComputer_P.Constant_Value_i, &rtb_DataTypeConversion25, &rtb_y_oi, &rtb_DataTypeConversion23,
    ...
    FmgcComputer_MATLABFunction_a(rtb_Logic_ac[0], FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_oa,
      FmgcComputer_P.ConfirmNode_timeDelay_a0, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_a);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_p, &rtb_DataTypeConversion2_bh);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_k, &rtb_y_ce);
    FmgcComputer_MATLABFunction_g(rtb_Logic_ac[0], FmgcComputer_P.PulseNode3_isRisingEdge_l4, &rtb_y_b0,
      &FmgcComputer_DWork.sf_MATLABFunction_g);
    absVsTarget = static_cast<int32_T>((((rtb_OR_bg || (rtb_y_pq && ((rtb_DataTypeConversion2_bh <
      FmgcComputer_P.CompareToConstant_const_j) || (rtb_y_ce < FmgcComputer_P.CompareToConstant1_const_d)))) + (
      static_cast<uint32_T>(rtb_y_b0) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_j);
    ...
    FmgcComputer_MATLABFunction_g((FmgcComputer_P.Logic_table_lwo[static_cast<uint32_T>(absVsTarget) + 8U] && (rtb_y_jm
      != 0U)), FmgcComputer_P.PulseNode3_isRisingEdge_ng, &rtb_y_ii, &FmgcComputer_DWork.sf_MATLABFunction_k);
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_y_ii) << 1)
      + rtb_y_ea) << 1) + FmgcComputer_DWork.Memory_PreviousInput_hu];
    rtb_BusAssignment_b_logic_ra_computation_data_ft = rtb_Switch1_a;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_hw, &rtb_y_ce);
    rtb_y_oi = (rtb_y_ce >= FmgcComputer_P.CompareToConstant_const_hq);
    rtb_y_fd = (rtb_y_ce <= FmgcComputer_P.CompareToConstant2_const_di);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o2, &rtb_y_ce);
    rtb_y_pq = (rtb_y_ce >= FmgcComputer_P.CompareToConstant1_const_h4);
    rtb_y_ii = (rtb_y_ce <= FmgcComputer_P.CompareToConstant3_const_d);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_b0);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_nt);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_k, &rtb_y_ce);
    rtb_Compare_d0 = (rtb_y_ce > FmgcComputer_P.CompareToConstant4_const_p);
    rtb_Compare_kg = (rtb_y_ce <= FmgcComputer_P.CompareToConstant6_const_h);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_l, &rtb_y_ce);
    rtb_DataTypeConversion_cm = rtb_Product_p2;
    rtb_y_ii = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_oi &&
      rtb_y_fd && rtb_y_pq && rtb_y_ii) || ((!rtb_y_b0) && (!rtb_y_nt) && rtb_BusAssignment_h_logic_one_engine_out &&
      (rtb_Compare_d0 && rtb_Compare_kg && (rtb_y_ce > FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_ce <=
      FmgcComputer_P.CompareToConstant7_const)))));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_m, &rtb_y_ce);
    rtb_Switch1_a = rtb_y_ce;
    rtb_y_oi = (rtb_y_ce < FmgcComputer_P.CompareToConstant8_const);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_fk, &rtb_y_ce);
    rtb_y_b0 = (rtb_y_ii && ((rtb_Switch1_a < FmgcComputer_P.CompareToConstant10_const) || (rtb_y_ce <
      FmgcComputer_P.CompareToConstant11_const) || (rtb_BusAssignment_h_logic_one_engine_out && (rtb_y_oi || (rtb_y_ce <
    ...
    FmgcComputer_MATLABFunction_g((((rtb_active_longitudinal_law == vertical_law::SPD_MACH) ||
      ...
      FmgcComputer_DWork.Delay_DSTATE_k), FmgcComputer_P.PulseNode_isRisingEdge_o, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_j);
    rtb_y_oi = !FmgcComputer_DWork.Memory_PreviousInput_hu;
    rtb_y_fd = (((rtb_y_jm != 0U) && rtb_y_l4) || (rtb_y_c && rtb_y_pq && rtb_y_oi));
    FmgcComputer_MATLABFunction_a(rtb_y_fd, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_b,
      FmgcComputer_P.ConfirmNode_timeDelay_gu, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_ay);
    rtb_y_nt = (FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active ||
                FmgcComputer_DWork.Delay1_DSTATE.retard_mode_active);
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_ea || ((rtb_y_nt ||
      FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_pq))) + (static_cast<uint32_T>(rtb_y_fd) << 1))
    ...
    FmgcComputer_MATLABFunction_g(((((rtb_active_longitudinal_law == vertical_law::NONE) &&
      ...
      rtb_Logic_b[0]))) && FmgcComputer_DWork.Delay_DSTATE_k), FmgcComputer_P.PulseNode_isRisingEdge_fz, &rtb_y_pq,
      &FmgcComputer_DWork.sf_MATLABFunction_ge);
    rtb_OR_m4 = (((rtb_y_jm != 0U) && rtb_y_l4) || (rtb_y_c && rtb_y_pq && rtb_y_oi));
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_k,
      FmgcComputer_P.ConfirmNode_timeDelay_ez, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_ig);
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_ea || ((rtb_y_nt ||
      FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active) && (!rtb_y_pq))) + (static_cast<uint32_T>(rtb_OR_m4) << 1)) <<
      1) + FmgcComputer_DWork.Memory_PreviousInput_cm];
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.ats_discrete_word,
      FmgcComputer_P.BitfromLabel_bit_hy, &rtb_y_jm);
    rtb_OR_m4 = (((rtb_y_jm != 0U) && rtb_y_l4) || (rtb_y_c && FmgcComputer_DWork.Memory_PreviousInput_d &&
      rtb_Logic_a2[0] && (rtb_raComputationData <= FmgcComputer_P.CompareToConstant_const_e3) && rtb_y_oi));
    FmgcComputer_MATLABFunction_a(rtb_OR_m4, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_cs,
      FmgcComputer_P.ConfirmNode_timeDelay_br, &rtb_y_pq, &FmgcComputer_DWork.sf_MATLABFunction_kh);
    FmgcComputer_DWork.Memory_PreviousInput_o = FmgcComputer_P.Logic_table_acc[(((rtb_y_ea ||
      ((FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active || FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active ||
        FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_pq))) + (static_cast<uint32_T>(rtb_OR_m4) <<
    ...
    FmgcComputer_DWork.Memory_PreviousInput_kr = FmgcComputer_P.Logic_table_b3[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_AND12 ||
        rtb_GreaterThan3_tmp_0) && rtb_Logic_gj_idx_0_tmp) << 1) + (rtb_BusAssignment_h_logic_one_engine_out || rtb_y_e ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_km = FmgcComputer_P.Logic_table_mj[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_AND12 ||
        rtb_GreaterThan3_tmp_0) && rtb_BusAssignment_h_logic_one_engine_out) << 1) + (rtb_Logic_gj_idx_0_tmp || rtb_y_e ||
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_l, &rtb_y_ce);
    rtb_y_c = !rtb_y_ii;
    rtb_y_j = athr_fma_message::NONE;
    rtb_y_oi = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_oi);
    if (rtb_y_oi && ((FmgcComputer_DWork.Memory_PreviousInput_kr && ((rtb_DataTypeConversion2_bh > rtb_y_ce +
            FmgcComputer_P.Bias_Bias_d) || (rtb_BusAssignment_hk_ap_fd_logic_tcas_vs_target <=
            FmgcComputer_P.CompareToConstant_const_eq) || rtb_OR_bg || (!rtb_y_c))) || (rtb_Logic_ac[0] && rtb_y_c &&
      ...
      rtb_y_j = athr_fma_message::LVR_CLB;
    } else if (rtb_y_oi && FmgcComputer_DWork.Memory_PreviousInput_km &&
      ...
      rtb_y_j = athr_fma_message::LVR_MCT;
    } else if (rtb_y_oi && rtb_Logic_gj_idx_0_tmp && (((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data
      > 24.0F) && (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 26.0F) &&
                ...
                ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 24.0F) &&
                 ...
                 ((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 26.0F))))) {
      rtb_y_j = athr_fma_message::LVR_ASYM;
    }
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_oi);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_fd);
    rtb_OR_bg = (rtb_y_oi || rtb_y_fd);
    rtb_y_eh = athr_fma_mode::NONE;
    rtb_y_oi = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_c);
    if (rtb_y_oi && (rtb_Max_a > 44.0F)) {
      rtb_y_eh = athr_fma_mode::MAN_TOGA;
    } else {
      rtb_y_fd = (rtb_y_oi && (rtb_Max_a > 34.0F) && (rtb_Max_a < 36.0F));
      if (rtb_y_fd && rtb_OR_bg) {
        rtb_y_eh = athr_fma_mode::MAN_FLEX;
      } else if (rtb_y_fd && (!rtb_OR_bg)) {
        rtb_y_eh = athr_fma_mode::MAN_MCT;
      } else if (rtb_y_oi && (rtb_Max_a > 24.0F)) {
        rtb_y_eh = athr_fma_mode::MAN_THR;
      } else {
        rtb_y_oi = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_ii);
        rtb_y_fd = (rtb_y_oi && FmgcComputer_DWork.Memory_PreviousInput_cm);
        if (rtb_y_fd && (!FmgcComputer_DWork.Delay_DSTATE_c)) {
          rtb_y_eh = athr_fma_mode::SPEED;
        } else if (rtb_y_fd && FmgcComputer_DWork.Delay_DSTATE_c) {
          rtb_y_eh = athr_fma_mode::MACH;
        } else {
          rtb_y_fd = (rtb_y_oi && FmgcComputer_DWork.Memory_PreviousInput_bh);
          rtb_Logic_gj_idx_0_tmp = !rtb_OR_m4;
          if (rtb_y_fd && (rtb_Max_a > 34.0F) && rtb_Logic_gj_idx_0_tmp) {
            rtb_y_eh = athr_fma_mode::THR_MCT;
          } else if (rtb_y_fd && (rtb_Max_a > 24.0F) && rtb_Logic_gj_idx_0_tmp) {
            rtb_y_eh = athr_fma_mode::THR_CLB;
          } else if (rtb_y_fd && (rtb_Max_a < 25.0F) && rtb_Logic_gj_idx_0_tmp) {
            rtb_y_eh = athr_fma_mode::THR_LVR;
          } else if (rtb_y_oi && ((FmgcComputer_DWork.Memory_PreviousInput_bh && rtb_OR_m4) ||
                                  FmgcComputer_DWork.Memory_PreviousInput_o)) {
            rtb_y_eh = athr_fma_mode::THR_IDLE;
          } else {
            rtb_y_oi = (rtb_y_oi && FmgcComputer_DWork.Memory_PreviousInput_hu);
            if (rtb_y_oi && (rtb_y_jm != 0U)) {
              rtb_y_eh = athr_fma_mode::A_FLOOR;
            } else if (rtb_y_oi && (rtb_y_jm == 0U)) {
              rtb_y_eh = athr_fma_mode::TOGA_LK;
            }
          }
        }
      }
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_km, &rtb_y_jv);
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_i, &rtb_y_ce);
    ...
    if (rtb_DataTypeConversion2_bh < static_cast<real32_T>(rtb_Switch_e[0])) {
      if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_ce) {
        high_i = 1;
      } else if (rtb_DataTypeConversion2_bh < rtb_y_ce) {
        high_i = 2;
      } else {
        high_i = 0;
      }
      ...
      high_i = 0;
    } else if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_ce) {
      high_i = 2;
    } else {
      high_i = 1;
    }

    rtb_DataTypeConversion2_bh = v[high_i] - rtb_y_jv;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
      FmgcComputer_P.A429ValueOrDefault11_defaultValue, &rtb_y_ce);
    rtb_DataTypeConversion1_d = FmgcComputer_P.Gain1_Gain_a * rtb_y_ce;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault10_defaultValue, &rtb_y_ce);
    rtb_DataTypeConversion8 = FmgcComputer_P.fpmtoms_Gain * rtb_y_ce;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_ground_speed_kn,
      FmgcComputer_P.A429ValueOrDefault8_defaultValue_i, &rtb_y_ce);
    rtb_Switch1_a = rtb_y_ce;
    rtb_DataTypeConversion2_i = FmgcComputer_P.kntoms_Gain * rtb_y_ce;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault12_defaultValue, &rtb_y_ce);
    rtb_Product_p2 = FmgcComputer_P.Gain1_Gain_h * rtb_y_ce;
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault13_defaultValue, &rtb_y_ce);
    rtb_DataTypeConversion5 = FmgcComputer_P.Gain1_Gain_f * rtb_y_ce;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_track_angle_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault14_defaultValue, &rtb_y_ce);
    ...
    if ((!FmgcComputer_DWork.pY_not_empty_b) || (!FmgcComputer_DWork.pU_not_empty_i)) {
      FmgcComputer_DWork.pU_i = rtb_DataTypeConversion6;
      FmgcComputer_DWork.pU_not_empty_i = true;
      FmgcComputer_DWork.pY_l = rtb_DataTypeConversion6;
      FmgcComputer_DWork.pY_not_empty_b = true;
    }

    rtb_DataTypeConversion7 = FmgcComputer_U.in.time.dt * FmgcComputer_P.WashoutFilter_C1;
    rtb_Product_p2 = rtb_DataTypeConversion7 + 2.0;
    rtb_Switch1_a = 2.0 / (rtb_DataTypeConversion7 + 2.0);
    FmgcComputer_DWork.pY_l = (2.0 - rtb_DataTypeConversion7) / (rtb_DataTypeConversion7 + 2.0) *
      FmgcComputer_DWork.pY_l + (rtb_DataTypeConversion6 * rtb_Switch1_a - FmgcComputer_DWork.pU_i * rtb_Switch1_a);
    FmgcComputer_DWork.pU_i = rtb_DataTypeConversion6;
    ...
    FmgcComputer_LeadLagFilter(FmgcComputer_DWork.pY_l - FmgcComputer_P.g_Gain * (FmgcComputer_P.Gain1_Gain_d *
      ...
      (FmgcComputer_P.Gain1_Gain_p * rtb_y_ce - rtb_DataTypeConversion5)))), FmgcComputer_P.HighPassFilter_C1,
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i2_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault9_defaultValue, &rtb_y_ce);
    if (rtb_y_ce > FmgcComputer_P.Saturation1_UpperSat_l) {
      rtb_Switch1_a = FmgcComputer_P.Saturation1_UpperSat_l;
    } else if (rtb_y_ce < FmgcComputer_P.Saturation1_LowerSat_i) {
    ...
    if ((!FmgcComputer_DWork.pY_not_empty_m) || (!FmgcComputer_DWork.pU_not_empty_l)) {
      ...
      FmgcComputer_DWork.pY_n = rtb_DataTypeConversion8;
      FmgcComputer_DWork.pY_not_empty_m = true;
    }

    rtb_DataTypeConversion7 = FmgcComputer_U.in.time.dt * FmgcComputer_P.LagFilter_C1_d;
    rtb_Switch1_a = rtb_DataTypeConversion7 / (rtb_DataTypeConversion7 + 2.0);
    FmgcComputer_DWork.pY_n = (2.0 - rtb_DataTypeConversion7) / (rtb_DataTypeConversion7 + 2.0) *
      FmgcComputer_DWork.pY_n + (rtb_DataTypeConversion8 * rtb_Switch1_a + FmgcComputer_DWork.pU * rtb_Switch1_a);
    FmgcComputer_DWork.pU = rtb_DataTypeConversion8;
    ...
    FmgcComputer_LagFilter(rtb_DataTypeConversion2_bh, FmgcComputer_P.LagFilter1_C1, FmgcComputer_U.in.time.dt,
      &rtb_y_ce, &FmgcComputer_DWork.sf_LagFilter_g);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
    ...
    rtb_Cos_h = rtb_y_ce - rtb_Cos_h / std::cos(FmgcComputer_P.Gain1_Gain_go * rtb_DataTypeConversion2_bh);
    ...
    rtb_DataTypeConversion7 = FmgcComputer_U.in.time.dt * FmgcComputer_P.WashoutFilter_C1_e;
    rtb_Switch1_a = 2.0 / (rtb_DataTypeConversion7 + 2.0);
    FmgcComputer_DWork.pY_e = static_cast<real32_T>((2.0 - rtb_DataTypeConversion7) / (rtb_DataTypeConversion7 + 2.0)) *
    ...
    if (FmgcComputer_U.in.sim_data.tracking_mode_on_override) {
      ...
      rtb_Switch1_a = ((FmgcComputer_P.Gain_Gain * rtb_DataTypeConversion1_d + FmgcComputer_DWork.pY_n) +
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_ea || rtb_y_c || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach, &rtb_y_ea);
    FmgcComputer_MATLABFunction_ie(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_spd_kts, &rtb_y_oi);
    FmgcComputer_MATLABFunction_ie(&rtb_BusAssignment_pw_logic_ils_computation_data_runway_heading_deg, &rtb_y_c);
    ...
    rtb_VectorConcatenate[16] = rtb_y_lh;
    rtb_VectorConcatenate[17] = rtb_ap_fd_condition_tmp_0;
    rtb_VectorConcatenate[18] = rtb_y_m5;
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_DataTypeConversion2_bh);
    ...
    rtb_VectorConcatenate[3] = rtb_y_ii;
    ...
    rtb_VectorConcatenate[14] = rtb_y_b0;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate, &rtb_y_jv);
    rtb_VectorConcatenate_bw[0] = (rtb_y_eh == athr_fma_mode::MAN_TOGA);
    rtb_VectorConcatenate_bw[1] = ((rtb_y_eh == athr_fma_mode::MAN_MCT) || (rtb_y_eh == athr_fma_mode::THR_MCT));
    rtb_VectorConcatenate_bw[2] = (rtb_y_eh == athr_fma_mode::MAN_FLEX);
    rtb_VectorConcatenate_bw[3] = (rtb_y_eh == athr_fma_mode::THR_CLB);
    rtb_VectorConcatenate_bw[4] = ((rtb_y_eh == athr_fma_mode::MAN_THR) || (rtb_y_eh == athr_fma_mode::THR_LVR));
    rtb_VectorConcatenate_bw[5] = (rtb_y_eh == athr_fma_mode::THR_IDLE);
    rtb_VectorConcatenate_bw[6] = (rtb_y_eh == athr_fma_mode::A_FLOOR);
    rtb_VectorConcatenate_bw[7] = (rtb_y_eh == athr_fma_mode::TOGA_LK);
    rtb_VectorConcatenate_bw[8] = (rtb_y_eh == athr_fma_mode::SPEED);
    rtb_VectorConcatenate_bw[9] = (rtb_y_eh == athr_fma_mode::MACH);
    rtb_VectorConcatenate_bw[10] = (rtb_y_j == athr_fma_message::LVR_ASYM);
    rtb_VectorConcatenate_bw[11] = (rtb_y_j == athr_fma_message::LVR_CLB);
    rtb_VectorConcatenate_bw[12] = (rtb_y_j == athr_fma_message::LVR_MCT);
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_bw, &rtb_y_js);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_fma_discrete_word.Data = rtb_y_js;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_bw, &rtb_y_js);
    rtb_VectorConcatenate_f[0] = Memory_PreviousInput_k_tmp_tmp;
    ...
    rtb_VectorConcatenate_f[13] = (rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_VectorConcatenate_f[14] = rtb_y_au;
    ...
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_f, &rtb_y_ce);
    rtb_VectorConcatenate_f[0] = rtb_y_n;
    ...
    rtb_VectorConcatenate_f[5] = rtb_y_m3u;
    rtb_VectorConcatenate_f[6] = rtb_AND9;
    ...
    rtb_VectorConcatenate_f[14] = rtb_NOT_c;
    ...
    rtb_VectorConcatenate_f[17] = rtb_y_a0_tmp;
    rtb_VectorConcatenate_f[18] = FmgcComputer_P.Constant8_Value;
    FmgcComputer_MATLABFunction_gy(rtb_VectorConcatenate_f, &rtb_y_ghj);
    ...
    rtb_VectorConcatenate_f[13] = rtb_NOT_it;
    rtb_VectorConcatenate_f[14] = rtb_NOT3;
    rtb_VectorConcatenate_f[15] = FmgcComputer_P.Constant1_Value_a;
    rtb_VectorConcatenate_f[16] = rtb_BusAssignment_j_ap_fd_logic_tcas_ra_corrective;
    ...
    FmgcComputer_Y.out.logic.on_ground = rtb_y_e;
    FmgcComputer_Y.out.logic.gnd_eng_stop_flt_5s = rtb_y_ks;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.rwy_active = rtb_y_n;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.hdg_active = rtb_y_m3u;
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.trk_active = rtb_AND9;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.align_submode_active = rtb_NOT_c;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.flare_active = rtb_y_au;
    ...
    FmgcComputer_Y.out.ap_fd_logic.fmgc_opp_mode_sync = rtb_y_l4;
    FmgcComputer_Y.out.ap_fd_logic.any_ap_fd_engaged = rtb_OR2_l;
    FmgcComputer_Y.out.ap_fd_logic.any_lateral_mode_engaged = rtb_Compare_ov;
    FmgcComputer_Y.out.ap_fd_logic.any_longitudinal_mode_engaged = rtb_y_mu;
    ...
    FmgcComputer_Y.out.ap_fd_logic.fd_auto_disengage = rtb_y_lh;
    FmgcComputer_Y.out.ap_fd_logic.ap_fd_mode_reversion = rtb_ap_fd_condition_tmp_0;
    FmgcComputer_Y.out.ap_fd_logic.lateral_mode_reversion = Memory_PreviousInput_d_tmp;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_mode_reversion_vs = rtb_NOT3_tmp;
    ...
    FmgcComputer_Y.out.ap_fd_logic.roll_fd_bars_flashing = rtb_y_a0_tmp;
    FmgcComputer_Y.out.ap_fd_logic.loc_bc_selection = rtP_fmgc_ap_fd_logic_output_MATLABStruct.loc_bc_selection;
    FmgcComputer_Y.out.ap_fd_logic.vs_target_not_held = rtb_y_m5;
    FmgcComputer_Y.out.ap_fd_logic.tcas_vs_target = rtb_BusAssignment_hk_ap_fd_logic_tcas_vs_target;
    FmgcComputer_Y.out.ap_fd_logic.tcas_ra_corrective = rtb_BusAssignment_j_ap_fd_logic_tcas_ra_corrective;
    FmgcComputer_Y.out.ap_fd_logic.active_tcas_submode = rtb_mode;
    FmgcComputer_Y.out.ap_fd_logic.tcas_alt_acq_cond = rtb_NOT_gj;
    FmgcComputer_Y.out.ap_fd_logic.tcas_alt_hold_cond = Memory_PreviousInput_k_tmp_tmp_tmp;
    FmgcComputer_Y.out.ap_fd_logic.tcas_ra_inhibited = rtb_NOT_it;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_2_capability = rtb_y_i2;
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_passive_capability = rtb_NOT_k;
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_op_capability = rtb_appCapability_idx_2;
    FmgcComputer_Y.out.ap_fd_logic.land_2_inop = rtb_GreaterThan3;
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_passive_inop = rtb_y_ky;
    ...
    FmgcComputer_Y.out.athr.athr_active = rtb_y_ii;
    FmgcComputer_Y.out.athr.athr_limited = rtb_y_b0;
    ...
    FmgcComputer_Y.out.athr.fma_mode = rtb_y_eh;
    FmgcComputer_Y.out.athr.fma_message = rtb_y_j;
    ...
    if ((!rtb_y_ea) && (!rtb_y_oi) && (!FmgcComputer_DWork.Memory_PreviousInput_hk)) {
    ...
    if (rtb_y_c || rtb_BusAssignment_b_logic_ils_tune_inhibit) {
    ...
    rtb_y_oi = !FmgcComputer_DWork.Memory_PreviousInput_m;
    if (rtb_Compare_ov && (!FmgcComputer_DWork.Memory_PreviousInput_c) && rtb_y_oi) {
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_c || rtb_NOT_c || FmgcComputer_DWork.Memory_PreviousInput_m) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.Data = rtb_y_jv;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_3.Data = rtb_y_js;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.Data = rtb_y_ce;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.Data = rtb_y_ghj;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.Data = rtb_y_jv;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_3.Data = rtb_y_js;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.Data = rtb_y_ce;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.Data = rtb_y_ghj;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active = rtb_y_n;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active = rtb_y_m3u;
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active = rtb_AND9;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.align_submode_active = rtb_NOT_c;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.flare_active = rtb_y_au;
    ...
    FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync = rtb_y_l4;
    ...
    FmgcComputer_DWork.Delay_DSTATE.fd_auto_disengage = rtb_y_lh;
    FmgcComputer_DWork.Delay_DSTATE.ap_fd_mode_reversion = rtb_ap_fd_condition_tmp_0;
    FmgcComputer_DWork.Delay_DSTATE.lateral_mode_reversion = Memory_PreviousInput_d_tmp;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_mode_reversion_vs = rtb_NOT3_tmp;
    ...
    FmgcComputer_DWork.Delay_DSTATE.roll_fd_bars_flashing = rtb_y_a0_tmp;
    FmgcComputer_DWork.Delay_DSTATE.loc_bc_selection = rtP_fmgc_ap_fd_logic_output_MATLABStruct.loc_bc_selection;
    FmgcComputer_DWork.Delay_DSTATE.vs_target_not_held = rtb_y_m5;
    FmgcComputer_DWork.Delay_DSTATE.tcas_vs_target = rtb_BusAssignment_hk_ap_fd_logic_tcas_vs_target;
    FmgcComputer_DWork.Delay_DSTATE.tcas_ra_corrective = rtb_BusAssignment_j_ap_fd_logic_tcas_ra_corrective;
    FmgcComputer_DWork.Delay_DSTATE.active_tcas_submode = rtb_mode;
    FmgcComputer_DWork.Delay_DSTATE.tcas_alt_acq_cond = rtb_NOT_gj;
    FmgcComputer_DWork.Delay_DSTATE.tcas_alt_hold_cond = Memory_PreviousInput_k_tmp_tmp_tmp;
    FmgcComputer_DWork.Delay_DSTATE.tcas_ra_inhibited = rtb_NOT_it;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_2_capability = rtb_y_i2;
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_passive_capability = rtb_NOT_k;
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_op_capability = rtb_appCapability_idx_2;
    FmgcComputer_DWork.Delay_DSTATE.land_2_inop = rtb_GreaterThan3;
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_passive_inop = rtb_y_ky;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.athr_active = rtb_y_ii;
    FmgcComputer_DWork.Delay1_DSTATE.athr_limited = rtb_y_b0;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.fma_mode = rtb_y_eh;
    FmgcComputer_DWork.Delay1_DSTATE.fma_message = rtb_y_j;
