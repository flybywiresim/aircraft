...
void FmgcComputer::FmgcComputer_MATLABFunction(const base_arinc_429 *rtu_u, real_T rtu_bit, uint32_T *rty_y)
{
  real32_T tmp;
  uint32_T a;
...
void FmgcComputer::FmgcComputer_MATLABFunction_p_Reset(rtDW_MATLABFunction_FmgcComputer_e_T *localDW)
{
  localDW->previousInput_not_empty = false;
}

void FmgcComputer::FmgcComputer_MATLABFunction_k(boolean_T rtu_u, boolean_T rtu_isRisingEdge, boolean_T *rty_y,
...
void FmgcComputer::FmgcComputer_MATLABFunction_i(const base_arinc_429 *rtu_u, boolean_T *rty_y)
{
  *rty_y = (rtu_u->SSM == static_cast<uint32_T>(SignStatusMatrix::NormalOperation));
}

void FmgcComputer::FmgcComputer_MATLABFunction_p(const base_arinc_429 *rtu_u, real32_T rtu_default, real32_T *rty_y)
{
...
void FmgcComputer::FmgcComputer_MATLABFunction_i_Reset(rtDW_MATLABFunction_FmgcComputer_h_T *localDW)
{
  localDW->output = false;
  localDW->timeSinceCondition = 0.0;
}

void FmgcComputer::FmgcComputer_MATLABFunction_kh(boolean_T rtu_u, real_T rtu_Ts, boolean_T rtu_isRisingEdge, real_T
  rtu_timeDelay, boolean_T *rty_y, rtDW_MATLABFunction_FmgcComputer_h_T *localDW)
{
...
void FmgcComputer::FmgcComputer_MATLABFunction_m_Reset(rtDW_MATLABFunction_FmgcComputer_a_T *localDW)
{
  localDW->previousInput = false;
  localDW->remainingTriggerTime = 0.0;
}

void FmgcComputer::FmgcComputer_MATLABFunction_j(boolean_T rtu_u, real_T rtu_Ts, boolean_T *rty_y, real_T
  rtp_isRisingEdge, real_T rtp_retriggerable, real_T rtp_triggerDuration, rtDW_MATLABFunction_FmgcComputer_a_T *localDW)
{
...
void FmgcComputer::step()
{
  ...
  base_arinc_429 rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft;
  base_arinc_429 rtb_BusAssignment_jc_logic_adr_computation_data_airspeed_computed_kn;
  base_arinc_429 rtb_BusAssignment_jc_logic_chosen_fac_bus_v_ls_kn;
  base_arinc_429 rtb_BusAssignment_jc_logic_chosen_fac_bus_v_max_kn;
  ...
  base_arinc_429 rtb_BusAssignment_k_logic_ir_computation_data_heading_magnetic_deg;
  ...
  base_arinc_429 rtb_BusAssignment_lp_logic_adr_computation_data_airspeed_computed_kn;
  base_arinc_429 rtb_BusAssignment_lp_logic_chosen_fac_bus_v_ls_kn;
  base_arinc_429 rtb_BusAssignment_lp_logic_chosen_fac_bus_v_max_kn;
  base_arinc_429 rtb_BusAssignment_lp_logic_ir_computation_data_flight_path_angle_deg;
  base_arinc_429 rtb_BusAssignment_lp_logic_ir_computation_data_inertial_vertical_speed_ft_s;
  base_arinc_429 rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5;
  base_arinc_429 rtb_BusAssignment_m_logic_adr_computation_data_altitude_corrected_ft;
  ...
  base_arinc_429 rtb_BusAssignment_o_logic_ils_computation_data_runway_heading_deg;
  base_arinc_429 rtb_BusAssignment_pw_logic_ils_computation_data_runway_heading_deg;
  real_T rtb_Switch_e[2];
  real_T rtb_BusAssignment_b_logic_ra_computation_data_ft;
  ...
  real_T rtb_DataTypeConversion41;
  real_T rtb_DataTypeConversion42;
  ...
  real32_T rtb_adrComputationBus_altitude_corrected_ft_Data;
  ...
  uint32_T rtb_adrComputationBus_altitude_corrected_ft_SSM;
  ...
  boolean_T apCondition_tmp;
  boolean_T apCondition_tmp_0;
  boolean_T fdOppOff;
  boolean_T fdOwnOff;
  boolean_T guard1;
  ...
  boolean_T rtb_AND2_po;
  boolean_T rtb_AND8;
  boolean_T rtb_AND_e_tmp;
  ...
  boolean_T rtb_Compare_ji_tmp;
  boolean_T rtb_Compare_ji_tmp_0;
  boolean_T rtb_Compare_jz;
  boolean_T rtb_Logic_d_idx_0_tmp;
  boolean_T rtb_NOT1_n_tmp;
  boolean_T rtb_NOT3;
  boolean_T rtb_OR2_l;
  ...
  boolean_T rtb_ap_fd_condition_tmp_0;
  boolean_T rtb_ap_fd_condition_tmp_1;
  boolean_T rtb_appCapability_idx_0;
  ...
  boolean_T rtb_y_p;
  boolean_T rtb_y_p3;
  athr_fma_message rtb_y_l;
  athr_fma_mode rtb_y_ey;
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    if (!FmgcComputer_DWork.Runtime_MODE) {
      ...
      FmgcComputer_DWork.Memory_PreviousInput_bw = FmgcComputer_P.SRFlipFlop_initial_condition_a;
      FmgcComputer_DWork.DelayInput1_DSTATE_f = FmgcComputer_P.DetectChange_vinit_c;
      ...
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_j3);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_it);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_kz);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_o);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_mn);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_jt);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_d);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ga);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_e5p);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_hz);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_gk);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_fx);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ngt);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_fm);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_jl);
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_mnt);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_kz1);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_hh);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ha);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_mq);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_cr);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_op);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_fa);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_fo);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_mb);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_j2);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_pu);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_mm);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_hvs);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_fn);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_lm);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_pnl);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_mtz);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_gb);
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_aw);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_hdw);
      ...
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_id);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ge4);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ah);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_p4);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_is);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_pr);
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_bq);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_hw);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ee);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_dt);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_cx);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_fe);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_gbq);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_p3z);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_df);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_dd);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ir);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_n5);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_f0h);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_moh);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_lva);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_go);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ms);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_hj);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_khd);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_bs);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_muf);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_db);
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_hdx);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_h0f);
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ppo);
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_hd1);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_k4v);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_esv);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_gp);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_k0);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_hjm);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_od);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_dtd);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_d5);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_aa);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_jcu);
      ...
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_aba);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_j3h);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ay);
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ge);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_ig);
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_kh);
      ...
      FmgcComputer_DWork.pU_not_empty_h = false;
      ...
      FmgcComputer_DWork.pY_not_empty_n = false;
    ...
    rtb_dualRaFailure = !rtb_adrOwnInvalid;
    rtb_bothRaValid = !rtb_adr3Invalid;
    rtb_adrOppInvalid = (rtb_dualRaFailure && (!rtb_adrOppInvalid) && rtb_bothRaValid);
    ...
    if (rtb_dualRaFailure) {
      FmgcComputer_Y.out.logic.adr_computation_data.altitude_standard_ft.SSM =
        FmgcComputer_U.in.bus_inputs.adr_own_bus.altitude_standard_ft.SSM;
      ...
      rtb_adrComputationBus_altitude_corrected_ft_SSM =
        FmgcComputer_U.in.bus_inputs.adr_own_bus.altitude_corrected_ft.SSM;
      rtb_adrComputationBus_altitude_corrected_ft_Data =
        FmgcComputer_U.in.bus_inputs.adr_own_bus.altitude_corrected_ft.Data;
      ...
      rtb_Cos_h = FmgcComputer_U.in.bus_inputs.adr_own_bus.airspeed_computed_kn.Data;
      ...
      FmgcComputer_Y.out.logic.adr_computation_data.vertical_speed_ft_min =
        FmgcComputer_U.in.bus_inputs.adr_own_bus.vertical_speed_ft_min;
    ...
    } else if (rtb_bothRaValid) {
      FmgcComputer_Y.out.logic.adr_computation_data.altitude_standard_ft.SSM =
        FmgcComputer_U.in.bus_inputs.adr_3_bus.altitude_standard_ft.SSM;
      rtb_adrComputationBus_altitude_standard_ft_Data = FmgcComputer_U.in.bus_inputs.adr_3_bus.altitude_standard_ft.Data;
      rtb_adrComputationBus_altitude_corrected_ft_SSM = FmgcComputer_U.in.bus_inputs.adr_3_bus.altitude_corrected_ft.SSM;
      rtb_adrComputationBus_altitude_corrected_ft_Data =
        FmgcComputer_U.in.bus_inputs.adr_3_bus.altitude_corrected_ft.Data;
      ...
      rtb_Cos_h = FmgcComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.Data;
      FmgcComputer_Y.out.logic.adr_computation_data.airspeed_true_kn.SSM =
      ...
      FmgcComputer_Y.out.logic.adr_computation_data.vertical_speed_ft_min =
        FmgcComputer_U.in.bus_inputs.adr_3_bus.vertical_speed_ft_min;
      FmgcComputer_Y.out.logic.adr_computation_data.aoa_corrected_deg.SSM =
      ...
      rtb_adrComputationBus_altitude_corrected_ft_SSM =
        FmgcComputer_P.Constant1_Value.adr_computation_data.altitude_corrected_ft.SSM;
      rtb_adrComputationBus_altitude_corrected_ft_Data =
        FmgcComputer_P.Constant1_Value.adr_computation_data.altitude_corrected_ft.Data;
      ...
      rtb_Cos_h = FmgcComputer_P.Constant1_Value.adr_computation_data.airspeed_computed_kn.Data;
      FmgcComputer_Y.out.logic.adr_computation_data.airspeed_true_kn.SSM =
      ...
      FmgcComputer_Y.out.logic.adr_computation_data.vertical_speed_ft_min =
        FmgcComputer_P.Constant1_Value.adr_computation_data.vertical_speed_ft_min;
      FmgcComputer_Y.out.logic.adr_computation_data.aoa_corrected_deg.SSM =
    ...
    if (rtb_irOwnInvalid) {
      ...
      rtb_Gain2_f = FmgcComputer_U.in.bus_inputs.ir_own_bus.ground_speed_kn.Data;
      ...
      rtb_irComputationBus_track_angle_magnetic_deg_Data =
        FmgcComputer_U.in.bus_inputs.ir_own_bus.track_angle_magnetic_deg.Data;
      ...
      rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg.SSM =
        FmgcComputer_U.in.bus_inputs.ir_own_bus.pitch_angle_deg.SSM;
      ...
      rtb_Gain2_f = FmgcComputer_U.in.bus_inputs.ir_3_bus.ground_speed_kn.Data;
      FmgcComputer_Y.out.logic.ir_computation_data.track_angle_true_deg.SSM =
      ...
      rtb_irComputationBus_track_angle_magnetic_deg_Data =
        FmgcComputer_U.in.bus_inputs.ir_3_bus.track_angle_magnetic_deg.Data;
      ...
      rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg.SSM =
        FmgcComputer_U.in.bus_inputs.ir_3_bus.pitch_angle_deg.SSM;
      ...
      rtb_Gain2_f = FmgcComputer_P.Constant1_Value.ir_computation_data.ground_speed_kn.Data;
      FmgcComputer_Y.out.logic.ir_computation_data.track_angle_true_deg.SSM =
      ...
      rtb_irComputationBus_track_angle_magnetic_deg_Data =
        FmgcComputer_P.Constant1_Value.ir_computation_data.track_angle_magnetic_deg.Data;
      ...
      rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg.SSM =
        FmgcComputer_P.Constant1_Value.ir_computation_data.pitch_angle_deg.SSM;
    ...
    raOppInvalid = (FmgcComputer_U.in.bus_inputs.ra_opp_bus.radio_height_ft.SSM == static_cast<uint32_T>
                    (SignStatusMatrix::FailureWarning));
    rtb_y_d1 = !raOppInvalid;
    rtb_ap_fd_condition_tmp_0 = !raOwnInvalid;
    rtb_y_no4 = (rtb_ap_fd_condition_tmp_0 && rtb_y_d1);
    if (rtb_y_no4) {
      rtb_raComputationData = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else if (raOwnInvalid && rtb_y_d1) {
      rtb_raComputationData = FmgcComputer_U.in.bus_inputs.ra_opp_bus.radio_height_ft.Data;
    } else if (rtb_ap_fd_condition_tmp_0 && raOppInvalid) {
      rtb_raComputationData = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else {
    ...
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_own_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel_bit, &rtb_y_ha);
    rtb_irOwnInvalid = (rtb_y_ha != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel2_bit, &rtb_y_ha);
    rtb_irOwnInvalid = (rtb_irOwnInvalid || (rtb_y_ha != 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_own_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit, &rtb_y_ha);
    rtb_y_ed = (rtb_y_ha != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel3_bit, &rtb_y_ha);
    rtb_ir3Invalid = ((!rtb_irOwnInvalid) || ((!rtb_y_ed) && (rtb_y_ha == 0U)) || (!FmgcComputer_P.Constant_Value_a) ||
                      ((!FmgcComputer_U.in.discrete_inputs.fac_own_healthy) &&
                       (!FmgcComputer_U.in.discrete_inputs.fac_opp_healthy)));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_own_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel4_bit, &rtb_y_ha);
    rtb_irOwnInvalid = (rtb_y_ha != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel6_bit, &rtb_y_ha);
    rtb_irOwnInvalid = (rtb_irOwnInvalid || (rtb_y_ha != 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_own_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel5_bit, &rtb_y_ha);
    rtb_y_bo = (rtb_y_ha != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel7_bit, &rtb_y_ha);
    rtb_irOwnInvalid = (FmgcComputer_U.in.discrete_inputs.fac_opp_healthy &&
                        FmgcComputer_U.in.discrete_inputs.fac_own_healthy && rtb_irOwnInvalid && (rtb_y_bo || (rtb_y_ha
      != 0U)));
    rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5.SSM = rtb_Switch_discrete_word_5_SSM;
    rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5.Data = rtb_Switch_discrete_word_5_Data;
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
      FmgcComputer_P.BitfromLabel_bit_p, &rtb_y_ha);
    rtb_y_p = (rtb_y_ha != 0U);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
      FmgcComputer_P.BitfromLabel1_bit_a, &rtb_y_ha);
    rtb_y_bo = (rtb_y_ha != 0U);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
      FmgcComputer_P.BitfromLabel2_bit_p, &rtb_y_ha);
    rtb_y_ed = (rtb_y_ha == 0U);
    FmgcComputer_MATLABFunction_f(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5, &rtb_y_p3);
    rtb_y_h = (rtb_y_p && rtb_y_bo && rtb_y_ed && rtb_y_p3);
    rtb_y_ae = ((!rtb_y_p3) || (!rtb_y_ed));
    rtb_OR_pj = !rtb_y_h;
    FmgcComputer_MATLABFunction_kh(rtb_OR_pj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge,
      FmgcComputer_P.ConfirmNode1_timeDelay, &rtb_y_p3, &FmgcComputer_DWork.sf_MATLABFunction_f);
    rtb_y_if = ((FmgcComputer_U.in.discrete_inputs.eng_opp_stop && FmgcComputer_U.in.discrete_inputs.eng_own_stop &&
                 rtb_y_h) || rtb_y_p3);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
    ...
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
      FmgcComputer_P.BitfromLabel10_bit, &rtb_y_ha);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
      FmgcComputer_P.BitfromLabel11_bit, &rtb_y);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
      FmgcComputer_P.BitfromLabel12_bit, &rtb_Switch_m);
    ...
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.glideslope_deviation_deg, &rtb_y_hq);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.localizer_deviation_deg, &rtb_y_p3);
    rtb_y_p = (rtb_y_hq && rtb_y_p3);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_own_bus.glideslope_deviation_deg, &rtb_y_hq);
    FmgcComputer_MATLABFunction_f(&FmgcComputer_U.in.bus_inputs.ils_own_bus.localizer_deviation_deg, &rtb_y_p3);
    rtb_y_bo = (rtb_y_hq && rtb_y_p3);
    rtb_y_ed = ((!rtb_y_p) && (!rtb_y_bo));
    rtb_BusAssignment_o_logic_both_ils_valid = (rtb_y_p && rtb_y_bo);
    if (rtb_y_bo) {
    ...
    rtb_BusAssignment_o_logic_ils_computation_data_runway_heading_deg.SSM = rtb_y;
    rtb_BusAssignment_o_logic_ils_computation_data_runway_heading_deg.Data = rtb_Switch_i_runway_heading_deg_Data;
    rtb_y_p = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active ||
               FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active ||
               (FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed && (rtb_raComputationData <=
      FmgcComputer_P.CompareToConstant_const)));
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_o_logic_ils_computation_data_runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue, &rtb_y_gl);
    rtb_y_a22 = !rtb_y_p;
    if (rtb_y_a22) {
      FmgcComputer_B.u_lyj = rtb_y_gl;
    }
    ...
    if (rtb_y_no4) {
      rtb_DataTypeConversion2_kb = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else if (raOwnInvalid && rtb_y_d1) {
      rtb_DataTypeConversion2_kb = FmgcComputer_U.in.bus_inputs.ra_opp_bus.radio_height_ft.Data;
    } else if (rtb_ap_fd_condition_tmp_0 && raOppInvalid) {
      rtb_DataTypeConversion2_kb = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else {
      rtb_DataTypeConversion2_kb = 250.0F;
    }

    raOwnInvalid = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_y_ae) || rtb_AND_nk) &&
                    (FmgcComputer_U.in.fms_inputs.fm_valid || rtb_AND_nk ||
                     (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active && (rtb_DataTypeConversion2_kb <
      700.0F))));
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_b_logic_ir_computation_data_heading_true_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue, &rtb_y_gl);
    FmgcComputer_MATLABFunction_j((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rollout_submode_active && (std::abs
      (FmgcComputer_B.u_lyj - rtb_y_gl) > FmgcComputer_P.CompareToConstant_const_h)), FmgcComputer_U.in.time.dt,
      &rtb_y_ft, FmgcComputer_P.MTrigNode_isRisingEdge, FmgcComputer_P.MTrigNode_retriggerable,
      FmgcComputer_P.MTrigNode_triggerDuration, &FmgcComputer_DWork.sf_MATLABFunction_j3);
    rtb_ap_fd_condition_tmp = !rtb_BusAssignment_h_logic_fcu_failure;
    rtb_ap_fd_condition_tmp_0 = !rtb_dualRaFailure;
    rtb_OR_fz = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed;
    rtb_ap_fd_condition_tmp_1 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active;
    rtb_y_n = !FmgcComputer_P.Constant1_Value.fac_speeds_failure;
    ...
    raOppInvalid = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || rtb_AND_nk) && (rtb_y_n ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (rtb_ap_fd_condition_tmp_0 || (rtb_OR_fz && rtb_y_k &&
      rtb_OR_ko && rtb_ap_fd_condition_tmp_1)) && (rtb_ap_fd_condition_tmp || rtb_AND_nk) && (!rtb_y_ft));
    ...
    fdOwnOff = (raOwnInvalid && raOppInvalid && ((!fdOwnOff) || ((!fdOppOff) &&
      (!FmgcComputer_U.in.discrete_inputs.fd_opp_engaged))));
    FmgcComputer_Y.out.logic.ils_failure = rtb_y_ed;
    FmgcComputer_MATLABFunction_k(FmgcComputer_U.in.discrete_inputs.fcu_ap_button, FmgcComputer_P.PulseNode_isRisingEdge,
      &rtb_y_nz, &FmgcComputer_DWork.sf_MATLABFunction_il);
    FmgcComputer_MATLABFunction_k(rtb_BusAssignment_h_logic_engine_running, FmgcComputer_P.PulseNode3_isRisingEdge,
      &rtb_y_ft, &FmgcComputer_DWork.sf_MATLABFunction_jp);
    FmgcComputer_MATLABFunction_k(FmgcComputer_U.in.discrete_inputs.ap_opp_engaged,
      FmgcComputer_P.PulseNode2_isRisingEdge, &rtb_y_p3, &FmgcComputer_DWork.sf_MATLABFunction_cb);
    rtb_OR2_l_tmp = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active;
    rtb_OR4_g = (rtb_OR_fz && rtb_ap_fd_condition_tmp_1);
    rtb_OR2_l = (rtb_OR4_g && rtb_OR2_l_tmp);
    FmgcComputer_MATLABFunction_k(rtb_OR2_l, FmgcComputer_P.PulseNode1_isRisingEdge, &rtb_y_hq,
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_l, &rtb_y_gl);
    rtb_y_p = (rtb_y_gl >= FmgcComputer_P.CompareToConstant3_const);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue, &rtb_y_gl);
    apCondition_tmp = !rtb_ir3Invalid;
    rtb_appCapability_idx_2 = !FmgcComputer_U.in.discrete_inputs.elac_own_ap_disc;
    apCondition_tmp_0 = !FmgcComputer_U.in.discrete_inputs.elac_opp_ap_disc;
    rtb_NOT3 = ((!FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc) && (rtb_appCapability_idx_2 ||
      apCondition_tmp_0) && apCondition_tmp);
    rtb_y_m = !raOwnInvalid;
    fdOppOff = (rtb_y_m || (!raOppInvalid) || (!rtb_NOT3));
    rtb_fmgcOppPriority = !FmgcComputer_U.in.discrete_inputs.is_unit_1;
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((fdOppOff || (rtb_y_nz &&
      FmgcComputer_DWork.Delay_DSTATE_p) || FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc || ((rtb_y_p3 &&
      rtb_OR2_l) || (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged && rtb_y_hq && rtb_fmgcOppPriority)) || (rtb_y_h &&
      (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_p || (rtb_y_gl >=
      FmgcComputer_P.CompareToConstant5_const))) || (rtb_y_ft && rtb_y_h)) + (static_cast<uint32_T>(rtb_y_nz &&
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_y_if && raOppInvalid && raOwnInvalid && rtb_NOT3) << 1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput];
    FmgcComputer_MATLABFunction_kh(FmgcComputer_DWork.Memory_PreviousInput, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge, FmgcComputer_P.ConfirmNode_timeDelay, &rtb_y_ft,
      &FmgcComputer_DWork.sf_MATLABFunction_it);
    low_i = static_cast<int32_T>((((static_cast<uint32_T>(rtb_y_nz && FmgcComputer_DWork.Memory_PreviousInput) << 1) +
      ((!rtb_y_ft) || FmgcComputer_U.in.discrete_inputs.ap_instinctive_disc)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_g);
    rtb_Logic_a2[0U] = FmgcComputer_P.Logic_table_h[static_cast<uint32_T>(low_i)];
    rtb_Logic_a2[1U] = FmgcComputer_P.Logic_table_h[static_cast<uint32_T>(low_i) + 8U];
    ...
    FmgcComputer_MATLABFunction_kh(FmgcComputer_U.in.discrete_inputs.athr_instinctive_disc, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode1_isRisingEdge_n, FmgcComputer_P.ConfirmNode1_timeDelay_l, &rtb_y_ft,
      &FmgcComputer_DWork.sf_MATLABFunction_kz);
    FmgcComputer_DWork.Memory_PreviousInput_g1 = FmgcComputer_P.Logic_table_f[(((static_cast<uint32_T>(rtb_y_ft) << 1) +
      FmgcComputer_P.Constant_Value_e) << 1) + FmgcComputer_DWork.Memory_PreviousInput_g1];
    FmgcComputer_MATLABFunction_k(FmgcComputer_U.in.discrete_inputs.fcu_athr_button,
      FmgcComputer_P.PulseNode_isRisingEdge_k, &rtb_Compare_bj, &FmgcComputer_DWork.sf_MATLABFunction_o);
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active), FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode2_isRisingEdge, FmgcComputer_P.ConfirmNode2_timeDelay, &rtb_y_p3,
      &FmgcComputer_DWork.sf_MATLABFunction_mn);
    FmgcComputer_MATLABFunction_k(rtb_y_p3, FmgcComputer_P.PulseNode1_isRisingEdge_h, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_jt);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_n, &rtb_y_gl);
    rtb_y_ft = (rtb_y_gl < FmgcComputer_P.CompareToConstant_const_o);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_p, &rtb_y_gl);
    FmgcComputer_MATLABFunction_k((rtb_y_ft && (rtb_y_gl < FmgcComputer_P.CompareToConstant1_const)),
      FmgcComputer_P.PulseNode2_isRisingEdge_n, &rtb_y_nz, &FmgcComputer_DWork.sf_MATLABFunction_d);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_i_logic_chosen_fac_bus_discrete_word_5,
      FmgcComputer_P.BitfromLabel_bit_g, &rtb_y_ha);
    FmgcComputer_MATLABFunction_k((rtb_y_ha != 0U), FmgcComputer_P.PulseNode3_isRisingEdge_a, &rtb_y_hq,
      &FmgcComputer_DWork.sf_MATLABFunction_ga);
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync &&
      (!FmgcComputer_U.in.discrete_inputs.athr_opp_engaged)), FmgcComputer_P.PulseNode4_isRisingEdge, &rtb_y_p3,
      &FmgcComputer_DWork.sf_MATLABFunction_e5p);
    rtb_y_n = ((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active ||
                FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active) && (!FmgcComputer_DWork.Memory_PreviousInput_g1)
               && rtb_ap_fd_condition_tmp && rtb_y_n);
    rtb_ap_fd_condition_tmp = (rtb_y_m || (!rtb_y_n));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(raOwnInvalid && rtb_y_n &&
      ((rtb_Compare_bj && ((rtb_raComputationData > 100.0F) || rtb_dualRaFailure)) || rtb_y_d1 || rtb_y_hq)) << 1) +
      (rtb_ap_fd_condition_tmp || rtb_y_p3 || (FmgcComputer_DWork.Delay_DSTATE_k && rtb_Compare_bj &&
      (!rtP_fmgc_ap_fd_logic_output_MATLABStruct.lateral_modes.land_active)) ||
       FmgcComputer_U.in.discrete_inputs.athr_instinctive_disc || rtb_y_nz)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_p];
    rtb_fmgcOppPriority_tmp = !rtb_Logic_a2[0];
    rtb_y_m = !fdOwnOff;
    rtb_y_n = !FmgcComputer_DWork.Delay_DSTATE_k;
    rtb_y_ft = (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || FmgcComputer_U.in.discrete_inputs.fd_opp_engaged);
    rtb_OR2_l = (rtb_y_ft || FmgcComputer_U.in.discrete_inputs.athr_opp_engaged);
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_y_m) && (rtb_y_ft || rtb_y_n) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_ft || rtb_y_m) && (rtb_OR2_l || rtb_y_n) &&
      (rtb_Logic_a2[0] || fdOwnOff || FmgcComputer_DWork.Delay_DSTATE_k ||
       (!FmgcComputer_U.in.discrete_inputs.fmgc_opp_healthy)))));
    rtb_y_p3 = !FmgcComputer_U.in.discrete_inputs.ap_opp_engaged;
    rtb_y_m = (rtb_fmgcOppPriority && (rtb_fmgcOppPriority_tmp || rtb_y_p3));
    rtb_BusAssignment_m_logic_adr_computation_data_altitude_corrected_ft.SSM =
      rtb_adrComputationBus_altitude_corrected_ft_SSM;
    rtb_BusAssignment_m_logic_adr_computation_data_altitude_corrected_ft.Data =
      rtb_adrComputationBus_altitude_corrected_ft_Data;
    rtb_y_ft = (rtb_Logic_a2[0] || FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || fdOwnOff ||
                FmgcComputer_U.in.discrete_inputs.fd_opp_engaged);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_m, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_m_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_c, &rtb_y_gl);
    rtb_AND_e_tmp = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active ||
    ...
    rtb_OR2_l = (rtb_AND_e_tmp && FmgcComputer_DWork.Delay_DSTATE.alt_cstr_applicable && rtb_appCapability_idx_0 &&
                 FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid);
    if (rtb_y_nl > rtb_y_gl) {
      rtb_y_d1 = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft < rtb_y_nl) &&
                  ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft + 250.0 > rtb_y_gl) || rtb_OR2_l));
    } else {
      rtb_y_d1 = ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft > rtb_y_nl) &&
                  ((FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft - 250.0 < rtb_y_gl) || rtb_OR2_l));
    }

    rtb_OR2_l = ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed ||
                  FmgcComputer_DWork.Delay_DSTATE.armed_modes.des_armed ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                  FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active || rtb_OR2_l) &&
                 (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != 0.0) && rtb_y_d1);
    if (rtb_OR2_l) {
      rtb_altCstrOrFcu = FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft;
    } else {
      rtb_altCstrOrFcu = rtb_y_nl;
    }
    ...
    FmgcComputer_MATLABFunction_kh(rtb_y_h, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_h,
      FmgcComputer_P.ConfirmNode_timeDelay_i, &rtb_Compare_bj, &FmgcComputer_DWork.sf_MATLABFunction_hz);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_l2, &rtb_y_gl);
    rtb_y_nz = (rtb_y_gl < FmgcComputer_P.CompareToConstant3_const_n);
    rtb_NOT3 = !rtb_y_nz;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_no4);
    rtb_y_no4 = (rtb_y_nz && (rtb_y_gl > FmgcComputer_P.CompareToConstant4_const) && rtb_y_no4);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b, &rtb_y_gl);
    rtb_y_nz = (rtb_y_gl < FmgcComputer_P.CompareToConstant5_const_a);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_j);
    FmgcComputer_MATLABFunction_k((rtb_NOT3 || rtb_y_no4 || (!rtb_y_nz) || (rtb_y_nz && (rtb_y_gl >
      FmgcComputer_P.CompareToConstant6_const) && rtb_y_j)), FmgcComputer_P.PulseNode_isRisingEdge_p, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_gk);
    rtb_y_no4 = !rtb_y_m;
    rtb_appInop_idx_2 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active;
    rtb_y_p = (rtb_y_no4 && rtb_appInop_idx_2 && rtb_OR2_l_tmp);
    rtb_NOT3 = (((FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant1_const_k) &&
                 (rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_p && rtb_Compare_bj &&
      (FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant2_const) && (rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_b) && rtb_y_d1));
    FmgcComputer_MATLABFunction_kh(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_c,
      FmgcComputer_P.ConfirmNode_timeDelay_h, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_fx);
    rtb_AND2_po = !rtb_y_ft;
    ...
    rtb_Compare_dw = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 ||
                      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    rtb_y_j = (rtb_Compare_dw || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
    ...
    rtb_y_lxi = (rtb_y_j || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active);
    FmgcComputer_DWork.Memory_PreviousInput_k = FmgcComputer_P.Logic_table_b[(((rtb_AND2_po || ((rtb_y_lxi ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_d1))) + (static_cast<uint32_T>(rtb_NOT3) <<
      1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_k];
    ...
    rtb_y_nz = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_g, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_kh(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active,
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_f, FmgcComputer_P.ConfirmNode1_timeDelay_e,
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_ngt);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_f4_logic_ils_computation_data_runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_m, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_f4_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue, &rtb_y_gl);
    rtb_DataTypeConversion2_kb = std::abs(rtb_y_nl - rtb_y_gl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_e, &rtb_y_gl);
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg, &rtb_NOT3);
    FmgcComputer_MATLABFunction_kh(rtb_y_h, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_p,
      FmgcComputer_P.ConfirmNode_timeDelay_o, &rtb_Compare_bj, &FmgcComputer_DWork.sf_MATLABFunction_fm);
    if (rtb_y_gl < 0.0F) {
      rtb_DataTypeConversion1_d = -rtb_y_gl;
    } else {
      rtb_DataTypeConversion1_d = rtb_y_gl;
    }

    rtb_NOT3 = ((rtb_y_nz && (rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active) && ((rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_cq) && rtb_y_d1 && (rtb_DataTypeConversion2_kb <=
      FmgcComputer_P.CompareToConstant2_const_b) && (rtb_DataTypeConversion1_d <
      FmgcComputer_P.CompareToConstant1_const_i) && FmgcComputer_P.Constant_Value_j && rtb_NOT3 && rtb_Compare_bj)));
    FmgcComputer_MATLABFunction_kh(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_l,
      FmgcComputer_P.ConfirmNode_timeDelay_f, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_jl);
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg,
      &rtb_Compare_bj);
    FmgcComputer_DWork.Memory_PreviousInput_c = FmgcComputer_P.Logic_table_hz[(((((!rtb_y_d1) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_trk_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_AND2_po || (!rtb_Compare_bj)) +
    ...
    FmgcComputer_MATLABFunction_j((rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_l),
      FmgcComputer_U.in.time.dt, &rtb_y_d1, FmgcComputer_P.MTrigNode_isRisingEdge_j,
    ...
    rtb_TmpSignalConversionAtSFunctionInport3_idx_0 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active;
    rtb_NOT3 = ((rtb_y_nz && (rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 &&
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed)) &&
      rtb_y_d1));
    FmgcComputer_MATLABFunction_kh(rtb_NOT3, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hu,
      FmgcComputer_P.ConfirmNode_timeDelay_j, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_kz1);
    FmgcComputer_DWork.Memory_PreviousInput_b = FmgcComputer_P.Logic_table_d[(((((!rtb_y_d1) &&
      (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active ||
       ...
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
       FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_AND2_po) + (static_cast<uint32_T>(rtb_NOT3) <<
    ...
    rtb_y_f = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_m);
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_l, &rtb_y_bo,
    ...
    FmgcComputer_MATLABFunction_kh(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_f, FmgcComputer_P.ConfirmNode_timeDelay_d, &rtb_y_d1,
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ek, &rtb_y_dbv);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_own_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_f, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_opp_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_c, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_own_bus.runway_heading_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_o, &rtb_y_gl);
    rtb_y_hq = !rtb_BusAssignment_h_logic_engine_running;
    rtb_y_ed = !rtb_y_ed;
    rtb_Compare_bj = !FmgcComputer_P.Constant2_Value_p;
    rtb_Compare_jz = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active;
    rtb_NOT1_n_tmp = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active;
    rtb_TmpSignalConversionAtSFunctionInport3_idx_2 =
      !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active;
    rtb_y_nz = (rtb_ap_fd_condition_tmp_1 && (rtb_y_f || (rtb_y_no4 && (FmgcComputer_P.Constant_Value_l && rtb_y_ed &&
      (rtb_y_hq || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_g)) && rtb_ap_fd_condition_tmp_0 &&
      rtb_y_bo && (!rtb_y_d1) && (rtb_TmpSignalConversionAtSFunctionInport3_idx_2 &&
      (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed))) && rtb_appInop_idx_2 && rtb_OR2_l_tmp &&
      rtb_Compare_jz && rtb_NOT1_n_tmp && rtb_Compare_bj && rtb_Compare_bj && (((rtb_y_dbv == rtb_y_g) && (rtb_y_nl ==
      rtb_y_gl)) || (!rtb_BusAssignment_o_logic_both_ils_valid)))));
    rtb_OR4_e = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    rtb_y_d4 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active), FmgcComputer_P.PulseNode2_isRisingEdge_e,
      &rtb_Compare_bj, &FmgcComputer_DWork.sf_MATLABFunction_kb);
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_j, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_eb2);
    rtb_AND8 = (rtb_y_d4 && rtb_y_d1);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_l, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_c, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_es);
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_AND_nk || ((!rtb_OR4_e) &&
      (!rtb_y_d4) && FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed) || ((rtb_OR4_e && rtb_Compare_bj) ||
      rtb_AND8) || (rtb_y_bo && FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed) || rtb_y_d1 || rtb_AND2_po) + (
      static_cast<uint32_T>(rtb_y_nz) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_l];
    FmgcComputer_MATLABFunction_kh(!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_e, FmgcComputer_P.ConfirmNode_timeDelay_l, &rtb_Compare_bj,
    ...
    FmgcComputer_MATLABFunction_kh((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_d),
      ...
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_cr);
    rtb_AND_nk = (rtb_Compare_bj && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active && rtb_y_d1)));
    FmgcComputer_MATLABFunction_kh(rtb_AND_nk, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_d,
      FmgcComputer_P.ConfirmNode_timeDelay_a, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_op);
    rtb_y_nz = !rtb_y_d1;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_f, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_a, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_fa);
    FmgcComputer_MATLABFunction_kh(rtb_y_h, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode2_isRisingEdge_l,
      FmgcComputer_P.ConfirmNode2_timeDelay_b, &rtb_Compare_bj, &FmgcComputer_DWork.sf_MATLABFunction_fo);
    rtb_AND8 = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.roll_goaround_active);
    rtb_y_bo = (rtb_AND8 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    rtb_Logic_d_idx_0_tmp = (rtb_y_bo || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_y_lxi ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active || (rtb_Logic_d_idx_0_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active)) && rtb_y_nz) ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || (rtb_fmgcOppPriority_tmp && rtb_y_p3 &&
      rtb_y_d1 && rtb_Compare_bj) || rtb_AND2_po) + (static_cast<uint32_T>(rtb_AND_nk) << 1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_d];
    rtb_y_f = (FmgcComputer_U.in.discrete_inputs.bscu_opp_valid || FmgcComputer_U.in.discrete_inputs.bscu_own_valid);
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      FmgcComputer_P.CompareToConstant2_const_i) && (((FmgcComputer_U.in.discrete_inputs.left_wheel_spd_abv_70_kts ||
      FmgcComputer_U.in.discrete_inputs.right_wheel_spd_abv_70_kts) && rtb_y_f) || ((!rtb_y_f) && rtb_y_h))),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_b, FmgcComputer_P.ConfirmNode1_timeDelay_ef,
    ...
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay2_DSTATE.flare_law.condition_Flare &&
      ...
      FmgcComputer_P.ConfirmNode1_isRisingEdge_d, FmgcComputer_P.ConfirmNode1_timeDelay_dj, &rtb_y_nz,
      &FmgcComputer_DWork.sf_MATLABFunction_j2);
    FmgcComputer_DWork.Memory_PreviousInput_bc = FmgcComputer_P.Logic_table_bp[(((static_cast<uint32_T>(rtb_y_nz) << 1)
      + rtb_ap_fd_condition_tmp_1) << 1) + FmgcComputer_DWork.Memory_PreviousInput_bc];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_l, &rtb_DataTypeConversion1_e);
    rtb_y_nz = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_m);
    rtb_y_m5 = (rtb_y_hq || (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_lj) || rtb_dualRaFailure);
    FmgcComputer_MATLABFunction_kh(FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed,
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_le, FmgcComputer_P.ConfirmNode_timeDelay_n,
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_pu);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_e, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_h, &rtb_y_hq,
      &FmgcComputer_DWork.sf_MATLABFunction_d3);
    rtb_y_i1_tmp = (rtb_y_no4 && FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid);
    rtb_y_f = (rtb_y_i1_tmp && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid &&
               FmgcComputer_P.Constant_Value_hg && rtb_y_m5 && rtb_OR_fz && (rtb_appInop_idx_2 && rtb_Compare_jz &&
                rtb_OR2_l_tmp && rtb_NOT1_n_tmp && rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && (!rtb_y_d1) &&
                rtb_y_hq));
    rtb_OR4_e = (rtb_ap_fd_condition_tmp_1 && (rtb_y_nz || rtb_y_f));
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active), FmgcComputer_P.PulseNode3_isRisingEdge_k, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_bbv);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_o, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_l, &rtb_y_f,
      &FmgcComputer_DWork.sf_MATLABFunction_bk);
    rtb_y_lxi = !FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid;
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c
      [(((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_lxi || rtb_y_d1 || (rtb_y_hq
           && FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed) || rtb_y_f || rtb_AND2_po) +
         (static_cast<uint32_T>(rtb_OR4_e) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_dv];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
      FmgcComputer_P.BitfromLabel_bit_a, &rtb_DataTypeConversion1_e);
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed && FmgcComputer_U.in.fms_inputs.final_app_can_engage &&
      (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant_Value_i5)));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ha,
      FmgcComputer_P.ConfirmNode_timeDelay_on, &rtb_y_hq, &FmgcComputer_DWork.sf_MATLABFunction_mm);
    rtb_y_p3 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active);
    rtb_Compare_jz = (rtb_y_p3 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    rowIdx_tmp = (rtb_Compare_jz || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active);
    low_i = static_cast<int32_T>((((rtb_AND2_po || ((rowIdx_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_hq))) + (static_cast<uint32_T>
      (rtb_Compare_bj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_f);
    rtb_Logic_b[0U] = FmgcComputer_P.Logic_table_pl[static_cast<uint32_T>(low_i)];
    rtb_Logic_b[1U] = FmgcComputer_P.Logic_table_pl[static_cast<uint32_T>(low_i) + 8U];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
      FmgcComputer_P.BitfromLabel_bit_cs, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_kh(rtb_y_h, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_m,
      FmgcComputer_P.ConfirmNode_timeDelay_j5, &rtb_y_m5, &FmgcComputer_DWork.sf_MATLABFunction_hvs);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_p, &rtb_y_gl);
    rtb_Compare_bj = (rtb_y_gl >= FmgcComputer_P.CompareToConstant3_const_i);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d, &rtb_y_gl);
    FmgcComputer_MATLABFunction_k((rtb_Compare_bj || (rtb_y_gl >= FmgcComputer_P.CompareToConstant5_const_k)),
      FmgcComputer_P.PulseNode_isRisingEdge_c, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_fn);
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_p && (!rtb_y_m5) && (rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_j) && rtb_y_d1));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_hj,
      FmgcComputer_P.ConfirmNode_timeDelay_a3, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_lm);
    FmgcComputer_DWork.Memory_PreviousInput_i = FmgcComputer_P.Logic_table_o[((((rtb_AND2_po || (rtb_y_j ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) && (!rtb_y_d1)) + (static_cast<uint32_T>
      (rtb_Compare_bj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_i];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_P.PulseNode_isRisingEdge_f, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_pnl);
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 && (rtb_NOT1_n_tmp && rtb_y_d1)));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_mf,
      FmgcComputer_P.ConfirmNode_timeDelay_dw, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_mtz);
    FmgcComputer_DWork.Memory_PreviousInput_e = FmgcComputer_P.Logic_table_c2[(((rtb_AND2_po ||
      ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active ||
        ...
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_d1))) + (static_cast<uint32_T>
      (rtb_Compare_bj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_e];
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode3_isRisingEdge_l, &rtb_y_m5,
      &FmgcComputer_DWork.sf_MATLABFunction_gb);
    rtb_y_nz = (rtb_y_bo || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel4_bit_k, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_j((rtb_DataTypeConversion1_e != 0U), FmgcComputer_U.in.time.dt, &rtb_y_d1,
    ...
    rtb_OR_fz = !rtb_y_nz;
    rtb_Compare_bj = (rtb_y_d4 && rtb_y_m5 && (rtb_y_d4 || rtb_OR_fz) && (!rtb_y_d1));
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active), FmgcComputer_P.PulseNode5_isRisingEdge,
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_aj);
    rtb_y_bo = (rtb_y_d1 && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active || rtb_OR_fz));
    rtb_OR4_e = rtb_y_d4;
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_b, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_at);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel5_bit_f, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_j,
      &rtb_OR4_e, &FmgcComputer_DWork.sf_MATLABFunction_o3);
    rtb_Compare_ji_tmp = !FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid;
    rtb_Compare_bj = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_Compare_ji_tmp &&
                       rtb_TmpSignalConversionAtSFunctionInport3_idx_2) || rtb_Compare_bj || rtb_y_bo || (rtb_y_d4 &&
      rtb_OR4_g && rtb_y_d1) || (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active && rtb_OR4_e));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel_bit_pg, &rtb_DataTypeConversion1_e);
    rtb_y_bo = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_ok, &rtb_DataTypeConversion1_e);
    rtb_y_bo = (rtb_y_bo || (rtb_DataTypeConversion1_e != 0U));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel2_bit_i, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_i, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_di2);
    rtb_y_f = (rtb_y_if && rtb_y_d1 && rtb_ap_fd_condition_tmp_1 && (rtb_NOT1_n_tmp || (rtb_raComputationData >=
      FmgcComputer_P.CompareToConstant_const_a)));
    rtb_y_m5 = rtb_OR_pj;
    FmgcComputer_MATLABFunction_k(rtb_y_ft, FmgcComputer_P.PulseNode4_isRisingEdge_e, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_a5);
    rtb_y_p = ((!FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged) && rtb_OR2_l_tmp);
    rtb_OR_fz = ((rtb_y_bo && rtb_y_m) || (rtb_y_no4 && (rtb_y_f || (rtb_OR_pj && rtb_y_d1 && rtb_y_p) || rtb_Compare_bj)));
    FmgcComputer_MATLABFunction_kh(rtb_OR_fz, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_a,
      FmgcComputer_P.ConfirmNode_timeDelay_a2, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_hdw);
    FmgcComputer_DWork.Memory_PreviousInput_f2 = FmgcComputer_P.Logic_table_i[(((((!rtb_y_d1) && rtb_y_nz) ||
      rtb_AND2_po) + (static_cast<uint32_T>(rtb_OR_fz) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_f2];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    apCondition_tmp = (FmgcComputer_DWork.Memory_PreviousInput_f2 && (rtb_DataTypeConversion1_e == 0U));
    rtb_y_j = rtb_Compare_bj;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_j, &rtb_y_f,
      &FmgcComputer_DWork.sf_MATLABFunction_m1w);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_bo);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_hq);
    FmgcComputer_MATLABFunction_k(FmgcComputer_U.in.fms_inputs.lateral_flight_plan_valid,
      FmgcComputer_P.PulseNode3_isRisingEdge_e, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_hu);
    rtb_OR4_e = (((!rtb_y_bo) && (!rtb_y_hq)) || rtb_y_d1);
    rtb_y_hq = ((!rtP_fmgc_ap_fd_logic_output_MATLABStruct.any_lateral_mode_engaged) ||
                FmgcComputer_DWork.Memory_PreviousInput_c);
    rtb_y_nz = rtb_y_hq;
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Memory_PreviousInput_dv, FmgcComputer_P.PulseNode4_isRisingEdge_b,
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_id);
    rtb_NOT1_n_tmp = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active;
    rtb_Compare_ji_tmp_0 = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active;
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_m) || (rtb_y_i1_tmp && ((rtb_NOT1_n_tmp && rtb_Compare_ji_tmp_0 &&
      rtb_ap_fd_condition_tmp_1 && rtb_y_f) || (rtb_y_h && rtb_OR4_e && rtb_y_hq) || rtb_y_d1)));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_bo);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_d1);
    FmgcComputer_MATLABFunction_k((rtb_y_bo || rtb_y_d1), FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_f,
      &FmgcComputer_DWork.sf_MATLABFunction_h0);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
      FmgcComputer_P.BitfromLabel1_bit_p, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_k, &rtb_y_m5,
      &FmgcComputer_DWork.sf_MATLABFunction_jle);
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active),
      FmgcComputer_P.PulseNode6_isRisingEdge, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_jd);
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Memory_PreviousInput_dv, FmgcComputer_P.PulseNode5_isRisingEdge_a,
      &rtb_y_nz, &FmgcComputer_DWork.sf_MATLABFunction_ew);
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_f || rtb_y_m5 || rtb_y_d1 ||
      rtb_Compare_ji_tmp || rtb_y_nz || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active || rtb_AND2_po) + (
      static_cast<uint32_T>(rtb_Compare_bj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_i1];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_co,
      FmgcComputer_P.ConfirmNode_timeDelay_d1, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_ge4);
    FmgcComputer_DWork.Memory_PreviousInput_ip = FmgcComputer_P.Logic_table_a[(((rtb_Compare_ji_tmp || rtb_AND2_po ||
      ((rtb_Logic_d_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_d1))) + (
      static_cast<uint32_T>(rtb_Compare_bj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_ip];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_o, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_k4c);
    rtb_OR4_e = rtb_y_ed;
    rtb_y_ed = (rtb_y_d1 && rtb_y_ed && (rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_m) &&
    ...
    FmgcComputer_MATLABFunction_kh(rtb_y_ed, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_n,
      FmgcComputer_P.ConfirmNode_timeDelay_g, &rtb_OR4_e, &FmgcComputer_DWork.sf_MATLABFunction_ah);
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed,
      FmgcComputer_P.PulseNode_isRisingEdge_g, &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_ol);
    rtb_OR4_g = (rtb_OR4_g && rtb_y_d1 && FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed);
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed,
      FmgcComputer_P.PulseNode3_isRisingEdge_d, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_mne);
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_OR4_e) && rtb_y_bo) ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_OR4_g || rtb_y_d1) + (static_cast<
      uint32_T>((rtb_Compare_bj && rtb_y_m) || (rtb_y_no4 && (rtb_y_p || rtb_y_ed))) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_k_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_j, &rtb_y_gl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_o, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_k_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o, &rtb_y_nl);
    rtb_y_gl = (rtb_y_gl - static_cast<real32_T>(FmgcComputer_B.u_lyj + 360.0)) + 360.0F;
    if (rtb_y_gl == 0.0F) {
      rtb_DataTypeConversion2_kb = 0.0F;
    } else {
      rtb_DataTypeConversion2_kb = std::fmod(rtb_y_gl, 360.0F);
      if (rtb_DataTypeConversion2_kb == 0.0F) {
        rtb_DataTypeConversion2_kb = 0.0F;
      } else if (rtb_y_gl < 0.0F) {
    ...
    if (360.0F - rtb_DataTypeConversion2_kb == 0.0F) {
      ...
      rtb_y_gl = std::fmod(360.0F - rtb_DataTypeConversion2_kb, 360.0F);
      if (rtb_y_gl == 0.0F) {
        rtb_y_gl = 0.0F;
      } else if (360.0F - rtb_DataTypeConversion2_kb < 0.0F) {
        rtb_y_gl += 360.0F;
      }
    }

    if (rtb_DataTypeConversion2_kb < rtb_y_gl) {
      rtb_y_gl = -rtb_DataTypeConversion2_kb;
    }

    if (FmgcComputer_DWork.Delay2_DSTATE.Phi_loc_c < 0.0) {
      high_i = -1;
    } else {
      high_i = (FmgcComputer_DWork.Delay2_DSTATE.Phi_loc_c > 0.0);
    }
    ...
    if (low_i == high_i) {
      rtb_DataTypeConversion1_d = std::abs(FmgcComputer_DWork.Delay2_DSTATE.Phi_loc_c);
      guard1 = false;
      if (rtb_DataTypeConversion1_d > 5.0) {
        if (std::abs(rtb_y_nl) <= 5.0F) {
          rtb_Compare_bj = true;
        } else {
          if (rtb_y_nl < 0.0F) {
            low_ip1 = -1;
          } else {
            low_ip1 = (rtb_y_nl > 0.0F);
          }
      ...
      if (guard1) {
        ...
        rtb_Compare_bj = ((rtb_DataTypeConversion1_d >= std::abs(rtb_y_nl)) && (high_i == low_ip1));
      }
    } else {
      rtb_Compare_bj = false;
    }

    rtb_DataTypeConversion2_kb = std::abs(rtb_y_gl);
    if (rtb_DataTypeConversion2_kb < 115.0F) {
      rtb_y_nl = std::abs(rtb_y_g);
      if (rtb_y_g < 0.0F) {
        high_i = -1;
      } else {
        high_i = (rtb_y_g > 0.0F);
      ...
      if (((rtb_DataTypeConversion2_kb > 25.0F) && ((rtb_y_nl < 10.0F) && ((low_i != high_i) && rtb_Compare_bj))) ||
          (rtb_y_nl < 1.92)) {
        rtb_Compare_bj = (rtb_Compare_bj || ((rtb_DataTypeConversion2_kb < 15.0F) && (rtb_y_nl < 1.1)));
      } else {
        rtb_Compare_bj = false;
      }
    } else {
    ...
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg, &rtb_y_bo);
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.loc_armed && rtb_Compare_bj && rtb_y_bo));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_at,
      FmgcComputer_P.ConfirmNode_timeDelay_h4, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_p4);
    rtb_y_bo = (rtb_AND8 || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active);
    FmgcComputer_DWork.Memory_PreviousInput_cv = FmgcComputer_P.Logic_table_g4[(((((!rtb_y_d1) && (rtb_y_bo ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_AND2_po) + (static_cast<uint32_T>
      (rtb_Compare_bj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cv];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_2,
      FmgcComputer_P.BitfromLabel_bit_es, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_b, &rtb_y_gl);
    if (rtb_y_gl < 0.0F) {
      rtb_DataTypeConversion1_d = -rtb_y_gl;
    } else {
      rtb_DataTypeConversion1_d = rtb_y_gl;
    ...
    FmgcComputer_MATLABFunction_kh((rtb_DataTypeConversion1_d < FmgcComputer_P.CompareToConstant1_const_n),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_nd, FmgcComputer_P.ConfirmNode_timeDelay_e,
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_is);
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active && rtb_y_d1));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ea,
      FmgcComputer_P.ConfirmNode_timeDelay_es, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_pr);
    FmgcComputer_DWork.Memory_PreviousInput_lq = FmgcComputer_P.Logic_table_j[(((((!rtb_y_d1) && (rtb_y_bo ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_AND2_po) + (static_cast<uint32_T>
      (rtb_Compare_bj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_lq];
    rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft.SSM =
      rtb_adrComputationBus_altitude_corrected_ft_SSM;
    rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft.Data =
      rtb_adrComputationBus_altitude_corrected_ft_Data;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_c, &rtb_y_gl);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pm, &rtb_y_dbv);
    rtb_DataTypeConversion2_kb = rtb_y_gl - rtb_y_dbv;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_j, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jm, &rtb_y_nl);
    ...
    rtb_y_ed = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    ...
    rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s.Data =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_Data;
    if (rtb_DataTypeConversion2_kb < 0.0F) {
      rtb_y_d1 = (rtb_y_nl <= 0.0F);
    } else {
      rtb_y_d1 = ((rtb_DataTypeConversion2_kb > 0.0F) && (rtb_y_nl >= 0.0F));
    }

    rtb_OR4_g = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active) && rtb_y_k && rtb_OR_ko &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_ap_fd_condition_tmp_1 && ((!rtb_y_d1) ||
      ((!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) &&
       (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active))) && ((!rtb_y_ed) || (rtb_DataTypeConversion2_kb
      <= FmgcComputer_P.CompareToConstant2_const_jy)) && rtb_y_ft && FmgcComputer_DWork.Memory_PreviousInput_n));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_gt_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_h, &rtb_y_nl);
    rtb_y_gl = std::abs(rtb_y_nl);
    high_i = 7;
    low_i = 0;
    low_ip1 = 2;
    while (high_i > low_ip1) {
      mid_i = ((low_i + high_i) + 1) >> 1;
      if (static_cast<real_T>(rtb_y_gl) >= b[mid_i - 1]) {
        low_i = mid_i - 1;
        low_ip1 = mid_i + 1;
      } else {
        high_i = mid_i;
    ...
    rtb_DataTypeConversion2_kb = rtb_y_gl - static_cast<real32_T>(b[low_i]);
    rtb_y_g = rtb_y_nl * 0.00508F;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_d, &rtb_y_gl);
    rtb_Phi_c_deg = rtb_altCstrOrFcu - rtb_y_gl;
    rtb_Nosewheel_c = std::abs(rtb_Phi_c_deg);
    if (rtb_Phi_c_deg < 0.0) {
      rtb_Phi_c_deg = -1.0;
    } else {
      rtb_Phi_c_deg = (rtb_Phi_c_deg > 0.0);
    }

    if (rtb_y_nl < 0.0F) {
      high_i = -1;
    } else {
      high_i = (rtb_y_nl > 0.0F);
    }

    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_m) || (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed && (!rtb_y_d1) && ((std::fmin(3000.0F, std::fmax(80.0F,
      rtb_y_g * rtb_y_g / ((((rtb_DataTypeConversion2_kb * static_cast<real32_T>(c[low_i]) + static_cast<real32_T>
      (c[low_i + 6])) * rtb_DataTypeConversion2_kb + static_cast<real32_T>(c[low_i + 12])) * rtb_DataTypeConversion2_kb
      + static_cast<real32_T>(c[low_i + 18])) * 9.81F) * 3.28084F)) > rtb_Nosewheel_c) && (static_cast<int32_T>
      (rtb_Phi_c_deg) == high_i)) && ((rtb_raComputationData >= FmgcComputer_P.CompareToConstant_const_l5) ||
      (rtb_OR2_l_tmp && rtb_appInop_idx_2))));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode_isRisingEdge_hux, FmgcComputer_P.ConfirmNode_timeDelay_lk, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_hw);
    FmgcComputer_DWork.Memory_PreviousInput_ne = FmgcComputer_P.Logic_table_nz[(((rtb_AND2_po || ((rtb_y_p3 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_g, &rtb_y_gl);
    FmgcComputer_MATLABFunction_kh((std::abs(rtb_altCstrOrFcu - rtb_y_gl) < FmgcComputer_P.CompareToConstant_const_f),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_nf, FmgcComputer_P.ConfirmNode_timeDelay_at,
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_ee);
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && rtb_y_d1));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lj,
      FmgcComputer_P.ConfirmNode_timeDelay_b, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_dt);
    FmgcComputer_DWork.Memory_PreviousInput_cb = FmgcComputer_P.Logic_table_ob[(((rtb_AND2_po || ((rtb_Compare_dw ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_m, &rtb_y_gl);
    rtb_Compare_ji_tmp = !rtb_OR2_l;
    rtb_Compare_dw = (FmgcComputer_DWork.Memory_PreviousInput_cb && rtb_Compare_ji_tmp && (std::abs
      (FmgcComputer_U.in.fms_inputs.cruise_alt_ft - rtb_y_gl) < FmgcComputer_P.CompareToConstant1_const_a));
    rtb_BusAssignment_o3_logic_adr_computation_data_airspeed_computed_kn.SSM =
      rtb_adrComputationBus_airspeed_computed_kn_SSM;
    rtb_BusAssignment_o3_logic_adr_computation_data_airspeed_computed_kn.Data = rtb_Cos_h;
    ...
    FmgcComputer_MATLABFunction_k((rtb_Logic_a2[0] || FmgcComputer_U.in.discrete_inputs.ap_opp_engaged),
      FmgcComputer_P.PulseNode2_isRisingEdge_bh, &rtb_y_ed, &FmgcComputer_DWork.sf_MATLABFunction_cx);
    rtb_y_d1 = !FmgcComputer_DWork.Delay_DSTATE.any_longitudinal_mode_engaged;
    rtb_y_bo = rtb_y_d1;
    rtb_Compare_bj = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
                      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active);
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode3_isRisingEdge_n, &rtb_y_bo,
      &FmgcComputer_DWork.sf_MATLABFunction_fe);
    rtb_AND8 = (rtb_Compare_bj && rtb_y_bo);
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active,
      FmgcComputer_P.PulseNode4_isRisingEdge_f, &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_bbb);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel6_bit_d, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode5_isRisingEdge_p,
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mr, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oi, &rtb_y_gl);
    rtb_DataTypeConversion2_bh = rtb_y_nl - rtb_y_gl;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_o3_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue, &rtb_y_gl);
    rtb_DataTypeConversion2_kb = rtb_y_gl + FmgcComputer_P.Bias_Bias_e;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_o3_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_o3_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue, &rtb_y_gl);
    rtb_y_p = (rtb_y_nl > rtb_y_gl + FmgcComputer_P.Bias1_Bias);
    rtb_y_p3 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_y_nz = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    rtb_NOT1_n_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 && rtb_NOT1_n_tmp && rtb_Compare_ji_tmp_0);
    rtb_Compare_bj = ((rtb_OR_pj && rtb_y_ed && rtb_y_d1) || rtb_AND8 ||
                      (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active && (rtb_y_bo ||
      ...
      ((FmgcComputer_P.EnumeratedConstant_Value_p == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant2_Value) || rtb_NOT1_n_tmp ||
       rtb_y_lxi)) || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && (std::abs
      (FmgcComputer_B.u_ly - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_om)) || (rtb_y_p3 &&
      (rtb_DataTypeConversion2_bh > FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_y_nz &&
      (rtb_DataTypeConversion2_bh < FmgcComputer_P.CompareToConstant2_const_g)) || ((rtb_y_p3 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (rtb_DataTypeConversion2_kb > rtb_y_nl) &&
      rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k) || (rtb_y_nz && rtb_y_p && rtb_fmgcOppPriority_tmp &&
    ...
    rtb_y_f = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_k((rtb_y_nz || (rtb_DataTypeConversion1_e != 0U)),
      FmgcComputer_P.PulseNode_isRisingEdge_d, &rtb_y_f, &FmgcComputer_DWork.sf_MATLABFunction_nd);
    rtb_y_nz = (rtb_y_if && rtb_y_f && rtb_ap_fd_condition_tmp_1);
    FmgcComputer_MATLABFunction_k(rtb_y_ft, FmgcComputer_P.PulseNode1_isRisingEdge_ky, &rtb_y_p,
      &FmgcComputer_DWork.sf_MATLABFunction_dsw);
    rtb_y_bo = ((rtb_y_bo && rtb_y_m) || (rtb_y_no4 && (rtb_y_nz || (rtb_OR_pj && rtb_y_p && rtb_y_d1) || rtb_Compare_bj)));
    FmgcComputer_MATLABFunction_kh(rtb_y_bo, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_lu,
      FmgcComputer_P.ConfirmNode_timeDelay_ll, &rtb_y_nz, &FmgcComputer_DWork.sf_MATLABFunction_gbq);
    FmgcComputer_DWork.Memory_PreviousInput_fg = FmgcComputer_P.Logic_table_ny[(((rtb_AND2_po || ((rtb_AND_e_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_nz))) + (static_cast<uint32_T>(rtb_y_bo) <<
      1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_fg];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_e, &rtb_DataTypeConversion1_e);
    rtb_fmgcOppPriority_tmp = ((rtb_DataTypeConversion1_e != 0U) && FmgcComputer_DWork.Memory_PreviousInput_fg);
    rtb_AND8 = (FmgcComputer_DWork.Memory_PreviousInput_fg && (rtb_DataTypeConversion1_e == 0U));
    rtb_y_p3 = rtb_Compare_bj;
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3,
      FmgcComputer_P.BitfromLabel_bit_jh, &rtb_DataTypeConversion1_e);
    rtb_Compare_bj = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_et, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_oj, &rtb_y_gl);
    rtb_y_f = (rtb_y_nl > rtb_y_gl);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_px, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_b, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_p3z);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_c, &rtb_y_gl);
    rtb_y_bo = (rtb_AND_e_tmp && rtb_OR2_l);
    rtb_OR4_e = (rtb_OR_pj && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_f && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_bo || (rtb_y_d1 &&
      rtb_AND_e_tmp && (rtb_OR2_l && (std::abs(rtb_altCstrOrFcu - rtb_y_gl) <= FmgcComputer_P.CompareToConstant2_const_d)))));
    rtb_y_nz = (rtb_y_h || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue, &rtb_y_gl);
    rtb_y_f = ((FmgcComputer_U.in.fms_inputs.acceleration_alt_ft != FmgcComputer_P.CompareToConstant_const_lz) &&
               (FmgcComputer_U.in.fms_inputs.acceleration_alt_ft < rtb_y_gl) &&
               ...
               (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active ||
                FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed) && rtb_y_hq);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_jt, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_os, &rtb_y_gl);
    rtb_y_p = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_y_nz && (!rtb_y_f)) || (rtb_y_p ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) && rtb_Compare_ji_tmp) ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) || (rtb_y_nl < rtb_y_gl) || (rtb_AND_e_tmp &&
      (rtb_Compare_ji_tmp || rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_lxi)) ||
      ((FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant3_Value) ||
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant4_Value)) || rtb_AND2_po) + (
      static_cast<uint32_T>((rtb_Compare_bj && rtb_y_m) || (rtb_y_no4 && (rtb_OR4_e || (rtb_y_nz && rtb_y_f)))) << 1)) <<
      1) + FmgcComputer_DWork.Memory_PreviousInput_ma];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_Compare_bj = (rtb_Compare_bj && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_h, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_n, &rtb_y_gl);
    rtb_y_nz = (rtb_y_nl > rtb_y_gl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_j4, &rtb_y_gl);
    FmgcComputer_MATLABFunction_k((rtb_y_gl > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode_isRisingEdge_bg, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_df);
    rtb_y_m5 = (rtb_y_d1 || (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE));
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_p, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_j4,
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_dd);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_d, &rtb_y_gl);
    rtb_y_ed = (rtb_Compare_ji_tmp || (std::abs(rtb_altCstrOrFcu - rtb_y_gl) > FmgcComputer_P.CompareToConstant2_const_a));
    rtb_TmpSignalConversionAtSFunctionInport3_idx_1 = (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible && rtb_y_if);
    rtb_Compare_ji_tmp_0 = !rtb_AND_e_tmp;
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_m) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 &&
      (rtb_ap_fd_condition_tmp_1 && rtb_OR_ko) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_nz &&
      ...
      ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed && rtb_y_m5) || (rtb_y_d1 && (rtb_Compare_ji_tmp_0 ||
      (rtb_AND_e_tmp && (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed) && rtb_y_ed))))));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_fc,
      FmgcComputer_P.ConfirmNode_timeDelay_nn, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_ir);
    rtb_y_hq = (rowIdx_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_ec = FmgcComputer_P.Logic_table_kw[(((rtb_AND2_po || ((rtb_y_hq ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_Compare_bj = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_nh, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_mc, &rtb_y_gl);
    rtb_y_nz = (rtb_y_nl < rtb_y_gl);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_nq, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_f, &rtb_y_ed,
      &FmgcComputer_DWork.sf_MATLABFunction_mrk);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_k, &rtb_y_gl);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_m) || (rtb_y_no4 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant1_Value_c) && (FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant2_Value_pi) && rtb_y_nz && rtb_appCapability_idx_0 &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_bo || (rtb_y_ed && rtb_AND_e_tmp && (rtb_OR2_l &&
      (std::abs(rtb_altCstrOrFcu - rtb_y_gl) <= FmgcComputer_P.CompareToConstant2_const_e)))))));
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_cj, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_b, &rtb_y_gl);
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he[(((rtb_y_p ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active || (rtb_y_nl > rtb_y_gl) || rtb_NOT1_n_tmp ||
      ((FmgcComputer_P.EnumeratedConstant_Value_b == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant6_Value)) || rtb_y_lxi ||
      (rtb_AND_e_tmp && rtb_Compare_ji_tmp) || rtb_AND2_po) + (static_cast<uint32_T>(rtb_Compare_bj) << 1)) << 1) +
    ...
    rtb_Compare_bj = (rtb_Compare_bj && (rtb_DataTypeConversion1_e == 0U));
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mo, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_b5, &rtb_y_gl);
    rtb_y_f = (rtb_y_nl < rtb_y_gl);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_fq,
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_kd);
    rtb_y_ed = !FmgcComputer_DWork.Delay_DSTATE.armed_modes.des_armed;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_m, &rtb_y_gl);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_m) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && (rtb_OR_ko &&
      rtb_ap_fd_condition_tmp_1 && (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active) &&
      rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && rtb_OR2_l_tmp && rtb_appInop_idx_2) && rtb_appCapability_idx_0 &&
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_f && ((FmgcComputer_P.EnumeratedConstant_Value_m
      != FmgcComputer_U.in.fms_inputs.fms_flight_phase) && (FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant1_Value_k) && (FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      FmgcComputer_P.EnumeratedConstant2_Value_pw)) && ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.des_armed &&
      (FmgcComputer_U.in.fms_inputs.next_alt_cstr_ft != FmgcComputer_DWork.DelayInput1_DSTATE_n)) || (rtb_y_d1 &&
      (rtb_Compare_ji_tmp_0 || (rtb_AND_e_tmp && rtb_y_ed && (rtb_Compare_ji_tmp || (std::abs(rtb_altCstrOrFcu -
      rtb_y_gl) > FmgcComputer_P.CompareToConstant2_const_l))))))));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_j,
      FmgcComputer_P.ConfirmNode_timeDelay_dy, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_n5);
    rtb_AND_e_tmp = (rtb_Compare_jz || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active);
    rtb_appCapability_idx_0 = (rtb_AND_e_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    FmgcComputer_DWork.Memory_PreviousInput_b3 = FmgcComputer_P.Logic_table_cv[(((rtb_AND2_po ||
      ((rtb_appCapability_idx_0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_y_d1))) + (static_cast<uint32_T>
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_ht, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_d2, &rtb_y_gl);
    rtb_y_nz = (rtb_y_nl > rtb_y_gl);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel4_bit_d, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_n, &rtb_y_ed,
      &FmgcComputer_DWork.sf_MATLABFunction_f0h);
    rtb_y_p = rtb_TmpSignalConversionAtSFunctionInport3_idx_0;
    rtb_y_m5 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active);
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && rtb_y_m5),
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_jo, FmgcComputer_P.ConfirmNode_timeDelay_jo,
      &rtb_y_m5, &FmgcComputer_DWork.sf_MATLABFunction_moh);
    rtb_y_f = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
                ((FmgcComputer_P.EnumeratedConstant_Value_c == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                 ...
                 rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_lxi)) || rtb_y_m5);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_e, &rtb_y_gl);
    FmgcComputer_MATLABFunction_k((rtb_y_gl > FmgcComputer_U.in.fms_inputs.acceleration_alt_ft),
      FmgcComputer_P.PulseNode1_isRisingEdge_g, &rtb_y_p, &FmgcComputer_DWork.sf_MATLABFunction_lva);
    rtb_y_m5 = (rtb_y_ed || rtb_y_f || (rtb_y_p && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_lxi)));
    rtb_Compare_ji_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_m) || (rtb_Compare_ji_tmp && rtb_y_nz && rtb_y_m5));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ca,
      FmgcComputer_P.ConfirmNode_timeDelay_ib, &rtb_OR4_e, &FmgcComputer_DWork.sf_MATLABFunction_go);
    FmgcComputer_DWork.Memory_PreviousInput_ae = FmgcComputer_P.Logic_table_jq[(((rtb_AND2_po || ((rtb_y_hq ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
    ...
    rtb_OR2_l_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ae && rtb_y_f);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    rtb_OR4_e = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_i, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_dp, &rtb_y_gl);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel4_bit_i, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_fw, &rtb_y_f,
    ...
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active &&
      ...
      FmgcComputer_P.ConfirmNode_isRisingEdge_fq, FmgcComputer_P.ConfirmNode_timeDelay_lp, &rtb_y_m5,
      &FmgcComputer_DWork.sf_MATLABFunction_hj);
    rtb_y_f = (rtb_y_f || rtb_y_m5);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_m) || (rtb_Compare_ji_tmp && (rtb_y_nl < rtb_y_gl) && rtb_y_f));
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ep,
      FmgcComputer_P.ConfirmNode_timeDelay_ob, &rtb_OR4_e, &FmgcComputer_DWork.sf_MATLABFunction_khd);
    FmgcComputer_DWork.Memory_PreviousInput_ev = FmgcComputer_P.Logic_table_l[(((rtb_AND2_po ||
      ((rtb_appCapability_idx_0 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
        FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
        FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (!rtb_OR4_e))) + (static_cast<uint32_T>
    ...
    rtb_y_bo = rtb_y_no4;
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_b, &rtb_y_f,
      &FmgcComputer_DWork.sf_MATLABFunction_pe);
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed,
      FmgcComputer_P.PulseNode_isRisingEdge_lz, &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_iv);
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 && (rtb_y_f && rtb_y_k && rtb_OR_ko))) << 1) +
      (rtb_y_bo || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_g, &rtb_y_gl);
    FmgcComputer_LagFilter(rtb_y_gl, FmgcComputer_P.LagFilter_C1, FmgcComputer_U.in.time.dt, &rtb_DataTypeConversion2_kb,
      &FmgcComputer_DWork.sf_LagFilter_k);
    if (rtb_y_gl < 0.0F) {
      rtb_Nosewheel_c = -rtb_y_gl;
    } else {
      rtb_Nosewheel_c = rtb_y_gl;
    }

    rtb_y_nz = (((rtb_DataTypeConversion2_kb < FmgcComputer_DWork.DelayInput1_DSTATE_b) && (rtb_Nosewheel_c <
      FmgcComputer_P.CompareToConstant1_const_n2)) || (rtb_Nosewheel_c < FmgcComputer_P.CompareToConstant2_const_iq));
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_k);
    rtb_y_bo = (rtb_y_no4 && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_y_d4 && rtb_y_nz && rtb_y_k);
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || rtb_y_bo);
    FmgcComputer_MATLABFunction_kh(rtb_Compare_bj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_g,
      FmgcComputer_P.ConfirmNode_timeDelay_a3g, &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_bs);
    rtb_y_k = (rtb_AND_e_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_nu = FmgcComputer_P.Logic_table_d3[(((((!rtb_y_bo) && (rtb_y_k ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      ...
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_AND2_po) + (static_cast<uint32_T>
      (rtb_Compare_bj) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_nu];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_k, &rtb_y_gl);
    if (rtb_y_gl < 0.0F) {
      rtb_DataTypeConversion1_d = -rtb_y_gl;
    } else {
      rtb_DataTypeConversion1_d = rtb_y_gl;
    ...
    rtb_OR_ko = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 && rtb_OR4_e &&
      (rtb_DataTypeConversion1_d < FmgcComputer_P.CompareToConstant2_const_h)));
    FmgcComputer_MATLABFunction_kh(rtb_OR_ko, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_o,
      FmgcComputer_P.ConfirmNode_timeDelay_mu, &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_db);
    rtb_y_k = FmgcComputer_P.Logic_table_fi[(((((!rtb_y_bo) && (rtb_y_k ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active)) || rtb_AND2_po) + (static_cast<uint32_T>(rtb_OR_ko) <<
      1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_as];
    rtb_BusAssignment_lp_logic_adr_computation_data_airspeed_computed_kn.SSM =
      rtb_adrComputationBus_airspeed_computed_kn_SSM;
    rtb_BusAssignment_lp_logic_adr_computation_data_airspeed_computed_kn.Data = rtb_Cos_h;
    rtb_BusAssignment_lp_logic_ir_computation_data_flight_path_angle_deg.SSM =
      rtb_irComputationBus_flight_path_angle_deg_SSM;
    rtb_BusAssignment_lp_logic_ir_computation_data_flight_path_angle_deg.Data =
      rtb_irComputationBus_flight_path_angle_deg_Data;
    rtb_BusAssignment_lp_logic_ir_computation_data_inertial_vertical_speed_ft_s.SSM =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_SSM;
    rtb_BusAssignment_lp_logic_ir_computation_data_inertial_vertical_speed_ft_s.Data =
      rtb_irComputationBus_inertial_vertical_speed_ft_s_Data;
    rtb_BusAssignment_lp_logic_chosen_fac_bus_v_ls_kn.SSM = rtb_Switch_v_ls_kn_SSM;
    rtb_BusAssignment_lp_logic_chosen_fac_bus_v_ls_kn.Data = rtb_Switch_v_ls_kn_Data;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_hd, &rtb_y_a);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_ir_computation_data_flight_path_angle_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_i, &rtb_y_dbv);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_pc, &rtb_y_nd);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_g, &rtb_DataTypeConversion2_bh);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_d, &rtb_y_gl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_b, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_f, &rtb_y_nl);
    rtb_appCapability_idx_0 = (rtb_fmgcOppPriority_tmp || rtb_AND8);
    if (rtb_fmgcOppPriority_tmp) {
      rtb_y_dbv = rtb_DataTypeConversion2_bh - rtb_y_nd;
    ...
    rtb_Compare_bj = (rtb_Logic_a2[0] && rtb_appCapability_idx_0);
    rtb_OR_ko = ((rtb_Compare_bj && (rtb_y_nl < rtb_y_gl + 3.0F) && (rtb_y_dbv < -rtb_Nosewheel_c)) || (rtb_Compare_bj &&
      (rtb_y_nl > rtb_y_g - 3.0F) && (rtb_y_dbv > rtb_Nosewheel_c)));
    FmgcComputer_MATLABFunction_j((rtb_OR_ko || rtb_OR2_l_tmp || rtb_y_p3 || rtb_y_j), FmgcComputer_U.in.time.dt,
      &FmgcComputer_DWork.Memory_PreviousInput_as, FmgcComputer_P.MTrigNode2_isRisingEdge,
    ...
    FmgcComputer_MATLABFunction_k(rtb_y_ft, FmgcComputer_P.PulseNode_isRisingEdge_fo, &rtb_Compare_bj,
      &FmgcComputer_DWork.sf_MATLABFunction_h0f);
    FmgcComputer_MATLABFunction_j((rtb_y_p3 || rtb_Compare_bj), FmgcComputer_U.in.time.dt, &rtb_OR4_e,
    ...
    FmgcComputer_MATLABFunction_j((rtb_y_j || rtb_Compare_bj), FmgcComputer_U.in.time.dt, &rtb_Compare_bj,
    ...
    rtb_AND_e_tmp = rtb_Compare_bj;
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_d1);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_d4);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_kh(FmgcComputer_DWork.Memory_PreviousInput_i1, FmgcComputer_U.in.time.dt,
      FmgcComputer_P.ConfirmNode1_isRisingEdge_a, FmgcComputer_P.ConfirmNode1_timeDelay_b, &rtb_y_bo,
    ...
    FmgcComputer_MATLABFunction_k(((rtb_y_d1 || rtb_y_d4 || (rtb_DataTypeConversion1_e != 0U)) && (rtb_y_bo ||
      rtb_Compare_bj)), FmgcComputer_P.PulseNode_isRisingEdge_py, &rtb_y_nz, &FmgcComputer_DWork.sf_MATLABFunction_esv);
    rtb_OR4_e = rtb_ap_fd_condition_tmp_0;
    rtb_Compare_bj = (rtb_Compare_bj || rtb_y_h || ((rtb_raComputationData < FmgcComputer_P.CompareToConstant_const_c) &&
      rtb_ap_fd_condition_tmp_0));
    rtb_y_bo = (rtb_y_nz && rtb_Compare_bj);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_kh(rtb_AND2_po, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_nz,
      FmgcComputer_P.ConfirmNode_timeDelay_a5, &rtb_y_nz, &FmgcComputer_DWork.sf_MATLABFunction_k0);
    FmgcComputer_DWork.Memory_PreviousInput_bw = FmgcComputer_P.Logic_table_bs[((((!rtb_Compare_bj) || rtb_OR_fz ||
      apCondition_tmp || FmgcComputer_DWork.Memory_PreviousInput_ip || rtb_OR4_e || rtb_y_nz) + (static_cast<uint32_T>
      (rtb_y_bo) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_bw];
    rtb_BusAssignment_ks_logic_adr_computation_data_altitude_corrected_ft.SSM =
      rtb_adrComputationBus_altitude_corrected_ft_SSM;
    rtb_BusAssignment_ks_logic_adr_computation_data_altitude_corrected_ft.Data =
      rtb_adrComputationBus_altitude_corrected_ft_Data;
    ...
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_m);
    rtb_y_bo = rtb_y_no4;
    FmgcComputer_MATLABFunction_kh(rtb_OR_pj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_b4,
      FmgcComputer_P.ConfirmNode1_timeDelay_h, &rtb_y_nz, &FmgcComputer_DWork.sf_MATLABFunction_hjm);
    FmgcComputer_MATLABFunction_k(rtb_y_nz, FmgcComputer_P.PulseNode3_isRisingEdge_ko, &rtb_y_bo,
      &FmgcComputer_DWork.sf_MATLABFunction_od);
    FmgcComputer_MATLABFunction_k(rtb_y_ft, FmgcComputer_P.PulseNode1_isRisingEdge_kl, &rtb_y_ed,
      &FmgcComputer_DWork.sf_MATLABFunction_dtd);
    rtb_OR4_e = (FmgcComputer_U.in.fms_inputs.fms_flight_phase != FmgcComputer_P.EnumeratedConstant_Value_ad);
    rtb_AND2_po = (rtb_y_ed && rtb_OR4_e);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel3_bit_gv, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode2_isRisingEdge_f,
      &rtb_OR4_e, &FmgcComputer_DWork.sf_MATLABFunction_d5);
    rtb_OR4_e = (rtb_OR4_e && rtb_y_if);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ks_logic_adr_computation_data_altitude_corrected_ft,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_a, &rtb_y_gl);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_alt_ft,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_mh, &rtb_y_nl);
    rtb_y_hq = !FmgcComputer_DWork.Memory_PreviousInput_k;
    rtb_y_nz = (FmgcComputer_U.in.fms_inputs.preset_spd_mach_activate && (rtb_y_hq || (rtb_y_gl <= rtb_y_nl)));
    FmgcComputer_MATLABFunction_k((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant1_const_e), FmgcComputer_P.PulseNode4_isRisingEdge_a, &rtb_y_p,
      &FmgcComputer_DWork.sf_MATLABFunction_aa);
    rtb_y_f = rtb_OR_pj;
    rtb_ap_fd_condition_tmp_0 = !FmgcComputer_DWork.Memory_PreviousInput_i;
    rtb_y_m5 = (rtb_y_hq && rtb_ap_fd_condition_tmp_0 && (!FmgcComputer_DWork.Memory_PreviousInput_nu) && (!rtb_y_k) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_d));
    rtb_AND2_po = (rtb_Compare_bj || (rtb_y_no4 && (((FmgcComputer_P.Constant_Value_k !=
      FmgcComputer_DWork.DelayInput1_DSTATE_f) && rtb_OR_pj) || ((FmgcComputer_U.in.fms_inputs.v_managed_kts ==
      FmgcComputer_P.CompareToConstant_const_dy) && rtb_y_bo && rtb_y_m5) || rtb_AND2_po || rtb_OR4_e || rtb_y_nz ||
      (rtb_y_p && rtb_OR_pj && rtb_y_m5))));
    FmgcComputer_MATLABFunction_kh(rtb_AND2_po, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_ch,
      FmgcComputer_P.ConfirmNode_timeDelay_ht, &rtb_Compare_bj, &FmgcComputer_DWork.sf_MATLABFunction_jcu);
    FmgcComputer_MATLABFunction_k(rtb_BusAssignment_h_logic_engine_running, FmgcComputer_P.PulseNode6_isRisingEdge_j,
      &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_abn);
    FmgcComputer_MATLABFunction_k(rtb_y_ft, FmgcComputer_P.PulseNode5_isRisingEdge_i, &rtb_OR4_e,
      &FmgcComputer_DWork.sf_MATLABFunction_kzm);
    FmgcComputer_DWork.Memory_PreviousInput_cu = FmgcComputer_P.Logic_table_kg
      [((((FmgcComputer_DWork.Delay_DSTATE.auto_spd_control_active && (!rtb_Compare_bj)) || (rtb_y_h && (rtb_y_bo ||
            rtb_OR4_e))) + (static_cast<uint32_T>(rtb_AND2_po) << 1)) << 1) + FmgcComputer_DWork.Memory_PreviousInput_cu];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_5,
      FmgcComputer_P.BitfromLabel_bit_kq, &rtb_DataTypeConversion1_e);
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_m);
    FmgcComputer_MATLABFunction_k(rtb_y_ft, FmgcComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_f,
      &FmgcComputer_DWork.sf_MATLABFunction_aba);
    rtb_y_bo = (FmgcComputer_U.in.fms_inputs.v_2_kts != FmgcComputer_P.CompareToConstant_const_e);
    ...
    FmgcComputer_MATLABFunction_k(rtb_y_bo, FmgcComputer_P.PulseNode2_isRisingEdge_iu, &rtb_y_nz,
      &FmgcComputer_DWork.sf_MATLABFunction_ft);
    rtb_y_nz = (rtb_y_ft && rtb_y_nz);
    rtb_OR4_e = ((rtb_y_f && rtb_y_bo) || (rtb_OR4_e && rtb_y_bo && rtb_y_ft) || rtb_y_nz);
    rtb_y_d1 = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_k(rtb_y_d1, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_f,
      &FmgcComputer_DWork.sf_MATLABFunction_mrn);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel2_bit_ie, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_jp, &rtb_y_m5,
    ...
    FmgcComputer_MATLABFunction_k((rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active ||
      ...
      FmgcComputer_P.PulseNode4_isRisingEdge_n, &rtb_y_nz, &FmgcComputer_DWork.sf_MATLABFunction_lr);
    rtb_y_bo = ((rtb_y_h && rtb_OR4_e) || (rtb_y_f || rtb_y_m5 || rtb_y_nz));
    rtb_OR4_e = (FmgcComputer_U.in.fms_inputs.v_managed_kts != FmgcComputer_P.CompareToConstant2_const_m);
    rtb_y_nz = (FmgcComputer_U.in.fms_inputs.v_2_kts != FmgcComputer_P.CompareToConstant3_const_j);
    rtb_y_bo = (rtb_Compare_bj || (rtb_y_no4 && rtb_y_bo && (rtb_OR4_e || rtb_y_nz)));
    FmgcComputer_MATLABFunction_kh(rtb_y_bo, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_h2,
      FmgcComputer_P.ConfirmNode_timeDelay_gz, &rtb_Compare_bj, &FmgcComputer_DWork.sf_MATLABFunction_j3h);
    FmgcComputer_MATLABFunction_k((FmgcComputer_U.in.fms_inputs.v_2_kts == FmgcComputer_P.CompareToConstant1_const_m),
      FmgcComputer_P.PulseNode6_isRisingEdge_k, &rtb_OR4_e, &FmgcComputer_DWork.sf_MATLABFunction_dq);
    FmgcComputer_DWork.Memory_PreviousInput_h = FmgcComputer_P.Logic_table_ds
      [((((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active && (!rtb_Compare_bj)) || (rtb_y_h &&
           (rtb_ap_fd_condition_tmp_0 && rtb_y_hq) && rtb_OR4_e)) + (static_cast<uint32_T>(rtb_y_bo) << 1)) << 1) +
      FmgcComputer_DWork.Memory_PreviousInput_h];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_1,
      FmgcComputer_P.BitfromLabel_bit_as, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_c2, &rtb_y_nz,
    ...
    FmgcComputer_DWork.Delay_DSTATE_c = FmgcComputer_P.Logic_table_ap[(((static_cast<uint32_T>
      (((!FmgcComputer_DWork.Delay_DSTATE_c) && rtb_y_nz) || FmgcComputer_U.in.fms_inputs.fms_mach_mode_activate ||
       (FmgcComputer_U.in.fms_inputs.preset_spd_mach_activate && (FmgcComputer_U.in.fms_inputs.preset_mach >
      FmgcComputer_P.CompareToConstant1_const_b))) << 1) + ((rtb_y_nz && FmgcComputer_DWork.Delay_DSTATE_c) ||
    ...
    rtb_BusAssignment_dc_logic_adr_computation_data_airspeed_computed_kn.SSM =
      rtb_adrComputationBus_airspeed_computed_kn_SSM;
    rtb_BusAssignment_dc_logic_adr_computation_data_airspeed_computed_kn.Data = rtb_Cos_h;
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_adr_computation_data_corrected_average_static_pressure,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_b, &rtb_y_gl);
    rtb_y_nd = std::pow((std::pow(FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach.Data *
      FmgcComputer_U.in.bus_inputs.fcu_bus.selected_mach.Data * 0.2F + 1.0F, 3.5F) - 1.0F) * (rtb_y_gl / 1013.25F) +
                        1.0F, 0.285714298F);
    if (rtb_y_a22) {
      FmgcComputer_B.u_l = FmgcComputer_U.in.fms_inputs.v_managed_kts;
    }

    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_man_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_h, &rtb_y_gl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_4_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_c, &rtb_y_nl);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_3_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_j, &rtb_y_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_m, &rtb_DataTypeConversion2_bh);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_i, &rtb_y_a);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_cz, &rtb_y_dbv);
    if (!FmgcComputer_DWork.vMemoEo_not_empty) {
      FmgcComputer_DWork.vMemoEo = rtb_DataTypeConversion2_bh;
      FmgcComputer_DWork.vMemoEo_not_empty = true;
    }

    if (!FmgcComputer_DWork.vMemoGa_not_empty) {
      FmgcComputer_DWork.vMemoGa = rtb_DataTypeConversion2_bh;
      FmgcComputer_DWork.vMemoGa_not_empty = true;
    }

    if (rtb_ap_fd_condition_tmp_0) {
      FmgcComputer_DWork.vMemoGa = rtb_DataTypeConversion2_bh;
    }

    rtb_ap_fd_condition_tmp_0 = !rtb_BusAssignment_h_logic_one_engine_out;
    if (rtb_ap_fd_condition_tmp_0) {
      FmgcComputer_DWork.vMemoEo = rtb_DataTypeConversion2_bh;
    }
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_i) {
      ...
      rtb_Nosewheel_c = rtb_y_a + static_cast<real_T>(high_i);
      rtb_pfdTarget = rtb_y_dbv - 5.0;
      if (rtb_y_dbv - 5.0 > rtb_Nosewheel_c) {
        rtb_pfdTarget = rtb_Nosewheel_c;
      }

      if (rtb_pfdTarget > FmgcComputer_DWork.vMemoGa) {
        rtb_pfdTarget = FmgcComputer_DWork.vMemoGa;
      }

      rtb_Nosewheel_c = std::fmax(FmgcComputer_B.u_l, rtb_pfdTarget);
      rtb_pfdTarget = rtb_Nosewheel_c;
      ...
      rtb_pfdTarget = FmgcComputer_U.in.fms_inputs.v_2_kts;
    }
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_h) {
      if (FmgcComputer_DWork.Memory_PreviousInput_d || FmgcComputer_DWork.Memory_PreviousInput_l ||
        ...
        rtb_Switch_e[0] = std::fmax(std::fmax(std::fmax(static_cast<real_T>(rtb_y_gl), static_cast<real_T>(rtb_y_nl)),
          static_cast<real_T>(rtb_y_g)), FmgcComputer_B.u_l);
        rtb_Switch_e[1] = FmgcComputer_B.u_l;
      } else if (rtb_y_d1) {
        rtb_Switch_e[0] = rtb_Nosewheel_c;
        rtb_Switch_e[1] = rtb_pfdTarget;
      } else {
      ...
      if (FmgcComputer_DWork.Delay_DSTATE_c) {
        rtb_y_nl = std::sqrt(rtb_y_nd - 1.0F) * 1479.1F;
      } else {
        rtb_y_nl = FmgcComputer_U.in.bus_inputs.fcu_bus.selected_spd_kts.Data;
      }

      rtb_Switch_e[0] = rtb_y_nl;
      rtb_Switch_e[1] = rtb_y_nl;
    }

    rtb_y_bo = (rtb_appCapability_idx_0 || FmgcComputer_DWork.Memory_PreviousInput_cb ||
                FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_ec ||
                FmgcComputer_DWork.Memory_PreviousInput_b3 ||
                rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active ||
                rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active || rtb_Logic_b[0] ||
                FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_y_k || FmgcComputer_DWork.Memory_PreviousInput_ae ||
    ...
    } else if (apCondition_tmp || FmgcComputer_DWork.Memory_PreviousInput_b || FmgcComputer_DWork.Memory_PreviousInput_e)
    {
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_bc) {
      rtb_active_longitudinal_law = vertical_law::FLARE;
    } else if (FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_y_k || FmgcComputer_DWork.Memory_PreviousInput_d) {
    ...
    } else if (rtb_fmgcOppPriority_tmp || rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.tcas_active) {
    ...
    } else if (FmgcComputer_DWork.Memory_PreviousInput_ne) {
      rtb_active_longitudinal_law = vertical_law::ALT_ACQ;
    } else if (FmgcComputer_DWork.Memory_PreviousInput_cb) {
    ...
    rtb_AND2_po = (rtb_NOT3 || FmgcComputer_DWork.Memory_PreviousInput_e || FmgcComputer_DWork.Memory_PreviousInput_cv ||
                   FmgcComputer_DWork.Memory_PreviousInput_lq || rtb_OR_fz || apCondition_tmp ||
    ...
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_3, &rtb_Compare_bj);
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_Compare_bj);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4,
      FmgcComputer_P.BitfromLabel1_bit_i5, &rtb_DataTypeConversion1_e);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4, &rtb_y_d1);
    rtb_Compare_bj = ((rtb_Compare_bj || ((rtb_DataTypeConversion1_e != 0U) && rtb_y_d1)) &&
                      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged);
    rtb_y_d1 = (rtb_Logic_a2[0] && (FmgcComputer_DWork.Memory_PreviousInput_l ||
      FmgcComputer_DWork.Memory_PreviousInput_d));
    rtb_y_d4 = ((!fdOppOff) && (FmgcComputer_U.in.discrete_inputs.fwc_own_valid ||
    ...
    rtb_y_ed = (rtb_y_d4 && (!rtb_ap_fd_condition_tmp) && rtb_bothRaValid);
    rtb_appInop_idx_2 = (FmgcComputer_U.in.discrete_inputs.fwc_own_valid &&
                         FmgcComputer_U.in.discrete_inputs.fwc_opp_valid &&
                         FmgcComputer_U.in.discrete_inputs.powersupply_split &&
                         FmgcComputer_U.in.discrete_inputs.pfd_own_valid &&
                         FmgcComputer_U.in.discrete_inputs.pfd_opp_valid && rtb_appCapability_idx_2 && apCondition_tmp_0
                         ...
                         FmgcComputer_U.in.discrete_inputs.bscu_opp_valid && rtb_irOwnInvalid);
    rtb_appCapability_idx_2 = (FmgcComputer_DWork.pLand3FailOp || (rtb_appInop_idx_2 && rtb_y_d1 && rtb_Compare_bj &&
      FmgcComputer_DWork.Delay_DSTATE_k));
    rtb_appCapability_idx_0 = !rtb_appCapability_idx_2;
    apCondition_tmp_0 = (FmgcComputer_DWork.pLand3FailPass || (rtb_y_ed && rtb_y_d1 && FmgcComputer_DWork.Delay_DSTATE_k
      && rtb_appCapability_idx_0));
    rtb_appCapability_idx_0 = (rtb_y_d4 && rtb_y_d1 && (!apCondition_tmp_0) && rtb_appCapability_idx_0);
    rtb_y_d4 = !rtb_y_d4;
    rtb_y_ed = !rtb_y_ed;
    rtb_appInop_idx_2 = !rtb_appInop_idx_2;
    if ((rtb_raComputationData < 100.0F) && (rtb_y_d1 || rtb_Compare_bj)) {
    ...
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_4, &rtb_Compare_bj);
    ...
    if (rtb_Logic_a2[0] && FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) {
      if (FmgcComputer_U.in.discrete_inputs.is_unit_1) {
        rtb_TmpSignalConversionAtSFunctionInport3_idx_0 = rtb_appCapability_idx_0;
    ...
    rtb_BusAssignment_jm_logic_ir_computation_data_track_angle_magnetic_deg.SSM =
      rtb_irComputationBus_track_angle_magnetic_deg_SSM;
    rtb_BusAssignment_jm_logic_ir_computation_data_track_angle_magnetic_deg.Data =
      rtb_irComputationBus_track_angle_magnetic_deg_Data;
    ...
    rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg.Data =
      rtb_Switch_i_glideslope_deviation_deg_Data;
    FmgcComputer_DWork.Delay_DSTATE.any_longitudinal_mode_engaged = rtb_y_bo;
    rtb_pfdTarget = rtb_irComputationBus_pitch_angle_deg_Data;
    ...
    rtb_DataTypeConversion4 = rtb_Cos_h;
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_chosen_fac_bus_estimated_sideslip_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_h, &rtb_y_nd);
    rtb_DataTypeConversion27 = rtb_y_nd;
    ...
    rtb_DataTypeConversion15 = rtb_irComputationBus_track_angle_magnetic_deg_Data;
    ...
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_a22);
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_i, &rtb_DataTypeConversion2_bh);
    rtb_DataTypeConversion26 = rtb_DataTypeConversion2_bh;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_j, &rtb_y_nl);
    rtb_DataTypeConversion39 = rtb_y_nl;
    rtb_Compare_bj = (FmgcComputer_DWork.Memory_PreviousInput_e || FmgcComputer_DWork.Memory_PreviousInput_b);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_ir_computation_data_track_angle_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault8_defaultValue, &rtb_y_dbv);
    if (!rtb_Compare_bj) {
      FmgcComputer_B.u_lyjj = rtb_y_dbv;
    }

    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue_a, &rtb_y_dbv);
    if (rtb_Compare_bj) {
      rtb_DataTypeConversion10 = FmgcComputer_B.u_lyjj;
    } else {
      rtb_DataTypeConversion10 = rtb_y_dbv;
    }

    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fc, &rtb_y_g);
    rtb_DataTypeConversion41 = rtb_y_g;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_f, &rtb_y_dbv);
    rtb_DataTypeConversion42 = rtb_y_dbv;
    rtb_y_d1 = (rtb_y_k || FmgcComputer_DWork.Memory_PreviousInput_d);
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_pfdTarget,
                    ...
                    &rtb_DataTypeConversion20, &rtb_Gain, &rtb_Gain1, &rtb_Gain2, &FmgcComputer_B.u_lyj,
                    &FmgcComputer_P.Constant_Value_m, &FmgcComputer_B.u, (const_cast<real_T*>(&FmgcComputer_RGND)),
                    &rtb_DataTypeConversion25, &rtb_y_a22, &rtb_DataTypeConversion23,
                    ...
                    &rtb_DataTypeConversion32, &rtb_DataTypeConversion26, &rtb_y_h, (const_cast<real_T*>
      (&FmgcComputer_RGND)), &rtb_Gain3, &(&rtb_Logic_a2[0])[0], &rtb_active_lateral_law, &rtb_active_longitudinal_law,
                    &rtb_DataTypeConversion39, &rtb_DataTypeConversion10, &rtb_altCstrOrFcu, &rtb_DataTypeConversion41,
                    &rtb_DataTypeConversion42, &(&rtb_Switch_e[0])[0],
                    &rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.cruise_active,
                    &rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.tcas_active, &(&rtb_Logic_b[0])[0],
                    &rtb_y_d1, &rtb_Phi_loc_c, &rtb_Nosewheel_c, &rtb_Theta_c_deg, &rtb_Phi_c_deg, &rtb_Beta_c_deg,
                    &rtb_Product_a, &rtb_Switch1_a, &rtb_Beta_c_deg_e, &rtb_Compare_bj, &rtb_H_dot_radio_fpm,
    ...
    FmgcComputer_MATLABFunction_k((rtb_y_ha != 0U), FmgcComputer_P.PulseNode3_isRisingEdge_ng, &rtb_y_d1,
      &FmgcComputer_DWork.sf_MATLABFunction_k);
    FmgcComputer_DWork.Memory_PreviousInput_hu = FmgcComputer_P.Logic_table_lm[(((static_cast<uint32_T>(rtb_y_d1) << 1)
      + rtb_y_n) << 1) + FmgcComputer_DWork.Memory_PreviousInput_hu];
    rtb_BusAssignment_b_logic_ra_computation_data_ft = rtb_Switch1_a;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_hw, &rtb_y_nl);
    rtb_y_a22 = (rtb_y_nl >= FmgcComputer_P.CompareToConstant_const_hq);
    rtb_y_d1 = (rtb_y_nl <= FmgcComputer_P.CompareToConstant2_const_di);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_o2, &rtb_y_nl);
    rtb_y_hq = (rtb_y_nl >= FmgcComputer_P.CompareToConstant1_const_h4);
    rtb_y_nz = (rtb_y_nl <= FmgcComputer_P.CompareToConstant3_const_d);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_lxi);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_p);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_k, &rtb_y_nl);
    rtb_Compare_jz = (rtb_y_nl > FmgcComputer_P.CompareToConstant4_const_p);
    rtb_OR4_e = (rtb_y_nl <= FmgcComputer_P.CompareToConstant6_const_h);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_l, &rtb_y_nl);
    rtb_pfdTarget = rtb_Product_a;
    rtb_y_nz = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_a22 &&
      rtb_y_d1 && rtb_y_hq && rtb_y_nz) || ((!rtb_y_lxi) && (!rtb_y_p) && rtb_BusAssignment_h_logic_one_engine_out &&
      (rtb_Compare_jz && rtb_OR4_e && (rtb_y_nl > FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_nl <=
      FmgcComputer_P.CompareToConstant7_const)))));
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_n, &rtb_y_nl);
    rtb_Switch1_a = rtb_y_nl;
    rtb_y_a22 = (rtb_y_nl < FmgcComputer_P.CompareToConstant8_const);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_mv, &rtb_y_nl);
    rtb_y_lxi = (rtb_y_nz && ((rtb_Switch1_a < FmgcComputer_P.CompareToConstant10_const) || (rtb_y_nl <
      FmgcComputer_P.CompareToConstant11_const) || (rtb_BusAssignment_h_logic_one_engine_out && (rtb_y_a22 || (rtb_y_nl <
    ...
    FmgcComputer_MATLABFunction_k((((rtb_active_longitudinal_law == vertical_law::SPD_MACH) ||
      ...
      FmgcComputer_DWork.Delay_DSTATE_k), FmgcComputer_P.PulseNode_isRisingEdge_o, &rtb_y_hq,
      &FmgcComputer_DWork.sf_MATLABFunction_j);
    rtb_y_a22 = !FmgcComputer_DWork.Memory_PreviousInput_hu;
    rtb_y_p = (((rtb_y_ha != 0U) && rtb_y_m) || (rtb_y_no4 && rtb_y_hq && rtb_y_a22));
    FmgcComputer_MATLABFunction_kh(rtb_y_p, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_b,
      FmgcComputer_P.ConfirmNode_timeDelay_gu, &rtb_y_hq, &FmgcComputer_DWork.sf_MATLABFunction_ay);
    rtb_y_d1 = (FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active ||
                FmgcComputer_DWork.Delay1_DSTATE.retard_mode_active);
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_n || ((rtb_y_d1 ||
      FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_hq))) + (static_cast<uint32_T>(rtb_y_p) << 1))
    ...
    FmgcComputer_MATLABFunction_k(((((rtb_active_longitudinal_law == vertical_law::NONE) &&
      ((!FmgcComputer_DWork.Delay1_DSTATE.retard_mode_active) || rtb_OR_pj)) || (rtb_active_longitudinal_law ==
      ...
      rtb_Logic_b[0]))) && FmgcComputer_DWork.Delay_DSTATE_k), FmgcComputer_P.PulseNode_isRisingEdge_fz, &rtb_y_hq,
      &FmgcComputer_DWork.sf_MATLABFunction_ge);
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_y_m) || (rtb_y_no4 && rtb_y_hq && rtb_y_a22));
    FmgcComputer_MATLABFunction_kh(rtb_OR_pj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_k,
      FmgcComputer_P.ConfirmNode_timeDelay_ez, &rtb_y_hq, &FmgcComputer_DWork.sf_MATLABFunction_ig);
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_n || ((rtb_y_d1 ||
      FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active) && (!rtb_y_hq))) + (static_cast<uint32_T>(rtb_OR_pj) << 1)) <<
      1) + FmgcComputer_DWork.Memory_PreviousInput_cm];
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.ats_discrete_word,
      FmgcComputer_P.BitfromLabel_bit_h, &rtb_y_ha);
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_y_m) || (rtb_y_no4 && FmgcComputer_DWork.Memory_PreviousInput_d &&
      rtb_Logic_a2[0] && (rtb_raComputationData <= FmgcComputer_P.CompareToConstant_const_e3) && rtb_y_a22));
    FmgcComputer_MATLABFunction_kh(rtb_OR_pj, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_cs,
      FmgcComputer_P.ConfirmNode_timeDelay_br, &rtb_y_hq, &FmgcComputer_DWork.sf_MATLABFunction_kh);
    FmgcComputer_DWork.Memory_PreviousInput_o = FmgcComputer_P.Logic_table_acc[(((rtb_y_n ||
      ((FmgcComputer_DWork.Delay1_DSTATE.alpha_floor_mode_active || FmgcComputer_DWork.Delay1_DSTATE.thrust_mode_active ||
        FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_hq))) + (static_cast<uint32_T>(rtb_OR_pj) <<
    ...
    rtb_y_hq = (FmgcComputer_DWork.Memory_PreviousInput_b3 || FmgcComputer_DWork.Memory_PreviousInput_ev ||
                rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active);
    rtb_OR_pj = (rtb_y_hq || rtb_Logic_b[0]);
    FmgcComputer_DWork.Memory_PreviousInput_kr = FmgcComputer_P.Logic_table_b3[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        ...
        rtb_fmgcOppPriority_tmp || rtb_AND8) && rtb_ap_fd_condition_tmp_0) << 1) +
      (rtb_BusAssignment_h_logic_one_engine_out || rtb_y_h || ((FmgcComputer_P.EnumeratedConstant_Value_by ==
      FmgcComputer_U.in.fms_inputs.fms_flight_phase) && (rtb_adrComputationBus_altitude_corrected_ft_Data <
    ...
    FmgcComputer_DWork.Memory_PreviousInput_km = FmgcComputer_P.Logic_table_mj[(((static_cast<uint32_T>
      (((rtb_adrComputationBus_altitude_corrected_ft_Data >= FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft) ||
        FmgcComputer_DWork.Memory_PreviousInput_ne || FmgcComputer_DWork.Memory_PreviousInput_cb ||
        rtb_fmgcOppPriority_tmp || rtb_AND8) && rtb_BusAssignment_h_logic_one_engine_out) << 1) +
      (rtb_ap_fd_condition_tmp_0 || rtb_y_h || ((FmgcComputer_P.EnumeratedConstant1_Value_e ==
      FmgcComputer_U.in.fms_inputs.fms_flight_phase) && (rtb_adrComputationBus_altitude_corrected_ft_Data <
      FmgcComputer_U.in.fms_inputs.thrust_reduction_alt_ft)))) << 1) + FmgcComputer_DWork.Memory_PreviousInput_km];
    rtb_y_l = athr_fma_message::NONE;
    rtb_y_a22 = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_a22);
    if (rtb_y_a22 && FmgcComputer_DWork.Memory_PreviousInput_kr &&
      ...
      rtb_y_l = athr_fma_message::LVR_CLB;
    } else if (rtb_y_a22 && FmgcComputer_DWork.Memory_PreviousInput_km &&
      ...
      rtb_y_l = athr_fma_message::LVR_MCT;
    } else if (rtb_y_a22 && rtb_ap_fd_condition_tmp_0 &&
               (((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 24.0F) &&
                 (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 26.0F) &&
                 ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 26.0F))) ||
                ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 24.0F) &&
                 ...
                 ((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 26.0F))))) {
      rtb_y_l = athr_fma_message::LVR_ASYM;
    }
    ...
    rtb_y_nl = std::fmax(FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data,
                         FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_a22);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_no4);
    rtb_y_a22 = (rtb_y_a22 || rtb_y_no4);
    rtb_y_ey = athr_fma_mode::NONE;
    rtb_y_d1 = !rtb_y_nz;
    rtb_ap_fd_condition_tmp_0 = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_d1);
    if (rtb_ap_fd_condition_tmp_0 && (rtb_y_nl > 44.0F)) {
      rtb_y_ey = athr_fma_mode::MAN_TOGA;
    } else {
      rtb_y_no4 = (rtb_ap_fd_condition_tmp_0 && (rtb_y_nl > 34.0F) && (rtb_y_nl < 36.0F));
      if (rtb_y_no4 && rtb_y_a22) {
        rtb_y_ey = athr_fma_mode::MAN_FLEX;
      } else if (rtb_y_no4 && (!rtb_y_a22)) {
        rtb_y_ey = athr_fma_mode::MAN_MCT;
      } else if (rtb_ap_fd_condition_tmp_0 && (rtb_y_nl > 24.0F)) {
        rtb_y_ey = athr_fma_mode::MAN_THR;
      } else {
        rtb_ap_fd_condition_tmp_0 = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_nz);
        rtb_y_no4 = (rtb_ap_fd_condition_tmp_0 && FmgcComputer_DWork.Memory_PreviousInput_cm);
        if (rtb_y_no4 && (!FmgcComputer_DWork.Delay_DSTATE_c)) {
          rtb_y_ey = athr_fma_mode::SPEED;
        } else if (rtb_y_no4 && FmgcComputer_DWork.Delay_DSTATE_c) {
          rtb_y_ey = athr_fma_mode::MACH;
        } else {
          rtb_y_no4 = (rtb_ap_fd_condition_tmp_0 && FmgcComputer_DWork.Memory_PreviousInput_bh);
          rtb_y_a22 = !rtb_OR_pj;
          if (rtb_y_no4 && (rtb_y_nl > 34.0F) && rtb_y_a22) {
            rtb_y_ey = athr_fma_mode::THR_MCT;
          } else if (rtb_y_no4 && (rtb_y_nl > 24.0F) && rtb_y_a22) {
            rtb_y_ey = athr_fma_mode::THR_CLB;
          } else if (rtb_y_no4 && (rtb_y_nl < 25.0F) && rtb_y_a22) {
            rtb_y_ey = athr_fma_mode::THR_LVR;
          } else if (rtb_ap_fd_condition_tmp_0 && ((FmgcComputer_DWork.Memory_PreviousInput_bh && rtb_OR_pj) ||
                      FmgcComputer_DWork.Memory_PreviousInput_o)) {
            rtb_y_ey = athr_fma_mode::THR_IDLE;
          } else {
            rtb_ap_fd_condition_tmp_0 = (rtb_ap_fd_condition_tmp_0 && FmgcComputer_DWork.Memory_PreviousInput_hu);
            if (rtb_ap_fd_condition_tmp_0 && (rtb_y_ha != 0U)) {
              rtb_y_ey = athr_fma_mode::A_FLOOR;
            } else if (rtb_ap_fd_condition_tmp_0 && (rtb_y_ha == 0U)) {
              rtb_y_ey = athr_fma_mode::TOGA_LK;
            }
          }
        }
      }
    ...
    rtb_BusAssignment_jc_logic_adr_computation_data_airspeed_computed_kn.SSM =
      rtb_adrComputationBus_airspeed_computed_kn_SSM;
    rtb_BusAssignment_jc_logic_adr_computation_data_airspeed_computed_kn.Data = rtb_Cos_h;
    rtb_BusAssignment_jc_logic_ir_computation_data_ground_speed_kn.Data = rtb_Gain2_f;
    rtb_BusAssignment_jc_logic_ir_computation_data_track_angle_magnetic_deg.SSM =
      rtb_irComputationBus_track_angle_magnetic_deg_SSM;
    rtb_BusAssignment_jc_logic_ir_computation_data_track_angle_magnetic_deg.Data =
      rtb_irComputationBus_track_angle_magnetic_deg_Data;
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_km, &rtb_DataTypeConversion2_bh);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_chosen_fac_bus_v_ls_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_hv, &rtb_y_dbv);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_i, &rtb_y_nl);
    v[0] = rtb_y_dbv;
    v[1] = static_cast<real32_T>(rtb_Switch_e[0]);
    v[2] = rtb_y_nl;
    if (rtb_y_dbv < static_cast<real32_T>(rtb_Switch_e[0])) {
      if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_nl) {
        high_i = 1;
      } else if (rtb_y_dbv < rtb_y_nl) {
        high_i = 2;
      } else {
        high_i = 0;
      }
      ...
      high_i = 0;
    } else if (static_cast<real32_T>(rtb_Switch_e[0]) < rtb_y_nl) {
      high_i = 2;
    } else {
      high_i = 1;
    }

    rtb_DataTypeConversion2_bh = v[high_i] - rtb_DataTypeConversion2_bh;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
      FmgcComputer_P.A429ValueOrDefault11_defaultValue, &rtb_y_nl);
    rtb_DataTypeConversion1_d = FmgcComputer_P.Gain1_Gain_a * rtb_y_nl;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault10_defaultValue, &rtb_y_nl);
    rtb_DataTypeConversion8 = FmgcComputer_P.fpmtoms_Gain * rtb_y_nl;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_ground_speed_kn,
      FmgcComputer_P.A429ValueOrDefault8_defaultValue_i, &rtb_y_nl);
    rtb_Switch1_a = rtb_y_nl;
    rtb_DataTypeConversion2_i = FmgcComputer_P.kntoms_Gain * rtb_y_nl;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault12_defaultValue, &rtb_y_nl);
    rtb_Product_a = FmgcComputer_P.Gain1_Gain_h * rtb_y_nl;
    rtb_DataTypeConversion3 = std::cos(rtb_Product_a);
    rtb_DataTypeConversion4 = std::sin(rtb_Product_a);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_heading_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault13_defaultValue, &rtb_y_nl);
    rtb_DataTypeConversion5 = FmgcComputer_P.Gain1_Gain_f * rtb_y_nl;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_track_angle_magnetic_deg,
      FmgcComputer_P.A429ValueOrDefault14_defaultValue, &rtb_y_nl);
    ...
    rtb_DataTypeConversion6 = FmgcComputer_P.ktstomps_Gain * rtb_Switch1_a * FmgcComputer_P._Gain;
    if ((!FmgcComputer_DWork.pY_not_empty_b) || (!FmgcComputer_DWork.pU_not_empty_n)) {
      FmgcComputer_DWork.pU_p = rtb_DataTypeConversion6;
      FmgcComputer_DWork.pU_not_empty_n = true;
      FmgcComputer_DWork.pY_f = rtb_DataTypeConversion6;
      FmgcComputer_DWork.pY_not_empty_b = true;
    }

    rtb_Product_a = FmgcComputer_U.in.time.dt * FmgcComputer_P.WashoutFilter_C1;
    rtb_Switch1_a = 2.0 / (rtb_Product_a + 2.0);
    FmgcComputer_DWork.pY_f = (2.0 - rtb_Product_a) / (rtb_Product_a + 2.0) * FmgcComputer_DWork.pY_f +
      (rtb_DataTypeConversion6 * rtb_Switch1_a - FmgcComputer_DWork.pU_p * rtb_Switch1_a);
    FmgcComputer_DWork.pU_p = rtb_DataTypeConversion6;
    if (rtb_DataTypeConversion2_i > FmgcComputer_P.Saturation_UpperSat_j) {
      rtb_DataTypeConversion2_i = FmgcComputer_P.Saturation_UpperSat_j;
    } else if (rtb_DataTypeConversion2_i < FmgcComputer_P.Saturation_LowerSat_o) {
      rtb_DataTypeConversion2_i = FmgcComputer_P.Saturation_LowerSat_o;
    }

    FmgcComputer_LeadLagFilter(FmgcComputer_DWork.pY_f - FmgcComputer_P.g_Gain * (FmgcComputer_P.Gain1_Gain_d *
      (FmgcComputer_P.Gain_Gain_j * ((rtb_DataTypeConversion1_d - FmgcComputer_P.Gain1_Gain_ak *
      (FmgcComputer_P.Gain_Gain_b * std::atan(rtb_DataTypeConversion8 / rtb_DataTypeConversion2_i))) *
      (FmgcComputer_P.Constant_Value_hx - rtb_DataTypeConversion3) + rtb_DataTypeConversion4 * std::sin
      (FmgcComputer_P.Gain1_Gain_p * rtb_y_nl - rtb_DataTypeConversion5)))), FmgcComputer_P.HighPassFilter_C1,
      FmgcComputer_P.HighPassFilter_C2, FmgcComputer_P.HighPassFilter_C3, FmgcComputer_P.HighPassFilter_C4,
      FmgcComputer_U.in.time.dt, &rtb_Product_a, &FmgcComputer_DWork.sf_LeadLagFilter);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault9_defaultValue, &rtb_y_nl);
    if (rtb_y_nl > FmgcComputer_P.Saturation1_UpperSat_l) {
      rtb_Switch1_a = FmgcComputer_P.Saturation1_UpperSat_l;
    } else if (rtb_y_nl < FmgcComputer_P.Saturation1_LowerSat_i) {
    ...
    rtb_DataTypeConversion1_d = (rtb_Product_a + rtb_Switch1_a) * FmgcComputer_P.mpstokts_Gain *
    ...
    rtb_Product_a = FmgcComputer_DWork.Delay_DSTATE_i;
    FmgcComputer_DWork.Delay_DSTATE_i = FmgcComputer_P.DiscreteDerivativeVariableTs_Gain * rtb_DataTypeConversion1_d;
    rtb_DataTypeConversion8 = (FmgcComputer_DWork.Delay_DSTATE_i - rtb_Product_a) / FmgcComputer_U.in.time.dt;
    if ((!FmgcComputer_DWork.pY_not_empty_c) || (!FmgcComputer_DWork.pU_not_empty_h)) {
      FmgcComputer_DWork.pU = rtb_DataTypeConversion8;
      FmgcComputer_DWork.pU_not_empty_h = true;
      FmgcComputer_DWork.pY_d = rtb_DataTypeConversion8;
      FmgcComputer_DWork.pY_not_empty_c = true;
    }

    rtb_Product_a = FmgcComputer_U.in.time.dt * FmgcComputer_P.LagFilter_C1_d;
    rtb_Switch1_a = rtb_Product_a / (rtb_Product_a + 2.0);
    FmgcComputer_DWork.pY_d = (2.0 - rtb_Product_a) / (rtb_Product_a + 2.0) * FmgcComputer_DWork.pY_d +
      (rtb_DataTypeConversion8 * rtb_Switch1_a + FmgcComputer_DWork.pU * rtb_Switch1_a);
    FmgcComputer_DWork.pU = rtb_DataTypeConversion8;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_body_normal_accel_g,
      FmgcComputer_P.A429ValueOrDefault3_defaultValue_bv, &rtb_y_dbv);
    FmgcComputer_LagFilter(rtb_y_dbv, FmgcComputer_P.LagFilter1_C1, FmgcComputer_U.in.time.dt, &rtb_y_nl,
      &FmgcComputer_DWork.sf_LagFilter_g);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_pitch_angle_deg,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fg, &rtb_y_dbv);
    rtb_Cos_h = std::cos(FmgcComputer_P.Gain1_Gain_hk * rtb_y_dbv);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_ir_computation_data_roll_angle_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_mp, &rtb_y_dbv);
    rtb_Cos_h = rtb_y_nl - rtb_Cos_h / std::cos(FmgcComputer_P.Gain1_Gain_go * rtb_y_dbv);
    rtb_Gain2_f = FmgcComputer_P.Gain2_Gain_o * rtb_Cos_h;
    if ((!FmgcComputer_DWork.pY_not_empty) || (!FmgcComputer_DWork.pU_not_empty)) {
      FmgcComputer_DWork.pU_c = rtb_Gain2_f;
      FmgcComputer_DWork.pU_not_empty = true;
      FmgcComputer_DWork.pY_p = rtb_Gain2_f;
      FmgcComputer_DWork.pY_not_empty = true;
    }

    rtb_Product_a = FmgcComputer_U.in.time.dt * FmgcComputer_P.WashoutFilter_C1_e;
    rtb_Switch1_a = 2.0 / (rtb_Product_a + 2.0);
    FmgcComputer_DWork.pY_p = static_cast<real32_T>((2.0 - rtb_Product_a) / (rtb_Product_a + 2.0)) *
      FmgcComputer_DWork.pY_p + (rtb_Gain2_f * static_cast<real32_T>(rtb_Switch1_a) - FmgcComputer_DWork.pU_c *
      static_cast<real32_T>(rtb_Switch1_a));
    FmgcComputer_DWork.pU_c = rtb_Gain2_f;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_n1_actual_percent,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_e, &rtb_DataTypeConversion2_bh);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_n1_actual_percent,
      FmgcComputer_P.A429ValueOrDefault7_defaultValue_e, &rtb_y_dbv);
    if (!FmgcComputer_DWork.pY_not_empty_n) {
      FmgcComputer_DWork.pY = FmgcComputer_P.RateLimiterVariableTs_InitialCondition;
      FmgcComputer_DWork.pY_not_empty_n = true;
    }

    FmgcComputer_DWork.pY += std::fmax(std::fmin(static_cast<real_T>(rtb_Compare_dw) - FmgcComputer_DWork.pY, std::abs
    ...
    if (FmgcComputer_U.in.sim_data.tracking_mode_on_override) {
    ...
    } else if (FmgcComputer_DWork.Memory_PreviousInput_o) {
      rtb_Switch1_a = FmgcComputer_P.RETARD_Value;
    } else if (FmgcComputer_DWork.Memory_PreviousInput_cm) {
      rtb_Switch1_a = ((FmgcComputer_P.Gain_Gain * rtb_DataTypeConversion1_d + FmgcComputer_DWork.pY_d) +
                       (FmgcComputer_P.Gain1_Gain_g * rtb_Cos_h + FmgcComputer_P.Gain3_Gain_k * FmgcComputer_DWork.pY_p))
        * look1_iflf_binlxpw(std::fmin(rtb_y_dbv, rtb_DataTypeConversion2_bh),
        FmgcComputer_P.ScheduledGain2_BreakpointsForDimension1, FmgcComputer_P.ScheduledGain2_Table, 3U) * look1_binlxpw
        (FmgcComputer_DWork.pY, FmgcComputer_P.ScheduledGain4_BreakpointsForDimension1,
         FmgcComputer_P.ScheduledGain4_Table, 1U);
      ...
      if (rtb_OR_pj) {
        rtb_DataTypeConversion1_d = FmgcComputer_P.Constant_Value;
      } else {
        rtb_DataTypeConversion1_d = FmgcComputer_P.Constant1_Value_i;
      }

      rtb_Switch1_a = rtb_DataTypeConversion1_d * look1_iflf_binlxpw(std::fmin
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_n || rtb_y_d1 || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    FmgcComputer_DWork.Delay_DSTATE_f += rtb_Switch1_a;
    ...
    if (FmgcComputer_DWork.Delay_DSTATE_f > rtb_Cos_h) {
      FmgcComputer_DWork.Delay_DSTATE_f = rtb_Cos_h;
    } else if (FmgcComputer_DWork.Delay_DSTATE_f < FmgcComputer_P.Constant_Value_h) {
      FmgcComputer_DWork.Delay_DSTATE_f = FmgcComputer_P.Constant_Value_h;
    }
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_hu) {
      ...
      rtb_Switch1_a = FmgcComputer_DWork.Delay_DSTATE_f;
    }
    ...
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_pw_logic_ils_computation_data_runway_heading_deg, &rtb_y_n);
    ...
    rtb_VectorConcatenate[13] = rtb_ap_fd_condition_tmp_1;
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_y_dbv);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_5.Data = rtb_y_dbv;
    ...
    rtb_VectorConcatenate[18] = rtb_OR_ko;
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_y_dbv);
    ...
    rtb_VectorConcatenate[3] = rtb_y_nz;
    ...
    rtb_VectorConcatenate[9] = FmgcComputer_DWork.Memory_PreviousInput_o;
    ...
    rtb_VectorConcatenate[13] = rtb_ap_fd_condition_tmp;
    rtb_VectorConcatenate[14] = rtb_y_lxi;
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_DataTypeConversion2_bh);
    rtb_VectorConcatenate_bw[0] = (rtb_y_ey == athr_fma_mode::MAN_TOGA);
    rtb_VectorConcatenate_bw[1] = ((rtb_y_ey == athr_fma_mode::MAN_MCT) || (rtb_y_ey == athr_fma_mode::THR_MCT));
    rtb_VectorConcatenate_bw[2] = (rtb_y_ey == athr_fma_mode::MAN_FLEX);
    rtb_VectorConcatenate_bw[3] = (rtb_y_ey == athr_fma_mode::THR_CLB);
    rtb_VectorConcatenate_bw[4] = ((rtb_y_ey == athr_fma_mode::MAN_THR) || (rtb_y_ey == athr_fma_mode::THR_LVR));
    rtb_VectorConcatenate_bw[5] = (rtb_y_ey == athr_fma_mode::THR_IDLE);
    rtb_VectorConcatenate_bw[6] = (rtb_y_ey == athr_fma_mode::A_FLOOR);
    rtb_VectorConcatenate_bw[7] = (rtb_y_ey == athr_fma_mode::TOGA_LK);
    rtb_VectorConcatenate_bw[8] = (rtb_y_ey == athr_fma_mode::SPEED);
    rtb_VectorConcatenate_bw[9] = (rtb_y_ey == athr_fma_mode::MACH);
    rtb_VectorConcatenate_bw[10] = (rtb_y_l == athr_fma_message::LVR_ASYM);
    rtb_VectorConcatenate_bw[11] = (rtb_y_l == athr_fma_message::LVR_CLB);
    rtb_VectorConcatenate_bw[12] = (rtb_y_l == athr_fma_message::LVR_MCT);
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_bw, &rtb_y_a);
    ...
    rtb_VectorConcatenate_bw[1] = rtb_OR4_g;
    ...
    rtb_VectorConcatenate_f[0] = (FmgcComputer_DWork.Memory_PreviousInput_ec ||
      FmgcComputer_DWork.Memory_PreviousInput_ae ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_VectorConcatenate_f[1] = rtb_y_hq;
    ...
    rtb_VectorConcatenate_f[6] = rtb_fmgcOppPriority_tmp;
    rtb_VectorConcatenate_f[7] = rtb_AND8;
    rtb_VectorConcatenate_f[8] = (FmgcComputer_DWork.Memory_PreviousInput_ne ||
      FmgcComputer_DWork.Memory_PreviousInput_cb);
    rtb_VectorConcatenate_f[9] = (FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_y_k);
    rtb_VectorConcatenate_f[10] = (FmgcComputer_DWork.Memory_PreviousInput_ne ||
      FmgcComputer_DWork.Memory_PreviousInput_nu);
    rtb_VectorConcatenate_f[11] = (FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_y_k);
    rtb_VectorConcatenate_f[12] = rtb_Logic_b[0];
    rtb_VectorConcatenate_f[13] = (rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_des_active ||
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.exp_clb_active);
    rtb_VectorConcatenate_f[14] = FmgcComputer_DWork.Memory_PreviousInput_bc;
    rtb_VectorConcatenate_f[15] = rtb_Compare_dw;
    rtb_VectorConcatenate_f[16] = ((FmgcComputer_U.in.fms_inputs.preset_mach > FmgcComputer_P.CompareToConstant3_const_p)
      || (FmgcComputer_U.in.fms_inputs.preset_spd_kts > FmgcComputer_P.CompareToConstant4_const_n));
    rtb_VectorConcatenate_f[17] = FmgcComputer_P.Constant7_Value;
    rtb_VectorConcatenate_f[18] = FmgcComputer_P.Constant7_Value;
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_f, &rtb_y_nd);
    ...
    rtb_VectorConcatenate_f[4] = FmgcComputer_DWork.Memory_PreviousInput_e;
    rtb_VectorConcatenate_f[5] = rtb_OR_fz;
    rtb_VectorConcatenate_f[6] = apCondition_tmp;
    ...
    rtb_VectorConcatenate_f[17] = rtb_AND_e_tmp;
    rtb_VectorConcatenate_f[18] = FmgcComputer_P.Constant8_Value;
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_f, &rtb_y_nl);
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_f, &rtb_y_g);
    FmgcComputer_Y.out.data = FmgcComputer_U.in;
    FmgcComputer_Y.out.logic.on_ground = rtb_y_h;
    FmgcComputer_Y.out.logic.gnd_eng_stop_flt_5s = rtb_y_if;
    ...
    FmgcComputer_Y.out.logic.ap_inop = fdOppOff;
    FmgcComputer_Y.out.logic.athr_inop = rtb_ap_fd_condition_tmp;
    ...
    FmgcComputer_Y.out.logic.adr_computation_data.altitude_standard_ft.Data =
      rtb_adrComputationBus_altitude_standard_ft_Data;
    FmgcComputer_Y.out.logic.adr_computation_data.altitude_corrected_ft.SSM =
      rtb_adrComputationBus_altitude_corrected_ft_SSM;
    FmgcComputer_Y.out.logic.adr_computation_data.altitude_corrected_ft.Data =
      rtb_adrComputationBus_altitude_corrected_ft_Data;
    ...
    FmgcComputer_Y.out.logic.adr_computation_data.airspeed_computed_kn =
      rtb_BusAssignment_jc_logic_adr_computation_data_airspeed_computed_kn;
    ...
    FmgcComputer_Y.out.logic.fac_lg_data_failure = rtb_y_ae;
    ...
    FmgcComputer_Y.out.logic.fac_rudder_control_failure = rtb_ir3Invalid;
    FmgcComputer_Y.out.logic.both_fac_rudder_valid = rtb_irOwnInvalid;
    ...
    FmgcComputer_Y.out.logic.chosen_fac_bus.v_max_kn = rtb_BusAssignment_jc_logic_chosen_fac_bus_v_max_kn;
    ...
    FmgcComputer_Y.out.logic.rwy_hdg_memo = FmgcComputer_B.u_lyj;
    ...
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.hdg_active = rtb_OR_fz;
    FmgcComputer_Y.out.ap_fd_logic.lateral_modes.trk_active = apCondition_tmp;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.vs_active = rtb_fmgcOppPriority_tmp;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.fpa_active = rtb_AND8;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.fma_dash_display = rtb_Compare_dw;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.gs_capt_active = FmgcComputer_DWork.Memory_PreviousInput_nu;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.gs_trk_active = rtb_y_k;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.final_des_active = rtb_Logic_b[0];
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.flare_active = FmgcComputer_DWork.Memory_PreviousInput_bc;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.tcas_active =
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.tcas_active;
    FmgcComputer_Y.out.ap_fd_logic.armed_modes.alt_acq_armed = rtb_OR4_g;
    ...
    FmgcComputer_Y.out.ap_fd_logic.armed_modes.tcas_armed =
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.armed_modes.tcas_armed;
    ...
    FmgcComputer_Y.out.ap_fd_logic.spd_target_kts = rtb_Switch_e[0];
    FmgcComputer_Y.out.ap_fd_logic.pfd_spd_target_kts = rtb_Switch_e[1];
    FmgcComputer_Y.out.ap_fd_logic.alt_cstr_applicable = rtb_OR2_l;
    FmgcComputer_Y.out.ap_fd_logic.alt_sel_or_cstr = rtb_altCstrOrFcu;
    FmgcComputer_Y.out.ap_fd_logic.fmgc_opp_mode_sync = rtb_y_m;
    FmgcComputer_Y.out.ap_fd_logic.any_ap_fd_engaged = rtb_y_ft;
    FmgcComputer_Y.out.ap_fd_logic.any_lateral_mode_engaged = rtb_AND2_po;
    FmgcComputer_Y.out.ap_fd_logic.any_longitudinal_mode_engaged = rtb_y_bo;
    FmgcComputer_Y.out.ap_fd_logic.hdg_trk_preset_available = FmgcComputer_DWork.Memory_PreviousInput_bw;
    FmgcComputer_Y.out.ap_fd_logic.ap_fd_mode_reversion = FmgcComputer_DWork.Memory_PreviousInput_as;
    FmgcComputer_Y.out.ap_fd_logic.lateral_mode_reversion = rtb_y_j;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_mode_reversion_vs = rtb_y_p3;
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_mode_reversion_op_clb = rtb_OR2_l_tmp;
    FmgcComputer_Y.out.ap_fd_logic.pitch_fd_bars_flashing = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_Y.out.ap_fd_logic.roll_fd_bars_flashing = rtb_AND_e_tmp;
    FmgcComputer_Y.out.ap_fd_logic.loc_bc_selection = rtP_fmgc_ap_fd_logic_output_MATLABStruct.loc_bc_selection;
    FmgcComputer_Y.out.ap_fd_logic.vs_target_not_held = rtb_OR_ko;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_2_capability = rtb_appCapability_idx_0;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_2_inop = rtb_y_d4;
    FmgcComputer_Y.out.ap_fd_logic.land_3_fail_passive_inop = rtb_y_ed;
    ...
    FmgcComputer_Y.out.ap_fd_outer_loops.autopilot.Theta_c_deg = rtb_pfdTarget;
    ...
    FmgcComputer_Y.out.athr.athr_active = rtb_y_nz;
    FmgcComputer_Y.out.athr.athr_limited = rtb_y_lxi;
    ...
    FmgcComputer_Y.out.athr.thrust_target_idle = rtb_OR_pj;
    ...
    FmgcComputer_Y.out.athr.fma_mode = rtb_y_ey;
    FmgcComputer_Y.out.athr.fma_message = rtb_y_l;
    ...
    if ((!FmgcComputer_DWork.Memory_PreviousInput_cu) && (!FmgcComputer_DWork.Memory_PreviousInput_h)) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.pfd_sel_spd_kts.Data = static_cast<real32_T>(rtb_Switch_e[1]);
    if (rtb_y_n || rtb_BusAssignment_b_logic_ils_tune_inhibit) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.runway_hdg_memorized_deg.Data = static_cast<real32_T>(FmgcComputer_B.u_lyj);
    ...
    rtb_y_d1 = !FmgcComputer_DWork.Memory_PreviousInput_m;
    if (rtb_AND2_po && (!FmgcComputer_DWork.Memory_PreviousInput_c) && rtb_y_d1) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_4.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_4.Data = rtb_y_dbv;
    if (rtb_OR2_l) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.altitude_ft.SSM = rtb_adrComputationBus_altitude_corrected_ft_SSM;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.altitude_ft.Data = rtb_adrComputationBus_altitude_corrected_ft_Data;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.Data = rtb_DataTypeConversion2_bh;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_1.Data = rtb_y_nd;
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_2.Data = rtb_y_nl;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.delta_q_voted_cmd_deg.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.delta_q_voted_cmd_deg.Data = static_cast<real32_T>(rtb_pfdTarget);
    ...
    if (rtb_dualRaFailure) {
      FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.fg_radio_height_ft.SSM = static_cast<uint32_T>
        (FmgcComputer_P.EnumeratedConstant_Value_i);
    } else {
      FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.fg_radio_height_ft.SSM = static_cast<uint32_T>
        (FmgcComputer_P.EnumeratedConstant1_Value_d);
    }

    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.fg_radio_height_ft.Data = rtb_raComputationData;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_4.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_4.Data = rtb_y_dbv;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.Data = rtb_DataTypeConversion2_bh;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_1.Data = rtb_y_nd;
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.discrete_word_2.Data = rtb_y_nl;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.delta_q_cmd_deg.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.delta_q_cmd_deg.Data = static_cast<real32_T>(rtb_pfdTarget);
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active = rtb_OR_fz;
    FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active = apCondition_tmp;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active = rtb_fmgcOppPriority_tmp;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active = rtb_AND8;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fma_dash_display = rtb_Compare_dw;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active = FmgcComputer_DWork.Memory_PreviousInput_nu;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active = rtb_y_k;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active = rtb_Logic_b[0];
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.flare_active = FmgcComputer_DWork.Memory_PreviousInput_bc;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.cruise_active =
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.cruise_active;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active =
      rtP_fmgc_ap_fd_logic_output_MATLABStruct.longitudinal_modes.tcas_active;
    FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed = rtb_OR4_g;
    ...
    FmgcComputer_DWork.Delay_DSTATE.spd_target_kts = rtb_Switch_e[0];
    FmgcComputer_DWork.Delay_DSTATE.pfd_spd_target_kts = rtb_Switch_e[1];
    FmgcComputer_DWork.Delay_DSTATE.alt_cstr_applicable = rtb_OR2_l;
    FmgcComputer_DWork.Delay_DSTATE.alt_sel_or_cstr = rtb_altCstrOrFcu;
    FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync = rtb_y_m;
    FmgcComputer_DWork.Delay_DSTATE.any_ap_fd_engaged = rtb_y_ft;
    FmgcComputer_DWork.Delay_DSTATE.any_lateral_mode_engaged = rtb_AND2_po;
    ...
    FmgcComputer_DWork.Delay_DSTATE.lateral_mode_reversion = rtb_y_j;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_mode_reversion_vs = rtb_y_p3;
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_mode_reversion_op_clb = rtb_OR2_l_tmp;
    FmgcComputer_DWork.Delay_DSTATE.pitch_fd_bars_flashing = rtb_ap_fd_condition_tmp_1;
    FmgcComputer_DWork.Delay_DSTATE.roll_fd_bars_flashing = rtb_AND_e_tmp;
    FmgcComputer_DWork.Delay_DSTATE.loc_bc_selection = rtP_fmgc_ap_fd_logic_output_MATLABStruct.loc_bc_selection;
    FmgcComputer_DWork.Delay_DSTATE.vs_target_not_held = rtb_OR_ko;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_2_capability = rtb_appCapability_idx_0;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_2_inop = rtb_y_d4;
    FmgcComputer_DWork.Delay_DSTATE.land_3_fail_passive_inop = rtb_y_ed;
    ...
    FmgcComputer_DWork.Memory_PreviousInput_as = rtb_y_k;
    FmgcComputer_DWork.DelayInput1_DSTATE_f = FmgcComputer_P.Constant_Value_k;
    FmgcComputer_DWork.Memory_PreviousInput_bo = FmgcComputer_DWork.Delay_DSTATE_c;
    FmgcComputer_DWork.Delay1_DSTATE.athr_active = rtb_y_nz;
    FmgcComputer_DWork.Delay1_DSTATE.athr_limited = rtb_y_lxi;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.thrust_target_idle = rtb_OR_pj;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.fma_mode = rtb_y_ey;
    FmgcComputer_DWork.Delay1_DSTATE.fma_message = rtb_y_l;
