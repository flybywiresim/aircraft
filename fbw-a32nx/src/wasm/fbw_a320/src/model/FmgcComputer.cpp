...
void FmgcComputer::step()
{
  ...
  real32_T rtb_Switch_i_localizer_deviation_deg_Data;
  ...
  boolean_T rtb_y_p3;
  boolean_T rtb_y_pa;
  athr_fma_message rtb_y_e;
  athr_fma_mode rtb_y_f3;
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    if (!FmgcComputer_DWork.Runtime_MODE) {
      ...
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_pn);
    ...
    rtb_y_n = ((FmgcComputer_U.in.discrete_inputs.eng_opp_stop && FmgcComputer_U.in.discrete_inputs.eng_own_stop &&
                rtb_y_h) || rtb_y_p3);
    FmgcComputer_MATLABFunction(&rtb_BusAssignment_lz_logic_chosen_fac_bus_discrete_word_5,
    ...
    if (rtb_y_bo) {
      ...
      rtb_Switch_i_localizer_deviation_deg_Data = FmgcComputer_U.in.bus_inputs.ils_own_bus.localizer_deviation_deg.Data;
      ...
      rtb_Switch_i_localizer_deviation_deg_Data = FmgcComputer_U.in.bus_inputs.ils_opp_bus.localizer_deviation_deg.Data;
    ...
    if (rtb_y_no4) {
      dPsi_1 = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else if (raOwnInvalid && rtb_y_d1) {
      dPsi_1 = FmgcComputer_U.in.bus_inputs.ra_opp_bus.radio_height_ft.Data;
    } else if (rtb_ap_fd_condition_tmp_0 && raOppInvalid) {
      dPsi_1 = FmgcComputer_U.in.bus_inputs.ra_own_bus.radio_height_ft.Data;
    } else {
      dPsi_1 = 250.0F;
    ...
    raOwnInvalid = ((!rtb_doubleAdrFault) && (!rtb_adr3Invalid) && ((!rtb_y_ae) || rtb_AND_nk) &&
                    (FmgcComputer_U.in.fms_inputs.fm_valid || rtb_AND_nk ||
                     (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active && (dPsi_1 < 700.0F))));
    ...
    rtb_y_if = !FmgcComputer_P.Constant1_Value.fac_speeds_failure;
    rtb_y_b4 = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active;
    rtb_OR_ko = !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active;
    raOppInvalid = (((!FmgcComputer_P.Constant1_Value.fac_weights_failure) || rtb_AND_nk) && (rtb_y_if ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active) && (rtb_ap_fd_condition_tmp_0 || (rtb_OR_fz && rtb_y_b4
    ...
    rtb_y_l = !raOwnInvalid;
    fdOppOff = (rtb_y_l || (!raOppInvalid) || (!rtb_NOT3));
    ...
    FmgcComputer_DWork.Memory_PreviousInput = FmgcComputer_P.Logic_table[(((fdOppOff || (rtb_y_nz &&
      ...
      (!FmgcComputer_DWork.Delay_DSTATE_p) && rtb_y_n && raOppInvalid && raOwnInvalid && rtb_NOT3) << 1)) << 1) +
    ...
    rtb_y_if = ((FmgcComputer_DWork.Delay_DSTATE.manual_spd_control_active ||
                ...
                (!FmgcComputer_DWork.Memory_PreviousInput_g1) && rtb_ap_fd_condition_tmp && rtb_y_if);
    rtb_ap_fd_condition_tmp = (rtb_y_l || (!rtb_y_if));
    FmgcComputer_DWork.Delay_DSTATE_k = FmgcComputer_P.Logic_table_n[(((static_cast<uint32_T>(raOwnInvalid && rtb_y_if &&
    ...
    rtb_y_l = !fdOwnOff;
    rtb_y_if = !FmgcComputer_DWork.Delay_DSTATE_k;
    ...
    rtb_fmgcOppPriority = ((rtb_fmgcOppPriority || (rtb_fmgcOppPriority_tmp &&
      (FmgcComputer_U.in.discrete_inputs.ap_opp_engaged || rtb_y_l) && (rtb_y_ft || rtb_y_if) && rtb_OR2_l)) &&
      (FmgcComputer_U.in.discrete_inputs.is_unit_1 || ((rtb_fmgcOppPriority_tmp ||
      FmgcComputer_U.in.discrete_inputs.ap_opp_engaged) && (rtb_y_ft || rtb_y_l) && (rtb_OR2_l || rtb_y_if) &&
    ...
    rtb_y_l = (rtb_fmgcOppPriority && (rtb_fmgcOppPriority_tmp || rtb_y_p3));
    ...
    rtb_NOT3 = (((FmgcComputer_U.in.fms_inputs.v_2_kts > FmgcComputer_P.CompareToConstant1_const_k) &&
                 (rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_p && rtb_Compare_bj &&
    ...
    rtb_y_g = (rtb_y_j || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active);
    FmgcComputer_DWork.Memory_PreviousInput_k = FmgcComputer_P.Logic_table_b[(((rtb_AND2_po || ((rtb_y_g ||
    ...
    rtb_BusAssignment_f4_logic_ils_computation_data_localizer_deviation_deg.Data =
      rtb_Switch_i_localizer_deviation_deg_Data;
    ...
    rtb_DataTypeConversion2_m = std::abs(rtb_y_nl - rtb_y_gl);
    ...
    rtb_NOT3 = ((rtb_y_nz && (rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_no4 &&
      (!FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_loc_submode_active) && ((rtb_handleIndex >=
      FmgcComputer_P.CompareToConstant_const_cq) && rtb_y_d1 && (rtb_DataTypeConversion2_m <=
    ...
    rtb_y_kd = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_l);
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.ils_own_bus.ils_frequency_mhz,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_f, &rtb_DataTypeConversion2_m);
    ...
    rtb_TmpSignalConversionAtSFunctionInport3_idx_2 =
      !FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active;
    rtb_y_nz = (rtb_ap_fd_condition_tmp_1 && (rtb_y_kd || (rtb_y_no4 && (FmgcComputer_P.Constant_Value_l && rtb_y_ed &&
      ...
      rtb_Compare_jz && rtb_NOT1_n_tmp && rtb_Compare_bj && rtb_Compare_bj && ((rtb_y_dbv == rtb_DataTypeConversion2_m) &&
      (rtb_y_nl == rtb_y_gl)))));
    rtb_OR4_e = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
                 FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active);
    rtb_y_bm = (FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_cpt_active ||
                FmgcComputer_DWork.Delay_DSTATE.lateral_modes.loc_trk_active);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_l = FmgcComputer_P.Logic_table_k[(((rtb_AND_nk || ((!rtb_OR4_e) &&
      (!rtb_y_bm) && FmgcComputer_DWork.Delay_DSTATE.armed_modes.nav_armed) || ((rtb_OR4_e && rtb_Compare_bj) ||
    ...
    rtb_AND_nk = (rtb_Compare_bj && (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active &&
    ...
    rtb_Logic_d_idx_0_tmp = (rtb_y_bo || FmgcComputer_DWork.Delay_DSTATE.lateral_modes.hdg_active ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.trk_active);
    FmgcComputer_DWork.Memory_PreviousInput_d = FmgcComputer_P.Logic_table_p[(((((rtb_y_g ||
    ...
    rtb_y_kd = (FmgcComputer_U.in.discrete_inputs.bscu_opp_valid || FmgcComputer_U.in.discrete_inputs.bscu_own_valid);
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      ...
      FmgcComputer_U.in.discrete_inputs.right_wheel_spd_abv_70_kts) && rtb_y_kd) || ((!rtb_y_kd) && rtb_y_h))),
    ...
    rtb_y_nz = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_l);
    ...
    rtb_y_kd = (rtb_y_i1_tmp && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid &&
                FmgcComputer_P.Constant_Value_hg && rtb_y_m5 && rtb_OR_fz && (rtb_appInop_idx_2 && rtb_Compare_jz &&
      rtb_OR2_l_tmp && rtb_NOT1_n_tmp && rtb_TmpSignalConversionAtSFunctionInport3_idx_2 && (!rtb_y_d1) && rtb_y_hq));
    rtb_OR4_e = (rtb_ap_fd_condition_tmp_1 && (rtb_y_nz || rtb_y_kd));
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode1_isRisingEdge_l, &rtb_y_kd,
      &FmgcComputer_DWork.sf_MATLABFunction_bk);
    rtb_y_g = !FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid;
    FmgcComputer_DWork.Memory_PreviousInput_dv = FmgcComputer_P.Logic_table_c
      [(((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active || rtb_y_g || rtb_y_d1 || (rtb_y_hq &&
           FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed) || rtb_y_kd || rtb_AND2_po) +
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
    ...
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_p && (!rtb_y_m5) && (rtb_handleIndex >=
    ...
    FmgcComputer_MATLABFunction_k(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active,
      FmgcComputer_P.PulseNode_isRisingEdge_f, &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_pn);
    rtb_Compare_bj = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_no4 && (rtb_NOT1_n_tmp && rtb_y_d1)));
    ...
    rtb_OR_fz = !rtb_y_nz;
    rtb_Compare_bj = (rtb_y_bm && rtb_y_m5 && (rtb_y_bm || rtb_OR_fz) && (!rtb_y_d1));
    ...
    rtb_Compare_bj = ((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active && rtb_Compare_ji_tmp &&
                       rtb_TmpSignalConversionAtSFunctionInport3_idx_2) || rtb_Compare_bj || rtb_y_bo || (rtb_y_bm &&
    ...
    rtb_y_kd = (rtb_y_n && rtb_y_d1 && rtb_ap_fd_condition_tmp_1 && (rtb_NOT1_n_tmp || (rtb_raComputationData >=
    ...
    rtb_OR_fz = ((rtb_y_bo && rtb_y_l) || (rtb_y_no4 && (rtb_y_kd || (rtb_OR_pj && rtb_y_d1 && rtb_y_p) ||
      rtb_Compare_bj)));
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_j, &rtb_y_kd,
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_l) || (rtb_y_i1_tmp && ((rtb_NOT1_n_tmp && rtb_Compare_ji_tmp_0 &&
      rtb_ap_fd_condition_tmp_1 && rtb_y_kd) || (rtb_y_h && rtb_OR4_e && rtb_y_hq) || rtb_y_d1)));
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_hdg_deg, &rtb_y_bo);
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_d1);
    FmgcComputer_MATLABFunction_k((rtb_y_bo || rtb_y_d1), FmgcComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_kd,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_i1 = FmgcComputer_P.Logic_table_g[(((rtb_y_kd || rtb_y_m5 || rtb_y_d1 ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_a = FmgcComputer_P.Logic_table_ku[(((((!rtb_OR4_e) && rtb_y_bo) ||
      ...
      uint32_T>((rtb_Compare_bj && rtb_y_l) || (rtb_y_no4 && (rtb_y_p || rtb_y_ed))) << 1)) << 1) +
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_k_logic_ils_computation_data_localizer_deviation_deg,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_o, &rtb_DataTypeConversion2_m);
    ...
    if (rtb_y_gl == 0.0F) {
      ...
      dPsi_1 = std::fmod(rtb_y_gl, 360.0F);
      if (dPsi_1 == 0.0F) {
        dPsi_1 = 0.0F;
    ...
    if (360.0F - dPsi_1 == 0.0F) {
      rtb_y_gl = 0.0F;
    } else {
      rtb_y_gl = std::fmod(360.0F - dPsi_1, 360.0F);
      if (rtb_y_gl == 0.0F) {
        rtb_y_gl = 0.0F;
      } else if (360.0F - dPsi_1 < 0.0F) {
        rtb_y_gl += 360.0F;
      }
    }
    ...
    dPsi_1 = std::abs(rtb_y_gl);
    if (dPsi_1 < 115.0F) {
      rtb_y_nl = std::abs(rtb_DataTypeConversion2_m);
      if (rtb_DataTypeConversion2_m < 0.0F) {
        high_i = -1;
      } else {
        high_i = (rtb_DataTypeConversion2_m > 0.0F);
      }

      if (((dPsi_1 > 25.0F) && ((rtb_y_nl < 10.0F) && ((low_i != high_i) && rtb_Compare_bj))) || (rtb_y_nl < 1.92)) {
        rtb_Compare_bj = (rtb_Compare_bj || ((dPsi_1 < 15.0F) && (rtb_y_nl < 1.1)));
      } else {
        rtb_Compare_bj = false;
      }
    } else {
    ...
    dPsi_1 = rtb_y_gl - rtb_y_dbv;
    rtb_DataTypeConversion2_m = std::abs(dPsi_1);
    FmgcComputer_DWork.Memory_PreviousInput_n = FmgcComputer_P.Logic_table_pk[(((static_cast<uint32_T>
      ((rtb_DataTypeConversion1_e != 0U) || (rtb_DataTypeConversion2_m > FmgcComputer_P.CompareToConstant1_const_hi)) <<
      1) + (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active && (rtb_DataTypeConversion2_m <=
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_j, &rtb_DataTypeConversion2_m);
    ...
    if (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) {
      rtb_y_nl = rtb_DataTypeConversion2_m;
    ...
    if (dPsi_1 < 0.0F) {
      ...
      rtb_y_d1 = ((dPsi_1 > 0.0F) && (rtb_y_nl >= 0.0F));
    }

    rtb_OR4_g = (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_no4 &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) &&
      (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active) && rtb_y_b4 && rtb_OR_ko &&
      ...
      ((!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.vs_active) &&
       (!FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fpa_active))) && ((!rtb_y_ed) || (dPsi_1 <=
    ...
    dPsi_1 = rtb_y_gl - static_cast<real32_T>(b[low_i]);
    rtb_DataTypeConversion2_m = rtb_y_nl * 0.00508F;
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_l) || (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_armed && (!rtb_y_d1) && ((std::fmin(3000.0F, std::fmax(80.0F,
      rtb_DataTypeConversion2_m * rtb_DataTypeConversion2_m / ((((dPsi_1 * static_cast<real32_T>(c[low_i]) +
      static_cast<real32_T>(c[low_i + 6])) * dPsi_1 + static_cast<real32_T>(c[low_i + 12])) * dPsi_1 +
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_no4 &&
    ...
    rtb_DataTypeConversion2_m = rtb_y_nl - rtb_y_gl;
    ...
    dPsi_1 = rtb_y_gl + FmgcComputer_P.Bias_Bias_e;
    ...
    rtb_Compare_bj = ((rtb_OR_pj && rtb_y_ed && rtb_y_d1) || rtb_AND8 ||
      ...
      ((FmgcComputer_P.EnumeratedConstant_Value_p == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       rtb_y_g)) || (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active && (std::abs(FmgcComputer_B.u_ly
      - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_om)) || (rtb_y_p3 && (rtb_DataTypeConversion2_m >
      FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_y_nz && (rtb_DataTypeConversion2_m <
      FmgcComputer_P.CompareToConstant2_const_g)) || ((rtb_y_p3 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (dPsi_1 > rtb_y_nl) &&
    ...
    rtb_y_kd = (rtb_DataTypeConversion1_e != 0U);
    FmgcComputer_MATLABFunction_k((rtb_y_nz || (rtb_DataTypeConversion1_e != 0U)),
      FmgcComputer_P.PulseNode_isRisingEdge_d, &rtb_y_kd, &FmgcComputer_DWork.sf_MATLABFunction_nd);
    rtb_y_nz = (rtb_y_n && rtb_y_kd && rtb_ap_fd_condition_tmp_1);
    ...
    rtb_y_bo = ((rtb_y_bo && rtb_y_l) || (rtb_y_no4 && (rtb_y_nz || (rtb_OR_pj && rtb_y_p && rtb_y_d1) || rtb_Compare_bj)));
    ...
    rtb_OR4_e = (rtb_OR_pj && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
      ...
      FmgcComputer_P.EnumeratedConstant2_Value_p)) && FmgcComputer_DWork.Delay_DSTATE.lateral_modes.nav_active &&
                 rtb_y_kd && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && (rtb_y_bo || (rtb_y_d1 &&
    ...
    rtb_y_kd = ((FmgcComputer_U.in.fms_inputs.acceleration_alt_ft != FmgcComputer_P.CompareToConstant_const_lz) &&
    ...
    rtb_y_p = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_y_nz && (!rtb_y_kd)) || (rtb_y_p ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      ...
      (rtb_Compare_ji_tmp || rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_g)) ||
      ...
      static_cast<uint32_T>((rtb_Compare_bj && rtb_y_l) || (rtb_y_no4 && (rtb_OR4_e || (rtb_y_nz && rtb_y_kd)))) << 1)) <<
    ...
    rtb_TmpSignalConversionAtSFunctionInport3_idx_1 = (rtb_y_no4 &&
      FmgcComputer_DWork.Delay_DSTATE.armed_modes.alt_acq_arm_possible && rtb_y_n);
    rtb_Compare_ji_tmp_0 = !rtb_AND_e_tmp;
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_l) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 &&
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_l) || (rtb_y_no4 && ((FmgcComputer_U.in.fms_inputs.fms_flight_phase !=
    ...
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he[(((rtb_y_p ||
      ...
      ((FmgcComputer_P.EnumeratedConstant_Value_b == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
       ...
       (FmgcComputer_U.in.fms_inputs.fms_flight_phase == FmgcComputer_P.EnumeratedConstant6_Value)) || rtb_y_g ||
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_l) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && (rtb_OR_ko &&
      ...
      FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid && rtb_y_kd && ((FmgcComputer_P.EnumeratedConstant_Value_m
    ...
    rtb_y_kd = ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active &&
                 ((FmgcComputer_P.EnumeratedConstant_Value_c == FmgcComputer_U.in.fms_inputs.fms_flight_phase) ||
                  ...
                  rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_g)) || rtb_y_m5);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_ic_logic_adr_computation_data_altitude_corrected_ft,
    ...
    rtb_y_m5 = (rtb_y_ed || rtb_y_kd || (rtb_y_p && FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed &&
      (rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_g)));
    rtb_Compare_ji_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && rtb_ap_fd_condition_tmp_1);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_l) || (rtb_Compare_ji_tmp && rtb_y_nz && rtb_y_m5));
    ...
    rtb_OR2_l_tmp = (FmgcComputer_DWork.Memory_PreviousInput_ae && rtb_y_kd);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fmgc_opp_bus.discrete_word_1,
    ...
    FmgcComputer_MATLABFunction_k((rtb_DataTypeConversion1_e != 0U), FmgcComputer_P.PulseNode_isRisingEdge_fw, &rtb_y_kd,
    ...
    rtb_y_kd = (rtb_y_kd || rtb_y_m5);
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_l) || (rtb_Compare_ji_tmp && (rtb_y_nl < rtb_y_gl) && rtb_y_kd));
    ...
    rtb_y_bo = rtb_y_no4;
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.armed_modes.land_armed ||
      FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active), FmgcComputer_P.PulseNode1_isRisingEdge_b, &rtb_y_kd,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_no4 && (rtb_y_kd && rtb_y_b4 && rtb_OR_ko))) << 1) +
    ...
    FmgcComputer_LagFilter(rtb_y_gl, FmgcComputer_P.LagFilter_C1, FmgcComputer_U.in.time.dt, &dPsi_1,
    ...
    rtb_y_nz = (((dPsi_1 < FmgcComputer_DWork.DelayInput1_DSTATE_b) && (rtb_Nosewheel_c <
      FmgcComputer_P.CompareToConstant1_const_n2)) || (rtb_Nosewheel_c < FmgcComputer_P.CompareToConstant2_const_iq));
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_b0_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_b4);
    rtb_y_bo = (rtb_y_no4 && FmgcComputer_DWork.Delay_DSTATE.armed_modes.glide_armed && rtb_y_bm && rtb_y_nz && rtb_y_b4);
    rtb_Compare_bj = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || rtb_y_bo);
    ...
    rtb_y_b4 = (rtb_AND_e_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_nu = FmgcComputer_P.Logic_table_d3[(((((!rtb_y_bo) && (rtb_y_b4 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    rtb_OR_ko = ((rtb_Compare_bj && (rtb_DataTypeConversion1_e != 0U) && rtb_y_l) || (rtb_y_no4 && rtb_OR4_e &&
    ...
    rtb_y_b4 = FmgcComputer_P.Logic_table_fi[(((((!rtb_y_bo) && (rtb_y_b4 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_ir_computation_data_inertial_vertical_speed_ft_s,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_g, &rtb_y_pu);
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_lp_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault4_defaultValue_b, &rtb_DataTypeConversion2_m);
    ...
    rtb_OR_ko = ((rtb_Compare_bj && (rtb_y_nl < rtb_y_gl + 3.0F) && (rtb_y_dbv < -rtb_Nosewheel_c)) || (rtb_Compare_bj &&
      (rtb_y_nl > rtb_DataTypeConversion2_m - 3.0F) && (rtb_y_dbv > rtb_Nosewheel_c)));
    ...
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_trk_deg, &rtb_y_bm);
    FmgcComputer_MATLABFunction(&FmgcComputer_U.in.bus_inputs.fcu_bus.fcu_discrete_word_2,
    ...
    FmgcComputer_MATLABFunction_k(((rtb_y_d1 || rtb_y_bm || (rtb_DataTypeConversion1_e != 0U)) && (rtb_y_bo ||
    ...
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_l);
    rtb_y_bo = rtb_y_no4;
    ...
    rtb_y_m5 = (rtb_y_hq && rtb_ap_fd_condition_tmp_0 && (!FmgcComputer_DWork.Memory_PreviousInput_nu) && (!rtb_y_b4) &&
                (!FmgcComputer_DWork.Memory_PreviousInput_d));
    ...
    rtb_Compare_bj = ((rtb_DataTypeConversion1_e != 0U) && rtb_y_l);
    FmgcComputer_MATLABFunction_k(rtb_y_ft, FmgcComputer_P.PulseNode1_isRisingEdge_n, &rtb_y_kd,
    ...
    rtb_OR4_e = ((rtb_y_kd && rtb_y_bo) || (rtb_OR4_e && rtb_y_bo && rtb_y_ft) || rtb_y_nz);
    rtb_y_d1 = (FmgcComputer_DWork.Memory_PreviousInput_i || FmgcComputer_DWork.Memory_PreviousInput_k);
    FmgcComputer_MATLABFunction_k(rtb_y_d1, FmgcComputer_P.PulseNode3_isRisingEdge_i, &rtb_y_kd,
    ...
    rtb_y_bo = ((rtb_y_h && rtb_OR4_e) || (rtb_y_kd || rtb_y_m5 || rtb_y_nz));
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_chosen_fac_bus_v_3_kn,
      FmgcComputer_P.A429ValueOrDefault5_defaultValue_j, &rtb_DataTypeConversion2_m);
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_dc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_m, &rtb_y_pu);
    ...
    if (FmgcComputer_DWork.Memory_PreviousInput_h) {
      if (FmgcComputer_DWork.Memory_PreviousInput_d || FmgcComputer_DWork.Memory_PreviousInput_l ||
        ...
        rtb_Switch_e[0] = std::fmax(std::fmax(std::fmax(static_cast<real_T>(rtb_y_gl), static_cast<real_T>(rtb_y_nl)),
          static_cast<real_T>(rtb_DataTypeConversion2_m)), FmgcComputer_B.u_l);
    ...
    rtb_y_bo = (rtb_appCapability_idx_0 || FmgcComputer_DWork.Memory_PreviousInput_cb ||
                ...
                FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_y_b4 || FmgcComputer_DWork.Memory_PreviousInput_ae ||
    ...
    } else if (FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_y_b4 || FmgcComputer_DWork.Memory_PreviousInput_d) {
    ...
    rtb_y_d1 = (rtb_Logic_a2[0] && (FmgcComputer_DWork.Memory_PreviousInput_l ||
      FmgcComputer_DWork.Memory_PreviousInput_d));
    rtb_y_bm = ((!fdOppOff) && (FmgcComputer_U.in.discrete_inputs.fwc_own_valid ||
    ...
    rtb_y_ed = (rtb_y_bm && (!rtb_ap_fd_condition_tmp) && rtb_bothRaValid);
    ...
    rtb_appCapability_idx_0 = (rtb_y_bm && rtb_y_d1 && (!apCondition_tmp_0) && rtb_appCapability_idx_0);
    rtb_y_bm = !rtb_y_bm;
    rtb_y_ed = !rtb_y_ed;
    ...
    rtb_DataTypeConversion2_e = rtb_irComputationBus_body_yaw_rate_deg_s_Data;
    ...
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_jm_logic_ils_computation_data_glideslope_deviation_deg, &rtb_y_pa);
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jm_logic_chosen_fac_bus_v_max_kn,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_i, &rtb_y_pu);
    rtb_DataTypeConversion26 = rtb_y_pu;
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_vz_ft_min,
      FmgcComputer_P.A429ValueOrDefault1_defaultValue_fc, &rtb_DataTypeConversion2_m);
    rtb_DataTypeConversion41 = rtb_DataTypeConversion2_m;
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fcu_bus.selected_fpa_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_f, &rtb_y_dbv);
    rtb_DataTypeConversion42 = rtb_y_dbv;
    rtb_y_d1 = (rtb_y_b4 || FmgcComputer_DWork.Memory_PreviousInput_d);
    LawMDLOBJ1.step(&FmgcComputer_U.in.time.dt, &FmgcComputer_U.in.time.simulation_time, &rtb_pfdTarget,
                    &rtb_DataTypeConversion1_d, &rtb_DataTypeConversion8, &rtb_DataTypeConversion2_e,
                    ...
                    &rtb_DataTypeConversion25, &rtb_y_pa, &rtb_DataTypeConversion23,
    ...
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_flex_temp_deg, &rtb_y_g);
    ...
    rtb_y_nz = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_pa &&
      rtb_y_d1 && rtb_y_hq && rtb_y_nz) || ((!rtb_y_g) && (!rtb_y_p) && rtb_BusAssignment_h_logic_one_engine_out &&
    ...
    rtb_y_pa = !FmgcComputer_DWork.Memory_PreviousInput_hu;
    rtb_y_g = (((rtb_y_ha != 0U) && rtb_y_l) || (rtb_y_no4 && rtb_y_hq && rtb_y_pa));
    FmgcComputer_MATLABFunction_kh(rtb_y_g, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_b,
    ...
    FmgcComputer_DWork.Memory_PreviousInput_bh = FmgcComputer_P.Logic_table_ac[(((rtb_y_if || ((rtb_y_d1 ||
      FmgcComputer_DWork.Delay1_DSTATE.speed_mach_mode_active) && (!rtb_y_hq))) + (static_cast<uint32_T>(rtb_y_g) << 1))
    ...
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_y_l) || (rtb_y_no4 && rtb_y_hq && rtb_y_pa));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cm = FmgcComputer_P.Logic_table_ma[(((rtb_y_if || ((rtb_y_d1 ||
    ...
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_y_l) || (rtb_y_no4 && FmgcComputer_DWork.Memory_PreviousInput_d &&
      rtb_Logic_a2[0] && (rtb_raComputationData <= FmgcComputer_P.CompareToConstant_const_e3) && rtb_y_pa));
    ...
    FmgcComputer_DWork.Memory_PreviousInput_o = FmgcComputer_P.Logic_table_acc[(((rtb_y_if ||
    ...
    rtb_y_e = athr_fma_message::NONE;
    rtb_y_pa = (FmgcComputer_DWork.Delay_DSTATE_k && rtb_y_pa);
    if (rtb_y_pa && FmgcComputer_DWork.Memory_PreviousInput_kr &&
      ...
      rtb_y_e = athr_fma_message::LVR_CLB;
    } else if (rtb_y_pa && FmgcComputer_DWork.Memory_PreviousInput_km &&
      ...
      rtb_y_e = athr_fma_message::LVR_MCT;
    } else if (rtb_y_pa && rtb_ap_fd_condition_tmp_0 &&
               (((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 24.0F) &&
                 (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 26.0F) &&
                 ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 26.0F))) ||
                ((FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_tla_deg.Data > 24.0F) &&
                 ...
                 ((FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data < 24.0F) ||
                  (FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg.Data > 26.0F))))) {
      rtb_y_e = athr_fma_message::LVR_ASYM;
    }
    ...
    if (rtb_ap_fd_condition_tmp_0 && (rtb_y_nl > 44.0F)) {
      ...
      if (rtb_y_no4 && rtb_y_pa) {
        ...
        if (rtb_y_no4 && (!FmgcComputer_DWork.Delay_DSTATE_c)) {
          rtb_y_f3 = athr_fma_mode::SPEED;
        } else if (rtb_y_no4 && FmgcComputer_DWork.Delay_DSTATE_c) {
          rtb_y_f3 = athr_fma_mode::MACH;
        } else {
          rtb_y_no4 = (rtb_ap_fd_condition_tmp_0 && FmgcComputer_DWork.Memory_PreviousInput_bh);
          rtb_y_pa = !rtb_OR_pj;
          if (rtb_y_no4 && (rtb_y_nl > 34.0F) && rtb_y_pa) {
            rtb_y_f3 = athr_fma_mode::THR_MCT;
          } else if (rtb_y_no4 && (rtb_y_nl > 24.0F) && rtb_y_pa) {
            rtb_y_f3 = athr_fma_mode::THR_CLB;
          } else if (rtb_y_no4 && (rtb_y_nl < 25.0F) && rtb_y_pa) {
            rtb_y_f3 = athr_fma_mode::THR_LVR;
            ...
            rtb_y_f3 = athr_fma_mode::THR_IDLE;
          } else {
            ...
            if (rtb_ap_fd_condition_tmp_0 && (rtb_y_ha != 0U)) {
              rtb_y_f3 = athr_fma_mode::A_FLOOR;
            } else if (rtb_ap_fd_condition_tmp_0 && (rtb_y_ha == 0U)) {
              rtb_y_f3 = athr_fma_mode::TOGA_LK;
            }
          }
        }
      }
    ...
    FmgcComputer_MATLABFunction_p(&rtb_BusAssignment_jc_logic_adr_computation_data_airspeed_computed_kn,
      FmgcComputer_P.A429ValueOrDefault_defaultValue_km, &rtb_y_pu);
    ...
    rtb_DataTypeConversion2_m = v[high_i] - rtb_y_pu;
    ...
    rtb_DataTypeConversion2_e = FmgcComputer_P.kntoms_Gain * rtb_y_nl;
    ...
    FmgcComputer_DWork.pU_p = rtb_DataTypeConversion6;
    if (rtb_DataTypeConversion2_e > FmgcComputer_P.Saturation_UpperSat_j) {
      rtb_DataTypeConversion2_e = FmgcComputer_P.Saturation_UpperSat_j;
    } else if (rtb_DataTypeConversion2_e < FmgcComputer_P.Saturation_LowerSat_o) {
      rtb_DataTypeConversion2_e = FmgcComputer_P.Saturation_LowerSat_o;
    }
    ...
    FmgcComputer_LeadLagFilter(FmgcComputer_DWork.pY_f - FmgcComputer_P.g_Gain * (FmgcComputer_P.Gain1_Gain_d *
      ...
      (FmgcComputer_P.Gain_Gain_b * std::atan(rtb_DataTypeConversion8 / rtb_DataTypeConversion2_e))) *
    ...
    rtb_DataTypeConversion1_d = (rtb_Product_a + rtb_Switch1_a) * FmgcComputer_P.mpstokts_Gain *
      FmgcComputer_P.Gain4_Gain * look1_iflf_binlxpw(rtb_DataTypeConversion2_m,
    ...
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_n1_actual_percent,
      FmgcComputer_P.A429ValueOrDefault6_defaultValue_e, &rtb_y_pu);
    ...
    if (FmgcComputer_U.in.sim_data.tracking_mode_on_override) {
      ...
      rtb_Switch1_a = ((FmgcComputer_P.Gain_Gain * rtb_DataTypeConversion1_d + FmgcComputer_DWork.pY_d) +
        ...
        * look1_iflf_binlxpw(std::fmin(rtb_y_dbv, rtb_y_pu), FmgcComputer_P.ScheduledGain2_BreakpointsForDimension1,
    ...
    FmgcComputer_DWork.icLoad = (rtb_y_if || rtb_y_d1 || FmgcComputer_DWork.Memory_PreviousInput_hu ||
    ...
    FmgcComputer_MATLABFunction_i(&rtb_BusAssignment_pw_logic_ils_computation_data_runway_heading_deg, &rtb_y_if);
    ...
    rtb_VectorConcatenate[9] = rtb_y_bm;
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_y_pu);
    rtb_VectorConcatenate_bw[0] = (rtb_y_f3 == athr_fma_mode::MAN_TOGA);
    rtb_VectorConcatenate_bw[1] = ((rtb_y_f3 == athr_fma_mode::MAN_MCT) || (rtb_y_f3 == athr_fma_mode::THR_MCT));
    rtb_VectorConcatenate_bw[2] = (rtb_y_f3 == athr_fma_mode::MAN_FLEX);
    rtb_VectorConcatenate_bw[3] = (rtb_y_f3 == athr_fma_mode::THR_CLB);
    rtb_VectorConcatenate_bw[4] = ((rtb_y_f3 == athr_fma_mode::MAN_THR) || (rtb_y_f3 == athr_fma_mode::THR_LVR));
    rtb_VectorConcatenate_bw[5] = (rtb_y_f3 == athr_fma_mode::THR_IDLE);
    rtb_VectorConcatenate_bw[6] = (rtb_y_f3 == athr_fma_mode::A_FLOOR);
    rtb_VectorConcatenate_bw[7] = (rtb_y_f3 == athr_fma_mode::TOGA_LK);
    rtb_VectorConcatenate_bw[8] = (rtb_y_f3 == athr_fma_mode::SPEED);
    rtb_VectorConcatenate_bw[9] = (rtb_y_f3 == athr_fma_mode::MACH);
    rtb_VectorConcatenate_bw[10] = (rtb_y_e == athr_fma_message::LVR_ASYM);
    rtb_VectorConcatenate_bw[11] = (rtb_y_e == athr_fma_message::LVR_CLB);
    rtb_VectorConcatenate_bw[12] = (rtb_y_e == athr_fma_message::LVR_MCT);
    ...
    rtb_VectorConcatenate_bw[8] = FmgcComputer_P.Constant6_Value;
    ...
    rtb_VectorConcatenate_f[9] = (FmgcComputer_DWork.Memory_PreviousInput_cb || rtb_y_b4);
    rtb_VectorConcatenate_f[10] = (FmgcComputer_DWork.Memory_PreviousInput_ne ||
      FmgcComputer_DWork.Memory_PreviousInput_nu);
    rtb_VectorConcatenate_f[11] = (FmgcComputer_DWork.Memory_PreviousInput_nu || rtb_y_b4);
    ...
    FmgcComputer_MATLABFunction_g(rtb_VectorConcatenate_f, &rtb_DataTypeConversion2_m);
    FmgcComputer_Y.out.data = FmgcComputer_U.in;
    FmgcComputer_Y.out.logic.on_ground = rtb_y_h;
    FmgcComputer_Y.out.logic.gnd_eng_stop_flt_5s = rtb_y_n;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.gs_trk_active = rtb_y_b4;
    ...
    FmgcComputer_Y.out.ap_fd_logic.fmgc_opp_mode_sync = rtb_y_l;
    ...
    FmgcComputer_Y.out.ap_fd_logic.land_2_inop = rtb_y_bm;
    ...
    FmgcComputer_Y.out.athr.fma_mode = rtb_y_f3;
    FmgcComputer_Y.out.athr.fma_message = rtb_y_e;
    ...
    if (rtb_y_if || rtb_BusAssignment_b_logic_ils_tune_inhibit) {
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.ats_discrete_word.Data = rtb_y_pu;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_6.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_a_bus.discrete_word_6.Data = rtb_DataTypeConversion2_m;
    ...
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.SSM = static_cast<uint32_T>
      (FmgcComputer_P.EnumeratedConstant1_Value);
    FmgcComputer_Y.out.bus_outputs.fmgc_b_bus.ats_discrete_word.Data = rtb_y_pu;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active = rtb_y_b4;
    ...
    FmgcComputer_DWork.Delay_DSTATE.fmgc_opp_mode_sync = rtb_y_l;
    ...
    FmgcComputer_DWork.Delay_DSTATE.land_2_inop = rtb_y_bm;
    ...
    FmgcComputer_DWork.DelayInput1_DSTATE_b = dPsi_1;
    FmgcComputer_DWork.Memory_PreviousInput_as = rtb_y_b4;
    ...
    FmgcComputer_DWork.Delay1_DSTATE.fma_mode = rtb_y_f3;
    FmgcComputer_DWork.Delay1_DSTATE.fma_message = rtb_y_e;
