...
void FmgcComputer::step()
{
  ...
  if (FmgcComputer_U.in.sim_data.computer_running) {
    if (!FmgcComputer_DWork.Runtime_MODE) {
      ...
      FmgcComputer_MATLABFunction_p_Reset(&FmgcComputer_DWork.sf_MATLABFunction_kq);
      ...
      FmgcComputer_MATLABFunction_m_Reset(&FmgcComputer_DWork.sf_MATLABFunction_db);
      ...
      FmgcComputer_MATLABFunction_i_Reset(&FmgcComputer_DWork.sf_MATLABFunction_dba);
    ...
    FmgcComputer_MATLABFunction_k((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_goaround_active ||
      ...
      &rtb_y_d1, &FmgcComputer_DWork.sf_MATLABFunction_kq);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
    ...
    rtb_Compare_du = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 ||
                      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    rtb_y_j = (rtb_Compare_du || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
               FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
    ...
    FmgcComputer_MATLABFunction_j(FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.pitch_takeoff_active,
      FmgcComputer_U.in.time.dt, &rtb_y_d1, FmgcComputer_P.MTrigNode_isRisingEdge_d,
      FmgcComputer_P.MTrigNode_retriggerable_m, FmgcComputer_P.MTrigNode_triggerDuration_e,
    ...
    rtb_y_e = !FmgcComputer_DWork.Delay_DSTATE.lateral_modes.rwy_active;
    ...
    rtb_y_nz = (rtb_ap_fd_condition_tmp_1 && (rtb_y_f || (rtb_y_no4 && (FmgcComputer_P.Constant_Value_l && rtb_y_ed &&
      ...
      (!FmgcComputer_DWork.Delay_DSTATE.armed_modes.final_des_armed))) && rtb_appInop_idx_2 && rtb_OR2_l_tmp && rtb_y_e &&
      rtb_NOT1_n_tmp && rtb_Compare_bj && rtb_Compare_bj && ((rtb_y_dbv == rtb_DataTypeConversion2_m) && (rtb_y_nl ==
      rtb_y_gl)))));
    ...
    FmgcComputer_MATLABFunction_kh(rtb_y_h, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode2_isRisingEdge,
      FmgcComputer_P.ConfirmNode2_timeDelay, &rtb_Compare_bj, &FmgcComputer_DWork.sf_MATLABFunction_fo);
    ...
    FmgcComputer_MATLABFunction_kh((FmgcComputer_DWork.Delay_DSTATE.lateral_modes.land_active && (rtb_raComputationData <=
      ...
      FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode1_isRisingEdge_b, FmgcComputer_P.ConfirmNode1_timeDelay_e,
    ...
    rtb_y_f = (rtb_y_i1_tmp && FmgcComputer_U.in.fms_inputs.vertical_flight_plan_valid &&
               FmgcComputer_P.Constant_Value_hg && rtb_y_m5 && rtb_OR_fz && (rtb_appInop_idx_2 && rtb_y_e &&
    ...
    rtb_y_p3 = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active);
    rtb_y_e = (rtb_y_p3 || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active);
    rowIdx_tmp = (rtb_y_e || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_cb = FmgcComputer_P.Logic_table_ob[(((rtb_AND2_po || ((rtb_Compare_du ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
    ...
    rtb_Compare_du = (FmgcComputer_DWork.Memory_PreviousInput_cb && (std::abs(FmgcComputer_U.in.fms_inputs.cruise_alt_ft
      - rtb_y_gl) < FmgcComputer_P.CompareToConstant1_const_a));
    ...
    rtb_Compare_ji_tmp = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
                          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                          FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active);
    rtb_y_p3 = (FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active);
    ...
    rtb_Compare_bj = ((rtb_OR_pj && rtb_y_ed && rtb_y_d1) || rtb_AND8 ||
      ...
      - rtb_altCstrOrFcu) >= FmgcComputer_P.CompareToConstant_const_om)) || (rtb_Compare_ji_tmp &&
      (rtb_DataTypeConversion2_m > FmgcComputer_P.CompareToConstant1_const_o)) || (rtb_y_p3 &&
      (rtb_DataTypeConversion2_m < FmgcComputer_P.CompareToConstant2_const_g)) || ((rtb_Compare_ji_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active) && (dPsi_1 > rtb_y_nl) &&
      rtb_fmgcOppPriority_tmp && FmgcComputer_DWork.Delay_DSTATE_k) || (rtb_y_p3 && rtb_y_p && rtb_fmgcOppPriority_tmp &&
    ...
    rtb_y_p = !rtb_OR2_l;
    rtb_Logic_d_idx_0_tmp = (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active);
    FmgcComputer_DWork.Memory_PreviousInput_ma = FmgcComputer_P.Logic_table_ns[((((rtb_y_nz && (!rtb_y_f)) ||
      (rtb_Logic_d_idx_0_tmp || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_clb_active ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.op_des_active ||
       ((FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_hold_active ||
         FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.alt_acq_active) && rtb_y_p) ||
       FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.tcas_active) || (rtb_y_nl < rtb_y_gl) || (rtb_AND_e_tmp &&
      (rtb_y_p || rtb_TmpSignalConversionAtSFunctionInport3_idx_0 || rtb_y_g)) ||
    ...
    rtb_y_ed = (rtb_y_p || (std::abs(rtb_altCstrOrFcu - rtb_y_gl) > FmgcComputer_P.CompareToConstant2_const_a));
    ...
    rtb_Compare_ji_tmp = !rtb_AND_e_tmp;
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_m) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 &&
      ...
      ((FmgcComputer_DWork.Delay_DSTATE.armed_modes.clb_armed && rtb_y_m5) || (rtb_y_d1 && (rtb_Compare_ji_tmp ||
    ...
    FmgcComputer_DWork.Memory_PreviousInput_nt = FmgcComputer_P.Logic_table_he[(((rtb_Logic_d_idx_0_tmp ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.des_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_capt_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.gs_trk_active ||
      FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active ||
      ...
      (rtb_AND_e_tmp && rtb_y_p) || rtb_AND2_po) + (static_cast<uint32_T>(rtb_Compare_bj) << 1)) << 1) +
    ...
    rtb_Compare_bj = ((rtb_Compare_bj && rtb_y_m) || (rtb_TmpSignalConversionAtSFunctionInport3_idx_1 && (rtb_OR_ko &&
      ...
      (rtb_Compare_ji_tmp || (rtb_AND_e_tmp && rtb_y_ed && (rtb_y_p || (std::abs(rtb_altCstrOrFcu - rtb_y_gl) >
      FmgcComputer_P.CompareToConstant2_const_l))))))));
    ...
    rtb_AND_e_tmp = (rtb_y_e || FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.clb_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_clb_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.exp_des_active ||
                     FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.final_des_active);
    ...
    FmgcComputer_DWork.Memory_PreviousInput_fm = FmgcComputer_P.Logic_table_dr[(((static_cast<uint32_T>
      (((rtb_DataTypeConversion1_e != 0U) && rtb_y_m) || (rtb_y_no4 && (rtb_y_f && rtb_y_b4 && rtb_OR_ko))) << 1) +
    ...
    FmgcComputer_MATLABFunction_kh(rtb_OR_ko, FmgcComputer_U.in.time.dt, FmgcComputer_P.ConfirmNode_isRisingEdge_o,
      FmgcComputer_P.ConfirmNode_timeDelay_mu, &rtb_y_bo, &FmgcComputer_DWork.sf_MATLABFunction_dba);
    ...
    FmgcComputer_MATLABFunction_i(&FmgcComputer_U.in.bus_inputs.fadec_own_bus.selected_flex_temp_deg, &rtb_y_e);
    FmgcComputer_MATLABFunction_p(&FmgcComputer_U.in.bus_inputs.fadec_opp_bus.selected_tla_deg,
      FmgcComputer_P.A429ValueOrDefault2_defaultValue_k, &rtb_y_nl);
    rtb_y_p = (rtb_y_nl > FmgcComputer_P.CompareToConstant4_const_p);
    ...
    rtb_y_nz = (FmgcComputer_DWork.Delay_DSTATE_k && (FmgcComputer_DWork.Memory_PreviousInput_hu || (rtb_y_pa &&
      rtb_y_d1 && rtb_y_hq && rtb_y_nz) || ((!rtb_y_g) && (!rtb_y_e) && rtb_BusAssignment_h_logic_one_engine_out &&
      (rtb_y_p && rtb_OR4_e && (rtb_y_nl > FmgcComputer_P.CompareToConstant5_const_av) && (rtb_y_nl <=
    ...
    rtb_y_g = (((rtb_y_ha != 0U) && rtb_y_m) || (rtb_y_no4 && rtb_y_hq && rtb_y_pa));
    ...
    rtb_OR_pj = (((rtb_y_ha != 0U) && rtb_y_m) || (rtb_y_no4 && rtb_y_hq && rtb_y_pa));
    ...
    FmgcComputer_DWork.pY += std::fmax(std::fmin(static_cast<real_T>(rtb_Compare_du) - FmgcComputer_DWork.pY, std::abs
    ...
    rtb_VectorConcatenate_f[15] = rtb_Compare_du;
    ...
    FmgcComputer_Y.out.ap_fd_logic.longitudinal_modes.fma_dash_display = rtb_Compare_du;
    ...
    FmgcComputer_DWork.Delay_DSTATE.longitudinal_modes.fma_dash_display = rtb_Compare_du;
