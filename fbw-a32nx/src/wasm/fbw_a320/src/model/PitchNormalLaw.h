...
class PitchNormalLaw final
{
 public:
  ...
  struct rtDW_LagFilter_PitchNormalLaw_f_T {
    real_T pY;
    real_T pU;
    boolean_T pY_not_empty;
    boolean_T pU_not_empty;
  ...
  struct D_Work_PitchNormalLaw_T {
    ...
    rtDW_LagFilter_PitchNormalLaw_f_T sf_LagFilter_f;
    ...
    rtDW_LagFilter_PitchNormalLaw_f_T sf_LagFilter_o;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter_k;
    rtDW_LagFilter_PitchNormalLaw_f_T sf_LagFilter_cx;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter_l;
    rtDW_LagFilter_PitchNormalLaw_f_T sf_LagFilter_i;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter_j;
    rtDW_LagFilter_PitchNormalLaw_f_T sf_LagFilter_c;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter;
    rtDW_LagFilter_PitchNormalLaw_f_T sf_LagFilter_n;
  ...
  struct Parameters_PitchNormalLaw_T {
    ...
    real_T ScheduledGain_BreakpointsForDimension1_h1[4];
    real_T ScheduledGain_BreakpointsForDimension1_d[4];
    real_T ScheduledGain1_BreakpointsForDimension1[5];
    real_T ScheduledGain_BreakpointsForDimension1_da[5];
    ...
    real_T DiscreteDerivativeVariableTs1_Gain_d;
    ...
    real_T DiscreteDerivativeVariableTs1_Gain_a;
    real_T DiscreteDerivativeVariableTs_Gain_d;
    real_T DiscreteDerivativeVariableTs2_Gain_m;
    real_T DiscreteDerivativeVariableTs1_Gain_n;
    real_T DiscreteDerivativeVariableTs_Gain_n;
    real_T DiscreteDerivativeVariableTs2_Gain_l;
    ...
    real_T DiscreteDerivativeVariableTs1_InitialCondition_p;
    real_T DiscreteDerivativeVariableTs_InitialCondition_b;
    real_T DiscreteDerivativeVariableTs2_InitialCondition_l;
    ...
    real_T DiscreteDerivativeVariableTs1_InitialCondition_k;
    real_T DiscreteDerivativeVariableTs_InitialCondition_i;
    real_T DiscreteDerivativeVariableTs2_InitialCondition_ei;
    real_T DiscreteDerivativeVariableTs1_InitialCondition_m;
    real_T DiscreteDerivativeVariableTs_InitialCondition_az;
    ...
    real_T ScheduledGain_Table_em[4];
    ...
    real_T Gain5_Gain_d;
    real_T Bias_Bias_a;
    real_T PLUT_tableData_i[2];
    real_T PLUT_bp01Data_j[2];
    real_T DLUT_tableData_f[2];
    real_T DLUT_bp01Data_b[2];
    real_T SaturationV_dot_UpperSat_n;
    real_T SaturationV_dot_LowerSat_k;
    real_T Gain_Gain_n;
    ...
    real_T Gain5_Gain_n;
    real_T Bias_Bias_ai;
    real_T PLUT_tableData_n[2];
    real_T PLUT_bp01Data_h[2];
    real_T DLUT_tableData_b[2];
    real_T DLUT_bp01Data_mz[2];
    real_T SaturationV_dot_UpperSat_a;
    real_T SaturationV_dot_LowerSat_i;
    real_T Gain_Gain_fk;
    real_T SaturationSpoilers_UpperSat_b;
    real_T SaturationSpoilers_LowerSat_c;
    ...
    real_T PLUT_tableData_h[2];
    real_T PLUT_bp01Data_e[2];
    real_T DLUT_tableData_c[2];
    real_T DLUT_bp01Data_d[2];
    real_T SaturationV_dot_UpperSat_l;
    real_T SaturationV_dot_LowerSat_mw;
    real_T Gain_Gain_e;
    real_T SaturationSpoilers_UpperSat_d;
 ...
 private:
  ...
  static void PitchNormalLaw_LagFilter_p_Reset(rtDW_LagFilter_PitchNormalLaw_f_T *localDW);
