...
class PitchNormalLaw final
{
 public:
  ...
  struct rtDW_RateLimiter_PitchNormalLaw_h_T {
    real_T pY;
    boolean_T pY_not_empty;
  };
  ...
  struct D_Work_PitchNormalLaw_T {
    ...
    real_T previous_flare_Theta_c_deg;
    real_T was_in_flare;
    real_T rate_down;
    ...
    boolean_T icLoad;
    boolean_T icLoad_p;
    boolean_T previous_flare_Theta_c_deg_not_empty;
    boolean_T was_in_flare_not_empty;
    rtDW_RateLimiter_PitchNormalLaw_T sf_RateLimiter_b;
    rtDW_RateLimiter_PitchNormalLaw_h_T sf_RateLimiter_ct;
    rtDW_LagFilter_PitchNormalLaw_d_T sf_LagFilter_fz;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter_h;
    rtDW_RateLimiter_PitchNormalLaw_h_T sf_RateLimiter_nx;
    rtDW_RateLimiter_PitchNormalLaw_h_T sf_RateLimiter_i;
    rtDW_RateLimiter_PitchNormalLaw_h_T sf_RateLimiter_c2;
    ...
    rtDW_RateLimiter_PitchNormalLaw_h_T sf_RateLimiter_f;
    ...
    rtDW_RateLimiter_PitchNormalLaw_T sf_RateLimiter_a;
    rtDW_RateLimiter_PitchNormalLaw_h_T sf_RateLimiter_g;
    rtDW_WashoutFilter_PitchNormalLaw_T sf_WashoutFilter_kh;
    rtDW_LagFilter_PitchNormalLaw_d_T sf_LagFilter_o;
    ...
    rtDW_RateLimiter_PitchNormalLaw_T sf_RateLimiter_cx;
  ...
  struct Parameters_PitchNormalLaw_T {
    ...
    real_T DiscreteDerivativeVariableTs1_Gain_o;
    ...
    real_T DiscreteDerivativeVariableTs2_Gain_pk;
    ...
    real_T DiscreteDerivativeVariableTs1_InitialCondition_ni;
    real_T RateLimiterVariableTs7_InitialCondition;
    ...
    real_T RateLimiterVariableTs7_lo;
    real_T RateLimiterVariableTs6_lo_a;
    ...
    real_T RateLimiterVariableTs7_up;
    real_T RateLimiterVariableTs6_up_e;
    ...
    real_T ConstantUp_Value_c;
    real_T LimitUp_tableData_a[35];
    real_T LimitUp_bp01Data_i[7];
    real_T LimitUp_bp02Data_c[5];
    real_T LimitLo_tableData_e[35];
    real_T LimitLo_bp01Data_k[7];
    real_T LimitLo_bp02Data_j[5];
    real_T ConstantLo_Value_k;
    real_T LimitSwitchLo_Threshold_f;
    real_T SaturationSpoilers_UpperSat_h;
    real_T SaturationSpoilers_LowerSat_n;
    real_T SaturationV_dot_UpperSat_e;
    real_T SaturationV_dot_LowerSat_p;
    real_T Gain_Gain_j;
    ...
    real_T LimitSwitchUp_Threshold_o;
    ...
    real_T Gain1_Gain_b;
    real_T Vm_currentms_Value_jv;
    real_T Gain_Gain_d3;
    real_T uDLookupTable_tableData_p[7];
    real_T uDLookupTable_bp01Data_a[7];
    real_T Saturation3_UpperSat_i;
    real_T Saturation3_LowerSat_lw;
    real_T Gain5_Gain_di;
    real_T Bias_Bias_o;
    real_T Gain1_Gain_ow;
    ...
    real_T DLUT_tableData_n[2];
    real_T DLUT_bp01Data_n[2];
    real_T GainLo_Gain_k;
    ...
    real_T Gain5_Gain_e;
    real_T Bias_Bias_f;
    real_T Loaddemand_tableData_c[3];
    real_T Loaddemand_bp01Data_h[3];
    ...
    real_T Gain_Gain_p;
    real_T uDLookupTable_tableData_pu[7];
    real_T uDLookupTable_bp01Data_a4[7];
    ...
    real_T Gain_Gain_k;
    real_T SaturationSpoilers_UpperSat_hy;
    ...
    real_T ConstantTailstrikeProtection_Value;
    ...
    uint32_T LimitUp_maxIndex_c[2];
    uint32_T LimitLo_maxIndex_k[2];
 ...
 private:
  ...
  static void PitchNormalLaw_RateLimiter_g_Reset(rtDW_RateLimiter_PitchNormalLaw_h_T *localDW);
  static void PitchNormalLaw_RateLimiter_g(const real_T *rtu_u, real_T rtu_up, real_T rtu_lo, const real_T *rtu_Ts,
    real_T rtu_init, real_T *rty_Y, rtDW_RateLimiter_PitchNormalLaw_h_T *localDW);
