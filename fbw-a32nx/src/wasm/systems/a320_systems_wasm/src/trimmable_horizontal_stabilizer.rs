...
const UPPER_BOUNDARY_1_PLUS_F_DATA: [f64; LUT_SHAPE.0 * LUT_SHAPE.1] = [
    3.5, 3.2, 2.7, 2.0, 1.4, 0.9, 0.4, 0.0, -0.9,
    4.3, 3.7, 3.2, 2.5, 1.8, 1.3, 0.9, 0.4, -0.6,
    3.6, 3.2, 2.6, 2.0, 1.5, 0.9, 0.6, 0.1, -0.8,
    4.6, 4.2, 3.6, 2.8, 2.2, 1.7, 1.3, 0.5, -0.6,
    4.9, 4.4, 3.7, 2.8, 2.4, 1.8, 1.4, 0.8, -0.2,
    4.9, 4.4, 3.8, 3.0, 2.5, 1.9, 1.5, 0.9, -0.1,
    5.2, 4.8, 4.0, 3.2, 2.7, 2.0, 1.7, 1.0, 0.1,
    5.3, 4.9, 4.1, 3.3, 2.8, 2.1, 1.8, 1.1, 0.2,
];
...
const UPPER_BOUNDARY_2_DATA: [f64; LUT_SHAPE.0 * LUT_SHAPE.1] = [
    1.1, 0.8, 0.4, -0.3, -0.8, -1.4, -1.7, -2.3, -3.2,
    1.1, 0.8, 0.4, -0.3, -0.7, -1.3, -1.6, -2.2, -3.1,
    1.5, 1.2, 0.6, -0.1, -0.5, -1.0, -1.3, -1.9, -2.8,
    1.8, 1.6, 1.0, 0.3, -0.1, -0.6, -0.9, -1.5, -2.3,
    1.7, 1.5, 0.9, 0.2, -0.2, -0.7, -1.0, -1.4, -2.2,
    2.0, 1.6, 1.2, 0.4, 0.0, -0.4, -0.7, -1.2, -2.0,
    2.1, 1.8, 1.4, 0.7, 0.3, -0.2, -0.5, -1.0, -1.8,
    2.2, 1.9, 1.5, 0.8, 0.4, -0.2, -0.5, -1.0, -1.8,
];
...
const UPPER_BOUNDARY_3_DATA: [f64; LUT_SHAPE.0 * LUT_SHAPE.1] = [
    ...
    3.0, 2.5, 2.0, 1.1, 0.6, 0.0, -0.4, -1.1, -2.2,
    2.1, 1.6, 1.0, 0.6, 0.0, -0.5, -0.8, -1.4, -2.2,
    1.7, 1.5, 1.0, 0.3, -0.3, -0.8, -1.1, -1.7, -2.5,
    1.6, 1.4, 0.9, 0.2, -0.4, -1.0, -1.1, -1.6, -2.5,
];
