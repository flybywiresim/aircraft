    ...
    public render(): VNode {
        return (
            <g transform={`translate(${this.props.x} ${this.props.y})`}>
                <text id="QFE" class={this.qfeLabelSub} x="50" y="61.5">QFE</text>
                <text id="QNH" class={this.qnhLabelSub} x="300" y="61.5" text-anchor="end">QNH</text>
                <text id="Value" class="Value" x="28" y="165">{this.baroValueSub}</text>
            </g>
        );
    }
}
