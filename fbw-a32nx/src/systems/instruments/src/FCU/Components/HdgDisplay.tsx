    ...
    public render(): VNode {
        return (
            <g transform={`translate(${this.props.x} ${this.props.y})`}>
                <text id="HDG" class={this.hdgLabelSub} x="77" y="57.6">HDG</text>
                <text id="TRK" class={this.trkLabelSub} x="210" y="57.6">TRK</text>
                <text id="LAT" class="Active" x="328" y="57.6">LAT</text>
                <text id="Value" class="Value" x="87" y="163">{this.valueSub}</text>
