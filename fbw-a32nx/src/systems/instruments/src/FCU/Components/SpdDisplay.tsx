    ...
    public render(): VNode {
        return (
            <g transform={`translate(${this.props.x} ${this.props.y})`}>
                <text id="SPD" class={this.spdLabelSub} x="77" y="57.6">SPD</text>
                <text id="MACH" class={this.machLabelSub} x="205" y="57.6">MACH</text>
                <text id="Value" class="Value" x="92" y="163">{this.valueSub}</text>
