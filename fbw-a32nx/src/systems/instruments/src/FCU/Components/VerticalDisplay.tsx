    ...
    public render(): VNode {
        return (
            <g transform={`translate(${this.props.x} ${this.props.y})`}>
                <g>
                    <text id="ALT" class="Active" x="256" y="57.6">ALT</text>
                    <text id="Value" class="Value" x="96" y="163">{this.altValueSub}</text>
                </g>
                ...
                <g transform="translate(512 0)">
                    ...
                    <text id="Value" class="Value" x="77" y="163">{this.vsValueSub}</text>
                </g>

                <g>
                    <line x1="369" y1="34.5" x2="369" y2="57.6" />
                    <line x1="369" y1="38.4" x2="440" y2="38.4" />
                    <text id="LVLCH" class="Active" x="450.5" y="57.6">LVL/CH</text>
