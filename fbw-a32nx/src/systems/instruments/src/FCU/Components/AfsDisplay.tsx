        ...
        return (
            <>
                <g transform="translate(0 0)">
                    ...
                    <text id="HDG" class={this.hdgVsLabelSub} x="1229" y="96" text-anchor="end" alignment-baseline="middle">HDG</text>
                    <text id="TRK" class={this.trkFpaLabelSub} x="1229" y="163" text-anchor="end">TRK</text>
                </g>

                <g transform="translate(0 224)">
                    <text id="VS" class={this.hdgVsLabelSub} x="51" y="96" alignment-baseline="middle">V/S</text>
                    <text id="FPA" class={this.trkFpaLabelSub} x="51" y="163">FPA</text>
