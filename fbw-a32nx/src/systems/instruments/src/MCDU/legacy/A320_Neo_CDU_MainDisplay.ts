  ...
  implements LegacyFmsPageInterface, LegacyAtsuPageInterface
{
  ...
  public page = {
    ...
    IRSMonitor: 19,
    IRSStatus: 20,
    LateralRevisionPage: 21,
    MenuPage: 22,
    NavaidPage: 23,
    NavRadioPage: 24,
    NewWaypoint: 25,
    PerformancePageTakeoff: 26,
    PerformancePageClb: 27,
    PerformancePageCrz: 28,
    PerformancePageDes: 29,
    PerformancePageAppr: 30,
    PerformancePageGoAround: 31,
    PilotsWaypoint: 32,
    PosFrozen: 33,
    PositionMonitorPage: 34,
    ProgressPage: 35,
    ProgressPageReport: 36,
    ProgressPagePredictiveGPS: 37,
    SelectedNavaids: 38,
    SelectWptPage: 39,
    VerticalRevisionPage: 40,
    WaypointPage: 41,
    AOCInit: 42,
    AOCInit2: 43,
    AOCOfpData: 44,
    ...
    ATCAtis: 52,
    ATCMessageRecord: 53,
    ATCMessageMonitoring: 54,
    ATCConnection: 55,
    ATCNotification: 56,
    ATCConnectionStatus: 57,
    ATCPositionReport1: 58,
    ATCPositionReport2: 59,
    ATCPositionReport3: 60,
    ATCFlightRequest: 61,
    ATCUsualRequest: 62,
    ATCGroundRequest: 63,
    ATCReports: 64,
    ATCEmergency: 65,
    ATCComLastId: 66, // This is needed for automatic page changes triggered by DCDU
    ATSUMenu: 67,
