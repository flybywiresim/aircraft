...
export class Egt extends DisplayComponent<EgtProps> {
    ...
    onAfterRender(node: VNode): void {
        ...
        sub.on(`engine${this.props.engine}EGT`).whenChanged().handle((egt) => {
            this.egt = egt;
        ...
        return (
            <Layer x={this.props.x} y={this.props.y}>
                <g visibility={this.inactiveVisibility}>
                    <GaugeComponent x={0} y={0} radius={radius} startAngle={this.gaugeStartAngle} endAngle={this.gaugeEndAngle} class="GaugeComponent GaugeInactive" />
                    <text class="Large End Amber" x={20} y={6}>XX</text>
                </g>
                <g visibility={this.activeVisibility}>
                    <text class={this.egtClass} x={35} y={6}>{this.egtText}</text>
                    <GaugeComponent x={0} y={0} radius={radius} startAngle={this.gaugeStartAngle} endAngle={this.gaugeEndAngle} class="GaugeComponent Gauge">
                        <GaugeComponent x={0} y={0} radius={radius} startAngle={this.gaugeStartAngleRed} endAngle={this.gaugeEndAngle} class="GaugeComponent Gauge RedLine" />
