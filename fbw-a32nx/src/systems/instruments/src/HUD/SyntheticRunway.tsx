...
export class SyntheticRunway extends DisplayComponent<{bus: ArincEventBus}> {
    ...
    onAfterRender(node: VNode): void {
        ...
        sub.on('symbol').handle((data: HUDSyntheticRunway) => {
            // while(
            //     this.data.cornerCoordinates[0].lat === undefined ||
            //     this.data.cornerCoordinates[0].long === undefined ||
            //     this.data.cornerCoordinates[1].lat === undefined ||
            //     this.data.cornerCoordinates[1].long === undefined ||
            //     this.data.cornerCoordinates[2].lat === undefined ||
            //     this.data.cornerCoordinates[2].long === undefined ||
            //     this.data.cornerCoordinates[3].lat === undefined ||
            //     this.data.cornerCoordinates[3].long === undefined 
            // ){
            //     this.data = data;
            // }
