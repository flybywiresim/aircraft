        ...
        return (
            <>
                ...
                <g stroke-width={3}>
                    ...
                    <text x={384} y={170} class="White" font-size={25} text-anchor="middle" alignmentBaseline="central">N</text>
                    <path d="M384,141.5 L390,151 L378,151 L384,141.5" fill="white" stroke="none" />

                    <text x={598} y={384} class="White" font-size={25} text-anchor="middle" alignmentBaseline="central">E</text>
                    <path d="M626.2,384 L617,390 L617,378 L626.5,384" fill="white" stroke="none" />

                    <text x={384} y={598} class="White" font-size={25} text-anchor="middle" alignmentBaseline="central">S</text>
                    <path d="M384,626.5 L390,617 L378,617 L384,626.5" fill="white" stroke="none" />

                    <text x={170} y={384} class="White" font-size={25} text-anchor="middle" alignmentBaseline="central">W</text>
