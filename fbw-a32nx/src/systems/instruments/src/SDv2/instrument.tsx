...
class SdInstrument implements FsInstrument {
  ...
  private readonly fcdcBusPublisher = new A32NXFcdcBusPublisher(this.bus);
  ...
  constructor(public readonly instrument: BaseInstrument) {
    ...
    this.backplane.addPublisher('facBusPublisher', this.facBusPublisher);
    this.backplane.addPublisher('fcuBusPublisher', this.fcuBusPublisher);
    this.backplane.addPublisher('fcdcBusPublisher', this.fcdcBusPublisher);
...
class A32NX_SDv2 extends FsBaseInstrument<SdInstrument> {
...
registerInstrument('a32nx-sdv2', A32NX_SDv2);
