        ...
        return (
            <Layer x={698} y={28}>
                ...
                <g visibility={this.activeVisibility}>
                    ...
                    <text class="Huge End Green" x={5} y={28}>{this.textThrustLimitInt}</text>
                    <text class="Large End Green" x={18} y={28}>.</text>
                    <text class="Standard End Green" x={34} y={28}>{this.textThrustLimitFract}</text>
                    <text class="Medium End Cyan" x={49} y={27}>%</text>
