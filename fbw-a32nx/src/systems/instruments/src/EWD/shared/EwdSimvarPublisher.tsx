...
export enum EwdVars {
    ...
    engine1ReverserTransit = 'L:A32NX_REVERSER1_DEPLOYING',
    engine1ReverserDeployed = 'L:A32NX_REVERSER1_DEPLOYED',
    ...
    engine2ReverserTransit = 'L:A32NX_REVERSER2_DEPLOYING',
    engine2ReverserDeployed = 'L:A32NX_REVERSER2_DEPLOYED',
