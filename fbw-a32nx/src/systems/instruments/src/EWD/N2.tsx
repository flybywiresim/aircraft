...
export class N2 extends DisplayComponent<N2Props> {
    ...
    onAfterRender(node: VNode): void {
        ...
        sub.on(`engine${this.props.engine}N2`).whenChanged().handle((n2) => {
        ...
        return (
            <Layer x={this.props.x} y={this.props.y}>
                ...
                <g visibility={this.activeVisibility}>
                    ...
                    <text class="Large End Green" x={42} y={45}>{this.n2Int}</text>
                    <text class="Large End Green" x={54} y={45}>.</text>
                    <text class="Medium End Green" x={70} y={45}>{this.n2Fract}</text>
                </g>
            </Layer>
        );
    }
