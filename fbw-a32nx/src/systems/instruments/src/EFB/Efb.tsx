...
import { FailureGeneratorsInit } from 'instruments/src/EFB/Failures/FailureGenerators/FailureGeneratorsInit';
...
const Efb = () => {
    ...
    case PowerStates.STANDBY:
        return (
            <div className="w-screen h-screen" onClick={offToLoaded}>
