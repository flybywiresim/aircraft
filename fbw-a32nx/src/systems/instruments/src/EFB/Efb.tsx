...
export const getAirframeType = () => airframeType;
export const airframeType = new URL(document.querySelectorAll('vcockpit-panel > *')[0].getAttribute('url')).searchParams.get('Airframe');
