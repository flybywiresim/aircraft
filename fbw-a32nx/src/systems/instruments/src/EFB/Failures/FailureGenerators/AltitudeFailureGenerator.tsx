...
import {
    ButtonIcon,
    FailureGeneratorChoiceSetting, FailureGeneratorSingleSetting,
...
import { Airplane, ArrowDownRight, ArrowUpRight } from 'react-bootstrap-icons';

const settingName = 'EFB_FAILURE_GENERATOR_SETTING_ALTITUDE';
const additionalSetting = [3, 1, 0, 80, 250];
...
const generatorSettingComponents = (genNumber: number, generatorSettings : FailureGenData, failureGenContext : FailureGenContext) => {
    ...
    const numberOfSelectedFailures = findGeneratorFailures(failureGenContext.allFailures, failureGenContext.generatorFailuresGetters,
        generatorSettings.uniqueGenPrefix + genNumber.toString()).length;
    const settingTable = [FailureGeneratorSingleSettingShortcut('Failures to trigger:', 14, '', 'All',
    ...
    FailureGeneratorChoiceSetting('Direction:', settings[genNumber * numberOfSettingsPerGenerator + 2], climbDescentMode,
        setNewSetting, generatorSettings, genNumber, 2, failureGenContext),
    FailureGeneratorSingleSetting(`${t('Failures.Generators.AltitudeAboveSeaMin')}:`, 24,
