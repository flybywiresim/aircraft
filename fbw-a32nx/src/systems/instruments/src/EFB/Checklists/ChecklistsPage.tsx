...
const CompletionButton = () => {
    ...
    if (checklists[selectedChecklistIndex].markedCompleted) {
        if (selectedChecklistIndex < checklists.length - 1) {
            return (
                <div
                    className="text-theme-highlight hover:text-theme-body bg-theme-body hover:bg-theme-highlight border-theme-highlight flex w-full items-center justify-center rounded-md border-2 py-2 text-center font-bold transition duration-100"
                    onClick={() => {
                        dispatch(setSelectedChecklistIndex(selectedChecklistIndex + 1));
                    }}
                >
        ...
        return (
            <div className="text-theme-highlight bg-theme-body border-theme-highlight flex w-full items-center justify-center rounded-md border-2 py-2 text-center font-bold">
    ...
    if (firstIncompleteIdx !== -1) {
        return (
            <div
                className="text-utility-green hover:text-theme-body bg-theme-body hover:bg-utility-green border-utility-green flex w-full items-center justify-center rounded-md border-2 py-2 text-center font-bold transition duration-100"
                onClick={() => {
                    dispatch(setChecklistItemCompletion({
                        checklistIndex: selectedChecklistIndex,
                        itemIndex: firstIncompleteIdx,
    ...
    return (
        <div className="text-utility-green bg-theme-body border-utility-green flex w-full items-center justify-center rounded-md border-2 py-2 text-center font-bold">
