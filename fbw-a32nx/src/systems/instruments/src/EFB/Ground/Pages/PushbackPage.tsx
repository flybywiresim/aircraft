    ...
    return (
        <>
            <div className="relative flex h-full w-full flex-col space-y-4">
                ...
                <div className={`border-theme-accent flex h-full flex-col space-y-2 rounded-lg border-2 p-6 ${!pushbackUIAvailable && 'pointer-events-none opacity-20'}`}>
                            ...
                            <div className="w-full">
                                ...
                                <TooltipWrapper text={t('Pushback.TT.SystemEnabledOn')}>
                                    <button
                                        ...
                                        className="text-theme-text border-theme-accent flex h-20 w-full items-center justify-center rounded-md border-2 bg-green-600 opacity-60 transition duration-100 hover:opacity-100"
                                    >
                                        <ToggleOn size={50} />
                                    </button>
                                </TooltipWrapper>
                            ...
                            <div className="w-full">
                                ...
                                <TooltipWrapper text={t('Pushback.TT.SystemEnabledOff')}>
                                    <button
                                        type="button"
                                        onClick={handleEnableSystem}
                                        className={`text-theme-text border-theme-accent { flex h-20 w-full items-center justify-center rounded-md border-2 bg-red-600 opacity-60 transition duration-100 hover:opacity-100${!pushbackUIAvailable && 'pointer-events-none opacity-30'}`}
                                    >
                                        <ToggleOff size={50} />
                                    </button>
                                </TooltipWrapper>
                        ...
                        <div className={`w-full ${!pushbackSystemEnabled && 'pointer-events-none opacity-30'}`}>
                            ...
                            <TooltipWrapper text={t('Pushback.TT.CallReleaseTug')}>
                                <button
                                    ...
                                    className={`text-theme-text border-theme-accent duration-100'} flex h-20 w-full items-center justify-center rounded-md border-2 opacity-60 transition hover:opacity-100 ${tugInTransit ? 'bg-utility-amber' : 'bg-green-600'} ${!pushbackSystemEnabled && 'pointer-events-none opacity-30'}`}
                                >
                    ...
                    <div className={`flex flex-row space-x-4 ${!pushbackActive && 'pointer-events-none opacity-30'}`}>
                        ...
                        <div className="w-full">
                            ...
                            <TooltipWrapper text={t('Pushback.TT.DecreaseSpeed')}>
                                <button
                                    type="button"
                                    className="hover:text-theme-highlight bg-theme-highlight hover:bg-theme-body border-theme-highlight flex h-20 w-full items-center justify-center rounded-md border-2 transition duration-100"
