    ...
    return (
        <div className="relative h-content-section-reduced">
            ...
            {main1LeftDoorOpen >= 1.0 && (
                <div
                    className={doorOpenCss}
                    style={{ position: 'absolute', left: 515, right: 0, top: 100 }}
                >
                    OPEN
                </div>
            )}
            {main2LeftDoorOpen >= 1.0 && (
                <div
                    className={doorOpenCss}
                    style={{ position: 'absolute', left: 515, right: 0, top: 200 }}
                >
                    OPEN
                </div>
            )}
            {upper1LeftDoorOpen >= 1.0 && (
                <div
                    className={doorOpenCss}
                    style={{ position: 'absolute', left: 515, right: 0, top: 230 }}
                >
                    OPEN
                </div>
            )}
            {main4RightDoorOpen >= 1.0 && (
                <div
                    className={doorOpenCss}
                    style={{ position: 'absolute', left: 700, right: 0, top: 593 }}
                >
                    OPEN
                </div>
            )}
