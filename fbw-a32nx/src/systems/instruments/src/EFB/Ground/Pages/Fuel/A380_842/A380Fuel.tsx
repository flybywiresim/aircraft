...
const ValueSimbriefInput: React.FC<ValueSimbriefInputProps> = ({ min, max, value, onBlur, unit, simbriefDataLoaded, onClickSync }) => (
    <div className="relative w-52">
        <div className="flex flex-row">
            <div className="relative">
                <SimpleInput
                    className={`${simbriefDataLoaded && 'rounded-r-none'} my-2 w-full font-mono`}
                ...
                && (
                    <TooltipWrapper text={t('Ground.Fuel.TT.FillBlockFuelFromSimBrief')}>
                        <div
                            ...
                            onClick={simbriefDataLoaded ? onClickSync : undefined}
                        >
...
export const A380Fuel: React.FC<FuelProps> = ({
    ...
    // Fragtality: Commented out since not on the A320 Page and generally don't know what this should achieve
    // useEffect(() => {
    //     // GSX
