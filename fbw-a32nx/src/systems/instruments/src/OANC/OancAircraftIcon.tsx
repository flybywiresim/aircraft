...
import { DisplayComponent, FSComponent, MappedSubject, MappedSubscribable, Subscribable, Subscription, VNode } from '@microsoft/msfs-sdk';
...
export class OancAircraftIcon extends DisplayComponent<OancAircraftIconProps> {
    ...
    render(): VNode | null {
        return (
            <svg ref={this.svgRef} class="oanc-svg" viewBox="0 0 90 70.25" style="position: absolute; width: 90px; height: 79.25px;">
                <path
