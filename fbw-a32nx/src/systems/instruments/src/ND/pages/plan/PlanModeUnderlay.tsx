        ...
        return (
            <>
                ...
                <g stroke-width={3} clip-path="url(#plan-mode-map-clip)">
                    ...
                    <text x={310} y={474} class="Cyan" font-size={22}>{this.props.mapRange.map((range) => range / 2)}</text>
                    <text x={212} y={556} class="Cyan" font-size={22}>{this.props.mapRange.map((range) => range / 1)}</text>
