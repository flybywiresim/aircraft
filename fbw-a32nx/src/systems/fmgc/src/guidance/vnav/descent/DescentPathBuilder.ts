...
function evaluateAltitudeConstraint(constraint: AltitudeConstraint, altitude: Feet, tol: number): [boolean, Feet] {
  ...
  switch (constraint.type) {
    ...
    case AltitudeConstraintType.range:
      return [
        isRangeAltitudeConstraintMet(constraint, altitude, tol),
...
const isAtAltitudeConstraintMet = (constraint: AltitudeConstraint, altitude: Feet, tol: Feet = 250) =>
  Math.abs(altitude - constraint.altitude1) < tol;
const isAtOrAboveAltitudeConstraintMet = (constraint: AltitudeConstraint, altitude: Feet, tol: Feet = 250) =>
  altitude - constraint.altitude1 > -tol;
const isAtOrBelowAltitudeConstraintMet = (constraint: AltitudeConstraint, altitude: Feet, tol: Feet = 250) =>
  altitude - constraint.altitude1 < tol;
const isRangeAltitudeConstraintMet = (constraint: AltitudeConstraint, altitude: Feet, tol: Feet = 250) =>
  altitude - constraint.altitude2 > -tol && altitude - constraint.altitude1 < tol;
