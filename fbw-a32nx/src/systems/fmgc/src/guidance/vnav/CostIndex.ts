...
export class CostIndex {
     ...
     */
    static calculateSpecificRange(config: AircraftConfig, mach: number, altitude: number, weight: number, isaDev: number): number {
     ...
     * @returns econ mach
     */
    static costIndexToMach(config: AircraftConfig, ci: number, flightLevel: number, weight: number, isaDev = 0, headwind = 0): number {
