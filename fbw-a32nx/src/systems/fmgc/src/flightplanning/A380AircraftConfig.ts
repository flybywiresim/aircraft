...
const engineModelParams: EngineModelParameters = {
  ...
  table1506: [
    ...
    [75.0, 0.982, 0.821, 0.695, 0.48, 0.42, 0.354, 0.301, 0.282, 0.29, 0.28],
    [80.0, 1.092, 0.941, 0.811, 0.605, 0.467, 0.43, 0.36, 0.33, 0.3, 0.51],
    [85.0, 1.23, 1.07, 0.932, 0.72, 0.57, 0.48, 0.45, 0.397, 0.34, 0.518],
    [90.0, 1.388, 1.206, 1.049, 0.75, 0.64, 0.56, 0.5, 0.482, 0.42, 0.53],
