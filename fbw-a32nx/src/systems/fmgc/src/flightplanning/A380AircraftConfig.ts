...
const flightModelParams: FlightModelParameters = {
  ...
  dragPolarCoefficients: {
    [FlapConf.CLEAN]: [0.0291, 0.0171, -0.0167, 0.0236],
    [FlapConf.CONF_1]: [0.0105, 0.0285, -0.02, 0.0305],
    [FlapConf.CONF_2]: [0.0169, -0.0073, -0.0017, 0.1222],
    [FlapConf.CONF_3]: [0.0026, 0.0127, -0.0308, 0.1529],
    [FlapConf.CONF_FULL]: [0.0048, 0.0013, -0.0193, 0.1628],
  },
};
...
const engineModelParams: EngineModelParameters = {
  ...
  table1506: [
    ...
    [20, 0.1286, -0.008, 0.015, 0.0008, -0.023, -0.061, -0.081, -0.135, -0.21, -0.3],
    ...
    [40.0, 0.396, 0.195, 0.149, 0.07, 0.065, 0.051, 0.042, 0.021, 0.015, -0.008],
    [45.0, 0.472, 0.3, 0.188, 0.114, 0.08, 0.076, 0.07, 0.032, 0.026, -0.005],
    [50.0, 0.543, 0.373, 0.254, 0.147, 0.109, 0.094, 0.085, 0.033, -0.01, -0.036],
    [55.0, 0.611, 0.448, 0.324, 0.18, 0.145, 0.127, 0.111, 0.085, 0.055, -0.005],
    [60.0, 0.714, 0.528, 0.41, 0.31, 0.198, 0.129, 0.109, 0.102, 0.088, 0.065],
    [65.0, 0.792, 0.615, 0.5, 0.357, 0.225, 0.16, 0.141, 0.121, 0.102, 0.087],
    [70.0, 0.88, 0.712, 0.586, 0.41, 0.3, 0.267, 0.26, 0.257, 0.252, 0.187],
    [75.0, 0.982, 0.821, 0.695, 0.48, 0.42, 0.354, 0.301, 0.282, 0.225, 0.195],
    [80.0, 1.092, 0.941, 0.811, 0.605, 0.467, 0.43, 0.36, 0.33, 0.3, 0.2],
    [85.0, 1.23, 1.07, 0.932, 0.72, 0.57, 0.48, 0.45, 0.397, 0.37, 0.215],
    [90.0, 1.388, 1.206, 1.049, 0.75, 0.64, 0.56, 0.5, 0.482, 0.46, 0.312],
    [95.0, 1.538, 1.34, 1.153, 0.875, 0.75, 0.6, 0.57, 0.56, 0.55, 0.54],
