class FlightPlan {
    constructor(_instrument) {
        console.log("FlightPlan created");
        this.wayPoints = [];
    ...
    updateActiveWaypoint() {
        console.log("FlightPlan update active waypoint");
    ...
    LoadData() {
        switch (this.loadState) {
            case 0:
                ...
                // waypointsBatch returns a multidimensional array of waypoints
    ...
    FillWithCurrentFP(_Callback = null) {
        console.log("Updating flight plan manager from flightplan");
...
class FlightPlanAlternate {
    ...
    async update() {
        ...
        this.updating = true;
        console.log("Updating alternate in flightPlan");
