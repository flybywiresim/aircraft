...
(function (A320_Neo_LowerECAM_CRZ) {
    ...
    class Page extends Airliners.EICASTemplateElement {
        ...
        init() {
            ...
            //this.querySelector("#LandingElevationMode").textValue 
        ...
        update(_deltaTime) {
            ...
            // Oil
            var value = SimVar.GetSimVarValue("ENG OIL QUANTITY:1", "percent") * 0.01 * 25;
            ...
            var cabinAltMetres = value * 0.3048;
            var cabinPressurePascal = 101325 * Math.exp(-0.00011857591*cabinAltMetres);
            var cabinPressurePSI = cabinPressurePascal * 0.000145038;
            var outsidePressureINHG = SimVar.GetSimVarValue("AMBIENT PRESSURE", "inHg");
            var outsidePressurePSI = outsidePressureINHG * 0.491154;
            var pressureDiff = cabinPressurePSI - outsidePressurePSI;
