        ...
        setFuelOnBoard(_value, _force = false) {
            if ((this.currentFOBValue != _value) || _force) {
                ...
                if (this.fobValue != null) {
                    let currentFOBShownValue = this.currentFOBValue - this.currentFOBValue % 10; //Issue 283 - Fuel should be in increments of 10
                    this.fobValue.textContent = fastToFixed(currentFOBShownValue, 0);
                }
            }
        }
    }
