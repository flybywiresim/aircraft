    ...
    class Display extends Airliners.EICASTemplateElement {
                        ...
                        messages: [
                            {
                                ...
                                actions: [
                                    ...
                                    },
                                    {
                                        ...
                                        action: "START",
                                        isCompleted: () => {
                                            return this.getCachedSimVar("L:A32NX_APU_N", "Percent") > 95;
                                        }
                                    },
                                    {
                                        style: "action",
        ...
        update(_deltaTime) {
            ...
            if (this.isGrounded || this.flightPhaseBeforeClb || (this.isTogaFlexMct1 && this.isTogaFlexMct2)) {
                ...
                const engBleedAndPackActive = xBleedPos === 2 || (xBleedPos === 1 && this.getCachedSimVar("L:A32NX_APU_N", "Percent") >= 95 && this.getCachedSimVar("BLEED AIR APU", "Bool")) ?
