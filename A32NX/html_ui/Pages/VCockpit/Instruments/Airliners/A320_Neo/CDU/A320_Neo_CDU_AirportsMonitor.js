        ...
        if (!this.user_ap) {
            ...
            if (this.page2) {
                ...
                this.user_ap_line = [
                    ...
                    `${this.brng5.toString().padStart(3, "0")}d_${this.dist5.toString().padStart(5, "_")}[color]green`
                ];
            }
        }
            ...
            if (this.page2) {
                ...
                mcdu.setTemplate([
                    ...
                    [`${this.icao1}[color]green`,
                        ...
                        `${this.brng1.toString().padStart(3, "0")}d_${this.dist1.toString().padStart(5, "_")}[color]green`],
                    [""],
                    [`${this.icao2}[color]green`,
                        `${this.eta2}[color]green`,
                        `${this.brng2.toString().padStart(3, "0")}d_${this.dist2.toString().padStart(5, "_")}[color]green`],
                    [""],
                    [`${this.icao3}[color]green`,
                        `${this.eta3}[color]green`,
                        `${this.brng3.toString().padStart(3, "0")}d_${this.dist3.toString().padStart(5, "_")}[color]green`],
                    [""],
                    [`${this.icao4}[color]green`,
                        `${this.eta4}[color]green`,
                        `${this.brng4.toString().padStart(3, "0")}d_${this.dist4.toString().padStart(5, "_")}[color]green`],
                    [""],
                    this.user_ap_line,
                    ["", "", this.frozen ? "LIST FROZEN" : ""],
                    [this.frozen ? "lUNFREEZE[color]blue" : "lFREEZE[color]blue", "EFOB/WIND>"]
                ]);
