class CDUAtcPositionReport {
    static ShowPage(mcdu) {
        ...
        mcdu.setTemplate([
            ["POSITION REPORT"],
            ["\xa0OVHD", "UTC/ALT\xa0"],
            ["[" + ovhdWaypointCell + "][color]blue", "[" + ovhdWaypointUTCCell + "/" + altCell + "][color]blue"],
            ["\xa0PPOS", "UTC/ALT\xa0"],
            ["{small}" + currPos + "{end}[color]green", "{small}" + currUTCCell + "Z" + "/" + altCell + "{end}[color]green"],
            ["\xa0TO", "UTC/ALT\xa0"],
            ["[" + toWaypointCell + "][color]blue", "[" + nextWaypointUTCCell + "/" + altCell + "][color]blue"],
            ["\xa0NEXT"],
            ["[" + nextWaypointCell + "][color]blue"],
            [""],
            [""],
