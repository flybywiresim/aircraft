class A320_Neo_CDU_MainDisplay extends FMCMainDisplay {
    ...
    checkUpdateFlightPhase() {
        ...
        //End preflight when takeoff power is applied
        if (this.currentFlightPhase <= 2) {
            if (highestThrottleDetent == ThrottleMode.TOGA || highestThrottleDetent == ThrottleMode.FLEX_MCT) SimVar.SetSimVarValue("L:A32NX_Preflight_Complete", "Bool", 1);
        }
