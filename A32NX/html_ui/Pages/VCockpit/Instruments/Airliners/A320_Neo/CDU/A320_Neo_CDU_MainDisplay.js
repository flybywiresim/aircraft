class A320_Neo_CDU_MainDisplay extends FMCMainDisplay {
    ...
    trySetFlapsTHS(s) {
        if (s) {
            ...
            // Commit changes.
            if (validEntry) {
                SimVar.SetSimVarValue("L:A32NX_VSPEEDS_TO_CONF", "number", nextFlaps);
    ...
    _getV1Speed() {
        ...
        return SimVar.GetSimVarValue("L:A32NX_VSPEEDS_V2", "number") - 5;
    }
    _computeV1Speed() {
    ...
    _getVRSpeed() {
        ...
        return this._getVSpeed(dWeightCoef, min, max);*/
        return SimVar.GetSimVarValue("L:A32NX_VSPEEDS_V2", "number") - 4;
    }
    _computeVRSpeed() {
    ...
    _getV2Speed() {
        ...
        return this._getVSpeed(dWeightCoef, min, max);*/
        return SimVar.GetSimVarValue("L:A32NX_VSPEEDS_V2", "number");
    }
    _computeV2Speed() {
