class Jet_PFD_ILSIndicator extends HTMLElement {
    ...
    construct_A320_Neo() {
        ...
        this.rootSVG.appendChild(this.centerGroup);
        {
            ...
            this.gs_mainGroup.setAttribute("id", "GlideSlopeGroup");
            {
                ...
                this.gs_mainGroup.appendChild(this.gs_cursorGroup);
                {
                    ...
                    this.gs_cursorShapeUp.setAttribute("stroke", "magenta");
                    ...
                    this.gs_cursorShapeDown.setAttribute("stroke", "magenta");
                    ...
                    this.gs_glidePathCursorUp.setAttribute("stroke", "magenta");
                    ...
                    this.gs_glidePathCursorDown.setAttribute("stroke", "magenta");
            ...
            this.loc_mainGroup.setAttribute("id", "LocalizerGroup");
            {
                ...
                this.loc_mainGroup.appendChild(this.loc_cursorGroup);
                {
                    ...
                    this.loc_cursorShapeRight.setAttribute("stroke", "magenta");
                    ...
                    this.loc_cursorShapeLeft.setAttribute("stroke", "magenta");
        ...
        this.rootSVG.appendChild(this.InfoGroup);
        {
            ...
            this.ILSIdent.setAttribute("fill", "magenta");
            ...
            this.ILSFreq.setAttribute("fill", "magenta");
            ...
            this.ILSDist.setAttribute("fill", "magenta");
