class Jet_PFD_ILSIndicator extends HTMLElement {
    ...
    construct_A320_Neo() {
        ...
        this.rootSVG.appendChild(this.centerGroup);
        {
            ...
            this.neutralLine.setAttribute("stroke", "#FFFF00");
            ...
            this.gs_mainGroup.setAttribute("id", "GlideSlopeGroup");
            {
                ...
                this.gs_mainGroup.appendChild(this.gs_cursorGroup);
                {
                    ...
                    this.gs_cursorShapeUp.setAttribute("stroke", "#FF6EFF");
                    ...
                    this.gs_cursorShapeDown.setAttribute("stroke", "#FF6EFF");
                    ...
                    this.gs_glidePathCursorUp.setAttribute("stroke", "#FF6EFF");
                    ...
                    this.gs_glidePathCursorDown.setAttribute("stroke", "#FF6EFF");
            ...
            this.loc_mainGroup.setAttribute("id", "LocalizerGroup");
            {
                ...
                neutralLine.setAttribute("stroke", "#FFFF00");
                ...
                this.loc_mainGroup.appendChild(this.loc_cursorGroup);
                {
                    ...
                    this.loc_cursorShapeRight.setAttribute("stroke", "#FF6EFF");
                    ...
                    this.loc_cursorShapeLeft.setAttribute("stroke", "#FF6EFF");
        ...
        this.rootSVG.appendChild(this.InfoGroup);
        {
            ...
            this.ILSIdent.setAttribute("fill", "#FF6EFF");
            ...
            this.ILSFreq.setAttribute("fill", "#FF6EFF");
            ...
            this.ILSDist.setAttribute("fill", "#FF6EFF");
