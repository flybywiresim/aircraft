...
class A320_Neo_PFD_MainPage extends NavSystemPage {
    ...
    onUpdate() {
        ...
        const YokeXPosition = 40.45 + (15 * SimVar.GetSimVarValue("YOKE X POSITION", "Position"));
        const YokeYPosition = 47.95 - (11.15 * SimVar.GetSimVarValue("YOKE Y POSITION", "Position"));
