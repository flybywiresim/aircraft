class Jet_PFD_AirspeedIndicator extends HTMLElement {
    ...
    construct_A320_Neo() {
        ...
        }
        {
            ...
            this.redSpeedTextLower.setAttribute("fill", "magenta");
        ...
        this.centerSVG.setAttribute("viewBox", "0 0 " + (width + arcWidth) + " " + height);
        {
            ...
            this.greenDotSVG.setAttribute("viewBox", "0 0 " + greenDotWidth + " " + greenDotHeight);
            {
                ...
                this.greenDotSVGShape.setAttribute("stroke", "lime");
        ...
        this.rootGroup.appendChild(this.centerSVG);
        {
            ...
            this.machPrefixSVG.setAttribute("fill", "lime");
            ...
            this.machValueSVG.setAttribute("fill", "lime");
    ...
    createSpeedMarker(_text, _x, _y, _handler, _scale = 1.0, _textScale = 1.5, _color = "lime", _bg = false, _params = []) {
