...
(function (Airbus_FMA) {
	...
	function TEXT_STYLE_CLASS(_style) {
		switch (_style) {
			case MODE_STATE.ENGAGED: return "Engaged";
			case MODE_STATE.CAPTURED: return "Captured";
			case MODE_STATE.ARMED: return "Armed";
			case MODE_STATE.CONSTRAINED: return "Constrained";
			case MODE_STATE.ACTIVE: return "Active";
			case MODE_STATE.STATUS: return "Status";
			case MODE_STATE.WARNING: return "Warning";
			case MODE_STATE.DANGER: return "Danger";
			case MODE_STATE.ACTIVE_BLINK: return "ActiveBlink";
		}
		return "";
	}
	...
	class CurrentPlaneState {
		...
		static refresh() {
			...
			let approachType = ApproachType.APPROACH_TYPE_ILS;
	...
	class Cell {
		constructor(_parent, _className) {
			...
			this.divRef.className = Airbus_FMA.TEXT_STYLE_CLASS(MODE_STATE.NONE);
			if (_parent != null) {
				_parent.appendChild(this.divRef);
			}
		}
		init() {
			this.textStyle = MODE_STATE.NONE;
		}
		setVisibility(_show) {
			if (this.divRef != null) {
	...
	class Row extends Airbus_FMA.Cell {
		constructor(_parent, _className, _createSubCells) {
			...
			if (_createSubCells && (this.parent != null)) {
				...
				this.subLeft.setText("", MODE_STATE.NONE);
				this.subRight = new Airbus_FMA.Cell(this.parent, _className + "SubRight");
				this.subRight.setText("", MODE_STATE.NONE);
			}
		}
		init() {
			super.init();
			this.highlightStyle = HIGHLIGHT_STYLE.FULL;
			this.hideHighlight();
		...
		setMainText(_text, _style) {
			let changed = this.setText(_text, _style);
			if (_text.length <= 0) {
				this.hideHighlight();
			}
			else if (changed) {
		...
		showHighlight() {
			if (this.divRef != null) {
				if (this.highlightStyle != HIGHLIGHT_STYLE.NONE) {
					let colour = "white";
					let showTop = true;
					let showBottom = true;
					switch (this.highlightStyle) {
						case HIGHLIGHT_STYLE.FULL_WARNING:
							colour = "orange";
							break;
						case HIGHLIGHT_STYLE.OPEN_BOTTOM:
							showBottom = false;
							break;
						case HIGHLIGHT_STYLE.OPEN_BOTTOM_WARNING:
							showBottom = false;
							colour = "orange";
							break;
						case HIGHLIGHT_STYLE.OPEN_TOP:
							showTop = false;
							break;
						case HIGHLIGHT_STYLE.OPEN_TOP_WARNING:
							colour = "orange";
							showTop = false;
							break;
					}
	...
	class Column1 extends Airbus_FMA.ColumnBase {
		...
		updateChild(_deltaTime) {
			let targetRow1And2State = this.getTargetRow1And2State();
			if ((targetRow1And2State != this.currentRow1And2State) || (this.currentRow1And2State == Column1.ROW_1_2_STATE.MANFLX)) {
				...
				this.setRowText(0, "", MODE_STATE.NONE);
				this.setRowText(1, "", MODE_STATE.NONE);
				switch (this.currentRow1And2State) {
					case Column1.ROW_1_2_STATE.MANTOGA:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.OPEN_BOTTOM);
						this.setRowHighlightStyle(1, HIGHLIGHT_STYLE.OPEN_TOP);
						this.setRowText(0, "MAN", MODE_STATE.STATUS);
						this.setRowText(1, "TOGA", MODE_STATE.STATUS);
						break;
					case Column1.ROW_1_2_STATE.TOGA:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL);
						this.setRowText(0, "TOGA", MODE_STATE.STATUS);
						break;
					case Column1.ROW_1_2_STATE.MANFLX:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.OPEN_BOTTOM);
						this.setRowHighlightStyle(1, HIGHLIGHT_STYLE.OPEN_TOP);
						this.setRowText(0, "MAN", MODE_STATE.STATUS);
						this.setRowMultiText(1, "FLX", MODE_STATE.STATUS, Airbus_FMA.CurrentPlaneState.flexTemperature.toFixed(0), MODE_STATE.ARMED);
						break;
					case Column1.ROW_1_2_STATE.MANMCT:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.OPEN_BOTTOM);
						this.setRowHighlightStyle(1, HIGHLIGHT_STYLE.OPEN_TOP);
						this.setRowText(0, "MAN", MODE_STATE.STATUS);
						this.setRowText(1, "MCT", MODE_STATE.STATUS);
						break;
					case Column1.ROW_1_2_STATE.MANTHR:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.OPEN_BOTTOM_WARNING);
						this.setRowHighlightStyle(1, HIGHLIGHT_STYLE.OPEN_TOP_WARNING);
						this.setRowText(0, "MAN", MODE_STATE.STATUS);
						this.setRowText(1, "THR", MODE_STATE.STATUS);
						break;
					case Column1.ROW_1_2_STATE.THRMCT:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL);
						this.setRowText(0, "THR MCT", MODE_STATE.ENGAGED);
						break;
					case Column1.ROW_1_2_STATE.THRCLB:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL);
						this.setRowText(0, "THR CLB", MODE_STATE.ENGAGED);
						break;
					case Column1.ROW_1_2_STATE.THRLVR:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL);
						this.setRowText(0, "THR LVR", MODE_STATE.ENGAGED);
						break;
					case Column1.ROW_1_2_STATE.THRIDLE:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL);
						this.setRowText(0, "THR IDLE", MODE_STATE.ENGAGED);
						break;
					case Column1.ROW_1_2_STATE.AFLOOR:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL_WARNING);
						this.setRowText(0, "A.FLOOR", MODE_STATE.ENGAGED);
						break;
					case Column1.ROW_1_2_STATE.TOGALK:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL_WARNING);
						this.setRowText(0, "TOGA LK", MODE_STATE.ENGAGED);
						break;
					case Column1.ROW_1_2_STATE.SPEED:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL);
						this.setRowText(0, "SPEED", MODE_STATE.ENGAGED);
						break;
					case Column1.ROW_1_2_STATE.MACH:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL);
						this.setRowText(0, "MACH", MODE_STATE.ENGAGED);
						break;
					case Column1.ROW_1_2_STATE.THRLK:
						this.setRowHighlightStyle(0, HIGHLIGHT_STYLE.FULL);
						this.setRowText(0, "THR LK", MODE_STATE.WARNING);
				}
			}
			let targetRow3State = this.getTargetRow3State();
			if (targetRow3State != this.currentRow3State) {
				...
				switch (this.currentRow3State) {
					case Column1.ROW_3_STATE.LVRCLB:
						this.setRowText(2, "LVR CLB", MODE_STATE.ACTIVE_BLINK);
						break;
					case Column1.ROW_3_STATE.LVRMCT:
						this.setRowText(2, "LVR MCT", MODE_STATE.STATUS);
						break;
					case Column1.ROW_3_STATE.LVRASYM:
						this.setRowText(2, "LVR ASYM", MODE_STATE.WARNING);
						break;
					default:
						this.setRowText(2, "", MODE_STATE.NONE);
				}
			}
		}
		...
		IsActive_THRCLB() {
			if (Airbus_FMA.CurrentPlaneState.autoPilotThrottleActive &&
				...
				Simplane.getVerticalSpeed() > 100 && !AltCaptured) {
				return true;
			}
			return false;
		}
		...
		IsActive_THRIDLE() {
			if (Airbus_FMA.CurrentPlaneState.autoPilotThrottleActive && (Airbus_FMA.CurrentPlaneState.highestThrottleDetent == ThrottleMode.IDLE)) {
				return true;
			}
			return false;
		}
		...
		IsActive_LVRASYM() {
			let leftCLOrMCTFLX = ((Airbus_FMA.CurrentPlaneState.leftThrottleDetent == ThrottleMode.CLIMB) || (Airbus_FMA.CurrentPlaneState.leftThrottleDetent == ThrottleMode.FLEX_MCT));
			let rightCLOrMCTFLX = ((Airbus_FMA.CurrentPlaneState.rightThrottleDetent == ThrottleMode.CLIMB) || (Airbus_FMA.CurrentPlaneState.rightThrottleDetent == ThrottleMode.FLEX_MCT));
		...
		IsActive_LVRMCT() {
			let takeoff = (Airbus_FMA.CurrentPlaneState.flightPhase == FlightPhase.FLIGHT_PHASE_TAKEOFF);
			let goaround = (Airbus_FMA.CurrentPlaneState.flightPhase == FlightPhase.FLIGHT_PHASE_GOAROUND);
			if (takeoff || goaround) {
				let greenDotSpeed = goaround ? Simplane.getFMCApprGreenDotSpeed() : Simplane.getFMCGreenDotSpeed();
	...
	class Column2 extends Airbus_FMA.ColumnBase {
			...
			if ((targetRow1State != this.currentRow1State) || (targetRow1State == Column2.ROW_1_STATE.VS) || (targetRow1State == Column2.ROW_1_STATE.FPA)) {
				...
				switch (this.currentRow1State) {
					case Column2.ROW_1_STATE.SRS_ARMED:
						this.setRowText(0, "SRS", MODE_STATE.ARMED);
						break;
					case Column2.ROW_1_STATE.SRS_ENGAGED:
						this.setRowText(0, "SRS", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.ALT_ENGAGED:
						this.setRowText(0, "ALT", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.ALT_CAPTURED:
						this.setRowText(0, "ALT*", MODE_STATE.CAPTURED);
						AltCaptured = true;
						break;
					case Column2.ROW_1_STATE.ALT_CST_ENGAGED:
						this.setRowText(0, "ALT CST", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.ALT_CST_CAPTURED:
						this.setRowText(0, "ALT CST*", MODE_STATE.CAPTURED);
						break;
					case Column2.ROW_1_STATE.VS:
						let speed = Airbus_FMA.CurrentPlaneState.autoPilotVerticalSpeedHoldValue;
						let str;
						if (speed >= 0) {
							str = "+" + speed.toFixed(0);
						} else {
						...
						this.setRowMultiText(0, "V/S", MODE_STATE.ENGAGED, str, MODE_STATE.ARMED);
						break;
					case Column2.ROW_1_STATE.FPA:
						let sign = (value < 0) ? "-" : "+";
						value = Math.min(Math.abs(value), 9.9);
						let str = sign + value.toFixed(2) + String.fromCharCode(176);
						this.setRowMultiText(0, "FPA", MODE_STATE.ENGAGED, str, MODE_STATE.ARMED);
						let value = -Airbus_FMA.CurrentPlaneState.autoPilotFlightPathAngle;
						break;
					case Column2.ROW_1_STATE.EXP_CLB:
						this.setRowText(0, "EXP CLB", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.EXP_DES:
						this.setRowText(0, "EXP DES", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.GS_ENGAGED:
						this.setRowText(0, "G/S", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.GS_CAPTURED:
						this.setRowText(0, "G/S*", MODE_STATE.CAPTURED);
						break;
					case Column2.ROW_1_STATE.OP_CLB:
						this.setRowText(0, "OP CLB", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.OP_DES:
						this.setRowText(0, "OP DES", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.CLB_ENGAGED:
						this.setRowText(0, "CLB", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.DES:
						this.setRowText(0, "DES", MODE_STATE.ENGAGED);
						break;
					case Column2.ROW_1_STATE.ALT_CRZ:
						this.setRowText(0, "ALT CRZ", MODE_STATE.ENGAGED);
						break;
					default:
						this.setRowText(0, "", MODE_STATE.NONE);
						break;
			...
			if (targetRow2State != this.currentRow2State) {
				...
				switch (this.currentRow2State) {
					case Column2.ROW_2_STATE.ALT_ARMED:
						this.setRowText(1, "ALT", MODE_STATE.ARMED);
						break;
					case Column2.ROW_2_STATE.ALT_CST_CONSTRAINED:
						this.setRowText(1, "ALT CST", MODE_STATE.CONSTRAINED);
						break;
					case Column2.ROW_2_STATE.GS_ARMED:
						this.setRowText(1, "G/S", MODE_STATE.ARMED);
						break;
					case Column2.ROW_2_STATE.GS_FINAL_ARMED:
						this.setRowText(1, "FINAL", MODE_STATE.ARMED);
						break;
					case Column2.ROW_2_STATE.CLB_ARMED:
						this.setRowMultiText(1, "CLB", MODE_STATE.ARMED, "", MODE_STATE.ACTIVE);
						break;
					default:
						this.setRowText(1, "", MODE_STATE.NONE);
						break;
		...
		getTargetRow1State() {
			let srsModeState = this.GetModeState_SRS();
			if (srsModeState == MODE_STATE.ARMED) {
				return Column2.ROW_1_STATE.SRS_ARMED;
			} else if (srsModeState == MODE_STATE.ENGAGED) {
				return Column2.ROW_1_STATE.SRS_ENGAGED;
			}

			let altModeState = Column2.GetModeState_ALT();
			if (altModeState == MODE_STATE.ENGAGED) {
			...
			} else if (altModeState == MODE_STATE.CAPTURED) {
				return Column2.ROW_1_STATE.ALT_CAPTURED;
			}

			let altCSTModeState = this.GetModeState_ALTCST();
			if (altCSTModeState == MODE_STATE.ENGAGED) {
				return Column2.ROW_1_STATE.ALT_CST_ENGAGED;
			} else if (altCSTModeState == MODE_STATE.CAPTURED) {
			...
			let gsModeState = Column2.GetModeState_GS();
			if (gsModeState == MODE_STATE.ENGAGED) {
				return Column2.ROW_1_STATE.GS_ENGAGED;
			} else if (gsModeState == MODE_STATE.CAPTURED) {
			...
			} else if (this.GetModeState_CLB() == MODE_STATE.ENGAGED) {
		...
		getTargetRow2State() {
			if (Column2.GetModeState_ALT() == MODE_STATE.ARMED) {
				return Column2.ROW_2_STATE.ALT_ARMED;
			} else if (this.GetModeState_ALTCST() == MODE_STATE.CONSTRAINED) {
				return Column2.ROW_2_STATE.ALT_CST_CONSTRAINED;
			} else if (Column2.GetModeState_GS() == MODE_STATE.ARMED) {
				return Column2.ROW_2_STATE.GS_ARMED;
			} else if (this.IsActive_FinalArmed()) {
				return Column2.ROW_2_STATE.GS_FINAL_ARMED;
			} else if (this.GetModeState_CLB() == MODE_STATE.ARMED) {
		...
		static GetModeState_ALT() {
			if (Airbus_FMA.CurrentPlaneState.anyAutoPilotsActive && Airbus_FMA.CurrentPlaneState.autoPilotAltitudeLockActive) {
				if (Airbus_FMA.CurrentPlaneState.autoPilotAltitudeArmed) {
					...
					let diffAlt = Math.abs(Airbus_FMA.CurrentPlaneState.autoPilotAltitudeLockValue - Airbus_FMA.CurrentPlaneState.altitude);
					if (diffAlt <= Airbus_FMA.Definitions.ALT_ENGAGED_RANGE) {
						this._lastALTMode = MODE_STATE.ENGAGED;
					} else {
						if (this._lastALTMode == MODE_STATE.ENGAGED) {
							if ((diffAlt - Airbus_FMA.Definitions.ALT_ENGAGED_RANGE) > 50) {
								this._lastALTMode = MODE_STATE.CAPTURED;
							}
						}
						else {
							this._lastALTMode = MODE_STATE.CAPTURED;
		...
		GetModeState_CLB() {
			if ((Airbus_FMA.CurrentPlaneState.autoPilotAltitudeLockActive && Airbus_FMA.CurrentPlaneState.anyFlightDirectorsActive || Simplane.getAutoPilotFLCActive()) && (Airbus_FMA.CurrentPlaneState.altitude < Airbus_FMA.CurrentPlaneState.autoPilotAltitudeLockValue) && Airbus_FMA.CurrentPlaneState.anyFlightDirectorsActive) {
	...
	class Column3 extends Airbus_FMA.ColumnBase {
			...
			if (targetRow1State != this.currentRow1State) {
				...
				switch (this.currentRow1State) {
					case Column3.ROW_1_STATE.RWY:
						this.setRowText(0, "RWY", MODE_STATE.ENGAGED);
						break;
					case Column3.ROW_1_STATE.HDG:
						this.setRowText(0, "HDG", MODE_STATE.ENGAGED);
						break;
					case Column3.ROW_1_STATE.TRACK:
						this.setRowText(0, "TRACK", MODE_STATE.ENGAGED);
						break;
					case Column3.ROW_1_STATE.LOC_ENGAGED:
						this.setRowText(0, "LOC", MODE_STATE.ENGAGED);
						break;
					case Column3.ROW_1_STATE.LOC_CAPTURED:
						this.setRowText(0, "LOC*", MODE_STATE.CAPTURED);
						break;
					case Column3.ROW_1_STATE.NAV_ENGAGED:
						this.setRowText(0, "NAV", MODE_STATE.ENGAGED);
						break;
					case Column3.ROW_1_STATE.NAV_CAPTURED:
						break;
						this.setRowText(0, "NAV", MODE_STATE.ENGAGED);
					case Column3.ROW_1_STATE.RWY_TRK:
						this.setRowText(0, "RWY TRK", MODE_STATE.ENGAGED);
						break;
					case Column3.ROW_1_STATE.GA_TRK:
						this.setRowText(0, "GA TRK", MODE_STATE.ENGAGED);
						break;
					case Column3.ROW_1_STATE.APPNAV_ENGAGED:
						this.setRowText(0, "APP NAV", MODE_STATE.ENGAGED);
						break;
					default:
						this.setRowText(0, "", MODE_STATE.NONE);
						break;
			...
			if (targetRow2State != this.currentRow2State) {
				...
				switch (this.currentRow2State) {
					case Column3.ROW_2_STATE.LOC_ARMED:
						this.setRowText(1, "LOC", MODE_STATE.ARMED);
						break;
					case Column3.ROW_2_STATE.NAV_ARMED:
						this.setRowText(1, "NAV", MODE_STATE.ARMED);
						break;
					case Column3.ROW_2_STATE.APPNAV_ARMED:
						this.setRowText(1, "APP NAV", MODE_STATE.ARMED);
						break;
					default:
						this.setRowText(1, "", MODE_STATE.NONE);
						break;
		...
		getTargetRow1State() {
			...
			let locModeState = this.GetModeState_LOC();
			if (locModeState == MODE_STATE.ENGAGED) {
				return Column3.ROW_1_STATE.LOC_ENGAGED;
			} else if (locModeState == MODE_STATE.CAPTURED) {
				return Column3.ROW_1_STATE.LOC_CAPTURED;
			}

			if (this.GetModeState_APPNAV() == MODE_STATE.ENGAGED) {
				return Column3.ROW_1_STATE.APPNAV_ENGAGED;
			}

			let navModeState = this.GetModeState_NAV();
			if (navModeState == MODE_STATE.ENGAGED) {
				return Column3.ROW_1_STATE.NAV_ENGAGED;
			} else if (navModeState == MODE_STATE.CAPTURED) {
		...
		getTargetRow2State() {
			if (this.GetModeState_LOC() == MODE_STATE.ARMED) {
				return Column3.ROW_2_STATE.LOC_ARMED;
			} else if (this.GetModeState_APPNAV() == MODE_STATE.ARMED) {
				return Column3.ROW_2_STATE.APPNAV_ARMED;
			} else if (this.GetModeState_NAV() == MODE_STATE.ARMED) {
			...
			if (targetState != this.currentRow1State) {
				...
				switch (targetState) {
					case Column4.ROW_1_STATE.CAT_1:
						this.setRowText(0, "CAT 1", MODE_STATE.STATUS);
						break;
					case Column4.ROW_1_STATE.CAT_2:
						this.setRowText(0, "CAT 2", MODE_STATE.STATUS);
						break;
					case Column4.ROW_1_STATE.CAT_3:
						this.setRowText(0, "CAT 3", MODE_STATE.STATUS);
						break;
					default:
						this.setRowText(0, "", MODE_STATE.NONE);
						break;
			...
			if (targetState != this.currentRow2State) {
				...
				switch (targetState) {
					case Column4.ROW_2_STATE.SINGLE:
						this.setRowText(1, "SINGLE", MODE_STATE.STATUS);
						break;
					case Column4.ROW_2_STATE.DUAL:
						this.setRowText(1, "DUAL", MODE_STATE.STATUS);
						break;
					default:
						this.setRowText(1, "", MODE_STATE.NONE);
				}
			...
			if ((targetState != this.currentRow3State) || (targetState == Column4.ROW_3_STATE.DH) || (targetState == Column4.ROW_3_STATE.MDA)) {
				...
				switch (targetState) {
					case Column4.ROW_3_STATE.DH:
						let value = Airbus_FMA.CurrentPlaneState.decisionHeight;
						this.setRowMultiText(2, "DH", MODE_STATE.STATUS, value.toFixed(0), MODE_STATE.ARMED);
						break;
					case Column4.ROW_3_STATE.NO_DH:
						this.setRowText(2, "NO DH", MODE_STATE.STATUS);
						break;
					case Column4.ROW_3_STATE.MDA:
						let value = Airbus_FMA.CurrentPlaneState.minimumDescentAltitude;
						this.setRowMultiText(2, "MDA", MODE_STATE.STATUS, value.toFixed(0), MODE_STATE.ARMED);
						break;
					default:
						this.setRowText(2, "", MODE_STATE.NONE);
				}
			...
			if (targetState != this.currentRow1State) {
				...
				switch (targetState) {
					case Column5.ROW_1_STATE.AP_1:
						this.setRowText(0, "AP1", MODE_STATE.ENGAGED);
						break;
					case Column5.ROW_1_STATE.AP_2:
						this.setRowText(0, "AP2", MODE_STATE.ENGAGED);
						break;
					case Column5.ROW_1_STATE.AP_BOTH:
						this.setRowText(0, "AP1+2", MODE_STATE.ENGAGED);
						break;
					default:
						this.setRowText(0, "", MODE_STATE.NONE);
				}
			...
			if (targetState != this.currentRow2State) {
				...
				switch (targetState) {
					case Column5.ROW_2_STATE.FD_1:
						this.setRowText(1, "1FD-", MODE_STATE.STATUS);
						break;
					case Column5.ROW_2_STATE.FD_2:
						this.setRowText(1, "-FD2", MODE_STATE.STATUS);
						break;
					case Column5.ROW_2_STATE.FD_BOTH:
						this.setRowText(1, "1FD2", MODE_STATE.STATUS);
						break;
					default:
						this.setRowText(1, "", MODE_STATE.NONE);
				}
			...
			if (targetState != this.currentRow3State) {
				...
				switch (targetState) {
					case Column5.ROW_3_STATE.ATHR_ARMED:
						this.setRowText(2, "A/THR", MODE_STATE.ARMED);
						break;
					case Column5.ROW_3_STATE.ATHR_ACTIVE:
						this.setRowText(2, "A/THR", MODE_STATE.ACTIVE);
						break;
					default:
						this.setRowText(2, "", MODE_STATE.NONE);
				}
	...
	class VerticalAndLateral {
		...
		init() {
			if (this.msg != null) {
				this.msg.init();
				this.msg.setText("", MODE_STATE.NONE);
		...
		update(_deltaTime) {
			...
			if (this.msg != null) {
				...
				if (targetState != this.currentState) {
					...
					if (str.length > 0) {
						this.msg.setText(str, MODE_STATE.ENGAGED);
	...
	class SpecialMessages {
		...
		init() {
			if (this.msg1 != null) {
				this.msg1.init();
				this.msg1.setText("", MODE_STATE.NONE);
				this.msg1.setVisibility(false);
			}
			if (this.msg2 != null) {
				this.msg2.init();
				this.msg2.setText("", MODE_STATE.NONE);
				this.msg2.setVisibility(false);
			}
		}
		update(_deltaTime) {
			if ((this.msg1 != null) && (this.msg2 != null)) {
				let requiredMessage = this.getCurrentRequiredMessage();
				if ((requiredMessage != this.currentMessage) || (requiredMessage == Airbus_FMA.SPECIAL_MESSAGE.MACH_SEL) || (requiredMessage == Airbus_FMA.SPECIAL_MESSAGE.SPEED_SEL)) {
					...
					switch (this.currentMessage) {
						case Airbus_FMA.SPECIAL_MESSAGE.MACH_SEL:
							useMsgID = 1;
							let value = Airbus_FMA.CurrentPlaneState.managedAirspeed * 0.0015130718954118;
							this.msg1.setText("MACH SEL: " + value.toFixed(2), MODE_STATE.ARMED);
							break;
						case Airbus_FMA.SPECIAL_MESSAGE.SPEED_SEL:
							useMsgID = 1;
							let value = Airbus_FMA.CurrentPlaneState.managedAirspeed;
							this.msg1.setText("SPEED SEL: " + value.toFixed(0), MODE_STATE.ARMED);
							break;
					}
					if (useMsgID == 1) {
