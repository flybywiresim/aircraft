 ...
 */
export type MapAbstractFlightPlanPathRendererRenderOrder = 'forward' | 'reverse';
 ...
 */
export abstract class MapAbstractFlightPlanPathRenderer<Args extends any[] = []> {
  /**
   * Constructor.
   ...
   */
  constructor(protected readonly renderOrder: MapAbstractFlightPlanPathRendererRenderOrder = 'forward', protected readonly renderActiveLegLast = true) {
  }
