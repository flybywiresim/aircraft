...
(function (Airbus_FMA) {
    ...
    class CurrentPlaneState {
        ...
        static refresh() {
            ...
            this.flightPhase = SimVar.GetSimVarValue("L:A32NX_FMGC_FLIGHT_PHASE", "number");
            const approachType = ApproachType.APPROACH_TYPE_ILS;
            this.isILSApproachActive = ((this.flightPhase == FmgcFlightPhases.APPROACH) && (approachType == ApproachType.APPROACH_TYPE_ILS));
            this.isNonILSApproachActive = ((this.flightPhase == FmgcFlightPhases.APPROACH) && (approachType != ApproachType.APPROACH_TYPE_ILS));
    ...
    class Column1 extends Airbus_FMA.ColumnBase {
        ...
        IsActive_MANFLX() {
            if (!Airbus_FMA.CurrentPlaneState.autoPilotThrottleActive && Airbus_FMA.CurrentPlaneState.autoPilotThrottleArmed && (Airbus_FMA.CurrentPlaneState.highestThrottleDetent == ThrottleMode.FLEX_MCT)) {
                if ((Airbus_FMA.CurrentPlaneState.flightPhase <= FmgcFlightPhases.TAKEOFF) && (Airbus_FMA.CurrentPlaneState.flexTemperature !== 0)) {
                    return true;
                }
            }
            return false;
        ...
        IsActive_MANSGA() {
            return Airbus_FMA.CurrentPlaneState.bothEnginesActive
                ...
                && Airbus_FMA.CurrentPlaneState.flightPhase === FmgcFlightPhases.GOAROUND;
        }
        ...
        IsActive_LVRCLB() {
            ...
            const inTakeoff = (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.TAKEOFF);
            const inClimb = (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.CLIMB);
            const inGoAround = (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.GOAROUND) || SimVar.GetSimVarValue("L:A32NX_GOAROUND_PASSED", "bool") === 1;
        ...
        IsActive_LVRMCT() {
            ...
            return false;
            const inTakeoff = (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.TAKEOFF);
            const inGoAround = (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.GOAROUND);
        ...
        IsActive_BRKLO() {
            return Airbus_FMA.CurrentPlaneState.autoBreakActivated
                ...
                && (Airbus_FMA.CurrentPlaneState.flightPhase > FmgcFlightPhases.TAKEOFF
                    || Airbus_FMA.CurrentPlaneState.flightPhase === FmgcFlightPhases.PREFLIGHT);
        }
        IsActive_BRKLOARMED() {
        ...
        IsActive_BRKMAX() {
            return Airbus_FMA.CurrentPlaneState.autoBreakDecel &&
                ...
                && Airbus_FMA.CurrentPlaneState.flightPhase < FmgcFlightPhases.CLIMB;
        }
    ...
    class Column2 extends Airbus_FMA.ColumnBase {
        ...
        getTargetRow1State() {
            ...
            if (altModeState == Airbus_FMA.MODE_STATE.ENGAGED) {
                if (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.CRUISE) {
        ...
        getTargetRow2State() {
            ...
            } else if (Column2.IsArmed_OPCLB_MA()) {
                return Column2.ROW_2_STATE.OP_CLB_ARMED;
            } else {
        ...
        GetModeState_SRS() {
            if (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.TAKEOFF && Airbus_FMA.CurrentPlaneState.thisFlightDirectorActive) {
            ...
            } else if (Airbus_FMA.CurrentPlaneState.flightPhase === FmgcFlightPhases.GOAROUND) {
                if ((Airbus_FMA.CurrentPlaneState.highestThrottleDetent === ThrottleMode.TOGA
            ...
            if (Airbus_FMA.CurrentPlaneState.flightPhase != FmgcFlightPhases.TAKEOFF) {
                SRSEnabled = false;
            }
            if (SRSEnabled) {
                return Airbus_FMA.MODE_STATE.ENGAGED;
        ...
        static GetModeState_GS() {
            ...
            if (Airbus_FMA.CurrentPlaneState.flightPhase != FmgcFlightPhases.GOAROUND) {
        ...
        static GetModeState_CLB() {
            ...
            if ((Airbus_FMA.CurrentPlaneState.autoPilotAltitudeLockActive && Airbus_FMA.CurrentPlaneState.thisFlightDirectorActive || Simplane.getAutoPilotFLCActive() && Airbus_FMA.CurrentPlaneState.thisFlightDirectorActive) && (Airbus_FMA.CurrentPlaneState.altitude < Airbus_FMA.CurrentPlaneState.autoPilotAltitudeLockValue) && Airbus_FMA.CurrentPlaneState.thisFlightDirectorActive) {
                ...
                if (Airbus_FMA.CurrentPlaneState.flightPhase < FmgcFlightPhases.CLIMB) {
                    return Airbus_FMA.MODE_STATE.ARMED;
        ...
        static IsActive_DES() {
            if (Airbus_FMA.CurrentPlaneState.autoPilotAltitudeLockActive && (Airbus_FMA.CurrentPlaneState.altitude > Airbus_FMA.CurrentPlaneState.autoPilotAltitudeLockValue) && Airbus_FMA.CurrentPlaneState.thisFlightDirectorActive) {
                if (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.DESCENT && Simplane.getVerticalSpeed() < -10) {
                    return true;
                }
            }
            if (Simplane.getAutoPilotFLCActive() && Airbus_FMA.CurrentPlaneState.thisFlightDirectorActive) {
    ...
    class Column3 extends Airbus_FMA.ColumnBase {
            ...
            if (targetRow1State != this.currentRow1State || targetRow2State != this.currentRow2State) {
                ...
                setTimeout(() => {
                    ...
                    switch (this.currentRow2State) {
                        ...
                        case Column3.ROW_2_STATE.HDG_ARMED: {
                            this.setRowText(1, "HDG", Airbus_FMA.MODE_STATE.ARMED);
                            break;
                        }
                        default: {
                            this.setRowText(1, "", Airbus_FMA.MODE_STATE.NONE);
        ...
        getTargetRow2State() {
            ...
            } else if (this.IsArmed_HDG()) {
                return Column3.ROW_1_STATE.HDG_ARMED;
            } else {
        ...
        IsActive_RWY() {
            if (Airbus_FMA.CurrentPlaneState.flightPhase <= FmgcFlightPhases.CLIMB && Airbus_FMA.CurrentPlaneState.thisFlightDirectorActive) {
        ...
        IsArmed_HDG() {
            ...
            if (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.GOAROUND && Airbus_FMA.CurrentPlaneState.flapsHandlePercent != 0) {
        ...
        IsActive_HDG() {
            ...
            // Airbus_FMA.CurrentPlaneState.flightPhase != FmgcFlightPhases.GOAROUND || Column2.GetModeState_SRS() == false
            if (Airbus_FMA.CurrentPlaneState.autoPilotHeadingSelectedMode && !Airbus_FMA.CurrentPlaneState.autoPilotTRKFPAModeActive && Airbus_FMA.CurrentPlaneState.thisFlightDirectorActive && Airbus_FMA.CurrentPlaneState.radioAltitude >= 1.5) {
                ...
                if (!Simplane.getAutoPilotAPPRActive() && Airbus_FMA.CurrentPlaneState.flightPhase != FmgcFlightPhases.GOAROUND) {
                    retVal = true;
                }

                if (SimVar.GetSimVarValue("L:A32NX_GOAROUND_HDG_MODE", "bool") === 1 && Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.GOAROUND) {
                    retVal = true;
                }
                return retVal;
            }
        ...
        GetModeState_LOC() {
            if (Airbus_FMA.CurrentPlaneState.thisFlightDirectorActive && Simplane.getAutoPilotApproachType() != 10) {
                if (Simplane.getAutoPilotAPPRActive() && SimVar.GetSimVarValue("L:A32NX_OFF_LOC", "bool") == 1 && Airbus_FMA.CurrentPlaneState.flightPhase != FmgcFlightPhases.GOAROUND) {
                    return Airbus_FMA.MODE_STATE.CAPTURED;
                }
                if (Simplane.getAutoPilotAPPRActive() && Airbus_FMA.CurrentPlaneState.flightPhase != FmgcFlightPhases.GOAROUND) {
                    return Airbus_FMA.MODE_STATE.ENGAGED;
        ...
        GetModeState_NAV() {
            if (
                (Airbus_FMA.CurrentPlaneState.flightPhase !== FmgcFlightPhases.GOAROUND
                || (Airbus_FMA.CurrentPlaneState.flightPhase === FmgcFlightPhases.GOAROUND && Airbus_FMA.CurrentPlaneState.highestThrottleDetent === ThrottleMode.FLEX_MCT))
            ...
            if (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.GOAROUND && SimVar.GetSimVarValue("L:A32NX_GOAROUND_NAV_MODE", "bool") === 1 && SimVar.GetSimVarValue("L:A320_FCU_SHOW_SELECTED_HEADING", "number") === 0) {
                if (Airbus_FMA.CurrentPlaneState.radioAltitude >= 30) {
                    return Airbus_FMA.MODE_STATE.ENGAGED;
                } else {
                    return Airbus_FMA.MODE_STATE.ARMED;
        ...
        IsActive_GATRK() {
            ...
            //if (Simplane.getAutoPilotAPPRActive() && !Simplane.getAutoPilotThrottleActive() && SimVar.GetSimVarValue("L:A32NX_FMGC_FLIGHT_PHASE", "number") == 6 && Airbus_FMA.CurrentPlaneState.highestThrottleDetent == ThrottleMode.TOGA) {
            if (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.GOAROUND && Airbus_FMA.CurrentPlaneState.flapsHandlePercent != 0) {
    ...
    class Column4 extends Airbus_FMA.ColumnBase {
        ...
        updateRow3(_deltaTime) {
            ...
            if ((Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.DESCENT) || (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.APPROACH)) {
            ...
            if (this.msg != null) {
                if (Airbus_FMA.VerticalAndLateral.IsActive_FinalApp()) {
                    ...
                    if (Airbus_FMA.CurrentPlaneState.radioAltitude <= 1.5) {
                        ...
                        (this._previousState === VerticalAndLateral.STATE.LAND && Airbus_FMA.CurrentPlaneState.radioAltitude < 400 * 1.1) && Airbus_FMA.CurrentPlaneState.highestThrottleDetent != ThrottleMode.TOGA) {
    ...
    class SpecialMessages {
        ...
        getCurrentRequiredMessage() {
            if (!Column1.IsActive_SpeedCommon() && (Airbus_FMA.CurrentPlaneState.managedAirspeed > 0) && ((Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.TAKEOFF) || (Airbus_FMA.CurrentPlaneState.flightPhase == FmgcFlightPhases.CLIMB))) {
