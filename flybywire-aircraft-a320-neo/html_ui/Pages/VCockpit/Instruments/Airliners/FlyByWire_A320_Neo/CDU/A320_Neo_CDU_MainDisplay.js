class A320_Neo_CDU_MainDisplay extends FMCMainDisplay {
    ...
    Init() {
        ...
        if (onlineFeaturesStatus === "UNKNOWN") {
            new NXNotif().showNotification({ message: "You have not yet configured the TELEX option. To do so, go to the electronic flight bag's settings page and set the TELEX setting on the ATSU/AOC tab. More information can be found at https://docs.flybywiresim.com/telex" });
        }
