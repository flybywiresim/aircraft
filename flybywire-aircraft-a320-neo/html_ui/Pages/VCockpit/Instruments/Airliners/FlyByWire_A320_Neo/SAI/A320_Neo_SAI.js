...
class A320_Neo_SAI_SelfTest extends NavSystemElement {
    init() {
        ...
        const coldDark = Boolean(SimVar.GetSimVarValue('L:A32NX_COLD_AND_DARK_SPAWN') && SimVar.GetSimVarValue('L:A32NX_FMGC_FLIGHT_PHASE', 'Enum') === (FmgcFlightPhases.PREFLIGHT));
