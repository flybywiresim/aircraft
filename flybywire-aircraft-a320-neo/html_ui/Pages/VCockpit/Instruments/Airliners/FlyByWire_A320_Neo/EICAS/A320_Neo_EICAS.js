class A320_Neo_EICAS extends Airliners.BaseEICAS {
    ...
    createLowerScreenPages() {
        ...
        this.createLowerScreenPage("CRZ", "BottomScreen", "a320-neo-lower-ecam-crz");
    }
    ...
    Init() {
        ...
        this.poweredDuringPreviousUpdate = (SimVar.GetSimVarValue('L:A32NX_COLD_AND_DARK_SPAWN', 'Bool') && SimVar.GetSimVarValue('L:A32NX_FMGC_FLIGHT_PHASE', 'Enum') === (FmgcFlightPhases.PREFLIGHT)) ? 0 : 1;
