...
export default new TaskOfTasks('a32nx', [
    new TaskOfTasks('build', [
        ...
        new ExecTask('textures','node src/textures/build.js', ['src/textures', 'flybywire-aircraft-a320-neo/SimObjects/AirPlanes/FlyByWire_A320_NEO/TEXTURE/A320NEO_COCKPIT_DECALSTEXT_ALBD.TIF.dds']),
